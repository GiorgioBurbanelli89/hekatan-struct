...
edb = os.path.abspath("validation/modelos/plantillas/etabs/edb/P2_portico-losa.EDB")
...
sm.File.Save(os.path.abspath("validation/modelos/plantillas/etabs/P2_lat2.EDB")); sm.Analyze.SetRunCaseFlag("", True, True); print("run", sm.Analyze.RunAnalysis())
...
json.dump({"cargas": cargas, "nudos": out}, open("validation/modelos/plantillas/etabs/P2_lat2.json", "w"), indent=1)
