#!/usr/bin/env node
// Regresión: frame Paz 6.3 por el camino NO-lateral (denso). Debe dar f1≈9.678, f3≈26.61 Hz.
...
const ei = { elasticities: eM(E, E), shearModuli: eM(G, G), areas: eM(43.0, 24.7), momentsOfInertiaZ: eM(391, 225), momentsOfInertiaY: eM(5630, 928), torsionalConstants: eM(34.8, 5.90), densities: new Map(elements.map((_, i) => [i, RHO])) };
...
console.log("Ref nativa:                          9.6780  16.9874  26.6149  29.9497  33.9929  44.9332");
console.log("(lat=1 = lateral: debe dar ~9.68 Uy y ~26.6 Ux)");
