...
|---|---|---|---|---|---|---|---|
| `portico-2d` | 46.01 | 44.25 | 3.830 % | 43.27 | 20.26 | 53.167 % | 2.7 / 2.7 |
| `portico-3d` | 289.76 | 275.67 | 4.865 % | 278.80 | 162.11 | 41.854 % | 11.0 / 11.0 |
| `portico-losa` | 924.11 | 910.01 | 1.525 % | 924.11 | 10.96 | 98.814 % | 899.0 / 0.0 |
| `solo-rejilla` | 78.31 | 78.31 | 0.000 % | 67.35 | 0.00 | 100.000 % | 11.0 / 11.0 |
| `losa-plana` | 712.66 | 712.66 | 0.000 % | 712.66 | 10.96 | 98.462 % | 701.7 / 0.0 |
| `losa-vigas-borde` | 818.38 | 811.34 | 0.861 % | 818.38 | 10.96 | 98.660 % | 800.4 / 0.0 |
| `dual` | 1015.88 | 1001.79 | 1.388 % | 1015.88 | 23.81 | 97.656 % | 978.0 / 0.0 |
| `arriostrado` | 295.73 | 281.63 | 4.767 % | 284.00 | 162.11 | 42.918 % | 11.7 / 11.7 |
...
|---|---|---|---|---|---|---|---|
| `portico-2d` | 1 | 1 | 0.857 | 1.4181 | 1.3860 | 2.32 % | 0/71/0 |
|  | 2 | 2 | 1.000 | 0.6545 | 0.6413 | 2.06 % | 0/0/77 |
|  | 3 | 3 | 0.971 | 0.3300 | 0.3229 | 2.21 % | 88/0/0 |
|  | 4 | - | 0.501 | 0.2320 | - | - | - |
| `portico-3d` | 1 | 2 | 0.980 | 0.4233 | 0.4121 | 2.71 % | 88/0/0 |
|  | 2 | 1 | 0.980 | 0.4233 | 0.4121 | 2.71 % | 0/88/0 |
|  | 3 | 3 | 1.000 | 0.3815 | 0.3716 | 2.67 % | 0/0/89 |
|  | 4 | - | 0.392 | 0.1359 | - | - | - |
| `portico-losa` | 1 | 1 | 0.725 | 0.7055 | 0.6999 | 0.79 % | 88/2/0 |
|  | 2 | 2 | 0.725 | 0.7055 | 0.6999 | 0.79 % | 2/88/0 |
|  | 3 | 3 | 1.000 | 0.5879 | 0.5822 | 0.98 % | 0/0/89 |
|  | 4 | - | 0.287 | 0.2268 | - | - | - |
| `solo-rejilla` | 1 | 2 | 0.757 | 0.8116 | 0.8116 | 0.00 % | 70/0/0 |
|  | 2 | 1 | 0.757 | 0.8116 | 0.8116 | 0.00 % | 0/70/0 |
|  | 3 | 3 | 1.000 | 0.6751 | 0.6751 | 0.00 % | 0/0/72 |
|  | 4 | - | 0.538 | 0.1389 | - | - | - |
| `losa-plana` | 1 | 2 | 0.970 | 1.0205 | 1.0205 | 0.00 % | 69/14/0 |
|  | 2 | 1 | 0.970 | 1.0205 | 1.0205 | 0.00 % | 14/69/0 |
|  | 3 | 3 | 1.000 | 0.8937 | 0.8937 | 0.01 % | 0/0/82 |
|  | 4 | - | 0.328 | 0.2929 | - | - | - |
| `losa-vigas-borde` | 1 | 1 | 0.986 | 0.7645 | 0.7611 | 0.45 % | 88/0/0 |
|  | 2 | 2 | 0.986 | 0.7645 | 0.7611 | 0.45 % | 0/88/0 |
|  | 3 | 3 | 1.000 | 0.5860 | 0.5815 | 0.78 % | 0/0/89 |
|  | 4 | - | 0.288 | 0.2394 | - | - | - |
| `dual` | 1 | 1 | 0.985 | 0.6803 | 0.6754 | 0.74 % | 0/88/0 |
|  | 2 | - | 0.354 | 0.2151 | - | - | - |
|  | 3 | 3 | 0.940 | 0.1790 | 0.1777 | 0.73 % | 77/0/0 |
|  | 4 | 8 | 1.000 | 0.1582 | 0.0398 | 297.32 % | 0/0/20 |
| `arriostrado` | 1 | 1 | 0.979 | 0.4268 | 0.4157 | 2.66 % | 0/88/0 |
|  | 2 | 2 | 1.000 | 0.2853 | 0.2780 | 2.62 % | 0/0/89 |
|  | 3 | 3 | 0.980 | 0.2603 | 0.2535 | 2.65 % | 89/0/0 |
|  | 4 | - | 0.397 | 0.1370 | - | - | - |
...
|---|---|---|---|---|---|---|---|
| `portico-2d` | 36 de 76 | 0.000 % | 0.000 % | 0.000 % | 0 de 0 | 0.000 % | 0.000 % |
| `portico-3d` | 288 de 544 | 0.000 % | 0.000 % | 0.000 % | 0 de 0 | 0.000 % | 0.000 % |
| `portico-losa` | 288 de 544 | 0.000 % | 0.000 % | 0.000 % | 900 de 900 | 68.057 % | 68.057 % |
| `solo-rejilla` | 64 de 64 | 0.000 % | 0.000 % | 0.000 % | 0 de 0 | 0.000 % | 0.000 % |
| `losa-plana` | 64 de 64 | 0.000 % | 0.000 % | 0.000 % | 900 de 900 | 87.628 % | 87.628 % |
| `losa-vigas-borde` | 160 de 304 | 0.000 % | 0.000 % | 0.000 % | 900 de 900 | 85.237 % | 85.237 % |
| `dual` | 288 de 544 | 0.000 % | 0.000 % | 0.000 % | 940 de 940 | 67.413 % | 103.193 % |
| `arriostrado` | 304 de 560 | 0.000 % | 0.000 % | 0.000 % | 0 de 0 | 0.000 % | 0.000 % |
