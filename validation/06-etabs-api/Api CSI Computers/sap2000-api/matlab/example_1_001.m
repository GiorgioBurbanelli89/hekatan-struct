%% ════════════════════════════════════════════════════════════════
%  SAP2000 Example 1-001 — Portal Frame (CSi official verification)
%
%  Fuente: https://wiki.csiamerica.com/display/oapi/Example+6+%28MATLAB%29
%  Probado con MATLAB R2015a + SAP2000 v21+ (compatible R2017a+).
%
%  Crea desde cero el problema de verificación oficial CSi:
%  un pórtico de 3 frames con 7 patrones de carga, corre el análisis,
%  extrae los desplazamientos U3 (columnas 1-4) y U1 (columnas 5-7)
%  en los puntos especificados, y los compara contra los valores
%  IndResult calculados a mano (hand-calculated reference).
%
%  Output: 3 vectores 7×1:
%     SapResult     — del SAP2000 API
%     IndResult     — del cálculo manual de referencia
%     PercentDiff   — (SapResult / IndResult) - 1
%
%  Esperado: PercentDiff < 1e-3 en todos los 7 patrones.
%% ════════════════════════════════════════════════════════════════
