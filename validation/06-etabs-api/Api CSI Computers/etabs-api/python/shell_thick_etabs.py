"""Shell Thick Cantilever — ETABS API (Python) — FE06."""
import os
import comtypes.client as cc

APIDLLPath     = r"C:\Program Files\Computers and Structures\ETABS 18\ETABSv1.dll"
ModelDirectory = r"C:\CSi_ETABS_API_ShellThick"
os.makedirs(ModelDirectory, exist_ok=True)
ModelPath = os.path.join(ModelDirectory, "shell_thick.edb")
...
SapModel.PropArea.SetSlab("SHELL_THICK", 1, 2, "SHELL_MAT", t)  # eShellType.ShellThick=2
...
print("\n" + "═"*60)
print("  SHELL THICK (eShellType.ShellThick) — ETABS vs HekatanLab vs Membrana")
print("═"*60)
...
print(f"\nETABSResult_sthk = {u_max:.6e}")
print(f"IndResult_sthk   = {delta_mem:.6e}")
print(f"PercentDiff_sthk = {(u_max/delta_mem)-1:+.4f}")
