% ===========================================================================
% composite_slab_thick_frame.m
% Losa cuadrada 4mx4m (Q4 shell THICK Mindlin-Reissner) sobre 4 vigas perimetrales,
...
fprintf('=== Composite floor: THICK shell (Mindlin) + 4 edge beams ===\n');
...
for e = 1:nShells
  ...
  ke_s = q4_shell_thick(E_c, nu_c, t_slab, ce);
  edof = zeros(24, 1);
  for k = 1:4
    nk = shells(e, k);
