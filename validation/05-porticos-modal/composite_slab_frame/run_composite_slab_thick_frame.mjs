#!/usr/bin/env node
/**
 * run_composite_slab_thick_frame.mjs
 *
 * Replica el benchmark composite_slab_thick_frame.m (MATLAB) con el solver
 * Eigen WASM C++ de hekatan-fem.  En Hekatan Struct, el Q4 shell C++ es
 * MITC4 / Mindlin-Reissner, asi que el tratamiento "thick" lo da
 * automaticamente el solver — los inputs son los mismos que thin.
 *
 * Modelo:
 *   - Losa cuadrada 4 x 4 m, t = 0.10 m (concreto E=25000 MPa, nu=0.20)
 *   - Mesh 4x4 = 16 Q4 shell (MITC4)
...
console.log("=== Hekatan Struct CLI: composite slab THICK + frames ===");
