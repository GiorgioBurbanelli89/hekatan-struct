%% ════════════════════════════════════════════════════════════════
%  ETABS Example 1-001 — Portal Frame (CSi official verification)
%
%  Fuente: documentación oficial CSi OAPI.
%  Probado con MATLAB R2016a + ETABS 18+ (compatible R2017a+).
%
%  Mismo problema que `sap2000/example_1_001.m` pero a través de ETABS.
%  Crea un pórtico de 3 frames con 7 patrones de carga, corre análisis,
%  extrae U3 (casos 1-4) y U1 (casos 5-7), compara contra IndResult.
%% ════════════════════════════════════════════════════════════════
