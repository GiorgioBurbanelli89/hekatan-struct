import { a as ft } from "./analyze-CDRzE7vM.js";
import { d as _t, __tla as __tla_0 } from "./didacticCpp-BTBicwl0.js";
import { b as ut, m as bt, i as ht } from "./menegottoPinto-B-C2cxus.js";
import { s as Ke, __tla as __tla_1 } from "./secantPlasticity-CnWr5aJq.js";
import { L as O, B as D, a as L, S as Me, e as ge, d as V, V as B, b as he, c as Mt, E as gt, w as Ze, M as te, I as He } from "./theme-DDCjfe25.js";
...
let __tla = Promise.all([
  ...
  function xt(e) {
    ...
    if (e.firstYieldStep >= 0) {
      const c = e.firstYieldStep, g = s(b[c], h[c]), $ = new O({
        color: 16711680
      }), _ = n * 0.04, I = new D().setFromPoints([
      ...
      l.push(new L(I, $)), l.push(new L(me, $));
    }
    return l;
  }
  function pt(e) {
  ...
  function $t(e) {
    ...
    const f = e.size, p = Math.max(...e.theta.map((_) => Math.abs(_)), 1e-9), u = Math.max(...e.M.map((_) => Math.abs(_)), 1e-9), b = e.theta.map((_) => _ / p * (f / 2)), h = e.M.map((_) => _ / u * (f / 2)), [v, x, a] = e.center, s = (_, I) => new B(v + _, x, a + I), i = f / 2, F = new O({
      color: 6710886
    });
    ...
    for (let _ = 0; _ < l; _++) {
      const I = s(b[_], h[_]);
      m[_ * 3 + 0] = I.x, m[_ * 3 + 1] = I.y, m[_ * 3 + 2] = I.z;
    }
    const M = new D();
    ...
    return $.position.copy(s(b[0], h[0])), n.push($), {
      objects: n,
      moveCursor: (_) => {
        const I = Math.max(0, Math.min(l - 1, _));
        $.position.copy(s(b[I], h[I]));
      },
      setProgress: (_) => {
        const I = Math.max(1, Math.min(l, _ + 1));
        M.setDrawRange(0, I);
      }
    };
  }
  ...
  Et = {
    ...
    build(e, n) {
      ...
      const l = [], f = [], p = /* @__PURE__ */ new Map(), u = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), h = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Map(), F = e.E_steel / 2.6, y = 77, S = 1e-4, z = /* @__PURE__ */ new Map(), m = (t, o, r) => {
        const d = Math.round(t / S), w = Math.round(o / S), R = Math.round(r / S), P = `${d},${w},${R}`;
        let A = z.get(P);
        return A === void 0 && (l.push([
          t,
          o,
          r
        ]), A = l.length - 1, z.set(P, A)), A;
      }, M = (t, o, r, d, w) => {
        f.push([
          t,
          o,
      ...
      }, C = e.story_h, c = Math.max(1, Math.round(e.mesh_density)), g = 6 * c, $ = 2 * c, _ = c + 1, I = +e.d_col / 2 - e.tf_col / 2, me = -e.d_col / 2 + e.tf_col / 2, ze = me, Je = I, oe = [];
      for (let t = 0; t <= g; t++) {
        const o = -C / 2 + t * C / g, r = [];
        for (let d = 0; d <= $; d++) {
      ...
      const Pe = 8 * c + 4;
      for (let t = 1; t < Pe; t++) J.push(T + (W - T) * t / Pe);
      J.push(W);
      const Ae = 5 * c;
      ...
      try {
        ...
        if (o) {
          ...
          if (n.__componentRatios = r, n.__governingComponent = d, n.__failureMode = w, e.colormap_mode > 0.5) {
            ...
            for (const Y of r) P.set(Y.zone, Y.ratio);
            const A = /* @__PURE__ */ new Map();
            for (let Y = 0; Y < f.length; Y++) {
              const Z = t.get(Y), ee = Z ? P.get(Z) ?? 0 : 0, G = f[Y].length, dt = new Array(G).fill(ee * e.Fy);
              A.set(Y, dt);
            }
      ...
      if (Te && (clearInterval(Te), window.__rbsK3Anim = null), e.animate_k3 > 0.5) {
        ...
        setTimeout(() => {
          ...
          if (!P) return;
          const A = P.__settings, Y = P.__ctx;
