import { m as k, __tla as __tla_0 } from "./didacticCpp-CLixJGob.js";
import { i as g, j as z, d as x, P as t, __tla as __tla_1 } from "./pazFrameE2k-BN1k77mc.js";
let A;
let __tla = Promise.all([
  ...
  A = {
    ...
    build(e, n) {
      const a = c(e);
      g(a, n), console.log(`[Paz 12.1] Grid frame L=${e.L_in}in, A=${e.A_in2}in\xB2, I=${e.Iy_in4}in\u2074, J=${e.J_in4}in\u2074`);
    },
    runModal(e, n, a) {
      if (n.nodes.val.length) try {
        const o = k(n.nodes.val, n.elements.val, n.nodeInputs.val, n.elementInputs.val, 6);
