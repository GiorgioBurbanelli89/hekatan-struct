const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/calcPanel-D9WCqeNy.js","assets/getMesh-CMOA6JCi.js","assets/__vite-browser-external-D7Ct-6yo.js","assets/pureFunctionsAny.generated-DeJSBP3k.js","assets/analyze-DOGq34F5.js","assets/didacticCpp-CT_TM4EM.js","assets/deform-BeOgLxmb.js","assets/preload-helper-DrUBW0xl.js","assets/cyclicPushoverCpp-CMN4yMbX.js"])))=>i.map(i=>d[i]);
...
import { g as $n, b as wn, a as so } from "./analyze-DOGq34F5.js";
import { d as pt, p as os, m as ul, s as fl, __tla as __tla_0 } from "./didacticCpp-CT_TM4EM.js";
import { g as lo, __tla as __tla_1 } from "./getMesh-CMOA6JCi.js";
import { c as ml, e as bl, a as gl, p as hl, b as xl } from "./e2kExporter-DYHA5hAz.js";
...
`);
      ...
      y && (y.value = B, y.addEventListener("change", (h) => {
        ...
        h.stopPropagation(), sa(async () => {
          const { openCalcPanel: S } = await import("./calcPanel-D9WCqeNy.js").then(async (m2) => {
            await m2.__tla;
            return m2;
          });
          return {
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        try {
          const { cyclicPushover: b } = await sa(async () => {
            const { cyclicPushover: k } = await import("./cyclicPushoverCpp-CMN4yMbX.js");
            return {
              cyclicPushover: k
            };
