...
let __tla = Promise.all([
  ...
  R = {
    ...
    build(e, o) {
      ...
      for (let t = 0; t < h.length; t++) E.set(t, e.E), I.set(t, f), M.set(t, s), b.set(t, m), v.set(t, r), B.set(t, i), $.set(t, F), A.set(t, c), W.set(t, P), L.set(t, w);
      ...
      const x = D(u, h, o.nodeInputs.val, o.elementInputs.val);
      o.deformOutputs.val = x, o.analyzeOutputs.val = y(u, h, o.elementInputs.val, x), o.objects3D.val = [];
      const k = d * e.L ** 4 / (8 * e.E * m), N = d * e.L ** 2 / (2 * f * F), _ = k + N, S = ((_b = (_a = x.deformations) == null ? void 0 : _a.get(a)) == null ? void 0 : _b[2]) ?? 0, O = Math.abs(_) > 1e-15 ? (Math.abs(S) - _) / _ * 100 : 0;
