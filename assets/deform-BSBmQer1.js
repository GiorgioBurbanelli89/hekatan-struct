...
import { _ as Nn } from "./preload-helper-DrUBW0xl.js";
let Mn;
let __tla = (async () => {
  Mn = async function(we = {}) {
    ...
    if (z) {
      const { createRequire: e } = await Nn(() => import("./__vite-browser-external-D7Ct-6yo.js").then((r) => r._), []);
    ...
    var Pe;
    function br() {
      return d.locateFile ? pr("deform.wasm") : new URL("/hekatan-struct/assets/deform-kQnINkrQ.wasm", import.meta.url).href;
    }
    function Tr(e) {
    ...
    var $e = (e) => {
      ...
      return a;
    }, H = (e, r, t) => (u(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? $(Z, e, r) : ""), Ir = (e, r, t, n) => T(`Assertion failed: ${H(e)}, at: ` + [
    ...
    }, Gr = () => T("native code called abort()"), Ke = (e, r, t, n) => {
...
`));
      ...
      register(e, r) {
        j.ttys[e] = {
          ...
          output: [],
          ops: r
        }, i.registerDevice(e, j.stream_ops);
      },
      stream_ops: {
        open(e) {
      ...
      default_tty_ops: {
        ...
        put_char(e, r) {
          r === null || r === 10 ? (ue($(e.output)), e.output = []) : r != 0 && e.output.push(r);
        },
        fsync(e) {
          var _a2;
          ((_a2 = e.output) == null ? void 0 : _a2.length) > 0 && (ue($(e.output)), e.output = []);
        },
        ioctl_tcgets(e) {
          return {
            c_iflag: 25856,
      ...
      default_tty1_ops: {
        put_char(e, r) {
          r === null || r === 10 ? (M($(e.output)), e.output = []) : r != 0 && e.output.push(r);
        },
        fsync(e) {
          var _a2;
          ((_a2 = e.output) == null ? void 0 : _a2.length) > 0 && (M($(e.output)), e.output = []);
        }
      }
    }, Qe = (e) => {
    ...
    }, G = 0, ae = null, q = {}, B = null, _t = (e) => {
      var _a2;
      if (G--, (_a2 = d.monitorRunDependencies) == null ? void 0 : _a2.call(d, G), u(e, "removeRunDependency requires an ID"), u(q[e]), delete q[e], G == 0 && (B !== null && (clearInterval(B), B = null), ae)) {
        var r = ae;
        ae = null, r();
      }
    }, mt = (e) => {
      var _a2, _b2;
      G++, (_a2 = d.monitorRunDependencies) == null ? void 0 : _a2.call(d, G), u(e, "addRunDependency requires an ID"), u(!q[e]), q[e] = 1, B === null && globalThis.setInterval && (B = setInterval(() => {
        if (_e) {
      ...
      readFile(e, r = {}) {
        ...
        return i.read(t, a, 0, o, 0), r.encoding === "utf8" && (a = $(a)), i.close(t), a;
      },
      writeFile(e, r, t = {}) {
        t.flags = t.flags || 577;
      ...
      createDefaultDevices() {
        i.mkdir("/dev"), i.registerDevice(i.makedev(1, 3), {
          ...
          write: (n, o, a, s, c) => s,
          llseek: () => 0
        }), i.mkdev("/dev/null", i.makedev(1, 3)), j.register(i.makedev(5, 0), j.default_tty_ops), j.register(i.makedev(6, 0), j.default_tty1_ops), i.mkdev("/dev/tty", i.makedev(5, 0)), i.mkdev("/dev/tty1", i.makedev(6, 0));
    ...
    var vr = {
      ...
      __cxa_rethrow: Wr,
      __cxa_throw: zr,
      __cxa_uncaught_exceptions: Hr,
      __resumeException: jr,
      _abort_js: Gr,
      _tzset_js: $r,
      clock_time_get: Qr,
      ...
      invoke_iiiiiiiiiii: wn,
      invoke_iiiiiiiiiiii: An,
      invoke_iiiiiiiiiiiii: kn,
      invoke_iiiiiiiiiiiiiii: jt,
      invoke_j: yn,
      invoke_jiiii: Sn,
      invoke_v: Mt,
      invoke_vddiiii: sn,
      ...
      invoke_viiiii: Ct,
      invoke_viiiiid: tn,
      invoke_viiiiidiii: ln,
      invoke_viiiiii: Lt,
      invoke_viiiiiid: nn,
      invoke_viiiiiii: Xt,
      invoke_viiiiiiidiiii: Kt,
      invoke_viiiiiiii: Yt,
      invoke_viiiiiiiii: qt,
      invoke_viiiiiiiiii: Ht,
      invoke_viiiiiiiiiidii: an,
      invoke_viiiiiiiiiii: rn,
      invoke_viiiiiiiiiiiddddii: un,
      invoke_viiiiiiiiiiii: on,
      invoke_viiiiiiiiiiiiiii: Pn,
      invoke_viiiiiiiiiiiiiiii: zt,
    ...
    function zt(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, P, R) {
      var N = E();
      try {
    ...
    function Ht(e, r, t, n, o, a, s, c, l, f, m) {
      var v = E();
      try {
    ...
    function jt(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S) {
      var P = E();
      try {
    ...
    function Kt(e, r, t, n, o, a, s, c, l, f, m, v, _) {
      var h = E();
      try {
    ...
    function an(e, r, t, n, o, a, s, c, l, f, m, v, _, h) {
      var S = E();
      try {
    ...
    function ln(e, r, t, n, o, a, s, c, l, f) {
      var m = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f);
      } catch (v) {
    ...
    function un(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, P, R, N) {
      var C = E();
      try {
    ...
    function _n(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, P) {
      var R = E();
      try {
    ...
    function wn(e, r, t, n, o, a, s, c, l, f, m) {
      var v = E();
      try {
    ...
    function kn(e, r, t, n, o, a, s, c, l, f, m, v, _) {
      var h = E();
      try {
    ...
    function Ue() {
      ...
      function e() {
        var _a2;
        u(!hr), hr = true, d.calledRun = true, !_e && (kr(), He == null ? void 0 : He(d), (_a2 = d.onRuntimeInitialized) == null ? void 0 : _a2.call(d), me("onRuntimeInitialized"), u(!d._main, 'compiled without a main, but one is present. if you added it from JS, use Module["onRuntimeInitialized"]'), Fr());
      }
