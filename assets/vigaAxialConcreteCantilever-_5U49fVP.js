...
import { m as O, d as C, __tla as __tla_0 } from "./didacticCpp-jx4SQtmt.js";
let D;
let __tla = Promise.all([
  ...
  D = {
    ...
    build(e, n) {
      var _a, _b;
      const o = e.b * e.h, l = e.b * e.h ** 3 / 12, r = e.b * e.h ** 3 / 12 * 0.3, s = 5 / 6 * o, m = e.E / (2 * (1 + x)), t = Math.max(1, Math.round(e.nElem)), I = e.L / t, c = [];
      ...
      ]), p = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map(), h = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), g = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), _ = /* @__PURE__ */ new Map();
      for (let a = 0; a < i.length; a++) p.set(a, e.E), f.set(a, m), h.set(a, o), v.set(a, l), M.set(a, l), b.set(a, r), g.set(a, s), E.set(a, s), F.set(a, N), _.set(a, x);
