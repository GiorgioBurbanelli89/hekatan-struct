...
import { v as l } from "./Text-CSfbf1xJ.js";
import { a as T } from "./analyze-BydHtRcI.js";
import { d as H, __tla as __tla_0 } from "./didacticCpp-B5f-GyHC.js";
import { g as k, b as A } from "./styles-CXNYye6A.js";
import { g as G } from "./getParameters-DsthXvNv.js";
...
Promise.all([
  ...
  l.derive(() => {
    ...
    let f = {}, M = {};
    try {
      f = H(i, s, b, d), M = T(i, s, d, f);
    } catch (t) {
      console.warn("Twisted Tower deform/analyze:", (t == null ? void 0 : t.message) ?? t);
    }
    I.val = i, F.val = s, O.val = b, x.val = d, C.val = f, S.val = M;
  });
