import { v as I, P as Eo, q as pn, a7 as Xn, B as he, a8 as Yn, F as It, a4 as Vo, _ as lt, N as jt, L as mt, h as tn, u as To, g as Uo, a9 as Ko, i as rt, d as tt, V as m, $ as dn, aa as qn, H as Lo, D as Yt, a as Lt, x as ut, z as Dn, ab as Nn, s as Ho, m as Wo, I as rn, a2 as Pn, E as yo, f as vn, Q as Jn, ac as zn, C as xo, S as go, c as vo, ad as In, p as Go, ae as qo, af as Jo, ag as Qo, ah as Oo, b as bo, ai as Mo, e as _o, K as jo, U as es, W as ts, X as ns, T as $n, o as Qn, Y as os, Z as ko, O as ss } from "./theme-B_wdNv2N.js";
import { T as zt, O as So } from "./Text-2ZjbNsXj.js";
import { e as as } from "./styles-uKUt2GN_.js";
function is(e, i, y) {
  ...
  const x = () => {
    ...
    b.addEventListener("mousedown", (G) => {
      ...
      pe = me.left, S = me.top, h.style.left = `${pe}px`, h.style.top = `${S}px`;
    }), window.addEventListener("mousemove", (G) => {
      if (!H) return;
      const me = G.clientX - se, ye = G.clientY - ae, _e = Math.max(0, Math.min(window.innerWidth - 40, pe + me)), K = Math.max(0, Math.min(window.innerHeight - 40, S + ye));
...
function rs(e, i, y) {
  const h = pn(), u = new Xn(new he(), new Yn({ color: h.nodePoint }));
  return Vo((k, v) => {
...
function On(e, i) {
  ...
  const _ = new jt(y.grid), P = new jt(y.grid).multiplyScalar(0.45), b = (se, ae, pe, S) => {
    ...
    const S = se === "xy" ? (D, X) => [D, X, 0] : se === "xz" ? (D, X) => [D, 0, X] : (D, X) => [0, D, X], G = [[-x, -x], [x, -x], [x, x], [-x, x]], me = [];
    for (const [D, X] of G) me.push(...S(D, X));
    const ye = new he();
    ye.setAttribute("position", new It(me, 3));
    const _e = new mt({ color: ae, transparent: true, opacity: pe, depthWrite: false }), K = new To(ye, _e);
...
function cs(e, i, y, h) {
  ...
  return I.derive(() => {
    ...
    (_b = (_a = e.nodeInputs) == null ? void 0 : _a.val.supports) == null ? void 0 : _b.forEach((ae, pe) => {
      ...
      let _e;
      me >= 3 && ye >= 3 ? _e = new tt(k, x) : me >= 3 && ye === 0 ? _e = new tt(v, w) : _e = new tt(v, _), _e.position.set(S[0], S[1], S[2]);
      const K = se * H();
...
function oo(e, i) {
  ...
  return w === 1 && (P = new qn().fromArray([[0, 0, 1], [0, 1, 0], [-1, 0, 0]].flat())), w === -1 && (P = new qn().fromArray([[0, 0, -1], [0, 1, 0], [1, 0, 0]].flat())), new Lo().setFromMatrix3(P);
}
function to(e, i) {
...
function ms(e, i, y, h) {
  const u = new lt(), k = new he(), v = new mt({ vertexColors: true }), x = [0, 0, 0], w = [1, 0, 0], _ = [0, 1, 0], P = [0, 0, 1];
...
function ys(e, i, y, h) {
  ...
  const G = new rt({ color: 52479, transparent: true, opacity: 0.35, side: Yt, depthWrite: false }), me = new mt({ color: 52479 }), ye = new rt({ color: 16750848, transparent: true, opacity: 0.4, side: Yt, depthWrite: false }), _e = new mt({ color: 16750848 });
  function K(D, X) {
...
class Po extends lt {
  constructor(i, y, h, u, k, v, x) {
    ...
    if (this.text = new zt(`${k[0].toFixed(2)}`), this.text2 = new zt(`${(k[1] * -1).toFixed(2)}`), this.normalizedResult = v, this.textPosition = to(i, y), this.text2Position = to(y, i), this.text.position.set(...this.textPosition), this.text2.position.set(...this.text2Position), this.text.rotation.setFromRotationMatrix(u), this.text2.rotation.setFromRotationMatrix(u), this.add(this.text, this.text2), _) {
      const P = new Dn().moveTo(0, 0).lineTo(0, v[0]).lineTo(w, 0).lineTo(0, 0), b = new Dn().moveTo(w, 0).lineTo(h, -v[1]).lineTo(h, 0).lineTo(w, 0), H = P.getPoints(), se = b.getPoints(), ae = new he().setFromPoints(H), pe = new he().setFromPoints(se), S = new mt({ color: pn().resultOutline });
      ...
      const G = new Nn(P), me = new Nn(b), ye = new rt({ color: v[0] > 0 ? 24435 : 11411474, side: Yt }), _e = new rt({ color: -v[1] > 0 ? 24435 : 11411474, side: Yt });
      this.mesh = new tt(G, ye), this.mesh2 = new tt(me, _e), this.mesh.position.set(...i), this.mesh2.position.set(...i), this.mesh.rotation.setFromRotationMatrix(u), this.mesh2.rotation.setFromRotationMatrix(u), x && this.mesh.rotateX(Math.PI / 2), x && this.mesh2.rotateX(Math.PI / 2), this.add(this.mesh, this.mesh2);
    } else {
...
function xs(e, i, y, h) {
  ...
  return I.derive(() => {
    ...
    (_b = (_a = e.analyzeOutputs) == null ? void 0 : _a.rawVal[w]) == null ? void 0 : _b.forEach((_, P) => {
      var _a2, _b2;
      const b = ((_a2 = e.elements) == null ? void 0 : _a2.rawVal[P]) ?? [0, 1], H = y.rawVal[b[0]], se = y.rawVal[b[1]], ae = new m(...se).distanceTo(new m(...H)), pe = gs((_b2 = e.analyzeOutputs) == null ? void 0 : _b2.rawVal[w]), S = _ == null ? void 0 : _.map((_e) => _e / (pe === 0 ? 1 : pe)), G = oo(H, se), me = new x[w](H, se, ae, G, _ ?? [0, 0], S ?? [0, 0], !!["normals", "shearsZ", "torsions", "bendingsY"].includes(w)), ye = v();
...
function Ms({ drawingObj: e, gridObj: i, scene: y, getActiveCamera: h, controls: u, gridSize: k, derivedDisplayScale: v, rendererElm: x, viewerRender: w }) {
  ...
  const ne = new Lt(new he().setFromPoints([new m(0, 0, 0), new m(0, 0, 0)]), new Pn({ color: 2282478, dashSize: 0.2, gapSize: 0.1, transparent: true, opacity: 0.85, linewidth: 2 }));
  ne.frustumCulled = false, ne.visible = false, y.add(ne);
  const ee = new Lt(new he(), new mt({ color: 2282478, transparent: true, opacity: 0.9 }));
  ee.frustumCulled = false, ee.visible = false, y.add(ee);
  let le = [];
  const re = new lt(), Fe = new tt(new rn(1, 1), new rt({ color: 2282478, transparent: true, opacity: 0.08, side: Yt, depthWrite: false })), de = new tn(new yo(new rn(1, 1)), new mt({ color: 2282478, transparent: true, opacity: 0.85 })), ce = new tn(new he(), new mt({ color: 2282478, transparent: true, opacity: 0.3 })), Ye = (n, o) => {
    const a = [], t = Math.ceil(n / o);
    for (let r = -t; r <= t; r++) {
      const s = r * o;
      a.push(-n, s, 0, n, s, 0), a.push(s, -n, 0, s, n, 0);
    }
    ce.geometry.dispose(), ce.geometry = new he(), ce.geometry.setAttribute("position", new It(a, 3));
  };
  ...
  const kt = (n) => {
    ...
    return new Lt(o, a);
  }, N = kt(16711680), ie = kt(65280), fe = kt(35071);
  Le.add(N, ie, fe);
  const we = (n) => {
    const o = new he().setFromPoints([new m(0, 0, 0), new m(0, 0, 0), new m(0, 0, 0), new m(0, 0, 0)]), a = new mt({ color: n, transparent: true, opacity: 0.2, depthTest: false }), t = new To(o, a);
  ...
  const ke = new Lt(new he().setFromPoints([new m(0, 0, 0), new m(0, 0, 0)]), new mt({ color: 16724804, transparent: true, opacity: 0.95, linewidth: 4, depthTest: false }));
  ke.renderOrder = 998, ke.frustumCulled = false, ke.visible = false, y.add(ke);
  let wt = -1, ft = -1, De = -1;
  const ze = /* @__PURE__ */ new Set();
  window.__hekatanSelection = ze;
  const Se = new Lt(new he().setFromPoints([new m(), new m()]), new mt({ color: 16766720, transparent: true, opacity: 0.95, depthTest: false }));
  ...
  const Be = (n, o, a, t) => {
    ...
    for (const l of ze) {
      ...
      if (p === "pt") {
        ...
        if (!M || !c) continue;
        const f = new he().setFromPoints([new m(M[0], M[1], M[2]), new m(c[0], c[1], c[2])]), C = new Lt(f, new mt({ color: Jt, transparent: true, opacity: 0.95, depthTest: false }));
        ...
        const c = new he().setFromPoints(M), f = new Lt(c, new mt({ color: Jt, transparent: true, opacity: 0.95, depthTest: false }));
        f.renderOrder = 999, Ue.add(f);
      } else if (p === "aux") {
        const g = t[+d[0]];
        if (!g || g.length !== 6) continue;
        const M = new he().setFromPoints([new m(g[0], g[1], g[2]), new m(g[3], g[4], g[5])]), c = new Lt(M, new mt({ color: Jt, transparent: true, opacity: 0.95, depthTest: false }));
        c.renderOrder = 999, Ue.add(c);
      }
    }
  ...
  me.geometry.setAttribute("position", new It(e.points.rawVal.flat(), 3)), me.geometry.computeBoundingSphere(), me.frustumCulled = false, ye.frustumCulled = false, y.add(ye), H.position.set(0, 0, 0), H.rotateX(Math.PI / 2), H.geometry.rotateX(Math.PI / 2), H.updateMatrixWorld(), e.polylines && (e.polylines.val = [...e.polylines.rawVal, []]), window.__hekatanDrawAt = (n, o, a) => {
  ...
  nt.visible = false, y.add(nt), window.__hekatanShowAxes = (n, o, a = 12, t = 2) => {
    ...
    n.forEach((M, c) => {
      const f = c < d.length ? d[c] : `X${c}`, C = new he().setFromPoints([new m(M, r, 0), new m(M, s, 0), new m(M, r, 0), new m(M, r, a)]), L = new Pn({ color: 6333946, dashSize: 0.3, gapSize: 0.15, transparent: true, opacity: 0.6 }), R = new tn(C, L);
      R.computeLineDistances(), nt.add(R), nt.add(g(f, M, r - 0.5, 0, "#60a5fa")), nt.add(g(f, M, s + 0.5, 0, "#60a5fa"));
    }), o.forEach((M, c) => {
      const f = `${c + 1}`, C = new he().setFromPoints([new m(l, M, 0), new m(p, M, 0), new m(l, M, 0), new m(l, M, a)]), L = new Pn({ color: 16478597, dashSize: 0.3, gapSize: 0.15, transparent: true, opacity: 0.6 }), R = new tn(C, L);
  ...
  window.__hekatanShowRefPlanes = (n = [0, 3, 6, 9, 12], o = 20, a = 0, t = 0) => {
    ...
    n.forEach((s, l) => {
      const p = r[l % r.length], d = o / 2, g = [new m(a - d, t - d, s), new m(a + d, t - d, s), new m(a + d, t + d, s), new m(a - d, t + d, s), new m(a - d, t - d, s)], M = new he().setFromPoints(g), c = new mt({ color: p, transparent: true, opacity: 0.55 });
      ot.add(new Lt(M, c));
  ...
  const en = () => {
    ...
    for (const a of o) {
      ...
      const t = new he().setFromPoints([new m(a[0], a[1], a[2]), new m(a[3], a[4], a[5])]), r = new Pn({ color: 2282478, dashSize: 0.3, gapSize: 0.15, transparent: true, opacity: 0.8 }), s = new Lt(t, r);
  ...
  window.__hekatanUpdateSelectionPtScale = Vn, u.addEventListener("change", () => {
    ...
    if (a.length) {
      ...
      if (d.length > 0 && g[d[d.length - 1]]) {
        ...
        un(xe), xe && ($t.style.left = n.clientX + "px", $t.style.top = n.clientY + "px"), N.geometry.setFromPoints([new m(c[0] - j, c[1], c[2]), new m(c[0] + j, c[1], c[2])]), (_o2 = N.computeLineDistances) == null ? void 0 : _o2.call(N), ie.geometry.setFromPoints([new m(c[0], c[1] - j, c[2]), new m(c[0], c[1] + j, c[2])]), (_p = ie.computeLineDistances) == null ? void 0 : _p.call(ie), fe.geometry.setFromPoints([new m(c[0], c[1], c[2] - j), new m(c[0], c[1], c[2] + j)]), (_q = fe.computeLineDistances) == null ? void 0 : _q.call(fe), Le.visible = true;
        const ge = N.material, St = ie.material, Re = fe.material;
    ...
    me.geometry.setAttribute("position", new It(e.points.val.flat(), 3)), me.geometry.computeBoundingSphere();
  }), I.derive(() => {
  ...
  const _t = (n, o, a, t) => {
    ...
    st = new Eo({ container: Xt, title: M });
    {
...
function Cs(e, i, y) {
  ...
  const h = Ss(), u = new qo({ uniforms: { cmap: { value: h }, ambient: { value: 0.95 } }, vertexShader: `
    ...
    `, side: Yt, transparent: false, clipping: true, depthWrite: true, depthTest: true }), k = new tt(new he(), u);
  ...
  return I.derive(() => {
    ...
    for (const { idx: z, vals: B } of ae) {
      ...
      for (let ce = 0; ce < Fe; ce++) {
        const Ye = ce / eo, Le = J[0] + F.x * ne * Ye, kt = J[1] + F.y * ne * Ye, N = J[2] + F.z * ne * Ye, ie = B[0] + (B[1] - B[0]) * Ye, fe = k.getColor(ie) ?? new jt(0, 0, 0);
      ...
      for (let ce = 0; ce < eo; ce++) for (let Ye = 0; Ye < de; Ye++) {
        const Le = (Ye + 1) % de, kt = T + ce * de + Ye, N = T + ce * de + Le, ie = T + (ce + 1) * de + Ye, fe = T + (ce + 1) * de + Le;
        X.push(kt, N, fe), X.push(kt, fe, ie);
      }
      T += Fe * de;
    }
...
function Ys(e) {
  ...
  const k = new he(), v = new mt({ color: zo, linewidth: 4, transparent: true, opacity: 0.9, depthTest: false }), x = new tn(k, v);
  ...
  const P = new he(), b = new rt({ color: Bs, transparent: true, opacity: 0.45, side: Yt, depthTest: false }), H = new tt(P, b);
  H.visible = false, H.renderOrder = 100, i.add(H);
  const se = new he(), ae = new mt({ color: Xs, linewidth: 3, transparent: true, opacity: 0.95, depthTest: false }), pe = new tn(se, ae);
  ...
  const me = new rt({ color: Bn, transparent: true, opacity: 0.85, depthTest: false }), ye = new tt(new _o(1, 1, 1, 12), me);
  ye.visible = false, ye.renderOrder = 101, i.add(ye);
  const _e = new he(), K = new rt({ color: Bn, transparent: true, opacity: 0.55, side: Yt, depthTest: false }), D = new tt(_e, K);
  D.visible = false, D.renderOrder = 101, i.add(D);
  const X = new he(), T = new mt({ color: Bn, linewidth: 4, transparent: true, opacity: 1, depthTest: false }), A = new tn(X, T);
...
Mz \u2248 ${yt(mn * ct)} ${Se.forceUnit}\xB7m`);
  ...
  function $e(U) {
    Le.innerHTML = "";
    const q = U === "frame" ? kt : U === "node" ? N : U === "shell" ? ie : fe, Pe = document.createElement("div");
...
function ea({ mesh: e, settingsObj: i, drawingObj: y, objects3D: h, solids: u }) {
  ...
  b.enableDamping = true, b.dampingFactor = 0.1, b.screenSpacePanning = true, b.zoomSpeed = 0.8, b.panSpeed = 1.2, b.rotateSpeed = 0.9, b.keyPanSpeed = 12, b.listenToKeyEvents(window), b.touches = { ONE: $n.ROTATE, TWO: $n.DOLLY_PAN }, P.domElement.addEventListener("wheel", (N) => {
    if (!N.ctrlKey && Math.abs(N.deltaX) > Math.abs(N.deltaY) * 1.5) {
      ...
      const He = fe.length() * 1e-3 * b.panSpeed;
  ...
  const S = ls(i), G = I.derive(() => S.displayScale.val === 0 ? 1 : S.displayScale.val > 0 ? S.displayScale.val : -1 / S.displayScale.val), me = Us(e, S), ye = () => {
    const N = [];
  ...
  function re(N, ie) {
    J = N, ie && (W = ie);
    const fe = k.clientWidth || 1, we = k.clientHeight || 1, He = (N ? fe / 2 : fe) / we;
  ...
  if (e) {
    v.add(rs(S, me, G), as(e, S, me), ps(S, me, G), us(e, S, me, G), cs(e, S, me, G), ds(e, S, me, G), ms(e, S, me, G), ys(e, S, me, G), bs(e, S, me, G), xs(e, S, me, G));
    const N = Ys({ scene: v, rendererElm: P.domElement, getActiveCamera: () => _, derivedNodes: me, derivedDisplayScale: G, mesh: e, settings: S, render: ee });
    v.add(N);
    const ie = Js(e, S), fe = Ps(e, S, me, ie), we = Fo(ie);
    ...
    Oe.id = "frame-legend", k.appendChild(Oe), I.derive(() => {
      ...
      we.hidden = !xt, fe.visible = xt, Oe.hidden = !Ft;
    });
  }
  if (u) {
  ...
  y && Ms({ drawingObj: y, gridObj: K, scene: v, getActiveCamera: () => _, controls: b, gridSize: T, derivedDisplayScale: G, rendererElm: P.domElement, viewerRender: ee }), Vo((N, ie) => {
    var _a;
  ...
  const ce = (N, ie, fe) => {
    ...
    const fe = b.target, we = new m().subVectors(_.position, fe), $e = we.length(), He = new m(), Oe = new m();
    He.crossVectors(_.up, we).normalize(), Oe.copy(_.up).normalize();
    const at = $e * 0.05;
    fe.addScaledVector(He, -N * at), fe.addScaledVector(Oe, ie * at), _.position.addScaledVector(He, -N * at), _.position.addScaledVector(Oe, ie * at), b.update(), ee();
  }, Le = (N) => {
