...
import { _ as Dn } from "./preload-helper-V2P8TQsQ.js";
let On;
let __tla = (async () => {
  On = async function(we = {}) {
    ...
    if (z) {
      const { createRequire: e } = await Dn(() => import("./__vite-browser-external-D7Ct-6yo.js").then((r) => r._), []);
    ...
    var Pe;
    function br() {
      return d.locateFile ? pr("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-DZ-RJ6M6.wasm", import.meta.url).href;
    }
    function Tr(e) {
...
`));
    ...
    function nn(e, r, t, n, o, a, s, c, l, f, m, v, _, h) {
      var S = E();
      try {
