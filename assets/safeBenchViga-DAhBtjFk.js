import { g as A, E as G, h as J, L as R } from "./theme-Buj43zQ_.js";
import { a as me } from "./analyze-DoaxThCI.js";
import { d as ue, __tla as __tla_0 } from "./didacticCpp-CCShk1kX.js";
let we;
let __tla = Promise.all([
  ...
  function fe(n, o, i, r, f, l, a = 9127187) {
    const g = Math.abs(o - n), d = new A(g, f, l), b = new G(d), x = new J(b, new R({
      color: a,
      linewidth: 2
    }));
  ...
  we = {
    ...
    build(n, o) {
      const i = n.Lz, r = n.Bz, f = n.t_zap, l = n.b_viga, a = n.h_viga, g = n.h_ped, d = n.b_ped, b = n.ks_tonfm3 * ne, x = n.P_tonf * ne, X = Math.round(n.nCols), z = Math.round(n.nx), M = Math.round(n.ny), p = z + 1, k = M + 1, E = i / z, N = r / M, D = r / 2, q = Math.round(M / 2), y = [];
      for (let e = 1; e <= X; ++e) {
        const t = e * i / (X + 1);
        y.push([
          t,
      ...
      for (let e = 0; e < k; ++e) for (let t = 0; t < p; ++t) {
        const s = t === 0 || t === p - 1, c = e === 0 || e === k - 1, u = s && c ? 0.25 : s || c ? 0.5 : 1, _ = E * N * u, v = e * p + t;
        if (I.push({
          node: v,
          dof: 2,
          k: b * _
