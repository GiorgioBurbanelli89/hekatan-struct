...
import { m as O, d as V, __tla as __tla_0 } from "./didacticCpp-BaiPjJ4y.js";
let G;
let __tla = Promise.all([
  ...
  G = {
    ...
    build(e, o) {
      var _a, _b;
      const a = e.b * e.h, i = e.b * e.h ** 3 / 12, r = e.h * e.b ** 3 / 12, n = 5 / 6 * a, m = e.b * e.h ** 3 / 12 * 0.3, s = e.E / (2 * (1 + _)), c = e.gamma * a, l = Math.max(2, Math.round(e.nElem)), u = e.L / l, h = [];
      for (let t = 0; t <= l; t++) h.push([
        u * t,
        0,
        0
      ]);
      ...
      const p = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), g = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), $ = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map();
      for (let t = 0; t < d.length; t++) p.set(t, e.E), v.set(t, s), g.set(t, a), w.set(t, i), M.set(t, r), E.set(t, m), F.set(t, n), $.set(t, D), L.set(t, _);
      o.nodes.val = h, o.elements.val = d, o.nodeInputs.val = {
        supports: C,
        loads: b
      }, o.elementInputs.val = {
        elasticities: p,
      ...
      const x = V(h, d, o.nodeInputs.val, o.elementInputs.val);
      o.deformOutputs.val = x, o.analyzeOutputs.val = B(h, d, o.elementInputs.val, x), o.objects3D.val = [];
      const I = c * e.L ** 4 / (8 * e.E * i), z = c * e.L ** 2 / (2 * s * n), f = I + z, k = ((_b = (_a = x.deformations) == null ? void 0 : _a.get(l)) == null ? void 0 : _b[2]) ?? 0, A = Math.abs(f) > 1e-15 ? (Math.abs(k) - f) / f * 100 : 0;
  ...
  w_tip Timoshenko total = ${(f * 1e3).toFixed(5)} mm  (ETABS validado 0.000%)
  w_tip hekatan-fem      = ${(k * 1e3).toFixed(5)} mm  (\u0394 ${A.toFixed(4)}%)`);
    },
    runModal(e, o, a) {
      var _a, _b;
