...
import { v as n, L as ta, M as pe, e as ue, d as he, P as ea, V as aa, B as oa, a as sa } from "./theme-BUyDDEHW.js";
import { a as na } from "./analyze-DQyLT4zB.js";
import { d as la, __tla as __tla_0 } from "./didacticCpp-C2di29sC.js";
import { g as ca, a as ve, b as be } from "./getViewer-B-rtxCYe.js";
import { e as ra } from "./makeDraggable-zx2br6Yh.js";
import { g as ia } from "./getParameters-CD9MeSfL.js";
import { g as da } from "./styles-tOu98xnK.js";
...
Promise.all([
  ...
  n.derive(() => {
    ...
    for (let t = 0; t <= g; t++) {
      ...
      for (let a = 0; a <= f; a++) {
        const s = -d / 2 + a * nt;
        t === 0 ? e.push(j(s, -m / 2)) : e.push(A(s, -m / 2, u + t * q));
      }
      P.push(e);
    }
    ...
    for (let t = 0; t <= g; t++) {
      ...
      for (let a = 0; a <= x; a++) {
        const s = -m / 2 + a * lt;
        t === 0 ? e.push(j(-d / 2, s)) : a === 0 ? e.push(P[t][0]) : a === x ? e.push(N[t][0]) : e.push(A(-d / 2, s, u + t * q));
      }
      z.push(e);
    }
    ...
    for (let t = 0; t <= g; t++) {
      ...
      for (let a = 0; a <= x; a++) {
        const s = -m / 2 + a * lt;
        t === 0 ? e.push(j(d / 2, s)) : a === 0 ? e.push(P[t][f]) : a === x ? e.push(N[t][f]) : e.push(A(d / 2, s, u + t * q));
      }
      k.push(e);
    }
    ...
    function C(t, e, a, s) {
      const [c, l] = t, [_, T] = e, Ct = a[0][s], zt = j(c + _ * Gt, l + T * Gt), me = a[Math.min(Se, a.length - 1)][s];
      S(Ct, zt, me, me, O);
    }
  ...
  document.body.append(ia(i), Ae, da({
