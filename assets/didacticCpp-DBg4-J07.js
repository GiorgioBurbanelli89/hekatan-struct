import { M as Ks, __tla as __tla_0 } from "./deform-Di_w7nI-.js";
...
let __tla = Promise.all([
  ...
  et = function(t, r, e, s, a) {
    ...
    c._deform($, t.length, Z, D.length, l, r.length, B, i, J.length, n, k, y.length, P.keysPtr, P.valuesPtr, P.size, _.keysPtr, _.valuesPtr, _.size, K.keysPtr, K.valuesPtr, K.size, O.keysPtr, O.valuesPtr, O.size, M.keysPtr, M.valuesPtr, M.size, f.keysPtr, f.valuesPtr, f.size, N.keysPtr, N.valuesPtr, N.size, T.keysPtr, T.valuesPtr, T.size, U.keysPtr, U.valuesPtr, U.size, Y.keysPtr, Y.valuesPtr, Y.size, L.keysPtr, L.valuesPtr, L.size, R, a ? a.length : 0, z, A, ns.length, hs, gs, v.length, xs, Hs, ps.length, _s, vs, ks.length, Ts, Ms, zs.length, Os, ds, ms.length, w, as, Ys.length, I, ls, C.length, s.etabsWallJoint === false ? 0 : 1, Ls.keysPtr, Ls.valuesPtr, Ls.size, G, X, x, ss);
