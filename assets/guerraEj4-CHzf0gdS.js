import { b as U, c as V, E as ee, L as ne } from "./theme-BEYHi-uR.js";
import { p as oe, __tla as __tla_0 } from "./didacticCpp-DDG05360.js";
let ie;
let __tla = Promise.all([
  ...
  ie = {
    ...
    build(t, a) {
      const d = t.L, s = t.B, l = t.h, i = Math.round(t.nx), M = Math.round(t.ny), c = i + 1, x = M + 1, r = d / i, m = s / M, p = (t.P_dead_c1 + t.P_live_c1) * f, Y = (t.M_dead_c1 + t.M_live_c1) * f, S = (t.P_dead_c2 + t.P_live_c2) * f, $ = (t.M_dead_c2 + t.M_live_c2) * f, k = t.ks_tm3 * f, D = 14100 * Math.sqrt(t.fc_kgcm2) * 98.0665, E = 0.2, b = [];
      ...
      for (let e = 0; e < x; ++e) for (let o = 0; o < c; ++o) {
        const n = o === 0 || o === c - 1, _ = e === 0 || e === x - 1, y = n && _ ? 0.25 : n || _ ? 0.5 : 1, G = r * m * y, g = e * c + o;
        if (v.push({
          node: g,
          dof: 0,
          k: k * G
      ...
      a.nodes.val = W, a.elements.val = u, a.nodeInputs.val = {
        supports: /* @__PURE__ */ new Map(),
        loads: /* @__PURE__ */ new Map()
      }, a.elementInputs.val = {
        elasticities: new Map(u.map((e, o) => [
          o,
          D
        ])),
        poissonsRatios: new Map(u.map((e, o) => [
          o,
          E
        ])),
        thicknesses: new Map(u.map((e, o) => [
          o,
          l
        ]))
      };
    ...
    computedLabels(t, a) {
      ...
      s === -1 / 0 && (s = 0, l = 0);
      const i = se, M = (_a = i == null ? void 0 : i.manual_libro) == null ? void 0 : _a.sigma_max_servicio_tm2, c = (_b = i == null ? void 0 : i.manual_libro) == null ? void 0 : _b.sigma_min_servicio_tm2, x = (r, m) => m === void 0 || m === 0 ? "\u2014" : `${((r - m) / m * 100).toFixed(2)} %`;
      return {
