...
let __tla = (async () => {
  Zr = async function(ue = {}) {
    ...
    var pe;
    function Qe() {
      return d.locateFile ? $e("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-DEqr1e18.wasm", import.meta.url).href;
    }
    function er(e) {
