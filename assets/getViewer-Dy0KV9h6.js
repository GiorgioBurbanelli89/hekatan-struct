import { N as de, B as N, U as ue, F as K, G as q, d as _e, L as oe, e as J, D as j, b as O, r as G, y as De, c as $e, V as I, w as ne, x as H, X as be, k as Le, a as se, f as $, h as pe, Y as he, l as He, j as Ue, Z as Ge, _ as qe, $ as ze, a0 as le, a1 as Ke, a2 as Oe, a3 as Qe, a4 as Je, a5 as je, n as Xe, a6 as Te, q as et, s as tt, t as nt, W as ot, u as st, a7 as Ee, z as ye, A as at, v as Be, O as it } from "./Text-QYN3x2IP.js";
...
function lt(e, t, r) {
  ...
  r && n.addBinding(e.solids, "val", { label: "Solids" });
  const i = n.addFolder({ title: "\u2702\uFE0F Cortes X/Y/Z", expanded: false }), c = window.__hekatanClip ?? (window.__hekatanClip = { enableX: false, enableY: false, enableZ: false, posX: 0, posY: 0, posZ: 0, invertX: false, invertY: false, invertZ: false }), l = () => {
    const d = window.__hekatanClipApply;
    typeof d == "function" && d();
  };
  return i.addBinding(c, "enableX", { label: "Cortar X" }).on("change", l), i.addBinding(c, "posX", { min: -50, max: 50, step: 0.1, label: "  pos X (m)" }).on("change", l), i.addBinding(c, "invertX", { label: "  invertir X" }).on("change", l), i.addBinding(c, "enableY", { label: "Cortar Y" }).on("change", l), i.addBinding(c, "posY", { min: -50, max: 50, step: 0.1, label: "  pos Y (m)" }).on("change", l), i.addBinding(c, "invertY", { label: "  invertir Y" }).on("change", l), i.addBinding(c, "enableZ", { label: "Cortar Z" }).on("change", l), i.addBinding(c, "posZ", { min: -50, max: 50, step: 0.1, label: "  pos Z (m)" }).on("change", l), i.addBinding(c, "invertZ", { label: "  invertir Z" }).on("change", l), o;
}
function ct(e) {
  return { gridSize: F.state((e == null ? void 0 : e.gridSize) ?? 20), displayScale: F.state((e == null ? void 0 : e.displayScale) ?? 1), nodes: F.state((e == null ? void 0 : e.nodes) ?? true), elements: F.state((e == null ? void 0 : e.elements) ?? true), edges: F.state((e == null ? void 0 : e.edges) ?? true), elemColumns: F.state((e == null ? void 0 : e.elemColumns) ?? true), elemBeams: F.state((e == null ? void 0 : e.elemBeams) ?? true), nodesIndexes: F.state((e == null ? void 0 : e.nodesIndexes) ?? false), elementsIndexes: F.state((e == null ? void 0 : e.elementsIndexes) ?? false), orientations: F.state((e == null ? void 0 : e.orientations) ?? false), sections: F.state((e == null ? void 0 : e.sections) ?? true), secColumns: F.state((e == null ? void 0 : e.secColumns) ?? true), secBeams: F.state((e == null ? void 0 : e.secBeams) ?? true), secFloor: F.state((e == null ? void 0 : e.secFloor) ?? -1), supports: F.state((e == null ? void 0 : e.supports) ?? true), loads: F.state((e == null ? void 0 : e.loads) ?? false), deformedShape: F.state((e == null ? void 0 : e.deformedShape) ?? false), nodeResults: F.state((e == null ? void 0 : e.nodeResults) ?? "none"), frameResults: F.state((e == null ? void 0 : e.frameResults) ?? "none"), shellResults: F.state((e == null ? void 0 : e.shellResults) ?? "none"), solidResults: F.state((e == null ? void 0 : e.solidResults) ?? "none"), flipAxes: F.state((e == null ? void 0 : e.flipAxes) ?? false), solids: F.state((e == null ? void 0 : e.solids) ?? true), custom3D: F.state((e == null ? void 0 : e.custom3D) ?? true), showCotas: F.state((e == null ? void 0 : e.showCotas) ?? true), deformScale: F.state((e == null ? void 0 : e.deformScale) ?? 1), deformScaleZ: F.state((e == null ? void 0 : e.deformScaleZ) ?? 1) };
}
function dt(e, t, r) {
  ...
  return me((i, c) => {
    ...
    e.nodes.rawVal && (n.material.size = i * r.rawVal);
  }), F.derive(() => {
...
function ut(e, t, r) {
  ...
  const c = new J({ vertexColors: true, transparent: true, opacity: o.shellOpacity, side: j, depthWrite: false, polygonOffset: true, polygonOffsetFactor: 1, polygonOffsetUnits: 1 }), l = new O(new N(), c);
  ...
  return F.derive(() => {
    ...
    const X = t.elemColumns.rawVal, T = t.elemBeams.rawVal, P = r.val, L = ((_a = e.elements) == null ? void 0 : _a.val) || [], h = L.filter((E) => {
    ...
    const _ = [], Z = [];
    function z(E, m, M, w) {
      const s = [m[0] - E[0], m[1] - E[1], m[2] - E[2]], u = [w[0] - E[0], w[1] - E[1], w[2] - E[2]], g = s[1] * u[2] - s[2] * u[1], p = s[2] * u[0] - s[0] * u[2], b = s[0] * u[1] - s[1] * u[0], S = Math.sqrt(g * g + p * p + b * b);
      return S < 1e-12 ? false : Math.abs(b / S) < 0.5;
    }
    for (const E of L) if (E.length === 3) {
      ...
      if (P[m] && P[M] && P[w] && P[s]) {
        ...
        for (let g = 0; g < 6; g++) Z.push(u.r, u.g, u.b);
      }
    }
    _.length > 0 ? (l.geometry.dispose(), l.geometry = new N(), l.geometry.setAttribute("position", new K(_, 3)), l.geometry.setAttribute("color", new K(Z, 3)), l.geometry.computeVertexNormals(), l.visible = true) : l.visible = false;
  }), F.derive(() => {
...
function Ie(e) {
  const t = te(), r = new De(e, 20, t.grid, t.grid);
...
function mt(e, t, r, o) {
  ...
  function i(c) {
    ...
    const l = [1 / 0, 1 / 0, 1 / 0], d = [-1 / 0, -1 / 0, -1 / 0];
    for (const x of c) for (let f = 0; f < 3; f++) l[f] = Math.min(l[f], x[f]), d[f] = Math.max(d[f], x[f]);
    return 0.08 * Math.max(d[0] - l[0], d[1] - l[1], d[2] - l[2], 0.1);
  }
  return F.derive(() => {
    var _a, _b, _c;
    ...
    (_c = (_b = (_a = e.nodeInputs) == null ? void 0 : _a.val) == null ? void 0 : _b.loads) == null ? void 0 : _c.forEach((d, v) => {
      ...
      f.normalize();
      const X = new ne(f, new I(...x), 1, 15637248, 0.3, 0.3), T = l * o.rawVal;
      X.scale.set(T, T, T), n.add(X);
    });
  }), F.derive(() => {
    if (o.val, !t.loads.rawVal) return;
    const l = i(r.rawVal) * o.rawVal;
    n.children.forEach((d) => d.scale.set(l, l, l));
  }), F.derive(() => {
...
function ft(e, t, r) {
  ...
  return F.derive(() => {
    ...
    t.val.forEach((i, c) => {
      const l = new H(`${c}`);
      l.position.set(...i), l.updateScale(n * r.rawVal), o.add(l);
    });
  }), F.derive(() => {
    if (r.val, !e.nodesIndexes.rawVal) return;
    const n = 0.05 * e.gridSize.val * 0.6;
    o.children.forEach((i) => i.updateScale(n * r.rawVal));
  }), F.derive(() => {
...
function wt(e, t, r, o) {
  ...
  return F.derive(() => {
    ...
    (_a = e.elements) == null ? void 0 : _a.val.forEach((c, l) => {
      const d = new H(`${l}`, void 0, "#001219");
      d.position.set(...vt(c.map((v) => r.rawVal[v]))), d.updateScale(i * o.rawVal), n.add(d);
    });
  }), F.derive(() => {
...
function xt(e, t) {
  const r = new q(), o = 0.05 * e * 1, n = te(), i = new H("X", "red", "transparent"), c = new H(t ? "Z" : "Y", "green", "transparent"), l = new H(t ? "Y" : "Z", "blue", "transparent"), d = new ne(new I(1, 0, 0), new I(0, 0, 0), 1, n.axisArrow, 0.2, 0.2), v = new ne(new I(0, 1, 0), new I(0, 0, 0), 1, n.axisArrow, 0.2, 0.2), x = new ne(new I(0, 0, 1), new I(0, 0, 0), 1, n.axisArrow, 0.2, 0.2);
  return i.position.set(1.3 * o, 0, 0), c.position.set(0, 1.3 * o, 0), l.position.set(0, 0, 1.3 * o), i.updateScale(0.4 * o), c.updateScale(0.4 * o), l.updateScale(0.4 * o), d.scale.set(o, o, o), v.scale.set(o, o, o), x.scale.set(o, o, o), r.add(d, v, x, i, c, l), r;
}
function Ve(e, t) {
  const r = new I(...e), n = new I(...t).clone().sub(r), i = n.length(), c = n.dot(new I(1, 0, 0)) / i, l = n.dot(new I(0, 1, 0)) / i, d = n.dot(new I(0, 0, 1)) / i, v = Math.sqrt(c ** 2 + l ** 2);
  let x = new be().fromArray([[c, l, d], [-l / v, c / v, 0], [-c * d / v, -l * d / v, v]].flat());
  return d === 1 && (x = new be().fromArray([[0, 0, 1], [0, 1, 0], [-1, 0, 0]].flat())), d === -1 && (x = new be().fromArray([[0, 0, -1], [0, 1, 0], [1, 0, 0]].flat())), new Le().setFromMatrix3(x);
}
function Fe(e, t) {
...
function gt(e, t, r) {
  const o = ie([t, r]), n = ie([e, r]), i = ie([e, t]), c = new I(...o).sub(new I(...n)).normalize(), l = new I(...r).sub(new I(...i)).normalize(), d = c.clone().cross(l).normalize(), v = d.clone().cross(c).normalize();
  return new Le().makeBasis(c, v, d);
}
function bt(e, t, r, o) {
  const n = new q(), i = new N(), c = new oe({ vertexColors: true }), l = [0, 0, 0], d = [1, 0, 0], v = [0, 1, 0], x = [0, 0, 1];
  i.setAttribute("position", new K([...l, ...d, ...l, ...v, ...l, ...x], 3));
  ...
  return i.setAttribute("color", new K([...f, ...f, ...X, ...X, ...T, ...T], 3)), F.derive(() => {
    ...
    t.deformedShape.val, t.orientations.val && (n.clear(), (_a = e.elements) == null ? void 0 : _a.val.forEach((P) => {
      const L = new _e(i, c), h = r.rawVal[P[0]], _ = r.rawVal[P[1]];
      if (P.length === 2 && (L.position.set(...Fe(h, _)), L.rotation.setFromRotationMatrix(Ve(h, _))), P.length === 3) {
        const E = r.rawVal[P[2]];
        L.position.set(...ie([h, _, E])), L.rotation.setFromRotationMatrix(gt(h, _, E));
      }
...
function Mt(e, t, r, o) {
  const n = new q();
  function i(m, M) {
    const w = m / 2, s = M / 2, u = new Float32Array([0, -w, -s, 0, w, -s, 0, w, s, 0, -w, -s, 0, w, s, 0, -w, s]), g = new N();
    g.setAttribute("position", new $(u, 3));
    const p = new Float32Array([0, -w, -s, 0, w, -s, 0, w, s, 0, -w, s, 0, -w, -s]), b = new N();
    return b.setAttribute("position", new $(p, 3)), { fill: g, outline: b };
  }
  function c(m, M = 24) {
    const w = m / 2, s = new Float32Array(M * 9);
    for (let b = 0; b < M; b++) {
      const S = b / M * Math.PI * 2, A = (b + 1) / M * Math.PI * 2;
      s[b * 9] = 0, s[b * 9 + 1] = 0, s[b * 9 + 2] = 0, s[b * 9 + 3] = 0, s[b * 9 + 4] = w * Math.cos(S), s[b * 9 + 5] = w * Math.sin(S), s[b * 9 + 6] = 0, s[b * 9 + 7] = w * Math.cos(A), s[b * 9 + 8] = w * Math.sin(A);
    }
    const u = new N();
    u.setAttribute("position", new $(s, 3));
    const g = new Float32Array((M + 1) * 3);
    for (let b = 0; b <= M; b++) {
      const S = b / M * Math.PI * 2;
      g[b * 3] = 0, g[b * 3 + 1] = w * Math.cos(S), g[b * 3 + 2] = w * Math.sin(S);
    }
    const p = new N();
    return p.setAttribute("position", new $(g, 3)), { fill: u, outline: p };
  }
  function l(m, M, w, s) {
    const u = w ?? M * 0.08, g = s ?? m * 0.07, p = m / 2, b = M / 2, S = b - u, A = g / 2, R = [];
    function a(Y, B, k, W) {
      R.push(0, Y, B, 0, k, B, 0, k, W, 0, Y, B, 0, k, W, 0, Y, W);
    }
    a(-p, -b, p, -S), a(-A, -S, A, S), a(-p, S, p, b);
    const y = new N();
    y.setAttribute("position", new $(new Float32Array(R), 3));
    const V = new Float32Array([0, -p, -b, 0, p, -b, 0, p, -S, 0, A, -S, 0, A, S, 0, p, S, 0, p, b, 0, -p, b, 0, -p, S, 0, -A, S, 0, -A, -S, 0, -p, -S, 0, -p, -b]), C = new N();
    return C.setAttribute("position", new $(V, 3)), { fill: y, outline: C };
  }
  function d(m, M, w) {
    const s = m / 2, u = M / 2, g = s - w, p = u - w, b = [];
    function S(y, V, C, Y) {
      b.push(0, y, V, 0, C, V, 0, C, Y, 0, y, V, 0, C, Y, 0, y, Y);
    }
    S(-s, -u, s, -p), S(-s, p, s, u), S(-s, -p, -g, p), S(g, -p, s, p);
    const A = new N();
    A.setAttribute("position", new $(new Float32Array(b), 3));
    const R = new Float32Array([0, -s, -u, 0, s, -u, 0, s, -u, 0, s, u, 0, s, u, 0, -s, u, 0, -s, u, 0, -s, -u, 0, -g, -p, 0, g, -p, 0, g, -p, 0, g, p, 0, g, p, 0, -g, p, 0, -g, p, 0, -g, -p]), a = new N();
    return a.setAttribute("position", new $(R, 3)), { fill: A, outline: a };
  }
  function v(m, M, w) {
    const s = m / 2, u = M / 2, g = s - w, p = u - w, b = new N(), S = new Float32Array([0, -g, -p, 0, g, -p, 0, g, p, 0, -g, -p, 0, g, p, 0, -g, p]);
    b.setAttribute("position", new $(S, 3));
    const A = [];
    function R(C, Y, B, k) {
      A.push(0, C, Y, 0, B, Y, 0, B, k, 0, C, Y, 0, B, k, 0, C, k);
    }
    R(-s, -u, s, -p), R(-s, p, s, u), R(-s, -p, -g, p), R(g, -p, s, p);
    const a = new N();
    a.setAttribute("position", new $(new Float32Array(A), 3));
    const y = new Float32Array([0, -s, -u, 0, s, -u, 0, s, -u, 0, s, u, 0, s, u, 0, -s, u, 0, -s, u, 0, -s, -u, 0, -g, -p, 0, g, -p, 0, g, -p, 0, g, p, 0, g, p, 0, -g, p, 0, -g, p, 0, -g, -p]), V = new N();
    return V.setAttribute("position", new $(y, 3)), { concFill: b, steelFillGeom: a, outline: V };
  }
  function x(m, M, w) {
    const s = [], u = [[0, -m / 2, -M / 2], [0, -m / 2 + w, -M / 2], [0, -m / 2 + w, M / 2 - w], [0, m / 2, M / 2 - w], [0, m / 2, M / 2], [0, -m / 2, M / 2]], g = [0, 1, 2, 0, 2, 5, 2, 3, 4, 2, 4, 5];
    for (const A of g) s.push(...u[A]);
    const p = new N();
    ...
    const S = new N();
    return S.setAttribute("position", new $(new Float32Array(b), 3)), { fill: p, outline: S };
  }
  function f(m, M, w, s) {
    const u = s / 2, g = [], p = [[0, -m - u, -M / 2], [0, -w - u, -M / 2], [0, -w - u, M / 2 - w], [0, -u, M / 2 - w], [0, -u, M / 2], [0, -m - u, M / 2]], b = [[0, u, -M / 2], [0, u + w, -M / 2], [0, u + w, M / 2 - w], [0, m + u, M / 2 - w], [0, m + u, M / 2], [0, u, M / 2]], S = [0, 1, 2, 0, 2, 5, 2, 3, 4, 2, 4, 5];
    for (const y of S) g.push(...p[y]);
    for (const y of S) g.push(...b[y]);
    const A = new N();
    A.setAttribute("position", new $(new Float32Array(g), 3));
    const R = [];
    for (const y of [p, b]) for (let V = 0; V < y.length; V++) {
  ...
  function X(m, M, w, s) {
    const u = M / 2, g = m, p = [[0, -g, -u], [0, -g, -u + w], [0, -s, -u + w], [0, -s, u - w], [0, -g, u - w], [0, -g, u], [0, 0, u], [0, 0, -u]], b = [0, 1, 7, 1, 6, 7, 1, 2, 6, 2, 5, 6, 2, 3, 5, 3, 4, 5], S = [];
    for (const y of b) S.push(...p[y]);
    const A = new N();
  ...
  function T(m, M, w, s, u) {
    const g = M / 2, p = u / 2, b = [], S = [[0, -m, -g], [0, -m, -g + w], [0, -p - s, -g + w], [0, -p - s, g - w], [0, -m, g - w], [0, -m, g], [0, -p, g], [0, -p, -g]], A = S.map((C) => [C[0], -C[1], C[2]]), R = [0, 1, 7, 1, 6, 7, 1, 2, 6, 2, 5, 6, 2, 3, 5, 3, 4, 5];
    for (const C of R) b.push(...S[C]);
    for (const C of R) b.push(...A[C]);
    const a = new N();
    a.setAttribute("position", new $(new Float32Array(b), 3));
    const y = [];
  ...
  function P(m, M, w, s) {
    const u = m / 2, g = M / 2, p = s / 2, b = [[0, -p, -g], [0, p, -g], [0, p, g - w], [0, u, g - w], [0, u, g], [0, -u, g], [0, -u, g - w], [0, -p, g - w]], S = [0, 1, 7, 1, 2, 7, 6, 7, 5, 2, 3, 4, 2, 4, 5, 2, 5, 7], A = [];
    for (const V of S) A.push(...b[V]);
    const R = new N();
    R.setAttribute("position", new $(new Float32Array(A), 3));
    const a = [];
    for (let V = 0; V < b.length; V++) {
      const C = (V + 1) % b.length;
      a.push(...b[V], ...b[C]);
    }
    const y = new N();
  ...
  function L(m, M, w = 24) {
    ...
    for (let A = 0; A < w; A++) {
      ...
      g.push(0, s * y, s * V, 0, s * C, s * Y, 0, u * C, u * Y), g.push(0, s * y, s * V, 0, u * C, u * Y, 0, u * y, u * V);
    }
    const p = new N();
    p.setAttribute("position", new $(new Float32Array(g), 3));
    const b = [];
    for (let A = 0; A < w; A++) {
      const R = A / w * Math.PI * 2, a = (A + 1) / w * Math.PI * 2;
      b.push(0, s * Math.cos(R), s * Math.sin(R), 0, s * Math.cos(a), s * Math.sin(a)), b.push(0, u * Math.cos(R), u * Math.sin(R), 0, u * Math.cos(a), u * Math.sin(a));
    }
    const S = new N();
    return S.setAttribute("position", new $(new Float32Array(b), 3)), { fill: p, outline: S };
  }
  ...
  return F.derive(() => {
    ...
    if (!w || !s) return;
    const u = s.sectionShapes, g = t.secFloor.rawVal;
    w.forEach((p, b) => {
      if (p.length !== 2) return;
      const S = r.rawVal[p[0]], A = r.rawVal[p[1]];
      if (!S || !A) return;
      const R = E(S, A);
      if (R && !m || !R && !M) return;
      if (g >= 0) {
        ...
        if (Math.floor(Y / B + 0.01) !== g) return;
      }
      const a = u == null ? void 0 : u.get(b);
      if (!a) return;
...
class ce extends q {
  constructor(t, r, o, n, i, c, l) {
    super();
    const d = new pe().moveTo(0, 0).lineTo(0, c[1]).lineTo(o, c[1]).lineTo(o, 0).lineTo(0, 0), v = d.getPoints(), x = new N().setFromPoints(v);
    this.lines = new se(x, new oe({ color: te().resultOutline })), this.lines.position.set(...t), this.lines.rotation.setFromRotationMatrix(n), l && this.lines.rotateX(Math.PI / 2), this.add(this.lines);
    const f = new he(d), X = new J({ color: c[1] > 0 ? 24435 : 11411474, side: j });
    this.mesh = new O(f, X), this.mesh.position.set(...t), this.mesh.rotation.setFromRotationMatrix(n), l && this.mesh.rotateX(Math.PI / 2), this.add(this.mesh), this.text = new H(`${i[1].toFixed(4)}`), this.normalizedResult = c, this.textPosition = ie([t, r]), this.text.position.set(...this.textPosition), this.text.rotation.setFromRotationMatrix(n), this.add(this.text);
  }
  updateScale(t) {
...
class Re extends q {
  constructor(t, r, o, n, i, c, l) {
    ...
    if (this.text = new H(`${i[0].toFixed(4)}`), this.text2 = new H(`${(i[1] * -1).toFixed(4)}`), this.normalizedResult = c, this.textPosition = Fe(t, r), this.text2Position = Fe(r, t), this.text.position.set(...this.textPosition), this.text2.position.set(...this.text2Position), this.text.rotation.setFromRotationMatrix(n), this.text2.rotation.setFromRotationMatrix(n), this.add(this.text, this.text2), v) {
      ...
      this.lines = new se(P, h), this.lines2 = new se(L, h), this.lines.position.set(...t), this.lines2.position.set(...t), this.lines.rotation.setFromRotationMatrix(n), this.lines2.rotation.setFromRotationMatrix(n), l && this.lines.rotateX(Math.PI / 2), l && this.lines2.rotateX(Math.PI / 2), this.add(this.lines, this.lines2);
      const _ = new he(x), Z = new he(f), z = new J({ color: c[0] > 0 ? 24435 : 11411474, side: j }), E = new J({ color: -c[1] > 0 ? 24435 : 11411474, side: j });
      this.mesh = new O(_, z), this.mesh2 = new O(Z, E), this.mesh.position.set(...t), this.mesh2.position.set(...t), this.mesh.rotation.setFromRotationMatrix(n), this.mesh2.rotation.setFromRotationMatrix(n), l && this.mesh.rotateX(Math.PI / 2), l && this.mesh2.rotateX(Math.PI / 2), this.add(this.mesh, this.mesh2);
    } else {
      ...
      this.mesh = new O(T, P), this.mesh.position.set(...t), this.mesh.rotation.setFromRotationMatrix(n), l && this.mesh.rotateX(Math.PI / 2), this.add(this.mesh);
    }
  }
  updateScale(t) {
    var _a, _b;
...
function St(e, t, r, o) {
  ...
  return F.derive(() => {
    ...
    (_b = (_a = e.analyzeOutputs) == null ? void 0 : _a.rawVal[c]) == null ? void 0 : _b.forEach((l, d) => {
      var _a2, _b2;
      const v = ((_a2 = e.elements) == null ? void 0 : _a2.rawVal[d]) ?? [0, 1], x = r.rawVal[v[0]], f = r.rawVal[v[1]], X = new I(...f).distanceTo(new I(...x)), T = Ft((_b2 = e.analyzeOutputs) == null ? void 0 : _b2.rawVal[c]), P = l == null ? void 0 : l.map((Z) => Z / (T === 0 ? 1 : T)), L = Ve(x, f), h = new i[c](x, f, X, L, l ?? [0, 0], P ?? [0, 0], !!["normals", "shearsZ", "torsions", "bendingsY"].includes(c)), _ = 0.05 * t.gridSize.rawVal;
...
function Vt(e, t, r, o) {
  ...
  return F.derive(() => {
    ...
    (_b = (_a = e.deformOutputs) == null ? void 0 : _a.val[i]) == null ? void 0 : _b.forEach((l, d) => {
      const v = new Ct(r.rawVal[d], i, l ?? [0, 0, 0, 0, 0, 0]);
...
function At({ drawingObj: e, gridObj: t, scene: r, camera: o, controls: n, gridSize: i, derivedDisplayScale: c, rendererElm: l, viewerRender: d }) {
  ...
  r.add(P), X.geometry.setAttribute("position", new K(e.points.rawVal.flat(), 3)), X.geometry.computeBoundingSphere(), X.frustumCulled = false, T.frustumCulled = false, r.add(T), f.position.set(0.5 * i, 0.5 * i, 0), f.rotateX(Math.PI / 2), f.geometry.rotateX(Math.PI / 2), f.updateMatrixWorld(), e.polylines && (e.polylines.val = [...e.polylines.rawVal, []]), F.derive(() => {
  ...
  l.addEventListener("pointerdown", () => {
    ...
    if (m.length && M.length) {
      const w = new I(...e.points.rawVal[m[0].index]), s = new I(...M[0].point), u = w.sub(s), g = (_a = M[0].face) == null ? void 0 : _a.normal;
      g.transformDirection(f.matrixWorld), Math.abs(u.dot(g)) < 1e-4 && (E = true);
    }
    T.visible = !E;
  });
  let _ = false, Z;
  l.addEventListener("pointermove", (z) => {
    ...
    const m = v.intersectObject(X), M = v.intersectObject(f);
    if (m.length && M.length) {
      const s = new I(...e.points.rawVal[m[0].index]), u = new I(...M[0].point), g = s.sub(u), p = (_a = M[0].face) == null ? void 0 : _a.normal;
      p.transformDirection(f.matrixWorld), Math.abs(g.dot(p)) < 1e-4 && (E = true);
    }
    ...
    const m = v.intersectObject(X), M = v.intersectObject(f);
    if (m.length && M.length) {
      const u = new I(...e.points.rawVal[m[0].index]), g = new I(...M[0].point), p = u.sub(g), b = (_a = M[0].face) == null ? void 0 : _a.normal;
      b.transformDirection(f.matrixWorld), Math.abs(p.dot(b)) < 1e-4 && (E = true);
    }
    if (!E) return;
    const w = [...e.points.rawVal];
    if (w.splice(m[0].index, 1), e.points.val = w, !e.polylines) return;
    const s = e.polylines.rawVal.map((u) => u.filter((g) => g !== m[0].index)).map((u) => u.map((g) => g > m[0].index ? g - 1 : g)).filter((u) => u.length);
    s.push([]), e.polylines.val = s;
  });
}
function Pt(e, t, r) {
  const i = Math.round(14.999999999999998), c = { position: e.position.clone(), quaternion: e.quaternion.clone() }, l = setInterval(v, 1e3 / 30);
  let d = 0;
  function v() {
    d++;
    const x = d / i;
    e.position.lerpVectors(c.position, t.position, x), e.quaternion.slerpQuaternions(c.quaternion, t.quaternion, x), r && r(), d == i && clearInterval(l);
  }
}
class We {
  constructor(t, r = 32) {
  ...
  setColorMap(t, r = 32) {
    ...
    for (let c = 1; c < r; c++) {
      const l = c * o;
      for (let d = 0; d < this.map.length - 1; d++) if (l > this.map[d][0] && l <= this.map[d + 1][0]) {
        const v = this.map[d][0], x = this.map[d + 1][0];
        n.setHex(this.map[d][1], le), i.setHex(this.map[d + 1][1], le);
        const f = new G().lerpColors(n, i, (l - v) / (x - v));
        this.lut.push(f);
      }
    }
  ...
  updateCanvas(t) {
    ...
    let i = 0;
    const c = 1 / this.n, l = new G(), d = new G(), v = new G();
    for (let x = 1; x >= 0; x -= c) for (let f = this.map.length - 1; f >= 0; f--) if (x < this.map[f][0] && x >= this.map[f - 1][0]) {
      ...
      l.setHex(this.map[f - 1][1], le), d.setHex(this.map[f][1], le), v.lerpColors(l, d, (x - X) / (T - X)), n[i * 4] = Math.round(v.r * 255), n[i * 4 + 1] = Math.round(v.g * 255), n[i * 4 + 2] = Math.round(v.b * 255), n[i * 4 + 3] = 255, i += 1;
    }
...
function Yt(e) {
  ...
  for (let r = 0; r < ae.length - 1; r++) {
    const [o, n, i, c] = ae[r], [l, d, v, x] = ae[r + 1];
    if (e <= l) {
      const f = (e - o) / (l - o);
...
function zt() {
  ...
  for (let o = 0; o < 256; o++) {
    const n = o / 255, [i, c, l] = Yt(n);
    t[o * 4 + 0] = i, t[o * 4 + 1] = c, t[o * 4 + 2] = l, t[o * 4 + 3] = 255;
  }
  const r = new Je(t, 256, 1, je);
  return r.minFilter = Xe, r.magFilter = Xe, r.wrapS = Te, r.wrapT = Te, r.needsUpdate = true, r;
}
function Xt(e, t, r) {
  new We();
  ...
  return i.renderOrder = -1, i.frustumCulled = false, F.derive(() => {
    ...
    const l = r.val.filter((h) => Number.isFinite(h));
    let d, v;
    const x = Pe.val;
    if (x ? (v = x[0], d = x[1]) : (d = l.length ? Math.max(...l) : 1, v = l.length ? Math.min(...l) : 0, v >= 0 && d > 0 && (v = 0)), d === v) {
      const h = Math.max(Math.abs(d) * 1e-6, 1e-9);
      d += h, v -= h;
    }
    const f = x && x[0] > x[1], X = Math.min(v, d), T = Math.max(v, d), P = T - X, L = new Float32Array(r.val.length);
...
function Zt(e, t, r, o) {
  ...
  const c = new G(), l = F.state([]);
  return F.derive(() => {
    var _a, _b, _c;
    t.deformedShape.val;
    const d = r.val, v = ((_a = e.elements) == null ? void 0 : _a.val) ?? [], x = It(t.frameResults.val);
    if (n.children.forEach((b) => {
    ...
    for (let b = 0; b < v.length; b++) {
      if (v[b].length !== 2) continue;
      const A = Rt(x, b, f, X);
      A && (T.push(A[0], A[1]), P.push({ idx: b, vals: A }));
    }
    if (T.length === 0) {
      l.val = [];
      return;
    ...
    i.setMin(L), i.setMax(h), l.val = T;
    const _ = [1 / 0, 1 / 0, 1 / 0], Z = [-1 / 0, -1 / 0, -1 / 0];
    for (const b of d) for (let S = 0; S < 3; S++) _[S] = Math.min(_[S], b[S]), Z[S] = Math.max(Z[S], b[S]);
    const E = Math.max(Z[0] - _[0], Z[1] - _[1], Z[2] - _[2], 1) * Bt, m = [], M = [], w = [];
    let s = 0;
    for (const { idx: b, vals: S } of P) {
      const A = v[b], R = d[A[0]], a = d[A[1]];
      if (!R || !a) continue;
      ...
      for (let D = 0; D < k; D++) {
        ...
        for (let ve = 0; ve < W; ve++) {
          const Ye = ve / W * Math.PI * 2, xe = Math.cos(Ye), ge = Math.sin(Ye);
          m.push(Q + (Y.x * xe + B.x * ge) * E, ee + (Y.y * xe + B.y * ge) * E, fe + (Y.z * xe + B.z * ge) * E), M.push(c.r, c.g, c.b);
        }
      }
    ...
    const g = new J({ vertexColors: true, side: j }), p = new O(u, g);
...
function Ze(e, t = 8) {
  ...
  let i, c;
  n.forEach((d, v) => {
    i = document.createElement("div"), i.id = `marker-${v}`, i.className = "marker", i.style.marginTop = v == 0 ? "0px" : `calc(${50 / t}vh - 1px)`, c = document.createElement("p"), c.id = `marker-text-${v}`, i.append(c), r.append(i);
  });
  const l = [];
  return r.querySelectorAll("p").forEach((d) => l.push(d)), setTimeout(() => {
    F.derive(() => {
      n.forEach((d, v) => {
        const x = l[v];
...
function Kt({ mesh: e, settingsObj: t, drawingObj: r, objects3D: o, solids: n }) {
  it.DEFAULT_UP = new I(0, 0, 1);
  const i = document.createElement("div"), c = new et(), l = new tt(45, 1, 0.1, 2 * 1e6), d = new nt(-10, 10, 10, -10, -1e3, 2e6);
  let v = l;
  const x = new ot({ antialias: true });
  x.localClippingEnabled = true;
  const f = new st(l, x.domElement);
  f.enableDamping = true, f.dampingFactor = 0.1, f.screenSpacePanning = true, f.zoomSpeed = 0.8, f.panSpeed = 1.2, f.rotateSpeed = 0.9, f.keyPanSpeed = 12, f.listenToKeyEvents(window), f.touches = { ONE: Ee.ROTATE, TWO: Ee.DOLLY_PAN }, x.domElement.addEventListener("wheel", (a) => {
    if (!a.ctrlKey && Math.abs(a.deltaX) > Math.abs(a.deltaY) * 1.5) {
      a.preventDefault();
      const y = f.target, V = new I().subVectors(l.position, y), C = new I();
      C.crossVectors(l.up, V).normalize();
      const B = V.length() * 1e-3 * f.panSpeed;
      y.addScaledVector(C, a.deltaX * B), l.position.addScaledVector(C, a.deltaX * B), f.update();
    }
  }, { passive: false });
  ...
  l.position.set(0.5 * m, 0.8 * -M, 0.5 * m), f.target.set(0.5 * m, 0.5 * m, 0), f.minDistance = 1, f.maxDistance = M * 2.5, i.__settings = h, f.zoomSpeed = 1, f._getZoomScale = function() {
    ...
    for (const y of a) {
      ...
      if (V === 0 || C === 0) continue;
      l.aspect = V / C, l.updateProjectionMatrix();
      const Y = V / C, B = d.top;
  ...
  if (e) {
    c.add(dt(h, Z, _), ut(e, h, Z), ft(h, Z, _), wt(e, h, Z, _), ht(e, h, Z, _), mt(e, h, Z, _), bt(e, h, Z, _), Mt(e, h, Z, _), Vt(e, h, Z, _), St(e, h, Z, _));
  ...
  r && At({ drawingObj: r, gridObj: z, scene: c, camera: l, controls: f, gridSize: m, derivedDisplayScale: _, rendererElm: x.domElement, viewerRender: s }), me((a, y) => {
  ...
  const g = { scene: c, perspCamera: l, orthoCamera: d, get camera() {
    return v;
  ...
  return p.append(R()), p.append(b("\u2191", "Pan arriba", () => S(0, 1))), p.append(b("\u2295", "Zoom in", () => A(0.85))), p.append(b("\u2190", "Pan izquierda", () => S(-1, 0))), p.append(b("\u2302", "Reset vista", () => {
    f.reset(), s();
  })), p.append(b("\u2192", "Pan derecha", () => S(1, 0))), p.append(b("\u2296", "Zoom out", () => A(1.18))), p.append(b("\u2193", "Pan abajo", () => S(0, -1))), p.append(R()), getComputedStyle(i).position === "static" && (i.style.position = "relative"), i.appendChild(p), i;
}
function _t(e, t) {
  return F.derive(() => {
    var _a, _b, _c, _d;
    ...
    const n = t.deformScale.val, i = t.deformScale.val * t.deformScaleZ.val, c = Number.isFinite(n) ? n : 1, l = Number.isFinite(i) ? i : 1;
    return r.map((d, v) => {
      var _a2;
      ...
      return [d[0] + f * c, d[1] + X * c, d[2] + T * l];
    });
  });
}
...
function Ht(e, t) {
  ...
  return ((n) => {
    ...
    const n = /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Map(), c = /* @__PURE__ */ new Map(), l = /* @__PURE__ */ new Map(), d = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map(), X = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Map(), P = (k, W) => {
      k == null ? void 0 : k.forEach((D, U) => {
        const Q = e.elements.val[U];
        if (Q) for (let ee = 0; ee < Q.length; ee++) W.set(Q[ee], [D[ee] ?? D[0]]);
      });
    };
    P((_b = (_a = e.analyzeOutputs) == null ? void 0 : _a.val) == null ? void 0 : _b.bendingXX, n), P((_d = (_c = e.analyzeOutputs) == null ? void 0 : _c.val) == null ? void 0 : _d.bendingYY, i), P((_f = (_e2 = e.analyzeOutputs) == null ? void 0 : _e2.val) == null ? void 0 : _f.bendingXY, c), P((_h = (_g = e.analyzeOutputs) == null ? void 0 : _g.val) == null ? void 0 : _h.membraneXX, l), P((_j = (_i = e.analyzeOutputs) == null ? void 0 : _i.val) == null ? void 0 : _j.membraneYY, d), P((_l = (_k = e.analyzeOutputs) == null ? void 0 : _k.val) == null ? void 0 : _l.membraneXY, v), P((_n = (_m = e.analyzeOutputs) == null ? void 0 : _m.val) == null ? void 0 : _n.tranverseShearX, x), P((_p = (_o = e.analyzeOutputs) == null ? void 0 : _o.val) == null ? void 0 : _p.tranverseShearY, f), P((_r = (_q = e.analyzeOutputs) == null ? void 0 : _q.val) == null ? void 0 : _r.vonMises, X), P((_t2 = (_s = e.analyzeOutputs) == null ? void 0 : _s.val) == null ? void 0 : _t2.pressure, T);
    const L = (_v = (_u = e.analyzeOutputs) == null ? void 0 : _u.val) == null ? void 0 : _v.colorMapRanges, h = (_w = t.solidResults) == null ? void 0 : _w.val, Z = h && h !== "none" ? h : t.shellResults.val, z = L == null ? void 0 : L[Z], E = { bendingXX: [n, 0], bendingYY: [i, 0], bendingXY: [c, 0], membraneXX: [l, 0], membraneYY: [d, 0], membraneXY: [v, 0], tranverseShearX: [x, 0], tranverseShearY: [f, 0], vonMises: [X, 0], pressure: [T, 0], displacementX: [(_y = (_x = e.deformOutputs) == null ? void 0 : _x.val) == null ? void 0 : _y.deformations, 0], displacementY: [(_A = (_z = e.deformOutputs) == null ? void 0 : _z.val) == null ? void 0 : _A.deformations, 1], displacementZ: [(_C = (_B = e.deformOutputs) == null ? void 0 : _B.val) == null ? void 0 : _C.deformations, 2] }, m = t.shellResults.val, M = Lt.val, w = Nt.val, s = m === "displacementX" || m === "displacementY" || m === "displacementZ", u = m === "bendingXX" || m === "bendingYY" || m === "bendingXY", g = m === "membraneXX" || m === "membraneYY" || m === "membraneXY", p = m === "vonMises" || m === "pressure", b = m === "tranverseShearX" || m === "tranverseShearY", S = (_D = t.solidResults) == null ? void 0 : _D.val, A = S === "vonMises" || S === "sigmaXX" || S === "sigmaYY" || S === "sigmaZZ" || S === "tauXY" || S === "tauYZ" || S === "tauXZ", R = S === "ux" || S === "uy" || S === "uz", a = Wt.val, y = A ? $t[a] : R || s ? ke[w] : u || g || p || b ? 1 / Dt[M] : 1, V = A ? a : R || s ? w : u ? `${M}\xB7m/m` : g ? `${M}/m\xB2` : p ? `${M}/m\xB2` : b ? `${M}/m` : "";
