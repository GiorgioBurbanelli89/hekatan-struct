const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/calcPanel-D_XtdB1x.js","assets/getMesh-CMOA6JCi.js","assets/__vite-browser-external-D7Ct-6yo.js","assets/pureFunctionsAny.generated-DeJSBP3k.js","assets/analyze-DNPn2SjO.js","assets/didacticCpp-9kTtzmo8.js","assets/deform-Brz07dfy.js","assets/preload-helper-DrUBW0xl.js","assets/cyclicPushoverCpp-BxUnsCfo.js"])))=>i.map(i=>d[i]);
...
import { d as pt, p as os, m as ul, s as fl, __tla as __tla_0 } from "./didacticCpp-9kTtzmo8.js";
...
`);
      ...
      y && (y.value = B, y.addEventListener("change", (h) => {
        ...
        h.stopPropagation(), sa(async () => {
          const { openCalcPanel: S } = await import("./calcPanel-D_XtdB1x.js").then(async (m2) => {
            await m2.__tla;
            return m2;
          });
          return {
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        try {
          const { cyclicPushover: b } = await sa(async () => {
            const { cyclicPushover: k } = await import("./cyclicPushoverCpp-BxUnsCfo.js");
            return {
              cyclicPushover: k
            };
