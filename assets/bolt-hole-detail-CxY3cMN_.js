...
import { v as a, L as et, V as B, a as E, B as G } from "./Text-CSfbf1xJ.js";
import { a as xt } from "./analyze-BydHtRcI.js";
import { d as It, __tla as __tla_0 } from "./didacticCpp-B5f-GyHC.js";
import { g as Bt, b as Pt } from "./styles-CXNYye6A.js";
import { g as Tt } from "./getParameters-DsthXvNv.js";
...
Promise.all([
  ...
  a.derive(() => {
    const r = i.L.value.val, pt = i.t_plate.value.val, A = i.d_hole.value.val, M = i.d_bolt.value.val, p = i.L_bolt.value.val, f = Math.round(i.nRadial.value.val), l = Math.round(i.nTheta.value.val), J = i.Pull.value.val, b = A / 2, dt = r / 2, d = [], u = [], P = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Map(), z = /* @__PURE__ */ new Map(), C = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map();
    function w(t, s, o) {
      return d.push([
        t,
        s,
