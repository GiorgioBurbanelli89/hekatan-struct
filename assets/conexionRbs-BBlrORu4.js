import { a as ft } from "./analyze-DQyLT4zB.js";
import { d as _t, __tla as __tla_0 } from "./didacticCpp-C2di29sC.js";
import { b as ut, m as bt, i as ht } from "./menegottoPinto-B-C2cxus.js";
import { s as Ke, __tla as __tla_1 } from "./secantPlasticity-DTH_OeMM.js";
import { L as O, B as D, a as L, S as Me, e as ge, d as V, V as B, b as he, c as Mt, E as gt, x as Ze, M as te, N as He } from "./theme-D5p5K0bJ.js";
...
let __tla = Promise.all([
  ...
  Et = {
    ...
    build(e, n) {
        ...
        if (t === 2) {
          const o = X[ye][0], r = xt({
            ...
            buildLoads: (Y) => {
              ...
              for (let N = 0; N <= H; N++) Z.set(X[ye][N], [
                0,
                0,
                -ee,
                0,
        ...
        if (o) {
          ...
          if (n.__componentRatios = r, n.__governingComponent = d, n.__failureMode = x, e.colormap_mode > 0.5) {
            ...
            for (let Y = 0; Y < f.length; Y++) {
              const Z = t.get(Y), ee = Z ? I.get(Z) ?? 0 : 0, N = f[Y].length, dt = new Array(N).fill(ee * e.Fy);
              A.set(Y, dt);
            }
      ...
      const G = [], Oe = E + $e, Ee = Math.min(e.bf_beam, e.d_beam) * 0.28, tt = new Me(Ee, 20, 16), ot = new te({
        color: 16720384,
        emissive: 6689024,
        metalness: 0.2,
        roughness: 0.5,
      ...
      ke.position.set(Oe, 0, 0), G.push(ke);
      const nt = new He(Ee * 1.25, 0.015, 12, 32), st = new te({
        color: 16755200,
        emissive: 4465152
      }), ve = new V(nt, st);
      ve.position.set(Oe, 0, 0), ve.rotation.y = Math.PI / 2, G.push(ve);
      ...
      G.push(Be(+e.d_beam / 2 - e.tf_beam / 2)), G.push(Be(-e.d_beam / 2 + e.tf_beam / 2));
      ...
      if (Ne.position.set(E - Q / 2, 0, 0), G.push(Ne), e.weld_access_hole > 0.5) {
        ...
        for (const o of [
          ...
          x.position.set(E + 2e-3, 0, o), x.rotation.y = Math.PI / 2, G.push(x);
        }
      }
      if (e.weld_type < 0.5) {
        ...
        for (const r of [
          ...
          d.position.set(E - 0.015, 0, r + x * e.tf_beam * 0.7), G.push(d);
        }
      }
      const Ge = (t) => {
      ...
      G.push(Ge(T)), G.push(Ge(W)), n.objects3D.val = G;
      ...
      if (Te && (clearInterval(Te), window.__rbsK3Anim = null), e.animate_k3 > 0.5) {
        ...
        setTimeout(() => {
          const I = (() => {
            ...
            for (const N of ee) if (N.__settings && N.__ctx) return N;
            return null;
          })();
          if (!I) return;
          ...
          const Z = setInterval(() => {
            var _a2;
            const N = (k[d] ?? 0) / o * r;
            A.deformScale.val = N, (x == null ? void 0 : x.hyst) && (x.hyst.moveCursor(d), x.hyst.setProgress(d)), (x == null ? void 0 : x.prot) && (x.prot.moveCursor(d), x.prot.setProgress(d)), (_a2 = Y.render) == null ? void 0 : _a2.call(Y), d = (d + 1) % k.length;
          }, t);
