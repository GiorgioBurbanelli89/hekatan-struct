...
import { i as J, j as N, g as Z, b as q } from "./styles-CXNYye6A.js";
import { g as Q } from "./getParameters-DsthXvNv.js";
import { g as W } from "./getTables-BI5U-xyf.js";
import { g as Y } from "./getDialog-BLThMiI7.js";
import { g as tt } from "./getReport-DWfPtl4T.js";
import { a as at } from "./analyze-BydHtRcI.js";
import { d as et, __tla as __tla_0 } from "./didacticCpp-B5f-GyHC.js";
import { g as st, a as lt, b as ot, c as A, d as H, __tla as __tla_1 } from "./getSolids-vmqHRshi.js";
...
`, document.head.appendChild(n), e;
  ...
  function rt(e, s, n, l, u, C) {
    ...
    const B = M.map((i) => Number((u * 1e6 * i / k).toFixed(2))), j = Math.max(...B), R = e.f_mk * C, _ = B.map((i) => Number((i / R).toFixed(2))), U = Math.max(..._);
    return {
      slabHeight: b,
      thicknesses: o,
      zCordsFromMid: M,
