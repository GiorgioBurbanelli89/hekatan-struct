...
import { v as U, P as bt } from "./theme-2eEBQPmF.js";
import { c as xt, d as wt, g as _t } from "./getViewer-B03AP59U.js";
import { g as $t } from "./styles-lf_LNy9d.js";
import { f as Lt, g as zt, V as $, h as Et, B as mt, L as ut, a as Mt, i as Tt } from "./Text-C748NMGi.js";
import { f as W, d as et, e as Pt, g as St, h as Q, i as It, s as nt, j as at, k as ot, l as it, m as Nt, n as Ft, o as Dt, p as Ot, t as Bt, q as Ct } from "./units-yggW8zr_.js";
let Rt;
let __tla = (async () => {
  ...
  function Yt(u, E) {
    ...
    const R = (p) => {
      ...
      const y = Y();
      if (!y) return -1;
      const o = y.renderer.domElement.getBoundingClientRect(), d = new Lt((p.clientX - o.left) / o.width * 2 - 1, -((p.clientY - o.top) / o.height) * 2 + 1), k = new zt();
      ...
      for (let c = 0; c < P.length; c++) {
        const t = P[c];
        if (t.length === 2) {
          const s = new $(...x[t[0]]), r = new $(...x[t[1]]), n = new Et(s, r), i = new $(), e = new $();
          g.closestPointToPoint(n.getCenter(new $()), i), n.closestPointToPoint(i, true, e);
          const a = i.distanceTo(e);
          a < D && (D = a, I = c);
        } else if (t.length === 3) {
          const s = new $(...x[t[0]]), r = new $(...x[t[1]]), n = new $(...x[t[2]]), i = new $();
          let e = g.intersectTriangle(s, r, n, false, i);
          if (e || (e = g.intersectTriangle(s, n, r, false, i)), e) {
            const a = g.origin.distanceTo(i);
            a < N && (N = a, _ = c);
          }
        } else if (t.length === 4) {
          const s = new $(...x[t[0]]), r = new $(...x[t[1]]), n = new $(...x[t[2]]), i = new $(...x[t[3]]), e = new $();
          let a = g.intersectTriangle(s, r, n, false, e);
          if (a || (a = g.intersectTriangle(s, n, r, false, e)), a) {
            const f = g.origin.distanceTo(e);
            f < N && (N = f, _ = c);
          }
          if (a = g.intersectTriangle(s, n, i, false, e), a || (a = g.intersectTriangle(s, i, n, false, e)), a) {
            const f = g.origin.distanceTo(e);
            f < N && (N = f, _ = c);
          }
        } else if (t.length === 8) {
          const s = t.map((i) => new $(...x[i])), r = new $(), n = [
            [
              0,
              1,
              2,
          ...
          for (const i of n) {
            let e = g.intersectTriangle(s[i[0]], s[i[1]], s[i[2]], false, r);
            if (e || (e = g.intersectTriangle(s[i[0]], s[i[2]], s[i[1]], false, r)), e) {
              const a = g.origin.distanceTo(r);
              a < N && (N = a, _ = c);
            }
            if (e = g.intersectTriangle(s[i[0]], s[i[2]], s[i[3]], false, r), e || (e = g.intersectTriangle(s[i[0]], s[i[3]], s[i[2]], false, r)), e) {
              const a = g.origin.distanceTo(r);
              a < N && (N = a, _ = c);
            }
          }
    ...
    `;
      if (x) {
        const m = w[o[0]], c = w[o[1]], t = Math.sqrt((c[0] - m[0]) ** 2 + (c[1] - m[1]) ** 2 + (c[2] - m[2]) ** 2), s = ((_b = d.elasticities) == null ? void 0 : _b.get(p)) || 0, r = ((_c = d.areas) == null ? void 0 : _c.get(p)) || 0, n = ((_d = d.momentsOfInertiaZ) == null ? void 0 : _d.get(p)) || 0, i = ((_e = d.momentsOfInertiaY) == null ? void 0 : _e.get(p)) || 0, e = ((_f = d.shearModuli) == null ? void 0 : _f.get(p)) || 0, a = ((_g = d.torsionalConstants) == null ? void 0 : _g.get(p)) || 0, f = (_h = d.shearAreasY) == null ? void 0 : _h.get(p), h = (_i = d.shearAreasZ) == null ? void 0 : _i.get(p), S = (_j = d.densities) == null ? void 0 : _j.get(p), T = f != null && f < 0 || h != null && h < 0, q = T ? "Bernoulli (As=\u22121)" : f != null && f > 0 || h != null && h > 0 ? "Timoshenko (As expl\xEDcito)" : "Timoshenko (5/6\xB7A default)", K = T ? 0 : (f ?? 0) > 0 ? f : 5 / 6 * r, V = T ? 0 : (h ?? 0) > 0 ? h : 5 / 6 * r, j = !T && K > 0 && e > 0 ? 12 * s * i / (e * K * t * t) : 0, Z = !T && V > 0 && e > 0 ? 12 * s * n / (e * V * t * t) : 0, rt = s * r / t, lt = e * a / t, ct = 12 * s * n / (t * t * t) / (1 + Z), vt = 6 * s * n / (t * t) / (1 + Z), dt = 4 * s * n / t * (1 + Z / 4) / (1 + Z), ht = 2 * s * n / t * (1 - Z / 2) / (1 + Z), pt = 12 * s * i / (t * t * t) / (1 + j), yt = 6 * s * i / (t * t) / (1 + j), ft = 4 * s * i / t * (1 + j / 4) / (1 + j), gt = 2 * s * i / t * (1 - j / 2) / (1 + j), kt = 2 * (rt + lt + ct + pt + ft + dt);
        _ += `
        <div class="section">
        ...
        <div class="section">
          ...
          <div class="prop-row"><span class="prop-key">A</span><span class="prop-val">${l(r)}</span></div>
          <div class="prop-row"><span class="prop-key">Iz (weak)</span><span class="prop-val">${l(n)}</span></div>
      ...
      `;
        ...
        const m = ((_k = d.elasticities) == null ? void 0 : _k.get(p)) || 0, c = ((_l = d.thicknesses) == null ? void 0 : _l.get(p)) || 0, t = ((_m = d.poissonsRatios) == null ? void 0 : _m.get(p)) || 0, r = ((_n = d.shearModuli) == null ? void 0 : _n.get(p)) || m / (2 * (1 + t)), n = 5 / 6, i = m * c ** 3 / (12 * (1 - t * t)), e = i * 1, a = i * t, f = i * (1 - t) / 2, h = n * r * c, S = m / (1 - t * t), T = S * 1, q = S * t, K = S * (1 - t) / 2, V = e + e + f, j = 2 * h, Z = T + T + K;
        _ += `
        <div class="section">
          <div class="section-title">Material</div>
          <div class="prop-row"><span class="prop-key">E</span><span class="prop-val">${l(m)}</span></div>
          <div class="prop-row"><span class="prop-key">G</span><span class="prop-val">${l(r)}</span></div>
        ...
        <div class="section">
          ...
          <div class="prop-row"><span class="prop-key">k_s (shear corr.)</span><span class="prop-val">5/6 = ${l(n, 4)}</span></div>
        </div>
    ...
    `;
      ...
      if (z && (D || P)) {
        ...
        if (m.length > 0) {
          ...
          for (const [t, s, r] of m) {
            ...
            const a = e > 0 ? i / e : NaN;
            c += `<td>${l(a, 3)}</td><td style="text-align:left">${r}</td></tr>`;
          }
          c += "</table>", _ += `
          <div class="section">
      ...
      if (x && (k == null ? void 0 : k.deformations)) {
        ...
        if (m && c) {
          const t = w[o[0]], s = w[o[1]], r = s[0] - t[0], n = s[1] - t[1], i = s[2] - t[2], e = Math.sqrt(r * r + n * n + i * i), a = [
            r / e,
            n / e,
            i / e
          ], f = [
    ...
    `, (_r = b.querySelector(".close-btn")) == null ? void 0 : _r.addEventListener("click", () => {
      ...
      if (C) {
        let m = false, c = 0, t = 0, s = 0, r = 0;
        C.addEventListener("mousedown", (n) => {
          if (n.target.classList.contains("close-btn")) return;
          m = true, c = n.clientX, t = n.clientY;
          const i = b.getBoundingClientRect();
          s = i.left, r = i.top, b.style.left = `${s}px`, b.style.top = `${r}px`, n.preventDefault();
        }), window.addEventListener("mousemove", (n) => {
          if (!m || !b) return;
          const i = n.clientX - c, e = n.clientY - t, a = Math.max(0, Math.min(window.innerWidth - 100, s + i)), f = Math.max(0, Math.min(window.innerHeight - 50, r + e));
  ...
  Rt = function(u) {
    ...
    const y = () => {
      ...
      if (p = o, B = o, setTimeout(() => {
        ...
        let s = false, r = 0, n = 0, i = 0, e = 0;
        t.addEventListener("mousedown", (a) => {
          s = true, r = a.clientX, n = a.clientY;
          const f = L.getBoundingClientRect();
          i = f.left, e = f.top, L.style.right = "auto", L.style.left = `${i}px`, L.style.top = `${e}px`, a.preventDefault();
        }), window.addEventListener("mousemove", (a) => {
          if (!s) return;
          const f = a.clientX - r, h = a.clientY - n, S = Math.max(0, Math.min(window.innerWidth - 40, i + f)), T = Math.max(0, Math.min(window.innerHeight - 40, e + h));
        ...
        t.addButton({
          ...
          try {
            ...
            }, []), n = v, i = n.ks_factor ?? 10.5, e = n.q_adm ?? 20, a = i * e * 9.80665, f = (n.useSimple ?? 1) >= 0.5, h = f ? (n.P_simple ?? 0) * 9.80665 : (n.P_D ?? 10) * 9.80665, S = f ? 0 : (n.P_L ?? 5) * 9.80665, T = f ? (n.Mx_simple ?? 0) * 9.80665 : (n.Mx_D ?? 0) * 9.80665, q = f ? (n.My_simple ?? 0) * 9.80665 : (n.My_D ?? 0) * 9.80665;
            r({
              Lz: n.Lz ?? 1.5,
              Bz: n.Bz ?? 1.5,
              tz: n.tz ?? 0.3,
...
Abrilo en SAFE: File \u2192 Import \u2192 SAFE Text File.`);
            ...
            alert(`Error: ${(r == null ? void 0 : r.message) ?? r}`);
          }
        });
        const s = async (r, n) => {
        ...
        window.__hekatanImportF2kText = s, t.addButton({
          ...
          r.type = "file", r.accept = ".f2k,.txt", r.onchange = async (n) => {
            var _a, _b, _c, _d, _e, _f, _g, _h, _i;
            const i = (_a = n.target.files) == null ? void 0 : _a[0];
            if (i) try {
...
\u2713 Los sliders del Tweakpane se actualizaron.`);
          ...
          try {
            const { exportZapataOpsPy: r } = await st(async () => {
              const { exportZapataOpsPy: S } = await import("./opsPyExporter-caFBRJ-n.js");
              return {
                exportZapataOpsPy: S
              };
            }, []), n = v, i = (n.ks_factor ?? 10.5) * (n.q_adm ?? 20) * 9.80665, e = (n.useSimple ?? 1) >= 0.5, a = r({
              Lz: n.Lz ?? 1.5,
              Bz: n.Bz ?? 1.5,
              tz: n.tz ?? 0.3,
              bc: n.bc ?? 0.4,
              ks_kNm3: i,
              P_dead_kN: e ? (n.P_simple ?? 0) * 9.80665 : (n.P_D ?? 10) * 9.80665,
              P_live_kN: e ? 0 : (n.P_L ?? 5) * 9.80665
            }), f = new Blob([
              a
            ], {
              type: "text/x-python"
...
Ejecutar: python -X utf8 <archivo>.py`);
      ...
      d.addBinding(k, "force", {
        ...
        const s = W.val, r = t.value;
        if (s !== r) {
          const n = s === "kN" ? 1 : s === "tonf" ? 9.80665 : 4.4482216, i = r === "kN" ? 1 : r === "tonf" ? 9.80665 : 4.4482216;
          for (const [e, a] of Object.entries(u.params)) (a.unitType === "force" || a.unitType === "moment") && (v[e] = v[e] * n / i);
        }
        W.val = r, y(), M();
      }), d.addBinding(k, "disp", {
      ...
      for (const [t, s] of Object.entries(u.params)) {
        const r = s.folder ?? N, n = z(r);
        if (s.boolean) {
          c[t] = v[t] >= 0.5, n.addBinding(c, t, {
            label: s.label ?? t
          }).on("change", (f) => {
        ...
        s.options !== void 0 ? a.options = s.options : (s.min !== void 0 && (a.min = s.min), s.max !== void 0 && (a.max = s.max), s.step !== void 0 && (a.step = s.step)), n.addBinding(v, t, a).on("change", () => {
      ...
      if (u.computedLabels) {
        ...
        F = F ?? {};
        for (const r of Object.keys(s)) F[r] = s[r];
        for (const r of Object.keys(s)) t.addBinding(F, r, {
          readonly: true,
          view: "text",
          interval: 0
        });
