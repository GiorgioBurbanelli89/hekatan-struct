...
import { K as X, q as Be, Z as We, c as Ye, B as be, L as Ue, e as Xe, D as Ve, d as Ke, v as ce, F as ue, a3 as xe, a4 as qe, a2 as Ge } from "./theme-DDCjfe25.js";
const Je = new X(16746496), Ze = new X(52428), ke = new X(52292), $e = new X(3377407), Se = new X(16763904);
function Te(D, e) {
...
function yt(D, e, t) {
  const i = Be(), s = new We(), l = new Ye(new be(), new Ue({ color: i.elementLine, vertexColors: false }));
  xe((u, p) => {
    l.material.color.setHex(p.elementLine);
  }), l.frustumCulled = false, l.renderOrder = 2, s.add(l);
  const r = new Xe({ vertexColors: true, transparent: true, opacity: i.shellOpacity, side: Ve, depthWrite: false, polygonOffset: true, polygonOffsetFactor: 1, polygonOffsetUnits: 1 }), a = new Ke(new be(), r);
  a.frustumCulled = false, a.userData.isShellArea = true, a.name = "__hekatan_shell_area", s.add(a);
  let h = new X(i.shellWall), o = new X(i.shellSlab), d = new X(i.shellTri);
  return xe((u, p) => {
    h = new X(p.shellWall), o = new X(p.shellSlab), d = new X(p.shellTri), r.opacity = p.shellOpacity, r.needsUpdate = true;
  }), ce.derive(() => {
    var _a, _b, _c, _d, _e2;
    ...
    const u = e.elemFrames ? e.elemFrames.rawVal : true, p = e.elemColumns.rawVal, m = e.elemBeams.rawVal, f = e.elemZapatas ? e.elemZapatas.rawVal : true, w = e.elemLosas ? e.elemLosas.rawVal : true, b = e.colorByType ? e.colorByType.rawVal : false, g = t.val, y = ((_e2 = D.elements) == null ? void 0 : _e2.val) || [], v = (k) => {
      if (k.length === 2) {
        if (!u) return false;
        const S = g[k[0]], C = g[k[1]];
        return !S || !C ? true : Te(S, C) ? p : m;
      }
      if (k.length === 4) {
        const S = k.map((_) => g[_]).filter(Boolean);
    ...
    for (const k of y) {
      ...
      let S = null;
      if (b) if (k.length === 2) {
        const C = g[k[0]], _ = g[k[1]];
        C && _ && (S = Te(C, _) ? Je : Ze);
      } else if (k.length === 4) {
        const C = k.map((_) => g[_]).filter(Boolean);
        if (C.length === 4) {
          const _ = (C[0][2] + C[1][2] + C[2][2] + C[3][2]) / 4;
          S = pe(_) ? ke : $e;
        }
      } else k.length === 3 && (S = Se);
      for (const C of et(k)) {
        const _ = g[C[0]], A = g[C[1]];
        !_ || !A || (x.push(..._, ...A), b && S && ($.push(S.r, S.g, S.b), $.push(S.r, S.g, S.b)));
      }
    }
    l.geometry.setAttribute("position", new ue(x, 3)), b && $.length === x.length ? (l.geometry.setAttribute("color", new ue($, 3)), l.material.vertexColors = true, l.material.needsUpdate = true) : (l.geometry.deleteAttribute("color"), l.material.vertexColors = false, l.material.needsUpdate = true);
    const E = [], T = [];
    for (const k of y) if (v(k)) {
      if (k.length === 3) {
        ...
        if (g[S] && g[C] && g[_]) {
          E.push(...g[S], ...g[C], ...g[_]);
          const A = b ? Se : d;
          for (let O = 0; O < 3; O++) T.push(A.r, A.g, A.b);
        }
      } else if (k.length === 4) {
        const [S, C, _, A] = k;
        if (g[S] && g[C] && g[_] && g[A]) {
          let O;
          if (b) {
            const L = (g[S][2] + g[C][2] + g[_][2] + g[A][2]) / 4;
            O = pe(L) ? ke : $e;
          } else O = Qe(g[S], g[C], g[_], g[A]) ? h : o;
          E.push(...g[S], ...g[C], ...g[_]), E.push(...g[S], ...g[_], ...g[A]);
          for (let L = 0; L < 6; L++) T.push(O.r, O.g, O.b);
        }
      }
    }
    E.length > 0 ? (a.geometry.dispose(), a.geometry = new be(), a.geometry.setAttribute("position", new ue(E, 3)), a.geometry.setAttribute("color", new ue(T, 3)), a.geometry.computeVertexNormals(), a.visible = e.faces ? e.faces.rawVal : true) : a.visible = false;
  }), ce.derive(() => {
    ...
    if (!e.faces) return;
    const u = e.faces.val;
    a.geometry.attributes.position ? a.visible = u : u || (a.visible = false);
  }), s;
}
function et(D) {
...
class te {
  ...
  trigger(e, t) {
    ...
    } else t instanceof Ae || (t = new Ae(this, t), this.activeEvents.push(t));
    let i, s, l;
...
let H = _H;
let n = function(D, e) {
  if (typeof D != "function") return new H(D, e);
  document.readyState == "complete" ? D() : window.addEventListener("load", D);
}, J = (n.html = (D) => (D = H._fragment(D), n(D.children, D)), n.version = H.version, {});
class tt {
  constructor() {
    this.version = "2.0.x", this.tmp = {}, this.settings = this.extend({}, { dataType: "HTTPJSON", dateStartYear: 1950, dateEndYear: 2030, macButtonOrder: false, warnNoPhrase: false }, ve, { phrases: null }), this.i18nCompare = Intl.Collator().compare, this.hasLocalStorage = function() {
      var e = "w2ui_test";
      try {
  ...
  message(e, t) {
    ...
    t.text != null && (t.body = `<div class="w2ui-centered w2ui-msg-text">${t.text}</div>`), t.width == null && (t.width = 350), t.height == null && (t.height = 170), t.hideOn == null && (t.hideOn = ["esc"]), t.on == null && (d = t, t = new te(), c.extend(t, d)), t.on("open", (f) => {
    ...
    return t.tmp || (t.tmp = { zIndex: m.css("z-index"), overflow: o.overflow }), t.html === "" && t.body === "" && t.buttons === "" ? r() : (t.msgIndex = n(e.box).find(".w2ui-message").length, t.msgIndex === 0 && typeof this.lock == "function" && (n(e.box).css("overflow", "hidden"), e.owner ? e.owner.lock(e.param) : this.lock(e.box)), n(e.box).find(".w2ui-message").css("z-index", 1390), m.css("z-index", 1501), u = `
      ...
      (_b2 = f != null ? isNaN(f) ? b.find(g).filter(f).get(0) : b.find(g).get(f) : b.find("[name=hidden-first]").get(0)) == null ? void 0 : _b2.focus(), n(e.box).find(".w2ui-message").find(g + ",[name=hidden-first],[name=hidden-last]").off(".keep-focus"), n(b).find(g + ",[name=hidden-first],[name=hidden-last]").on("blur.keep-focus", function(y) {
        setTimeout(() => {
          var _a3, _b3, _c;
          var v = document.activeElement, x = 0 < n(b).find(g).filter(v).length, $ = n(v).attr("name");
          !x && v && v !== document.body && ((_a3 = n(b).find(g).get(0)) == null ? void 0 : _a3.focus()), $ == "hidden-last" && ((_b3 = n(b).find(g).get(0)) == null ? void 0 : _b3.focus()), $ == "hidden-first" && ((_c = n(b).find(g).get(-1)) == null ? void 0 : _c.focus());
        }, 1);
      });
    }, h;
  }
  ...
  locale(e, t, i) {
    return new Promise((s, l) => {
      ...
      } else (e = e || "en-us") instanceof Object ? this.settings = this.extend({}, this.settings, ve, e) : (e.length === 5 && (e = "locale/" + e.toLowerCase() + ".json"), fetch(e, { method: "GET" }).then((r) => r.json()).then((r) => {
        i !== true && (this.settings = t ? this.extend({}, this.settings, r) : this.extend({}, this.settings, ve, { phrases: {} }, r)), s({ file: e, data: r });
      }).catch((r) => {
  ...
  checkName(e) {
    return e == null ? (console.log('ERROR: Property "name" is required but not supplied.'), false) : J[e] != null ? (console.log(`ERROR: Object named "${e}" is already registered as w2ui.${e}.`), false) : !!this.isAlphaNumeric(e) || (console.log('ERROR: Property "name" has to be alpha-numeric (a-z, 0-9, dash and underscore).'), false);
  }
...
const _F = class _F {
  ...
  getPosition(e) {
    ...
    if (t && t.box) {
      ...
      let v, x, $, E, T = "", k = { offset: 0, class: "", style: `#${t.id} { --tip-size: ${g}px; }` }, S = { left: 0, top: 0 }, C = { posX: "", x: 0, posY: "", y: 0 };
      r.forEach((_) => {
        ["top", "bottom"].includes(_) && (!T && w.height + g / 1.893 < y[_] && (T = _), y[_] > C.y) && Object.assign(C, { posY: _, y: y[_] }), ["left", "right"].includes(_) && (!T && w.width + g / 1.893 < y[_] && (T = _), y[_] > C.x) && Object.assign(C, { posX: _, x: y[_] });
      }), T = T || (f ? C.posY : C.posX), u.autoResize && (["top", "bottom"].includes(T) && (w.height > y[T] ? (E = y[T], t.tmp.resizedY = true) : t.tmp.resizedY = false), ["left", "right"].includes(T)) && (w.width > y[T] ? ($ = y[T], t.tmp.resizedX = true) : t.tmp.resizedX = false);
      var a = T;
      switch (k.class = b.arrow || "w2ui-arrow-" + a, a) {
        case "top":
          v = b.left + (b.width - ($ ?? w.width)) / 2, x = b.top - (E ?? w.height) - g / 1.5 + 1;
          break;
        case "bottom":
          v = b.left + (b.width - ($ ?? w.width)) / 2, x = b.top + b.height + g / 1.25 + 1;
          break;
        case "left":
          v = b.left - ($ ?? w.width) - g / 1.2 - 1, x = b.top + (b.height - (E ?? w.height)) / 2;
          break;
        case "right":
          v = b.left + b.width + g / 1.2 + 1, x = b.top + (b.height - (E ?? w.height)) / 2;
      }
      f && (u.align == "left" && (S.left = b.left - v, v = b.left), u.align == "right" && (S.left = b.left + b.width - ($ ?? w.width) - v, v = b.left + b.width - ($ ?? w.width)), ["top", "bottom"].includes(T) && u.align.startsWith("both") && (l = u.align.split(":")[1] ?? 50, b.width >= l) && (v = b.left, $ = b.width), u.align == "top" && (S.top = b.top - x, x = b.top), u.align == "bottom" && (S.top = b.top + b.height - (E ?? w.height) - x, x = b.top + b.height - (E ?? w.height)), ["left", "right"].includes(T) && u.align.startsWith("both") && (l = u.align.split(":")[1] ?? 50, b.height >= l) && (x = b.top, E = b.height));
      {
        let _;
        (["left", "right"].includes(u.align) && b.width < ($ ?? w.width) || ["top", "bottom"].includes(u.align) && b.height < (E ?? w.height)) && (_ = true);
        var h = T == "right" ? g : u.screenMargin, o = T == "bottom" ? g : u.screenMargin, d = m.width - ($ ?? w.width) - (T == "left" ? g : u.screenMargin), i = m.height - (E ?? w.height) - (T == "top" ? g : u.screenMargin) + 3;
        (["top", "bottom"].includes(T) || u.autoResize) && (v < h && (_ = true, S.left -= v, v = h), v > d) && (_ = true, S.left -= v - d, v += d - v), (["left", "right"].includes(T) || u.autoResize) && (x < o && (_ = true, S.top -= x, x = o), x > i) && (_ = true, S.top -= x - i, x += i - x), _ && (h = f ? "left" : "top", d = f ? "width" : "height", k.offset = -S[h], o = w[d] / 2 - g, Math.abs(k.offset) > o + g && (k.class = ""), Math.abs(k.offset) > o && (k.offset = k.offset < 0 ? -o : o), k.style = c.stripSpaces(`#${t.id} .w2ui-overlay-body:after,
                            #${t.id} .w2ui-overlay-body:before {
                                --tip-size: ${g}px;
                                margin-${h}: ${k.offset}px;
                            }`));
      }
      return s = T == "top" ? -u.margin : T == "bottom" ? u.margin : 0, e = T == "left" ? -u.margin : T == "right" ? u.margin : 0, x = Math.floor(100 * (x + parseFloat(u.offsetY) + parseFloat(s))) / 100, { left: v = Math.floor(100 * (v + parseFloat(u.offsetX) + parseFloat(e))) / 100, top: x, arrow: k, adjust: S, width: $, height: E, pos: T };
    }
  }
};
...
class st extends F {
  ...
  initControls(e) {
    ...
    function o(m, f, w) {
      ...
      g.forEach((x, $) => {
        x.length === 1 && (g[$] = "0" + x);
      }), b = g[0] + g[1] + g[2] + g[3], l.a === 1 && (b = g[0] + g[1] + g[2]), n(e.box).find(".color-preview").css("background-color", "#" + b), n(e.box).find("input").each((x) => {
...
class rt extends F {
  ...
  getMonthHTML(e, t, i) {
    ...
    for (let y = 0; y < 42; y++) {
      ...
      let v = "", x = "", $, E;
      E = e.type === "datetime" ? ($ = c.formatDateTime(b, e.format), c.formatDate(b, c.settings.dateFormat)) : $ = c.formatDate(b, e.format), e.colored && e.colored[E] !== void 0 && (b = e.colored[E].split("|"), x = "background-color: " + b[0] + ";", v = "color: " + b[1] + ";"), m += `<div class="w2ui-day ${this.inRange($, e, true) ? "w2ui-date " + (E == a ? "w2ui-selected" : "") : "w2ui-blocked"} ${w.join(" ")}"
                       style="${v + x}" date="${E}" data-date="${f.getTime()}">
                            ${g}
...
let M = new F(), Y = new lt(), Fe = new st(), le = new rt();
class at extends te {
  constructor(e) {
    ...
    if (1 < i.length) (i = this.get(e)) && !i.disabled && this.menuClick({ name: this.name, item: s, subItem: i, originalEvent: t });
      ...
      if (["menu", "menu-radio", "menu-check", "drop", "color", "text-color"].includes(s.type)) {
        ...
        setTimeout(() => {
          ...
          if (c.isPlainObject(s.overlay) || (s.overlay = {}), s.type == "drop" && M.show(c.extend({ html: s.html, class: "w2ui-white", hideOn: ["doc-click"] }, s.overlay, { anchor: d[0], name: this.name + "-drop", data: { item: s, btn: h } })).hide(o(s.id)), ["menu", "menu-radio", "menu-check"].includes(s.type)) {
            let u = "normal";
          ...
          ["color", "text-color"].includes(s.type) && Fe.show(c.extend({ color: s.color }, s.overlay, { anchor: d[0], name: this.name + "-drop", data: { item: s, btn: h } })).hide(o(s.id)).select((u) => {
      ...
      if (e == null) for (let o = 0; o < this.items.length; o++) {
        ...
        if (typeof l.onRefresh != "function" || (h = this.trigger("refresh", { target: e, item: l, object: l })).isCancelled !== true) {
          ...
          if (this.tooltipHide(e), l.type == "spacer" && n(this.box).find(".w2ui-tb-line:nth-child(" + l.line).find(".w2ui-tb-right").css("width", "auto"), o.length === 0) {
            ...
            let d = n(this.box).find(r).get(0), u = (c.bindEvents(d, this), M.get(true));
  ...
  destroy() {
    ...
    e.isCancelled !== true && (0 < n(this.box).find(".w2ui-scroll-wrapper  .w2ui-tb-right").length && n(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-toolbar").html(""), n(this.box).html(""), (_a = this.last.observeResize) == null ? void 0 : _a.disconnect(), delete J[this.name], e.finish());
  }
  getItemHTML(e) {
...
class xt extends te {
  ...
  destroy() {
    var _a;
    var e = this.trigger("destroy", { target: this.name });
    e.isCancelled !== true && (0 < n(this.box).find("#tabs_" + this.name + "_right").length && n(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-tabs").html(""), (_a = this.last.observeResize) == null ? void 0 : _a.disconnect(), delete J[this.name], e.finish());
  }
  click(e, t) {
    var i = this.get(e);
...
class _t extends te {
          ...
          if (function o(d) {
            ...
            for (let g = 0; g < t.searchData.length; g++) {
              ...
              if (y != null) {
                ...
                let x = t.parseField(d, v.field);
                switch (p = x == null || typeof x == "object" && x.toString == r ? "" : String(x).toLowerCase(), y.value != null && (Array.isArray(y.value) ? (m = y.value[0], f = y.value[1]) : m = String(y.value).toLowerCase()), y.operator) {
                  case "=":
                  case "is":
                  ...
                  case "more":
                    ...
                    break;
                  case "in":
                    w = y.value, (w = y.svalue ? y.svalue : w).indexOf(c.isFloat(x) ? parseFloat(x) : x) === -1 && w.indexOf(p) === -1 || u++;
                    break;
                  case "not in":
                    w = y.value, (w = y.svalue ? y.svalue : w).indexOf(c.isFloat(x) ? parseFloat(x) : x) === -1 && w.indexOf(p) === -1 && u++;
                    break;
    ...
    if (this.ranges.length !== 0) {
      let w = function(g) {
        ...
        if (y && y.type == "expand") {
          ...
          let v, x, $ = g.target;
          $.tagName.toUpperCase() != "TD" && ($ = n($).closest("td")[0]), (x = n($).attr("col") != null ? parseInt(n($).attr("col")) : x) != null && ($ = n($).closest("tr")[0], v = p.records[n($).attr("index")].recid, y.newRange[1].recid != v || y.newRange[1].column != x) && (g = c.clone(y.newRange), y.newRange = [{ recid: y.recid, column: y.column }, { recid: v, column: x }], f.detail && (f.detail.newRange = c.clone(y.newRange), f.detail.originalRange = c.clone(y.originalRange)), (f = p.trigger("selectionExtend", f)).isCancelled === true ? (y.newRange = g, f.detail.newRange = g) : (p.removeRange("grid-selection-expand"), p.addRange({ name: "grid-selection-expand", range: y.newRange, style: "background-color: rgba(100,100,100,0.1); border: 2px dotted rgba(100,100,100,0.5);" })));
        }
      }, b = function(g) {
      ...
      for (let g = 0; g < this.ranges.length; g++) {
        ...
        let y = n(this.box).find("#grid_" + this.name + "_rec_" + c.escapeId(l.recid) + ' td[col="' + l.column + '"]'), v = n(this.box).find("#grid_" + this.name + "_rec_" + c.escapeId(r.recid) + ' td[col="' + r.column + '"]'), x = n(this.box).find("#grid_" + this.name + "_frec_" + c.escapeId(l.recid) + ' td[col="' + l.column + '"]'), $ = n(this.box).find("#grid_" + this.name + "_frec_" + c.escapeId(r.recid) + ' td[col="' + r.column + '"]'), E = r.column;
  ...
  search(e, t) {
    ...
    if (arguments.length === 0 && d.length === 0 && (t = this.multiSearch ? (e = this.searchData, this.last.logic) : (e = this.last.field, this.last.search)), arguments.length === 0 && d.length !== 0) {
      ...
      for (let C = 0; C < this.searches.length; C++) {
        ...
        let _ = m.val(), A = f.val(), O = null, L = null;
        if (["int", "float", "money", "currency", "percent"].indexOf(u.type) != -1 && (w = m[0]._w2field, f = f[0]._w2field, w && (_ = w.clean(_)), f) && (A = f.clean(A)), ["list", "enum"].indexOf(u.type) != -1 || ["in", "not in"].indexOf(p) != -1) if (_ = m[0]._w2field.selected || {}, Array.isArray(_)) {
          O = [];
          for (let B = 0; B < _.length; B++) O.push(c.isFloat(_[B].id) ? parseFloat(_[B].id) : String(_[B].id).toLowerCase()), delete _[B].hidden;
          Object.keys(_).length === 0 && (_ = "");
        } else L = _.text || "", _ = _.id || "";
        if (_ !== "" && _ != null || A != null && A !== "") {
          var w = { field: u.field, type: u.type, operator: p };
          p == "between" ? c.extend(w, { value: [_, A] }) : p == "in" && typeof _ == "string" || p == "not in" && typeof _ == "string" ? c.extend(w, { value: _.split(",") }) : c.extend(w, { value: _ }), O && c.extend(w, { svalue: O }), L && c.extend(w, { text: L });
          try {
            u.type == "date" && p == "between" && (w.value[0] = _, w.value[1] = A), u.type == "date" && p == "is" && (w.value = _);
          } catch {
          }
          s.push(w), l = true;
        }
    ...
    if (typeof e == "string" && (arguments.length == 1 && (t = e, e = "all"), a = e, h = t, l = false, r = o ? "AND" : "OR", t != null)) if (e.toLowerCase() == "all") if (0 < this.searches.length) for (let C = 0; C < this.searches.length; C++) {
      ...
      if ((g.type == "text" || g.type == "alphanumeric" && c.isAlphaNumeric(t) || g.type == "int" && c.isInt(t) || g.type == "float" && c.isFloat(t) || g.type == "percent" && c.isFloat(t) || (g.type == "hex" || g.type == "color") && c.isHex(t) || g.type == "currency" && c.isMoney(t) || g.type == "money" && c.isMoney(t) || g.type == "date" && c.isDate(t) || g.type == "time" && c.isTime(t) || g.type == "datetime" && c.isDateTime(t) || g.type == "datetime" && c.isDate(t) || g.type == "enum" && c.isAlphaNumeric(t) || g.type == "list" && c.isAlphaNumeric(t)) && (b = this.defaultOperator[this.operatorsMap[g.type]], b = { field: g.field, type: g.type, operator: g.operator != null ? g.operator : b, value: t }, String(t).trim() != "") && s.push(b), ["int", "float", "money", "currency", "percent"].indexOf(g.type) != -1 && String(t).trim().split("-").length == 2 && (b = String(t).trim().split("-"), y = { field: g.field, type: g.type, operator: g.operator != null ? g.operator : "between", value: [b[0], b[1]] }, s.push(y)), ["list", "enum"].indexOf(g.type) != -1) {
        ...
        for (let _ = 0; _ < g.options.items; _++) {
          var x = g.options.items[_];
          try {
            var $ = new RegExp(t, "i");
            $.test(x) && v.push(_), x.text && $.test(x.text) && v.push(x.id);
          } catch {
          }
        }
      ...
      if ((C = C ?? { field: e, type: "text" }).field == e && (this.last.label = C.label), t !== "") {
        let _ = this.defaultOperator[this.operatorsMap[C.type]], A = t;
        if (["date", "time", "datetime"].indexOf(C.type) != -1 && (_ = "is"), ["list", "enum"].indexOf(C.type) != -1 && (_ = "is", T = T._w2field.get(), A = T && 0 < Object.keys(T).length ? T.id : ""), C.type == "int" && t !== "" && (_ = "is", String(t).indexOf("-") != -1 && (T = t.split("-")).length == 2 && (_ = "between", A = [parseInt(T[0]), parseInt(T[1])]), String(t).indexOf(",") != -1)) {
          var k = t.split(",");
          _ = "in", A = [];
          for (let O = 0; O < k.length; O++) A.push(k[O]);
        }
        C.operator != null && (_ = C.operator), T = { field: C.field, type: C.type, operator: _, value: A }, s.push(T);
      }
    }
    if (Array.isArray(e)) {
      let C = "AND";
  ...
  searchFieldTooltip(s, t, i) {
    ...
    }))) : l.type == "date" && (h = c.formatDateTime(h)), M.hide(this.name + "-search-props"), M.show({ name: this.name + "-search-props", anchor: i, class: "w2ui-white", hideOn: "doc-click", html: `
      ...
      if (d && !["checkbox", "check"].includes(d.type)) {
        ...
        if (["enum", "file"].indexOf(d.type) != -1) console.log('ERROR: input types "enum" and "file" are not supported in inline editing.');
          ...
          if (a.isCancelled !== true) {
            let v = function(x) {
              try {
                var $ = getComputedStyle(x), E = x.tagName.toUpperCase() == "DIV" ? x.innerText : x.value, T = n(l.box).find("#grid_" + l.name + "_editable").get(0), k = `font-family: ${$["font-family"]}; font-size: ${$["font-size"]}; white-space: no-wrap;`, S = c.getStrWidth(E, k);
                S + 20 > T.clientWidth && n(T).css("width", S + 20 + "px");
              } catch {
              }
            };
            ...
            s = getComputedStyle(h.find('[col="' + t + '"] > div').get(0)), r = `font-family: ${s["font-family"]}; font-size: ${s["font-size"]};`, d.type === "div" ? (m.addClass("w2ui-editable").html(c.stripSpaces(`<div id="grid_${this.name}_edit_${e}_${t}" class="w2ui-input w2ui-focus"
                        ...
                        style="${r + b + d.style}"
                        field="${p.field}" recid="${e}" column="${t}" ${d.attr}>` + d.text)), g = m.find("input").get(0), d.type == "number" && (f = c.formatNumber(f)), d.type == "date" && (f = c.formatDate(c.isDate(f, d.format, true) || /* @__PURE__ */ new Date(), d.format)), g.value = typeof f != "object" ? f : "", h = (x) => {
              var _a2, _b2, _c, _d;
              var $ = (_a2 = this.last._edit) == null ? void 0 : _a2.escKey;
              let E = false;
              var T = n(g).data("tooltipName");
              T && ((_b2 = M.get(T[0])) == null ? void 0 : _b2.selected) != null && (E = true), !this.last.inEditMode || $ || !y.includes(d.type) || ((_c = x.detail.overlay.anchor) == null ? void 0 : _c.id) != ((_d = this.last._edit.input) == null ? void 0 : _d.id) && d.type != "list" || (this.editChange(), this.editDone(void 0, void 0, { keyCode: E ? 13 : 0 }));
            }, new fe(c.extend({}, d, { el: g, selected: f, onSelect: h, onHide: h })), i == null && g && g.select()), Object.assign(this.last._edit, { input: g, edit: d }), n(g).off(".w2ui-editable").on("blur.w2ui-editable", (x) => {
              var $, E;
              this.last.inEditMode && ($ = this.last._edit.edit.type, E = n(g).data("tooltipName"), y.includes($) && E || (this.editChange(g, o, t, x), this.editDone()));
              ...
              switch (x.keyCode) {
                case 8:
                  d.type != "list" || g._w2field || x.preventDefault();
                  break;
                case 9:
                case 13:
                  x.preventDefault();
                ...
                case 27:
                  ...
                  $ && 0 < $.length && (this.last._edit.escKey = true, M.hide($[0]), x.preventDefault()), x.stopPropagation();
              }
              setTimeout(() => {
                var _a2, _b2;
                switch (x.keyCode) {
                  case 9:
                    ...
                    E != null && (T = l.records[E.index].recid, this.editChange(g, o, t, x), this.editDone(o, t, x), l.selectType != "row" ? (l.selectNone(true), l.select({ recid: T, column: E.colIndex })) : l.editField(T, E.colIndex, null, x), x.preventDefault) && x.preventDefault();
                    break;
                  case 13: {
                    let k = false;
                    var T = n(g).data("tooltipName");
                    T && M.get(T[0]).selected != null && (k = true), T && k || (this.editChange(g, o, t, x), this.editDone(o, t, x));
                    break;
                  }
                  case 27: {
                    this.last._edit.escKey = false;
                    let k = l.parseField(u, p.field);
                    ((_b2 = (_a2 = u.w2ui) == null ? void 0 : _a2.changes) == null ? void 0 : _b2[p.field]) != null && (k = u.w2ui.changes[p.field]), g._prevValue != null && (k = g._prevValue), g.tagName == "DIV" ? g.innerText = k ?? "" : g.value = k ?? "", this.editDone(o, t, x), setTimeout(() => {
  ...
  keydown(e) {
    ...
    if (t.keyboard === true) {
      ...
      if (s.isCancelled !== true) if (0 < n(this.box).find(".w2ui-message").length) e.keyCode == 27 && this.message();
        ...
        let x = function(k) {
          if (h && E(), !(b.length <= 0)) {
            let _ = t.prevRow(f, t.selectType == "row" ? 0 : d[0].column, k);
            if ((_ = v || _ != null ? _ : t.searchData.length == 0 || i ? 0 : t.last.searchIds[0]) != null) {
              if (v && t.multiSelect) {
                if (T()) return;
                if (t.selectType == "row") t.last.sel_ind > _ && t.last.sel_ind != w ? t.unselect(t.records[w].recid) : t.select(t.records[_].recid);
                else if (t.last.sel_ind > _ && t.last.sel_ind != w) {
                  _ = w;
                  var S = [];
                  for (let A = 0; A < p.length; A++) S.push({ recid: t.records[_].recid, column: p[A] });
                  t.unselect(S);
                } else {
                  var C = [];
                  for (let A = 0; A < p.length; A++) C.push({ recid: t.records[_].recid, column: p[A] });
                  t.select(C);
                }
              } else t.selectNone(true), t.click({ recid: t.records[_].recid, column: p[0] }, e);
              t.scrollIntoView(_, null, true, k != 1), e.preventDefault && e.preventDefault();
            } else v || t.selectNone(true);
          }
        }, $ = function(k) {
          if (h && E(), !(b.length <= 0)) {
            let _ = t.nextRow(w, t.selectType == "row" ? 0 : d[0].column, k);
            if ((_ = v || _ != null ? _ : t.searchData.length == 0 || i ? t.records.length - 1 : t.last.searchIds[t.last.searchIds.length - 1]) != null) {
              if (v && t.multiSelect) {
                if (T()) return;
              ...
              t.scrollIntoView(_, null, true, k != 1), g = true;
            } else v || t.selectNone(true);
          }
        }, E = function() {
            ...
            (function() {
              if (h) E();
                ...
                if (t.selectType == "row") {
                  ...
                  let A = t.prevCell(f, p[0]);
                  if (A = (A == null ? void 0 : A.index) != f ? null : A == null ? void 0 : A.colIndex, v || A != null || (t.selectNone(true), A = 0), A != null) if (v && t.multiSelect) {
                    if (T()) return;
                    var S = [], C = [], _ = [];
                    if (p.indexOf(t.last.sel_col) === 0 && 1 < p.length) {
                      for (let O = 0; O < d.length; O++) S.indexOf(d[O].recid) == -1 && S.push(d[O].recid), _.push({ recid: d[O].recid, column: p[p.length - 1] });
                      t.unselect(_), t.scrollIntoView(f, p[p.length - 1], true);
                    } else {
                      for (let O = 0; O < d.length; O++) S.indexOf(d[O].recid) == -1 && S.push(d[O].recid), C.push({ recid: d[O].recid, column: A });
                      t.select(C), t.scrollIntoView(f, A, true);
                    }
                  } else t.click({ recid: u, column: A }, e), t.scrollIntoView(f, A, true);
                  else v || t.selectNone(true);
                }
                g = true;
              }
            ...
            (function() {
              if (h) E();
                ...
                if (t.selectType == "row") {
                  ...
                  if (_ = _.index != f ? null : _.colIndex, v || _ != null || (t.selectNone(true), _ = t.columns.length - 1), _ != null) if (v && y == 39 && t.multiSelect) {
                    if (T()) return;
                    var k = [], S = [], C = [];
                    if (p.indexOf(t.last.sel_col) == p.length - 1 && 1 < p.length) {
                      for (let A = 0; A < d.length; A++) k.indexOf(d[A].recid) == -1 && k.push(d[A].recid), C.push({ recid: d[A].recid, column: p[0] });
                      t.unselect(C), t.scrollIntoView(f, p[0], true);
                    } else {
                      for (let A = 0; A < d.length; A++) k.indexOf(d[A].recid) == -1 && k.push(d[A].recid), S.push({ recid: d[A].recid, column: _ });
                      t.select(S), t.scrollIntoView(f, _, true);
                    }
...
`);
  ...
  update({ cells: e, fullCellRefresh: t, ignoreColumns: i } = {}) {
    ...
    function d(u, p, m, f, w) {
      ...
      if (!Array.isArray(i) || !i.includes(w) && !i.includes(b.field)) {
        let x = u.w2ui._update.cells[w];
        if (x != null && x.isConnected || (x = l.box.querySelector(`#grid_${l.name}_data_${f}_` + w), u.w2ui._update.cells[w] = x), x != null) {
          if (t) n(x).replace(l.getCellHTML(f, w, false)), x = l.box.querySelector(`#grid_${l.name}_data_${f}_` + w), u.w2ui._update.cells[w] = x;
          else {
            var g = x.children[0], { value: f, style: y, className: v } = l.getCellValue(f, w, false, true);
            if (g.innerHTML != f && (g.innerHTML = f), y != "" && x.style.cssText != y && (x.style.cssText = y), v != "") {
              let E = ["w2ui-grid-data"], T = [];
              g = v.split(" ").filter((k) => !!k), x.classList.forEach((k) => {
                E.includes(k) || T.push(k);
              }), x.classList.remove(...T), x.classList.add(...g);
            }
          }
          if (l.columns[w].style && l.columns[w].style != x.style.cssText && (x.style.cssText = l.columns[w].style ?? ""), u.w2ui.class != null) {
            if (typeof u.w2ui.class == "string") {
              let $ = ["w2ui-odd", "w2ui-even", "w2ui-record"], E = [];
            ...
            if (c.isPlainObject(u.w2ui.class) && typeof u.w2ui.class[b.field] == "string") {
              let $ = ["w2ui-grid-data"], E = [];
              y = u.w2ui.class[b.field].split(" ").filter((T) => !!T), x.classList.forEach((T) => {
                $.includes(T) || E.push(T);
              }), x.classList.remove(...E), x.classList.add(...y);
            }
          }
          u.w2ui.style != null && (p && m && typeof u.w2ui.style == "string" && p.style.cssText !== u.w2ui.style && (p.style.cssText = "height: " + l.recordHeight + "px;" + u.w2ui.style, p.setAttribute("custom_style", u.w2ui.style), m.style.cssText = "height: " + l.recordHeight + "px;" + u.w2ui.style, m.setAttribute("custom_style", u.w2ui.style)), c.isPlainObject(u.w2ui.style)) && typeof u.w2ui.style[b.field] == "string" && x.style.cssText !== u.w2ui.style[b.field] && (x.style.cssText = u.w2ui.style[b.field]);
        }
      }
    }
  }
  ...
  refreshBody() {
    ...
    e = n(this.box).find(`#grid_${this.name}_records`, this.box), t = n(this.box).find(`#grid_${this.name}_frecords`, this.box), this.selectType == "row" && (e.on("mouseover mouseout", { delegate: "tr" }, (s) => {
      ...
      }) : s.type == "click" && (M.hide(this.name + "-bubble"), this.showBubble(r.attr("index"), l.attr("col"), h));
      ...
      if (!s.delegate._tooltipShow) {
        ...
        M.show({ name: this.name + "-bubble", anchor: s.delegate, html: c.lang(typeof l.clipboardCopy == "string" ? l.clipboardCopy : "Copy to clipboard"), position: "top|bottom", offsetY: -2 }).hide((o) => {
          ...
          o.stopPropagation(), M.update(this.name + "-bubble", c.lang("Copied")), this.clipboardCopy(a.attr("index"), r.attr("col"), h);
          ...
          if (u && ["select", "select-column"].indexOf(u.type) != -1 && (u.divX = d.screenX - u.x, u.divY = d.screenY - u.y, !(Math.abs(u.divX) <= 1 && Math.abs(u.divY) <= 1))) if (i.last.cancelClick = true, i.reorderRows == 1 && i.last.move.reorder) {
            ...
            if (m == null) {
              ...
              if (!($ == null || i.records[$] && i.records[$].recid != u.recid)) {
                let E = i.get(m, true);
                if (E != null) {
                  let T = parseInt(u.column), k = parseInt((d.target.tagName.toUpperCase() == "TD" ? n(d.target) : n(d.target).parents("td")).attr("col"));
                  isNaN(T) && isNaN(k) && (T = 0, k = i.columns.length - 1), $ > E && (f = $, $ = E, E = f);
                  var y, m = "ind1:" + $ + ",ind2;" + E + ",col1:" + T + ",col2:" + k;
                  if (u.range != m) {
                    u.range = m;
                    for (let C = $; C <= E; C++) if (!(0 < i.last.searchIds.length && i.last.searchIds.indexOf(C) == -1)) if (i.selectType != "row") {
                      T > k && (y = T, T = k, k = y);
                      for (let _ = T; _ <= k; _++) i.columns[_].hidden || p.push({ recid: i.records[C].recid, column: parseInt(_) });
                    ...
                    if (i.selectType != "row") {
                      ...
                      for (let _ = 0; _ < p.length; _++) {
                        let A = false;
                        for (let O = 0; O < v.length; O++) p[_].recid == v[O].recid && p[_].column == v[O].column && (A = true);
                        A || C.push({ recid: p[_].recid, column: p[_].column });
                      }
                      i.select(C), C = [];
                      for (let _ = 0; _ < v.length; _++) {
                        let A = false;
                        for (let O = 0; O < p.length; O++) p[O].recid == v[_].recid && p[O].column == v[_].column && (A = true);
                        A || C.push({ recid: v[_].recid, column: v[_].column });
                      }
                      i.unselect(C);
...
`)), w.push({ kind: p.type == "text/html" ? "html" : "text", data: b });
          ...
          w.length === 1 && w[0].kind != "file" && (w = w[0].data), J[this.name].paste(w, d), d.preventDefault();
        }
      }).on("keydown", function(d) {
        J[i.name].keydown.call(J[i.name], d);
      });
      let r;
  ...
  initToolbar() {
    if (this.toolbar.render == null) {
      ...
      var e;
      this.toolbar.items = [], this.toolbar = new at(c.extend({}, this.toolbar, { name: this.name + "_toolbar", owner: this })), this.show.toolbarReload && this.toolbar.items.push(c.extend({}, this.buttons.reload)), this.show.toolbarColumns && this.toolbar.items.push(c.extend({}, this.buttons.columns)), this.show.toolbarSearch && (e = `
  ...
  resizeRecords() {
    ...
    let g = 8 * String(this.total).length + 10, y = (g < 34 && (g = 34), this.lineNumberWidth != null && (g = this.lineNumberWidth), false), v = false, x = 0;
    for (let I = 0; I < this.columns.length; I++) this.columns[I].frozen || this.columns[I].hidden || (t = parseInt(this.columns[I].sizeCalculated || this.columns[I].size), x += t);
    ...
    if (a = typeof this.url != "object" ? this.url : this.url.get, this.searchData.length == 0 || a || ($ = this.last.searchIds.length), this.fixedBody || (v = false), y || v ? (p.find(":scope > table > tbody > tr:nth-child(1) td.w2ui-head-last").css("width", c.scrollBarSize() + "px").show(), f.css({ top: (0 < this.columnGroups.length && this.show.columns ? 1 : 0) + c.getSize(p, "height") + "px", "-webkit-overflow-scrolling": "touch", "overflow-x": y ? "auto" : "hidden", "overflow-y": v ? "auto" : "hidden" })) : (p.find(":scope > table > tbody > tr:nth-child(1) td.w2ui-head-last").hide(), f.css({ top: (0 < this.columnGroups.length && this.show.columns ? 1 : 0) + c.getSize(p, "height") + "px", overflow: "hidden" }), 0 < f.length && (this.last.scrollTop = 0, this.last.scrollLeft = 0)), y ? (w.css("margin-bottom", c.scrollBarSize() + "px"), b.show()) : (w.css("margin-bottom", 0), b.hide()), w.css({ overflow: "hidden", top: f.css("top") }), this.show.emptyRecords && !v) {
      let I = Math.floor((((_f = f[0]) == null ? void 0 : _f.clientHeight) ?? 0) / this.recordHeight) - 1, N = 0;
      if ((N = f[0] ? f[0].scrollHeight - I * this.recordHeight : N) >= this.recordHeight && (N -= this.recordHeight, I++), this.fixedBody) {
        for (let R = $; R < I; R++) E(R, this.recordHeight, this);
        E(I, N, this);
      }
    }
    function E(I, N, R) {
      let z = "", q = "";
      var j;
      z += '<tr class="' + (I % 2 ? "w2ui-even" : "w2ui-odd") + ' w2ui-empty-record" recid="-none-" style="height: ' + N + 'px">', q += '<tr class="' + (I % 2 ? "w2ui-even" : "w2ui-odd") + ' w2ui-empty-record" recid="-none-" style="height: ' + N + 'px">', R.show.lineNumbers && (z += '<td class="w2ui-col-number"></td>'), R.show.selectColumn && (z += '<td class="w2ui-grid-data w2ui-col-select"></td>'), R.show.expandColumn && (z += '<td class="w2ui-grid-data w2ui-col-expand"></td>'), q += '<td class="w2ui-grid-data-spacer" col="start" style="border-right: 0"></td>', R.reorderRows && (q += '<td class="w2ui-grid-data w2ui-col-order" col="order"></td>');
      for (let U = 0; U < R.columns.length; U++) {
        var K = R.columns[U];
        (K.hidden || U < R.last.colStart || U > R.last.colEnd) && !K.frozen || (j = '<td class="w2ui-grid-data" ' + (K.attr != null ? K.attr : "") + ' col="' + U + '"></td>', K.frozen ? z += j : q += j);
      }
      z += '<td class="w2ui-grid-data-last"></td> </tr>', q += '<td class="w2ui-grid-data-last" col="end"></td> </tr>', n(R.box).find("#grid_" + R.name + "_frecords > table").append(z), n(R.box).find("#grid_" + R.name + "_records > table").append(q);
    }
    let T, k;
    if (0 < u.length) {
      let I = parseInt(u[0].clientWidth) - (v ? c.scrollBarSize() : 0) - (this.show.lineNumbers ? g : 0) - (this.reorderRows ? 26 : 0) - (this.show.selectColumn ? 26 : 0) - (this.show.expandColumn ? 26 : 0) - 1, N = (T = I, false);
      for (let R = k = 0; R < this.columns.length; R++) {
        var S = this.columns[R];
        0 < S.gridMinWidth && (S.gridMinWidth > T && S.hidden !== true && (S.hidden = true, N = true), S.gridMinWidth < T) && S.hidden === true && (S.hidden = false, N = true);
      }
      if (N === true) return void this.refresh();
      for (let R = 0; R < this.columns.length; R++) {
        var C = this.columns[R];
        C.hidden || (String(C.size).substr(String(C.size).length - 2).toLowerCase() == "px" ? (I -= parseFloat(C.size), this.columns[R].sizeCalculated = C.size, this.columns[R].sizeType = "px") : (k += parseFloat(C.size), this.columns[R].sizeType = "%", delete C.sizeCorrected));
      }
      if (k != 100 && 0 < k) for (let R = 0; R < this.columns.length; R++) {
        var _ = this.columns[R];
        _.hidden || _.sizeType == "%" && (_.sizeCorrected = Math.round(100 * parseFloat(_.size) * 100 / k) / 100 + "%");
      }
      for (let R = 0; R < this.columns.length; R++) {
        var A = this.columns[R];
        A.hidden || A.sizeType == "%" && (this.columns[R].sizeCorrected != null ? this.columns[R].sizeCalculated = Math.floor(I * parseFloat(A.sizeCorrected) / 100) - 1 + "px" : this.columns[R].sizeCalculated = Math.floor(I * parseFloat(A.size) / 100) - 1 + "px");
      }
    }
    let O = 0;
    for (let I = 0; I < this.columns.length; I++) {
      var L = this.columns[I];
      L.hidden || (L.min == null && (L.min = 20), parseInt(L.sizeCalculated) < parseInt(L.min) && (L.sizeCalculated = L.min + "px"), parseInt(L.sizeCalculated) > parseInt(L.max) && (L.sizeCalculated = L.max + "px"), O += parseInt(L.sizeCalculated));
    }
    let B = parseInt(T) - parseInt(O);
    if (0 < B && 0 < k) {
      let I = 0;
      for (; ; ) {
        var V = this.columns[I];
        if (V == null) I = 0;
        else {
          if (!V.hidden && V.sizeType != "px" && (V.sizeCalculated = parseInt(V.sizeCalculated) + 1 + "px", --B === 0)) break;
          I++;
        }
      }
    } else 0 < B && p.find(":scope > table > tbody > tr:nth-child(1) td.w2ui-head-last").css("width", c.scrollBarSize() + "px").show();
    let W = 1;
    this.show.lineNumbers && (W += g), this.show.selectColumn && (W += 26), this.show.expandColumn && (W += 26);
    for (let I = 0; I < this.columns.length; I++) this.columns[I].hidden || this.columns[I].frozen && (W += parseInt(this.columns[I].sizeCalculated));
    m.css("width", W + "px"), w.css("width", W + "px"), o.css("width", W + "px"), b.css("width", W + "px"), p.css("left", W + "px"), f.css("left", W + "px"), h.css("left", W + "px"), p.find(":scope > table > tbody > tr:nth-child(1) td").add(m.find(":scope > table > tbody > tr:nth-child(1) td")).each((I) => {
      n(I).hasClass("w2ui-col-number") && n(I).css("width", g + "px");
      var N = n(I).attr("col");
      if (N != null) {
        if (N == "start") {
          let R = 0;
          for (let z = 0; z < e.last.colStart; z++) !e.columns[z] || e.columns[z].frozen || e.columns[z].hidden || (R += parseInt(e.columns[z].sizeCalculated));
          n(I).css("width", R + "px");
        }
        e.columns[N] && n(I).css("width", e.columns[N].sizeCalculated);
      }
      if (n(I).hasClass("w2ui-head-last")) if (e.last.colEnd + 1 < e.columns.length) {
        let R = 0;
        for (let z = e.last.colEnd + 1; z < e.columns.length; z++) !e.columns[z] || e.columns[z].frozen || e.columns[z].hidden || (R += parseInt(e.columns[z].sizeCalculated));
        n(I).css("width", R + "px");
      } else n(I).css("width", c.scrollBarSize() + (0 < B && k === 0 ? B : 0) + "px");
    }), p.find(":scope > table > tbody > tr").length == 3 && p.find(":scope > table > tbody > tr:nth-child(1) td").add(m.find(":scope > table > tbody > tr:nth-child(1) td")).html("").css({ height: "0", border: "0", padding: "0", margin: "0" }), f.find(":scope > table > tbody > tr:nth-child(1) td").add(w.find(":scope > table > tbody > tr:nth-child(1) td")).each((I) => {
      n(I).hasClass("w2ui-col-number") && n(I).css("width", g + "px");
      var N = n(I).attr("col");
      if (N != null) {
        if (N == "start") {
      ...
      if (n(I).hasClass("w2ui-grid-data-last") && n(I).parents(".w2ui-grid-frecords").length === 0) if (e.last.colEnd + 1 < e.columns.length) {
        let R = 0;
        for (let z = e.last.colEnd + 1; z < e.columns.length; z++) !e.columns[z] || e.columns[z].frozen || e.columns[z].hidden || (R += parseInt(e.columns[z].sizeCalculated));
        n(I).css("width", R + "px");
      } else n(I).css("width", (0 < B && k === 0 ? B : 0) + "px");
    }), h.find(":scope > table > tbody > tr:nth-child(1) td").add(o.find(":scope > table > tbody > tr:nth-child(1) td")).each((I) => {
      n(I).hasClass("w2ui-col-number") && n(I).css("width", g + "px");
      var N = n(I).attr("col");
      if (N != null) {
        if (N == "start") {
      ...
      n(I).hasClass("w2ui-grid-data-last") && n(I).parents(".w2ui-grid-frecords").length === 0 && n(I).css("width", c.scrollBarSize() + (0 < B && k === 0 ? B : 0) + "px");
...
`;
  ...
  initOperator(e) {
    ...
    switch (i.type) {
      ...
      case "time":
      case "datetime":
        a[0]._w2field || (new fe(i.type, { el: a[0], ...i.options }), new fe(i.type, { el: h[0], ...i.options }), setTimeout(() => {
      ...
      case "combo":
      case "enum":
        t = i.options, i.type == "list" && (t.selected = {}), i.type == "enum" && (t.selected = []), s && (t.selected = s.value), a[0]._w2field || (d = new fe(i.type, { el: a[0], ...t }), s && s.text != null && d.set({ id: s.value, text: s.text }));
        break;
      case "select":
    ...
    return this.show.columnHeaders && (i = 0 < this.columnGroups.length ? (r = a(true), s = function() {
      ...
      for (let b = 0; b < e.columnGroups.length; b++) {
        ...
        if (!((g = b == e.columnGroups.length - 1 ? 100 : g) <= 0)) {
          if (m.main === true) {
            let y = "";
            for (let x = 0; x < e.sortData.length; x++) e.sortData[x].field == f.field && ((e.sortData[x].direction || "").toLowerCase() === "asc" && (y = "w2ui-sort-up"), (e.sortData[x].direction || "").toLowerCase() === "desc") && (y = "w2ui-sort-down");
            let v = "";
  ...
  scroll(e) {
    ...
    e && (v = e.target.scrollTop, e = e.target.scrollLeft, this.last.scrollTop = v, this.last.scrollLeft = e, u = n(this.box).find(`#grid_${this.name}_columns`)[0], p = n(this.box).find(`#grid_${this.name}_summary`)[0], u && (u.scrollLeft = e), p && (p.scrollLeft = e), l[0]) && (l[0].scrollTop = v), this.last.bubbleEl && (M.hide(this.name + "-bubble"), this.last.bubbleEl = null);
    let r = null, a = null;
    if (this.disableCVS || 0 < this.columnGroups.length) r = 0, a = this.columns.length - 1;
    else {
      var h, o = s.prop("clientWidth");
      let C = 0;
      for (let _ = 0; _ < this.columns.length; _++) this.columns[_].frozen || this.columns[_].hidden || (h = parseInt(this.columns[_].sizeCalculated || this.columns[_].size), C + h + 30 > this.last.scrollLeft && r == null && (r = _), C + h - 30 > this.last.scrollLeft + o && a == null && (a = _), C += h);
    ...
    if (r != null && (r < 0 && (r = 0), a < 0 && (a = 0), r == a && (0 < r ? r-- : a++), r != this.last.colStart || a != this.last.colEnd)) {
      ...
      if (u < 5 && p < 5) {
        ...
        if (r < this.last.colStart) for (let C = this.last.colStart - 1; C >= r; C--) this.columns[C] && (this.columns[C].frozen || this.columns[C].hidden) || (m.after(this.getColumnCellHTML(C)), w.each((_) => {
          var A = n(_).parent().attr("index");
          let O = '<td class="w2ui-grid-data" col="' + C + '" style="height: 0px"></td>';
          A != null && (O = this.getCellHTML(parseInt(A), C, false)), n(_).after(O);
        }), g.each((_) => {
          var A = n(_).parent().attr("index");
          let O = '<td class="w2ui-grid-data" col="' + C + '" style="height: 0px"></td>';
          A != null && (O = this.getCellHTML(parseInt(A), C, true)), n(_).after(O);
        }));
        if (a > this.last.colEnd) for (let C = this.last.colEnd + 1; C <= a; C++) this.columns[C] && (this.columns[C].frozen || this.columns[C].hidden) || (f.before(this.getColumnCellHTML(C)), b.each((_) => {
          var A = n(_).parent().attr("index");
          let O = '<td class="w2ui-grid-data" col="' + C + '" style="height: 0px"></td>';
          A != null && (O = this.getCellHTML(parseInt(A), C, false)), n(_).before(O);
        }), y.each((_) => {
          var A = n(_).parent().attr("index") || -1, A = this.getCellHTML(parseInt(A), C, true);
          n(_).before(A);
        }));
        ...
        let O = d.find(`#grid_${this.name}_records`);
        var x = d.find(`#grid_${this.name}_frecords`);
        let L = d.find(`#grid_${this.name}_summary`);
        p.find("tbody").html(e[1]), x.html(v[0]), O.prepend(v[1]), u != null && L.html(u[1]), setTimeout(() => {
          O.find(":scope > table").filter(":not(table:first-child)").remove(), L[0] && (L[0].scrollLeft = this.last.scrollLeft);
        }, 1);
      }
      this.resizeRecords();
    }
    ...
    if ($ > this.total && this.total !== -1 && ($ = this.total), ($ = this.searchData.length == 0 || i ? $ : this.last.searchIds.length) !== 0 && s.length !== 0 && s.prop("clientHeight") !== 0) {
      ...
      if (C > $ && (C = $), _ >= $ - 1 && (_ = $), n(this.box).find("#grid_" + this.name + "_footer .w2ui-footer-right").html((this.show.statusRange ? c.formatNumber(this.offset + C) + "-" + c.formatNumber(this.offset + _) + (this.total != -1 ? " " + c.lang("of") + " " + c.formatNumber(this.total) : "") : "") + (i && this.show.statusBuffered ? " (" + c.lang("buffered") + " " + c.formatNumber($) + (0 < this.offset ? ", skip " + c.formatNumber(this.offset) : "") + ")" : "")), i || this.fixedBody && !(this.total != -1 && this.total <= this.vs_start)) {
        let q = function() {
          t.markSearch && (clearTimeout(t.last.marker_timer), t.last.marker_timer = setTimeout(() => {
            var j = [];
            for (let ie = 0; ie < t.searchData.length; ie++) {
              var K = t.searchData[ie], U = t.getSearch(K.field);
              U && !U.hidden && (U = t.getColumn(K.field, true), j.push({ field: K.field, search: K.value, col: U }));
            }
            0 < j.length && j.forEach((ie) => {
              var Pe = n(t.box).find('td[col="' + ie.col + '"]:not(.w2ui-head)');
              c.marker(Pe, ie.search);
            });
          }, 50));
        }, A = Math.floor(s.prop("scrollTop") / this.recordHeight) - this.last.show_extra, O = A + Math.floor(s.prop("clientHeight") / this.recordHeight) + 2 * this.last.show_extra + 1;
        A < 1 && (A = 1), O > this.total && this.total != -1 && (O = this.total);
        var E = s.find("#grid_" + this.name + "_rec_top"), T = s.find("#grid_" + this.name + "_rec_bottom"), k = l.find("#grid_" + this.name + "_frec_top"), S = l.find("#grid_" + this.name + "_frec_bottom"), p = (String(E.next().prop("id")).indexOf("_expanded_row") != -1 && (E.next().remove(), k.next().remove()), this.total > O && String(T.prev().prop("id")).indexOf("_expanded_row") != -1 && (T.prev().remove(), S.prev().remove()), parseInt(E.next().attr("line"))), e = parseInt(T.prev().attr("line"));
        let V, W, I, N, R;
        if (p < A || p == 1 || this.last.pull_refresh) {
          if (O <= e + this.last.show_extra - 2 && O != this.total) return;
          for (this.last.pull_refresh = false; W = l.find("#grid_" + this.name + "_frec_top").next(), !((I = s.find("#grid_" + this.name + "_rec_top").next()).attr("line") == "bottom" || !(parseInt(I.attr("line")) < A)); ) W.remove(), I.remove();
          V = s.find("#grid_" + this.name + "_rec_bottom").prev(), (N = V.attr("line")) == "top" && (N = A);
          for (let j = parseInt(N) + 1; j <= O; j++) this.records[j - 1] && ((I = this.records[j - 1].w2ui) && !Array.isArray(I.children) && (I.expanded = false), R = this.getRecordHTML(j - 1, j), T.before(R[1]), S.before(R[0]));
        } else {
          if (A >= p - this.last.show_extra + 2 && 1 < A) return;
          for (; W = l.find("#grid_" + this.name + "_frec_bottom").prev(), !((I = s.find("#grid_" + this.name + "_rec_bottom").prev()).attr("line") == "top" || !(parseInt(I.attr("line")) > O)); ) W.remove(), I.remove();
          V = s.find("#grid_" + this.name + "_rec_top").next(), (N = V.attr("line")) == "bottom" && (N = O);
          for (let j = parseInt(N) - 1; j >= A; j--) this.records[j - 1] && ((I = this.records[j - 1].w2ui) && !Array.isArray(I.children) && (I.expanded = false), R = this.getRecordHTML(j - 1, j), E.after(R[1]), k.after(R[0]));
        }
        q(), setTimeout(() => {
          this.refreshRanges();
        }, 0), x = (A - 1) * this.recordHeight;
        let z = ($ - O) * this.recordHeight;
        z < 0 && (z = 0), E.css("height", x + "px"), k.css("height", x + "px"), T.css("height", z + "px"), S.css("height", z + "px"), this.last.range_start = A, this.last.range_end = O, Math.floor(s.prop("scrollTop") / this.recordHeight) + Math.floor(s.prop("clientHeight") / this.recordHeight) + 10 > $ && this.last.pull_more !== true && ($ < this.total - this.offset || this.total == -1 && this.last.fetch.hasMore) && (this.autoLoad === true && (this.last.pull_more = true, this.last.fetch.offset += this.limit, this.request("load")), n(this.box).find("#grid_" + this.name + "_rec_more, #grid_" + this.name + "_frec_more").show().eq(1).off(".load-more").on("click.load-more", function() {
        ...
        if (p.hidden) y++, 0 < v && v--;
          ...
          if (a.w2ui && (f = a.w2ui.colspan, u = this.columns[y].field, f) && f[u] === 0 && delete f[u], !(y < this.last.colStart || y > this.last.colEnd) || p.frozen) {
            if (a.w2ui && typeof a.w2ui.colspan == "object") {
              ...
              if (1 < m) {
                let $ = 0;
                for (let E = y; E < y + m && !(E >= this.columns.length); E++) this.columns[E].hidden && $++;
                x = m - $, v = m - 1;
              }
            }
            var f = this.getCellHTML(e, y, i, x);
            p.frozen ? s += f : l += f;
          }
          y++;
        }
  ...
  getCellHTML(e, t, i, s) {
    ...
    if (b.indexes.indexOf(e) != -1 && (g = true), s == null && (s = ((_b = a == null ? void 0 : a.w2ui) == null ? void 0 : _b.colspan) && a.w2ui.colspan[r.field] ? a.w2ui.colspan[r.field] : 1), t === 0 && Array.isArray((_c = a == null ? void 0 : a.w2ui) == null ? void 0 : _c.children)) {
      ...
      y += `<span class="w2ui-show-children ${x}"></span>`;
    }
    ...
    let $ = h, E = (m && ["checkbox", "check"].indexOf(m.type) != -1 && (f += "text-align: center;", $ = `<input tabindex="-1" type="checkbox" class="w2ui-editable-checkbox"
    ...
    let T;
    return r.clipboardCopy && (T = '<span class="w2ui-clipboard-copy w2ui-icon-paste"></span>'), $ = '<td class="w2ui-grid-data' + (E ? " w2ui-selected" : "") + " " + d + (w ? " w2ui-changed" : "") + '"    id="grid_' + this.name + "_data_" + e + "_" + t + '" col="' + t + '"    style="' + o + (r.style != null ? r.style : "") + '" ' + (r.attr != null ? r.attr : "") + u + (1 < s ? 'colspan="' + s + '"' : "") + ">" + $ + (T && c.stripTags($) ? T : "") + "</td>", $ = e === -1 && i === true ? '<td class="w2ui-grid-data" col="' + t + '" style="height: 0px; ' + o + '" ' + (1 < s ? 'colspan="' + s + '"' : "") + "></td>" : $;
  }
  clipboardCopy(e, t, i) {
...
class fe extends te {
        ...
        if (!n(d).hasClass("li-search")) {
          ...
          if (n(o.target).hasClass("w2ui-list-remove")) n(this.el).prop("readOnly") || n(this.el).prop("disabled") || (m = this.trigger("remove", { target: this.el, originalEvent: o, item: p })).isCancelled !== true && (this.selected.splice(u, 1), n(this.el).trigger("input").trigger("change"), n(o.target).remove());
            ...
            if (this.type === "file" && (/image/i.test(p.type) && (f = `
              ...
              M.show({ name: w, anchor: d.get(0), html: f, hideOn: ["doc-click"], class: "" }).show((b) => {
  ...
  keyDown(e, l) {
    ...
    if (this.type === "time") {
      ...
      let w = le.str2min(a) || le.str2min((/* @__PURE__ */ new Date()).getHours() + ":" + ((/* @__PURE__ */ new Date()).getMinutes() - 1));
      switch (l) {
        case 38:
      ...
      r && (e.preventDefault(), n(this.el).val(le.min2str(w)).trigger("input").trigger("change"), this.moveCaret2end());
    }
  ...
  updateOverlay(e) {
    ...
    if (this.type === "color") {
      if (n(this.el).prop("readOnly") || n(this.el).prop("disabled")) return;
      Fe.show(c.extend({ name: this.el.id + "_color", anchor: this.el, transparent: t.transparent, advanced: t.advanced, color: this.el.value, liveUpdate: true }, this.options)).select((s) => {
    ...
    !["date", "time", "datetime"].includes(this.type) || n(this.el).prop("readOnly") || n(this.el).prop("disabled") || le.show(c.extend({ name: this.el.id + "_date", anchor: this.el, value: this.el.value }, this.options)).select((s) => {
  ...
  addFile(e) {
    ...
    if (h.isCancelled !== true) if (t.silent !== true && 0 < a.length) M.show({ anchor: this.el, html: "Errors: " + a.join("<br>") }), console.log("ERRORS (while adding files): ", a);
...
*/
const _e = globalThis, Ee = (D) => D, ge = _e.trustedTypes, De = ge ? ge.createPolicy("lit-html", { createHTML: (D) => D }) : void 0, Ne = "$lit$", G = `lit$${Math.random().toFixed(9).slice(2)}$`, Le = "?" + G, nt = `<${Le}>`, ee = document, ae = () => ee.createComment(""), ne = (D) => D === null || typeof D != "object" && typeof D != "function", Ce = Array.isArray, ot = (D) => Ce(D) || typeof (D == null ? void 0 : D[Symbol.iterator]) == "function", ye = `[ 	
\f\r]`, re = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ie = /-->/g, Oe = />/g, Z = RegExp(`>|${ye}(?:([^\\s"'>=/]+)(${ye}*=${ye}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Re = /'/g, ze = /"/g, He = /^(?:script|style|textarea|title)$/i, ht = (D) => (e, ...t) => ({ _$litType$: D, strings: e, values: t }), me = ht(1), oe = Symbol.for("lit-noChange"), P = Symbol.for("lit-nothing"), Me = /* @__PURE__ */ new WeakMap(), Q = ee.createTreeWalker(ee, 129);
function je(D, e) {
  if (!Ce(D) || !D.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return De !== void 0 ? De.createHTML(e) : e;
}
const dt = (D, e) => {
  const t = D.length - 1, i = [];
  let s, l = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", r = re;
  for (let a = 0; a < t; a++) {
    const h = D[a];
    let o, d, u = -1, p = 0;
    for (; p < h.length && (r.lastIndex = p, d = r.exec(h), d !== null); ) p = r.lastIndex, r === re ? d[1] === "!--" ? r = Ie : d[1] !== void 0 ? r = Oe : d[2] !== void 0 ? (He.test(d[2]) && (s = RegExp("</" + d[2], "g")), r = Z) : d[3] !== void 0 && (r = Z) : r === Z ? d[0] === ">" ? (r = s ?? re, u = -1) : d[1] === void 0 ? u = -2 : (u = r.lastIndex - d[2].length, o = d[1], r = d[3] === void 0 ? Z : d[3] === '"' ? ze : Re) : r === ze || r === Re ? r = Z : r === Ie || r === Oe ? r = re : (r = Z, s = void 0);
    const m = r === Z && D[a + 1].startsWith("/>") ? " " : "";
    l += r === re ? h + nt : u >= 0 ? (i.push(o), h.slice(0, u) + Ne + h.slice(u) + G + m) : h + G + (u === -2 ? a : m);
  }
  return [je(D, l + (D[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class he {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let l = 0, r = 0;
    const a = e.length - 1, h = this.parts, [o, d] = dt(e, t);
    if (this.el = he.createElement(o, i), Q.currentNode = this.el.content, t === 2 || t === 3) {
      const u = this.el.content.firstChild;
      u.replaceWith(...u.childNodes);
    }
    for (; (s = Q.nextNode()) !== null && h.length < a; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const u of s.getAttributeNames()) if (u.endsWith(Ne)) {
          const p = d[r++], m = s.getAttribute(u).split(G), f = /([.?@])?(.*)/.exec(p);
          h.push({ type: 1, index: l, name: f[2], strings: m, ctor: f[1] === "." ? ut : f[1] === "?" ? pt : f[1] === "@" ? ft : we }), s.removeAttribute(u);
        } else u.startsWith(G) && (h.push({ type: 6, index: l }), s.removeAttribute(u));
        if (He.test(s.tagName)) {
          const u = s.textContent.split(G), p = u.length - 1;
          if (p > 0) {
            s.textContent = ge ? ge.emptyScript : "";
            for (let m = 0; m < p; m++) s.append(u[m], ae()), Q.nextNode(), h.push({ type: 2, index: ++l });
            s.append(u[p], ae());
          }
        }
      } else if (s.nodeType === 8) if (s.data === Le) h.push({ type: 2, index: l });
      else {
        let u = -1;
        for (; (u = s.data.indexOf(G, u + 1)) !== -1; ) h.push({ type: 7, index: l }), u += G.length - 1;
      }
      l++;
    }
  }
...
class ct {
  ...
  u(e) {
    const { el: { content: t }, parts: i } = this._$AD, s = ((e == null ? void 0 : e.creationScope) ?? ee).importNode(t, true);
    Q.currentNode = s;
    let l = Q.nextNode(), r = 0, a = 0, h = i[0];
    for (; h !== void 0; ) {
      if (r === h.index) {
        let o;
        h.type === 2 ? o = new de(l, l.nextSibling, this, e) : h.type === 1 ? o = new h.ctor(l, h.name, h.strings, this, e) : h.type === 6 && (o = new mt(l, this, e)), this._$AV.push(o), h = i[++a];
      }
      r !== (h == null ? void 0 : h.index) && (l = Q.nextNode(), r++);
    }
...
class de {
  ...
  _$AI(e, t = this) {
    e = se(this, e, t), ne(e) ? e === P || e == null || e === "" ? (this._$AH !== P && this._$AR(), this._$AH = P) : e !== this._$AH && e !== oe && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : ot(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== P && ne(this._$AH) ? this._$AA.nextSibling.data = e : this.T(ee.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var _a;
    const { values: t, _$litType$: i } = e, s = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = he.createElement(je(i.h, i.h[0]), this.options)), i);
    if (((_a = this._$AH) == null ? void 0 : _a._$AD) === s) this._$AH.p(t);
    else {
      const l = new ct(s, this), r = l.u(this.options);
      l.p(t), this.T(r), this._$AH = l;
    }
  }
  _$AC(e) {
    let t = Me.get(e.strings);
    return t === void 0 && Me.set(e.strings, t = new he(e)), t;
  }
  k(e) {
    Ce(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let i, s = 0;
    for (const l of e) s === t.length ? t.push(i = new de(this.O(ae()), this.O(ae()), this, this.options)) : i = t[s], i._$AI(l), s++;
...
class we {
  ...
  _$AI(e, t = this, i, s) {
    ...
    let r = false;
    if (l === void 0) e = se(this, e, t, 0), r = !ne(e) || e !== this._$AH && e !== oe, r && (this._$AH = e);
    else {
      const a = e;
      let h, o;
      for (e = l[0], h = 0; h < l.length - 1; h++) o = se(this, a[i + h], t, h), o === oe && (o = this._$AH[h]), r || (r = !ne(o) || o !== this._$AH[h]), o === P ? e = P : e !== P && (e += (o ?? "") + l[h + 1]), this._$AH[h] = o;
    }
    r && !s && this.j(e);
  }
  j(e) {
...
class ft extends we {
  ...
  _$AI(e, t = this) {
    if ((e = se(this, e, t, 0) ?? P) === oe) return;
...
const gt = _e.litHtmlPolyfillSupport;
gt == null ? void 0 : gt(he, de), (_e.litHtmlVersions ?? (_e.litHtmlVersions = [])).push("3.3.2");
const wt = (D, e, t) => {
  const i = e;
  let s = i._$litPart$;
  return s === void 0 && (i._$litPart$ = s = new de(e.insertBefore(ae(), null), null, void 0, {})), s._$AI(D), s;
};
function Ct({ buttons: D, clickedButton: e, author: t, sourceCode: i }) {
  ...
  const r = me`
    <div class="buttons-container">
      ${D == null ? void 0 : D.map((d) => me`<button class="btn btn-text" @click=${a}>
            ${d}
          </button>`)}
...
function bt() {
  return me`<img src="${"/hekatan-struct-lineal/"}img/hekatan-logo.png" alt="Hekatan" style="width:22px;height:22px;border-radius:4px;">`;
}
export {
  P as A,
  wt as D,
