...
import { m as k, d as P, __tla as __tla_0 } from "./didacticCpp-CLixJGob.js";
let V;
let __tla = Promise.all([
  ...
  V = {
    ...
    build(e, s) {
      ...
      ]), x = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), h = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), I = /* @__PURE__ */ new Map();
      for (let t = 0; t < c.length; t++) x.set(t, e.E_s), b.set(t, w), F.set(t, a), h.set(t, u), E.set(t, u), A.set(t, L), p.set(t, q), v.set(t, D), I.set(t, g);
      ...
      const d = e.Fx * e.L / (e.E_s * a), M = ((_b = (_a = f.deformations) == null ? void 0 : _a.get(i)) == null ? void 0 : _b[0]) ?? 0, C = d !== 0 ? (M - d) / d * 100 : 0;
  ...
  u_x hekatan   = ${(M * 1e3).toFixed(5)} mm  (\u0394 ${C.toFixed(4)}%)`);
    },
    runModal(e, s, o) {
      var _a, _b;
