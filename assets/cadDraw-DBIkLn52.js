...
function v() {
  return { model: x(), tool: "select", snap: 0.5, workPlane: "xz", workZ: 0, pendingNodes: [], nextNodeId: 1, nextLineId: 1, nextAreaId: 1, nextSolidId: 1 };
}
let s = v();
function k() {
  return s;
...
window.__hekatanCadState = { get: k, reset: S, addNode: A, addLine: D, addArea: C, setTool: N, getStats: y };
const b = { id: "cad-draw", name: "CAD Drawer (mouse + Tweakpane)", category: "Modelar", defaultShellResult: "none", availableShellResults: [], params: {}, build(n, e) {
  ...
  const c = [], m = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map(), g = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Map(), I = /* @__PURE__ */ new Map(), $ = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), h = /* @__PURE__ */ new Map(), z = /* @__PURE__ */ new Map();
