import { a as k } from "./analyze-Baqb28rE.js";
import { m as p, d as W, __tla as __tla_0 } from "./didacticCpp-PqvqKlgs.js";
let y;
let __tla = Promise.all([
  ...
  y = {
    ...
    build(e, o) {
      var _a, _b;
      const m = e.D_st - 2 * e.TF_st, a = 2 * e.B_st * e.TF_st + m * e.TW_st, l = e.D_out * e.B_out - a, s = e.E_s / e.E_c, n = a + l / s, M = e.B_out * e.D_out ** 3 / 12 - e.B_st * e.D_st ** 3 / 12, x = 2 * (e.B_st * e.TF_st ** 3 / 12 + e.B_st * e.TF_st * ((e.D_st - e.TF_st) / 2) ** 2) + e.TW_st * m ** 3 / 12 + M / s, B = e.B_out * e.D_out ** 3 / 12 * 0.3, T = e.D_st * e.TW_st + l / s, S = e.E_s / (2 * (1 + D)), i = Math.max(1, Math.round(e.nElem)), w = e.L / i, _ = [];
      ...
      ]), f = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map(), I = /* @__PURE__ */ new Map(), $ = /* @__PURE__ */ new Map(), h = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map();
      for (let t = 0; t < d.length; t++) f.set(t, e.E_s), E.set(t, S), F.set(t, n), b.set(t, x), A.set(t, x), I.set(t, B), $.set(t, T), h.set(t, O), v.set(t, D);
      ...
      o.deformOutputs.val = u, o.analyzeOutputs.val = k(_, d, o.elementInputs.val, u), o.objects3D.val = [];
      const r = e.Fx * e.L / (e.E_s * n), g = ((_b = (_a = u.deformations) == null ? void 0 : _a.get(i)) == null ? void 0 : _b[0]) ?? 0, q = r !== 0 ? (g - r) / r * 100 : 0;
  ...
  u_x hekatan    = ${(g * 1e3).toFixed(5)} mm  (\u0394 ${q.toFixed(4)}%)
