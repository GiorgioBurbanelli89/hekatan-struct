import { a as we } from "./analyze-CWooBpVN.js";
import { d as ye, __tla as __tla_0 } from "./didacticCpp-C0Qfkfmr.js";
import { c as ze } from "./colorMapPercentile-OnF3uP-w.js";
import { M as K, d as Q, e as fe, f as Fe } from "./theme-N6TOO4-G.js";
let Pe;
let __tla = Promise.all([
  ...
  Pe = {
    ...
    build(e, c) {
      ...
      const f = A + e.tp, w = +e.d_beam / 2 - e.tf_beam / 2, h = -e.d_beam / 2 + e.tf_beam / 2, G = 8 * u, v = 2 * u, Y = 2 * u, y = [], S = [], P = [];
      for (let t = 0; t <= G; t++) {
        const o = f + t * e.L_beam / G, n = [], a = [];
        for (let s = 0; s <= v; s++) {
          const q = -e.bf_beam / 2 + s * e.bf_beam / v;
      ...
      for (let t = 0; t < G; t++) {
        for (let o = 0; o < v; o++) d(y[t][o], y[t][o + 1], y[t + 1][o + 1], y[t + 1][o], e.tf_beam), d(S[t][o], S[t][o + 1], S[t + 1][o + 1], S[t + 1][o], e.tf_beam);
      ...
      const ue = e.Mu / Math.max(e.d_beam - e.tf_beam, 0.1) * 0.4, J = /* @__PURE__ */ new Map(), he = ue / (v + 1);
      for (let t = 0; t <= v; t++) J.set(y[G][t], [
        0,
        0,
        -he,
        0,
      ...
      const j = [], pe = new K({
        ...
        color: 2236962
      }), oe = e.tp + e.tf_col + 0.02, ae = +e.d_beam / 2 + e.pf, ne = +e.d_beam / 2 - e.pf, se = -e.d_beam / 2 - e.pf, le = -e.d_beam / 2 + e.pf, me = +e.d_beam / 2 + e.pf * 2, ce = -e.d_beam / 2 - e.pf * 2, R = -e.g / 2, C = +e.g / 2, r = A - e.tp / 2 - 5e-3, re = [
        [
          r,
          R,
          ae
