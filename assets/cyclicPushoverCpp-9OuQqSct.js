import { M as P } from "./deform-CGyu4ATa.js";
let y = null;
async function m() {
...
async function F(s) {
  ...
  return t._free(_), l && t._free(l), i && t._free(i), t._free(n), t._free(f), t._free(p), { displacements: h, forces: E, nSteps: o };
}
async function M(s, t, r, e, a, b, u) {
