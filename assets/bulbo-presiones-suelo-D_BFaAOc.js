...
import { v as l, P as ge } from "./Text-CSfbf1xJ.js";
import { h as be, __tla as __tla_0 } from "./h8-C0kIpAby.js";
import { g as we, a as Q, h as W, b as ye } from "./styles-CXNYye6A.js";
import { e as Me } from "./makeDraggable-zx2br6Yh.js";
import { g as _e } from "./getParameters-DsthXvNv.js";
...
Promise.all([
  ...
  l.derive(() => {
    const n = r.Lx.value.val, I = r.Ly.value.val, ce = r.Lz.value.val, p = Math.round(r.nx.value.val), u = Math.round(r.ny.value.val), _ = Math.round(r.nz.value.val), R = r.Es.value.val, N = r.nu.value.val, Z = r.Rx.value.val, Y = r.Ry.value.val, me = r.w.value.val, z = Math.round(r.showSlice.value.val) === 1, L = n / p, O = I / u, pe = ce / _, d = (e, t, a) => a * (p + 1) * (u + 1) + t * (p + 1) + e, S = [];
    ...
    for (let e = 0; e < _; e++) for (let t = 0; t < u; t++) for (let a = 0; a < p; a++) {
      ...
      const s = (i, m, c) => d(a + i, t + m, e + c), o = v.length;
      if (g(s(0, 0, 0), s(1, 0, 0), s(1, 0, 1), s(0, 0, 1)), k.set(o, y), !z || t === T) {
        if (z) {
          const c = v.length;
          g(s(0, 1, 0), s(1, 1, 0), s(1, 1, 1), s(0, 1, 1)), k.set(c, y);
        }
        const i = v.length;
        g(s(0, 0, 0), s(1, 0, 0), s(1, 1, 0), s(0, 1, 0)), k.set(i, y);
        const m = v.length;
        if (g(s(0, 0, 1), s(1, 0, 1), s(1, 1, 1), s(0, 1, 1)), k.set(m, y), !z) g(s(0, 1, 0), s(1, 1, 0), s(1, 1, 1), s(0, 1, 1)), g(s(0, 0, 0), s(0, 1, 0), s(0, 1, 1), s(0, 0, 1)), g(s(1, 0, 0), s(1, 1, 0), s(1, 1, 1), s(1, 0, 1));
        else {
          if (a === 0) {
            const c = v.length;
            g(s(0, 0, 0), s(0, 1, 0), s(0, 1, 1), s(0, 0, 1)), k.set(c, y);
          }
          if (a === p - 1) {
            const c = v.length;
            g(s(1, 0, 0), s(1, 1, 0), s(1, 1, 1), s(1, 0, 1)), k.set(c, y);
          }
        }
      }
      y++;
  ...
  document.body.append(_e(r), ie, ye({
