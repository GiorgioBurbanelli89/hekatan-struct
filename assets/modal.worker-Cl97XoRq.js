(async ()=>{
    ...
    async function Le(L = {}) {
        ...
        var Te, pe, G, ye, ge, F, z, ae = !1;
        function nr() {
            var e = hr.buffer;
            G = new Int8Array(e), d.HEAPU8 = ye = new Uint8Array(e), ge = new Int32Array(e), d.HEAPU32 = F = new Uint32Array(e), d.HEAPF64 = new Float64Array(e), z = new BigInt64Array(e), new BigUint64Array(e);
        }
        ...
        var Me;
        function ar() {
            return d.locateFile ? ne("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-CHCeGM91.wasm", import.meta.url).href;
        }
        function Ge(e) {
        ...
        var qe = (e)=>{
            ...
            var r = new Se(e);
            return r.get_caught() || (r.set_caught(!0), we--), r.set_rethrown(!1), re.push(r), $r(e);
        }, V = 0, De = ()=>{
            E(0, 0), u(re.length > 0);
            var e = re.pop();
            br(e.excPtr), V = 0;
...
`));
        ...
        var Vr = {
            ...
            invoke_iiiiiiiiiiii: xn,
            invoke_iiiiiiiiiiiii: Nn,
        ...
        function Sn(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, N) {
            var C = g();
            try {
                w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, N);
            } catch (O) {
        ...
        function Pn(e, r, t, n, o, a, s, c, l, f) {
            var m = g();
            try {
                w(e)(r, t, n, o, a, s, c, l, f);
            } catch (v) {
        ...
        function xn(e, r, t, n, o, a, s, c, l, f, m, v) {
            var _ = g();
            try {
        ...
        function Un(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, N) {
            var C = g();
            try {
                w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, N);
            } catch (O) {
    ...
    await Le();
    const b = await Le();
    function zn(L, B, d, k, K = 10, q = 0, X = 0, Q = 1, te, Pe) {
        ...
        A.push(u);
        const x = (U)=>{
            const $ = U ? Array.from(U.keys()) : [], yr = U ? Array.from(U.values()) : [], _r = j($, Uint32Array, b.HEAPU32);
            A.push(_r);
        ...
        }, ze = x(k.elasticities), ve = x(k.areas), p = x(k.momentsOfInertiaZ), he = x(k.momentsOfInertiaY), oe = x(k.shearModuli), T = x(k.torsionalConstants), He = x(k.densities), We = x(k.thicknesses), je = x(k.poissonsRatios), Ae = x(k.membraneModifiers), Te = x(k.bendingModifiers), pe = k.plateFormulations, G = pe ? Array.from(pe.keys()) : [], ye = pe ? Array.from(pe.values()) : [], ge = j(G, Uint32Array, b.HEAPU32);
        A.push(ge);
        ...
        A.push(ar);
        const Ge = x(k.shearAreasY), $e = x(k.shearAreasZ), Ve = x(k.localAngles), sr = k.momentReleases ? Array.from(k.momentReleases.keys()) : [], pr = k.momentReleases ? Array.from(k.momentReleases.values()).flatMap(Bn) : [], cr = j(sr, Uint32Array, b.HEAPU32);
        A.push(cr);
        ...
        A.push(Xe), b._modal(ne, L.length, ie, fe.length, ue, B.length, me, u, I.length, ze.keysPtr, ze.valuesPtr, ze.size, ve.keysPtr, ve.valuesPtr, ve.size, p.keysPtr, p.valuesPtr, p.size, he.keysPtr, he.valuesPtr, he.size, oe.keysPtr, oe.valuesPtr, oe.size, T.keysPtr, T.valuesPtr, T.size, He.keysPtr, He.valuesPtr, He.size, We.keysPtr, We.valuesPtr, We.size, je.keysPtr, je.valuesPtr, je.size, Ae.keysPtr, Ae.valuesPtr, Ae.size, Te.keysPtr, Te.valuesPtr, Te.size, ge, F, G.length, ir, or, ae.length, Me, ar, R.length, Ge.keysPtr, Ge.valuesPtr, Ge.size, $e.keysPtr, $e.valuesPtr, $e.size, Ve.keysPtr, Ve.valuesPtr, Ve.size, cr, qe, sr.length, Ne.keysPtr, Ne.valuesPtr, Ne.size, Q, Ke.keysPtr, Ke.valuesPtr, Ke.size, se, Ee ? Ee.length : 0, K, q, X, y, g, ee, Oe, Ye, J, Y, Xe);
        const re = b.HEAPU32[y / 4], we = b.HEAPU32[g / 4], Je = b.HEAPU32[ee / 4], V = b.HEAPU32[Oe / 4], De = b.HEAPU32[Ye / 4], Se = b.HEAPU32[J / 4], ce = b.HEAPU32[Y / 4], ke = b.HEAPU32[Xe / 4];
        let dr = [], fr = [], ur = [];
        if (we > 0 && re) {
        ...
        if (V > 0 && De > 0 && Je) {
            ...
            for(let $ = 0; $ < V; $++)fr.push(Array.from(U.slice($ * De, ($ + 1) * De)));
            A.push(Je);
        }
        if (ce > 0 && ke > 0 && Se) {
            const U = new Float64Array(b.HEAPF64.buffer, Se, ce * ke);
            for(let $ = 0; $ < ce; $++)ur.push(Array.from(U.slice($ * ke, ($ + 1) * ke)));
            A.push(Se);
        }
