...
import { v as a, L as et, V as B, a as E, B as G } from "./theme-dnnHIQ7U.js";
import { a as xt } from "./analyze-DZ5QYzyM.js";
import { d as It, __tla as __tla_0 } from "./didacticCpp-C2di29sC.js";
import { g as Bt } from "./getViewer-f7b0_qaE.js";
import { g as Pt } from "./getParameters-BanUaban.js";
import { g as Tt } from "./styles-CClJeH1b.js";
...
Promise.all([
  ...
  a.derive(() => {
    ...
    function ht(t, o, s, n, c) {
      ...
      const e = m.length - 1;
      P.set(e, c), T.set(e, N), L.set(e, V), S.set(e, st), y.set(e, 0), z.set(e, 0), O.set(e, 0), C.set(e, 0), F.set(e, ot);
    }
    function R(t, o, s, n, c) {
      ...
      const e = m.length - 1;
      T.set(e, N), F.set(e, ot), L.set(e, V), S.set(e, st), y.set(e, s), z.set(e, n), O.set(e, n), C.set(e, c), P.set(e, 0);
    }
    const u = [];
    for (let t = 0; t <= M; t++) {
