...
import { v as n, L as ta, M as pe, C as ue, b as he, V as ea, B as aa, a as oa } from "./theme-Dvy8oz6E.js";
import { P as sa } from "./tweakpane-BXg6ZhiP.js";
import { a as na } from "./analyze-CWooBpVN.js";
import { d as la, __tla as __tla_0 } from "./didacticCpp-Ci4FJJr7.js";
import { g as ca, c as ve, a as be } from "./getViewer-sAJH_bF_.js";
import { e as ra } from "./makeDraggable-zx2br6Yh.js";
import { g as ia } from "./getParameters-BAMvp3bK.js";
import { g as ma } from "./styles-C0vEGWQ9.js";
...
Promise.all([
  ...
  n.derive(() => {
    ...
    for (let t = 0; t <= g; t++) {
      ...
      for (let a = 0; a <= f; a++) {
        const s = -m / 2 + a * nt;
        t === 0 ? e.push(j(s, -d / 2)) : e.push(C(s, -d / 2, u + t * q));
      }
      P.push(e);
    }
    ...
    for (let t = 0; t <= g; t++) {
      ...
      for (let a = 0; a <= x; a++) {
        const s = -d / 2 + a * lt;
        t === 0 ? e.push(j(-m / 2, s)) : a === 0 ? e.push(P[t][0]) : a === x ? e.push(N[t][0]) : e.push(C(-m / 2, s, u + t * q));
      }
      z.push(e);
    }
    ...
    for (let t = 0; t <= g; t++) {
      ...
      for (let a = 0; a <= x; a++) {
        const s = -d / 2 + a * lt;
        t === 0 ? e.push(j(m / 2, s)) : a === 0 ? e.push(P[t][f]) : a === x ? e.push(N[t][f]) : e.push(C(m / 2, s, u + t * q));
      }
      k.push(e);
    }
    ...
    function A(t, e, a, s) {
      const [c, l] = t, [_, T] = e, At = a[0][s], zt = j(c + _ * Gt, l + T * Gt), de = a[Math.min(Se, a.length - 1)][s];
      S(At, zt, de, de, O);
    }
  ...
  document.body.append(ia(i), Ce, ma({
