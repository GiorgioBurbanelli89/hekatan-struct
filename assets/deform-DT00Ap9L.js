...
let __tla = (async () => {
  ...
  On = function(ae, d, Ae) {
    ...
    if (d && d.length > 0) {
      ...
      const W = document.querySelector("meta[property=csp-nonce]"), I = (W == null ? void 0 : W.nonce) || (W == null ? void 0 : W.getAttribute("nonce"));
      q = Promise.allSettled(d.map((L) => {
        if (L = Mn(L), L in gr) return;
        gr[L] = true;
        const $ = L.endsWith(".css"), Z = $ ? '[rel="stylesheet"]' : "";
        if (document.querySelector(`link[href="${L}"]${Z}`)) return;
        const z = document.createElement("link");
        if (z.rel = $ ? "stylesheet" : Dn, $ || (z.as = "script"), z.crossOrigin = "", z.href = L, I && z.setAttribute("nonce", I), document.head.appendChild(z), $) return new Promise((ee, Y) => {
          z.addEventListener("load", ee), z.addEventListener("error", () => Y(new Error(`Unable to preload CSS for ${L}`)));
        });
      }));
    }
    function B(W) {
      ...
      if (I.payload = W, window.dispatchEvent(I), !I.defaultPrevented) throw W;
    }
    return q.then((W) => {
      for (const I of W || []) I.status === "rejected" && B(I.reason);
      return ae().catch(B);
    });
  };
  Cn = async function(Q = {}) {
    ...
    var d = Q, Ae = !!globalThis.window, q = !!globalThis.WorkerGlobalScope, B = ((_b = (_a = globalThis.process) == null ? void 0 : _a.versions) == null ? void 0 : _b.node) && ((_c = globalThis.process) == null ? void 0 : _c.type) != "renderer", W = !Ae && !B && !q;
    if (B) {
      const { createRequire: e } = await On(() => import("./__vite-browser-external-D7Ct-6yo.js").then((r) => r._), []);
      var I = e(import.meta.url);
    }
    var L = "./this.program", $ = import.meta.url, Z = "";
    function z(e) {
    ...
    if (B) {
      ...
      var Pe = I("fs");
      $.startsWith("file:") && (Z = I("path").dirname(I("url").fileURLToPath($)) + "/"), Y = (r) => {
        r = ce(r) ? new URL(r) : r;
      ...
      q && (Y = (e) => {
        ...
        if (ce(e)) return new Promise((t, n) => {
    ...
    var ge = console.log.bind(console), M = console.error.bind(console);
    u(!W, "shell environment detected but not enabled at build time.  Add `shell` to `-sENVIRONMENT` to enable.");
    var se;
    ...
    function Re() {
      if (!ye) {
        ...
        (r != 34821223 || t != 2310721022) && T(`Stack overflow! Stack cookie has been overwritten at ${fe(e)}, expected hex dwords 0x89BACDFE and 0x2135467, but received ${fe(t)} ${fe(r)}`), F[0] != 1668509029 && T("Runtime error: The application has corrupted its heap memory area (address zero)!");
      }
    }
    ...
    function He(e) {
      Object.getOwnPropertyDescriptor(d, e) || Object.defineProperty(d, e, {
        ...
        get() {
          ...
          wr(e) && (r += ". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you"), T(r);
        }
      });
    }
    var je, $e, U, le, we, F, x, de = false;
    function Ge() {
      var e = Te.buffer;
      U = new Int8Array(e), d.HEAPU8 = le = new Uint8Array(e), we = new Int32Array(e), d.HEAPU32 = F = new Uint32Array(e), d.HEAPF64 = new Float64Array(e), x = new BigInt64Array(e), new BigUint64Array(e);
    }
    ...
    function kr() {
      if (d.preRun) for (typeof d.preRun == "function" && (d.preRun = [
        d.preRun
      ]); d.preRun.length; ) Cr(d.preRun.shift());
      Ee("preRun"), Ve(Ye);
    }
    function Fr() {
      u(!de), de = true, Re(), !d.noFSInit && !i.initialized && i.init(), ie.__wasm_call_ctors(), i.ignorePermissions = false;
    }
    function br() {
      if (Re(), d.postRun) for (typeof d.postRun == "function" && (d.postRun = [
        d.postRun
      ]); d.postRun.length; ) Or(d.postRun.shift());
      Ee("postRun"), Ve(qe);
    }
    function T(e) {
      var _a2;
      (_a2 = d.onAbort) == null ? void 0 : _a2.call(d, e), e = "Aborted(" + e + ")", M(e), ye = true;
      var r = new WebAssembly.RuntimeError(e);
      throw $e == null ? void 0 : $e(r), r;
    }
    function D(e, r) {
      return (...t) => {
        u(de, `native function \`${e}\` called before runtime initialization`);
        var n = ie[e];
    ...
    var De;
    function Tr() {
      return d.locateFile ? z("deform.wasm") : new URL("/hekatan-struct/assets/deform-kQnINkrQ.wasm", import.meta.url).href;
    }
    function Ar(e) {
      if (e == De && se) return new Uint8Array(se);
      if (Y) return Y(e);
    ...
    async function Rr(e, r) {
      try {
        var t = await Pr(e), n = await WebAssembly.instantiate(t, r);
        return n;
      } catch (o) {
        M(`failed to asynchronously prepare wasm: ${o}`), ce(e) && M(`warning: Loading from a file URI (${e}) is not supported in most browsers. See https://emscripten.org/docs/getting_started/FAQ.html#how-do-i-run-a-local-webserver-for-testing-why-does-my-program-stall-in-downloading-or-preparing`), T(o);
      }
    }
    ...
    function Dr() {
      var e = {
        env: hr,
        wasi_snapshot_preview1: hr
      };
      return e;
    }
    async function Mr() {
      function e(s, c) {
        return ie = s.exports, Dt(ie), Ge(), ie;
      }
      var r = d;
      function t(s) {
      ...
      De ?? (De = Tr());
      var o = await Nr(se, De, n), a = t(o);
      return a;
    }
    var Ve = (e) => {
      for (; e.length > 0; ) e.shift()(d);
    }, qe = [], Or = (e) => qe.push(e), Ye = [], Cr = (e) => Ye.push(e), fe = (e) => (u(typeof e == "number", `ptrToString expects a number, got ${typeof e}`), e >>>= 0, "0x" + e.toString(16).padStart(8, "0")), y = (e) => dr(e), E = () => ur(), ue = (e) => {
      ue.shown || (ue.shown = {}), ue.shown[e] || (ue.shown[e] = 1, B && (e = "warning: " + e), M(e));
    }, Xe = globalThis.TextDecoder && new TextDecoder(), Ir = (e, r, t, n) => {
      ...
      for (var a = ""; r < o; ) {
        ...
        var l = e[r++] & 63;
        if ((s & 240) == 224 ? s = (s & 15) << 12 | c << 6 | l : ((s & 248) != 240 && ue("Invalid UTF-8 leading byte " + fe(s) + " encountered when deserializing a UTF-8 string in wasm memory to a JS string!"), s = (s & 7) << 18 | c << 12 | l << 6 | e[r++] & 63), s < 65536) a += String.fromCharCode(s);
        else {
          var f = s - 65536;
      ...
      return a;
    }, X = (e, r, t) => (u(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? re(le, e, r) : ""), xr = (e, r, t, n) => T(`Assertion failed: ${X(e)}, at: ` + [
      r ? X(r) : "unknown filename",
      t,
      n ? X(n) : "unknown function"
    ]), _e = [], Se = 0, Lr = (e) => {
      var r = new Me(e);
      return r.get_caught() || (r.set_caught(true), Se--), r.set_rethrown(false), _e.push(r), vr(e);
    }, j = 0, Ur = () => {
      p(0, 0), u(_e.length > 0);
      var e = _e.pop();
      Be(e.excPtr), j = 0;
    ...
    class Me {
      ...
      set_caught(r) {
        r = r ? 1 : 0, U[this.ptr + 12] = r;
      }
      get_caught() {
        return U[this.ptr + 12] != 0;
      }
      set_rethrown(r) {
        r = r ? 1 : 0, U[this.ptr + 13] = r;
      }
      get_rethrown() {
    ...
    var ke = (e) => cr(e), Ke = (e) => {
      ...
      var r = e.excPtr;
      throw e.get_rethrown() || (_e.push(e), e.set_rethrown(true), e.set_caught(false), Se++), be(r), j = new Ne(r), j;
    }, Hr = (e, r, t) => {
      var n = new Me(e);
      throw n.init(r, t), be(e), j = new Ne(e), Se++, j;
    }, jr = () => Se, $r = (e) => {
      throw j || (j = new Ne(e)), j;
    }, Gr = () => T("native code called abort()"), Je = (e, r, t, n) => {
      ...
      for (var o = t, a = t + n - 1, s = 0; s < e.length; ++s) {
        ...
        if (c <= 127) {
          ...
          if (t + 3 >= a) break;
          c > 1114111 && ue("Invalid Unicode code point " + fe(c) + " encountered when serializing a JS string to a UTF-8 string in wasm memory! (Valid unicode code points should be in range 0-0x10FFFF)."), r[t++] = 240 | c >> 18, r[t++] = 128 | c >> 12 & 63, r[t++] = 128 | c >> 6 & 63, r[t++] = 128 | c & 63, s++;
        }
      }
      return r[t] = 0, t - o;
    }, me = (e, r, t) => (u(typeof t == "number", "stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), Je(e, le, r, t)), Fe = (e) => {
      ...
      F[e >> 2] = f * 60, we[r >> 2] = +(c != l);
      var m = (h) => {
        var S = h >= 0 ? "-" : "+", P = Math.abs(h), R = String(Math.floor(P / 60)).padStart(2, "0"), N = String(P % 60).padStart(2, "0");
        return `UTC${S}${R}${N}`;
      }, v = m(c), _ = m(l);
      u(v), u(_), u(Fe(v) <= 16, `timezone name truncated to fit in TZNAME_MAX (${v})`), u(Fe(_) <= 16, `timezone name truncated to fit in TZNAME_MAX (${_})`), l < c ? (me(v, t, 17), me(_, n, 17)) : (me(v, n, 17), me(_, t, 17));
    }, qr = () => performance.now(), Yr = () => Date.now(), Xr = (e) => e >= 0 && e <= 3, Kr = 9007199254740992, Jr = -9007199254740992, Qr = (e) => e < Jr || e > Kr ? NaN : Number(e);
    function Zr(e, r, t) {
      if (!Xr(e)) return 28;
      var n;
      e === 0 ? n = Yr() : n = qr();
      var o = Math.round(n * 1e3 * 1e3);
      return x[t >> 3] = BigInt(o), 0;
    }
    var et = () => 2147483648, rt = (e, r) => (u(r, "alignment argument is required"), Math.ceil(e / r) * r), tt = (e) => {
      var r = Te.buffer.byteLength, t = (e - r + 65535) / 65536 | 0;
      try {
        return Te.grow(t), Ge(), 1;
      } catch (n) {
      ...
      if (!ve.strings) {
        ...
        for (var t in Oe) Oe[t] === void 0 ? delete r[t] : r[t] = Oe[t];
        var n = [];
      ...
      var n = Fe(e) + 1, o = new Array(n), a = Je(e, o, 0, o.length);
      return o.length = a, o;
    }, ct = () => {
      var _a2;
      if (!Ce.length) {
...
`));
      ...
      register(e, r) {
        K.ttys[e] = {
          ...
          output: [],
          ops: r
        }, i.registerDevice(e, K.stream_ops);
      },
      stream_ops: {
        open(e) {
          var r = K.ttys[e.node.rdev];
      ...
      default_tty_ops: {
        ...
        put_char(e, r) {
          r === null || r === 10 ? (ge(re(e.output)), e.output = []) : r != 0 && e.output.push(r);
        },
        fsync(e) {
          var _a2;
          ((_a2 = e.output) == null ? void 0 : _a2.length) > 0 && (ge(re(e.output)), e.output = []);
        },
        ioctl_tcgets(e) {
          return {
            c_iflag: 25856,
      ...
      default_tty1_ops: {
        put_char(e, r) {
          r === null || r === 10 ? (M(re(e.output)), e.output = []) : r != 0 && e.output.push(r);
        },
        fsync(e) {
          var _a2;
          ((_a2 = e.output) == null ? void 0 : _a2.length) > 0 && (M(re(e.output)), e.output = []);
        }
      }
    }, Ze = (e) => {
      ...
      stream_ops: {
        ...
        write(e, r, t, n, o, a) {
          if (u(!(r instanceof ArrayBuffer)), r.buffer === U.buffer && (a = false), !n) return 0;
          var s = e.node;
        ...
        mmap(e, r, t, n, o) {
          ...
          if (!(o & 2) && c && c.buffer === U.buffer) s = false, a = c.byteOffset;
          else {
            if (s = true, a = Ze(), !a) throw new i.ErrnoError(48);
            c && ((t > 0 || t + r < c.length) && (c.subarray ? c = c.subarray(t, t + r) : c = Array.prototype.slice.call(c, t, t + r)), U.set(c, a));
          }
          return {
            ptr: a,
            allocated: s
    ...
    }, ut = (...e) => i.createDataFile(...e), _t = (e) => {
      for (var r = e; ; ) {
        if (!ne[e]) return e;
        e = r + Math.random();
      }
    }, J = 0, he = null, ne = {}, G = null, mt = (e) => {
      var _a2;
      if (J--, (_a2 = d.monitorRunDependencies) == null ? void 0 : _a2.call(d, J), u(e, "removeRunDependency requires an ID"), u(ne[e]), delete ne[e], J == 0 && (G !== null && (clearInterval(G), G = null), he)) {
        var r = he;
        he = null, r();
      }
    }, vt = (e) => {
      var _a2, _b2;
      J++, (_a2 = d.monitorRunDependencies) == null ? void 0 : _a2.call(d, J), u(e, "addRunDependency requires an ID"), u(!ne[e]), ne[e] = 1, G === null && globalThis.setInterval && (G = setInterval(() => {
        if (ye) {
          clearInterval(G), G = null;
          return;
        }
        var r = false;
        for (var t in ne) r || (r = true, M("still waiting on run dependencies:")), M(`dependency: ${t}`);
        r && M("(end of list)");
      }, 1e4), (_b2 = G.unref) == null ? void 0 : _b2.call(G));
    }, rr = [], ht = async (e, r) => {
      typeof Browser < "u" && Browser.init();
      for (var t of rr) if (t.canHandle(r)) return u(t.handle.constructor.name === "AsyncFunction", "Filesystem plugin handlers must be async functions (See #24914)"), t.handle(e, r);
      return e;
    }, tr = async (e, r, t, n, o, a, s, c) => {
      var l = r ? te.resolve(A.join2(e, r)) : e, f = _t(`cp ${l}`);
      vt(f);
      try {
        var m = t;
        typeof t == "string" && (m = await ft(t)), m = await ht(m, l), c == null ? void 0 : c(), a || ut(e, r, m, n, o, s);
      } finally {
        mt(f);
      }
    }, pt = (e, r, t, n, o, a, s, c, l, f) => {
      tr(e, r, t, n, o, c, l, f).then(a).catch(s);
    }, i = {
      root: null,
      mounts: [],
      devices: {},
      ...
      symlink(e, r) {
        if (!te.resolve(e)) throw new i.ErrnoError(44);
      ...
      rename(e, r) {
        ...
        var f = i.lookupNode(c, o), m = te.relative(e, n);
        if (m.charAt(0) !== ".") throw new i.ErrnoError(28);
        if (m = te.relative(r, t), m.charAt(0) !== ".") throw new i.ErrnoError(55);
        var v;
        try {
          v = i.lookupNode(l, a);
        } catch {
      ...
      open(e, r, t = 438) {
        if (e === "") throw new i.ErrnoError(44);
        r = typeof r == "string" ? lt(r) : r, r & 64 ? t = t & 4095 | 32768 : t = 0;
        var n, o;
      ...
      readFile(e, r = {}) {
        ...
        return i.read(t, a, 0, o, 0), r.encoding === "utf8" && (a = re(a)), i.close(t), a;
      },
      writeFile(e, r, t = {}) {
        t.flags = t.flags || 577;
        var n = i.open(e, t.flags, t.mode);
        typeof r == "string" && (r = new Uint8Array(Ie(r))), ArrayBuffer.isView(r) ? i.write(n, r, 0, r.byteLength, void 0, t.canOwn) : T("Unsupported data type"), i.close(n);
      },
      cwd: () => i.currentPath,
      chdir(e) {
        var r = i.lookupPath(e, {
      ...
      createDefaultDevices() {
        i.mkdir("/dev"), i.registerDevice(i.makedev(1, 3), {
          ...
          write: (n, o, a, s, c) => s,
          llseek: () => 0
        }), i.mkdev("/dev/null", i.makedev(1, 3)), K.register(i.makedev(5, 0), K.default_tty_ops), K.register(i.makedev(6, 0), K.default_tty1_ops), i.mkdev("/dev/tty", i.makedev(5, 0)), i.mkdev("/dev/tty1", i.makedev(6, 0));
      ...
      createFile(e, r, t, n, o) {
        var a = A.join2(typeof e == "string" ? e : i.getPath(e), r), s = xe(n, o);
        return i.create(a, s);
      },
      createDataFile(e, r, t, n, o, a) {
        var s = r;
        e && (e = typeof e == "string" ? e : i.getPath(e), s = r ? A.join2(e, r) : e);
        var c = xe(n, o), l = i.create(s, c);
        if (t) {
          if (typeof t == "string") {
      ...
      createDevice(e, r, t, n) {
        var _a2;
        var o = A.join2(typeof e == "string" ? e : i.getPath(e), r), a = xe(!!t, !!n);
      ...
      createLazyFile(e, r, t, n, o) {
        class a {
          ...
          cacheLength() {
            ...
            var h = Number(_.getResponseHeader("Content-length")), S, P = (S = _.getResponseHeader("Accept-Ranges")) && S === "bytes", R = (S = _.getResponseHeader("Content-Encoding")) && S === "gzip", N = 1024 * 1024;
            P || (N = h);
            var C = (H, oe) => {
              H > oe && T("invalid range (" + H + ", " + oe + ") or no bytes requested!"), oe > h - 1 && T("only " + h + " bytes available! programmer error!");
              var O = new XMLHttpRequest();
              return O.open("GET", t, false), h !== N && O.setRequestHeader("Range", "bytes=" + H + "-" + oe), O.responseType = "arraybuffer", O.overrideMimeType && O.overrideMimeType("text/plain; charset=x-user-defined"), O.send(null), O.status >= 200 && O.status < 300 || O.status === 304 || T("Couldn't load " + t + ". Status: " + O.status), O.response !== void 0 ? new Uint8Array(O.response || []) : Ie(O.responseText || "");
            }, V = this;
            V.setDataGetter((H) => {
              var oe = H * N, O = (H + 1) * N - 1;
              return O = Math.min(O, h - 1), typeof V.chunks[H] > "u" && (V.chunks[H] = C(oe, O)), typeof V.chunks[H] > "u" && T("doXHR failed!"), V.chunks[H];
            }), (R || !h) && (N = h = 1, h = this.getter(0).length, N = h, ge("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = h, this._chunkSize = N, this.lengthKnown = true;
          }
          get length() {
        ...
        if (globalThis.XMLHttpRequest) {
          q || T("Cannot do synchronous binary XHRs outside webworkers in modern browsers. Use --embed-file or --preload-file in emcc");
          var s = new a(), c = {
            isDevice: false,
            contents: s
          };
        ...
        function m(v, _, h, S, P) {
          var R = v.node.contents;
          if (P >= R.length) return 0;
          var N = Math.min(R.length - P, S);
          if (u(N >= 0), R.slice) for (var C = 0; C < N; C++) _[h + C] = R[P + C];
          else for (var C = 0; C < N; C++) _[h + C] = R.get(P + C);
          return N;
        }
        return f.read = (v, _, h, S, P) => (i.forceLoadFile(l), m(v, _, h, S, P)), f.mmap = (v, _, h, S, P) => {
          i.forceLoadFile(l);
          var R = Ze();
          if (!R) throw new i.ErrnoError(48);
          return m(v, U, R, _, h), {
            ptr: R,
            allocated: true
          };
      ...
      writeStat(e, r) {
        F[e >> 2] = r.dev, F[e + 4 >> 2] = r.mode, F[e + 8 >> 2] = r.nlink, F[e + 12 >> 2] = r.uid, F[e + 16 >> 2] = r.gid, F[e + 20 >> 2] = r.rdev, x[e + 24 >> 3] = BigInt(r.size), we[e + 32 >> 2] = 4096, we[e + 36 >> 2] = r.blocks;
        var t = r.atime.getTime(), n = r.mtime.getTime(), o = r.ctime.getTime();
        return x[e + 40 >> 3] = BigInt(Math.floor(t / 1e3)), F[e + 48 >> 2] = t % 1e3 * 1e3 * 1e3, x[e + 56 >> 3] = BigInt(Math.floor(n / 1e3)), F[e + 64 >> 2] = n % 1e3 * 1e3 * 1e3, x[e + 72 >> 3] = BigInt(Math.floor(o / 1e3)), F[e + 80 >> 2] = o % 1e3 * 1e3 * 1e3, x[e + 88 >> 3] = BigInt(r.ino), 0;
      },
      writeStatFs(e, r) {
        F[e + 4 >> 2] = r.bsize, F[e + 60 >> 2] = r.bsize, x[e + 8 >> 3] = BigInt(r.blocks), x[e + 16 >> 3] = BigInt(r.bfree), x[e + 24 >> 3] = BigInt(r.bavail), x[e + 32 >> 3] = BigInt(r.files), x[e + 40 >> 3] = BigInt(r.ffree), F[e + 48 >> 2] = r.fsid, F[e + 64 >> 2] = r.flags, F[e + 56 >> 2] = r.namelen;
      },
      doMsync(e, r, t, n, o) {
        if (!i.isFile(r.node.mode)) throw new i.ErrnoError(43);
        if (n & 2) return 0;
        var a = le.slice(e, e + t);
        i.msync(r, a, o, t, n);
      },
      getStreamFromFD(e) {
    ...
    function Et(e, r, t, n) {
      try {
        var o = pe.getStreamFromFD(e), a = yt(o, r, t);
        return F[n >> 2] = a, 0;
      } catch (s) {
    ...
    function wt(e, r, t, n) {
      ...
      try {
        ...
        var o = pe.getStreamFromFD(e);
        return i.llseek(o, r, t), x[n >> 3] = BigInt(o.position), o.getdents && r === 0 && t === 0 && (o.getdents = null), 0;
      } catch (a) {
    ...
    function kt(e, r, t, n) {
      try {
        var o = pe.getStreamFromFD(e), a = St(o, r, t);
        return F[n >> 2] = a, 0;
      } catch (s) {
        if (typeof i > "u" || s.name !== "ErrnoError") throw s;
        return s.errno;
    ...
    Rt.forEach(He), d.incrementExceptionRefcount = bt, d.decrementExceptionRefcount = Tt, d.getExceptionMessage = or;
    function Nt() {
      Er("fetchSettings");
    }
    d._deform = b("_deform"), d._malloc = b("_malloc");
    var Le = d._free = b("_free");
    ...
    var hr = {
      ...
      _tzset_js: Vr,
      clock_time_get: Zr,
      emscripten_resize_heap: nt,
      environ_get: ot,
      environ_sizes_get: at,
      fd_close: gt,
      fd_read: Et,
      fd_seek: wt,
      fd_write: kt,
      ...
      invoke_iiiiiiii: qt,
      invoke_iiiiiiiii: Vt,
      invoke_iiiiiiiiii: Gt,
      invoke_iiiiiiiiiii: Sn,
      invoke_iiiiiiiiiiii: Pn,
      invoke_iiiiiiiiiiiii: Fn,
      invoke_iiiiiiiiiiiiiii: $t,
      invoke_j: En,
      invoke_jiiii: kn,
      invoke_v: Ot,
      invoke_vddiiii: cn,
      ...
      invoke_viiiii: It,
      invoke_viiiiid: nn,
      invoke_viiiiidiii: dn,
      invoke_viiiiii: Ut,
      invoke_viiiiiid: on,
      invoke_viiiiiii: Kt,
      invoke_viiiiiiidiiii: Jt,
      invoke_viiiiiiii: Xt,
      invoke_viiiiiiiii: Yt,
      invoke_viiiiiiiiii: jt,
      invoke_viiiiiiiiiidii: sn,
      invoke_viiiiiiiiiii: tn,
      invoke_viiiiiiiiiiiddddii: _n,
      invoke_viiiiiiiiiiii: an,
      invoke_viiiiiiiiiiiiiii: Rn,
      invoke_viiiiiiiiiiiiiiii: Ht,
      llvm_eh_typeid_for: Ft
    };
    function Mt(e, r, t, n) {
      var o = E();
      try {
    ...
    function Ht(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, P, R) {
      var N = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, P, R);
      } catch (C) {
        if (y(N), !(C instanceof g)) throw C;
        p(1, 0);
      }
    }
    ...
    function $t(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S) {
      var P = E();
      try {
        return w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S);
      } catch (R) {
        if (y(P), !(R instanceof g)) throw R;
        p(1, 0);
      }
    }
    function Gt(e, r, t, n, o, a, s, c, l, f) {
      var m = E();
      try {
    ...
    function Yt(e, r, t, n, o, a, s, c, l, f) {
      var m = E();
      try {
    ...
    function Jt(e, r, t, n, o, a, s, c, l, f, m, v, _) {
      var h = E();
      try {
    ...
    function tn(e, r, t, n, o, a, s, c, l, f, m, v) {
      var _ = E();
      try {
    ...
    function an(e, r, t, n, o, a, s, c, l, f, m, v, _) {
      var h = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, m, v, _);
      } catch (S) {
    ...
    function sn(e, r, t, n, o, a, s, c, l, f, m, v, _, h) {
      var S = E();
      try {
    ...
    function dn(e, r, t, n, o, a, s, c, l, f) {
      var m = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f);
      } catch (v) {
    ...
    function _n(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, P, R, N) {
      var C = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, P, R, N);
      } catch (V) {
        if (y(C), !(V instanceof g)) throw V;
        p(1, 0);
      }
    }
    ...
    function Sn(e, r, t, n, o, a, s, c, l, f, m) {
      var v = E();
      try {
    ...
    function Pn(e, r, t, n, o, a, s, c, l, f, m, v) {
      var _ = E();
      try {
    ...
    function Rn(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, P) {
      var R = E();
      try {
        w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, P);
      } catch (N) {
    ...
    function ze() {
      ...
      function e() {
        var _a2;
        u(!pr), pr = true, d.calledRun = true, !ye && (Fr(), je == null ? void 0 : je(d), (_a2 = d.onRuntimeInitialized) == null ? void 0 : _a2.call(d), Ee("onRuntimeInitialized"), u(!d._main, 'compiled without a main, but one is present. if you added it from JS, use Module["onRuntimeInitialized"]'), br());
      }
    ...
    var ie;
    ie = await Mr(), ze(), de ? ae = d : ae = new Promise((e, r) => {
      je = e, $e = r;
    });
    for (const e of Object.keys(d)) e in Q || Object.defineProperty(Q, e, {
      configurable: true,
      get() {
