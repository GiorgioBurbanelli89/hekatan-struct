const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/calcPanel-BtNNA8Jg.js","assets/getMesh-_M9lDnOs.js","assets/__vite-browser-external-D7Ct-6yo.js","assets/pureFunctionsAny.generated-DeJSBP3k.js","assets/analyze-DNPn2SjO.js","assets/didacticCpp-CCShk1kX.js","assets/deform-DpU98sna.js","assets/preload-helper-V2P8TQsQ.js","assets/cyclicPushoverCpp-Cj0lC_wj.js"])))=>i.map(i=>d[i]);
...
import { d as pt, p as Qn, m as pl, s as ul, __tla as __tla_0 } from "./didacticCpp-CCShk1kX.js";
...
`);
      ...
      y && (y.value = q, y.addEventListener("change", (x) => {
        ...
        x.stopPropagation(), na(async () => {
          const { openCalcPanel: S } = await import("./calcPanel-BtNNA8Jg.js").then(async (m2) => {
            await m2.__tla;
            return m2;
          });
          return {
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        try {
          const { cyclicPushover: g } = await na(async () => {
            const { cyclicPushover: k } = await import("./cyclicPushoverCpp-Cj0lC_wj.js");
            return {
              cyclicPushover: k
            };
