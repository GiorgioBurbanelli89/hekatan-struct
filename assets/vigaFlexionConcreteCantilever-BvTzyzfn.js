...
import { m as B, d as O, __tla as __tla_0 } from "./didacticCpp-DDG05360.js";
let G;
let __tla = Promise.all([
  ...
  G = {
    ...
    build(e, o) {
      ...
      const p = /* @__PURE__ */ new Map(), g = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map(), $ = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map();
      for (let t = 0; t < d.length; t++) p.set(t, e.E), g.set(t, s), v.set(t, a), w.set(t, i), M.set(t, r), F.set(t, m), E.set(t, n), $.set(t, D), L.set(t, _);
      ...
      const x = O(h, d, o.nodeInputs.val, o.elementInputs.val);
      o.deformOutputs.val = x, o.analyzeOutputs.val = y(h, d, o.elementInputs.val, x), o.objects3D.val = [];
      const I = c * e.L ** 4 / (8 * e.E * i), A = c * e.L ** 2 / (2 * s * n), f = I + A, k = ((_b = (_a = x.deformations) == null ? void 0 : _a.get(l)) == null ? void 0 : _b[2]) ?? 0, C = Math.abs(f) > 1e-15 ? (Math.abs(k) - f) / f * 100 : 0;
