import { K as It, a5 as bn, o as Ho, v as $, a6 as Wo, D as zt, d as Ge, B as fe, F as Mt, a7 as Go, w as at, a8 as qo, a9 as Jo, b as ho, aa as mo, p as jt, ab as zn, ac as Pn, a3 as Fo, Z as je, L as it, h as Dt, t as Vo, g as Qo, ad as Oo, i as et, V as m, _ as Ot, ae as Nn, G as Ao, a as vt, y as Cn, af as Fn, r as jo, m as es, H as Gt, a1 as hn, E as wo, f as rn, Q as Zn, ag as mn, C as yo, S as xo, c as go, e as vo, J as ts, N as ns, U as os, W as ss, T as _n, P as Un, X as as, Y as Mo, O as is } from "./theme-Buj43zQ_.js";
import { T as wt, O as bo } from "./Text-BaPYKrWi.js";
import { P as To } from "./tweakpane-BXg6ZhiP.js";
import { e as ls } from "./styles-CsTo04SN.js";
class Eo {
  constructor(i, x = 32) {
  ...
  setColorMap(i, x = 32) {
    this.map = Kn[i] || Kn.rainbow, this.n = x;
  ...
  updateCanvas(i) {
    const x = i.getContext("2d", { alpha: false }), h = x.getImageData(0, 0, 1, this.n), d = h.data;
    let _ = 0;
    const y = 1 / this.n, w = new It(), v = new It(), z = new It();
    for (let P = 1; P >= 0; P -= y) for (let b = this.map.length - 1; b >= 0; b--) if (P < this.map[b][0] && P >= this.map[b - 1][0]) {
...
const Kn = { rainbow: [[0, 255], [0.2, 65535], [0.5, 65280], [0.8, 16776960], [1, 16711680]], cooltowarm: [[0, 3952322], [0.2, 10206463], [0.5, 14474460], [0.8, 16163717], [1, 11797542]], blackbody: [[0, 0], [0.2, 7864320], [0.5, 15086080], [0.8, 16776960], [1, 16777215]], grayscale: [[0, 0], [0.2, 4210752], [0.5, 8355712], [0.8, 12566463], [1, 16777215]] }, $o = [[0, 255, 0, 255], [0.077, 255, 0, 180], [0.154, 255, 0, 0], [0.231, 255, 80, 0], [0.308, 255, 140, 0], [0.385, 255, 190, 0], [0.462, 255, 255, 0], [0.538, 180, 255, 0], [0.615, 0, 255, 0], [0.692, 0, 255, 180], [0.769, 0, 255, 255], [0.846, 0, 180, 255], [0.923, 0, 0, 255], [1, 0, 0, 180]], rs = { safe: [[0, 236, 0, 140], [0.13, 250, 25, 25], [0.28, 255, 100, 0], [0.42, 255, 165, 0], [0.55, 245, 230, 0], [0.7, 120, 230, 0], [0.83, 0, 230, 75], [0.93, 0, 225, 165], [1, 0, 205, 235]], csi: $o, jet_r: [[0, 200, 0, 0], [0.15, 255, 80, 0], [0.32, 255, 200, 0], [0.48, 180, 255, 0], [0.6, 0, 230, 90], [0.74, 0, 220, 230], [0.88, 0, 110, 255], [1, 0, 0, 180]], jet: [[0, 0, 0, 180], [0.12, 0, 110, 255], [0.26, 0, 220, 230], [0.4, 0, 230, 90], [0.52, 180, 255, 0], [0.68, 255, 200, 0], [0.85, 255, 80, 0], [1, 200, 0, 0]], viridis: [[0, 68, 1, 84], [0.25, 59, 82, 139], [0.5, 33, 145, 140], [0.75, 94, 201, 98], [1, 253, 231, 37]] }, Jn = $.state("safe");
function cs(e) {
  e = Math.max(0, Math.min(1, e));
  const i = rs[Jn.val] ?? $o;
  for (let h = 0; h < i.length - 1; h++) {
    const [d, _, y, w] = i[h], [v, z, P, b] = i[h + 1];
    if (e <= v) {
      const O = (e - d) / (v - d);
      return [_ + (z - _) * O, y + (P - y) * O, w + (b - w) * O];
    }
  }
...
function _o() {
  ...
  for (let h = 0; h < 256; h++) {
    const d = h / 255, [_, y, w] = cs(d);
    i[h * 4 + 0] = _, i[h * 4 + 1] = y, i[h * 4 + 2] = w, i[h * 4 + 3] = 255;
  }
  const x = new qo(i, 256, 1, Jo);
  return x.minFilter = ho, x.magFilter = ho, x.wrapS = mo, x.wrapT = mo, x.needsUpdate = true, x;
}
function ds(e, i, x) {
  new Eo();
  ...
  $.derive(() => {
    var _a;
    Jn.val;
    const y = d.uniforms.cmap.value;
    d.uniforms.cmap.value = _o(), (_a = y == null ? void 0 : y.dispose) == null ? void 0 : _a.call(y);
  });
  const _ = new Ge(new fe(), d);
  return _.renderOrder = -1, _.frustumCulled = false, _.userData.isShellArea = true, _.name = "__hekatan_shell_colormap", $.derive(() => {
    ...
    const y = [];
    for (const k of i.val) k.length === 3 ? y.push(k[0], k[1], k[2]) : k.length === 4 && (y.push(k[0], k[1], k[2]), y.push(k[0], k[2], k[3]));
    _.geometry.setIndex(new Go(y, 1));
    const w = x.val.filter((k) => Number.isFinite(k));
    let v, z;
    const P = jn.val;
    ...
    const b = P && P[0] > P[1], O = Math.min(z, v), ae = Math.max(z, v), ie = ae - O, ue = new Float32Array(x.val.length);
    for (let k = 0; k < x.val.length; k++) {
      const W = x.val[k];
      if (!Number.isFinite(W)) {
        ue[k] = -1;
        continue;
      }
      const ge = ((b ? ae + O - W : W) - O) / ie;
...
function ps(e, i, x) {
  ...
  const w = () => {
    ...
    b.addEventListener("mousedown", (W) => {
      O = true, ae = W.clientX, ie = W.clientY;
...
function fs(e, i, x) {
  ...
  return Fo((_, y) => {
    d.material.color.setHex(y.nodePoint);
    ...
    if (_.length >= 2) {
      ...
      y = Math.max(z[0] - v[0], z[1] - v[1], z[2] - v[2], 0.1);
    }
    const w = 0.03 * y;
    d.material.size = w * x.rawVal;
  }), $.derive(() => {
...
function Hn(e, i) {
  ...
  let _ = (i == null ? void 0 : i.majorStep) ?? 1, y = (i == null ? void 0 : i.minorStep) ?? 0.1;
  for (_ <= 0 && (_ = 1), y <= 0 && (y = 0.1); e / y > 500; ) y *= 2;
  for (; e / _ > 100; ) _ *= 2;
  const w = e / 2;
  _ = Math.max(y, Math.round(_ / y) * y);
  const z = new It(x.grid), P = new It(x.grid).multiplyScalar(0.45), b = (ae, ie, ue, k) => {
    const W = [], he = ae === "xy" ? (D, I) => [D, I, 0] : ae === "xz" ? (D, I) => [D, 0, I] : (D, I) => [0, D, I], ge = Math.floor(w / ie);
    for (let D = -ge; D <= ge; D++) {
    ...
    return Z.name = `grid-${ae}-${ie === y ? "minor" : "major"}`, Z;
  }, O = (ae, ie, ue) => {
    const k = ae === "xy" ? (Z, D) => [Z, D, 0] : ae === "xz" ? (Z, D) => [Z, 0, D] : (Z, D) => [0, Z, D], W = [[-w, -w], [w, -w], [w, w], [-w, w]], he = [];
    for (const [Z, D] of W) he.push(...k(Z, D));
    const ge = new fe();
  ...
  for (const ae of d) h.add(b(ae, y, P, 0.12)), h.add(b(ae, _, z, 0.4)), h.add(O(ae, z, 0.55));
  return h.position.set(0, 0, 0), window.__hekatanGridConfig = { majorStep: _, minorStep: y, gridSize: e, planes: [...d] }, h;
}
function hs(e, i, x, h) {
  const d = new je(), _ = new Qo(0.5, 0.5, 0.5), y = new Oo(0.45, 0.7, 4);
  ...
  return $.derive(() => {
    ...
    (_b = (_a = e.nodeInputs) == null ? void 0 : _a.val.supports) == null ? void 0 : _b.forEach((ie, ue) => {
      ...
      let Pe;
      he >= 3 && ge >= 3 ? Pe = new Ge(_, w) : he >= 3 && ge === 0 ? Pe = new Ge(y, v) : Pe = new Ge(y, z), Pe.position.set(k[0], k[1], k[2]);
      const K = ae * O();
...
function ms(e, i, x, h) {
  ...
  function _(y) {
    ...
    for (const P of y) for (let b = 0; b < 3; b++) w[b] = Math.min(w[b], P[b]), v[b] = Math.max(v[b], P[b]);
...
function ws(e, i, x) {
  ...
  return $.derive(() => {
    ...
    i.val.forEach((_, y) => {
      const w = new wt(`${y}`);
      w.position.set(..._), w.updateScale(d * x.rawVal), h.add(w);
    });
  }), $.derive(() => {
    if (x.val, !e.nodesIndexes.rawVal) return;
    const d = 0.05 * e.gridSize.val * 0.6;
    h.children.forEach((_) => _.updateScale(d * x.rawVal));
  }), $.derive(() => {
...
function ys(e, i, x, h) {
  ...
  return $.derive(() => {
    ...
    d.children.forEach((y) => y.dispose()), d.clear();
    const _ = 0.05 * i.gridSize.val * 0.6;
    (_a = e.elements) == null ? void 0 : _a.val.forEach((y, w) => {
      const v = new wt(`${w}`, void 0, "#001219");
      v.position.set(...xs(y.map((z) => x.rawVal[z]))), v.updateScale(_ * h.rawVal), d.add(v);
    });
  }), $.derive(() => {
    if (h.val, !i.elementsIndexes.rawVal) return;
    const _ = 0.05 * i.gridSize.val * 0.6;
    d.children.forEach((y) => y.updateScale(_ * h.rawVal));
  }), $.derive(() => {
    d.visible = i.elementsIndexes.val;
  }), d;
}
function xs(e) {
  const i = e.reduce((h, d) => [h[0] + d[0], h[1] + d[1], h[2] + d[2]], [0, 0, 0]), x = e.length;
  return [i[0] / x, i[1] / x, i[2] / x];
}
function So(e, i) {
  const x = new je(), h = 0.05 * e * 1, d = jt(), _ = new wt("X", "red", "transparent"), y = new wt(i ? "Z" : "Y", "green", "transparent"), w = new wt(i ? "Y" : "Z", "blue", "transparent"), v = new Ot(new m(1, 0, 0), new m(0, 0, 0), 1, d.axisArrow, 0.2, 0.2), z = new Ot(new m(0, 1, 0), new m(0, 0, 0), 1, d.axisArrow, 0.2, 0.2), P = new Ot(new m(0, 0, 1), new m(0, 0, 0), 1, d.axisArrow, 0.2, 0.2);
  return _.position.set(1.3 * h, 0, 0), y.position.set(0, 1.3 * h, 0), w.position.set(0, 0, 1.3 * h), _.updateScale(0.4 * h), y.updateScale(0.4 * h), w.updateScale(0.4 * h), v.scale.set(h, h, h), z.scale.set(h, h, h), P.scale.set(h, h, h), x.add(v, z, P, _, y, w), x;
}
function Qn(e, i) {
  const x = new m(...e), d = new m(...i).clone().sub(x), _ = d.length(), y = d.dot(new m(1, 0, 0)) / _, w = d.dot(new m(0, 1, 0)) / _, v = d.dot(new m(0, 0, 1)) / _, z = Math.sqrt(y ** 2 + w ** 2);
  let P = new Nn().fromArray([[y, w, v], [-w / z, y / z, 0], [-y * v / z, -w * v / z, z]].flat());
  return v === 1 && (P = new Nn().fromArray([[0, 0, 1], [0, 1, 0], [-1, 0, 0]].flat())), v === -1 && (P = new Nn().fromArray([[0, 0, -1], [0, 1, 0], [1, 0, 0]].flat())), new Ao().setFromMatrix3(P);
}
function Gn(e, i) {
...
function gs(e, i, x) {
  const h = wn([i, x]), d = wn([e, x]), _ = wn([e, i]), y = new m(...h).sub(new m(...d)).normalize(), w = new m(...x).sub(new m(..._)).normalize(), v = y.clone().cross(w).normalize(), z = v.clone().cross(y).normalize();
  return new Ao().makeBasis(y, z, v);
}
function vs(e, i, x, h) {
  const d = new je(), _ = new fe(), y = new it({ vertexColors: true }), w = [0, 0, 0], v = [1, 0, 0], z = [0, 1, 0], P = [0, 0, 1];
  ...
  return _.setAttribute("color", new Mt([...b, ...b, ...O, ...O, ...ae, ...ae], 3)), $.derive(() => {
    ...
    i.deformedShape.val, i.orientations.val && (d.clear(), (_a = e.elements) == null ? void 0 : _a.val.forEach((ie) => {
      const ue = new Dt(_, y), k = x.rawVal[ie[0]], W = x.rawVal[ie[1]];
      if (ie.length === 2 && (ue.position.set(...Gn(k, W)), ue.rotation.setFromRotationMatrix(Qn(k, W))), ie.length === 3) {
        const Pe = x.rawVal[ie[2]];
        ue.position.set(...wn([k, W, Pe])), ue.rotation.setFromRotationMatrix(gs(k, W, Pe));
      }
...
function bs(e, i, x, h) {
  ...
  function w(Z, D = 24) {
    ...
    for (let N = 0; N < D; N++) {
      const ne = N / D * Math.PI * 2, G = (N + 1) / D * Math.PI * 2;
      A[N * 9] = 0, A[N * 9 + 1] = 0, A[N * 9 + 2] = 0, A[N * 9 + 3] = 0, A[N * 9 + 4] = I * Math.cos(ne), A[N * 9 + 5] = I * Math.sin(ne), A[N * 9 + 6] = 0, A[N * 9 + 7] = I * Math.cos(G), A[N * 9 + 8] = I * Math.sin(G);
    }
    const E = new fe();
  ...
  function v(Z, D, I, A) {
    const E = I ?? D * 0.08, B = A ?? Z * 0.07, C = Z / 2, N = D / 2, ne = N - E, G = B / 2, H = [];
    ...
    const te = new Float32Array([0, -C, -N, 0, C, -N, 0, C, -ne, 0, G, -ne, 0, G, ne, 0, C, ne, 0, C, N, 0, -C, N, 0, -C, ne, 0, -G, ne, 0, -G, -ne, 0, -C, -ne, 0, -C, -N]), le = new fe();
  ...
  function O(Z, D, I, A) {
    ...
    const G = new fe();
    G.setAttribute("position", new at(new Float32Array(B), 3));
    const H = [];
  ...
  function ie(Z, D, I, A, E) {
    const B = D / 2, C = E / 2, N = [], ne = [[0, -Z, -B], [0, -Z, -B + I], [0, -C - A, -B + I], [0, -C - A, B - I], [0, -Z, B - I], [0, -Z, B], [0, -C, B], [0, -C, -B]], G = ne.map((le) => [le[0], -le[1], le[2]]), H = [0, 1, 7, 1, 6, 7, 1, 2, 6, 2, 5, 6, 2, 3, 5, 3, 4, 5];
  ...
  function ue(Z, D, I, A) {
    const E = Z / 2, B = D / 2, C = A / 2, N = [[0, -C, -B], [0, C, -B], [0, C, B - I], [0, E, B - I], [0, E, B], [0, -E, B], [0, -E, B - I], [0, -C, B - I]], ne = [0, 1, 7, 1, 2, 7, 6, 7, 5, 2, 3, 4, 2, 4, 5, 2, 5, 7], G = [];
    for (const te of ne) G.push(...N[te]);
    const H = new fe();
  ...
  function k(Z, D, I = 24) {
    const A = Z / 2, E = A - D, B = [];
    for (let G = 0; G < I; G++) {
      const H = G / I * Math.PI * 2, F = (G + 1) / I * Math.PI * 2, oe = Math.cos(H), te = Math.sin(H), le = Math.cos(F), re = Math.sin(F);
    ...
    const N = [];
    for (let G = 0; G < I; G++) {
      const H = G / I * Math.PI * 2, F = (G + 1) / I * Math.PI * 2;
  ...
  return $.derive(() => {
    ...
    I.forEach((C, N) => {
      ...
      const ne = x.rawVal[C[0]], G = x.rawVal[C[1]];
      if (!ne || !G) return;
      const H = K(ne, G);
      if (H && !Z || !H && !D) return;
      if (B >= 0) {
      ...
      if (!F) return;
      const oe = [(ne[0] + G[0]) / 2, (ne[1] + G[1]) / 2, (ne[2] + G[2]) / 2], te = Qn(ne, G);
      if (F.type === "CFT") {
...
class Sn extends je {
  constructor(i, x, h, d, _, y, w) {
    super();
    const v = new Cn().moveTo(0, 0).lineTo(0, y[1]).lineTo(h, y[1]).lineTo(h, 0).lineTo(0, 0), z = v.getPoints(), P = new fe().setFromPoints(z);
    ...
    const b = new Fn(v), O = new et({ color: y[1] > 0 ? 24435 : 11411474, side: zt });
    this.mesh = new Ge(b, O), this.mesh.position.set(...i), this.mesh.rotation.setFromRotationMatrix(d), w && this.mesh.rotateX(Math.PI / 2), this.add(this.mesh), this.text = new wt(`${_[1].toFixed(4)}`), this.normalizedResult = y, this.textPosition = wn([i, x]), this.text.position.set(...this.textPosition), this.text.rotation.setFromRotationMatrix(d), this.add(this.text);
  }
  updateScale(i) {
...
class ko extends je {
  constructor(i, x, h, d, _, y, w) {
    ...
    if (this.text = new wt(`${_[0].toFixed(4)}`), this.text2 = new wt(`${(_[1] * -1).toFixed(4)}`), this.normalizedResult = y, this.textPosition = Gn(i, x), this.text2Position = Gn(x, i), this.text.position.set(...this.textPosition), this.text2.position.set(...this.text2Position), this.text.rotation.setFromRotationMatrix(d), this.text2.rotation.setFromRotationMatrix(d), this.add(this.text, this.text2), z) {
      const P = new Cn().moveTo(0, 0).lineTo(0, y[0]).lineTo(v, 0).lineTo(0, 0), b = new Cn().moveTo(v, 0).lineTo(h, -y[1]).lineTo(h, 0).lineTo(v, 0), O = P.getPoints(), ae = b.getPoints(), ie = new fe().setFromPoints(O), ue = new fe().setFromPoints(ae), k = new it({ color: jt().resultOutline });
      ...
      const W = new Fn(P), he = new Fn(b), ge = new et({ color: y[0] > 0 ? 24435 : 11411474, side: zt }), Pe = new et({ color: -y[1] > 0 ? 24435 : 11411474, side: zt });
      this.mesh = new Ge(W, ge), this.mesh2 = new Ge(he, Pe), this.mesh.position.set(...i), this.mesh2.position.set(...i), this.mesh.rotation.setFromRotationMatrix(d), this.mesh2.rotation.setFromRotationMatrix(d), w && this.mesh.rotateX(Math.PI / 2), w && this.mesh2.rotateX(Math.PI / 2), this.add(this.mesh, this.mesh2);
    } else {
      const P = new Cn().moveTo(0, 0).lineTo(0, y[0]).lineTo(h, -y[1]).lineTo(h, 0).lineTo(0, 0), b = P.getPoints(), O = new fe().setFromPoints(b);
      ...
      const ae = new Fn(P), ie = new et({ color: y[0] > 0 ? 24435 : 11411474, side: zt });
      this.mesh = new Ge(ae, ie), this.mesh.position.set(...i), this.mesh.rotation.setFromRotationMatrix(d), w && this.mesh.rotateX(Math.PI / 2), this.add(this.mesh);
    }
  }
  updateScale(i) {
    var _a, _b;
...
function _s(e, i, x, h) {
  ...
  return $.derive(() => {
    ...
    const y = Io[i.frameResults.rawVal];
    (_b = (_a = e.analyzeOutputs) == null ? void 0 : _a.rawVal[y]) == null ? void 0 : _b.forEach((w, v) => {
      var _a2, _b2;
      const z = ((_a2 = e.elements) == null ? void 0 : _a2.rawVal[v]) ?? [0, 1], P = x.rawVal[z[0]], b = x.rawVal[z[1]], O = new m(...b).distanceTo(new m(...P)), ae = Ss((_b2 = e.analyzeOutputs) == null ? void 0 : _b2.rawVal[y]), ie = w == null ? void 0 : w.map((he) => he / (ae === 0 ? 1 : ae)), ue = Qn(P, b), k = new _[y](P, b, O, ue, w ?? [0, 0], ie ?? [0, 0], !!["normals", "shearsZ", "torsions", "bendingsY"].includes(y)), W = 0.05 * i.gridSize.rawVal;
      k.updateScale(W * h.rawVal), d.add(k);
    });
  }), $.derive(() => {
    if (h.val, i.frameResults.rawVal == "none") return;
    const y = 0.05 * i.gridSize.val;
    d.children.forEach((w) => w.updateScale(y * h.rawVal));
  }), $.derive(() => {
...
function zs(e, i, x, h) {
  ...
  return $.derive(() => {
    ...
    d.children.forEach((w) => w.dispose()), d.clear();
    const _ = On[i.nodeResults.rawVal], y = 0.05 * i.gridSize.val;
    (_b = (_a = e.deformOutputs) == null ? void 0 : _a.val[_]) == null ? void 0 : _b.forEach((w, v) => {
      const z = new ks(x.rawVal[v], _, w ?? [0, 0, 0, 0, 0, 0]);
      z.updateScale(y * h.rawVal), d.add(z);
    });
  }), $.derive(() => {
...
function Ps({ drawingObj: e, gridObj: i, scene: x, getActiveCamera: h, controls: d, gridSize: _, derivedDisplayScale: y, rendererElm: w, viewerRender: v }) {
  const z = new jo(), P = new es(), b = (n) => {
  ...
  }, O = new Ge(new Gt(1e4, 1e4), new et({ side: zt, transparent: true, opacity: 0, depthWrite: false }));
  O.visible = true, O.frustumCulled = false, x.add(O);
  const ae = (n, o, a) => {
  ...
  const W = () => {
    ...
    if (ie.visible = !!window.__hekatanGridPlaneXZ, ue.visible = !!window.__hekatanGridPlaneYZ, window.__hekatanOrthoRaycast === true && De.visible) {
      const a = z.intersectObjects([De, Be, We], false);
  ...
  te.frustumCulled = false, te.visible = false, x.add(te);
  let le = [];
  const re = new je(), Fe = new Ge(new Gt(1, 1), new et({ color: 2282478, transparent: true, opacity: 0.08, side: zt, depthWrite: false })), ce = new Dt(new wo(new Gt(1, 1)), new it({ color: 2282478, transparent: true, opacity: 0.85 })), _e = new Dt(new fe(), new it({ color: 2282478, transparent: true, opacity: 0.3 })), Ze = (n, o) => {
  ...
  re.add(Fe, ce, _e), re.visible = false, re.frustumCulled = false, x.add(re);
  const j = new je();
  ...
  me.frustumCulled = false, me.visible = false, x.add(me), me.add(we, de, ze);
  const tt = (n) => {
  ...
  }, De = tt(3462041), Be = tt(16724804), We = tt(6333946);
  me.add(De, Be, We);
  const Ce = (n, o, a, t) => {
  ...
  Ke.id = "hk-refplane-badge", Ke.style.cssText = ["position:fixed", "pointer-events:none", "z-index:99997", "padding:3px 10px", "border-radius:4px", "font-family:Consolas,monospace", "font-size:12px", "font-weight:bold", "transform:translate(20px,40px)", "white-space:nowrap", "display:none"].join(";") + ";", document.body.appendChild(Ke), window.__hekatanSetOrthoPlanes = (n) => {
    ...
    if (window.__hekatanShowOrthoPlanes = n, me.visible = n, n) {
      ...
      Ft(we, s, "xy", l), Ft(de, s, "xz", l), Ft(ze, s, "yz", l), Ce(De, s, "xy", l), Ce(Be, s, "xz", l), Ce(We, s, "yz", l), De.material.opacity = 0.05, Be.material.opacity = 0.05, We.material.opacity = 0.05;
    } else {
    ...
    Ft(we, s, "xy", n), Ft(de, s, "xz", n), Ft(ze, s, "yz", n), Ce(De, s, "xy", n), Ce(Be, s, "xz", n), Ce(We, s, "yz", n), v();
  };
  const ot = (n) => {
    if (De.material.opacity = n === "xy" ? 0.09 : 0.025, Be.material.opacity = n === "xz" ? 0.09 : 0.025, We.material.opacity = n === "yz" ? 0.09 : 0.025, n) {
  ...
  Ie.renderOrder = 998, Ie.frustumCulled = false, Ie.visible = false, x.add(Ie);
  let Ue = -1, pt = -1, $e = -1;
  ...
  nt.renderOrder = 997, nt.frustumCulled = false, nt.visible = false, x.add(nt);
  ...
  lt.frustumCulled = false, x.add(lt);
  const ct = 2282478;
  let bt = null;
  const yn = (n, o, a, t) => {
  ...
  he.geometry.setAttribute("position", new Mt(e.points.rawVal.flat(), 3)), he.geometry.computeBoundingSphere(), he.frustumCulled = false, ge.frustumCulled = false, x.add(ge), O.position.set(0, 0, 0), O.rotateX(Math.PI / 2), O.geometry.rotateX(Math.PI / 2), O.updateMatrixWorld(), e.polylines && (e.polylines.val = [...e.polylines.rawVal, []]), window.__hekatanDrawAt = (n, o, a) => {
    ...
    for (let Xe = 0; Xe <= r; Xe++) {
      const Ve = Xe / r, He = Le * Ve, st = new Zn().setFromAxisAngle(ft, He), ht = ee.clone().applyQuaternion(st).add(T);
  ...
  window.__hekatanFinalizePolyArea = tn, window.__hekatanSetInclinedPlaneFrom3 = (n, o, a) => {
    ...
    l.normalize();
    const u = new Zn().setFromUnitVectors(new m(0, 0, 1), l), p = new mn().setFromQuaternion(u);
    ...
    Fe.geometry.dispose(), Fe.geometry = new Gt(M, M), ce.geometry.dispose(), ce.geometry = new wo(new Gt(M, M)), Ze(c, 1), re.position.copy(g), re.quaternion.copy(u), re.scale.set(1, 1, 1), re.visible = true;
    try {
  ...
  window.__hekatanShowRefPlanes = (n = [0, 3, 6, 9, 12], o = 20, a = 0, t = 0) => {
    ...
    n.forEach((s, l) => {
      ...
      const T = new Gt(1e4, 1e4), Q = new et({ visible: false, side: zt }), ee = new Ge(T, Q);
      ee.position.set(0, 0, s), ee.frustumCulled = false, ee.userData = { refPlaneZ: s }, x.add(ee), Ht.push(ee);
    }), Tt.visible = true, v();
  ...
  const Jt = new je();
  Jt.frustumCulled = false, x.add(Jt);
  const gn = () => {
    var _a, _b, _c, _d;
  ...
  const Yt = new je();
  Yt.frustumCulled = false, x.add(Yt);
  const eo = () => {
    var _a, _b, _c, _d;
  ...
  const ut = new je(), Lo = new Ge(new rn(0.01, 12, 12), new et({ color: 16724804, transparent: true, opacity: 0.95 })), Bo = new Ge(new rn(0.015, 12, 12), new et({ color: 16498468, transparent: true, opacity: 0.2, depthWrite: false }));
  ut.add(Lo, Bo);
  const nn = 0.08, En = (n, o, a) => {
    const t = new fe().setFromPoints([new m(...n), new m(...o)]);
    return new vt(t, new it({ color: a, transparent: true, opacity: 0.7 }));
  };
  ut.add(En([-nn, 0, 0], [nn, 0, 0], 16711680)), ut.add(En([0, -nn, 0], [0, nn, 0], 65280)), ut.add(En([0, 0, -nn], [0, 0, nn], 35071)), ut.visible = false, ut.frustumCulled = false, x.add(ut);
  const to = 40, Ro = 2.5, $n = () => {
    if (!ut.visible) return;
    const o = h().position.distanceTo(ut.position), a = Math.max(0.05, Math.min(Ro, o / to));
  ...
  window.__hekatanUpdateSelectionPtScale = no, d.addEventListener("change", () => {
    ...
    ut.position.set(n, o, a), ut.visible = true, $n(), v();
    ...
    if (a.length) {
      ...
      if (l === "delete") {
        ...
        S ? ($e = f, Ue = -1, pt = -1, Vn(f)) : c ? (Ue = c.polyIdx, pt = c.segIdx, $e = -1, An(c.polyIdx, c.segIdx)) : (Ue = -1, pt = -1, $e = -1, Ie.visible = false), oe.visible = false, j.visible = false, B(), H.style.left = n.clientX + "px", H.style.top = n.clientY + "px", H.style.display = "block";
      ...
      if (p.length > 0 && g[p[p.length - 1]]) {
        ...
        if (Lt = null, !f && window.__hekatanAxisSnap !== false) {
          ...
          for (const [Vt, gt] of Zt) {
            ...
            if (mt === null || fn < mt.dpx) {
              const Dn = z.ray, po = St.clone().sub(Dn.origin), Yn = gt.dot(Dn.direction), uo = gt.dot(po), Uo = Dn.direction.dot(po), fo = 1 - Yn * Yn, Ko = Math.abs(fo) < 1e-6 ? -uo : (Yn * Uo - uo) / fo;
              mt = { axis: Vt, dpx: fn, pt: St.clone().addScaledVector(gt, Ko) };
            }
          }
        ...
        if (!f && S) {
          ...
          let St = null;
          ht === De ? St = "xy" : ht === Be ? St = "xz" : ht === We && (St = "yz"), St === "xy" ? f = Ve >= He ? "x" : "y" : St === "xz" ? f = Ve >= st ? "x" : "z" : St === "yz" ? f = He >= st ? "y" : "z" : f = Ve >= He && Ve >= st ? "x" : He >= st ? "y" : "z";
        }
        ...
        if (f) {
          ...
          let mt = null;
          $t === De ? mt = "xy" : $t === Be ? mt = "xz" : $t === We && (mt = "yz");
        ...
        me.visible = pe, pe || ot(null), pe && (Ft(we, c, "xy", ee), Ft(de, c, "xz", ee), Ft(ze, c, "yz", ee), Ce(De, c, "xy", ee), Ce(Be, c, "xz", ee), Ce(We, c, "yz", ee));
        const Le = pe ? z.intersectObjects([De, Be, We], false) : [];
        let ye = null;
        if (Le.length > 0) {
          const Ve = Le[0].object;
          Ve === De ? ye = "xy" : Ve === Be ? ye = "xz" : Ve === We && (ye = "yz");
        }
      ...
      v();
    } else Bn(), H.style.display = "none", ut.visible = false, oe.visible = false, j.visible = false, B(), v();
  }), $.derive(() => {
    if (!e.gridTarget) return;
    Cs(i, { position: new m(...e.gridTarget.val.position), quaternion: new Zn().setFromEuler(new mn(...e.gridTarget.val.rotation)) }, v), O.position.set(...e.gridTarget.val.position), O.quaternion.setFromEuler(new mn(...e.gridTarget.val.rotation)), O.updateMatrixWorld();
  ...
  const dt = (n, o, a, t) => {
    ...
    Qe.addButton({ title: "\u2715 Cerrar (limpia selecci\xF3n)" }).on("click", () => {
      ve.clear(), Rt();
    }), kt.style.display = "block", Xo();
  };
  window.__hekatanRefreshPropsPane = Do;
  ...
  w.addEventListener("pointerdown", (n) => {
    ...
    if (Ct && n.buttons === 0) {
      ...
      Ln(Ct.x, Ct.y, n.clientX, n.clientY, s);
      return;
    }
    if (!Et) return;
    ...
    Ln(Et.x, Et.y, n.clientX, n.clientY, r);
  }), w.addEventListener("pointerup", (n) => {
    if (!Et) return;
    if (!cn) {
      Et = null;
  ...
  const Nt = new je();
  Nt.visible = false, Nt.frustumCulled = false, x.add(Nt);
  const Yo = { end: 16724804, mid: 16498468, node: 6333946, cen: 3462041, per: 12616956, nea: 16744118, int: 16746496 }, io = (n, o, a, t) => {
    var _a, _b, _c, _d;
    ...
    const r = Yo[n] ?? 16777215, s = 0.05, l = new fe().setFromPoints([new m(o - s, a - s, t), new m(o + s, a - s, t), new m(o + s, a - s, t), new m(o + s, a + s, t), new m(o + s, a + s, t), new m(o - s, a + s, t), new m(o - s, a + s, t), new m(o - s, a - s, t)]);
  ...
  window.__hekatanOsnapCompute = No, window.__hekatanOsnapShow = io, window.__hekatanOsnapHide = Bn;
  let Te = [], xt = 0;
  ...
  window.__hekatanEscapeCancel = co, window.__hekatanReplicateSelection = (n, o, a, t) => {
    ...
    if (r === "select" || r === "none" || !r) {
      if (bt) {
        ...
        Ct ? (oo(Ct.x, Ct.y, l, u, s), Ct = null) : s || (Ct = { x: l, y: u }, se("\u{1F5B1} Click 2 para cerrar el rect\xE1ngulo (\u2192 derecha=Window azul, \u2190izquierda=Crossing verde). Esc=cancelar."), Ln(l, u, l + 1, u + 1, false));
      }
      return;
    }
    if (r === "axis") {
    ...
    if (r === "delete") {
      if ($e >= 0) {
        ...
        const s = Ue, l = pt;
        ((_i = (_h = e.areas) == null ? void 0 : _h.rawVal) == null ? void 0 : _i.includes(s)) ?? false ? (en(s), se(`\u{1F5D1} \xC1rea #${s + 1} (shell Q4) borrada`)) : l >= 0 ? (Tn(s, l), se(`\u{1F5D1} Segmento ${l + 1} de polil\xEDnea #${s + 1} borrado`)) : (en(s), se(`\u{1F5D1} Polil\xEDnea #${s + 1} borrada`));
    ...
    if (I = false, Wt(), e.points.val = [...e.points.rawVal, t.toArray()], e.polylines && (e.polylines.val = [...e.polylines.rawVal.slice(0, -1), [...e.polylines.rawVal.length ? e.polylines.rawVal.pop() : [], e.points.rawVal.length - 1]]), e.polylines) {
  ...
  w.addEventListener("pointermove", (n) => {
    ...
    if (a && Qt < 5 && (Rn = true, d.enabled = false, Xn = t[0].index), !Rn || Qt % 2 !== 0) return;
    const s = [...e.points.rawVal];
    if (Xn !== void 0) {
      let l = r[0].point;
      (n.ctrlKey || n.metaKey) && (l = new m(Math.round(l.x), Math.round(l.y), Math.round(l.z))), s[Xn] = l.toArray();
    }
    e.points.val = s;
  }), w.addEventListener("pointerup", () => {
    d.enabled = true, Rn = false;
  }), w.addEventListener("contextmenu", (n) => {
    var _a;
    const o = b(n);
    if (!o) return;
...
function Cs(e, i, x) {
  const _ = Math.round(14.999999999999998), y = { position: e.position.clone(), quaternion: e.quaternion.clone() }, w = setInterval(z, 1e3 / 30);
  let v = 0;
  function z() {
    v++;
    const P = v / _;
    e.position.lerpVectors(y.position, i.position, P), e.quaternion.slerpQuaternions(y.quaternion, i.quaternion, P), x && x(), v == _ && clearInterval(w);
  }
}
function Fs(e, i, x, h) {
  const d = ds(x, e.elements, h);
  return $.derive(() => {
    d.visible = i.shellResults.val != "none";
  }), d;
}
const Vs = 6, Wn = 10, As = 0.012;
function Ts(e) {
...
function $s(e, i, x, h) {
  ...
  const y = new It(), w = $.state([]);
  return $.derive(() => {
    var _a, _b, _c;
    i.deformedShape.val;
    const v = x.val, z = ((_a = e.elements) == null ? void 0 : _a.val) ?? [], P = Ts(i.frameResults.val);
    ...
    const Pe = Math.max(he[0] - W[0], he[1] - W[1], he[2] - W[2], 1) * As, K = [], Z = [], D = [];
    let I = 0;
    for (const { idx: C, vals: N } of ie) {
      ...
      F.normalize();
      const te = Math.abs(F.y) < 0.99 ? new m(0, 1, 0) : new m(1, 0, 0), le = new m().crossVectors(F, te).normalize(), re = new m().crossVectors(F, le).normalize(), Fe = Wn + 1, ce = Vs;
      for (let _e = 0; _e < Fe; _e++) {
        const Ze = _e / Wn, j = G[0] + F.x * oe * Ze, Me = G[1] + F.y * oe * Ze, V = G[2] + F.z * oe * Ze, X = N[0] + (N[1] - N[0]) * Ze, J = _.getColor(X) ?? new It(0, 0, 0);
        y.copy(J).convertSRGBToLinear();
        for (let q = 0; q < ce; q++) {
          const we = q / ce * Math.PI * 2, de = Math.cos(we), ze = Math.sin(we);
          K.push(j + (le.x * de + re.x * ze) * Pe, Me + (le.y * de + re.y * ze) * Pe, V + (le.z * de + re.z * ze) * Pe), Z.push(y.r, y.g, y.b);
        }
      }
    ...
    const E = new et({ vertexColors: true, side: zt }), B = new Ge(A, E);
...
const Ls = { kN: 1, tonf: 1 / 9.80665, kip: 1 / 4.4482216 }, Bs = { mm: 1e3, cm: 100, m: 1, in: 39.3700787402 }, Rs = { "kN/m\xB2": 1, kPa: 1, MPa: 1 / 1e3, GPa: 1 / 1e6, "kgf/cm\xB2": 1 / 98.0665, "tonf/m\xB2": 1 / 9.80665, psi: 1 / 6.89476, ksi: 1 / 6894.76, "kip/ft\xB2": 1 / 47.88026 };
function rt(e, i = 4) {
  return e == null || !isFinite(e) ? "\u2014" : e === 0 ? "0" : Math.abs(e) < 1e-3 || Math.abs(e) > 1e5 ? e.toExponential(i) : e.toFixed(i);
}
const Xs = 16755200, zo = 56831, Ds = 56831, Ys = 56831, kn = 65382;
function Ns(e) {
  const i = new je();
  i.name = "__hekatan_hover", i.renderOrder = 99;
  const x = new rn(1, 16, 16), h = new et({ color: Xs, transparent: true, opacity: 0.85, depthTest: false }), d = new Ge(x, h);
  d.visible = false, d.renderOrder = 100, i.add(d);
  const _ = new fe(), y = new it({ color: zo, linewidth: 4, transparent: true, opacity: 0.9, depthTest: false }), w = new Dt(_, y);
  w.visible = false, w.renderOrder = 100, i.add(w);
  const v = new et({ color: zo, transparent: true, opacity: 0.7, depthTest: false }), z = new Ge(new vo(1, 1, 1, 12), v);
  z.visible = false, z.renderOrder = 100, i.add(z);
  const P = new fe(), b = new et({ color: Ds, transparent: true, opacity: 0.45, side: zt, depthTest: false }), O = new Ge(P, b);
  O.visible = false, O.renderOrder = 100, i.add(O);
  const ae = new fe(), ie = new it({ color: Ys, linewidth: 3, transparent: true, opacity: 0.95, depthTest: false }), ue = new Dt(ae, ie);
  ue.visible = false, ue.renderOrder = 100, i.add(ue);
  const k = new et({ color: kn, transparent: true, opacity: 0.95, depthTest: false }), W = new Ge(x, k);
  W.visible = false, W.renderOrder = 101, i.add(W);
  const he = new et({ color: kn, transparent: true, opacity: 0.85, depthTest: false }), ge = new Ge(new vo(1, 1, 1, 12), he);
  ge.visible = false, ge.renderOrder = 101, i.add(ge);
  const Pe = new fe(), K = new et({ color: kn, transparent: true, opacity: 0.55, side: zt, depthTest: false }), Z = new Ge(Pe, K);
  ...
  function N(j, Me) {
    ...
    const Ce = Is(), Ke = Bs[Ce.dispUnit] ?? 1e3, ot = Ls[Ce.forceUnit] ?? 1;
    if (Be >= 0) {
      const Ye = we[Be];
      let Ae = `Nodo ${Be}
    ...
    for (let Ye = 0; Ye < de.length; Ye++) {
      ...
      if (!(!Ae || Ae.length < 2)) {
        if (Ae.length === 2) {
          ...
          const Se = Zs(J, q, be.x, be.y, Ne.x, Ne.y);
      ...
      if (qe === "frame" && ((_m = e.mesh) == null ? void 0 : _m.deformOutputs) && e.mesh.elementInputs) {
        ...
        if (pt && Ye.length === 2) {
          ...
          if ($e && ve && nt && Je) {
            ...
            if (ct > 1e-9) {
              const bt = Bt / ct, yn = Xt / ct, Rt = lt / ct, qt = (ve[0] - $e[0]) * bt + (ve[1] - $e[1]) * yn + (ve[2] - $e[2]) * Rt, Kt = ((_n2 = Ue.elasticities) == null ? void 0 : _n2.get(Ee)) ?? 0, xn = ((_o2 = Ue.areas) == null ? void 0 : _o2.get(Ee)) ?? 0, Vn = ((_p = Ue.momentsOfInertiaY) == null ? void 0 : _p.get(Ee)) ?? 0, An = ((_q = Ue.momentsOfInertiaZ) == null ? void 0 : _q.get(Ee)) ?? 0, en = ((_r = Ue.torsionalConstants) == null ? void 0 : _r.get(Ee)) ?? 0, Tn = ((_s2 = Ue.shearModuli) == null ? void 0 : _s2.get(Ee)) ?? Kt / 2.6, tn = Kt * xn * (qt / ct), Pt = (ve[3] - $e[3]) * bt + (ve[4] - $e[4]) * yn + (ve[5] - $e[5]) * Rt, Tt = Tn * en * (Pt / ct), Ht = ve[4] - $e[4], Jt = ve[5] - $e[5], gn = Kt * Vn * Ht / ct, Yt = Kt * An * Jt / ct;
              be += `
\u2500\u2500\u2500\u2500 frame \u2500\u2500\u2500\u2500`, be += `
L = ${rt(ct, 3)} m`, be += `
...
Mz \u2248 ${rt(Yt * ot)} ${Ce.forceUnit}\xB7m`);
  ...
  function ne(j, Me, V) {
    ...
    if (j.type === "node") {
      ...
      if (de) {
        ...
        let me = 1;
        if (ze.length >= 2) {
          let Be = [1 / 0, 1 / 0, 1 / 0], We = [-1 / 0, -1 / 0, -1 / 0];
          for (const Ce of ze) for (let Ke = 0; Ke < 3; Ke++) Ce[Ke] < Be[Ke] && (Be[Ke] = Ce[Ke]), Ce[Ke] > We[Ke] && (We[Ke] = Ce[Ke]);
          me = Math.max(We[0] - Be[0], We[1] - Be[1], We[2] - Be[2], 0.1);
        }
      ...
      for (const [tt, De] of ze) {
        const Be = C(de[tt]), We = C(de[De]);
        Be && We && me.push(Be.x, Be.y, Be.z, We.x, We.y, We.z);
      }
  ...
  const oe = window.__hekatanHoverDebug ?? false, te = (j) => {
    H && cancelAnimationFrame(H), H = requestAnimationFrame(() => {
      ...
      if (V !== G) G = V, ne(Me, j.clientX, j.clientY);
      else if (Me) {
  ...
  let le = null;
  const re = () => {
    G = "", d.visible = false, w.visible = false, z.visible = false, O.visible = false, ue.visible = false, B.style.display = "none", e.render();
  }, Fe = (j) => {
...
function Zs(e, i, x, h, d, _) {
  const y = d - x, w = _ - h, v = y * y + w * w;
  if (v < 1e-9) {
    const ie = e - x, ue = i - h;
  ...
  const P = x + z * y, b = h + z * w, O = e - P, ae = i - b;
  return Math.sqrt(O * O + ae * ae);
}
function Us(e, i, x) {
  let h = false;
  for (let d = 0, _ = x.length - 1; d < x.length; _ = d++) {
    const y = x[d].x, w = x[d].y, v = x[_].x, z = x[_].y;
    w > i != z > i && e < (v - y) * (i - w) / (z - w + 1e-12) + y && (h = !h);
  }
  return h;
}
function Po(e, i = 8) {
  ...
  let _, y;
  d.forEach((v, z) => {
    _ = document.createElement("div"), _.id = `marker-${z}`, _.className = "marker", _.style.marginTop = z == 0 ? "0px" : `calc(${50 / i}vh - 1px)`, y = document.createElement("p"), y.id = `marker-text-${z}`, _.append(y), x.append(_);
  });
  const w = [];
  return x.querySelectorAll("p").forEach((v) => w.push(v)), setTimeout(() => {
    $.derive(() => {
      d.forEach((v, z) => {
        const P = w[z];
        P && (P.innerText = Ks(e.val, v).toString());
      });
    });
  }), x;
}
...
function oa({ mesh: e, settingsObj: i, drawingObj: x, objects3D: h, solids: d }) {
  is.DEFAULT_UP = new m(0, 0, 1);
  const _ = document.createElement("div"), y = new ts(), w = new ns(45, 1, 0.1, 2 * 1e6), v = new os(-10, 10, 10, -10, -1e3, 2e6);
  let z = w;
  const P = new ss({ antialias: true });
  ...
  const O = new Un(new m(-1, 0, 0), 0), ae = new Un(new m(0, -1, 0), 0), ie = new Un(new m(0, 0, -1), 0);
  window.__hekatanClip = window.__hekatanClip ?? { enableX: false, enableY: false, enableZ: false, posX: 0, posY: 0, posZ: 0, invertX: false, invertY: false, invertZ: false };
  function ue() {
    const V = window.__hekatanClip, X = [];
    V.enableX && (O.normal.set(V.invertX ? 1 : -1, 0, 0), O.constant = V.invertX ? -V.posX : V.posX, X.push(O)), V.enableY && (ae.normal.set(0, V.invertY ? 1 : -1, 0), ae.constant = V.invertY ? -V.posY : V.posY, X.push(ae)), V.enableZ && (ie.normal.set(0, 0, V.invertZ ? 1 : -1), ie.constant = V.invertZ ? -V.posZ : V.posZ, X.push(ie)), P.clippingPlanes = X, y.traverse((q) => {
      const we = q;
      if (we.material) {
  ...
  const k = us(i), W = $.derive(() => Math.pow(10, k.displayScale.val / 10)), he = Hs(e, k), ge = () => {
    const V = [];
  ...
  Z(), _.appendChild(ps(k, e, d)), _.setAttribute("id", "viewer"), _.appendChild(P.domElement), P.setPixelRatio(window.devicePixelRatio);
  const D = jt();
  ...
  $.derive(() => {
    ...
    y.remove(K), (_a = K.traverse) == null ? void 0 : _a.call(K, (we) => {
      var _a2, _b, _c, _d;
    ...
    }), K = Hn(V, Pe()), K.visible = k.gridVisible.rawVal, y.add(K), Z(), y.remove(E), E.traverse((we) => {
      var _a2, _b, _c, _d;
      (_b = (_a2 = we.geometry) == null ? void 0 : _a2.dispose) == null ? void 0 : _b.call(_a2), (_d = (_c = we.material) == null ? void 0 : _c.dispose) == null ? void 0 : _d.call(_c);
    }), E = So(V, X), y.add(E);
  ...
  function te() {
    ...
    if (!G || !H) {
      P.setScissorTest(false), P.setViewport(0, 0, V, X), P.render(y, z);
      return;
    }
    const J = V / 2;
    P.setScissorTest(true), P.setViewport(0, 0, J, X), P.setScissor(0, 0, J, X), P.render(y, z), P.setViewport(J, 0, J, X), P.setScissor(J, 0, J, X), P.render(y, H), P.setScissorTest(false);
  }
  function le(V) {
  ...
  function re(V, X) {
    ...
    if (v.left = -ze * de, v.right = ze * de, v.updateProjectionMatrix(), V && H) {
      if (F ? (F.object = H, F.update()) : (F = new bo(H, P.domElement), F.enableDamping = true, F.dampingFactor = 0.1, F.screenSpacePanning = true, F.zoomSpeed = 0.8, F.panSpeed = 1.2, F.rotateSpeed = 0.9, F.touches = { ONE: _n.ROTATE, TWO: _n.DOLLY_PAN }, F.target.copy(b.target), F.addEventListener("change", te), F.enabled = false), !oe) {
        const me = (tt) => {
          if (!G || !F) return;
          const De = P.domElement.getBoundingClientRect(), Be = tt.clientX - De.left, We = De.width / 2, Ce = Be >= We;
  ...
  if (e) {
    y.add(fs(k, he, W), ls(e, k, he), ws(k, he, W), ys(e, k, he, W), hs(e, k, he, W), ms(e, k, he, W), vs(e, k, he, W), bs(e, k, he, W), zs(e, k, he, W), _s(e, k, he, W));
    const V = Ns({ scene: y, rendererElm: P.domElement, getActiveCamera: () => z, derivedNodes: he, derivedDisplayScale: W, mesh: e, settings: k, render: te });
    y.add(V);
    const X = Os(e, k), J = Fs(e, k, he, X), q = Po(X);
    y.add(J), _.appendChild(q);
    const we = $s(e, k, he);
    y.add(we);
  ...
  if (d) {
    const V = new as(16777215, 0.5);
    y.add(V);
    const X = new Mo(16777215, 0.5);
    X.position.set(30, 25, -10), X.shadow.mapSize.width = 1024, X.shadow.mapSize.height = 1024, y.add(X);
    const J = 10;
    ...
    q.color.setHSL(11, 43, 96), q.position.set(-10, 0, 30), y.add(q), $.derive(() => {
      (d == null ? void 0 : d.val.length) && (y.remove(...d.oldVal), y.add(...d.rawVal), te());
    }), $.derive(() => {
  ...
  if (h) {
    ...
    $.derive(() => {
      const q = h.val;
      V.length && (y.remove(...V), V.length = 0), q.length && (y.add(...q), V.push(...q), J()), te();
    }), $.derive(() => {
      k.custom3D.val, J();
    }), $.derive(() => {
      k.showCotas.val, J();
  ...
  x && Ps({ drawingObj: x, gridObj: K, scene: y, getActiveCamera: () => z, controls: b, gridSize: I, derivedDisplayScale: W, rendererElm: P.domElement, viewerRender: te }), Fo((V, X) => {
    var _a;
    P.setClearColor(X.background, 1), y.remove(K), (_a = K.traverse) == null ? void 0 : _a.call(K, (J) => {
      var _a2, _b, _c, _d;
    ...
    }), K = Hn(k.gridSize.rawVal, { planes: ge() }), y.add(K), _.style.setProperty("--awatif-legend-color", X.legendMarker), te();
  });
  const Fe = { scene: y, perspCamera: w, orthoCamera: v, get camera() {
    return z;
...
function Hs(e, i) {
  return $.derive(() => {
    ...
    const d = i.deformScale.val, _ = i.deformScale.val * i.deformScaleZ.val, y = Number.isFinite(d) ? d : 1, w = Number.isFinite(_) ? _ : 1;
    return x.map((v, z) => {
      var _a2;
      ...
      return [v[0] + b * y, v[1] + O * y, v[2] + ae * w];
    });
  });
}
const jn = $.state(null), qn = $.state(""), Ws = $.state("kN"), Gs = $.state("mm"), qs = $.state("kN/m\xB2"), Js = { kN: 1, tonf: 9.80665, kip: 4.4482216 }, Co = { mm: 1e3, cm: 100, m: 1, in: 39.3700787402 }, Qs = { "kN/m\xB2": 1, kPa: 1, MPa: 1 / 1e3, GPa: 1 / 1e6, "kgf/cm\xB2": 1 / 98.0665, "tonf/m\xB2": 1 / 9.80665, psi: 1 / 6.89476, ksi: 1 / 6894.76 };
function Os(e, i) {
  const x = $.state([]);
  let h;
  return ((d) => {
    ...
    const d = /* @__PURE__ */ new Map(), _ = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), z = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Map(), ae = /* @__PURE__ */ new Map(), ie = (Fe, ce) => {
      Fe == null ? void 0 : Fe.forEach((_e2, Ze) => {
        const j = e.elements.val[Ze];
        if (j) for (let Me = 0; Me < j.length; Me++) ce.set(j[Me], [_e2[Me] ?? _e2[0]]);
      });
    };
    ie((_b = (_a = e.analyzeOutputs) == null ? void 0 : _a.val) == null ? void 0 : _b.bendingXX, d), ie((_d = (_c = e.analyzeOutputs) == null ? void 0 : _c.val) == null ? void 0 : _d.bendingYY, _), ie((_f = (_e = e.analyzeOutputs) == null ? void 0 : _e.val) == null ? void 0 : _f.bendingXY, y), ie((_h = (_g = e.analyzeOutputs) == null ? void 0 : _g.val) == null ? void 0 : _h.membraneXX, w), ie((_j = (_i = e.analyzeOutputs) == null ? void 0 : _i.val) == null ? void 0 : _j.membraneYY, v), ie((_l = (_k = e.analyzeOutputs) == null ? void 0 : _k.val) == null ? void 0 : _l.membraneXY, z), ie((_n2 = (_m = e.analyzeOutputs) == null ? void 0 : _m.val) == null ? void 0 : _n2.tranverseShearX, P), ie((_p = (_o2 = e.analyzeOutputs) == null ? void 0 : _o2.val) == null ? void 0 : _p.tranverseShearY, b), ie((_r = (_q = e.analyzeOutputs) == null ? void 0 : _q.val) == null ? void 0 : _r.vonMises, O), ie((_t = (_s2 = e.analyzeOutputs) == null ? void 0 : _s2.val) == null ? void 0 : _t.pressure, ae);
    const ue = (_v = (_u = e.analyzeOutputs) == null ? void 0 : _u.val) == null ? void 0 : _v.colorMapRanges, k = (_w = i.solidResults) == null ? void 0 : _w.val, he = k && k !== "none" ? k : i.shellResults.val, ge = ue == null ? void 0 : ue[he], Pe = { bendingXX: [d, 0], bendingYY: [_, 0], bendingXY: [y, 0], membraneXX: [w, 0], membraneYY: [v, 0], membraneXY: [z, 0], tranverseShearX: [P, 0], tranverseShearY: [b, 0], vonMises: [O, 0], pressure: [ae, 0], displacementX: [(_y = (_x = e.deformOutputs) == null ? void 0 : _x.val) == null ? void 0 : _y.deformations, 0], displacementY: [(_A = (_z = e.deformOutputs) == null ? void 0 : _z.val) == null ? void 0 : _A.deformations, 1], displacementZ: [(_C = (_B = e.deformOutputs) == null ? void 0 : _B.val) == null ? void 0 : _C.deformations, 2] }, K = i.shellResults.val, Z = Ws.val, D = Gs.val, I = K === "displacementX" || K === "displacementY" || K === "displacementZ", A = K === "bendingXX" || K === "bendingYY" || K === "bendingXY", E = K === "membraneXX" || K === "membraneYY" || K === "membraneXY", B = K === "vonMises" || K === "pressure", C = K === "tranverseShearX" || K === "tranverseShearY", N = (_D = i.solidResults) == null ? void 0 : _D.val, ne = N === "vonMises" || N === "sigmaXX" || N === "sigmaYY" || N === "sigmaZZ" || N === "tauXY" || N === "tauYZ" || N === "tauXZ", G = N === "ux" || N === "uy" || N === "uz", H = qs.val, F = ne ? Qs[H] : G || I ? Co[D] : A || E || B || C ? 1 / Js[Z] : 1, oe = ne ? H : G || I ? D : A ? `${Z}\xB7m/m` : E ? `${Z}/m\xB2` : B ? `${Z}/m\xB2` : C ? `${Z}/m` : "";
    qn.val = oe, jn.val = Array.isArray(ge) && ge.length === 2 ? [ge[0] * F, ge[1] * F] : null;
