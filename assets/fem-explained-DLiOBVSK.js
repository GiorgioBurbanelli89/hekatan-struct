...
import { m as pt, k as mt, d as Z, a as xt, V as ut, B as ht, f as bt, L as gt, v as M } from "./Text-CSfbf1xJ.js";
import { g as _t, b as vt, a as yt } from "./analyze-BydHtRcI.js";
import { d as $t, __tla as __tla_0 } from "./didacticCpp-B5f-GyHC.js";
import { g as wt, b as zt } from "./styles-CXNYye6A.js";
...
Promise.all([
  ...
  function Ft(t, l, i, r, p, f, m) {
    ...
    const a = i[t], o = l[a[0]], e = l[a[1]], c = [
      o,
      e
    ], s = Mt(Q(o, e)), d = ((_a = r.elasticities) == null ? void 0 : _a.get(t)) ?? 0, b = ((_b = r.areas) == null ? void 0 : _b.get(t)) ?? 0, x = ((_c = r.momentsOfInertiaZ) == null ? void 0 : _c.get(t)) ?? 0, u = ((_d = r.momentsOfInertiaY) == null ? void 0 : _d.get(t)) ?? 0, h = ((_e = r.shearModuli) == null ? void 0 : _e.get(t)) ?? 0, _ = ((_f = r.torsionalConstants) == null ? void 0 : _f.get(t)) ?? 0, $ = d * b / s, E = d * x / s ** 3, F = d * u / s ** 3, L = h * _ / s, w = _t(c, r, t), y = vt(c), A = N(Et(y), N(w, y)), q = Q(e, o), X = q[0] / s, U = q[1] / s, G = q[2] / s, rt = Math.sqrt(X ** 2 + U ** 2), V = a[0] * 6, H = a[1] * 6, S = [];
  ...
  M.derive(() => {
    ...
    !t.length || !l.length || (T.val = $t(t, l, i, r), C.val = yt(t, l, r, T.val));
  });
