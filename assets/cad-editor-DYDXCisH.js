...
import { v as y, V as b, U as q, W as K, X as Q, K as ee, O as oe, Y as ne, Z as se, _ as ie, J as G, $ as k, a0 as te, B as F, L as z, a as N, S as ae, e as re, d as le, F as de, c as ce, P as pe, p as me } from "./theme-D5p5K0bJ.js";
import { O as fe, T as M } from "./Text-B4nrRMfX.js";
...
function Ye(e, l) {
  ...
  a.id = "cad-panel";
  const o = { viewMode: "3d", selector: "", sectionPos: 0, showGrid: true, showLabels: true, showNodes: true, showFrames: true, showAreas: true }, n = new pe({ title: "FEM Studio", container: a, expanded: true });
...
const L = ue(), { element: B, ctx: U } = Me(), _ = Ye(L, U);
ze(L, U);
