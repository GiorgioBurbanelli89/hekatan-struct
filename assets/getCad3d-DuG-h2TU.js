const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/calcPanel-DPB8ntV2.js","assets/getMesh-_M9lDnOs.js","assets/__vite-browser-external-D7Ct-6yo.js","assets/pureFunctionsAny.generated-DeJSBP3k.js","assets/analyze-CDRzE7vM.js","assets/didacticCpp-pa3uOomD.js","assets/deform-BgDMNlBc.js","assets/preload-helper-V2P8TQsQ.js","assets/cyclicPushoverCpp-CLUVV3nQ.js"])))=>i.map(i=>d[i]);
import { _ as na } from "./preload-helper-V2P8TQsQ.js";
import { Z as nn, a0 as Za, M as sa, D as aa, B as Dt, w as yn, G as Qa, K as el, d as ba, v as jo, V as Ee, P as xo, s as la, n as ra, a1 as Bo, c as Ho, b as tl, S as ol, e as nl, F as Eo, L as Do, a as ko, t as sl, q as al, $ as ll, _ as un, r as Zn, i as fn, h as mn, f as rl, g as il, a2 as cl, a3 as dl } from "./theme-DDCjfe25.js";
...
import { d as pt, p as Qn, m as pl, s as ul, __tla as __tla_0 } from "./didacticCpp-pa3uOomD.js";
...
`);
      ...
      y && (y.value = q, y.addEventListener("change", (x) => {
        ...
        x.stopPropagation(), na(async () => {
          const { openCalcPanel: S } = await import("./calcPanel-DPB8ntV2.js").then(async (m2) => {
            await m2.__tla;
            return m2;
          });
          return {
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        try {
          const { cyclicPushover: g } = await na(async () => {
            const { cyclicPushover: k } = await import("./cyclicPushoverCpp-CLUVV3nQ.js");
            return {
              cyclicPushover: k
            };
