...
import { v as l, M as at, D as vt, d as y, g as S, e as ae } from "./theme-dnnHIQ7U.js";
import { P as se } from "./tweakpane-BXg6ZhiP.js";
import { a as oe } from "./analyze-DZ5QYzyM.js";
import { d as ne, __tla as __tla_0 } from "./didacticCpp-C2di29sC.js";
import { g as le, a as bt, b as ht } from "./getViewer-f7b0_qaE.js";
import { e as ie } from "./makeDraggable-zx2br6Yh.js";
import { g as me } from "./getParameters-BanUaban.js";
import { g as ce } from "./styles-CClJeH1b.js";
...
Promise.all([
  ...
  const _t = 25e6, Mt = 0.2, re = _t / (2 * (1 + Mt)), de = 24 / 9.80665, gt = 2e8, xt = 0.3, pe = gt / (2 * (1 + xt)), fe = 78 / 9.80665, r = {
    L: {
      value: l.state(15),
      min: 5,
      max: 30,
  ...
  l.derive(() => {
    ...
    function qt(t, e, s, i, c) {
      ...
      const o = _.length - 1;
      P.set(o, c), R.set(o, _t), C.set(o, Mt), D.set(o, de), T.set(o, re), V.set(o, 0), G.set(o, 0), q.set(o, 0), J.set(o, 0);
    }
    function Gt(t, e, s, i, c) {
      ...
      const o = _.length - 1;
      R.set(o, gt), C.set(o, xt), D.set(o, fe), T.set(o, pe), V.set(o, s), G.set(o, i), q.set(o, i), J.set(o, c), P.set(o, 0);
    }
    const U = [
      v / 2 - B,
      v / 2,
    ...
    for (let t = 0; t < g; t++) for (let e = 0; e < f; e++) qt(u[t][e], u[t][e + 1], u[t + 1][e + 1], u[t + 1][e], d);
    let H = Dt, K = Ct;
    if (I === 2) {
      const t = d / 2 + Ot / 2;
      H = it + L * t * t, K = L;
    ...
    for (let t = 0; t <= g; t++) for (let e = 0; e <= f; e++) {
      const s = t === 0 || t === g ? Z / 2 : Z, c = (e === 0 || e === f ? Y / 2 : Y) * s, o = -lt * c, w = u[t][e];
      rt.set(w, [
        0,
        0,
        o,
    ...
    for (let t = 0; t < f; t++) {
      ...
      if (s) for (const c of s) Math.abs(c) > x && (x = Math.abs(c));
    ...
    if (x === 0) {
      ...
      for (let s = 0; s < f; s++) {
        ...
        if (c) for (const w of c) Math.abs(w) > x && (x = Math.abs(w));
    ...
    const Xt = lt * B * a * a / 8, $t = x / Math.max(1e-3, Xt);
    zt.val = {
      modo: [
        "0 \u2014 Naive (doble-T)",
