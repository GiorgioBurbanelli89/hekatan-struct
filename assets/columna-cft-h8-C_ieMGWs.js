...
import { v as l } from "./theme-BEYHi-uR.js";
import { P as ke } from "./tweakpane-BXg6ZhiP.js";
import { a as Ce } from "./analyze-DNPn2SjO.js";
import { d as we, __tla as __tla_0 } from "./didacticCpp-DDG05360.js";
import { h as Ee, __tla as __tla_1 } from "./h8-CxVKcm6Z.js";
import { g as Fe, c as Be, d as oe, e as ne } from "./getViewer-BzX_T-Bo.js";
import { e as Oe } from "./makeDraggable-zx2br6Yh.js";
import { g as Te } from "./getParameters-BmrkFEnV.js";
import { g as je } from "./styles-CwaapIhw.js";
...
Promise.all([
  ...
  l.derive(() => {
    ...
    const ve = 2 * U / i, xe = 2 * $ / m, ge = A / b, o = (e, t, n) => be(-U + e * ve, -$ + t * xe, n * ge), E = [];
    for (let e = 0; e < b; e++) for (let t = 0; t < m; t++) for (let n = 0; n < i; n++) E.push([
      o(n, t, e),
      o(n + 1, t, e),
      o(n + 1, t + 1, e),
      o(n, t + 1, e),
    ...
    for (let e = 0; e < b; e++) for (let t = 0; t < m; t++) I(o(i, t, e), o(i, t + 1, e), o(i, t + 1, e + 1), o(i, t, e + 1));
    for (let e = 0; e < b; e++) for (let t = 0; t < i; t++) I(o(t, 0, e), o(t + 1, 0, e), o(t + 1, 0, e + 1), o(t, 0, e + 1));
    for (let e = 0; e < b; e++) for (let t = 0; t < i; t++) I(o(t, m, e), o(t + 1, m, e), o(t + 1, m, e + 1), o(t, m, e + 1));
