...
import { g as ht } from "./getViewer-2Tsmr46n.js";
import { g as bt } from "./styles-Y66YTQNs.js";
import { l as gt, i as _t, d as Z, a as vt, V as yt, B as $t, f as wt, L as zt } from "./Text-CRSNY_qz.js";
...
Promise.all([
  ...
  function jt(t, l, i, r, p, f, m) {
    ...
    const a = i[t], o = l[a[0]], e = l[a[1]], c = [
      o,
      e
    ], s = Mt(Q(o, e)), d = ((_a = r.elasticities) == null ? void 0 : _a.get(t)) ?? 0, b = ((_b = r.areas) == null ? void 0 : _b.get(t)) ?? 0, x = ((_c = r.momentsOfInertiaZ) == null ? void 0 : _c.get(t)) ?? 0, u = ((_d = r.momentsOfInertiaY) == null ? void 0 : _d.get(t)) ?? 0, h = ((_e = r.shearModuli) == null ? void 0 : _e.get(t)) ?? 0, _ = ((_f = r.torsionalConstants) == null ? void 0 : _f.get(t)) ?? 0, $ = d * b / s, E = d * x / s ** 3, j = d * u / s ** 3, L = h * _ / s, w = pt(c, r, t), y = mt(c), A = N(Et(y), N(w, y)), q = Q(e, o), X = q[0] / s, U = q[1] / s, G = q[2] / s, rt = Math.sqrt(X ** 2 + U ** 2), V = a[0] * 6, H = a[1] * 6, S = [];
