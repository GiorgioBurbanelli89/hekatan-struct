import { m as q, __tla as __tla_0 } from "./didacticCpp-BebR7qv7.js";
import { i as G, j as R, d as j, P as c, __tla as __tla_1 } from "./pazFrameE2k-AKY0xJia.js";
import { g as E } from "./chartPanel-DKe9UCQ8.js";
import { a as $, s as I, b as K, p as U, r as P, n as V } from "./newmarkBeta-CtZFLc7z.js";
let X;
let __tla = Promise.all([
  ...
  X = {
    ...
    computedLabels(e) {
      const a = e.E_psi, d = e.I1_in4, i = e.I2_in4, r = e.H1_ft * 12, b = e.H2_ft * 12, p = 12 * a * d * 2 / Math.pow(r, 3), H = 12 * a * i * 2 / Math.pow(b, 3), x = e.W1_lb / 386.088, h = e.W2_lb / 386.088, { K: z, M: y } = $([
        x,
        h
      ], [
        p,
    ...
    build(e, a) {
      const d = W(e);
      G(d, a);
      const i = e.E_psi, r = e.I1_in4, b = e.I2_in4, p = e.H1_ft * 12, H = e.H2_ft * 12, x = 12 * i * r * 2 / Math.pow(p, 3), h = 12 * i * b * 2 / Math.pow(H, 3), z = e.W1_lb / 386.088, y = e.W2_lb / 386.088, { K: f, M: u } = $([
        z,
        y
      ], [
        x,
...
`;
      try {
        const m = I(f, u), F = m.freqs[0], T = m.freqs[1], S = (F - _.f1_Hz) / _.f1_Hz * 100, v = (T - _.f2_Hz) / _.f2_Hz * 100;
