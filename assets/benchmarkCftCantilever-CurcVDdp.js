...
import { a as i, b as f, c as g } from "./units-yggW8zr_.js";
...
let __tla = Promise.all([
  ...
  k = {
    ...
    category: "\u{1F3C1} Benchmarks \xB7 1\uFE0F\u20E3 Frames",
    benchmark: true,
    ...
    computedLabels(e) {
      const a = e.D_out, l = e.t_HSS, o = a - 2 * l, t = a * a - o * o, r = o * o, d = (a ** 4 - o ** 4) / 12, c = o ** 4 / 12, n = e.E_s / e.E_c, _ = t + r / n, m = d + c / n, u = e.gamma_s * t + e.gamma_c * r, x = u * e.L, s = u * e.L * e.L / (2 * e.E_s * _) * 1e3;
      return {
        ...
        "Uz_top anal\xEDtico": `${s.toFixed(5)} mm`,
    ...
    build(e, a) {
      ...
      if (d) {
        ...
        let s = `[Cantilever ${o.materialType}] ${r} segmentos
  Secci\xF3n: ${o.sectionLabel}
  Modifiers: A=${e.A_mod} As2=${e.As2_mod} As3=${e.As3_mod} J=${e.J_mod} I22=${e.I22_mod} I33=${e.I33_mod}
  Uz_top   = ${i(n, 5)}  (anal\xEDtico ${i(m, 5)}, \u0394 ${x.toFixed(3)}%)
`;
        if (l === 2 && (s += `  ETABS API: ${p.Uz_top_mm.toFixed(5)} mm  (\u0394 ${u.toFixed(2)}%)
`), Math.abs(e.P_lat) > 1e-9) {
          ...
          s += `  Ux_top = ${i(_, 4)} (lateral, P=${f(e.P_lat)})
    Anal\xEDtico Timoshenko: ${i(E, 4)} (bending ${i(b, 4)} + shear ${i(A, 4)})
  Esperado en base: M = P\xB7L = ${g(M)},  V = P = ${f(F)}
`;
        }
        c && (s += `  Reacci\xF3n base: Fz=${f(c[2], 3)}  My=${g(c[4], 3)}  (W=${f(o.q * t, 3)} esperado)`), console.log(s);
      }
    },
    runModal(e, a, l) {
