import { m as q, __tla as __tla_0 } from "./didacticCpp-C2di29sC.js";
import { i as G, j as R, d as j, P as c, __tla as __tla_1 } from "./pazFrameE2k-BCTNzm-z.js";
import { a as E, s as $, b as K, p as U, r as I, n as V, g as P } from "./newmarkBeta-CfFoMJcW.js";
let Q;
let __tla = Promise.all([
  ...
  Q = {
    ...
    onParamChange(e, a) {
      ...
      e === "showTH" && a.showTH < 0.5 && P().hide();
    },
    computedLabels(e) {
      const a = e.E_psi, d = e.I1_in4, i = e.I2_in4, r = e.H1_ft * 12, b = e.H2_ft * 12, p = 12 * a * d * 2 / Math.pow(r, 3), H = 12 * a * i * 2 / Math.pow(b, 3), x = e.W1_lb / 386.088, h = e.W2_lb / 386.088, { K: z, M: y } = E([
        x,
        h
      ], [
        p,
    ...
    build(e, a) {
      const d = W(e);
      G(d, a);
      const i = e.E_psi, r = e.I1_in4, b = e.I2_in4, p = e.H1_ft * 12, H = e.H2_ft * 12, x = 12 * i * r * 2 / Math.pow(p, 3), h = 12 * i * b * 2 / Math.pow(H, 3), z = e.W1_lb / 386.088, y = e.W2_lb / 386.088, { K: f, M: u } = E([
        z,
        y
      ], [
        x,
...
`;
      try {
        const m = $(f, u), F = m.freqs[0], T = m.freqs[1], S = (F - _.f1_Hz) / _.f1_Hz * 100, v = (T - _.f2_Hz) / _.f2_Hz * 100;
        n += `  Solver matricial directo:
`, n += `    f1 = ${F.toFixed(4)} Hz  (libro ${_.f1_Hz}, \u0394 ${S.toFixed(3)}%)
`, n += `    f2 = ${T.toFixed(4)} Hz  (libro ${_.f2_Hz}, \u0394 ${v.toFixed(3)}%)
`;
...
`;
        const w = Math.sqrt(m.omega2[0]), A = Math.sqrt(m.omega2[1]), L = K(u, f, w, A, e.xi), N = U(I(e.F0_lb, 0, e.pulseDur_s), 1, 2), D = Math.floor(e.tEnd_s / e.dt_s), l = V({
          M: u,
          K: f,
          C: L,
          loadFunc: N,
...
`, e.showTH > 0.5) {
          const t = P(), g = Math.round(e.plotType ?? 0);
...
` + i.frequencies.slice(0, 4).map((r, b) => `  Modo ${b + 1}: f = ${r.toFixed(3)} Hz   T = ${(1 / r).toFixed(4)} s`).join(`
`)), (d == null ? void 0 : d.render) && d.render(i, {
          title: "Paz 7.1 \u2014 2-story shear building",
          properties: [
            `Libro: f\u2081=${_.f1_Hz} Hz, f\u2082=${_.f2_Hz} Hz`,
  ...
  function W(e) {
    const a = c.psi_to_kNm2(e.E_psi), d = c.in_to_m(e.H1_ft * 12), i = c.in_to_m(e.H2_ft * 12), r = c.in_to_m(e.bay_ft * 12), b = c.in4_to_m4(e.I1_in4), p = c.in4_to_m4(e.I2_in4), H = c.lb_to_kN(e.W1_lb), x = c.lb_to_kN(e.W2_lb);
    return {
      nStories: 2,
      storyHeights: [
        d,
