...
import { G as pn, J as nl, M as ia, D as ca, B as ro, f as Sn, l as sl, s as al, b as xa, v as Ko, V as Ne, I as Lo, m as da, k as pa, K as Jo, d as Xo, c as ll, S as rl, e as il, F as Oo, L as Uo, a as No, N as cl, P as cn, U as dl, H as pl, y as hn, X as ss, q as xn, p as vn, n as fl, o as ul, Y as ml, Z as gl } from "./Text-CSfbf1xJ.js";
...
` + f;
  ...
  `, document.head.appendChild(Ns), ml() === "light" && document.documentElement.classList.add("awatif-light"), gl((t) => {
...
`);
    ...
    function It(t = false) {
      ...
      const d = dl(), a = new pl(l, 20, d.grid, d.grid);
...
${r.join(", ")}`);
    ...
    function Ws(t) {
      ...
      if (Wt && (o.scene.remove(Wt), Wt.geometry.dispose(), Wt.material.dispose(), Wt = null), t.worldPos) {
        const l = t.snapType === "node" ? 16776960 : t.snapType === "mid" ? 16711935 : t.snapType === "grid" ? 65535 : 8947848, s = t.snapType === "node" ? 0.08 : 0.06, d = t.snapType === "mid" ? new ll(s * 2, s * 2, s * 2) : new rl(s, 12, 12), a = new il({
          color: l,
          transparent: true,
          opacity: 0.8,
          depthTest: false
    ...
    function Zn(t) {
      ...
      for (let m = 0; m < a.length; m++) {
        const M = a[m];
        if (M.length === 2) {
          const w = new Ne(...d[M[0]]), y = new Ne(...d[M[1]]), f = new cl(w, y), h = new Ne(), T = new Ne();
