...
import { g as pt, b as mt, a as xt } from "./analyze-DNPn2SjO.js";
import { d as ut, __tla as __tla_0 } from "./didacticCpp-CLixJGob.js";
import { g as ht } from "./getViewer-CoMhMl8V.js";
import { g as bt } from "./styles-lf_LNy9d.js";
import { g as gt, f as _t, c as Z, a as vt, V as yt, B as $t, j as wt, L as zt } from "./Text-BmY6zyQy.js";
import { n as Mt, s as Q, m as N, t as Et } from "./pureFunctionsAny.generated-DeJSBP3k.js";
import { __tla as __tla_1 } from "./deform-C054iIuL.js";
...
Promise.all([
  ...
  M.derive(() => {
    const t = B.val, r = k.val, i = Y.val, l = O.val;
...
`;
  ...
  M.derive(() => {
    const t = K.val;
    if (t < 0) return;
    const r = B.val, i = k.val, l = O.val, p = Y.val, f = T.val;
