import { m as q, __tla as __tla_0 } from "./didacticCpp-CLixJGob.js";
import { b as G, g as R, d as j, P as c, __tla as __tla_1 } from "./pazFrameE2k-BN1k77mc.js";
import { s as E, a as $, b as K, p as U, r as I, n as V, g as P } from "./newmarkBeta-CZ1uRmPu.js";
let Q;
let __tla = Promise.all([
  ...
  Q = {
    ...
    computedLabels(e) {
      const a = e.E_psi, d = e.I1_in4, i = e.I2_in4, r = e.H1_ft * 12, _ = e.H2_ft * 12, p = 12 * a * d * 2 / Math.pow(r, 3), H = 12 * a * i * 2 / Math.pow(_, 3), x = e.W1_lb / 386.088, h = e.W2_lb / 386.088, { K: z, M: y } = E([
        x,
        h
      ], [
        p,
    ...
    build(e, a) {
      const d = W(e);
      G(d, a);
      const i = e.E_psi, r = e.I1_in4, _ = e.I2_in4, p = e.H1_ft * 12, H = e.H2_ft * 12, x = 12 * i * r * 2 / Math.pow(p, 3), h = 12 * i * _ * 2 / Math.pow(H, 3), z = e.W1_lb / 386.088, y = e.W2_lb / 386.088, { K: f, M: u } = E([
        z,
        y
      ], [
        x,
...
`;
      try {
        const m = $(f, u), F = m.freqs[0], T = m.freqs[1], S = (F - b.f1_Hz) / b.f1_Hz * 100, v = (T - b.f2_Hz) / b.f2_Hz * 100;
