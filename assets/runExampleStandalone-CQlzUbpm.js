...
function E(s) {
  const l = n.state([]), r = n.state([]), m = n.state({}), c = n.state({}), p = n.state({}), u = n.state({}), f = n.state([]), y = { nodes: l, elements: r, nodeInputs: m, elementInputs: c, deformOutputs: p, analyzeOutputs: u, objects3D: f }, b = Object.fromEntries(Object.entries(s.params).map(([e, t]) => [e, t.default])), a = () => s.build(b, y), d = document.createElement("div");
  ...
  for (const [e, t] of Object.entries(s.params)) {
    ...
    t.options !== void 0 ? o.options = t.options : (t.min !== void 0 && (o.min = t.min), t.max !== void 0 && (o.max = t.max), t.step !== void 0 && (o.step = t.step)), k.addBinding(b, e, o).on("change", j);
  }
  document.body.append(O({ mesh: { nodes: l, elements: r, nodeInputs: m, elementInputs: c, deformOutputs: p, analyzeOutputs: u }, objects3D: f, settingsObj: { deformedShape: true, displayScale: -1, shellResults: "displacementZ", gridSize: 10 } }), P({ sourceCode: "https://github.com/GiorgioBurbanelli89/hekatan-struct", author: "https://www.linkedin.com/in/jorge-burbano-213741138/" })), a();
}
export {
  E as r
};
