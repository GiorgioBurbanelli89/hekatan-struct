...
import { m as E, d as g, __tla as __tla_0 } from "./didacticCpp-BkpWNA4I.js";
let k;
let __tla = Promise.all([
  ...
  k = {
    ...
    build(n, t) {
      ...
      ]), c = /* @__PURE__ */ new Map(), u = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), h = /* @__PURE__ */ new Map(), i = n.A * n.A / 12;
      for (let e = 0; e < a.length; e++) c.set(e, n.E), u.set(e, L), h.set(e, I), v.set(e, O), p.set(e, n.A), f.set(e, i), x.set(e, i), M.set(e, 2 * i);
      ...
      t.deformOutputs.val = d, t.analyzeOutputs.val = w(s, a, t.elementInputs.val, d), t.objects3D.val = [];
      const b = n.F * n.L / (n.A * n.E), F = ((_b = (_a = d.deformations) == null ? void 0 : _a.get(o)) == null ? void 0 : _b[0]) ?? 0;
