...
import { p as H, __tla as __tla_0 } from "./didacticCpp-BfFs_eNG.js";
let te;
  ...
  te = {
    ...
    build(s, a) {
      ...
      const G = [
        ...
        pointLoads: G,
        springs: _
      }), R = /* @__PURE__ */ new Map(), B = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map(), z = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map();
      f.forEach((e, n) => {
      ...
      w.nodeResults.forEach((e, n) => A.set(n, [
        0,
        0,
        e.w,
        e.bx,
