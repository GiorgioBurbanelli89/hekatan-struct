...
import { d as at, __tla as __tla_0 } from "./didacticCpp-B5f-GyHC.js";
import { g as lt, b as rt } from "./styles-CXNYye6A.js";
import { g as ct } from "./getParameters-DsthXvNv.js";
...
Promise.all([
  ...
  const P = tt(0.16, 0.16, 0.013, 8e-3), Y = tt(0.2, 0.1, 85e-4, 56e-4), b = 0.06, A = 4e-3, it = b * b - (b - 2 * A) ** 2, V = (b ** 4 - (b - 2 * A) ** 4) / 12, mt = 2 * A * (b - A) ** 3 / 2;
  n.derive(() => {
    ...
    const x = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), O = /* @__PURE__ */ new Map(), I = /* @__PURE__ */ new Map();
    for (let t = 0; t < r; t++) for (let e = 0; e < l; e++) {
      ...
      a.push([
        J[t][e],
        i[t][s]
      ]), x.set(o, M), y.set(o, L), S.set(o, P.A), k.set(o, P.Iy), w.set(o, P.Iz), O.set(o, P.J), I.set(o, j);
    }
    for (let t = 0; t < r; t++) for (let e = 0; e < v - 1; e++) {
      ...
      a.push([
        i[t][e],
        i[t][e + 1]
      ]), x.set(s, M), y.set(s, L), S.set(s, Y.A), k.set(s, Y.Iy), w.set(s, Y.Iz), O.set(s, Y.J), I.set(s, j);
    }
    for (let t = 0; t < v; t++) for (let e = 0; e < r - 1; e++) {
      ...
      a.push([
        i[e][t],
        i[e + 1][t]
      ]), x.set(s, M), y.set(s, L), S.set(s, it), k.set(s, V), w.set(s, V), O.set(s, mt), I.set(s, j);
    }
