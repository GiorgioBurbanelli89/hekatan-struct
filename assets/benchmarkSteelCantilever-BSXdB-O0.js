...
import { a as m, b as i, c as b } from "./units-yggW8zr_.js";
import { g as v, b as y, e as C, __tla as __tla_1 } from "./loadCaseHelpers-CqGkeYfR.js";
let k;
let __tla = Promise.all([
  ...
  k = {
    ...
    hasModal: true,
    onParamChange(e, o) {
      e === "exportE2k" && o.exportE2k > 0.5 && (C(x(o), 0), o.exportE2k = 0);
    },
    computedLabels(e) {
      const o = e.D_out, n = e.t_HSS, a = o - 2 * n, t = o * o - a * a, l = (o ** 4 - a ** 4) / 12, r = e.gamma_s * t, s = r * e.L, d = r * e.L * e.L / (2 * e.E_s * t) * 1e3;
      return {
    ...
    build(e, o) {
      var _a, _b;
      const n = v(o), { sec: a } = y(x(e), o, 0, n), t = e.L, l = Math.max(1, Math.round(e.nSegments)), r = (_a = o.deformOutputs.val.deformations) == null ? void 0 : _a.get(l), s = (_b = o.deformOutputs.val.reactions) == null ? void 0 : _b.get(0);
      if (r) {
        const d = r[2], A = r[0], _ = -a.q * t * t / (2 * a.E_col * a.A_eq), g = (d - _) / Math.abs(_) * 100;
  ...
  Uz_top   = ${m(d, 5)}  (anal\xEDtico ${m(_, 5)}, \u0394 ${g.toFixed(3)}%)
`;
        if (Math.abs(e.P_lat) > 1e-9) {
          const p = 0.8333333333333334 * a.A_eq, u = e.P_lat * t * t * t / (3 * a.E_col * a.I_eq), f = e.P_lat * t / (a.G_col * p), M = u + f, $ = e.P_lat * t, S = e.P_lat;
          c += `  Ux_top = ${m(A, 4)} (lateral, P=${i(e.P_lat)})
    Anal\xEDtico Timoshenko: ${m(M, 4)} (bending ${m(u, 4)} + shear ${m(f, 4)})
  Esperado en base: M = P\xB7L = ${b($)},  V = P = ${i(S)}
`;
        }
        s && (c += `  Reacci\xF3n base: Fz=${i(s[2], 3)}  My=${b(s[4], 3)}  (W=${i(a.q * t, 3)} esperado)`), console.log(c);
      }
    },
    runModal(e, o, n) {
...
` + a.frequencies.map((t, l) => `  Modo ${l + 1}: f = ${t.toFixed(3)} Hz   T = ${(1 / t).toFixed(4)} s`).join(`
`)), (n == null ? void 0 : n.render) && n.render(a, {
