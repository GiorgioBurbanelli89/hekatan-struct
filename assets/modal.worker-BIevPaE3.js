(async ()=>{
    ...
    async function Le(L = {}) {
        ...
        var d = L, k = !!globalThis.window, Y = !!globalThis.WorkerGlobalScope, q = globalThis.process?.versions?.node && globalThis.process?.type != "renderer", X = !k && !q && !Y;
        if (q) {
        ...
        var Me;
        function ar() {
            return d.locateFile ? ne("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-FYL7B-Tq.wasm", import.meta.url).href;
        }
        function $e(e) {
        ...
        }, Oe = globalThis.TextDecoder && new TextDecoder, Ke = (e, r, t, n)=>{
...
`));
        ...
        var Vr = {
            ...
            invoke_iiiiiiiiiiii: Cn,
            invoke_iiiiiiiiiiiii: Mn,
        ...
        function bn(e, r, t, n, o, a, s, c, l, f) {
            var m = g();
            try {
                w(e)(r, t, n, o, a, s, c, l, f);
            } catch (v) {
        ...
        function Mn(e, r, t, n, o, a, s, c, l, f, m, v, _) {
            var h = g();
            try {
        ...
        function Cn(e, r, t, n, o, a, s, c, l, f, m, v) {
            var _ = g();
            try {
        ...
        function xn(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, N) {
            var C = g();
            try {
                w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, N);
            } catch (O) {
    ...
    await Le();
    const b = await Le();
    function Bn(L, B, d, k, Y = 10, q = 0, X = 0, Q = 1, te, Pe) {
        ...
        A.push(ar);
        const $e = x(k.shearAreasY), Ge = x(k.shearAreasZ), Ve = x(k.localAngles), sr = k.momentReleases ? Array.from(k.momentReleases.keys()) : [], pr = k.momentReleases ? Array.from(k.momentReleases.values()).flatMap(Ln) : [], cr = j(sr, Uint32Array, b.HEAPU32);
        A.push(cr);
    ...
    function j(L, B, d) {
        const k = new B(L), Y = b._malloc(k.length * k.BYTES_PER_ELEMENT);
    ...
    self.onmessage = async (L)=>{
        const { nodes: B, elements: d, nodeInputs: k, elementInputs: Y, nModes: q } = L.data ?? {};
        try {
            const X = {};
            for (const [A, ne] of Object.entries(k ?? {}))X[A] = Yr(ne);
            const Q = {};
            for (const [A, ne] of Object.entries(Y ?? {}))Q[A] = Yr(ne);
            const te = Bn(B, d, X, Q, q), Pe = {
