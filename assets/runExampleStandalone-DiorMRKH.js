const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C9n3CVf2.js","assets/analyze-Dltu42RS.js","assets/pureFunctionsAny.generated-DeJSBP3k.js","assets/didacticCpp-CO3UMe4K.js","assets/deform-p-ZVnXlU.js","assets/preload-helper-V2P8TQsQ.js","assets/planeQ4-DsCzHfbV.js","assets/layeredQ4-DuXBBCkf.js","assets/mitc3-2FJr2z_r.js","assets/fiberSectionCft-CvKVMF85.js","assets/menegottoPinto-9Id4uJ7l.js"])))=>i.map(i=>d[i]);
import { _ as ot } from "./preload-helper-V2P8TQsQ.js";
import { o as bt, t as wt, V as B, u as xt, B as ut, a as ht, d as _t, w as $t, v as G } from "./theme-Co6w-pfC.js";
import { P as Mt } from "./tweakpane-BXg6ZhiP.js";
import { c as Lt, d as Et, g as zt } from "./getViewer-Cldwtr0C.js";
import { g as Pt } from "./styles-CcTqhjpF.js";
import { c as Tt } from "./renderModalTable-BJWFR1R0.js";
import { f as nt, d as it, e as Ft, g as It, h as St, i as st, j as Dt, s as lt, k as ct, l as dt, m as pt, n as Nt, o as Ct, p as At, q as Bt, t as Ot, r as jt } from "./units-DErH5pWJ.js";
let Gt;
let __tla = (async () => {
  ...
  Gt = function(w) {
    const C = G.state([]), Y = G.state([]), X = G.state({}), P = G.state({}), Z = G.state({}), R = G.state({}), W = G.state([]), Q = {
      nodes: C,
      elements: Y,
      nodeInputs: X,
      elementInputs: P,
      ...
      if (l == null ? void 0 : l.addFolder) {
        ...
        y.on("click", async () => {
          ...
          try {
            ...
            n("\u23F3 calculando\u2026");
            const t = new Worker(new URL("/hekatan-struct-lineal/assets/modal.worker-B82fZEgK.js", import.meta.url), {
              type: "module"
            }), i = (D) => {
              const N = {};
              ...
              if (!c) {
                ...
                try {
                  const { modalAnalysis: N } = await ot(async () => {
                    const { modalAnalysis: I } = await import("./index-C9n3CVf2.js").then(async (m2) => {
                      await m2.__tla;
                      return m2;
                    });
                    return {
        ...
        p.addBinding(h, "limite", {
          ...
          for (let r = 0; r < x.length; r++) {
            ...
            for (const T of t) for (const I of x[T]) {
              const V = k[I], H = m < 1e-9 ? 0 : ((V[0] - c[0]) * (o[0] - c[0]) + (V[1] - c[1]) * (o[1] - c[1]) + (V[2] - c[2]) * (o[2] - c[2])) / (m * m), J = L + (F - L) * H, K = Math.abs((b.get(I) || [
                0,
                0,
                0
              ])[2] - J) * 1e3;
