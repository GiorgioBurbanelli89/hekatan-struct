const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/calcPanel-DPBu3lb1.js","assets/getMesh-BksPag0G.js","assets/__vite-browser-external-D7Ct-6yo.js","assets/pureFunctionsAny.generated-DeJSBP3k.js","assets/analyze-DZ5QYzyM.js","assets/didacticCpp-C2di29sC.js","assets/deform-D-nmLsId.js","assets/preload-helper-DrUBW0xl.js","assets/cyclicPushoverCpp-DAhfUice.js"])))=>i.map(i=>d[i]);
...
import { g as $n, b as wn, a as so } from "./analyze-DZ5QYzyM.js";
import { d as pt, p as os, m as ul, s as fl, __tla as __tla_0 } from "./didacticCpp-C2di29sC.js";
import { g as lo, __tla as __tla_1 } from "./getMesh-BksPag0G.js";
import { c as ml, e as bl, a as gl, p as hl, b as xl } from "./e2kExporter-DmB4lqNQ.js";
...
`);
      ...
      y && (y.value = B, y.addEventListener("change", (h) => {
        ...
        h.stopPropagation(), sa(async () => {
          const { openCalcPanel: S } = await import("./calcPanel-DPBu3lb1.js").then(async (m2) => {
            await m2.__tla;
            return m2;
          });
          return {
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        try {
          const { cyclicPushover: b } = await sa(async () => {
            const { cyclicPushover: k } = await import("./cyclicPushoverCpp-DAhfUice.js");
            return {
              cyclicPushover: k
            };
