...
import { G as pn, H as il, M as ia, D as ca, B as ro, h as Sn, k as cl, r as dl, b as xa, V as Ne, z as Lo, l as da, j as pa, I as Jo, d as Xo, c as pl, S as fl, e as ul, F as Oo, L as Uo, a as No, J as ml, y as gl, w as hn, K as as, p as xn, o as vn, m as bl, n as hl } from "./Text-BajK4Ymq.js";
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        try {
          const { cyclicPushover: h } = await ra(async () => {
            const { cyclicPushover: k } = await import("./cyclicPushoverCpp-IZWEMEFm.js").then(async (m2) => {
              await m2.__tla;
              return m2;
            });
            return {
