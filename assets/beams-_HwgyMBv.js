...
import { v as t } from "./Text-CSfbf1xJ.js";
import { a as S } from "./analyze-BydHtRcI.js";
import { d as Y, m as z, __tla as __tla_0 } from "./didacticCpp-B5f-GyHC.js";
import { g as E, b as G } from "./styles-CXNYye6A.js";
import { g as A } from "./getParameters-DsthXvNv.js";
import { g as R, __tla as __tla_1 } from "./getCad3d-DPiETcmE.js";
...
Promise.all([
  ...
  const m = 29500, H = 0.3, v = m / (2 * (1 + H)), L = 180, B = 114, J = 240, I = 490 / 1e3 / 12 ** 3 / 386.4, _ = 43, O = 5630, x = 391, C = 34.8, $ = 24.7, g = 928, h = 225, w = 5.9, T = 6, p = {
    storyH: {
      value: t.state(L),
      min: 100,
      max: 300,
  ...
  t.derive(() => {
    ...
    r.val = {
      ...
      shearModuli: s(v, v),
      areas: s(_, $),
      momentsOfInertiaZ: s(x, h),
      momentsOfInertiaY: s(O, g),
      torsionalConstants: s(C, w),
    ...
    c.render(M, {
      ...
      properties: [
        ...
        `Cols: W24x146 (A=${_}, Iz=${O}, Iy=${x}, J=${C})`,
        `Girs: W14x84  (A=${$}, Iz=${g}, Iy=${h}, J=${w})`
      ]
    });
  });
