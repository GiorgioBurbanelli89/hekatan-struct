...
function et(I, e, t, i, s, l, r = 8) {
  ...
  b = [b[0] / g, b[1] / g, b[2] / g];
  const y = w(p, b), v = (E, O) => E[0] * O[0] + E[1] * O[1] + E[2] * O[2], C = (E) => {
    const O = E ?? [0, 0, 0];
    return [(O[0] || 0) * s, (O[1] || 0) * s, (O[2] || 0) * l];
  }, k = C(t), D = C(i), T = v(k, b), S = v(D, b), A = v(k, y), _ = v(D, y), x = d ? v(d, y) * s : 0, $ = u ? v(u, y) * s : 0, R = d ? v(d, b) * s : 0, N = u ? v(u, b) * s : 0, H = v(k, p), W = v(D, p), B = [];
  for (let E = 0; E <= r; E++) {
    const O = E / r, z = 1 - 3 * O * O + 2 * O * O * O, M = m * (O - 2 * O * O + O * O * O), K = 3 * O * O - 2 * O * O * O, P = m * (-O * O + O * O * O), V = z * T + M * x + K * S + P * $, X = z * A - M * R + K * _ - P * N, q = H + (W - H) * O, le = [I[0] + p[0] * (O * m + q), I[1] + p[1] * (O * m + q), I[2] + p[2] * (O * m + q)];
    B.push([le[0] + b[0] * V + y[0] * X, le[1] + b[1] * V + y[1] * X, le[2] + b[2] * V + y[2] * X]);
  }
  return B;
}
function xt(I, e, t) {
  ...
  return _e((u, p) => {
    ...
    const u = e.elemFrames ? e.elemFrames.rawVal : true, p = e.elemColumns.rawVal, m = e.elemBeams.rawVal, f = e.elemZapatas ? e.elemZapatas.rawVal : true, w = e.elemLosas ? e.elemLosas.rawVal : true, b = e.colorByType ? e.colorByType.rawVal : false, g = t.val, y = ((_e2 = I.elements) == null ? void 0 : _e2.val) || [], v = (A) => {
      if (A.length === 2) {
        if (!u) return false;
        const _ = g[A[0]], x = g[A[1]];
        return !_ || !x ? true : Ae(_, x) ? p : m;
      }
      if (A.length === 4) {
        const _ = A.map(($) => g[$]).filter(Boolean);
        if (_.length < 4) return true;
        const x = (_[0][2] + _[1][2] + _[2][2] + _[3][2]) / 4;
        return fe(x) ? f : w;
      }
      if (A.length === 3) {
        const _ = A.map(($) => g[$]).filter(Boolean);
        if (_.length < 3) return true;
        const x = (_[0][2] + _[1][2] + _[2][2]) / 3;
        return fe(x) ? f : w;
      }
      return true;
    }, C = [], k = [];
    for (const A of y) {
      ...
      if (b) if (A.length === 2) {
        ...
        const x = A.map(($) => g[$]).filter(Boolean);
        if (x.length === 4) {
          const $ = (x[0][2] + x[1][2] + x[2][2] + x[3][2]) / 4;
          _ = fe($) ? $e : Se;
        }
      } else A.length === 3 && (_ = Te);
      if (A.length === 2 && e.deformedShape.val) {
        const x = ((_f = I.nodes) == null ? void 0 : _f.val) ?? [], $ = (_h = (_g = I.deformOutputs) == null ? void 0 : _g.val) == null ? void 0 : _h.deformations, R = x[A[0]], N = x[A[1]];
        if (R && N && $) {
          const H = Number.isFinite(e.deformScale.val) ? e.deformScale.val : 1, W = H * (Number.isFinite(e.deformScaleZ.val) ? e.deformScaleZ.val : 1), B = et(R, N, $.get(A[0]), $.get(A[1]), H, W);
          for (let E = 0; E < B.length - 1; E++) C.push(...B[E], ...B[E + 1]), b && _ && (k.push(_.r, _.g, _.b), k.push(_.r, _.g, _.b));
          continue;
        }
      }
      for (const x of tt(A)) {
        const $ = g[x[0]], R = g[x[1]];
        !$ || !R || (C.push(...$, ...R), b && _ && (k.push(_.r, _.g, _.b), k.push(_.r, _.g, _.b)));
      }
    }
    l.geometry.setAttribute("position", new pe(C, 3)), b && k.length === C.length ? (l.geometry.setAttribute("color", new pe(k, 3)), l.material.vertexColors = true, l.material.needsUpdate = true) : (l.geometry.deleteAttribute("color"), l.material.vertexColors = false, l.material.needsUpdate = true);
    const D = [], T = [], S = [];
    for (let A = 0; A < y.length; A++) {
      ...
      if (v(_)) {
        if (_.length === 3) {
          const [x, $, R] = _;
          if (g[x] && g[$] && g[R]) {
            S.push(A), D.push(...g[x], ...g[$], ...g[R]);
            const N = b ? Te : d;
            for (let H = 0; H < 3; H++) T.push(N.r, N.g, N.b);
          }
        } else if (_.length === 4) {
          const [x, $, R, N] = _;
          if (g[x] && g[$] && g[R] && g[N]) {
            let H;
            if (b) {
              const W = (g[x][2] + g[$][2] + g[R][2] + g[N][2]) / 4;
              H = fe(W) ? $e : Se;
            } else H = Qe(g[x], g[$], g[R], g[N]) ? h : o;
            D.push(...g[x], ...g[$], ...g[R]), D.push(...g[x], ...g[R], ...g[N]), S.push(A, A);
            for (let W = 0; W < 6; W++) T.push(H.r, H.g, H.b);
          }
        }
      }
    }
    a.userData.faceToElem = S, D.length > 0 ? (a.geometry.dispose(), a.geometry = new ve(), a.geometry.setAttribute("position", new pe(D, 3)), a.geometry.setAttribute("color", new pe(T, 3)), a.geometry.computeVertexNormals(), a.visible = e.faces ? e.faces.rawVal : true) : a.visible = false;
  }), ue.derive(() => {
...
const _j = class _j {
  constructor(e, t, i) {
    ...
    else if (e instanceof _j) s = e.nodes;
  ...
  eq(e) {
    ...
    return t[0] == null && (t = []), new _j(t, this.context, this);
  }
  then(e) {
  ...
  shadow(e) {
    ...
    var i = new _j(t, this.context, this);
    return e ? i.find(e) : i;
  }
  closest(e) {
    let t = [];
  ...
  parents(e, t) {
    ...
    var l = new _j(i, this.context, this);
    return e ? l.filter(e) : l;
  }
  add(e) {
    return e = e instanceof _j ? e.nodes : Array.isArray(e) ? e : [e], new _j(this.nodes.concat(e), this.context, this);
  }
  each(e) {
  ...
  prop(e, t) {
    if (t === void 0 && typeof e == "string") return this[0] ? this[0][e] : void 0;
    {
      ...
      return typeof e == "object" ? i = e : i[e] = t, this.each((s) => {
        Object.entries(i).forEach(([l, r]) => {
          l = _j._fixProp(l), s[l] = r, l == "innerHTML" && _j._scriptConvert(s);
        });
      }), this;
    }
  }
...
__publicField(_j, "version", 0.7);
let j = _j;
let n = function(I, e) {
  if (typeof I != "function") return new j(I, e);
  document.readyState == "complete" ? I() : window.addEventListener("load", I);
}, Z = (n.html = (I) => (I = j._fragment(I), n(I.children, I)), n.version = j.version, {});
class it {
  constructor() {
  ...
  message(e, t) {
    ...
    return t.tmp || (t.tmp = { zIndex: m.css("z-index"), overflow: o.overflow }), t.html === "" && t.body === "" && t.buttons === "" ? r() : (t.msgIndex = n(e.box).find(".w2ui-message").length, t.msgIndex === 0 && typeof this.lock == "function" && (n(e.box).css("overflow", "hidden"), e.owner ? e.owner.lock(e.param) : this.lock(e.box)), n(e.box).find(".w2ui-message").css("z-index", 1390), m.css("z-index", 1501), u = `
      ...
      (_b2 = f != null ? isNaN(f) ? b.find(g).filter(f).get(0) : b.find(g).get(f) : b.find("[name=hidden-first]").get(0)) == null ? void 0 : _b2.focus(), n(e.box).find(".w2ui-message").find(g + ",[name=hidden-first],[name=hidden-last]").off(".keep-focus"), n(b).find(g + ",[name=hidden-first],[name=hidden-last]").on("blur.keep-focus", function(y) {
        setTimeout(() => {
          var _a3, _b3, _c;
          var v = document.activeElement, C = 0 < n(b).find(g).filter(v).length, k = n(v).attr("name");
          !C && v && v !== document.body && ((_a3 = n(b).find(g).get(0)) == null ? void 0 : _a3.focus()), k == "hidden-last" && ((_b3 = n(b).find(g).get(0)) == null ? void 0 : _b3.focus()), k == "hidden-first" && ((_c = n(b).find(g).get(-1)) == null ? void 0 : _c.focus());
        }, 1);
      });
    }, h;
  }
...
const _L = class _L {
  ...
  getPosition(e) {
    ...
    if (t && t.box) {
      ...
      let v, C, k, D, T = "", S = { offset: 0, class: "", style: `#${t.id} { --tip-size: ${g}px; }` }, A = { left: 0, top: 0 }, _ = { posX: "", x: 0, posY: "", y: 0 };
      r.forEach((x) => {
        ["top", "bottom"].includes(x) && (!T && w.height + g / 1.893 < y[x] && (T = x), y[x] > _.y) && Object.assign(_, { posY: x, y: y[x] }), ["left", "right"].includes(x) && (!T && w.width + g / 1.893 < y[x] && (T = x), y[x] > _.x) && Object.assign(_, { posX: x, x: y[x] });
      }), T = T || (f ? _.posY : _.posX), u.autoResize && (["top", "bottom"].includes(T) && (w.height > y[T] ? (D = y[T], t.tmp.resizedY = true) : t.tmp.resizedY = false), ["left", "right"].includes(T)) && (w.width > y[T] ? (k = y[T], t.tmp.resizedX = true) : t.tmp.resizedX = false);
      var a = T;
      switch (S.class = b.arrow || "w2ui-arrow-" + a, a) {
        case "top":
          v = b.left + (b.width - (k ?? w.width)) / 2, C = b.top - (D ?? w.height) - g / 1.5 + 1;
          break;
        case "bottom":
          v = b.left + (b.width - (k ?? w.width)) / 2, C = b.top + b.height + g / 1.25 + 1;
          break;
        case "left":
          v = b.left - (k ?? w.width) - g / 1.2 - 1, C = b.top + (b.height - (D ?? w.height)) / 2;
          break;
        case "right":
          v = b.left + b.width + g / 1.2 + 1, C = b.top + (b.height - (D ?? w.height)) / 2;
      }
      f && (u.align == "left" && (A.left = b.left - v, v = b.left), u.align == "right" && (A.left = b.left + b.width - (k ?? w.width) - v, v = b.left + b.width - (k ?? w.width)), ["top", "bottom"].includes(T) && u.align.startsWith("both") && (l = u.align.split(":")[1] ?? 50, b.width >= l) && (v = b.left, k = b.width), u.align == "top" && (A.top = b.top - C, C = b.top), u.align == "bottom" && (A.top = b.top + b.height - (D ?? w.height) - C, C = b.top + b.height - (D ?? w.height)), ["left", "right"].includes(T) && u.align.startsWith("both") && (l = u.align.split(":")[1] ?? 50, b.height >= l) && (C = b.top, D = b.height));
      {
        let x;
        (["left", "right"].includes(u.align) && b.width < (k ?? w.width) || ["top", "bottom"].includes(u.align) && b.height < (D ?? w.height)) && (x = true);
        var h = T == "right" ? g : u.screenMargin, o = T == "bottom" ? g : u.screenMargin, d = m.width - (k ?? w.width) - (T == "left" ? g : u.screenMargin), i = m.height - (D ?? w.height) - (T == "top" ? g : u.screenMargin) + 3;
        (["top", "bottom"].includes(T) || u.autoResize) && (v < h && (x = true, A.left -= v, v = h), v > d) && (x = true, A.left -= v - d, v += d - v), (["left", "right"].includes(T) || u.autoResize) && (C < o && (x = true, A.top -= C, C = o), C > i) && (x = true, A.top -= C - i, C += i - C), x && (h = f ? "left" : "top", d = f ? "width" : "height", S.offset = -A[h], o = w[d] / 2 - g, Math.abs(S.offset) > o + g && (S.class = ""), Math.abs(S.offset) > o && (S.offset = S.offset < 0 ? -o : o), S.style = c.stripSpaces(`#${t.id} .w2ui-overlay-body:after,
                            #${t.id} .w2ui-overlay-body:before {
                                --tip-size: ${g}px;
                                margin-${h}: ${S.offset}px;
                            }`));
      }
      return s = T == "top" ? -u.margin : T == "bottom" ? u.margin : 0, e = T == "left" ? -u.margin : T == "right" ? u.margin : 0, C = Math.floor(100 * (C + parseFloat(u.offsetY) + parseFloat(s))) / 100, { left: v = Math.floor(100 * (v + parseFloat(u.offsetX) + parseFloat(e))) / 100, top: C, arrow: S, adjust: A, width: k, height: D, pos: T };
    }
  }
};
...
class lt extends L {
  ...
  initControls(e) {
    ...
    function o(m, f, w) {
      ...
      g.forEach((C, k) => {
        C.length === 1 && (g[k] = "0" + C);
      }), b = g[0] + g[1] + g[2] + g[3], l.a === 1 && (b = g[0] + g[1] + g[2]), n(e.box).find(".color-preview").css("background-color", "#" + b), n(e.box).find("input").each((C) => {
        C.name && (l[C.name] != null && (C.value = l[C.name]), r[C.name] != null && (C.value = r[C.name]), C.name === "a") && (C.value = l.a);
...
class at extends L {
  ...
  getMonthHTML(e, t, i) {
    ...
    for (let y = 0; y < 42; y++) {
      ...
      let v = "", C = "", k, D;
      D = e.type === "datetime" ? (k = c.formatDateTime(b, e.format), c.formatDate(b, c.settings.dateFormat)) : k = c.formatDate(b, e.format), e.colored && e.colored[D] !== void 0 && (b = e.colored[D].split("|"), C = "background-color: " + b[0] + ";", v = "color: " + b[1] + ";"), m += `<div class="w2ui-day ${this.inRange(k, e, true) ? "w2ui-date " + (D == a ? "w2ui-selected" : "") : "w2ui-blocked"} ${w.join(" ")}"
                       style="${v + C}" date="${D}" data-date="${f.getTime()}">
                            ${g}
...
class Ct extends ie {
          ...
          if (function o(d) {
            ...
            for (let g = 0; g < t.searchData.length; g++) {
              ...
              if (y != null) {
                ...
                let C = t.parseField(d, v.field);
                switch (p = C == null || typeof C == "object" && C.toString == r ? "" : String(C).toLowerCase(), y.value != null && (Array.isArray(y.value) ? (m = y.value[0], f = y.value[1]) : m = String(y.value).toLowerCase()), y.operator) {
                  case "=":
                  case "is":
                  ...
                  case "more":
                    ...
                    break;
                  case "in":
                    w = y.value, (w = y.svalue ? y.svalue : w).indexOf(c.isFloat(C) ? parseFloat(C) : C) === -1 && w.indexOf(p) === -1 || u++;
                    break;
                  case "not in":
                    w = y.value, (w = y.svalue ? y.svalue : w).indexOf(c.isFloat(C) ? parseFloat(C) : C) === -1 && w.indexOf(p) === -1 && u++;
                    break;
    ...
    if (this.ranges.length !== 0) {
      let w = function(g) {
        ...
        if (y && y.type == "expand") {
          ...
          let v, C, k = g.target;
          k.tagName.toUpperCase() != "TD" && (k = n(k).closest("td")[0]), (C = n(k).attr("col") != null ? parseInt(n(k).attr("col")) : C) != null && (k = n(k).closest("tr")[0], v = p.records[n(k).attr("index")].recid, y.newRange[1].recid != v || y.newRange[1].column != C) && (g = c.clone(y.newRange), y.newRange = [{ recid: y.recid, column: y.column }, { recid: v, column: C }], f.detail && (f.detail.newRange = c.clone(y.newRange), f.detail.originalRange = c.clone(y.originalRange)), (f = p.trigger("selectionExtend", f)).isCancelled === true ? (y.newRange = g, f.detail.newRange = g) : (p.removeRange("grid-selection-expand"), p.addRange({ name: "grid-selection-expand", range: y.newRange, style: "background-color: rgba(100,100,100,0.1); border: 2px dotted rgba(100,100,100,0.5);" })));
        }
      }, b = function(g) {
      ...
      for (let g = 0; g < this.ranges.length; g++) {
        ...
        let y = n(this.box).find("#grid_" + this.name + "_rec_" + c.escapeId(l.recid) + ' td[col="' + l.column + '"]'), v = n(this.box).find("#grid_" + this.name + "_rec_" + c.escapeId(r.recid) + ' td[col="' + r.column + '"]'), C = n(this.box).find("#grid_" + this.name + "_frec_" + c.escapeId(l.recid) + ' td[col="' + l.column + '"]'), k = n(this.box).find("#grid_" + this.name + "_frec_" + c.escapeId(r.recid) + ' td[col="' + r.column + '"]'), D = r.column;
  ...
  search(e, t) {
    ...
    for (let _ = 0; _ < this.searches.length; _++) this.searches[_].hidden && this.searches[_].value != null && (s.push({ field: this.searches[_].field, operator: this.searches[_].operator || "is", type: this.searches[_].type, value: this.searches[_].value || "" }), o = true);
    if (arguments.length === 0 && d.length === 0 && (t = this.multiSearch ? (e = this.searchData, this.last.logic) : (e = this.last.field, this.last.search)), arguments.length === 0 && d.length !== 0) {
      ...
      for (let _ = 0; _ < this.searches.length; _++) {
        var u = this.searches[_], p = d.find("#grid_" + this.name + "_operator_" + _).val(), m = d.find("#grid_" + this.name + "_field_" + _), f = d.find("#grid_" + this.name + "_field2_" + _);
        let x = m.val(), $ = f.val(), R = null, N = null;
        if (["int", "float", "money", "currency", "percent"].indexOf(u.type) != -1 && (w = m[0]._w2field, f = f[0]._w2field, w && (x = w.clean(x)), f) && ($ = f.clean($)), ["list", "enum"].indexOf(u.type) != -1 || ["in", "not in"].indexOf(p) != -1) if (x = m[0]._w2field.selected || {}, Array.isArray(x)) {
          R = [];
          for (let H = 0; H < x.length; H++) R.push(c.isFloat(x[H].id) ? parseFloat(x[H].id) : String(x[H].id).toLowerCase()), delete x[H].hidden;
          Object.keys(x).length === 0 && (x = "");
        } else N = x.text || "", x = x.id || "";
        if (x !== "" && x != null || $ != null && $ !== "") {
          var w = { field: u.field, type: u.type, operator: p };
          p == "between" ? c.extend(w, { value: [x, $] }) : p == "in" && typeof x == "string" || p == "not in" && typeof x == "string" ? c.extend(w, { value: x.split(",") }) : c.extend(w, { value: x }), R && c.extend(w, { svalue: R }), N && c.extend(w, { text: N });
          try {
    ...
    if (typeof e == "string" && (arguments.length == 1 && (t = e, e = "all"), a = e, h = t, l = false, r = o ? "AND" : "OR", t != null)) if (e.toLowerCase() == "all") if (0 < this.searches.length) for (let _ = 0; _ < this.searches.length; _++) {
      var b, g = this.searches[_];
      if ((g.type == "text" || g.type == "alphanumeric" && c.isAlphaNumeric(t) || g.type == "int" && c.isInt(t) || g.type == "float" && c.isFloat(t) || g.type == "percent" && c.isFloat(t) || (g.type == "hex" || g.type == "color") && c.isHex(t) || g.type == "currency" && c.isMoney(t) || g.type == "money" && c.isMoney(t) || g.type == "date" && c.isDate(t) || g.type == "time" && c.isTime(t) || g.type == "datetime" && c.isDateTime(t) || g.type == "datetime" && c.isDate(t) || g.type == "enum" && c.isAlphaNumeric(t) || g.type == "list" && c.isAlphaNumeric(t)) && (b = this.defaultOperator[this.operatorsMap[g.type]], b = { field: g.field, type: g.type, operator: g.operator != null ? g.operator : b, value: t }, String(t).trim() != "") && s.push(b), ["int", "float", "money", "currency", "percent"].indexOf(g.type) != -1 && String(t).trim().split("-").length == 2 && (b = String(t).trim().split("-"), y = { field: g.field, type: g.type, operator: g.operator != null ? g.operator : "between", value: [b[0], b[1]] }, s.push(y)), ["list", "enum"].indexOf(g.type) != -1) {
        ...
        for (let x = 0; x < g.options.items; x++) {
          var C = g.options.items[x];
          try {
            var k = new RegExp(t, "i");
            k.test(C) && v.push(x), C.text && k.test(C.text) && v.push(C.id);
          } catch {
          }
        }
    ...
    else for (let _ = 0; _ < this.columns.length; _++) {
      var D = { field: this.columns[_].field, type: "text", operator: this.defaultOperator.text, value: t };
      s.push(D);
    }
    else {
      var T = d.find("#grid_" + this.name + "_search_all");
      let _ = this.getSearch(e);
      if ((_ = _ ?? { field: e, type: "text" }).field == e && (this.last.label = _.label), t !== "") {
        let x = this.defaultOperator[this.operatorsMap[_.type]], $ = t;
        if (["date", "time", "datetime"].indexOf(_.type) != -1 && (x = "is"), ["list", "enum"].indexOf(_.type) != -1 && (x = "is", T = T._w2field.get(), $ = T && 0 < Object.keys(T).length ? T.id : ""), _.type == "int" && t !== "" && (x = "is", String(t).indexOf("-") != -1 && (T = t.split("-")).length == 2 && (x = "between", $ = [parseInt(T[0]), parseInt(T[1])]), String(t).indexOf(",") != -1)) {
          var S = t.split(",");
          x = "in", $ = [];
          for (let R = 0; R < S.length; R++) $.push(S[R]);
        }
        _.operator != null && (x = _.operator), T = { field: _.field, type: _.type, operator: x, value: $ }, s.push(T);
      }
    }
    if (Array.isArray(e)) {
      let _ = "AND";
      typeof t == "string" && (_ = t.toUpperCase()) != "OR" && _ != "AND" && (_ = "AND"), h = "", l = true, r = _;
      ...
      if (d && !["checkbox", "check"].includes(d.type)) {
        ...
        if (["enum", "file"].indexOf(d.type) != -1) console.log('ERROR: input types "enum" and "file" are not supported in inline editing.');
          ...
          if (a.isCancelled !== true) {
            let v = function(C) {
              try {
                var k = getComputedStyle(C), D = C.tagName.toUpperCase() == "DIV" ? C.innerText : C.value, T = n(l.box).find("#grid_" + l.name + "_editable").get(0), S = `font-family: ${k["font-family"]}; font-size: ${k["font-size"]}; white-space: no-wrap;`, A = c.getStrWidth(D, S);
                A + 20 > T.clientWidth && n(T).css("width", A + 20 + "px");
              } catch {
              }
            };
            ...
            s = getComputedStyle(h.find('[col="' + t + '"] > div').get(0)), r = `font-family: ${s["font-family"]}; font-size: ${s["font-size"]};`, d.type === "div" ? (m.addClass("w2ui-editable").html(c.stripSpaces(`<div id="grid_${this.name}_edit_${e}_${t}" class="w2ui-input w2ui-focus"
                        ...
                        style="${r + b + d.style}"
                        field="${p.field}" recid="${e}" column="${t}" ${d.attr}>` + d.text)), g = m.find("input").get(0), d.type == "number" && (f = c.formatNumber(f)), d.type == "date" && (f = c.formatDate(c.isDate(f, d.format, true) || /* @__PURE__ */ new Date(), d.format)), g.value = typeof f != "object" ? f : "", h = (C) => {
              var _a2, _b2, _c, _d;
              var k = (_a2 = this.last._edit) == null ? void 0 : _a2.escKey;
              let D = false;
              var T = n(g).data("tooltipName");
              T && ((_b2 = F.get(T[0])) == null ? void 0 : _b2.selected) != null && (D = true), !this.last.inEditMode || k || !y.includes(d.type) || ((_c = C.detail.overlay.anchor) == null ? void 0 : _c.id) != ((_d = this.last._edit.input) == null ? void 0 : _d.id) && d.type != "list" || (this.editChange(), this.editDone(void 0, void 0, { keyCode: D ? 13 : 0 }));
            }, new me(c.extend({}, d, { el: g, selected: f, onSelect: h, onHide: h })), i == null && g && g.select()), Object.assign(this.last._edit, { input: g, edit: d }), n(g).off(".w2ui-editable").on("blur.w2ui-editable", (C) => {
              var k, D;
              this.last.inEditMode && (k = this.last._edit.edit.type, D = n(g).data("tooltipName"), y.includes(k) && D || (this.editChange(g, o, t, C), this.editDone()));
              ...
              switch (C.keyCode) {
                case 8:
                  d.type != "list" || g._w2field || C.preventDefault();
                  break;
                case 9:
                case 13:
                  C.preventDefault();
                ...
                case 27:
                  ...
                  k && 0 < k.length && (this.last._edit.escKey = true, F.hide(k[0]), C.preventDefault()), C.stopPropagation();
              }
              setTimeout(() => {
                var _a2, _b2;
                switch (C.keyCode) {
                  case 9:
                    var D = C.shiftKey ? l.prevCell(o, t, true) : l.nextCell(o, t, true);
                    D != null && (T = l.records[D.index].recid, this.editChange(g, o, t, C), this.editDone(o, t, C), l.selectType != "row" ? (l.selectNone(true), l.select({ recid: T, column: D.colIndex })) : l.editField(T, D.colIndex, null, C), C.preventDefault) && C.preventDefault();
                    break;
                  case 13: {
                    let S = false;
                    var T = n(g).data("tooltipName");
                    T && F.get(T[0]).selected != null && (S = true), T && S || (this.editChange(g, o, t, C), this.editDone(o, t, C));
                    break;
                  }
                  case 27: {
                    this.last._edit.escKey = false;
                    let S = l.parseField(u, p.field);
                    ((_b2 = (_a2 = u.w2ui) == null ? void 0 : _a2.changes) == null ? void 0 : _b2[p.field]) != null && (S = u.w2ui.changes[p.field]), g._prevValue != null && (S = g._prevValue), g.tagName == "DIV" ? g.innerText = S ?? "" : g.value = S ?? "", this.editDone(o, t, C), setTimeout(() => {
    ...
    if (t.keyboard === true) {
      ...
      if (s.isCancelled !== true) if (0 < n(this.box).find(".w2ui-message").length) e.keyCode == 27 && this.message();
            ...
            if ((x = v || x != null ? x : t.searchData.length == 0 || i ? 0 : t.last.searchIds[0]) != null) {
              if (v && t.multiSelect) {
                ...
                if (t.selectType == "row") t.last.sel_ind > x && t.last.sel_ind != w ? t.unselect(t.records[w].recid) : t.select(t.records[x].recid);
                  ...
                  x = w;
                  var A = [];
                  for (let $ = 0; $ < p.length; $++) A.push({ recid: t.records[x].recid, column: p[$] });
                  t.unselect(A);
                } else {
                  var _ = [];
                  for (let $ = 0; $ < p.length; $++) _.push({ recid: t.records[x].recid, column: p[$] });
                  t.select(_);
                }
                ...
                if (t.selectType == "row") {
                  ...
                  if ($ = ($ == null ? void 0 : $.index) != f ? null : $ == null ? void 0 : $.colIndex, v || $ != null || (t.selectNone(true), $ = 0), $ != null) if (v && t.multiSelect) {
                    ...
                    if (p.indexOf(t.last.sel_col) === 0 && 1 < p.length) {
                      for (let R = 0; R < d.length; R++) A.indexOf(d[R].recid) == -1 && A.push(d[R].recid), x.push({ recid: d[R].recid, column: p[p.length - 1] });
                      t.unselect(x), t.scrollIntoView(f, p[p.length - 1], true);
                    } else {
                      for (let R = 0; R < d.length; R++) A.indexOf(d[R].recid) == -1 && A.push(d[R].recid), _.push({ recid: d[R].recid, column: $ });
                      t.select(_), t.scrollIntoView(f, $, true);
                    }
                ...
                if (t.selectType == "row") {
                  ...
                  if (x = x.index != f ? null : x.colIndex, v || x != null || (t.selectNone(true), x = t.columns.length - 1), x != null) if (v && y == 39 && t.multiSelect) {
                    ...
                    if (p.indexOf(t.last.sel_col) == p.length - 1 && 1 < p.length) {
                      for (let $ = 0; $ < d.length; $++) S.indexOf(d[$].recid) == -1 && S.push(d[$].recid), _.push({ recid: d[$].recid, column: p[0] });
                      t.unselect(_), t.scrollIntoView(f, p[0], true);
                    } else {
                      for (let $ = 0; $ < d.length; $++) S.indexOf(d[$].recid) == -1 && S.push(d[$].recid), A.push({ recid: d[$].recid, column: x });
                      t.select(A), t.scrollIntoView(f, x, true);
                    }
        ...
        a.indexOf(y) == -1 || e.ctrlKey || e.metaKey || g || (p.length === 0 && p.push(0), g = false, setTimeout(() => {
          var S = n(t.box).find("#grid_" + t.name + "_focus"), A = S.val();
          S.val(""), t.editField(u, p[0], A, e);
  ...
  update({ cells: e, fullCellRefresh: t, ignoreColumns: i } = {}) {
    ...
    function d(u, p, m, f, w) {
      ...
      if (!Array.isArray(i) || !i.includes(w) && !i.includes(b.field)) {
        let C = u.w2ui._update.cells[w];
        if (C != null && C.isConnected || (C = l.box.querySelector(`#grid_${l.name}_data_${f}_` + w), u.w2ui._update.cells[w] = C), C != null) {
          if (t) n(C).replace(l.getCellHTML(f, w, false)), C = l.box.querySelector(`#grid_${l.name}_data_${f}_` + w), u.w2ui._update.cells[w] = C;
          else {
            var g = C.children[0], { value: f, style: y, className: v } = l.getCellValue(f, w, false, true);
            if (g.innerHTML != f && (g.innerHTML = f), y != "" && C.style.cssText != y && (C.style.cssText = y), v != "") {
              let D = ["w2ui-grid-data"], T = [];
              g = v.split(" ").filter((S) => !!S), C.classList.forEach((S) => {
                D.includes(S) || T.push(S);
              }), C.classList.remove(...T), C.classList.add(...g);
            }
          }
          if (l.columns[w].style && l.columns[w].style != C.style.cssText && (C.style.cssText = l.columns[w].style ?? ""), u.w2ui.class != null) {
            if (typeof u.w2ui.class == "string") {
              let k = ["w2ui-odd", "w2ui-even", "w2ui-record"], D = [];
              f = u.w2ui.class.split(" ").filter((T) => !!T), p && m && (p.classList.forEach((T) => {
                k.includes(T) || D.push(T);
            ...
            if (c.isPlainObject(u.w2ui.class) && typeof u.w2ui.class[b.field] == "string") {
              let k = ["w2ui-grid-data"], D = [];
              y = u.w2ui.class[b.field].split(" ").filter((T) => !!T), C.classList.forEach((T) => {
                k.includes(T) || D.push(T);
              }), C.classList.remove(...D), C.classList.add(...y);
            }
          }
          u.w2ui.style != null && (p && m && typeof u.w2ui.style == "string" && p.style.cssText !== u.w2ui.style && (p.style.cssText = "height: " + l.recordHeight + "px;" + u.w2ui.style, p.setAttribute("custom_style", u.w2ui.style), m.style.cssText = "height: " + l.recordHeight + "px;" + u.w2ui.style, m.setAttribute("custom_style", u.w2ui.style)), c.isPlainObject(u.w2ui.style)) && typeof u.w2ui.style[b.field] == "string" && C.style.cssText !== u.w2ui.style[b.field] && (C.style.cssText = u.w2ui.style[b.field]);
        }
      }
    }
  }
            ...
            if (m == null) {
              ...
              if (!(k == null || i.records[k] && i.records[k].recid != u.recid)) {
                ...
                if (D != null) {
                  ...
                  isNaN(T) && isNaN(S) && (T = 0, S = i.columns.length - 1), k > D && (f = k, k = D, D = f);
                  var y, m = "ind1:" + k + ",ind2;" + D + ",col1:" + T + ",col2:" + S;
                  if (u.range != m) {
                    u.range = m;
                    for (let _ = k; _ <= D; _++) if (!(0 < i.last.searchIds.length && i.last.searchIds.indexOf(_) == -1)) if (i.selectType != "row") {
                      T > S && (y = T, T = S, S = y);
                      for (let x = T; x <= S; x++) i.columns[x].hidden || p.push({ recid: i.records[_].recid, column: parseInt(x) });
                    } else p.push(i.records[_].recid);
                    if (i.selectType != "row") {
                      var v = i.getSelection();
                      let _ = [];
                      for (let x = 0; x < p.length; x++) {
                        let $ = false;
                        for (let R = 0; R < v.length; R++) p[x].recid == v[R].recid && p[x].column == v[R].column && ($ = true);
                        $ || _.push({ recid: p[x].recid, column: p[x].column });
                      }
                      i.select(_), _ = [];
                      for (let x = 0; x < v.length; x++) {
                        let $ = false;
                        for (let R = 0; R < p.length; R++) p[R].recid == v[x].recid && p[R].column == v[x].column && ($ = true);
                        $ || _.push({ recid: v[x].recid, column: v[x].column });
                      }
                      i.unselect(_);
                    } else if (i.multiSelect) {
                      var C = i.getSelection();
                      for (let _ = 0; _ < p.length; _++) C.indexOf(p[_]) == -1 && i.select(p[_]);
                      for (let _ = 0; _ < C.length; _++) p.indexOf(C[_]) == -1 && i.unselect(C[_]);
                    }
                  }
                }
              }
...
`)), w.push({ kind: p.type == "text/html" ? "html" : "text", data: b });
  ...
  resizeRecords() {
    ...
    let g = 8 * String(this.total).length + 10, y = (g < 34 && (g = 34), this.lineNumberWidth != null && (g = this.lineNumberWidth), false), v = false, C = 0;
    for (let E = 0; E < this.columns.length; E++) this.columns[E].frozen || this.columns[E].hidden || (t = parseInt(this.columns[E].sizeCalculated || this.columns[E].size), C += t);
    ...
    if (a = typeof this.url != "object" ? this.url : this.url.get, this.searchData.length == 0 || a || (k = this.last.searchIds.length), this.fixedBody || (v = false), y || v ? (p.find(":scope > table > tbody > tr:nth-child(1) td.w2ui-head-last").css("width", c.scrollBarSize() + "px").show(), f.css({ top: (0 < this.columnGroups.length && this.show.columns ? 1 : 0) + c.getSize(p, "height") + "px", "-webkit-overflow-scrolling": "touch", "overflow-x": y ? "auto" : "hidden", "overflow-y": v ? "auto" : "hidden" })) : (p.find(":scope > table > tbody > tr:nth-child(1) td.w2ui-head-last").hide(), f.css({ top: (0 < this.columnGroups.length && this.show.columns ? 1 : 0) + c.getSize(p, "height") + "px", overflow: "hidden" }), 0 < f.length && (this.last.scrollTop = 0, this.last.scrollLeft = 0)), y ? (w.css("margin-bottom", c.scrollBarSize() + "px"), b.show()) : (w.css("margin-bottom", 0), b.hide()), w.css({ overflow: "hidden", top: f.css("top") }), this.show.emptyRecords && !v) {
      ...
      if ((O = f[0] ? f[0].scrollHeight - E * this.recordHeight : O) >= this.recordHeight && (O -= this.recordHeight, E++), this.fixedBody) {
        for (let z = k; z < E; z++) D(z, this.recordHeight, this);
        D(E, O, this);
      }
    }
    function D(E, O, z) {
    ...
    let T, S;
    if (0 < u.length) {
      let E = parseInt(u[0].clientWidth) - (v ? c.scrollBarSize() : 0) - (this.show.lineNumbers ? g : 0) - (this.reorderRows ? 26 : 0) - (this.show.selectColumn ? 26 : 0) - (this.show.expandColumn ? 26 : 0) - 1, O = (T = E, false);
      for (let z = S = 0; z < this.columns.length; z++) {
        var A = this.columns[z];
        0 < A.gridMinWidth && (A.gridMinWidth > T && A.hidden !== true && (A.hidden = true, O = true), A.gridMinWidth < T) && A.hidden === true && (A.hidden = false, O = true);
      }
      if (O === true) return void this.refresh();
      for (let z = 0; z < this.columns.length; z++) {
        var _ = this.columns[z];
        _.hidden || (String(_.size).substr(String(_.size).length - 2).toLowerCase() == "px" ? (E -= parseFloat(_.size), this.columns[z].sizeCalculated = _.size, this.columns[z].sizeType = "px") : (S += parseFloat(_.size), this.columns[z].sizeType = "%", delete _.sizeCorrected));
      }
      ...
      for (let z = 0; z < this.columns.length; z++) {
        var $ = this.columns[z];
        $.hidden || $.sizeType == "%" && (this.columns[z].sizeCorrected != null ? this.columns[z].sizeCalculated = Math.floor(E * parseFloat($.sizeCorrected) / 100) - 1 + "px" : this.columns[z].sizeCalculated = Math.floor(E * parseFloat($.size) / 100) - 1 + "px");
      }
    }
    let R = 0;
    for (let E = 0; E < this.columns.length; E++) {
      var N = this.columns[E];
      N.hidden || (N.min == null && (N.min = 20), parseInt(N.sizeCalculated) < parseInt(N.min) && (N.sizeCalculated = N.min + "px"), parseInt(N.sizeCalculated) > parseInt(N.max) && (N.sizeCalculated = N.max + "px"), R += parseInt(N.sizeCalculated));
    }
    let H = parseInt(T) - parseInt(R);
    if (0 < H && 0 < S) {
      let E = 0;
      for (; ; ) {
        var W = this.columns[E];
        if (W == null) E = 0;
        else {
          if (!W.hidden && W.sizeType != "px" && (W.sizeCalculated = parseInt(W.sizeCalculated) + 1 + "px", --H === 0)) break;
          E++;
        }
      }
    } else 0 < H && p.find(":scope > table > tbody > tr:nth-child(1) td.w2ui-head-last").css("width", c.scrollBarSize() + "px").show();
    let B = 1;
    this.show.lineNumbers && (B += g), this.show.selectColumn && (B += 26), this.show.expandColumn && (B += 26);
    for (let E = 0; E < this.columns.length; E++) this.columns[E].hidden || this.columns[E].frozen && (B += parseInt(this.columns[E].sizeCalculated));
    m.css("width", B + "px"), w.css("width", B + "px"), o.css("width", B + "px"), b.css("width", B + "px"), p.css("left", B + "px"), f.css("left", B + "px"), h.css("left", B + "px"), p.find(":scope > table > tbody > tr:nth-child(1) td").add(m.find(":scope > table > tbody > tr:nth-child(1) td")).each((E) => {
      ...
      if (n(E).hasClass("w2ui-head-last")) if (e.last.colEnd + 1 < e.columns.length) {
        ...
        n(E).css("width", z + "px");
      } else n(E).css("width", c.scrollBarSize() + (0 < H && S === 0 ? H : 0) + "px");
      ...
      if (n(E).hasClass("w2ui-grid-data-last") && n(E).parents(".w2ui-grid-frecords").length === 0) if (e.last.colEnd + 1 < e.columns.length) {
        ...
        for (let M = e.last.colEnd + 1; M < e.columns.length; M++) !e.columns[M] || e.columns[M].frozen || e.columns[M].hidden || (z += parseInt(e.columns[M].sizeCalculated));
        n(E).css("width", z + "px");
      } else n(E).css("width", (0 < H && S === 0 ? H : 0) + "px");
      ...
      n(E).hasClass("w2ui-grid-data-last") && n(E).parents(".w2ui-grid-frecords").length === 0 && n(E).css("width", c.scrollBarSize() + (0 < H && S === 0 ? H : 0) + "px");
...
`;
    ...
    return this.show.columnHeaders && (i = 0 < this.columnGroups.length ? (r = a(true), s = function() {
      ...
      for (let b = 0; b < e.columnGroups.length; b++) {
        ...
        if (!((g = b == e.columnGroups.length - 1 ? 100 : g) <= 0)) {
          if (m.main === true) {
            let y = "";
            for (let C = 0; C < e.sortData.length; C++) e.sortData[C].field == f.field && ((e.sortData[C].direction || "").toLowerCase() === "asc" && (y = "w2ui-sort-up"), (e.sortData[C].direction || "").toLowerCase() === "desc") && (y = "w2ui-sort-down");
            let v = "";
  ...
  scroll(e) {
    ...
    if (this.disableCVS || 0 < this.columnGroups.length) r = 0, a = this.columns.length - 1;
      ...
      let _ = 0;
      for (let x = 0; x < this.columns.length; x++) this.columns[x].frozen || this.columns[x].hidden || (h = parseInt(this.columns[x].sizeCalculated || this.columns[x].size), _ + h + 30 > this.last.scrollLeft && r == null && (r = x), _ + h - 30 > this.last.scrollLeft + o && a == null && (a = x), _ += h);
    ...
    if (r != null && (r < 0 && (r = 0), a < 0 && (a = 0), r == a && (0 < r ? r-- : a++), r != this.last.colStart || a != this.last.colEnd)) {
      ...
      if (u < 5 && p < 5) {
        ...
        if (r > this.last.colStart) for (let _ = this.last.colStart; _ < r; _++) d.find("#grid_" + this.name + "_columns #grid_" + this.name + "_column_" + _).remove(), d.find("#grid_" + this.name + '_records td[col="' + _ + '"]').remove(), d.find("#grid_" + this.name + '_summary td[col="' + _ + '"]').remove();
        if (a < this.last.colEnd) for (let _ = this.last.colEnd; _ > a; _--) d.find("#grid_" + this.name + "_columns #grid_" + this.name + "_column_" + _).remove(), d.find("#grid_" + this.name + '_records td[col="' + _ + '"]').remove(), d.find("#grid_" + this.name + '_summary td[col="' + _ + '"]').remove();
        if (r < this.last.colStart) for (let _ = this.last.colStart - 1; _ >= r; _--) this.columns[_] && (this.columns[_].frozen || this.columns[_].hidden) || (m.after(this.getColumnCellHTML(_)), w.each((x) => {
          var $ = n(x).parent().attr("index");
          let R = '<td class="w2ui-grid-data" col="' + _ + '" style="height: 0px"></td>';
          $ != null && (R = this.getCellHTML(parseInt($), _, false)), n(x).after(R);
        }), g.each((x) => {
          var $ = n(x).parent().attr("index");
          let R = '<td class="w2ui-grid-data" col="' + _ + '" style="height: 0px"></td>';
          $ != null && (R = this.getCellHTML(parseInt($), _, true)), n(x).after(R);
        }));
        if (a > this.last.colEnd) for (let _ = this.last.colEnd + 1; _ <= a; _++) this.columns[_] && (this.columns[_].frozen || this.columns[_].hidden) || (f.before(this.getColumnCellHTML(_)), b.each((x) => {
          var $ = n(x).parent().attr("index");
          let R = '<td class="w2ui-grid-data" col="' + _ + '" style="height: 0px"></td>';
          $ != null && (R = this.getCellHTML(parseInt($), _, false)), n(x).before(R);
        }), y.each((x) => {
          var $ = n(x).parent().attr("index") || -1, $ = this.getCellHTML(parseInt($), _, true);
          n(x).before($);
        }));
        ...
        var C = d.find(`#grid_${this.name}_frecords`);
        let N = d.find(`#grid_${this.name}_summary`);
        p.find("tbody").html(e[1]), C.html(v[0]), R.prepend(v[1]), u != null && N.html(u[1]), setTimeout(() => {
          R.find(":scope > table").filter(":not(table:first-child)").remove(), N[0] && (N[0].scrollLeft = this.last.scrollLeft);
        }, 1);
      }
      this.resizeRecords();
    }
    ...
    if (k > this.total && this.total !== -1 && (k = this.total), (k = this.searchData.length == 0 || i ? k : this.last.searchIds.length) !== 0 && s.length !== 0 && s.prop("clientHeight") !== 0) {
      ...
      let _ = Math.round(s.prop("scrollTop") / this.recordHeight + 1), x = _ + (Math.round(s.prop("clientHeight") / this.recordHeight) - 1);
      if (_ > k && (_ = k), x >= k - 1 && (x = k), n(this.box).find("#grid_" + this.name + "_footer .w2ui-footer-right").html((this.show.statusRange ? c.formatNumber(this.offset + _) + "-" + c.formatNumber(this.offset + x) + (this.total != -1 ? " " + c.lang("of") + " " + c.formatNumber(this.total) : "") : "") + (i && this.show.statusBuffered ? " (" + c.lang("buffered") + " " + c.formatNumber(k) + (0 < this.offset ? ", skip " + c.formatNumber(this.offset) : "") + ")" : "")), i || this.fixedBody && !(this.total != -1 && this.total <= this.vs_start)) {
        let K = function() {
        ...
        }, $ = Math.floor(s.prop("scrollTop") / this.recordHeight) - this.last.show_extra, R = $ + Math.floor(s.prop("clientHeight") / this.recordHeight) + 2 * this.last.show_extra + 1;
        $ < 1 && ($ = 1), R > this.total && this.total != -1 && (R = this.total);
        var D = s.find("#grid_" + this.name + "_rec_top"), T = s.find("#grid_" + this.name + "_rec_bottom"), S = l.find("#grid_" + this.name + "_frec_top"), A = l.find("#grid_" + this.name + "_frec_bottom"), p = (String(D.next().prop("id")).indexOf("_expanded_row") != -1 && (D.next().remove(), S.next().remove()), this.total > R && String(T.prev().prop("id")).indexOf("_expanded_row") != -1 && (T.prev().remove(), A.prev().remove()), parseInt(D.next().attr("line"))), e = parseInt(T.prev().attr("line"));
        let W, B, E, O, z;
        if (p < $ || p == 1 || this.last.pull_refresh) {
          if (R <= e + this.last.show_extra - 2 && R != this.total) return;
          for (this.last.pull_refresh = false; B = l.find("#grid_" + this.name + "_frec_top").next(), !((E = s.find("#grid_" + this.name + "_rec_top").next()).attr("line") == "bottom" || !(parseInt(E.attr("line")) < $)); ) B.remove(), E.remove();
          W = s.find("#grid_" + this.name + "_rec_bottom").prev(), (O = W.attr("line")) == "top" && (O = $);
          for (let P = parseInt(O) + 1; P <= R; P++) this.records[P - 1] && ((E = this.records[P - 1].w2ui) && !Array.isArray(E.children) && (E.expanded = false), z = this.getRecordHTML(P - 1, P), T.before(z[1]), A.before(z[0]));
        } else {
          if ($ >= p - this.last.show_extra + 2 && 1 < $) return;
          for (; B = l.find("#grid_" + this.name + "_frec_bottom").prev(), !((E = s.find("#grid_" + this.name + "_rec_bottom").prev()).attr("line") == "top" || !(parseInt(E.attr("line")) > R)); ) B.remove(), E.remove();
          W = s.find("#grid_" + this.name + "_rec_top").next(), (O = W.attr("line")) == "bottom" && (O = R);
          for (let P = parseInt(O) - 1; P >= $; P--) this.records[P - 1] && ((E = this.records[P - 1].w2ui) && !Array.isArray(E.children) && (E.expanded = false), z = this.getRecordHTML(P - 1, P), D.after(z[1]), S.after(z[0]));
        }
        K(), setTimeout(() => {
          this.refreshRanges();
        }, 0), C = ($ - 1) * this.recordHeight;
        let M = (k - R) * this.recordHeight;
        M < 0 && (M = 0), D.css("height", C + "px"), S.css("height", C + "px"), T.css("height", M + "px"), A.css("height", M + "px"), this.last.range_start = $, this.last.range_end = R, Math.floor(s.prop("scrollTop") / this.recordHeight) + Math.floor(s.prop("clientHeight") / this.recordHeight) + 10 > k && this.last.pull_more !== true && (k < this.total - this.offset || this.total == -1 && this.last.fetch.hasMore) && (this.autoLoad === true && (this.last.pull_more = true, this.last.fetch.offset += this.limit, this.request("load")), n(this.box).find("#grid_" + this.name + "_rec_more, #grid_" + this.name + "_frec_more").show().eq(1).off(".load-more").on("click.load-more", function() {
        ...
        if (p.hidden) y++, 0 < v && v--;
          ...
          if (a.w2ui && (f = a.w2ui.colspan, u = this.columns[y].field, f) && f[u] === 0 && delete f[u], !(y < this.last.colStart || y > this.last.colEnd) || p.frozen) {
            if (a.w2ui && typeof a.w2ui.colspan == "object") {
              ...
              if (1 < m) {
                let k = 0;
                for (let D = y; D < y + m && !(D >= this.columns.length); D++) this.columns[D].hidden && k++;
                C = m - k, v = m - 1;
              }
            }
            var f = this.getCellHTML(e, y, i, C);
            p.frozen ? s += f : l += f;
          }
          y++;
        }
  ...
  getCellHTML(e, t, i, s) {
    ...
    if (b.indexes.indexOf(e) != -1 && (g = true), s == null && (s = ((_b = a == null ? void 0 : a.w2ui) == null ? void 0 : _b.colspan) && a.w2ui.colspan[r.field] ? a.w2ui.colspan[r.field] : 1), t === 0 && Array.isArray((_c = a == null ? void 0 : a.w2ui) == null ? void 0 : _c.children)) {
      let S = 0, A = this.get(a.w2ui.parent_recid, true);
      for (; A != null; ) {
        S++;
        var v = this.records[A].w2ui;
        if (v == null || v.parent_recid == null) break;
        A = this.get(v.parent_recid, true);
      }
      if (a.w2ui.parent_recid) for (let _ = 0; _ < S; _++) y += '<span class="w2ui-show-children w2ui-icon-empty"></span>';
      var C = 0 < a.w2ui.children.length ? a.w2ui.expanded ? "w2ui-icon-collapse" : "w2ui-icon-expand" : "w2ui-icon-empty";
      y += `<span class="w2ui-show-children ${C}"></span>`;
    }
    if (r.info === true && (r.info = {}), r.info != null) {
      let S = "w2ui-icon-info", A = (typeof r.info.icon == "function" ? S = r.info.icon(a, { self: this, index: e, colIndex: t, summary: !!i }) : typeof r.info.icon == "object" ? S = r.info.icon[this.parseField(a, r.field)] || "" : typeof r.info.icon == "string" && (S = r.info.icon), r.info.style || "");
      typeof r.info.style == "function" ? A = r.info.style(a, { self: this, index: e, colIndex: t, summary: !!i }) : typeof r.info.style == "object" ? A = r.info.style[this.parseField(a, r.field)] || "" : typeof r.info.style == "string" && (A = r.info.style), y += `<span class="w2ui-info ${S}" style="${A}"></span>`;
    }
    let k = h, D = (m && ["checkbox", "check"].indexOf(m.type) != -1 && (f += "text-align: center;", k = `<input tabindex="-1" type="checkbox" class="w2ui-editable-checkbox"
                            data-changeInd="${i ? -(e + 1) : e}" data-colInd="${t}" ${k ? 'checked="checked"' : ""}>`, y = ""), (k = `<div style="${f}" ${function(S) {
      let A;
      return l.show.recordTitles && (r.title != null ? (typeof r.title == "function" && (A = r.title.call(l, a, { self: this, index: e, colIndex: t, summary: !!i })), typeof r.title == "string" && (A = r.title)) : A = c.stripTags(String(S).replace(/"/g, "''"))), A != null ? 'title="' + String(A) + '"' : "";
    }(k)} ${p}>${y}${String(k)}</div>`) == null && (k = ""), typeof r.render == "string" && (C = r.render.toLowerCase().split(":"), ["number", "int", "float", "money", "currency", "percent", "size"].indexOf(C[0]) != -1) && (o += "text-align: right;"), (a == null ? void 0 : a.w2ui) && (typeof a.w2ui.style == "object" && (typeof a.w2ui.style[t] == "string" && (o += a.w2ui.style[t] + ";"), typeof a.w2ui.style[r.field] == "string") && (o += a.w2ui.style[r.field] + ";"), typeof a.w2ui.class == "object") && (typeof a.w2ui.class[t] == "string" && (d += a.w2ui.class[t] + " "), typeof a.w2ui.class[r.field] == "string") && (d += a.w2ui.class[r.field] + " "), false);
    g && ((_d = b.columns[e]) == null ? void 0 : _d.includes(t)) && (D = true);
    let T;
    return r.clipboardCopy && (T = '<span class="w2ui-clipboard-copy w2ui-icon-paste"></span>'), k = '<td class="w2ui-grid-data' + (D ? " w2ui-selected" : "") + " " + d + (w ? " w2ui-changed" : "") + '"    id="grid_' + this.name + "_data_" + e + "_" + t + '" col="' + t + '"    style="' + o + (r.style != null ? r.style : "") + '" ' + (r.attr != null ? r.attr : "") + u + (1 < s ? 'colspan="' + s + '"' : "") + ">" + k + (T && c.stripTags(k) ? T : "") + "</td>", k = e === -1 && i === true ? '<td class="w2ui-grid-data" col="' + t + '" style="height: 0px; ' + o + '" ' + (1 < s ? 'colspan="' + s + '"' : "") + "></td>" : k;
  }
  clipboardCopy(e, t, i) {
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), ze = /'/g, Me = /"/g, je = /^(?:script|style|textarea|title)$/i, dt = (I) => (e, ...t) => ({ _$litType$: I, strings: e, values: t }), ge = dt(1), he = Symbol.for("lit-noChange"), U = Symbol.for("lit-nothing"), Fe = /* @__PURE__ */ new WeakMap(), ee = te.createTreeWalker(te, 129);
function Pe(I, e) {
