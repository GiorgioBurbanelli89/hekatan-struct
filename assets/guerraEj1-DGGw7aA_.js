import { g as Z, h as q, E as J, L as Q } from "./theme-N6TOO4-G.js";
import { p as U, __tla as __tla_0 } from "./didacticCpp-C0Qfkfmr.js";
let _e;
let __tla = Promise.all([
  ...
  _e = {
    ...
    build(s, l) {
      const d = s.B, t = s.B, i = s.h, o = Math.round(s.nx), f = Math.round(s.ny), m = o + 1, w = f + 1, p = d / o, u = t / f, k = (s.P_dead + s.P_live) * y, x = (s.M_dead + s.M_live) * y, M = s.ks_tm3 * y, b = 14100 * Math.sqrt(s.fc_kgcm2) * 98.0665, z = 0.2, c = [];
      for (let e = 0; e < w; ++e) for (let n = 0; n < m; ++n) c.push([
        n * p,
        e * u
      ]);
      const h = [];
      ...
      const X = 2.4 * y * i, F = [], D = [];
      for (let e = 0; e < w; ++e) for (let n = 0; n < m; ++n) {
        const a = n === 0 || n === m - 1, _ = e === 0 || e === w - 1, r = a && _ ? 0.25 : a || _ ? 0.5 : 1, A = p * u * r, v = e * m + n;
        if (F.push({
          node: v,
          dof: 0,
          k: M * A
      ...
      ((e, n) => {
        ...
        for (let r = 0; r < c.length; ++r) {
          const A = c[r][0] - e, v = c[r][1] - n, E = A * A + v * v;
          E < _ && (_ = E, a = r);
        }
        return a;
      })(N, L);
      ...
      const H = k / S.length, G = x / S.length, P = [];
      ...
      h.forEach((e, n) => {
        W.set(n, e.map((r) => -Math.abs(M * I.nodeResults[r].w)));
    ...
    computedLabels(s, l) {
      ...
      if (d) for (const M of d.values()) for (const g of M) {
        const b = Math.abs(g) * se;
        b > t && (t = b), b < i && (i = b);
      }
      t === -1 / 0 && (t = 0, i = 0);
      const o = ne, f = (_b = (_a = o == null ? void 0 : o.safe_api_live) == null ? void 0 : _a.with_self_weight) == null ? void 0 : _b.sigma_max_servicio_tm2, m = (_d = (_c = o == null ? void 0 : o.safe_api_live) == null ? void 0 : _c.with_self_weight) == null ? void 0 : _d.sigma_min_servicio_tm2, w = (_f = (_e2 = o == null ? void 0 : o.safe_api_live) == null ? void 0 : _e2.without_self_weight) == null ? void 0 : _f.sigma_max_servicio_tm2, p = (_g = o == null ? void 0 : o.safe_libro_pag_36) == null ? void 0 : _g.sigma_max_servicio_tm2, u = (_h = o == null ? void 0 : o.manual_libro_pag_19) == null ? void 0 : _h.sigma_max_tm2, k = (_i = o == null ? void 0 : o.manual_libro_pag_19) == null ? void 0 : _i.sigma_min_tm2, x = (M, g) => g === void 0 || g === 0 ? "\u2014" : `${((M - g) / g * 100).toFixed(2)} %`;
      return {
        "\u{1F4CA} \u03C3_max Hekatan (con SW)": `${t.toFixed(3)} t/m\xB2`,
        "\u{1F7E2} \u03C3_max SAFE API (con SW)": f !== void 0 ? `${f.toFixed(3)} t/m\xB2` : "\u2014",
        "\u{1F7E1} \u03C3_max SAFE API (sin SW)": w !== void 0 ? `${w.toFixed(3)} t/m\xB2` : "\u2014",
        ...
        "\u{1F4D8} \u03C3_min manual (libro p.19)": k !== void 0 ? `${k.toFixed(3)} t/m\xB2` : "\u2014",
        "\u0394 \u03C3_min vs SAFE API": x(i, m),
        "\u0394 \u03C3_min vs manual": x(i, k)
      };
    }
  };
});
