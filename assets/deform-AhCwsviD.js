...
import { _ as Ln } from "./preload-helper-V2P8TQsQ.js";
let Un;
let __tla = (async () => {
  Un = async function(we = {}) {
    ...
    var d = we, Be = !!globalThis.window, ce = !!globalThis.WorkerGlobalScope, j = ((_b = (_a = globalThis.process) == null ? void 0 : _a.versions) == null ? void 0 : _b.node) && ((_c = globalThis.process) == null ? void 0 : _c.type) != "renderer", We = !Be && !j && !ce;
    if (j) {
      const { createRequire: e } = await Ln(() => import("./__vite-browser-external-D7Ct-6yo.js").then((r) => r._), []);
    ...
    var je, He, L, Q, ve, F, I, ee = false;
    function $e() {
      var e = Ee.buffer;
      L = new Int8Array(e), d.HEAPU8 = Q = new Uint8Array(e), ve = new Int32Array(e), d.HEAPU32 = F = new Uint32Array(e), d.HEAPF64 = new Float64Array(e), I = new BigInt64Array(e), new BigUint64Array(e);
    }
    ...
    function kr() {
      u(!ee), ee = true, Te(), !d.noFSInit && !i.initialized && i.init(), W.__wasm_call_ctors(), i.ignorePermissions = false;
    }
    function Fr() {
    ...
    var Pe;
    function br() {
      return d.locateFile ? pr("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-C73rjIOk.wasm", import.meta.url).href;
    }
    function Tr(e) {
    ...
    async function Dr() {
      function e(s, c) {
        return W = s.exports, W = Cn(W), Nt(W), $e(), W;
      }
      var r = d;
      function t(s) {
    ...
    var Ge = (e) => {
      ...
      te.shown || (te.shown = {}), te.shown[e] || (te.shown[e] = 1, j && (e = "warning: " + e), M(e));
    }, Cr = 9007199254740992, Ir = -9007199254740992, Lr = (e) => e < Ir || e > Cr ? NaN : Number(e), Ye = globalThis.TextDecoder && new TextDecoder(), xr = (e, r, t, n) => {
      ...
      return a;
    }, H = (e, r, t) => (u(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e >>>= 0, e ? V(Q, e, r) : "");
    function Ur(e, r, t, n) {
      return e >>>= 0, r >>>= 0, n >>>= 0, T(`Assertion failed: ${H(e)}, at: ` + [
    ...
    class Re {
      ...
      set_caught(r) {
        r = r ? 1 : 0, L[this.ptr + 12 >>> 0] = r;
      }
      get_caught() {
        return L[this.ptr + 12 >>> 0] != 0;
      }
      set_rethrown(r) {
        r = r ? 1 : 0, L[this.ptr + 13 >>> 0] = r;
      }
      get_rethrown() {
    ...
    var Gr = () => he;
    function Vr(e) {
      throw e >>>= 0, U || (U = new Ae(e)), U;
    }
    var qr = () => T("native code called abort()"), Ke = (e, r, t, n) => {
      ...
      for (var o = t, a = t + n - 1, s = 0; s < e.length; ++s) {
        ...
        if (c <= 127) {
          ...
          if (t + 3 >= a) break;
          c > 1114111 && te("Invalid Unicode code point " + re(c) + " encountered when serializing a JS string to a UTF-8 string in wasm memory! (Valid unicode code points should be in range 0-0x10FFFF)."), r[t++ >>> 0] = 240 | c >> 18, r[t++ >>> 0] = 128 | c >> 12 & 63, r[t++ >>> 0] = 128 | c >> 6 & 63, r[t++ >>> 0] = 128 | c & 63, s++;
        }
      }
      return r[t >>> 0] = 0, t - o;
    ...
    }, Xr = () => performance.now(), Kr = () => Date.now(), Jr = (e) => e >= 0 && e <= 3;
    function Zr(e, r, t) {
      if (t >>>= 0, !Jr(e)) return 28;
      var n;
      e === 0 ? n = Kr() : n = Xr();
      var o = Math.round(n * 1e3 * 1e3);
      return I[t >>> 3 >>> 0] = BigInt(o), 0;
    }
    var Qr = () => 4294901760, et = (e, r) => (u(r, "alignment argument is required"), Math.ceil(e / r) * r), rt = (e) => {
    ...
    function it(e, r) {
      ...
      for (var o of oe()) {
        var a = r + t;
        F[e + n >>> 2 >>> 0] = a, t += ie(o, a, 1 / 0) + 1, n += 4;
      }
      return 0;
    }
    function ot(e, r) {
    ...
    var A = {
      ...
      relative: (e, r) => {
        e = q.resolve(e).slice(1), r = q.resolve(r).slice(1);
        function t(f) {
...
`));
      ...
      register(e, r) {
        $.ttys[e] = {
          ...
          output: [],
          ops: r
        }, i.registerDevice(e, $.stream_ops);
      },
      stream_ops: {
        open(e) {
          var r = $.ttys[e.node.rdev];
      ...
      default_tty_ops: {
        ...
        put_char(e, r) {
          r === null || r === 10 ? (ue(V(e.output)), e.output = []) : r != 0 && e.output.push(r);
        },
        fsync(e) {
          var _a2;
          ((_a2 = e.output) == null ? void 0 : _a2.length) > 0 && (ue(V(e.output)), e.output = []);
        },
        ioctl_tcgets(e) {
          return {
            c_iflag: 25856,
      ...
      default_tty1_ops: {
        put_char(e, r) {
          r === null || r === 10 ? (M(V(e.output)), e.output = []) : r != 0 && e.output.push(r);
        },
        fsync(e) {
          var _a2;
          ((_a2 = e.output) == null ? void 0 : _a2.length) > 0 && (M(V(e.output)), e.output = []);
        }
      }
    }, Ze = (e) => {
      ...
      stream_ops: {
        ...
        write(e, r, t, n, o, a) {
          if (u(!(r instanceof ArrayBuffer)), r.buffer === L.buffer && (a = false), !n) return 0;
          var s = e.node;
        ...
        mmap(e, r, t, n, o) {
          ...
          if (!(o & 2) && c && c.buffer === L.buffer) s = false, a = c.byteOffset;
          else {
            if (s = true, a = Ze(), !a) throw new i.ErrnoError(48);
            c && ((t > 0 || t + r < c.length) && (c.subarray ? c = c.subarray(t, t + r) : c = Array.prototype.slice.call(c, t, t + r)), L.set(c, a >>> 0));
          }
          return {
            ptr: a,
            allocated: s
    ...
    }, G = 0, ae = null, Y = {}, B = null, _t = (e) => {
      var _a2;
      if (G--, (_a2 = d.monitorRunDependencies) == null ? void 0 : _a2.call(d, G), u(e, "removeRunDependency requires an ID"), u(Y[e]), delete Y[e], G == 0 && (B !== null && (clearInterval(B), B = null), ae)) {
        var r = ae;
        ae = null, r();
      }
    }, mt = (e) => {
      var _a2, _b2;
      G++, (_a2 = d.monitorRunDependencies) == null ? void 0 : _a2.call(d, G), u(e, "addRunDependency requires an ID"), u(!Y[e]), Y[e] = 1, B === null && globalThis.setInterval && (B = setInterval(() => {
        if (_e) {
          clearInterval(B), B = null;
          return;
        }
        var r = false;
        for (var t in Y) r || (r = true, M("still waiting on run dependencies:")), M(`dependency: ${t}`);
        r && M("(end of list)");
      ...
      var l = r ? q.resolve(A.join2(e, r)) : e, f = ut(`cp ${l}`);
      mt(f);
      try {
        var m = t;
      ...
      symlink(e, r) {
        if (!q.resolve(e)) throw new i.ErrnoError(44);
      ...
      rename(e, r) {
        ...
        var f = i.lookupNode(c, o), m = q.relative(e, n);
        if (m.charAt(0) !== ".") throw new i.ErrnoError(28);
        if (m = q.relative(r, t), m.charAt(0) !== ".") throw new i.ErrnoError(55);
        var v;
        try {
          v = i.lookupNode(l, a);
        } catch {
      ...
      readFile(e, r = {}) {
        ...
        return i.read(t, a, 0, o, 0), r.encoding === "utf8" && (a = V(a)), i.close(t), a;
      },
      writeFile(e, r, t = {}) {
        t.flags = t.flags || 577;
      ...
      createDefaultDevices() {
        i.mkdir("/dev"), i.registerDevice(i.makedev(1, 3), {
          ...
          write: (n, o, a, s, c) => s,
          llseek: () => 0
        }), i.mkdev("/dev/null", i.makedev(1, 3)), $.register(i.makedev(5, 0), $.default_tty_ops), $.register(i.makedev(6, 0), $.default_tty1_ops), i.mkdev("/dev/tty", i.makedev(5, 0)), i.mkdev("/dev/tty1", i.makedev(6, 0));
      ...
      createLazyFile(e, r, t, n, o) {
        class a {
          ...
          cacheLength() {
            ...
            P || (R = h);
            var C = (x, X) => {
              x > X && T("invalid range (" + x + ", " + X + ") or no bytes requested!"), X > h - 1 && T("only " + h + " bytes available! programmer error!");
              var O = new XMLHttpRequest();
              return O.open("GET", t, false), h !== R && O.setRequestHeader("Range", "bytes=" + x + "-" + X), O.responseType = "arraybuffer", O.overrideMimeType && O.overrideMimeType("text/plain; charset=x-user-defined"), O.send(null), O.status >= 200 && O.status < 300 || O.status === 304 || T("Couldn't load " + t + ". Status: " + O.status), O.response !== void 0 ? new Uint8Array(O.response || []) : Me(O.responseText || "");
            }, z = this;
            z.setDataGetter((x) => {
              var X = x * R, O = (x + 1) * R - 1;
              return O = Math.min(O, h - 1), typeof z.chunks[x] > "u" && (z.chunks[x] = C(X, O)), typeof z.chunks[x] > "u" && T("doXHR failed!"), z.chunks[x];
      ...
      writeStat(e, r) {
        F[e >>> 2 >>> 0] = r.dev, F[e + 4 >>> 2 >>> 0] = r.mode, F[e + 8 >>> 2 >>> 0] = r.nlink, F[e + 12 >>> 2 >>> 0] = r.uid, F[e + 16 >>> 2 >>> 0] = r.gid, F[e + 20 >>> 2 >>> 0] = r.rdev, I[e + 24 >>> 3 >>> 0] = BigInt(r.size), ve[e + 32 >>> 2 >>> 0] = 4096, ve[e + 36 >>> 2 >>> 0] = r.blocks;
        var t = r.atime.getTime(), n = r.mtime.getTime(), o = r.ctime.getTime();
        return I[e + 40 >>> 3 >>> 0] = BigInt(Math.floor(t / 1e3)), F[e + 48 >>> 2 >>> 0] = t % 1e3 * 1e3 * 1e3, I[e + 56 >>> 3 >>> 0] = BigInt(Math.floor(n / 1e3)), F[e + 64 >>> 2 >>> 0] = n % 1e3 * 1e3 * 1e3, I[e + 72 >>> 3 >>> 0] = BigInt(Math.floor(o / 1e3)), F[e + 80 >>> 2 >>> 0] = o % 1e3 * 1e3 * 1e3, I[e + 88 >>> 3 >>> 0] = BigInt(r.ino), 0;
      },
      writeStatFs(e, r) {
        F[e + 4 >>> 2 >>> 0] = r.bsize, F[e + 60 >>> 2 >>> 0] = r.bsize, I[e + 8 >>> 3 >>> 0] = BigInt(r.blocks), I[e + 16 >>> 3 >>> 0] = BigInt(r.bfree), I[e + 24 >>> 3 >>> 0] = BigInt(r.bavail), I[e + 32 >>> 3 >>> 0] = BigInt(r.files), I[e + 40 >>> 3 >>> 0] = BigInt(r.ffree), F[e + 48 >>> 2 >>> 0] = r.fsid, F[e + 64 >>> 2 >>> 0] = r.flags, F[e + 56 >>> 2 >>> 0] = r.namelen;
      },
      doMsync(e, r, t, n, o) {
    ...
    function Et(e, r, t, n) {
      ...
      try {
        ...
        var o = se.getStreamFromFD(e);
        return i.llseek(o, r, t), I[n >>> 3 >>> 0] = BigInt(o.position), o.getdents && r === 0 && t === 0 && (o.getdents = null), 0;
      } catch (a) {
    ...
    var tr = [], w = (e) => {
      var r = tr[e];
      return r || (tr[e] = r = xe.get(e)), u(xe.get(e) == r, "JavaScript-side Wasm function table mirror is out of date!"), r;
    }, Ft = (e) => ye(e), bt = (e) => Le(e), nr = (e) => dr(e), Tt = (e) => {
      var r = E(), t = nr(4), n = nr(4);
      ur(e, t, n);
      var o = F[t >>> 2 >>> 0], a = F[n >>> 2 >>> 0], s = H(o);
      Ce(o);
      var c;
      return a && (c = H(a), Ce(a)), y(r), [
        s,
        c
      ];
    }, ir = (e) => Tt(e);
    ...
    var vr = {
      ...
      __cxa_find_matching_catch_3: jr,
      __cxa_rethrow: Hr,
      __cxa_throw: $r,
      ...
      invoke_viiiiiid: an,
      invoke_viiiiiii: Zt,
      invoke_viiiiiiidiiii: Qt,
      invoke_viiiiiiii: Jt,
      invoke_viiiiiiiii: Kt,
      invoke_viiiiiiiiii: Gt,
      invoke_viiiiiiiiiidii: on,
      invoke_viiiiiiiiiii: en,
      invoke_viiiiiiiiiiiddddii: _n,
      invoke_viiiiiiiiiiii: cn,
      invoke_viiiiiiiiiiiiiii: On,
      invoke_viiiiiiiiiiiiiiii: $t,
    ...
    function $t(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, P, N) {
      var R = E();
      try {
    ...
    function Gt(e, r, t, n, o, a, s, c, l, f, m) {
      var v = E();
      try {
    ...
    function Vt(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S) {
      var P = E();
      try {
    ...
    function Kt(e, r, t, n, o, a, s, c, l, f) {
      var m = E();
      try {
    ...
    function Qt(e, r, t, n, o, a, s, c, l, f, m, v, _) {
      var h = E();
      try {
    ...
    function en(e, r, t, n, o, a, s, c, l, f, m, v) {
      var _ = E();
      try {
    ...
    var W;
    W = await Dr(), Ue(), ee ? Se = d : Se = new Promise((e, r) => {
      je = e, He = r;
    });
