import { b as y, g as w, d as H, P as b, __tla as __tla_0 } from "./pazFrameE2k-ChdegBMW.js";
import { n as F, g as v } from "./newmarkBeta-CZ1uRmPu.js";
let N;
let __tla = Promise.all([
  ...
  N = {
    ...
    build(a, s) {
      ...
      ], c = a.Fmax_kip, p = a.t1_s, k = a.t2_s, u = a.t3_s, x = (e) => e <= 0 ? [
        0
      ] : e <= p ? [
        c * e / p
      ] : e <= k ? [
...
`, a.showTH > 0.5) {
  ...
  function P(a) {
    const i = a.H_in, r = a.k_kipin * 1e3 * Math.pow(i, 3) / (24 * 3e7), d = a.m_kips2in * 1e3 * 386.088, c = b.psi_to_kNm2(3e7), p = b.in_to_m(i), k = b.in4_to_m4(r), u = b.lb_to_kN(d);
    return {
      nStories: 1,
      storyHeights: [
        p
      ],
      bayWidth: b.in_to_m(120),
      storyWeights: [
        u
      ],
      I_per_column: [
