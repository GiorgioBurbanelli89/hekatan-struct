...
import { g as C, b as M } from "./styles-CXNYye6A.js";
import { g as _ } from "./getParameters-DsthXvNv.js";
import { g as k, __tla as __tla_1 } from "./getCad3d-DPiETcmE.js";
...
Promise.all([
  ...
  }, i = a.state([]), m = a.state([]), r = a.state({}), u = a.state({}), f = a.state({}), g = a.state({});
  a.derive(() => {
    ...
    i.val = l, m.val = s, r.val = v, u.val = p, f.val = h, g.val = O;
  });
