...
const b = { id: "cad-draw", name: "CAD Drawer (mouse + Tweakpane)", category: "\u{1F9EA} Utilidades", defaultShellResult: "none", availableShellResults: [], params: {}, build(n, e) {
  ...
  const c = [], m = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map(), g = /* @__PURE__ */ new Map(), I = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Map(), $ = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), h = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map();
  for (const a of o.model.lines.values()) {
    const d = r.get(a.nI), l = r.get(a.nJ);
    if (d === void 0 || l === void 0) continue;
    const t = c.length;
    c.push([d, l]), m.set(t, 25e6), f.set(t, 25e6 / (2 * 1.2)), g.set(t, 0.16), I.set(t, 21e-4), M.set(t, 21e-4), $.set(t, 14e-4), w.set(t, 2.45), h.set(t, 0.2);
  }
