import { g as T, E as W, h as Y, L as J } from "./theme-Cr2LU0HL.js";
import { a as fe } from "./analyze-DoaxThCI.js";
...
let __tla = Promise.all([
  ...
  function pe(t, n, m, l, i, r, a = 9127187) {
    const g = Math.abs(n - t), d = new T(g, i, r), b = new W(d), x = new Y(b, new J({
      color: a,
      linewidth: 2
    }));
  ...
  he = {
    ...
    build(t, n) {
      const m = t.L, l = t.Bz, i = t.t_zap, r = t.b_viga, a = t.h_viga, g = t.h_ped, d = t.b_ped, b = t.ks_tonfm3 * q, x = Math.round(t.nx), w = Math.round(t.ny), f = x + 1, L = w + 1, D = m / x, j = l / w, h = l / 2, V = Math.round(w / 2), S = [
        [
          t.x1,
          h
        ],
      ...
      for (let e = 0; e < L; ++e) for (let o = 0; o < f; ++o) {
        const s = o === 0 || o === f - 1, c = e === 0 || e === L - 1, p = s && c ? 0.25 : s || c ? 0.5 : 1, _ = D * j * p, P = e * f + o;
        if (y.push({
          node: P,
          dof: 2,
          k: b * _
