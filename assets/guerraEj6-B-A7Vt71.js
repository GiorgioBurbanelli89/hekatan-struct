import { z as a, __tla as __tla_0 } from "./zapataVigaAmarre-DeubCPkm.js";
let u;
let __tla = Promise.all([
  ...
  u = {
    ...
    computedLabels(n, e) {
      var _a, _b;
      const p = 0.10197162129779283, o = (_b = (_a = e.analyzeOutputs) == null ? void 0 : _a.val) == null ? void 0 : _b.pressure;
      let m = -1 / 0, t = 1 / 0;
      if (o) for (const L of o.values()) for (const x of L) {
        const s = Math.abs(x) * p;
        s > m && (m = s), s < t && (t = s);
      }
      m === -1 / 0 && (m = 0, t = 0);
      const i = 24.179;
      return {
        ...
        "\u{1F4DA} \u03C3_max SAFE (libro)": `${i} t/m\xB2`,
        "\u{1F4D8} \u03C3_max manual (Fig.180)": `${26.179} t/m\xB2`,
        "\u0394 vs SAFE libro": `${((m - i) / i * 100).toFixed(1)} %`
      };
    }
  };
});
