(async ()=>{
    ...
    async function Le(L = {}) {
        ...
        var Me;
        function ar() {
            return d.locateFile ? ne("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-CQk6lz7F.wasm", import.meta.url).href;
        }
        function $e(e) {
...
`));
        ...
        function In(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, N) {
            var C = g();
            try {
                w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, N);
            } catch (O) {
    ...
    await Le();
    const b = await Le();
    function Hn(L, B, d, k, K = 10, q = 0, X = 0, Q = 1, te, Pe) {
