import { b as Y, c as S, E as $, L as K } from "./theme-DDCjfe25.js";
import { p as H, __tla as __tla_0 } from "./didacticCpp-CCShk1kX.js";
let te;
let __tla = Promise.all([
  ...
  function Z(s, a, d, l) {
    const c = new Y(l, l, d), m = new S(new $(c), new K({
      color: 11579568,
      linewidth: 2
    }));
  ...
  te = {
    ...
    build(s, a) {
      const d = s.L, l = s.B, c = s.h, m = Math.round(s.nx), x = Math.round(s.ny), i = m + 1, r = x + 1, h = d / m, g = l / x, v = s.ks_tm3 * b, L = 14100 * Math.sqrt(s.fc_kgcm2) * 98.0665, N = 0.2, p = [];
      ...
      for (const e of D) {
        const n = e.P * s.P_scale * b, o = T(e.x, e.y);
      ...
      const q = [
        ...
        pointLoads: q,
        springs: _
      }), B = /* @__PURE__ */ new Map(), C = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map(), z = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map();
      f.forEach((e, n) => {
        B.set(n, e.map((u) => -Math.abs(v * w.nodeResults[u].w)));
      ...
      a.nodes.val = F, a.elements.val = f;
      ...
      for (const e of k) {
        ...
        n[X[e.dof] ?? 2] += e.value, P.set(e.node, n);
      }
      a.nodeInputs.val = {
      ...
      for (const e of w.nodeResults) j.set(e.node, [
        0,
        0,
        e.w,
        e.bx,
