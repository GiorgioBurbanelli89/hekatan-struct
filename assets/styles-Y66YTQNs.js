...
import { t as Ie, a as Oe, o as Re } from "./theme-CzzIlc4y.js";
class be {
  constructor(e, t) {
...
let M = new F(), Y = new Ne(), $e = new Fe(), se = new Le();
class He extends ee {
  constructor(e) {
    ...
    if (1 < i.length) (i = this.get(e)) && !i.disabled && this.menuClick({ name: this.name, item: s, subItem: i, originalEvent: t });
      ...
      if (["menu", "menu-radio", "menu-check", "drop", "color", "text-color"].includes(s.type)) {
        ...
        setTimeout(() => {
          ...
          ["color", "text-color"].includes(s.type) && $e.show(c.extend({ color: s.color }, s.overlay, { anchor: h[0], name: this.name + "-drop", data: { item: s, btn: d } })).hide(o(s.id)).select((u) => {
...
`)), g.push({ kind: p.type == "text/html" ? "html" : "text", data: w });
  ...
  initToolbar() {
    if (this.toolbar.render == null) {
      ...
      var e;
      this.toolbar.items = [], this.toolbar = new He(c.extend({}, this.toolbar, { name: this.name + "_toolbar", owner: this })), this.show.toolbarReload && this.toolbar.items.push(c.extend({}, this.buttons.reload)), this.show.toolbarColumns && this.toolbar.items.push(c.extend({}, this.buttons.columns)), this.show.toolbarSearch && (e = `
        ...
        let K = function() {
          t.markSearch && (clearTimeout(t.last.marker_timer), t.last.marker_timer = setTimeout(() => {
            ...
            0 < H.length && H.forEach((te) => {
              var Ae = n(t.box).find('td[col="' + te.col + '"]:not(.w2ui-head)');
              c.marker(Ae, te.search);
            });
          }, 50));
...
class de extends ee {
  ...
  updateOverlay(e) {
    ...
    if (this.type === "color") {
      if (n(this.el).prop("readOnly") || n(this.el).prop("disabled")) return;
      $e.show(c.extend({ name: this.el.id + "_color", anchor: this.el, transparent: t.transparent, advanced: t.advanced, color: this.el.value, liveUpdate: true }, this.options)).select((s) => {
...
*/
const ge = globalThis, ue = ge.trustedTypes, ye = ue ? ue.createPolicy("lit-html", { createHTML: (O) => O }) : void 0, Se = "$lit$", q = `lit$${Math.random().toFixed(9).slice(2)}$`, Te = "?" + q, je = `<${Te}>`, Q = document, re = () => Q.createComment(""), ae = (O) => O === null || typeof O != "object" && typeof O != "function", we = Array.isArray, Pe = (O) => we(O) || typeof (O == null ? void 0 : O[Symbol.iterator]) == "function", me = `[ 	
\f\r]`, le = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ve = /-->/g, xe = />/g, J = RegExp(`>|${me}(?:([^\\s"'>=/]+)(${me}*=${me}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), _e = /'/g, Ce = /"/g, Ee = /^(?:script|style|textarea|title)$/i, Be = (O) => (e, ...t) => ({ _$litType$: O, strings: e, values: t }), ce = Be(1), ne = Symbol.for("lit-noChange"), P = Symbol.for("lit-nothing"), ke = /* @__PURE__ */ new WeakMap(), Z = Q.createTreeWalker(Q, 129);
function De(O, e) {
...
const We = (O, e) => {
  ...
  for (let a = 0; a < t; a++) {
    const d = O[a];
    let o, h, u = -1, p = 0;
    for (; p < d.length && (r.lastIndex = p, h = r.exec(d), h !== null); ) p = r.lastIndex, r === le ? h[1] === "!--" ? r = ve : h[1] !== void 0 ? r = xe : h[2] !== void 0 ? (Ee.test(h[2]) && (s = RegExp("</" + h[2], "g")), r = J) : h[3] !== void 0 && (r = J) : r === J ? h[0] === ">" ? (r = s ?? le, u = -1) : h[1] === void 0 ? u = -2 : (u = r.lastIndex - h[2].length, o = h[1], r = h[3] === void 0 ? J : h[3] === '"' ? Ce : _e) : r === Ce || r === _e ? r = J : r === ve || r === xe ? r = le : (r = J, s = void 0);
    const m = r === J && O[a + 1].startsWith("/>") ? " " : "";
    l += r === le ? d + je : u >= 0 ? (i.push(o), d.slice(0, u) + Se + d.slice(u) + q + m) : d + q + (u === -2 ? a : m);
  }
  return [De(O, l + (O[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class oe {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let l = 0, r = 0;
    const a = e.length - 1, d = this.parts, [o, h] = We(e, t);
    ...
    for (; (s = Z.nextNode()) !== null && d.length < a; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const u of s.getAttributeNames()) if (u.endsWith(Se)) {
          ...
          d.push({ type: 1, index: l, name: f[2], strings: m, ctor: f[1] === "." ? Ue : f[1] === "?" ? Xe : f[1] === "@" ? Ve : pe }), s.removeAttribute(u);
      ...
      } else if (s.nodeType === 8) if (s.data === Te) d.push({ type: 2, index: l });
      else {
        let u = -1;
...
class Ye {
  ...
  u(e) {
    ...
    for (; d !== void 0; ) {
      if (r === d.index) {
        let o;
        d.type === 2 ? o = new he(l, l.nextSibling, this, e) : d.type === 1 ? o = new d.ctor(l, d.name, d.strings, this, e) : d.type === 6 && (o = new Ke(l, this, e)), this._$AV.push(o), d = i[++a];
      }
...
class he {
  ...
  _$AI(e, t = this) {
    e = ie(this, e, t), ae(e) ? e === P || e == null || e === "" ? (this._$AH !== P && this._$AR(), this._$AH = P) : e !== this._$AH && e !== ne && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Pe(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var _a;
    const { values: t, _$litType$: i } = e, s = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = oe.createElement(De(i.h, i.h[0]), this.options)), i);
    if (((_a = this._$AH) == null ? void 0 : _a._$AD) === s) this._$AH.p(t);
    else {
      const l = new Ye(s, this), r = l.u(this.options);
  ...
  _$AR(e = this._$AA.nextSibling, t) {
    var _a;
    for ((_a = this._$AP) == null ? void 0 : _a.call(this, false, true, t); e && e !== this._$AB; ) {
...
const qe = ge.litHtmlPolyfillSupport;
qe == null ? void 0 : qe(oe, he), (ge.litHtmlVersions ?? (ge.litHtmlVersions = [])).push("3.2.1");
const Ge = (O, e, t) => {
  const i = e;
  let s = i._$litPart$;
  return s === void 0 && (i._$litPart$ = s = new he(e.insertBefore(re(), null), null, void 0, {})), s._$AI(O), s;
};
function tt({ buttons: O, clickedButton: e, author: t, sourceCode: i }) {
...
function Je() {
  const O = window.location.pathname.split("/").filter(Boolean), e = O.length >= 2 ? `/${O[0]}/` : "/";
  return ce`<img src="${e}img/hekatan-logo.png" alt="Hekatan" style="width:22px;height:22px;border-radius:4px;">`;
}
export {
  Ge as B,
  P as E,
