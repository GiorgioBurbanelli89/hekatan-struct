  ...
  go = {
    ...
    computedLabels(t, n) {
      ...
      d.forEach((i, l) => {
        ...
        if (!F) return;
        const O = i[2], N = i[0], L = i[1], b = Math.abs(O), w = Math.sqrt(N * N + L * L), C = v.get(x) ?? {
          count: 0,
          maxP: 0,
          sumP: 0,
          maxV: 0
        };
        C.count += 1, C.sumP += b, b > C.maxP && (C.maxP = b), w > C.maxV && (C.maxV = w), v.set(x, C);
      });
      const g = {
        "\u2500\u2500 Reacciones por cota \u2500\u2500": ""
    ...
    build(t, n) {
      ...
      const E = t.fcConcr * 0.0981, P = 4700 * Math.sqrt(E) * 1e3, i = 0.2, l = P / (2 * (1 + i)), m = t.colSize * t.colSize, x = t.vigaB * t.vigaH, F = t.colSize ** 4 / 12, O = t.colSize ** 4 / 12, N = 0.14 * t.colSize ** 4, L = t.vigaB * t.vigaH ** 3 / 12, b = t.vigaH * t.vigaB ** 3 / 12, w = 0.14 * Math.min(t.vigaB, t.vigaH) ** 3 * Math.max(t.vigaB, t.vigaH), C = [], h = /* @__PURE__ */ new Map(), V = (e, a, o) => {
      ...
      const k = [], B = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map(), H = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), q = /* @__PURE__ */ new Map(), W = (e, a) => {
        const o = k.length;
        k.push([
          e,
          a
        ]), B.set(o, P), G.set(o, i), Y.set(o, m), j.set(o, F), A.set(o, O), H.set(o, N), T.set(o, l), R.set(o, Q), q.set(o, {
          type: "rect",
          b: t.colSize,
          h: t.colSize
        });
        ...
        k.push([
          e,
          a
        ]), B.set(o, P), G.set(o, i), Y.set(o, x), j.set(o, L), A.set(o, b), H.set(o, w), T.set(o, l), R.set(o, Q), q.set(o, {
          type: "rect",
          b: t.vigaB,
          h: t.vigaH
        });
