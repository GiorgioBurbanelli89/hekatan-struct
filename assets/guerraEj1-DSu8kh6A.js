...
let __tla = Promise.all([
  ...
  _e = {
    ...
    build(s, l) {
      const d = s.B, t = s.B, i = s.h, o = Math.round(s.nx), b = Math.round(s.ny), c = o + 1, y = b + 1, h = d / o, v = t / b, E = (s.P_dead + s.P_live) * A, f = (s.M_dead + s.M_live) * A, p = s.ks_tm3 * A, x = 14100 * Math.sqrt(s.fc_kgcm2) * 98.0665, C = 0.2, _ = [];
