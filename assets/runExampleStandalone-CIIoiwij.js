...
import { g as O } from "./getViewer-DXzw4WPM.js";
import { g as P } from "./styles-Z6stOm1O.js";
...
function C(s) {
  ...
  document.body.append(O({ mesh: { nodes: l, elements: r, nodeInputs: m, elementInputs: c, deformOutputs: p, analyzeOutputs: u }, objects3D: f, settingsObj: { deformedShape: true, displayScale: -1, shellResults: "displacementZ", gridSize: 10, showCotas: true } }), P({ sourceCode: "https://github.com/GiorgioBurbanelli89/hekatan-struct", author: "https://www.linkedin.com/in/jorge-burbano-213741138/" })), a();
}
export {
  C as r
};
