(async ()=>{
    ...
    async function Le(L = {}) {
        ...
        var Me;
        function ar() {
            return d.locateFile ? ne("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-DZ-RJ6M6.wasm", import.meta.url).href;
        }
        function $e(e) {
        ...
        var qe = (e)=>{
        ...
        }, Ne = [], Ke = (e)=>Ne.push(e), Ee = [], lr = (e)=>Ee.push(e), se = (e)=>(u(typeof e == "number", `ptrToString expects a number, got ${typeof e}`), e >>>= 0, "0x" + e.toString(16).padStart(8, "0")), g = (e)=>zr(e), y = ()=>Wr(), ee = (e)=>{
            ...
            return a;
        }, Y = (e, r, t)=>(u(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? J(ge, e, r) : ""), Xe = (e, r, t, n)=>R(`Assertion failed: ${Y(e)}, at: ` + [
        ...
        var ce = (e)=>Lr(e), ke = (e)=>{
            ...
            return r[t] = 0, t - o;
        }, Qe = (e, r, t)=>(u(typeof t == "number", "stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), Ze(e, ge, r, t)), mr = (e)=>{
            ...
            F[e >> 2] = f * 60, ye[r >> 2] = +(c != l);
            var m = (h)=>{
                var S = h >= 0 ? "-" : "+", N = Math.abs(h), O = String(Math.floor(N / 60)).padStart(2, "0"), C = String(N % 60).padStart(2, "0");
                return `UTC${S}${O}${C}`;
            }, v = m(c), _ = m(l);
...
`));
            ...
            createLazyFile (e, r, t, n, o) {
                class a {
                    ...
                    cacheLength() {
                        ...
                        var h = Number(_.getResponseHeader("Content-length")), S, N = (S = _.getResponseHeader("Accept-Ranges")) && S === "bytes", O = (S = _.getResponseHeader("Content-Encoding")) && S === "gzip", C = 1024 * 1024;
                        N || (C = h);
                        var W = (Z, Ie)=>{
                        ...
                        }), (O || !h) && (C = h = 1, h = this.getter(0).length, C = h, ue("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = h, this._chunkSize = C, this.lengthKnown = !0;
                    }
                    get length() {
                ...
                function m(v, _, h, S, N) {
                    var O = v.node.contents;
                    if (N >= O.length) return 0;
                    var C = Math.min(O.length - N, S);
                    if (u(C >= 0), O.slice) for(var W = 0; W < C; W++)_[h + W] = O[N + W];
                    else for(var W = 0; W < C; W++)_[h + W] = O.get(N + W);
                    return C;
                }
                return f.read = (v, _, h, S, N)=>(i.forceLoadFile(l), m(v, _, h, S, N)), f.mmap = (v, _, h, S, N)=>{
                    i.forceLoadFile(l);
                    var O = Rr();
                    if (!O) throw new i.ErrnoError(48);
                    return m(v, $, O, _, h), {
                        ptr: O,
                        allocated: !0
                    };
        ...
        d._modal = T("_modal"), d._modal_paz = T("_modal_paz"), d._didactic_solve = T("_didactic_solve"), d._plate_q4_solve = T("_plate_q4_solve"), d._slopeAllocDouble = T("_slopeAllocDouble"), d._slopeStabilitySolver = T("_slopeStabilitySolver"), d._nonlinear_dynamic = T("_nonlinear_dynamic"), d._steel02_test = T("_steel02_test"), d._cyclic_pushover = T("_cyclic_pushover"), d._concrete02_test = T("_concrete02_test"), d._hex8_solve = T("_hex8_solve");
        ...
        function Kt(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, N, O) {
            var C = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, N, O);
            } catch (W) {
        ...
        function pn(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, N, O, C) {
            var W = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, N, O, C);
            } catch (de) {
        ...
        function Pn(e, r, t, n, o, a, s, c, l, f, m) {
            var v = y();
            try {
        ...
        function Tn(e, r, t, n, o, a, s, c, l, f, m, v, _) {
            var h = y();
            try {
        ...
        function On(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, N) {
            var O = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, f, m, v, _, h, S, N);
            } catch (C) {
    ...
    function In(L, B, d, k, K = 10, q = 0, X = 0, Q = 1, te, Pe) {
        ...
        A.push(Xe), b._modal(ne, L.length, ie, fe.length, ue, B.length, me, u, I.length, ze.keysPtr, ze.valuesPtr, ze.size, ve.keysPtr, ve.valuesPtr, ve.size, p.keysPtr, p.valuesPtr, p.size, he.keysPtr, he.valuesPtr, he.size, oe.keysPtr, oe.valuesPtr, oe.size, T.keysPtr, T.valuesPtr, T.size, He.keysPtr, He.valuesPtr, He.size, We.keysPtr, We.valuesPtr, We.size, je.keysPtr, je.valuesPtr, je.size, Ae.keysPtr, Ae.valuesPtr, Ae.size, Te.keysPtr, Te.valuesPtr, Te.size, ye, F, $.length, ir, or, ae.length, Me, ar, R.length, $e.keysPtr, $e.valuesPtr, $e.size, Ge.keysPtr, Ge.valuesPtr, Ge.size, Ve.keysPtr, Ve.valuesPtr, Ve.size, cr, qe, sr.length, Ne.keysPtr, Ne.valuesPtr, Ne.size, Q, Ke.keysPtr, Ke.valuesPtr, Ke.size, se, Ee ? Ee.length : 0, K, q, X, g, y, ee, De, Ye, J, Y, Xe);
        const re = b.HEAPU32[g / 4], we = b.HEAPU32[y / 4], Je = b.HEAPU32[ee / 4], V = b.HEAPU32[De / 4], Oe = b.HEAPU32[Ye / 4], Se = b.HEAPU32[J / 4], ce = b.HEAPU32[Y / 4], ke = b.HEAPU32[Xe / 4];
        let dr = [], fr = [], ur = [];
        if (we > 0 && re) {
