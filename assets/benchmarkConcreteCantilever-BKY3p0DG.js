...
import { b as y, e as P, __tla as __tla_1 } from "./cantileverE2k-D0Jqmswh.js";
import { g as F } from "./loadCaseHelpers-Cnzqw99W.js";
let S;
let __tla = Promise.all([
  ...
  S = {
    ...
    hasModal: true,
    onParamChange(e, o) {
      e === "exportE2k" && o.exportE2k > 0.5 && (P(x(o), 1), o.exportE2k = 0);
    },
    computedLabels(e) {
    ...
    build(e, o) {
      var _a, _b;
      const l = F(o), { sec: a } = y(x(e), o, 1, l), t = e.L, r = Math.max(1, Math.round(e.nSegments)), m = (_a = o.deformOutputs.val.deformations) == null ? void 0 : _a.get(r), s = (_b = o.deformOutputs.val.reactions) == null ? void 0 : _b.get(0);
      if (m) {
