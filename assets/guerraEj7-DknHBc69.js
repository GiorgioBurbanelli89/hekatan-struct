...
import { p as q, __tla as __tla_0 } from "./didacticCpp-PqvqKlgs.js";
let se;
let __tla = Promise.all([
  ...
  se = {
    ...
    build(s, a) {
      const f = s.L, c = s.B, i = s.h, m = Math.round(s.nx), x = Math.round(s.ny), r = m + 1, u = x + 1, y = f / m, g = c / x, v = s.ks_tm3 * l, L = 14100 * Math.sqrt(s.fc_kgcm2) * 98.0665, C = 0.2, N = [
        {
          x: 0.3,
          P: (90 + 37.5) * l,
          M: (3 + 1.5) * l
      ...
      for (let e = 0; e < u; ++e) for (let n = 0; n < r; ++n) {
        const o = n === 0 || n === r - 1, t = e === 0 || e === u - 1, d = o && t ? 0.25 : o || t ? 0.5 : 1, X = y * g * d, b = e * r + n;
        if (_.push({
          node: b,
          dof: 0,
          k: v * X
      ...
      for (const e of h) {
        ...
        n[G[e.dof] ?? 2] += e.value, k.set(e.node, n);
      }
      a.nodeInputs.val = {
      ...
      const T = [];
      for (const e of N) T.push(...Z(e.x, z, s.h_col, s.col_size));
      a.objects3D.val = T;
    },
    computedLabels(s, a) {
      var _a, _b;
