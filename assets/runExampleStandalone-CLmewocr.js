const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CTpRKu7o.js","assets/analyze-CzODpdUg.js","assets/pureFunctionsAny.generated-DeJSBP3k.js","assets/didacticCpp-Bg32IAmg.js","assets/deform-CGfcN_JQ.js","assets/preload-helper-V2P8TQsQ.js","assets/planeQ4-DsCzHfbV.js","assets/layeredQ4-DuXBBCkf.js","assets/mitc3-2FJr2z_r.js","assets/fiberSectionCft-CvKVMF85.js","assets/menegottoPinto-9Id4uJ7l.js"])))=>i.map(i=>d[i]);
...
import { c as Lt, d as Et, g as zt } from "./getViewer-CKWONEcy.js";
import { g as Pt } from "./styles-BcI84iw5.js";
import { c as Tt } from "./renderModalTable-BJWFR1R0.js";
import { f as nt, d as it, e as Ft, g as It, h as St, i as st, j as Dt, s as lt, k as ct, l as dt, m as pt, n as Nt, o as Ct, p as At, q as Bt, t as Ot, r as jt } from "./units-DndAA6y9.js";
let Gt;
let __tla = (async () => {
  ...
  Gt = function(w) {
    const C = G.state([]), Y = G.state([]), X = G.state({}), P = G.state({}), R = G.state({}), U = G.state({}), W = G.state([]), Q = {
      nodes: C,
      elements: Y,
      nodeInputs: X,
      elementInputs: P,
      ...
      if (l == null ? void 0 : l.addFolder) {
        ...
        y.on("click", async () => {
          ...
          try {
            ...
            n("\u23F3 calculando\u2026");
            const t = new Worker(new URL("/hekatan-struct-lineal/assets/modal.worker-CKwf--K4.js", import.meta.url), {
              type: "module"
            }), i = (D) => {
              const N = {};
              ...
              if (!c) {
                ...
                try {
                  const { modalAnalysis: N } = await ot(async () => {
                    const { modalAnalysis: I } = await import("./index-CTpRKu7o.js").then(async (m2) => {
                      await m2.__tla;
                      return m2;
                    });
                    return {
