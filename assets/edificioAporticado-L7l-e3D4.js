...
import { b as Ne, a as Xt } from "./cotas3D-CWuKMnWq.js";
import { f as Ae, i as Be, d as To, M as Xo, L as Dt, B as io, V as H, a as fe, g as Te, h as mo, E as Ye, I as De, D as qe } from "./theme-BUyDDEHW.js";
let es, os;
      ...
      if (t.slabOn >= 0.5) {
        ...
        for (let d = 1; d < g.length; d++) {
          ...
          for (let C = 0; C < x.length - 1; C++) for (let r = 0; r < b.length - 1; r++) {
            const l = x[C], Q = x[C + 1], i = b[r], v = b[r + 1], { n: Gt } = he(Math.abs(Q - l), a), { n: Nt } = he(Math.abs(v - i), a), qt = [];
            for (let Z = 0; Z <= Nt; Z++) {
              const xt = [];
