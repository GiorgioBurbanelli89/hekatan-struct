...
let __tla = Promise.all([
  ...
  W = {
    ...
    computedLabels(e) {
      const t = g(e.D, e.B, e.TF, e.TW), n = e.Fx * e.L / (e.E * t.A) * 1e3;
      return {
    ...
    build(e, t) {
      var _a, _b;
      const n = g(e.D, e.B, e.TF, e.TW), o = Math.max(1, Math.round(e.nElem)), l = e.L / o, i = [];
      ...
      ]), m = /* @__PURE__ */ new Map(), d = /* @__PURE__ */ new Map(), u = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map(), I = /* @__PURE__ */ new Map(), h = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), M = e.E / (2 * (1 + e.nu));
      for (let a = 0; a < s.length; a++) m.set(a, e.E), d.set(a, M), u.set(a, n.A), x.set(a, n.I33), f.set(a, n.I22), A.set(a, n.J), p.set(a, n.As2), I.set(a, n.As3), h.set(a, S), b.set(a, e.nu);
      ...
      const F = k(i, s, t.nodeInputs.val, t.elementInputs.val);
      t.deformOutputs.val = F, t.analyzeOutputs.val = E(i, s, t.elementInputs.val, F), t.objects3D.val = [];
      const v = e.Fx * e.L / (e.E * n.A), _ = ((_b = (_a = F.deformations) == null ? void 0 : _a.get(o)) == null ? void 0 : _b[0]) ?? 0, $ = 848e-7, w = v !== 0 ? (_ - v) / v * 100 : 0;
      console.log(`[W2 Viga axial cantilever] L=${e.L}m  P=${e.Fx}kN  A=${(n.A * 1e4).toFixed(2)} cm\xB2
  u_x anal\xEDtico (P\xB7L/E\xB7A) = ${(v * 1e3).toFixed(5)} mm
  ...
  ETABS referencia        = ${($ * 1e3).toFixed(3)} mm  (defaults L=3 I450 A36 P=100)`);
    ...
    runModal(e, t, n) {
      ...
      if (!(!o.length || !l.length || !((_a = i.supports) == null ? void 0 : _a.size) || !((_b = s.densities) == null ? void 0 : _b.size))) try {
        const r = L(o, l, i, s, 6), c = g(e.D, e.B, e.TF, e.TW);
        n.render(r, {
