const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CMdqSfVq.js","assets/analyze-ClLKGn9k.js","assets/pureFunctionsAny.generated-JAcEVsJ7.js","assets/didacticCpp-RemoaQyH.js","assets/planeQ4-DsCzHfbV.js","assets/mitc3-2FJr2z_r.js","assets/fiberSectionCft-D5oK3FFf.js","assets/menegottoPinto-B-C2cxus.js"])))=>i.map(i=>d[i]);
import { _ as j, d as z, __tla as __tla_0 } from "./didacticCpp-RemoaQyH.js";
...
let __tla = Promise.all([
  ...
  X = {
    ...
    build(a, o) {
      ...
      const v = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map(), I = /* @__PURE__ */ new Map(), _ = /* @__PURE__ */ new Map(), h = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), S = a.E / (2 * (1 + a.nu));
      for (let e = 0; e < M; e++) v.set(e, a.t), x.set(e, a.E), f.set(e, a.nu), h.set(e, b);
      const C = a.bViga * a.hViga, E = a.bViga * a.hViga ** 3 / 12, N = a.hViga * a.bViga ** 3 / 12, q = 0.28 * a.bViga * a.hViga ** 3;
      for (let e = M; e < l.length; e++) x.set(e, a.E), f.set(e, a.nu), _.set(e, S), y.set(e, C), L.set(e, E), p.set(e, N), I.set(e, q), h.set(e, b), w.set(e, {
        type: "rect",
        b: a.bViga,
        h: a.hViga
      });
      ...
      try {
        o.deformOutputs.val = z(i, l, {
          supports: d,
          loads: u
        }, o.elementInputs.val), o.analyzeOutputs.val = F(i, l, o.elementInputs.val, o.deformOutputs.val);
  ...
  \u03B4_max = ${($ * 1e3).toFixed(3)} mm`);
    ...
    runModal: function(a, o, t) {
      j(async () => {
        const { modalAnalysis: s } = await import("./index-CMdqSfVq.js").then(async (m) => {
          await m.__tla;
          return m;
        });
        return {
      ...
      }, __vite__mapDeps([0,1,2,3,4,5,6,7])).then(({ modalAnalysis: s }) => {
        try {
