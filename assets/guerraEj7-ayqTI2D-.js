import { b as S, c as D, E as K, L as $ } from "./theme-BEYHi-uR.js";
import { p as H, __tla as __tla_0 } from "./didacticCpp-DDG05360.js";
let ne;
let __tla = Promise.all([
  ...
  function W(o, a, f, c) {
    const i = new S(c, c, f), m = new D(new K(i), new $({
      color: 11579568,
      linewidth: 2
    }));
  ...
  ne = {
    ...
    build(o, a) {
      const f = o.L, c = o.B, i = o.h, m = Math.round(o.nx), x = Math.round(o.ny), r = m + 1, u = x + 1, b = f / m, y = c / x, g = o.ks_tm3 * l, w = 14100 * Math.sqrt(o.fc_kgcm2) * 98.0665, L = 0.2, C = [
        {
          x: 0.3,
          P: (90 + 37.5) * l,
          M: (3 + 1.5) * l
