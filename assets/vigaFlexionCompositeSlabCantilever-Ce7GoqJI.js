import { a as j } from "./analyze-Baqb28rE.js";
import { m as J, d as U, __tla as __tla_0 } from "./didacticCpp-BeLq_Lcs.js";
import { g as Y } from "./loadCaseHelpers-Cnzqw99W.js";
let Q;
let __tla = Promise.all([
  ...
  Q = {
    ...
    build(e, s) {
      ...
      const V = h / (l * 9.80665) * 1e3, q = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Map(), B = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), W = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map(), C = /* @__PURE__ */ new Map();
      for (let t = 0; t < u.length; t++) q.set(t, e.E_s), L.set(t, f), S.set(t, l), B.set(t, _), y.set(t, _), W.set(t, w), k.set(t, F), p.set(t, V), C.set(t, v);
      ...
      const N = d * e.L ** 4 / (8 * e.E_s * _), D = d * e.L ** 2 / (2 * f * F), M = N + D, O = ((_b = (_a = $.deformations) == null ? void 0 : _a.get(i)) == null ? void 0 : _b[2]) ?? 0, R = Math.abs(M) > 1e-15 ? (Math.abs(O) - M) / M * 100 : 0;
  ...
  w_tip hekatan= ${(O * 1e3).toFixed(5)} mm  (\u0394 ${R.toFixed(4)}%)`);
    },
    runModal(e, s, a) {
      var _a, _b;
