...
import { v as y, P as _ } from "./theme-CzzIlc4y.js";
import { V as b, O as K, j as Q, k as ee, l as oe, m as ne, W as se, n as ie, A as te, D as ae, G, o as E, T as M, p as re, B as X, L as z, a as N, q as le, r as de, M as ce, F as pe, d as me, s as fe } from "./Text-BCbgLTjz.js";
...
function Me() {
  ...
  const t = new G(), s = 1, i = new E(new b(1, 0, 0), new b(0, 0, 0), s, 6710886, 0.2, 0.2), p = new E(new b(0, 1, 0), new b(0, 0, 0), s, 6710886, 0.2, 0.2), r = new E(new b(0, 0, 1), new b(0, 0, 0), s, 6710886, 0.2, 0.2), m = new M("X", "red", "transparent"), v = new M("Y", "green", "transparent"), u = new M("Z", "blue", "transparent");
  ...
  const k = { scene: l, perspCamera: a, orthoCamera: o, controls: d, renderer: n, render: C };
...
const L = ue(), { element: j, ctx: U } = Me(), q = Pe(L, U);
ze(L, U);
