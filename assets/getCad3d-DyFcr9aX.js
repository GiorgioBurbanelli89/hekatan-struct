const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/calcPanel-Dlz5GJKe.js","assets/getMesh-CMOA6JCi.js","assets/__vite-browser-external-D7Ct-6yo.js","assets/pureFunctionsAny.generated-DeJSBP3k.js","assets/analyze-CRXZq0x4.js","assets/didacticCpp-9rTpExtC.js","assets/deform-wakq4P6K.js","assets/preload-helper-DrUBW0xl.js","assets/cyclicPushoverCpp-Uwy7ujKG.js"])))=>i.map(i=>d[i]);
...
import { d as pt, p as os, m as ul, s as fl, __tla as __tla_0 } from "./didacticCpp-9rTpExtC.js";
...
`);
      ...
      y && (y.value = B, y.addEventListener("change", (h) => {
        ...
        h.stopPropagation(), sa(async () => {
          const { openCalcPanel: S } = await import("./calcPanel-Dlz5GJKe.js").then(async (m2) => {
            await m2.__tla;
            return m2;
          });
          return {
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        try {
          const { cyclicPushover: b } = await sa(async () => {
            const { cyclicPushover: k } = await import("./cyclicPushoverCpp-Uwy7ujKG.js");
            return {
              cyclicPushover: k
            };
