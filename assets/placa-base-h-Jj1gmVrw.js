...
import { a as ke } from "./analyze-DNPn2SjO.js";
import { d as Ee, __tla as __tla_0 } from "./didacticCpp-CLixJGob.js";
import { g as Te } from "./getViewer-By3HsiUo.js";
import { g as je } from "./getParameters-By9CJogb.js";
import { g as Ge } from "./styles-lf_LNy9d.js";
import { e as ht, L as xt, C as Wt, d as ft, E as Zt, c as Qt, V as Ut, a as te, B as ee, b as He, D as Se } from "./Text-BmY6zyQy.js";
...
Promise.all([
  ...
  n.derive(() => {
    ...
    const kt = new He(_t, yt, V), we = new ht({
      color: 9079434,
      transparent: true,
      opacity: 0.35,
      side: Se
    ...
    let dt = {}, pt = {};
    try {
      dt = Ee(b, u, Ht, it), pt = ke(b, u, it, dt), console.log(`Placa base H: ${b.length} nodos, ${u.length} elementos | Pu=${F}kN, Mu=${K}kN\xB7m | t_plate=${(m * 1e3).toFixed(0)}mm`);
    } catch (t) {
  ...
  document.body.append(je(r), me, Ge({
