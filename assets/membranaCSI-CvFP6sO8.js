...
let __tla = Promise.all([
  ...
  P = {
    ...
    build(a, o) {
      ...
      const M = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map(), I = /* @__PURE__ */ new Map(), h = /* @__PURE__ */ new Map(), _ = /* @__PURE__ */ new Map(), C = a.E / (2 * (1 + a.nu));
      for (let e = 0; e < g; e++) M.set(e, a.t), x.set(e, a.E), f.set(e, a.nu), h.set(e, V);
      const E = a.bViga * a.hViga, N = a.bViga * a.hViga ** 3 / 12, q = a.hViga * a.bViga ** 3 / 12, O = 0.28 * a.bViga * a.hViga ** 3;
      for (let e = g; e < l.length; e++) x.set(e, a.E), f.set(e, a.nu), I.set(e, C), v.set(e, E), y.set(e, N), L.set(e, q), p.set(e, O), h.set(e, V), _.set(e, {
        type: "rect",
        b: a.bViga,
        h: a.hViga
      });
