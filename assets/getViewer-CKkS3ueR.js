import { N as ce, B as k, U as de, F as q, G as U, d as Ie, L as te, e as Q, D as J, c as K, r as H, y as Le, b as ke, V as R, w as ee, x as D, X as be, j as Ee, a as ne, f as $, S as ue, Y as he, k as Ze, i as We, Z as Ne, _ as _e, $ as ze, a0 as re, a1 as $e, a2 as He, q as De, s as Ge, t as qe, W as Ue, u as Ke, A as Qe, v as Pe, O as Oe } from "./Text-Dh9LKuSL.js";
...
class Te extends U {
  constructor(t, r, s, n, a, d, u) {
    ...
    if (this.text = new D(`${a[0].toFixed(4)}`), this.text2 = new D(`${(a[1] * -1).toFixed(4)}`), this.normalizedResult = d, this.textPosition = ge(t, r), this.text2Position = ge(r, t), this.text.position.set(...this.textPosition), this.text2.position.set(...this.text2Position), this.text.rotation.setFromRotationMatrix(n), this.text2.rotation.setFromRotationMatrix(n), this.add(this.text, this.text2), b) {
      ...
      const E = new he(f), Z = new he(g), z = new Q({ color: d[0] > 0 ? 24435 : 11411474, side: J }), C = new Q({ color: -d[1] > 0 ? 24435 : 11411474, side: J });
...
function Vt(e, t, r, s) {
  ...
  return F.derive(() => {
    ...
    for (const { idx: x, vals: S } of v) {
      ...
      for (let G = 0; G < N; G++) {
        const O = G / ye, se = Y[0] + P.x * T * O, ie = Y[1] + P.y * T * O, me = Y[2] + P.z * T * O, fe = S[0] + (S[1] - S[0]) * O, ae = a.getColor(fe) ?? new H(0, 0, 0);
