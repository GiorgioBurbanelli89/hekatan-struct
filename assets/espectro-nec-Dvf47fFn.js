...
import { c as S } from "./chartPanel-DKe9UCQ8.js";
import { I as v, T as F, a as $, p as P } from "./espectroNec-CMQq_yyp.js";
document.body.style.margin = "0";
document.body.style.background = "#0d1117";
document.body.style.fontFamily = "ui-monospace, Menlo, Consolas, monospace";
const h = document.createElement("div");
h.innerHTML = `<div style="padding:10px 16px;color:#e6edf3;font-size:15px;font-weight:600;border-bottom:1px solid #30363d">
...
const d = new C({ title: "\u2699\uFE0F Par\xE1metros NEC-SE-DS", container: b });
