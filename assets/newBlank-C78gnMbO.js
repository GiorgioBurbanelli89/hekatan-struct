import { d as ce, __tla as __tla_0 } from "./didacticCpp-BTBicwl0.js";
let de;
    ...
    build(l, t) {
      ...
      for (let n = 0; n < h.length; n++) {
        ...
        if (g.has(n)) {
          ...
          const M = a[i][0] - a[o][0], G = a[i][1] - a[o][1], ie = a[i][2] - a[o][2];
          Math.abs(ie) > Math.max(Math.abs(M), Math.abs(G)) ? P.add(d) : H.add(d);
        }
      }
      const b = Math.round(l.mat ?? 0), W = b === 0 ? O : j, ee = b === 0 ? X : q, ne = b === 0 ? U : K, se = b === 0 ? Y : Q, A = Math.round(l.matShell ?? 0), oe = A === 0 ? O : j, ae = A === 0 ? X : q, te = A === 0 ? U : K, le = A === 0 ? Y : Q, D = /* @__PURE__ */ new Map(), $ = /* @__PURE__ */ new Map(), _ = /* @__PURE__ */ new Map(), I = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Map(), z = /* @__PURE__ */ new Map(), C = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Map();
      for (let n = 0; n < r.length; n++) if (p.has(n)) D.set(n, oe), $.set(n, ae), C.set(n, le), E.set(n, te), T.set(n, l.tShell ?? 0.2);
      else {
        const s = P.has(n), e = s ? l.bCol : l.bViga, o = s ? l.hCol : l.hViga, i = e * o, d = o * Math.pow(e, 3) / 12, M = e * Math.pow(o, 3) / 12, G = 0.14 * Math.pow(Math.min(e, o), 4);
        D.set(n, W), $.set(n, ee), _.set(n, i), I.set(n, d), S.set(n, M), z.set(n, G), C.set(n, se), E.set(n, ne);
      }
      ...
      const k = [], V = window.__hekatanManualSprings;
      if (V && V.size > 0) {
        for (const [n, s] of V.entries()) if (!(n < 0 || n >= a.length)) for (let e = 0; e < 6; e++) s[e] !== 0 && k.push({
          node: n,
          dof: e,
          k: s[e]
        });
