import { m as M, __tla as __tla_0 } from "./didacticCpp-C2di29sC.js";
import { i as P, j as v, d as S, P as _, __tla as __tla_1 } from "./pazFrameE2k-BCTNzm-z.js";
import { a as h, s as x, b as A, p as w, r as y, n as L, g as H } from "./newmarkBeta-CfFoMJcW.js";
let j;
let __tla = Promise.all([
  ...
  j = {
    ...
    computedLabels(e) {
      var _a, _b, _c, _d;
      const t = new Array(4).fill(e.m_lbs2in), s = new Array(4).fill(e.k_lbin), { K: r, M: m } = h(t, s);
      let i = [];
      try {
        i = x(r, m).freqs;
      } catch {
    ...
    build(e, t) {
      const s = z(e);
      P(s, t);
      const r = new Array(4).fill(e.m_lbs2in), m = new Array(4).fill(e.k_lbin), { K: i, M: c } = h(r, m);
...
`;
        ...
        const k = Math.sqrt(n.omega2[0]), T = Math.sqrt(n.omega2[n.omega2.length - 1]), F = A(c, i, k, T, e.xi), E = w(y(e.F0_lb, 0, e.pulseDur_s), 3, 4), $ = Math.floor(e.tEnd_s / e.dt_s), b = L({
          M: c,
          K: i,
          C: F,
          loadFunc: E,
