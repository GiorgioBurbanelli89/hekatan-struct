...
let __tla = Promise.all([
  ...
  const S = 7849;
  function h(e, t, n, o) {
    const l = e - 2 * n, i = 2 * t * n, s = l * o, r = i + s, c = (e - n) / 2, m = 2 * (t * n ** 3 / 12), d = 2 * (t * n) * c ** 2, u = o * l ** 3 / 12, x = m + d + u, f = 2 * (n * t ** 3 / 12) + l * o ** 3 / 12, A = (2 * t * n ** 3 + l * o ** 3) / 3, p = l * o, F = 5 / 6 * (2 * t * n);
    return {
      A: r,
      I33: x,
      I22: f,
  ...
  W = {
    ...
    build(e, t) {
      ...
      ]), m = /* @__PURE__ */ new Map(), d = /* @__PURE__ */ new Map(), u = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), M = e.E / (2 * (1 + e.nu));
      for (let a = 0; a < s.length; a++) m.set(a, e.E), d.set(a, M), u.set(a, n.A), x.set(a, n.I33), f.set(a, n.I22), A.set(a, n.J), p.set(a, n.As2), F.set(a, n.As3), v.set(a, S), b.set(a, e.nu);
      ...
      const I = e.Fx * e.L / (e.E * n.A), _ = ((_b = (_a = g.deformations) == null ? void 0 : _a.get(o)) == null ? void 0 : _b[0]) ?? 0, $ = 848e-7, w = I !== 0 ? (_ - I) / I * 100 : 0;
      console.log(`[W2 Viga axial cantilever] L=${e.L}m  P=${e.Fx}kN  A=${(n.A * 1e4).toFixed(2)} cm\xB2
  u_x anal\xEDtico (P\xB7L/E\xB7A) = ${(I * 1e3).toFixed(5)} mm
