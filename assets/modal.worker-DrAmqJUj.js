(async ()=>{
    ...
    async function Le(L = {}) {
        ...
        var Me;
        function ar() {
            return d.locateFile ? ne("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-DrHcpOgi.wasm", import.meta.url).href;
        }
        function $e(e) {
...
`));
        ...
        var Vr = {
            ...
            invoke_viiiiiiiiiiiddddii: yn,
            invoke_viiiiiiiiiiii: un,
            invoke_viiiiiiiiiiiiiii: Bn,
            invoke_viiiiiiiiiiiiiiii: Xt,
        ...
        function Xt(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, N, C) {
            var O = g();
            try {
        ...
        function yn(e, r, t, n, o, a, s, c, l, f, m, v, _, h, S, N, C, O) {
            var W = g();
            try {
        ...
        function Rn(e, r, t, n, o, a, s, c, l, f) {
            var m = g();
            try {
                w(e)(r, t, n, o, a, s, c, l, f);
            } catch (v) {
        ...
        function Ln(e, r, t, n, o, a, s, c, l, f, m, v) {
            var _ = g();
            try {
    ...
    await Le();
    const b = await Le();
    function jn(L, B, d, k, K = 10, q = 0, X = 0, Q = 1, te, Pe) {
        ...
        A.push(ar);
        const $e = x(k.shearAreasY), Ge = x(k.shearAreasZ), Ve = x(k.localAngles), sr = k.momentReleases ? Array.from(k.momentReleases.keys()) : [], pr = k.momentReleases ? Array.from(k.momentReleases.values()).flatMap(Wn) : [], cr = j(sr, Uint32Array, b.HEAPU32);
        A.push(cr);
