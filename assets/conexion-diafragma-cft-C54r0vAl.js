...
import { v as c, P as $t } from "./Text-CSfbf1xJ.js";
import { a as Ut } from "./analyze-BydHtRcI.js";
import { d as Gt, __tla as __tla_0 } from "./didacticCpp-B5f-GyHC.js";
import { g as Yt, a as gt, h as yt, b as Zt } from "./styles-CXNYye6A.js";
import { e as Rt } from "./makeDraggable-zx2br6Yh.js";
import { g as Jt } from "./getParameters-DsthXvNv.js";
...
Promise.all([
  ...
  c.derive(() => {
    ...
    const it = l / u, rt = m / u, A = (t, e, b, s, a, o) => {
      const f = [];
    ...
    A("y", -m / 2, "x", it, u, E), A("y", m / 2, "x", it, u, E), A("x", -l / 2, "y", rt, u, E), A("x", l / 2, "y", rt, u, E);
    function dt(t) {
      const e = l / 2 + M, b = m / 2 + M, s = 2, a = m / 2, o = b;
      for (let n = 0; n < s; n++) {
        const i = a + n / s * (o - a), p = a + (n + 1) / s * (o - a);
        for (let r = 0; r < u + 2; r++) {
          const x = -e + r / (u + 2) * (2 * e), h = -e + (r + 1) / (u + 2) * (2 * e);
          g(d(x, i, t), d(h, i, t), d(h, p, t), d(x, p, t), S);
        }
      }
      for (let n = 0; n < s; n++) {
        const i = -a - n / s * (o - a), p = -a - (n + 1) / s * (o - a);
      ...
      for (let n = 0; n < s; n++) {
        ...
        for (let r = 0; r < u; r++) {
          const x = -m / 2 + r / u * m, h = -m / 2 + (r + 1) / u * m;
          g(d(i, x, t), d(p, x, t), d(p, h, t), d(i, h, t), S);
        }
      }
      for (let n = 0; n < s; n++) {
        const i = -f - n / s * M, p = -f - (n + 1) / s * M;
    ...
    const ut = (t) => {
      ...
      for (let a = 0; a <= I; a++) {
        ...
        for (let n = 0; n <= 4; n++) {
          const i = -T / 2 + n * b;
          Math.abs(i) < 1e-7 ? Math.abs(t - O) < 1e-6 ? o.push(y[F][a]) : Math.abs(t - w) < 1e-6 ? o.push(y[0][a]) : o.push(d(0, f, t)) : o.push(d(i, f, t));
        }
        s.push(o);
      }
    ...
    _.forEach((t, e) => {
      Math.abs(t[0]) <= l / 2 + 1e-6 && Math.abs(t[1]) <= m / 2 + 1e-6 && (Math.abs(t[2]) < 1e-6 || Math.abs(t[2] - N) < 1e-6) && vt.set(e, [
        true,
        true,
        true,
        true,
    ...
    const G = [];
    _.forEach((t, e) => {
      Math.abs(t[1] - (m / 2 + H)) < 1e-6 && Math.abs(t[0]) <= T / 2 + 1e-6 && t[2] >= w - 1e-6 && t[2] <= O + 1e-6 && G.push(e);
    });
    ...
    const xt = W * H, Tt = xt / P, ht = 2 * (l + m) * S, bt = Tt / ht;
    let L = 0;
