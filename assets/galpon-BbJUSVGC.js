...
import { m as F, d as N, __tla as __tla_0 } from "./didacticCpp-PqvqKlgs.js";
let P;
let __tla = Promise.all([
  ...
  P = {
    ...
    build(n, o) {
      const u = n.span, p = n.length, c = n.height, m = n.archRise, d = Math.round(n.xDiv), h = Math.round(n.yDiv), $ = (e) => c + m * (1 - Math.pow(2 * e / u - 1, 2)), g = h + 1, s = [], a = [];
      for (let e = 0; e < g; e++) {
        const t = [], r = p / h * e;
      ...
      const L = n.barA, v = (n.barI ?? 869) * 1e-8, I = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map(), C = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map();
      for (let e = 0; e < l.length; e++) I.set(e, O), w.set(e, Y), R.set(e, S), C.set(e, k), G.set(e, L), b.set(e, v), D.set(e, v), A.set(e, 2 * v);
      ...
      const x = N(s, l, o.nodeInputs.val, o.elementInputs.val);
      o.deformOutputs.val = x, o.analyzeOutputs.val = _(s, l, o.elementInputs.val, x), o.objects3D.val = [];
    },
    runModal(n, o, u) {
      var _a, _b;
