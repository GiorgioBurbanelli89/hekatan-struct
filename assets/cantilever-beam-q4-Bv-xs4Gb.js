...
import { v as a } from "./Text-CSfbf1xJ.js";
import { a as B } from "./analyze-BydHtRcI.js";
import { d as F, __tla as __tla_0 } from "./didacticCpp-B5f-GyHC.js";
import { g as H, b as T } from "./styles-CXNYye6A.js";
import { g as V } from "./getParameters-DsthXvNv.js";
...
Promise.all([
  ...
  a.derive(() => {
    ...
    try {
      ...
      const t = m.deformations.get(_), e = t ? t[2] : 0, g = y * l * l * l / 12, v = x * n * n * n / (3 * c * g), b = Math.abs(e) / v, R = Math.abs(b - 1) * 100, j = x * n * (l / 2) / g;
      console.log(`Viga Q4: Uz_tip=${e.toExponential(4)} | Anal\xEDtico=${v.toExponential(4)} | ratio=${b.toFixed(4)}`), O.val = {
        uz_an: -v,
        uz_he: e,
        ratio: b,
        errPct: R,
  ...
  h.style.cssText = "position:fixed;top:8px;right:8px;background:rgba(20,20,20,0.94);color:#ddd;font:11px/1.4 ui-monospace,Menlo,monospace;padding:10px 14px;border-radius:6px;border:1px solid #444;z-index:9999;min-width:320px;max-width:400px;";
  a.derive(() => {
