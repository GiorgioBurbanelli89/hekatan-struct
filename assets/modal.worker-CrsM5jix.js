    ...
    async function Le(L = {}) {
        ...
        (function() {
            function e(l) {
                ...
                return u = u.map((m, v, _)=>m.padStart(2, "0")), u.join("");
            }
            var r = (l)=>[
                    l / 1e4 | 0,
                    (l / 100 | 0) % 100,
        ...
        f(!X, "shell environment detected but not enabled at build time.  Add `shell` to `-sENVIRONMENT` to enable.");
        var _e;
        ...
        function ze() {
            var e = Fr();
            f((e & 3) == 0), e == 0 && (e += 4), F[e >> 2] = 34821223, F[e + 4 >> 2] = 2310721022, F[0] = 1668509029;
        }
        function ve() {
            if (!me) {
                var e = Fr();
        ...
        function T(e) {
            return ()=>f(!1, `call to '${e}' via reference taken before Wasm module initialization`);
        }
        function He(e) {
        ...
        var Te, pe, $, ge, ye, F, z, ae = !1;
        function nr() {
            var e = hr.buffer;
            $ = new Int8Array(e), d.HEAPU8 = ge = new Uint8Array(e), ye = new Int32Array(e), d.HEAPU32 = F = new Uint32Array(e), d.HEAPF64 = new Float64Array(e), z = new BigInt64Array(e), new BigUint64Array(e);
        }
        ...
        function or() {
            f(!ae), ae = !0, ve(), !d.noFSInit && !i.initialized && i.init(), Ue.__wasm_call_ctors(), i.ignorePermissions = !1;
        }
        function Re() {
        ...
        function N(e, r) {
            return (...t)=>{
                f(ae, `native function \`${e}\` called before runtime initialization`);
                var n = Ue[e];
        ...
        var Me;
        function ar() {
            return d.locateFile ? ne("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-Cwcbau8L.wasm", import.meta.url).href;
        }
        function $e(e) {
        ...
        var qe = (e)=>{
        ...
        }, Ne = [], Ke = (e)=>Ne.push(e), Ee = [], lr = (e)=>Ee.push(e), se = (e)=>(f(typeof e == "number", `ptrToString expects a number, got ${typeof e}`), e >>>= 0, "0x" + e.toString(16).padStart(8, "0")), g = (e)=>zr(e), y = ()=>Wr(), ee = (e)=>{
            ...
            return a;
        }, Y = (e, r, t)=>(f(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? J(ge, e, r) : ""), Xe = (e, r, t, n)=>R(`Assertion failed: ${Y(e)}, at: ` + [
        ...
        var ce = (e)=>Lr(e), ke = (e)=>{
            ...
            return r[t] = 0, t - o;
        }, Qe = (e, r, t)=>(f(typeof t == "number", "stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), Ze(e, ge, r, t)), mr = (e)=>{
            ...
            var o = new Date().getFullYear(), a = new Date(o, 0, 1), s = new Date(o, 6, 1), c = a.getTimezoneOffset(), l = s.getTimezoneOffset(), u = Math.max(c, l);
            F[e >> 2] = u * 60, ye[r >> 2] = +(c != l);
            var m = (h)=>{
                var S = h >= 0 ? "-" : "+", O = Math.abs(h), D = String(Math.floor(O / 60)).padStart(2, "0"), C = String(O % 60).padStart(2, "0");
                return `UTC${S}${D}${C}`;
            }, v = m(c), _ = m(l);
            f(v), f(_), f(mr(v) <= 16, `timezone name truncated to fit in TZNAME_MAX (${v})`), f(mr(_) <= 16, `timezone name truncated to fit in TZNAME_MAX (${_})`), l < c ? (Qe(v, t, 17), Qe(_, n, 17)) : (Qe(v, n, 17), Qe(_, t, 17));
        ...
        var nt = ()=>2147483648, it = (e, r)=>(f(r, "alignment argument is required"), Math.ceil(e / r) * r), ot = (e)=>{
            ...
            relative: (e, r)=>{
                ...
                function t(u) {
                    for(var m = 0; m < u.length && u[m] === ""; m++);
                    for(var v = u.length - 1; v >= 0 && u[v] === ""; v--);
                    return m > v ? [] : u.slice(m, v - m + 1);
                }
...
`));
            ...
            stream_ops: {
                ...
                write (e, r, t, n, o, a) {
                    if (f(!(r instanceof ArrayBuffer)), r.buffer === $.buffer && (a = !1), !n) return 0;
                    var s = e.node;
            ...
            if (be--, d.monitorRunDependencies?.(be), f(e, "removeRunDependency requires an ID"), f(xe[e]), delete xe[e], be == 0 && (le !== null && (clearInterval(le), le = null), rr)) {
                var r = rr;
                rr = null, r();
            }
        }, gt = (e)=>{
            be++, d.monitorRunDependencies?.(be), f(e, "addRunDependency requires an ID"), f(!xe[e]), xe[e] = 1, le === null && globalThis.setInterval && (le = setInterval(()=>{
                if (me) {
            ...
            for (var t of Nr)if (t.canHandle(r)) return f(t.handle.constructor.name === "AsyncFunction", "Filesystem plugin handlers must be async functions (See #24914)"), t.handle(e, r);
            return e;
        }, Or = async (e, r, t, n, o, a, s, c)=>{
            var l = r ? Ce.resolve(M.join2(e, r)) : e, u = ht(`cp ${l}`);
            gt(u);
            try {
                var m = t;
        ...
        }, Et = (e, r, t, n, o, a, s, c, l, u)=>{
            Or(e, r, t, n, o, c, l, u).then(a).catch(s);
        }, i = {
            root: null,
            mounts: [],
            devices: {},
                    ...
                    for(var n = e.split("/").filter((u)=>!!u), o = i.root, a = "/", s = 0; s < n.length; s++){
                        ...
                        if (n[s] !== ".") {
                            ...
                            try {
                                ...
                                if (u?.errno === 44 && c && r.noent_okay) return {
                                    path: a
                                };
                                throw u;
                            }
            ...
            rename (e, r) {
                ...
                var u = i.lookupNode(c, o), m = Ce.relative(e, n);
                ...
                if (u !== v) {
                    var _ = i.isDir(u.mode), h = i.mayDelete(c, o, _);
                    ...
                    if (i.isMountpoint(u) || v && i.isMountpoint(v)) throw new i.ErrnoError(10);
            ...
            init (e, r, t) {
                f(!i.initialized, "FS.init was previously called. If you want to initialize later with custom parameters, remove any earlier calls (note that one is automatically added to the generated code)"), i.initialized = !0, e ??= d.stdin, r ??= d.stdout, t ??= d.stderr, i.createStandardStreams(e, r, t);
            },
            quit () {
            ...
            createDataFile (e, r, t, n, o, a) {
                ...
                if (t) {
                    if (typeof t == "string") {
                        for(var u = new Array(t.length), m = 0, v = t.length; m < v; ++m)u[m] = t.charCodeAt(m);
                        t = u;
                    }
                    i.chmod(l, c | 146);
                    var _ = i.open(l, 577);
            ...
            createLazyFile (e, r, t, n, o) {
                ...
                var u = {};
                for (const [v, _] of Object.entries(l.stream_ops))u[v] = (...h)=>(i.forceLoadFile(l), _(...h));
                function m(v, _, h, S, O) {
                    var D = v.node.contents;
                    if (O >= D.length) return 0;
                    var C = Math.min(D.length - O, S);
                    if (f(C >= 0), D.slice) for(var W = 0; W < C; W++)_[h + W] = D[O + W];
                    else for(var W = 0; W < C; W++)_[h + W] = D.get(O + W);
                    return C;
                }
                return u.read = (v, _, h, S, O)=>(i.forceLoadFile(l), m(v, _, h, S, O)), u.mmap = (v, _, h, S, O)=>{
                    i.forceLoadFile(l);
                    var D = Rr();
                    if (!D) throw new i.ErrnoError(48);
                    return m(v, $, D, _, h), {
                        ptr: D,
                        allocated: !0
                    };
            ...
            writeStat (e, r) {
                F[e >> 2] = r.dev, F[e + 4 >> 2] = r.mode, F[e + 8 >> 2] = r.nlink, F[e + 12 >> 2] = r.uid, F[e + 16 >> 2] = r.gid, F[e + 20 >> 2] = r.rdev, z[e + 24 >> 3] = BigInt(r.size), ye[e + 32 >> 2] = 4096, ye[e + 36 >> 2] = r.blocks;
        ...
        var At = (e)=>e, Dr = [], w = (e)=>{
            var r = Dr[e];
            return r || (Dr[e] = r = Pr.get(e)), f(Pr.get(e) == r, "JavaScript-side Wasm function table mirror is out of date!"), r;
        ...
        function Ct(e) {
            f(typeof e.deform < "u", "missing Wasm export: deform"), f(typeof e.malloc < "u", "missing Wasm export: malloc"), f(typeof e.free < "u", "missing Wasm export: free"), f(typeof e.__cxa_free_exception < "u", "missing Wasm export: __cxa_free_exception"), f(typeof e.assembled_joint_mass < "u", "missing Wasm export: assembled_joint_mass"), f(typeof e.modal < "u", "missing Wasm export: modal"), f(typeof e.modal_paz < "u", "missing Wasm export: modal_paz"), f(typeof e.didactic_solve < "u", "missing Wasm export: didactic_solve"), f(typeof e.plate_q4_solve < "u", "missing Wasm export: plate_q4_solve"), f(typeof e.slopeAllocDouble < "u", "missing Wasm export: slopeAllocDouble"), f(typeof e.slopeStabilitySolver < "u", "missing Wasm export: slopeStabilitySolver"), f(typeof e.nonlinear_dynamic < "u", "missing Wasm export: nonlinear_dynamic"), f(typeof e.steel02_test < "u", "missing Wasm export: steel02_test"), f(typeof e.cyclic_pushover < "u", "missing Wasm export: cyclic_pushover"), f(typeof e.concrete02_test < "u", "missing Wasm export: concrete02_test"), f(typeof e.hex8_solve < "u", "missing Wasm export: hex8_solve"), f(typeof e.fflush < "u", "missing Wasm export: fflush"), f(typeof e.strerror < "u", "missing Wasm export: strerror"), f(typeof e.emscripten_stack_get_end < "u", "missing Wasm export: emscripten_stack_get_end"), f(typeof e.emscripten_stack_get_base < "u", "missing Wasm export: emscripten_stack_get_base"), f(typeof e.setThrew < "u", "missing Wasm export: setThrew"), f(typeof e._emscripten_tempret_set < "u", "missing Wasm export: _emscripten_tempret_set"), f(typeof e.emscripten_stack_init < "u", "missing Wasm export: emscripten_stack_init"), f(typeof e.emscripten_stack_get_free < "u", "missing Wasm export: emscripten_stack_get_free"), f(typeof e._emscripten_stack_restore < "u", "missing Wasm export: _emscripten_stack_restore"), f(typeof e._emscripten_stack_alloc < "u", "missing Wasm export: _emscripten_stack_alloc"), f(typeof e.emscripten_stack_get_current < "u", "missing Wasm export: emscripten_stack_get_current"), f(typeof e.__cxa_decrement_exception_refcount < "u", "missing Wasm export: __cxa_decrement_exception_refcount"), f(typeof e.__cxa_increment_exception_refcount < "u", "missing Wasm export: __cxa_increment_exception_refcount"), f(typeof e.__get_exception_message < "u", "missing Wasm export: __get_exception_message"), f(typeof e.__cxa_can_catch < "u", "missing Wasm export: __cxa_can_catch"), f(typeof e.__cxa_get_exception_ptr < "u", "missing Wasm export: __cxa_get_exception_ptr"), f(typeof e.memory < "u", "missing Wasm export: memory"), f(typeof e.__indirect_function_table < "u", "missing Wasm export: __indirect_function_table"), d._deform = N("deform", 75), d._malloc = N("malloc", 1), kr = d._free = N("free", 1), d._assembled_joint_mass = N("assembled_joint_mass", 22), d._modal = N("modal", 83), d._modal_paz = N("modal_paz", 54), d._didactic_solve = N("didactic_solve", 48), d._plate_q4_solve = N("plate_q4_solve", 26), d._slopeAllocDouble = N("slopeAllocDouble", 1), d._slopeStabilitySolver = N("slopeStabilitySolver", 16), d._nonlinear_dynamic = N("nonlinear_dynamic", 20), d._steel02_test = N("steel02_test", 8), d._cyclic_pushover = N("cyclic_pushover", 40), d._concrete02_test = N("concrete02_test", 10), d._hex8_solve = N("hex8_solve", 17), Ur = N("fflush", 1), Ir = N("strerror", 1), Fr = e.emscripten_stack_get_end, e.emscripten_stack_get_base, E = N("setThrew", 2), Lr = N("_emscripten_tempret_set", 1), Br = e.emscripten_stack_init, e.emscripten_stack_get_free, zr = e._emscripten_stack_restore, Hr = e._emscripten_stack_alloc, Wr = e.emscripten_stack_get_current, br = N("__cxa_decrement_exception_refcount", 1), vr = N("__cxa_increment_exception_refcount", 1), jr = N("__get_exception_message", 3), $r = N("__cxa_can_catch", 3), Gr = N("__cxa_get_exception_ptr", 1), hr = e.memory, Pr = e.__indirect_function_table;
        }
        var Vr = {
            __assert_fail: Xe,
            ...
            invoke_iiiiiiiiiii: Pn,
            invoke_iiiiiiiiiiii: On,
            invoke_iiiiiiiiiiiii: Tn,
        ...
        function Kt(e, r, t, n, o, a, s, c, l, u, m, v, _, h, S, O, D) {
            var C = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, u, m, v, _, h, S, O, D);
            } catch (W) {
                if (g(C), !(W instanceof p)) throw W;
                E(1, 0);
            }
        }
        function Yt(e, r, t, n, o, a, s, c, l, u, m) {
            var v = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, u, m);
            } catch (_) {
                if (g(v), !(_ instanceof p)) throw _;
                E(1, 0);
            }
        }
        function Xt(e, r, t, n, o, a, s, c, l, u, m, v, _, h, S) {
            var O = y();
            try {
                return w(e)(r, t, n, o, a, s, c, l, u, m, v, _, h, S);
            } catch (D) {
                if (g(O), !(D instanceof p)) throw D;
                E(1, 0);
            }
        }
        function Jt(e, r, t, n, o, a, s, c, l, u) {
            var m = y();
            try {
                return w(e)(r, t, n, o, a, s, c, l, u);
            } catch (v) {
        ...
        function Qt(e, r, t, n, o, a, s, c) {
            ...
            try {
                ...
                if (g(l), !(u instanceof p)) throw u;
                E(1, 0);
            }
        }
        function en(e, r, t, n, o, a, s, c, l, u) {
            var m = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, u);
            } catch (v) {
                if (g(m), !(v instanceof p)) throw v;
                E(1, 0);
            }
        ...
        function nn(e, r, t, n, o, a, s, c, l, u, m, v, _) {
            var h = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, u, m, v, _);
            } catch (S) {
                if (g(h), !(S instanceof p)) throw S;
                E(1, 0);
            }
        }
        function on(e, r, t, n, o, a, s, c, l, u, m, v) {
            var _ = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, u, m, v);
            } catch (h) {
        ...
        function ln(e, r, t, n, o, a, s, c, l, u, m, v, _, h) {
            var S = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, u, m, v, _, h);
            } catch (O) {
                if (g(S), !(O instanceof p)) throw O;
                E(1, 0);
            }
        }
        ...
        function un(e, r, t, n, o, a, s, c, l, u, m, v, _) {
            var h = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, u, m, v, _);
            } catch (S) {
        ...
        function vn(e, r, t, n, o, a, s, c, l, u) {
            var m = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, u);
            } catch (v) {
        ...
        function pn(e, r, t, n, o, a, s, c, l, u, m, v, _, h, S, O, D, C) {
            var W = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, u, m, v, _, h, S, O, D, C);
            } catch (de) {
                if (g(W), !(de instanceof p)) throw de;
                E(1, 0);
            }
        }
        function gn(e, r, t, n, o, a, s, c, l, u, m, v, _, h, S, O) {
            var D = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, u, m, v, _, h, S, O);
            } catch (C) {
                if (g(D), !(C instanceof p)) throw C;
                E(1, 0);
            }
        }
        function yn(e, r, t) {
        ...
        function Pn(e, r, t, n, o, a, s, c, l, u, m) {
            var v = y();
            try {
                return w(e)(r, t, n, o, a, s, c, l, u, m);
            } catch (_) {
                if (g(v), !(_ instanceof p)) throw _;
                E(1, 0);
            }
        ...
        function Tn(e, r, t, n, o, a, s, c, l, u, m, v, _) {
            var h = y();
            try {
                return w(e)(r, t, n, o, a, s, c, l, u, m, v, _);
            } catch (S) {
                if (g(h), !(S instanceof p)) throw S;
                E(1, 0);
            }
        ...
        function On(e, r, t, n, o, a, s, c, l, u, m, v) {
            var _ = y();
            try {
                return w(e)(r, t, n, o, a, s, c, l, u, m, v);
            } catch (h) {
                if (g(_), !(h instanceof p)) throw h;
                E(1, 0);
            }
        }
        function Dn(e, r, t, n, o, a, s, c, l, u, m, v, _, h, S, O) {
            var D = y();
            try {
                w(e)(r, t, n, o, a, s, c, l, u, m, v, _, h, S, O);
            } catch (C) {
        ...
        function Ar() {
            ...
            function e() {
                f(!qr), qr = !0, d.calledRun = !0, !me && (or(), Te?.(d), d.onRuntimeInitialized?.(), oe("onRuntimeInitialized"), f(!d._main, 'compiled without a main, but one is present. if you added it from JS, use Module["onRuntimeInitialized"]'), Re());
            }
    ...
    await Le();
    const b = await Le();
    function In(L, B, d, k, K = 10, q = 0, X = 0, Q = 1, te, Pe) {
        ...
        A.push(me);
        const f = j(_e, Uint8Array, b.HEAPU8);
        A.push(f);
        const x = (U)=>{
            const G = U ? Array.from(U.keys()) : [], gr = U ? Array.from(U.values()) : [], _r = j(G, Uint32Array, b.HEAPU32);
            A.push(_r);
            const Ze = j(gr, Float64Array, b.HEAPF64);
            return A.push(Ze), {
                keysPtr: _r,
                valuesPtr: Ze,
                size: G.length
            };
        }, ze = x(k.elasticities), ve = x(k.areas), p = x(k.momentsOfInertiaZ), he = x(k.momentsOfInertiaY), oe = x(k.shearModuli), T = x(k.torsionalConstants), He = x(k.densities), We = x(k.thicknesses), je = x(k.poissonsRatios), Ae = x(k.membraneModifiers), Te = x(k.bendingModifiers), pe = k.plateFormulations, $ = pe ? Array.from(pe.keys()) : [], ge = pe ? Array.from(pe.values()) : [], ye = j($, Uint32Array, b.HEAPU32);
        A.push(ye);
        const F = j(ge, Uint32Array, b.HEAPU32);
        A.push(F);
        ...
        A.push(or);
        const Re = k.drillingPenaltyScales, R = Re ? Array.from(Re.keys()) : [], N = Re ? Array.from(Re.values()) : [], Me = j(R, Uint32Array, b.HEAPU32);
        A.push(Me);
        const ar = j(N, Float64Array, b.HEAPF64);
        A.push(ar);
        const $e = x(k.shearAreasY), Ge = x(k.shearAreasZ), Ve = x(k.localAngles), sr = k.momentReleases ? Array.from(k.momentReleases.keys()) : [], pr = k.momentReleases ? Array.from(k.momentReleases.values()).flatMap(Un) : [], cr = j(sr, Uint32Array, b.HEAPU32);
        A.push(cr);
        ...
        A.push(Xe), b._modal(ne, L.length, ie, fe.length, ue, B.length, me, f, I.length, ze.keysPtr, ze.valuesPtr, ze.size, ve.keysPtr, ve.valuesPtr, ve.size, p.keysPtr, p.valuesPtr, p.size, he.keysPtr, he.valuesPtr, he.size, oe.keysPtr, oe.valuesPtr, oe.size, T.keysPtr, T.valuesPtr, T.size, He.keysPtr, He.valuesPtr, He.size, We.keysPtr, We.valuesPtr, We.size, je.keysPtr, je.valuesPtr, je.size, Ae.keysPtr, Ae.valuesPtr, Ae.size, Te.keysPtr, Te.valuesPtr, Te.size, ye, F, $.length, ir, or, ae.length, Me, ar, R.length, $e.keysPtr, $e.valuesPtr, $e.size, Ge.keysPtr, Ge.valuesPtr, Ge.size, Ve.keysPtr, Ve.valuesPtr, Ve.size, cr, qe, sr.length, Ne.keysPtr, Ne.valuesPtr, Ne.size, Q, Ke.keysPtr, Ke.valuesPtr, Ke.size, se, Ee ? Ee.length : 0, K, q, X, g, y, ee, Oe, Ye, J, Y, Xe);
        const re = b.HEAPU32[g / 4], we = b.HEAPU32[y / 4], Je = b.HEAPU32[ee / 4], V = b.HEAPU32[Oe / 4], De = b.HEAPU32[Ye / 4], Se = b.HEAPU32[J / 4], ce = b.HEAPU32[Y / 4], ke = b.HEAPU32[Xe / 4];
        let dr = [], fr = [], ur = [];
        if (we > 0 && re) {
