import { v as L, P as xo, r as tn, a7 as zn, B as he, a8 as Fn, F as zt, a4 as yo, J as Qe, X as Bt, L as ht, c as Ot, w as go, b as Vo, a9 as To, e as je, d as qe, V as x, $ as en, aa as Bn, H as vo, D as Tt, a as Ct, x as ot, z as En, ab as An, t as Lo, n as Io, I as Sn, a2 as hn, S as rn, l as to, f as no, h as oo, i as so, ac as ao, ad as kn, q as $o, ae as Ro, af as Bo, ag as Xo, ah as Yo, g as io, ai as lo, C as ro, W as Do, K as No, O as Zo, Y as Uo, T as _n, p as Xn, Z as Ko, _ as co, U as Ho } from "./theme-D5p5K0bJ.js";
import { T as yt, O as po } from "./Text-B4nrRMfX.js";
...
function Jo(e, a, w) {
  ...
  return yo((S, y) => {
    ...
    e.nodes.val && l.geometry.setAttribute("position", new zt(a.val.flat(), 3));
  }), L.derive(() => {
...
function Yn(e, a) {
  ...
  const b = new Bt(w.grid), _ = new Bt(w.grid).multiplyScalar(0.45), v = (te, de, ie, M) => {
    ...
    const Z = new he();
    Z.setAttribute("position", new zt(U, 3));
    ...
    const ne = new he();
    ne.setAttribute("position", new zt(ue, 3));
...
function es(e, a, w, f) {
  ...
  return L.derive(() => {
    ...
    (_a = e.elements) == null ? void 0 : _a.val.forEach((y, m) => {
      const g = new yt(`${m}`, void 0, "#001219");
...
function uo(e, a) {
  const w = new Qe(), f = 0.05 * e * 1, l = tn(), S = new yt("X", "red", "transparent"), y = new yt(a ? "Z" : "Y", "green", "transparent"), m = new yt(a ? "Y" : "Z", "blue", "transparent"), g = new en(new x(1, 0, 0), new x(0, 0, 0), 1, l.axisArrow, 0.2, 0.2), b = new en(new x(0, 1, 0), new x(0, 0, 0), 1, l.axisArrow, 0.2, 0.2), _ = new en(new x(0, 0, 1), new x(0, 0, 0), 1, l.axisArrow, 0.2, 0.2);
...
function os(e, a, w, f) {
  ...
  S.setAttribute("position", new zt([...m, ...g, ...m, ...b, ...m, ..._], 3));
  const v = [255, 0, 0], K = [0, 255, 0], te = [0, 0, 255];
  return S.setAttribute("color", new zt([...v, ...v, ...K, ...K, ...te, ...te], 3)), L.derive(() => {
    var _a;
  ...
  return L.derive(() => {
    ...
    I.forEach((C, N) => {
      ...
      if (E.type === "CFT") {
        ...
        ke.position.set(...D), ke.rotation.setFromRotationMatrix(oe), l.add(ke);
        const ze = new Ct(J.outline, Se);
        ze.position.set(...D), ze.rotation.setFromRotationMatrix(oe), l.add(ze);
      }
      const pe = ss(E);
      if (pe) {
        const Pe = ["I", "HSS", "CFT", "L", "2L", "C", "2C", "T", "pipe", "coldC"].includes(E.type) ? "#ff9900" : "#00ccff", Se = new yt(pe, Pe, "transparent");
    ...
    S.children.forEach((B) => {
      B instanceof yt && B.updateScale(q * f.rawVal);
    });
  }), L.derive(() => {
...
class Pn extends Qe {
  constructor(a, w, f, l, S, y, m) {
    ...
    this.lines = new Ct(_, new ht({ color: tn().resultOutline })), this.lines.position.set(...a), this.lines.rotation.setFromRotationMatrix(l), m && this.lines.rotateX(Math.PI / 2), this.add(this.lines);
    const v = new An(g), K = new je({ color: y[1] > 0 ? 24435 : 11411474, side: Tt });
    this.mesh = new qe(v, K), this.mesh.position.set(...a), this.mesh.rotation.setFromRotationMatrix(l), m && this.mesh.rotateX(Math.PI / 2), this.add(this.mesh), this.text = new yt(`${S[1].toFixed(2)}`), this.normalizedResult = y, this.textPosition = wn([a, w]), this.text.position.set(...this.textPosition), this.text.rotation.setFromRotationMatrix(l), this.add(this.text);
  }
  updateScale(a) {
...
class fo extends Qe {
  constructor(a, w, f, l, S, y, m) {
    ...
    if (this.text = new yt(`${S[0].toFixed(2)}`), this.text2 = new yt(`${(S[1] * -1).toFixed(2)}`), this.normalizedResult = y, this.textPosition = Zn(a, w), this.text2Position = Zn(w, a), this.text.position.set(...this.textPosition), this.text2.position.set(...this.text2Position), this.text.rotation.setFromRotationMatrix(l), this.text2.rotation.setFromRotationMatrix(l), this.add(this.text, this.text2), b) {
      ...
      this.lines = new Ct(de, M), this.lines2 = new Ct(ie, M), this.lines.position.set(...a), this.lines2.position.set(...a), this.lines.rotation.setFromRotationMatrix(l), this.lines2.rotation.setFromRotationMatrix(l), m && this.lines.rotateX(Math.PI / 2), m && this.lines2.rotateX(Math.PI / 2), this.add(this.lines, this.lines2);
      ...
      this.lines = new Ct(K, new ht({ color: tn().resultOutline })), this.lines.position.set(...a), this.lines.rotation.setFromRotationMatrix(l), m && this.lines.rotateX(Math.PI / 2), this.add(this.lines);
...
class rs extends Qe {
  constructor(a, w, f) {
    ...
    f[0] && (this.xText1 = new yt(`${l ? "Fx" : "Dx"}: ` + f[0].toFixed(4))), f[3] && (this.xText2 = new yt(`${l ? "Mx" : "Rx"}: ` + f[3].toFixed(4))), f[1] && (this.yText1 = new yt(`${l ? "Fy" : "Dy"}: ` + f[1].toFixed(4))), f[4] && (this.yText2 = new yt(`${l ? "My" : "Ry"}: ` + f[4].toFixed(4))), f[2] && (this.zText1 = new yt(`${l ? "Fz" : "Dz"}: ` + f[2].toFixed(4))), f[5] && (this.zText2 = new yt(`${l ? "Mz" : "Rz"}: ` + f[5].toFixed(4))), (f[0] || f[3]) && (this.xArrow = new en(new x(1, 0, 0), new x(0, 0, 0), 1, 15637248, 0.3, 0.3)), (f[1] || f[4]) && (this.yArrow = new en(new x(0, 1, 0), new x(0, 0, 0), 1, 15637248, 0.3, 0.3)), (f[2] || f[5]) && (this.zArrow = new en(new x(0, 0, 1), new x(0, 0, 0), 1, 15637248, 0.3, 0.3)), this.position.set(...a), this.xArrow && this.add(this.xArrow), this.yArrow && this.add(this.yArrow), this.zArrow && this.add(this.zArrow), this.xText1 && this.add(this.xText1), this.xText2 && this.add(this.xText2), this.yText1 && this.add(this.yText1), this.yText2 && this.add(this.yText2), this.zText1 && this.add(this.zText1), this.zText2 && this.add(this.zText2);
  }
  updateScale(a) {
...
function ds({ drawingObj: e, gridObj: a, scene: w, getActiveCamera: f, controls: l, gridSize: S, derivedDisplayScale: y, rendererElm: m, viewerRender: g }) {
  ...
  const I = new x(), V = (n, o, i, t, d, s) => {
    ...
    if (o === "col" || o === "wall" || o === "extp" || o === "extl") {
      Mt = n, me(`\u{1F4D0} Altura ${n}m memorizada \u2014 hac\xE9 el click para crear ${{ col: "columna", wall: "pared", extp: "extrusi\xF3n punto\u2192l\xEDnea", extl: "extrusi\xF3n l\xEDnea\u2192\xE1rea" }[o]}.`), Z.blur();
      return;
    }
  ...
  window.__hekatanTypeCoord = (n) => {
    ...
    const o = C(n);
    if (!o) return false;
    if (o.kind === "length") return T(o.L), true;
    const i = N(o);
    if (!i) return false;
    if (j(i), ((_c = (_b = (_a = window.__hekatanCadState) == null ? void 0 : _a.get) == null ? void 0 : _b.call(_a)) == null ? void 0 : _c.tool) === "area" && e.polylines) {
      const d = e.polylines.rawVal, s = d.length - 1, r = d[s] ?? [];
      if (r.length === 4) {
        e.polylines.val = [...d.slice(0, -1), [...r, r[0]], []], e.areas && (e.areas.val = [...e.areas.rawVal, s]);
        try {
          (_d = window.__hekatanRebuild) == null ? void 0 : _d.call(window);
        } catch {
        }
  ...
  const E = new Ct(new he().setFromPoints([new x(0, 0, 0), new x(0, 0, 0)]), new hn({ color: 2282478, dashSize: 0.2, gapSize: 0.1, transparent: true, opacity: 0.85, linewidth: 2 }));
  ...
  }, Ue = gt(3462041), A = gt(16724804), W = gt(6333946);
  st.add(Ue, A, W);
  const ee = (n, o, i, t) => {
  ...
  const Q = new Ct(new he().setFromPoints([new x(0, 0, 0), new x(0, 0, 0)]), new ht({ color: 16724804, transparent: true, opacity: 0.95, linewidth: 4, depthTest: false }));
  Q.renderOrder = 998, Q.frustumCulled = false, Q.visible = false, w.add(Q);
  let ve = -1, ae = -1, Ae = -1;
  const we = /* @__PURE__ */ new Set();
  window.__hekatanSelection = we;
  const De = new Ct(new he().setFromPoints([new x(), new x()]), new ht({ color: 16766720, transparent: true, opacity: 0.95, depthTest: false }));
  ...
  const pt = (n, o, i, t) => {
    ...
    for (const r of we) {
      ...
      if (p === "pt") {
        const k = n[+u[0]];
        if (!k) continue;
        const P = new qe(new rn(0.025, 12, 12), new je({ color: lt, transparent: true, opacity: 0.9, depthTest: false }));
        ...
        if (!P || !c) continue;
        const h = new he().setFromPoints([new x(P[0], P[1], P[2]), new x(c[0], c[1], c[2])]), F = new Ct(h, new ht({ color: lt, transparent: true, opacity: 0.95, depthTest: false }));
        ...
        const c = new he().setFromPoints(P), h = new Ct(c, new ht({ color: lt, transparent: true, opacity: 0.95, depthTest: false }));
        h.renderOrder = 999, et.add(h);
      } else if (p === "aux") {
        const k = t[+u[0]];
        if (!k || k.length !== 6) continue;
        const P = new he().setFromPoints([new x(k[0], k[1], k[2]), new x(k[3], k[4], k[5])]), c = new Ct(P, new ht({ color: lt, transparent: true, opacity: 0.95, depthTest: false }));
  ...
  U.geometry.setAttribute("position", new zt(e.points.rawVal.flat(), 3)), U.geometry.computeBoundingSphere(), U.frustumCulled = false, ue.frustumCulled = false, w.add(ue), K.position.set(0, 0, 0), K.rotateX(Math.PI / 2), K.geometry.rotateX(Math.PI / 2), K.updateMatrixWorld(), e.polylines && (e.polylines.val = [...e.polylines.rawVal, []]), window.__hekatanDrawAt = (n, o, i) => {
    ...
    const le = s.distanceTo(R), xe = new x().subVectors(s, R), Fe = new x().subVectors(p, R), _e = Math.acos(Math.max(-1, Math.min(1, xe.dot(Fe) / (le * le)))), Te = e.points.rawVal.length, St = [], Ft = P.clone();
    for (let it = 0; it <= d; it++) {
      const Be = it / d, ft = _e * Be, ct = new to().setFromAxisAngle(Ft, ft), xt = xe.clone().applyQuaternion(ct).add(R);
      St.push([xt.x, xt.y, xt.z]);
    }
    if (e.points.val = [...e.points.rawVal, ...St], e.polylines) {
      const it = St.map((ft, ct) => Te + ct), Be = e.polylines.rawVal;
  ...
  const Oe = () => {
    ...
    for (const i of o) {
      ...
      const t = new he().setFromPoints([new x(i[0], i[1], i[2]), new x(i[3], i[4], i[5])]), d = new hn({ color: 2282478, dashSize: 0.3, gapSize: 0.15, transparent: true, opacity: 0.8 }), s = new Ct(t, d);
  ...
  Me.add(He, kt);
  const rt = 0.08, Yt = (n, o, i) => {
    const t = new he().setFromPoints([new x(...n), new x(...o)]);
    return new Ct(t, new ht({ color: i, transparent: true, opacity: 0.7 }));
  };
  Me.add(Yt([-rt, 0, 0], [rt, 0, 0], 16711680)), Me.add(Yt([0, -rt, 0], [0, rt, 0], 65280)), Me.add(Yt([0, 0, -rt], [0, 0, rt], 35071)), Me.visible = false, Me.frustumCulled = false, w.add(Me);
  const Dt = 40, $t = 2.5, wt = () => {
  ...
  window.__hekatanUpdateSelectionPtScale = Ht, l.addEventListener("change", () => {
    ...
    Me.position.set(n, o, i), Me.visible = true, wt(), g();
    ...
    if (i.length) {
      ...
      if (u.length > 0 && k[u[u.length - 1]]) {
        ...
        if (Je = null, !h && window.__hekatanAxisSnap !== false) {
          const Be = m.getBoundingClientRect(), ft = n.clientX, ct = n.clientY, xt = ((_k = settings.gridSize) == null ? void 0 : _k.rawVal) ?? 10, Vt = new x(c[0], c[1], c[2]), ln = [["x", new x(1, 0, 0)], ["y", new x(0, 1, 0)], ["z", new x(0, 0, 1)]], Gt = (qt) => {
            const Rt = qt.clone().project(o);
            return { x: (Rt.x * 0.5 + 0.5) * Be.width + Be.left, y: (-Rt.y * 0.5 + 0.5) * Be.height + Be.top };
          };
          let Pt = null;
          for (const [qt, Rt] of ln) {
            const Jt = Gt(Vt.clone().addScaledVector(Rt, -xt)), gn = Gt(Vt.clone().addScaledVector(Rt, xt)), vn = gn.x - Jt.x, bn = gn.y - Jt.y, Co = ft - Jt.x, zo = ct - Jt.y, Fo = vn * vn + bn * bn || 1;
            let Mn = (Co * vn + zo * bn) / Fo;
            Mn = Math.max(0, Math.min(1, Mn));
            const On = Math.hypot(ft - (Jt.x + Mn * vn), ct - (Jt.y + Mn * bn));
            if (Pt === null || On < Pt.dpx) {
              ...
              Pt = { axis: qt, dpx: On, pt: Vt.clone().addScaledVector(Rt, Ao) };
            }
          }
          Pt && Pt.dpx <= 12 && (t.copy(Pt.pt), h = Pt.axis, Je = Pt.pt.clone());
        }
        const F = !!window.__hekatanOrthoMode;
        if (!h && F) {
          const Be = Math.abs(t.x - c[0]), ft = Math.abs(t.y - c[1]), ct = Math.abs(t.z - c[2]), xt = (_l = i[0]) == null ? void 0 : _l.object;
          let Vt = null;
          xt === Ue ? Vt = "xy" : xt === A ? Vt = "xz" : xt === W && (Vt = "yz"), Vt === "xy" ? h = Be >= ft ? "x" : "y" : Vt === "xz" ? h = Be >= ct ? "x" : "z" : Vt === "yz" ? h = ft >= ct ? "y" : "z" : h = Be >= ft && Be >= ct ? "x" : ft >= ct ? "y" : "z";
        }
        const X = window.__hekatanPolarTrack !== false;
        if (!h && X) {
          const Be = t.x - c[0], ft = t.y - c[1], ct = t.z - c[2], xt = Math.hypot(Be, ft, ct);
          if (xt > 1e-3) {
            const ln = Math.tan(6 * Math.PI / 180) * xt, Gt = Math.hypot(ft, ct), Pt = Math.hypot(Be, ct), qt = Math.hypot(Be, ft), Rt = [["x", Gt], ["y", Pt], ["z", qt]];
            Rt.sort((Jt, gn) => Jt[1] - gn[1]), Rt[0][1] <= ln && (h = Rt[0][0]);
          }
        }
        if (h) {
          const Be = c[0], ft = c[1], ct = c[2];
          h === "x" ? t.set(t.x, ft, ct) : h === "y" ? t.set(Be, t.y, ct) : t.set(Be, ft, t.z);
          const xt = !!Ee, ln = { x: "#ff3344", y: "#34d399", z: "#60a5fa" }[h];
          ...
          let Pt = null;
          Gt === Ue ? Pt = "xy" : Gt === A ? Pt = "xz" : Gt === W && (Pt = "yz");
          const qt = Pt ? ` (plano ${Pt.toUpperCase()})` : "";
          Ke.textContent = xt ? `\u{1F512} LOCK ${h.toUpperCase()}${qt}` : `\u22A5 ORTO ${h.toUpperCase()}${qt}`, Ke.style.left = n.clientX + 20 + "px", Ke.style.top = n.clientY + 18 + "px", Ke.style.transform = "none", Ke.style.display = "block";
        ...
        const St = pe.material, Ft = J.material, it = Pe.material;
        h === "x" ? (St.opacity = 0.95, Ft.opacity = 0.1, it.opacity = 0.1) : h === "y" ? (St.opacity = 0.1, Ft.opacity = 0.95, it.opacity = 0.1) : h === "z" ? (St.opacity = 0.1, Ft.opacity = 0.1, it.opacity = 0.95) : (St.opacity = 0.5, Ft.opacity = 0.5, it.opacity = 0.5);
      } else {
    ...
    U.geometry.setAttribute("position", new zt(e.points.val.flat(), 3)), U.geometry.computeBoundingSphere();
  }), L.derive(() => {
    ...
    const d = new he();
    d.setAttribute("position", new zt(t, 3)), ne.geometry.dispose(), ne.geometry = d;
  });
  let on = false, Nt = 0;
  ...
  const cn = (n, o, i, t, d) => {
    ...
    for (let _e = 0; _e < R.length; _e++) {
      const Te = R[_e], St = le.includes(_e);
      let Ft = false;
      for (let it = 0; it < Te.length - 1; it++) {
        const Be = G[Te[it]], ft = G[Te[it + 1]];
        if (!Be || !ft) continue;
        const ct = h(Be), xt = h(ft);
        if (F(ct) || F(xt) || X(ct, xt)) {
          if (St) {
            Ft = true;
            break;
          }
  ...
  bt.style.cssText = ["position:fixed", Wt ? `left:${Wt.left}px` : "left:50%", Wt ? `top:${Wt.top}px` : "top:8px", Wt ? "transform:none" : "transform:translateX(-50%)", "width:min(320px, calc(100vw - 32px))", "max-height:60vh", "overflow-y:auto", "z-index:201", "box-shadow:0 6px 24px rgba(0,0,0,0.45)", "border-radius:6px", "display:none"].join(";") + ";", document.body.appendChild(bt);
  const Vn = () => {
    ...
    n.addEventListener("mousedown", (r) => {
      ...
      d = p.left, s = p.top, bt.style.transform = "none", bt.style.left = `${d}px`, bt.style.top = `${s}px`, r.preventDefault();
      ...
      bt.style.left = `${k}px`, bt.style.top = `${P}px`;
    }), window.addEventListener("mouseup", () => {
      if (o) {
        o = false;
        try {
          localStorage.setItem(pn, JSON.stringify({ left: parseFloat(bt.style.left), top: parseFloat(bt.style.top) }));
        } catch {
        }
      }
    });
  ...
  const mt = (n, o, i, t) => {
    ...
    if (We = new xo({ container: bt, title: P }), s) {
    ...
    if (r) {
      ...
      xe.addBinding($, "qx", { step: 0.1 }), xe.addBinding($, "qy", { step: 0.1 }), xe.addBinding($, "qz", { step: 0.1 }), We.addFolder({ title: "\u2696 Additional Mass (kg/m)", expanded: false }).addBinding($, "massPerM", { label: "m/L", min: 0, step: 1 }), We.addButton({ title: "\u2713 Aplicar a segmentos seleccionados" }).on("click", () => {
        ...
        const Te = [$.relMxI, $.relMyI, $.relMzI], St = [$.relMxJ, $.relMyJ, $.relMzJ];
        (Te.some((Be) => Be) || St.some((Be) => Be)) && mt("segs", i, "releases", { i: Te, j: St }), $.hinges !== "None" && mt("segs", i, "hinges", $.hinges);
        const Ft = [$.LKx, $.LKy, $.LKz];
        Ft.some((Be) => Be !== 0) && mt("segs", i, "lineSprings", Ft);
        const it = [$.qx, $.qy, $.qz];
  ...
  m.addEventListener("pointerdown", (n) => {
    ...
    var _a, _b, _c;
    const o = ((_c = (_b = (_a = window.__hekatanCadState) == null ? void 0 : _a.get) == null ? void 0 : _b.call(_a)) == null ? void 0 : _c.tool) ?? "select";
    o !== "select" && o !== "none" && o || n.button === 0 && window.__hekatanRectSelectExplicit && n.pointerType !== "touch" && (vt = { x: n.clientX, y: n.clientY }, Qt = false);
  }), m.addEventListener("pointermove", (n) => {
    if (_t && n.buttons === 0) {
    ...
    if (!vt) return;
    const o = n.clientX - vt.x, i = n.clientY - vt.y, t = Math.hypot(o, i);
    if (!Qt && t < 8) return;
    Qt = true;
    const d = n.clientX < vt.x;
    cn(vt.x, vt.y, n.clientX, n.clientY, d);
  }), m.addEventListener("pointerup", (n) => {
    if (!vt) return;
    if (!Qt) {
      vt = null;
    ...
    xn(vt.x, vt.y, n.clientX, n.clientY, o), vt = null, Qt = false;
  ...
  window.__hekatanFinalizeDraw = Jn, m.addEventListener("click", (n) => {
    ...
    if (d === "col") {
      jt();
      const s = t.z, r = Mt && Mt > 0 ? Mt : 3;
      e.points.val = [...e.points.rawVal, [t.x, t.y, s], [t.x, t.y, s + r]];
      const p = e.polylines.rawVal, u = e.points.rawVal.length;
      e.polylines.val = [...p.slice(0, -1), ...p[p.length - 1].length > 0 ? [p[p.length - 1]] : [], [u - 2, u - 1], []], Mt = 0, me(`\u258C Columna creada \u2014 h=${r.toFixed(2)}m. Tipe\xE1 altura + Enter para custom.`);
      try {
    ...
    if (d === "wall") {
      ...
      me(`\u25A5 Pared Q4 creada \u2014 h=${p.toFixed(2)}m. Tipe\xE1 altura + Enter para custom.`), Ze = [], Mt = 0;
      try {
    ...
    if (d === "extp") {
      jt();
      const s = Mt && Mt > 0 ? Mt : 3, r = t.z;
      e.points.val = [...e.points.rawVal, [t.x, t.y, r], [t.x, t.y, r + s]];
      const p = e.polylines.rawVal, u = e.points.rawVal.length;
      e.polylines.val = [...p.slice(0, -1), ...p[p.length - 1].length > 0 ? [p[p.length - 1]] : [], [u - 2, u - 1], []], Mt = 0, me(`\u2B06 Extrusi\xF3n punto\u2192l\xEDnea \u2014 h=${s.toFixed(2)}m`);
      try {
    ...
    if (d === "extl") {
      ...
      Mt = 0, me(`\u2B06 Extrusi\xF3n l\xEDnea\u2192\xE1rea Q4 \u2014 h=${h.toFixed(2)}m`);
      try {
    ...
    if (ue.geometry.deleteAttribute("position"), i.length) {
      ...
      ue.geometry.setAttribute("position", new zt(t.toArray(), 3));
    }
    g();
  }), m.addEventListener("pointermove", (n) => {
    var _a;
...
function hs(e, a, w) {
  ...
  return S.renderOrder = -1, S.frustumCulled = false, S.userData.isShellArea = true, S.name = "__hekatan_shell_colormap", L.derive(() => {
    S.geometry.setAttribute("position", new zt(e.val.flat(), 3));
    const y = [];
  ...
  return L.derive(() => {
    ...
    for (const { idx: C, vals: N } of de) {
      ...
      for (let ke = 0; ke < Pe; ke++) {
        const ze = ke / Nn, Xe = Y[0] + E.x * D * ze, st = Y[1] + E.y * D * ze, gt = Y[2] + E.z * D * ze, Ue = N[0] + (N[1] - N[0]) * ze, A = S.getColor(Ue) ?? new Bt(0, 0, 0);
        y.copy(A).convertSRGBToLinear();
        for (let W = 0; W < Se; W++) {
          const ee = W / Se * Math.PI * 2, se = Math.cos(ee), Le = Math.sin(ee);
          re.push(Xe + (pe.x * se + J.x * Le) * Z, st + (pe.y * se + J.y * Le) * Z, gt + (pe.z * se + J.z * Le) * Z), q.push(y.r, y.g, y.b);
        }
      }
      for (let ke = 0; ke < Nn; ke++) for (let ze = 0; ze < Se; ze++) {
        const Xe = (ze + 1) % Se, st = I + ke * Se + ze, gt = I + ke * Se + Xe, Ue = I + (ke + 1) * Se + ze, A = I + (ke + 1) * Se + Xe;
        B.push(st, gt, A), B.push(st, A, Ue);
      }
      I += Pe * Se;
    }
    if (re.length === 0) return;
    const V = new he();
    V.setAttribute("position", new zt(re, 3)), V.setAttribute("color", new zt(q, 3)), V.setIndex(B), V.computeVertexNormals();
      ...
      if (!(!ge || ge.length < 2)) {
        if (ge.length === 2) {
          ...
          if (Ae >= fe && Ae <= Oe && we >= Ge && we <= At) {
            const He = ce.reduce((kt, rt) => kt + rt.z, 0) / ce.length * 1e-3;
...
nodos: [${Ne.join(", ")}]`, Lt === "shell" && ((_l = e.mesh) == null ? void 0 : _l.analyzeOutputs)) {
        ...
        for (const [He, kt, rt, Yt] of At) {
          const Dt = Oe == null ? void 0 : Oe[He];
          if (Dt && Dt instanceof Map) {
            const $t = Dt.get(nt);
            if ($t != null) {
              if (typeof $t == "number") Me.push(`${kt} = ${dt($t * rt, 3)} ${Yt}`);
              else if (Array.isArray($t)) {
                let wt = $t[0];
                for (const Ht of $t) Math.abs(Ht) > Math.abs(wt) && (wt = Ht);
                Me.push(`${kt} = ${dt(wt * rt, 3)} ${Yt}`);
              }
            }
          }
        }
...
`));
      ...
      if (Lt === "frame" && ((_m = e.mesh) == null ? void 0 : _m.deformOutputs) && e.mesh.elementInputs) {
        ...
        if (At && Ne.length === 2) {
          const Me = At.get(Ne[0]), He = At.get(Ne[1]), kt = De[Ne[0]], rt = De[Ne[1]];
          if (Me && He && kt && rt) {
            const Yt = rt[0] - kt[0], Dt = rt[1] - kt[1], $t = rt[2] - kt[2], wt = Math.sqrt(Yt * Yt + Dt * Dt + $t * $t);
            if (wt > 1e-9) {
              const Ht = Yt / wt, on = Dt / wt, Nt = $t / wt, ut = (He[0] - Me[0]) * Ht + (He[1] - Me[1]) * on + (He[2] - Me[2]) * Nt, vt = ((_n2 = Ge.elasticities) == null ? void 0 : _n2.get(nt)) ?? 0, Qt = ((_o = Ge.areas) == null ? void 0 : _o.get(nt)) ?? 0, _t = ((_p = Ge.momentsOfInertiaY) == null ? void 0 : _p.get(nt)) ?? 0, cn = ((_q = Ge.momentsOfInertiaZ) == null ? void 0 : _q.get(nt)) ?? 0, xn = ((_r = Ge.torsionalConstants) == null ? void 0 : _r.get(nt)) ?? 0, sn = ((_s2 = Ge.shearModuli) == null ? void 0 : _s2.get(nt)) ?? vt / 2.6, dn = vt * Qt * (ut / wt), bt = (He[3] - Me[3]) * Ht + (He[4] - Me[4]) * on + (He[5] - Me[5]) * Nt, pn = sn * xn * (bt / wt), Wt = He[4] - Me[4], Vn = He[5] - Me[5], $ = vt * _t * Wt / wt, We = vt * cn * Vn / wt;
              ce += `
\u2500\u2500\u2500\u2500 frame \u2500\u2500\u2500\u2500`, ce += `
L = ${dt(wt, 3)} m`, ce += `
\u0394L = ${dt(ut * at, 3)} ${Ce.dispUnit}`, ce += `
\u03B5 = ${dt(ut / wt, 6)}`, Math.abs(dn) > 1e-6 && (ce += `
...
Mz \u2248 ${dt(We * tt)} ${Ce.forceUnit}\xB7m`);
  ...
  function j(H, Q, ve) {
    ...
    if (H.type === "node") {
      ...
      if (be) {
        ...
        const et = ((_b = e.derivedDisplayScale) == null ? void 0 : _b.rawVal) ?? 1, lt = 0.015 * Ie * et;
        l.position.copy(be), l.scale.setScalar(lt), l.visible = true;
      }
    } else if (H.type === "frame" && ae) {
      const be = ae[H.idx], Re = C(be[0]), Ie = C(be[1]);
      if (Re && Ie) {
        const et = Re.clone().add(Ie).multiplyScalar(0.5), lt = Ie.clone().sub(Re), $e = lt.length(), pt = e.getActiveCamera();
        let Ce;
        ...
        b.position.copy(et);
        const at = new x(0, 1, 0), tt = at.clone().cross(lt).normalize(), nn = at.angleTo(lt);
      ...
      for (const et of be) {
        const lt = C(et);
        if (!lt) return;
        Re.push(lt.x, lt.y, lt.z);
      }
      be.length === 4 ? Ie.push(0, 1, 2, 0, 2, 3) : be.length === 3 && Ie.push(0, 1, 2), _.setAttribute("position", new zt(Re, 3)), _.setIndex(Ie), _.computeVertexNormals(), K.visible = true;
    } else if (H.type === "solid" && ae) {
      const be = ae[H.idx], Re = [[0, 1], [1, 2], [2, 3], [3, 0], [4, 5], [5, 6], [6, 7], [7, 4], [0, 4], [1, 5], [2, 6], [3, 7]], Ie = [];
      for (const [et, lt] of Re) {
        const $e = C(be[et]), pt = C(be[lt]);
        $e && pt && Ie.push($e.x, $e.y, $e.z, pt.x, pt.y, pt.z);
      }
      te.setAttribute("position", new zt(Ie, 3)), ie.visible = true;
    }
  ...
  function ee(H) {
    Xe.innerHTML = "";
    const Q = H === "frame" ? st : H === "node" ? gt : H === "shell" ? Ue : A, ve = document.createElement("div");
  ...
  function Zt() {
    ...
    if (z.type === "node") {
      ...
      if (ve && ae) {
        ...
        ne.position.copy(Ae);
        const Ie = new x(0, 1, 0), et = Ie.clone().cross(we).normalize(), lt = Ie.angleTo(we);
        ne.quaternion.setFromAxisAngle(et, lt), ne.scale.set(Re, De, Re), ne.visible = true;
      }
      ...
      Q.length === 4 ? ae.push(0, 1, 2, 0, 2, 3) : Q.length === 3 && ae.push(0, 1, 2), Z.setAttribute("position", new zt(ve, 3)), Z.setIndex(ae), Z.computeVertexNormals(), q.visible = true;
      ...
      B.setAttribute("position", new zt(ae, 3)), V.visible = true;
    }
    e.render();
  }
  return L.derive(() => {
...
function Ns({ mesh: e, settingsObj: a, drawingObj: w, objects3D: f, solids: l }) {
  ...
  return ze.append(Ue()), ze.append(Xe("\u2191", "Pan arriba", () => st(0, 1))), ze.append(Xe("\u2295", "Zoom in", () => gt(0.85))), ze.append(Xe("\u2190", "Pan izquierda", () => st(-1, 0))), ze.append(Xe("\u2302", "Reset vista", () => {
    v.reset(), J();
  })), ze.append(Xe("\u2192", "Pan derecha", () => st(1, 0))), ze.append(Xe("\u2296", "Zoom out", () => gt(1.18))), ze.append(Xe("\u2193", "Pan abajo", () => st(0, -1))), ze.append(Ue()), getComputedStyle(S).position === "static" && (S.style.position = "relative"), S.appendChild(ze), S;
}
function Vs(e, a) {
  return L.derive(() => {
    var _a, _b, _c, _d;
...
function Bs(e, a) {
  ...
  return ((l) => {
    ...
    const l = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), m = /* @__PURE__ */ new Map(), g = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), _ = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Map(), te = /* @__PURE__ */ new Map(), de = /* @__PURE__ */ new Map(), ie = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), ue = /* @__PURE__ */ new Map(), ne = (st, gt) => {
      st == null ? void 0 : st.forEach((Ue, A) => {
        const W = e.elements.val[A];
        if (W) for (let ee = 0; ee < W.length; ee++) gt.set(W[ee], [Ue[ee] ?? Ue[0]]);
      });
    };
    ...
    e.nodes.val.forEach((st, gt) => {
      ...
      const A = Ue[0].get(gt), W = A ? A[Ue[1]] ?? 0 : 0;
      Xe.push(W * Pe);
    }), w.val = Xe;
  }), w;
}
