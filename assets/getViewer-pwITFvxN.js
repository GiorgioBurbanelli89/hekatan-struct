import { H as ce, B as k, I as de, F as q, G as U, d as Ie, L as te, r as Q, v as O, M as K, k as H, p as Le, x as ke, V as R, o as ee, T as D, J as be, i as Ee, a as ne, e as $, g as ue, K as he, R as Ze, h as We, N as Ne, U as _e, X as ze, Y as re, Z as $e, _ as He, j as De, l as Ge, m as qe, W as Ue, n as Ke, A as Qe, D as Pe, O as Je } from "./Text-BCbgLTjz.js";
...
class Te extends U {
  constructor(t, r, s, n, a, d, u) {
    ...
    if (this.text = new D(`${a[0].toFixed(4)}`), this.text2 = new D(`${(a[1] * -1).toFixed(4)}`), this.normalizedResult = d, this.textPosition = ge(t, r), this.text2Position = ge(r, t), this.text.position.set(...this.textPosition), this.text2.position.set(...this.text2Position), this.text.rotation.setFromRotationMatrix(n), this.text2.rotation.setFromRotationMatrix(n), this.add(this.text, this.text2), b) {
      ...
      const E = new he(f), Z = new he(g), z = new Q({ color: d[0] > 0 ? 24435 : 11411474, side: O }), S = new Q({ color: -d[1] > 0 ? 24435 : 11411474, side: O });
...
function Vt(e, t, r, s) {
  ...
  return F.derive(() => {
    ...
    for (const { idx: x, vals: C } of v) {
      ...
      for (let G = 0; G < N; G++) {
        const J = G / ye, se = Y[0] + P.x * T * J, ie = Y[1] + P.y * T * J, me = Y[2] + P.z * T * J, fe = C[0] + (C[1] - C[0]) * J, ae = a.getColor(fe) ?? new H(0, 0, 0);
