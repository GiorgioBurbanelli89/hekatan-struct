import { a as H } from "./analyze-DOGq34F5.js";
import { m as w, d as E, __tla as __tla_0 } from "./didacticCpp-CT_TM4EM.js";
let g;
let __tla = Promise.all([
  ...
  g = {
    ...
    build(e, n) {
      ...
      a.forEach((t, o) => {
        M.set(o, e.t), h.set(o, e.E), v.set(o, e.nu), b.set(o, 24);
      ...
      try {
        n.deformOutputs.val = E(r, a, {
          supports: c,
          loads: u
        }, n.elementInputs.val), n.analyzeOutputs.val = H(r, a, n.elementInputs.val, n.deformOutputs.val);
        const t = e.t * Math.pow(e.W, 3) / 12, o = e.t * e.W, m = e.E / (2 * (1 + e.nu)), f = e.F * Math.pow(e.H, 3) / (3 * e.E * t), F = 1.2 * e.F * e.H / (m * o), $ = f + F, k = x + Math.floor(s / 2), z = ((_b = (_a = n.deformOutputs.val.deformations) == null ? void 0 : _a.get(k)) == null ? void 0 : _b[0]) ?? 0;
        console.log(`[Muro Q4] W=${e.W}m H=${e.H}m F=${e.F}kN  \u2192  \u03B4_top FEM=${(z * 1e3).toFixed(3)} mm | te\xF3rico flex+shear=${($ * 1e3).toFixed(3)} mm (flex=${(f * 1e3).toFixed(3)}, shear=${(F * 1e3).toFixed(3)})`);
      } catch (t) {
