import { a as S } from "./analyze-Baqb28rE.js";
import { m as F, d as P, __tla as __tla_0 } from "./didacticCpp-PqvqKlgs.js";
let k;
let __tla = Promise.all([
  ...
  k = {
    ...
    build(n, o) {
      const i = n.span, p = n.length, u = n.height, m = n.archRise, d = Math.round(n.xDiv), h = Math.round(n.yDiv), N = (e) => u + m * (1 - Math.pow(2 * e / i - 1, 2)), g = h + 1, s = [], a = [];
      for (let e = 0; e < g; e++) {
        const t = [], r = p / h * e;
      ...
      const v = n.barA, M = v * v / 12, I = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), C = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map();
      for (let e = 0; e < l.length; e++) I.set(e, $), D.set(e, Y), R.set(e, L), A.set(e, Z), G.set(e, v), b.set(e, M), C.set(e, M), x.set(e, 2 * M);
      ...
      const z = P(s, l, o.nodeInputs.val, o.elementInputs.val);
      o.deformOutputs.val = z, o.analyzeOutputs.val = S(s, l, o.elementInputs.val, z), o.objects3D.val = [];
    },
    runModal(n, o, i) {
      var _a, _b;
