...
let __tla = (async () => {
  Mn = async function(we = {}) {
    ...
    var Pe;
    function br() {
      return d.locateFile ? pr("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-BHVrkPs1.wasm", import.meta.url).href;
    }
    function Tr(e) {
