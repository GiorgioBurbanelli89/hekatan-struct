...
import { _ as Kr } from "./preload-helper-DrUBW0xl.js";
let Zr;
let __tla = (async () => {
  Zr = async function(ue = {}) {
    ...
    var pe;
    function Qe() {
      return d.locateFile ? $e("deform.wasm") : new URL("/hekatan-struct/assets/deform-CELh3_YL.wasm", import.meta.url).href;
    }
    function er(e) {
    ...
    var De = (e) => {
    ...
    }, Re = [], ar = (e) => Re.push(e), Oe = [], sr = (e) => Oe.push(e), q = (e) => (u(typeof e == "number", `ptrToString expects a number, got ${typeof e}`), e >>>= 0, "0x" + e.toString(16).padStart(8, "0")), Y = (e) => {
      Y.shown || (Y.shown = {}), Y.shown[e] || (Y.shown[e] = 1, C && (e = "warning: " + e), F(e));
      ...
      for (var a = ""; r < i; ) {
        ...
        var c = e[r++] & 63;
        if ((s & 240) == 224 ? s = (s & 15) << 12 | l << 6 | c : ((s & 248) != 240 && Y("Invalid UTF-8 leading byte " + q(s) + " encountered when deserializing a UTF-8 string in wasm memory to a JS string!"), s = (s & 7) << 18 | l << 12 | c << 6 | e[r++] & 63), s < 65536) a += String.fromCharCode(s);
        else {
          var f = s - 65536;
      ...
      return a;
    }, X = (e, r, t) => (u(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? U($, e, r) : ""), dr = (e, r, t, o) => y(`Assertion failed: ${X(e)}, at: ` + [
    ...
    var ur = (e, r, t) => {
      ...
      for (var i = t, a = t + o - 1, s = 0; s < e.length; ++s) {
        ...
        if (l <= 127) {
          ...
          if (t + 3 >= a) break;
          l > 1114111 && Y("Invalid Unicode code point " + q(l) + " encountered when serializing a JS string to a UTF-8 string in wasm memory! (Valid unicode code points should be in range 0-0x10FFFF)."), r[t++] = 240 | l >> 18, r[t++] = 128 | l >> 12 & 63, r[t++] = 128 | l >> 6 & 63, r[t++] = 128 | l & 63, s++;
        }
      }
      return r[t] = 0, t - i;
      ...
      u(E), u(m), u(de(E) <= 16, `timezone name truncated to fit in TZNAME_MAX (${E})`), u(de(m) <= 16, `timezone name truncated to fit in TZNAME_MAX (${m})`), c < l ? (K(E, t, 17), K(m, o, 17)) : (K(E, o, 17), K(m, t, 17));
    }, vr = () => performance.now(), _r = () => Date.now(), hr = (e) => e >= 0 && e <= 3, pr = 9007199254740992, Er = -9007199254740992, gr = (e) => e < Er || e > pr ? NaN : Number(e);
    function yr(e, r, t) {
      if (!hr(e)) return 28;
      var o;
      e === 0 ? o = _r() : o = vr();
    ...
    var wr = () => 2147483648, Sr = (e, r) => (u(r, "alignment argument is required"), Math.ceil(e / r) * r), Fr = (e) => {
      ...
      if (!J.strings) {
        ...
        for (var t in Ee) Ee[t] === void 0 ? delete r[t] : r[t] = Ee[t];
        var o = [];
...
`));
      ...
      var c = r ? B.resolve(g.join2(e, r)) : e, f = Cr(`cp ${c}`);
      Lr(f);
      try {
        var p = t;
      ...
      createFile(e, r, t, o, i) {
        var a = g.join2(typeof e == "string" ? e : n.getPath(e), r), s = we(o, i);
        return n.create(a, s);
      },
      ...
      createDevice(e, r, t, o) {
        var _a2;
        var i = g.join2(typeof e == "string" ? e : n.getPath(e), r), a = we(!!t, !!o);
      ...
      createLazyFile(e, r, t, o, i) {
        class a {
          ...
          cacheLength() {
            ...
            var R = (O, W) => {
              ...
              return k.open("GET", t, false), _ !== T && k.setRequestHeader("Range", "bytes=" + O + "-" + W), k.responseType = "arraybuffer", k.overrideMimeType && k.overrideMimeType("text/plain; charset=x-user-defined"), k.send(null), k.status >= 200 && k.status < 300 || k.status === 304 || y("Couldn't load " + t + ". Status: " + k.status), k.response !== void 0 ? new Uint8Array(k.response || []) : ye(k.responseText || "");
            }, ee = this;
            ee.setDataGetter((O) => {
              var W = O * T, k = (O + 1) * T - 1;
              return k = Math.min(k, _ - 1), typeof ee.chunks[O] > "u" && (ee.chunks[O] = R(W, k)), typeof ee.chunks[O] > "u" && y("doXHR failed!"), ee.chunks[O];
        ...
        return f.read = (E, m, _, w, P) => (n.forceLoadFile(c), p(E, m, _, w, P)), f.mmap = (E, m, _, w, P) => {
          n.forceLoadFile(c);
          var N = Le();
