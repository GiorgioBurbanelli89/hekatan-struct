import { b as V, c as ee, E as ne, L as oe } from "./theme-CaJUXK9g.js";
import { p as te, __tla as __tla_0 } from "./didacticCpp-CT_TM4EM.js";
let de;
let __tla = Promise.all([
  ...
  de = {
    ...
    build(t, a) {
      const r = t.L, s = t.B, l = t.h, i = Math.round(t.nx), M = Math.round(t.ny), c = i + 1, p = M + 1, u = r / i, m = s / M, x = (t.P_dead_c1 + t.P_live_c1) * d, Y = (t.M_dead_c1 + t.M_live_c1) * d, S = (t.P_dead_c2 + t.P_live_c2) * d, $ = (t.M_dead_c2 + t.M_live_c2) * d, k = t.ks_tm3 * d, D = 14100 * Math.sqrt(t.fc_kgcm2) * 98.0665, E = 0.2, b = [];
      for (let e = 0; e < p; ++e) for (let o = 0; o < c; ++o) b.push([
        o * u,
        e * m
      ]);
      const f = [];
      for (let e = 0; e < M; ++e) for (let o = 0; o < i; ++o) {
        const n = e * c + o;
        f.push([
          n,
          n + 1,
      ...
      for (let e = 0; e < p; ++e) for (let o = 0; o < c; ++o) {
        const n = o === 0 || o === c - 1, _ = e === 0 || e === p - 1, y = n && _ ? 0.25 : n || _ ? 0.5 : 1, G = u * m * y, g = e * c + o;
        if (v.push({
          node: g,
          dof: 0,
          k: k * G
    ...
    computedLabels(t, a) {
      ...
      let s = -1 / 0, l = 1 / 0;
      if (r) for (const u of r.values()) for (const m of u) {
        const x = Math.abs(m) * le;
        x > s && (s = x), x < l && (l = x);
      }
      s === -1 / 0 && (s = 0, l = 0);
      const i = ae, M = (_a = i == null ? void 0 : i.manual_libro) == null ? void 0 : _a.sigma_max_servicio_tm2, c = (_b = i == null ? void 0 : i.manual_libro) == null ? void 0 : _b.sigma_min_servicio_tm2, p = (u, m) => m === void 0 || m === 0 ? "\u2014" : `${((u - m) / m * 100).toFixed(2)} %`;
      return {
