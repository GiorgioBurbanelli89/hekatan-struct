...
import { v as y, P as q } from "./theme-2eEBQPmF.js";
import { V as b, O as K, s as Q, t as ee, u as oe, v as ne, W as se, w as ie, A as te, x as ae, G, y as k, z as M, H as re, B as X, L as z, a as N, S as le, e as de, b as ce, F as pe, d as me, I as fe } from "./Text-CU7BY_Ns.js";
...
function Me() {
  ...
  new ResizeObserver(($) => {
    for (const A of $) {
      ...
      const O = S / F, H = o.top;
      o.left = -H * O, o.right = H * O, o.updateProjectionMatrix(), n.setSize(S, F), C();
    }
...
function Pe(e, l) {
  ...
  a.id = "cad-panel";
  const o = { viewMode: "3d", selector: "", sectionPos: 0, showGrid: true, showLabels: true, showNodes: true, showFrames: true, showAreas: true }, n = new q({ title: "FEM Studio", container: a, expanded: true });
