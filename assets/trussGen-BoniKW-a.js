...
import { m as A, d as y, __tla as __tla_0 } from "./didacticCpp-PqvqKlgs.js";
let E;
let __tla = Promise.all([
  ...
  E = {
    ...
    build(o, t) {
      ...
      for (let e = 0; e < n.length; e++) d.set(e, w), f.set(e, O), I.set(e, x), C.set(e, _), h.set(e, u), v.set(e, m), M.set(e, m), b.set(e, 2 * m);
      ...
      t.deformOutputs.val = g, t.analyzeOutputs.val = z(a, n, t.elementInputs.val, g), t.objects3D.val = [];
    },
    runModal(o, t, s) {
      var _a, _b;
