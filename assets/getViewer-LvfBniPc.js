import { v as I, p as pn, a6 as Xn, B as he, a7 as Yn, F as It, a3 as Eo, Z as lt, K as jt, L as mt, h as tn, t as Vo, g as Uo, a8 as Ko, i as rt, d as tt, V as m, _ as dn, a9 as qn, G as To, D as Yt, a as Lt, w as ut, y as Dn, aa as Nn, r as Ho, m as Wo, H as rn, a1 as Pn, E as yo, f as vn, Q as Jn, ab as zn, C as xo, S as go, c as vo, ac as In, o as Go, ad as qo, ae as Jo, af as Qo, ag as Oo, b as bo, ah as Mo, e as _o, J as jo, N as es, U as ts, W as ns, T as $n, P as Qn, X as os, Y as ko, O as ss } from "./theme-N6TOO4-G.js";
import { T as zt, O as So } from "./Text-RdOEoJ2D.js";
import { P as Lo } from "./tweakpane-BXg6ZhiP.js";
import { e as as } from "./styles-C91QLG29.js";
function is(e, i, y) {
...
function Ms({ drawingObj: e, gridObj: i, scene: y, getActiveCamera: h, controls: u, gridSize: k, derivedDisplayScale: v, rendererElm: x, viewerRender: w }) {
  ...
  Le.add(N, ie, fe);
  const we = (n) => {
    const o = new he().setFromPoints([new m(0, 0, 0), new m(0, 0, 0), new m(0, 0, 0), new m(0, 0, 0)]), a = new mt({ color: n, transparent: true, opacity: 0.2, depthTest: false }), t = new Vo(o, a);
