import { m as W, __tla as __tla_0 } from "./didacticCpp-PqvqKlgs.js";
...
let __tla = Promise.all([
  ...
  I = {
    ...
    build(e, n) {
      ...
      i.forEach((t, s) => {
        f.set(s, e.t), M.set(s, e.E), p.set(s, e.nu), h.set(s, 24 / 9.81);
      }), n.elementInputs.val = {
        thicknesses: f,
        elasticities: M,
        poissonsRatios: p,
      ...
      const b = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), v = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map();
