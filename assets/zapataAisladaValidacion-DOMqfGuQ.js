import { a as Co, v as Yo, V as S, d as So, B as Ao } from "./theme-Co6w-pfC.js";
import { a as Uo } from "./analyze-Baqb28rE.js";
import { d as xo, __tla as __tla_0 } from "./didacticCpp-BeLq_Lcs.js";
import { a as Po } from "./exampleVersion-D1A_5i59.js";
import { f as A } from "./units-CylPiZqQ.js";
let it;
let __tla = Promise.all([
  ...
  it = {
    ...
    computedLabels(t, s) {
      ...
      if (B && B.size) for (const z of B.values()) for (const m of z) R || (C = g = m, R = true), m < C && (C = m), m > g && (g = m);
      const p = Math.abs(C), _ = Math.abs(g), V = p / n, L = _ / n, G = V / (r || 1), W = t.kh_ratio ?? 0.5, no = (t.support_mode ?? 0) | 0, ao = [
        "A. Winkler 3D",
        "B. Vert+esquinas",
        "C. Vert+1 nodo"
      ][no], a = A.val, X = a === "tonf" ? 1 / n : a === "kip" ? 1 / 4.4482216 : 1, lo = P * X, ro = F * X, Z = V * (a === "tonf" ? 1 : a === "kip" ? n / 4.4482216 : n), io = L * (a === "tonf" ? 1 : a === "kip" ? n / 4.4482216 : n), Y = r * (a === "tonf" ? 1 : a === "kip" ? n / 4.4482216 : n), U = so * (a === "tonf" ? 1 : a === "kip" ? n / 4.4482216 : n), i = (t.Mx_simple ?? 0) * (a === "tonf" ? 1 : a === "kip" ? n / 4.4482216 : n), ho = (t.My_simple ?? 0) * (a === "tonf" ? 1 : a === "kip" ? n / 4.4482216 : n), I = (t.q_adm ?? 10) === 10 && (t.P_simple ?? 0) === 20 && Math.abs((t.Mx_simple ?? 0) - 0.5) < 0.01 && Math.abs((t.My_simple ?? 0) - -0.5) < 0.01 && (t.Lz ?? 1.5) === 1.5 && (t.Bz ?? 1.5) === 1.5, M = I ? "96.7 mm" : "(no aplica)", K = (_b = s.deformOutputs.rawVal) == null ? void 0 : _b.deformations;
      let H = 0;
      K && K.forEach((z) => {
    ...
    build(t, s) {
      ...
      t.q_adm * n;
      const F = (Math.round(t.springMode ?? 0) === 0 ? t.q_adm * t.ks_factor : t.ks ?? 2e3) * n, j = (t.P_simple ?? 0) * n, so = (t.Mx_simple ?? 0) * n, C = (t.My_simple ?? 0) * n, g = Math.round(t.nSub), R = r / 2, B = d / 2, p = [], _ = [];
      for (let o = 0; o <= g; o++) p.push(r * o / g), _.push(d * o / g);
      p.includes(R) || (p.push(R), p.sort((o, e) => o - e)), _.includes(B) || (_.push(B), _.sort((o, e) => o - e));
      const V = [], L = [], G = /* @__PURE__ */ new Map(), W = /* @__PURE__ */ new Map(), no = /* @__PURE__ */ new Map(), ao = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map(), X = /* @__PURE__ */ new Map(), lo = /* @__PURE__ */ new Map(), ro = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), io = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map(), U = (o, e, l) => {
      ...
      const ho = U(R, B, 0), I = U(R, B, P), M = L.length;
      L.push([
        ho,
        I
  ...
  FS = ${(t.q_adm / ($ || 1)).toFixed(3)}`);
      ...
      const wo = $o * 12, Ro = new Set(mo), fo = (_a = document.querySelector("#viewer")) == null ? void 0 : _a.__settings, No = (o, e, l = 1) => {
