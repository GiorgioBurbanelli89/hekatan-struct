import { a as I } from "./analyze-DNPn2SjO.js";
import { m as g, d as H, __tla as __tla_0 } from "./didacticCpp-Ck1qafl6.js";
let E;
let __tla = Promise.all([
  ...
  E = {
    ...
    build(e, n) {
      ...
      const d = /* @__PURE__ */ new Map(), h = r * (l + 1), p = e.Fx / l, M = e.Fz / l;
      for (let t = 0; t <= l; t++) {
        const o = h + t, a = t === 0 || t === l, x = a ? p * 0.5 : p, f = a ? M * 0.5 : M;
        d.set(o, [
          x,
          0,
          f,
