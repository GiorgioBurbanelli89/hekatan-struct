import { M as ws, __tla as __tla_0 } from "./deform-BTnZUOjy.js";
...
let __tla = Promise.all([
  ...
  ot = function(t, r, e, s, a) {
    ...
    o.push(k);
    const m = (U) => {
      const us = U ? Array.from(U.keys()) : [], qs = U ? Array.from(U.values()) : [], Gs = g(us, Uint32Array, i.HEAPU32);
      o.push(Gs);
  ...
  const y = await ws();
  et = function(t, r, e, s, a = 10, o = 0, Q = 0, $ = 1, N, G) {
    if (t.length === 0) return {
      frequencies: [],
      modeShapes: [],
      massParticipation: []
  ...
  const cs = await ws();
  lt = function(t) {
    const { nodes: r, elements: e, E: s, nu: a, gamma: o, c: Q, phi: $, thickness: N = 1, supports: G, surcharge: n = 0, surfaceYThreshold: q = -1e10 } = t, w = [], Z = r.flat(), P = st(Z);
    w.push(P);
  ...
  ct = function(t, r, e, s) {
    ...
    return M && a.push(M), X && a.push(X), J && a.push(J), a.forEach((x) => p._free(x)), tt(es, C, ss, t.length, r.length);
  };
