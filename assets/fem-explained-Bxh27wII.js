...
import { v as M } from "./theme-2eEBQPmF.js";
import { g as pt, b as mt, a as xt } from "./analyze-CRXZq0x4.js";
import { d as ut, __tla as __tla_0 } from "./didacticCpp-CT_TM4EM.js";
import { g as ht } from "./getViewer-LadiwUlT.js";
import { g as bt } from "./styles-lf_LNy9d.js";
import { k as gt, j as _t, c as Z, a as vt, V as yt, B as $t, n as wt, L as zt } from "./Text-CEhsqBUu.js";
...
Promise.all([
  ...
  function kt(t, r, i) {
    ...
    for (let e = 0; e < m; e++) {
      ...
      for (let c = 0; c < a; c++) {
        ...
        o += `<td class="${d ? "zero" : e === c ? "highlight" : ""}">${d ? "0" : jt(s)}</td>`;
      }
      o += "</tr>";
    }
  ...
  function Dt(t, r, i, l, p, f, m) {
    var _a, _b, _c, _d, _e, _f;
    const a = i[t], o = r[a[0]], e = r[a[1]], c = [
      o,
      e
    ], s = Mt(Q(o, e)), d = ((_a = l.elasticities) == null ? void 0 : _a.get(t)) ?? 0, b = ((_b = l.areas) == null ? void 0 : _b.get(t)) ?? 0, x = ((_c = l.momentsOfInertiaZ) == null ? void 0 : _c.get(t)) ?? 0, u = ((_d = l.momentsOfInertiaY) == null ? void 0 : _d.get(t)) ?? 0, h = ((_e = l.shearModuli) == null ? void 0 : _e.get(t)) ?? 0, _ = ((_f = l.torsionalConstants) == null ? void 0 : _f.get(t)) ?? 0, $ = d * b / s, E = d * x / s ** 3, D = d * u / s ** 3, L = h * _ / s, w = pt(c, l, t), y = mt(c), A = N(Et(y), N(w, y)), q = Q(e, o), X = q[0] / s, U = q[1] / s, G = q[2] / s, lt = Math.sqrt(X ** 2 + U ** 2), V = a[0] * 6, H = a[1] * 6, S = [];
    ...
    v.push({
      ...
      formulas: [
        ...
        `K[2,2] = \\frac{12EI_y}{L^3} = ${n(12 * D)}`,
        `K[3,3] = \\frac{GJ}{L} = ${n(L)}`,
        `K[4,4] = \\frac{4EI_y}{L} = ${n(4 * D * s ** 2)}`,
  ...
  M.derive(() => {
    const t = B.val, r = j.val, i = Y.val, l = O.val;
