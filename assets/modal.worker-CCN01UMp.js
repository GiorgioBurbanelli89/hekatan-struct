(async ()=>{
    ...
    async function Le(L = {}) {
        ...
        var Me;
        function ar() {
            return d.locateFile ? ne("deform.wasm") : new URL("/hekatan-struct-lineal/assets/deform-CEF8-h67.wasm", import.meta.url).href;
        }
        function $e(e) {
...
`));
    ...
    function zn(L, B, d, k, K = 10, q = 0, X = 0, Q = 1, te, Pe) {
        ...
        A.push(ar);
        const $e = x(k.shearAreasY), Ge = x(k.shearAreasZ), Ve = x(k.localAngles), sr = k.momentReleases ? Array.from(k.momentReleases.keys()) : [], pr = k.momentReleases ? Array.from(k.momentReleases.values()).flatMap(Bn) : [], cr = j(sr, Uint32Array, b.HEAPU32);
        A.push(cr);
