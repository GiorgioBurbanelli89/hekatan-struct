import { a as O } from "./analyze-DNPn2SjO.js";
import { m as V, d as B, __tla as __tla_0 } from "./didacticCpp-BaiPjJ4y.js";
let G;
let __tla = Promise.all([
  ...
  G = {
    ...
    category: "\u{1F3AF} 2 DOF \xB7 Cantilever Flexi\xF3n",
    benchmark: true,
    ...
    build(e, o) {
      ...
      const x = B(f, d, o.nodeInputs.val, o.elementInputs.val);
      o.deformOutputs.val = x, o.analyzeOutputs.val = O(f, d, o.elementInputs.val, x), o.objects3D.val = [];
      const I = c * e.L ** 4 / (8 * e.E * i), z = c * e.L ** 2 / (2 * s * n), h = I + z, k = ((_b = (_a = x.deformations) == null ? void 0 : _a.get(l)) == null ? void 0 : _b[2]) ?? 0, A = Math.abs(h) > 1e-15 ? (Math.abs(k) - h) / h * 100 : 0;
