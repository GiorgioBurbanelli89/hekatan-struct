import { a as G, b as O, L as B, E as R } from "./theme-Co6w-pfC.js";
import { a as te } from "./analyze-Baqb28rE.js";
import { d as ae, __tla as __tla_0 } from "./didacticCpp-PqvqKlgs.js";
let me;
let __tla = Promise.all([
  ...
  function Y(t, a, s, o) {
    const n = t * a, l = s * o, m = n + l, f = a / 2, c = a + o / 2, u = (n * f + l * c) / m, p = t * a ** 3 / 12, r = s * o ** 3 / 12, _ = p + n * (u - f) ** 2 + r + l * (u - c) ** 2, x = a * t ** 3 / 12 + o * s ** 3 / 12, h = (P, d) => {
  ...
  me = {
    ...
    build(t, a) {
      const s = t.L, o = t.Bz, n = t.t_zap, l = t.b_viga, m = t.h_viga, f = t.h_ped, c = t.b_ped, u = t.ks_tonfm3 * q, p = Math.round(t.nx), r = p + 1, _ = s / p, x = o / 2, h = [
        [
          t.x1,
          x
        ],
      ...
      const A = 228e5, T = 0.2, Z = A / (2 * (1 + T)), I = Y(o, n, l, m), $ = c * c, H = c ** 4 / 12, ee = 0.141 * c ** 4, C = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Map(), z = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map();
