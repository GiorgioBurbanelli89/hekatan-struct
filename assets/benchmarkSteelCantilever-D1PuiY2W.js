...
import { a as n, b as i, c as b } from "./units-yggW8zr_.js";
...
let __tla = Promise.all([
  ...
  I = {
    ...
    computedLabels(e) {
      const o = e.D_out, m = e.t_HSS, a = o - 2 * m, t = o * o - a * a, l = (o ** 4 - a ** 4) / 12, r = e.gamma_s * t, s = r * e.L, d = r * e.L * e.L / (2 * e.E_s * t) * 1e3;
      return {
    ...
    build(e, o) {
      var _a, _b;
      const m = v(o), { sec: a } = y(x(e), o, 0, m), t = e.L, l = Math.max(1, Math.round(e.nSegments)), r = (_a = o.deformOutputs.val.deformations) == null ? void 0 : _a.get(l), s = (_b = o.deformOutputs.val.reactions) == null ? void 0 : _b.get(0);
      if (r) {
...
`;
    ...
    Anal\xEDtico Timoshenko: ${n(M, 4)} (bending ${n(u, 4)} + shear ${n(f, 4)})
...
`)), (m == null ? void 0 : m.render) && m.render(a, {
