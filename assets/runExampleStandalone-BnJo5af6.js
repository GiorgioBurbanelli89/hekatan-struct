const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CSXO-8kx.js","assets/analyze-BFwM3Jvn.js","assets/pureFunctionsAny.generated-DeJSBP3k.js","assets/didacticCpp-DG5VoQAQ.js","assets/deform-Uxr1_sxQ.js","assets/preload-helper-V2P8TQsQ.js","assets/planeQ4-DsCzHfbV.js","assets/layeredQ4-DuXBBCkf.js","assets/mitc3-2FJr2z_r.js","assets/fiberSectionCft-CvKVMF85.js","assets/menegottoPinto-9Id4uJ7l.js"])))=>i.map(i=>d[i]);
      ...
      if (l == null ? void 0 : l.addFolder) {
        ...
        y.on("click", async () => {
          ...
          try {
            ...
            n("\u23F3 calculando\u2026");
            const t = new Worker(new URL("/hekatan-struct-lineal/assets/modal.worker-Cl97XoRq.js", import.meta.url), {
              type: "module"
            }), i = (D) => {
              const N = {};
              ...
              if (!c) {
                ...
                try {
                  const { modalAnalysis: N } = await ot(async () => {
                    const { modalAnalysis: I } = await import("./index-CSXO-8kx.js").then(async (m2) => {
                      await m2.__tla;
                      return m2;
                    });
                    return {
        ...
        p.addBinding(h, "limite", {
          ...
          for (let r = 0; r < x.length; r++) {
            ...
            for (const T of t) for (const I of x[T]) {
              const X = k[I], H = m < 1e-9 ? 0 : ((X[0] - c[0]) * (o[0] - c[0]) + (X[1] - c[1]) * (o[1] - c[1]) + (X[2] - c[2]) * (o[2] - c[2])) / (m * m), J = L + (F - L) * H, G = Math.abs((b.get(I) || [
                0,
                0,
                0
              ])[2] - J) * 1e3;
