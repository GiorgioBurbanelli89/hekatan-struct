...
import { g as J } from "./getViewer-CKkS3ueR.js";
import { g as Z } from "./getParameters-DoKMBz9t.js";
import { g as q } from "./getTables-BhF8jhBF.js";
import { b as Q, x as N, g as W } from "./styles-Y66YTQNs.js";
import { g as Y } from "./getDialog-HRYuxjvF.js";
import { g as tt } from "./getReport-Dwb99Wvd.js";
import { a as at } from "./analyze-ClLKGn9k.js";
import { d as et, __tla as __tla_0 } from "./didacticCpp-RemoaQyH.js";
import { g as st, a as lt, b as ot, c as A, d as H, __tla as __tla_1 } from "./getSolids-tScdAgAu.js";
...
`, document.head.appendChild(n), e;
  ...
  function gt() {
    w === "1st-floor" ? c.val = [] : (m.val = [], h.val = []), f.val = [], S.val = [], a.points.val = [], a.columns.val = [], a.slabs.val = [], a.columnsByStory.val = /* @__PURE__ */ new Map(), a.slabsByStory.val = /* @__PURE__ */ new Map(), a.columnData.val = /* @__PURE__ */ new Map(), a.slabData.val = /* @__PURE__ */ new Map(), r.nodes.val = [], r.elements.val = [], r.nodeInputs.val = {}, P.geometry = A(a.points.val, a.slabs.val, a.columns.val), I.geometry = H(a.points.val, a.slabs.val, a.columns.val), g.val = [
      ...g.rawVal
    ];
  }
  t.derive(() => {
