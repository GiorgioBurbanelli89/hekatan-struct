import { L as G, b as O, c as B, E as R } from "./Text-BmY6zyQy.js";
import { a as te } from "./analyze-DNPn2SjO.js";
import { d as ae, __tla as __tla_0 } from "./didacticCpp-9kTtzmo8.js";
let me;
let __tla = Promise.all([
  ...
  me = {
    ...
    name: "Viga Cimentaci\xF3n \xB7 Ej.7 Guerra (T invertida + pedestales)",
    ...
    build(t, a) {
      ...
      const A = 228e5, C = 0.2, Z = A / (2 * (1 + C)), I = Y(o, n, l, m), $ = c * c, H = c ** 4 / 12, ee = 0.141 * c ** 4, T = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Map(), z = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map();
      for (let e = X; e < V; ++e) T.set(e, A), k.set(e, C), z.set(e, I.A), D.set(e, I.Iz), F.set(e, I.Iy), S.set(e, Z), E.set(e, I.J);
      for (let e = V; e < b.length; ++e) T.set(e, A), k.set(e, C), z.set(e, $), D.set(e, H), F.set(e, H), S.set(e, Z), E.set(e, ee);
      const K = {
