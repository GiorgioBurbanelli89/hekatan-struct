  ...
  it = function(p, a, m) {
    ...
    if (a && a.length > 0) {
      ...
      h = Promise.allSettled(a.map((I) => {
        ...
        _r[I] = true;
        const V = I.endsWith(".css"), ae = V ? '[rel="stylesheet"]' : "";
        if (!!m) for (let v = G.length - 1; v >= 0; v--) {
          const P = G[v];
          if (P.href === I && (!V || P.rel === "stylesheet")) return;
        }
        else if (document.querySelector(`link[href="${I}"]${ae}`)) return;
        const U = document.createElement("link");
        if (U.rel = V ? "stylesheet" : st, V || (U.as = "script"), U.crossOrigin = "", U.href = I, re && U.setAttribute("nonce", re), document.head.appendChild(U), V) return new Promise((v, P) => {
          U.addEventListener("load", v), U.addEventListener("error", () => P(new Error(`Unable to preload CSS for ${I}`)));
        });
      }));
    }
    function w(G) {
    ...
    return h.then((G) => {
      for (const C of G || []) C.status === "rejected" && w(C.reason);
      return p().catch(w);
    });
  };
  Le = async function(f = {}) {
    ...
    var a = f, m = !!globalThis.window, h = !!globalThis.WorkerGlobalScope, w = ((_b = (_a = globalThis.process) == null ? void 0 : _a.versions) == null ? void 0 : _b.node) && ((_c = globalThis.process) == null ? void 0 : _c.type) != "renderer", G = !m && !w && !h;
    if (w) {
    ...
    var re = "./this.program", I = import.meta.url, V = "";
    function ae(e) {
    ...
    if (w) {
      ...
      var v = C("fs");
      I.startsWith("file:") && (V = C("path").dirname(C("url").fileURLToPath(I)) + "/"), U = (r) => {
        r = z(r) ? new URL(r) : r;
        var t = v.readFileSync(r);
        return d(Buffer.isBuffer(t)), t;
      }, K = async (r, t = true) => {
        r = z(r) ? new URL(r) : r;
        var o = v.readFileSync(r, t ? void 0 : "utf8");
    ...
    function Q() {
      if (!O) {
        ...
        (r != 34821223 || t != 2310721022) && b(`Stack overflow! Stack cookie has been overwritten at ${He(e)}, expected hex dwords 0x89BACDFE and 0x2135467, but received ${He(t)} ${He(r)}`), _[0] != 1668509029 && b("Runtime error: The application has corrupted its heap memory area (address zero)!");
      }
    }
    (() => {
    ...
    function le(e) {
      Object.getOwnPropertyDescriptor(a, e) || Object.defineProperty(a, e, {
        ...
        get() {
          ...
          N(e) && (r += ". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you"), b(r);
        }
      });
    }
    var pe, ce, J, ee, de, _, H, oe = false;
    function q() {
      var e = qe.buffer;
      J = new Int8Array(e), a.HEAPU8 = ee = new Uint8Array(e), de = new Int32Array(e), a.HEAPU32 = _ = new Uint32Array(e), a.HEAPF64 = new Float64Array(e), H = new BigInt64Array(e), new BigUint64Array(e);
    }
    ...
    function fe() {
      d(!oe), oe = true, Q(), !a.noFSInit && !n.initialized && n.init(), Ce.__wasm_call_ctors(), n.ignorePermissions = false;
    }
    function me() {
    ...
    var _e;
    function M() {
      return a.locateFile ? ae("deform.wasm") : new URL("" + new URL("deform-BUc6yFME.wasm", import.meta.url).href, import.meta.url).href;
    }
    function F(e) {
      if (e == _e && E) return new Uint8Array(E);
      if (U) return U(e);
    ...
    var Pr = (e, r, t) => {
      ...
      normalize: (e) => {
        var r = j.isAbs(e), t = e.slice(-1) === "/";
        return e = j.normalizeArray(e.split("/").filter((o) => !!o), !r).join("/"), !e && !r && (e = "."), e && t && (e += "/"), (r ? "/" : "") + e;
      },
      dirname: (e) => {
        var r = j.splitPath(e), t = r[0], o = r[1];
      ...
      resolve: (...e) => {
        ...
        return r = j.normalizeArray(r.split("/").filter((i) => !!i), !t).join("/"), (t ? "/" : "") + r || ".";
      },
      relative: (e, r) => {
...
`));
      ...
      var u = r ? Ne.resolve(j.join2(e, r)) : e, y = xr(`cp ${u}`);
      Wr(y);
      try {
        var D = t;
      ...
      lookupPath(e, r = {}) {
        ...
        r.follow_mount ?? (r.follow_mount = true), j.isAbs(e) || (e = n.cwd() + "/" + e);
          ...
          for (var o = e.split("/").filter((y) => !!y), s = n.root, i = "/", l = 0; l < o.length; l++) {
            ...
            if (o[l] !== ".") {
              ...
              if (n.isMountpoint(s) && (!c || r.follow_mount) && (s = s.mounted.root), n.isLink(s.mode) && (!c || r.follow)) {
                ...
                j.isAbs(u) || (u = j.dirname(i) + "/" + u), e = u + "/" + o.slice(l + 1).join("/");
                continue e;
              }
            }
          }
      ...
      rmdir(e) {
        var r = n.lookupPath(e, {
          parent: true
        }), t = r.node, o = j.basename(e), s = n.lookupNode(t, o), i = n.mayDelete(t, o, true);
        if (i) throw new n.ErrnoError(i);
      ...
      unlink(e) {
        ...
        var o = j.basename(e), s = n.lookupNode(t, o), i = n.mayDelete(t, o, false);
        if (i) throw new n.ErrnoError(i);
      ...
      analyzePath(e, r) {
        ...
        try {
          ...
          o.parentExists = true, o.parentPath = t.path, o.parentObject = t.node, o.name = j.basename(e), t = n.lookupPath(e, {
            follow: !r
      ...
      createFile(e, r, t, o, s) {
        var i = j.join2(typeof e == "string" ? e : n.getPath(e), r), l = rr(o, s);
        return n.create(i, l);
      },
      createDataFile(e, r, t, o, s, i) {
        var l = r;
        e && (e = typeof e == "string" ? e : n.getPath(e), l = r ? j.join2(e, r) : e);
      ...
      createDevice(e, r, t, o) {
        var _a2;
        var s = j.join2(typeof e == "string" ? e : n.getPath(e), r), i = rr(!!t, !!o);
      ...
      writeStat(e, r) {
        _[e >> 2] = r.dev, _[e + 4 >> 2] = r.mode, _[e + 8 >> 2] = r.nlink, _[e + 12 >> 2] = r.uid, _[e + 16 >> 2] = r.gid, _[e + 20 >> 2] = r.rdev, H[e + 24 >> 3] = BigInt(r.size), de[e + 32 >> 2] = 4096, de[e + 36 >> 2] = r.blocks;
        var t = r.atime.getTime(), o = r.mtime.getTime(), s = r.ctime.getTime();
        return H[e + 40 >> 3] = BigInt(Math.floor(t / 1e3)), _[e + 48 >> 2] = t % 1e3 * 1e3 * 1e3, H[e + 56 >> 3] = BigInt(Math.floor(o / 1e3)), _[e + 64 >> 2] = o % 1e3 * 1e3 * 1e3, H[e + 72 >> 3] = BigInt(Math.floor(s / 1e3)), _[e + 80 >> 2] = s % 1e3 * 1e3 * 1e3, H[e + 88 >> 3] = BigInt(r.ino), 0;
      },
      writeStatFs(e, r) {
    ...
    function nr() {
      ...
      function e() {
        var _a2;
        d(!vr), vr = true, a.calledRun = true, !O && (fe(), pe == null ? void 0 : pe(a), (_a2 = a.onRuntimeInitialized) == null ? void 0 : _a2.call(a), te("onRuntimeInitialized"), d(!a._main, 'compiled without a main, but one is present. if you added it from JS, use Module["onRuntimeInitialized"]'), me());
      }
  ...
  dt = function(f, p, a, m) {
    ...
    const h = [], w = we(f.flat(), Float64Array, Z.HEAPF64);
    h.push(w);
    const G = p.flat(), C = we(G, Uint32Array, Z.HEAPU32);
    h.push(C);
    const re = p.map((R) => R.length), I = we(re, Uint32Array, Z.HEAPU32);
    h.push(I);
    const V = a.supports ? Array.from(a.supports.keys()) : [], ae = a.supports ? Array.from(a.supports.values()).flat().map((R) => R ? 1 : 0) : [], K = we(V, Uint32Array, Z.HEAPU32);
    h.push(K);
    const U = we(ae, Uint8Array, Z.HEAPU8);
    h.push(U);
    const v = a.loads ? Array.from(a.loads.keys()) : [], P = a.loads ? Array.from(a.loads.values()).flat() : [], S = we(v, Uint32Array, Z.HEAPU32);
    h.push(S);
    const E = we(P, Float64Array, Z.HEAPF64);
    h.push(E);
    const O = (R) => {
      const Se = R ? Array.from(R.keys()) : [], Ze = R ? Array.from(R.values()) : [], Ie = we(Se, Uint32Array, Z.HEAPU32);
      h.push(Ie);
      const ze = we(Ze, Float64Array, Z.HEAPF64);
      return h.push(ze), {
        keysPtr: Ie,
        valuesPtr: ze,
        size: Se.length
      };
    }, d = O(m.elasticities), z = O(m.elasticitiesOrthogonal), W = O(m.areas), Q = O(m.momentsOfInertiaZ), te = O(m.momentsOfInertiaY), k = O(m.shearModuli), ne = O(m.torsionalConstants), N = O(m.thicknesses), ie = O(m.poissonsRatios);
    O(m.shearAreasY), O(m.shearAreasZ);
    const le = m.rigidOffsets ? Array.from(m.rigidOffsets.keys()) : [], pe = m.rigidOffsets ? Array.from(m.rigidOffsets.values()).flat() : [], ce = we(le, Uint32Array, Z.HEAPU32);
    h.push(ce);
    const J = we(pe, Float64Array, Z.HEAPF64);
    h.push(J);
    const ee = m.momentReleases ? Array.from(m.momentReleases.keys()) : [], de = m.momentReleases ? Array.from(m.momentReleases.values()).flat().map((R) => R ? 1 : 0) : [], _ = we(ee, Uint32Array, Z.HEAPU32);
    h.push(_);
    const H = we(de, Uint8Array, Z.HEAPU8);
    h.push(H);
    const oe = Z._malloc(4);
    h.push(oe);
    const q = Z._malloc(4);
    h.push(q);
    const ve = Z._malloc(4);
    h.push(ve);
    const fe = Z._malloc(4);
    h.push(fe), Z._deform(w, f.length, C, G.length, I, p.length, K, U, V.length, S, E, v.length, d.keysPtr, d.valuesPtr, d.size, W.keysPtr, W.valuesPtr, W.size, Q.keysPtr, Q.valuesPtr, Q.size, te.keysPtr, te.valuesPtr, te.size, k.keysPtr, k.valuesPtr, k.size, ne.keysPtr, ne.valuesPtr, ne.size, N.keysPtr, N.valuesPtr, N.size, ie.keysPtr, ie.valuesPtr, ie.size, z.keysPtr, z.valuesPtr, z.size, oe, q, ve, fe);
    const me = Z.HEAPU32[oe / 4], b = Z.HEAPU32[q / 4], $ = Z.HEAPU32[ve / 4], _e = Z.HEAPU32[fe / 4], M = new Float64Array(Z.HEAPF64.buffer, me, b), F = new Float64Array(Z.HEAPF64.buffer, $, _e), X = /* @__PURE__ */ new Map();
    for (let R = 0; R < b; R += 7) {
      const Se = M[R];
      X.set(Se, Array.from(M.slice(R + 1, R + 7)));
    }
    const x = /* @__PURE__ */ new Map();
    for (let R = 0; R < _e; R += 7) {
      const Se = F[R];
      x.set(Se, Array.from(F.slice(R + 1, R + 7)));
    }
    return me && h.push(me), $ && h.push($), h.forEach((R) => Z._free(R)), {
      deformations: X,
      reactions: x
    };
  };
  function we(f, p, a) {
    const m = new p(f), h = Z._malloc(m.length * m.BYTES_PER_ELEMENT);
  ...
  ft = function(f, p, a, m, h = 10) {
    ...
    const w = [], G = Re(f.flat(), Float64Array, B.HEAPF64);
    w.push(G);
    const C = p.flat(), re = Re(C, Uint32Array, B.HEAPU32);
    w.push(re);
    const I = p.map((M) => M.length), V = Re(I, Uint32Array, B.HEAPU32);
    w.push(V);
    const ae = a.supports ? Array.from(a.supports.keys()) : [], K = a.supports ? Array.from(a.supports.values()).flat().map((M) => M ? 1 : 0) : [], U = Re(ae, Uint32Array, B.HEAPU32);
    w.push(U);
    const v = Re(K, Uint8Array, B.HEAPU8);
    w.push(v);
    const P = (M) => {
      const F = M ? Array.from(M.keys()) : [], X = M ? Array.from(M.values()) : [], x = Re(F, Uint32Array, B.HEAPU32);
      w.push(x);
      const R = Re(X, Float64Array, B.HEAPF64);
      return w.push(R), {
        keysPtr: x,
        valuesPtr: R,
        size: F.length
      };
    }, S = P(m.elasticities), E = P(m.areas), O = P(m.momentsOfInertiaZ), d = P(m.momentsOfInertiaY), z = P(m.shearModuli), W = P(m.torsionalConstants), Q = P(m.densities), te = P(m.thicknesses), k = P(m.poissonsRatios), ne = B._malloc(4);
    w.push(ne);
    const N = B._malloc(4);
    w.push(N);
    const ie = B._malloc(4);
    w.push(ie);
    const le = B._malloc(4);
    w.push(le);
    const pe = B._malloc(4);
    w.push(pe);
    ...
    w.push(ee), B._modal(G, f.length, re, C.length, V, p.length, U, v, ae.length, S.keysPtr, S.valuesPtr, S.size, E.keysPtr, E.valuesPtr, E.size, O.keysPtr, O.valuesPtr, O.size, d.keysPtr, d.valuesPtr, d.size, z.keysPtr, z.valuesPtr, z.size, W.keysPtr, W.valuesPtr, W.size, Q.keysPtr, Q.valuesPtr, Q.size, te.keysPtr, te.valuesPtr, te.size, k.keysPtr, k.valuesPtr, k.size, h, ne, N, ie, le, pe, ce, J, ee);
    const de = B.HEAPU32[ne / 4], _ = B.HEAPU32[N / 4], H = B.HEAPU32[ie / 4], oe = B.HEAPU32[le / 4], q = B.HEAPU32[pe / 4], ve = B.HEAPU32[ce / 4], fe = B.HEAPU32[J / 4], me = B.HEAPU32[ee / 4];
    let b = [], $ = [], _e = [];
    if (_ > 0 && de) {
      const M = new Float64Array(B.HEAPF64.buffer, de, _);
      b = Array.from(M), w.push(de);
    }
    if (oe > 0 && q > 0 && H) {
      const M = new Float64Array(B.HEAPF64.buffer, H, oe * q);
      for (let F = 0; F < oe; F++) $.push(Array.from(M.slice(F * q, (F + 1) * q)));
      w.push(H);
    }
    if (fe > 0 && me > 0 && ve) {
      const M = new Float64Array(B.HEAPF64.buffer, ve, fe * me);
      for (let F = 0; F < fe; F++) _e.push(Array.from(M.slice(F * me, (F + 1) * me)));
      w.push(ve);
    }
    return w.forEach((M) => B._free(M)), {
      frequencies: b,
      modeShapes: $,
      massParticipation: _e
    };
  };
  function Re(f, p, a) {
    const m = new p(f), h = B._malloc(m.length * m.BYTES_PER_ELEMENT);
    return a.set(m, h / m.BYTES_PER_ELEMENT), h;
  }
  await Le();
  const Pe = await Le();
  ut = function(f) {
    const { nodes: p, elements: a, E: m, nu: h, gamma: w, c: G, phi: C, thickness: re = 1, supports: I, surcharge: V = 0, surfaceYThreshold: ae = -1e10 } = f, K = [], U = p.flat(), v = lt(U);
    K.push(v);
    const P = a.flat(), S = Er(P);
    K.push(S);
    const E = [];
    for (const N of I) E.push(N.node, N.fixX ? 1 : 0, N.fixY ? 1 : 0);
    const O = Er(E);
    K.push(O);
    const d = a.length, z = p.length, W = Pe._slopeAllocDouble(d);
    K.push(W);
    const Q = Pe._slopeAllocDouble(z * 2);
    K.push(Q);
    const te = Pe._slopeStabilitySolver(v, z, S, d, m, h, w, G, C, re, O, I.length, V, ae, W, Q), k = [];
    for (let N = 0; N < d; N++) k.push(Pe.HEAPF64[W / 8 + N]);
    const ne = [];
    for (let N = 0; N < z; N++) ne.push([
      Pe.HEAPF64[Q / 8 + 2 * N],
      Pe.HEAPF64[Q / 8 + 2 * N + 1]
    ]);
    return K.forEach((N) => Pe._free(N)), {
      fos: te,
      plasticStrain: k,
      displacements: ne
    };
  ...
  mt = function(f) {
    ...
    p.push(h);
    let w = [], G = 0;
    f.elements && f.elements.length > 0 && (G = f.elements.length, w = f.elements.flat());
    const C = Ye(w.length > 0 ? w : [
      0
    ], Int32Array, ue.HEAPU32);
    p.push(C);
    let re = [], I = 0;
    f.bcs && f.bcs.length > 0 && (I = f.bcs.length, re = f.bcs.flatMap((F) => [
      F.node,
      F.dof,
      F.value
    ]));
    const V = Ye(re.length > 0 ? re : [
      0
    ], Float64Array, ue.HEAPF64);
    p.push(V);
    let ae = [], K = 0;
    f.pointLoads && f.pointLoads.length > 0 && (K = f.pointLoads.length, ae = f.pointLoads.flatMap((F) => [
      F.node,
      F.dof,
      F.value
    ]));
    const U = Ye(ae.length > 0 ? ae : [
      0
    ], Float64Array, ue.HEAPF64);
    p.push(U);
    const v = f.meshLx ?? 0, P = f.meshLy ?? 0, S = f.meshNx ?? 0, E = f.meshNy ?? 0, d = {
      none: 0,
      "simply-supported": 1,
      clamped: 2
    }[f.bcType ?? "none"] ?? 0, z = f.theoryType ?? 0;
    let W = [], Q = 0;
    f.springs && f.springs.length > 0 && (Q = f.springs.length, W = f.springs.flatMap((F) => [
      F.node,
      F.dof,
      F.k
    ]));
    const te = Ye(W.length > 0 ? W : [
      0
    ], Float64Array, ue.HEAPF64);
    p.push(te);
    ...
    p.push(ne);
    const N = ue._malloc(4);
    p.push(N);
    const ie = ue._malloc(4);
    p.push(ie), ue._plate_q4_solve(h, m, C, G, f.E, f.nu, f.thickness, V, I, f.pressure ?? 0, U, K, v, P, S, E, d, z, te, Q, k, ne, N, ie);
    const le = ue.HEAPU32[k / 4], pe = ue.HEAPU32[ne / 4], ce = ue.HEAPU32[N / 4], J = ue.HEAPU32[ie / 4], ee = new Float64Array(ue.HEAPF64.buffer, le, pe), de = ee[0], _ = ee[1], H = [];
    let oe = 0;
    for (let F = 0; F < de; F++) {
      const X = 2 + F * 5, x = {
        x: ee[X],
      ...
      H.push(x), Math.abs(x.w) > Math.abs(oe) && (oe = x.w);
    }
    const q = new Float64Array(ue.HEAPF64.buffer, ce, J), ve = [];
    let fe = 0, me = 0, b = 0, $ = 0, _e = 0;
    for (let F = 0; F < _; F++) {
      const X = F * 9, x = {
        nodes: [
          q[X],
      ...
      ve.push(x), Math.abs(x.Mxx) > Math.abs(fe) && (fe = x.Mxx), Math.abs(x.Myy) > Math.abs(me) && (me = x.Myy), Math.abs(x.Mxy) > Math.abs(b) && (b = x.Mxy), Math.abs(x.Qx) > Math.abs($) && ($ = x.Qx), Math.abs(x.Qy) > Math.abs(_e) && (_e = x.Qy);
    }
    let M;
    if (v > 0 && P > 0) {
      const F = v / 2, X = P / 2;
      let x = 1 / 0;
      for (const R of H) {
        const Se = Math.hypot(R.x - F, R.y - X);
        Se < x && (x = Se, M = R.w);
      }
    }
    return le && p.push(le), ce && p.push(ce), p.forEach((F) => ue._free(F)), {
      nodeResults: H,
      elementResults: ve,
      maxW: oe,
      maxMxx: fe,
  ...
  ht = function(f, p, a, m) {
    ...
    const h = [], w = ke(f.flat(), Float64Array, Y.HEAPF64);
    h.push(w);
    const G = p.flat(), C = ke(G, Uint32Array, Y.HEAPU32);
    h.push(C);
    const re = p.map((M) => M.length), I = ke(re, Uint32Array, Y.HEAPU32);
    h.push(I);
    const V = a.supports ? Array.from(a.supports.keys()) : [], ae = a.supports ? Array.from(a.supports.values()).flat().map((M) => M ? 1 : 0) : [], K = ke(V, Uint32Array, Y.HEAPU32);
    h.push(K);
    const U = ke(ae, Uint8Array, Y.HEAPU8);
    h.push(U);
    const v = a.loads ? Array.from(a.loads.keys()) : [], P = a.loads ? Array.from(a.loads.values()).flat() : [], S = ke(v, Uint32Array, Y.HEAPU32);
    h.push(S);
    const E = ke(P, Float64Array, Y.HEAPF64);
    h.push(E);
    const O = (M) => {
      const F = M ? Array.from(M.keys()) : [], X = M ? Array.from(M.values()) : [], x = ke(F, Uint32Array, Y.HEAPU32);
      h.push(x);
      const R = ke(X, Float64Array, Y.HEAPF64);
      return h.push(R), {
        keysPtr: x,
        valuesPtr: R,
        size: F.length
      };
    }, d = O(m.elasticities), z = O(m.areas), W = O(m.momentsOfInertiaZ), Q = O(m.momentsOfInertiaY), te = O(m.shearModuli), k = O(m.torsionalConstants), ne = O(m.thicknesses), N = O(m.poissonsRatios), ie = O(m.shearAreasY), le = O(m.shearAreasZ), pe = Y._malloc(4);
    h.push(pe);
    const ce = Y._malloc(4);
    h.push(ce);
    const J = Y._malloc(4);
    h.push(J);
    const ee = Y._malloc(4);
    h.push(ee);
    const de = Y._malloc(4);
    h.push(de);
    const _ = Y._malloc(4);
    h.push(_), Y._didactic_solve(w, f.length, C, G.length, I, p.length, K, U, V.length, S, E, v.length, d.keysPtr, d.valuesPtr, d.size, z.keysPtr, z.valuesPtr, z.size, W.keysPtr, W.valuesPtr, W.size, Q.keysPtr, Q.valuesPtr, Q.size, te.keysPtr, te.valuesPtr, te.size, k.keysPtr, k.valuesPtr, k.size, ne.keysPtr, ne.valuesPtr, ne.size, N.keysPtr, N.valuesPtr, N.size, ie.keysPtr, ie.valuesPtr, ie.size, le.keysPtr, le.valuesPtr, le.size, pe, ce, J, ee, de, _);
    const H = Y.HEAPU32[pe / 4], oe = Y.HEAPU32[ce / 4], q = Y.HEAPU32[J / 4], ve = Y.HEAPU32[ee / 4], fe = Y.HEAPU32[de / 4], me = Y.HEAPU32[_ / 4], b = H && oe > 0 ? Array.from(new Float64Array(Y.HEAPF64.buffer, H, oe)) : [], $ = q && ve > 0 ? Array.from(new Float64Array(Y.HEAPF64.buffer, q, ve)) : [], _e = fe && me > 0 ? Array.from(new Float64Array(Y.HEAPF64.buffer, fe, me)) : [];
    return H && h.push(H), q && h.push(q), fe && h.push(fe), h.forEach((M) => Y._free(M)), ct(b, $, _e, f.length, p.length);
  };
  function ct(f, p, a, m, h) {
    const w = m * 6, G = [];
    if (f.length > 0) {
      const v = f[0], P = [];
      for (let S = 0; S < v; S++) P.push(f[1 + S]);
      for (let S = 0; S < v; S++) {
        let E = P[S];
        const O = f[E++], d = f[E++], z = f[E++], W = z * z, Q = Xe(f.slice(E, E + W), z);
        E += W;
        const te = Xe(f.slice(E, E + W), z);
        E += W;
        const k = Xe(f.slice(E, E + W), z);
        E += W;
        const ne = Xe(f.slice(E, E + 9), 3);
        E += 9;
        const N = f[E++], ie = f[E++], le = f[E++], pe = f[E++], ce = f[E++], J = f[E++], ee = f[E++], de = f[E++], _ = f[E++], H = f[E++], oe = f[E++];
        G.push({
          index: O,
    ...
    if (a.length > 0) {
      let v = 0;
      const P = a[v++];
      I = a.slice(v, v + P), v += P, V = a.slice(v, v + P), v += P, ae = a.slice(v, v + P), v += P;
      const S = a[v++];
      K = a.slice(v, v + S).map(Math.round), v += S;
      const E = a[v++];
      U = a.slice(v, v + E).map(Math.round);
    }
    return {
      nNodes: m,
      nElements: h,
  ...
  function ke(f, p, a) {
    const m = new p(f), h = Y._malloc(m.length * m.BYTES_PER_ELEMENT);
    return a.set(m, h / m.BYTES_PER_ELEMENT), h;
  }
})();
export {
