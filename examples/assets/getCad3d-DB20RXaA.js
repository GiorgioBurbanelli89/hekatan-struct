...
import { G as bn, b as vl, M as ya, D as $a, B as co, c as Cn, d as yl, C as $l, e as Ta, V as qe, P as Po, R as Ma, f as wa, g as Qo, h as en, i as Ml, S as wl, j as El, F as Bo, a as tn, L as Do, k as Sl, l as Il, A as En, T as ds, m as Sn, n as In, o as kl, p as Tl } from "./Text-CBH-tcJP.js";
import { g as Fn, b as Pn, a as Eo } from "./analyze-ClLKGn9k.js";
import { g as Io, __tla as __tla_1 } from "./getMesh-B1dmlgUt.js";
import { t as A, s as zl, u as Al } from "./i18n-BFLtEji2.js";
import { n as Wo, s as ko, m as uo, t as hs } from "./pureFunctionsAny.generated-JAcEVsJ7.js";
let ka, Pl, Mi;
let __tla = Promise.all([
  ...
  function jo(e, b) {
    const O = bs.find((W) => W.id === e), M = nn.find((W) => W.id === b), X = O.toKN, H = M.toM, Z = (W, he, T) => T / (Math.pow(X, W) * Math.pow(H, he));
    let V, j;
    switch (e) {
      case "kN":
        V = 10, j = [
  ...
  <td style="padding:2px 5px; text-align:right; color:#0ff">${(Z[5] * 100).toFixed(1)}%</td></tr>`;
      ...
      (_b = e.querySelector("#modal-copy")) == null ? void 0 : _b.addEventListener("click", () => {
        ...
        M.frequencies.forEach(($e, fe) => {
          var _a2;
          const re = $e > 0 ? 1 / $e : 0, ne = $e * 2 * Math.PI, B = ((_a2 = M.massParticipation) == null ? void 0 : _a2[fe]) || [
            0,
            0,
            0,
            0,
          ...
          for (let Y = 0; Y < 6; Y++) T[Y] += B[Y];
          const D = B.map((Y) => ((Y * 100).toFixed(1) + "%").padStart(6)).join(" ");
          W.push(`${String(fe + 1).padStart(4)}  ${$e.toFixed(4).padStart(9)}  ${re.toFixed(4).padStart(9)}  ${ne.toFixed(2).padStart(9)}  ${D}  ${(T[0] * 100).toFixed(1).padStart(5)}%  ${(T[1] * 100).toFixed(1).padStart(5)}%  ${(T[5] * 100).toFixed(1).padStart(5)}%`);
...
`));
  ...
  function Rl(e) {
    ...
    T += '<button class="rpt-close" id="rpt-close">\u2715 Close</button>', T += "<h1>Finite Element Analysis \u2014 Step-by-Step Report</h1>", T += '<div class="rpt-subtitle">Complete FEM derivation from element formulation to final results</div>', T += '<hr class="rpt-sep"/>', T += "<h2>1. Input Data</h2>", T += '<table class="rpt-info"><tbody>', T += `<tr><td>Number of nodes</td><td class="val">${b.length}</td></tr>`, T += `<tr><td>Number of elements</td><td class="val">${V} (${j} frames, ${W} shells)</td></tr>`, T += '<tr><td>DOFs per node</td><td class="val">6 (u<sub>x</sub>, u<sub>y</sub>, u<sub>z</sub>, \u03B8<sub>x</sub>, \u03B8<sub>y</sub>, \u03B8<sub>z</sub>)</td></tr>', T += `<tr><td>Total DOFs</td><td class="val">${Z}</td></tr>`, T += "</tbody></table>", T += "<h3>1.1 Node Coordinates</h3>", T += '<table class="rpt-data"><thead><tr><th>Node</th><th>x</th><th>y</th><th>z</th></tr></thead><tbody>', b.forEach((re, ne) => {
      ...
      var _a2, _b2, _c2, _d2;
      const B = re.length === 2, D = re.map((ye) => b[ye]), Y = B ? Wo(ko(D[1], D[0])) : 0, ue = ((_a2 = M.elasticities) == null ? void 0 : _a2.get(ne)) ?? 0, Me = ((_b2 = M.areas) == null ? void 0 : _b2.get(ne)) ?? 0, Ae = ((_c2 = M.momentsOfInertiaZ) == null ? void 0 : _c2.get(ne)) ?? 0, Ke = ((_d2 = M.momentsOfInertiaY) == null ? void 0 : _d2.get(ne)) ?? 0;
      T += `<tr><td>${ne}</td><td>${B ? "Frame" : "Shell"}</td><td>${re.join(" \u2192 ")}</td>`, T += `<td>${rt(Y)}</td><td>${rt(ue)}</td><td>${rt(Me)}</td><td>${rt(Ae)}</td><td>${rt(Ke)}</td></tr>`;
    ...
    for (let re = 0; re < V; re++) {
      const ne = O[re], B = ne.map((dt) => b[dt]);
      if (!(ne.length === 2)) continue;
      const Y = Wo(ko(B[1], B[0])), ue = ((_a = M.elasticities) == null ? void 0 : _a.get(re)) ?? 0, Me = ((_b = M.areas) == null ? void 0 : _b.get(re)) ?? 0, Ae = ((_c = M.momentsOfInertiaZ) == null ? void 0 : _c.get(re)) ?? 0, Ke = ((_d = M.momentsOfInertiaY) == null ? void 0 : _d.get(re)) ?? 0, ye = ((_e = M.shearModuli) == null ? void 0 : _e.get(re)) ?? 0, Ge = ((_f = M.torsionalConstants) == null ? void 0 : _f.get(re)) ?? 0;
      let Ye = null, be = null, Te = null;
      try {
        Ye = Fn(B, M, re), be = Pn(B), Te = uo(hs(be), uo(Ye, be));
      } catch {
        continue;
      }
      const Ce = ko(B[1], B[0]), Ue = Ce[0] / Y, ct = Ce[1] / Y, Ze = Ce[2] / Y;
    ...
    if (T += "<h3>5.1 Supports (fixed DOFs)</h3>", X.supports && X.supports.size > 0) {
      ...
      T += "</tr></thead><tbody>", X.supports.forEach((re, ne) => {
        T += `<tr><td>${ne}</td>`, re.forEach((B, D) => {
          B && $e.push(ne * 6 + D), T += `<td class="${B ? "fixed" : ""}">${B ? "Fixed" : "Free"}</td>`;
        }), T += "</tr>";
      }), T += "</tbody></table>";
    }
    if (T += `<div class="rpt-eq-small">Fixed DOFs: [${$e.join(", ")}] \u2192 ${$e.length} constraints<br/>`, T += `Free DOFs: ${Z} \u2212 ${$e.length} = <b>${Z - $e.length}</b></div>`, T += "<h3>5.2 Applied Loads</h3>", X.loads && X.loads.size > 0) {
      ...
      T += "</tr></thead><tbody>", X.loads.forEach((ne, B) => {
        T += `<tr><td>${B}</td>`, ne.forEach((D) => {
          const Y = Math.abs(D) > 1e-10;
          T += `<td class="${Y ? "nz" : ""}">${Y ? rt(D) : "0"}</td>`;
        }), T += "</tr>";
      }), T += "</tbody></table>";
    }
    if (T += "<h2>6. Solution</h2>", T += "<p>After removing fixed DOFs, the reduced system is:</p>", T += '<div class="rpt-eq rpt-eq-highlight">K<sub>free</sub> \xB7 u<sub>free</sub> = F<sub>free</sub></div>', T += "<p>Solved using LU decomposition with partial pivoting (sparse matrix).</p>", T += "<h3>6.1 Nodal Displacements</h3>", H == null ? void 0 : H.deformations) {
      ...
      T += "</tr></thead><tbody>", H.deformations.forEach((re, ne) => {
        T += `<tr><td>${ne}</td>`, re.forEach((B) => {
          const D = Math.abs(B) > 1e-10;
          T += `<td class="${D ? "nz" : ""}">${rt(B, 6)}</td>`;
        }), T += "</tr>";
      }), T += "</tbody></table>";
    }
    if (T += "<h3>6.2 Reactions</h3>", T += '<div class="rpt-eq">R = K<sub>total</sub> \xB7 u (extract at fixed DOFs)</div>', H == null ? void 0 : H.reactions) {
      ...
      T += "</tr></thead><tbody>", H.reactions.forEach((re, ne) => {
        T += `<tr><td>${ne}</td>`, re.forEach((B) => {
          const D = Math.abs(B) > 1e-10;
          T += `<td class="${D ? "nz-react" : ""}">${D ? rt(B, 4) : "0"}</td>`;
        }), T += "</tr>";
      }), T += "</tbody></table>";
    }
  ...
  `;
    return he.innerHTML = fe + T, (_h = he.querySelector("#rpt-close")) == null ? void 0 : _h.addEventListener("click", () => he.remove()), he.querySelectorAll("[data-toggle]").forEach((re) => {
      re.addEventListener("click", () => {
        const ne = re.dataset.toggle, B = he.querySelector(`#rpt-${ne}`);
        if (B) {
          const D = B.style.display !== "none";
          B.style.display = D ? "none" : "", re.textContent = re.textContent.replace(/^[▼▶]/, D ? "\u25B6" : "\u25BC");
        }
      });
    }), he;
  }
  ...
  function Bl(e, b, O, M, X, H) {
    ...
    let ne = null, B = null, D = null;
    try {
      ne = Fn(V, M, e), B = Pn(V), D = uo(hs(B), uo(ne, B));
    } catch {
    }
  ...
  function Dl(e, b, O, M, X, H) {
    var _a, _b;
    const Z = Bl(e, b, O, M, X, H), V = document.createElement("div");
  ...
  `, Yt.innerHTML = `
    ...
    <div style="margin-top:8px;display:flex;gap:3px;justify-content:center;">
      ${gn.map((B, D) => `<div style="width:${D === e ? "16px" : "6px"};height:6px;border-radius:3px;background:${D === e ? "#0099ff" : D < e ? "#004488" : "#333"};transition:all 0.3s;"></div>`).join("")}
    </div>
  `, document.body.appendChild(Yt), (_a = Yt.querySelector("#tour-next")) == null ? void 0 : _a.addEventListener("click", () => {
    ...
    const ne = (B) => {
      ...
      (B.key === "ArrowRight" || B.key === "Enter") && (sn(e + 1), document.removeEventListener("keydown", ne)), B.key === "ArrowLeft" && (sn(Math.max(0, e - 1)), document.removeEventListener("keydown", ne)), B.key === "Escape" && (xs(), document.removeEventListener("keydown", ne));
    };
  ...
  function Xl(e) {
    ...
    for (const Pe of b) {
      ...
      if (fe === "MATERIAL PROPERTIES") {
        ...
        if (xe) {
          ...
          const ht = Be.match(/WEIGHTPERVOLUME\s+([\d.eE+-]+)/);
    ...
    if (M.length > 0) {
      ...
      for (let Be = Pe - 1; Be >= 0; Be--) {
        const Fe = ne.get(M[Be + 1].name) + M[Be].height;
        M[Be].elev = Fe, ne.set(M[Be].name, Fe);
      }
    }
    const B = [], D = [], Y = /* @__PURE__ */ new Map(), ue = (Pe, Be) => `${Pe}@${Be}`, Me = /* @__PURE__ */ new Set(), Ae = /* @__PURE__ */ new Map();
    for (const Pe of V) Ae.set(Pe.name, Pe);
    for (const Pe of V) for (const [Be, xe] of he) {
      if (!Be.startsWith(Pe.name + "@")) continue;
    ...
    for (const Pe of Me) {
      const [Be, xe] = Pe.split("@"), Fe = Z.get(Be), ve = ne.get(xe);
      Fe === void 0 || ve === void 0 || (B.push([
        Fe[0],
        Fe[1],
        ve
      ]), D.push(Pe), Y.set(Pe, B.length - 1));
    }
    ...
    const Te = /* @__PURE__ */ new Map(), Ce = /* @__PURE__ */ new Map(), Ue = /* @__PURE__ */ new Map(), ct = /* @__PURE__ */ new Map(), Ze = /* @__PURE__ */ new Map(), dt = /* @__PURE__ */ new Map(), ut = /* @__PURE__ */ new Map(), Tt = /* @__PURE__ */ new Map(), Nt = /* @__PURE__ */ new Map(), Dt = /* @__PURE__ */ new Map(), Mt = /* @__PURE__ */ new Map();
    for (const [Pe, Be] of be) {
      const xe = H.get(Be);
      if (!xe) continue;
      ...
      xe.modI2 && (Je *= xe.modI2), xe.modI3 && (ht *= xe.modI3), Ue.set(Pe, ft), Tt.set(Pe, ht), Nt.set(Pe, Je), Dt.set(Pe, Qe), mt > 0 && ct.set(Pe, mt), pt > 0 && Ze.set(Pe, pt), Mt.set(Pe, {
        type: xt,
        b: ze || void 0,
        h: ve || void 0,
    ...
    for (const [Pe, Be] of W) {
      ...
      for (const ve of Be) ve === "UX" && (Fe[0] = true), ve === "UY" && (Fe[1] = true), ve === "UZ" && (Fe[2] = true), ve === "RX" && (Fe[3] = true), ve === "RY" && (Fe[4] = true), ve === "RZ" && (Fe[5] = true);
      bt.set(xe, Fe);
    }
    const ho = /* @__PURE__ */ new Map(), _e = /* @__PURE__ */ new Map();
    for (let Pe = 0; Pe < ye.length; Pe++) _e.set(`${ye[Pe]}@${Ye[Pe]}`, Pe);
    for (const Pe of T) {
      const Be = _e.get(`${Pe.line}@${Pe.story}`);
      if (Be === void 0) continue;
      const [xe, Fe] = Ke[Be], ve = B[xe], ze = B[Fe], Ve = Math.sqrt((ze[0] - ve[0]) ** 2 + (ze[1] - ve[1]) ** 2 + (ze[2] - ve[2]) ** 2);
  ...
  function Kl(e) {
    ...
    for (const ne of e) {
      const B = ne.trimEnd();
      B.endsWith("_") ? O += B.slice(0, -1) + " " : (O += B, b.push(O), O = "");
    }
    O && b.push(O);
    const M = {
      force: "KN",
    ...
    for (const ne of b) {
      const B = ne.trim();
      if (!B || B.startsWith(";") || B.startsWith("File ")) continue;
      if (B.startsWith("TABLE:")) {
        const Y = B.match(/TABLE:\s+"(.+?)"/);
      ...
      switch (re) {
        ...
        case "MATERIAL PROPERTIES 02 - BASIC MECHANICAL PROPERTIES": {
          ...
          if (Y) {
            ...
            ue.E = it(D.get("E1")), ue.G = it(D.get("G12")), ue.nu = it(D.get("U12")), ue.density = it(D.get("UnitMass")), H.set(Y, ue);
          }
          break;
        }
        ...
        case "CONNECTIVITY - FRAME": {
          const Y = D.get("Frame"), ue = D.get("JointI"), Me = D.get("JointJ");
          Y && ue && Me && W.push({
            name: Y,
            j1: ue,
            j2: Me
        ...
        case "FRAME SECTION ASSIGNMENTS": {
          const Y = D.get("Frame"), ue = D.get("AnalSect");
          Y && ue && J.set(Y, ue);
          break;
        }
        case "AREA SECTION ASSIGNMENTS": {
          const Y = D.get("Area"), ue = D.get("Section");
          Y && ue && $e.set(Y, ue);
          break;
        }
  ...
  function Zl(e) {
    ...
    for (const re of e) {
      ...
      const B = za(ne), D = ne.split(/\s+/);
      switch (T) {
        case "SYSTEM": {
          const Y = B.get("DOF");
          Y && (O = Y);
          const ue = B.get("LENGTH");
          ue && (b.length = ue);
          const Me = B.get("FORCE");
          Me && (b.force = Me);
          break;
        }
        case "JOINT": {
        ...
        case "RESTRAINT": {
          const Y = B.get("ADD"), ue = B.get("DOF");
          if (Y && ue) {
  ...
  function Aa(e, b, O, M, X, H, Z, V, j, W, he, T) {
    ...
    const re = [], ne = [], B = /* @__PURE__ */ new Map();
    for (const ye of Z) {
    ...
    for (let ye = 0; ye < re.length; ye++) {
      const Ge = B.get(ye), Ye = Ge ? M.get(Ge) : null, be = Ge ? X.get(Ge) : null;
  ...
  function Ql(e) {
    ...
    const { nodes: b, elements: O, nodeInputs: M, elementInputs: X } = e, H = e.units || {
      force: "KN",
      length: "m"
    }, Z = e.title || "Awatif Model", V = [], j = (B) => V.push(B), W = () => V.push(" ");
    ...
    const he = [], T = [];
    if (O.forEach((B, D) => {
      B.length === 2 ? he.push(D) : T.push(D);
    }), he.length > 0) {
      j('TABLE:  "CONNECTIVITY - FRAME"');
      for (const B of he) {
        const D = O[B];
        j(`   Frame=${B + 1}   JointI=${D[0] + 1}   JointJ=${D[1] + 1}   IsCurved=No`);
      }
      W();
    }
    if (T.length > 0) {
      ...
      for (const B of T) {
        const D = O[B], Y = D.map((ue, Me) => `Joint${Me + 1}=${ue + 1}`).join("   ");
        j(`   Area=${B + 1}   NumJoints=${D.length}   ${Y}`);
      }
      W();
    }
    ...
    for (const B of he) {
      const D = ((_a = X.areas) == null ? void 0 : _a.get(B)) || 0, Y = ((_b = X.momentsOfInertiaZ) == null ? void 0 : _b.get(B)) || 0, ue = ((_c = X.momentsOfInertiaY) == null ? void 0 : _c.get(B)) || 0, Me = ((_d = X.torsionalConstants) == null ? void 0 : _d.get(B)) || 0, Ae = ((_e = X.elasticities) == null ? void 0 : _e.get(B)) || 0, Ke = `MAT_${Math.round(Ae)}`, ye = `A${D.toPrecision(6)}_Iz${Y.toPrecision(6)}`;
      if (!J.has(ye)) {
        let Ye = 0.3, be = 0.3;
        D > 0 && Y > 0 && (Ye = Math.sqrt(12 * Y / D), be = D / Ye), J.set(ye, {
          A: D,
          Iz: Y,
          Iy: ue,
          J: Me,
    ...
    if (he.length > 0) {
      ...
      for (const B of he) {
        const D = $e.get(B) || "SEC1";
        j(`   Frame=${B + 1}   AutoSelect=N.A.   AnalSect=${D}   MatProp=Default`);
      }
      W();
    }
    if (J.size > 0) {
      ...
      for (const [, D] of J) {
        B++;
        const Y = D.A * 5 / 6;
        j(`   SectionName=SEC${B}   Material=${D.matKey}   Shape=Rectangular   t3=${Pt(D.h)}   t2=${Pt(D.b)}   Area=${Pt(D.A)}   TorsConst=${Pt(D.J)}   I33=${Pt(D.Iz)}   I22=${Pt(D.Iy)}   I23=0   AS2=${Pt(Y)}   AS3=${Pt(Y)} _`), j("        Color=Blue   FromFile=No   AMod=1   A2Mod=1   A3Mod=1   JMod=1   I2Mod=1   I3Mod=1   MMod=1   WMod=1");
      }
      W();
    }
    const fe = /* @__PURE__ */ new Map(), re = /* @__PURE__ */ new Map();
    for (const B of T) {
      const D = ((_f = X.thicknesses) == null ? void 0 : _f.get(B)) || 0.1, Y = ((_g = X.elasticities) == null ? void 0 : _g.get(B)) || 0, ue = `MAT_${Math.round(Y)}`, Me = `t${D.toPrecision(6)}`;
      fe.has(Me) || fe.set(Me, {
        t: D,
        matKey: ue
      });
    ...
    if (T.length > 0) {
      ...
      for (const D of T) {
        const Y = re.get(D) || "SSEC1";
        j(`   Area=${D + 1}   Section=${Y}   MatProp=Default`);
      }
      W(), j('TABLE:  "AREA SECTION PROPERTIES"');
      let B = 0;
      for (const [, D] of fe) B++, j(`   Section=SSEC${B}   Material=${D.matKey}   MatAngle=0   AreaType=Shell   Type=ShellThin   DrillDOF=Yes   Thickness=${Pt(D.t)}   BendThick=${Pt(D.t)}   Color=Cyan`);
      W();
    }
    j('TABLE:  "JOINT COORDINATES"');
    for (let B = 0; B < b.length; B++) {
      const D = b[B];
      j(`   Joint=${B + 1}   CoordSys=GLOBAL   CoordType=Cartesian   XorR=${Pt(D[0])}   Y=${Pt(D[1])}   Z=${Pt(D[2])}   SpecialJt=No`);
    }
    if (W(), M.supports && M.supports.size > 0) {
      j('TABLE:  "JOINT RESTRAINT ASSIGNMENTS"');
      for (const [B, D] of M.supports) {
        if (!D.some((ue) => ue)) continue;
        const Y = (ue) => ue ? "Yes" : "No";
        j(`   Joint=${B + 1}   U1=${Y(D[0])}   U2=${Y(D[1])}   U3=${Y(D[2])}   R1=${Y(D[3])}   R2=${Y(D[4])}   R3=${Y(D[5])}`);
      }
      W();
    }
    if (j('TABLE:  "LOAD PATTERN DEFINITIONS"'), j("   LoadPat=DEAD   DesignType=Dead   SelfWtMult=0"), W(), j('TABLE:  "LOAD CASE DEFINITIONS"'), j('   Case=DEAD   Type=LinStatic   InitialCond=Zero   DesTypeOpt="Prog Det"   DesignType=Dead   DesActOpt="Prog Det"   DesignAct=Non-Composite   AutoType=None   RunCase=Yes'), W(), j('TABLE:  "CASE - STATIC 1 - LOAD ASSIGNMENTS"'), j('   Case=DEAD   LoadType="Load pattern"   LoadName=DEAD   LoadSF=1'), W(), M.forces && M.forces.size > 0) {
      ...
      for (const [B, D] of M.forces) D.some((Y) => Math.abs(Y) > 1e-12) && j(`   Joint=${B + 1}   LoadPat=DEAD   CoordSys=GLOBAL   F1=${Pt(D[0])}   F2=${Pt(D[1])}   F3=${Pt(D[2])}   M1=${Pt(D[3])}   M2=${Pt(D[4])}   M3=${Pt(D[5])}`);
      W();
    }
    const ne = /* @__PURE__ */ new Map();
    for (let B = 0; B < O.length; B++) {
      const D = ((_h = X.elasticities) == null ? void 0 : _h.get(B)) || 0, Y = ((_i = X.shearModuli) == null ? void 0 : _i.get(B)) || 0, ue = D > 0 && Y > 0 ? Math.max(0, Math.min(0.5, D / (2 * Y) - 1)) : 0.2, Me = ((_j = X.densities) == null ? void 0 : _j.get(B)) || 0, Ae = `MAT_${Math.round(D)}`;
      ne.has(Ae) || ne.set(Ae, {
        E: D,
        nu: ue,
        G: Y,
    ...
    for (const [B] of ne) j(`   Material=${B}   Type=Concrete   SymType=Isotropic   TempDepend=No   Color=Green`);
    W(), j('TABLE:  "MATERIAL PROPERTIES 02 - BASIC MECHANICAL PROPERTIES"');
    for (const [B, D] of ne) j(`   Material=${B}   UnitWeight=${Pt(D.rho * 9.81)}   UnitMass=${Pt(D.rho)}   E1=${Pt(D.E)}   G12=${Pt(D.G)}   U12=${Pt(D.nu)}   A1=9.9E-06`);
    W(), j('TABLE:  "MATERIAL PROPERTIES 03B - CONCRETE DATA"');
    for (const [B] of ne) j(`   Material=${B}   Fc=27579   eFc=27579   LtWtConc=No   SSCurveOpt=Mander   SSHysType=Takeda   SFc=0.00222   SCap=0.005   FinalSlope=-0.1   FAngle=0   DAngle=0`);
...
`);
  ...
  function oi(e) {
    ...
    for (const be of ne) {
      const Te = `Mat_${++D}`;
      B.set(be, Te), W.push(`  MATERIAL  "${Te}"    TYPE "Concrete"    WEIGHTPERVOLUME 2.4`), W.push(`  MATERIAL  "${Te}"    SYMTYPE "Isotropic"  E ${be}  U 0.2  A 1E-05`);
    }
    ...
    O.forEach((be, Te) => {
      ...
      const Ce = (_a2 = X.sectionShapes) == null ? void 0 : _a2.get(Te), Ue = ((_b2 = X.elasticities) == null ? void 0 : _b2.get(Te)) ?? 0, ct = B.get(Ue) || "Mat_1", Ze = (Ce == null ? void 0 : Ce.h) ?? 0, dt = (Ce == null ? void 0 : Ce.b) ?? 0, ut = (Ce == null ? void 0 : Ce.d) ?? 0, Tt = (Ce == null ? void 0 : Ce.tf) ?? 0, Nt = (Ce == null ? void 0 : Ce.tw) ?? 0, Dt = (Ce == null ? void 0 : Ce.type) || "rect", Mt = `${Dt}_${Ze}_${dt}_${ut}_${Tt}_${Nt}`;
      (Ce == null ? void 0 : Ce.name) && !Me.has(Mt) && Me.set(Mt, Ce.name);
      let bt = Me.get(Mt);
      if (bt || (Dt === "rect" ? bt = `R${he(dt * 100)}x${he(Ze * 100)}` : Dt === "circ" ? bt = `C_D${he(ut * 100)}` : Dt === "I" ? bt = `I_${he(Ze * 100)}` : bt = `Sec_${Y.size + 1}`, Me.set(Mt, bt)), ue.set(Te, bt), Y.has(bt)) return;
      Y.add(bt);
      const _e = {
    ...
    O.forEach((be, Te) => {
      ...
      if (Ce === "BEAM") {
        ...
        ye(ct);
        const dt = ye(Ze), ut = he(b[ct][1]), Tt = he(b[Ze][1]), Nt = J.indexOf(ut), Dt = J.indexOf(Tt), Mt = Math.max(1, Dt >= 0 && Nt >= 0 ? Dt - Nt : 1);
    ...
    if (O.forEach((be, Te) => {
      ...
      W.push(`  SHELLPROP  "Losa"  PROPTYPE  "Slab"  MATERIAL "${B.values().next().value || "Mat_1"}"  MODELINGTYPE "ShellThin"  SLABTYPE "Slab"  SLABTHICKNESS ${be} `), W.push("");
    }
    if (Ye.some((be) => be.isWall)) {
      W.push("$ WALL PROPERTIES");
      const be = ((_d = X.thicknesses) == null ? void 0 : _d.values().next().value) ?? 0.2;
      W.push(`  SHELLPROP  "Muro"  PROPTYPE  "Wall"  MATERIAL "${B.values().next().value || "Mat_1"}"  MODELINGTYPE "ShellThick"  WALLTHICKNESS ${be} `), W.push("");
    }
    if (Ye.length > 0) {
      ...
      Ye.forEach((Te, Ce) => {
        ...
        if (ct) {
          ...
          be.push(`  AREAASSIGN  "${Ze}"  "${Dt}"  SECTION "Muro"  OBJMESHTYPE "DEFAULT"  ADDRESTRAINT "Yes"  CARDINALPOINT "MIDDLE"  TRANSFORMSTIFFNESSFOROFFSETS "No"  `);
...
`);
  ...
  function si(e) {
    ...
    return H.push("# OpenSeesPy model exported from Awatif FEM Studio"), H.push(`# ${b.length} nodes, ${O.length} elements`), H.push(""), H.push("import openseespy.opensees as ops"), H.push(""), H.push("ops.wipe()"), H.push("ops.model('basic', '-ndm', 3, '-ndf', 6)"), H.push(""), H.push("# --- Nodes ---"), b.forEach((Z, V) => {
      ...
      const j = b[Z[0]], W = b[Z[1]], T = Math.abs(W[2] - j[2]) > Math.max(Math.abs(W[0] - j[0]), Math.abs(W[1] - j[1])) ? 2 : 1, J = ((_a2 = X.areas) == null ? void 0 : _a2.get(V)) ?? 1, $e = ((_b2 = X.elasticities) == null ? void 0 : _b2.get(V)) ?? 2e5, fe = ((_c = X.shearModuli) == null ? void 0 : _c.get(V)) ?? 8e4, re = ((_d = X.torsionalConstants) == null ? void 0 : _d.get(V)) ?? 1, ne = ((_e = X.momentsOfInertiaY) == null ? void 0 : _e.get(V)) ?? 1, B = ((_f = X.momentsOfInertiaZ) == null ? void 0 : _f.get(V)) ?? 1;
      H.push(`ops.element('elasticBeamColumn', ${V + 1}, ${Z[0] + 1}, ${Z[1] + 1}, ${J}, ${$e}, ${fe}, ${re}, ${ne}, ${B}, ${T})`);
...
`);
  ...
  function ai(e) {
    ...
    return H.push("# OpenSees Tcl model exported from Awatif FEM Studio"), H.push(`# ${b.length} nodes, ${O.length} elements`), H.push(""), H.push("wipe"), H.push("model basic -ndm 3 -ndf 6"), H.push(""), H.push("# --- Nodes ---"), b.forEach((Z, V) => {
      ...
      if (Z.length !== 2) return;
      const j = b[Z[0]], W = b[Z[1]], T = Math.abs(W[2] - j[2]) > Math.max(Math.abs(W[0] - j[0]), Math.abs(W[1] - j[1])) ? 2 : 1, J = ((_a2 = X.areas) == null ? void 0 : _a2.get(V)) ?? 1, $e = ((_b2 = X.elasticities) == null ? void 0 : _b2.get(V)) ?? 2e5, fe = ((_c = X.shearModuli) == null ? void 0 : _c.get(V)) ?? 8e4, re = ((_d = X.torsionalConstants) == null ? void 0 : _d.get(V)) ?? 1, ne = ((_e = X.momentsOfInertiaY) == null ? void 0 : _e.get(V)) ?? 1, B = ((_f = X.momentsOfInertiaZ) == null ? void 0 : _f.get(V)) ?? 1;
      H.push(`element elasticBeamColumn ${V + 1} ${Z[0] + 1} ${Z[1] + 1} ${J} ${$e} ${fe} ${re} ${ne} ${B} ${T}`);
...
`);
  ...
  function li(e) {
    ...
    for (const $e of e.split(/\r?\n/)) {
      ...
      const B = fe.match(/ops\.element\(\s*'elasticBeamColumn'\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)/);
      if (B) {
        const Y = parseInt(B[1]), ue = T.get(parseInt(B[2])), Me = T.get(parseInt(B[3]));
        if (ue !== void 0 && Me !== void 0) {
          const Ae = O.length;
          O.push([
            ue,
            Me
          ]), J.set(Y, Ae), V.set(Ae, parseFloat(B[4])), H.set(Ae, parseFloat(B[5])), Z.set(Ae, parseFloat(B[6])), he.set(Ae, parseFloat(B[7])), j.set(Ae, parseFloat(B[8])), W.set(Ae, parseFloat(B[9]));
        }
        continue;
      }
      const D = fe.match(/ops\.load\(\s*(\d+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)/);
      if (D) {
        const Y = T.get(parseInt(D[1]));
        Y !== void 0 && X.set(Y, [
          parseFloat(D[2]),
          parseFloat(D[3]),
          parseFloat(D[4]),
      ...
      if (fe[0] === "element" && fe[1] === "elasticBeamColumn" && fe.length >= 12) {
        ...
        if (re !== void 0 && ne !== void 0) {
          ...
          O.push([
            re,
            ne
          ]), V.set(B, parseFloat(fe[5])), H.set(B, parseFloat(fe[6])), Z.set(B, parseFloat(fe[7])), he.set(B, parseFloat(fe[8])), j.set(B, parseFloat(fe[9])), W.set(B, parseFloat(fe[10]));
        }
        continue;
      }
  ...
  function Fa(e, b) {
    ...
    if (M && (X = Ca(e, M)), O[0] && O[0] !== "$") {
      ...
      if (H && H.type === "IFCLOCALPLACEMENT") {
        const Z = Fa(e, H), V = gs(X.origin, Z.dirX, ms(Z.dirZ, Z.dirX), Z.dirZ);
        X.origin = [
          Z.origin[0] + V[0],
          Z.origin[1] + V[1],
          Z.origin[2] + V[2]
  ...
  function pi(e) {
    ...
    function W(ne, B, D) {
      for (const Y of X) {
        const ue = Y.x - ne, Me = Y.y - B, Ae = Y.z - D;
    ...
    function he(ne) {
      const B = La(ne.args, 2) || "", D = M.IFCRELASSOCIATESMATERIAL || [];
      for (const ue of D) {
        const Me = O[ue];
        if (!Me) continue;
        const Ae = no(Me.args);
    ...
    function T(ne) {
      const B = ne.type;
      if (B === "IFCRECTANGLEPROFILEDEF") {
        const D = no(ne.args), Y = (D[1] || "").replace(/'/g, ""), ue = parseFloat(D[3]) || 0.3, Me = parseFloat(D[4]) || 0.3;
        return {
          b: ue,
          h: Me,
          name: Y
      ...
      if (B === "IFCMATERIALPROFILE") {
        const D = no(ne.args), Y = D[2] || D[1] || "", ue = Zt(O, Y);
        if (ue) return T(ue);
      }
      if (B === "IFCMATERIALPROFILESET") {
      ...
      if (B === "IFCMATERIALPROFILESETUSAGE") {
    ...
    function J(ne, B, D, Y) {
      ...
      for (const Me of ue) {
        ...
        const dt = Ce ? Ce[0] : Ye.origin[0], ut = Ce ? Ce[1] : Ye.origin[1], Tt = Ce ? Ce[2] : Ye.origin[2], Nt = Ue || (D === "Z" ? Ye.dirZ : Ye.dirX), Dt = W(dt, ut, Tt), Mt = W(dt + Nt[0] * Te, ut + Nt[1] * Te, Tt + Nt[2] * Te);
        H.push({
          id: j++,
          type: "frame",
          nodeIds: [
    ...
    function $e(ne, B, D) {
      ...
      for (const ue of Y) {
        ...
        be && (Ge = fi(O, be) || D);
        const Te = B === "slab" ? `Losa e=${(Ge * 100).toFixed(0)}cm` : B === "wall" ? `Muro e=${(Ge * 100).toFixed(0)}cm` : B === "footing" ? `Zapata e=${(Ge * 100).toFixed(0)}cm` : `${B} e=${(Ge * 100).toFixed(0)}cm`;
        H.push({
          id: j++,
          type: "shell",
          nodeIds: [],
    ...
    for (const ne of re) {
      const B = O[ne];
      if (!B) continue;
      const D = no(B.args), Y = (D[2] || "").replace(/'/g, ""), ue = parseFloat(D[9]) || 0;
      fe.push({
        name: Y,
        elevation: ue
      });
    }
    return fe.sort((ne, B) => ne.elevation - B.elevation), {
      nodes: X,
      elements: H,
      materials: Z,
      levels: fe,
  ...
  async function mi(e, b) {
    ...
    return M.StreamAllMeshes(H, ($e) => {
      ...
      for (let B = 0; B < ne.size(); B++) {
        const D = ne.get(B), Y = M.GetGeometry(H, D.geometryExpressID), ue = M.GetVertexArray(Y.GetVertexData(), Y.GetVertexDataSize()), Me = M.GetIndexArray(Y.GetIndexData(), Y.GetIndexDataSize()), Ae = new co(), Ke = new Float32Array(ue.length / 2), ye = new Float32Array(ue.length / 2);
  ...
  Mi = function(e) {
    ...
    let T = "", J = {}, $e = null, fe = "", re = [], ne = [], B = [], D = /* @__PURE__ */ new Set(), Y = /* @__PURE__ */ new Set(), ue = /* @__PURE__ */ new Set(), Me = /* @__PURE__ */ new Map(), Ae = /* @__PURE__ */ new Map(), Ke = null, ye = [], Ge = 0.2, Ye = 2, be = 2, Te = false, Ce = 2, Ue = "x", ct = /* @__PURE__ */ new Set(), Ze = true, dt = 0.15, ut = 2, Tt = 2, Nt = /* @__PURE__ */ new Set(), Dt = false, Mt = "perimeter";
    const bt = () => ({
      b: 0.3,
      h: 0.4,
      profileIdx: 0,
    ...
    let St = 0, Pe = 3, Be = false, xe = 0, Fe = null, ve = 0, ze = [], Ve = 1, He = true;
    const ft = Pl();
    ...
    function an(t, o, n, l, a) {
      ...
      for (let m = 0; m < t.length; m++) {
        ...
        if (I) {
          const E = -$ - h * 1.5;
          Bn(u, 0, 0, u, 0, E + h, L, Ht), Dn(y[m] || `${m}`, u, 0, E, h, Ht);
        } else {
          const E = p - $ - h * 1.5;
          Bn(u, p, 0, u, E + h, 0, L, Ht), Dn(y[m] || `${m}`, u, E, 0, h, Ht);
        }
      }
      if (!I) for (let m = 0; m < o.length; m++) {
        const u = o[m], E = s - $ - h * 1.5;
        Bn(s, u, 0, E + h, u, 0, L, Ht), Dn(f[m] || `${m}`, E, u, 0, h, Ht);
      }
    ...
    const ot = {
      ...
      build(t) {
        ...
        return e.nodes.val = f, e.elements.val = I, e.nodeInputs.val = {
          ...
          sectionShapes: ke
        }, D = L, Y = z, Me = R, console.log(`Built: ${f.length} nodes, ${I.length} elements (${L.size} cols, ${z.size} beams, ${m.size} braces)`), console.log(`  Col: ${o}, Viga: ${n}, f'c=${l}${k ? `, braces=${k}` : ""}`), {
          nodes: f.length,
          elements: I.length
        };
      },
...
`;
      ...
      model3d(t) {
        ...
        return vs(g, S, $), st(), console.log(`Model3D: ${L.length}n ${R.length}e | ${y}x${f} grid, ${I} floors | COL${a} V${c} f'c=${s}`), {
          nodes: L.length,
          elements: R.length,
          columns: k.size,
          beams: m.size
      ...
      clear() {
        e.nodes.val = [], e.elements.val = [], e.nodeInputs && (e.nodeInputs.val = {}), e.elementInputs && (e.elementInputs.val = {}), D = /* @__PURE__ */ new Set(), Y = /* @__PURE__ */ new Set(), Me = /* @__PURE__ */ new Map(), Ae = /* @__PURE__ */ new Map(), Je = [], Qe = [], mt = 0, ys(), $s(), Jt();
      ...
      building(t, o, n, l = 3, a = 0, c = 0, s = 0, i = 0, p = 1) {
        ...
        for (const { el: [u, E], floor: C } of z) {
          if (p <= 1) {
            D.add(L.length), Me.set(L.length, C), L.push([
              u,
              E
            ]);
            continue;
      ...
      example(t) {
        ...
        switch (t) {
          ...
          case "edificio": {
            nt("edificio"), _e.colMat = 0, _e.vigaMat = 0, _e.colShape = 0, ye = [], Ze = false, Te = false, Dt = false, Ne();
            break;
          }
          case "edif-acero":
          case "edificio-acero": {
            ...
            Ue = o >= n ? "y" : "x", Ze = true, dt = 0.08, Dt = false, Ne();
            break;
          }
          ...
          case "edificio-acero-diag": {
            nt("edificio"), _e.colMat = 1, _e.vigaMat = 1, _e.steelColType = 0, _e.steelVigaType = 0, ye = [], Te = true, Ce = 2;
            const o = re.reduce((l, a) => l + a, 0) / re.length, n = ne.reduce((l, a) => l + a, 0) / ne.length;
            Ue = o >= n ? "y" : "x", Ze = true, dt = 0.08, Dt = true, Mt = "perimeter", Ne();
            break;
          }
          case "edif-muros":
          case "edificio-muros": {
...
Util:     cad.info()  cad.clear()  cad.help()
    ...
    function Ne() {
      ...
      switch (T) {
        ...
        case "edificio": {
          const o = ie("Lvix") || 0, n = ie("Lvdx") || 0, l = ie("Lviy") || 0, a = ie("Lvdy") || 0, c = Math.max(1, Math.round(ie("nSubViga") || 3)), s = Math.max(1, Math.round(ie("nSubCol") || 1)), i = ie("hPiso"), p = B.length > 0 ? [
            ...B
      ...
      if (L === 0) {
        ...
        if (L === 2) {
          ...
          for (let se = 0; se < ke; se++) {
            const we = u[se], De = (m[we[0]][0] + m[we[1]][0] + m[we[2]][0]) / 3, lt = (m[we[0]][1] + m[we[1]][1] + m[we[2]][1]) / 3, et = De >= -z && De <= R && lt >= 0 && lt <= l, vt = De >= 0 && De <= n && lt >= l && lt <= l + t, Bt = et || vt;
          ...
          if (I > 0) {
            ...
            for (let we = 0; we < se.length; we++) {
              ...
              const lt = -I * De, et = C.get(se[we].idx) || [
                0,
                0,
                0,
                0,
    ...
    function Oo(t) {
      const o = bs.find((l) => l.id === X.forceId), n = nn.find((l) => l.id === X.lengthId);
    ...
    function No() {
      ...
      if (!o) return;
      o.style.display = "";
      const n = M, l = Math.round(((_a2 = J.nPisos) == null ? void 0 : _a2.val) ?? 3), a = _a(), c = Ba(), s = re.length || 1, i = ne.length || 1;
          ...
          if (i && J[i]) {
            if (J[i].val = s.value, T === "edificio" && (i === "nVanosX" || i === "nVanosY" || i === "nPisos")) {
              ...
              if (i === "nPisos" || i === "hPiso") {
                ...
                for (; B.length < p; ) B.push(B[B.length - 1] ?? r);
                B.length > p && (B.length = p);
              }
              mo();
            }
            Ne();
      ...
      if (T === "edificio") {
        ...
        if (a) {
          let c = function() {
            ...
            let f = "Z: ";
            for (let h = 0; h < B.length; h++) f += `P${h + 1}=${B[h].toFixed(1)} `;
            i.textContent = $ + `
` + y + `
` + f;
          };
      ...
      window.__cad = {
        ...
        setGenerator: nt,
        createCustomPanel: (a, c, s) => Da(a, c, s),
        removeCustomPanel: (a) => {
          _s(a);
        }
      };
...
`);
    ...
    function cn() {
      ...
      function L() {
        ...
        if (S) {
          ...
          m && m.array.length === f.length ? (m.array.set(f), m.needsUpdate = true) : k.setAttribute("position", new Bo(f.slice(), 3));
        }
        if ($) {
          ...
          m && m.array.length === I.length ? (m.array.set(I), m.needsUpdate = true) : k.setAttribute("position", new Bo(I.slice(), 3));
        }
        if (y) {
          const k = [];
          ...
          if (k.length > 0) {
            ...
            E && E.array.length === u.length ? (E.array.set(u), E.needsUpdate = true) : m.setAttribute("position", new Bo(u, 3));
          }
        }
    ...
    function Jn() {
      ...
      window.__femLog = S, console.log(`FEM Solver: ${t.length}n ${o.length}e \u2192 ${(performance.now() - a).toFixed(0)}ms`), Be && setTimeout(() => Gn(), 50);
    }
    function Vn(t, o) {
    ...
    function To() {
      ...
      if ((T === "edificio" || T === "frame") && D.size > 0) {
        ...
        for (let f = 0; f < t.length; f++) {
          ...
          let z, R, k, m;
          if (h) if (a === 0) R = r, k = d, m = g, z = s === 1 ? Ds(L.dCol) : Vn(L.bCol, L.hCol), n.sectionShapes.set(f, s === 1 ? {
            type: "circ",
            d: L.dCol
          } : {
            type: "rect",
    ...
    window.innerWidth <= 600 && Le.classList.add("collapsed"), setTimeout(() => {
      ...
      function o(x) {
        ...
        if (x === "test-wilson-beam" || x === "test-all") {
          ...
          try {
            const Kt = Ft(et, vt, {
              supports: yt,
              loads: Ct
            }, Bt), jt = Math.abs(((_b2 = (_a3 = Kt.deformations) == null ? void 0 : _a3.get(2)) == null ? void 0 : _b2[1]) ?? 0), at = Math.abs(((_d2 = (_c2 = Kt.deformations) == null ? void 0 : _c2.get(3)) == null ? void 0 : _d2[1]) ?? 0), $t = (jt + at) / 2, Ut = $t / go;
            oe.push({
        ...
        if (x === "test-scordelis" || x === "test-all") {
          ...
          for (const at of yt) {
            const $t = Bt[at[0]], Ut = Bt[at[1]], Rt = Bt[at[2]], fo = Bt[at[3]], ro = [
              Rt[0] - $t[0],
              Rt[1] - $t[1],
              Rt[2] - $t[2]
            ], wo = [
      ...
      function n(x) {
        ...
        if (x.elements.forEach((q, ce) => {
          ...
          const oe = x.nodes[q[0]], pe = x.nodes[q[1]], ee = Math.abs(pe[1] - oe[1]), ge = Math.sqrt((pe[0] - oe[0]) ** 2 + (pe[2] - oe[2]) ** 2), Ie = ee > ge * 0.5, se = de(q[0]), we = de(q[1]), De = Ie ? "COL30" : "VIGA";
...
`);
      ...
      function d(x, w) {
        ...
        <div style="display:flex;gap:8px">
          ...
          for (const oe of w.elements) if (Q.has(oe.category) && oe.type === "frame" && oe.nodeIds.length >= 2) {
            ...
            ke.elasticities.set(q, pe.E), ke.shearModuli.set(q, lt), ke.areas.set(q, Ie), ke.momentsOfInertiaZ.set(q, we), ke.momentsOfInertiaY.set(q, se), ke.torsionalConstants.set(q, De), ke.densities.set(q, pe.rho), ke.sectionShapes.set(q, {
              type: "rect",
              b: ee,
              h: ge,
              name: oe.sectionName
      ...
      function g(x) {
        D = /* @__PURE__ */ new Set(), Y = /* @__PURE__ */ new Set(), Me = /* @__PURE__ */ new Map(), Ae = /* @__PURE__ */ new Map();
        const w = /* @__PURE__ */ new Map();
        ...
        for (let de = 0; de < x.elementTypes.length; de++) {
          ...
          Me.set(de, q), ke === "COLUMN" || ke === "BRACE" ? D.add(de) : Y.add(de);
        }
        T = "edificio";
      ...
      y && (y.value = O, y.addEventListener("change", (x) => {
        ...
        var _a3, _b2;
        x.stopPropagation(), Be = !Be, (_a3 = Le.querySelector("#cad3d-modal")) == null ? void 0 : _a3.classList.toggle("active", Be);
      ...
      h == null ? void 0 : h.addEventListener("mousedown", (x) => x.stopPropagation()), h == null ? void 0 : h.addEventListener("change", () => {
        Be && (Fe == null ? void 0 : Fe.modeShapes) && cn();
      });
...
`);
    ...
    function ts(t) {
      ...
      const c = new co();
      c.setAttribute("position", new Bo(a, 3));
...
${r.join(", ")}`);
    ...
    function Vs(t) {
      ...
      if (Wt && (o.scene.remove(Wt), Wt.geometry.dispose(), Wt.material.dispose(), Wt = null), kt !== null && t.worldPos) {
        ...
        if (Vt === "arc" && lo !== null) {
          ...
          a.setAttribute("position", new Bo(p, 3));
        } else a.setAttribute("position", new Bo([
          l[0],
          l[1],
          l[2],
          t.worldPos.x,
    ...
    function Ka(t) {
      ...
      if (Vt === "arc") {
        ...
        if (o === kt || o === lo) return;
        const n = e.nodes.val, l = new qe(...n[kt]), a = new qe(...n[lo]), c = new qe(...n[o]), s = Math.max(4, Math.round(((_a2 = J.nSubViga) == null ? void 0 : _a2.val) ?? 8)), i = Xs(l, a, c, s);
        Vo();
        const p = [
          ...e.nodes.val
        ], r = [
    ...
    function Us(t) {
      ...
      const c = new co();
      c.setAttribute("position", new Bo(a, 3)), to = new en(c, new tn({
        color: 16776960,
        linewidth: 3,
        depthTest: false
    ...
    function Zs(t) {
      ...
      try {
        if (I = Fn(a, s, t), L = Pn(a), z = uo(hs(L), uo(I, L)), R = c ? [
          "ux\u2080",
          "uy\u2080",
          "uz\u2080",
          "\u03B8x\u2080",
      ...
      `${l[0]}`, 6 * l[0], 6 * l[0] + 5, `${l[1]}`, 6 * l[1], 6 * l[1] + 5, l.length === 3 && (`${l[2]}`, 6 * l[2], 6 * l[2] + 5), o.length * 6, o.length * 6, ao = Dl(t, o, n, s, i, p), ao.id = "fem-inspect-panel", document.body.appendChild(ao), (_N = ao.querySelector("#er-close")) == null ? void 0 : _N.addEventListener("click", () => _o()), (_O = ao.querySelector("#rel-apply")) == null ? void 0 : _O.addEventListener("click", () => {
    ...
    function ra() {
      ...
      for (let Se = 0; Se < q; Se++) for (let We = 0; We < De - 1; We++) oe.push([
        et[Se][We],
        et[Se][We + 1]
      ]), yt.push("vig"), Ct++;
      oe.length;
      for (let Se = 0; Se < De; Se++) for (let We = 0; We < q - 1; We++) oe.push([
        et[We][Se],
        et[We + 1][Se]
      ]), yt.push("corr"), Ct++;
      oe.length;
      for (let Se = 0; Se < q - 1; Se++) for (let We = 0; We < De - 1; We++) oe.push([
        et[Se][We],
        et[Se + 1][We],
        et[Se + 1][We + 1],
        et[Se][We + 1]
      ...
      for (let Se = 0; Se < q; Se++) for (let We = 0; We < De; We++) {
        let Et;
    ...
    setTimeout(() => {
      ...
      var _a2, _b;
      if (t === void 0 && (t = !Be), Be = t, (_a2 = Le.querySelector("#cad3d-modal")) == null ? void 0 : _a2.classList.toggle("active", Be), Be) {
        const n = tt();
