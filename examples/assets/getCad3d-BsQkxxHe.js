const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./calcPanel-BcV0bfdm.js","./getMesh-B1dmlgUt.js","./__vite-browser-external-D7Ct-6yo.js","./pureFunctionsAny.generated-JAcEVsJ7.js","./analyze-ClLKGn9k.js","./didacticCpp-BGUxSkhs.js","./tutorialPanel-DFygt7Wm.js","./i18n-B_HPMgm2.js","./cyclicPushoverCpp-Xwxa7wee.js"])))=>i.map(i=>d[i]);
...
`);
      ...
      y && (y.value = O, y.addEventListener("change", (x) => {
        ...
        x.stopPropagation(), cs(async () => {
          const { openTutorialPanel: w } = await import("./tutorialPanel-DFygt7Wm.js").then(async (m2) => {
            await m2.__tla;
            return m2;
          });
          return {
