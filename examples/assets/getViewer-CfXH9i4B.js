import { H as ct, B as L, I as dt, F as K, G as U, h as Yt, a as et, j as Q, D as O, e as D, C as G, l as Bt, i as Rt, V as E, A as tt, z as q, J as yt, d as It, L as nt, c as $, r as ht, K as ut, R as Lt, f as kt, N as Zt, U as Wt, X as St, Y as rt, Z as Ht, _ as _t, t as $t, u as Gt, v as qt, W as Nt, w as Kt, x as Ut, y as At, O as Dt } from "./Text-CBH-tcJP.js";
...
function Jt(t, e, r) {
  ...
  if (o.setAttribute("id", "settings"), (e == null ? void 0 : e.nodes) && (n.addBinding(t.displayScale, "val", { label: "Display scale", min: 1, max: 500, step: 1 }), n.addBinding(t.nodes, "val", { label: "Nodes" }), n.addBinding(t.elements, "val", { label: "Elements" }), n.addBinding(t.elemColumns, "val", { label: "  Columnas" }), n.addBinding(t.elemBeams, "val", { label: "  Vigas" }), n.addBinding(t.nodesIndexes, "val", { label: "Nodes indexes" }), n.addBinding(t.elementsIndexes, "val", { label: "Elements indexes" }), n.addBinding(t.orientations, "val", { label: "Orientations" }), n.addBinding(t.sections, "val", { label: "Sections" }), n.addBinding(t.secColumns, "val", { label: "  Sec. Columnas" }), n.addBinding(t.secBeams, "val", { label: "  Sec. Vigas" }), n.addBinding(t.secFloor, "val", { label: "  Sec. Piso", options: { Todos: -1, "Piso 1": 0, "Piso 2": 1, "Piso 3": 2, "Piso 4": 3, "Piso 5": 4 } })), (e == null ? void 0 : e.nodeInputs) || (e == null ? void 0 : e.elementInputs)) {
    const l = n.addFolder({ title: "Analysis Inputs" });
    l.addBinding(t.supports, "val", { label: "Supports" }), l.addBinding(t.loads, "val", { label: "Loads" });
  }
  if ((e == null ? void 0 : e.deformOutputs) || (e == null ? void 0 : e.analyzeOutputs)) {
    const l = n.addFolder({ title: "Analysis Outputs" });
    l.addBinding(t.nodeResults, "val", { options: { none: "none", deformations: "deformations", reactions: "reactions" }, label: "Node results" }), l.addBinding(t.frameResults, "val", { options: { none: "none", normals: "normals", shearsY: "shearsY", shearsZ: "shearsZ", torsions: "torsions", bendingsY: "bendingsY", bendingsZ: "bendingsZ", "contour:normals": "contour:normals", "contour:shearsY": "contour:shearsY", "contour:shearsZ": "contour:shearsZ", "contour:torsions": "contour:torsions", "contour:bendingsY": "contour:bendingsY", "contour:bendingsZ": "contour:bendingsZ" }, label: "Frame results" }), l.addBinding(t.shellResults, "val", { options: { none: "none", bendingXX: "bendingXX", bendingYY: "bendingYY", bendingXY: "bendingXY", membraneXX: "membraneXX", membraneYY: "membraneYY", membraneXY: "membraneXY", shearX: "tranverseShearX", shearY: "tranverseShearY", vonMises: "vonMises", displacementX: "displacementX", displacementY: "displacementY", displacementZ: "displacementZ" }, label: "Shell results" }), l.addBinding(t.deformedShape, "val", { label: "Deformed shape" });
  }
...
function jt(t, e, r) {
  ...
  return pt((l, c) => {
    ...
    r.val;
    const l = 0.05 * t.gridSize.val * 0.5;
    t.nodes.rawVal && (n.material.size = l * r.rawVal);
  }), F.derive(() => {
    n.visible = t.nodes.val;
  }), n;
}
function te(t, e, r) {
  const o = j(), n = new U(), l = new Yt(new L(), new et({ color: o.elementLine }));
  pt((w, V) => {
    l.material.color.setHex(V.elementLine);
  ...
  let p = new G(o.shellWall), M = new G(o.shellSlab), y = new G(o.shellTri);
  pt((w, V) => {
    p = new G(V.shellWall), M = new G(V.shellSlab), y = new G(V.shellTri), c.opacity = V.shellOpacity, c.needsUpdate = true;
  });
  function b(w, V) {
  ...
  return F.derive(() => {
    ...
    const w = e.elemColumns.rawVal, V = e.elemBeams.rawVal, S = r.val, X = ((_a = t.elements) == null ? void 0 : _a.val) || [], k = X.filter((C) => {
    ...
    l.geometry.setAttribute("position", new K(k, 3));
    const B = [], Y = [];
    function P(C, m, x, d) {
    ...
    for (const C of X) if (C.length === 3) {
      ...
      if (S[m] && S[x] && S[d]) {
        B.push(...S[m], ...S[x], ...S[d]);
        for (let s = 0; s < 3; s++) Y.push(y.r, y.g, y.b);
      }
    } else if (C.length === 4) {
      const [m, x, d, s] = C;
      if (S[m] && S[x] && S[d] && S[s]) {
        const a = P(S[m], S[x], S[d], S[s]) ? p : M;
...
function ne(t, e, r, o) {
  const n = new U(), l = new Rt(0.5, 0.5, 0.5), c = new Q({ color: 10166822 });
  return F.derive(() => {
    var _a, _b;
    if (e.deformedShape.val, !e.supports.val) return;
    n.clear();
    const i = 0.05 * e.gridSize.val * 0.6;
    (_b = (_a = t.nodeInputs) == null ? void 0 : _a.val.supports) == null ? void 0 : _b.forEach((p, M) => {
      const y = r.val[M];
      if (!y) return;
      const b = new D(l, c);
      b.position.set(...y);
    ...
    n.children.forEach((M) => M.scale.set(p, p, p));
  }), F.derive(() => {
...
function oe(t, e, r, o) {
  ...
  return F.derive(() => {
    ...
    const c = r.val, i = l(c);
    (_c = (_b = (_a = t.nodeInputs) == null ? void 0 : _a.val) == null ? void 0 : _b.loads) == null ? void 0 : _c.forEach((p, M) => {
      const y = c[M];
      if (!y) return;
      const b = new E(...p.slice(0, 3));
      if (b.lengthSq() < 1e-30) return;
      b.normalize();
      const w = new tt(b, new E(...y), 1, 15637248, 0.3, 0.3), V = i * o.rawVal;
      w.scale.set(V, V, V), n.add(w);
    });
  }), F.derive(() => {
    if (o.val, !e.loads.rawVal) return;
    const i = l(r.rawVal) * o.rawVal;
...
function se(t, e, r) {
  ...
  return F.derive(() => {
    ...
    e.val.forEach((l, c) => {
      const i = new q(`${c}`);
      i.position.set(...l), i.updateScale(n * r.rawVal), o.add(i);
    });
  }), F.derive(() => {
    if (r.val, !t.nodesIndexes.rawVal) return;
    const n = 0.05 * t.gridSize.val * 0.6;
    o.children.forEach((l) => l.updateScale(n * r.rawVal));
  }), F.derive(() => {
...
function ie(t, e, r, o) {
  ...
  return F.derive(() => {
    ...
    (_a = t.elements) == null ? void 0 : _a.val.forEach((c, i) => {
      ...
      p.position.set(...ae(c.map((M) => r.rawVal[M]))), p.updateScale(l * o.rawVal), n.add(p);
    });
  }), F.derive(() => {
...
function re(t, e) {
  const r = new U(), o = 0.05 * t * 1, n = j(), l = new q("X", "red", "transparent"), c = new q(e ? "Z" : "Y", "green", "transparent"), i = new q(e ? "Y" : "Z", "blue", "transparent"), p = new tt(new E(1, 0, 0), new E(0, 0, 0), 1, n.axisArrow, 0.2, 0.2), M = new tt(new E(0, 1, 0), new E(0, 0, 0), 1, n.axisArrow, 0.2, 0.2), y = new tt(new E(0, 0, 1), new E(0, 0, 0), 1, n.axisArrow, 0.2, 0.2);
  return l.position.set(1.3 * o, 0, 0), c.position.set(0, 1.3 * o, 0), i.position.set(0, 0, 1.3 * o), l.updateScale(0.4 * o), c.updateScale(0.4 * o), i.updateScale(0.4 * o), p.scale.set(o, o, o), M.scale.set(o, o, o), y.scale.set(o, o, o), r.add(p, M, y, l, c, i), r;
}
function Ft(t, e) {
  const r = new E(...t), n = new E(...e).clone().sub(r), l = n.length(), c = n.dot(new E(1, 0, 0)) / l, i = n.dot(new E(0, 1, 0)) / l, p = n.dot(new E(0, 0, 1)) / l, M = Math.sqrt(c ** 2 + i ** 2);
  let y = new yt().fromArray([[c, i, p], [-i / M, c / M, 0], [-c * p / M, -i * p / M, M]].flat());
...
function le(t, e, r) {
  const o = ot([e, r]), n = ot([t, r]), l = ot([t, e]), c = new E(...o).sub(new E(...n)).normalize(), i = new E(...r).sub(new E(...l)).normalize(), p = c.clone().cross(i).normalize(), M = p.clone().cross(c).normalize();
  return new It().makeBasis(c, M, p);
}
function ce(t, e, r, o) {
  const n = new U(), l = new L(), c = new et({ vertexColors: true }), i = [0, 0, 0], p = [1, 0, 0], M = [0, 1, 0], y = [0, 0, 1];
  l.setAttribute("position", new K([...i, ...p, ...i, ...M, ...i, ...y], 3));
  const b = [255, 0, 0], w = [0, 255, 0], V = [0, 0, 255];
  return l.setAttribute("color", new K([...b, ...b, ...w, ...w, ...V, ...V], 3)), F.derive(() => {
    var _a;
    e.deformedShape.val, e.orientations.val && (n.clear(), (_a = t.elements) == null ? void 0 : _a.val.forEach((S) => {
      const X = new Yt(l, c), k = r.rawVal[S[0]], B = r.rawVal[S[1]];
      if (S.length === 2 && (X.position.set(...gt(k, B)), X.rotation.setFromRotationMatrix(Ft(k, B))), S.length === 3) {
        const C = r.rawVal[S[2]];
...
function he(t, e, r, o) {
  ...
  return F.derive(() => {
    ...
    d.forEach((h, f) => {
      ...
      const g = r.rawVal[h[0]], A = r.rawVal[h[1]];
      if (!g || !A) return;
      const I = C(g, A);
      if (I && !m || !I && !x) return;
      if (u >= 0) {
      ...
      if (v.type === "CFT") {
        const T = M(v.b, v.h, v.tw ?? v.b * 0.05), W = new D(T.concFill, k);
        ...
        switch (v.type) {
          ...
          case "HSS":
            ...
            break;
          case "CFT":
            T = M(v.b, v.h, v.tw ?? v.b * 0.05), W = Y, H = P;
            break;
          case "L":
            T = y(v.b ?? v.h, v.h, v.t ?? v.tw ?? 3e-3), W = Y, H = P;
            break;
          case "2L":
...
class lt extends U {
  constructor(e, r, o, n, l, c, i) {
    super();
    const p = new ht().moveTo(0, 0).lineTo(0, c[1]).lineTo(o, c[1]).lineTo(o, 0).lineTo(0, 0), M = p.getPoints(), y = new L().setFromPoints(M);
    ...
    this.mesh = new D(b, w), this.mesh.position.set(...e), this.mesh.rotation.setFromRotationMatrix(n), i && this.mesh.rotateX(Math.PI / 2), this.add(this.mesh), this.text = new q(`${l[1].toFixed(4)}`), this.normalizedResult = c, this.textPosition = ot([e, r]), this.text.position.set(...this.textPosition), this.text.rotation.setFromRotationMatrix(n), this.add(this.text);
  }
  updateScale(e) {
...
class Pt extends U {
  constructor(e, r, o, n, l, c, i) {
    super();
    const p = l[0] * o / (l[0] + l[1]), M = l[0] * l[1] > 0;
    if (this.text = new q(`${l[0].toFixed(4)}`), this.text2 = new q(`${(l[1] * -1).toFixed(4)}`), this.normalizedResult = c, this.textPosition = gt(e, r), this.text2Position = gt(r, e), this.text.position.set(...this.textPosition), this.text2.position.set(...this.text2Position), this.text.rotation.setFromRotationMatrix(n), this.text2.rotation.setFromRotationMatrix(n), this.add(this.text, this.text2), M) {
      const y = new ht().moveTo(0, 0).lineTo(0, c[0]).lineTo(p, 0).lineTo(0, 0), b = new ht().moveTo(p, 0).lineTo(o, -c[1]).lineTo(o, 0).lineTo(p, 0), w = y.getPoints(), V = b.getPoints(), S = new L().setFromPoints(w), X = new L().setFromPoints(V), k = new et({ color: j().resultOutline });
      ...
      const B = new ut(y), Y = new ut(b), P = new Q({ color: c[0] > 0 ? 24435 : 11411474, side: O }), C = new Q({ color: -c[1] > 0 ? 24435 : 11411474, side: O });
      ...
      const y = new ht().moveTo(0, 0).lineTo(0, c[0]).lineTo(o, -c[1]).lineTo(o, 0).lineTo(0, 0), b = y.getPoints(), w = new L().setFromPoints(b);
      ...
      const V = new ut(y), S = new Q({ color: c[0] > 0 ? 24435 : 11411474, side: O });
...
function ue(t, e, r, o) {
  const n = new U(), l = { normals: lt, shearsY: lt, shearsZ: lt, torsions: lt, bendingsY: Pt, bendingsZ: Pt };
  return F.derive(() => {
    var _a, _b;
    ...
    (_b = (_a = t.analyzeOutputs) == null ? void 0 : _a.rawVal[c]) == null ? void 0 : _b.forEach((i, p) => {
      var _a2, _b2;
      const M = ((_a2 = t.elements) == null ? void 0 : _a2.rawVal[p]) ?? [0, 1], y = r.rawVal[M[0]], b = r.rawVal[M[1]], w = new E(...b).distanceTo(new E(...y)), V = pe((_b2 = t.analyzeOutputs) == null ? void 0 : _b2.rawVal[c]), S = i == null ? void 0 : i.map((Y) => Y / (V === 0 ? 1 : V)), X = Ft(y, b), k = new l[c](y, b, w, X, i ?? [0, 0], S ?? [0, 0], !!["normals", "shearsZ", "torsions", "bendingsY"].includes(c)), B = 0.05 * e.gridSize.rawVal;
...
function fe(t, e, r, o) {
  ...
  return F.derive(() => {
    ...
    n.children.forEach((i) => i.dispose()), n.clear();
    const l = Ct[e.nodeResults.rawVal], c = 0.05 * e.gridSize.val;
    (_b = (_a = t.deformOutputs) == null ? void 0 : _a.val[l]) == null ? void 0 : _b.forEach((i, p) => {
      const M = new me(r.rawVal[p], l, i ?? [0, 0, 0, 0, 0, 0]);
      M.updateScale(c * o.rawVal), n.add(M);
    });
  }), F.derive(() => {
    if (o.val, e.nodeResults.rawVal == "none") return;
    const l = 0.05 * e.gridSize.val;
    n.children.forEach((c) => c.updateScale(l * o.rawVal));
  }), F.derive(() => {
    n.visible = e.nodeResults.val != "none";
  }), n;
}
function we({ drawingObj: t, gridObj: e, scene: r, camera: o, controls: n, gridSize: l, derivedDisplayScale: c, rendererElm: i, viewerRender: p }) {
  const M = new Lt(), y = new kt(), b = new D(new Zt(l, l), new Q({ side: O })), w = new ct(new L(), new dt()), V = new ct(new L(), new dt({ color: "gray" })), S = new ct(new L(), new dt({ color: "orange", size: 0.8 }));
  r.add(S), w.geometry.setAttribute("position", new K(t.points.rawVal.flat(), 3)), w.geometry.computeBoundingSphere(), w.frustumCulled = false, V.frustumCulled = false, r.add(V), b.position.set(0.5 * l, 0.5 * l, 0), b.rotateX(Math.PI / 2), b.geometry.rotateX(Math.PI / 2), b.updateMatrixWorld(), t.polylines && (t.polylines.val = [...t.polylines.rawVal, []]), F.derive(() => {
    ...
    const P = 0.05 * l * 0.5 * c.val;
    V.material.size = P, M.params.Points.threshold = 0.4 * P;
  }), F.derive(() => {
    var _a;
  ...
  i.addEventListener("pointerdown", () => {
    ...
    k = 0, y.x = P.clientX / window.innerWidth * 2 - 1, y.y = -(P.clientY / window.innerHeight) * 2 + 1, M.setFromCamera(y, o);
    const C = M.intersectObject(b);
    if (C.length) {
      let m = C[0].point;
    ...
    y.x = P.clientX / window.innerWidth * 2 - 1, y.y = -(P.clientY / window.innerHeight) * 2 + 1, M.setFromCamera(y, o);
    const C = M.intersectObject(b);
    ...
    y.x = P.clientX / window.innerWidth * 2 - 1, y.y = -(P.clientY / window.innerHeight) * 2 + 1, M.setFromCamera(y, o);
    let C = false;
    const m = M.intersectObject(w), x = M.intersectObject(b);
...
function ve(t, e, r) {
  const l = Math.round(14.999999999999998), c = { position: t.position.clone(), quaternion: t.quaternion.clone() }, i = setInterval(M, 1e3 / 30);
  let p = 0;
  function M() {
    p++;
    const y = p / l;
    t.position.lerpVectors(c.position, e.position, y), t.quaternion.slerpQuaternions(c.quaternion, e.quaternion, y), r && r(), p == l && clearInterval(i);
  }
}
class Et {
  constructor(e, r = 32) {
  ...
  setColorMap(e, r = 32) {
    this.map = Mt[e] || Mt.rainbow, this.n = r;
    const o = 1 / this.n, n = new G(), l = new G();
    this.lut.length = 0, this.lut.push(new G(this.map[0][1]));
    for (let c = 1; c < r; c++) {
      const i = c * o;
      for (let p = 0; p < this.map.length - 1; p++) if (i > this.map[p][0] && i <= this.map[p + 1][0]) {
        const M = this.map[p][0], y = this.map[p + 1][0];
        n.setHex(this.map[p][1], rt), l.setHex(this.map[p + 1][1], rt);
        const b = new G().lerpColors(n, l, (i - M) / (y - M));
        this.lut.push(b);
      }
    }
  ...
  updateCanvas(e) {
    ...
    let l = 0;
    const c = 1 / this.n, i = new G(), p = new G(), M = new G();
    for (let y = 1; y >= 0; y -= c) for (let b = this.map.length - 1; b >= 0; b--) if (y < this.map[b][0] && y >= this.map[b - 1][0]) {
      ...
      i.setHex(this.map[b - 1][1], rt), p.setHex(this.map[b][1], rt), M.lerpColors(i, p, (y - w) / (V - w)), n[l * 4] = Math.round(M.r * 255), n[l * 4 + 1] = Math.round(M.g * 255), n[l * 4 + 2] = Math.round(M.b * 255), n[l * 4 + 3] = 255, l += 1;
    }
...
function xe(t, e, r) {
  const o = new Et(), n = new G(), l = new D(new L(), new Q({ side: O, vertexColors: true }));
  return o.setColorMap("rainbow"), l.renderOrder = -1, l.frustumCulled = false, F.derive(() => {
    l.geometry.setAttribute("position", new K(t.val.flat(), 3));
    const c = [];
    for (const i of e.val) i.length === 3 ? c.push(i[0], i[1], i[2]) : i.length === 4 && (c.push(i[0], i[1], i[2]), c.push(i[0], i[2], i[3]));
    l.geometry.setIndex(new _t(c, 1)), l.geometry.setAttribute("color", new K(t.val.map(() => [0, 0, 0]).flat(), 3)), o.setMax(Math.max(...r.val)), o.setMin(Math.min(...r.val));
    for (let i = 0; i < r.val.length; i++) {
      const p = o.getColor(r.val[i]) ?? new G(0, 0, 0);
      n.copy(p).convertSRGBToLinear(), n.multiplyScalar(0.6), l.geometry.attributes.color.setXYZ(i, n.r, n.g, n.b);
    }
  }), l;
}
function ye(t, e, r, o) {
...
function Ce(t, e, r, o) {
  ...
  return F.derive(() => {
    ...
    for (const { idx: f, vals: g } of S) {
      const A = M[f], I = p[A[0]], v = p[A[1]];
      if (!I || !v) continue;
      const z = new E(v[0] - I[0], v[1] - I[1], v[2] - I[2]), R = z.length();
      if (R < 1e-10) continue;
      z.normalize();
      const Z = Math.abs(z.y) < 0.99 ? new E(0, 1, 0) : new E(1, 0, 0), T = new E().crossVectors(z, Z).normalize(), W = new E().crossVectors(z, T).normalize(), H = bt + 1, _ = Me;
      for (let N = 0; N < H; N++) {
        const J = N / bt, st = I[0] + z.x * R * J, it = I[1] + z.y * R * J, mt = I[2] + z.z * R * J, ft = g[0] + (g[1] - g[0]) * J, at = l.getColor(ft) ?? new G(0, 0, 0);
...
function Tt(t, e = 8) {
  ...
  let n, l;
  o.forEach((i, p) => {
    n = document.createElement("div"), n.id = `marker-${p}`, n.className = "marker", n.style.marginTop = p == 0 ? "0px" : `calc(${50 / e}vh - 1px)`, l = document.createElement("p"), l.id = `marker-text-${p}`, n.append(l), r.append(n);
  });
  const c = [];
  return r.querySelectorAll("p").forEach((i) => c.push(i)), setTimeout(() => {
    F.derive(() => {
      o.forEach((i, p) => {
        const M = c[p];
        M && (M.innerText = Ve(t.val, i).toString());
      });
    });
  }), r;
}
function Ve(t, e) {
  const r = Math.max(...t) - Math.min(...t);
  return (Math.min(...t) + e * r).toPrecision(3);
}
function Ye({ mesh: t, settingsObj: e, drawingObj: r, objects3D: o, solids: n }) {
  Dt.DEFAULT_UP = new E(0, 0, 1);
  const l = document.createElement("div"), c = new $t(), i = new Gt(45, 1, 0.1, 2 * 1e6), p = new qt(-10, 10, 10, -10, -1e3, 2e6);
  let M = i;
  const y = new Nt({ antialias: true });
  y.localClippingEnabled = true;
  const b = new Kt(i, y.domElement), w = Ot(e), V = F.derive(() => w.displayScale.val === 0 ? 1 : w.displayScale.val > 0 ? w.displayScale.val : -1 / w.displayScale.val), S = Se(t, w);
  let X = zt(w.gridSize.rawVal);
  l.appendChild(Jt(w, t, n)), l.setAttribute("id", "viewer"), l.appendChild(y.domElement), y.setPixelRatio(window.devicePixelRatio);
  const k = j();
  ...
  i.position.set(0.5 * B, 0.8 * -Y, 0.5 * B), b.target.set(0.5 * B, 0.5 * B, 0), b.minDistance = 1, b.maxDistance = Y * 2.5, b.zoomSpeed = 10, b.update(), c.add(X, re(w.gridSize.rawVal, w.flipAxes.rawVal)), new ResizeObserver((d) => {
    ...
    for (const s of d) {
      ...
      const h = a / u, f = p.top;
      p.left = -f * h, p.right = f * h, p.updateProjectionMatrix(), y.setSize(a, u), C();
    }
  }).observe(l), b.addEventListener("change", C), F.derive(() => {
    var _a, _b, _c, _d, _e, _f;
  ...
  }), r && we({ drawingObj: r, gridObj: X, scene: c, camera: i, controls: b, gridSize: B, derivedDisplayScale: V, rendererElm: y.domElement, viewerRender: C }), pt((d, s) => {
    y.setClearColor(s.background, 1), c.remove(X), X.geometry.dispose(), X.material.dispose(), X = zt(w.gridSize.rawVal), c.add(X), l.style.setProperty("--awatif-legend-color", s.legendMarker), C();
  });
  const x = { scene: c, perspCamera: i, orthoCamera: p, get camera() {
    return M;
  }, controls: b, renderer: y, rendererElm: y.domElement, render: C, setActiveCamera: m, settings: w };
  return l.__ctx = x, l;
}
function Se(t, e) {
  return F.derive(() => {
    ...
    const l = ((_e = e.displayScale) == null ? void 0 : _e.val) ?? 1;
    return r.map((c, i) => {
      var _a2;
      const p = ((_a2 = o.get(i)) == null ? void 0 : _a2.slice(0, 3)) ?? [0, 0, 0];
      return c.map((M, y) => M + p[y] * l);
    });
  });
}
function Ae(t, e) {
  ...
  return ((n) => {
    ...
    const n = /* @__PURE__ */ new Map(), l = /* @__PURE__ */ new Map(), c = /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), V = (k, B) => {
      k == null ? void 0 : k.forEach((Y, P) => {
        const C = t.elements.val[P];
        if (C) for (let m = 0; m < C.length; m++) B.set(C[m], [Y[m] ?? Y[0]]);
      });
    };
    V((_b = (_a = t.analyzeOutputs) == null ? void 0 : _a.val) == null ? void 0 : _b.bendingXX, n), V((_d = (_c = t.analyzeOutputs) == null ? void 0 : _c.val) == null ? void 0 : _d.bendingYY, l), V((_f = (_e = t.analyzeOutputs) == null ? void 0 : _e.val) == null ? void 0 : _f.bendingXY, c), V((_h = (_g = t.analyzeOutputs) == null ? void 0 : _g.val) == null ? void 0 : _h.membraneXX, i), V((_j = (_i = t.analyzeOutputs) == null ? void 0 : _i.val) == null ? void 0 : _j.membraneYY, p), V((_l = (_k = t.analyzeOutputs) == null ? void 0 : _k.val) == null ? void 0 : _l.membraneXY, M), V((_n = (_m = t.analyzeOutputs) == null ? void 0 : _m.val) == null ? void 0 : _n.tranverseShearX, y), V((_p = (_o = t.analyzeOutputs) == null ? void 0 : _o.val) == null ? void 0 : _p.tranverseShearY, b), V((_r = (_q = t.analyzeOutputs) == null ? void 0 : _q.val) == null ? void 0 : _r.vonMises, w);
    const S = { bendingXX: [n, 0], bendingYY: [l, 0], bendingXY: [c, 0], membraneXX: [i, 0], membraneYY: [p, 0], membraneXY: [M, 0], tranverseShearX: [y, 0], tranverseShearY: [b, 0], vonMises: [w, 0], displacementX: [(_t2 = (_s = t.deformOutputs) == null ? void 0 : _s.val) == null ? void 0 : _t2.deformations, 0], displacementY: [(_v = (_u = t.deformOutputs) == null ? void 0 : _u.val) == null ? void 0 : _v.deformations, 1], displacementZ: [(_x = (_w = t.deformOutputs) == null ? void 0 : _w.val) == null ? void 0 : _x.deformations, 2] }, X = [];
