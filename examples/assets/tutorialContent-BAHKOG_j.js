...
% para carga puntual en cantilever`, en: `% =========================================
...
% for point load on cantilever` } }, { id: "assembly", title: { es: "Ensamblaje Global", en: "Global Assembly" }, desc: { es: "Ensamblaje de 3 barras en un truss, mapeo de GDL local a global.", en: "Assembly of 3 bars in a truss, local-to-global DOF mapping." }, code: { es: `% =========================================
...
% es aproximada pero muy precisa`, en: `% =========================================
...
% approximate but very accurate` } }, { id: "beam_3d", title: { es: "Elemento Viga 3D", en: "3D Beam Element" }, desc: { es: "Viga 12 GDL, coeficientes de la K local, K_global = T'*K_local*T.", en: "12 DOF beam, local K coefficients, K_global = T'*K_local*T." }, code: { es: `% =========================================
...
nu = E / (2*G) - 1
nu` } }, { id: "shell_q4", title: { es: "Elemento Shell Q4", en: "Shell Q4 Element" }, desc: { es: "Funciones de forma bilineales, rigidez de membrana, integracion de Gauss 2x2.", en: "Bilinear shape functions, membrane stiffness, 2x2 Gauss integration." }, code: { es: `% =========================================
...
% single column (factor ~4)` } }, { id: "modal_analysis", title: { es: "Analisis Modal", en: "Modal Analysis" }, desc: { es: "Problema de eigenvalores K*phi=w2*M*phi, masas consistente y concentrada.", en: "Eigenvalue problem K*phi=w2*M*phi, consistent and lumped mass." }, code: { es: `% =========================================
...
sum_eig
tr_A` } }, { id: "releases", title: { es: "Releases (Articulaciones)", en: "Moment Releases" }, desc: { es: "Condensacion estatica para extremos articulados, efecto en rigidez.", en: "Static condensation for pinned ends, effect on stiffness." }, code: { es: `% =========================================
...
% la restriccion del elemento`, en: `% =========================================
...
% element's constraint` } }, { id: "property_modifiers", title: { es: "Modificadores de Propiedades", en: "Property Modifiers" }, desc: { es: "Inercia agrietada Icr, factores ACI, efecto en drift.", en: "Cracked inertia Icr, ACI factors, effect on drift." }, code: { es: `% =========================================
