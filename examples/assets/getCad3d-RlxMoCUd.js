...
import { d as kt, _ as ea, p as Un, m as Va, s as Ua, __tla as __tla_0 } from "./didacticCpp-BGUxSkhs.js";
import { v as Jo, P as on, g as Xa, a as Ka, o as Za } from "./theme-CzzIlc4y.js";
import { G as sn, b as Qa, M as ta, D as oa, B as to, c as xn, d as el, C as tl, e as ca, V as Oe, P as Io, R as na, f as sa, g as Wo, h as Go, i as ol, S as nl, j as sl, F as Lo, a as Yo, L as Co, k as al, l as ll, A as dn, T as Xn, m as pn, n as fn, o as rl, p as il } from "./Text-CBH-tcJP.js";
...
let __tla = Promise.all([
  ...
  function Ro(e, g) {
    const R = os.find((j) => j.id === e), M = Vo.find((j) => j.id === g), J = R.toKN, B = M.toM, U = (j, ge, T) => T / (Math.pow(J, j) * Math.pow(B, ge));
    let Y, H;
    switch (e) {
      case "kN":
        Y = 10, H = [
...
`));
  ...
  const Fe = 64516e-8, N = 416231e-12, oe = 0.0254, ko = [
    {
      name: "W6x9",
      type: "W",
      A: 2.68 * Fe,
  ...
  function ul(e) {
    ...
    T += '<button class="rpt-close" id="rpt-close">\u2715 Close</button>', T += "<h1>Finite Element Analysis \u2014 Step-by-Step Report</h1>", T += '<div class="rpt-subtitle">Complete FEM derivation from element formulation to final results</div>', T += '<hr class="rpt-sep"/>', T += "<h2>1. Input Data</h2>", T += '<table class="rpt-info"><tbody>', T += `<tr><td>Number of nodes</td><td class="val">${g.length}</td></tr>`, T += `<tr><td>Number of elements</td><td class="val">${Y} (${H} frames, ${j} shells)</td></tr>`, T += '<tr><td>DOFs per node</td><td class="val">6 (u<sub>x</sub>, u<sub>y</sub>, u<sub>z</sub>, \u03B8<sub>x</sub>, \u03B8<sub>y</sub>, \u03B8<sub>z</sub>)</td></tr>', T += `<tr><td>Total DOFs</td><td class="val">${U}</td></tr>`, T += "</tbody></table>", T += "<h3>1.1 Node Coordinates</h3>", T += '<table class="rpt-data"><thead><tr><th>Node</th><th>x</th><th>y</th><th>z</th></tr></thead><tbody>', g.forEach((re, te) => {
      T += `<tr><td>${te}</td><td>${nt(re[0])}</td><td>${nt(re[1])}</td><td>${nt(re[2])}</td></tr>`;
      ...
      var _a2, _b2, _c2, _d2;
      const q = re.length === 2, D = re.map((ve) => g[ve]), G = q ? Po(xo(D[1], D[0])) : 0, de = ((_a2 = M.elasticities) == null ? void 0 : _a2.get(te)) ?? 0, $e = ((_b2 = M.areas) == null ? void 0 : _b2.get(te)) ?? 0, Te = ((_c2 = M.momentsOfInertiaZ) == null ? void 0 : _c2.get(te)) ?? 0, Ve = ((_d2 = M.momentsOfInertiaY) == null ? void 0 : _d2.get(te)) ?? 0;
      T += `<tr><td>${te}</td><td>${q ? "Frame" : "Shell"}</td><td>${re.join(" \u2192 ")}</td>`, T += `<td>${nt(G)}</td><td>${nt(de)}</td><td>${nt($e)}</td><td>${nt(Te)}</td><td>${nt(Ve)}</td></tr>`;
    ...
    for (let re = 0; re < Y; re++) {
      ...
      const G = Po(xo(q[1], q[0])), de = ((_a = M.elasticities) == null ? void 0 : _a.get(re)) ?? 0, $e = ((_b = M.areas) == null ? void 0 : _b.get(re)) ?? 0, Te = ((_c = M.momentsOfInertiaZ) == null ? void 0 : _c.get(re)) ?? 0, Ve = ((_d = M.momentsOfInertiaY) == null ? void 0 : _d.get(re)) ?? 0, ve = ((_e = M.shearModuli) == null ? void 0 : _e.get(re)) ?? 0, Be = ((_f = M.torsionalConstants) == null ? void 0 : _f.get(re)) ?? 0;
      let He = null, be = null, Ee = null;
      try {
        He = vn(q, M, re), be = yn(q), Ee = no(ns(be), no(He, be));
      } catch {
        continue;
      }
      const ze = xo(q[1], q[0]), Je = ze[0] / G, st = ze[1] / G, Ue = ze[2] / G;
      T += '<div class="rpt-elem-block">', T += `<h3 class="rpt-elem-title" data-toggle="elem${re}">\u25B6 Element ${re} \u2014 Nodes ${te[0]} \u2192 ${te[1]}, L = ${nt(G)}</h3>`, T += `<div id="rpt-elem${re}" class="rpt-elem-body" style="display:none">`, T += "<h4>Properties (numerical substitution)</h4>", T += '<div class="rpt-eq-small">', T += `E = ${nt(de)} &nbsp;&nbsp; A = ${nt($e)} &nbsp;&nbsp; I<sub>z</sub> = ${nt(Te)} &nbsp;&nbsp; I<sub>y</sub> = ${nt(Ve)} &nbsp;&nbsp; G = ${nt(ve)} &nbsp;&nbsp; J = ${nt(Be)}<br/>`, T += `EA/L = ${nt(de)}\xB7${nt($e)}/${nt(G)} = <b>${nt(de * $e / G)}</b><br/>`, T += `12EI<sub>z</sub>/L\xB3 = 12\xB7${nt(de)}\xB7${nt(Te)}/${nt(G)}\xB3 = <b>${nt(12 * de * Te / G ** 3)}</b><br/>`, T += `12EI<sub>y</sub>/L\xB3 = 12\xB7${nt(de)}\xB7${nt(Ve)}/${nt(G)}\xB3 = <b>${nt(12 * de * Ve / G ** 3)}</b><br/>`, T += `GJ/L = ${nt(ve)}\xB7${nt(Be)}/${nt(G)} = <b>${nt(ve * Be / G)}</b>`, T += "</div>", T += "<h4>Direction cosines</h4>", T += `<div class="rpt-eq-small">l = ${gn(Je)}, m = ${gn(st)}, n = ${gn(Ue)}, D = ${gn(Math.sqrt(Je ** 2 + st ** 2))}</div>`, T += "<h4>K<sub>local</sub> (12\xD712)</h4>", T += Kn(He, 12), T += "<h4>T \u2014 Transformation (12\xD712)</h4>", T += Kn(be, 12), T += "<h4>K<sub>global</sub> = T\u1D40 \xB7 K<sub>local</sub> \xB7 T</h4>", T += Kn(Ee, 12), T += "<h4>Assembly</h4>", T += `<div class="rpt-eq-small">Global DOFs: node ${te[0]} \u2192 [${te[0] * 6}..${te[0] * 6 + 5}], node ${te[1]} \u2192 [${te[1] * 6}..${te[1] * 6 + 5}]</div>`, T += "</div></div>";
    }
    ...
    if (T += "<h3>6.2 Reactions</h3>", T += '<div class="rpt-eq">R = K<sub>total</sub> \xB7 u (extract at fixed DOFs)</div>', B == null ? void 0 : B.reactions) {
      ...
      T += "</tr></thead><tbody>", B.reactions.forEach((re, te) => {
        T += `<tr><td>${te}</td>`, re.forEach((q) => {
          const D = Math.abs(q) > 1e-10;
          T += `<td class="${D ? "nz-react" : ""}">${D ? nt(q, 4) : "0"}</td>`;
        }), T += "</tr>";
      }), T += "</tbody></table>";
    }
  ...
  let Mn = false, Oo = null, lo = null, Bt = null, Tt = null;
  function El() {
  ...
  function Sl() {
    Mn = true, Tt && (Tt.innerHTML = "\u2715", Tt.style.background = "linear-gradient(135deg, #cc3333, #ff4444)", Tt.style.animation = "none"), Oo = document.createElement("div"), Oo.id = "tour-overlay", Oo.style.cssText = `
    position: fixed; inset: 0; z-index: 9999990;
    pointer-events: none;
  `, document.body.appendChild(Oo), Uo(0);
  }
  function ss() {
    Mn = false, Tt && (Tt.innerHTML = "?", Tt.style.background = "linear-gradient(135deg, #0066cc, #0099ff)", Tt.style.animation = "helpPulse 2s infinite"), lo && (lo.remove(), lo = null), Bt && (Bt.remove(), Bt = null), Oo && (Oo.remove(), Oo = null);
  }
  function Uo(e) {
    var _a, _b;
    if (e >= nn.length) {
    ...
    const g = nn[e], R = document.querySelector(g.selector);
    if (!R) {
      Uo(e + 1);
      return;
    }
  ...
  `, document.body.appendChild(Bt), (_a = Bt.querySelector("#tour-next")) == null ? void 0 : _a.addEventListener("click", () => {
    ...
    const te = (q) => {
      ...
      (q.key === "ArrowRight" || q.key === "Enter") && (Uo(e + 1), document.removeEventListener("keydown", te)), q.key === "ArrowLeft" && (Uo(Math.max(0, e - 1)), document.removeEventListener("keydown", te)), q.key === "Escape" && (ss(), document.removeEventListener("keydown", te));
    };
    ...
    R.forEach((be, Ee) => {
      ...
      if (ze === "BEAM") {
        ...
        for (let ut = 0; ut < gt; ut++) {
          const ro = Ft - ut;
          ro >= 0 && ro < ye.length && Be.push(`  LINEASSIGN  "E${Ee + 1}"  "${ye[ro]}"  SECTION "${Je}"  MINNUMSTA 3 AUTOMESH "YES"  MESHATINTERSECTIONS "YES"  `);
        }
      }
...
`);
  ...
  async function Yl(e, g) {
    ...
    return M.StreamAllMeshes(B, (ye) => {
      ...
      for (let q = 0; q < te.size(); q++) {
        const D = te.get(q), G = M.GetGeometry(B, D.geometryExpressID), de = M.GetVertexArray(G.GetVertexData(), G.GetVertexDataSize()), $e = M.GetIndexArray(G.GetIndexData(), G.GetIndexDataSize()), Te = new to(), Ve = new Float32Array(de.length / 2), ve = new Float32Array(de.length / 2);
        for (let ze = 0; ze < de.length; ze += 6) {
          const Je = ze / 2;
          Ve[Je] = de[ze], Ve[Je + 1] = de[ze + 1], Ve[Je + 2] = de[ze + 2], ve[Je] = de[ze + 3], ve[Je + 1] = de[ze + 4], ve[Je + 2] = de[ze + 5];
        }
        Te.setAttribute("position", new xn(Ve, 3)), Te.setAttribute("normal", new xn(ve, 3)), Te.setIndex(new xn(new Uint32Array($e), 1));
        const Be = new el();
  ...
  er = function(e) {
    ...
    function as(t, o, n, l, s) {
      ...
      const a = Math.min(...t), r = Math.max(...t), p = Math.min(...o), i = Math.max(...o), c = Math.max(...n), b = r - a || 1, S = i - p || 1, $ = 3359829, y = 2241348;
      for (const h of n) {
        for (const I of o) {
      ...
      for (const h of n) for (const I of t) for (const A of o) {
        const z = [
          ...
          new Oe(I, h, A - f),
          new Oe(I, h, A + f)
        ], P = new to().setFromPoints(z), k = new Yo({
          color: 5596791,
          transparent: true,
          opacity: 0.4
        }), m = new Go(P, k);
    ...
    function Xo(t, o, n, l, s) {
      ...
      const a = Math.min(...t), r = Math.max(...t), p = Math.min(...o), i = Math.max(...o), c = r - a || 1, b = i - p || 1, S = Math.max(c, b), $ = S * 0.08, y = l || t.map((m, u) => String.fromCharCode(65 + u)), f = s || o.map((m, u) => String(u + 1)), h = S * 0.018, I = o.length <= 1, A = 8947848;
      for (let m = 0; m < t.length; m++) {
        const u = t[m];
        if (I) {
          const E = -$ - h * 1.5;
          In(u, 0, 0, u, 0, E + h, A, Pt), kn(y[m] || `${m}`, u, 0, E, h, Pt);
        } else {
          const E = p - $ - h * 1.5;
          In(u, p, 0, u, E + h, 0, A, Pt), kn(y[m] || `${m}`, u, E, 0, h, Pt);
        }
      }
      if (!I) for (let m = 0; m < o.length; m++) {
        const u = o[m], E = a - $ - h * 1.5;
        In(a, u, 0, E + h, u, 0, A, Pt), kn(f[m] || `${m}`, E, u, 0, h, Pt);
      }
      const z = h * 1.8, P = $ * 1.2, k = $ * 1.2;
      for (let m = 0; m < t.length - 1; m++) {
        const u = t[m], E = t[m + 1], L = Math.abs(E - u), O = (u + E) / 2, W = `${L.toFixed(2)} m`;
        I ? (En(W, O, 0, -P, z, Pt), Sn(u, 0, -P * 0.7, E, 0, -P * 0.7, 16763904, Pt)) : (En(W, O, p - k, 0, z, Pt), Sn(u, p - k * 0.7, 0, E, p - k * 0.7, 0, 16763904, Pt));
      }
      if (!I) for (let m = 0; m < o.length - 1; m++) {
        const u = o[m], E = o[m + 1], L = Math.abs(E - u), O = (u + E) / 2, W = `${L.toFixed(2)} m`;
        En(W, a - P, O, 0, z, Pt), Sn(a - P * 0.7, u, 0, a - P * 0.7, E, 0, 16763904, Pt);
      }
      Pt.traverse((m) => {
    ...
    function wn(t, o, n) {
      ...
      const s = Math.min(...o), d = Math.max(...o), a = Math.min(...n), r = Math.max(...n), p = d - s || 1, i = r - a || 1, c = Math.max(p, i), b = c * 0.06, S = n.length <= 1, $ = 4491519, y = c * 0.015;
      for (const f of t) {
        const h = f.elev;
        S ? (Ko(s - b, 0, h, d + b, 0, h, $, Gt), is(f.name, d + b * 1.5, 0, h, y, Gt)) : (Ko(s, a, h, d, a, h, $, Gt), Ko(d, a, h, d, r, h, $, Gt), Ko(d, r, h, s, r, h, $, Gt), Ko(s, r, h, s, a, h, $, Gt), is(f.name, s - b * 1.5, a, h, y, Gt));
      }
      Gt.traverse((f) => {
    ...
    function Ko(t, o, n, l, s, d, a, r) {
      const p = Math.sqrt((l - t) ** 2 + (s - o) ** 2 + (d - n) ** 2) || 1, i = new to().setFromPoints([
        new Oe(t, o, n),
        new Oe(l, s, d)
      ]), c = new Wo({
        color: a,
    ...
    function is(t, o, n, l, s, d) {
      ...
      $.position.set(o, n, l), $.scale.set(s * 8, s, 1), $.renderOrder = 101, d.add($);
    }
    function En(t, o, n, l, s, d) {
      ...
      $.position.set(o, n, l);
      const y = r / p;
      $.scale.set(s * y, s, 1), $.renderOrder = 999, d.add($);
    }
    ...
    function kn(t, o, n, l, s, d) {
      ...
      const S = s * 2;
      b.scale.set(S, S, 1), b.renderOrder = 100, d.add(b);
    }
    const Ze = {
      addNode(t, o, n) {
        const l = [
        ...
        return l.push([
          ...
          o,
          n
        ]), e.nodes.val = l, console.log(`Node ${s} at (${t}, ${o}, ${n})`), Qe(), s;
      },
      removeNode(t) {
        const o = [
          ...e.nodes.val
      ...
      build(t) {
        ...
        const o = (t == null ? void 0 : t.col) || "40x40", n = (t == null ? void 0 : t.viga) || "30x40", l = (t == null ? void 0 : t.fc) || 210, [s, d] = o.split("x").map((_) => parseFloat(_) / 100), [a, r] = n.split("x").map((_) => parseFloat(_) / 100), p = We.map((_) => _.coord), i = Xe.map((_) => _.coord), c = lt.map((_) => _.elev), b = p.length, S = i.length, $ = c.length, y = $ - 1, f = [], h = {};
        for (let _ = 0; _ < $; _++) for (let ue = 0; ue < S; ue++) for (let ne = 0; ne < b; ne++) h[`${ne},${ue},${_}`] = f.length, f.push([
          p[ne],
          i[ue],
          c[_]
        ]);
        const I = [], A = /* @__PURE__ */ new Set(), z = /* @__PURE__ */ new Set(), P = /* @__PURE__ */ new Map();
        for (let _ = 0; _ < y; _++) for (let ue = 0; ue < S; ue++) for (let ne = 0; ne < b; ne++) {
          const fe = I.length;
          I.push([
            h[`${ne},${ue},${_}`],
            h[`${ne},${ue},${_ + 1}`]
        ...
        for (let _ = 1; _ < $; _++) for (let ue = 0; ue < S; ue++) for (let ne = 0; ne < b - 1; ne++) {
          const fe = I.length;
          I.push([
            h[`${ne},${ue},${_}`],
            h[`${ne + 1},${ue},${_}`]
        ...
        for (let _ = 1; _ < $; _++) for (let ue = 0; ue < b; ue++) for (let ne = 0; ne < S - 1; ne++) {
          const fe = I.length;
          I.push([
            h[`${ue},${ne},${_}`],
            h[`${ue},${ne + 1},${_}`]
            ...
            if (_) for (let fe = 0; fe < S; fe++) {
              ...
              for (let me = 0; me < b - 1; me++) {
                ...
                I.push([
                  h[`${me},${fe},${ne}`],
                  h[`${me + 1},${fe},${ne + 1}`]
                ]), m.add(we), P.set(we, ne);
                const se = I.length;
                I.push([
                  h[`${me + 1},${fe},${ne}`],
                  h[`${me},${fe},${ne + 1}`]
                ]), m.add(se), P.set(se, ne);
              }
            }
        ...
        const u = 15100 * Math.sqrt(l) * 10, E = u / (2 * (1 + 0.2)), L = s * d, O = s * d ** 3 / 12, W = d * s ** 3 / 12, x = s * d * (s ** 2 + d ** 2) / 12, w = a * r, v = a * r ** 3 / 12, F = r * a ** 3 / 12, X = a * r * (a ** 2 + r ** 2) / 12, V = /* @__PURE__ */ new Map(), ae = /* @__PURE__ */ new Map(), Q = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Map(), pe = /* @__PURE__ */ new Map(), ce = /* @__PURE__ */ new Map(), Ie = /* @__PURE__ */ new Map();
        ...
        return e.nodes.val = f, e.elements.val = I, e.nodeInputs.val = {
          ...
          sectionShapes: Ie
        }, D = A, G = z, $e = P, console.log(`Built: ${f.length} nodes, ${I.length} elements (${A.size} cols, ${z.size} beams, ${m.size} braces)`), console.log(`  Col: ${o}, Viga: ${n}, f'c=${l}${k ? `, braces=${k}` : ""}`), {
          nodes: f.length,
          elements: I.length
        };
      },
      addCol(t, o, n) {
        ...
        const i = (y) => {
          const f = r.findIndex((h) => Math.abs(h[0] - d) < 1e-3 && Math.abs(h[1] - a) < 1e-3 && Math.abs(h[2] - y) < 1e-3);
          return f >= 0 ? f : (r.push([
            d,
            a,
            y
          ...
          length: lt.length - 1
        }, (y, f) => f + 1), b = new Map(((_d = (_c = e.nodeInputs) == null ? void 0 : _c.val) == null ? void 0 : _d.supports) || []), S = i(lt[0].elev);
        b.has(S) || b.set(S, [
          true,
          true,
          true,
        ...
        for (const y of c) {
          ...
          const f = i(lt[y - 1].elev), h = i(lt[y].elev);
          p.push([
            f,
            h
      ...
      addBeam(t, o, n, l, s) {
        var _a2;
        const d = We.findIndex((P) => P.label === t), a = Xe.findIndex((P) => P.label === o), r = We.findIndex((P) => P.label === n), p = Xe.findIndex((P) => P.label === l), i = lt.findIndex((P) => P.label === s);
        if (d < 0 || a < 0 || r < 0 || p < 0) {
        ...
        const c = We[d].coord, b = Xe[a].coord, S = We[r].coord, $ = Xe[p].coord, y = lt[i].elev, f = [
          ...e.nodes.val
        ], h = [
          ...((_a2 = e.elements) == null ? void 0 : _a2.val) || []
        ], I = (P, k, m) => {
        ...
        return h.push([
          A,
          z
        ]), G.add(h.length - 1), $e.set(h.length - 1, i - 1), e.nodes.val = f, e.elements.val = h, console.log(`Added beam ${t}-${o} \u2192 ${n}-${l} at ${s}`), h.length - 1;
      },
      addBrace(t, o, n, l, s, d) {
        var _a2;
        const a = We.findIndex((u) => u.label === t), r = Xe.findIndex((u) => u.label === o), p = lt.findIndex((u) => u.label === n), i = We.findIndex((u) => u.label === l), c = Xe.findIndex((u) => u.label === s), b = lt.findIndex((u) => u.label === d);
        if (a < 0 || r < 0 || p < 0) {
        ...
        const S = We[a].coord, $ = Xe[r].coord, y = lt[p].elev, f = We[i].coord, h = Xe[c].coord, I = lt[b].elev, A = [
          ...e.nodes.val
        ], z = [
          ...((_a2 = e.elements) == null ? void 0 : _a2.val) || []
        ], P = (u, E, L) => {
        ...
        return z.push([
          k,
          m
        ]), $e.set(z.length - 1, Math.min(p, b)), e.nodes.val = A, e.elements.val = z, console.log(`Added brace ${t}-${o}@${n} \u2192 ${l}-${s}@${d}`), z.length - 1;
      },
      help() {
        return `=== CLI Commands ===
MODEL:
...
`;
      ...
      model3d(t) {
        ...
        const o = (t == null ? void 0 : t.bx) || [
          ...
          3,
          3
        ], s = (t == null ? void 0 : t.col) || "40x40", d = (t == null ? void 0 : t.viga) || "30x40", a = (t == null ? void 0 : t.fc) || 210, [r, p] = s.split("x").map((ee) => parseFloat(ee) / 100), [i, c] = d.split("x").map((ee) => parseFloat(ee) / 100), b = [
          0
        ];
        ...
        const y = b.length, f = S.length, h = $.length, I = l.length, A = [], z = {};
        for (let ee = 0; ee < h; ee++) for (let me = 0; me < f; me++) for (let we = 0; we < y; we++) z[`${we},${ee},${me}`] = A.length, A.push([
          b[we],
          $[ee],
          S[me]
        ]);
        const P = [], k = /* @__PURE__ */ new Set(), m = /* @__PURE__ */ new Set(), u = /* @__PURE__ */ new Map();
        for (let ee = 0; ee < I; ee++) for (let me = 0; me < f; me++) for (let we = 0; we < y; we++) {
          const se = P.length;
          P.push([
            z[`${we},${ee},${me}`],
            z[`${we},${ee + 1},${me}`]
        ...
        for (let ee = 1; ee < h; ee++) for (let me = 0; me < f; me++) for (let we = 0; we < y - 1; we++) {
          const se = P.length;
          P.push([
            z[`${we},${ee},${me}`],
            z[`${we + 1},${ee},${me}`]
        ...
        for (let ee = 1; ee < h; ee++) for (let me = 0; me < y; me++) for (let we = 0; we < f - 1; we++) {
          const se = P.length;
          P.push([
            z[`${me},${ee},${we}`],
            z[`${me},${ee},${we + 1}`]
        ...
        const L = 15100 * Math.sqrt(a) * 10, O = L / (2 * (1 + 0.2)), W = r * p, x = r * p ** 3 / 12, w = p * r ** 3 / 12, v = r * p * (r ** 2 + p ** 2) / 12, F = i * c, X = i * c ** 3 / 12, V = c * i ** 3 / 12, ae = i * c * (i ** 2 + c ** 2) / 12, Q = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Map(), pe = /* @__PURE__ */ new Map(), ce = /* @__PURE__ */ new Map(), Ie = /* @__PURE__ */ new Map(), Pe = /* @__PURE__ */ new Map(), _ = /* @__PURE__ */ new Map();
        ...
        e.nodes.val = A, e.elements.val = P, e.nodeInputs.val = {
          ...
          label: `${me + 1}`,
          coord: ee
        })), pt = $[$.length - 1], Xo(We.map((ee) => ee.coord), Xe.map((ee) => ee.coord), pt, We.map((ee) => ee.label), Xe.map((ee) => ee.label));
        {
          const ee = $.map((me, we) => ({
            name: we === 0 ? "Base" : `P${we}`,
        ...
        const ne = Le.querySelector("#cad3d-axis-buttons");
        if (ne) {
          ...
          for (const we of me) ne.innerHTML += `<button class="axis-btn" data-axis="y" data-label="${we}">${we}</button>`;
        }
        ...
        return as(b, S, $), Qe(), console.log(`Model3D: ${A.length}n ${P.length}e | ${y}x${f} grid, ${I} floors | COL${s} V${d} f'c=${a}`), {
          nodes: A.length,
          elements: P.length,
          columns: k.size,
          beams: m.size
      ...
      frame(t, o, n = 0, l = 0) {
        ...
        const p = (y) => n > 0 && y === 0 || l > 0 && y === s.length - 1, i = {}, c = [];
        for (let y = 0; y < a.length; y++) for (let f = 0; f < s.length; f++) y === 0 && p(f) || (i[`${f},${y}`] = c.length, c.push([
          s[f],
          0,
          a[y]
        ]));
        ...
        for (let y = 0; y < a.length - 1; y++) for (let f = 0; f < s.length; f++) p(f) || (D.add(b.length), b.push([
          i[`${f},${y}`],
          i[`${f},${y + 1}`]
        ]));
        for (let y = 1; y < a.length; y++) for (let f = 0; f < s.length - 1; f++) G.add(b.length), b.push([
          i[`${f},${y}`],
          i[`${f + 1},${y}`]
        ]);
      ...
      building(t, o, n, l = 3, s = 0, d = 0, a = 0, r = 0, p = 1) {
        Ze.clear();
        const i = [];
        ...
        const S = (u) => s > 0 && u === 0 || d > 0 && u === i.length - 1, $ = (u) => a > 0 && u === 0 || r > 0 && u === c.length - 1, y = (u, E) => S(u) || $(E), f = [], h = {};
        for (let u = 0; u < b.length; u++) for (let E = 0; E < c.length; E++) for (let L = 0; L < i.length; L++) u === 0 && y(L, E) || (h[`${L},${E},${u}`] = f.length, f.push([
          i[L],
          c[E],
          b[u]
        ]));
        ...
        const z = [];
        for (let u = 0; u < b.length - 1; u++) for (let E = 0; E < c.length; E++) for (let L = 0; L < i.length; L++) y(L, E) || z.push({
          el: [
            h[`${L},${E},${u}`],
            h[`${L},${E},${u + 1}`]
          ],
        ...
        Te = /* @__PURE__ */ new Map();
        const P = [];
        for (let u = 1; u < b.length; u++) for (let E = 0; E < c.length; E++) for (let L = 0; L < i.length - 1; L++) P.push({
          el: [
            h[`${L},${E},${u}`],
            h[`${L + 1},${E},${u}`]
          ],
        ...
        for (let u = 1; u < b.length; u++) for (let E = 0; E < i.length; E++) for (let L = 0; L < c.length - 1; L++) P.push({
          el: [
            h[`${E},${L},${u}`],
            h[`${E},${L + 1},${u}`]
          ],
        ...
        if (st = /* @__PURE__ */ new Set(), Ee && ze > 0) {
          ...
          for (let E = 1; E < b.length; E++) if (Je === "x") for (let L = 0; L < c.length - 1; L++) {
            const O = c[L], W = c[L + 1];
            for (let x = 1; x <= ze; x++) {
            ...
            for (let x = 1; x <= ze; x++) {
              const w = O + x / (ze + 1) * (W - O), v = [];
              for (let F = 0; F < c.length; F++) v.push(u(w, c[F], b[E]));
        ...
        for (let u = 0; u < c.length; u++) for (let E = 0; E < i.length; E++) y(E, u) || k.set(h[`${E},${u},0`], [
          ...m
        ]);
        de = /* @__PURE__ */ new Set();
        for (const u of ve) {
          ...
          for (const O of L) {
            ...
            const Q = be, K = He, pe = f[F], ce = f[V], Ie = f[X], Pe = f[ae], _ = [];
            for (let ue = 0; ue <= K; ue++) {
              ...
              for (let ee = 0; ee <= Q; ee++) {
                ...
                ue === 0 && ee === 0 ? ne.push(F) : ue === 0 && ee === Q ? ne.push(V) : ue === K && ee === 0 ? ne.push(X) : ue === K && ee === Q ? ne.push(ae) : (ne.push(f.length), f.push([
                  we,
                  se,
                  Se
                ]));
            ...
            for (let ue = 0; ue < K; ue++) for (let ne = 0; ne < Q; ne++) {
              const fe = _[ue][ne], ee = _[ue][ne + 1], me = _[ue + 1][ne + 1], we = _[ue + 1][ne], se = A.length;
        ...
        if (zt = /* @__PURE__ */ new Set(), Ue) {
          ...
          for (let W = 1; W < b.length; W++) {
            const x = b[W];
            for (let w = 0; w < i.length - 1; w++) for (let v = 0; v < c.length - 1; v++) {
              const F = i[w], X = i[w + 1], V = c[v], ae = c[v + 1], Q = [];
              for (let K = 0; K <= E; K++) {
                const pe = [];
      ...
      galpon(t = 12, o = 20, n = 6, l = 3, s = 8, d = 4) {
        Ze.clear();
        const a = [], r = [], p = ($) => n + l * (1 - Math.pow(2 * $ / t - 1, 2)), i = [], c = d + 1;
        for (let $ = 0; $ < c; $++) {
          const y = [], f = o / d * $;
        ...
        for (let $ = 0; $ < d; $++) for (let y = 2; y < i[0].length; y++) r.push([
          i[$][y],
          i[$ + 1][y]
        ]);
        for (let $ = 0; $ < d; $++) for (let y = 2; y < i[0].length - 1; y += 2) r.push([
          i[$][y],
          i[$ + 1][y + 1]
        ]);
        const b = /* @__PURE__ */ new Map(), S = mt();
        for (let $ = 0; $ < c; $++) b.set(i[$][0], [
          ...S
        ]), b.set(i[$][1], [
          ...S
        ]);
      ...
      example(t) {
        ...
        switch (t) {
          case "truss": {
            Ne.colMat = 1, Ne.vigaMat = 1, Ze.clear(), et("truss"), ps();
            break;
          }
          case "beams": {
            Ne.colMat = 0, Ne.vigaMat = 0, Ne.colShape = 0, Ze.clear(), et("beams"), fs();
            break;
          }
          case "3d":
          case "3d-structure":
          case "torre": {
            Ne.colMat = 1, Ne.vigaMat = 1, Ze.clear(), et("3d"), us();
            break;
          }
          case "portico": {
          ...
          case "edificio-acero": {
            ...
            const o = re.reduce((l, s) => l + s, 0) / re.length, n = te.reduce((l, s) => l + s, 0) / te.length;
          ...
          case "plate-q4":
          case "placa-q4": {
            Ze.clear(), et("placa-q4"), bs();
            break;
          }
          case "losa-rect":
          case "rectangular-slab": {
            Ze.clear(), et("losa-rect"), gs();
            break;
          }
          case "losa-plana":
          case "flat-slab": {
            Ze.clear(), et("losa-plana"), hs();
            break;
          }
          case "viga-alta":
          case "deep-beam": {
            Ze.clear(), et("viga-alta"), xs();
            break;
          }
          case "muro-contencion":
          case "retaining-wall": {
            Ze.clear(), et("muro-contencion"), vs();
            break;
          }
          case "zapata":
          case "footing": {
            Ze.clear(), et("zapata"), ys();
            break;
          }
          case "placa-orificios":
          case "plate-holes":
          case "placa-base": {
            Ze.clear(), et("placa-orificios"), $s();
            break;
          }
          case "col-placa":
          case "columna-placa": {
            Ze.clear(), et("col-placa"), Ms();
            break;
          }
          case "talud":
          case "slope": {
            Ze.clear(), et("talud"), ws();
            break;
          }
          case "eiffel":
          case "torre-eiffel": {
            Ze.clear(), et("eiffel"), _s();
            break;
          }
          case "arco":
          case "arco-gateway": {
          ...
          case "puente-colgante": {
            Ze.clear(), et("puente"), Bs();
            break;
          }
          case "twisted":
          case "torre-twisted":
          case "turning-torso": {
            Ze.clear(), et("twisted"), Hs();
            break;
          }
          case "burj":
          case "burj-khalifa": {
          ...
          case "opera":
          case "sydney-opera": {
            Ze.clear(), et("opera"), Ws();
            break;
          }
          case "diagrid":
          case "gherkin": {
            Ze.clear(), et("diagrid"), Gs();
            break;
          }
          case "muro-q4":
          case "shear-wall":
          case "muro-cantilever": {
            Ze.clear(), et("muro-q4"), Vn();
            break;
          }
          case "viga-q4":
          case "cantilever-beam":
          case "viga-cantilever": {
            Ze.clear(), et("viga-q4"), Ys();
            break;
          }
          case "placa-xz":
          case "placa-cantilever":
          case "losa-cantilever": {
            Ze.clear(), et("placa-xz"), Js();
            break;
          }
          default:
      ...
      plateQ4(t = 10, o = 10, n = 16, l = 16, s = "simply-supported", d = -10, a = 0.2, r = 3e7, p = 0.3, i = 0) {
      ...
      set(t, o) {
        Z[t] ? (Z[t].val = o, console.log(`${t} = ${o}`), so(), Re()) : ft[t] ? (ft[t].val = o, console.log(`${t} = ${o}`), so(), Re()) : console.error(`Par\xE1metro "${t}" no encontrado. Disponibles: ${Object.keys({
          ...Z,
          ...ft
        }).join(", ")}`);
      },
      get(t) {
        if (!t) {
          ...
          o.plateTheory = Ce, o.supportType = xt;
          const n = un()[T];
...
Util:     cad.info()  cad.clear()  cad.help()
      ...
      units(t, o) {
        t && (g = t), o && (R = o), M = Ro(g, R);
        const n = Le.querySelector("#cad3d-force-unit"), l = Le.querySelector("#cad3d-length-unit");
        return n && (n.textContent = g), l && (l.textContent = R), T && et(T), console.log(`Unidades: ${M.label} | E=${M.E.toExponential(3)} ${M.stress}`), M.id;
      },
      view(t) {
      },
      get mesh() {
    ...
    function Re() {
      ...
      switch (T) {
        ...
        case "edificio": {
          const o = le("Lvix") || 0, n = le("Lvdx") || 0, l = le("Lviy") || 0, s = le("Lvdy") || 0, d = Math.max(1, Math.round(le("nSubViga") || 3)), a = Math.max(1, Math.round(le("nSubCol") || 1)), r = le("hPiso"), p = q.length > 0 ? [
            ...q
        ...
        case "galpon":
          Ze.galpon(le("span"), le("length"), le("height"), le("archRise"), Math.round(le("xDiv")), Math.round(le("yDiv")));
          break;
        case "barra":
          xa();
          break;
      ...
      if (![
        ...
        if (U.size > 0 || Y.size > 0 || H) {
          const o = e.elements.val, n = o.filter((l, s) => !(U.has(s) || Y.has(s) || H && !j.has(s)));
          if (n.length !== o.length) {
            const l = /* @__PURE__ */ new Set();
            n.forEach((d) => d.forEach((a) => l.add(a)));
            const s = e.nodes.val;
            if (l.size < s.length) {
              const d = [
                ...l
              ].sort((p, i) => p - i), a = /* @__PURE__ */ new Map();
              d.forEach((p, i) => a.set(p, i)), e.nodes.val = d.map((p) => s[p]), n.forEach((p, i) => {
                n[i] = p.map((c) => a.get(c) ?? c);
              });
              const r = (_a2 = e.nodeInputs) == null ? void 0 : _a2.val;
              if (r == null ? void 0 : r.supports) {
                const p = /* @__PURE__ */ new Map();
                r.supports.forEach((i, c) => {
                  a.has(c) && p.set(a.get(c), i);
                }), r.supports = p;
              }
    ...
    function fs() {
      ...
      else if (l !== 0 && n === 0) for (let b = 1; b < d.length; b++) b === 0 || b === 3 || c.set(b, [
        0,
        0,
        l,
        0,
      ...
      else if (n !== 0 && l !== 0) for (let b = 1; b < d.length; b++) b === 0 || b === 3 || c.set(b, [
        b === 2 ? n : 0,
        0,
        l,
        0,
    ...
    function us() {
      ...
      else if (S !== 0 && b === 0) for (let f = 0; f < r.length; f++) c.has(f) || y.set(f, [
        0,
        0,
        S,
        0,
      ...
      else if (b !== 0 && S !== 0) for (let f = 0; f < r.length; f++) c.has(f) || y.set(f, [
        f === $ ? b : 0,
        0,
        S,
        0,
    ...
    function ms() {
      const t = le("Lx") || 15, o = le("Ly") || 10, n = le("meshSize") || 0.5, l = le("q") || -3, s = le("t") || 1, d = le("E") || 3e7, a = le("nu") || 0.3, r = d / (2 * (1 + a)), p = Ce === 1 ? "Membrana" : Ce === 2 ? "Kirchhoff" : "Mindlin", { nodes: i, elements: c, boundaryIndices: b } = ho({
        points: [
          [
            0,
            0,
      ...
      e.nodes.val = i, e.elements.val = c, e.nodeInputs && (e.nodeInputs.val = {
        ...
        elasticities: new Map(c.map((h, I) => [
          I,
          d
        ])),
        elasticitiesOrthogonal: new Map(c.map((h, I) => [
          I,
          d
        ])),
        thicknesses: new Map(c.map((h, I) => [
          I,
          s
        ])),
        poissonsRatios: new Map(c.map((h, I) => [
          I,
          a
        ])),
        shearModuli: new Map(c.map((h, I) => [
          I,
          r
        ]))
      });
      try {
        ...
        const I = go(i, c, e.elementInputs.val, h);
        I && e.analyzeOutputs && (e.analyzeOutputs.val = I), console.log(`Plate 3Q [${p}]: ${i.length} nodes, ${c.length} triangles, t=${s}, E=${d}, \u03BD=${a}`);
      } catch (h) {
    ...
    function bs() {
      const t = le("Lx") || 10, o = le("Ly") || 10, n = Math.round(le("nx") || 16), l = Math.round(le("ny") || 16), s = le("t") || 0.2, d = le("q") || -10, a = le("E") || 3e7, r = le("nu") || 0.3, p = xt === 1 ? "clamped" : "simply-supported", c = {
        1: 2,
        2: 1,
        3: 0
      }[Ce] ?? 0;
      return Ze.plateQ4(t, o, n, l, p, d, s, a, r, c);
    }
    function gs() {
      const t = le("a") || 6, o = le("b") || 4, n = Math.round(le("nx") || 12), l = Math.round(le("ny") || 8), s = le("t") || 0.1, d = le("q") || -10, a = le("E") || 35e6, r = le("nu") || 0.15, i = {
        ...
        2: 1,
        3: 0
      }[Ce] ?? 0, c = Ze.plateQ4(t, o, n, l, "simply-supported", d, s, a, r, i), b = a * s * s * s / (12 * (1 - r * r));
      let S = 0;
      for (let $ = 1; $ <= 19; $ += 2) for (let y = 1; y <= 19; y += 2) {
        const f = $ * $ / (t * t) + y * y / (o * o);
        S += 1 / ($ * y * f * f);
      }
      if (S *= 16 * Math.abs(d) / (Math.PI ** 6 * b), console.log(`\u{1F4D0} Navier anal\xEDtico w_center = ${S.toExponential(6)}`), c) {
        const $ = Math.abs((Math.abs(c.centerW || 0) - S) / S * 100);
        console.log(`   WASM w_center = ${(c.centerW || 0).toExponential(6)}, error = ${$.toFixed(2)}%`);
      }
      return c;
    }
    function hs() {
      const t = le("t") || 0.2, o = le("q") || -10, n = le("E") || 35e6, l = le("nu") || 0.2, s = le("meshSize") || 0.6, d = [
        ...
        3.6,
        3
      ], r = d.reduce((x, w) => x + w, 0), p = a.reduce((x, w) => x + w, 0), i = [
        0
      ];
      for (const x of d) i.push(i[i.length - 1] + x);
      const c = [
        0
      ];
      for (const x of a) c.push(c[c.length - 1] + x);
      const b = Math.max(2, Math.round(r / s)), S = Math.max(2, Math.round(p / s)), $ = r / b, y = p / S, f = [];
      for (let x = 0; x <= S; x++) for (let w = 0; w <= b; w++) f.push([
        w * $,
        x * y
      ]);
      const h = [], I = /* @__PURE__ */ new Set();
      for (const x of i) for (const w of c) {
        let v = 1 / 0, F = 0;
        for (let X = 0; X < f.length; X++) {
          const V = Math.hypot(f[X][0] - x, f[X][1] - w);
          V < v && (v = V, F = X);
        }
    ...
    function xs() {
      const t = le("L") || 4, o = le("H") || 2, n = le("t") || 0.1, l = le("E") || 2e7, s = le("nu") || 0.2, d = l / (2 * (1 + s)), a = le("q") || -100, r = le("b") || 0.8, p = le("meshSize") || 0.2, { nodes: i, elements: c, boundaryIndices: b } = ho({
        points: [
          [
            0,
            0,
      ...
      try {
        const m = kt(S, c, k, P), u = go(S, c, P, m), E = S.map((O) => [
          O[0],
          0,
          O[1]
        ]);
    ...
    function vs() {
      const t = le("H") || 4, o = le("B") || 3, n = le("tw") || 0.3, l = le("tb") || 0.4, s = le("meshSize") || 0.2, d = le("E") || 25e6, a = le("nu") || 0.2, r = d / (2 * (1 + a)), p = le("gamma") || 18, i = le("Ka") || 0.33, c = le("Es") || 5e4, b = le("nus") || 0.3, S = c / (2 * (1 + b)), $ = le("kn") || 1e6, y = le("ks") || 1e4, f = le("gammaW") || 9.81, h = le("Hw") || 3.5, I = le("qs") || 0, A = xt, z = o * 0.3, P = o * 0.7, k = [
        [
          -z,
          0,
          0
      ...
      if (A === 0) {
        ...
        if (A === 2) {
          ...
          for (let se = 0; se < m.length; se++) {
            ...
            Math.abs(Se - n) < Q && je >= l - Q && K.push(se);
          }
          ...
          for (let se = 0; se < Ie; se++) {
            const Se = u[se], je = (m[Se[0]][0] + m[Se[1]][0] + m[Se[2]][0]) / 3, rt = (m[Se[0]][1] + m[Se[1]][1] + m[Se[2]][1]) / 3, ct = je >= -z && je <= P && rt >= 0 && rt <= l, Ct = je >= 0 && je <= n && rt >= l && rt <= l + t, _t = ct || Ct;
          ...
          const ue = u.length - _, ne = /* @__PURE__ */ new Map(), fe = /* @__PURE__ */ new Map(), ee = /* @__PURE__ */ new Map(), me = /* @__PURE__ */ new Map(), we = /* @__PURE__ */ new Map();
          for (let se = 0; se < Ie; se++) Pe[se] ? (ne.set(se, c), fe.set(se, c), me.set(se, b), we.set(se, S), ee.set(se, 1)) : (ne.set(se, d), fe.set(se, d), me.set(se, a), we.set(se, r), ee.set(se, 1));
          for (let se = _; se < u.length; se++) ne.set(se, $), fe.set(se, 0), me.set(se, 0), we.set(se, y), ee.set(se, 0);
          O = {
            elasticities: ne,
          ...
          for (let se = 0; se < Ie; se++) {
            if (!Pe[se]) continue;
            const Se = u[se], je = m[Se[0]], rt = m[Se[1]], ct = m[Se[2]], Ct = Math.abs((rt[0] - je[0]) * (ct[1] - je[1]) - (ct[0] - je[0]) * (rt[1] - je[1])) / 2, _t = -p * Ct / 3;
            for (const Rt of Se) {
              const Dt = L.get(Rt) || [
                0,
                0,
          ...
          const ae = (_) => {
            const ue = (m[_[0]][0] + m[_[1]][0] + m[_[2]][0]) / 3, ne = (m[_[0]][1] + m[_[1]][1] + m[_[2]][1]) / 3, fe = ue >= -z && ue <= P && ne >= 0 && ne <= l, ee = ue >= 0 && ue <= n && ne >= l && ne <= l + t;
            return fe || ee;
          }, Q = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Map(), pe = /* @__PURE__ */ new Map(), ce = /* @__PURE__ */ new Map(), Ie = /* @__PURE__ */ new Map(), Pe = [];
          for (let _ = 0; _ < u.length; _++) {
            const ue = ae(u[_]);
            Pe.push(!ue), ue ? (Q.set(_, d), K.set(_, d), ce.set(_, a), Ie.set(_, r), pe.set(_, 1)) : (Q.set(_, c), K.set(_, c), ce.set(_, b), Ie.set(_, S), pe.set(_, 1));
          }
          O = {
            elasticities: Q,
          ...
          for (let _ = 0; _ < m.length; _++) {
            const ue = m[_][0], ne = m[_][1];
            Math.abs(ne) < 1e-6 ? E.set(_, [
              true,
              true,
              true,
              true,
          ...
          for (let _ = 0; _ < u.length; _++) {
            if (!Pe[_]) continue;
            const ue = u[_], ne = m[ue[0]], fe = m[ue[1]], ee = m[ue[2]], me = Math.abs((fe[0] - ne[0]) * (ee[1] - ne[1]) - (ee[0] - ne[0]) * (fe[1] - ne[1])) / 2, we = -p * me / 3;
            for (const se of ue) {
              const Se = L.get(se) || [
                0,
                0,
          ...
          if (I > 0) {
            ...
            for (let ue = 0; ue < m.length; ue++) {
              const ne = m[ue][0], fe = m[ue][1];
              Math.abs(fe - v) < s * 0.1 && ne > n - 1e-6 && _.push({
                idx: ue,
                x: ne
              });
            }
            _.sort((ue, ne) => ue.x - ne.x);
            for (let ue = 0; ue < _.length; ue++) {
              let ne = s;
              ue > 0 && ue < _.length - 1 ? ne = (_[ue + 1].x - _[ue - 1].x) / 2 : ue === 0 && _.length > 1 ? ne = (_[1].x - _[0].x) / 2 : ue === _.length - 1 && _.length > 1 && (ne = (_[ue].x - _[ue - 1].x) / 2);
              const fe = -I * ne, ee = L.get(_[ue].idx) || [
                0,
                0,
                0,
                0,
      ...
      if (A === 3) {
        ...
        for (let ae = 0; ae < m.length; ae++) {
          ...
          Math.abs(Q - n) < s * 0.6 && K >= l - 1e-6 && V.push({
            idx: ae,
            y: K
          });
        }
        ...
        for (let ae = 0; ae < V.length; ae++) {
          ...
          const ce = Math.min(pe, F), Ie = f * ce;
          let Pe = s;
      ...
      try {
        ...
        w && w.deformations && w.deformations.forEach((pe) => {
          ...
          K = Math.max(K, ce);
        }), console.log(`Muro Contencion [${x[A]}]: ${m.length} nodos, ${u.length} triangulos`), console.log(`  H=${t}, B=${o}, tw=${n}, tb=${l}, Ka=${i}, gamma=${p}, qs=${I}`), A === 1 && console.log(`  Es=${c}, nus=${b}`), A === 2 && console.log(`  Es=${c}, nus=${b}, kn=${$}, ks=${y}`), A === 3 && console.log(`  gammaW=${f}, Hw=${h}`), console.log(`  max|u| = ${K.toExponential(4)}`);
      } catch (w) {
    ...
    function ys() {
      const t = le("Lx") || 2, o = le("Ly") || 2, n = le("t") || 0.5, l = le("colA") || 0.4, s = le("colH") || 1.5, d = Math.round(le("nx") || 8), a = Math.round(le("ny") || 8), r = le("E") || 25e6, p = le("nu") || 0.2, i = le("P") || -500, c = le("Mx") || 0, b = le("My") || 0, S = le("ks") || 2e4, $ = t / d, y = o / a, f = t / 2, h = o / 2, I = l / 2, A = [];
      for (let E = 0; E <= a; E++) for (let L = 0; L <= d; L++) {
        const O = E * (d + 1) + L;
        let W = $, x = y;
        (L === 0 || L === d) && (W = $ / 2), (E === 0 || E === a) && (x = y / 2), A.push({
          node: O,
          dof: 0,
          k: S * W * x
        });
      ...
      let z = 0;
      for (let E = 0; E <= a; E++) for (let L = 0; L <= d; L++) Math.abs(L * $ - f) <= I + 1e-6 && Math.abs(E * y - h) <= I + 1e-6 && z++;
      ...
      console.log(`Zapata: ${t}x${o}m, t=${n}m, ${d}x${a} elem`), console.log(`  col=${l}m, P=${i}, Mx=${c}, My=${b}, ks=${S}`);
      try {
        const E = Un({
          E: r,
          nu: p,
        ...
        E.nodeResults.forEach((X, V) => {
          const ae = X.x, Q = X.y;
          (ae < 1e-6 || ae > t - 1e-6 || Q < 1e-6 || Q > o - 1e-6) && w.set(V, [
            false,
            false,
            true,
            false,
    ...
    function $s() {
      const t = le("Lx") || 0.4, o = le("Ly") || 0.4, n = le("t") || 0.025, l = le("dBolt") || 0.022, s = le("sx") || 0.28, d = le("sy") || 0.28, a = le("colA") || 0.2, r = le("meshSize") || 8e-3, p = le("E") || 2e8, i = le("nu") || 0.3, c = p / (2 * (1 + i)), b = le("P") || -200, S = Math.round(le("nBolts") || 4), $ = t / 2, y = o / 2, f = l / 2, h = a / 2, I = [];
      S >= 4 && (I.push([
        $ - s / 2,
        y - d / 2
      ]), I.push([
      ...
      console.log(`Placa Base: ${t * 1e3}x${o * 1e3}mm, t=${n * 1e3}mm, ${S} pernos d=${l * 1e3}mm`), console.log(`  P=${b} kN, col=${a * 1e3}mm, mesh=${r * 1e3}mm`), console.log(`  ${k.length} triangulos, ${m.length} nodos`);
      try {
        const x = kt(m, k, {
          supports: u,
          loads: E
    ...
    function Ms() {
      const t = le("colB") || 0.3, o = le("colH") || 0.3, n = le("colT") || 8e-3, l = le("colLen") || 1.5, s = le("Lx") || 0.45, d = le("Ly") || 0.45, a = le("tPlaca") || 0.025, r = le("dBolt") || 0.022, p = le("sx") || 0.32, i = le("sy") || 0.32, c = Math.round(le("nSubColV") || 6), b = Math.round(le("nSubColH") || 4), S = Math.round(le("nSubPlaca") || 10), $ = le("E") || 2e8, y = le("nu") || 0.3, f = $ / (2 * (1 + y)), h = le("P") || -300, I = s / 2, A = d / 2, z = r / 2, P = t / 2, k = o / 2, m = [], u = [], E = S, L = s / E, O = d / E, W = (fe, ee) => ee * (E + 1) + fe;
      ...
      for (const [fe, ee] of K) {
        ...
        for (let rt = 0; rt <= X; rt++) {
          ...
          for (let _t = 0; _t <= V; _t++) {
            const Rt = _t / V, Dt = me + Rt * (se - me), So = we + Rt * (Se - we);
            if (rt === 0) {
              const Vt = pe(Dt, So);
              if (Vt >= 0) {
                ct.push(Vt);
            ...
            let ao = -1;
            for (let Vt = 0; Vt < m.length; Vt++) if (Math.abs(m[Vt][0] - Dt) < 1e-6 && Math.abs(m[Vt][1] - So) < 1e-6 && Math.abs(m[Vt][2] - Ct) < 1e-6) {
              ao = Vt;
              break;
            }
            ao >= 0 ? ct.push(ao) : (ct.push(m.length), m.push([
              Dt,
              So,
              Ct
            ]));
      ...
      for (let fe = v; fe < v + F; fe++) ne.elasticities.set(fe, $), ne.poissonsRatios.set(fe, y), ne.thicknesses.set(fe, a), ne.shearModuli.set(fe, f);
      for (let fe = Q; fe < Q + ce; fe++) ne.elasticities.set(fe, $), ne.poissonsRatios.set(fe, y), ne.thicknesses.set(fe, n), ne.shearModuli.set(fe, f);
      console.log(`Col+Placa 3D: col ${t * 1e3}x${o * 1e3}x${n * 1e3}mm, h=${l}m`), console.log(`  Placa ${s * 1e3}x${d * 1e3}mm, t=${a * 1e3}mm, 4 pernos d=${r * 1e3}mm`), console.log(`  ${F} Q4 placa + ${ce} Q4 columna = ${u.length} total`), console.log(`  ${m.length} nodos, P=${h} kN`);
      try {
        const fe = kt(m, u, {
          supports: Ie,
          loads: Pe
    ...
    function ws() {
      const t = le("H") || 6, o = le("angle") || 45, n = le("bTop") || 3, l = le("bBot") || 3, s = le("meshSize") || 2, d = le("E") || 5e4, a = le("nu") || 0.3, r = le("gamma") || 18, p = le("c") || 15, i = le("phi") || 30, c = le("qs") || 0, b = t / Math.tan(o * Math.PI / 180), S = l + b + n, $ = t, y = [
        [
          0,
          -$,
          0
    ...
    function Es(t, o, n, l, s) {
      ...
      if (Ne.vigaMat === 0) {
        for (let r = 0; r < o.length; r++) {
          const p = o[r], i = `b${n}${r}`, c = `h${n}${r}`, b = {};
          b[i] = +$t(p.b).toFixed(2), b[c] = +$t(p.h).toFixed(2), t.addBinding(b, i, {
            min: l[0],
            max: l[1],
            step: l[2],
            label: `b sv${n}${r + 1}`
    ...
    function No() {
      ...
      if (!o) return;
      o.style.display = "";
      const n = M, l = Math.round(((_a2 = Z.nPisos) == null ? void 0 : _a2.val) ?? 3), s = ya(), d = $a(), a = re.length || 1, r = te.length || 1;
      for (; Ne.perFloor.length < l; ) {
        const m = Ne.perFloor.length > 0 ? JSON.parse(JSON.stringify(Ne.perFloor[Ne.perFloor.length - 1])) : ro(a, r);
        Ne.perFloor.push(m);
      }
      ...
      if (At.addBinding(p, "colMat", {
        ...
        At.addBinding(u, "fc", {
          ...
          var _a3;
          ((_a3 = E.target) == null ? void 0 : _a3.key) === "fc" && (Ne.fc = Tn(E.value), Re());
        });
      } else if (Ne.colMat === 1) {
        const m = {
      ...
      for (let m = 0; m < l; m++) {
        ...
        if (Ne.colMat === 0) if (Ne.colShape === 1) {
          ...
          const O = +To(1e8).toFixed(0), W = +To(3e8).toFixed(0), x = Math.max(1, Math.round((W - O) / 200));
          E.addBinding(L, "Es", {
            min: O,
            max: W,
            step: x,
            ...
            ((_a3 = w.target) == null ? void 0 : _a3.key) === "bc" && (u.colBc = Mt(w.value), Re()), ((_b = w.target) == null ? void 0 : _b.key) === "hc" && (u.colHc = Mt(w.value), Re()), ((_c = w.target) == null ? void 0 : _c.key) === "t" && (u.colT = Mt(w.value), Re()), ((_d = w.target) == null ? void 0 : _d.key) === "Es" && (u.colEs = Tn(w.value), Re()), ((_e2 = w.target) == null ? void 0 : _e2.key) === "nuS" && (u.colNuS = w.value, Re()), ((_f = w.target) == null ? void 0 : _f.key) === "fc" && (u.colFc = Tn(w.value), Re()), ((_g = w.target) == null ? void 0 : _g.key) === "nuC" && (u.colNuC = w.value, Re());
          });
        }
    ...
    function so() {
      ...
      if (n) {
        ...
        for (const a of n) {
          ...
          d.addBinding(r, "min", {
            ...
            Z[a.key] && (Z[a.key].min = r.min, Z[a.key].max = r.max, Z[a.key].val < r.min && (Z[a.key].val = r.min), Z[a.key].val > r.max && (Z[a.key].val = r.max)), so(), Re();
          });
        }
        ye.on("change", (a) => {
          var _a2, _b;
          ...
          if (r && Z[r]) {
            if (Z[r].val = a.value, T === "edificio" && (r === "nVanosX" || r === "nVanosY" || r === "nPisos")) {
              if (r === "nVanosX" || r === "nVanosY") {
                const p = Math.round(Z.nVanosX.val), i = Math.round(Z.nVanosY.val);
                for (; re.length < p; ) re.push(re[re.length - 1] ?? M.defaultSpan);
                for (re.length > p && (re.length = p); te.length < i; ) te.push(te[te.length - 1] ?? M.defaultSpan * 0.8);
                te.length > i && (te.length = i);
              }
              if (r === "nPisos" || r === "hPiso") {
                const p = Math.round(Z.nPisos.val), i = ((_b = Z.hPiso) == null ? void 0 : _b.val) ?? 3;
      ...
      if (T === "edificio") {
        ...
        if (s) {
          let d = function() {
            var _a2, _b, _c, _d;
            const p = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", i = ((_a2 = Z.Lvix) == null ? void 0 : _a2.val) || 0, c = ((_b = Z.Lvdx) == null ? void 0 : _b.val) || 0, b = ((_c = Z.Lviy) == null ? void 0 : _c.val) || 0, S = ((_d = Z.Lvdy) == null ? void 0 : _d.val) || 0;
            let $ = "X: ";
            i > 0 && ($ += `\u251C${i.toFixed(1)}\u2524`);
            for (let h = 0; h < re.length; h++) $ += `[${p[h + (i > 0 ? 1 : 0)]}]\u2500\u2500${re[h].toFixed(1)}\u2500\u2500`;
            $ += `[${p[re.length + (i > 0 ? 1 : 0)]}]`, c > 0 && ($ += `\u251C${c.toFixed(1)}\u2524`);
            let y = "Y: ";
            b > 0 && (y += `\u251C${b.toFixed(1)}\u2524`);
...
` + f;
      ...
      for (const [r, p] of Object.entries(o)) {
        ...
        if (Array.isArray(p.value)) {
          ...
          d.addBinding(c, r, {
            ...
            a[r] = b.value.split(",").map((S) => parseFloat(S.trim())).filter((S) => !isNaN(S)), n && n({
              ...a
            });
          });
        } else if (p.options) {
          ...
          p.min !== void 0 && (b.min = p.min), p.max !== void 0 && (b.max = p.max), p.step !== void 0 && (b.step = p.step), d.addBinding(c, r, b).on("change", (S) => {
            a[r] = S.value, n && n({
              ...a
            });
          });
  ...
  `;
    ...
    function Ea() {
      var _a2, _b, _c, _d, _e2, _f;
      const t = e.nodes.val, o = e.elements.val, n = (_a2 = e.nodeInputs) == null ? void 0 : _a2.val, l = (_b = e.elementInputs) == null ? void 0 : _b.val, s = R, d = g, a = [];
      if (a.push("# Awatif FEM \u2014 Model Export"), a.push(`# Generator: ${T || "custom"}`), a.push(`# Units: ${d}, ${s}`), a.push(`# ${(/* @__PURE__ */ new Date()).toISOString()}`), a.push(""), a.push(`## NODES (${t.length})`), a.push("# idx     X          Y          Z"), t.forEach((i, c) => {
      ...
      if (p && p.size > 0 && (a.push(`## REACTIONS (${p.size} supports)`), a.push("# node          Rx           Ry           Rz           Mx           My           Mz"), p.forEach((i, c) => {
        const b = i.map((S) => S.toFixed(4).padStart(12)).join(" ");
        a.push(`  ${String(c).padStart(4)}  ${b}`);
      }), a.push("")), T) {
        a.push("## CLI COMMAND");
        const i = Object.entries(Z).map(([c, b]) => `${c}=${b.val}`).join(" ");
...
`);
    ...
    `, document.body.appendChild(Lt), (_a2 = Lt.querySelector("#export-close")) == null ? void 0 : _a2.addEventListener("click", () => {
        Lt == null ? void 0 : Lt.remove(), Lt = null, Zo = false;
      }), (_b = Lt.querySelector("#export-minimize")) == null ? void 0 : _b.addEventListener("click", () => {
        const o = Lt.querySelector("#export-body"), n = Lt.querySelector("#export-minimize");
        Zo = !Zo, Zo ? (o.style.display = "none", n.textContent = "\u25A2", n.title = "Restaurar", Lt.style.width = "auto") : (o.style.display = "flex", n.textContent = "\u25AC", n.title = "Minimizar", Lt.style.width = "720px");
      }), (_c = Lt.querySelector("#export-copy")) == null ? void 0 : _c.addEventListener("click", () => {
        const o = Lt.querySelector("#export-text");
        navigator.clipboard.writeText(o.value).then(() => {
          const n = Lt.querySelector("#export-status");
        ...
        const p = Lt.querySelector("#export-text");
    ...
    function Qe() {
      ...
      if (t) {
        ...
        let p = `${o}n ${l}e ${s}s`;
        (r > 0 || a > 0) && (p += ` | ${d}fr`, r > 0 && (p += ` ${r}q4`), a > 0 && (p += ` ${a}tri`)), t.textContent = p;
      }
    }
    function Ln() {
      var _a2;
      ...
      if (!(t.length === 0 || o.length === 0) && !(!n.supports || n.supports.size === 0) && !(!l.densities || l.densities.size === 0)) try {
        ...
        if (s <= 0) return;
        const d = Va(t, o, n, l, Math.min(s, 12));
        if (d.frequencies && d.frequencies.length > 0) {
          Ae = d, ke = t.map((i) => [
            ...i
          ]), he = 0;
          const { extent: a } = yo(), r = (_a2 = d.modeShapes) == null ? void 0 : _a2[0];
          if (r) {
            let i = 0;
            for (let c = 0; c < t.length; c++) {
              const b = r[c * 6] || 0, S = r[c * 6 + 1] || 0, $ = r[c * 6 + 2] || 0;
    ...
    function Cn() {
      xe && (cancelAnimationFrame(xe), xe = 0), ke.length > 0 && (e.nodes.val = ke.map((o) => [
        ...o
      ]));
      const t = Ke();
    ...
    function Qo() {
      ...
      if (!t) return;
      const o = ((_a2 = Ae.frequencies) == null ? void 0 : _a2[he]) || 1, n = Math.max(0.5, Math.min(3, o * 0.1)), l = performance.now(), s = ke.length, d = e.elements.rawVal, { extent: a } = yo(), r = Le.querySelector("#cad3d-modal-scale"), p = r && parseFloat(r.value) || 15;
      let i = 0;
      for (let z = 0; z < s; z++) {
        const P = t[z * 6] || 0, k = t[z * 6 + 1] || 0, m = t[z * 6 + 2] || 0;
        i = Math.max(i, Math.sqrt(P * P + k * k + m * m));
      }
      const c = i > 1e-12 ? a * p / 100 / i : 1, b = Ke();
      if (!b) return;
      ...
      for (const z of d) if (z.length === 2) h.push([
        z[0],
        z[1]
      ]);
      ...
      function A() {
        const z = (performance.now() - l) / 1e3, P = Math.sin(2 * Math.PI * n * z) * c;
        for (let k = 0; k < s; k++) {
          const m = ke[k];
    ...
    function Fn() {
      ...
      const p = ((_d = n.supports) == null ? void 0 : _d.size) || 0, i = ((_e2 = n.loads) == null ? void 0 : _e2.size) || 0, c = t.length * 6, b = c - p * 6, S = [], $ = (y) => S.push(y);
      $('<b style="color:var(--cad-heading)">FEM Solver</b>'), $(`<span style="color:var(--cad-info)">Modelo:</span> ${t.length} nodos, ${o.length} elem`), d && $(`&nbsp;&nbsp;Frames: <b>${d}</b>`), a && $(`&nbsp;&nbsp;Shell Q4: <b>${a}</b>`), r && $(`&nbsp;&nbsp;Triangulos: <b>${r}</b>`), $(`&nbsp;&nbsp;Apoyos: ${p} &nbsp;|&nbsp; Cargas: ${i}`), $(`<span style="color:var(--cad-info)">DOFs:</span> ${c} total, ~${b} libres`), $('<hr style="border-color:var(--cad-border);margin:4px 0">'), $(`<span style="color:#888">1.</span> Ensamblaje <b>K</b> global (${c}&times;${c})`), $("&nbsp;&nbsp;&nbsp;<i>K<sub>global</sub> = &Sigma; T<sup>T</sup> &middot; K<sub>local</sub> &middot; T</i>");
      try {
        const y = kt(t, o, n, l), f = performance.now() - s;
        if (y) {
          ...
          const P = performance.now(), k = go(t, o, l, y), m = performance.now() - P;
    ...
    function Pn(t, o, n, l) {
      const s = o - 2 * n, d = 2 * t * n + s * l, a = (t * o * o * o - (t - l) * s * s * s) / 12, r = (2 * n * t * t * t + s * l * l * l) / 12, p = (2 * t * n * n * n + s * l * l * l) / 3;
      return {
        A: d,
        Iz: a,
        Iy: r,
    ...
    function On(t, o, n) {
      const l = t - 2 * n, s = o - 2 * n, d = t * o - l * s, a = (t * o * o * o - l * s * s * s) / 12, r = (o * t * t * t - s * l * l * l) / 12, p = (t - n) * (o - n), i = 2 * ((t - n) / n + (o - n) / n), c = 4 * p * p / (i > 0 ? i : 1);
      return {
        A: d,
        Iz: a,
        Iy: r,
    ...
    function Ia(t, o, n, l, s, d, a) {
      const p = 4700 * Math.sqrt(d / 1e3) * 1e3 / l, i = t - 2 * n, c = o - 2 * n, b = t * o - i * c, S = (t * o * o * o - i * c * c * c) / 12, $ = (o * t * t * t - c * i * i * i) / 12, y = i * c, f = i * c * c * c / 12, h = c * i * i * i / 12, I = b + p * y, A = S + p * f, z = $ + p * h, P = l / (2 * (1 + s)), k = (t - n) * (o - n), m = 2 * ((t - n) / n + (o - n) / n), u = 4 * k * k / (m > 0 ? m : 1);
      return {
        A: I,
        Iz: A,
        Iy: z,
    ...
    function vo() {
      ...
      if ((T === "edificio" || T === "frame") && D.size > 0) {
        const { colMat: s, vigaMat: d, colShape: a, fc: r, perFloor: p } = Ne, i = 4700 * Math.sqrt(r / 1e3) * 1e3, c = i / (2 * 1.2), b = 24 / 9.80665, S = o.E, $ = o.G, y = o.rho;
        for (let f = 0; f < t.length; f++) {
          if (de.has(f)) {
            const E = 4700 * Math.sqrt(r / 1e3) * 1e3, L = 0.2;
            n.elasticities.set(f, E), n.poissonsRatios.set(f, L), n.thicknesses.set(f, Be), n.shearModuli.set(f, E / (2 * (1 + L))), n.densities.set(f, 24 / 9.80665);
            continue;
          }
          if (zt.has(f)) {
            const E = 4700 * Math.sqrt(r / 1e3) * 1e3, L = 0.2;
            n.elasticities.set(f, E), n.poissonsRatios.set(f, L), n.thicknesses.set(f, at), n.shearModuli.set(f, E / (2 * (1 + L))), n.densities.set(f, 24 / 9.80665);
            continue;
          }
          ...
          let z, P, k, m;
          if (h) if (s === 0) P = i, k = c, m = b, z = a === 1 ? ks(A.dCol) : Rn(A.bCol, A.hCol), n.sectionShapes.set(f, a === 1 ? {
            type: "circ",
            d: A.dCol
          } : {
            type: "rect",
            ...
            if (E <= 1) {
              const L = ko[A.colProfileIdx] ?? ko[0];
              z = {
                A: L.A,
                Iz: L.Iz,
                Iy: L.Iy,
            ...
            const E = Te.get(f), L = E ? E.dir === "x" ? A.vigasX : A.vigasY : [], O = E ? L[E.bay] ?? L[0] ?? ut() : ut();
            if (d === 0) P = i, k = c, m = b, z = Rn(O.b, O.h), n.sectionShapes.set(f, {
              type: "rect",
              b: O.b,
              h: O.h
            });
              ...
              if (W <= 1) {
                const x = ko[O.profileIdx ?? 0] ?? ko[0];
                z = {
                  A: x.A,
                  Iz: x.Iz,
                  Iy: x.Iy,
          ...
          const u = ge.get(f);
          if (u) {
            if ((u.material ?? 1) === 0 ? (P = i, k = c, m = b) : (P = S, k = $, m = y), u.secType === "rect" && u.b && u.h) z = Rn(u.b, u.h), n.sectionShapes.set(f, {
              type: "rect",
              b: u.b,
              h: u.h
            });
    ...
    window.innerWidth <= 600 && Le.classList.add("collapsed"), setTimeout(() => {
      ...
      (_a2 = Le.querySelector("#cad3d-toggle")) == null ? void 0 : _a2.addEventListener("click", (x) => {
        ...
        x.addEventListener("click", (w) => {
          ...
          $o(v), Le.querySelectorAll("[data-view]").forEach((F) => F.classList.remove("view-active")), x.classList.add("view-active");
        });
      }), (_c = Le.querySelector("#cad3d-btn-clear")) == null ? void 0 : _c.addEventListener("click", (x) => {
        x.stopPropagation(), T = "", ia.val = false, wa(), Ze.clear();
      }), (_d = Le.querySelector("#cad3d-select")) == null ? void 0 : _d.addEventListener("click", (x) => {
        var _a3;
        x.stopPropagation(), oo && (oo = false, Ao()), po && cn(), Yt = !Yt, (_a3 = Le.querySelector("#cad3d-select")) == null ? void 0 : _a3.classList.toggle("inspect-active", Yt);
        const v = Ke();
        v && (v.controls.enabled = !Yt), Yt || rn();
      }), (_e2 = Le.querySelector("#cad3d-draw")) == null ? void 0 : _e2.addEventListener("click", (x) => {
        var _a3;
        x.stopPropagation(), oo && (oo = false, Ao()), Yt && rn(), po = !po, (_a3 = Le.querySelector("#cad3d-draw")) == null ? void 0 : _a3.classList.toggle("inspect-active", po), po ? La() : cn();
      }), (_f = Le.querySelector("#cad3d-inspect")) == null ? void 0 : _f.addEventListener("click", (x) => {
        var _a3;
        x.stopPropagation(), Yt && rn(), po && cn(), oo = !oo, (_a3 = Le.querySelector("#cad3d-inspect")) == null ? void 0 : _a3.classList.toggle("inspect-active", oo), oo || Ao();
      }), (_g = Le.querySelector("#cad3d-new-model")) == null ? void 0 : _g.addEventListener("click", (x) => {
        x.stopPropagation(), Ze.clear(), Ve = null;
      });
      ...
      function o(x) {
        ...
        const F = 15e3 * Math.sqrt(210) * 10, X = 0.2, V = F / (2 * (1 + X)), ae = 0.09, Q = 0.3 ** 4 / 12, K = 0.141 * 0.3 ** 4, pe = 0.25 * 0.4, ce = 0.25 * 0.4 ** 3 / 12, Ie = 0.4 * 0.25 ** 3 / 12, Pe = 1e-3, _ = 5 / 6 * ae, ue = 5 / 6 * pe, ne = [];
        ...
        if (x === "test-scordelis" || x === "test-all") {
          ...
          for (let ot = 0; ot <= ct; ot++) for (let St = 0; St <= Ct; St++) {
            const eo = 25 * ot / ct, Ot = rt * St / Ct, bo = 25 * Math.sin(Ot), mo = 25 * Math.cos(Ot) - 25 * Math.cos(rt);
            _t.push([
              eo,
              bo,
              mo
          ...
          const Rt = [];
          for (let ot = 0; ot < ct; ot++) for (let St = 0; St < Ct; St++) {
            const eo = ot * (Ct + 1) + St, Ot = (ot + 1) * (Ct + 1) + St, bo = (ot + 1) * (Ct + 1) + (St + 1), mo = ot * (Ct + 1) + (St + 1);
            Rt.push([
              eo,
              Ot,
              bo,
          ...
          for (let ot = 0; ot < Rt.length; ot++) Dt.elasticities.set(ot, 432e6), Dt.shearModuli.set(ot, So), Dt.thicknesses.set(ot, 0.25), Dt.poissonsRatios.set(ot, 0);
          const ao = /* @__PURE__ */ new Map();
          for (let ot = 0; ot <= ct; ot++) for (let St = 0; St <= Ct; St++) {
            const eo = ot * (Ct + 1) + St, Ot = [
              false,
              false,
              false,
              false,
          ...
          for (const ot of Rt) {
            const St = _t[ot[0]], eo = _t[ot[1]], Ot = _t[ot[2]], bo = _t[ot[3]], mo = [
              ...
              bo[1] - eo[1],
              bo[2] - eo[2]
            ], Us = mo[1] * jo[2] - mo[2] * jo[1], Xs = mo[2] * jo[0] - mo[0] * jo[2], Ks = mo[0] * jo[1] - mo[1] * jo[0], Ja = -90 * (0.5 * Math.sqrt(Us * Us + Xs * Xs + Ks * Ks)) / 4;
            for (const Zs of ot) {
              const Qs = Vt.get(Zs) || [
                0,
                0,
          ...
          try {
            const ot = kt(_t, Rt, {
              supports: ao,
              loads: Vt
            }, Dt), St = Ct, eo = ((_f2 = (_e3 = ot.deformations) == null ? void 0 : _e3.get(St)) == null ? void 0 : _f2[2]) ?? 0;
            ne.push({
      ...
      function n(x) {
        ...
        for (const [_, ue] of K) {
          const [ne, fe] = _.split(",").map(Number);
          v.push(`  POINT "${ue}"  ${ne} ${fe} `);
        }
        v.push("");
        const ce = (_) => {
          const ue = x.nodes[_], ne = `${ue[0]},${ue[2]}`;
          return {
            pt: K.get(ne) || "1",
        ...
        if (x.elements.forEach((_, ue) => {
          ...
          const ne = x.nodes[_[0]], fe = x.nodes[_[1]], ee = Math.abs(fe[1] - ne[1]), me = Math.sqrt((fe[0] - ne[0]) ** 2 + (fe[2] - ne[2]) ** 2), we = ee > me * 0.5, se = ce(_[0]), Se = ce(_[1]), je = we ? "COL30" : "VIGA";
          ...
          const _ = [];
          x.elements.forEach((ue, ne) => {
            if (ue.length !== 4) return;
            const fe = ue.map((ee) => ce(ee));
            v.push(`  AREA "W${ne + 1}"  PANEL  4  "${fe[0].pt}"  "${fe[1].pt}"  "${fe[2].pt}"  "${fe[3].pt}"  1  1  0  0  `), _.push(`  AREAASSIGN  "W${ne + 1}"  "${fe[2].story}"  SECTION "Muro20"  `);
...
`);
      ...
      function c(x, w) {
        ...
        <div style="display:flex;gap:8px">
          ...
          F.querySelectorAll("input[data-ifc-cat]:checked").forEach((ne) => {
            K.add(ne.dataset.ifcCat);
          });
          const pe = w.nodes.map((ne) => [
            ne.x,
            ne.y,
            ne.z
          ]), ce = [], Ie = {
          ...
          let _ = 0;
          for (const ne of w.elements) if (K.has(ne.category) && ne.type === "frame" && ne.nodeIds.length >= 2) {
            ce.push(ne.nodeIds);
            const fe = ((_a4 = w.materials) == null ? void 0 : _a4.get(ne.material)) || {
              E: 2132888792e-2,
              nu: 0.2,
              rho: 2.4
            }, ee = ne.b || 0.3, me = ne.h || 0.3, we = ee * me, se = ee * me * me * me / 12, Se = me * ee * ee * ee / 12, je = ee * me * (ee * ee + me * me) / 12, rt = fe.E / (2 * (1 + fe.nu));
          ...
          const ue = Math.min(...pe.map((ne) => ne[2]));
          pe.forEach((ne, fe) => {
            Math.abs(ne[2] - ue) < 0.05 && Pe.supports.set(fe, [
              true,
              true,
              true,
              true,
      ...
      function b(x) {
        ...
        We = X, Xe = V, pt = K, setTimeout(() => {
          wt(), Xo(X, V, K, ae, Q), wn(x.stories, X, V), Nn(), qn();
        }, 100);
        const pe = {
          COLUMN: 0,
          BEAM: 0,
      ...
      r && r.addEventListener("change", () => {
        if (a = r.value, r.value = "", a.startsWith("import")) a === "import-e2k" ? p.accept = ".e2k,.E2K" : a === "import-s2k" ? p.accept = ".s2k,.S2K,.$2k" : a === "import-ifc" ? p.accept = ".ifc,.IFC" : a === "import-py" ? p.accept = ".py" : a === "import-tcl" && (p.accept = ".tcl"), p.click();
      ...
      $ && ($.value = g, $.addEventListener("change", (x) => {
        x.stopPropagation(), g = $.value, M = Ro(g, R), T && et(T);
      }));
      const y = Le.querySelector("#cad3d-length-unit");
      y && (y.value = R, y.addEventListener("change", (x) => {
        x.stopPropagation(), R = y.value, M = Ro(g, R), T && et(T);
      })), Le.querySelectorAll("[data-preset]").forEach((x) => {
        x.addEventListener("click", (w) => {
          w.stopPropagation();
          const v = x.dataset.preset, F = B[v];
          F && (g = F.force, R = F.length, J = F.stress, M = Ro(g, R), $ && ($.value = g), y && (y.value = R), Le.querySelectorAll("[data-preset]").forEach((X) => {
        ...
        if (qe) {
          const ae = Ke();
          ((_b2 = ae == null ? void 0 : ae.settings) == null ? void 0 : _b2.loads) && (_e = ae.settings.loads.rawVal, ae.settings.loads.val = false), Ln(), v.style.display = "", F.style.display = "", X.style.display = "", V && (V.style.display = ""), f();
        } else Cn(), v.style.display = "none", F.style.display = "none", X.style.display = "none", V && (V.style.display = "none"), T && T !== "placa-q4" && T !== "placa-3q" && Re(), setTimeout(() => {
          var _a4;
          const ae = Ke();
      ...
      (_o2 = Le.querySelector("#cad3d-mode-prev")) == null ? void 0 : _o2.addEventListener("click", (x) => {
        ...
        Ge = F > 1e-12 ? v * 0.05 / F : 1, console.log(`Mode ${he + 1}: maxDisp=${F.toExponential(3)}, scale=${Ge.toFixed(1)}, f=${(_b2 = (_a3 = Ae.frequencies) == null ? void 0 : _a3[he]) == null ? void 0 : _b2.toFixed(2)} Hz`), Qo(), f();
      });
      ...
      h == null ? void 0 : h.addEventListener("mousedown", (x) => x.stopPropagation()), h == null ? void 0 : h.addEventListener("change", () => {
        qe && (Ae == null ? void 0 : Ae.modeShapes) && Qo();
      });
...
`));
        ...
        if ((x.key === "Delete" || x.key === "Backspace") && ht.size > 0) {
          x.preventDefault(), ht.forEach((w) => U.add(w)), ht.clear(), fo && (fo.remove(), fo = null), Re();
          return;
        }
        if (x.key === "Escape") {
          if (po) if (vt !== null) {
          ...
          Yt && rn(), oo && (oo = false, Ao(), (_a3 = Le.querySelector("#cad3d-inspect")) == null ? void 0 : _a3.classList.remove("inspect-active"));
        }
...
`);
            try {
              const v = new Function("cad", `return ${w}`)(Ze);
              if (v !== void 0 && z) {
...
`);
    ...
    function yo() {
      ...
      for (const [i, c, b] of t) i < o && (o = i), i > s && (s = i), c < n && (n = c), c > d && (d = c), b < l && (l = b), b > a && (a = b);
      const r = new Oe((o + s) / 2, (n + d) / 2, (l + a) / 2), p = Math.max(s - o, d - n, a - l, 1);
      return {
        center: r,
        extent: p
      };
    ...
    function wt(t = false) {
      ...
      a.rotation.x = Math.PI / 2, a.position.set(0.5 * l, 0.5 * l, 0), o.scene.add(a), o.scene.children.filter((b) => b.type === "Group" && b.name !== "gridAxes" && b.name !== "loadsGroup" && (b.name === "viewerAxes" || b.children.some((S) => S instanceof dn))).forEach((b) => {
        b.traverse((S) => {
      ...
      i.name = "viewerAxes";
      const c = d.axisArrow;
      i.add(new dn(new Oe(1, 0, 0), new Oe(), 1, c, 0.2, 0.2)), i.add(new dn(new Oe(0, 1, 0), new Oe(), 1, c, 0.2, 0.2)), i.add(new dn(new Oe(0, 0, 1), new Oe(), 1, c, 0.2, 0.2)), i.children.forEach((b) => b.scale.set(p, p, p));
      for (const [b, S, $] of [
        [
          "X",
          "red",
    ...
    function $o(t) {
      ...
      const o = Ke();
      if (!o) return;
      const { center: n, extent: l } = yo(), s = o.renderer.domElement.clientWidth / (o.renderer.domElement.clientHeight || 1), d = l * 0.7;
      ...
      const a = () => {
        o.scene.traverse((r) => {
          ...
          (p || i || c) && (Array.isArray(r.material) ? r.material.forEach((b) => {
            b.clippingPlanes = [];
      ...
      if (t === "3d") {
        ...
        const p = (i, c, b) => {
          r.position.copy(i), r.up.copy(b), o.controls.target.copy(c), r.lookAt(c), o.controls.update();
        };
        if (t === "plan") o.renderer.clippingPlanes = [], p(new Oe(n.x, n.y, n.z + l * 2), new Oe(n.x, n.y, n.z), new Oe(0, 1, 0));
        else if (t.startsWith("plan:")) {
          const i = parseInt(t.split(":")[1]), c = ((_a2 = Z.hPiso) == null ? void 0 : _a2.val) ?? 3, b = (i + 1) * c, S = c * 0.45;
          o.renderer.clippingPlanes = [
            new Io(new Oe(0, 0, -1), b + S),
            new Io(new Oe(0, 0, 1), -b + S)
          ], a(), p(new Oe(n.x, n.y, b + l * 2), new Oe(n.x, n.y, b), new Oe(0, 1, 0));
    ...
    function Nn() {
      ...
      const o = (d, a, r) => {
        ...
        return p.textContent = d, p.dataset.view = a, p.title = r, p.style.cssText = "min-width:22px;padding:1px 5px;font-weight:bold", p.addEventListener("click", (i) => {
          var _a2;
          i.stopPropagation();
          const c = p.classList.contains("view-active");
          Le.querySelectorAll("[data-view]").forEach((b) => b.classList.remove("view-active")), c ? ($o("3d"), (_a2 = Le.querySelector('[data-view="3d"]')) == null ? void 0 : _a2.classList.add("view-active")) : ($o(a), p.classList.add("view-active"));
        }), p;
    ...
    function qn() {
      ...
      const n = (s, d, a) => {
        ...
        return r.textContent = s, r.dataset.view = d, r.title = a, r.style.cssText = "min-width:22px;padding:1px 5px;font-weight:bold", r.addEventListener("click", (p) => {
          var _a3;
          p.stopPropagation();
          const i = r.classList.contains("view-active");
          Le.querySelectorAll("[data-view]").forEach((c) => c.classList.remove("view-active")), i ? ($o("3d"), (_a3 = Le.querySelector('[data-view="3d"]')) == null ? void 0 : _a3.classList.add("view-active")) : ($o(d), r.classList.add("view-active"));
        }), r;
    ...
    function ka() {
      $o("3d"), Le.querySelectorAll("[data-view]").forEach((t) => t.classList.toggle("view-active", t.dataset.view === "3d"));
    }
    Ze.view = (t) => {
      t = {
        planta: "plan",
        ...
        elevationY: "elevY",
        corte: "section"
      }[t] || t, $o(t), Le.querySelectorAll("[data-view]").forEach((n) => n.classList.toggle("view-active", n.dataset.view === t));
    };
    ...
    function Do() {
      ...
      }), _o.length > Ta && _o.shift(), ln.length = 0;
    }
    function As() {
    ...
    function Bn(t) {
      ...
      for (let r = 0; r < l.length; r++) {
        ...
        s.push(p[0], p[1], p[2], i[0], i[1], i[2]);
      }
      const d = new to();
    ...
    `, document.body.appendChild(o), fo = o, o.querySelector("#sel-assign").addEventListener("click", () => {
        ...
        if (ht.size === 1) {
          ...
          const i = [];
          d && i.push(`${d} columnas`), a && i.push(`${a} vigas`), p && i.push(`${p} shells Q4`), r && i.push(`${r} triangulos`), alert(`${n.length} elementos seleccionados:
${i.join(", ")}`);
        }
      }), o.querySelector("#sel-hide").addEventListener("click", () => {
        ht.forEach((n) => Y.add(n)), ht.clear(), wo(), Eo(), Re();
      }), o.querySelector("#sel-isolate").addEventListener("click", () => {
        H = true, j.clear(), ht.forEach((n) => j.add(n)), ht.clear(), wo(), Eo(), Re();
      }), o.querySelector("#sel-showall").addEventListener("click", () => {
        Y.clear(), H = false, j.clear(), Eo(), Re();
      }), o.querySelector("#sel-delete").addEventListener("click", () => {
        Do(), ht.forEach((n) => U.add(n)), ht.clear(), wo(), Eo(), Re();
    ...
    function rn() {
      var _a2;
      Yt = false, ht.clear(), wo(), fo && (fo.remove(), fo = null), (_a2 = Le.querySelector("#cad3d-select")) == null ? void 0 : _a2.classList.remove("inspect-active");
      const o = Ke();
    ...
    function Cs(t, o, n, l) {
      ...
      const s = l.x - n.x, d = l.y - n.y, a = l.z - n.z, r = Math.sqrt(s * s + d * d + a * a), p = Math.abs(s), i = Math.abs(d), c = Math.abs(a);
      let b = "";
      p > i && p > c ? b = `\u0394X=${s.toFixed(2)}` : i > p && i > c ? b = `\u0394Y=${d.toFixed(2)}` : c > 0.01 && (b = `\u0394Z=${a.toFixed(2)}`), Qt.textContent = `${r.toFixed(3)} m  ${b}`, Qt.style.left = t + 20 + "px", Qt.style.top = o - 10 + "px";
    }
    function Aa(t, o) {
      const l = e.nodes.val[o];
      if (!l) return null;
      const s = new Oe(l[0], l[1], l[2]), d = t.clone(), a = d.clone().sub(s), r = 0.3, p = Math.abs(a.x), i = Math.abs(a.y), c = Math.abs(a.z);
      return i < r && c < r && p > 0.01 ? new Oe(d.x, s.y, s.z) : p < r && c < r && i > 0.01 ? new Oe(s.x, d.y, s.z) : p < r && i < r && c > 0.01 ? new Oe(s.x, s.y, d.z) : null;
    }
    function cn() {
      var _a2;
      const t = Ke();
      Nt && t && (t.scene.remove(Nt), Nt.geometry.dispose(), Nt.material.dispose(), Nt = null), qt && t && (t.scene.remove(qt), qt.geometry.dispose(), qt.material.dispose(), qt = null), Hn(), vt = null, Zt = null, po = false, qo && (qo.remove(), qo = null), (_a2 = Le.querySelector("#cad3d-draw")) == null ? void 0 : _a2.classList.remove("inspect-active"), t == null ? void 0 : t.render();
    }
    function La() {
      qo && qo.remove();
      ...
      <button id="ds-node" style="${n(Et.node)}">Node</button>
      <button id="ds-grid" style="${n(Et.grid)}">Grid</button>
      <button id="ds-mid" style="${n(Et.midpoint)}">Mid</button>
      <button id="ds-track" style="${n(Et.track)}">Prolong</button>
      <span style="color:#666;margin:0 4px;">|</span>
    ...
    `, document.body.appendChild(t), qo = t;
      const l = () => {
        ...
        const p = t.querySelector("#ds-node"), i = t.querySelector("#ds-grid"), c = t.querySelector("#ds-mid"), b = t.querySelector("#ds-track");
        p && (p.style.cssText = n(Et.node)), i && (i.style.cssText = n(Et.grid)), c && (c.style.cssText = n(Et.midpoint)), b && (b.style.cssText = n(Et.track));
      };
      t.querySelector("#dt-line").addEventListener("click", () => {
        ...
        Et.track = !Et.track, Et.track || Hn(), l();
    ...
    function Fs(t, o, n, l) {
      const s = l.getBoundingClientRect(), d = (t - s.left) / s.width * 2 - 1, a = -((o - s.top) / s.height) * 2 + 1, r = new na();
      r.setFromCamera(new sa(d, a), n);
      const p = e.nodes.val, i = e.elements.val, c = 0.12;
      if (Et.node) {
        let $ = -1, y = 1 / 0;
        for (let f = 0; f < p.length; f++) {
          const h = p[f], I = new Oe(h[0], h[1], h[2]).project(n), A = Math.sqrt((I.x - d) ** 2 + (I.y - a) ** 2);
          A < c && A < y && (y = A, $ = f);
        }
        if ($ >= 0) return {
          nodeIdx: $,
      ...
      if (Et.midpoint) {
        ...
        for (const f of i) {
          ...
          const h = p[f[0]], I = p[f[1]], A = new Oe((h[0] + I[0]) / 2, (h[1] + I[1]) / 2, (h[2] + I[2]) / 2), z = A.clone().project(n), P = Math.sqrt((z.x - d) ** 2 + (z.y - a) ** 2);
          P < c * 0.8 && P < $ && ($ = P, y = A);
        }
        if (y) return {
          nodeIdx: null,
      ...
      if (Et.grid) {
        const $ = new Io(new Oe(0, 0, 1), 0), y = new Oe();
        if (r.ray.intersectPlane($, y)) {
          const f = Et.gridSize || _n;
      ...
      const b = new Io(new Oe(0, 0, 1), 0), S = new Oe();
    ...
    function Ps(t, o, n, l) {
      const s = [];
      for (let d = 0; d <= l; d++) {
        const a = d / l, r = o.clone().multiplyScalar(2).sub(t.clone().multiplyScalar(0.5)).sub(n.clone().multiplyScalar(0.5)), p = (1 - a) * (1 - a), i = 2 * (1 - a) * a, c = a * a;
        s.push(new Oe(p * t.x + i * r.x + c * n.x, p * t.y + i * r.y + c * n.y, p * t.z + i * r.z + c * n.z));
      }
      return s;
    }
    function jn(t) {
    ...
    function Ca(t) {
      ...
      if (jt === "arc") {
        ...
        if (o === vt || o === Zt) return;
        const n = e.nodes.val, l = new Oe(...n[vt]), s = new Oe(...n[Zt]), d = new Oe(...n[o]), a = Math.max(4, Math.round(((_a2 = Z.nSubViga) == null ? void 0 : _a2.val) ?? 8)), r = Ps(l, s, d, a);
        Do();
        const p = [
          ...e.nodes.val
        ], i = [
        ...
        e.nodes.val = p, e.elements.val = i, vo(), e.elementInputs.val = {
          ...e.elementInputs.val
        }, vt = o, Zt = null;
        return;
      }
      if (jt === "area") {
          ...
          try {
            ...
            for (const r of d.nodes) {
              ...
              for (let i = 0; i < n.length; i++) {
                const c = Math.abs(n[i][0] - r[0]), b = Math.abs(n[i][1] - r[1]), S = Math.abs(n[i][2] - r[2]);
                if (c < 0.01 && b < 0.01 && S < 0.01) {
                  p = i;
                  break;
                }
              }
            ...
            e.nodes.val = n, e.elements.val = l, vo(), console.log(`Area: ${d.elements.length} triangulos creados desde ${Xt.length} vertices`);
          } catch (d) {
        ...
        if (Xt.push(o), console.log(`Area vertex ${Xt.length}: node ${o}`), Xt.length >= 2) {
          const n = Xt[Xt.length - 2], l = e.nodes.val, s = Ke();
          if (s) {
    ...
    function Wn(t) {
      const o = Ke();
      if (!o) return -1;
      const n = o.renderer.domElement.getBoundingClientRect(), l = new sa((t.clientX - n.left) / n.width * 2 - 1, -((t.clientY - n.top) / n.height) * 2 + 1), s = new na();
      ...
      for (let b = 0; b < a.length; b++) {
        const S = a[b];
        if (S.length === 2) {
          const $ = new Oe(...d[S[0]]), y = new Oe(...d[S[1]]), f = new al($, y), h = new Oe(), I = new Oe();
          i.closestPointToPoint(f.getCenter(new Oe()), h), f.closestPointToPoint(h, true, I);
          const A = h.distanceTo(I);
          A < r && (r = A, p = b);
        } else if (S.length === 3) {
          const $ = new Oe(...d[S[0]]), y = new Oe(...d[S[1]]), f = new Oe(...d[S[2]]), h = new Oe();
          if (i.intersectTriangle($, y, f, false, h)) {
            const A = i.origin.distanceTo(h);
            A < r && (r = A, p = b);
          } else {
            const A = $.add(y).add(f).divideScalar(3), z = new Oe();
            i.closestPointToPoint(A, z);
            const P = z.distanceTo(A);
            P < r && (r = P, p = b);
          }
        } else if (S.length === 4) {
          const $ = new Oe(...d[S[0]]), y = new Oe(...d[S[1]]), f = new Oe(...d[S[2]]), h = new Oe(...d[S[3]]), I = new Oe();
    ...
    function Gn(t, o, n = 12) {
      ...
      for (let a = 0; a < l; a++) {
        ...
        for (let r = 0; r < s; r++) {
          const p = t[a][r], i = Math.abs(p) > 1e-10 ? "nonzero" : "";
    ...
    function Fa(t, o, n, l, s, d, a) {
      const r = 0.8333333333333334 * o, p = 5 / 6 * o, i = p > 0 && s > 0 ? 12 * t * n / (s * p * a ** 2) : 0, c = r > 0 && s > 0 ? 12 * t * l / (s * r * a ** 2) : 0, b = t * o / a, S = s * d / a, $ = 12 * t * n / a ** 3 / (1 + i), y = 6 * t * n / a ** 2 / (1 + i), f = 4 * t * n / a * (1 + i / 4) / (1 + i), h = 2 * t * n / a * (1 - i / 2) / (1 + i), I = i > 1e-10 || c > 1e-10;
      ...
      <div>${C("k", "z")} = ${De("4\xB7" + C("E") + "\xB7" + C("I", "z") + "\xB7(1+\u03C6/4)", C("L") + "\xB7(1+\u03C6<sub>z</sub>)")} = <span class="highlight">${Me(f)}</span> &nbsp;(flexi\xF3n diagonal)</div>
      ...
      <div>${De("4\xB7" + C("E") + "\xB7" + C("I", "z"), C("L"))} = <span class="highlight">${Me(f)}</span></div>
      `}
    </div>
    <div class="fem-eq">
    ...
    function Ra(t) {
      if (t.length === 2) {
        const n = xo(t[1], t[0]), l = Po(n), s = n[0] / l, d = n[1] / l, a = n[2] / l;
        return `<div class="fem-eq eq-box">
        <div style="text-align:left;margin-bottom:4px"><strong style="color:var(--fem-section-title)">Cosenos directores:</strong></div>
        <div>${C("l")} = cos(\u03B1) = ${De("\u0394x", C("L"))} = ${De(Me(n[0]), Me(l))} = <span class="highlight">${Me(s)}</span></div>
        <div>${C("m")} = cos(\u03B2) = ${De("\u0394y", C("L"))} = ${De(Me(n[1]), Me(l))} = <span class="highlight">${Me(d)}</span></div>
        <div>${C("n")} = cos(\u03B3) = ${De("\u0394z", C("L"))} = ${De(Me(n[2]), Me(l))} = <span class="highlight">${Me(a)}</span></div>
      </div>
      <div class="fem-eq">
    ...
    function Ns() {
      const t = "0", o = De(C("EA"), C("L")), n = De("\u2212" + C("EA"), C("L")), l = De("12" + C("EI", "z"), C("L") + "\xB3"), s = De("\u221212" + C("EI", "z"), C("L") + "\xB3"), d = De("12" + C("EI", "y"), C("L") + "\xB3"), a = De("\u221212" + C("EI", "y"), C("L") + "\xB3"), r = De("6" + C("EI", "z"), C("L") + "\xB2"), p = De("\u22126" + C("EI", "z"), C("L") + "\xB2"), i = De("6" + C("EI", "y"), C("L") + "\xB2"), c = De("\u22126" + C("EI", "y"), C("L") + "\xB2"), b = De(C("GJ"), C("L")), S = De("\u2212" + C("GJ"), C("L")), $ = De("4" + C("EI", "z"), C("L")), y = De("2" + C("EI", "z"), C("L")), f = De("4" + C("EI", "y"), C("L")), h = De("2" + C("EI", "y"), C("L")), I = '<span style="color:var(--fem-eq-dots);font-style:italic">sym</span>', A = [
        "P\u2081",
        "P\u2082",
        "P\u2083",
        "P\u2084",
    ...
    function qs(t) {
      ...
      Kt && Kt.remove();
      const o = e.nodes.val, n = e.elements.val, l = n[t], s = l.map((m) => o[m]), d = l.length === 2, a = ((_a2 = e.elementInputs) == null ? void 0 : _a2.val) || {}, r = (_b = e.deformOutputs) == null ? void 0 : _b.val, p = (_c = e.analyzeOutputs) == null ? void 0 : _c.val;
      var i = "";
      if (d) {
        const m = Po(xo(s[1], s[0])), u = ((_d = a.elasticities) == null ? void 0 : _d.get(t)) ?? 0, E = ((_e2 = a.areas) == null ? void 0 : _e2.get(t)) ?? 0, L = ((_f = a.momentsOfInertiaZ) == null ? void 0 : _f.get(t)) ?? 0, O = ((_g = a.momentsOfInertiaY) == null ? void 0 : _g.get(t)) ?? 0, W = ((_h = a.shearModuli) == null ? void 0 : _h.get(t)) ?? 0, x = ((_i = a.torsionalConstants) == null ? void 0 : _i.get(t)) ?? 0, w = ((_j = a.momentReleases) == null ? void 0 : _j.get(t)) || [], v = ((_k = a.partialFixitySprings) == null ? void 0 : _k.get(t)) || [], F = [
          "P (Axial)",
          "V2 (Corte)",
          "V3 (Corte)",
          "T (Torsi\xF3n)",
        ...
        `${l.length}${l.join(", ")}${Me(m)}${Me(L)}${Me(u)}${Me(E)}`, O && (i = `<div class="fem-eq eq-box">
      ...
      try {
        if (I = vn(s, a, t), A = yn(s), z = no(ns(A), no(I, A)), P = d ? [
          "ux\u2080",
          "uy\u2080",
          "uz\u2080",
          "\u03B8x\u2080",
          ...
          const L = Po(xo(s[1], s[0])), O = ((_o2 = a.elasticities) == null ? void 0 : _o2.get(t)) ?? 0, W = ((_p = a.areas) == null ? void 0 : _p.get(t)) ?? 0, x = ((_q = a.momentsOfInertiaZ) == null ? void 0 : _q.get(t)) ?? 0, w = ((_r = a.momentsOfInertiaY) == null ? void 0 : _r.get(t)) ?? 0, v = ((_s2 = a.shearModuli) == null ? void 0 : _s2.get(t)) ?? 0, F = ((_t = a.torsionalConstants) == null ? void 0 : _t.get(t)) ?? 0;
          i = Fa(O, W, x, w, v, F, L);
        }
        $ = Ra(s), y = Pa(), f = Oa(l), h = Na(d);
        ...
        c = `<div class="matrix-label">k_local (${I.length}\xD7${I.length}) ${m}</div>${Gn(I, P)}`, b = `<div class="matrix-label">T \u2014 Transformaci\xF3n (${A.length}\xD7${A.length}) ${u}</div>${Gn(A, P)}`, S = `<div class="matrix-label">K_global = T^T \xB7 k \xB7 T ${E}</div>${Gn(z, P)}`;
      } catch (m) {
      ...
      `${l[0]}`, 6 * l[0], 6 * l[0] + 5, `${l[1]}`, 6 * l[1], 6 * l[1] + 5, l.length === 3 && (`${l[2]}`, 6 * l[2], 6 * l[2] + 5), o.length * 6, o.length * 6, Kt = vl(t, o, n, a, r, p), Kt.id = "fem-inspect-panel", document.body.appendChild(Kt), (_N = Kt.querySelector("#er-close")) == null ? void 0 : _N.addEventListener("click", () => Ao()), (_O = Kt.querySelector("#rel-apply")) == null ? void 0 : _O.addEventListener("click", () => {
      ...
      const k = d ? (() => {
        var _a3, _b2, _c2, _d2, _e3, _f2;
        const m = Po(xo(s[1], s[0])), u = ((_a3 = a.elasticities) == null ? void 0 : _a3.get(t)) ?? 0, E = ((_b2 = a.areas) == null ? void 0 : _b2.get(t)) ?? 0, L = ((_c2 = a.momentsOfInertiaZ) == null ? void 0 : _c2.get(t)) ?? 0, O = ((_d2 = a.momentsOfInertiaY) == null ? void 0 : _d2.get(t)) ?? 0, W = ((_e3 = a.shearModuli) == null ? void 0 : _e3.get(t)) ?? 0, x = ((_f2 = a.torsionalConstants) == null ? void 0 : _f2.get(t)) ?? 0;
      ...
      Kt.querySelectorAll("[data-full]").forEach((m) => {
        m.addEventListener("click", (u) => {
          ...
          if (E === "kLocal" && I) {
            ...
            Jn(`Elemento ${t} \u2014 Rigidez Local k_local`, L, Yn(I, P), k);
          } else if (E === "T" && A) Jn(`Elemento ${t} \u2014 Transformaci\xF3n T`, $, Yn(A, P));
          else if (E === "kGlobal" && z) {
            const L = d ? Ns() : "<em>Shell 18\xD718</em>";
            Jn(`Elemento ${t} \u2014 Rigidez Global K = T^T \xB7 k \xB7 T`, L, Yn(z, P), k);
          }
        });
      });
    }
    function _s() {
      ...
      const p = 2e8, i = 77e6, c = 5e-3, b = 2e-6, S = 1e-6, $ = {
    ...
    function Ds() {
      ...
      const r = 2e8, p = 77e6, i = 0.01, c = 5e-6, b = 2e-6, S = {
    ...
    function Hs() {
      ...
      const c = 2e8, b = 77e6, S = 8e-3, $ = 1e-5, y = 5e-6, f = {
    ...
    function js() {
      ...
      const i = 35e6, c = 14e6, b = 0.02, S = 5e-5, $ = 2e-5, y = {
    ...
    function Ws() {
      ...
      const a = 35e6, r = 0.2, p = 0.15, i = a / (2 * (1 + r)), c = {
      ...
      setTimeout(() => wt(), 50), Qe(), console.log(`Sydney Opera: ${t.length} nodos, ${o.length} shells Q4, 3 velas`);
    }
    function Gs() {
      const l = [], s = [];
      for (let y = 0; y <= 15; y++) {
      ...
      const p = 2e8, i = 77e6, c = 6e-3, b = 8e-6, S = 4e-6, $ = {
        elasticities: new Map(s.map((y, f) => [
          f,
          p
        ])),
    ...
    function Vn() {
      ...
      const t = M, o = ((_a2 = Z.W) == null ? void 0 : _a2.val) ?? 5, n = ((_b = Z.H) == null ? void 0 : _b.val) ?? 3, l = ((_c = Z.t) == null ? void 0 : _c.val) ?? 0.2, s = Math.round(((_d = Z.nx) == null ? void 0 : _d.val) ?? 8), d = Math.round(((_e2 = Z.ny) == null ? void 0 : _e2.val) ?? 6), a = ((_f = Z.E) == null ? void 0 : _f.val) ?? 25e6, r = ((_g = Z.nu) == null ? void 0 : _g.val) ?? 0.2, p = ((_h = Z.P) == null ? void 0 : _h.val) ?? 100, i = a / (2 * (1 + r)), c = o / s, b = n / d, S = [], $ = [], y = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map();
      for (let k = 0; k <= d; k++) for (let m = 0; m <= s; m++) S.push([
        m * c,
        0,
        k * b
      ]);
      const h = s + 1;
      for (let k = 0; k < d; k++) for (let m = 0; m < s; m++) $.push([
        k * h + m,
        k * h + m + 1,
        (k + 1) * h + m + 1,
        (k + 1) * h + m
      ...
      const I = [];
      for (let k = 0; k <= s; k++) I.push(d * h + k);
      const A = p / I.length;
      ...
      try {
        ...
        if (k && e.deformOutputs) {
          ...
          const u = d * h + Math.floor(s / 2), E = k.deformations.get(u), L = E ? E[0] : 0;
    ...
    function Ys() {
      var _a2, _b, _c, _d, _e2, _f, _g, _h;
      const t = M, o = ((_a2 = Z.L) == null ? void 0 : _a2.val) ?? 6, n = ((_b = Z.h) == null ? void 0 : _b.val) ?? 0.5, l = ((_c = Z.t) == null ? void 0 : _c.val) ?? 0.2, s = Math.round(((_d = Z.nx) == null ? void 0 : _d.val) ?? 12), d = Math.round(((_e2 = Z.ny) == null ? void 0 : _e2.val) ?? 4), a = ((_f = Z.E) == null ? void 0 : _f.val) ?? 25e6, r = ((_g = Z.nu) == null ? void 0 : _g.val) ?? 0.2, p = ((_h = Z.P) == null ? void 0 : _h.val) ?? 50, i = a / (2 * (1 + r)), c = o / s, b = n / d, S = [], $ = [], y = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map();
      for (let P = 0; P <= d; P++) for (let k = 0; k <= s; k++) S.push([
        k * c,
        P * b,
        0
      ]);
      const h = s + 1;
      for (let P = 0; P < d; P++) for (let k = 0; k < s; k++) $.push([
        P * h + k,
        P * h + k + 1,
        (P + 1) * h + k + 1,
        (P + 1) * h + k
      ]);
      for (let P = 0; P <= d; P++) y.set(P * h, [
        true,
        true,
        true,
        true,
      ...
      try {
        ...
        if (P && e.deformOutputs) {
          ...
          const m = P.deformations.get(I), u = m ? m[2] : 0, E = l * n * n * n / 12, L = p * o * o * o / (3 * a * E);
    ...
    function Js() {
      var _a2, _b, _c, _d, _e2, _f, _g, _h;
      const t = M, o = ((_a2 = Z.Lx) == null ? void 0 : _a2.val) ?? 4, n = ((_b = Z.Lz) == null ? void 0 : _b.val) ?? 2, l = ((_c = Z.t) == null ? void 0 : _c.val) ?? 0.15, s = Math.round(((_d = Z.nx) == null ? void 0 : _d.val) ?? 8), d = Math.round(((_e2 = Z.nz) == null ? void 0 : _e2.val) ?? 4), a = ((_f = Z.E) == null ? void 0 : _f.val) ?? 25e6, r = ((_g = Z.nu) == null ? void 0 : _g.val) ?? 0.2, p = ((_h = Z.P) == null ? void 0 : _h.val) ?? 20, i = a / (2 * (1 + r)), c = o / s, b = n / d, S = [], $ = [], y = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map();
      for (let k = 0; k <= d; k++) for (let m = 0; m <= s; m++) S.push([
        m * c,
        0,
        k * b
      ...
      const I = [];
      for (let k = 0; k <= d; k++) I.push(k * h + s);
      const A = p / I.length;
      for (const k of I) f.set(k, [
        0,
        0,
      ...
      try {
        ...
        if (k && e.deformOutputs) {
          ...
          const m = go(S, $, z, k);
          e.analyzeOutputs && (e.analyzeOutputs.val = m);
          const u = (d / 2 | 0) * h + s, E = k.deformations.get(u), L = E ? E[2] : 0;
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        }, n = o("po-colB"), l = o("po-colH"), s = o("po-fc") * 1e3, d = o("po-fy") * 1e3, a = o("po-H"), r = o("po-L"), p = o("po-As") * 1e-4, i = o("po-nbar"), c = o("po-drift") / 100, b = o("po-ncycles"), S = t.querySelector("#pushover-status");
        ...
        try {
          ...
          S.textContent = `Completado: ${I.nSteps} pasos`, Ba(t.querySelector("#pushover-canvas"), I.displacements, I.forces, `Pushover: ${n * 100}x${l * 100}cm, f'c=${s / 1e3}MPa, Fy=${d / 1e3}MPa`);
        } catch (h) {
    ...
    function Ba(t, o, n, l) {
      ...
      const d = t.width, a = t.height, r = {
        ...
        top: 30,
        bottom: 35
      }, p = d - r.left - r.right, i = a - r.top - r.bottom;
      s.fillStyle = "#111118", s.fillRect(0, 0, d, a);
      let c = Math.min(...o), b = Math.max(...o), S = Math.min(...n), $ = Math.max(...n);
      c === b && (c -= 0.01, b += 0.01), S === $ && (S -= 1, $ += 1);
      const y = b - c, f = $ - S, h = (P) => r.left + (P - c) / y * p, I = (P) => r.top + i - (P - S) / f * i;
      s.strokeStyle = "#333", s.lineWidth = 0.5, c < 0 && b > 0 && (s.strokeStyle = "#555", s.beginPath(), s.moveTo(h(0), r.top), s.lineTo(h(0), r.top + i), s.stroke()), S < 0 && $ > 0 && (s.beginPath(), s.moveTo(r.left, I(0)), s.lineTo(r.left + p, I(0)), s.stroke()), s.strokeStyle = "#ff4444", s.lineWidth = 1.5, s.beginPath(), s.moveTo(h(o[0]), I(n[0]));
      for (let P = 1; P < o.length; P++) s.lineTo(h(o[P]), I(n[P]));
    ...
    function ja(t) {
      const o = parseFloat(t.querySelector("#nl-fy").value), n = parseFloat(t.querySelector("#nl-e0").value), l = parseFloat(t.querySelector("#nl-b").value), s = parseFloat(t.querySelector("#nl-r0").value), d = parseFloat(t.querySelector("#nl-amp").value), a = parseInt(t.querySelector("#nl-cycles").value), r = 100, p = [];
      for (let V = 0; V < a; V++) {
        const ae = d * (1 + V * 0.5);
        for (let Q = 0; Q < r; Q++) {
      ...
      const i = o / n, c = l * n;
      let b = 0, S = 0, $ = -i, y = i, f = 0, h = 0, I = 0, A = 0, z = 0, P = 0;
      const k = [];
      for (const V of p) {
        let ae = $, Q = y, K = f, pe = h, ce = I, Ie = A, Pe = z, _ = P, ue;
        const ne = V - b;
        if (Math.abs(ne) < 1e-20) {
          k.push(S);
          continue;
        }
        if ((_ === 0 || _ === 3) && (ne < 0 ? (_ = 2, pe = -i, ce = -o, K = pe, Ie = 0, Pe = 0) : (_ = 1, pe = i, ce = o, K = pe, Ie = 0, Pe = 0)), _ === 2 && ne > 0) {
          _ = 1, Ie = b, Pe = S, b < ae && (ae = b);
          const Se = (Q - ae) / (2 * 1 * i), je = 1 + 0 * Math.pow(Se, 0.8);
          pe = (o * je - c * i * je - Pe + n * Ie) / (n - c), ce = o * je + c * (pe - i * je), K = Q;
        } else if (_ === 1 && ne < 0) {
          _ = 2, Ie = b, Pe = S, b > Q && (Q = b);
          const Se = (Q - ae) / (2 * 1 * i), je = 1 + 0 * Math.pow(Se, 0.8);
          pe = (-o * je + c * i * je - Pe + n * Ie) / (n - c), ce = -o * je + c * (pe + i * je), K = ae;
        }
        const fe = Math.abs((K - pe) / i);
        let ee = s - 0.925 * fe / (0.15 + fe);
        ee < 0.1 && (ee = 0.1);
        const me = (V - Ie) / (pe - Ie), we = 1 + Math.pow(Math.abs(me), ee), se = Math.pow(we, 1 / ee);
        ue = l * me + (1 - l) * me / se, ue = ue * (ce - Pe) + Pe, k.push(ue), b = V, S = ue, $ = ae, y = Q, f = K, h = pe, I = ce, A = Ie, z = Pe, P = _;
      }
    ...
    function Ya(t) {
      ...
      const l = o[n[0]], s = o[n[1]], d = Math.abs(s[0] - l[0]), a = Math.abs(s[1] - l[1]), r = Math.abs(s[2] - l[2]), p = a > d && a > r, i = Math.sqrt(d * d + a * a + r * r), c = $e.get(t) ?? 0, b = (_c = (_b = (_a2 = e.elementInputs) == null ? void 0 : _a2.val) == null ? void 0 : _b.sectionShapes) == null ? void 0 : _c.get(t), S = (b == null ? void 0 : b.name) || (b ? `${b.type} ${((b.b ?? 0) * 100).toFixed(0)}x${((b.h ?? 0) * 100).toFixed(0)}` : "\u2014"), $ = document.createElement("div");
    ...
    setTimeout(() => {
      ...
      function d(p) {
        const i = Ke();
        if (!i) return null;
        const c = i.controls.object, b = new Oe(p[0], p[1], p[2]);
        b.project(c);
      ...
      function a(p, i, c, b, S) {
        const $ = Math.min(p, c), y = Math.max(p, c), f = Math.min(i, b), h = Math.max(i, b), I = e.nodes.val, A = e.elements.val, z = [];
        for (let P = 0; P < A.length; P++) {
          const k = A[P], m = k.map((u) => d(I[u])).filter(Boolean);
          if (m.length !== 0) if (S) m.every((E) => E.x >= $ && E.x <= y && E.y >= f && E.y <= h) && z.push(P);
            ...
            if (k.length === 2) {
              const E = m[0], L = m[1];
              r(E.x, E.y, L.x, L.y, $, f, y, h) && z.push(P);
            }
          }
        }
        return z;
      }
      function r(p, i, c, b, S, $, y, f) {
        const h = (A, z) => A >= S && A <= y && z >= $ && z <= f;
        if (h(p, i) || h(c, b)) return true;
        ...
        return I(p, i, c, b, S, $, y, $) || I(p, i, c, b, y, $, y, f) || I(p, i, c, b, S, f, y, f) || I(p, i, c, b, S, $, S, f);
      }
      o.addEventListener("mousedown", (p) => {
        ...
        if (po) {
          const c = Ke();
          if (!c) return;
          const b = Fs(p.clientX, p.clientY, c.camera, c.rendererElm);
          if (Et.track && b.snapType === "node" && b.nodeIdx !== null && b.nodeIdx !== zo && za(b.nodeIdx), Et.track && zo !== null && b.worldPos && b.snapType !== "node") {
            const S = Aa(b.worldPos, zo);
            S && (b.worldPos = S, b.snapType = "grid");
          }
          if (zo !== null && b.worldPos) {
            const S = e.nodes.val[zo];
            S && Cs(p.clientX, p.clientY, new Oe(...S), b.worldPos);
        ...
        if (!oo && !Yt) return;
        if (Yt && n) {
          const c = p.offsetX - n.x, b = p.offsetY - n.y;
          if (Math.abs(c) > s || Math.abs(b) > s) {
            ...
            const S = c > 0, $ = Math.min(n.x, p.offsetX), y = Math.min(n.y, p.offsetY), f = Math.abs(c), h = Math.abs(b);
        ...
        if (Yt && n) {
          ...
          if (Math.abs(i) > s || Math.abs(c) > s) {
            const b = i > 0, S = a(n.x, n.y, p.offsetX, p.offsetY, b);
            p.ctrlKey || p.metaKey || (ht.clear(), wo()), S.forEach((y) => {
        ...
        if (po) {
          const i = Ke();
          if (!i) return;
          const c = Fs(p.clientX, p.clientY, i.camera, i.rendererElm);
      ...
      if (t === void 0 && (t = !qe), qe = t, (_a2 = Le.querySelector("#cad3d-modal")) == null ? void 0 : _a2.classList.toggle("active", qe), qe) {
        const n = Ke();
        ((_b = n == null ? void 0 : n.settings) == null ? void 0 : _b.loads) && (_e = n.settings.loads.rawVal, n.settings.loads.val = false), Ln(), Le.querySelector("#cad3d-mode-prev").style.display = "", Le.querySelector("#cad3d-mode-next").style.display = "", Le.querySelector("#cad3d-mode-label").style.display = "";
      } else Cn(), Le.querySelector("#cad3d-mode-prev").style.display = "none", Le.querySelector("#cad3d-mode-next").style.display = "none", Le.querySelector("#cad3d-mode-label").style.display = "none", T && T !== "placa-q4" && T !== "placa-3q" && Re(), setTimeout(() => {
        var _a3;
        const n = Ke();
      ...
      const o = Ae.modeShapes[he], { extent: n } = yo();
      let l = 0;
      for (let d = 0; d < ke.length; d++) {
        const a = o[d * 6] || 0, r = o[d * 6 + 1] || 0, p = o[d * 6 + 2] || 0;
      ...
      e.nodes.val.length === 0 && (et("muro-q4"), Vn(), Ts("muro-q4"), setTimeout(() => {
        T === "muro-q4" && so();
      }, 200));
    }, 100);
