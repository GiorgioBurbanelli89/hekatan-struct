...
import { m as j, t as Xe, s as pe, d as de, n as ye, c as J, b as Je } from "./pureFunctionsAny.generated-BHh0zpCc.js";
let yr;
let __tla = (async () => {
  function Ke(n) {
  ...
  (function(n, t) {
    var o = function() {
      ...
      return typeof __filename < "u" && (s = s || __filename), function(r) {
        ...
        var P = function(e, i) {
          throw i;
        }, I = false, p = false, x = false, ee = false;
        I = typeof window == "object", p = typeof importScripts == "function", x = typeof process == "object" && typeof process.versions == "object" && typeof process.versions.node == "string", ee = !I && !x && !p;
        var v = "";
        function be(e) {
          return r.locateFile ? r.locateFile(e, v) : v + e;
        }
        var L, N, z, G;
        x ? (p ? v = K.dirname(v) + "/" : v = __dirname + "/", L = function(i, a) {
          ...
          quit(e);
        }), typeof print < "u" && (typeof console > "u" && (console = {}), console.log = print, console.warn = console.error = typeof printErr < "u" ? printErr : print)) : (I || p) && (p ? v = self.location.href : document.currentScript && (v = document.currentScript.src), s && (v = s), v.indexOf("blob:") !== 0 ? v = v.substr(0, v.lastIndexOf("/") + 1) : v = "", L = function(i) {
        ...
        function ne(e, i, a) {
          for (var h = i + a, A = i; e[A] && !(A >= h); ) ++A;
          if (A - i > 16 && e.subarray && te) return te.decode(e.subarray(i, A));
          for (var g = ""; i < A; ) {
            var l = e[i++];
            if (!(l & 128)) {
            ...
            var b = e[i++] & 63;
            if ((l & 240) == 224 ? l = (l & 15) << 12 | f << 6 | b : l = (l & 7) << 18 | f << 12 | b << 6 | e[i++] & 63, l < 65536) g += String.fromCharCode(l);
            else {
              var ge = l - 65536;
        ...
        function Re(e, i, a, h) {
          if (!(h > 0)) return 0;
          for (var A = a, g = a + h - 1, l = 0; l < e.length; ++l) {
            var f = e.charCodeAt(l);
            if (f >= 55296 && f <= 57343) {
              var b = e.charCodeAt(++l);
              f = 65536 + ((f & 1023) << 10) | b & 1023;
            }
            if (f <= 127) {
              if (a >= g) break;
              i[a++] = f;
        ...
        function qe() {
          return !U && (I || p) && typeof fetch == "function" && !le(R) ? fetch(R, {
        ...
        function De() {
          ...
          function A() {
            if (!U && typeof WebAssembly.instantiateStreaming == "function" && !ue(R) && !le(R) && typeof fetch == "function") fetch(R, {
              ...
              return f.then(a, function(b) {
                return F("wasm streaming compile failed: " + b), F("falling back to ArrayBuffer instantiation"), h(a);
              });
            });
            else return h(a);
          }
        ...
        function Ge(e, i, a, h) {
          for (var A = 0, g = 0; g < a; g++) {
            for (var l = T[i + g * 8 >> 2], f = T[i + (g * 8 + 4) >> 2], b = 0; b < f; b++) W.printChar(e, H[l + b]);
            A += f;
          }
          return T[h >> 2] = A, 0;
        }
  ...
  }, nr = (n, t) => n.constructor == t ? n : new t(n), Ae = (n, t, o = null) => {
  ...
  class C {
    ...
    constructor(t = {}) {
      this.ptr = c._malloc(C.LENGTH * Int32Array.BYTES_PER_ELEMENT), this.arr = d(this.ptr, C.LENGTH), this.arr.set(new Int32Array(C.LENGTH));
    ...
    get pointlist() {
      return d(this.arr[0], this.numberofpoints * 2, Float64Array);
    }
    get pointattributelist() {
      return d(this.arr[1], this.numberofpointattributes * this.numberofpoints, Float64Array);
    }
    get pointmarkerlist() {
      return d(this.arr[2], this.numberofpoints);
    }
    get numberofpoints() {
      return this.arr[3];
    }
    ...
    get trianglelist() {
      return d(this.arr[5], this.numberoftriangles * this.numberofcorners);
    }
    get triangleattributelist() {
      return d(this.arr[6], this.numberoftriangleattributes * this.numberoftriangles, Float64Array);
    }
    get trianglearealist() {
      return d(this.arr[7], this.numberoftriangles, Float64Array);
    }
    get neighborlist() {
      return d(this.arr[8], this.numberoftriangles * 3);
    }
    ...
    get segmentlist() {
      return d(this.arr[12], this.numberofsegments * 2);
    }
    get segmentmarkerlist() {
      return d(this.arr[13], this.numberofsegments);
    }
    get numberofsegments() {
      return this.arr[14];
    }
    get holelist() {
      return d(this.arr[15], this.numberofholes * 2, Float64Array);
    }
    get numberofholes() {
      return this.arr[16];
    }
    get regionlist() {
      return d(this.arr[17], this.numberofregions * 4, Float64Array);
    }
    get numberofregions() {
      return this.arr[18];
    }
    get edgelist() {
      return d(this.arr[19], this.numberofedges * 2);
    }
    get edgemarkerlist() {
      return d(this.arr[20], this.numberofedges);
    }
    get normlist() {
      return d(this.arr[21], this.numberofedges * 2, Float64Array);
    }
    get numberofedges() {
      return this.arr[22];
    }
  ...
  const ir = (n) => new Promise((t, o) => {
    ...
    const u = Ae(n, t, s), r = tr(u), m = s ? s.ptr : null;
  ...
  await O.init(ur);
  yr = function({ points: n, polygon: t, maxMeshSize: o = 3 }) {
    ...
    const s = n.slice(0, 3);
    gr(t, n) > 0 && s.reverse();
    const u = hr(s), r = n.map((p) => j(Xe(u), p)).map((p) => [
      p[0],
      p[1]
    ]), m = O.makeIO({
      pointlist: r.flat(),
    ...
    const { nodes: _, boundaryIndices: w } = mr(E.pointlist, E.pointmarkerlist), P = _.map((p) => j(u, [
      p[0],
      p[1],
      0
    ])), I = cr(E.trianglelist);
  ...
  function hr([n, t, o]) {
    const s = pe(t, n), u = pe(o, n), r = de(s, ye(s));
    let m = de(J(s, u), ye(J(s, u)));
    Je(m, [
      0,
      0,
      1
