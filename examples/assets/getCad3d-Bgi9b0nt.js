...
import { _ as Zs, p as En, m as Qs, d as Ot, s as ea, __tla as __tla_0 } from "./plateQ4Cpp-Duau68tz.js";
import { v as ko, P as Ho, g as ta, a as oa, o as na } from "./theme-CzzIlc4y.js";
import { V as Se, P as lo, R as vs, b as ys, B as io, c as sa, d as kn, e as Ao, f as aa, S as la, M as ia, g as ra, F as uo, a as Fo, L as Bo, h as ca, G as da, A as Do, i as In, T as zn, j as jo, k as Wo, C as pa, l as fa } from "./Text-Cin90tvN.js";
import { g as Ko, b as Uo, a as Eo } from "./analyze-B6dp1uvy.js";
import { g as Ut, __tla as __tla_1 } from "./getMesh-Ch3239Ot.js";
import { n as ho, s as Zt, m as Rt, t as Fn } from "./pureFunctionsAny.generated-BHh0zpCc.js";
let ws, ha, Ga;
let __tla = Promise.all([
  ...
  function bo(e, g) {
    const N = An.find((Y) => Y.id === e), S = Io.find((Y) => Y.id === g), W = N.toKN, R = S.toM, G = (Y, me, z) => z / (Math.pow(W, Y) * Math.pow(R, me));
    let D, B;
    switch (e) {
      case "kN":
        D = 10, B = [
...
<tr style="color:#ff0; border-bottom:1px solid #ff03">
  ...
  <th style="padding:2px 5px; color:#0ff">\u03A3Rz</th></tr>`, S.frequencies.forEach((B, Y) => {
        var _a3;
        const me = B > 0 ? 1 / B : 0, z = B * 2 * Math.PI, V = ((_a3 = S.massParticipation) == null ? void 0 : _a3[Y]) || [
          0,
          0,
          0,
          0,
        ...
        for (let he = 0; he < 6; he++) G[he] += V[he];
  ...
  <td style="padding:2px 6px; text-align:right">${z.toFixed(2)}</td>`;
        for (let he = 0; he < 6; he++) {
          const le = (V[he] * 100).toFixed(1), X = V[he] > 0.5 ? "#f00" : V[he] > 0.1 ? "#ff0" : "#0f0";
  ...
  <td style="padding:2px 5px; text-align:right; color:#0ff">${(G[5] * 100).toFixed(1)}%</td></tr>`;
      ...
      (_a2 = e.querySelector("#modal-minimize")) == null ? void 0 : _a2.addEventListener("click", () => {
        ...
        S.frequencies.forEach((V, he) => {
          var _a3;
          const le = V > 0 ? 1 / V : 0, X = V * 2 * Math.PI, Z = ((_a3 = S.massParticipation) == null ? void 0 : _a3[he]) || [
            0,
            0,
            0,
            0,
          ...
          for (let Ie = 0; Ie < 6; Ie++) me[Ie] += Z[Ie];
          const ce = Z.map((Ie) => ((Ie * 100).toFixed(1) + "%").padStart(6)).join(" ");
          B.push(`${String(he + 1).padStart(4)}  ${V.toFixed(4).padStart(9)}  ${le.toFixed(4).padStart(9)}  ${X.toFixed(2).padStart(9)}  ${ce}  ${(me[0] * 100).toFixed(1).padStart(5)}%  ${(me[1] * 100).toFixed(1).padStart(5)}%  ${(me[5] * 100).toFixed(1).padStart(5)}%`);
...
`));
  ...
  const ue = 64516e-8, L = 416231e-12, H = 0.0254, ro = [
    {
      name: "W6x9",
      type: "W",
      A: 2.68 * ue,
  ...
  function ga(e) {
    ...
    const { nodes: g, elements: N, elementInputs: S, nodeInputs: W, deformOutputs: R } = e, G = g.length * 6, D = N.length, B = N.filter((X) => X.length === 2).length, Y = N.filter((X) => X.length >= 3).length, me = document.createElement("div");
    ...
    z += '<button class="rpt-close" id="rpt-close">\u2715 Close</button>', z += "<h1>Finite Element Analysis \u2014 Step-by-Step Report</h1>", z += '<div class="rpt-subtitle">Complete FEM derivation from element formulation to final results</div>', z += '<hr class="rpt-sep"/>', z += "<h2>1. Input Data</h2>", z += '<table class="rpt-info"><tbody>', z += `<tr><td>Number of nodes</td><td class="val">${g.length}</td></tr>`, z += `<tr><td>Number of elements</td><td class="val">${D} (${B} frames, ${Y} shells)</td></tr>`, z += '<tr><td>DOFs per node</td><td class="val">6 (u<sub>x</sub>, u<sub>y</sub>, u<sub>z</sub>, \u03B8<sub>x</sub>, \u03B8<sub>y</sub>, \u03B8<sub>z</sub>)</td></tr>', z += `<tr><td>Total DOFs</td><td class="val">${G}</td></tr>`, z += "</tbody></table>", z += "<h3>1.1 Node Coordinates</h3>", z += '<table class="rpt-data"><thead><tr><th>Node</th><th>x</th><th>y</th><th>z</th></tr></thead><tbody>', g.forEach((X, Z) => {
      z += `<tr><td>${Z}</td><td>${Ge(X[0])}</td><td>${Ge(X[1])}</td><td>${Ge(X[2])}</td></tr>`;
      ...
      var _a3, _b2, _c2, _d2;
      const ce = X.length === 2, Ie = X.map((ze) => g[ze]), Fe = ce ? ho(Zt(Ie[1], Ie[0])) : 0, Ce = ((_a3 = S.elasticities) == null ? void 0 : _a3.get(Z)) ?? 0, Be = ((_b2 = S.areas) == null ? void 0 : _b2.get(Z)) ?? 0, ot = ((_c2 = S.momentsOfInertiaZ) == null ? void 0 : _c2.get(Z)) ?? 0, de = ((_d2 = S.momentsOfInertiaY) == null ? void 0 : _d2.get(Z)) ?? 0;
      z += `<tr><td>${Z}</td><td>${ce ? "Frame" : "Shell"}</td><td>${X.join(" \u2192 ")}</td>`, z += `<td>${Ge(Fe)}</td><td>${Ge(Ce)}</td><td>${Ge(Be)}</td><td>${Ge(ot)}</td><td>${Ge(de)}</td></tr>`;
    ...
    for (let X = 0; X < D; X++) {
      const Z = N[X], ce = Z.map((At) => g[At]);
      if (!(Z.length === 2)) continue;
      const Fe = ho(Zt(ce[1], ce[0])), Ce = ((_a2 = S.elasticities) == null ? void 0 : _a2.get(X)) ?? 0, Be = ((_b = S.areas) == null ? void 0 : _b.get(X)) ?? 0, ot = ((_c = S.momentsOfInertiaZ) == null ? void 0 : _c.get(X)) ?? 0, de = ((_d = S.momentsOfInertiaY) == null ? void 0 : _d.get(X)) ?? 0, ze = ((_e = S.shearModuli) == null ? void 0 : _e.get(X)) ?? 0, Pe = ((_f = S.torsionalConstants) == null ? void 0 : _f.get(X)) ?? 0;
      let tt = null, Je = null, Ve = null;
      try {
        tt = Ko(ce, S, X), Je = Uo(ce), Ve = Rt(Fn(Je), Rt(tt, Je));
      } catch {
        continue;
      }
      const yt = Zt(ce[1], ce[0]), zt = yt[0] / Fe, ht = yt[1] / Fe, wt = yt[2] / Fe;
      z += '<div class="rpt-elem-block">', z += `<h3 class="rpt-elem-title" data-toggle="elem${X}">\u25B6 Element ${X} \u2014 Nodes ${Z[0]} \u2192 ${Z[1]}, L = ${Ge(Fe)}</h3>`, z += `<div id="rpt-elem${X}" class="rpt-elem-body" style="display:none">`, z += "<h4>Properties (numerical substitution)</h4>", z += '<div class="rpt-eq-small">', z += `E = ${Ge(Ce)} &nbsp;&nbsp; A = ${Ge(Be)} &nbsp;&nbsp; I<sub>z</sub> = ${Ge(ot)} &nbsp;&nbsp; I<sub>y</sub> = ${Ge(de)} &nbsp;&nbsp; G = ${Ge(ze)} &nbsp;&nbsp; J = ${Ge(Pe)}<br/>`, z += `EA/L = ${Ge(Ce)}\xB7${Ge(Be)}/${Ge(Fe)} = <b>${Ge(Ce * Be / Fe)}</b><br/>`, z += `12EI<sub>z</sub>/L\xB3 = 12\xB7${Ge(Ce)}\xB7${Ge(ot)}/${Ge(Fe)}\xB3 = <b>${Ge(12 * Ce * ot / Fe ** 3)}</b><br/>`, z += `12EI<sub>y</sub>/L\xB3 = 12\xB7${Ge(Ce)}\xB7${Ge(de)}/${Ge(Fe)}\xB3 = <b>${Ge(12 * Ce * de / Fe ** 3)}</b><br/>`, z += `GJ/L = ${Ge(ze)}\xB7${Ge(Pe)}/${Ge(Fe)} = <b>${Ge(ze * Pe / Fe)}</b>`, z += "</div>", z += "<h4>Direction cosines</h4>", z += `<div class="rpt-eq-small">l = ${Vo(zt)}, m = ${Vo(ht)}, n = ${Vo(wt)}, D = ${Vo(Math.sqrt(zt ** 2 + ht ** 2))}</div>`, z += "<h4>K<sub>local</sub> (12\xD712)</h4>", z += Ln(tt, 12), z += "<h4>T \u2014 Transformation (12\xD712)</h4>", z += Ln(Je, 12), z += "<h4>K<sub>global</sub> = T\u1D40 \xB7 K<sub>local</sub> \xB7 T</h4>", z += Ln(Ve, 12), z += "<h4>Assembly</h4>", z += `<div class="rpt-eq-small">Global DOFs: node ${Z[0]} \u2192 [${Z[0] * 6}..${Z[0] * 6 + 5}], node ${Z[1]} \u2192 [${Z[1] * 6}..${Z[1] * 6 + 5}]</div>`, z += "</div></div>";
    }
    ...
    if (z += "<h3>5.1 Supports (fixed DOFs)</h3>", W.supports && W.supports.size > 0) {
      ...
      z += "</tr></thead><tbody>", W.supports.forEach((X, Z) => {
        z += `<tr><td>${Z}</td>`, X.forEach((ce, Ie) => {
          ce && he.push(Z * 6 + Ie), z += `<td class="${ce ? "fixed" : ""}">${ce ? "Fixed" : "Free"}</td>`;
        }), z += "</tr>";
      }), z += "</tbody></table>";
    }
    if (z += `<div class="rpt-eq-small">Fixed DOFs: [${he.join(", ")}] \u2192 ${he.length} constraints<br/>`, z += `Free DOFs: ${G} \u2212 ${he.length} = <b>${G - he.length}</b></div>`, z += "<h3>5.2 Applied Loads</h3>", W.loads && W.loads.size > 0) {
      z += '<table class="rpt-data"><thead><tr><th>Node</th>';
      const X = [
        "F<sub>x</sub>",
        "F<sub>y</sub>",
      ...
      z += "</tr></thead><tbody>", W.loads.forEach((Z, ce) => {
        z += `<tr><td>${ce}</td>`, Z.forEach((Ie) => {
          const Fe = Math.abs(Ie) > 1e-10;
          z += `<td class="${Fe ? "nz" : ""}">${Fe ? Ge(Ie) : "0"}</td>`;
        }), z += "</tr>";
      }), z += "</tbody></table>";
    }
    if (z += "<h2>6. Solution</h2>", z += "<p>After removing fixed DOFs, the reduced system is:</p>", z += '<div class="rpt-eq rpt-eq-highlight">K<sub>free</sub> \xB7 u<sub>free</sub> = F<sub>free</sub></div>', z += "<p>Solved using LU decomposition with partial pivoting (sparse matrix).</p>", z += "<h3>6.1 Nodal Displacements</h3>", R == null ? void 0 : R.deformations) {
      z += '<table class="rpt-data"><thead><tr><th>Node</th>';
      for (const X of V) z += `<th>${X}</th>`;
      z += "</tr></thead><tbody>", R.deformations.forEach((X, Z) => {
        z += `<tr><td>${Z}</td>`, X.forEach((ce) => {
          const Ie = Math.abs(ce) > 1e-10;
          z += `<td class="${Ie ? "nz" : ""}">${Ge(ce, 6)}</td>`;
        }), z += "</tr>";
      }), z += "</tbody></table>";
    }
    if (z += "<h3>6.2 Reactions</h3>", z += '<div class="rpt-eq">R = K<sub>total</sub> \xB7 u (extract at fixed DOFs)</div>', R == null ? void 0 : R.reactions) {
      z += '<table class="rpt-data"><thead><tr><th>Node</th>';
      for (const X of V) z += `<th>${X}</th>`;
      z += "</tr></thead><tbody>", R.reactions.forEach((X, Z) => {
        z += `<tr><td>${Z}</td>`, X.forEach((ce) => {
          const Ie = Math.abs(ce) > 1e-10;
          z += `<td class="${Ie ? "nz-react" : ""}">${Ie ? Ge(ce, 4) : "0"}</td>`;
        }), z += "</tr>";
      }), z += "</tbody></table>";
    }
    if (z += "<h2>7. Internal Forces</h2>", z += "<p>For each element, transform global displacements to local and multiply by K<sub>local</sub>:</p>", z += '<div class="rpt-eq">u<sub>local</sub> = T \xB7 u<sub>global</sub></div>', z += '<div class="rpt-eq rpt-eq-highlight">f<sub>local</sub> = K<sub>local</sub> \xB7 u<sub>local</sub></div>', R == null ? void 0 : R.deformations) {
      ...
      for (let Z = 0; Z < D; Z++) {
        ...
        const Ie = ce.map((Fe) => g[Fe]);
        try {
          const Fe = Ko(Ie, S, Z), Ce = Uo(Ie), Be = [];
          for (const ze of ce) {
            const Pe = ((_g = R.deformations) == null ? void 0 : _g.get(ze)) || [
              0,
              0,
              0,
              0,
          ...
          const ot = Rt(Ce, Be), de = Rt(Fe, ot);
          z += `<tr><td>${Z}</td><td>${ce.join("\u2192")}</td>`;
          for (let ze = 0; ze < 12; ze++) {
            const Pe = Math.abs(de[ze]) > 1e-10;
            z += `<td class="${Pe ? "nz" : ""}">${Ge(de[ze], 2)}</td>`;
          }
          z += "</tr>";
        } catch {
        }
  ...
  `;
    return me.innerHTML = le + z, (_h = me.querySelector("#rpt-close")) == null ? void 0 : _h.addEventListener("click", () => me.remove()), me.querySelectorAll("[data-toggle]").forEach((X) => {
      X.addEventListener("click", () => {
        const Z = X.dataset.toggle, ce = me.querySelector(`#rpt-${Z}`);
        if (ce) {
  ...
  function Ln(e, g) {
    ...
    for (let W = 0; W < N; W++) {
      S += "<tr>";
      for (let R = 0; R < N; R++) {
        const G = ((_a2 = e[W]) == null ? void 0 : _a2[R]) ?? 0, D = Math.abs(G) < 1e-10;
        S += `<td class="${D ? "z" : ""} ${W === R && !D ? "diag" : ""}">${D ? "0" : xa(G)}</td>`;
      }
      S += "</tr>";
    }
  ...
  function va() {
    ...
    for (const B of G) {
      ...
      for (let he = 0; he <= 80; he++) {
        const le = he / 80, X = 30 + le * 540, Z = 180 / 2 - B.fn(le) * 60;
        Y += (he === 0 ? "M" : "L") + `${X.toFixed(1)},${Z.toFixed(1)}`;
      }
      D += `<path d="${Y}" fill="none" stroke="${B.color}" stroke-width="2.5"/>`;
      const me = 0.75, z = 30 + me * 540 + 8, V = 180 / 2 - B.fn(me) * 60 - 6;
  ...
  function ya(e, g) {
    ...
    for (let G = 0; G < e.length; G++) {
      ...
      for (const B of D) for (const Y of D) for (let me = 0; me < 6; me++) for (let z = 0; z < 6; z++) {
        const V = B + me, he = Y + z;
        V < S && he < S && R[V][he]++;
      }
    }
    for (let G = 0; G < S; G++) {
      ...
      for (let D = 0; D < S; D++) {
        const B = R[G][D], Y = B === 0 ? "#fff" : B === 1 ? "#e8f0fe" : B === 2 ? "#c6dcf5" : "#a0c4e8", me = B === 0 ? "" : B.toString();
        W += `<td style="background:${Y};color:#003366">${me}</td>`;
      }
      W += "</tr>";
    }
  ...
  function Ma(e, g, N, S, W, R) {
    var _a2, _b, _c, _d, _e, _f;
    const G = N[e], D = G.map((Je) => g[Je]), B = G.length === 2, Y = B ? ho(Zt(D[1], D[0])) : 0, me = ((_a2 = S.elasticities) == null ? void 0 : _a2.get(e)) ?? 0, z = ((_b = S.areas) == null ? void 0 : _b.get(e)) ?? 0, V = ((_c = S.momentsOfInertiaZ) == null ? void 0 : _c.get(e)) ?? 0, he = ((_d = S.momentsOfInertiaY) == null ? void 0 : _d.get(e)) ?? 0, le = ((_e = S.shearModuli) == null ? void 0 : _e.get(e)) ?? 0, X = ((_f = S.torsionalConstants) == null ? void 0 : _f.get(e)) ?? 0;
    let Z = null, ce = null, Ie = null;
    try {
      Z = Ko(D, S, e), ce = Uo(D), Ie = Rt(Fn(ce), Rt(Z, ce));
    } catch {
    }
    const Fe = B ? Zt(D[1], D[0]) : [
      0,
      0,
      0
    ], Ce = Y > 0 ? Fe[0] / Y : 0, Be = Y > 0 ? Fe[1] / Y : 0, ot = Y > 0 ? Fe[2] / Y : 0, de = Math.sqrt(Ce ** 2 + Be ** 2), ze = [];
    if ((W == null ? void 0 : W.deformations) && B) for (const Je of G) {
      const Ve = W.deformations.get(Je) || [
        0,
        0,
        0,
        0,
  ...
  function wa(e, g, N, S, W, R) {
    var _a2, _b;
    const G = Ma(e, g, N, S, W, R), D = document.createElement("div");
  ...
  `, D.querySelectorAll(".er-tab").forEach((B) => {
      B.addEventListener("click", () => {
        D.querySelectorAll(".er-tab").forEach((me) => me.classList.remove("active")), B.classList.add("active");
        const Y = B.dataset.tab;
        D.querySelectorAll(".er-body").forEach((me) => me.style.display = "none"), D.querySelector(`#er-body-${Y}`).style.display = "";
      });
      ...
      B && (B.innerHTML = Ms(G)), setTimeout(() => {
        ...
        Y.addEventListener("click", () => {
          const me = Y.dataset.toggle, z = D.querySelector(`#er-${me}`);
  ...
  function Sa(e) {
    ...
    if (g += '<div class="er-section-title">1. Propiedades</div>', g += '<table class="er-props">', g += `<tr><td>E</td><td>${qe(e.E)}</td><td>A</td><td>${qe(e.A)}</td></tr>`, g += `<tr><td>I<sub>z</sub></td><td>${qe(e.Iz)}</td><td>I<sub>y</sub></td><td>${qe(e.Iy)}</td></tr>`, g += `<tr><td>G</td><td>${qe(e.G)}</td><td>J</td><td>${qe(e.J)}</td></tr>`, g += "</table>", e.kLocal && (g += `<div class="er-section-title">2. K<sub>local</sub> (${e.kLocal.length}\xD7${e.kLocal.length})</div>`, g += Po(e.kLocal)), e.T && (g += '<div class="er-section-title">3. T \u2014 Transformaci\xF3n</div>', g += Po(e.T)), e.kGlobal && (g += '<div class="er-section-title">4. K<sub>global</sub> = T<sup>T</sup>\xB7K\xB7T</div>', g += Po(e.kGlobal)), g += '<div class="er-section-title">5. Desplazamientos</div>', e.uGlobal.length > 0) {
      ...
      for (let S = 0; S < e.elem.length; S++) {
        ...
        for (let W = 0; W < 6; W++) {
          const R = e.uGlobal[S * 6 + W];
          g += `${N[W]}=<span class="${Math.abs(R) > 1e-10 ? "nz" : ""}">${qe(R, 6)}</span> `;
        }
        g += "</div>";
      }
    ...
    if (g += '<div class="er-section-title">6. Fuerzas internas</div>', e.fLocal.length > 0 && e.fLocal.some((N) => N !== 0)) {
      ...
      for (let S = 0; S < 6; S++) g += `<td class="${Math.abs(e.fLocal[S]) > 1e-10 ? "nz" : ""}">${qe(e.fLocal[S], 3)}</td>`;
      g += "</tr><tr><td>Nodo j</td>";
      for (let S = 6; S < 12; S++) g += `<td class="${Math.abs(e.fLocal[S]) > 1e-10 ? "nz" : ""}">${qe(e.fLocal[S], 3)}</td>`;
      g += "</tr></table>";
    } else g += '<div class="er-sub">Sin an\xE1lisis</div>';
    return g;
  }
  ...
  function Po(e) {
    ...
    for (let W = 0; W < N; W++) {
      ...
      for (let R = 0; R < N; R++) {
        const G = ((_a2 = e[W]) == null ? void 0 : _a2[R]) ?? 0, D = Math.abs(G) < 1e-10;
        S += `<td class="${D ? "z" : ""} ${W === R && !D ? "diag" : ""}">${D ? "0" : ka(G)}</td>`;
      }
      S += "</tr>";
    }
  ...
  function qn(e) {
    ...
    if (!g) return;
    const N = e.width, S = e.height, W = 30, R = N - 2 * W, G = (S - 3 * W) / 2;
    g.fillStyle = getComputedStyle(document.body).getPropertyValue("--fem-bg").trim() || "#111", g.fillRect(0, 0, N, S);
    const D = (B, Y, me) => {
      g.strokeStyle = "#333", g.lineWidth = 1, g.strokeRect(W, B, R, G), g.strokeStyle = "#444", g.beginPath(), g.moveTo(W, B + G / 2), g.lineTo(W + R, B + G / 2), g.stroke(), g.fillStyle = "#888", g.font = "11px sans-serif", g.fillText(Y, W + 4, B + 14);
      for (const V of me) {
        g.strokeStyle = V.color, g.lineWidth = 2.5, g.beginPath();
        for (let he = 0; he <= 100; he++) {
          const le = he / 100, X = W + le * R, Z = B + G / 2 - V.fn(le) * (G / 2 * 0.85);
          he === 0 ? g.moveTo(X, Z) : g.lineTo(X, Z);
        }
        g.stroke();
      }
      let z = W + R - 90;
      for (const V of me) g.fillStyle = V.color, g.font = "bold 10px sans-serif", g.fillText(V.label, z, B + G - 6), z += 36;
      g.fillStyle = "#666", g.font = "9px monospace", g.fillText("0", W, B + G + 12), g.fillText("1", W + R - 6, B + G + 12), g.fillText("\u03BE", W + R / 2, B + G + 12);
    };
    D(W, "Axial (lineal)", [
      {
        fn: (B) => 1 - B,
  ...
  let Zo = false, go = null, _t = null, vt = null, ut = null;
  function za() {
  ...
  function La() {
    Zo = true, ut && (ut.innerHTML = "\u2715", ut.style.background = "linear-gradient(135deg, #cc3333, #ff4444)", ut.style.animation = "none"), go = document.createElement("div"), go.id = "tour-overlay", go.style.cssText = `
    position: fixed; inset: 0; z-index: 9999990;
    pointer-events: none;
  `, document.body.appendChild(go), zo(0);
  }
  function Cn() {
    Zo = false, ut && (ut.innerHTML = "?", ut.style.background = "linear-gradient(135deg, #0066cc, #0099ff)", ut.style.animation = "helpPulse 2s infinite"), _t && (_t.remove(), _t = null), vt && (vt.remove(), vt = null), go && (go.remove(), go = null);
  }
  function zo(e) {
    var _a2, _b;
    if (e >= Co.length) {
    ...
    const g = Co[e], N = document.querySelector(g.selector);
    if (!N) {
      zo(e + 1);
      return;
    }
    N.scrollIntoView({
      behavior: "smooth",
      block: "nearest"
    }), _t && _t.remove(), vt && vt.remove();
    const S = N.getBoundingClientRect(), W = window.innerWidth, R = window.innerHeight, G = 320, D = 180;
    _t = document.createElement("div"), _t.style.cssText = `
    position: fixed;
  ...
  `, document.body.appendChild(_t);
    const B = W - S.right, Y = S.left, me = R - S.bottom, z = S.top;
    let V = g.position || "bottom";
    V === "bottom" && me < D + 20 && (V = "top"), V === "top" && z < D + 20 && (V = "right"), V === "right" && B < G + 20 && (V = "left"), V === "left" && Y < G + 20 && (V = "bottom");
    let he, le, X = "";
    switch (V) {
      case "bottom":
        he = S.left + S.width / 2 - G / 2, le = S.bottom + 14, X = "position:absolute;top:-8px;left:50%;transform:translateX(-50%);width:0;height:0;border-left:8px solid transparent;border-right:8px solid transparent;border-bottom:8px solid #0099ff;";
        break;
      case "top":
        he = S.left + S.width / 2 - G / 2, le = S.top - D - 14, X = "position:absolute;bottom:-8px;left:50%;transform:translateX(-50%);width:0;height:0;border-left:8px solid transparent;border-right:8px solid transparent;border-top:8px solid #0099ff;";
        break;
      case "right":
        he = S.right + 14, le = S.top + S.height / 2 - D / 2, X = "position:absolute;left:-8px;top:50%;transform:translateY(-50%);width:0;height:0;border-top:8px solid transparent;border-bottom:8px solid transparent;border-right:8px solid #0099ff;";
        break;
      case "left":
        he = S.left - G - 14, le = S.top + S.height / 2 - D / 2, X = "position:absolute;right:-8px;top:50%;transform:translateY(-50%);width:0;height:0;border-top:8px solid transparent;border-bottom:8px solid transparent;border-left:8px solid #0099ff;";
        break;
    }
    he = Math.max(10, Math.min(he, W - G - 10)), le = Math.max(10, Math.min(le, R - D - 10)), vt = document.createElement("div"), vt.style.cssText = `
    position: fixed;
    left: ${he}px; top: ${le}px;
    width: ${G}px;
  ...
  `, vt.innerHTML = `
    ...
    <div style="margin-top:8px;display:flex;gap:3px;justify-content:center;">
      ${Co.map((ce, Ie) => `<div style="width:${Ie === e ? "16px" : "6px"};height:6px;border-radius:3px;background:${Ie === e ? "#0099ff" : Ie < e ? "#004488" : "#333"};transition:all 0.3s;"></div>`).join("")}
    </div>
  `, document.body.appendChild(vt), (_a2 = vt.querySelector("#tour-next")) == null ? void 0 : _a2.addEventListener("click", () => {
    ...
    const Z = (ce) => {
      ...
      (ce.key === "ArrowRight" || ce.key === "Enter") && (zo(e + 1), document.removeEventListener("keydown", Z)), ce.key === "ArrowLeft" && (zo(Math.max(0, e - 1)), document.removeEventListener("keydown", Z)), ce.key === "Escape" && (Cn(), document.removeEventListener("keydown", Z));
    };
    document.addEventListener("keydown", Z);
  }
  function Ta() {
    var _a2;
    _t && (_t.remove(), _t = null), vt && (vt.remove(), vt = null), vt = document.createElement("div"), vt.style.cssText = `
    position: fixed;
  ...
  function qa(e) {
    ...
    const g = e.split(/\r?\n/), N = {
      force: "TONF",
      length: "M"
    }, S = [], W = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), D = [], B = [], Y = /* @__PURE__ */ new Map(), me = /* @__PURE__ */ new Map(), z = [], V = [];
    let he = "", le = "";
    ...
    for (const ie of g) {
      ...
      if (le && (X.has(le) || X.set(le, []), X.get(le).push(ie)), le === "CONTROLS") {
        ...
        const ke = ye.match(/TITLE2\s+"([^"]+)"/);
        ke && (he = ke[1]);
      }
      if (le === "STORIES - IN SEQUENCE FROM TOP") {
        const Q = ye.match(/STORY\s+"([^"]+)"\s+(?:HEIGHT\s+([\d.]+)|ELEV\s+([-\d.]+))/);
        if (Q) {
          const ke = Q[1], J = Q[2] ? parseFloat(Q[2]) : 0, pe = Q[3] ? parseFloat(Q[3]) : void 0;
          S.push({
            name: ke,
            height: J,
            elev: pe ?? 0
      ...
      if (le === "MATERIAL PROPERTIES") {
        ...
        if (Q) {
          ...
          const J = W.get(ke);
          Q[2] && (J.type = Q[2]);
          const pe = ye.match(/\bE\s+([\d.eE+-]+)/);
          pe && (J.E = parseFloat(pe[1]));
          const Ae = ye.match(/\bU\s+([\d.eE+-]+)/);
          Ae && (J.nu = parseFloat(Ae[1]), J.G = J.E / (2 * (1 + J.nu)));
          const xe = ye.match(/\bFY\s+([\d.eE+-]+)/);
          xe && (J.fy = parseFloat(xe[1]));
          const De = ye.match(/\bFC\s+([\d.eE+-]+)/);
          De && (J.fc = parseFloat(De[1]));
          const _e = ye.match(/WEIGHTPERVOLUME\s+([\d.eE+-]+)/);
          _e && (J.density = parseFloat(_e[1]));
        }
      }
      if (le === "FRAME SECTIONS") {
        ...
        if (Q) {
          ...
          const J = R.get(ke), pe = ye.match(/MATERIAL\s+"([^"]+)"/);
          pe && (J.material = pe[1]);
          const Ae = ye.match(/SHAPE\s+"([^"]+)"/);
          Ae && (J.shape = Ae[1]);
          const xe = ye.match(/\bD\s+([\d.eE+-]+)/);
          xe && (J.D = parseFloat(xe[1]));
          const De = ye.match(/\bB\s+([\d.eE+-]+)/);
          De && (J.B = parseFloat(De[1]));
          const _e = ye.match(/\bTF\s+([\d.eE+-]+)/);
          _e && (J.TF = parseFloat(_e[1]));
          const Ke = ye.match(/\bTW\s+([\d.eE+-]+)/);
          Ke && (J.TW = parseFloat(Ke[1]));
          const et = ye.match(/\bR\s+([\d.eE+-]+)/);
          et && (J.R = parseFloat(et[1]));
          const je = ye.match(/FILLMATERIAL\s+"([^"]+)"/);
          je && (J.fillMaterial = je[1]);
          const St = ye.match(/I2MOD\s+([\d.eE+-]+)/);
          St && (J.modI2 = parseFloat(St[1]));
          const It = ye.match(/I3MOD\s+([\d.eE+-]+)/);
          It && (J.modI3 = parseFloat(It[1]));
        }
      }
      ...
      if (le === "LINE ASSIGNS") {
        ...
        if (Q) {
          ...
          J && (ke.rigidZone = parseFloat(J[1]));
          const pe = ye.match(/RELEASE\s+"([^"]+)"/);
          pe && (ke.releases = pe[1].split(/\s+/));
          const Ae = ye.match(/ANG\s+([-\d.eE+]+)/);
          Ae && (ke.angle = parseFloat(Ae[1])), me.set(`${Q[1]}@${Q[2]}`, ke);
        }
      }
      if (le === "GRIDS") {
      ...
      if (le === "AREA CONNECTIVITIES") {
        ...
        if (Q) {
          const ke = ((_a2 = Q[2].match(/"([^"]+)"/g)) == null ? void 0 : _a2.map((J) => J.replace(/"/g, ""))) || [];
          B.push({
            name: Q[1],
            pts: ke,
            nStories: 0
    ...
    if (S.length > 0) {
      ...
      for (let ye = ie - 1; ye >= 0; ye--) {
        const ke = Z.get(S[ye + 1].name) + S[ye].height;
        S[ye].elev = ke, Z.set(S[ye].name, ke);
      }
    }
    const ce = [], Ie = [], Fe = /* @__PURE__ */ new Map(), Ce = (ie, ye) => `${ie}@${ye}`, Be = /* @__PURE__ */ new Set(), ot = /* @__PURE__ */ new Map();
    for (const ie of D) ot.set(ie.name, ie);
    for (const ie of D) for (const [ye, Q] of me) {
      if (!ye.startsWith(ie.name + "@")) continue;
      const ke = Q.story, J = S.findIndex((pe) => pe.name === ke);
      if (!(J < 0)) if (ie.type === "COLUMN" || ie.type === "BRACE") {
        Be.add(Ce(ie.pt2, ke));
        const pe = Math.max(ie.nStories, 1), Ae = Math.min(J + pe, S.length - 1);
        Be.add(Ce(ie.pt1, S[Ae].name));
      } else Be.add(Ce(ie.pt1, ke)), Be.add(Ce(ie.pt2, ke));
    }
    for (const [ie] of Y) Be.add(ie);
    for (const ie of Be) {
      const [ye, Q] = ie.split("@"), ke = G.get(ye), J = Z.get(Q);
      ke === void 0 || J === void 0 || (ce.push([
        ke[0],
        ke[1],
        J
      ]), Ie.push(ie), Fe.set(ie, ce.length - 1));
    }
    const de = [], ze = [], Pe = [], tt = [], Je = /* @__PURE__ */ new Map();
    for (const ie of D) for (const [ye, Q] of me) {
      if (!ye.startsWith(ie.name + "@")) continue;
      const ke = Q.story, J = S.findIndex((Ke) => Ke.name === ke);
      if (J < 0) continue;
      let pe, Ae;
      if (ie.type === "COLUMN" || ie.type === "BRACE") {
        const Ke = Math.max(ie.nStories, 1), et = Math.min(J + Ke, S.length - 1);
        pe = Ce(ie.pt1, S[et].name), Ae = Ce(ie.pt2, ke);
      } else pe = Ce(ie.pt1, ke), Ae = Ce(ie.pt2, ke);
      const xe = Fe.get(pe), De = Fe.get(Ae);
      if (xe === void 0 || De === void 0 || xe === De) continue;
      const _e = de.length;
      if (de.push([
        xe,
        De
      ]), ze.push(ie.name), Pe.push(ie.type), tt.push(ke), Je.set(_e, Q.section), Q.rigidZone > 0 && At.set(_e, [
        Q.rigidZone,
        Q.rigidZone
      ]), Q.releases.length > 0) {
        const Ke = [
        ...
        for (const et of Q.releases) et === "TI" && (Ke[0] = true), et === "M2I" && (Ke[1] = true), et === "M3I" && (Ke[2] = true), et === "TJ" && (Ke[3] = true), et === "M2J" && (Ke[4] = true), et === "M3J" && (Ke[5] = true);
        Ht.set(_e, Ke);
      }
    }
    const Ve = /* @__PURE__ */ new Map(), yt = /* @__PURE__ */ new Map(), zt = /* @__PURE__ */ new Map(), ht = /* @__PURE__ */ new Map(), wt = /* @__PURE__ */ new Map(), At = /* @__PURE__ */ new Map(), Ht = /* @__PURE__ */ new Map(), Bt = /* @__PURE__ */ new Map(), Et = /* @__PURE__ */ new Map(), Oo = /* @__PURE__ */ new Map(), Le = /* @__PURE__ */ new Map();
    for (const [ie, ye] of Je) {
      const Q = R.get(ye);
      if (!Q) continue;
      const ke = W.get(Q.material);
      ke && (Ve.set(ie, ke.E), yt.set(ie, ke.G));
      const J = Q.D, pe = Q.B, Ae = Q.TF, xe = Q.TW;
      let De = 0, _e = 0, Ke = 0, et = 0, je = 0, St = 0, It = "rect";
      switch (Q.shape) {
        case "Concrete Rectangular":
          De = J * pe, _e = pe * J ** 3 / 12, Ke = J * pe ** 3 / 12, et = pe * J ** 3 * (1 / 3 - 0.21 * (J / pe) * (1 - J ** 4 / (12 * pe ** 4))), je = St = 5 / 6 * De, It = "rect";
          break;
        case "Concrete Circle":
          De = Math.PI * J ** 2 / 4, _e = Ke = Math.PI * J ** 4 / 64, et = Math.PI * J ** 4 / 32, je = St = 0.9 * De, It = "circ";
          break;
        case "Steel I/Wide Flange":
          De = 2 * pe * Ae + (J - 2 * Ae) * xe, _e = (pe * J ** 3 - (pe - xe) * (J - 2 * Ae) ** 3) / 12, Ke = (2 * Ae * pe ** 3 + (J - 2 * Ae) * xe ** 3) / 12, et = (2 * pe * Ae ** 3 + (J - 2 * Ae) * xe ** 3) / 3, je = (J - 2 * Ae) * xe, St = 2 * pe * Ae * 5 / 6, It = "I";
          break;
        case "Steel Tube":
          De = J * pe - (J - 2 * xe) * (pe - 2 * xe), _e = (pe * J ** 3 - (pe - 2 * xe) * (J - 2 * xe) ** 3) / 12, Ke = (J * pe ** 3 - (J - 2 * xe) * (pe - 2 * xe) ** 3) / 12, et = 2 * xe * (J - xe) * (pe - xe) * ((J - xe) * (pe - xe)) / (J - xe + (pe - xe)), je = 2 * J * xe, St = 2 * pe * xe, It = "HSS";
          break;
        case "Filled Steel Tube":
          De = J * pe, _e = pe * J ** 3 / 12, Ke = J * pe ** 3 / 12, et = 2 * xe * (J - xe) * (pe - xe) * ((J - xe) * (pe - xe)) / (J - xe + (pe - xe)), je = 2 * J * xe + 5 / 6 * (J - 2 * xe) * (pe - 2 * xe), St = 2 * pe * xe + 5 / 6 * (J - 2 * xe) * (pe - 2 * xe), It = "CFT";
          break;
        case "Steel Angle": {
          const mt = Ae || xe;
          De = mt * (J + pe - mt), _e = mt * (J ** 3 + pe * mt ** 2 + mt ** 2 * (J - mt)) / 12, Ke = mt * (pe ** 3 + J * mt ** 2 + mt ** 2 * (pe - mt)) / 12, et = (J + pe - mt) * mt ** 3 / 3, je = J * mt, St = pe * mt, It = "L";
          break;
        }
        case "Steel Channel":
        case "Cold Formed C":
          De = 2 * pe * Ae + (J - 2 * Ae) * xe, _e = (xe * J ** 3 + 2 * pe * Ae * (J - Ae) ** 2) / 12, Ke = (2 * Ae * pe ** 3 + (J - 2 * Ae) * xe ** 3) / 12, et = (2 * pe * Ae ** 3 + (J - 2 * Ae) * xe ** 3) / 3, je = (J - 2 * Ae) * xe, St = 2 * pe * Ae * 5 / 6, It = Q.shape === "Cold Formed C" ? "coldC" : "C";
          break;
        case "Steel Double Channel":
          De = 2 * (2 * pe * Ae + (J - 2 * Ae) * xe), _e = 2 * (xe * J ** 3 + 2 * pe * Ae * (J - Ae) ** 2) / 12, Ke = 2 * (2 * Ae * pe ** 3 + (J - 2 * Ae) * xe ** 3) / 12, et = 2 * (2 * pe * Ae ** 3 + (J - 2 * Ae) * xe ** 3) / 3, je = 2 * (J - 2 * Ae) * xe, St = 4 * pe * Ae * 5 / 6, It = "2C";
          break;
        default:
          J > 0 && pe > 0 && (De = J * pe, _e = pe * J ** 3 / 12, Ke = J * pe ** 3 / 12, et = Math.min(J, pe) * Math.max(J, pe) ** 3 / 3 * 0.3, je = St = 5 / 6 * De);
          break;
      }
      Q.modI2 && (Ke *= Q.modI2), Q.modI3 && (_e *= Q.modI3), zt.set(ie, De), Bt.set(ie, _e), Et.set(ie, Ke), Oo.set(ie, et), je > 0 && ht.set(ie, je), St > 0 && wt.set(ie, St), Le.set(ie, {
        type: It,
        b: pe || void 0,
        h: J || void 0,
        d: It === "circ" || It === "pipe" ? J : void 0,
        tw: xe || void 0,
        tf: Ae || void 0,
        r: Q.R,
        name: ye
    ...
    for (const [ie, ye] of Y) {
      ...
      for (const J of ye) J === "UX" && (ke[0] = true), J === "UY" && (ke[1] = true), J === "UZ" && (ke[2] = true), J === "RX" && (ke[3] = true), J === "RY" && (ke[4] = true), J === "RZ" && (ke[5] = true);
      $t.set(Q, ke);
    }
    const kt = /* @__PURE__ */ new Map(), Lt = /* @__PURE__ */ new Map();
    for (let ie = 0; ie < ze.length; ie++) Lt.set(`${ze[ie]}@${tt[ie]}`, ie);
    for (const ie of z) {
      const ye = Lt.get(`${ie.line}@${ie.story}`);
      if (ye === void 0) continue;
      const [Q, ke] = de[ye], J = ce[Q], pe = ce[ke], Ae = Math.sqrt((pe[0] - J[0]) ** 2 + (pe[1] - J[1]) ** 2 + (pe[2] - J[2]) ** 2);
      if (Ae < 1e-10) continue;
      const xe = ie.val * Ae / 2;
      let De = 0, _e = 0, Ke = 0;
      ie.dir === "GRAV" || ie.dir === "GRAVITY" ? Ke = -xe : ie.dir === "X" ? De = xe : ie.dir === "Y" ? _e = xe : ie.dir === "Z" && (Ke = -xe);
      for (const et of [
        Q,
        ke
      ]) {
        ...
        je[0] += De, je[1] += _e, je[2] += Ke, kt.set(et, je);
      }
    }
    ...
    for (const [ie, ye] of Je) {
      ...
      if (!Q) continue;
      const ke = W.get(Q.material);
      (ke == null ? void 0 : ke.density) && pt.set(ie, ke.density);
    }
    return {
      units: N,
      stories: S.reverse(),
  ...
  function Fa(e, g) {
    ...
    for (const W of S) {
      ...
      if (!(!R || R.length === 0)) {
        N.push(`$ ${W}`);
        for (const G of R) N.push(G);
        N.push("");
      }
    }
    for (const [W, R] of e) if (!S.includes(W) && R.length !== 0) {
      N.push(`$ ${W}`);
      for (const G of R) N.push(G);
      N.push("");
    }
    return N.push("$ END OF MODEL FILE"), N.join(`\r
`);
  }
  function Ca(e) {
    var _a2, _b;
    const { nodes: g, elements: N, nodeInputs: S, elementInputs: W, title: R, units: G } = e, D = (G == null ? void 0 : G.force) || "TONF", B = (G == null ? void 0 : G.length) || "M", Y = [], me = (de) => Math.round(de * 1e4) / 1e4;
    ...
    g.forEach((de) => z.add(me(de[1])));
    const V = [
      ...z
    ].sort((de, ze) => de - ze), he = [], le = /* @__PURE__ */ new Map();
    he.push("Base"), le.set(V[0], "Base");
    for (let de = 1; de < V.length; de++) {
      const ze = `Level_${de}`;
      he.push(ze), le.set(V[de], ze);
    }
    Y.push("$ STORIES - IN SEQUENCE FROM TOP");
    for (let de = V.length - 1; de >= 1; de--) Y.push(`  STORY "${he[de]}"  HEIGHT ${me(V[de] - V[de - 1])} MASTERSTORY "Yes"  `);
    V.length > 0 && Y.push(`  STORY "Base"  ELEV ${V[0]} `), Y.push(""), Y.push("$ MATERIAL PROPERTIES");
    const X = /* @__PURE__ */ new Set();
    (_a2 = W.elasticities) == null ? void 0 : _a2.forEach((de) => X.add(de));
    const Z = /* @__PURE__ */ new Map();
    let ce = 0;
    for (const de of X) {
      const ze = `Mat_${++ce}`;
      Z.set(de, ze), Y.push(`  MATERIAL  "${ze}"    TYPE "Concrete"    WEIGHTPERVOLUME 2.4`), Y.push(`  MATERIAL  "${ze}"    SYMTYPE "Isotropic"  E ${de}  U 0.2  A 1E-05`);
    }
    ...
    N.forEach((de, ze) => {
      ...
      const Pe = (_a3 = W.sectionShapes) == null ? void 0 : _a3.get(ze), tt = ((_b2 = W.elasticities) == null ? void 0 : _b2.get(ze)) ?? 0, Je = Z.get(tt) || "Mat_1", Ve = (Pe == null ? void 0 : Pe.name) || `Sec_${ze}`;
      if (!Ie.has(Ve)) if (Ie.add(Ve), Pe) {
        const yt = Pe.h ?? 0, zt = Pe.b ?? 0, ht = Pe.d ?? 0, wt = Pe.tf ?? 0, At = Pe.tw ?? 0, Bt = {
        ...
        }[Pe.type] || "Concrete Rectangular";
        let Et = `  FRAMESECTION  "${Ve}"  MATERIAL "${Je}"  SHAPE "${Bt}"`;
        yt && (Et += `  D ${yt}`), zt && (Et += `  B ${zt}`), ht && !yt && (Et += `  D ${ht}`), wt && (Et += `  TF ${wt}`), At && (Et += `  TW ${At}`), Y.push(Et);
      } else Y.push(`  FRAMESECTION  "${Ve}"  MATERIAL "${Je}"  SHAPE "Concrete Rectangular"  D 0.5 B 0.3 `);
    }), Y.push("");
    const Fe = /* @__PURE__ */ new Map();
    let Ce = 0;
    g.forEach((de) => {
      const ze = `${me(de[0])},${me(de[2])}`;
      Fe.has(ze) || Fe.set(ze, `${++Ce}`);
    }), Y.push("$ POINT COORDINATES");
    for (const [de, ze] of Fe) {
      const [Pe, tt] = de.split(",").map(Number);
      Y.push(`  POINT "${ze}"  ${Pe} ${tt} `);
    }
    Y.push("");
    const Be = (de) => {
      const ze = g[de], Pe = `${me(ze[0])},${me(ze[2])}`;
      return {
        pt: Fe.get(Pe) || "1",
        story: le.get(me(ze[1])) || "Base"
      };
    };
    Y.push("$ LINE CONNECTIVITIES");
    const ot = [];
    return N.forEach((de, ze) => {
      var _a3, _b2;
      if (de.length !== 2) return;
      const Pe = Pa(g, de), tt = ((_b2 = (_a3 = W.sectionShapes) == null ? void 0 : _a3.get(ze)) == null ? void 0 : _b2.name) || `Sec_${ze}`;
      if (Pe === "BEAM") {
        const Je = Be(de[0]), Ve = Be(de[1]);
        Y.push(`  LINE  "E${ze + 1}"  BEAM  "${Je.pt}"  "${Ve.pt}"  0`), ot.push(`  LINEASSIGN  "E${ze + 1}"  "${Je.story}"  SECTION "${tt}"  MINNUMSTA 3 AUTOMESH "YES"  MESHATINTERSECTIONS "YES"  `);
      } else {
        const Je = g[de[0]][1] <= g[de[1]][1] ? de[0] : de[1], Ve = g[de[0]][1] <= g[de[1]][1] ? de[1] : de[0], yt = Be(Je), zt = Be(Ve), ht = me(g[Je][1]), wt = me(g[Ve][1]), At = V.indexOf(ht), Ht = V.indexOf(wt), Bt = Math.max(1, Ht >= 0 && At >= 0 ? Ht - At : 1);
        Y.push(`  LINE  "E${ze + 1}"  ${Pe}  "${yt.pt}"  "${zt.pt}"  ${Bt}`), ot.push(`  LINEASSIGN  "E${ze + 1}"  "${zt.story}"  SECTION "${tt}"  MINNUMSTA 3 AUTOMESH "YES"  MESHATINTERSECTIONS "YES"  `);
      }
    }), Y.push(""), Y.push("$ POINT ASSIGNS"), (_b = S.supports) == null ? void 0 : _b.forEach((de, ze) => {
      const Pe = [];
      if (de[0] && Pe.push("UX"), de[1] && Pe.push("UY"), de[2] && Pe.push("UZ"), de[3] && Pe.push("RX"), de[4] && Pe.push("RY"), de[5] && Pe.push("RZ"), Pe.length > 0) {
        const tt = Be(ze);
        Y.push(`  POINTASSIGN  "${tt.pt}"  "${tt.story}"  RESTRAINT "${Pe.join(" ")}"  `);
      }
    }), Y.push(""), Y.push("$ LINE ASSIGNS"), ot.forEach((de) => Y.push(de)), Y.push(""), Y.push("$ LOAD PATTERNS"), Y.push('  LOADPATTERN "Dead"  TYPE  "Dead"  SELFWEIGHT  1'), Y.push('  LOADPATTERN "Live"  TYPE  "Live"  SELFWEIGHT  0'), Y.push(""), S.loads && S.loads.size > 0 && (Y.push("$ POINT OBJECT LOADS"), S.loads.forEach((de, ze) => {
      const [Pe, tt, Je] = de, Ve = Be(ze);
      Math.abs(Pe) > 1e-10 && Y.push(`  POINTLOAD  "${Ve.pt}"  "${Ve.story}"  "Dead"  TYPE "FORCE"  FX ${Pe}`), Math.abs(tt) > 1e-10 && Y.push(`  POINTLOAD  "${Ve.pt}"  "${Ve.story}"  "Dead"  TYPE "FORCE"  FY ${tt}`), Math.abs(Je) > 1e-10 && Y.push(`  POINTLOAD  "${Ve.pt}"  "${Ve.story}"  "Dead"  TYPE "FORCE"  FZ ${Je}`);
    }), Y.push("")), Y.push("$ END OF MODEL FILE"), Y.join(`\r
`);
  }
  function Pa(e, g) {
    const N = e[g[0]], S = e[g[1]], W = Math.abs(S[1] - N[1]), R = Math.sqrt((S[0] - N[0]) ** 2 + (S[2] - N[2]) ** 2), G = W > R * 0.5;
    return G && R > 0.01 ? "BRACE" : G ? "COLUMN" : "BEAM";
  }
  function Oa(e) {
    var _a2, _b;
    const { nodes: g, elements: N, nodeInputs: S, elementInputs: W } = e, R = [];
    return R.push("# OpenSeesPy model exported from Awatif FEM Studio"), R.push(`# ${g.length} nodes, ${N.length} elements`), R.push(""), R.push("import openseespy.opensees as ops"), R.push(""), R.push("ops.wipe()"), R.push("ops.model('basic', '-ndm', 3, '-ndf', 6)"), R.push(""), R.push("# --- Nodes ---"), g.forEach((G, D) => {
      R.push(`ops.node(${D + 1}, ${G[0]}, ${G[1]}, ${G[2]})`);
    }), R.push(""), R.push("# --- Boundary Conditions ---"), (_a2 = S.supports) == null ? void 0 : _a2.forEach((G, D) => {
      const B = G.map((Y) => Y ? 1 : 0).join(", ");
      R.push(`ops.fix(${D + 1}, ${B})`);
    }), R.push(""), R.push("# --- Geometric Transformations ---"), R.push("ops.geomTransf('Linear', 1, 0.0, 0.0, 1.0)  # beams (vecxz = Z)"), R.push("ops.geomTransf('Linear', 2, -1.0, 0.0, 0.0)  # columns (vecxz = -X)"), R.push(""), R.push("# --- Elements (elasticBeamColumn) ---"), N.forEach((G, D) => {
      var _a3, _b2, _c, _d, _e, _f;
      if (G.length !== 2) return;
      const B = g[G[0]], Y = g[G[1]], z = Math.abs(Y[2] - B[2]) > Math.max(Math.abs(Y[0] - B[0]), Math.abs(Y[1] - B[1])) ? 2 : 1, V = ((_a3 = W.areas) == null ? void 0 : _a3.get(D)) ?? 1, he = ((_b2 = W.elasticities) == null ? void 0 : _b2.get(D)) ?? 2e5, le = ((_c = W.shearModuli) == null ? void 0 : _c.get(D)) ?? 8e4, X = ((_d = W.torsionalConstants) == null ? void 0 : _d.get(D)) ?? 1, Z = ((_e = W.momentsOfInertiaY) == null ? void 0 : _e.get(D)) ?? 1, ce = ((_f = W.momentsOfInertiaZ) == null ? void 0 : _f.get(D)) ?? 1;
      R.push(`ops.element('elasticBeamColumn', ${D + 1}, ${G[0] + 1}, ${G[1] + 1}, ${V}, ${he}, ${le}, ${X}, ${Z}, ${ce}, ${z})`);
    }), R.push(""), S.loads && S.loads.size > 0 && (R.push("# --- Loads ---"), R.push("ops.timeSeries('Linear', 1)"), R.push("ops.pattern('Plain', 1, 1)"), S.loads.forEach((G, D) => {
    ...
    }), R.push(""), R.push('print("\\n=== Reactions ===")'), R.push("ops.reactions()"), (_b = S.supports) == null ? void 0 : _b.forEach((G, D) => {
...
`);
  ...
  function Na(e) {
    var _a2, _b;
    const { nodes: g, elements: N, nodeInputs: S, elementInputs: W } = e, R = [];
    return R.push("# OpenSees Tcl model exported from Awatif FEM Studio"), R.push(`# ${g.length} nodes, ${N.length} elements`), R.push(""), R.push("wipe"), R.push("model basic -ndm 3 -ndf 6"), R.push(""), R.push("# --- Nodes ---"), g.forEach((G, D) => {
      R.push(`node ${D + 1} ${G[0]} ${G[1]} ${G[2]}`);
    }), R.push(""), R.push("# --- Boundary Conditions ---"), (_a2 = S.supports) == null ? void 0 : _a2.forEach((G, D) => {
      const B = G.map((Y) => Y ? 1 : 0).join(" ");
      R.push(`fix ${D + 1} ${B}`);
    }), R.push(""), R.push("# --- Geometric Transformations ---"), R.push("geomTransf Linear 1 0.0 0.0 1.0"), R.push("geomTransf Linear 2 -1.0 0.0 0.0"), R.push(""), R.push("# --- Elements ---"), N.forEach((G, D) => {
      var _a3, _b2, _c, _d, _e, _f;
      if (G.length !== 2) return;
      const B = g[G[0]], Y = g[G[1]], z = Math.abs(Y[2] - B[2]) > Math.max(Math.abs(Y[0] - B[0]), Math.abs(Y[1] - B[1])) ? 2 : 1, V = ((_a3 = W.areas) == null ? void 0 : _a3.get(D)) ?? 1, he = ((_b2 = W.elasticities) == null ? void 0 : _b2.get(D)) ?? 2e5, le = ((_c = W.shearModuli) == null ? void 0 : _c.get(D)) ?? 8e4, X = ((_d = W.torsionalConstants) == null ? void 0 : _d.get(D)) ?? 1, Z = ((_e = W.momentsOfInertiaY) == null ? void 0 : _e.get(D)) ?? 1, ce = ((_f = W.momentsOfInertiaZ) == null ? void 0 : _f.get(D)) ?? 1;
      R.push(`element elasticBeamColumn ${D + 1} ${G[0] + 1} ${G[1] + 1} ${V} ${he} ${le} ${X} ${Z} ${ce} ${z}`);
    }), R.push(""), S.loads && S.loads.size > 0 && (R.push("# --- Loads ---"), R.push("timeSeries Linear 1"), R.push("pattern Plain 1 1 {"), S.loads.forEach((G, D) => {
      const B = G.map((Y) => Y).join(" ");
      R.push(`  load ${D + 1} ${B}`);
    ...
    }), R.push('puts "\\n=== Reactions ==="'), R.push("reactions"), (_b = S.supports) == null ? void 0 : _b.forEach((G, D) => {
      R.push(`puts "Node ${D + 1}: [nodeReaction ${D + 1}]"`);
    }), R.join(`
`);
  }
  function Ra(e) {
    const g = [], N = [], S = /* @__PURE__ */ new Map(), W = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), B = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map(), me = /* @__PURE__ */ new Map(), z = /* @__PURE__ */ new Map(), V = /* @__PURE__ */ new Map();
    for (const he of e.split(/\r?\n/)) {
      const le = he.trim(), X = le.match(/ops\.node\(\s*(\d+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)/);
      if (X) {
        const Fe = parseInt(X[1]), Ce = g.length;
        g.push([
          parseFloat(X[2]),
          parseFloat(X[3]),
          parseFloat(X[4])
      ...
      if (Z) {
        const Fe = parseInt(Z[1]), Ce = z.get(Fe);
        Ce !== void 0 && S.set(Ce, [
          Z[2] === "1",
          Z[3] === "1",
          Z[4] === "1",
      ...
      if (ce) {
        const Fe = parseInt(ce[1]), Ce = z.get(parseInt(ce[2])), Be = z.get(parseInt(ce[3]));
        if (Ce !== void 0 && Be !== void 0) {
          const ot = N.length;
          N.push([
            Ce,
            Be
          ]), V.set(Fe, ot), D.set(ot, parseFloat(ce[4])), R.set(ot, parseFloat(ce[5])), G.set(ot, parseFloat(ce[6])), me.set(ot, parseFloat(ce[7])), B.set(ot, parseFloat(ce[8])), Y.set(ot, parseFloat(ce[9]));
        }
        continue;
      }
      const Ie = le.match(/ops\.load\(\s*(\d+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)/);
      if (Ie) {
        const Fe = z.get(parseInt(Ie[1]));
        Fe !== void 0 && W.set(Fe, [
          parseFloat(Ie[2]),
          parseFloat(Ie[3]),
          parseFloat(Ie[4]),
  ...
  function _a(e) {
    const g = [], N = [], S = /* @__PURE__ */ new Map(), W = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), B = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map(), me = /* @__PURE__ */ new Map(), z = /* @__PURE__ */ new Map();
      ...
      if (le[0] === "element" && le[1] === "elasticBeamColumn" && le.length >= 12) {
        ...
        if (X !== void 0 && Z !== void 0) {
          ...
          N.push([
            X,
            Z
          ]), D.set(ce, parseFloat(le[5])), R.set(ce, parseFloat(le[6])), G.set(ce, parseFloat(le[7])), me.set(ce, parseFloat(le[8])), B.set(ce, parseFloat(le[9])), Y.set(ce, parseFloat(le[10]));
        }
        continue;
      }
  ...
  Ga = function(e) {
    ...
    let B = false;
    const Y = /* @__PURE__ */ new Set(), me = /* @__PURE__ */ new Map();
    let z = "", V = {}, he = null, le = "", X = [], Z = [], ce = /* @__PURE__ */ new Set(), Ie = /* @__PURE__ */ new Set(), Fe = /* @__PURE__ */ new Set(), Ce = /* @__PURE__ */ new Map(), Be = /* @__PURE__ */ new Map(), ot = null, de = [], ze = 0.2, Pe = 2, tt = 2, Je = false, Ve = 2, yt = "x", zt = /* @__PURE__ */ new Set(), ht = true, wt = 0.15, At = 2, Ht = 2, Bt = /* @__PURE__ */ new Set();
    const Et = () => ({
      b: 0.3,
      h: 0.4,
      profileIdx: 0,
    ...
    let $t = 0, kt = 3, Lt = false, pt = 0, ie = null, ye = 0, Q = [], ke = 1, J = true;
    const pe = ha();
    pe.div.style.display = "none";
    function Ae() {
      const t = Yo()[z];
    ...
    function Ke() {
      if (!_e) return;
      const t = Ze();
      t && t.scene.remove(_e), _e.traverse((o) => {
    ...
    function et(t, o, n, l, s) {
      Ke();
      const d = Ze();
      if (!d) return;
      _e = new In(), _e.name = "gridAxes";
      ...
      for (let b = 0; b < t.length; b++) {
        ...
        if (v) {
          const y = -w - u * 1.5;
          tn(f, 0, 0, f, 0, y + u, M, _e), on(x[b] || `${b}`, f, 0, y, u, _e);
        } else {
          const y = m - w - u * 1.5;
          tn(f, m, 0, f, y + u, 0, M, _e), on(x[b] || `${b}`, f, y, 0, u, _e);
        }
      }
      if (!v) for (let b = 0; b < o.length; b++) {
        const f = o[b], y = a - w - u * 1.5;
        tn(a, f, 0, y + u, f, 0, M, _e), on(p[b] || `${b}`, y, f, 0, u, _e);
      }
      const $ = u * 1.8, F = w * 1.2, A = w * 1.2;
      for (let b = 0; b < t.length - 1; b++) {
        const f = t[b], y = t[b + 1], k = Math.abs(y - f), I = (f + y) / 2, _ = `${k.toFixed(2)} m`;
        v ? (Qo(_, I, 0, -F, $, _e), en(f, 0, -F * 0.7, y, 0, -F * 0.7, 16763904, _e)) : (Qo(_, I, m - A, 0, $, _e), en(f, m - A * 0.7, 0, y, m - A * 0.7, 0, 16763904, _e));
      }
      if (!v) for (let b = 0; b < o.length - 1; b++) {
        const f = o[b], y = o[b + 1], k = Math.abs(y - f), I = (f + y) / 2, _ = `${k.toFixed(2)} m`;
        Qo(_, a - F, I, 0, $, _e), en(a - F * 0.7, f, 0, a - F * 0.7, y, 0, 16763904, _e);
      }
      _e.traverse((b) => {
        b.material && (Array.isArray(b.material) ? b.material.forEach((f) => {
          f.clippingPlanes = [];
        }) : b.material.clippingPlanes = []);
      }), d.scene.add(_e), d.render();
    }
    let je = null;
    function St() {
      if (!je) return;
      const t = Ze();
      t && t.scene.remove(je), je.traverse((o) => {
        if (o.geometry && o.geometry.dispose(), o.material) {
          const n = o.material;
          n.map && n.map.dispose(), n.dispose();
        }
    ...
    function It(t, o, n) {
      if (St(), t.length === 0) return;
      const l = Ze();
      if (!l) return;
      je = new In(), je.name = "storyLevels";
      ...
      for (const p of t) {
        const u = p.elev;
        E ? (mt(s - h, 0, u, d + h, 0, u, w, je), Pn(p.name, d + h * 1.5, 0, u, x, je)) : (mt(s, a, u, d, a, u, w, je), mt(d, a, u, d, c, u, w, je), mt(d, c, u, s, c, u, w, je), mt(s, c, u, s, a, u, w, je), Pn(p.name, s - h * 1.5, a, u, x, je));
      }
      je.traverse((p) => {
        p.material && (Array.isArray(p.material) ? p.material.forEach((u) => {
          u.clippingPlanes = [];
        }) : p.material.clippingPlanes = []);
      }), l.scene.add(je), l.render();
    }
    function mt(t, o, n, l, s, d, a, c) {
    ...
    function en(t, o, n, l, s, d, a, c) {
      const m = [
        new Se(t, o, n),
        new Se(l, s, d)
      ], r = new io().setFromPoints(m), i = new Fo({
        color: a,
        transparent: true,
        opacity: 0.6,
        depthTest: false
    ...
    const We = {
      ...
      clear() {
        e.nodes.val = [], e.elements.val = [], e.nodeInputs && (e.nodeInputs.val = {}), e.elementInputs && (e.elementInputs.val = {}), ce = /* @__PURE__ */ new Set(), Ie = /* @__PURE__ */ new Set(), Ce = /* @__PURE__ */ new Map(), Be = /* @__PURE__ */ new Map(), xe = [], De = [], Ke(), St();
      ...
      building(t, o, n, l = 3, s = 0, d = 0, a = 0, c = 0, m = 1) {
        ...
        for (const { el: [f, y], floor: k } of $) {
          if (m <= 1) {
            ce.add(M.length), Ce.set(M.length, k), M.push([
              f,
              y
            ]);
            continue;
        ...
        for (const { el: [f, y], floor: k, dir: I, bay: _ } of F) {
          const q = p[f], T = p[y];
          let P = f;
          for (let te = 1; te < l; te++) {
            ...
            const ee = M.length;
            Ie.add(ee), Ce.set(ee, k), Be.set(ee, {
              dir: I,
              bay: _
            }), M.push([
              P,
        ...
        if (zt = /* @__PURE__ */ new Set(), Je && Ve > 0) {
          const f = (y, k, I) => {
          ...
          for (let y = 1; y < h.length; y++) if (yt === "x") for (let k = 0; k < i.length - 1; k++) {
            const I = i[k], _ = i[k + 1];
            for (let q = 1; q <= Ve; q++) {
              const T = I + q / (Ve + 1) * (_ - I), P = [];
              for (let O = 0; O < r.length; O++) P.push(f(r[O], T, h[y]));
              for (let O = 0; O < r.length - 1; O++) {
                const te = M.length;
                zt.add(te), Ie.add(te), Ce.set(te, y - 1), Be.set(te, {
                  dir: "x",
                  bay: O
                }), M.push([
                  P[O],
            ...
            for (let q = 1; q <= Ve; q++) {
              const T = I + q / (Ve + 1) * (_ - I), P = [];
              for (let O = 0; O < i.length; O++) P.push(f(T, i[O], h[y]));
        ...
        for (const f of de) {
          ...
          for (const I of k) {
            let _, q, T, P;
            f.dir === "x" ? (_ = f.bay, T = f.bay + 1, q = f.axisIdx, P = f.axisIdx) : (_ = f.axisIdx, T = f.axisIdx, q = f.bay, P = f.bay + 1);
            const O = u[`${_},${q},${I}`], te = u[`${_},${q},${I + 1}`];
            let ne, re;
            if (f.dir === "x" ? (ne = u[`${T},${P},${I}`], re = u[`${T},${P},${I + 1}`]) : (ne = u[`${T},${P},${I}`], re = u[`${T},${P},${I + 1}`]), O === void 0 || ne === void 0 || te === void 0 || re === void 0) continue;
            const ee = tt, U = Pe, se = p[O], Me = p[ne], Re = p[te], Oe = p[re], ae = [];
            for (let ge = 0; ge <= U; ge++) {
              const we = [], fe = ge / U;
              for (let Te = 0; Te <= ee; Te++) {
                const Ne = Te / ee, Qe = (1 - fe) * ((1 - Ne) * se[0] + Ne * Me[0]) + fe * ((1 - Ne) * Re[0] + Ne * Oe[0]), oe = (1 - fe) * ((1 - Ne) * se[1] + Ne * Me[1]) + fe * ((1 - Ne) * Re[1] + Ne * Oe[1]), Ee = (1 - fe) * ((1 - Ne) * se[2] + Ne * Me[2]) + fe * ((1 - Ne) * Re[2] + Ne * Oe[2]);
            ...
            for (let ge = 0; ge < U; ge++) for (let we = 0; we < ee; we++) {
              const fe = ae[ge][we], Te = ae[ge][we + 1], Ne = ae[ge + 1][we + 1], Qe = ae[ge + 1][we], oe = M.length;
              Fe.add(oe), Ce.set(oe, I), M.push([
                fe,
                Te,
                Ne,
                Qe
        ...
        if (Bt = /* @__PURE__ */ new Set(), ht) {
          const f = l, y = l, k = /* @__PURE__ */ new Map(), I = (_, q, T) => `${Math.round(_ * 1e4)},${Math.round(q * 1e4)},${Math.round(T * 1e4)}`;
          ...
          for (let _ = 1; _ < h.length; _++) {
            ...
            for (let T = 0; T < r.length - 1; T++) for (let P = 0; P < i.length - 1; P++) {
              const O = r[T], te = r[T + 1], ne = i[P], re = i[P + 1], ee = [];
              for (let U = 0; U <= y; U++) {
                const se = [];
                for (let Me = 0; Me <= f; Me++) {
                  const Re = O + Me / f * (te - O), Oe = ne + U / y * (re - ne);
                  if (U === 0 && Me === 0) se.push(u[`${T},${P},${_}`]);
                  else if (U === 0 && Me === f) se.push(u[`${T + 1},${P},${_}`]);
                  else if (U === y && Me === 0) se.push(u[`${T},${P + 1},${_}`]);
                  else if (U === y && Me === f) se.push(u[`${T + 1},${P + 1},${_}`]);
                  else {
                    const ae = I(Re, Oe, q), ge = k.get(ae);
              ...
              for (let U = 0; U < y; U++) for (let se = 0; se < f; se++) {
                const Me = ee[U][se], Re = ee[U][se + 1], Oe = ee[U + 1][se + 1], ae = ee[U + 1][se], ge = M.length;
                Bt.add(ge), Ce.set(ge, _ - 1), M.push([
                  Me,
                  Re,
                  Oe,
                  ae
      ...
      example(t) {
        ...
        switch (t) {
          case "truss": {
            We.clear(), Xe("truss"), Rn();
            break;
          }
          case "beams": {
            We.clear(), Xe("beams"), _n();
            break;
          }
          case "3d":
          case "3d-structure":
          ...
          case "edificio": {
            Xe("edificio"), Le.colMat = 0, Le.vigaMat = 0, Le.colShape = 0, de = [], ht = false, Je = false, be();
            break;
          }
          case "edif-acero":
          case "edificio-acero": {
            Xe("edificio"), Le.colMat = 1, Le.vigaMat = 1, Le.steelColType = 0, Le.steelVigaType = 0, de = [], Je = true, Ve = 2;
            const o = X.reduce((l, s) => l + s, 0) / X.length, n = Z.reduce((l, s) => l + s, 0) / Z.length;
            yt = o >= n ? "y" : "x", ht = true, wt = 0.08, be();
            break;
          }
          case "edif-muros":
          case "edificio-muros": {
            Xe("edificio"), Le.colMat = 0, Le.vigaMat = 0, Le.colShape = 0, Je = false;
          ...
          case "edif-mixto":
          case "edificio-mixto": {
            Xe("edificio"), Le.colMat = 2, Le.vigaMat = 0, Je = false;
          ...
          case "mezanine":
          case "mezzanine": {
            Xe("edificio"), V.nPisos && (V.nPisos.val = 1), V.hPiso && (V.hPiso.val = 4.5), V.nVanosX && (V.nVanosX.val = 3), V.nVanosY && (V.nVanosY.val = 2), V.nSubViga && (V.nSubViga.val = 3), X = [
              6,
              6,
              6
            ], Z = [
              5,
              5
            ], Le.colMat = 1, Le.vigaMat = 1, Le.steelColType = 0, Le.steelVigaType = 0, de = [], Je = true, Ve = 2, yt = X[0] >= Z[0] ? "y" : "x", ht = true, wt = 0.08, At = 3, Ht = 3, be();
            break;
          }
          case "galpon": {
            Xe("galpon"), be();
          ...
          case "plate-q4":
          case "placa-q4": {
            We.clear(), Xe("placa-q4"), Dn();
            break;
          }
          case "losa-rect":
          case "rectangular-slab": {
            We.clear(), Xe("losa-rect"), jn();
            break;
          }
          case "losa-plana":
          case "flat-slab": {
            We.clear(), Xe("losa-plana"), Wn();
            break;
          }
          case "viga-alta":
          case "deep-beam": {
            We.clear(), Xe("viga-alta"), Yn();
            break;
          }
          case "muro-contencion":
          case "retaining-wall": {
            We.clear(), Xe("muro-contencion"), Gn();
            break;
          }
          case "zapata":
          case "footing": {
            We.clear(), Xe("zapata"), Jn();
            break;
          }
          case "placa-orificios":
          case "plate-holes":
          case "placa-base": {
            We.clear(), Xe("placa-orificios"), Vn();
            break;
          }
          case "col-placa":
          case "columna-placa": {
            We.clear(), Xe("col-placa"), Xn();
            break;
          }
          case "talud":
          case "slope": {
            We.clear(), Xe("talud"), Kn();
            break;
          }
          case "eiffel":
          case "torre-eiffel": {
            We.clear(), Xe("eiffel"), ps();
            break;
          }
          case "arco":
          case "arco-gateway": {
          ...
          case "opera":
          case "sydney-opera": {
            We.clear(), Xe("opera"), hs();
            break;
          }
          case "diagrid":
          case "gherkin": {
            We.clear(), Xe("diagrid"), gs();
            break;
          }
          default:
      ...
      plateQ4(t = 10, o = 10, n = 16, l = 16, s = "simply-supported", d = -10, a = 0.2, c = 3e7, m = 0.3, r = 0) {
        ...
        return setTimeout(() => bt(), 50), Ye(), E;
      },
      set(t, o) {
        V[t] ? (V[t].val = o, console.log(`${t} = ${o}`), jt(), be()) : Ue[t] ? (Ue[t].val = o, console.log(`${t} = ${o}`), jt(), be()) : console.error(`Par\xE1metro "${t}" no encontrado. Disponibles: ${Object.keys({
          ...V,
          ...Ue
        }).join(", ")}`);
      },
      get(t) {
        if (!t) {
          ...
          for (const l in Ue) o[l] = Ue[l].val;
          o.plateTheory = kt, o.supportType = $t;
          const n = Yo()[z];
          return n && n[$t] && (o.supportLabel = n[$t].label), console.table(o), o;
        }
        if (V[t]) return V[t].val;
        if (Ue[t]) return Ue[t].val;
      ...
      setBc(t) {
        ...
        $t = t, $t >= o.length && ($t = 0), console.log(`Apoyo: ${o[$t].label} \u2192 DOFs: [${o[$t].dofs.map((n) => n ? "1" : "0").join(",")}]`), jt(), be();
      },
      help() {
        console.log(`
=== FEM Studio CLI ===
...
Util:     cad.info()  cad.clear()  cad.help()
      ...
      units(t, o) {
        t && (g = t), o && (N = o), S = bo(g, N);
        const n = ve.querySelector("#cad3d-force-unit"), l = ve.querySelector("#cad3d-length-unit");
        return n && (n.textContent = g), l && (l.textContent = N), z && Xe(z), console.log(`Unidades: ${S.label} | E=${S.E.toExponential(3)} ${S.stress}`), S.id;
      },
      view(t) {
      },
      get mesh() {
    ...
    function Xe(t) {
      ...
      Ue = {};
      const n = Nn()[t];
      if (n) for (const l of n) Ue[l.key] = {
        val: l.val,
        min: l.min,
        max: l.max,
        step: l.step,
    ...
    function j(t) {
      var _a2, _b;
      return ((_a2 = V[t]) == null ? void 0 : _a2.val) ?? ((_b = Ue[t]) == null ? void 0 : _b.val) ?? 0;
    }
    function be() {
      switch (z) {
        case "truss":
    ...
    function Bn() {
      const t = j("Lx") || 15, o = j("Ly") || 10, n = j("meshSize") || 0.5, l = j("q") || -3, s = j("t") || 1, d = j("E") || 3e7, a = j("nu") || 0.3, c = d / (2 * (1 + a)), m = kt === 1 ? "Membrana" : kt === 2 ? "Kirchhoff" : "Mindlin", { nodes: r, elements: i, boundaryIndices: h } = Ut({
        points: [
          [
            0,
            0,
      ...
      try {
        const u = Ot(r, i, e.nodeInputs.val, e.elementInputs.val);
    ...
    function Dn() {
      const t = j("Lx") || 10, o = j("Ly") || 10, n = Math.round(j("nx") || 16), l = Math.round(j("ny") || 16), s = j("t") || 0.2, d = j("q") || -10, a = j("E") || 3e7, c = j("nu") || 0.3, m = $t === 1 ? "clamped" : "simply-supported", i = {
        1: 2,
        2: 1,
        3: 0
      }[kt] ?? 0;
    ...
    function Wn() {
      const t = j("t") || 0.2, o = j("q") || -10, n = j("E") || 35e6, l = j("nu") || 0.2, s = j("meshSize") || 0.6, d = [
        ...
        3.6,
        3
      ], c = d.reduce((q, T) => q + T, 0), m = a.reduce((q, T) => q + T, 0), r = [
        0
      ];
      ...
      for (let q = 0; q <= E; q++) for (let T = 0; T <= h; T++) p.push([
        T * w,
        q * x
      ]);
      const u = [], v = /* @__PURE__ */ new Set();
      for (const q of r) for (const T of i) {
        let P = 1 / 0, O = 0;
        for (let te = 0; te < p.length; te++) {
          const ne = Math.hypot(p[te][0] - q, p[te][1] - T);
          ne < P && (P = ne, O = te);
        }
      ...
      if (e.nodeInputs && (e.nodeInputs.val = {
        ...
        const q = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ new Map();
    ...
    function Yn() {
      const t = j("L") || 4, o = j("H") || 2, n = j("t") || 0.1, l = j("E") || 2e7, s = j("nu") || 0.2, d = l / (2 * (1 + s)), a = j("q") || -100, c = j("b") || 0.8, m = j("meshSize") || 0.2, { nodes: r, elements: i, boundaryIndices: h } = Ut({
        points: [
          [
            0,
            0,
      ...
      try {
        const b = Ot(E, i, A, F), f = Eo(E, i, F, b), y = E.map((I) => [
          I[0],
          0,
          I[1]
        ]);
    ...
    function Gn() {
      const t = j("H") || 4, o = j("B") || 3, n = j("tw") || 0.3, l = j("tb") || 0.4, s = j("meshSize") || 0.2, d = j("E") || 25e6, a = j("nu") || 0.2, c = d / (2 * (1 + a)), m = j("gamma") || 18, r = j("Ka") || 0.33, i = j("Es") || 5e4, h = j("nus") || 0.3, E = i / (2 * (1 + h)), w = j("kn") || 1e6, x = j("ks") || 1e4, p = j("gammaW") || 9.81, u = j("Hw") || 3.5, v = j("qs") || 0, M = $t, $ = o * 0.3, F = o * 0.7, A = [
        [
          -$,
          0,
          0
      ...
      if (M === 0) {
        ...
        if (M === 2) {
          ...
          const Re = f.length, Oe = [];
          for (let oe = 0; oe < Re; oe++) {
            const Ee = f[oe], He = (b[Ee[0]][0] + b[Ee[1]][0] + b[Ee[2]][0]) / 3, at = (b[Ee[0]][1] + b[Ee[1]][1] + b[Ee[2]][1]) / 3, ft = He >= -$ && He <= F && at >= 0 && at <= l, So = He >= 0 && He <= n && at >= l && at <= l + t, ao = ft || So;
            if (Oe.push(!ao), !ao) for (let Jt = 0; Jt < Ee.length; Jt++) {
              const Xt = Me.get(Ee[Jt]);
              Xt !== void 0 && (Ee[Jt] = Xt);
            }
          }
          const ae = f.length;
          for (let oe = 0; oe < U.length - 1; oe++) {
            const Ee = U[oe], He = U[oe + 1], at = Me.get(Ee), ft = Me.get(He);
            f.push([
              He,
              Ee,
              at,
          ...
          const ge = f.length - ae, we = /* @__PURE__ */ new Map(), fe = /* @__PURE__ */ new Map(), Te = /* @__PURE__ */ new Map(), Ne = /* @__PURE__ */ new Map(), Qe = /* @__PURE__ */ new Map();
          for (let oe = 0; oe < Re; oe++) Oe[oe] ? (we.set(oe, i), fe.set(oe, i), Ne.set(oe, h), Qe.set(oe, E), Te.set(oe, 1)) : (we.set(oe, d), fe.set(oe, d), Ne.set(oe, a), Qe.set(oe, c), Te.set(oe, 1));
          for (let oe = ae; oe < f.length; oe++) we.set(oe, w), fe.set(oe, 0), Ne.set(oe, 0), Qe.set(oe, x), Te.set(oe, 0);
          I = {
            elasticities: we,
          ...
          for (let oe = 0; oe < Re; oe++) {
            if (!Oe[oe]) continue;
            const Ee = f[oe], He = b[Ee[0]], at = b[Ee[1]], ft = b[Ee[2]], So = Math.abs((at[0] - He[0]) * (ft[1] - He[1]) - (ft[0] - He[0]) * (at[1] - He[1])) / 2, ao = -m * So / 3;
            for (const Jt of Ee) {
              const Xt = k.get(Jt) || [
                0,
                0,
          ...
          if (v > 0) {
            ...
            for (let Ee = 0; Ee < oe.length; Ee++) {
              ...
              const at = -v * He, ft = k.get(oe[Ee].idx) || [
                0,
                0,
                0,
                0,
          ...
          const re = (ae) => {
            ...
            return fe || Te;
          }, ee = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), se = /* @__PURE__ */ new Map(), Me = /* @__PURE__ */ new Map(), Re = /* @__PURE__ */ new Map(), Oe = [];
          for (let ae = 0; ae < f.length; ae++) {
            const ge = re(f[ae]);
            Oe.push(!ge), ge ? (ee.set(ae, d), U.set(ae, d), Me.set(ae, a), Re.set(ae, c), se.set(ae, 1)) : (ee.set(ae, i), U.set(ae, i), Me.set(ae, h), Re.set(ae, E), se.set(ae, 1));
          }
          I = {
            elasticities: ee,
          ...
          for (let ae = 0; ae < f.length; ae++) {
            if (!Oe[ae]) continue;
            const ge = f[ae], we = b[ge[0]], fe = b[ge[1]], Te = b[ge[2]], Ne = Math.abs((fe[0] - we[0]) * (Te[1] - we[1]) - (Te[0] - we[0]) * (fe[1] - we[1])) / 2, Qe = -m * Ne / 3;
            for (const oe of ge) {
              const Ee = k.get(oe) || [
                0,
                0,
      ...
      if (M === 3) {
        ...
        for (let re = 0; re < ne.length; re++) {
          ...
          const Me = Math.min(se, O), Re = p * Me;
          let Oe = s;
      ...
      try {
        const T = Ot(b, f, _, I), P = f.filter((se) => se.length === 3), O = {};
        for (const se of Object.keys(I)) {
          const Me = I[se];
          if (Me && Me instanceof Map) {
            const Re = /* @__PURE__ */ new Map();
            let Oe = 0;
            for (let ae = 0; ae < f.length; ae++) f[ae].length === 3 && (Me.has(ae) && Re.set(Oe, Me.get(ae)), Oe++);
            O[se] = Re;
          }
        }
        const te = Eo(b, P, O, T), ne = b.map((se) => [
          se[0],
          0,
          se[1]
        ]);
        if (e.nodes.val = ne, e.elements.val = P, T && T.deformations) {
          const se = /* @__PURE__ */ new Map();
          T.deformations.forEach((Me, Re) => {
            se.set(Re, [
              Me[0],
              Me[2],
              Me[1],
        ...
        let U = 0;
        T && T.deformations && T.deformations.forEach((se) => {
    ...
    function Jn() {
      ...
      for (let y = 0; y <= a; y++) for (let k = 0; k <= d; k++) {
        const I = k * w, _ = y * x;
        Math.abs(I - p) <= v + 1e-6 && Math.abs(_ - u) <= v + 1e-6 && A.push({
          node: y * (d + 1) + k,
          dof: 0,
          value: F
        });
      ...
      if (Math.abs(i) > 1e-6) {
        ...
        for (let I = 0; I <= a; I++) for (let _ = 0; _ <= d; _++) {
          const q = _ * w, T = I * x;
          if (Math.abs(q - p) <= v + 1e-6 && Math.abs(T - u) <= v + 1e-6) {
            const P = T - u;
            if (Math.abs(P) > 1e-6) {
              const O = P > 0 ? 1 : -1;
              A.push({
      ...
      try {
        ...
        const _ = y.elementResults.map((te) => [
          ...te.nodes
        ]);
        _.push([
          I,
        ...
        y.nodeResults.forEach((te, ne) => {
          ...
          (re < 1e-6 || re > t - 1e-6 || ee < 1e-6 || ee > o - 1e-6) && T.set(ne, [
            false,
            false,
            true,
            false,
    ...
    function Vn() {
      ...
      const { nodes: M, elements: $ } = Ut({
        ...
        for (const [P, O] of v) if ((q - P) * (q - P) + (T - O) * (T - O) < p * p) return true;
        return false;
      }, A = $.filter((q) => {
        const T = (M[q[0]][0] + M[q[1]][0] + M[q[2]][0]) / 3, P = (M[q[0]][1] + M[q[1]][1] + M[q[2]][1]) / 3;
        return !F(T, P);
      }), b = M, f = /* @__PURE__ */ new Map();
      for (let q = 0; q < b.length; q++) {
        const T = b[q][0], P = b[q][1];
        for (const [O, te] of v) {
          const ne = Math.sqrt((T - O) * (T - O) + (P - te) * (P - te));
      ...
      const _ = {
        elasticities: new Map(A.map((q, T) => [
          T,
          m
        ])),
        elasticitiesOrthogonal: new Map(A.map((q, T) => [
          T,
          m
        ])),
        thicknesses: new Map(A.map((q, T) => [
          T,
          n
        ])),
        poissonsRatios: new Map(A.map((q, T) => [
          T,
          r
        ])),
        shearModuli: new Map(A.map((q, T) => [
          T,
          i
        ]))
      };
    ...
    function Xn() {
      const t = j("colB") || 0.3, o = j("colH") || 0.3, n = j("colT") || 8e-3, l = j("colLen") || 1.5, s = j("Lx") || 0.45, d = j("Ly") || 0.45, a = j("tPlaca") || 0.025, c = j("dBolt") || 0.022, m = j("sx") || 0.32, r = j("sy") || 0.32, i = Math.round(j("nSubColV") || 6), h = Math.round(j("nSubColH") || 4), E = Math.round(j("nSubPlaca") || 10), w = j("E") || 2e8, x = j("nu") || 0.3, p = w / (2 * (1 + x)), u = j("P") || -300, v = s / 2, M = d / 2, $ = c / 2, F = t / 2, A = o / 2, b = [], f = [], y = E, k = s / y, I = d / y, _ = (fe, Te) => Te * (y + 1) + fe;
      ...
      const q = [
        ...
        for (const [Ne, Qe] of q) if ((fe - Ne) * (fe - Ne) + (Te - Qe) * (Te - Qe) < $ * $) return true;
        return false;
      }, P = f.length;
      for (let fe = 0; fe < y; fe++) for (let Te = 0; Te < y; Te++) {
        const Ne = (Te + 0.5) * k, Qe = (fe + 0.5) * I;
        T(Ne, Qe) || f.push([
          _(Te, fe),
          _(Te + 1, fe),
          _(Te + 1, fe + 1),
      ...
      for (const [fe, Te] of U) {
        const [Ne, Qe] = re[fe], [oe, Ee] = re[Te], He = [];
        for (let at = 0; at <= te; at++) {
          const ft = [], So = at / te * l;
          for (let ao = 0; ao <= ne; ao++) {
            const Jt = ao / ne, Xt = Ne + Jt * (oe - Ne), wn = Qe + Jt * (Ee - Qe);
            if (at === 0) {
              const Kt = se(Xt, wn);
              if (Kt >= 0) {
                ft.push(Kt);
            ...
            let Sn = -1;
            for (let Kt = 0; Kt < b.length; Kt++) if (Math.abs(b[Kt][0] - Xt) < 1e-6 && Math.abs(b[Kt][1] - wn) < 1e-6 && Math.abs(b[Kt][2] - So) < 1e-6) {
              Sn = Kt;
              break;
            }
        ...
        for (let at = 0; at < te; at++) for (let ft = 0; ft < ne; ft++) f.push([
          He[at][ft],
          He[at][ft + 1],
          He[at + 1][ft + 1],
          He[at + 1][ft]
      ...
      const Me = f.length - ee, Re = /* @__PURE__ */ new Map();
      for (let fe = 0; fe < (y + 1) * (y + 1); fe++) {
        const Te = b[fe][0], Ne = b[fe][1];
        for (const [Qe, oe] of q) {
          const Ee = Math.sqrt((Te - Qe) * (Te - Qe) + (Ne - oe) * (Ne - oe));
          Ee >= $ * 0.5 && Ee <= $ * 2 && Re.set(fe, [
            true,
            true,
            true,
            true,
      ...
      try {
        ...
        let Ne = 0;
        (fe == null ? void 0 : fe.deformations) && fe.deformations.forEach((Qe) => {
          const oe = Math.sqrt(Qe[0] * Qe[0] + Qe[1] * Qe[1] + Qe[2] * Qe[2]);
          Ne = Math.max(Ne, oe);
    ...
    function Kn() {
      ...
      try {
        ...
        for (const [T, P] of f.displacements) {
          const O = Math.sqrt(T * T + P * P);
          _ = Math.max(_, O);
        }
        let q = 0;
        for (const T of f.plasticStrain) q = Math.max(q, T);
    ...
    function co(t) {
      const o = An.find((l) => l.id === W.forceId), n = Io.find((l) => l.id === W.lengthId);
    ...
    function Un(t, o, n, l, s) {
      const d = Le.steelVigaType, a = d === 0 ? Go() : Jo();
      if (Le.vigaMat === 0) {
        for (let c = 0; c < o.length; c++) {
          const m = o[c], r = `b${n}${c}`, i = `h${n}${c}`, h = {};
          h[r] = +lt(m.b).toFixed(2), h[i] = +lt(m.h).toFixed(2), t.addBinding(h, r, {
            min: l[0],
            max: l[1],
            step: l[2],
            label: `b sv${n}${c + 1}`
        ...
        t.on("change", (c) => {
          ...
          r && (o[parseInt(r[1])].b = it(c.value), be()), i && (o[parseInt(i[1])].h = it(c.value), be());
        });
      } else if (d <= 1) {
        for (let c = 0; c < o.length; c++) {
          const m = {};
        ...
        for (let c = 0; c < o.length; c++) {
          const m = o[c], r = {}, i = `${n}${c}`;
          r[`bf${i}`] = +lt(m.bf ?? 0.2).toFixed(3), r[`h${i}`] = +lt(m.hf ?? 0.4).toFixed(3), r[`tf${i}`] = +lt(m.tf ?? 0.015).toFixed(3), r[`tw${i}`] = +lt(m.tw ?? 0.01).toFixed(3), t.addBinding(r, `bf${i}`, {
            min: l[0],
            max: l[1],
            step: l[2],
            label: `bf sv${n}${c + 1}`
        ...
        t.on("change", (c) => {
          ...
          for (let r = 0; r < o.length; r++) {
            const i = `${n}${r}`;
            m === `bf${i}` && (o[r].bf = it(c.value), be()), m === `h${i}` && (o[r].hf = it(c.value), be()), m === `tf${i}` && (o[r].tf = it(c.value), be()), m === `tw${i}` && (o[r].tw = it(c.value), be());
          }
        });
      } else {
        for (let c = 0; c < o.length; c++) {
          const m = o[c], r = {}, i = `${n}${c}`;
          r[`bc${i}`] = +lt(m.bc ?? 0.2).toFixed(3), r[`hc${i}`] = +lt(m.hc ?? 0.3).toFixed(3), r[`t${i}`] = +lt(m.t ?? 8e-3).toFixed(3), t.addBinding(r, `bc${i}`, {
            min: l[0],
            max: l[1],
            step: l[2],
            label: `b sv${n}${c + 1}`
        ...
        t.on("change", (c) => {
          ...
          for (let r = 0; r < o.length; r++) {
            const i = `${n}${r}`;
            m === `bc${i}` && (o[r].bc = it(c.value), be()), m === `hc${i}` && (o[r].hc = it(c.value), be()), m === `t${i}` && (o[r].t = it(c.value), be());
          }
        });
      }
    }
    function xo() {
      ...
      for (; Le.perFloor.length < l; ) {
        const b = Le.perFloor.length > 0 ? JSON.parse(JSON.stringify(Le.perFloor[Le.perFloor.length - 1])) : Oo(a, c);
        Le.perFloor.push(b);
      }
      Le.perFloor.length > l && (Le.perFloor.length = l);
      for (const b of Le.perFloor) {
      ...
      if (ct.addBinding(m, "colMat", {
        ...
        Le.colMat = b.value, xo(), be();
      }), Le.colMat === 0) {
        const b = {
          forma: Le.colShape
        };
        ct.addBinding(b, "forma", {
          label: "Col forma",
          options: {
            Rectangular: 0,
            Circular: 1
          ...
          Le.colShape = y.value, xo(), be();
        });
        const f = {
          fc: +co(Le.fc).toFixed(1)
        };
        ct.addBinding(f, "fc", {
          min: d[0],
          max: d[1],
          ...
          var _a3;
          ((_a3 = y.target) == null ? void 0 : _a3.key) === "fc" && (Le.fc = nn(y.value), be());
        });
      } else if (Le.colMat === 1) {
        const b = {
          colType: Le.steelColType
        };
        ct.addBinding(b, "colType", {
          label: "Col tipo",
          options: {
            "W profile": 0,
            "HSS profile": 1,
      ...
      if (ct.addBinding(r, "vigaMat", {
        ...
        Le.vigaMat = b.value, xo(), be();
      }), Le.vigaMat === 1) {
        const b = {
          vigaType: Le.steelVigaType
        };
        ct.addBinding(b, "vigaType", {
          label: "Viga tipo",
          options: {
            "W profile": 0,
            "HSS profile": 1,
          ...
          Le.steelVigaType = f.value, xo(), be();
        });
      }
      const i = Le.steelColType === 0 ? Go() : Jo();
      Le.steelVigaType === 0 ? Go() : Jo();
      const h = N === "m" ? [
        5e-3,
        0.1,
        1e-3
      ...
      for (let b = 0; b < l; b++) {
        const f = Le.perFloor[b], y = ct.addFolder({
          title: `Piso ${b + 1}`,
          expanded: b < 2
        });
        if (Le.colMat === 0) if (Le.colShape === 1) {
          const k = {
            dCol: +lt(f.dCol).toFixed(2)
          };
          y.addBinding(k, "dCol", {
            min: s[0],
            max: s[1],
            ...
            var _a3;
            ((_a3 = I.target) == null ? void 0 : _a3.key) === "dCol" && (f.dCol = it(I.value), be());
          });
        } else {
          const k = {
            bCol: +lt(f.bCol).toFixed(2),
            hCol: +lt(f.hCol).toFixed(2)
          };
          y.addBinding(k, "bCol", {
            min: s[0],
            max: s[1],
            ...
            var _a3, _b;
            ((_a3 = I.target) == null ? void 0 : _a3.key) === "bCol" && (f.bCol = it(I.value), be()), ((_b = I.target) == null ? void 0 : _b.key) === "hCol" && (f.hCol = it(I.value), be());
          });
        }
          ...
          const k = {
            bf: +lt(f.colBf ?? 0.3).toFixed(3),
            h: +lt(f.colHf ?? 0.3).toFixed(3),
            tf: +lt(f.colTf ?? 0.02).toFixed(3),
            tw: +lt(f.colTw ?? 0.012).toFixed(3)
          };
          y.addBinding(k, "bf", {
            min: s[0],
            max: s[1],
            ...
            var _a3, _b, _c, _d;
            ((_a3 = I.target) == null ? void 0 : _a3.key) === "bf" && (f.colBf = it(I.value), be()), ((_b = I.target) == null ? void 0 : _b.key) === "h" && (f.colHf = it(I.value), be()), ((_c = I.target) == null ? void 0 : _c.key) === "tf" && (f.colTf = it(I.value), be()), ((_d = I.target) == null ? void 0 : _d.key) === "tw" && (f.colTw = it(I.value), be());
          });
        } else {
          const k = {
            bc: +lt(f.colBc ?? 0.3).toFixed(3),
            hc: +lt(f.colHc ?? 0.3).toFixed(3),
            t: +lt(f.colT ?? 0.01).toFixed(3)
          };
          y.addBinding(k, "bc", {
            min: s[0],
            max: s[1],
            ...
            var _a3, _b, _c;
            ((_a3 = I.target) == null ? void 0 : _a3.key) === "bc" && (f.colBc = it(I.value), be()), ((_b = I.target) == null ? void 0 : _b.key) === "hc" && (f.colHc = it(I.value), be()), ((_c = I.target) == null ? void 0 : _c.key) === "t" && (f.colT = it(I.value), be());
          });
        }
        else {
          const k = {
          ...
          const I = +co(1e8).toFixed(0), _ = +co(3e8).toFixed(0), q = Math.max(1, Math.round((_ - I) / 200));
          y.addBinding(k, "Es", {
            min: I,
            max: _,
            step: q,
            ...
            ((_a3 = T.target) == null ? void 0 : _a3.key) === "bc" && (f.colBc = it(T.value), be()), ((_b = T.target) == null ? void 0 : _b.key) === "hc" && (f.colHc = it(T.value), be()), ((_c = T.target) == null ? void 0 : _c.key) === "t" && (f.colT = it(T.value), be()), ((_d = T.target) == null ? void 0 : _d.key) === "Es" && (f.colEs = nn(T.value), be()), ((_e2 = T.target) == null ? void 0 : _e2.key) === "nuS" && (f.colNuS = T.value, be()), ((_f = T.target) == null ? void 0 : _f.key) === "fc" && (f.colFc = nn(T.value), be()), ((_g = T.target) == null ? void 0 : _g.key) === "nuC" && (f.colNuC = T.value, be());
          });
        }
      ...
      E.addBinding(w, "activar", {
        ...
        var _a3, _b, _c;
        ((_a3 = b.target) == null ? void 0 : _a3.key) === "activar" && (Je = b.value, be()), ((_b = b.target) == null ? void 0 : _b.key) === "direccion" && (yt = b.value === 0 ? "x" : "y", be()), ((_c = b.target) == null ? void 0 : _c.key) === "cantidad" && (Ve = Math.round(b.value), be());
      }), ct.addBlade({
        view: "separator"
      });
      const x = ct.addFolder({
        title: "Losas de Piso",
        expanded: true
      }), p = {
        activar: ht,
        espesor: +lt(wt).toFixed(3),
        subdivX: At,
        subdivY: Ht
      };
      x.addBinding(p, "activar", {
        ...
        var _a3, _b, _c, _d;
        ((_a3 = b.target) == null ? void 0 : _a3.key) === "activar" && (ht = b.value, be()), ((_b = b.target) == null ? void 0 : _b.key) === "espesor" && (wt = it(b.value), be()), ((_c = b.target) == null ? void 0 : _c.key) === "subdivX" && (At = Math.round(b.value), be()), ((_d = b.target) == null ? void 0 : _d.key) === "subdivY" && (Ht = Math.round(b.value), be());
      }), ct.addBlade({
        view: "separator"
      });
      const u = ct.addFolder({
        title: "Muros de Corte",
        expanded: true
      }), v = {
        espesor: +lt(ze).toFixed(3),
        subdivH: Pe,
        subdivW: tt
      };
      u.addBinding(v, "espesor", {
        ...
        var _a3, _b, _c;
        ((_a3 = b.target) == null ? void 0 : _a3.key) === "espesor" && (ze = it(b.value), be()), ((_b = b.target) == null ? void 0 : _b.key) === "subdivH" && (Pe = Math.round(b.value), be()), ((_c = b.target) == null ? void 0 : _c.key) === "subdivW" && (tt = Math.round(b.value), be());
      });
      ...
      if (M > 0) {
        ...
        for (let f = 0; f < M; f++) for (let y = 0; y < A; y++) {
          const k = `wx_${f}_${y}`, I = de.some((T) => T.dir === "x" && T.bay === f && T.axisIdx === y), _ = {};
          _[k] = I;
          ...
          b.addBinding(_, k, {
            ...
            }) : de = de.filter((P) => !(P.dir === "x" && P.bay === f && P.axisIdx === y)), be();
          });
        }
      }
      if ($ > 0) {
        ...
        for (let f = 0; f < $; f++) for (let y = 0; y < F; y++) {
          const k = `wy_${f}_${y}`, I = de.some((T) => T.dir === "y" && T.bay === f && T.axisIdx === y), _ = {};
          _[k] = I;
          ...
          b.addBinding(_, k, {
            ...
            }) : de = de.filter((P) => !(P.dir === "y" && P.bay === f && P.axisIdx === y)), be();
          });
        }
      }
      if (de.length > 0) {
    ...
    function jt() {
      ...
      if (n) {
        ...
        for (const a of n) {
          ...
          d.addBinding(c, "min", {
            ...
            V[a.key] && (V[a.key].min = c.min, V[a.key].max = c.max, V[a.key].val < c.min && (V[a.key].val = c.min), V[a.key].val > c.max && (V[a.key].val = c.max)), jt(), be();
          });
        }
        he.on("change", (a) => {
          var _a2;
      ...
      if (l && l.length > 0) {
        ...
        const s = {};
        for (const a of l) s[a.key] = Ue[a.key].val;
        for (const a of l) Dt.addBinding(s, a.key, {
          min: Ue[a.key].min,
          max: Ue[a.key].max,
          step: Ue[a.key].step,
          label: Ue[a.key].label
        });
        const d = Dt.addFolder({
          title: "Rangos",
          expanded: false
        });
        for (const a of l) {
          ...
          d.addBinding(c, "min", {
            ...
            Ue[a.key] && (Ue[a.key].min = c.min, Ue[a.key].max = c.max, Ue[a.key].val < c.min && (Ue[a.key].val = c.min), Ue[a.key].val > c.max && (Ue[a.key].val = c.max)), jt(), be();
          });
        }
        Dt.on("change", (a) => {
          var _a2;
          const c = (_a2 = a.target) == null ? void 0 : _a2.key;
          if (c && Ue[c]) {
            if (Ue[c].val = a.value, e.nodeInputs) {
      ...
      window.__cad = {
        setParam: (s, d) => {
          if (V[s]) V[s].val = d, be(), jt();
          else if (Ue[s]) {
            if (Ue[s].val = d, e.nodeInputs) {
        ...
        getParams: () => {
          ...
          for (const d in Ue) s[d] = Ue[d].val;
          return s;
        },
        setGenerator: Xe
      };
  ...
  `, document.head.appendChild(Zn), oa() === "light" && document.documentElement.classList.add("awatif-light"), na((t) => {
      t === "light" ? document.documentElement.classList.add("awatif-light") : document.documentElement.classList.remove("awatif-light"), z && bt(true);
    }), ve.innerHTML = `
...
`);
    ...
    `, document.body.appendChild(dt), (_a2 = dt.querySelector("#export-close")) == null ? void 0 : _a2.addEventListener("click", () => {
        dt == null ? void 0 : dt.remove(), dt = null, Lo = false;
        ...
        Lo = !Lo, Lo ? (o.style.display = "none", n.textContent = "\u25A2", n.title = "Restaurar", dt.style.width = "auto") : (o.style.display = "flex", n.textContent = "\u25AC", n.title = "Minimizar", dt.style.width = "720px");
        ...
        const m = dt.querySelector("#export-text");
    ...
    function an() {
      var _a2;
      if (!Lt || !e.nodeInputs || !e.elementInputs) return;
      ...
      if (!(t.length === 0 || o.length === 0) && !(!n.supports || n.supports.size === 0) && !(!l.densities || l.densities.size === 0)) try {
        ...
        if (d.frequencies && d.frequencies.length > 0) {
          ...
          const { extent: a } = eo(), c = (_a2 = d.modeShapes) == null ? void 0 : _a2[0];
          if (c) {
            let r = 0;
            ...
            ke = r > 1e-12 ? a * 0.05 / r : 1;
          }
          const m = `${z} \u2014 ${t.length}n ${o.length}e`;
          pe.render(d, {
            title: m
          }), pe.div.style.display = "", To(), console.log(`Modal: ${d.frequencies.length} modos. f\u2081 = ${d.frequencies[0].toFixed(4)} Hz`);
        }
      } catch (s) {
    ...
    function ln() {
      ye && (cancelAnimationFrame(ye), ye = 0), Q.length > 0 && (e.nodes.val = Q.map((t) => [
        ...t
      ])), pe.div.style.display = "none", ie = null;
    }
    function To() {
      var _a2;
      if (ye && cancelAnimationFrame(ye), !(ie == null ? void 0 : ie.modeShapes) || !Q.length) return;
      const t = ie.modeShapes[pt];
      if (!t) return;
      const o = ((_a2 = ie.frequencies) == null ? void 0 : _a2[pt]) || 1, n = Math.max(0.5, Math.min(3, o * 0.1)), l = performance.now(), s = Q.length, d = e.elements.rawVal, { extent: a } = eo(), c = ve.querySelector("#cad3d-modal-scale"), m = c && parseFloat(c.value) || 5;
      let r = 0;
      for (let $ = 0; $ < s; $++) {
        const F = t[$ * 6] || 0, A = t[$ * 6 + 1] || 0, b = t[$ * 6 + 2] || 0;
        r = Math.max(r, Math.sqrt(F * F + A * A + b * b));
      }
      const i = r > 1e-12 ? a * m / 100 / r : 1, h = Ze();
      if (!h) return;
      ...
      function M() {
        ...
        if (E) {
          ...
          b && b.array.length === p.length ? (b.array.set(p), b.needsUpdate = true) : A.setAttribute("position", new uo(p.slice(), 3));
        }
        if (w) {
          ...
          b && b.array.length === v.length ? (b.array.set(v), b.needsUpdate = true) : A.setAttribute("position", new uo(v.slice(), 3));
        }
        if (x) {
          const A = [];
    ...
    function rn() {
      ...
      if (!n.loads || n.loads.size === 0) {
        ...
        for (let T = 0; T < t.length; T++) n.supports.has(T) || F.push(T);
        const A = (T) => Math.round(T * 1e3) / 1e3, b = /* @__PURE__ */ new Set();
        n.supports.forEach((T, P) => {
          b.add(`${A(t[P][0])},${A(t[P][1])}`);
        });
        const f = /* @__PURE__ */ new Set();
        for (const T of F) b.has(`${A(t[T][0])},${A(t[T][1])}`) && f.add(T);
        const y = /* @__PURE__ */ new Set(), k = /* @__PURE__ */ new Set();
        if (v !== 0 || M !== 0) {
          let T = -1 / 0, P = -1 / 0;
          for (const te of f) T = Math.max(T, A(t[te][0])), P = Math.max(P, A(t[te][1]));
          ...
          O.forEach((te) => {
            if (v !== 0) {
              ...
              for (const re of te) if (A(t[re][0]) === T) {
                const ee = A(t[re][1]);
        ...
        for (let T = 0; T < o.length; T++) {
          const P = o[T], O = ((_a2 = l.densities) == null ? void 0 : _a2.get(T)) ?? 0;
          if (!(Math.abs(O) < 1e-15)) {
            if (P.length === 2) {
              const te = ((_b = l.areas) == null ? void 0 : _b.get(T)) ?? 0, ne = t[P[0]], re = t[P[1]], ee = Math.sqrt((re[0] - ne[0]) ** 2 + (re[1] - ne[1]) ** 2 + (re[2] - ne[2]) ** 2), se = -(O * te * ee * I) / 2;
              _.set(P[0], (_.get(P[0]) ?? 0) + se), _.set(P[1], (_.get(P[1]) ?? 0) + se);
            } else if (P.length >= 3) {
              const te = ((_c = l.thicknesses) == null ? void 0 : _c.get(T)) ?? 0;
              let ne = 0;
              if (P.length === 3) {
                const [U, se, Me] = P.map((Re) => t[Re]);
                ne = 0.5 * Math.abs((se[0] - U[0]) * (Me[1] - U[1]) - (Me[0] - U[0]) * (se[1] - U[1]));
              } else if (P.length === 4) {
                const [U, se, Me, Re] = P.map((Oe) => t[Oe]);
                if (ne = 0.5 * Math.abs((se[0] - U[0]) * (Me[1] - U[1]) - (Me[0] - U[0]) * (se[1] - U[1])) + 0.5 * Math.abs((Me[0] - U[0]) * (Re[1] - U[1]) - (Re[0] - U[0]) * (Me[1] - U[1])), ne < 1e-10) {
                  const Oe = [
                    se[0] - U[0],
                    se[1] - U[1],
                    se[2] - U[2]
              ...
              for (const U of P) _.set(U, (_.get(U) ?? 0) + ee);
            }
          }
        }
        const q = /* @__PURE__ */ new Set();
        for (const T of o) T.length === 2 && (q.add(T[0]), q.add(T[1]));
        for (const T of F) {
          const P = y.has(T) ? v : 0, O = k.has(T) ? M : 0, te = _.get(T) ?? 0, ne = q.has(T) ? u : 0, re = te + ne;
          (P !== 0 || O !== 0 || Math.abs(re) > 1e-10) && $.set(T, [
            P,
            O,
            re,
            0,
      ...
      const m = ((_d = n.supports) == null ? void 0 : _d.size) || 0, r = ((_e2 = n.loads) == null ? void 0 : _e2.size) || 0, i = t.length * 6, h = i - m * 6, E = [], w = (x) => E.push(x);
      ...
      try {
        const x = Ot(t, o, n, l), p = performance.now() - s;
        if (x) {
          ...
          const F = performance.now(), A = Eo(t, o, l, x), b = performance.now() - F;
      ...
      window.__femLog = E, console.log(`FEM Solver: ${t.length}n ${o.length}e \u2192 ${(performance.now() - s).toFixed(0)}ms`), Lt && setTimeout(() => an(), 50);
    }
    function cn(t, o) {
    ...
    function Qt() {
      ...
      if ((z === "edificio" || z === "frame") && ce.size > 0) {
        const { colMat: s, vigaMat: d, colShape: a, fc: c, perFloor: m } = Le, r = 4700 * Math.sqrt(c / 1e3) * 1e3, i = r / (2 * 1.2), h = 24 / 9.80665, E = o.E, w = o.G, x = o.rho;
        for (let p = 0; p < t.length; p++) {
          if (Fe.has(p)) {
            const y = 4700 * Math.sqrt(c / 1e3) * 1e3, k = 0.2;
            n.elasticities.set(p, y), n.poissonsRatios.set(p, k), n.thicknesses.set(p, ze), n.shearModuli.set(p, y / (2 * (1 + k))), n.densities.set(p, 24 / 9.80665);
            continue;
          }
          if (Bt.has(p)) {
            const y = 4700 * Math.sqrt(c / 1e3) * 1e3, k = 0.2;
            n.elasticities.set(p, y), n.poissonsRatios.set(p, k), n.thicknesses.set(p, wt), n.shearModuli.set(p, y / (2 * (1 + k))), n.densities.set(p, 24 / 9.80665);
            continue;
          }
          const u = ce.has(p), v = Ce.get(p) ?? 0, M = m[v] ?? m[0] ?? {
            bCol: 0.4,
            hCol: 0.4,
            dCol: 0.4
          };
          ...
          if (u) if (s === 0) F = r, A = i, b = h, $ = a === 1 ? Qn(M.dCol) : cn(M.bCol, M.hCol), n.sectionShapes.set(p, a === 1 ? {
            ...
            F = E, A = w, b = x;
            const y = Le.steelColType;
            if (y <= 1) {
              const k = ro[M.colProfileIdx] ?? ro[0];
              $ = {
                A: k.A,
                Iz: k.Iz,
                Iy: k.Iy,
            ...
            const y = M.colBc ?? 0.3, k = M.colHc ?? 0.3, I = M.colT ?? 0.01, _ = M.colFc ?? 28e3, q = M.colEs ?? 2e8, T = M.colNuS ?? 0.3;
            M.colNuC;
            const P = qs(y, k, I, q, T, _);
            $ = {
              A: P.A,
              Iz: P.Iz,
              Iy: P.Iy,
            ...
            const y = Be.get(p), k = y ? y.dir === "x" ? M.vigasX : M.vigasY : [], I = y ? k[y.bay] ?? k[0] ?? Et() : Et();
            if (d === 0) F = r, A = i, b = h, $ = cn(I.b, I.h), n.sectionShapes.set(p, {
              ...
              F = E, A = w, b = x;
              const _ = Le.steelVigaType;
              if (_ <= 1) {
                const q = ro[I.profileIdx ?? 0] ?? ro[0];
                $ = {
                  A: q.A,
                  Iz: q.Iz,
                  Iy: q.Iy,
                ...
                const q = I.bf ?? 0.2, T = I.hf ?? 0.4, P = I.tf ?? 0.015, O = I.tw ?? 0.01;
                $ = dn(q, T, P, O);
                const te = `I${(T * 100).toFixed(0)}x${(q * 100).toFixed(0)}`;
                n.sectionShapes.set(p, {
                  type: "I",
                  b: q,
                  h: T,
                ...
                const q = I.bc ?? 0.2, T = I.hc ?? 0.3, P = I.t ?? 8e-3;
                $ = pn(q, T, P);
                const O = `\u25A1${(T * 100).toFixed(0)}x${(q * 100).toFixed(0)}x${(P * 1e3).toFixed(0)}`;
                n.sectionShapes.set(p, {
                  type: "HSS",
                  b: q,
                  h: T,
    ...
    setTimeout(() => {
      ...
      (_a2 = ve.querySelector("#cad3d-toggle")) == null ? void 0 : _a2.addEventListener("click", (u) => {
        ...
        u.addEventListener("click", (v) => {
          ...
          to(M), ve.querySelectorAll("[data-view]").forEach(($) => $.classList.remove("view-active")), u.classList.add("view-active");
        });
      }), (_c = ve.querySelector("#cad3d-btn-clear")) == null ? void 0 : _c.addEventListener("click", (u) => {
        u.stopPropagation(), z = "", ws.val = false, zs(), We.clear();
      }), (_d = ve.querySelector("#cad3d-select")) == null ? void 0 : _d.addEventListener("click", (u) => {
        var _a3;
        u.stopPropagation(), Nt && (Nt = false, fo()), Wt && _o(), Tt = !Tt, (_a3 = ve.querySelector("#cad3d-select")) == null ? void 0 : _a3.classList.toggle("inspect-active", Tt);
        const M = Ze();
        M && (M.controls.enabled = !Tt), Tt || Ro();
      }), (_e2 = ve.querySelector("#cad3d-draw")) == null ? void 0 : _e2.addEventListener("click", (u) => {
        var _a3;
        u.stopPropagation(), Nt && (Nt = false, fo()), Tt && Ro(), Wt = !Wt, (_a3 = ve.querySelector("#cad3d-draw")) == null ? void 0 : _a3.classList.toggle("inspect-active", Wt), Wt ? Os() : _o();
      }), (_f = ve.querySelector("#cad3d-inspect")) == null ? void 0 : _f.addEventListener("click", (u) => {
        var _a3;
        u.stopPropagation(), Tt && Ro(), Wt && _o(), Nt = !Nt, (_a3 = ve.querySelector("#cad3d-inspect")) == null ? void 0 : _a3.classList.toggle("inspect-active", Nt), Nt || fo();
      ...
      function s(u) {
        ce = /* @__PURE__ */ new Set(), Ie = /* @__PURE__ */ new Set(), Ce = /* @__PURE__ */ new Map(), Be = /* @__PURE__ */ new Map();
        const v = /* @__PURE__ */ new Map();
        for (let I = 0; I < u.stories.length; I++) v.set(u.stories[I].name, I);
        for (let I = 0; I < u.elementTypes.length; I++) {
          const _ = u.elementTypes[I], q = u.elementStories[I], T = v.get(q) ?? 0;
          Ce.set(I, T), _ === "COLUMN" || _ === "BRACE" ? ce.add(I) : Ie.add(I);
        }
        z = "edificio";
        ...
        if (M.length > 0 || $.length > 0) F = M.map((I) => I.coord), A = $.map((I) => I.coord), b = M.map((I) => I.label), f = $.map((I) => I.label);
          ...
          F = [
            ...
            ..._
          ].sort((q, T) => q - T), b = F.map((q, T) => String(T + 1)), f = A.map((q, T) => String.fromCharCode(65 + T));
        }
        const y = u.stories.length > 0 ? Math.max(...u.stories.map((I) => I.elev)) : Math.max(...u.nodes.map((I) => I[2]));
        xe = F, De = A, setTimeout(() => {
          bt(), et(F, A, y, b, f), It(u.stories, F, A), fn(), un();
        }, 100);
        const k = {
          COLUMN: 0,
          BEAM: 0,
        ...
        console.log(`E2K grids: X=[${b.join(",")}] Y=[${f.join(",")}]`), console.log(`E2K stories: ${u.stories.map((I) => `${I.name}@${I.elev.toFixed(2)}`).join(", ")}`), console.log(`E2K elements: ${k.COLUMN} columns, ${k.BEAM} beams, ${k.BRACE} braces`), Ye();
      }
      function d(u, v) {
        const M = new Blob([
          u
      ...
      a && (a.value = g, a.addEventListener("change", (u) => {
        u.stopPropagation(), g = a.value, S = bo(g, N), z && Xe(z);
      }));
      const c = ve.querySelector("#cad3d-length-unit");
      c && (c.value = N, c.addEventListener("change", (u) => {
        u.stopPropagation(), N = c.value, S = bo(g, N), z && Xe(z);
      })), ve.querySelectorAll("[data-preset]").forEach((u) => {
        u.addEventListener("click", (v) => {
          v.stopPropagation();
          const M = u.dataset.preset, $ = R[M];
          $ && (g = $.force, N = $.length, W = $.stress, S = bo(g, N), a && (a.value = g), c && (c.value = N), ve.querySelectorAll("[data-preset]").forEach((F) => {
            F.classList.toggle("active", F.dataset.preset === M);
          }), z && Xe(z), console.log(`Preset: ${M} \u2192 ${g}+${N}, stress: ${W.label}`));
        });
        ...
        var _a3, _b2;
        u.stopPropagation(), Lt = !Lt, (_a3 = ve.querySelector("#cad3d-modal")) == null ? void 0 : _a3.classList.toggle("active", Lt);
      ...
      function m() {
        ...
        const v = ie.frequencies[pt], M = v > 0 ? 1 / v : 0, $ = [
          0,
          0,
          0,
          0,
        ...
        u.textContent = `Modo ${pt + 1} \u2014 ${v.toFixed(2)} Hz \u2014 T=${M.toFixed(3)}s \u2014 \u03A3Ux=${($[0] * 100).toFixed(1)}% \u03A3Uy=${($[1] * 100).toFixed(1)}% \u03A3Rz=${($[5] * 100).toFixed(1)}%`;
      }
      ...
      r == null ? void 0 : r.addEventListener("mousedown", (u) => u.stopPropagation()), r == null ? void 0 : r.addEventListener("change", () => {
        Lt && (ie == null ? void 0 : ie.modeShapes) && To();
      });
      ...
      i == null ? void 0 : i.addEventListener("mousedown", (u) => u.stopPropagation()), document.addEventListener("keydown", (u) => {
        ...
        if ((u.key === "Delete" || u.key === "Backspace") && nt.size > 0) {
          u.preventDefault(), nt.forEach((v) => G.add(v)), nt.clear(), Gt && (Gt.remove(), Gt = null), be();
          return;
        }
        if (u.key === "Escape") {
          if (Wt) if (st !== null) {
          ...
          Tt && Ro(), Nt && (Nt = false, fo(), (_a3 = ve.querySelector("#cad3d-inspect")) == null ? void 0 : _a3.classList.remove("inspect-active"));
        }
    ...
    function fn() {
      ...
      const o = (d, a, c) => {
        ...
        return m.textContent = d, m.dataset.view = a, m.title = c, m.style.cssText = "min-width:22px;padding:1px 5px;font-weight:bold", m.addEventListener("click", (r) => {
          ...
          ve.querySelectorAll("[data-view]").forEach((h) => h.classList.remove("view-active")), i ? (to("3d"), (_a2 = ve.querySelector('[data-view="3d"]')) == null ? void 0 : _a2.classList.add("view-active")) : (to(a), m.classList.add("view-active"));
        }), m;
    ...
    function un() {
      ...
      const n = (s, d, a) => {
        ...
        return c.textContent = s, c.dataset.view = d, c.title = a, c.style.cssText = "min-width:22px;padding:1px 5px;font-weight:bold", c.addEventListener("click", (m) => {
          ...
          ve.querySelectorAll("[data-view]").forEach((i) => i.classList.remove("view-active")), r ? (to("3d"), (_a3 = ve.querySelector('[data-view="3d"]')) == null ? void 0 : _a3.classList.add("view-active")) : (to(d), c.classList.add("view-active"));
        }), c;
    ...
    function As() {
      to("3d"), ve.querySelectorAll("[data-view]").forEach((t) => t.classList.toggle("view-active", t.dataset.view === "3d"));
    }
    We.view = (t) => {
      t = {
        planta: "plan",
        ...
        elevationY: "elevY",
        corte: "section"
      }[t] || t, to(t), ve.querySelectorAll("[data-view]").forEach((n) => n.classList.toggle("view-active", n.dataset.view === t));
    };
    let Nt = false, Tt = false, Wt = false, Mt = "line", Ft = [], st = null, gt = null, xt = null, vo = null, Ct = null;
    const rt = {
      node: true,
      grid: true,
      midpoint: true,
    ...
    let qt = null, oo = [], Yt = null, Gt = null;
    function hn(t) {
      const o = Ze();
      if (!o) return;
    ...
    `, document.body.appendChild(o), Gt = o, o.querySelector("#sel-assign").addEventListener("click", () => {
        Ks([
          ...nt
        ]);
...
${r.join(", ")}`);
        ...
        nt.forEach((n) => D.add(n)), nt.clear(), no(), so(), be();
      }), o.querySelector("#sel-isolate").addEventListener("click", () => {
        B = true, Y.clear(), nt.forEach((n) => Y.add(n)), nt.clear(), no(), so(), be();
      }), o.querySelector("#sel-showall").addEventListener("click", () => {
        D.clear(), B = false, Y.clear(), so(), be();
      }), o.querySelector("#sel-delete").addEventListener("click", () => {
        $o(), nt.forEach((n) => G.add(n)), nt.clear(), no(), so(), be();
    ...
    function Ro() {
      var _a2;
      Tt = false, nt.clear(), no(), Gt && (Gt.remove(), Gt = null), (_a2 = ve.querySelector("#cad3d-select")) == null ? void 0 : _a2.classList.remove("inspect-active");
      const o = Ze();
    ...
    function gn() {
      ...
      bn = [], po = null, Pt && (Pt.remove(), Pt = null);
    }
    function ss(t, o, n, l) {
    ...
    function _o() {
      var _a2;
      const t = Ze();
      gt && t && (t.scene.remove(gt), gt.geometry.dispose(), gt.material.dispose(), gt = null), xt && t && (t.scene.remove(xt), xt.geometry.dispose(), xt.material.dispose(), xt = null), gn(), st = null, Ct = null, Wt = false, vo && (vo.remove(), vo = null), (_a2 = ve.querySelector("#cad3d-draw")) == null ? void 0 : _a2.classList.remove("inspect-active"), t == null ? void 0 : t.render();
    }
    function Os() {
      vo && vo.remove();
      ...
      <button id="dt-line" style="${o(Mt === "line")}">\u{1F4CF} Line</button>
      <button id="dt-arc" style="${o(Mt === "arc")}">\u2312 Arc</button>
      <button id="dt-node" style="${o(Mt === "node")}">\u2295 Node</button>
      <button id="dt-area" style="${o(Mt === "area")}">\u25A2 Area</button>
      <span style="color:#666;margin:0 4px;">|</span>
      <span style="color:#888;font-size:10px;">Snap:</span>
      <button id="ds-node" style="${n(rt.node)}">Node</button>
      <button id="ds-grid" style="${n(rt.grid)}">Grid</button>
      <button id="ds-mid" style="${n(rt.midpoint)}">Mid</button>
      <button id="ds-track" style="${n(rt.track)}">Prolong</button>
      <span style="color:#666;margin:0 4px;">|</span>
    ...
    `, document.body.appendChild(t), vo = t;
      const l = () => {
        ...
        s && (s.style.cssText = o(Mt === "line")), d && (d.style.cssText = o(Mt === "arc")), a && (a.style.cssText = o(Mt === "node")), c && (c.style.cssText = o(Mt === "area"));
        const m = t.querySelector("#ds-node"), r = t.querySelector("#ds-grid"), i = t.querySelector("#ds-mid"), h = t.querySelector("#ds-track");
        m && (m.style.cssText = n(rt.node)), r && (r.style.cssText = n(rt.grid)), i && (i.style.cssText = n(rt.midpoint)), h && (h.style.cssText = n(rt.track));
      };
      t.querySelector("#dt-line").addEventListener("click", () => {
        Mt = "line", st = null, Ct = null, Ft = [], l();
      }), t.querySelector("#dt-arc").addEventListener("click", () => {
        Mt = "arc", st = null, Ct = null, Ft = [], l();
      }), t.querySelector("#dt-node").addEventListener("click", () => {
        Mt = "node", st = null, Ct = null, Ft = [], l();
      }), t.querySelector("#dt-area").addEventListener("click", () => {
        Mt = "area", st = null, Ct = null, Ft = [], console.log("Area mode: click vertices del poligono. Doble-click o click cerca del 1er punto para cerrar."), l();
    ...
    function as(t, o, n, l) {
      ...
      if (rt.grid) {
        const w = new lo(new Se(0, 0, 1), 0), x = new Se();
        if (c.ray.intersectPlane(w, x)) {
          const p = rt.gridSize || mn;
      ...
      const h = new lo(new Se(0, 0, 1), 0), E = new Se();
    ...
    function ls(t) {
      ...
      if (gt && (o.scene.remove(gt), gt.geometry.dispose(), gt.material.dispose(), gt = null), st !== null && t.worldPos) {
        const l = n[st], s = new io();
        if (Mt === "arc" && Ct !== null) {
          const a = n[Ct], c = is(new Se(l[0], l[1], l[2]), new Se(a[0], a[1], a[2]), t.worldPos, 16), m = [];
        ...
        gt = new Bo(s, d), Mt === "arc" && Ct !== null && (gt = new Ao(s, d)), gt.renderOrder = 9999, o.scene.add(gt);
      }
      o.render();
    }
    function is(t, o, n, l) {
    ...
    function Ns(t) {
      ...
      if (Mt === "arc") {
        ...
        if (o === st || o === Ct) return;
        const n = e.nodes.val, l = new Se(...n[st]), s = new Se(...n[Ct]), d = new Se(...n[o]), a = Math.max(4, Math.round(((_a2 = V.nSubViga) == null ? void 0 : _a2.val) ?? 8)), c = is(l, s, d, a);
        $o();
        const m = [
          ...e.nodes.val
        ], r = [
      ...
      if (Mt === "area") {
        ...
        if (Ft.length >= 3 && o === Ft[0]) {
          ...
          try {
            ...
            e.nodes.val = n, e.elements.val = l, Qt(), console.log(`Area: ${d.elements.length} triangulos creados desde ${Ft.length} vertices`);
          } catch (d) {
        ...
        if (Ft.push(o), console.log(`Area vertex ${Ft.length}: node ${o}`), Ft.length >= 2) {
          const n = Ft[Ft.length - 2], l = e.nodes.val, s = Ze();
          if (s) {
    ...
    function rs(t) {
      ...
      const d = new io();
      d.setAttribute("position", new uo(s, 3)), qt = new Ao(d, new Fo({
        color: 16776960,
        linewidth: 3,
        depthTest: false
    ...
    function ds(t) {
      ...
      if (d) {
        const b = ho(Zt(s[1], s[0])), f = ((_d = a.elasticities) == null ? void 0 : _d.get(t)) ?? 0, y = ((_e2 = a.areas) == null ? void 0 : _e2.get(t)) ?? 0, k = ((_f = a.momentsOfInertiaZ) == null ? void 0 : _f.get(t)) ?? 0, I = ((_g = a.momentsOfInertiaY) == null ? void 0 : _g.get(t)) ?? 0, _ = ((_h = a.shearModuli) == null ? void 0 : _h.get(t)) ?? 0, q = ((_i = a.torsionalConstants) == null ? void 0 : _i.get(t)) ?? 0;
        `${l[0]}${l[1]}${K(b)}${K(f)}${K(y)}${K(k)}${K(I)}${K(_)}${K(q)}`;
      } else {
      ...
      try {
        if (v = Ko(s, a, t), M = Uo(s), $ = Rt(Fn(M), Rt(v, M)), F = d ? [
          "ux\u2080",
          "uy\u2080",
          "uz\u2080",
          "\u03B8x\u2080",
          ...
          const k = ho(Zt(s[1], s[0])), I = ((_m = a.elasticities) == null ? void 0 : _m.get(t)) ?? 0, _ = ((_n2 = a.areas) == null ? void 0 : _n2.get(t)) ?? 0, q = ((_o2 = a.momentsOfInertiaZ) == null ? void 0 : _o2.get(t)) ?? 0, T = ((_p = a.momentsOfInertiaY) == null ? void 0 : _p.get(t)) ?? 0, P = ((_q = a.shearModuli) == null ? void 0 : _q.get(t)) ?? 0, O = ((_r = a.torsionalConstants) == null ? void 0 : _r.get(t)) ?? 0;
          E = Rs(I, _, q, T, P, O, k);
        }
        w = _s(s), x = Hs(), p = Bs(l), u = Ds(d);
      ...
      if (c == null ? void 0 : c.deformations) {
        ...
        l.map((f, y) => {
          ...
          const k = ((_a3 = c.deformations) == null ? void 0 : _a3.get(f)) || [
            ...
            0,
            0
          ], I = b.map((_, q) => `<span class="prop-key">${_}</span>: <span class="${Math.abs(k[q]) > 1e-10 ? "result-val" : ""}">${K(k[q])}</span>`).join(" &nbsp;");
      ...
      if (m && d && (c == null ? void 0 : c.deformations) && v && M) {
        ...
        `${C("u", "global")}${l.map((ee, U) => `<span style="color:var(--fem-label)">nodo ${ee}:</span> ${q.map((se, Me) => `<span style="color:${Math.abs(T[U * 6 + Me]) > 1e-10 ? "var(--fem-eq-var)" : "var(--fem-eq-dots)"}">${K(T[U * 6 + Me])}</span>`).join(", ")}`).join(" | ")}${C("u", "local")}${C("T")}${C("u", "global")}${C("u", "local")}${te(P, [
          ...q,
          ...q
        ])}${C("f", "local")}${C("k", "local")}${C("u", "local")}${C("f", "local")}${O.map((ee, U) => `<span style="color:${Math.abs(ee) > 1e-10 ? "var(--fem-nonzero)" : "var(--fem-eq-dots)"}">${re[U]}=${K(ee)}</span>`).join(", ")}${C("P", "1")}${C("N", "i")}${K(O[0])}${C("P", "7")}${C("N", "j")}${K(O[6])}${C("P", "2")}${C("V", "y,i")}${K(O[1])}${C("P", "8")}${C("V", "y,j")}${K(O[7])}${C("P", "3")}${C("V", "z,i")}${K(O[2])}${C("P", "9")}${C("V", "z,j")}${K(O[8])}${C("P", "4")}${C("M", "x,i")}${K(O[3])}${C("P", "10")}${C("M", "x,j")}${K(O[9])}${C("P", "5")}${C("M", "y,i")}${K(O[4])}${C("P", "11")}${C("M", "y,j")}${K(O[10])}${C("P", "6")}${C("M", "z,i")}${K(O[5])}${C("P", "12")}${C("M", "z,j")}${K(O[11])}${b ? b.map((ee) => K(ee)).join(", ") : "\u2014"}${f ? f.map((ee) => K(ee)).join(", ") : "\u2014"}${y ? y.map((ee) => K(ee)).join(", ") : "\u2014"}${k ? k.map((ee) => K(ee)).join(", ") : "\u2014"}${I ? I.map((ee) => K(ee)).join(", ") : "\u2014"}${_ ? _.map((ee) => K(ee)).join(", ") : "\u2014"}`;
      } else if (m && d) {
        ...
        `${b ? b.map((q) => K(q)).join(", ") : "\u2014"}${f ? f.map((q) => K(q)).join(", ") : "\u2014"}${y ? y.map((q) => K(q)).join(", ") : "\u2014"}${k ? k.map((q) => K(q)).join(", ") : "\u2014"}${I ? I.map((q) => K(q)).join(", ") : "\u2014"}${_ ? _.map((q) => K(q)).join(", ") : "\u2014"}`;
      } else if (m && !d) {
      ...
      `${l[0]}`, 6 * l[0], 6 * l[0] + 5, `${l[1]}`, 6 * l[1], 6 * l[1] + 5, l.length === 3 && (`${l[2]}`, 6 * l[2], 6 * l[2] + 5), o.length * 6, o.length * 6, Yt = wa(t, o, n, a, c, m), Yt.id = "fem-inspect-panel", document.body.appendChild(Yt), (_L = Yt.querySelector("#er-close")) == null ? void 0 : _L.addEventListener("click", () => fo());
      const A = d ? (() => {
        var _a3, _b2, _c2, _d2, _e3, _f2;
        const b = ho(Zt(s[1], s[0])), f = ((_a3 = a.elasticities) == null ? void 0 : _a3.get(t)) ?? 0, y = ((_b2 = a.areas) == null ? void 0 : _b2.get(t)) ?? 0, k = ((_c2 = a.momentsOfInertiaZ) == null ? void 0 : _c2.get(t)) ?? 0, I = ((_d2 = a.momentsOfInertiaY) == null ? void 0 : _d2.get(t)) ?? 0, _ = ((_e3 = a.shearModuli) == null ? void 0 : _e3.get(t)) ?? 0, q = ((_f2 = a.torsionalConstants) == null ? void 0 : _f2.get(t)) ?? 0;
        return js(f, y, k, I, _, q, b);
      })() : void 0;
      Yt.querySelectorAll("[data-full]").forEach((b) => {
    ...
    function ps() {
      ...
      setTimeout(() => bt(), 50), Ye(), console.log(`Torre Eiffel: ${l.length} nodos, ${s.length} elementos, H=30m`);
    }
    function fs() {
      const l = [], s = [];
      for (let w = 0; w <= 20; w++) {
      ...
      setTimeout(() => bt(), 50), Ye(), console.log(`Arco Gateway: ${l.length} nodos, ${s.length} elem, span=20m, H=20m`);
    }
    function us() {
      const d = [], a = [];
      for (let p = 0; p <= 16; p++) {
      ...
      setTimeout(() => bt(), 50), Ye(), console.log(`Puente atirantado: ${d.length} nodos, ${a.length} elem, span=60m`);
    }
    function ms() {
      const d = [], a = [];
      for (let u = 0; u <= 12; u++) {
      ...
      setTimeout(() => bt(), 50), Ye(), console.log(`Torre Twist: ${d.length} nodos, ${a.length} elem, 12 pisos, twist=5deg/piso`);
    }
    function bs() {
      const s = [], d = [];
      for (let p = 0; p <= 20; p++) {
      ...
      setTimeout(() => bt(), 50), Ye(), console.log(`Burj Khalifa: ${s.length} nodos, ${d.length} elem, 20 pisos, H=${20 * 3}m`);
    }
    function hs() {
      const t = [], o = [];
      for (let h = 0; h < 3; h++) {
      ...
      setTimeout(() => bt(), 50), Ye(), console.log(`Sydney Opera: ${t.length} nodos, ${o.length} shells Q4, 3 velas`);
    }
    function gs() {
      const l = [], s = [];
      for (let x = 0; x <= 15; x++) {
      ...
      setTimeout(() => bt(), 50), Ye(), console.log(`Diagrid Tower: ${l.length} nodos, ${s.length} elem, 15 pisos, H=${15 * 3.5}m`);
    }
    function Ws() {
      var _a2, _b;
    ...
    `, document.body.appendChild(t), qo = t, t.querySelector("#nl-close").addEventListener("click", () => {
        t.remove(), qo = null;
    ...
    function Vs(t) {
      ...
      const A = [];
      for (const ne of m) {
        let re = w, ee = x, U = p, se = u, Me = v, Re = M, Oe = $, ae = F, ge;
        const we = ne - h;
        if (Math.abs(we) < 1e-20) {
          A.push(E);
          continue;
        }
        if ((ae === 0 || ae === 3) && (we < 0 ? (ae = 2, se = -r, Me = -o, U = se, Re = 0, Oe = 0) : (ae = 1, se = r, Me = o, U = se, Re = 0, Oe = 0)), ae === 2 && we > 0) {
          ae = 1, Re = h, Oe = E, h < re && (re = h);
          const Ee = (ee - re) / (2 * 1 * r), He = 1 + 0 * Math.pow(Ee, 0.8);
          se = (o * He - i * r * He - Oe + n * Re) / (n - i), Me = o * He + i * (se - r * He), U = ee;
        } else if (ae === 1 && we < 0) {
          ae = 2, Re = h, Oe = E, h > ee && (ee = h);
          const Ee = (ee - re) / (2 * 1 * r), He = 1 + 0 * Math.pow(Ee, 0.8);
          se = (-o * He + i * r * He - Oe + n * Re) / (n - i), Me = -o * He + i * (se + r * He), U = re;
        }
        const fe = Math.abs((U - se) / r);
        let Te = s - 0.925 * fe / (0.15 + fe);
        Te < 0.1 && (Te = 0.1);
        const Ne = (ne - Re) / (se - Re), Qe = 1 + Math.pow(Math.abs(Ne), Te), oe = Math.pow(Qe, 1 / Te);
        ge = l * Ne + (1 - l) * Ne / oe, ge = ge * (Me - Oe) + Oe, A.push(ge), h = ne, E = ge, w = re, x = ee, p = U, u = se, v = Me, M = Re, $ = Oe, F = ae;
      }
      const b = t.querySelector("#nl-canvas"), f = b.getContext("2d"), y = b.width, k = b.height;
      f.clearRect(0, 0, y, k);
      const I = Math.max(...m.map(Math.abs)), _ = Math.max(...A.map(Math.abs)), q = (y - 40) / (2 * I), T = (k - 40) / (2 * _), P = y / 2, O = k / 2;
      ...
      for (let ne = 0; ne < m.length; ne++) {
        const re = P + m[ne] * q, ee = O - A[ne] * T;
        ne === 0 ? f.moveTo(re, ee) : f.lineTo(re, ee);
      }
      f.stroke(), f.strokeStyle = "#ff333366", f.lineWidth = 1, f.setLineDash([
        4,
        4
      ]), f.beginPath(), f.moveTo(20, O - o * T), f.lineTo(y - 20, O - o * T), f.stroke(), f.beginPath(), f.moveTo(20, O + o * T), f.lineTo(y - 20, O + o * T), f.stroke(), f.setLineDash([]), f.fillStyle = "#ff6666", f.font = "9px monospace", f.fillText(`Fy = ${(o / 1e3).toFixed(0)} MPa`, y - 50, O - o * T - 5);
    ...
    `, document.body.appendChild(w), wo = w, w.querySelector("#ep-close").addEventListener("click", () => {
        ...
        G.add(t), w.remove(), wo = null, fo(), be();
      }), w.querySelector("#ep-inspect").addEventListener("click", () => {
        w.remove(), wo = null, ds(t);
      });
    }
    setTimeout(() => {
      const t = document.getElementById("viewer");
      ...
      function c(m, r, i, h, E, w, x, p) {
        ...
        const v = (M, $, F, A, b, f, y, k) => {
          ...
          const _ = ((b - M) * (k - f) - (f - $) * (y - b)) / I, q = ((b - M) * (A - $) - (f - $) * (F - M)) / I;
      ...
      o.addEventListener("mousedown", (m) => {
        ...
        if (Wt) {
          ...
          if (rt.track && h.snapType === "node" && h.nodeIdx !== null && h.nodeIdx !== po && Cs(h.nodeIdx), rt.track && po !== null && h.worldPos && h.snapType !== "node") {
            const E = Ps(h.worldPos, po);
            E && (h.worldPos = E, h.snapType = "grid");
          }
          if (po !== null && h.worldPos) {
            const E = e.nodes.val[po];
        ...
        if (Tt && n) {
          ...
          if (Math.abs(r) > s || Math.abs(i) > s) {
            ...
            m.ctrlKey || m.metaKey || (nt.clear(), no()), E.forEach((x) => {
        ...
        if (Tt) {
          ...
          if (r >= 0) {
            if (i) if (nt.has(r)) {
              nt.delete(r);
              const h = oo.findIndex((E) => E.__elemIdx === r);
              if (h >= 0) {
                const E = Ze();
                E == null ? void 0 : E.scene.remove(oo[h]), oo[h].geometry.dispose(), oo[h].material.dispose(), oo.splice(h, 1), E == null ? void 0 : E.render();
              }
            } else nt.add(r), hn(r);
            else nt.clear(), no(), nt.add(r), hn(r);
            so();
          } else i || (nt.clear(), no(), so());
          return;
        }
        if (Nt) {
          const r = vn(m);
      ...
      var _a2;
      e.nodes.val, e.elements.val, (_a2 = e.nodeInputs) == null ? void 0 : _a2.val, Ye();
    }), We.modal = (t) => {
      var _a2, _b;
      if (t === void 0 && (t = !Lt), Lt = t, (_a2 = ve.querySelector("#cad3d-modal")) == null ? void 0 : _a2.classList.toggle("active", Lt), Lt) {
        const n = Ze();
      ...
      console.log(`Modal analysis: ${Lt ? "ON" : "OFF"}`);
    }, We.setMode = (t) => {
      var _a2;
      ...
      pt = Math.max(0, Math.min(t, ie.modeShapes.length - 1));
      const o = ie.modeShapes[pt], { extent: n } = eo();
      let l = 0;
      for (let d = 0; d < Q.length; d++) {
        const a = o[d * 6] || 0, c = o[d * 6 + 1] || 0, m = o[d * 6 + 2] || 0;
        l = Math.max(l, Math.sqrt(a * a + c * c + m * m));
      }
      ke = l > 1e-12 ? n * 0.05 / l : 1, To();
      const s = ve.querySelector("#cad3d-mode-label");
      s && ie.frequencies && (s.textContent = `Modo ${pt + 1} \u2014 ${ie.frequencies[pt].toFixed(2)} Hz`), console.log(`Modo ${pt + 1}: f = ${(_a2 = ie.frequencies) == null ? void 0 : _a2[pt].toFixed(4)} Hz`);
    }, window.cad = We, console.log("FEM Studio CLI ready. Type cad.help() for commands."), setTimeout(() => {
      document.body.appendChild(ve), document.body.appendChild(pe.div);
    }, 0), setTimeout(() => {
      e.nodes.val.length === 0 && (Xe("edificio"), be(), es("edificio"));
