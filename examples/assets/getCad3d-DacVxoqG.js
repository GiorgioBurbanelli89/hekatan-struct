...
import { V as ue, P as Bt, R as ts, b as ns, B as Vt, c as Ws, d as os, e as gn, f as Js, S as Ys, M as Vs, g as Gs, F as Gt, a as xn, L as ao, h as Xs, G as Ks, A as Sn, i as ss, T as as, j as lo, k as ro, C as Us, l as Zs } from "./Text-Cin90tvN.js";
...
let __tla = Promise.all([
  ...
  function Kt(e, h) {
    const B = fo.find((fe) => fe.id === e), T = cn.find((fe) => fe.id === h), V = B.toKN, ye = T.toM, le = (fe, me, I) => I / (Math.pow(V, fe) * Math.pow(ye, me));
    let Z, R;
    switch (e) {
      case "kN":
        Z = 10, R = [
  ...
  function ta(e) {
    const h = e.force, [B, T, V] = e.forceRange;
    return {
      truss: [
        {
          key: "CM",
  ...
  <div style="display:flex; gap:4px; margin-left:12px;">
    ...
    <button id="modal-minimize" style="padding:2px 8px; font-size:10px; cursor:pointer;
      ...
      if (Z += '<div id="modal-body" style="padding:0 12px 10px 12px;">', V.properties) for (const R of V.properties) Z += `<span style="color:#888">${R}</span>
`;
...
`));
  ...
  function oa(e) {
    ...
    const { nodes: h, elements: B, elementInputs: T, nodeInputs: V, deformOutputs: ye } = e, le = h.length * 6, Z = B.length, R = B.filter((ne) => ne.length === 2).length, fe = B.filter((ne) => ne.length >= 3).length, me = document.createElement("div");
    ...
    I += '<button class="rpt-close" id="rpt-close">\u2715 Close</button>', I += "<h1>Finite Element Analysis \u2014 Step-by-Step Report</h1>", I += '<div class="rpt-subtitle">Complete FEM derivation from element formulation to final results</div>', I += '<hr class="rpt-sep"/>', I += "<h2>1. Input Data</h2>", I += '<table class="rpt-info"><tbody>', I += `<tr><td>Number of nodes</td><td class="val">${h.length}</td></tr>`, I += `<tr><td>Number of elements</td><td class="val">${Z} (${R} frames, ${fe} shells)</td></tr>`, I += '<tr><td>DOFs per node</td><td class="val">6 (u<sub>x</sub>, u<sub>y</sub>, u<sub>z</sub>, \u03B8<sub>x</sub>, \u03B8<sub>y</sub>, \u03B8<sub>z</sub>)</td></tr>', I += `<tr><td>Total DOFs</td><td class="val">${le}</td></tr>`, I += "</tbody></table>", I += "<h3>1.1 Node Coordinates</h3>", I += '<table class="rpt-data"><thead><tr><th>Node</th><th>x</th><th>y</th><th>z</th></tr></thead><tbody>', h.forEach((ne, se) => {
      ...
      var _a2, _b2, _c2, _d2;
      const ve = ne.length === 2, Se = ne.map((Je) => h[Je]), Fe = ve ? Ut(qt(Se[1], Se[0])) : 0, Pe = ((_a2 = T.elasticities) == null ? void 0 : _a2.get(se)) ?? 0, Ge = ((_b2 = T.areas) == null ? void 0 : _b2.get(se)) ?? 0, Ce = ((_c2 = T.momentsOfInertiaZ) == null ? void 0 : _c2.get(se)) ?? 0, rt = ((_d2 = T.momentsOfInertiaY) == null ? void 0 : _d2.get(se)) ?? 0;
      I += `<tr><td>${se}</td><td>${ve ? "Frame" : "Shell"}</td><td>${ne.join(" \u2192 ")}</td>`, I += `<td>${Ie(Fe)}</td><td>${Ie(Pe)}</td><td>${Ie(Ge)}</td><td>${Ie(Ce)}</td><td>${Ie(rt)}</td></tr>`;
    ...
    for (let ne = 0; ne < Z; ne++) {
      ...
      const Fe = Ut(qt(ve[1], ve[0])), Pe = ((_a = T.elasticities) == null ? void 0 : _a.get(ne)) ?? 0, Ge = ((_b = T.areas) == null ? void 0 : _b.get(ne)) ?? 0, Ce = ((_c = T.momentsOfInertiaZ) == null ? void 0 : _c.get(ne)) ?? 0, rt = ((_d = T.momentsOfInertiaY) == null ? void 0 : _d.get(ne)) ?? 0, Je = ((_e = T.shearModuli) == null ? void 0 : _e.get(ne)) ?? 0, nt = ((_f = T.torsionalConstants) == null ? void 0 : _f.get(ne)) ?? 0;
      ...
      I += '<div class="rpt-elem-block">', I += `<h3 class="rpt-elem-title" data-toggle="elem${ne}">\u25B6 Element ${ne} \u2014 Nodes ${se[0]} \u2192 ${se[1]}, L = ${Ie(Fe)}</h3>`, I += `<div id="rpt-elem${ne}" class="rpt-elem-body" style="display:none">`, I += "<h4>Properties (numerical substitution)</h4>", I += '<div class="rpt-eq-small">', I += `E = ${Ie(Pe)} &nbsp;&nbsp; A = ${Ie(Ge)} &nbsp;&nbsp; I<sub>z</sub> = ${Ie(Ce)} &nbsp;&nbsp; I<sub>y</sub> = ${Ie(rt)} &nbsp;&nbsp; G = ${Ie(Je)} &nbsp;&nbsp; J = ${Ie(nt)}<br/>`, I += `EA/L = ${Ie(Pe)}\xB7${Ie(Ge)}/${Ie(Fe)} = <b>${Ie(Pe * Ge / Fe)}</b><br/>`, I += `12EI<sub>z</sub>/L\xB3 = 12\xB7${Ie(Pe)}\xB7${Ie(Ce)}/${Ie(Fe)}\xB3 = <b>${Ie(12 * Pe * Ce / Fe ** 3)}</b><br/>`, I += `12EI<sub>y</sub>/L\xB3 = 12\xB7${Ie(Pe)}\xB7${Ie(rt)}/${Ie(Fe)}\xB3 = <b>${Ie(12 * Pe * rt / Fe ** 3)}</b><br/>`, I += `GJ/L = ${Ie(Je)}\xB7${Ie(nt)}/${Ie(Fe)} = <b>${Ie(Je * nt / Fe)}</b>`, I += "</div>", I += "<h4>Direction cosines</h4>", I += `<div class="rpt-eq-small">l = ${Ln(gt)}, m = ${Ln(ht)}, n = ${Ln(dn)}, D = ${Ln(Math.sqrt(gt ** 2 + ht ** 2))}</div>`, I += "<h4>K<sub>local</sub> (12\xD712)</h4>", I += io(ot, 12), I += "<h4>T \u2014 Transformation (12\xD712)</h4>", I += io(Qe, 12), I += "<h4>K<sub>global</sub> = T\u1D40 \xB7 K<sub>local</sub> \xB7 T</h4>", I += io(xt, 12), I += "<h4>Assembly</h4>", I += `<div class="rpt-eq-small">Global DOFs: node ${se[0]} \u2192 [${se[0] * 6}..${se[0] * 6 + 5}], node ${se[1]} \u2192 [${se[1] * 6}..${se[1] * 6 + 5}]</div>`, I += "</div></div>";
    }
    ...
    if (I += "<h3>5.1 Supports (fixed DOFs)</h3>", V.supports && V.supports.size > 0) {
      I += '<table class="rpt-data"><thead><tr><th>Node</th>';
      for (const ne of ee) I += `<th>${ne}</th>`;
      I += "</tr></thead><tbody>", V.supports.forEach((ne, se) => {
        I += `<tr><td>${se}</td>`, ne.forEach((ve, Se) => {
          ve && he.push(se * 6 + Se), I += `<td class="${ve ? "fixed" : ""}">${ve ? "Fixed" : "Free"}</td>`;
        }), I += "</tr>";
      }), I += "</tbody></table>";
    }
    if (I += `<div class="rpt-eq-small">Fixed DOFs: [${he.join(", ")}] \u2192 ${he.length} constraints<br/>`, I += `Free DOFs: ${le} \u2212 ${he.length} = <b>${le - he.length}</b></div>`, I += "<h3>5.2 Applied Loads</h3>", V.loads && V.loads.size > 0) {
      I += '<table class="rpt-data"><thead><tr><th>Node</th>';
      const ne = [
        "F<sub>x</sub>",
        "F<sub>y</sub>",
      ...
      I += "</tr></thead><tbody>", V.loads.forEach((se, ve) => {
    ...
    if (I += "<h2>7. Internal Forces</h2>", I += "<p>For each element, transform global displacements to local and multiply by K<sub>local</sub>:</p>", I += '<div class="rpt-eq">u<sub>local</sub> = T \xB7 u<sub>global</sub></div>', I += '<div class="rpt-eq rpt-eq-highlight">f<sub>local</sub> = K<sub>local</sub> \xB7 u<sub>local</sub></div>', ye == null ? void 0 : ye.deformations) {
      ...
      for (let se = 0; se < Z; se++) {
        ...
        try {
          const Fe = Tn(Se, T, se), Pe = Fn(Se), Ge = [];
          for (const Je of ve) {
  ...
  function io(e, h) {
    ...
    for (let V = 0; V < B; V++) {
      ...
      for (let ye = 0; ye < B; ye++) {
        const le = ((_a = e[V]) == null ? void 0 : _a[ye]) ?? 0, Z = Math.abs(le) < 1e-10;
        T += `<td class="${Z ? "z" : ""} ${V === ye && !Z ? "diag" : ""}">${Z ? "0" : sa(le)}</td>`;
      }
      T += "</tr>";
    }
  ...
  function la(e, h) {
    ...
    for (let le = 0; le < T; le++) V += `<td style="color:#003366;font-weight:bold;font-size:7px">${le}</td>`;
    V += "</tr>";
    const ye = Array.from({
      length: T
    }, () => Array(T).fill(0));
    ...
    for (let le = 0; le < T; le++) {
      V += `<tr><td style="color:#003366;font-weight:bold;font-size:7px">${le}</td>`;
      for (let Z = 0; Z < T; Z++) {
        const R = ye[le][Z], fe = R === 0 ? "#fff" : R === 1 ? "#e8f0fe" : R === 2 ? "#c6dcf5" : "#a0c4e8", me = R === 0 ? "" : R.toString();
        V += `<td style="background:${fe};color:#003366">${me}</td>`;
      }
      V += "</tr>";
    }
    return V += "</table></div>", B > T && (V += `<div style="color:#888;font-size:9pt">(showing ${T}\xD7${T} of ${B}\xD7${B})</div>`), V;
  }
  let co = false;
  function ra(e) {
    if (co || window.katex) {
  ...
  function ia(e, h, B, T, V, ye) {
    ...
    const Fe = R ? qt(Z[1], Z[0]) : [
      ...
      0,
      0
    ], Pe = fe > 0 ? Fe[0] / fe : 0, Ge = fe > 0 ? Fe[1] / fe : 0, Ce = fe > 0 ? Fe[2] / fe : 0, rt = Math.sqrt(Pe ** 2 + Ge ** 2), Je = [];
    if ((V == null ? void 0 : V.deformations) && R) for (const Qe of le) {
      const xt = V.deformations.get(Qe) || [
        0,
        0,
        0,
        0,
  ...
  function ca(e, h, B, T, V, ye) {
    var _a, _b;
    const le = ia(e, h, B, T, V, ye), Z = document.createElement("div");
  ...
  function da(e) {
    ...
    if (h += '<div class="er-section-title">1. Propiedades</div>', h += '<table class="er-props">', h += `<tr><td>E</td><td>${ge(e.E)}</td><td>A</td><td>${ge(e.A)}</td></tr>`, h += `<tr><td>I<sub>z</sub></td><td>${ge(e.Iz)}</td><td>I<sub>y</sub></td><td>${ge(e.Iy)}</td></tr>`, h += `<tr><td>G</td><td>${ge(e.G)}</td><td>J</td><td>${ge(e.J)}</td></tr>`, h += "</table>", e.kLocal && (h += `<div class="er-section-title">2. K<sub>local</sub> (${e.kLocal.length}\xD7${e.kLocal.length})</div>`, h += hn(e.kLocal)), e.T && (h += '<div class="er-section-title">3. T \u2014 Transformaci\xF3n</div>', h += hn(e.T)), e.kGlobal && (h += '<div class="er-section-title">4. K<sub>global</sub> = T<sup>T</sup>\xB7K\xB7T</div>', h += hn(e.kGlobal)), h += '<div class="er-section-title">5. Desplazamientos</div>', e.uGlobal.length > 0) {
      ...
      for (let T = 0; T < e.elem.length; T++) {
        ...
        for (let V = 0; V < 6; V++) {
          const ye = e.uGlobal[T * 6 + V];
          h += `${B[V]}=<span class="${Math.abs(ye) > 1e-10 ? "nz" : ""}">${ge(ye, 6)}</span> `;
        }
        h += "</div>";
      }
  ...
  function hn(e) {
    ...
    for (let V = 0; V < B; V++) {
      ...
      for (let ye = 0; ye < B; ye++) {
        const le = ((_a = e[V]) == null ? void 0 : _a[ye]) ?? 0, Z = Math.abs(le) < 1e-10;
        T += `<td class="${Z ? "z" : ""} ${V === ye && !Z ? "diag" : ""}">${Z ? "0" : fa(le)}</td>`;
      }
      T += "</tr>";
    }
  ...
  function po(e) {
    ...
    if (!h) return;
    const B = e.width, T = e.height, V = 30, ye = B - 2 * V, le = (T - 3 * V) / 2;
    h.fillStyle = getComputedStyle(document.body).getPropertyValue("--fem-bg").trim() || "#111", h.fillRect(0, 0, B, T);
    const Z = (R, fe, me) => {
      h.strokeStyle = "#333", h.lineWidth = 1, h.strokeRect(V, R, ye, le), h.strokeStyle = "#444", h.beginPath(), h.moveTo(V, R + le / 2), h.lineTo(V + ye, R + le / 2), h.stroke(), h.fillStyle = "#888", h.font = "11px sans-serif", h.fillText(fe, V + 4, R + 14);
      for (const ee of me) {
        h.strokeStyle = ee.color, h.lineWidth = 2.5, h.beginPath();
        for (let he = 0; he <= 100; he++) {
          const Ze = he / 100, ne = V + Ze * ye, se = R + le / 2 - ee.fn(Ze) * (le / 2 * 0.85);
      ...
      h.fillStyle = "#666", h.font = "9px monospace", h.fillText("0", V, R + le + 12), h.fillText("1", V + ye - 6, R + le + 12), h.fillText("\u03BE", V + ye / 2, R + le + 12);
    };
    Z(V, "Axial (lineal)", [
      {
        fn: (R) => 1 - R,
    ...
    ]), Z(V + le + V, "Flexi\xF3n (Hermite c\xFAbicos)", [
      {
  ...
  ya = function(e) {
    ...
    let I = "", ee = {}, he = null, Ze = "", ne = [], se = [], ve = /* @__PURE__ */ new Set(), Se = /* @__PURE__ */ new Set(), Fe = /* @__PURE__ */ new Set(), Pe = /* @__PURE__ */ new Map(), Ge = /* @__PURE__ */ new Map(), Ce = [], rt = 0.2, Je = 2, nt = 2, ot = false, Qe = 2, xt = "x", Dt = /* @__PURE__ */ new Set(), gt = true, ht = 0.15, dn = 2, pn = 2, Pn = /* @__PURE__ */ new Set();
    const Zt = () => ({
      b: 0.3,
      h: 0.4,
      profileIdx: 0,
    ...
    function mo() {
      if (!Ve) return;
      const t = _e();
      t && t.scene.remove(Ve), Ve.traverse((n) => {
    ...
    function An(t, n, o, l, s, i, r, c) {
      const u = [
        new ue(t, n, o),
        new ue(l, s, i)
      ], d = new Vt().setFromPoints(u), a = new xn({
        color: r,
        transparent: true,
        opacity: 0.6,
        depthTest: false
    ...
    const ze = {
      ...
      clear() {
        e.nodes.val = [], e.elements.val = [], e.nodeInputs && (e.nodeInputs.val = {}), e.elementInputs && (e.elementInputs.val = {}), ve = /* @__PURE__ */ new Set(), Se = /* @__PURE__ */ new Set(), Pe = /* @__PURE__ */ new Map(), Ge = /* @__PURE__ */ new Map(), Ft = [], Pt = [], mo();
      ...
      building(t, n, o, l = 3, s = 0, i = 0, r = 0, c = 0, u = 1) {
          ...
          for (let v = 1; v < m.length; v++) if (xt === "x") for (let M = 0; M < a.length - 1; M++) {
            ...
            for (let q = 1; q <= Qe; q++) {
              ...
              for (let C = 0; C < d.length - 1; C++) {
                const J = z.length;
                Dt.add(J), Se.add(J), Pe.set(J, v - 1), Ge.set(J, {
                  dir: "x",
                  bay: C
                }), z.push([
                  P[C],
        ...
        for (const f of Ce) {
          ...
          for (const L of M) {
            ...
            let G, U;
            if (f.dir === "x" ? (G = x[`${E},${P},${L}`], U = x[`${E},${P},${L + 1}`]) : (G = x[`${E},${P},${L}`], U = x[`${E},${P},${L + 1}`]), C === void 0 || G === void 0 || J === void 0 || U === void 0) continue;
            const W = nt, D = Je, X = p[C], ce = p[G], Me = p[J], $e = p[U], K = [];
            for (let ae = 0; ae <= D; ae++) {
              ...
              for (let be = 0; be <= W; be++) {
                ...
                ae === 0 && be === 0 ? de.push(C) : ae === 0 && be === W ? de.push(G) : ae === D && be === 0 ? de.push(J) : ae === D && be === W ? de.push(U) : (de.push(p.length), p.push([
                  Te,
                  Y,
                  pe
                ]));
        ...
        if (Pn = /* @__PURE__ */ new Set(), gt) {
          ...
          for (let N = 1; N < m.length; N++) {
            ...
            for (let E = 0; E < d.length - 1; E++) for (let P = 0; P < a.length - 1; P++) {
              const C = d[E], J = d[E + 1], G = a[P], U = a[P + 1], W = [];
              for (let D = 0; D <= v; D++) {
                const X = [];
                for (let ce = 0; ce <= f; ce++) {
                  const Me = C + ce / f * (J - C), $e = G + D / v * (U - G);
...
Util:     cad.info()  cad.clear()  cad.help()
    ...
    function ko() {
      ...
      for (const q of d) for (const E of a) {
        ...
        for (let J = 0; J < p.length; J++) {
          const G = Math.hypot(p[J][0] - q, p[J][1] - E);
          G < P && (P = G, C = J);
        }
    ...
    function zo() {
      ...
      if (z === 0) {
        ...
        for (let C = 0; C < b.length; C++) {
          const J = b[C][0], G = b[C][1];
          Math.abs(J - o) < s * 0.6 && G >= l - 1e-6 && P.push({
            idx: C,
            y: G
          });
        }
        ...
        for (let C = 0; C < P.length; C++) {
          const { idx: J, y: G } = P[C], U = l + t - G, W = d * u * U + d * w;
          let D = s;
        ...
        if (z === 2) {
          ...
          ], J = Math.max(3, Math.ceil((P - l) / s)), G = [];
          for (let Y = 0; Y <= J; Y++) G.push([
            o,
            l + Y * (P - l) / J,
            0
          ]);
      ...
      if (z === 3) {
        ...
        const P = l + t, C = Math.min(x, t), J = P - C, G = [];
        for (let U = 0; U < b.length; U++) {
          const W = b[U][0], D = b[U][1];
          Math.abs(W - o) < s * 0.6 && D >= l - 1e-6 && G.push({
            idx: U,
            y: D
          });
        }
        ...
        for (let U = 0; U < G.length; U++) {
          const { idx: W, y: D } = G[U], X = Math.max(0, P - D);
          if (X <= 0 || D < J - 1e-6) continue;
          const ce = Math.min(X, C), Me = p * ce;
          let $e = s;
          U > 0 && U < G.length - 1 ? $e = (G[U + 1].y - G[U - 1].y) / 2 : U === 0 && G.length > 1 ? $e = (G[1].y - G[0].y) / 2 : U === G.length - 1 && G.length > 1 && ($e = (G[U].y - G[U - 1].y) / 2);
          const K = Me * $e;
      ...
      try {
        ...
        const J = ln(b, P, C, E), G = b.map((X) => [
          X[0],
          0,
          X[1]
        ]);
        if (e.nodes.val = G, e.elements.val = P, E && E.deformations) {
          const X = /* @__PURE__ */ new Map();
    ...
    function Io() {
      ...
      try {
        ...
        v.nodeResults.forEach((J, G) => {
          const U = J.x, W = J.y;
          (U < 1e-6 || U > t - 1e-6 || W < 1e-6 || W > n - 1e-6) && E.set(G, [
            false,
            false,
            true,
            false,
        ...
        if (P.set(L + 4, [
          ...
          const J = v.elementResults.length, G = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), W = /* @__PURE__ */ new Map();
    ...
    function Eo() {
      ...
      for (let q = 0; q < b.length; q++) {
        ...
        for (const [C, J] of w) {
          const G = Math.sqrt((E - C) * (E - C) + (P - J) * (P - J));
      ...
      for (const [Q, be] of D) {
        ...
        for (let Ne = 0; Ne <= J; Ne++) {
          ...
          for (let Rt = 0; Rt <= G; Rt++) {
            const kt = Rt / G, It = we + kt * (Y - we), no = Te + kt * (pe - Te);
            if (Ne === 0) {
              const Et = X(It, no);
              if (Et >= 0) {
                Ye.push(Et);
        ...
        for (let Ne = 0; Ne < J; Ne++) for (let Ye = 0; Ye < G; Ye++) f.push([
          ke[Ne][Ye],
          ke[Ne][Ye + 1],
          ke[Ne + 1][Ye + 1],
          ke[Ne + 1][Ye]
    ...
    function Wt(t) {
      const n = fo.find((l) => l.id === V.forceId), o = cn.find((l) => l.id === V.lengthId);
...
`);
    ...
    function mn() {
      ...
      function z() {
        ...
        if ($) {
          ...
          b && b.array.length === p.length ? (b.array.set(p), b.needsUpdate = true) : _.setAttribute("position", new Gt(p.slice(), 3));
        }
        if (y) {
          ...
          b && b.array.length === w.length ? (b.array.set(w), b.needsUpdate = true) : _.setAttribute("position", new Gt(w.slice(), 3));
        }
        if (g) {
          const _ = [];
          ...
          if (_.length > 0) {
            ...
            v && v.array.length === f.length ? (v.array.set(f), v.needsUpdate = true) : b.setAttribute("position", new Gt(f, 3));
          }
        }
    ...
    function Dn() {
      ...
      if (!o.loads || o.loads.size === 0) {
        ...
        if (w !== 0 || z !== 0) {
          ...
          for (const J of f) {
            const G = _(t[J][2]);
            C.has(G) || C.set(G, []), C.get(G).push(J);
          }
          C.forEach((J) => {
            if (w !== 0) {
        ...
        for (let E = 0; E < n.length; E++) {
          ...
          if (!(Math.abs(C) < 1e-15)) {
            if (P.length === 2) {
              const J = ((_b = l.areas) == null ? void 0 : _b.get(E)) ?? 0, G = t[P[0]], U = t[P[1]], W = Math.sqrt((U[0] - G[0]) ** 2 + (U[1] - G[1]) ** 2 + (U[2] - G[2]) ** 2), X = -(C * J * W * L) / 2;
              ...
              if (P.length === 3) {
                ...
                G = 0.5 * Math.abs((X[0] - D[0]) * (ce[1] - D[1]) - (ce[0] - D[0]) * (X[1] - D[1]));
              } else if (P.length === 4) {
                const [D, X, ce, Me] = P.map(($e) => t[$e]);
                if (G = 0.5 * Math.abs((X[0] - D[0]) * (ce[1] - D[1]) - (ce[0] - D[0]) * (X[1] - D[1])) + 0.5 * Math.abs((ce[0] - D[0]) * (Me[1] - D[1]) - (Me[0] - D[0]) * (ce[1] - D[1])), G < 1e-10) {
                  const $e = [
                    X[0] - D[0],
                    X[1] - D[1],
                    X[2] - D[2]
                  ...
                  G = Math.sqrt(ae[0] ** 2 + ae[1] ** 2 + ae[2] ** 2);
                }
              }
              const W = -(C * J * G * L) / P.length;
        ...
        for (const E of H) {
          const P = v.has(E) ? w : 0, C = M.has(E) ? z : 0, J = N.get(E) ?? 0, G = q.has(E) ? x : 0, U = J + G;
      ...
      if ((I === "edificio" || I === "frame") && ve.size > 0) {
        ...
        for (let p = 0; p < t.length; p++) {
          ...
          if (x) if (s === 0) H = d, _ = a, b = m, S = r === 1 ? Po(z.dCol) : Wn(z.bCol, z.hCol), o.sectionShapes.set(p, r === 1 ? {
            ...
            const v = Ge.get(p), M = v ? v.dir === "x" ? z.vigasX : z.vigasY : [], L = v ? M[v.bay] ?? M[0] ?? Zt() : Zt();
    ...
    setTimeout(() => {
      ...
      n && (n.value = B, n.addEventListener("change", (a) => {
        ...
        a.addEventListener("click", (m) => {
          ...
          y && (h = y.force, B = y.length, V = y.stress, T = Kt(h, B), t && (t.value = h), n && (n.value = B), re.querySelectorAll("[data-preset]").forEach((g) => {
            g.classList.toggle("active", g.dataset.preset === $);
          }), I && Ee(I), console.log(`Preset: ${$} \u2192 ${h}+${B}, stress: ${V.label}`));
        });
    ...
    function Xn(t) {
      ...
      const i = new Vt();
      i.setAttribute("position", new Gt(s, 3));
...
${d.join(", ")}`);
    ...
    function ys(t) {
      ...
      for (const [i, r] of s) {
        ...
        a.computeLineDistances(), a.renderOrder = 9990, n.scene.add(a), Gn.push(a);
      }
      n.render();
    }
    function Kn() {
      const t = _e();
      for (const n of Gn) t == null ? void 0 : t.scene.remove(n), n.geometry.dispose(), n.material.dispose();
      Gn = [], Jt = null, dt && (dt.remove(), dt = null);
    }
    function Ro(t, n, o, l) {
    ...
    function jo(t) {
      ...
      if (Ue && (n.scene.remove(Ue), Ue.geometry.dispose(), Ue.material.dispose(), Ue = null), t.worldPos) {
        const l = t.snapType === "node" ? 16776960 : t.snapType === "mid" ? 16711935 : t.snapType === "grid" ? 65535 : 8947848, s = t.snapType === "node" ? 0.08 : 0.06, i = t.snapType === "mid" ? new Js(s * 2, s * 2, s * 2) : new Ys(s, 12, 12), r = new Vs({
          color: l,
          transparent: true,
          opacity: 0.8,
          depthTest: false
        });
        Ue = new Gs(i, r), Ue.position.copy(t.worldPos), Ue.renderOrder = 9999, n.scene.add(Ue);
      }
      if (Ke && (n.scene.remove(Ke), Ke.geometry.dispose(), Ke.material.dispose(), Ke = null), He !== null && t.worldPos) {
        const l = o[He], s = new Vt();
        if (tt === "arc" && ct !== null) {
          ...
          s.setAttribute("position", new Gt(u, 3));
        } else s.setAttribute("position", new Gt([
          l[0],
          l[1],
          l[2],
          t.worldPos.x,
    ...
    function Wo(t) {
      ...
      const i = new Vt();
      i.setAttribute("position", new Gt(s, 3)), lt = new gn(i, new xn({
        color: 16776960,
        linewidth: 3,
        depthTest: false
    ...
    function _s(t) {
      ...
      for (const G of u) {
        ...
        be < 0.1 && (be = 0.1);
        const we = (G - Me) / (X - Me), Te = 1 + Math.pow(Math.abs(we), be), Y = Math.pow(Te, 1 / be);
        ae = l * we + (1 - l) * we / Y, ae = ae * (ce - $e) + $e, _.push(ae), m = G, $ = ae, y = U, g = W, p = D, x = X, w = ce, z = Me, S = $e, H = K;
      }
      ...
      for (let G = 0; G < u.length; G++) {
        const U = P + u[G] * q, W = C - _[G] * E;
        G === 0 ? f.moveTo(U, W) : f.lineTo(U, W);
      }
