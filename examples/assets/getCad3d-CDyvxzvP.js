...
`);
  ...
  er = function(e) {
    ...
    function as(t, n, o, l, s) {
      ...
      const a = Math.min(...t), c = Math.max(...t), d = Math.min(...n), r = Math.max(...n), i = Math.max(...o), m = c - a || 1, w = r - d || 1, E = 3359829, y = 2241348;
      for (const h of o) {
        for (const T of n) {
    ...
    function Xn(t, n, o, l, s) {
      ...
      const a = Math.min(...t), c = Math.max(...t), d = Math.min(...n), r = Math.max(...n), i = c - a || 1, m = r - d || 1, w = Math.max(i, m), E = w * 0.08, y = l || t.map((x, u) => String.fromCharCode(65 + u)), f = s || n.map((x, u) => String(u + 1)), h = w * 0.018, T = n.length <= 1, k = 8947848;
      for (let x = 0; x < t.length; x++) {
        ...
        if (T) {
          ...
          const I = d - E - h * 1.5;
          Io(u, d, 0, u, I + h, 0, k, Rt), ko(y[x] || `${x}`, u, I, 0, h, Rt);
        }
      }
      if (!T) for (let x = 0; x < n.length; x++) {
        const u = n[x], I = a - E - h * 1.5;
        Io(a, u, 0, I + h, u, 0, k, Rt), ko(f[x] || `${x}`, I, u, 0, h, Rt);
      }
      const $ = h * 1.8, C = E * 1.2, B = E * 1.2;
      for (let x = 0; x < t.length - 1; x++) {
        const u = t[x], I = t[x + 1], L = Math.abs(I - u), R = (u + I) / 2, j = `${L.toFixed(2)} m`;
        T ? (Eo(j, R, 0, -C, $, Rt), So(u, 0, -C * 0.7, I, 0, -C * 0.7, 16763904, Rt)) : (Eo(j, R, d - B, 0, $, Rt), So(u, d - B * 0.7, 0, I, d - B * 0.7, 0, 16763904, Rt));
      }
    ...
    function wo(t, n, o) {
      ...
      const s = Math.min(...n), p = Math.max(...n), a = Math.min(...o), c = Math.max(...o), d = p - s || 1, r = c - a || 1, i = Math.max(d, r), m = i * 0.06, w = o.length <= 1, E = 4491519, y = i * 0.015;
      for (const f of t) {
        const h = f.elev;
        w ? (Kn(s - m, 0, h, p + m, 0, h, E, Gt), is(f.name, p + m * 1.5, 0, h, y, Gt)) : (Kn(s, a, h, p, a, h, E, Gt), Kn(p, a, h, p, c, h, E, Gt), Kn(p, c, h, s, c, h, E, Gt), Kn(s, c, h, s, a, h, E, Gt), is(f.name, s - m * 1.5, a, h, y, Gt));
      }
      Gt.traverse((f) => {
    ...
    function Kn(t, n, o, l, s, p, a, c) {
      const d = Math.sqrt((l - t) ** 2 + (s - n) ** 2 + (p - o) ** 2) || 1, r = new tn().setFromPoints([
        new Oe(t, n, o),
        new Oe(l, s, p)
      ]), i = new Wn({
        color: a,
      ...
      m.computeLineDistances(), m.renderOrder = 50, c.add(m);
    }
    function is(t, n, o, l, s, p) {
      const a = document.createElement("canvas"), c = 512, d = 64;
      a.width = c, a.height = d;
      const r = a.getContext("2d");
      r.fillStyle = "rgba(30,60,120,0.8)";
      const i = 8;
      r.beginPath(), r.moveTo(i, 0), r.lineTo(c - i, 0), r.quadraticCurveTo(c, 0, c, i), r.lineTo(c, d - i), r.quadraticCurveTo(c, d, c - i, d), r.lineTo(i, d), r.quadraticCurveTo(0, d, 0, d - i), r.lineTo(0, i), r.quadraticCurveTo(0, 0, i, 0), r.closePath(), r.fill(), r.fillStyle = "#88bbff", r.font = "bold 38px monospace", r.textAlign = "center", r.textBaseline = "middle", r.fillText(t, c / 2, d / 2);
      const m = new Xo(a);
      m.needsUpdate = true;
      const w = new fo({
        map: m,
      ...
      E.position.set(n, o, l), E.scale.set(s * 8, s, 1), E.renderOrder = 101, p.add(E);
    }
    function Eo(t, n, o, l, s, p) {
      const a = document.createElement("canvas"), c = 256, d = 64;
      a.width = c, a.height = d;
      const r = a.getContext("2d");
      r.fillStyle = "rgba(0,0,0,0.75)";
      const i = 8;
      r.beginPath(), r.moveTo(i, 0), r.lineTo(c - i, 0), r.quadraticCurveTo(c, 0, c, i), r.lineTo(c, d - i), r.quadraticCurveTo(c, d, c - i, d), r.lineTo(i, d), r.quadraticCurveTo(0, d, 0, d - i), r.lineTo(0, i), r.quadraticCurveTo(0, 0, i, 0), r.closePath(), r.fill(), r.fillStyle = "#ffcc00", r.font = "bold 36px monospace", r.textAlign = "center", r.textBaseline = "middle", r.fillText(t, c / 2, d / 2);
      const m = new rl(a);
      m.minFilter = il;
      const w = new fo({
        map: m,
      ...
      const y = c / d;
      E.scale.set(s * y, s, 1), E.renderOrder = 999, p.add(E);
    }
    function So(t, n, o, l, s, p, a, c) {
      const d = [
        new Oe(t, n, o),
        new Oe(l, s, p)
      ], r = new tn().setFromPoints(d), i = new Yn({
        color: a,
        transparent: true,
        opacity: 0.6,
        depthTest: false
    ...
    function Io(t, n, o, l, s, p, a, c) {
      const d = new tn().setFromPoints([
        new Oe(t, n, o),
        new Oe(l, s, p)
      ]), r = new Wn({
        color: a,
        dashSize: 0.15 * Math.max(Math.abs(l - t), Math.abs(s - n), Math.abs(p - o), 0.1),
        gapSize: 0.1 * Math.max(Math.abs(l - t), Math.abs(s - n), Math.abs(p - o), 0.1),
        transparent: true,
        opacity: 0.6
      }), i = new Cn(d, r);
      i.computeLineDistances(), c.add(i);
    }
    function ko(t, n, o, l, s, p) {
      const a = document.createElement("canvas"), c = 128;
      a.width = c, a.height = c;
      const d = a.getContext("2d");
      d.beginPath(), d.arc(c / 2, c / 2, c * 0.42, 0, Math.PI * 2), d.fillStyle = "rgba(255,255,255,0.9)", d.fill(), d.lineWidth = c * 0.04, d.strokeStyle = "#555", d.stroke(), d.fillStyle = "#222", d.font = `bold ${c * 0.45}px Arial`, d.textAlign = "center", d.textBaseline = "middle", d.fillText(t, c / 2, c / 2 + c * 0.02);
      const r = new Xo(a);
      r.needsUpdate = true;
      const i = new fo({
        map: r,
      ...
      const w = s * 2;
      m.scale.set(w, w, 1), m.renderOrder = 100, p.add(m);
    }
    const Ke = {
      addNode(t, n, o) {
        const l = [
      ...
      set(t, n) {
        ...
        for (const l of o) {
          const s = ((_b = (_a2 = l.closest("label")) == null ? void 0 : _a2.textContent) == null ? void 0 : _b.trim()) || ((_d = (_c = l.parentElement) == null ? void 0 : _c.textContent) == null ? void 0 : _d.trim()) || "", p = l.id || "";
          if (s.toLowerCase().includes(t.toLowerCase()) || p.toLowerCase().includes(t.toLowerCase())) {
            ...
            return a.checked = n !== void 0 ? n : !a.checked, a.dispatchEvent(new Event("change", {
              bubbles: true
            })), console.log(`${s || p}: ${a.checked}`), a.checked;
          }
        }
      ...
      refgrid(t, n, o) {
        ...
        as(l, s, p), We = l.map((a, c) => ({
          label: String.fromCharCode(65 + c),
          coord: a
        })), Xe = s.map((a, c) => ({
          label: `${c + 1}`,
          coord: a
        })), pt = p[p.length - 1], lt = p.map((a, c) => ({
          label: c === 0 ? "Base" : `P${c}`,
          elev: a
        })), Xn(We.map((a) => a.coord), Xe.map((a) => a.coord), pt, We.map((a) => a.label), Xe.map((a) => a.label));
        {
          const a = p.map((c, d) => ({
            name: d === 0 ? "Base" : `P${d}`,
            height: d > 0 ? c - p[d - 1] : 0,
            elev: c
          }));
          wo(a, We.map((c) => c.coord), Xe.map((c) => c.coord));
        }
        return console.log(`RefGrid: X=[${l}] Z=[${s}] Y=[${p}]`), {
          xCoords: l,
          zCoords: s,
          yLevels: p
        };
      ...
      build(t) {
        ...
        const n = (t == null ? void 0 : t.col) || "40x40", o = (t == null ? void 0 : t.viga) || "30x40", l = (t == null ? void 0 : t.fc) || 210, [s, p] = n.split("x").map((_) => parseFloat(_) / 100), [a, c] = o.split("x").map((_) => parseFloat(_) / 100), d = We.map((_) => _.coord), r = Xe.map((_) => _.coord), i = lt.map((_) => _.elev), m = d.length, w = r.length, E = i.length, y = E - 1, f = [], h = {};
        for (let _ = 0; _ < E; _++) for (let fe = 0; fe < w; fe++) for (let oe = 0; oe < m; oe++) h[`${oe},${fe},${_}`] = f.length, f.push([
          d[oe],
          r[fe],
          i[_]
        ]);
        ...
        const u = 15100 * Math.sqrt(l) * 10, I = u / (2 * (1 + 0.2)), L = s * p, R = s * p ** 3 / 12, j = p * s ** 3 / 12, g = s * p * (s ** 2 + p ** 2) / 12, S = a * c, v = a * c ** 3 / 12, F = c * a ** 3 / 12, X = a * c * (a ** 2 + c ** 2) / 12, V = /* @__PURE__ */ new Map(), ae = /* @__PURE__ */ new Map(), Q = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Map(), de = /* @__PURE__ */ new Map(), re = /* @__PURE__ */ new Map(), Ie = /* @__PURE__ */ new Map();
        ...
        return e.nodes.val = f, e.elements.val = T, e.nodeInputs.val = {
          ...
          sectionShapes: Ie
        }, D = k, G = $, $e = C, console.log(`Built: ${f.length} nodes, ${T.length} elements (${k.size} cols, ${$.size} beams, ${x.size} braces)`), console.log(`  Col: ${n}, Viga: ${o}, f'c=${l}${B ? `, braces=${B}` : ""}`), {
          nodes: f.length,
          elements: T.length
        };
      },
      addCol(t, n, o) {
        ...
        const p = We[l].coord, a = Xe[s].coord, c = [
          ...e.nodes.val
        ], d = [
        ...
        const r = (y) => {
          const f = c.findIndex((h) => Math.abs(h[0] - p) < 1e-3 && Math.abs(h[1] - a) < 1e-3 && Math.abs(h[2] - y) < 1e-3);
          return f >= 0 ? f : (c.push([
            p,
            a,
            y
          ...
          length: lt.length - 1
        }, (y, f) => f + 1), m = new Map(((_d = (_c = e.nodeInputs) == null ? void 0 : _c.val) == null ? void 0 : _d.supports) || []), w = r(lt[0].elev);
        m.has(w) || m.set(w, [
          true,
          true,
          true,
        ...
        for (const y of i) {
          ...
          const f = r(lt[y - 1].elev), h = r(lt[y].elev);
          d.push([
            f,
            h
          ]), D.add(d.length - 1), $e.set(d.length - 1, y - 1), E++;
        }
        return e.nodes.val = c, e.elements.val = d, e.nodeInputs.val = {
          ...e.nodeInputs.val,
          supports: m,
      ...
      addBeam(t, n, o, l, s) {
        var _a2;
        const p = We.findIndex((C) => C.label === t), a = Xe.findIndex((C) => C.label === n), c = We.findIndex((C) => C.label === o), d = Xe.findIndex((C) => C.label === l), r = lt.findIndex((C) => C.label === s);
        if (p < 0 || a < 0 || c < 0 || d < 0) {
        ...
        const i = We[p].coord, m = Xe[a].coord, w = We[c].coord, E = Xe[d].coord, y = lt[r].elev, f = [
          ...e.nodes.val
        ], h = [
          ...((_a2 = e.elements) == null ? void 0 : _a2.val) || []
        ], T = (C, B, x) => {
        ...
        return h.push([
          k,
          $
        ]), G.add(h.length - 1), $e.set(h.length - 1, r - 1), e.nodes.val = f, e.elements.val = h, console.log(`Added beam ${t}-${n} \u2192 ${o}-${l} at ${s}`), h.length - 1;
      },
      addBrace(t, n, o, l, s, p) {
        var _a2;
        const a = We.findIndex((u) => u.label === t), c = Xe.findIndex((u) => u.label === n), d = lt.findIndex((u) => u.label === o), r = We.findIndex((u) => u.label === l), i = Xe.findIndex((u) => u.label === s), m = lt.findIndex((u) => u.label === p);
        if (a < 0 || c < 0 || d < 0) {
          console.log(`Point 1 not found: ${t}-${n}@${o}`);
          return;
        }
        if (r < 0 || i < 0 || m < 0) {
          console.log(`Point 2 not found: ${l}-${s}@${p}`);
          return;
        }
        const w = We[a].coord, E = Xe[c].coord, y = lt[d].elev, f = We[r].coord, h = Xe[i].coord, T = lt[m].elev, k = [
          ...e.nodes.val
        ], $ = [
          ...((_a2 = e.elements) == null ? void 0 : _a2.val) || []
        ], C = (u, I, L) => {
        ...
        return $.push([
          B,
          x
        ]), $e.set($.length - 1, Math.min(d, m)), e.nodes.val = k, e.elements.val = $, console.log(`Added brace ${t}-${n}@${o} \u2192 ${l}-${s}@${p}`), $.length - 1;
      },
      help() {
        return `=== CLI Commands ===
MODEL:
...
`;
      ...
      model3d(t) {
        ...
        const n = (t == null ? void 0 : t.bx) || [
          ...
          3,
          3
        ], s = (t == null ? void 0 : t.col) || "40x40", p = (t == null ? void 0 : t.viga) || "30x40", a = (t == null ? void 0 : t.fc) || 210, [c, d] = s.split("x").map((ee) => parseFloat(ee) / 100), [r, i] = p.split("x").map((ee) => parseFloat(ee) / 100), m = [
          0
        ];
        ...
        for (let ee = 0; ee < h; ee++) for (let ue = 0; ue < f; ue++) for (let we = 0; we < y; we++) $[`${we},${ee},${ue}`] = k.length, k.push([
          m[we],
          E[ee],
          w[ue]
        ]);
        const C = [], B = /* @__PURE__ */ new Set(), x = /* @__PURE__ */ new Set(), u = /* @__PURE__ */ new Map();
        for (let ee = 0; ee < T; ee++) for (let ue = 0; ue < f; ue++) for (let we = 0; we < y; we++) {
          const se = C.length;
          C.push([
            $[`${we},${ee},${ue}`],
            $[`${we},${ee + 1},${ue}`]
        ...
        for (let ee = 1; ee < h; ee++) for (let ue = 0; ue < f; ue++) for (let we = 0; we < y - 1; we++) {
          const se = C.length;
          C.push([
            $[`${we},${ee},${ue}`],
            $[`${we + 1},${ee},${ue}`]
        ...
        for (let ee = 1; ee < h; ee++) for (let ue = 0; ue < y; ue++) for (let we = 0; we < f - 1; we++) {
          const se = C.length;
          C.push([
            $[`${ue},${ee},${we}`],
            $[`${ue},${ee},${we + 1}`]
        ...
        const L = 15100 * Math.sqrt(a) * 10, R = L / (2 * (1 + 0.2)), j = c * d, g = c * d ** 3 / 12, S = d * c ** 3 / 12, v = c * d * (c ** 2 + d ** 2) / 12, F = r * i, X = r * i ** 3 / 12, V = i * r ** 3 / 12, ae = r * i * (r ** 2 + i ** 2) / 12, Q = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Map(), de = /* @__PURE__ */ new Map(), re = /* @__PURE__ */ new Map(), Ie = /* @__PURE__ */ new Map(), Re = /* @__PURE__ */ new Map(), _ = /* @__PURE__ */ new Map();
        ...
        for (let ee = 0; ee < f; ee++) for (let ue = 0; ue < y; ue++) fe.set($[`${ue},0,${ee}`], [
          true,
          true,
          true,
          true,
        ...
        return as(m, w, E), Ze(), console.log(`Model3D: ${k.length}n ${C.length}e | ${y}x${f} grid, ${T} floors | COL${s} V${p} f'c=${a}`), {
          nodes: k.length,
          elements: C.length,
          columns: B.size,
          beams: x.size
      ...
      frame(t, n, o = 0, l = 0) {
        ...
        let p = 0;
        s.push(p);
        for (const y of t) p += y, s.push(p);
        l > 0 && s.push(p + l);
        const a = [
          0
        ];
        let c = 0;
        for (const y of n) c += y, a.push(c);
        const d = (y) => o > 0 && y === 0 || l > 0 && y === s.length - 1, r = {}, i = [];
        for (let y = 0; y < a.length; y++) for (let f = 0; f < s.length; f++) y === 0 && d(f) || (r[`${f},${y}`] = i.length, i.push([
          s[f],
          0,
          a[y]
        ]));
        ...
        for (let y = 0; y < a.length - 1; y++) for (let f = 0; f < s.length; f++) d(f) || (D.add(m.length), m.push([
          r[`${f},${y}`],
          r[`${f},${y + 1}`]
        ]));
        ...
        return e.nodes.val = i, e.elements.val = m, e.nodeInputs && (e.nodeInputs.val = {
          supports: w
        }), We = [
          ...s
        ], Xe = [
      ...
      building(t, n, o, l = 3, s = 0, p = 0, a = 0, c = 0, d = 1) {
        Ke.clear();
        const r = [];
        ...
        for (const u of n) i.push(i[i.length - 1] + u);
        c > 0 && i.push(i[i.length - 1] + c);
        const m = [
          0
        ];
        for (const u of o) m.push(m[m.length - 1] + u);
        const w = (u) => s > 0 && u === 0 || p > 0 && u === r.length - 1, E = (u) => a > 0 && u === 0 || c > 0 && u === i.length - 1, y = (u, I) => w(u) || E(I), f = [], h = {};
        for (let u = 0; u < m.length; u++) for (let I = 0; I < i.length; I++) for (let L = 0; L < r.length; L++) u === 0 && y(L, I) || (h[`${L},${I},${u}`] = f.length, f.push([
          r[L],
          i[I],
          m[u]
        ]));
        ...
        const $ = [];
        for (let u = 0; u < m.length - 1; u++) for (let I = 0; I < i.length; I++) for (let L = 0; L < r.length; L++) y(L, I) || $.push({
          el: [
            h[`${L},${I},${u}`],
            h[`${L},${I},${u + 1}`]
          ],
        ...
        Te = /* @__PURE__ */ new Map();
        const C = [];
        for (let u = 1; u < m.length; u++) for (let I = 0; I < i.length; I++) for (let L = 0; L < r.length - 1; L++) C.push({
          el: [
            h[`${L},${I},${u}`],
            h[`${L + 1},${I},${u}`]
          ],
        ...
        for (let u = 1; u < m.length; u++) for (let I = 0; I < r.length; I++) for (let L = 0; L < i.length - 1; L++) C.push({
          el: [
            h[`${I},${L},${u}`],
            h[`${I},${L + 1},${u}`]
          ],
        ...
        if (st = /* @__PURE__ */ new Set(), Ee && ze > 0) {
          const u = (I, L, R) => {
            for (let g = 0; g < f.length; g++) if (Math.abs(f[g][0] - I) < 1e-6 && Math.abs(f[g][1] - L) < 1e-6 && Math.abs(f[g][2] - R) < 1e-6) return g;
            const j = f.length;
            return f.push([
              I,
              L,
          ...
          for (let I = 1; I < m.length; I++) if (Je === "x") for (let L = 0; L < i.length - 1; L++) {
            const R = i[L], j = i[L + 1];
            for (let g = 1; g <= ze; g++) {
            ...
            for (let g = 1; g <= ze; g++) {
              const S = R + g / (ze + 1) * (j - R), v = [];
              for (let F = 0; F < i.length; F++) v.push(u(S, i[F], m[I]));
        ...
        for (let u = 0; u < i.length; u++) for (let I = 0; I < r.length; I++) y(I, u) || B.set(h[`${I},${u},0`], [
          ...x
        ]);
        ce = /* @__PURE__ */ new Set();
        for (const u of he) {
          ...
          for (const R of L) {
            ...
            const Q = be, K = He, de = f[F], re = f[V], Ie = f[X], Re = f[ae], _ = [];
            for (let fe = 0; fe <= K; fe++) {
              ...
              for (let ee = 0; ee <= Q; ee++) {
                ...
                fe === 0 && ee === 0 ? oe.push(F) : fe === 0 && ee === Q ? oe.push(V) : fe === K && ee === 0 ? oe.push(X) : fe === K && ee === Q ? oe.push(ae) : (oe.push(f.length), f.push([
                  we,
                  se,
                  Se
                ]));
        ...
        if (zt = /* @__PURE__ */ new Set(), Ue) {
          ...
          for (let j = 0; j < f.length; j++) L.set(R(f[j][0], f[j][1], f[j][2]), j);
          for (let j = 1; j < m.length; j++) {
            const g = m[j];
            for (let S = 0; S < r.length - 1; S++) for (let v = 0; v < i.length - 1; v++) {
              const F = r[S], X = r[S + 1], V = i[v], ae = i[v + 1], Q = [];
              for (let K = 0; K <= I; K++) {
                const de = [];
        ...
        if (Ft && gt) {
          ...
          for (let R = 0; R < L; R++) {
            ...
            if (I) for (let j = 0; j < r.length; j++) {
              if (gt === "perimeter" && j !== 0 && j !== r.length - 1) continue;
      ...
      galpon(t = 12, n = 20, o = 6, l = 3, s = 8, p = 4) {
        Ke.clear();
        const a = [], c = [], d = (E) => o + l * (1 - Math.pow(2 * E / t - 1, 2)), r = [], i = p + 1;
        for (let E = 0; E < i; E++) {
          const y = [], f = n / p * E;
        ...
        for (let E = 0; E < i; E++) {
          ...
          for (let f = 2; f < y.length - 1; f++) c.push([
            y[f],
            y[f + 1]
          ]);
        }
        for (let E = 0; E < p; E++) for (let y = 2; y < r[0].length; y++) c.push([
          r[E][y],
          r[E + 1][y]
        ]);
        for (let E = 0; E < p; E++) for (let y = 2; y < r[0].length - 1; y += 2) c.push([
          r[E][y],
          r[E + 1][y + 1]
        ]);
        const m = /* @__PURE__ */ new Map(), w = mt();
        for (let E = 0; E < i; E++) m.set(r[E][0], [
          ...w
        ]), m.set(r[E][1], [
          ...w
        ]);
      ...
      plateQ4(t = 10, n = 10, o = 16, l = 16, s = "simply-supported", p = -10, a = 0.2, c = 3e7, d = 0.3, r = 0) {
        console.log(`Plate Q4 [${[
          "Mindlin (gruesa)",
          "Kirchhoff (delgada)",
          "Membrane"
        ][r]}]: ${t}\xD7${n}, ${o}\xD7${l} elem, BC=${s}, q=${p}, t=${a}`);
...
Util:     cad.info()  cad.clear()  cad.help()  cad.helpFull()
    ...
    function Qe(t) {
      ...
      if (t === "edificio") {
        ...
        const p = Math.round(((_c = Z.nPisos) == null ? void 0 : _c.val) ?? 3), a = ((_d = Z.hPiso) == null ? void 0 : _d.val) ?? 3;
        N = Array(p).fill(a);
      }
      sn(), setTimeout(() => {
        ka(), Pe();
    ...
    function Pe() {
      switch (z) {
        ...
        case "edificio": {
          const n = le("Lvix") || 0, o = le("Lvdx") || 0, l = le("Lviy") || 0, s = le("Lvdy") || 0, p = Math.max(1, Math.round(le("nSubViga") || 3)), a = Math.max(1, Math.round(le("nSubCol") || 1)), c = le("hPiso"), d = N.length > 0 ? [
            ...N
          ] : Array(Math.round(le("nPisos"))).fill(c);
          Ke.building([
            ...ie
          ], [
            ...ne
    ...
    function ps() {
      const t = le("span"), n = Math.round(le("divisions")), o = le("height"), l = t / n, s = [], p = [];
      ...
      for (let i = 0; i < n; i++) i < n / 2 ? p.push([
        i,
        a + i + 1
      ]) : p.push([
        a + i,
      ...
      ]), d = (le("CM") ?? 0) + (le("CV") ?? 0), r = /* @__PURE__ */ new Map();
      if (d !== 0) for (let i = 0; i <= n; i++) r.set(i, [
        0,
        0,
        d,
        0,
    ...
    function fs() {
      const t = le("width"), n = le("height"), o = le("Ex") ?? 0, l = (le("CM") ?? 0) + (le("CV") ?? 0), s = Math.max(1, Math.round(le("nSub") || 4)), p = [
        [
          0,
          0,
          0
      ...
      else if (l !== 0 && o === 0) for (let m = 1; m < p.length; m++) m === 0 || m === 3 || i.set(m, [
        0,
        0,
        l,
        0,
      ...
      else if (o !== 0 && l !== 0) for (let m = 1; m < p.length; m++) m === 0 || m === 3 || i.set(m, [
        m === 2 ? o : 0,
        0,
        l,
        0,
    ...
    function us() {
      const t = le("dx"), n = le("dy"), o = le("dz"), l = Math.round(le("stories")), s = Math.max(1, Math.round(le("nSub") || 3)), p = [];
      for (let f = 0; f <= l; f++) p.push([
        0,
        0,
        o * f
      ], [
      ...
      for (let f = 0; f < l; f++) for (let h = 0; h < 4; h++) d.push([
        f * 4 + h,
        (f + 1) * 4 + h
      ]);
      for (let f = 0; f < l; f++) {
      ...
      else if (w !== 0 && m === 0) for (let f = 0; f < c.length; f++) i.has(f) || y.set(f, [
        0,
        0,
        w,
        0,
      ...
      else if (m !== 0 && w !== 0) for (let f = 0; f < c.length; f++) i.has(f) || y.set(f, [
        f === E ? m : 0,
        0,
        w,
        0,
    ...
    function xa() {
      const t = le("L"), n = Math.round(le("nElem")), o = le("F"), l = t / n, s = [], p = [];
      for (let d = 0; d <= n; d++) s.push([
        l * d,
        0,
        0
      ]);
      for (let d = 0; d < n; d++) p.push([
        d,
        d + 1
      ]);
    ...
    function ms() {
      const t = le("Lx") || 15, n = le("Ly") || 10, o = le("meshSize") || 0.5, l = le("q") || -3, s = le("t") || 1, p = le("E") || 3e7, a = le("nu") || 0.3, c = p / (2 * (1 + a)), d = Le === 1 ? "Membrana" : Le === 2 ? "Kirchhoff" : "Mindlin", { nodes: r, elements: i, boundaryIndices: m } = hn({
        points: [
          [
            0,
            0,
        ...
        maxMeshSize: o
      }), w = t * n, E = l * w / r.length, y = new Map(m.map((h) => [
        h,
        [
          true,
          true,
      ...
      e.nodes.val = r, e.elements.val = i, e.nodeInputs && (e.nodeInputs.val = {
        ...
        elasticities: new Map(i.map((h, T) => [
          T,
          p
        ])),
        elasticitiesOrthogonal: new Map(i.map((h, T) => [
          T,
          p
        ])),
        thicknesses: new Map(i.map((h, T) => [
          T,
          s
        ])),
        poissonsRatios: new Map(i.map((h, T) => [
          T,
          a
        ])),
        shearModuli: new Map(i.map((h, T) => [
          T,
          c
        ]))
      });
      try {
        const h = kt(r, i, e.nodeInputs.val, e.elementInputs.val);
        h && e.deformOutputs && (e.deformOutputs.val = h);
        const T = gn(r, i, e.elementInputs.val, h);
        T && e.analyzeOutputs && (e.analyzeOutputs.val = T), console.log(`Plate 3Q [${d}]: ${r.length} nodes, ${i.length} triangles, t=${s}, E=${p}, \u03BD=${a}`);
      } catch (h) {
    ...
    function bs() {
      const t = le("Lx") || 10, n = le("Ly") || 10, o = Math.round(le("nx") || 16), l = Math.round(le("ny") || 16), s = le("t") || 0.2, p = le("q") || -10, a = le("E") || 3e7, c = le("nu") || 0.3, d = xt === 1 ? "clamped" : "simply-supported", i = {
        1: 2,
        2: 1,
        3: 0
      }[Le] ?? 0;
      return Ke.plateQ4(t, n, o, l, d, p, s, a, c, i);
    }
    function gs() {
      const t = le("a") || 6, n = le("b") || 4, o = Math.round(le("nx") || 12), l = Math.round(le("ny") || 8), s = le("t") || 0.1, p = le("q") || -10, a = le("E") || 35e6, c = le("nu") || 0.15, r = {
        1: 2,
        2: 1,
        3: 0
      }[Le] ?? 0, i = Ke.plateQ4(t, n, o, l, "simply-supported", p, s, a, c, r), m = a * s * s * s / (12 * (1 - c * c));
      let w = 0;
      for (let E = 1; E <= 19; E += 2) for (let y = 1; y <= 19; y += 2) {
        const f = E * E / (t * t) + y * y / (n * n);
        w += 1 / (E * y * f * f);
      }
      if (w *= 16 * Math.abs(p) / (Math.PI ** 6 * m), console.log(`\u{1F4D0} Navier anal\xEDtico w_center = ${w.toExponential(6)}`), i) {
        const E = Math.abs((Math.abs(i.centerW || 0) - w) / w * 100);
        console.log(`   WASM w_center = ${(i.centerW || 0).toExponential(6)}, error = ${E.toFixed(2)}%`);
      }
      return i;
    }
    function hs() {
      const t = le("t") || 0.2, n = le("q") || -10, o = le("E") || 35e6, l = le("nu") || 0.2, s = le("meshSize") || 0.6, p = [
        3.6,
        4.2,
        4.2,
        3.6
        ...
        3.6,
        3
      ], c = p.reduce((g, S) => g + S, 0), d = a.reduce((g, S) => g + S, 0), r = [
        0
      ];
      for (const g of p) r.push(r[r.length - 1] + g);
      const i = [
        0
      ];
      for (const g of a) i.push(i[i.length - 1] + g);
      const m = Math.max(2, Math.round(c / s)), w = Math.max(2, Math.round(d / s)), E = c / m, y = d / w, f = [];
      for (let g = 0; g <= w; g++) for (let S = 0; S <= m; S++) f.push([
        S * E,
        g * y
      ]);
      const h = [], T = /* @__PURE__ */ new Set();
      for (const g of r) for (const S of i) {
        let v = 1 / 0, F = 0;
        for (let X = 0; X < f.length; X++) {
          const V = Math.hypot(f[X][0] - g, f[X][1] - S);
          V < v && (v = V, F = X);
        }
      ...
      console.log(`Losa Plana Q4 [${[
        ...
        "Kirchhoff",
        "Membrane"
      ][$]}]: ${c}\xD7${d}m, ${m}\xD7${w} elem, ${T.size} columnas`);
    ...
    function xs() {
      const t = le("L") || 4, n = le("H") || 2, o = le("t") || 0.1, l = le("E") || 2e7, s = le("nu") || 0.2, p = l / (2 * (1 + s)), a = le("q") || -100, c = le("b") || 0.8, d = le("meshSize") || 0.2, { nodes: r, elements: i, boundaryIndices: m } = hn({
        points: [
          [
            0,
            0,
      ...
      const C = {
        elasticities: new Map(i.map((x, u) => [
          u,
          l
        ])),
        elasticitiesOrthogonal: new Map(i.map((x, u) => [
          u,
          l
        ])),
        thicknesses: new Map(i.map((x, u) => [
          u,
          o
        ])),
        poissonsRatios: new Map(i.map((x, u) => [
          u,
          s
        ])),
        shearModuli: new Map(i.map((x, u) => [
          u,
          p
        ]))
      }, B = {
      ...
      try {
        const x = kt(w, i, B, C), u = gn(w, i, C, x), I = w.map((R) => [
          R[0],
          0,
          R[1]
        ]);
        if (e.nodes.val = I, e.elements.val = i, x && x.deformations) {
          const R = /* @__PURE__ */ new Map();
        ...
        x && x.deformations && x.deformations.forEach((R) => {
          ...
          L = Math.max(L, j);
        }), console.log(`Viga Alta: ${w.length} nodos, ${i.length} triangulos`), console.log(`  L=${t}, H=${n}, t=${o}, E=${l}, nu=${s}`), console.log(`  Carga: q=${a} kN/m sobre ${c}m central`), console.log(`  max|u| = ${L.toExponential(4)}`);
      } catch (x) {
    ...
    function vs() {
      const t = le("H") || 4, n = le("B") || 3, o = le("tw") || 0.3, l = le("tb") || 0.4, s = le("meshSize") || 0.2, p = le("E") || 25e6, a = le("nu") || 0.2, c = p / (2 * (1 + a)), d = le("gamma") || 18, r = le("Ka") || 0.33, i = le("Es") || 5e4, m = le("nus") || 0.3, w = i / (2 * (1 + m)), E = le("kn") || 1e6, y = le("ks") || 1e4, f = le("gammaW") || 9.81, h = le("Hw") || 3.5, T = le("qs") || 0, k = xt, $ = n * 0.3, C = n * 0.7, B = [
        [
          -$,
          0,
          0
      ...
      if (k === 0) {
        ...
        for (let F = 0; F < v.length; F++) {
          const { idx: X, y: V } = v[F], ae = l + t - V, Q = r * d * ae + r * T;
          let K = s;
        ...
        if (k === 2) {
          ...
          for (let se = 0; se < Ie; se++) Re[se] ? (oe.set(se, i), pe.set(se, i), ue.set(se, m), we.set(se, w), ee.set(se, 1)) : (oe.set(se, p), pe.set(se, p), ue.set(se, a), we.set(se, c), ee.set(se, 1));
          ...
          for (let se = 0; se < Ie; se++) {
            if (!Re[se]) continue;
            const Se = u[se], je = x[Se[0]], rt = x[Se[1]], ct = x[Se[2]], Ct = Math.abs((rt[0] - je[0]) * (ct[1] - je[1]) - (ct[0] - je[0]) * (rt[1] - je[1])) / 2, _t = -d * Ct / 3;
            for (const Pt of Se) {
              const Dt = L.get(Pt) || [
                0,
                0,
          ...
          for (let _ = 0; _ < u.length; _++) {
            const fe = ae(u[_]);
            Re.push(!fe), fe ? (Q.set(_, p), K.set(_, p), re.set(_, a), Ie.set(_, c), de.set(_, 1)) : (Q.set(_, i), K.set(_, i), re.set(_, m), Ie.set(_, w), de.set(_, 1));
          }
          R = {
            elasticities: Q,
          ...
          for (let _ = 0; _ < u.length; _++) {
            if (!Re[_]) continue;
            const fe = u[_], oe = x[fe[0]], pe = x[fe[1]], ee = x[fe[2]], ue = Math.abs((pe[0] - oe[0]) * (ee[1] - oe[1]) - (ee[0] - oe[0]) * (pe[1] - oe[1])) / 2, we = -d * ue / 3;
            for (const se of fe) {
              const Se = L.get(se) || [
                0,
                0,
      ...
      if (k === 3) {
        ...
        for (let ae = 0; ae < V.length; ae++) {
          ...
          const re = Math.min(de, F), Ie = f * re;
          let Re = s;
      ...
      try {
        ...
        S && S.deformations && S.deformations.forEach((de) => {
          ...
          K = Math.max(K, re);
        }), console.log(`Muro Contencion [${g[k]}]: ${x.length} nodos, ${u.length} triangulos`), console.log(`  H=${t}, B=${n}, tw=${o}, tb=${l}, Ka=${r}, gamma=${d}, qs=${T}`), k === 1 && console.log(`  Es=${i}, nus=${m}`), k === 2 && console.log(`  Es=${i}, nus=${m}, kn=${E}, ks=${y}`), k === 3 && console.log(`  gammaW=${f}, Hw=${h}`), console.log(`  max|u| = ${K.toExponential(4)}`);
      } catch (S) {
    ...
    function ys() {
      const t = le("Lx") || 2, n = le("Ly") || 2, o = le("t") || 0.5, l = le("colA") || 0.4, s = le("colH") || 1.5, p = Math.round(le("nx") || 8), a = Math.round(le("ny") || 8), c = le("E") || 25e6, d = le("nu") || 0.2, r = le("P") || -500, i = le("Mx") || 0, m = le("My") || 0, w = le("ks") || 2e4, E = t / p, y = n / a, f = t / 2, h = n / 2, T = l / 2, k = [];
      for (let I = 0; I <= a; I++) for (let L = 0; L <= p; L++) {
        const R = I * (p + 1) + L;
        let j = E, g = y;
        (L === 0 || L === p) && (j = E / 2), (I === 0 || I === a) && (g = y / 2), k.push({
          node: R,
          dof: 0,
          k: w * j * g
        });
      ...
      let $ = 0;
      for (let I = 0; I <= a; I++) for (let L = 0; L <= p; L++) Math.abs(L * E - f) <= T + 1e-6 && Math.abs(I * y - h) <= T + 1e-6 && $++;
      ...
      if (Math.abs(i) > 1e-6) {
        const I = T > 1e-6 ? T : y, L = i / I;
        for (let R = 0; R <= a; R++) for (let j = 0; j <= p; j++) {
          const g = j * E, S = R * y;
      ...
      console.log(`Zapata: ${t}x${n}m, t=${o}m, ${p}x${a} elem`), console.log(`  col=${l}m, P=${r}, Mx=${i}, My=${m}, ks=${w}`);
      try {
        const I = Uo({
          E: c,
          nu: d,
    ...
    function $s() {
      const t = le("Lx") || 0.4, n = le("Ly") || 0.4, o = le("t") || 0.025, l = le("dBolt") || 0.022, s = le("sx") || 0.28, p = le("sy") || 0.28, a = le("colA") || 0.2, c = le("meshSize") || 8e-3, d = le("E") || 2e8, r = le("nu") || 0.3, i = d / (2 * (1 + r)), m = le("P") || -200, w = Math.round(le("nBolts") || 4), E = t / 2, y = n / 2, f = l / 2, h = a / 2, T = [];
      w >= 4 && (T.push([
        E - s / 2,
        y - p / 2
      ]), T.push([
      ...
      console.log(`Placa Base: ${t * 1e3}x${n * 1e3}mm, t=${o * 1e3}mm, ${w} pernos d=${l * 1e3}mm`), console.log(`  P=${m} kN, col=${a * 1e3}mm, mesh=${c * 1e3}mm`), console.log(`  ${B.length} triangulos, ${x.length} nodos`);
      try {
        const g = kt(x, B, {
          supports: u,
          loads: I
    ...
    function Ms() {
      const t = le("colB") || 0.3, n = le("colH") || 0.3, o = le("colT") || 8e-3, l = le("colLen") || 1.5, s = le("Lx") || 0.45, p = le("Ly") || 0.45, a = le("tPlaca") || 0.025, c = le("dBolt") || 0.022, d = le("sx") || 0.32, r = le("sy") || 0.32, i = Math.round(le("nSubColV") || 6), m = Math.round(le("nSubColH") || 4), w = Math.round(le("nSubPlaca") || 10), E = le("E") || 2e8, y = le("nu") || 0.3, f = E / (2 * (1 + y)), h = le("P") || -300, T = s / 2, k = p / 2, $ = c / 2, C = t / 2, B = n / 2, x = [], u = [], I = w, L = s / I, R = p / I, j = (pe, ee) => ee * (I + 1) + pe;
      ...
      for (let pe = v; pe < v + F; pe++) oe.elasticities.set(pe, E), oe.poissonsRatios.set(pe, y), oe.thicknesses.set(pe, a), oe.shearModuli.set(pe, f);
      for (let pe = Q; pe < Q + re; pe++) oe.elasticities.set(pe, E), oe.poissonsRatios.set(pe, y), oe.thicknesses.set(pe, o), oe.shearModuli.set(pe, f);
      console.log(`Col+Placa 3D: col ${t * 1e3}x${n * 1e3}x${o * 1e3}mm, h=${l}m`), console.log(`  Placa ${s * 1e3}x${p * 1e3}mm, t=${a * 1e3}mm, 4 pernos d=${c * 1e3}mm`), console.log(`  ${F} Q4 placa + ${re} Q4 columna = ${u.length} total`), console.log(`  ${x.length} nodos, P=${h} kN`);
      try {
        const pe = kt(x, u, {
          supports: Ie,
          loads: Re
    ...
    function ws() {
      const t = le("H") || 6, n = le("angle") || 45, o = le("bTop") || 3, l = le("bBot") || 3, s = le("meshSize") || 2, p = le("E") || 5e4, a = le("nu") || 0.3, c = le("gamma") || 18, d = le("c") || 15, r = le("phi") || 30, i = le("qs") || 0, m = t / Math.tan(n * Math.PI / 180), w = l + m + o, E = t, y = [
        [
          0,
          -E,
          0
      ...
      try {
        ...
        console.log(`Talud SRM: ${T.length} nodos, ${h.length} triangulos`), console.log(`  H=${t}, angulo=${n}\xB0, c=${d} kPa, \u03C6=${r}\xB0, \u03B3=${c}`), console.log("  \u2550\u2550\u2550 Strength Reduction Method (Mohr-Coulomb) \u2550\u2550\u2550"), console.log(`  FOS = ${u.fos.toFixed(3)}`), console.log(`  max|u| = ${j.toExponential(4)}`), console.log(`  max \u03B5_pl = ${g.toExponential(4)}`), u.fos < 1 ? console.warn("  \u26A0 TALUD INESTABLE (FOS < 1.0)") : u.fos < 1.5 && console.warn("  \u26A0 FOS < 1.5 \u2014 revisar estabilidad");
      } catch (B) {
    ...
    function Es(t, n, o, l, s) {
      const p = Ne.steelVigaType, a = p === 0 ? mo() : bo();
      if (Ne.vigaMat === 0) {
        for (let c = 0; c < n.length; c++) {
          const d = n[c], r = `b${o}${c}`, i = `h${o}${c}`, m = {};
          m[r] = +$t(d.b).toFixed(2), m[i] = +$t(d.h).toFixed(2), t.addBinding(m, r, {
            min: l[0],
            max: l[1],
            step: l[2],
            label: `b sv${o}${c + 1}`
        ...
        t.on("change", (c) => {
          var _a2;
          const d = (_a2 = c.target) == null ? void 0 : _a2.key, r = d == null ? void 0 : d.match(new RegExp(`^b${o}(\\d+)$`)), i = d == null ? void 0 : d.match(new RegExp(`^h${o}(\\d+)$`));
          r && (n[parseInt(r[1])].b = Mt(c.value), Pe()), i && (n[parseInt(i[1])].h = Mt(c.value), Pe());
        });
      } else if (p <= 1) {
        for (let c = 0; c < n.length; c++) {
          const d = {};
          d[`p${o}${c}`] = n[c].profileIdx ?? 0, t.addBinding(d, `p${o}${c}`, {
            label: `sv${o}${c + 1}`,
            options: a
          });
        }
        t.on("change", (c) => {
          var _a2, _b;
          const r = (_b = (_a2 = c.target) == null ? void 0 : _a2.key) == null ? void 0 : _b.match(new RegExp(`^p${o}(\\d+)$`));
          r && (n[parseInt(r[1])].profileIdx = c.value, Pe());
        });
      } else if (p === 2) {
        for (let c = 0; c < n.length; c++) {
          const d = n[c], r = {}, i = `${o}${c}`;
          r[`bf${i}`] = +$t(d.bf ?? 0.2).toFixed(3), r[`h${i}`] = +$t(d.hf ?? 0.4).toFixed(3), r[`tf${i}`] = +$t(d.tf ?? 0.015).toFixed(3), r[`tw${i}`] = +$t(d.tw ?? 0.01).toFixed(3), t.addBinding(r, `bf${i}`, {
            min: l[0],
            max: l[1],
            step: l[2],
            label: `bf sv${o}${c + 1}`
        ...
        t.on("change", (c) => {
          var _a2;
          const d = (_a2 = c.target) == null ? void 0 : _a2.key;
          for (let r = 0; r < n.length; r++) {
            const i = `${o}${r}`;
            d === `bf${i}` && (n[r].bf = Mt(c.value), Pe()), d === `h${i}` && (n[r].hf = Mt(c.value), Pe()), d === `tf${i}` && (n[r].tf = Mt(c.value), Pe()), d === `tw${i}` && (n[r].tw = Mt(c.value), Pe());
          }
        });
      } else {
        for (let c = 0; c < n.length; c++) {
          const d = n[c], r = {}, i = `${o}${c}`;
          r[`bc${i}`] = +$t(d.bc ?? 0.2).toFixed(3), r[`hc${i}`] = +$t(d.hc ?? 0.3).toFixed(3), r[`t${i}`] = +$t(d.t ?? 8e-3).toFixed(3), t.addBinding(r, `bc${i}`, {
            min: l[0],
            max: l[1],
            step: l[2],
            label: `b sv${o}${c + 1}`
        ...
        t.on("change", (c) => {
          ...
          for (let r = 0; r < n.length; r++) {
            const i = `${o}${r}`;
            d === `bc${i}` && (n[r].bc = Mt(c.value), Pe()), d === `hc${i}` && (n[r].hc = Mt(c.value), Pe()), d === `t${i}` && (n[r].t = Mt(c.value), Pe());
          }
        });
      }
    }
    function Nn() {
      ...
      if (!n) return;
      n.style.display = "";
      const o = M, l = Math.round(((_a2 = Z.nPisos) == null ? void 0 : _a2.val) ?? 3), s = ya(), p = $a(), a = ie.length || 1, c = ne.length || 1;
      for (; Ne.perFloor.length < l; ) {
        const x = Ne.perFloor.length > 0 ? JSON.parse(JSON.stringify(Ne.perFloor[Ne.perFloor.length - 1])) : rn(a, c);
        Ne.perFloor.push(x);
      }
      ...
      for (const x of Ne.perFloor) {
        ...
        for (x.vigasX.length > a && (x.vigasX.length = a); x.vigasY.length < c; ) x.vigasY.push(x.vigasY.length > 0 ? {
          ...x.vigasY[x.vigasY.length - 1]
        } : ut());
        x.vigasY.length > c && (x.vigasY.length = c);
      }
      At = new no({
      ...
      const i = Ne.steelColType === 0 ? mo() : bo();
    ...
    function sn() {
      ...
      if (o) {
        const s = {};
        for (const d of o) {
          const r = Z[d.key], i = r.min === 0 && r.max === 1 && r.step === 1;
          s[d.key] = i ? r.val >= 0.5 : r.val;
        }
        const p = o.filter((d) => {
          const r = Z[d.key];
        ...
        if (p.length > 0) {
          ...
          for (const r of p) d.addBinding(s, r.key, {
            label: Z[r.key].label
          });
        }
        ...
        for (const d of a) {
          ...
          c.addBinding(r, "min", {
            ...
            Z[d.key] && (Z[d.key].min = r.min, Z[d.key].max = r.max, Z[d.key].val < r.min && (Z[d.key].val = r.min), Z[d.key].val > r.max && (Z[d.key].val = r.max)), sn(), Pe();
          });
        }
        ve.on("change", (d) => {
          var _a2, _b;
          ...
          if (r && Z[r]) {
            if (Z[r].val = typeof d.value == "boolean" ? d.value ? 1 : 0 : d.value, z === "edificio" && (r === "nVanosX" || r === "nVanosY" || r === "nPisos")) {
              if (r === "nVanosX" || r === "nVanosY") {
                const i = Math.round(Z.nVanosX.val), m = Math.round(Z.nVanosY.val);
                for (; ie.length < i; ) ie.push(ie[ie.length - 1] ?? M.defaultSpan);
                for (ie.length > i && (ie.length = i); ne.length < m; ) ne.push(ne[ne.length - 1] ?? M.defaultSpan * 0.8);
                ne.length > m && (ne.length = m);
              }
              if (r === "nPisos" || r === "hPiso") {
                const i = Math.round(Z.nPisos.val), m = ((_b = Z.hPiso) == null ? void 0 : _b.val) ?? 3;
                for (; N.length < i; ) N.push(N[N.length - 1] ?? m);
      ...
      if (z === "edificio") {
        ...
        if (s) {
          let p = function() {
            var _a2, _b, _c, _d;
            const d = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", r = ((_a2 = Z.Lvix) == null ? void 0 : _a2.val) || 0, i = ((_b = Z.Lvdx) == null ? void 0 : _b.val) || 0, m = ((_c = Z.Lviy) == null ? void 0 : _c.val) || 0, w = ((_d = Z.Lvdy) == null ? void 0 : _d.val) || 0;
            let E = "X: ";
            r > 0 && (E += `\u251C${r.toFixed(1)}\u2524`);
            for (let h = 0; h < ie.length; h++) E += `[${d[h + (r > 0 ? 1 : 0)]}]\u2500\u2500${ie[h].toFixed(1)}\u2500\u2500`;
            E += `[${d[ie.length + (r > 0 ? 1 : 0)]}]`, i > 0 && (E += `\u251C${i.toFixed(1)}\u2524`);
            let y = "Y: ";
            m > 0 && (y += `\u251C${m.toFixed(1)}\u2524`);
            for (let h = 0; h < ne.length; h++) y += `[${h + 1 + (m > 0 ? 1 : 0)}]\u2500\u2500${ne[h].toFixed(1)}\u2500\u2500`;
            y += `[${ne.length + 1 + (m > 0 ? 1 : 0)}]`, w > 0 && (y += `\u251C${w.toFixed(1)}\u2524`);
            let f = "Z: ";
            for (let h = 0; h < N.length; h++) f += `P${h + 1}=${N[h].toFixed(1)} `;
            c.textContent = E + `
` + y + `
` + f;
          };
          ...
          c.style.cssText = "font-family:monospace;font-size:10px;color:#aaa;padding:6px;background:#1a1a2e;border-radius:4px;margin-top:6px;line-height:1.6;white-space:pre;overflow-x:auto;", p(), s.appendChild(c);
        }
      }
      if (Nn(), ve) {
        ve.addBlade({
      ...
      if (l && l.length > 0) {
        ...
        for (const a of l) {
          ...
          p.addBinding(c, "min", {
            ...
            ft[a.key] && (ft[a.key].min = c.min, ft[a.key].max = c.max, ft[a.key].val < c.min && (ft[a.key].val = c.min), ft[a.key].val > c.max && (ft[a.key].val = c.max)), sn(), Pe();
          });
        }
        cn.on("change", (a) => {
          var _a2;
          ...
          if (c && ft[c]) {
            if (ft[c].val = a.value, e.nodeInputs) {
      ...
      window.__cad = {
        setParam: (s, p) => {
          if (Z[s]) Z[s].val = p, Pe(), sn();
          else if (ft[s]) {
            if (ft[s].val = p, e.nodeInputs) {
        ...
        getParams: () => {
          const s = {};
          for (const p in Z) s[p] = Z[p].val;
          for (const p in ft) s[p] = ft[p].val;
          return s;
        },
        setGenerator: Qe,
        createCustomPanel: (s, p, a) => Ma(s, p, a),
        removeCustomPanel: (s) => {
          Ss(s);
        }
      };
    ...
    function Ma(t, n, o) {
      ...
      if (!l) {
        ...
        const c = document.querySelector("#parameters");
        c ? (_a2 = c.parentElement) == null ? void 0 : _a2.insertBefore(l, c.nextSibling) : document.body.appendChild(l);
      }
      ...
      for (const [c, d] of Object.entries(n)) {
        ...
        if (Array.isArray(d.value)) {
          ...
          p.addBinding(i, c, {
            ...
            a[c] = m.value.split(",").map((w) => parseFloat(w.trim())).filter((w) => !isNaN(w)), o && o({
              ...a
            });
          });
        } else if (d.options) {
          ...
          d.min !== void 0 && (m.min = d.min), d.max !== void 0 && (m.max = d.max), d.step !== void 0 && (m.step = d.step), p.addBinding(i, c, m).on("change", (w) => {
            a[c] = w.value, o && o({
              ...a
            });
          });
  ...
  `;
    ...
    function Ea() {
      var _a2, _b, _c, _d, _e2, _f;
      const t = e.nodes.val, n = e.elements.val, o = (_a2 = e.nodeInputs) == null ? void 0 : _a2.val, l = (_b = e.elementInputs) == null ? void 0 : _b.val, s = P, p = b, a = [];
      if (a.push("# Awatif FEM \u2014 Model Export"), a.push(`# Generator: ${z || "custom"}`), a.push(`# Units: ${p}, ${s}`), a.push(`# ${(/* @__PURE__ */ new Date()).toISOString()}`), a.push(""), a.push(`## NODES (${t.length})`), a.push("# idx     X          Y          Z"), t.forEach((r, i) => {
        a.push(`  ${String(i).padStart(4)}  ${r[0].toFixed(4).padStart(10)}  ${r[1].toFixed(4).padStart(10)}  ${r[2].toFixed(4).padStart(10)}`);
      }), a.push(""), a.push(`## ELEMENTS (${n.length})`), a.push("# idx    nodeI  nodeJ"), n.forEach((r, i) => {
        const m = r.map((w) => String(w).padStart(6)).join("");
        a.push(`  ${String(i).padStart(4)}  ${m}`);
      }), a.push(""), (o == null ? void 0 : o.supports) && o.supports.size > 0 && (a.push(`## SUPPORTS (${o.supports.size})`), a.push("# node   Ux  Uy  Uz  Rx  Ry  Rz"), o.supports.forEach((r, i) => {
        const m = r.map((w) => w ? "  1" : "  0").join("");
        a.push(`  ${String(i).padStart(4)} ${m}`);
      }), a.push("")), (o == null ? void 0 : o.loads) && o.loads.size > 0 && (a.push(`## LOADS (${o.loads.size})`), a.push("# node         Fx          Fy          Fz          Mx          My          Mz"), o.loads.forEach((r, i) => {
        ...
        ], i = "# elem  " + r.map((m) => m.name.padStart(12)).join(" ");
        a.push(i);
        for (let m = 0; m < n.length; m++) {
          const w = r.map((E) => {
            var _a3;
      ...
      if (d && d.size > 0 && (a.push(`## REACTIONS (${d.size} supports)`), a.push("# node          Rx           Ry           Rz           Mx           My           Mz"), d.forEach((r, i) => {
        const m = r.map((w) => w.toFixed(4).padStart(12)).join(" ");
        a.push(`  ${String(i).padStart(4)}  ${m}`);
      }), a.push("")), z) {
        a.push("## CLI COMMAND");
        const r = Object.entries(Z).map(([i, m]) => `${i}=${m.val}`).join(" ");
...
`);
    ...
    `, document.body.appendChild(Lt), (_a2 = Lt.querySelector("#export-close")) == null ? void 0 : _a2.addEventListener("click", () => {
        ...
        const n = e.nodes.val, o = e.elements.val, l = (_a3 = e.nodeInputs) == null ? void 0 : _a3.val, s = (_b2 = e.elementInputs) == null ? void 0 : _b2.val, p = {
          generator: z || "custom",
          units: {
            force: b,
            length: P
        ...
        (l == null ? void 0 : l.supports) && (p.supports = [], l.supports.forEach((i, m) => p.supports.push({
          node: m,
          dofs: i
        }))), (l == null ? void 0 : l.loads) && (p.loads = [], l.loads.forEach((i, m) => p.loads.push({
          node: m,
          forces: i
        ...
        a && a.size > 0 && (p.displacements = {}, a.forEach((i, m) => p.displacements[m] = i));
        const c = (_f = (_e2 = e.deformOutputs) == null ? void 0 : _e2.val) == null ? void 0 : _f.reactions;
        c && c.size > 0 && (p.reactions = {}, c.forEach((i, m) => p.reactions[m] = i));
        const d = Lt.querySelector("#export-text");
        d.value = JSON.stringify(p, null, 2);
        const r = Lt.querySelector("#export-status");
    ...
    function Ze() {
      ...
      if (t) {
        ...
        let p = 0, a = 0, c = 0;
        for (const r of o) r.length === 2 ? p++ : r.length === 3 ? a++ : r.length === 4 && c++;
        let d = `${n}n ${l}e ${s}s`;
        (c > 0 || a > 0) && (d += ` | ${p}fr`, c > 0 && (d += ` ${c}q4`), a > 0 && (d += ` ${a}tri`)), t.textContent = d;
      }
    }
    function Lo() {
      var _a2;
      ...
      if (!(t.length === 0 || n.length === 0) && !(!o.supports || o.supports.size === 0) && !(!l.densities || l.densities.size === 0)) try {
        ...
        if (s <= 0) return;
        const p = Va(t, n, o, l, Math.min(s, 12));
        if (p.frequencies && p.frequencies.length > 0) {
          Ce = p, ke = t.map((r) => [
            ...r
          ]), xe = 0;
          const { extent: a } = yn(), c = (_a2 = p.modeShapes) == null ? void 0 : _a2[0];
          if (c) {
            let r = 0;
            for (let i = 0; i < t.length; i++) {
              const m = c[i * 6] || 0, w = c[i * 6 + 1] || 0, E = c[i * 6 + 2] || 0;
              r = Math.max(r, Math.sqrt(m * m + w * w + E * E));
            }
            Ge = r > 1e-12 ? a * 0.05 / r : 1;
          }
          const d = `${z} \u2014 ${t.length}n ${n.length}e`;
          it.render(p, {
            title: d
          }), it.div.style.display = "", Qn(), console.log(`Modal: ${p.frequencies.length} modos. f\u2081 = ${p.frequencies[0].toFixed(4)} Hz`);
        }
      } catch (s) {
    ...
    function Qn() {
      ...
      if (!t) return;
      const n = ((_a2 = Ce.frequencies) == null ? void 0 : _a2[xe]) || 1, o = Math.max(0.5, Math.min(3, n * 0.1)), l = performance.now(), s = ke.length, p = e.elements.rawVal, { extent: a } = yn(), c = Ae.querySelector("#cad3d-modal-scale"), d = c && parseFloat(c.value) || 5;
      let r = 0;
      for (let $ = 0; $ < s; $++) {
        const C = t[$ * 6] || 0, B = t[$ * 6 + 1] || 0, x = t[$ * 6 + 2] || 0;
        r = Math.max(r, Math.sqrt(C * C + B * B + x * x));
      }
      const i = r > 1e-12 ? a * d / 100 / r : 1, m = et();
      if (!m) return;
      ...
      for (const $ of p) if ($.length === 2) h.push([
        $[0],
        $[1]
      ]);
      ...
      function k() {
        const $ = (performance.now() - l) / 1e3, C = Math.sin(2 * Math.PI * o * $) * i;
        for (let B = 0; B < s; B++) {
          const x = ke[B];
        ...
        if (w) {
          ...
          x && x.array.length === f.length ? (x.array.set(f), x.needsUpdate = true) : B.setAttribute("position", new Ln(f.slice(), 3));
        }
        if (E) {
        ...
        if (y) {
          ...
          for (const x of p) if (x.length === 3) {
            const [u, I, L] = x;
            B.push(f[u * 3], f[u * 3 + 1], f[u * 3 + 2]), B.push(f[I * 3], f[I * 3 + 1], f[I * 3 + 2]), B.push(f[L * 3], f[L * 3 + 1], f[L * 3 + 2]);
          } else if (x.length === 4) {
            const [u, I, L, R] = x;
            B.push(f[u * 3], f[u * 3 + 1], f[u * 3 + 2]), B.push(f[I * 3], f[I * 3 + 1], f[I * 3 + 2]), B.push(f[L * 3], f[L * 3 + 1], f[L * 3 + 2]), B.push(f[u * 3], f[u * 3 + 1], f[u * 3 + 2]), B.push(f[L * 3], f[L * 3 + 1], f[L * 3 + 2]), B.push(f[R * 3], f[R * 3 + 1], f[R * 3 + 2]);
          }
          if (B.length > 0) {
    ...
    function Fo() {
      ...
      let p = 0, a = 0, c = 0;
      for (const y of n) y.length === 2 ? p++ : y.length === 3 ? c++ : y.length === 4 && a++;
      const d = ((_d = o.supports) == null ? void 0 : _d.size) || 0, r = ((_e2 = o.loads) == null ? void 0 : _e2.size) || 0, i = t.length * 6, m = i - d * 6, w = [], E = (y) => w.push(y);
      E('<b style="color:var(--cad-heading)">FEM Solver</b>'), E(`<span style="color:var(--cad-info)">Modelo:</span> ${t.length} nodos, ${n.length} elem`), p && E(`&nbsp;&nbsp;Frames: <b>${p}</b>`), a && E(`&nbsp;&nbsp;Shell Q4: <b>${a}</b>`), c && E(`&nbsp;&nbsp;Triangulos: <b>${c}</b>`), E(`&nbsp;&nbsp;Apoyos: ${d} &nbsp;|&nbsp; Cargas: ${r}`), E(`<span style="color:var(--cad-info)">DOFs:</span> ${i} total, ~${m} libres`), E('<hr style="border-color:var(--cad-border);margin:4px 0">'), E(`<span style="color:#888">1.</span> Ensamblaje <b>K</b> global (${i}&times;${i})`), E("&nbsp;&nbsp;&nbsp;<i>K<sub>global</sub> = &Sigma; T<sup>T</sup> &middot; K<sub>local</sub> &middot; T</i>");
      try {
        const y = kt(t, n, o, l), f = performance.now() - s;
        if (y) {
    ...
    function Po(t, n) {
      const o = t * n, l = t * n * n * n / 12, s = n * t * t * t / 12, p = Math.min(t, n), a = Math.max(t, n), c = p * p * p * a * (1 / 3 - 0.21 * p / a * (1 - p * p * p * p / (12 * a * a * a * a)));
      return {
        A: o,
        Iz: l,
        Iy: s,
    ...
    function Ro(t, n, o, l) {
      const s = n - 2 * o, p = 2 * t * o + s * l, a = (t * n * n * n - (t - l) * s * s * s) / 12, c = (2 * o * t * t * t + s * l * l * l) / 12, d = (2 * t * o * o * o + s * l * l * l) / 3;
      return {
        A: p,
        Iz: a,
        Iy: c,
    ...
    function Oo(t, n, o) {
      const l = t - 2 * o, s = n - 2 * o, p = t * n - l * s, a = (t * n * n * n - l * s * s * s) / 12, c = (n * t * t * t - s * l * l * l) / 12, d = (t - o) * (n - o), r = 2 * ((t - o) / o + (n - o) / o), i = 4 * d * d / (r > 0 ? r : 1);
      return {
        A: p,
        Iz: a,
        Iy: c,
    ...
    function Ia(t, n, o, l, s, p, a) {
      const d = 4700 * Math.sqrt(p / 1e3) * 1e3 / l, r = t - 2 * o, i = n - 2 * o, m = t * n - r * i, w = (t * n * n * n - r * i * i * i) / 12, E = (n * t * t * t - i * r * r * r) / 12, y = r * i, f = r * i * i * i / 12, h = i * r * r * r / 12, T = m + d * y, k = w + d * f, $ = E + d * h, C = l / (2 * (1 + s)), B = (t - o) * (n - o), x = 2 * ((t - o) / o + (n - o) / o), u = 4 * B * B / (x > 0 ? x : 1);
      return {
        A: T,
        Iz: k,
        Iy: $,
    ...
    function vn() {
      ...
      if ((z === "edificio" || z === "frame") && D.size > 0) {
        const { colMat: s, vigaMat: p, colShape: a, fc: c, perFloor: d } = Ne, r = 4700 * Math.sqrt(c / 1e3) * 1e3, i = r / (2 * 1.2), m = 24 / 9.80665, w = n.E, E = n.G, y = n.rho;
        for (let f = 0; f < t.length; f++) {
          if (ce.has(f)) {
            const I = 4700 * Math.sqrt(c / 1e3) * 1e3, L = 0.2;
            o.elasticities.set(f, I), o.poissonsRatios.set(f, L), o.thicknesses.set(f, Be), o.shearModuli.set(f, I / (2 * (1 + L))), o.densities.set(f, 24 / 9.80665);
            continue;
          }
          if (zt.has(f)) {
            const I = 4700 * Math.sqrt(c / 1e3) * 1e3, L = 0.2;
            o.elasticities.set(f, I), o.poissonsRatios.set(f, L), o.thicknesses.set(f, at), o.shearModuli.set(f, I / (2 * (1 + L))), o.densities.set(f, 24 / 9.80665);
            continue;
          }
          const h = D.has(f), T = $e.get(f) ?? 0, k = d[T] ?? d[0] ?? {
            bCol: 0.4,
            hCol: 0.4,
            dCol: 0.4
          };
          let $, C, B, x;
          if (h) if (s === 0) C = r, B = i, x = m, $ = a === 1 ? ks(k.dCol) : Po(k.bCol, k.hCol), o.sectionShapes.set(f, a === 1 ? {
            type: "circ",
            d: k.dCol
          } : {
            type: "rect",
            ...
            const I = Te.get(f), L = I ? I.dir === "x" ? k.vigasX : k.vigasY : [], R = I ? L[I.bay] ?? L[0] ?? ut() : ut();
            if (p === 0) C = r, B = i, x = m, $ = Po(R.b, R.h), o.sectionShapes.set(f, {
              type: "rect",
              b: R.b,
              h: R.h
            });
          ...
          const u = ye.get(f);
          if (u) {
            if ((u.material ?? 1) === 0 ? (C = r, B = i, x = m) : (C = w, B = E, x = y), u.secType === "rect" && u.b && u.h) $ = Po(u.b, u.h), o.sectionShapes.set(f, {
              type: "rect",
              b: u.b,
              h: u.h
            });
            else if (u.secType === "circ" && u.b) $ = ks(u.b), o.sectionShapes.set(f, {
              type: "circ",
              d: u.b
            });
          ...
          o.elasticities.set(f, C), o.shearModuli.set(f, B), o.areas.set(f, $.A), o.momentsOfInertiaZ.set(f, $.Iy), o.momentsOfInertiaY.set(f, $.Iz), o.torsionalConstants.set(f, $.J), o.densities.set(f, x), u && u.releases12 && u.releases12.some((I) => I) && (o.momentReleases || (o.momentReleases = /* @__PURE__ */ new Map()), o.momentReleases.set(f, u.releases12)), u && u.springs12 && u.springs12.some((I) => I > 0) && (o.partialFixitySprings || (o.partialFixitySprings = /* @__PURE__ */ new Map()), o.partialFixitySprings.set(f, u.springs12));
        }
...
`);
      ...
      let a = "";
      const c = Ae.querySelector("#cad3d-io-menu"), d = Ae.querySelector("#cad3d-io-file");
      function r(g, S) {
      ...
      c && c.addEventListener("change", () => {
        if (a = c.value, c.value = "", a.startsWith("import")) a === "import-e2k" ? d.accept = ".e2k,.E2K" : a === "import-s2k" ? d.accept = ".s2k,.S2K,.$2k" : a === "import-ifc" ? d.accept = ".ifc,.IFC" : a === "import-py" ? d.accept = ".py" : a === "import-tcl" && (d.accept = ".tcl"), d.click();
        ...
        var _a3;
        const g = (_a3 = d.files) == null ? void 0 : _a3[0];
        if (!g) return;
        if (a === "import-ifc") {
          ...
          v.onload = async () => {
            ...
            try {
              ...
              de.onload = () => {
                ...
                const Re = {};
                V.elementInfo.forEach((_) => Re[_.category] = (Re[_.category] || 0) + 1), console.log("IFC categories:", Re), console.log(`IFC: ${V.elementInfo.size} geometric elements, ${Ie.elements.length} analytical elements`), i(V, Ie);
              }, de.readAsText(g);
            } catch (X) {
              alert("IFC error: " + X.message), console.error(X);
            }
          }, v.readAsArrayBuffer(g), d.value = "";
          return;
        }
      ...
      y && (y.value = P, y.addEventListener("change", (g) => {
        ...
        if (qe) {
          const ae = et();
          ((_b2 = ae == null ? void 0 : ae.settings) == null ? void 0 : _b2.loads) && (_e = ae.settings.loads.rawVal, ae.settings.loads.val = false), Lo(), v.style.display = "", F.style.display = "", X.style.display = "", V && (V.style.display = ""), f();
...
`);
    ...
    function yn() {
      ...
      let n = 1 / 0, o = 1 / 0, l = 1 / 0, s = -1 / 0, p = -1 / 0, a = -1 / 0;
      for (const [r, i, m] of t) r < n && (n = r), r > s && (s = r), i < o && (o = i), i > p && (p = i), m < l && (l = m), m > a && (a = m);
      const c = new Oe((n + s) / 2, (o + p) / 2, (l + a) / 2), d = Math.max(s - n, p - o, a - l, 1);
      return {
        center: c,
        extent: d
      };
    ...
    function wt(t = false) {
      ...
      const p = Xa(), a = new ll(l, 20, p.grid, p.grid);
      ...
      const d = 0.05 * l, r = new so();
      r.name = "viewerAxes";
      const i = p.axisArrow;
      r.add(new co(new Oe(1, 0, 0), new Oe(), 1, i, 0.2, 0.2)), r.add(new co(new Oe(0, 1, 0), new Oe(), 1, i, 0.2, 0.2)), r.add(new co(new Oe(0, 0, 1), new Oe(), 1, i, 0.2, 0.2)), r.children.forEach((m) => m.scale.set(d, d, d));
      for (const [m, w, E] of [
        [
          "X",
          "red",
        ...
        T.position.set(E[0], E[1], E[2]), T.scale.set(0.4 * d, 0.4 * d, 1), T.renderOrder = 99, r.add(T);
      }
      n.scene.add(r), t ? n.render() : $n("3d");
    }
    function zs(t, n, o) {
    ...
    function $n(t) {
      ...
      const n = et();
      if (!n) return;
      const { center: o, extent: l } = yn(), s = n.renderer.domElement.clientWidth / (n.renderer.domElement.clientHeight || 1), p = l * 0.7;
      n.controls.maxDistance = l * 5, n.controls.minDistance = l * 0.05, n.renderer.clippingPlanes = [];
      const a = () => {
        n.scene.traverse((c) => {
          var _a3;
          if (!c.material) return;
          const d = c.type === "GridHelper" || c.type === "AxesHelper", r = c.isSprite, i = ((_a3 = c.userData) == null ? void 0 : _a3.noClip) === true;
          (d || r || i) && (Array.isArray(c.material) ? c.material.forEach((m) => {
            m.clippingPlanes = [];
          }) : c.material.clippingPlanes = []);
        });
      };
      if (t === "3d") {
        const c = n.perspCamera.fov, d = l / (2 * Math.tan(c * Math.PI / 360)) * 2.2;
        n.perspCamera.position.set(o.x + d * 0.5, o.y - d * 0.8, o.z + d * 0.5), n.controls.target.copy(o), n.setActiveCamera(n.perspCamera);
      } else {
        const c = n.orthoCamera;
        c.left = -p * s, c.right = p * s, c.top = p, c.bottom = -p, c.near = -l * 10, c.far = l * 10, c.updateProjectionMatrix();
        const d = (r, i, m) => {
          c.position.copy(r), c.up.copy(m), n.controls.target.copy(i), c.lookAt(i), n.controls.update();
        };
        if (t === "plan") n.renderer.clippingPlanes = [], d(new Oe(o.x, o.y, o.z + l * 2), new Oe(o.x, o.y, o.z), new Oe(0, 1, 0));
        else if (t.startsWith("plan:")) {
          const r = parseInt(t.split(":")[1]), i = ((_a2 = Z.hPiso) == null ? void 0 : _a2.val) ?? 3, m = (r + 1) * i, w = i * 0.45;
          n.renderer.clippingPlanes = [
            new In(new Oe(0, 0, -1), m + w),
            new In(new Oe(0, 0, 1), -m + w)
          ], a(), d(new Oe(o.x, o.y, m + l * 2), new Oe(o.x, o.y, m), new Oe(0, 1, 0));
          ...
          const r = parseInt(t.split(":")[1]), i = We[r] ?? o.x;
          if (Xe.length > 1) {
            const w = zs(We, r, l);
            n.renderer.clippingPlanes = [
              new In(new Oe(-1, 0, 0), i + w),
              new In(new Oe(1, 0, 0), -i + w)
            ], a(), c.position.set(o.x + l * 2, o.y, o.z), n.controls.target.set(o.x, o.y, o.z);
          } else c.position.set(o.x, o.y - l * 2, o.z), n.controls.target.copy(o);
          c.up.set(0, 0, 1);
        } else if (t.startsWith("axisY:")) {
          const r = parseInt(t.split(":")[1]), i = Xe[r] ?? o.y;
          if (We.length > 1) {
            const w = zs(Xe, r, l);
            n.renderer.clippingPlanes = [
              new In(new Oe(0, -1, 0), i + w),
              new In(new Oe(0, 1, 0), -i + w)
            ], a(), c.position.set(o.x, o.y - l * 2, o.z), n.controls.target.set(o.x, o.y, o.z);
    ...
    function No() {
      ...
      const n = (p, a, c) => {
        ...
        return d.textContent = p, d.dataset.view = a, d.title = c, d.style.cssText = "min-width:22px;padding:1px 5px;font-weight:bold", d.addEventListener("click", (r) => {
          var _a2;
          r.stopPropagation();
          const i = d.classList.contains("view-active");
          Ae.querySelectorAll("[data-view]").forEach((m) => m.classList.remove("view-active")), i ? ($n("3d"), (_a2 = Ae.querySelector('[data-view="3d"]')) == null ? void 0 : _a2.classList.add("view-active")) : ($n(a), d.classList.add("view-active"));
        }), d;
      ...
      We.forEach((p, a) => {
        ...
        t.appendChild(n(c, `axisX:${a}`, `Eje ${c} \u2014 elevaci\xF3n mirando en Y`));
      });
      const s = document.createElement("span");
      s.textContent = "|", s.style.cssText = "color:#555;margin:0 3px;align-self:center;font-weight:bold", t.appendChild(s), Xe.forEach((p, a) => {
        const c = `${a + 1}`;
        t.appendChild(n(c, `axisY:${a}`, `Eje ${c} \u2014 elevaci\xF3n mirando en X`));
      });
    }
    function qo() {
      var _a2;
      ...
      const o = (s, p, a) => {
        ...
        return c.textContent = s, c.dataset.view = p, c.title = a, c.style.cssText = "min-width:22px;padding:1px 5px;font-weight:bold", c.addEventListener("click", (d) => {
          var _a3;
          d.stopPropagation();
          const r = c.classList.contains("view-active");
          Ae.querySelectorAll("[data-view]").forEach((i) => i.classList.remove("view-active")), r ? ($n("3d"), (_a3 = Ae.querySelector('[data-view="3d"]')) == null ? void 0 : _a3.classList.add("view-active")) : ($n(p), c.classList.add("view-active"));
        }), c;
    ...
    function Bo(t) {
      ...
      for (let c = 0; c < l.length; c++) {
        const d = o[l[c]], r = o[l[(c + 1) % l.length]];
        s.push(d[0], d[1], d[2], r[0], r[1], r[2]);
      }
      const p = new tn();
      p.setAttribute("position", new Ln(s, 3));
      const a = new Gn(p, new Yn({
        color: 16711935,
        linewidth: 3,
        depthTest: false
      }));
        ...
        if (ht.size === 1) {
          ...
          o.forEach((i) => {
            ...
            if (m) if (m.length === 2) {
              ...
              h > y && h > f ? p++ : a++;
            } else m.length === 3 ? c++ : m.length === 4 && d++;
          });
          const r = [];
          p && r.push(`${p} columnas`), a && r.push(`${a} vigas`), d && r.push(`${d} shells Q4`), c && r.push(`${c} triangulos`), alert(`${o.length} elementos seleccionados:
${r.join(", ")}`);
        }
    ...
    function za(t) {
      ...
      for (const [p, a] of s) {
        ...
        d.setAttribute("position", new xo(c, 3));
        const r = new Wn({
          color: a,
          dashSize: 0.3,
          gapSize: 0.15,
        ...
        i.computeLineDistances(), i.renderOrder = 9990, n.scene.add(i), Do.push(i);
      }
      n.render();
    }
    function Ho() {
    ...
    function Cs(t, n, o, l) {
      ...
      const s = l.x - o.x, p = l.y - o.y, a = l.z - o.z, c = Math.sqrt(s * s + p * p + a * a), d = Math.abs(s), r = Math.abs(p), i = Math.abs(a);
      let m = "";
      d > r && d > i ? m = `\u0394X=${s.toFixed(2)}` : r > d && r > i ? m = `\u0394Y=${p.toFixed(2)}` : i > 0.01 && (m = `\u0394Z=${a.toFixed(2)}`), Qt.textContent = `${c.toFixed(3)} m  ${m}`, Qt.style.left = t + 20 + "px", Qt.style.top = n - 10 + "px";
    }
    function Aa(t, n) {
      const l = e.nodes.val[n];
      if (!l) return null;
      const s = new Oe(l[0], l[1], l[2]), p = t.clone(), a = p.clone().sub(s), c = 0.3, d = Math.abs(a.x), r = Math.abs(a.y), i = Math.abs(a.z);
      return r < c && i < c && d > 0.01 ? new Oe(p.x, s.y, s.z) : d < c && i < c && r > 0.01 ? new Oe(s.x, p.y, s.z) : d < c && r < c && i > 0.01 ? new Oe(s.x, s.y, p.z) : null;
    }
    function io() {
      var _a2;
      const t = et();
    ...
    `, document.body.appendChild(t), qn = t;
      const l = () => {
        const s = t.querySelector("#dt-line"), p = t.querySelector("#dt-arc"), a = t.querySelector("#dt-node"), c = t.querySelector("#dt-area");
        s && (s.style.cssText = n(jt === "line")), p && (p.style.cssText = n(jt === "arc")), a && (a.style.cssText = n(jt === "node")), c && (c.style.cssText = n(jt === "area"));
        const d = t.querySelector("#ds-node"), r = t.querySelector("#ds-grid"), i = t.querySelector("#ds-mid"), m = t.querySelector("#ds-track");
        d && (d.style.cssText = o(Et.node)), r && (r.style.cssText = o(Et.grid)), i && (i.style.cssText = o(Et.midpoint)), m && (m.style.cssText = o(Et.track));
      };
    ...
    function Fs(t, n, o, l) {
      const s = l.getBoundingClientRect(), p = (t - s.left) / s.width * 2 - 1, a = -((n - s.top) / s.height) * 2 + 1, c = new oa();
      c.setFromCamera(new sa(p, a), o);
      const d = e.nodes.val, r = e.elements.val, i = 0.12;
      if (Et.node) {
        let E = -1, y = 1 / 0;
        for (let f = 0; f < d.length; f++) {
          const h = d[f], T = new Oe(h[0], h[1], h[2]).project(o), k = Math.sqrt((T.x - p) ** 2 + (T.y - a) ** 2);
          k < i && k < y && (y = k, E = f);
        }
        if (E >= 0) return {
          nodeIdx: E,
      ...
      if (Et.midpoint) {
        ...
        for (const f of r) {
          ...
          const h = d[f[0]], T = d[f[1]], k = new Oe((h[0] + T[0]) / 2, (h[1] + T[1]) / 2, (h[2] + T[2]) / 2), $ = k.clone().project(o), C = Math.sqrt(($.x - p) ** 2 + ($.y - a) ** 2);
          C < i * 0.8 && C < E && (E = C, y = k);
        }
        if (y) return {
          nodeIdx: null,
      ...
      if (Et.grid) {
        ...
        if (c.ray.intersectPlane(E, y)) {
          const f = Et.gridSize || _o;
      ...
      return c.ray.intersectPlane(m, w), {
        nodeIdx: null,
        worldPos: w,
        snapType: "free"
      };
    ...
    function Ps(t) {
      ...
      if (qt && (n.scene.remove(qt), qt.geometry.dispose(), qt.material.dispose(), qt = null), t.worldPos) {
        const l = t.snapType === "node" ? 16776960 : t.snapType === "mid" ? 16711935 : t.snapType === "grid" ? 65535 : 8947848, s = t.snapType === "node" ? 0.08 : 0.06, p = t.snapType === "mid" ? new nl(s * 2, s * 2, s * 2) : new ol(s, 12, 12), a = new sl({
          color: l,
          transparent: true,
          opacity: 0.8,
          depthTest: false
        });
        qt = new ca(p, a), qt.position.copy(t.worldPos), qt.renderOrder = 9999, n.scene.add(qt);
      }
      if (Nt && (n.scene.remove(Nt), Nt.geometry.dispose(), Nt.material.dispose(), Nt = null), vt !== null && t.worldPos) {
        const l = o[vt], s = new tn();
        if (jt === "arc" && Zt !== null) {
          const a = o[Zt], c = Rs(new Oe(l[0], l[1], l[2]), new Oe(a[0], a[1], a[2]), t.worldPos, 16), d = [];
          for (let r = 0; r < c.length - 1; r++) d.push(c[r].x, c[r].y, c[r].z, c[r + 1].x, c[r + 1].y, c[r + 1].z);
          s.setAttribute("position", new Ln(d, 3));
        ...
        Nt = new Cn(s, p), jt === "arc" && Zt !== null && (Nt = new Gn(s, p)), Nt.renderOrder = 9999, n.scene.add(Nt);
      }
      n.render();
    }
    function Rs(t, n, o, l) {
      const s = [];
      for (let p = 0; p <= l; p++) {
        const a = p / l, c = n.clone().multiplyScalar(2).sub(t.clone().multiplyScalar(0.5)).sub(o.clone().multiplyScalar(0.5)), d = (1 - a) * (1 - a), r = 2 * (1 - a) * a, i = a * a;
        s.push(new Oe(d * t.x + r * c.x + i * o.x, d * t.y + r * c.y + i * o.y, d * t.z + r * c.z + i * o.z));
      }
      return s;
    }
    function jo(t) {
    ...
    function Ca(t) {
      ...
      if (jt === "arc") {
        ...
        if (n === vt || n === Zt) return;
        const o = e.nodes.val, l = new Oe(...o[vt]), s = new Oe(...o[Zt]), p = new Oe(...o[n]), a = Math.max(4, Math.round(((_a2 = Z.nSubViga) == null ? void 0 : _a2.val) ?? 8)), c = Rs(l, s, p, a);
        Dn();
        const d = [
          ...e.nodes.val
        ], r = [
        ...
        e.nodes.val = d, e.elements.val = r, vn(), e.elementInputs.val = {
          ...e.elementInputs.val
        }, vt = n, Zt = null;
        return;
      }
      if (jt === "area") {
        ...
        if (Xt.length >= 3 && n === Xt[0]) {
          ...
          try {
            ...
            for (const c of p.nodes) {
              let d = -1;
              for (let r = 0; r < o.length; r++) {
                const i = Math.abs(o[r][0] - c[0]), m = Math.abs(o[r][1] - c[1]), w = Math.abs(o[r][2] - c[2]);
                if (i < 0.01 && m < 0.01 && w < 0.01) {
                  d = r;
                  break;
                }
              }
              d >= 0 ? a.push(d) : (a.push(o.length), o.push([
                c[0],
                c[1],
                c[2]
              ]));
            }
            for (const c of p.elements) l.push([
              a[c[0]],
              a[c[1]],
              a[c[2]]
            ]);
            e.nodes.val = o, e.elements.val = l, vn(), console.log(`Area: ${p.elements.length} triangulos creados desde ${Xt.length} vertices`);
          } catch (p) {
    ...
    function Os(t) {
      ...
      for (let a = 0; a < l.length; a++) {
        const c = o[l[a]], d = o[l[(a + 1) % l.length]];
        s.push(c[0], c[1], c[2], d[0], d[1], d[2]);
      }
      const p = new tn();
      p.setAttribute("position", new Ln(s, 3)), Jt = new Gn(p, new Yn({
        color: 16776960,
        linewidth: 3,
        depthTest: false
    ...
    function Wo(t) {
      ...
      const p = e.nodes.val, a = e.elements.val;
      if (p.length === 0 || a.length === 0) return -1;
      let c = 1 / 0, d = -1;
      const r = s.ray;
      for (let m = 0; m < a.length; m++) {
        const w = a[m];
        if (w.length === 2) {
          const E = new Oe(...p[w[0]]), y = new Oe(...p[w[1]]), f = new al(E, y), h = new Oe(), T = new Oe();
          r.closestPointToPoint(f.getCenter(new Oe()), h), f.closestPointToPoint(h, true, T);
          const k = h.distanceTo(T);
          k < c && (c = k, d = m);
        } else if (w.length === 3) {
          const E = new Oe(...p[w[0]]), y = new Oe(...p[w[1]]), f = new Oe(...p[w[2]]), h = new Oe();
          if (r.intersectTriangle(E, y, f, false, h)) {
            const k = r.origin.distanceTo(h);
            k < c && (c = k, d = m);
          } else {
            const k = E.add(y).add(f).divideScalar(3), $ = new Oe();
            r.closestPointToPoint(k, $);
            const C = $.distanceTo(k);
            C < c && (c = C, d = m);
          }
        } else if (w.length === 4) {
          const E = new Oe(...p[w[0]]), y = new Oe(...p[w[1]]), f = new Oe(...p[w[2]]), h = new Oe(...p[w[3]]), T = new Oe();
    ...
    function Go(t, n, o = 12) {
      ...
      if (n) {
        ...
        for (let a = 0; a < s; a++) p += `<td class="header">${n[a] || a}</td>`;
        p += "</tr>";
      }
      for (let a = 0; a < l; a++) {
        p += "<tr>", n && (p += `<td class="header">${n[a] || a}</td>`);
        for (let c = 0; c < s; c++) {
          const d = t[a][c], r = Math.abs(d) > 1e-10 ? "nonzero" : "";
          p += `<td class="${r}">${Me(d, 2)}</td>`;
        }
        p += "</tr>";
      }
      return p += "</table>", p;
    ...
    function Fa(t, n, o, l, s, p, a) {
      const c = 0.8333333333333334 * n, d = 5 / 6 * n, r = d > 0 && s > 0 ? 12 * t * o / (s * d * a ** 2) : 0, i = c > 0 && s > 0 ? 12 * t * l / (s * c * a ** 2) : 0, m = t * n / a, w = s * p / a, E = 12 * t * o / a ** 3 / (1 + r), y = 6 * t * o / a ** 2 / (1 + r), f = 4 * t * o / a * (1 + r / 4) / (1 + r), h = 2 * t * o / a * (1 - r / 2) / (1 + r), T = r > 1e-10 || i > 1e-10;
      ...
      <div style="text-align:left;margin-bottom:6px;color:var(--fem-eq-sub)">
        ${A("A", "s")} = ${De("5", "6")} \xB7 ${A("A")} = <span class="highlight">${Me(c)}</span>
        &nbsp;&nbsp; \u03C6<sub>z</sub> = ${De("12\xB7" + A("E") + "\xB7" + A("I", "z"), A("G") + "\xB7" + A("A", "s") + "\xB7" + A("L") + "\xB2")} = <span class="highlight">${Me(r)}</span>
      ...
      <div>${A("k", "z")} = ${De("4\xB7" + A("E") + "\xB7" + A("I", "z") + "\xB7(1+\u03C6/4)", A("L") + "\xB7(1+\u03C6<sub>z</sub>)")} = <span class="highlight">${Me(f)}</span> &nbsp;(flexi\xF3n diagonal)</div>
      ...
      <div>${De("4\xB7" + A("E") + "\xB7" + A("I", "z"), A("L"))} = <span class="highlight">${Me(f)}</span></div>
      `}
    </div>
    <div class="fem-eq">
    ...
    function Pa(t) {
      if (t.length === 2) {
        const o = xn(t[1], t[0]), l = Rn(o), s = o[0] / l, p = o[1] / l, a = o[2] / l;
        return `<div class="fem-eq eq-box">
        ...
        <div>${A("m")} = cos(\u03B2) = ${De("\u0394y", A("L"))} = ${De(Me(o[1]), Me(l))} = <span class="highlight">${Me(p)}</span></div>
    ...
    function Yo(t, n) {
      ...
      for (let s = 0; s < o; s++) {
        ...
        for (let p = 0; p < o; p++) {
          const a = t[s][p], c = (s === p ? "diag " : "") + (Math.abs(a) > 1e-10 ? "nz" : "");
          l += `<td class="${c}">${Me(a, 2)}</td>`;
        }
        l += "</tr>";
      }
      return l += "</table>", l;
    ...
    function Ns() {
      const t = "0", n = De(A("EA"), A("L")), o = De("\u2212" + A("EA"), A("L")), l = De("12" + A("EI", "z"), A("L") + "\xB3"), s = De("\u221212" + A("EI", "z"), A("L") + "\xB3"), p = De("12" + A("EI", "y"), A("L") + "\xB3"), a = De("\u221212" + A("EI", "y"), A("L") + "\xB3"), c = De("6" + A("EI", "z"), A("L") + "\xB2"), d = De("\u22126" + A("EI", "z"), A("L") + "\xB2"), r = De("6" + A("EI", "y"), A("L") + "\xB2"), i = De("\u22126" + A("EI", "y"), A("L") + "\xB2"), m = De(A("GJ"), A("L")), w = De("\u2212" + A("GJ"), A("L")), E = De("4" + A("EI", "z"), A("L")), y = De("2" + A("EI", "z"), A("L")), f = De("4" + A("EI", "y"), A("L")), h = De("2" + A("EI", "y"), A("L")), T = '<span style="color:var(--fem-eq-dots);font-style:italic">sym</span>', k = [
        "P\u2081",
        "P\u2082",
        "P\u2083",
        "P\u2084",
    ...
    function qa(t, n, o, l, s, p, a) {
      ...
      ].map((d) => `<div class="coeff-item"><div style="color:var(--fem-eq-sub);font-size:10px;font-family:monospace;margin-bottom:2px">${d.label}</div>${d.name} = ${d.calc} = <span class="highlight">${Me(d.val)}</span></div>`).join("")}</div>`;
    }
    function Jo(t, n, o, l) {
      var _a2;
    ...
    `, document.body.appendChild(p), (_a2 = p.querySelector("#fem-full-close")) == null ? void 0 : _a2.addEventListener("click", () => p.remove()), p.addEventListener("click", (a) => {
        a.target === p && p.remove();
      });
    }
    function qs(t) {
      ...
      Kt && Kt.remove();
      const n = e.nodes.val, o = e.elements.val, l = o[t], s = l.map((x) => n[x]), p = l.length === 2, a = ((_a2 = e.elementInputs) == null ? void 0 : _a2.val) || {}, c = (_b = e.deformOutputs) == null ? void 0 : _b.val, d = (_c = e.analyzeOutputs) == null ? void 0 : _c.val;
      if (p) {
      ...
      let r = "", i = "", m = "", w = "", E = "", y = "", f = "", h = "", T = null, k = null, $ = null, C = [];
      try {
        if (T = vo(s, a, t), k = yo(s), $ = on(os(k), on(T, k)), C = p ? [
          "ux\u2080",
          "uy\u2080",
          "uz\u2080",
          "\u03B8x\u2080",
        ...
        r = `<div class="matrix-label">k_local (${T.length}\xD7${T.length}) ${x}</div>${Go(T, C)}`, i = `<div class="matrix-label">T \u2014 Transformaci\xF3n (${k.length}\xD7${k.length}) ${u}</div>${Go(k, C)}`, m = `<div class="matrix-label">K_global = T^T \xB7 k \xB7 T ${I}</div>${Go($, C)}`;
      } catch (x) {
      ...
      if (c == null ? void 0 : c.deformations) {
        ...
        l.map((u, I) => {
          var _a3;
          const L = ((_a3 = c.deformations) == null ? void 0 : _a3.get(u)) || [
            0,
            0,
            0,
            0,
      ...
      if (d && p && (c == null ? void 0 : c.deformations) && T && k) {
        const x = (_u = d.normals) == null ? void 0 : _u.get(t), u = (_v = d.shearsY) == null ? void 0 : _v.get(t), I = (_w = d.shearsZ) == null ? void 0 : _w.get(t), L = (_x = d.torsions) == null ? void 0 : _x.get(t), R = (_y = d.bendingsY) == null ? void 0 : _y.get(t), j = (_z = d.bendingsZ) == null ? void 0 : _z.get(t), g = [
          "ux",
          "uy",
          "uz",
          "\u03B8x",
        ...
        for (const Q of l) {
          const K = ((_A = c.deformations) == null ? void 0 : _A.get(Q)) || [
            0,
            0,
            0,
            0,
        ...
        const x = (_B = d.normals) == null ? void 0 : _B.get(t), u = (_C = d.shearsY) == null ? void 0 : _C.get(t), I = (_D = d.shearsZ) == null ? void 0 : _D.get(t), L = (_E = d.torsions) == null ? void 0 : _E.get(t), R = (_F = d.bendingsY) == null ? void 0 : _F.get(t), j = (_G = d.bendingsZ) == null ? void 0 : _G.get(t);
        `${x ? x.map((g) => Me(g)).join(", ") : "\u2014"}${u ? u.map((g) => Me(g)).join(", ") : "\u2014"}${I ? I.map((g) => Me(g)).join(", ") : "\u2014"}${L ? L.map((g) => Me(g)).join(", ") : "\u2014"}${R ? R.map((g) => Me(g)).join(", ") : "\u2014"}${j ? j.map((g) => Me(g)).join(", ") : "\u2014"}`;
      } else if (d && !p) {
        const x = (_H = d.bendingXX) == null ? void 0 : _H.get(t), u = (_I = d.bendingYY) == null ? void 0 : _I.get(t), I = (_J = d.bendingXY) == null ? void 0 : _J.get(t), L = (_K = d.membraneXX) == null ? void 0 : _K.get(t), R = (_L = d.membraneYY) == null ? void 0 : _L.get(t), j = (_M = d.membraneXY) == null ? void 0 : _M.get(t);
        `${x ? x.map((g) => Me(g)).join(", ") : "\u2014"}${u ? u.map((g) => Me(g)).join(", ") : "\u2014"}${I ? I.map((g) => Me(g)).join(", ") : "\u2014"}${L ? L.map((g) => Me(g)).join(", ") : "\u2014"}${R ? R.map((g) => Me(g)).join(", ") : "\u2014"}${j ? j.map((g) => Me(g)).join(", ") : "\u2014"}`;
      }
      `${l[0]}`, 6 * l[0], 6 * l[0] + 5, `${l[1]}`, 6 * l[1], 6 * l[1] + 5, l.length === 3 && (`${l[2]}`, 6 * l[2], 6 * l[2] + 5), n.length * 6, n.length * 6, Kt = vl(t, n, o, a, c, d), Kt.id = "fem-inspect-panel", document.body.appendChild(Kt), (_N = Kt.querySelector("#er-close")) == null ? void 0 : _N.addEventListener("click", () => An()), (_O = Kt.querySelector("#rel-apply")) == null ? void 0 : _O.addEventListener("click", () => {
    ...
    function _s() {
      ...
      const d = 2e8, r = 77e6, i = 5e-3, m = 2e-6, w = 1e-6, E = {
    ...
    function Ds() {
      ...
      const c = 2e8, d = 77e6, r = 0.01, i = 5e-6, m = 2e-6, w = {
    ...
    function Bs() {
      ...
      for (let f = c; f < c + d.length * 4; f += 4) i.set(f, [
        true,
        true,
        true,
        true,
      ...
      setTimeout(() => wt(), 50), Ze(), console.log(`Puente atirantado: ${p.length} nodos, ${a.length} elem, span=60m`);
    }
    function Hs() {
      const p = [], a = [];
      for (let h = 0; h <= 12; h++) {
      ...
      const i = 2e8, m = 77e6, w = 8e-3, E = 1e-5, y = 5e-6, f = {
      ...
      setTimeout(() => wt(), 50), Ze(), console.log(`Torre Twist: ${p.length} nodos, ${a.length} elem, 12 pisos, twist=5deg/piso`);
    }
    function js() {
      const s = [], p = [];
      for (let f = 0; f <= 20; f++) {
      ...
      const r = 35e6, i = 14e6, m = 0.02, w = 5e-5, E = 2e-5, y = {
        elasticities: new Map(p.map((f, h) => [
          h,
          r
        ])),
        shearModuli: new Map(p.map((f, h) => [
          h,
          i
        ])),
        areas: new Map(p.map((f, h) => [
          h,
          m
        ])),
        momentsOfInertiaZ: new Map(p.map((f, h) => [
          h,
          w
        ])),
        momentsOfInertiaY: new Map(p.map((f, h) => [
          h,
          w
        ])),
        torsionalConstants: new Map(p.map((f, h) => [
          h,
          E
        ]))
      };
      ...
      setTimeout(() => wt(), 50), Ze(), console.log(`Burj Khalifa: ${s.length} nodos, ${p.length} elem, 20 pisos, H=${20 * 3}m`);
    }
    function Ws() {
      const t = [], n = [];
      for (let m = 0; m < 3; m++) {
      ...
      const a = 35e6, c = 0.2, d = 0.15, r = a / (2 * (1 + c)), i = {
    ...
    function Gs() {
      ...
      for (let y = 1; y <= 15; y++) {
        ...
        for (let T = 0; T < 12; T += 3) c.set(f + T, [
          h,
          0,
          -8,
          0,
      ...
      const d = 2e8, r = 77e6, i = 6e-3, m = 8e-6, w = 4e-6, E = {
        elasticities: new Map(s.map((y, f) => [
          f,
          d
        ])),
    ...
    function Vo() {
      ...
      const t = ((_a2 = Z.W) == null ? void 0 : _a2.val) ?? 5, n = ((_b = Z.H) == null ? void 0 : _b.val) ?? 3, o = ((_c = Z.t) == null ? void 0 : _c.val) ?? 0.2, l = Math.round(((_d = Z.nx) == null ? void 0 : _d.val) ?? 8), s = Math.round(((_e2 = Z.ny) == null ? void 0 : _e2.val) ?? 6), p = ((_f = Z.E) == null ? void 0 : _f.val) ?? 25e6, a = ((_g = Z.nu) == null ? void 0 : _g.val) ?? 0.2, c = ((_h = Z.P) == null ? void 0 : _h.val) ?? 100, d = p / (2 * (1 + a)), r = t / l, i = n / s, m = [], w = [], E = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map();
    ...
    function Ys() {
      var _a2, _b, _c, _d, _e2, _f, _g, _h;
      const t = ((_a2 = Z.L) == null ? void 0 : _a2.val) ?? 6, n = ((_b = Z.h) == null ? void 0 : _b.val) ?? 0.5, o = ((_c = Z.t) == null ? void 0 : _c.val) ?? 0.2, l = Math.round(((_d = Z.nx) == null ? void 0 : _d.val) ?? 12), s = Math.round(((_e2 = Z.ny) == null ? void 0 : _e2.val) ?? 4), p = ((_f = Z.E) == null ? void 0 : _f.val) ?? 25e6, a = ((_g = Z.nu) == null ? void 0 : _g.val) ?? 0.2, c = ((_h = Z.P) == null ? void 0 : _h.val) ?? 50, d = p / (2 * (1 + a)), r = t / l, i = n / s, m = [], w = [], E = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map();
      ...
      try {
        ...
        if (k && e.deformOutputs) {
          ...
          const $ = gn(m, w, T, k);
          e.analyzeOutputs && (e.analyzeOutputs.val = $);
          const C = k.deformations.get(h), B = C ? C[2] : 0, x = o * n * n * n / 12, u = c * t * t * t / (3 * p * x);
    ...
    function Js() {
      var _a2, _b, _c, _d, _e2, _f, _g, _h;
      const t = ((_a2 = Z.Lx) == null ? void 0 : _a2.val) ?? 4, n = ((_b = Z.Ly) == null ? void 0 : _b.val) ?? 2, o = ((_c = Z.t) == null ? void 0 : _c.val) ?? 0.15, l = Math.round(((_d = Z.nx) == null ? void 0 : _d.val) ?? 8), s = Math.round(((_e2 = Z.ny) == null ? void 0 : _e2.val) ?? 4), p = ((_f = Z.E) == null ? void 0 : _f.val) ?? 25e6, a = ((_g = Z.nu) == null ? void 0 : _g.val) ?? 0.2, c = ((_h = Z.P) == null ? void 0 : _h.val) ?? 20, d = p / (2 * (1 + a)), r = t / l, i = n / s, m = [], w = [], E = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map();
      for (let $ = 0; $ <= s; $++) for (let C = 0; C <= l; C++) m.push([
        C * r,
        0,
        $ * i
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        }, o = n("po-colB"), l = n("po-colH"), s = n("po-fc") * 1e3, p = n("po-fy") * 1e3, a = n("po-H"), c = n("po-L"), d = n("po-As") * 1e-4, r = n("po-nbar"), i = n("po-drift") / 100, m = n("po-ncycles"), w = t.querySelector("#pushover-status");
        ...
        try {
          ...
          w.textContent = `Completado: ${T.nSteps} pasos`, Ba(t.querySelector("#pushover-canvas"), T.displacements, T.forces, `Pushover: ${o * 100}x${l * 100}cm, f'c=${s / 1e3}MPa, Fy=${p / 1e3}MPa`);
        } catch (h) {
    ...
    function Ba(t, n, o, l) {
      ...
      const p = t.width, a = t.height, c = {
        left: 55,
        right: 15,
        top: 30,
        bottom: 35
      }, d = p - c.left - c.right, r = a - c.top - c.bottom;
      s.fillStyle = "#111118", s.fillRect(0, 0, p, a);
      let i = Math.min(...n), m = Math.max(...n), w = Math.min(...o), E = Math.max(...o);
      i === m && (i -= 0.01, m += 0.01), w === E && (w -= 1, E += 1);
      const y = m - i, f = E - w, h = (C) => c.left + (C - i) / y * d, T = (C) => c.top + r - (C - w) / f * r;
      s.strokeStyle = "#333", s.lineWidth = 0.5, i < 0 && m > 0 && (s.strokeStyle = "#555", s.beginPath(), s.moveTo(h(0), c.top), s.lineTo(h(0), c.top + r), s.stroke()), w < 0 && E > 0 && (s.beginPath(), s.moveTo(c.left, T(0)), s.lineTo(c.left + d, T(0)), s.stroke()), s.strokeStyle = "#ff4444", s.lineWidth = 1.5, s.beginPath(), s.moveTo(h(n[0]), T(o[0]));
      for (let C = 1; C < n.length; C++) s.lineTo(h(n[C]), T(o[C]));
      s.stroke(), s.fillStyle = "#aaa", s.font = "11px monospace", s.textAlign = "center", s.fillText("Desplazamiento (m)", c.left + d / 2, a - 5), s.save(), s.translate(12, c.top + r / 2), s.rotate(-Math.PI / 2), s.fillText("Fuerza (kN)", 0, 0), s.restore(), s.fillStyle = "#ee9b00", s.font = "bold 11px monospace", s.textAlign = "center", s.fillText(l, p / 2, 15), s.fillStyle = "#888", s.font = "9px monospace", s.textAlign = "center";
      const k = y / 5;
      for (let C = 0; C <= 5; C++) {
        const B = i + k * C;
        s.fillText((B * 1e3).toFixed(1), h(B), a - c.bottom + 15);
      }
      s.textAlign = "right";
      const $ = f / 5;
      for (let C = 0; C <= 5; C++) {
        const B = w + $ * C;
        s.fillText(B.toFixed(0), c.left - 5, T(B) + 3);
      }
    }
    let eo = null;
    function Ha() {
    ...
    function ja(t) {
      const n = parseFloat(t.querySelector("#nl-fy").value), o = parseFloat(t.querySelector("#nl-e0").value), l = parseFloat(t.querySelector("#nl-b").value), s = parseFloat(t.querySelector("#nl-r0").value), p = parseFloat(t.querySelector("#nl-amp").value), a = parseInt(t.querySelector("#nl-cycles").value), c = 100, d = [];
      for (let V = 0; V < a; V++) {
        const ae = p * (1 + V * 0.5);
        for (let Q = 0; Q < c; Q++) {
          const K = Q / c * 2 * Math.PI;
          d.push(ae * Math.sin(K));
        }
      }
      const r = n / o, i = l * o;
      ...
      const B = [];
      for (const V of d) {
        let ae = E, Q = y, K = f, de = h, re = T, Ie = k, Re = $, _ = C, fe;
        const oe = V - m;
        if (Math.abs(oe) < 1e-20) {
          B.push(w);
          continue;
        }
        if ((_ === 0 || _ === 3) && (oe < 0 ? (_ = 2, de = -r, re = -n, K = de, Ie = 0, Re = 0) : (_ = 1, de = r, re = n, K = de, Ie = 0, Re = 0)), _ === 2 && oe > 0) {
          _ = 1, Ie = m, Re = w, m < ae && (ae = m);
          const Se = (Q - ae) / (2 * 1 * r), je = 1 + 0 * Math.pow(Se, 0.8);
          de = (n * je - i * r * je - Re + o * Ie) / (o - i), re = n * je + i * (de - r * je), K = Q;
        } else if (_ === 1 && oe < 0) {
          _ = 2, Ie = m, Re = w, m > Q && (Q = m);
          const Se = (Q - ae) / (2 * 1 * r), je = 1 + 0 * Math.pow(Se, 0.8);
          de = (-n * je + i * r * je - Re + o * Ie) / (o - i), re = -n * je + i * (de + r * je), K = ae;
        }
        const pe = Math.abs((K - de) / r);
        let ee = s - 0.925 * pe / (0.15 + pe);
        ee < 0.1 && (ee = 0.1);
        const ue = (V - Ie) / (de - Ie), we = 1 + Math.pow(Math.abs(ue), ee), se = Math.pow(we, 1 / ee);
        fe = l * ue + (1 - l) * ue / se, fe = fe * (re - Re) + Re, B.push(fe), m = V, w = fe, E = ae, y = Q, f = K, h = de, T = re, k = Ie, $ = Re, C = _;
      }
      const x = t.querySelector("#nl-canvas"), u = x.getContext("2d"), I = x.width, L = x.height;
      u.clearRect(0, 0, I, L);
      const R = Math.max(...d.map(Math.abs)), j = Math.max(...B.map(Math.abs)), g = (I - 40) / (2 * R), S = (L - 40) / (2 * j), v = I / 2, F = L / 2;
      ...
      X.textContent = `Steel02: Fy=${(n / 1e3).toFixed(0)} MPa, E\u2080=${(o / 1e6).toFixed(0)} GPa, b=${l}, R\u2080=${s} \u2014 ${a} ciclos, amp=${(p * 100).toFixed(1)}%`;
    }
    function Wa() {
      var _a2, _b, _c, _d;
      ...
      const n = e.nodes.val, o = e.elements.val, l = ((_a2 = e.elementInputs) == null ? void 0 : _a2.val) || {}, s = ((_b = e.nodeInputs) == null ? void 0 : _b.val) || {}, p = (_c = e.deformOutputs) == null ? void 0 : _c.val;
    ...
    function Ga(t) {
      ...
      const o = mo(), l = bo(), s = Object.entries(o).map(([r, i]) => `<option value="${i}">${r}</option>`).join(""), p = Object.entries(l).map(([r, i]) => `<option value="${i}">${r}</option>`).join("");
      n.innerHTML = `
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;">
    ...
    `, document.body.appendChild(n), Bn = n;
      const a = n.querySelector("#asgn-type"), c = n.querySelector("#asgn-params");
      function d() {
        const r = a.value;
        let i = "";
      ...
      a.addEventListener("change", d), d(), n.querySelector("#asgn-close").addEventListener("click", () => {
        n.remove(), Bn = null;
        ...
        r === "rect" ? (i.b = parseFloat(n.querySelector("#ap-b").value), i.h = parseFloat(n.querySelector("#ap-h").value), i.material = 0) : r === "circ" ? (i.b = parseFloat(n.querySelector("#ap-d").value), i.material = 0) : r === "W" || r === "HSS" ? (i.profileIdx = parseInt(n.querySelector("#ap-profile").value), i.material = 1) : r === "I-param" ? (i.bf = parseFloat(n.querySelector("#ap-bf").value), i.hf = parseFloat(n.querySelector("#ap-hf").value), i.tf = parseFloat(n.querySelector("#ap-tf").value), i.tw = parseFloat(n.querySelector("#ap-tw").value), i.material = 1) : r === "tubular" && (i.bc = parseFloat(n.querySelector("#ap-bc").value), i.hc = parseFloat(n.querySelector("#ap-hc").value), i.t = parseFloat(n.querySelector("#ap-t").value), i.material = 1);
        ...
        }), i.releases12 = m, i.springs12 = w, i.releaseRotStart = m[4] || m[5], i.releaseRotEnd = m[10] || m[11], i.releaseAxial = m[0], i.releaseTorsion = m[3], i.modI = parseFloat((_a2 = n.querySelector("#asgn-mod-i")) == null ? void 0 : _a2.value) || 1, i.modA = parseFloat((_b = n.querySelector("#asgn-mod-a")) == null ? void 0 : _b.value) || 1, i.modJ = parseFloat((_c = n.querySelector("#asgn-mod-j")) == null ? void 0 : _c.value) || 1, i.modAs2 = parseFloat((_d = n.querySelector("#asgn-mod-as2")) == null ? void 0 : _d.value) ?? 1, i.modAs3 = parseFloat((_e2 = n.querySelector("#asgn-mod-as3")) == null ? void 0 : _e2.value) ?? 1, i.modI3 = parseFloat((_f = n.querySelector("#asgn-mod-i3")) == null ? void 0 : _f.value) || 1, i.modMass = parseFloat((_g = n.querySelector("#asgn-mod-mass")) == null ? void 0 : _g.value) || 1, i.modWeight = parseFloat((_h = n.querySelector("#asgn-mod-weight")) == null ? void 0 : _h.value) || 1, t.forEach((E) => ye.set(E, {
          ...i
        })), n.remove(), Bn = null, vn(), e.elementInputs.val = {
          ...e.elementInputs.val
        };
      }), n.querySelector("#asgn-remove").addEventListener("click", () => {
        t.forEach((r) => ye.delete(r)), n.remove(), Bn = null, vn(), e.elementInputs.val = {
          ...e.elementInputs.val
        };
      });
    }
    ...
    function Ya(t) {
      ...
      const l = n[o[0]], s = n[o[1]], p = Math.abs(s[0] - l[0]), a = Math.abs(s[1] - l[1]), c = Math.abs(s[2] - l[2]), d = a > p && a > c, r = Math.sqrt(p * p + a * a + c * c), i = $e.get(t) ?? 0, m = (_c = (_b = (_a2 = e.elementInputs) == null ? void 0 : _a2.val) == null ? void 0 : _b.sectionShapes) == null ? void 0 : _c.get(t), w = (m == null ? void 0 : m.name) || (m ? `${m.type} ${((m.b ?? 0) * 100).toFixed(0)}x${((m.h ?? 0) * 100).toFixed(0)}` : "\u2014"), E = document.createElement("div");
    ...
    setTimeout(() => {
      ...
      function p(d) {
        const r = et();
        if (!r) return null;
        const i = r.controls.object, m = new Oe(d[0], d[1], d[2]);
        m.project(i);
      ...
      function a(d, r, i, m, w) {
        const E = Math.min(d, i), y = Math.max(d, i), f = Math.min(r, m), h = Math.max(r, m), T = e.nodes.val, k = e.elements.val, $ = [];
        for (let C = 0; C < k.length; C++) {
          const B = k[C], x = B.map((u) => p(T[u])).filter(Boolean);
          if (x.length !== 0) if (w) x.every((I) => I.x >= E && I.x <= y && I.y >= f && I.y <= h) && $.push(C);
            ...
            if (B.length === 2) {
              const I = x[0], L = x[1];
              c(I.x, I.y, L.x, L.y, E, f, y, h) && $.push(C);
            }
          }
        }
        return $;
      }
      function c(d, r, i, m, w, E, y, f) {
        const h = (k, $) => k >= w && k <= y && $ >= E && $ <= f;
        if (h(d, r) || h(i, m)) return true;
        ...
        return T(d, r, i, m, w, E, y, E) || T(d, r, i, m, y, E, y, f) || T(d, r, i, m, w, f, y, f) || T(d, r, i, m, w, E, w, f);
      }
      n.addEventListener("mousedown", (d) => {
        ...
        if (pn) {
          const i = et();
          if (!i) return;
          const m = Fs(d.clientX, d.clientY, i.camera, i.rendererElm);
          ...
          if (zn !== null && m.worldPos) {
            ...
            w && Cs(d.clientX, d.clientY, new Oe(...w), m.worldPos);
        ...
        if (!nn && !Yt) return;
        if (Yt && o) {
          const i = d.offsetX - o.x, m = d.offsetY - o.y;
          if (Math.abs(i) > s || Math.abs(m) > s) {
            ...
            const w = i > 0, E = Math.min(o.x, d.offsetX), y = Math.min(o.y, d.offsetY), f = Math.abs(i), h = Math.abs(m);
            l.style.left = E + "px", l.style.top = y + "px", l.style.width = f + "px", l.style.height = h + "px", l.style.border = w ? "2px solid #3399ff" : "2px dashed #33ff33", l.style.background = w ? "rgba(51,153,255,0.1)" : "rgba(51,255,51,0.1)", n.style.cursor = "crosshair";
            return;
          }
        }
        const r = Wo(d);
        if (r >= 0) Os(r), n.style.cursor = "pointer";
        else {
          if (Jt) {
            const i = et();
            i == null ? void 0 : i.scene.remove(Jt), Jt = null, i == null ? void 0 : i.render();
          }
          n.style.cursor = Yt ? "crosshair" : "";
        }
      }), n.addEventListener("mouseup", (d) => {
        if (Yt && o) {
          const r = d.offsetX - o.x, i = d.offsetY - o.y;
          if (Math.abs(r) > s || Math.abs(i) > s) {
            const m = r > 0, w = a(o.x, o.y, d.offsetX, d.offsetY, m);
            d.ctrlKey || d.metaKey || (ht.clear(), wn()), w.forEach((y) => {
        ...
        if (pn) {
          const r = et();
          if (!r) return;
          const i = Fs(d.clientX, d.clientY, r.camera, r.rendererElm);
          (i.worldPos || i.nodeIdx !== null) && (Ca(i), Ps(i));
          return;
        }
        if (Yt) {
          if (l) return;
          const r = Wo(d), i = d.ctrlKey || d.metaKey;
          if (r >= 0) {
            if (i) if (ht.has(r)) {
              ht.delete(r);
              const m = Mn.findIndex((w) => w.__elemIdx === r);
              if (m >= 0) {
                const w = et();
                w == null ? void 0 : w.scene.remove(Mn[m]), Mn[m].geometry.dispose(), Mn[m].material.dispose(), Mn.splice(m, 1), w == null ? void 0 : w.render();
              }
            } else ht.add(r), Bo(r);
            else ht.clear(), wn(), ht.add(r), Bo(r);
            En();
          } else i || (ht.clear(), wn(), En());
          return;
        }
        if (nn) {
          const r = Wo(d);
      ...
      for (let p = 0; p < ke.length; p++) {
        const a = n[p * 6] || 0, c = n[p * 6 + 1] || 0, d = n[p * 6 + 2] || 0;
        l = Math.max(l, Math.sqrt(a * a + c * c + d * d));
      }
