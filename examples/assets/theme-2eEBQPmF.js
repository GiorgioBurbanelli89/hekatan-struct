let U = Object.getPrototypeOf, wt, le, ot, _t, fn = { isConnected: 1 }, Sr = 1e3, It, Lr = {}, Mr = U(fn), _n = U(U), X, wn = (n, t, e, r) => (n ?? (r ? setTimeout(e, r) : queueMicrotask(e), /* @__PURE__ */ new Set())).add(t), gn = (n, t, e) => {
  let r = ot;
  ot = t;
  try {
    return n(e);
  ...
  var _a2;
  (_a2 = ot == null ? void 0 : ot._setters) == null ? void 0 : _a2.add(this), n !== this.rawVal && (this.rawVal = n, this._bindings.length + this._listeners.length ? (le == null ? void 0 : le.add(this), wt = wn(wt, this, Ar)) : this._oldVal = n);
} }, xn = (n) => ({ __proto__: Ut, rawVal: n, _oldVal: n, _bindings: [], _listeners: [] }), gt = (n, t) => {
  let e = { _getters: /* @__PURE__ */ new Set(), _setters: /* @__PURE__ */ new Set() }, r = { f: n }, i = _t;
  _t = [];
  let s = gn(n, e, t);
  s = (s ?? document).nodeType ? s : new Text(s);
  for (let o of e._getters) e._setters.has(o) || (Cn(o), o._bindings.push(r));
  for (let o of _t) o._dom = s;
  return _t = i, r._dom = s;
}, be = (n, t = xn(), e) => {
  let r = { _getters: /* @__PURE__ */ new Set(), _setters: /* @__PURE__ */ new Set() }, i = { f: n, s: t };
  i._dom = e ?? (_t == null ? void 0 : _t.push(i)) ?? fn, t.val = gn(n, r, t.rawVal);
  for (let s of r._getters) r._setters.has(s) || (Cn(s), s._listeners.push(i));
  return t;
}, yn = (n, ...t) => {
  for (let e of t.flat(1 / 0)) {
    let r = U(e ?? 0), i = r === Ut ? gt(() => e.val) : r === _n ? gt(e) : e;
    i != X && n.append(i);
  }
  return n;
}, Pn = (n, t, ...e) => {
  var _a2;
  let [{ is: r, ...i }, ...s] = U(e[0] ?? 0) === Mr ? e : [{}, ...e], o = n ? document.createElementNS(n, t, { is: r }) : document.createElement(t, { is: r });
  for (let [a, l] of Object.entries(i)) {
    let p = (A) => A ? Object.getOwnPropertyDescriptor(A, a) ?? p(U(A)) : X, u = t + "," + a, c = Lr[u] ?? (Lr[u] = ((_a2 = p(U(o))) == null ? void 0 : _a2.set) ?? 0), S = a.startsWith("on") ? (A, rt) => {
      let $e = a.slice(2);
      o.removeEventListener($e, rt), o.addEventListener($e, A);
    } : c ? c.bind(o) : o.setAttribute.bind(o, a), Y = U(l ?? 0);
    a.startsWith("on") || Y === _n && (l = be(l), Y = Ut), Y === Ut ? gt(() => (S(l.val, l._oldVal), o)) : S(l);
  }
  return yn(o, s);
}, Ue = (n) => ({ get: (t, e) => Pn.bind(X, n, e) }), En = (n, t) => t ? t !== n && n.replaceWith(t) : n.remove(), Ar = () => {
  let n = 0, t = [...wt].filter((r) => r.rawVal !== r._oldVal);
  do {
    le = /* @__PURE__ */ new Set();
    for (let r of new Set(t.flatMap((i) => i._listeners = $t(i._listeners)))) be(r.f, r.s, r._dom), r._dom = X;
  } while (++n < 100 && (t = [...le]).length);
  let e = [...wt].filter((r) => r.rawVal !== r._oldVal);
  wt = X;
  for (let r of new Set(e.flatMap((i) => i._bindings = $t(i._bindings)))) En(r._dom, gt(r.f, r._dom)), r._dom = X;
  for (let r of e) r._oldVal = r.rawVal;
};
const il = { tags: new Proxy((n) => new Proxy(Pn, Ue(n)), Ue()), hydrate: (n, t) => En(n, gt(t, n)), add: yn, state: xn, derive: be };
...
class w {
  ...
  constructor(t) {
    var e;
    this.message = (e = Dr[t.type](t.context)) !== null && e !== void 0 ? e : "Unexpected error", this.name = this.constructor.name, this.stack = new Error(this.message).stack, this.type = t.type;
  }
  toString() {
    return this.message;
  }
...
function f(n, t) {
  ...
  return !e && !r ? new jr(n) : new Tr(n, t);
}
function Br(n) {
  return [new Rr(n), (t, e) => {
    n.setRawValue(t, e);
...
const Kr = { "**": (n, t) => Math.pow(n, t), "*": (n, t) => n * t, "/": (n, t) => n / t, "%": (n, t) => n % t, "+": (n, t) => n + t, "-": (n, t) => n - t, "<<": (n, t) => n << t, ">>": (n, t) => n >> t, ">>>": (n, t) => n >>> t, "&": (n, t) => n & t, "^": (n, t) => n ^ t, "|": (n, t) => n | t };
class zr {
  constructor(t, e, r) {
    this.left = e, this.operator = t, this.right = r;
  }
  evaluate() {
    const t = Kr[this.operator];
...
const ri = we([Zr, ti, ni]), ii = we([ri, Xr]);
function si(n, t) {
  const e = ii(n, t);
  return t += e.length, e === "" ? null : { evaluable: new Fr(e), cursor: t };
}
function oi(n, t) {
  const e = n.substr(t, 1);
...
function ai(n, t) {
  var e;
  return (e = si(n, t)) !== null && e !== void 0 ? e : oi(n, t);
}
function Vn(n, t) {
  const e = ai(n, t);
  if (e) return e;
  ...
  const i = Vn(n, t);
  return i ? (t = i.cursor, { cursor: t, evaluable: new Ur(r, i.evaluable) }) : null;
}
function li(n, t, e) {
  e += Ct(t, e).length;
...
function pi(n, t) {
  return (e, r) => {
    ...
    for (; ; ) {
      ...
      const a = n(e, r);
      if (!a) return null;
      r = a.cursor, s = new zr(o.operator, s, a.evaluable);
    }
    return s ? { cursor: r, evaluable: s } : null;
  };
}
const ci = [["**"], ["*", "/", "%"], ["+", "-"], ["<<", ">>>", ">>"], ["&"], ["^"], ["|"]].reduce((n, t) => pi(n, t), Vn);
function Sn(n, t) {
  return t += Ct(n, t).length, ci(n, t);
}
function di(n) {
  const t = Sn(n, 0);
...
function hi(n, t) {
  return b(n.step) ? Math.max(He(t), 2) : He(n.step);
}
function An(n) {
  var t;
...
function Dn(n, t) {
  return b(n.step) ? null : new Nr(n.step, t);
}
function Tn(n) {
  return !b(n.max) && !b(n.min) ? new St({ max: n.max, min: n.min }) : !b(n.max) || !b(n.min) ? new Ir({ max: n.max, min: n.min }) : null;
}
function jn(n, t) {
  var e, r, i;
  return { formatter: (e = n.format) !== null && e !== void 0 ? e : E(hi(n, t)), keyScale: (r = n.keyScale) !== null && r !== void 0 ? r : An(n), pointerScale: (i = n.pointerScale) !== null && i !== void 0 ? i : On(n, t) };
}
function Rn(n) {
...
function Ce(n) {
  return { constraint: n.constraint, textProps: d.fromObject(jn(n.params, n.initialValue)) };
}
class et {
  constructor(t) {
    this.controller = t;
...
function qe(n) {
  return { custom: (t) => j(t)(n), boolean: j((t) => typeof t == "boolean" ? t : void 0)(n), number: j((t) => typeof t == "number" ? t : void 0)(n), string: j((t) => typeof t == "string" ? t : void 0)(n), function: j((t) => typeof t == "function" ? t : void 0)(n), constant: (t) => j((e) => e === t ? t : void 0)(n), raw: j((t) => t)(n), object: (t) => j((e) => {
    if (Ci(e)) return wi(e, t);
  })(n), array: (t) => j((e) => {
    if (Array.isArray(e)) return gi(e, t);
  })(n) };
}
const ce = { optional: qe(true), required: qe(false) };
function _(n, t) {
...
function V(n, t) {
  var e;
  return Z((e = n == null ? void 0 : n()) !== null && e !== void 0 ? e : {}, t);
}
function Q(n) {
  return "value" in n;
}
...
const ki = { check: '<path d="M2 8l4 4l8 -8"/>', dropdown: '<path d="M5 7h6l-3 3 z"/>', p2dpad: '<path d="M8 4v8"/><path d="M4 8h8"/><circle cx="12" cy="12" r="1.2"/>' };
function Qt(n, t) {
...
const Si = "tp";
function h(n) {
  return (e, r) => [Si, "-", n, "v", e ? `_${e}` : "", r ? `-${r}` : ""].join("");
}
const vt = h("lbl");
function Li(n, t) {
...
class Kn {
  constructor(t, e) {
    ...
    r.classList.add(vt("l")), D(e.props, "label", (s) => {
      b(s) ? this.element.classList.add(vt(void 0, "nol")) : (this.element.classList.remove(vt(void 0, "nol")), Vi(r), r.appendChild(Li(t, s)));
...
class zn {
  constructor(t, e) {
    this.props = e.props, this.valueController = e.valueController, this.viewProps = e.valueController.viewProps, this.view = new Kn(t, { props: e.props, viewProps: this.viewProps }), this.view.valueElement.appendChild(this.valueController.view.element);
  }
  importProps(t) {
...
const Ge = h(""), Ye = { veryfirst: "vfst", first: "fst", last: "lst", verylast: "vlst" };
class Zt {
  constructor(t) {
    ...
    this.blade.value("positions").emitter.on("change", () => {
      Mi().forEach((r) => {
        e.classList.remove(Ge(void 0, Ye[r]));
      }), this.blade.get("positions").forEach((r) => {
        e.classList.add(Ge(void 0, Ye[r]));
      });
...
class J extends Zt {
  constructor(t, e) {
    ...
    const r = e.valueController.viewProps, i = new zn(t, { blade: e.blade, props: e.props, valueController: e.valueController });
    super(Object.assign(Object.assign({}, e), { view: new Kn(t, { props: e.props, viewProps: r }), viewProps: r })), this.labelController = i, this.value = e.value, this.valueController = e.valueController, this.view.valueElement.appendChild(this.valueController.view.element);
  }
  importState(t) {
    return k(t, (e) => {
      var r, i, s;
  ...
  exportState() {
    var t, e, r;
    return V(() => super.exportState(), Object.assign(Object.assign({ value: this.value.rawValue }, this.labelController.exportProps()), (r = (e = (t = this.valueController).exportProps) === null || e === void 0 ? void 0 : e.call(t)) !== null && r !== void 0 ? r : {}));
  }
}
function We(n) {
...
class $n extends J {
  ...
  importState(t) {
    return k(t, (e) => super.importState(We(t)), (e) => ({ tag: e.optional.string }), (e) => (this.tag = e.tag, true));
  }
  exportState() {
    return V(() => We(super.exportState()), { binding: { key: this.value.binding.target.key, value: this.value.binding.target.read() }, tag: this.tag });
  }
}
function Ai(n) {
  return Q(n) && Bn(n.value);
}
class Oi extends $n {
  importState(t) {
...
function Ri(n, t) {
  const e = [...ji(n), t];
  return e.length > n.length ? e.splice(0, e.length - n.length) : Un(e, n.length), e;
}
class Bi {
  constructor(t) {
    this.emitter = new g(), this.onTick_ = this.onTick_.bind(this), this.onValueBeforeChange_ = this.onValueBeforeChange_.bind(this), this.onValueChange_ = this.onValueChange_.bind(this), this.binding = t.binding, this.value_ = f(Ti(t.bufferSize)), this.value_.emitter.on("beforechange", this.onValueBeforeChange_), this.value_.emitter.on("change", this.onValueChange_), this.ticker = t.ticker, this.ticker.emitter.on("tick", this.onTick_), this.fetch();
  }
  get rawValue() {
    return this.value_.rawValue;
  }
  ...
  fetch() {
    this.value_.rawValue = Ri(this.value_.rawValue, this.binding.read());
  }
  onTick_() {
    this.fetch();
  }
...
class Ui {
  constructor(t, e) {
    this.emitter = new g(), this.onClick_ = this.onClick_.bind(this), this.props = e.props, this.viewProps = e.viewProps, this.view = new $i(t, { props: this.props, viewProps: this.viewProps }), this.view.buttonElement.addEventListener("click", this.onClick_);
  }
  importProps(t) {
...
class Xe extends Zt {
  constructor(t, e) {
    const r = new Ui(t, { props: e.buttonProps, viewProps: e.viewProps }), i = new zn(t, { blade: e.blade, props: e.labelProps, valueController: r });
...
const dt = new Hn("2.0.5");
function y(n) {
  return Object.assign({ core: dt }, n);
}
const Hi = y({ id: "button", type: "blade", accept(n) {
  const t = _(n, (e) => ({ title: e.required.string, view: e.required.constant("button"), label: e.optional.string }));
  return t ? { params: t } : null;
}, controller(n) {
  return new Xe(n.document, { blade: n.blade, buttonProps: d.fromObject({ title: n.params.title }), labelProps: d.fromObject({ label: n.params.label }), viewProps: n.viewProps });
}, api(n) {
  return n.controller instanceof Xe ? new Ki(n.controller) : null;
} });
function qi(n, t) {
...
class Qi {
  ...
  addBinding(t, e, r) {
    const i = r ?? {}, s = this.controller_.element.ownerDocument, o = this.pool_.createBinding(s, Xi(t, e), i), a = this.pool_.createBindingApi(o);
  ...
  onRackValueChange_(t) {
    const e = t.bladeController, r = this.pool_.createApi(e), i = Bn(e.value) ? e.value.binding : null;
    this.emitter_.emit("change", new Lt(r, i ? i.target.read() : e.value.rawValue, t.options.last));
  }
}
class Ee extends et {
  constructor(t, e) {
    super(t), this.rackApi_ = new Qi(t.rackController, e);
  }
  refresh() {
...
class ke extends Zt {
  ...
  importState(t) {
    return k(t, (e) => super.importState(e), (e) => ({ children: e.required.array(e.required.raw) }), (e) => this.rackController.rack.children.every((r, i) => r.importState(e.children[i])));
  }
  exportState() {
...
class es {
  ...
  onSetAdd_(t) {
    ...
    const r = t.item;
    if (r.viewProps.emitter.on("change", this.onChildViewPropsChange_), r.blade.value("positions").emitter.on("change", this.onChildPositionsChange_), r.viewProps.handleDispose(this.onChildDispose_), Q(r)) r.value.emitter.on("change", this.onChildValueChange_);
    else if (de(r)) {
  ...
  onSetRemove_(t) {
    ...
    const r = t.item;
    if (Q(r)) r.value.emitter.off("change", this.onChildValueChange_);
    else if (de(r)) {
      const i = r.rackController.rack;
      if (i) {
        const s = i.emitter;
  ...
  onChildValueChange_(t) {
    const e = Ji(this.find(Q), t.sender);
...
class Ve {
  constructor(t) {
    ...
    const e = new es({ blade: t.root ? void 0 : t.blade, viewProps: t.viewProps });
  ...
  onRackAdd_(t) {
    t.root && In(this.element, t.bladeController.view.element, t.index);
  }
  onRackRemove_(t) {
...
function ut() {
  return new d({ positions: f([], { equals: Or }) });
}
class Mt extends d {
  constructor(t) {
    super(t);
  ...
  static create(t) {
    const e = { completed: true, expanded: t, expandedHeight: null, shouldFixHeight: false, temporaryExpanded: null }, r = d.createCore(e);
    return new Mt(r);
  }
  get styleExpanded() {
    var t;
  ...
  bindExpandedClass(t, e) {
    ...
    D(this, "expanded", r), D(this, "temporaryExpanded", r);
  }
  cleanUpTransition() {
...
function Se(n, t) {
  n.value("expanded").emitter.on("beforechange", () => {
    ...
    Qe(n, t);
  }), Qe(n, t), t.addEventListener("transitionend", (e) => {
...
class qn extends Ee {
  constructor(t, e) {
    super(t, e), this.emitter_ = new g(), this.controller.foldable.value("expanded").emitter.on("change", (r) => {
      this.emitter_.emit("fold", new vi(this, r.sender.rawValue));
...
class rs {
  constructor(t, e) {
    var r;
    this.className_ = h((r = e.viewName) !== null && r !== void 0 ? r : "fld"), this.element = t.createElement("div"), this.element.classList.add(this.className_(), Gn()), e.viewProps.bindClassModifiers(this.element), this.foldable_ = e.foldable, this.foldable_.bindExpandedClass(this.element, this.className_(void 0, "expanded")), D(this.foldable_, "completed", ct(this.element, this.className_(void 0, "cpl")));
    const i = t.createElement("button");
    i.classList.add(this.className_("b")), D(e.props, "title", (p) => {
...
class ue extends ke {
  constructor(t, e) {
    var r;
    const i = Mt.create((r = e.expanded) !== null && r !== void 0 ? r : true), s = new rs(t, { foldable: i, props: e.props, viewName: e.root ? "rot" : void 0, viewProps: e.viewProps });
...
const is = y({ id: "folder", type: "blade", accept(n) {
  const t = _(n, (e) => ({ title: e.required.string, view: e.required.constant("folder"), expanded: e.optional.boolean }));
  return t ? { params: t } : null;
}, controller(n) {
  return new ue(n.document, { blade: n.blade, expanded: n.params.expanded, props: d.fromObject({ title: n.params.title }), viewProps: n.viewProps });
}, api(n) {
  return n.controller instanceof ue ? new qn(n.controller, n.pool) : null;
} }), ss = h("");
function Ze(n, t) {
  return ct(n, ss(void 0, t));
}
class F extends d {
  constructor(t) {
    var e;
    super(t), this.onDisabledChange_ = this.onDisabledChange_.bind(this), this.onParentChange_ = this.onParentChange_.bind(this), this.onParentGlobalDisabledChange_ = this.onParentGlobalDisabledChange_.bind(this), [this.globalDisabled_, this.setGlobalDisabled_] = Br(f(this.getGlobalDisabled_())), this.value("disabled").emitter.on("change", this.onDisabledChange_), this.value("parent").emitter.on("change", this.onParentChange_), (e = this.get("parent")) === null || e === void 0 || e.globalDisabled.emitter.on("change", this.onParentGlobalDisabledChange_);
  }
  static create(t) {
    var e, r, i;
    const s = t ?? {};
    return new F(d.createCore({ disabled: (e = s.disabled) !== null && e !== void 0 ? e : false, disposed: false, hidden: (r = s.hidden) !== null && r !== void 0 ? r : false, parent: (i = s.parent) !== null && i !== void 0 ? i : null }));
  }
  get globalDisabled() {
    return this.globalDisabled_;
  }
  bindClassModifiers(t) {
    B(this.globalDisabled_, Ze(t, "disabled")), D(this, "hidden", Ze(t, "hidden"));
  }
  bindDisabled(t) {
...
class os {
  constructor(t, e) {
    ...
    const r = t.createElement("div");
    r.classList.add(Je("c")), this.element.appendChild(r), this.containerElement = r;
  }
}
const mt = h("tbi");
class as {
  constructor(t, e) {
    this.element = t.createElement("div"), this.element.classList.add(mt()), e.viewProps.bindClassModifiers(this.element), D(e.props, "selected", (s) => {
...
class ls {
  constructor(t, e) {
    this.emitter = new g(), this.onClick_ = this.onClick_.bind(this), this.props = e.props, this.viewProps = e.viewProps, this.view = new as(t, { props: e.props, viewProps: e.viewProps }), this.view.buttonElement.addEventListener("click", this.onClick_);
  }
  onClick_() {
...
class he extends ke {
  constructor(t, e) {
    const r = new os(t, { viewProps: e.viewProps });
    super(Object.assign(Object.assign({}, e), { rackController: new Ve({ blade: e.blade, element: r.containerElement, viewProps: e.viewProps }), view: r })), this.onItemClick_ = this.onItemClick_.bind(this), this.ic_ = new ls(t, { props: e.itemProps, viewProps: F.create() }), this.ic_.emitter.on("click", this.onItemClick_), this.props = e.props, D(this.props, "selected", (i) => {
...
class ps extends Ee {
  ...
  addPage(t) {
    const e = this.controller.view.element.ownerDocument, r = new he(e, { blade: ut(), itemProps: d.fromObject({ selected: false, title: t.title }), props: d.fromObject({ selected: false }), viewProps: F.create() }), i = this.pool_.createApi(r);
  ...
  onSelect_(t) {
    this.emitter_.emit("select", new mi(this, t.rawValue));
  }
}
class cs extends Ee {
  get title() {
...
class ds {
  constructor() {
    this.onItemSelectedChange_ = this.onItemSelectedChange_.bind(this), this.empty = f(true), this.selectedIndex = f(tn), this.items_ = [];
  }
  add(t, e) {
  ...
  keepSelection_() {
    if (this.items_.length === 0) {
      this.selectedIndex.rawValue = tn, this.empty.rawValue = true;
      return;
    }
...
class us {
  constructor(t, e) {
    this.element = t.createElement("div"), this.element.classList.add(bt(), Gn()), e.viewProps.bindClassModifiers(this.element), B(e.empty, ct(this.element, bt(void 0, "nop")));
    const r = t.createElement("div");
...
class en extends ke {
  constructor(t, e) {
    const r = new ds(), i = new us(t, { empty: r.empty, viewProps: e.viewProps });
  ...
  onRackAdd_(t) {
    ...
    In(this.view.itemsElement, e.itemController.view.element, t.index), e.itemController.viewProps.set("parent", this.viewProps), this.tab.add(e.props.value("selected"));
  }
  onRackRemove_(t) {
    if (!t.root) return;
    const e = t.bladeController;
...
const Yn = y({ id: "tab", type: "blade", accept(n) {
  ...
  const t = new en(n.document, { blade: n.blade, viewProps: n.viewProps });
  return n.params.pages.forEach((e) => {
    const r = new he(n.document, { blade: ut(), itemProps: d.fromObject({ selected: false, title: e.title }), props: d.fromObject({ selected: false }), viewProps: F.create() });
    t.add(r);
  }), t;
}, api(n) {
  return n.controller instanceof en ? new ps(n.controller, n.pool) : n.controller instanceof he ? new cs(n.controller, n.pool) : null;
} });
function hs(n, t) {
...
class bs {
  constructor(t, e) {
    ...
    const i = t.createElement("div");
    i.classList.add(ee("m")), i.appendChild(Qt(t, "dropdown")), this.element.appendChild(i), e.value.emitter.on("change", this.onValueChange_), this.value_ = e.value, D(this.props_, "options", (s) => {
      Nn(this.selectElement), s.forEach((o) => {
...
class G {
  constructor(t, e) {
    this.onSelectChange_ = this.onSelectChange_.bind(this), this.props = e.props, this.value = e.value, this.viewProps = e.viewProps, this.view = new bs(t, { props: this.props, value: this.value, viewProps: this.viewProps }), this.view.selectElement.addEventListener("change", this.onSelectChange_);
  }
  onSelectChange_(t) {
  ...
  importProps(t) {
    return k(t, null, (e) => ({ options: e.required.custom(Dt) }), (e) => (this.props.set("options", Me(e.options)), true));
  }
  exportProps() {
...
class fs {
  constructor(t, e) {
    this.element = t.createElement("div"), this.element.classList.add(nn()), e.viewProps.bindClassModifiers(this.element), B(e.shows, ct(this.element, nn(void 0, "v")));
  }
}
class Wn {
  constructor(t, e) {
    this.shows = f(false), this.viewProps = e.viewProps, this.view = new fs(t, { shows: this.shows, viewProps: this.viewProps });
  }
}
const rn = h("txt");
class _s {
  constructor(t, e) {
    this.onChange_ = this.onChange_.bind(this), this.element = t.createElement("div"), this.element.classList.add(rn()), e.viewProps.bindClassModifiers(this.element), this.props_ = e.props, this.props_.emitter.on("change", this.onChange_);
    const r = t.createElement("input");
    r.classList.add(rn("i")), r.type = "text", e.viewProps.bindDisabled(r), this.element.appendChild(r), this.inputElement = r, e.value.emitter.on("change", this.onChange_), this.value_ = e.value, this.refresh();
  }
  refresh() {
...
class Pt {
  constructor(t, e) {
    this.onInputChange_ = this.onInputChange_.bind(this), this.parser_ = e.parser, this.props = e.props, this.value = e.value, this.viewProps = e.viewProps, this.view = new _s(t, { props: e.props, value: this.value, viewProps: this.viewProps }), this.view.inputElement.addEventListener("change", this.onInputChange_);
  }
  onInputChange_(t) {
...
function Zn(n) {
  return xs(n) || n === "ArrowLeft" || n === "ArrowRight";
}
function ne(n, t) {
  var e, r;
...
class Es {
  constructor(t, e) {
    this.onKeyDown_ = this.onKeyDown_.bind(this), this.onKeyUp_ = this.onKeyUp_.bind(this), this.onPointerDownOrMove_ = this.onPointerDownOrMove_.bind(this), this.onPointerUp_ = this.onPointerUp_.bind(this), this.value = e.value, this.viewProps = e.viewProps, this.props = e.props, this.view = new Ps(t, { props: this.props, value: this.value, viewProps: this.viewProps }), this.ptHandler_ = new nt(this.view.trackElement), this.ptHandler_.emitter.on("down", this.onPointerDownOrMove_), this.ptHandler_.emitter.on("move", this.onPointerDownOrMove_), this.ptHandler_.emitter.on("up", this.onPointerUp_), this.view.trackElement.addEventListener("keydown", this.onKeyDown_), this.view.trackElement.addEventListener("keyup", this.onKeyUp_);
  }
...
class Wt {
  constructor(t, e) {
    this.value = e.value, this.viewProps = e.viewProps, this.sliderC_ = new Es(t, { props: e.sliderProps, value: e.value, viewProps: this.viewProps }), this.textC_ = new Tt(t, { parser: e.parser, props: e.textProps, sliderProps: e.sliderProps, value: e.value, viewProps: e.viewProps }), this.view = new ks(t, { sliderView: this.sliderC_.view, textView: this.textC_.view });
  }
...
const Vs = { containerUnitSize: "cnt-usz" };
function tr(n) {
  return `--${Vs[n]}`;
}
function kt(n) {
...
class Ms {
  constructor(t, e) {
    this.onInputChange_ = this.onInputChange_.bind(this), this.onLabelMouseDown_ = this.onLabelMouseDown_.bind(this), this.value = e.value, this.viewProps = e.viewProps, this.view = new Ls(t, { value: this.value, viewProps: this.viewProps }), this.view.inputElement.addEventListener("change", this.onInputChange_), this.view.labelElement.addEventListener("mousedown", this.onLabelMouseDown_);
  }
  onInputChange_(t) {
    const e = t.currentTarget;
...
const Os = y({ id: "input-bool", type: "input", accept: (n, t) => {
...
}, binding: { reader: (n) => Xn, constraint: (n) => As(n.params), writer: (n) => jt }, controller: (n) => {
  const t = n.document, e = n.value, r = n.constraint, i = r && Gt(r, Ot);
  return i ? new G(t, { props: new d({ options: i.values.value("options") }), value: e, viewProps: n.viewProps }) : new Ms(t, { value: e, viewProps: n.viewProps });
}, api(n) {
...
class Ds {
  constructor(t, e) {
    this.element = t.createElement("div"), this.element.classList.add(W()), e.foldable.bindExpandedClass(this.element, W(void 0, "expanded")), D(e.foldable, "completed", ct(this.element, W(void 0, "cpl")));
    const r = t.createElement("div");
    r.classList.add(W("h")), this.element.appendChild(r);
    const i = t.createElement("div");
    i.classList.add(W("s")), r.appendChild(i), this.swatchElement = i;
    const s = t.createElement("div");
    if (s.classList.add(W("t")), r.appendChild(s), this.textElement = s, e.pickerLayout === "inline") {
      const o = t.createElement("div");
...
function Ts(n, t, e) {
  ...
  let p = 0, u = 0;
  const c = (a + o) / 2;
  return l !== 0 && (u = l / (1 - Math.abs(o + a - 1)), r === o ? p = (i - s) / l : i === o ? p = 2 + (s - r) / l : p = 4 + (r - i) / l, p = p / 6 + (p < 0 ? 1 : 0)), [p * 360, u * 100, c * 100];
}
function js(n, t, e) {
  const r = (n % 360 + 360) % 360, i = C(t / 100, 0, 1), s = C(e / 100, 0, 1), o = (1 - Math.abs(2 * s - 1)) * i, a = o * (1 - Math.abs(r / 60 % 2 - 1)), l = s - o / 2;
  let p, u, c;
  return r >= 0 && r < 60 ? [p, u, c] = [o, a, 0] : r >= 60 && r < 120 ? [p, u, c] = [a, o, 0] : r >= 120 && r < 180 ? [p, u, c] = [0, o, a] : r >= 180 && r < 240 ? [p, u, c] = [0, a, o] : r >= 240 && r < 300 ? [p, u, c] = [a, 0, o] : [p, u, c] = [o, 0, a], [(p + l) * 255, (u + l) * 255, (c + l) * 255];
}
function Rs(n, t, e) {
  const r = C(n / 255, 0, 1), i = C(t / 255, 0, 1), s = C(e / 255, 0, 1), o = Math.max(r, i, s), a = Math.min(r, i, s), l = o - a;
  let p;
  l === 0 ? p = 0 : o === r ? p = 60 * (((i - s) / l % 6 + 6) % 6) : o === i ? p = 60 * ((s - r) / l + 2) : p = 60 * ((r - i) / l + 4);
  const u = o === 0 ? 0 : l / o, c = o;
  return [p, u * 100, c * 100];
}
function nr(n, t, e) {
  const r = Mn(n, 360), i = C(t / 100, 0, 1), s = C(e / 100, 0, 1), o = s * i, a = o * (1 - Math.abs(r / 60 % 2 - 1)), l = s - o;
  let p, u, c;
  return r >= 0 && r < 60 ? [p, u, c] = [o, a, 0] : r >= 60 && r < 120 ? [p, u, c] = [a, o, 0] : r >= 120 && r < 180 ? [p, u, c] = [0, o, a] : r >= 180 && r < 240 ? [p, u, c] = [0, a, o] : r >= 240 && r < 300 ? [p, u, c] = [a, 0, o] : [p, u, c] = [o, 0, a], [(p + l) * 255, (u + l) * 255, (c + l) * 255];
}
function Bs(n, t, e) {
...
const Ns = { hsl: { hsl: (n, t, e) => [n, t, e], hsv: Bs, rgb: js }, hsv: { hsl: Is, hsv: (n, t, e) => [n, t, e], rgb: nr }, rgb: { hsl: Ts, hsv: Rs, rgb: (n, t, e) => [n, t, e] } };
function pt(n, t) {
...
function rr(n, t, e) {
  var r;
  const i = pt(t, e);
  return [t === "rgb" ? C(n[0], 0, i[0]) : Fs(n[0], i[0]), C(n[1], 0, i[1]), C(n[2], 0, i[2]), C((r = n[3]) !== null && r !== void 0 ? r : 1, 0, 1)];
}
function on(n, t, e, r) {
...
function ir(n, t, e) {
  const r = on(n, t.mode, t.type, "int"), i = Ns[t.mode][e.mode](...r);
  return on(i, e.mode, "int", e.type);
}
class v {
  static black() {
  ...
  constructor(t, e) {
    this.type = "int", this.mode = e, this.comps_ = rr(t, e, this.type);
  }
  getComponents(t) {
    return Jt(ir(T(this.comps_), { mode: this.mode, type: this.type }, { mode: t ?? this.mode, type: this.type }), this.comps_[3]);
  }
  toRgbaObject() {
...
function Oe(n) {
  return _(n, (t) => ({ color: t.optional.object({ alpha: t.optional.boolean, type: t.optional.custom(zs) }), expanded: t.optional.boolean, picker: t.optional.custom(er), readonly: t.optional.constant(false) }));
}
function tt(n) {
  return n ? 0.1 : 1;
}
...
class De {
  constructor(t, e) {
    this.type = "float", this.mode = e, this.comps_ = rr(t, e, this.type);
  }
  getComponents(t) {
    return Jt(ir(T(this.comps_), { mode: this.mode, type: this.type }, { mode: t ?? this.mode, type: this.type }), this.comps_[3]);
  }
...
const $s = { int: (n, t) => new v(n, t), float: (n, t) => new De(n, t) };
function Te(n, t, e) {
  return $s[e](n, t);
}
function Us(n) {
...
function x(n, t) {
  ...
  if (Hs(n) && t === "float") return Gs(n);
  if (Us(n) && t === "int") return qs(n);
...
const Ws = { deg: (n) => n, grad: (n) => n * 360 / 400, rad: (n) => n * 360 / (2 * Math.PI), turn: (n) => n * 360 };
function or(n) {
...
function pr(n) {
  ...
  if (!t) return null;
  const e = [or(t[1]), M(t[2], 100), M(t[3], 100)];
  return isNaN(e[0]) || isNaN(e[1]) || isNaN(e[2]) ? null : e;
}
function Zs(n) {
  const t = pr(n);
...
function cr(n) {
  ...
  if (!t) return null;
  const e = [or(t[1]), M(t[2], 100), M(t[3], 100), M(t[4], 1)];
  return isNaN(e[0]) || isNaN(e[1]) || isNaN(e[2]) || isNaN(e[3]) ? null : e;
}
function Js(n) {
  const t = cr(n);
...
const io = [{ parser: dr, result: { alpha: false, mode: "rgb", notation: "hex" } }, { parser: ur, result: { alpha: true, mode: "rgb", notation: "hex" } }, { parser: ar, result: { alpha: false, mode: "rgb", notation: "func" } }, { parser: lr, result: { alpha: true, mode: "rgb", notation: "func" } }, { parser: pr, result: { alpha: false, mode: "hsl", notation: "func" } }, { parser: cr, result: { alpha: true, mode: "hsl", notation: "func" } }, { parser: hr, result: { alpha: false, mode: "rgb", notation: "object" } }, { parser: vr, result: { alpha: true, mode: "rgb", notation: "object" } }];
function so(n) {
  return io.reduce((t, { parser: e, result: r }) => t || (e(n) ? r : null), null);
}
function oo(n, t = "int") {
  const e = so(n);
...
function Rt(n) {
  const t = [to, eo, Xs, Qs, Zs, Js];
  t.push(no("int"), ro("int"));
  const e = gs(t);
  return (r) => {
    const i = e(r);
    return i ? x(i, n) : null;
...
function je(n, t = "#") {
  const e = T(n.getComponents("rgb")).map(mr).join("");
  return `${t}${e}`;
}
function Re(n, t = "#") {
  const e = n.getComponents("rgb"), r = [e[0], e[1], e[2], e[3] * 255].map(mr).join("");
  return `${t}${r}`;
}
function br(n) {
  const t = E(0), e = x(n, "int");
  return `rgb(${T(e.getComponents("rgb")).map((i) => t(i)).join(", ")})`;
}
function Ft(n) {
  const t = E(2), e = E(0);
...
function lo(n) {
  ...
  return `hsl(${T(e.getComponents("hsl")).map((i, s) => t[s](i)).join(", ")})`;
}
function po(n) {
...
function fr(n, t) {
  ...
  return `{${T(i.getComponents("rgb")).map((o, a) => `${r[a]}: ${e(o)}`).join(", ")}}`;
}
function co(n) {
  return (t) => fr(t, n);
}
...
const ho = [{ format: { alpha: false, mode: "rgb", notation: "hex", type: "int" }, stringifier: je }, { format: { alpha: true, mode: "rgb", notation: "hex", type: "int" }, stringifier: Re }, { format: { alpha: false, mode: "rgb", notation: "func", type: "int" }, stringifier: br }, { format: { alpha: true, mode: "rgb", notation: "func", type: "int" }, stringifier: Ft }, { format: { alpha: false, mode: "hsl", notation: "func", type: "int" }, stringifier: lo }, { format: { alpha: true, mode: "hsl", notation: "func", type: "int" }, stringifier: po }, ...["int", "float"].reduce((n, t) => [...n, { format: { alpha: false, mode: "rgb", notation: "object", type: t }, stringifier: co(t) }, { format: { alpha: true, mode: "rgb", notation: "object", type: t }, stringifier: uo(t) }], [])];
function wr(n) {
  return ho.reduce((t, e) => t || (Ys(e.format, n) ? e.stringifier : null), null);
}
const ft = h("apl");
class vo {
  constructor(t, e) {
...
class mo {
  constructor(t, e) {
    this.onKeyDown_ = this.onKeyDown_.bind(this), this.onKeyUp_ = this.onKeyUp_.bind(this), this.onPointerDown_ = this.onPointerDown_.bind(this), this.onPointerMove_ = this.onPointerMove_.bind(this), this.onPointerUp_ = this.onPointerUp_.bind(this), this.value = e.value, this.viewProps = e.viewProps, this.view = new vo(t, { value: this.value, viewProps: this.viewProps }), this.ptHandler_ = new nt(this.view.element), this.ptHandler_.emitter.on("down", this.onPointerDown_), this.ptHandler_.emitter.on("move", this.onPointerMove_), this.ptHandler_.emitter.on("up", this.onPointerUp_), this.view.element.addEventListener("keydown", this.onKeyDown_), this.view.element.addEventListener("keyup", this.onKeyUp_);
  }
  handlePointerEvent_(t, e) {
    if (!t.point) return;
  ...
  onKeyUp_(t) {
    P(tt(true), N(t)) !== 0 && this.value.setRawValue(this.value.rawValue, { forceEmit: true, last: true });
  }
}
const it = h("coltxt");
function bo(n) {
...
class fo {
  constructor(t, e) {
    ...
    const r = t.createElement("div");
    r.classList.add(it("m")), this.modeElem_ = bo(t), this.modeElem_.classList.add(it("ms")), r.appendChild(this.modeSelectElement), e.viewProps.bindDisabled(this.modeElem_);
    const i = t.createElement("div");
...
function go(n, t, e) {
  return new Tt(n, { arrayPosition: e === 0 ? "fst" : e === 2 ? "lst" : "mid", parser: t.parser, props: d.fromObject({ formatter: _o(t.colorType), keyScale: tt(false), pointerScale: t.colorType === "float" ? 0.01 : 1 }), value: f(0, { constraint: wo(t.colorMode, t.colorType, e) }), viewProps: t.viewProps });
}
function Co(n, t) {
  ...
  return [0, 1, 2].map((r) => {
    ...
    return ht({ primary: t.value, secondary: i.value, forward(s) {
      ...
      p[r] = o;
      const u = Te(Jt(T(p), p[3]), a, t.colorType);
      return x(u, "int");
    } }), i;
  });
}
function xo(n, t) {
  const e = new Pt(n, { parser: Rt("int"), props: d.fromObject({ formatter: je }), value: f(v.black()), viewProps: t.viewProps });
  return ht({ primary: t.value, secondary: e.value, forward: (r) => new v(T(r.getComponents()), r.mode), backward: (r, i) => new v(Jt(T(i.getComponents(r.mode)), r.getComponents()[3]), r.mode) }), [e];
}
function yo(n) {
  return n !== "hex";
}
class Po {
  constructor(t, e) {
    this.onModeSelectChange_ = this.onModeSelectChange_.bind(this), this.colorType_ = e.colorType, this.value = e.value, this.viewProps = e.viewProps, this.colorMode = f(this.value.rawValue.mode), this.ccs_ = this.createComponentControllers_(t), this.view = new fo(t, { mode: this.colorMode, inputViews: [this.ccs_[0].view, this.ccs_[1].view, this.ccs_[2].view], viewProps: this.viewProps }), this.view.modeSelectElement.addEventListener("change", this.onModeSelectChange_);
  }
  createComponentControllers_(t) {
    const e = this.colorMode.rawValue;
    return yo(e) ? Co(t, { colorMode: e, colorType: this.colorType_, value: this.value, viewProps: this.viewProps }) : xo(t, { value: this.value, viewProps: this.viewProps });
  }
...
class Eo {
  ...
  update_() {
    ...
    this.markerElem_.style.backgroundColor = br(new v([e, 100, 100], "hsv"));
...
class ko {
  constructor(t, e) {
    this.onKeyDown_ = this.onKeyDown_.bind(this), this.onKeyUp_ = this.onKeyUp_.bind(this), this.onPointerDown_ = this.onPointerDown_.bind(this), this.onPointerMove_ = this.onPointerMove_.bind(this), this.onPointerUp_ = this.onPointerUp_.bind(this), this.value = e.value, this.viewProps = e.viewProps, this.view = new Eo(t, { value: this.value, viewProps: this.viewProps }), this.ptHandler_ = new nt(this.view.element), this.ptHandler_.emitter.on("down", this.onPointerDown_), this.ptHandler_.emitter.on("move", this.onPointerMove_), this.ptHandler_.emitter.on("up", this.onPointerUp_), this.view.element.addEventListener("keydown", this.onKeyDown_), this.view.element.addEventListener("keyup", this.onKeyUp_);
  }
  handlePointerEvent_(t, e) {
    if (!t.point) return;
  ...
  onKeyDown_(t) {
    const e = P(tt(false), N(t));
    if (e === 0) return;
    const r = this.value.rawValue, [i, s, o, a] = r.getComponents("hsv");
    this.value.setRawValue(new v([i + e, s, o, a], "hsv"), { forceEmit: false, last: false });
  }
  onKeyUp_(t) {
    P(tt(false), N(t)) !== 0 && this.value.setRawValue(this.value.rawValue, { forceEmit: true, last: true });
  }
}
const oe = h("svp"), an = 64;
class Vo {
  constructor(t, e) {
    ...
    r.height = an, r.width = an, r.classList.add(oe("c")), this.element.appendChild(r), this.canvasElement = r;
    const i = t.createElement("div");
  ...
  update_() {
    ...
    for (let u = 0; u < s; u++) for (let c = 0; c < i; c++) {
      const S = m(c, 0, i, 0, 100), Y = m(u, 0, s, 100, 0), A = nr(r[0], S, Y), rt = (u * i + c) * 4;
      a[rt] = A[0], a[rt + 1] = A[1], a[rt + 2] = A[2], a[rt + 3] = 255;
    }
...
class So {
  ...
  onKeyDown_(t) {
    Zn(t.key) && t.preventDefault();
    const [e, r, i, s] = this.value.rawValue.getComponents("hsv"), o = tt(false), a = P(o, N(t)), l = P(o, Et(t));
    a === 0 && l === 0 || this.value.setRawValue(new v([e, r + a, i + l, s], "hsv"), { forceEmit: false, last: false });
  }
  onKeyUp_(t) {
    const e = tt(false), r = P(e, N(t)), i = P(e, Et(t));
    r === 0 && i === 0 || this.value.setRawValue(this.value.rawValue, { forceEmit: true, last: true });
  }
}
class Lo {
  constructor(t, e) {
    this.value = e.value, this.viewProps = e.viewProps, this.hPaletteC_ = new ko(t, { value: this.value, viewProps: this.viewProps }), this.svPaletteC_ = new So(t, { value: this.value, viewProps: this.viewProps }), this.alphaIcs_ = e.supportsAlpha ? { palette: new mo(t, { value: this.value, viewProps: this.viewProps }), text: new Tt(t, { parser: I, props: d.fromObject({ pointerScale: 0.01, keyScale: 0.1, formatter: E(2) }), value: f(0, { constraint: new St({ min: 0, max: 1 }) }), viewProps: this.viewProps }) } : null, this.alphaIcs_ && ht({ primary: this.value, secondary: this.alphaIcs_.text.value, forward: (r) => r.getComponents()[3], backward: (r, i) => {
      const s = r.getComponents();
      return s[3] = i, new v(s, r.mode);
    } }), this.textsC_ = new Po(t, { colorType: e.colorType, value: this.value, viewProps: this.viewProps }), this.view = new Ks(t, { alphaViews: this.alphaIcs_ ? { palette: this.alphaIcs_.palette.view, text: this.alphaIcs_.text.view } : null, hPaletteView: this.hPaletteC_.view, supportsAlpha: e.supportsAlpha, svPaletteView: this.svPaletteC_.view, textsView: this.textsC_.view, viewProps: this.viewProps });
  }
  get textsController() {
    return this.textsC_;
  }
...
class Ao {
  constructor(t, e) {
    this.value = e.value, this.viewProps = e.viewProps, this.view = new Mo(t, { value: this.value, viewProps: this.viewProps });
  }
}
class Be {
  constructor(t, e) {
    this.onButtonBlur_ = this.onButtonBlur_.bind(this), this.onButtonClick_ = this.onButtonClick_.bind(this), this.onPopupChildBlur_ = this.onPopupChildBlur_.bind(this), this.onPopupChildKeydown_ = this.onPopupChildKeydown_.bind(this), this.value = e.value, this.viewProps = e.viewProps, this.foldable_ = Mt.create(e.expanded), this.swatchC_ = new Ao(t, { value: this.value, viewProps: this.viewProps });
    const r = this.swatchC_.view.buttonElement;
    r.addEventListener("blur", this.onButtonBlur_), r.addEventListener("click", this.onButtonClick_), this.textC_ = new Pt(t, { parser: e.parser, props: d.fromObject({ formatter: e.formatter }), value: this.value, viewProps: this.viewProps }), this.view = new Ds(t, { foldable: this.foldable_, pickerLayout: e.pickerLayout }), this.view.swatchElement.appendChild(this.swatchC_.view.element), this.view.textElement.appendChild(this.textC_.view.element), this.popC_ = e.pickerLayout === "popup" ? new Wn(t, { viewProps: this.viewProps }) : null;
    const i = new Lo(t, { colorType: e.colorType, supportsAlpha: e.supportsAlpha, value: this.value, viewProps: this.viewProps });
  ...
  onPopupChildBlur_(t) {
    if (!this.popC_) return;
    const e = this.popC_.view.element, r = Fn(t);
...
function Oo(n) {
  return T(n.getComponents("rgb")).reduce((t, e) => t << 8 | Math.floor(e) & 255, 0);
}
function Do(n) {
...
function Bo(n) {
  return typeof n != "number" ? v.black() : jo(n);
}
function Kt(n, t) {
...
const qo = y({ id: "input-color-number", type: "input", accept: (n, t) => {
  if (typeof n != "number" || !Ho(t)) return null;
  const e = Oe(t);
  return e ? { initialValue: n, params: Object.assign(Object.assign({}, e), { supportsAlpha: $o(t) }) } : null;
}, binding: { reader: (n) => n.params.supportsAlpha ? Bo : Ro, equals: Ie, writer: (n) => No(n.params.supportsAlpha) }, controller: (n) => {
  var t, e;
  return new Be(n.document, { colorType: "int", expanded: (t = n.params.expanded) !== null && t !== void 0 ? t : false, formatter: Uo(n.params.supportsAlpha), parser: Rt("int"), pickerLayout: (e = n.params.picker) !== null && e !== void 0 ? e : "popup", supportsAlpha: n.params.supportsAlpha, value: n.value, viewProps: n.viewProps });
} });
function Go(n, t) {
  if (!xr(n)) return x(v.black(), t);
  if (t === "int") {
    const e = ln(n);
    return new v(e, "rgb");
  }
...
function Xo(n, t) {
  return (e) => n ? _r(e, t) : fr(e, t);
}
const Qo = y({ id: "input-color-object", type: "input", accept: (n, t) => {
  var e;
  if (!xr(n)) return null;
  const r = Oe(t);
  return r ? { initialValue: n, params: Object.assign(Object.assign({}, r), { colorType: (e = sr(t)) !== null && e !== void 0 ? e : "int" }) } : null;
}, binding: { reader: (n) => Wo(n.params.colorType), equals: Ie, writer: (n) => zo(Yo(n.initialValue), n.params.colorType) }, controller: (n) => {
  var t, e;
  const r = Cr(n.initialValue);
  return new Be(n.document, { colorType: n.params.colorType, expanded: (t = n.params.expanded) !== null && t !== void 0 ? t : false, formatter: Xo(r, n.params.colorType), parser: Rt("int"), pickerLayout: (e = n.params.picker) !== null && e !== void 0 ? e : "popup", supportsAlpha: r, value: n.value, viewProps: n.viewProps });
} }), Zo = y({ id: "input-color-string", type: "input", accept: (n, t) => {
...
}, binding: { reader: () => ao, equals: Ie, writer: (n) => {
  const t = Io(n.params.format);
...
class Jo {
  constructor(t, e) {
    this.textViews = e.textViews, this.element = t.createElement("div"), this.element.classList.add(pn()), this.textViews.forEach((r) => {
      const i = t.createElement("div");
      i.classList.add(pn("a")), i.appendChild(r.element), this.element.appendChild(i);
    });
  }
}
function ta(n, t, e) {
...
class Fe {
  constructor(t, e) {
    this.value = e.value, this.viewProps = e.viewProps, this.acs_ = e.axes.map((r, i) => ta(t, e, i)), this.acs_.forEach((r, i) => {
    ...
    }), this.view = new Jo(t, { textViews: this.acs_.map((r) => r.view) });
  }
  get textControllers() {
    return this.acs_;
  }
...
const ra = y({ id: "input-number", type: "input", accept: (n, t) => {
  if (typeof n != "number") return null;
  const e = _(t, (r) => Object.assign(Object.assign({}, Rn(r)), { options: r.optional.custom(Dt), readonly: r.optional.constant(false) }));
  return e ? { initialValue: n, params: e } : null;
}, binding: { reader: (n) => Ln, constraint: (n) => na(n.params, n.initialValue), writer: (n) => jt }, controller: (n) => {
  const t = n.value, e = n.constraint, r = e && Gt(e, Ot);
  if (r) return new G(n.document, { props: new d({ options: r.values.value("options") }), value: t, viewProps: n.viewProps });
  const i = jn(n.params, t.rawValue), s = e && Gt(e, St);
  return s ? new Wt(n.document, Object.assign(Object.assign({}, Jn(Object.assign(Object.assign({}, i), { keyScale: f(i.keyScale), max: s.values.value("max"), min: s.values.value("min") }))), { parser: I, value: t, viewProps: n.viewProps })) : new Tt(n.document, { parser: I, props: d.fromObject(i), value: t, viewProps: n.viewProps });
}, api(n) {
  return typeof n.controller.value.rawValue != "number" ? null : n.controller.valueController instanceof Wt ? new ea(n.controller) : n.controller.valueController instanceof G ? new Le(n.controller) : null;
} });
class q {
  constructor(t = 0, e = 0) {
    this.x = t, this.y = e;
...
const yr = { toComponents: (n) => n.getComponents(), fromComponents: (n) => new q(...n) }, st = h("p2d");
class ia {
  constructor(t, e) {
...
class sa {
  constructor(t, e) {
    ...
    const s = t.createElementNS(O, "line");
...
class oa {
  ...
  onPadKeyDown_(t) {
    Zn(t.key) && t.preventDefault();
    const [e, r] = cn(t, [this.props.get("xKeyScale"), this.props.get("yKeyScale")], this.props.get("invertsY"));
...
class aa {
  constructor(t, e) {
    var r, i;
    this.onPopupChildBlur_ = this.onPopupChildBlur_.bind(this), this.onPopupChildKeydown_ = this.onPopupChildKeydown_.bind(this), this.onPadButtonBlur_ = this.onPadButtonBlur_.bind(this), this.onPadButtonClick_ = this.onPadButtonClick_.bind(this), this.value = e.value, this.viewProps = e.viewProps, this.foldable_ = Mt.create(e.expanded), this.popC_ = e.pickerLayout === "popup" ? new Wn(t, { viewProps: this.viewProps }) : null;
    const s = new oa(t, { layout: e.pickerLayout, props: new d({ invertsY: f(e.invertsY), max: f(e.max), xKeyScale: e.axes[0].textProps.value("keyScale"), yKeyScale: e.axes[1].textProps.value("keyScale") }), value: this.value, viewProps: this.viewProps });
    ...
    }), this.pickerC_ = s, this.textC_ = new Fe(t, { assembly: yr, axes: e.axes, parser: e.parser, value: this.value, viewProps: this.viewProps }), this.view = new ia(t, { expanded: this.foldable_.value("expanded"), pickerLayout: e.pickerLayout, viewProps: this.viewProps }), this.view.textElement.appendChild(this.textC_.view.element), (r = this.view.buttonElement) === null || r === void 0 || r.addEventListener("blur", this.onPadButtonBlur_), (i = this.view.buttonElement) === null || i === void 0 || i.addEventListener("click", this.onPadButtonClick_), this.popC_ ? (this.view.element.appendChild(this.popC_.view.element), this.popC_.view.element.appendChild(this.pickerC_.view.element), ht({ primary: this.foldable_.value("expanded"), secondary: this.popC_.shows, forward: (o) => o, backward: (o, a) => a })) : this.view.pickerElement && (this.view.pickerElement.appendChild(this.pickerC_.view.element), Se(this.foldable_, this.view.pickerElement));
  }
  get textController() {
    return this.textC_;
  }
...
function ca(n, t) {
  return new Ne({ assembly: yr, components: [R(Object.assign(Object.assign({}, n), n.x), t.x), R(Object.assign(Object.assign({}, n), n.y), t.y)] });
}
function dn(n, t) {
  var e, r;
...
function da(n, t) {
  var e, r;
  const i = dn(Z(n, (e = n.x) !== null && e !== void 0 ? e : {}), t.x), s = dn(Z(n, (r = n.y) !== null && r !== void 0 ? r : {}), t.y);
  return Math.max(i, s);
}
function ua(n) {
...
const ha = y({ id: "input-point2d", type: "input", accept: (n, t) => {
  if (!q.isObject(n)) return null;
  const e = _(t, (r) => Object.assign(Object.assign({}, kt(r)), { expanded: r.optional.boolean, picker: r.optional.custom(er), readonly: r.optional.constant(false), x: r.optional.custom(H), y: r.optional.object(Object.assign(Object.assign({}, kt(r)), { inverted: r.optional.boolean })) }));
  return e ? { initialValue: n, params: e } : null;
}, binding: { reader: () => la, constraint: (n) => ca(n.params, n.initialValue), equals: q.equals, writer: () => pa }, controller: (n) => {
  var t, e;
  const r = n.document, i = n.value, s = n.constraint, o = [n.params.x, n.params.y];
  return new aa(r, { axes: i.rawValue.getComponents().map((a, l) => {
    var p;
    return Ce({ constraint: s.components[l], initialValue: a, params: Z(n.params, (p = o[l]) !== null && p !== void 0 ? p : {}) });
  }), expanded: (t = n.params.expanded) !== null && t !== void 0 ? t : false, invertsY: ua(n.params), max: da(n.params, i.rawValue), parser: I, pickerLayout: (e = n.params.picker) !== null && e !== void 0 ? e : "popup", value: i, viewProps: n.viewProps });
} });
class at {
...
const Pr = { toComponents: (n) => n.getComponents(), fromComponents: (n) => new at(...n) };
function va(n) {
...
function ba(n, t) {
  return new Ne({ assembly: Pr, components: [R(Object.assign(Object.assign({}, n), n.x), t.x), R(Object.assign(Object.assign({}, n), n.y), t.y), R(Object.assign(Object.assign({}, n), n.z), t.z)] });
}
const fa = y({ id: "input-point3d", type: "input", accept: (n, t) => {
  ...
  return e ? { initialValue: n, params: e } : null;
}, binding: { reader: (n) => va, constraint: (n) => ba(n.params, n.initialValue), equals: at.equals, writer: (n) => ma }, controller: (n) => {
  ...
  return new Fe(n.document, { assembly: Pr, axes: t.rawValue.getComponents().map((i, s) => {
    var o;
    return Ce({ constraint: e.components[s], initialValue: i, params: Z(n.params, (o = r[s]) !== null && o !== void 0 ? o : {}) });
...
const Er = { toComponents: (n) => n.getComponents(), fromComponents: (n) => new lt(...n) };
function _a(n) {
...
function ga(n, t) {
  return new Ne({ assembly: Er, components: [R(Object.assign(Object.assign({}, n), n.x), t.x), R(Object.assign(Object.assign({}, n), n.y), t.y), R(Object.assign(Object.assign({}, n), n.z), t.z), R(Object.assign(Object.assign({}, n), n.w), t.w)] });
}
const Ca = y({ id: "input-point4d", type: "input", accept: (n, t) => {
  ...
  return e ? { initialValue: n, params: e } : null;
}, binding: { reader: (n) => _a, constraint: (n) => ga(n.params, n.initialValue), equals: lt.equals, writer: (n) => wa }, controller: (n) => {
  const t = n.value, e = n.constraint, r = [n.params.x, n.params.y, n.params.z, n.params.w];
  return new Fe(n.document, { assembly: Er, axes: t.rawValue.getComponents().map((i, s) => {
    var o;
    return Ce({ constraint: e.components[s], initialValue: i, params: Z(n.params, (o = r[s]) !== null && o !== void 0 ? o : {}) });
  }), parser: I, value: t, viewProps: n.viewProps });
} });
...
const ya = y({ id: "input-string", type: "input", accept: (n, t) => {
  if (typeof n != "string") return null;
  const e = _(t, (r) => ({ readonly: r.optional.constant(false), options: r.optional.custom(Dt) }));
  return e ? { initialValue: n, params: e } : null;
}, binding: { reader: (n) => Qn, constraint: (n) => xa(n.params), writer: (n) => jt }, controller: (n) => {
  const t = n.document, e = n.value, r = n.constraint, i = r && Gt(r, Ot);
  return i ? new G(t, { props: new d({ options: i.values.value("options") }), value: e, viewProps: n.viewProps }) : new Pt(t, { parser: (s) => s, props: d.fromObject({ formatter: ve }), value: e, viewProps: n.viewProps });
}, api(n) {
  return typeof n.controller.value.rawValue != "string" ? null : n.controller.valueController instanceof G ? new Le(n.controller) : null;
} }), Bt = { monitor: { defaultInterval: 200, defaultRows: 3 } }, un = h("mll");
class Pa {
  constructor(t, e) {
    ...
    r.classList.add(un("i")), r.style.height = `calc(var(${tr("containerUnitSize")}) * ${e.rows})`, r.readOnly = true, e.viewProps.bindDisabled(r), this.element.appendChild(r), this.textareaElem_ = r, e.value.emitter.on("change", this.onValueUpdate_), this.value = e.value, this.update_();
  }
  update_() {
...
class Ke {
  constructor(t, e) {
    this.value = e.value, this.viewProps = e.viewProps, this.view = new Pa(t, { formatter: e.formatter, rows: e.rows, value: this.value, viewProps: this.viewProps });
  }
}
const hn = h("sgl");
class Ea {
  constructor(t, e) {
    this.onValueUpdate_ = this.onValueUpdate_.bind(this), this.formatter_ = e.formatter, this.element = t.createElement("div"), this.element.classList.add(hn()), e.viewProps.bindClassModifiers(this.element);
    const r = t.createElement("input");
    r.classList.add(hn("i")), r.readOnly = true, r.type = "text", e.viewProps.bindDisabled(r), this.element.appendChild(r), this.inputElement = r, e.value.emitter.on("change", this.onValueUpdate_), this.value = e.value, this.update_();
  }
  update_() {
...
class ze {
  constructor(t, e) {
    this.value = e.value, this.viewProps = e.viewProps, this.view = new Ea(t, { formatter: e.formatter, value: this.value, viewProps: this.viewProps });
  }
}
const ka = y({ id: "monitor-bool", type: "monitor", accept: (n, t) => {
  if (typeof n != "boolean") return null;
  const e = _(t, (r) => ({ readonly: r.required.constant(true), rows: r.optional.number }));
  return e ? { initialValue: n, params: e } : null;
}, binding: { reader: (n) => Xn }, controller: (n) => {
  var t;
  return n.value.rawValue.length === 1 ? new ze(n.document, { formatter: sn, value: n.value, viewProps: n.viewProps }) : new Ke(n.document, { formatter: sn, rows: (t = n.params.rows) !== null && t !== void 0 ? t : Bt.monitor.defaultRows, value: n.value, viewProps: n.viewProps });
} });
class Va extends yt {
  get max() {
...
class Sa {
  constructor(t, e) {
    ...
    r.classList.add($("g")), r.style.height = `calc(var(${tr("containerUnitSize")}) * ${e.rows})`, this.element.appendChild(r), this.svgElem_ = r;
    const i = t.createElementNS(O, "polyline");
  ...
  update_() {
    ...
    this.value.rawValue.forEach((c, S) => {
      if (c === void 0) return;
      const Y = m(S, 0, r, 0, t), A = m(c, i, s, e, 0);
      o.push([Y, A].join(","));
    ...
    const p = m(this.cursor_.rawValue, 0, r, 0, t), u = m(l, i, s, e, 0);
    a.style.left = `${p}px`, a.style.top = `${u}px`, a.textContent = `${this.formatter_(l)}`, a.classList.contains($("t", "a")) || (a.classList.add($("t", "a"), $("t", "in")), qt(a), a.classList.remove($("t", "in")));
  }
  onValueUpdate_() {
    this.update_();
  }
...
function Ma(n) {
  var t, e, r;
  return new kr(n.document, { formatter: me(n.params), rows: (t = n.params.rows) !== null && t !== void 0 ? t : Bt.monitor.defaultRows, props: d.fromObject({ max: (e = n.params.max) !== null && e !== void 0 ? e : 100, min: (r = n.params.min) !== null && r !== void 0 ? r : 0 }), value: n.value, viewProps: n.viewProps });
}
function vn(n) {
  return n.view === "graph";
}
const Aa = y({ id: "monitor-number", type: "monitor", accept: (n, t) => {
  if (typeof n != "number") return null;
  ...
  return e ? { initialValue: n, params: e } : null;
}, binding: { defaultBufferSize: (n) => vn(n) ? 64 : 1, reader: (n) => Ln }, controller: (n) => vn(n.params) ? Ma(n) : La(n), api: (n) => n.controller.valueController instanceof kr ? new Va(n.controller) : null }), Oa = y({ id: "monitor-string", type: "monitor", accept: (n, t) => {
  if (typeof n != "string") return null;
  const e = _(t, (r) => ({ multiline: r.optional.boolean, readonly: r.required.constant(true), rows: r.optional.number }));
  return e ? { initialValue: n, params: e } : null;
}, binding: { reader: (n) => Qn }, controller: (n) => {
  var t;
  const e = n.value;
...
function ja(n, t) {
  ...
  if (b(r)) return null;
  const i = { target: t.target, initialValue: r.initialValue, params: r.params }, s = _(t.params, (c) => ({ disabled: c.optional.boolean, hidden: c.optional.boolean, label: c.optional.string, tag: c.optional.string })), o = n.binding.reader(i), a = n.binding.constraint ? n.binding.constraint(i) : void 0, l = new Ta({ reader: o, target: t.target, writer: n.binding.writer(i) }), p = new fi(f(o(r.initialValue), { constraint: a, equals: n.binding.equals }), l), u = n.controller({ constraint: a, document: t.document, initialValue: r.initialValue, params: r.params, value: p, viewProps: F.create({ disabled: s == null ? void 0 : s.disabled, hidden: s == null ? void 0 : s.hidden }) });
  return new Oi(t.document, { blade: ut(), props: d.fromObject({ label: "label" in t.params ? (e = s == null ? void 0 : s.label) !== null && e !== void 0 ? e : null : t.target.key }), tag: s == null ? void 0 : s.tag, value: p, valueController: u });
}
class Ra {
  constructor(t) {
...
function Ba(n, t) {
  return t === 0 ? new vs() : new ms(n, t ?? Bt.monitor.defaultInterval);
}
function Ia(n, t) {
  var e, r, i;
  const s = n.accept(t.target.read(), t.params);
  if (b(s)) return null;
  const o = { target: t.target, initialValue: s.initialValue, params: s.params }, a = _(t.params, (S) => ({ bufferSize: S.optional.number, disabled: S.optional.boolean, hidden: S.optional.boolean, interval: S.optional.number, label: S.optional.string })), l = n.binding.reader(o), p = (r = (e = a == null ? void 0 : a.bufferSize) !== null && e !== void 0 ? e : n.binding.defaultBufferSize && n.binding.defaultBufferSize(s.params)) !== null && r !== void 0 ? r : 1, u = new Bi({ binding: new Ra({ reader: l, target: t.target }), bufferSize: p, ticker: Ba(t.document, a == null ? void 0 : a.interval) }), c = n.controller({ document: t.document, params: s.params, value: u, viewProps: F.create({ disabled: a == null ? void 0 : a.disabled, hidden: a == null ? void 0 : a.hidden }) });
  return c.viewProps.bindDisabled(u.ticker), c.viewProps.handleDispose(() => {
    u.ticker.dispose();
  }), new Ni(t.document, { blade: ut(), props: d.fromObject({ label: "label" in t.params ? (i = a == null ? void 0 : a.label) !== null && i !== void 0 ? i : null : t.target.key }), value: u, valueController: c });
}
class Na {
  constructor(t) {
  ...
  register(t, e) {
    if (!Ss(e.core)) throw w.notCompatible(t, e.id);
  ...
  createInput_(t, e, r) {
    return this.pluginsMap_.inputs.reduce((i, s) => i ?? ja(s, { document: t, target: e, params: r }), null);
  }
  createMonitor_(t, e, r) {
    return this.pluginsMap_.monitors.reduce((i, s) => i ?? Ia(s, { document: t, params: r, target: e }), null);
  }
  createBinding(t, e, r) {
    const i = e.read();
  ...
  createBlade(t, e) {
    const r = this.pluginsMap_.blades.reduce((i, s) => i ?? hs(s, { document: t, params: e }), null);
  ...
  createBindingApi(t) {
    ...
    if (Di(t)) return this.createInputBindingApi_(t);
    if (Fi(t)) return this.createMonitorBindingApi_(t);
    throw w.shouldNeverHappen();
  }
  createApi(t) {
    if (this.apiCache_.has(t)) return this.apiCache_.get(t);
    if (Ai(t)) return this.createBindingApi(t);
...
function Ka() {
  const n = new Na(Fa);
  return [ha, fa, Ca, ya, ra, Zo, Qo, qo, Os, ka, Oa, Aa, Hi, is, Yn].forEach((t) => {
    n.register("core", t);
  }), n;
}
class za extends et {
...
const qa = /* @__PURE__ */ function() {
  return { id: "list", type: "blade", core: dt, accept(n) {
    ...
    const t = new Ot(Me(n.params.options)), e = f(n.params.value, { constraint: t }), r = new G(n.document, { props: new d({ options: t.values.value("options") }), value: e, viewProps: n.viewProps });
    return new J(n.document, { blade: n.blade, props: d.fromObject({ label: n.params.label }), value: e, valueController: r });
  }, api(n) {
    return !(n.controller instanceof J) || !(n.controller.valueController instanceof G) ? null : new za(n.controller);
  } };
}();
class Ga extends qn {
  constructor(t, e) {
...
class Wa {
  constructor(t, e) {
    this.element = t.createElement("div"), this.element.classList.add(mn()), e.viewProps.bindClassModifiers(this.element);
    const r = t.createElement("hr");
    r.classList.add(mn("r")), this.element.appendChild(r);
  }
}
class bn extends Zt {
  constructor(t, e) {
    super(Object.assign(Object.assign({}, e), { view: new Wa(t, { viewProps: e.viewProps }) }));
  }
}
const Xa = { id: "separator", type: "blade", core: dt, accept(n) {
  const t = _(n, (e) => ({ view: e.required.constant("separator") }));
  return t ? { params: t } : null;
}, controller(n) {
  return new bn(n.document, { blade: n.blade, viewProps: n.viewProps });
}, api(n) {
  return n.controller instanceof bn ? new $a(n.controller) : null;
} }, Qa = { id: "slider", type: "blade", core: dt, accept(n) {
  ...
  var t, e;
  const r = (t = n.params.value) !== null && t !== void 0 ? t : 0, i = new St({ max: n.params.max, min: n.params.min }), s = f(r, { constraint: i }), o = new Wt(n.document, Object.assign(Object.assign({}, Jn({ formatter: (e = n.params.format) !== null && e !== void 0 ? e : ui, keyScale: f(1), max: i.values.value("max"), min: i.values.value("min"), pointerScale: On(n.params, r) })), { parser: I, value: s, viewProps: n.viewProps }));
  return new J(n.document, { blade: n.blade, props: d.fromObject({ label: n.params.label }), value: s, valueController: o });
}, api(n) {
  return !(n.controller instanceof J) || !(n.controller.valueController instanceof Wt) ? null : new Ua(n.controller);
  ...
  return { id: "text", type: "blade", core: dt, accept(n) {
    ...
    var t;
    const e = f(n.params.value), r = new Pt(n.document, { parser: n.params.parse, props: d.fromObject({ formatter: (t = n.params.format) !== null && t !== void 0 ? t : (i) => String(i) }), value: e, viewProps: n.viewProps });
    return new J(n.document, { blade: n.blade, props: d.fromObject({ label: n.params.label }), value: e, valueController: r });
  }, api(n) {
    return !(n.controller instanceof J) || !(n.controller.valueController instanceof Pt) ? null : new Ha(n.controller);
  } };
}();
function Ja(n) {
...
class sl extends Ga {
  constructor(t) {
    var e, r;
    const i = t ?? {}, s = (e = i.document) !== null && e !== void 0 ? e : Pi(), o = Ka(), a = new Ya(s, { expanded: i.expanded, blade: ut(), props: d.fromObject({ title: i.title }), viewProps: F.create() });
    super(a, o), this.pool_ = o, this.containerElem_ = (r = i.container) !== null && r !== void 0 ? r : Ja(s), this.containerElem_.appendChild(this.element), this.doc_ = s, this.usesDefaultWrapper_ = !i.container, this.setUpDefaultPlugins_();
  }
  get document() {
