...
Util:     cad.info()  cad.clear()  cad.help()
    ...
    function bs() {
      ...
      return Ze.plateQ4(t, n, o, l, f, c, s, a, r, d);
    }
    function gs() {
      const t = le("a") || 6, n = le("b") || 4, o = Math.round(le("nx") || 12), l = Math.round(le("ny") || 8), s = le("t") || 0.1, c = le("q") || -10, a = le("E") || 35e6, r = le("nu") || 0.15, i = {
        ...
        2: 1,
        3: 0
      }[Ce] ?? 0, d = Ze.plateQ4(t, n, o, l, "simply-supported", c, s, a, r, i), b = a * s * s * s / (12 * (1 - r * r));
      let S = 0;
...
`);
    ...
    function Co() {
      xe && (cancelAnimationFrame(xe), xe = 0), ke.length > 0 && (e.nodes.val = ke.map((n) => [
        ...n
      ]));
      const t = Ke();
      t && t.scene.traverse((n) => {
        var _a2;
        n.isMesh && ((_a2 = n.material) == null ? void 0 : _a2.vertexColors) && n.visible === false && (n.visible = true);
    ...
    function Qn() {
      ...
      const d = i > 1e-12 ? a * f / 100 / i : 1, b = Ke();
      if (!b) return;
...
${i.join(", ")}`);
    ...
    function Ca(t) {
      ...
      if (jt === "area") {
        ...
        if (Xt.push(n), console.log(`Area vertex ${Xt.length}: node ${n}`), Xt.length >= 2) {
          const o = Xt[Xt.length - 2], l = e.nodes.val, s = Ke();
          if (s) {
    ...
    function qs(t) {
      ...
      let d = "", b = "", S = "";
      i || (i = "");
      let $ = "", y = "", p = "", h = "", I = null, A = null, z = null, P = [];
      try {
        ...
        d = `<div class="matrix-label">k_local (${I.length}\xD7${I.length}) ${m}</div>${Go(I, P)}`, b = `<div class="matrix-label">T \u2014 Transformaci\xF3n (${A.length}\xD7${A.length}) ${u}</div>${Go(A, P)}`, S = `<div class="matrix-label">K_global = T^T \xB7 k \xB7 T ${E}</div>${Go(z, P)}`;
      } catch (m) {
