...
import { _ as Us, p as Mn, m as Zs, d as It, s as Qs, __tla as __tla_0 } from "./plateQ4Cpp-CArWqXeL.js";
import { v as yo, P as _o, g as ea, a as ta, o as oa } from "./theme-CzzIlc4y.js";
import { V as ke, P as Qt, R as gs, b as xs, B as eo, c as na, d as wn, e as zo, f as sa, S as aa, M as la, g as ia, F as ao, a as Lo, L as Oo, h as ra, G as ca, A as Ro, i as Sn, T as En, j as No, k as Ho, C as da, l as pa } from "./Text-Cin90tvN.js";
import { g as Jo, b as Go, a as vo } from "./analyze-B0bulnNq.js";
...
`));
  ...
  function ha(e) {
    ...
    for (let K = 0; K < D; K++) {
      ...
      try {
        rt = Jo(X, z, K), ct = Go(X), wt = Lt(Tn(ct), Lt(rt, ct));
      } catch {
        continue;
      }
      const Ft = Wt(X[1], X[0]), $t = Ft[0] / Y, St = Ft[1] / Y, Yt = Ft[2] / Y;
      E += '<div class="rpt-elem-block">', E += `<h3 class="rpt-elem-title" data-toggle="elem${K}">\u25B6 Element ${K} \u2014 Nodes ${Q[0]} \u2192 ${Q[1]}, L = ${De(Y)}</h3>`, E += `<div id="rpt-elem${K}" class="rpt-elem-body" style="display:none">`, E += "<h4>Properties (numerical substitution)</h4>", E += '<div class="rpt-eq-small">', E += `E = ${De(Le)} &nbsp;&nbsp; A = ${De(Re)} &nbsp;&nbsp; I<sub>z</sub> = ${De(Me)} &nbsp;&nbsp; I<sub>y</sub> = ${De(We)} &nbsp;&nbsp; G = ${De(et)} &nbsp;&nbsp; J = ${De(ft)}<br/>`, E += `EA/L = ${De(Le)}\xB7${De(Re)}/${De(Y)} = <b>${De(Le * Re / Y)}</b><br/>`, E += `12EI<sub>z</sub>/L\xB3 = 12\xB7${De(Le)}\xB7${De(Me)}/${De(Y)}\xB3 = <b>${De(12 * Le * Me / Y ** 3)}</b><br/>`, E += `12EI<sub>y</sub>/L\xB3 = 12\xB7${De(Le)}\xB7${De(We)}/${De(Y)}\xB3 = <b>${De(12 * Le * We / Y ** 3)}</b><br/>`, E += `GJ/L = ${De(et)}\xB7${De(ft)}/${De(Y)} = <b>${De(et * ft / Y)}</b>`, E += "</div>", E += "<h4>Direction cosines</h4>", E += `<div class="rpt-eq-small">l = ${Wo($t)}, m = ${Wo(St)}, n = ${Wo(Yt)}, D = ${Wo(Math.sqrt($t ** 2 + St ** 2))}</div>`, E += "<h4>K<sub>local</sub> (12\xD712)</h4>", E += kn(rt, 12), E += "<h4>T \u2014 Transformation (12\xD712)</h4>", E += kn(ct, 12), E += "<h4>K<sub>global</sub> = T\u1D40 \xB7 K<sub>local</sub> \xB7 T</h4>", E += kn(wt, 12), E += "<h4>Assembly</h4>", E += `<div class="rpt-eq-small">Global DOFs: node ${Q[0]} \u2192 [${Q[0] * 6}..${Q[0] * 6 + 5}], node ${Q[1]} \u2192 [${Q[1] * 6}..${Q[1] * 6 + 5}]</div>`, E += "</div></div>";
    }
  ...
  function $a(e, g, j, z, J, N) {
    ...
    try {
      Q = Jo(D, z, e), X = Go(D), de = Lt(Tn(X), Lt(Q, X));
    } catch {
    }
  ...
  let Vo = false, co = null, Tt = null, ht = null, pt = null;
  function Ia() {
  ...
  function za() {
    Vo = true, pt && (pt.innerHTML = "\u2715", pt.style.background = "linear-gradient(135deg, #cc3333, #ff4444)", pt.style.animation = "none"), co = document.createElement("div"), co.id = "tour-overlay", co.style.cssText = `
    position: fixed; inset: 0; z-index: 9999990;
    pointer-events: none;
  `, document.body.appendChild(co), Mo(0);
  }
  function Fn() {
    Vo = false, pt && (pt.innerHTML = "?", pt.style.background = "linear-gradient(135deg, #0066cc, #0099ff)", pt.style.animation = "helpPulse 2s infinite"), Tt && (Tt.remove(), Tt = null), ht && (ht.remove(), ht = null), co && (co.remove(), co = null);
  }
  function Mo(e) {
    var _a, _b;
    if (e >= To.length) {
  ...
  Da = function(e) {
    ...
    function Xo(t, o, n, l, s) {
      ...
      for (let b = 0; b < t.length; b++) {
        ...
        if (v) {
          const y = -w - u * 1.5;
          Zo(f, 0, 0, f, 0, y + u, M, Ne), Qo(x[b] || `${b}`, f, 0, y, u, Ne);
        } else {
          const y = m - w - u * 1.5;
          Zo(f, m, 0, f, y + u, 0, M, Ne), Qo(x[b] || `${b}`, f, y, 0, u, Ne);
        }
      }
      if (!v) for (let b = 0; b < o.length; b++) {
        const f = o[b], y = a - w - u * 1.5;
        Zo(a, f, 0, y + u, f, 0, M, Ne), Qo(p[b] || `${b}`, y, f, 0, u, Ne);
      }
      const $ = u * 1.8, A = w * 1.2, q = w * 1.2;
      for (let b = 0; b < t.length - 1; b++) {
        const f = t[b], y = t[b + 1], k = Math.abs(y - f), I = (f + y) / 2, O = `${k.toFixed(2)} m`;
        v ? (Ko(O, I, 0, -A, $, Ne), Uo(f, 0, -A * 0.7, y, 0, -A * 0.7, 16763904, Ne)) : (Ko(O, I, m - q, 0, $, Ne), Uo(f, m - q * 0.7, 0, y, m - q * 0.7, 0, 16763904, Ne));
      }
      if (!v) for (let b = 0; b < o.length - 1; b++) {
        const f = o[b], y = o[b + 1], k = Math.abs(y - f), I = (f + y) / 2, O = `${k.toFixed(2)} m`;
        Ko(O, a - A, I, 0, $, Ne), Uo(a - A * 0.7, f, 0, a - A * 0.7, y, 0, 16763904, Ne);
      }
      Ne.traverse((b) => {
...
Util:     cad.info()  cad.clear()  cad.help()
    ...
    function Xn(t, o, n, l, s) {
      const d = ze.steelVigaType, a = d === 0 ? Do() : jo();
      if (ze.vigaMat === 0) {
    ...
    function fo() {
      ...
      if (lt.addBinding(m, "colMat", {
        ...
        lt.addBinding(f, "fc", {
          ...
          var _a2;
          ((_a2 = y.target) == null ? void 0 : _a2.key) === "fc" && (ze.fc = en(y.value), me());
        });
      } else if (ze.colMat === 1) {
        const b = {
      ...
      const i = ze.steelColType === 0 ? Do() : jo();
      ze.steelVigaType === 0 ? Do() : jo();
      const h = j === "m" ? [
        5e-3,
        0.1,
        1e-3
      ...
      for (let b = 0; b < l; b++) {
        ...
        if (ze.colMat === 0) if (ze.colShape === 1) {
          ...
          y.addBinding(k, "Es", {
            ...
            ((_a2 = T.target) == null ? void 0 : _a2.key) === "bc" && (f.colBc = st(T.value), me()), ((_b = T.target) == null ? void 0 : _b.key) === "hc" && (f.colHc = st(T.value), me()), ((_c = T.target) == null ? void 0 : _c.key) === "t" && (f.colT = st(T.value), me()), ((_d = T.target) == null ? void 0 : _d.key) === "Es" && (f.colEs = en(T.value), me()), ((_e = T.target) == null ? void 0 : _e.key) === "nuS" && (f.colNuS = T.value, me()), ((_f = T.target) == null ? void 0 : _f.key) === "fc" && (f.colFc = en(T.value), me()), ((_g = T.target) == null ? void 0 : _g.key) === "nuC" && (f.colNuC = T.value, me());
          });
        }
...
`);
    ...
    function sn() {
      ...
      window.__femLog = S, console.log(`FEM Solver: ${t.length}n ${o.length}e \u2192 ${(performance.now() - s).toFixed(0)}ms`), te && setTimeout(() => on(), 50);
    }
    function an(t, o) {
    ...
    setTimeout(() => {
      ...
      (_a = $e.querySelector("#cad3d-toggle")) == null ? void 0 : _a.addEventListener("click", (u) => {
        ...
        var _a2;
        u.stopPropagation(), zt && (zt = false, so()), Pt && Po(), vt = !vt, (_a2 = $e.querySelector("#cad3d-select")) == null ? void 0 : _a2.classList.toggle("inspect-active", vt);
        const M = Je();
        M && (M.controls.enabled = !vt), vt || Co();
      }), (_e = $e.querySelector("#cad3d-draw")) == null ? void 0 : _e.addEventListener("click", (u) => {
        var _a2;
        u.stopPropagation(), zt && (zt = false, so()), vt && Co(), Pt = !Pt, (_a2 = $e.querySelector("#cad3d-draw")) == null ? void 0 : _a2.classList.toggle("inspect-active", Pt), Pt ? Ps() : Po();
      }), (_f = $e.querySelector("#cad3d-inspect")) == null ? void 0 : _f.addEventListener("click", (u) => {
        var _a2;
        u.stopPropagation(), vt && Co(), Pt && Po(), zt = !zt, (_a2 = $e.querySelector("#cad3d-inspect")) == null ? void 0 : _a2.classList.toggle("inspect-active", zt), zt || so();
      ...
      function s(u) {
        ...
        Ue = A, Ve = q, setTimeout(() => {
          ut(), Xo(A, q, y, b, f), Ms(u.stories, A, q), cn(), dn();
        }, 100);
        const k = {
          COLUMN: 0,
          BEAM: 0,
      ...
      c && (c.value = j, c.addEventListener("change", (u) => {
        ...
        if (te) {
          const b = Je();
          ((_b2 = b == null ? void 0 : b.settings) == null ? void 0 : _b2.loads) && (Xe = b.settings.loads.rawVal, b.settings.loads.val = false), on(), M.style.display = "", $.style.display = "", A.style.display = "", q && (q.style.display = ""), m();
        } else nn(), M.style.display = "none", $.style.display = "none", A.style.display = "none", q && (q.style.display = "none"), E && E !== "placa-q4" && E !== "placa-3q" && me(), setTimeout(() => {
          var _a3;
          const b = Je();
      ...
      i == null ? void 0 : i.addEventListener("mousedown", (u) => u.stopPropagation()), document.addEventListener("keydown", (u) => {
        ...
        if (u.key === "Escape") {
          ...
          vt && Co(), zt && (zt = false, so(), (_a2 = $e.querySelector("#cad3d-inspect")) == null ? void 0 : _a2.classList.remove("inspect-active"));
        }
    ...
    function ut(t = false) {
      ...
      a.rotation.x = Math.PI / 2, a.position.set(0.5 * l, 0.5 * l, 0), o.scene.add(a), o.scene.children.filter((h) => h.type === "Group" && h.name !== "gridAxes" && h.name !== "loadsGroup" && (h.name === "viewerAxes" || h.children.some((S) => S instanceof Ro))).forEach((h) => {
        h.traverse((S) => {
      ...
      r.name = "viewerAxes";
      const i = d.axisArrow;
      r.add(new Ro(new ke(1, 0, 0), new ke(), 1, i, 0.2, 0.2)), r.add(new Ro(new ke(0, 1, 0), new ke(), 1, i, 0.2, 0.2)), r.add(new Ro(new ke(0, 0, 1), new ke(), 1, i, 0.2, 0.2)), r.children.forEach((h) => h.scale.set(m, m, m));
      for (const [h, S, w] of [
        [
          "X",
          "red",
    ...
    function bo() {
      ...
      }), mo.length > qs && mo.shift(), Ao.length = 0;
    }
    function es() {
...
${r.join(", ")}`);
    ...
    function ss(t) {
      ...
      if (mt && (o.scene.remove(mt), mt.geometry.dispose(), mt.material.dispose(), mt = null), tt !== null && t.worldPos) {
        ...
        mt = new Oo(s, d), gt === "arc" && Et !== null && (mt = new zo(s, d)), mt.renderOrder = 9999, o.scene.add(mt);
      }
      o.render();
    }
    function as(t, o, n, l) {
    ...
    function rs(t) {
      ...
      try {
        if (v = Jo(s, a, t), M = Go(s), $ = Lt(Tn(M), Lt(v, M)), A = d ? [
          "ux\u2080",
          "uy\u2080",
          "uz\u2080",
          "\u03B8x\u2080",
    ...
    function Xs(t) {
      ...
      const n = Do(), l = jo(), s = Object.entries(n).map(([r, i]) => `<option value="${i}">${r}</option>`).join(""), d = Object.entries(l).map(([r, i]) => `<option value="${i}">${r}</option>`).join("");
      o.innerHTML = `
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;">
    ...
    setTimeout(() => {
      ...
      if (t === void 0 && (t = !te), te = t, (_a = $e.querySelector("#cad3d-modal")) == null ? void 0 : _a.classList.toggle("active", te), te) {
        const n = Je();
        ((_b = n == null ? void 0 : n.settings) == null ? void 0 : _b.loads) && (Xe = n.settings.loads.rawVal, n.settings.loads.val = false), on(), $e.querySelector("#cad3d-mode-prev").style.display = "", $e.querySelector("#cad3d-mode-next").style.display = "", $e.querySelector("#cad3d-mode-label").style.display = "";
      } else nn(), $e.querySelector("#cad3d-mode-prev").style.display = "none", $e.querySelector("#cad3d-mode-next").style.display = "none", $e.querySelector("#cad3d-mode-label").style.display = "none", E && E !== "placa-q4" && E !== "placa-3q" && me(), setTimeout(() => {
        var _a2;
        const n = Je();
