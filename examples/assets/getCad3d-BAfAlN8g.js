    ...
    setTimeout(() => {
      ...
      function o(v) {
        ...
        function se(Q, W, le) {
          ...
          for (const K of le) de.elasticities.set(K, C), de.shearModuli.set(K, B), de.areas.set(K, oe), de.momentsOfInertiaZ.set(K, j), de.momentsOfInertiaY.set(K, he), de.torsionalConstants.set(K, ze), de.shearAreasY.set(K, R), de.shearAreasZ.set(K, R);
          return de;
        }
