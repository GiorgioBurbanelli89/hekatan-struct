const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./calcPanel-CYgx4MWJ.js","./getMesh-B1dmlgUt.js","./__vite-browser-external-D7Ct-6yo.js","./pureFunctionsAny.generated-JAcEVsJ7.js","./analyze-ClLKGn9k.js","./didacticCpp-Det8eHZd.js","./cyclicPushoverCpp-DL5y1q_I.js"])))=>i.map(i=>d[i]);
import { d as kt, _ as ea, p as Uo, m as Va, s as Ua, __tla as __tla_0 } from "./didacticCpp-Det8eHZd.js";
...
`);
      ...
      y && (y.value = P, y.addEventListener("change", (g) => {
        ...
        g.stopPropagation(), ea(async () => {
          const { openCalcPanel: E } = await import("./calcPanel-CYgx4MWJ.js").then(async (m2) => {
            await m2.__tla;
            return m2;
          });
          return {
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        try {
          const { cyclicPushover: h } = await ea(async () => {
            const { cyclicPushover: A } = await import("./cyclicPushoverCpp-DL5y1q_I.js").then(async (m2) => {
              await m2.__tla;
              return m2;
            });
            return {
