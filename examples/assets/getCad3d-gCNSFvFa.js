...
import { _ as la, p as An, m as ia, d as Ht, s as ra, __tla as __tla_0 } from "./plateQ4Cpp-WQQsWWc3.js";
import { v as Ao, P as Ho, g as ca, a as da, o as pa } from "./theme-CzzIlc4y.js";
...
import { g as tn, b as on, a as Co } from "./analyze-B6dp1uvy.js";
...
let __tla = Promise.all([
  ...
  function xo(t, h) {
    const _ = Nn.find((J) => J.id === t), k = qo.find((J) => J.id === h), Y = _.toKN, R = k.toM, V = (J, he, z) => z / (Math.pow(Y, J) * Math.pow(R, he));
    let j, D;
    switch (t) {
      case "kN":
        j = 10, D = [
...
<tr style="color:#ff0; border-bottom:1px solid #ff03">
  ...
  <th style="padding:2px 5px; color:#0ff">\u03A3Rz</th></tr>`, k.frequencies.forEach((D, J) => {
        var _a3;
        const he = D > 0 ? 1 / D : 0, z = D * 2 * Math.PI, Z = ((_a3 = k.massParticipation) == null ? void 0 : _a3[J]) || [
          0,
          0,
          0,
          0,
        ...
        for (let ye = 0; ye < 6; ye++) V[ye] += Z[ye];
  ...
  <td style="padding:2px 6px; text-align:right">${z.toFixed(2)}</td>`;
        for (let ye = 0; ye < 6; ye++) {
          const pe = (Z[ye] * 100).toFixed(1), Q = Z[ye] > 0.5 ? "#f00" : Z[ye] > 0.1 ? "#ff0" : "#0f0";
          j += `<td style="padding:2px 5px; text-align:right; color:${Q}">${pe}%</td>`;
        }
  ...
  <td style="padding:2px 5px; text-align:right; color:#0ff">${(V[5] * 100).toFixed(1)}%</td></tr>`;
        ...
        const D = t.querySelector("#modal-body"), J = t.querySelector("#modal-minimize");
        D && (D.style.display = "none"), J && (J.textContent = "\u25A2", J.title = "Restaurar");
      }
      (_a2 = t.querySelector("#modal-minimize")) == null ? void 0 : _a2.addEventListener("click", () => {
        h = !h;
        const D = t.querySelector("#modal-body"), J = t.querySelector("#modal-minimize");
        h ? (D.style.display = "none", J.textContent = "\u25A2", J.title = "Restaurar") : (D.style.display = "block", J.textContent = "\u25AC", J.title = "Minimizar");
      }), (_b = t.querySelector("#modal-copy")) == null ? void 0 : _b.addEventListener("click", () => {
        const D = [];
        D.push(`Modal Analysis \u2014 ${Y.title}`);
        const J = `Mode  Freq(Hz)  Period(s)  \u03C9(rad/s)  ${R.join("     ")}  \u03A3Ux    \u03A3Uy    \u03A3Rz`;
        D.push(J), D.push("-".repeat(J.length));
        const he = [
          0,
          0,
          0,
        ...
        k.frequencies.forEach((Z, ye) => {
          var _a3;
          const pe = Z > 0 ? 1 / Z : 0, Q = Z * 2 * Math.PI, se = ((_a3 = k.massParticipation) == null ? void 0 : _a3[ye]) || [
            0,
            0,
            0,
            0,
          ...
          for (let ze = 0; ze < 6; ze++) he[ze] += se[ze];
          const fe = se.map((ze) => ((ze * 100).toFixed(1) + "%").padStart(6)).join(" ");
          D.push(`${String(ye + 1).padStart(4)}  ${Z.toFixed(4).padStart(9)}  ${pe.toFixed(4).padStart(9)}  ${Q.toFixed(2).padStart(9)}  ${fe}  ${(he[0] * 100).toFixed(1).padStart(5)}%  ${(he[1] * 100).toFixed(1).padStart(5)}%  ${(he[5] * 100).toFixed(1).padStart(5)}%`);
...
`));
  ...
  function Ea(t) {
    ...
    const { nodes: h, elements: _, elementInputs: k, nodeInputs: Y, deformOutputs: R } = t, V = h.length * 6, j = _.length, D = _.filter((Q) => Q.length === 2).length, J = _.filter((Q) => Q.length >= 3).length, he = document.createElement("div");
    he.className = "rpt-overlay";
    let z = "";
    z += '<button class="rpt-close" id="rpt-close">\u2715 Close</button>', z += "<h1>Finite Element Analysis \u2014 Step-by-Step Report</h1>", z += '<div class="rpt-subtitle">Complete FEM derivation from element formulation to final results</div>', z += '<hr class="rpt-sep"/>', z += "<h2>1. Input Data</h2>", z += '<table class="rpt-info"><tbody>', z += `<tr><td>Number of nodes</td><td class="val">${h.length}</td></tr>`, z += `<tr><td>Number of elements</td><td class="val">${j} (${D} frames, ${J} shells)</td></tr>`, z += '<tr><td>DOFs per node</td><td class="val">6 (u<sub>x</sub>, u<sub>y</sub>, u<sub>z</sub>, \u03B8<sub>x</sub>, \u03B8<sub>y</sub>, \u03B8<sub>z</sub>)</td></tr>', z += `<tr><td>Total DOFs</td><td class="val">${V}</td></tr>`, z += "</tbody></table>", z += "<h3>1.1 Node Coordinates</h3>", z += '<table class="rpt-data"><thead><tr><th>Node</th><th>x</th><th>y</th><th>z</th></tr></thead><tbody>', h.forEach((Q, se) => {
      z += `<tr><td>${se}</td><td>${Xe(Q[0])}</td><td>${Xe(Q[1])}</td><td>${Xe(Q[2])}</td></tr>`;
    }), z += "</tbody></table>", z += "<h3>1.2 Element Connectivity</h3>", z += '<table class="rpt-data"><thead><tr><th>Elem</th><th>Type</th><th>Nodes</th><th>L</th><th>E</th><th>A</th><th>I<sub>z</sub></th><th>I<sub>y</sub></th></tr></thead><tbody>', _.forEach((Q, se) => {
      var _a3, _b2, _c2, _d2;
      const fe = Q.length === 2, ze = Q.map((Qe) => h[Qe]), He = fe ? vo(to(ze[1], ze[0])) : 0, Ae = ((_a3 = k.elasticities) == null ? void 0 : _a3.get(se)) ?? 0, Je = ((_b2 = k.areas) == null ? void 0 : _b2.get(se)) ?? 0, st = ((_c2 = k.momentsOfInertiaZ) == null ? void 0 : _c2.get(se)) ?? 0, je = ((_d2 = k.momentsOfInertiaY) == null ? void 0 : _d2.get(se)) ?? 0;
      z += `<tr><td>${se}</td><td>${fe ? "Frame" : "Shell"}</td><td>${Q.join(" \u2192 ")}</td>`, z += `<td>${Xe(He)}</td><td>${Xe(Ae)}</td><td>${Xe(Je)}</td><td>${Xe(st)}</td><td>${Xe(je)}</td></tr>`;
    ...
    for (let Q = 0; Q < j; Q++) {
      const se = _[Q], fe = se.map((Pt) => h[Pt]);
      if (!(se.length === 2)) continue;
      const He = vo(to(fe[1], fe[0])), Ae = ((_a2 = k.elasticities) == null ? void 0 : _a2.get(Q)) ?? 0, Je = ((_b = k.areas) == null ? void 0 : _b.get(Q)) ?? 0, st = ((_c = k.momentsOfInertiaZ) == null ? void 0 : _c.get(Q)) ?? 0, je = ((_d = k.momentsOfInertiaY) == null ? void 0 : _d.get(Q)) ?? 0, Qe = ((_e = k.shearModuli) == null ? void 0 : _e.get(Q)) ?? 0, we = ((_f = k.torsionalConstants) == null ? void 0 : _f.get(Q)) ?? 0;
      let Re = null, _e2 = null, et = null;
      try {
        Re = tn(fe, k, Q), _e2 = on(fe), et = jt(_n(_e2), jt(Re, _e2));
      } catch {
        continue;
      }
      const dt = to(fe[1], fe[0]), ot = dt[0] / He, ut = dt[1] / He, $t = dt[2] / He;
      z += '<div class="rpt-elem-block">', z += `<h3 class="rpt-elem-title" data-toggle="elem${Q}">\u25B6 Element ${Q} \u2014 Nodes ${se[0]} \u2192 ${se[1]}, L = ${Xe(He)}</h3>`, z += `<div id="rpt-elem${Q}" class="rpt-elem-body" style="display:none">`, z += "<h4>Properties (numerical substitution)</h4>", z += '<div class="rpt-eq-small">', z += `E = ${Xe(Ae)} &nbsp;&nbsp; A = ${Xe(Je)} &nbsp;&nbsp; I<sub>z</sub> = ${Xe(st)} &nbsp;&nbsp; I<sub>y</sub> = ${Xe(je)} &nbsp;&nbsp; G = ${Xe(Qe)} &nbsp;&nbsp; J = ${Xe(we)}<br/>`, z += `EA/L = ${Xe(Ae)}\xB7${Xe(Je)}/${Xe(He)} = <b>${Xe(Ae * Je / He)}</b><br/>`, z += `12EI<sub>z</sub>/L\xB3 = 12\xB7${Xe(Ae)}\xB7${Xe(st)}/${Xe(He)}\xB3 = <b>${Xe(12 * Ae * st / He ** 3)}</b><br/>`, z += `12EI<sub>y</sub>/L\xB3 = 12\xB7${Xe(Ae)}\xB7${Xe(je)}/${Xe(He)}\xB3 = <b>${Xe(12 * Ae * je / He ** 3)}</b><br/>`, z += `GJ/L = ${Xe(Qe)}\xB7${Xe(we)}/${Xe(He)} = <b>${Xe(Qe * we / He)}</b>`, z += "</div>", z += "<h4>Direction cosines</h4>", z += `<div class="rpt-eq-small">l = ${Qo(ot)}, m = ${Qo(ut)}, n = ${Qo($t)}, D = ${Qo(Math.sqrt(ot ** 2 + ut ** 2))}</div>`, z += "<h4>K<sub>local</sub> (12\xD712)</h4>", z += Fn(Re, 12), z += "<h4>T \u2014 Transformation (12\xD712)</h4>", z += Fn(_e2, 12), z += "<h4>K<sub>global</sub> = T\u1D40 \xB7 K<sub>local</sub> \xB7 T</h4>", z += Fn(et, 12), z += "<h4>Assembly</h4>", z += `<div class="rpt-eq-small">Global DOFs: node ${se[0]} \u2192 [${se[0] * 6}..${se[0] * 6 + 5}], node ${se[1]} \u2192 [${se[1] * 6}..${se[1] * 6 + 5}]</div>`, z += "</div></div>";
    }
    ...
    if (z += "<h3>5.1 Supports (fixed DOFs)</h3>", Y.supports && Y.supports.size > 0) {
      ...
      for (const Q of Z) z += `<th>${Q}</th>`;
      z += "</tr></thead><tbody>", Y.supports.forEach((Q, se) => {
        z += `<tr><td>${se}</td>`, Q.forEach((fe, ze) => {
          fe && ye.push(se * 6 + ze), z += `<td class="${fe ? "fixed" : ""}">${fe ? "Fixed" : "Free"}</td>`;
        }), z += "</tr>";
      }), z += "</tbody></table>";
    }
    if (z += `<div class="rpt-eq-small">Fixed DOFs: [${ye.join(", ")}] \u2192 ${ye.length} constraints<br/>`, z += `Free DOFs: ${V} \u2212 ${ye.length} = <b>${V - ye.length}</b></div>`, z += "<h3>5.2 Applied Loads</h3>", Y.loads && Y.loads.size > 0) {
      ...
      for (const se of Q) z += `<th>${se}</th>`;
      z += "</tr></thead><tbody>", Y.loads.forEach((se, fe) => {
        z += `<tr><td>${fe}</td>`, se.forEach((ze) => {
    ...
    if (z += "<h2>6. Solution</h2>", z += "<p>After removing fixed DOFs, the reduced system is:</p>", z += '<div class="rpt-eq rpt-eq-highlight">K<sub>free</sub> \xB7 u<sub>free</sub> = F<sub>free</sub></div>', z += "<p>Solved using LU decomposition with partial pivoting (sparse matrix).</p>", z += "<h3>6.1 Nodal Displacements</h3>", R == null ? void 0 : R.deformations) {
      z += '<table class="rpt-data"><thead><tr><th>Node</th>';
      for (const Q of Z) z += `<th>${Q}</th>`;
      z += "</tr></thead><tbody>", R.deformations.forEach((Q, se) => {
        z += `<tr><td>${se}</td>`, Q.forEach((fe) => {
          const ze = Math.abs(fe) > 1e-10;
          z += `<td class="${ze ? "nz" : ""}">${Xe(fe, 6)}</td>`;
        }), z += "</tr>";
      }), z += "</tbody></table>";
    }
    if (z += "<h3>6.2 Reactions</h3>", z += '<div class="rpt-eq">R = K<sub>total</sub> \xB7 u (extract at fixed DOFs)</div>', R == null ? void 0 : R.reactions) {
      z += '<table class="rpt-data"><thead><tr><th>Node</th>';
      for (const Q of Z) z += `<th>${Q}</th>`;
      z += "</tr></thead><tbody>", R.reactions.forEach((Q, se) => {
        z += `<tr><td>${se}</td>`, Q.forEach((fe) => {
          const ze = Math.abs(fe) > 1e-10;
          z += `<td class="${ze ? "nz-react" : ""}">${ze ? Xe(fe, 4) : "0"}</td>`;
        }), z += "</tr>";
      }), z += "</tbody></table>";
    }
    if (z += "<h2>7. Internal Forces</h2>", z += "<p>For each element, transform global displacements to local and multiply by K<sub>local</sub>:</p>", z += '<div class="rpt-eq">u<sub>local</sub> = T \xB7 u<sub>global</sub></div>', z += '<div class="rpt-eq rpt-eq-highlight">f<sub>local</sub> = K<sub>local</sub> \xB7 u<sub>local</sub></div>', R == null ? void 0 : R.deformations) {
      ...
      for (const se of Q) z += `<th>${se}<sub>i</sub></th>`;
      for (const se of Q) z += `<th>${se}<sub>j</sub></th>`;
      z += "</tr></thead><tbody>";
      for (let se = 0; se < j; se++) {
        const fe = _[se];
        if (fe.length !== 2) continue;
        const ze = fe.map((He) => h[He]);
        try {
          const He = tn(ze, k, se), Ae = on(ze), Je = [];
          for (const Qe of fe) {
          ...
          const st = jt(Ae, Je), je = jt(He, st);
          z += `<tr><td>${se}</td><td>${fe.join("\u2192")}</td>`;
  ...
  `;
    return he.innerHTML = pe + z, (_h = he.querySelector("#rpt-close")) == null ? void 0 : _h.addEventListener("click", () => he.remove()), he.querySelectorAll("[data-toggle]").forEach((Q) => {
      Q.addEventListener("click", () => {
        const se = Q.dataset.toggle, fe = he.querySelector(`#rpt-${se}`);
        if (fe) {
          const ze = fe.style.display !== "none";
          fe.style.display = ze ? "none" : "", Q.textContent = Q.textContent.replace(/^[▼▶]/, ze ? "\u25B6" : "\u25BC");
        }
      });
    }), he;
  }
  ...
  function ka() {
    ...
    for (const D of V) {
      ...
      for (let ye = 0; ye <= 80; ye++) {
        const pe = ye / 80, Q = 30 + pe * 540, se = 180 / 2 - D.fn(pe) * 60;
        J += (ye === 0 ? "M" : "L") + `${Q.toFixed(1)},${se.toFixed(1)}`;
      }
      j += `<path d="${J}" fill="none" stroke="${D.color}" stroke-width="2.5"/>`;
      const he = 0.75, z = 30 + he * 540 + 8, Z = 180 / 2 - D.fn(he) * 60 - 6;
      j += `<text x="${z}" y="${Z}" fill="${D.color}" font-size="11" font-weight="bold" font-family="sans-serif">${D.name}</text>`;
    }
    return j += "</svg>", j;
  }
  function za(t, h) {
    ...
    for (let V = 0; V < t.length; V++) {
      ...
      for (const D of j) for (const J of j) for (let he = 0; he < 6; he++) for (let z = 0; z < 6; z++) {
        const Z = D + he, ye = J + z;
        Z < k && ye < k && R[Z][ye]++;
      }
    }
    for (let V = 0; V < k; V++) {
      ...
      for (let j = 0; j < k; j++) {
        const D = R[V][j], J = D === 0 ? "#fff" : D === 1 ? "#e8f0fe" : D === 2 ? "#c6dcf5" : "#a0c4e8", he = D === 0 ? "" : D.toString();
        Y += `<td style="background:${J};color:#003366">${he}</td>`;
      }
      Y += "</tr>";
    }
  ...
  function Ta(t, h, _, k, Y, R) {
    ...
    const V = _[t], j = V.map((_e2) => h[_e2]), D = V.length === 2, J = D ? vo(to(j[1], j[0])) : 0, he = ((_a2 = k.elasticities) == null ? void 0 : _a2.get(t)) ?? 0, z = ((_b = k.areas) == null ? void 0 : _b.get(t)) ?? 0, Z = ((_c = k.momentsOfInertiaZ) == null ? void 0 : _c.get(t)) ?? 0, ye = ((_d = k.momentsOfInertiaY) == null ? void 0 : _d.get(t)) ?? 0, pe = ((_e = k.shearModuli) == null ? void 0 : _e.get(t)) ?? 0, Q = ((_f = k.torsionalConstants) == null ? void 0 : _f.get(t)) ?? 0;
    let se = null, fe = null, ze = null;
    try {
      se = tn(j, k, t), fe = on(j), ze = jt(_n(fe), jt(se, fe));
    } catch {
    }
    const He = D ? to(j[1], j[0]) : [
      ...
      0,
      0
    ], Ae = J > 0 ? He[0] / J : 0, Je = J > 0 ? He[1] / J : 0, st = J > 0 ? He[2] / J : 0, je = Math.sqrt(Ae ** 2 + Je ** 2), Qe = [];
  ...
  function Ca(t, h, _, k, Y, R) {
    ...
    <div class="er-body" id="er-body-tabla">${Aa(V)}</div>
  ...
  `, j.querySelectorAll(".er-tab").forEach((D) => {
      ...
      const D = j.classList.toggle("er-fullscreen-mode"), J = j.querySelector("#er-fullscreen");
      J && (J.textContent = D ? "\u22A1" : "\u26F6");
    }), setTimeout(() => {
      ...
      D && (D.innerHTML = Ls(V)), setTimeout(() => {
        ...
        J.addEventListener("click", () => {
          const he = J.dataset.toggle, z = j.querySelector(`#er-${he}`);
  ...
  function Ls(t) {
    ...
    const D = t.elem[0] * 6, J = t.elem[1] * 6;
    if (h += `<div class="er-eq">${k(`\\text{Nodo } ${t.elem[0]} \\rightarrow \\text{DOFs } [${D} \\ldots ${D + 5}]`)}</div>`, h += `<div class="er-eq">${k(`\\text{Nodo } ${t.elem[1]} \\rightarrow \\text{DOFs } [${J} \\ldots ${J + 5}]`)}</div>`, h += `<div class="er-eq">${k("\\mathbf{K}_{total}[\\text{DOFs}_i, \\text{DOFs}_j] \\mathrel{+}= \\mathbf{K}_{global}[i, j]")}</div>`, h += '<div class="er-section-title">9. Recuperacion de fuerzas internas</div>', h += `<div class="er-eq">${k("\\mathbf{u}_{local} = \\mathbf{T} \\cdot \\mathbf{u}_{global}")}</div>`, h += `<div class="er-eq er-eq-main">${k("\\mathbf{f}_{local} = \\mathbf{K}_{local} \\cdot \\mathbf{u}_{local}")}</div>`, t.fLocal.length > 0 && t.fLocal.some((he) => he !== 0)) {
      const he = [
        "N",
        "V<sub>y</sub>",
        "V<sub>z</sub>",
  ...
  function On(t) {
    ...
    const j = (D, J, he) => {
      h.strokeStyle = "#333", h.lineWidth = 1, h.strokeRect(Y, D, R, V), h.strokeStyle = "#444", h.beginPath(), h.moveTo(Y, D + V / 2), h.lineTo(Y + R, D + V / 2), h.stroke(), h.fillStyle = "#888", h.font = "11px sans-serif", h.fillText(J, Y + 4, D + 14);
      for (const Z of he) {
        h.strokeStyle = Z.color, h.lineWidth = 2.5, h.beginPath();
        for (let ye = 0; ye <= 100; ye++) {
          const pe = ye / 100, Q = Y + pe * R, se = D + V / 2 - Z.fn(pe) * (V / 2 * 0.85);
          ye === 0 ? h.moveTo(Q, se) : h.lineTo(Q, se);
        }
        h.stroke();
      }
      let z = Y + R - 90;
      for (const Z of he) h.fillStyle = Z.color, h.font = "bold 10px sans-serif", h.fillText(Z.label, z, D + V - 6), z += 36;
  ...
  `, document.body.appendChild(Wt);
    const D = Y - k.right, J = k.left, he = R - k.bottom, z = k.top;
    let Z = h.position || "bottom";
    Z === "bottom" && he < j + 20 && (Z = "top"), Z === "top" && z < j + 20 && (Z = "right"), Z === "right" && D < V + 20 && (Z = "left"), Z === "left" && J < V + 20 && (Z = "bottom");
    let ye, pe, Q = "";
    switch (Z) {
      case "bottom":
        ye = k.left + k.width / 2 - V / 2, pe = k.bottom + 14, Q = "position:absolute;top:-8px;left:50%;transform:translateX(-50%);width:0;height:0;border-left:8px solid transparent;border-right:8px solid transparent;border-bottom:8px solid #0099ff;";
        break;
      case "top":
        ye = k.left + k.width / 2 - V / 2, pe = k.top - j - 14, Q = "position:absolute;bottom:-8px;left:50%;transform:translateX(-50%);width:0;height:0;border-left:8px solid transparent;border-right:8px solid transparent;border-top:8px solid #0099ff;";
        break;
      case "right":
        ye = k.right + 14, pe = k.top + k.height / 2 - j / 2, Q = "position:absolute;left:-8px;top:50%;transform:translateY(-50%);width:0;height:0;border-top:8px solid transparent;border-bottom:8px solid transparent;border-right:8px solid #0099ff;";
        break;
      case "left":
        ye = k.left - V - 14, pe = k.top + k.height / 2 - j / 2, Q = "position:absolute;right:-8px;top:50%;transform:translateY(-50%);width:0;height:0;border-top:8px solid transparent;border-bottom:8px solid transparent;border-left:8px solid #0099ff;";
        break;
    }
    ye = Math.max(10, Math.min(ye, Y - V - 10)), pe = Math.max(10, Math.min(pe, R - j - 10)), Et = document.createElement("div"), Et.style.cssText = `
    position: fixed;
  ...
  `, Et.innerHTML = `
    ...
    <div style="margin-top:8px;display:flex;gap:3px;justify-content:center;">
      ${Bo.map((fe, ze) => `<div style="width:${ze === t ? "16px" : "6px"};height:6px;border-radius:3px;background:${ze === t ? "#0099ff" : ze < t ? "#004488" : "#333"};transition:all 0.3s;"></div>`).join("")}
    </div>
  `, document.body.appendChild(Et), (_a2 = Et.querySelector("#tour-next")) == null ? void 0 : _a2.addEventListener("click", () => {
    ...
    const se = (fe) => {
      ...
      (fe.key === "ArrowRight" || fe.key === "Enter") && (Fo(t + 1), document.removeEventListener("keydown", se)), fe.key === "ArrowLeft" && (Fo(Math.max(0, t - 1)), document.removeEventListener("keydown", se)), fe.key === "Escape" && (Rn(), document.removeEventListener("keydown", se));
    };
  ...
  function Ra(t) {
    ...
    const h = t.split(/\r?\n/), _ = {
      force: "TONF",
      length: "M"
    }, k = [], Y = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), V = /* @__PURE__ */ new Map(), j = [], D = [], J = /* @__PURE__ */ new Map(), he = /* @__PURE__ */ new Map(), z = [], Z = [];
    let ye = "", pe = "";
    const Q = /* @__PURE__ */ new Map();
    for (const me of h) {
      const Ee = me.trim();
      if (!Ee || Ee.startsWith("$")) {
        Ee.startsWith("$ ") && (pe = Ee.substring(2).trim());
        continue;
      }
      if (pe && (Q.has(pe) || Q.set(pe, []), Q.get(pe).push(me)), pe === "CONTROLS") {
        const le = Ee.match(/UNITS\s+"([^"]+)"\s+"([^"]+)"/);
        le && (_.force = le[1], _.length = le[2]);
        const Ce = Ee.match(/TITLE2\s+"([^"]+)"/);
        Ce && (ye = Ce[1]);
      }
      if (pe === "STORIES - IN SEQUENCE FROM TOP") {
        const le = Ee.match(/STORY\s+"([^"]+)"\s+(?:HEIGHT\s+([\d.]+)|ELEV\s+([-\d.]+))/);
        if (le) {
          const Ce = le[1], K = le[2] ? parseFloat(le[2]) : 0, ge = le[3] ? parseFloat(le[3]) : void 0;
          k.push({
            name: Ce,
            height: K,
            elev: ge ?? 0
      ...
      if (pe === "MATERIAL PROPERTIES") {
        const le = Ee.match(/MATERIAL\s+"([^"]+)"\s+(?:TYPE\s+"([^"]+)")?/);
        if (le) {
          const Ce = le[1];
          Y.has(Ce) || Y.set(Ce, {
            type: le[2] || "",
          ...
          const K = Y.get(Ce);
          le[2] && (K.type = le[2]);
          const ge = Ee.match(/\bE\s+([\d.eE+-]+)/);
          ge && (K.E = parseFloat(ge[1]));
          const Ne = Ee.match(/\bU\s+([\d.eE+-]+)/);
          Ne && (K.nu = parseFloat(Ne[1]), K.G = K.E / (2 * (1 + K.nu)));
          const ue = Ee.match(/\bFY\s+([\d.eE+-]+)/);
          ue && (K.fy = parseFloat(ue[1]));
          const qe = Ee.match(/\bFC\s+([\d.eE+-]+)/);
          qe && (K.fc = parseFloat(qe[1]));
          const Ue = Ee.match(/WEIGHTPERVOLUME\s+([\d.eE+-]+)/);
          Ue && (K.density = parseFloat(Ue[1]));
        }
      }
      if (pe === "FRAME SECTIONS") {
        const le = Ee.match(/FRAMESECTION\s+"([^"]+)"/);
        if (le) {
          const Ce = le[1];
          R.has(Ce) || R.set(Ce, {
            material: "",
          ...
          const K = R.get(Ce), ge = Ee.match(/MATERIAL\s+"([^"]+)"/);
          ge && (K.material = ge[1]);
          const Ne = Ee.match(/SHAPE\s+"([^"]+)"/);
          Ne && (K.shape = Ne[1]);
          const ue = Ee.match(/\bD\s+([\d.eE+-]+)/);
          ue && (K.D = parseFloat(ue[1]));
          const qe = Ee.match(/\bB\s+([\d.eE+-]+)/);
          qe && (K.B = parseFloat(qe[1]));
          const Ue = Ee.match(/\bTF\s+([\d.eE+-]+)/);
          Ue && (K.TF = parseFloat(Ue[1]));
          const Be = Ee.match(/\bTW\s+([\d.eE+-]+)/);
          Be && (K.TW = parseFloat(Be[1]));
          const We = Ee.match(/\bR\s+([\d.eE+-]+)/);
          We && (K.R = parseFloat(We[1]));
          const ft = Ee.match(/FILLMATERIAL\s+"([^"]+)"/);
          ft && (K.fillMaterial = ft[1]);
          const zt = Ee.match(/I2MOD\s+([\d.eE+-]+)/);
          zt && (K.modI2 = parseFloat(zt[1]));
          const Ve = Ee.match(/I3MOD\s+([\d.eE+-]+)/);
          Ve && (K.modI3 = parseFloat(Ve[1]));
        }
      }
      if (pe === "POINT COORDINATES") {
        const le = Ee.match(/POINT\s+"([^"]+)"\s+([-\d.eE+]+)\s+([-\d.eE+]+)/);
        le && V.set(le[1], [
          parseFloat(le[2]),
          parseFloat(le[3])
        ]);
      ...
      if (pe === "LINE CONNECTIVITIES") {
        const le = Ee.match(/LINE\s+"([^"]+)"\s+(COLUMN|BEAM|BRACE)\s+"([^"]+)"\s+"([^"]+)"\s+(\d+)/);
        le && j.push({
          name: le[1],
          type: le[2],
          pt1: le[3],
      ...
      if (pe === "POINT ASSIGNS") {
        const le = Ee.match(/POINTASSIGN\s+"([^"]+)"\s+"([^"]+)".*RESTRAINT\s+"([^"]+)"/);
        le && J.set(`${le[1]}@${le[2]}`, le[3].split(/\s+/));
      }
      if (pe === "LINE ASSIGNS") {
        const le = Ee.match(/LINEASSIGN\s+"([^"]+)"\s+"([^"]+)".*SECTION\s+"([^"]+)"/);
        if (le) {
          const Ce = {
            story: le[2],
            section: le[3],
            ...
            releases: [],
            angle: 0
          }, K = Ee.match(/RIGIDZONE\s+([\d.eE+-]+)/);
          K && (Ce.rigidZone = parseFloat(K[1]));
          const ge = Ee.match(/RELEASE\s+"([^"]+)"/);
          ge && (Ce.releases = ge[1].split(/\s+/));
          const Ne = Ee.match(/ANG\s+([-\d.eE+]+)/);
          Ne && (Ce.angle = parseFloat(Ne[1])), he.set(`${le[1]}@${le[2]}`, Ce);
        }
      }
      if (pe === "GRIDS") {
        const le = Ee.match(/^\s*GRID\s+"[^"]+"\s+LABEL\s+"([^"]+)"\s+DIR\s+"([XY])"\s+COORD\s+([-\d.eE+]+)/);
        le && Z.push({
          label: le[1],
          dir: le[2],
      ...
      if (pe === "FRAME OBJECT LOADS") {
        const le = Ee.match(/LINELOAD\s+"([^"]+)"\s+"([^"]+)"\s+TYPE\s+"([^"]+)"\s+DIR\s+"([^"]+)"\s+LC\s+"([^"]+)"\s+FVAL\s+([-\d.eE+]+)/);
        le && z.push({
          line: le[1],
          story: le[2],
          type: le[3],
      ...
      if (pe === "AREA CONNECTIVITIES") {
        const le = Ee.match(/AREA\s+"([^"]+)"\s+\d+\s+(.+)/);
        if (le) {
          const Ce = ((_a2 = le[2].match(/"([^"]+)"/g)) == null ? void 0 : _a2.map((K) => K.replace(/"/g, ""))) || [];
          D.push({
            name: le[1],
            pts: Ce,
            nStories: 0
    ...
    if (k.length > 0) {
      const me = k.length - 1;
      se.set(k[me].name, k[me].elev);
      for (let Ee = me - 1; Ee >= 0; Ee--) {
        const Ce = se.get(k[Ee + 1].name) + k[Ee].height;
        k[Ee].elev = Ce, se.set(k[Ee].name, Ce);
      }
    }
    const fe = [], ze = [], He = /* @__PURE__ */ new Map(), Ae = (me, Ee) => `${me}@${Ee}`, Je = /* @__PURE__ */ new Set(), st = /* @__PURE__ */ new Map();
    for (const me of j) st.set(me.name, me);
    for (const me of j) for (const [Ee, le] of he) {
      if (!Ee.startsWith(me.name + "@")) continue;
      const Ce = le.story, K = k.findIndex((ge) => ge.name === Ce);
      if (!(K < 0)) if (me.type === "COLUMN" || me.type === "BRACE") {
        Je.add(Ae(me.pt2, Ce));
        const ge = Math.max(me.nStories, 1), Ne = Math.min(K + ge, k.length - 1);
        Je.add(Ae(me.pt1, k[Ne].name));
      } else Je.add(Ae(me.pt1, Ce)), Je.add(Ae(me.pt2, Ce));
    }
    for (const [me] of J) Je.add(me);
    for (const me of Je) {
      const [Ee, le] = me.split("@"), Ce = V.get(Ee), K = se.get(le);
      Ce === void 0 || K === void 0 || (fe.push([
        Ce[0],
        Ce[1],
        K
      ]), ze.push(me), He.set(me, fe.length - 1));
    }
    const je = [], Qe = [], we = [], Re = [], _e = /* @__PURE__ */ new Map();
    for (const me of j) for (const [Ee, le] of he) {
      if (!Ee.startsWith(me.name + "@")) continue;
      const Ce = le.story, K = k.findIndex((Be) => Be.name === Ce);
      if (K < 0) continue;
      let ge, Ne;
      if (me.type === "COLUMN" || me.type === "BRACE") {
        const Be = Math.max(me.nStories, 1), We = Math.min(K + Be, k.length - 1);
        ge = Ae(me.pt1, k[We].name), Ne = Ae(me.pt2, Ce);
      } else ge = Ae(me.pt1, Ce), Ne = Ae(me.pt2, Ce);
      const ue = He.get(ge), qe = He.get(Ne);
      if (ue === void 0 || qe === void 0 || ue === qe) continue;
      const Ue = je.length;
      if (je.push([
        ue,
        qe
      ]), Qe.push(me.name), we.push(me.type), Re.push(Ce), _e.set(Ue, le.section), le.rigidZone > 0 && Pt.set(Ue, [
        le.rigidZone,
        le.rigidZone
        ...
        for (const We of le.releases) We === "TI" && (Be[0] = true), We === "M2I" && (Be[1] = true), We === "M3I" && (Be[2] = true), We === "TJ" && (Be[3] = true), We === "M2J" && (Be[4] = true), We === "M3J" && (Be[5] = true);
        Nt.set(Ue, Be);
      }
    }
    ...
    for (const [me, Ee] of _e) {
      const le = R.get(Ee);
      if (!le) continue;
      const Ce = Y.get(le.material);
      Ce && (et.set(me, Ce.E), dt.set(me, Ce.G));
      const K = le.D, ge = le.B, Ne = le.TF, ue = le.TW;
      let qe = 0, Ue = 0, Be = 0, We = 0, ft = 0, zt = 0, Ve = "rect";
      switch (le.shape) {
        case "Concrete Rectangular":
          qe = K * ge, Ue = ge * K ** 3 / 12, Be = K * ge ** 3 / 12, We = ge * K ** 3 * (1 / 3 - 0.21 * (K / ge) * (1 - K ** 4 / (12 * ge ** 4))), ft = zt = 5 / 6 * qe, Ve = "rect";
          break;
        case "Concrete Circle":
          qe = Math.PI * K ** 2 / 4, Ue = Be = Math.PI * K ** 4 / 64, We = Math.PI * K ** 4 / 32, ft = zt = 0.9 * qe, Ve = "circ";
          break;
        case "Steel I/Wide Flange":
          qe = 2 * ge * Ne + (K - 2 * Ne) * ue, Ue = (ge * K ** 3 - (ge - ue) * (K - 2 * Ne) ** 3) / 12, Be = (2 * Ne * ge ** 3 + (K - 2 * Ne) * ue ** 3) / 12, We = (2 * ge * Ne ** 3 + (K - 2 * Ne) * ue ** 3) / 3, ft = (K - 2 * Ne) * ue, zt = 2 * ge * Ne * 5 / 6, Ve = "I";
          break;
        case "Steel Tube":
          qe = K * ge - (K - 2 * ue) * (ge - 2 * ue), Ue = (ge * K ** 3 - (ge - 2 * ue) * (K - 2 * ue) ** 3) / 12, Be = (K * ge ** 3 - (K - 2 * ue) * (ge - 2 * ue) ** 3) / 12, We = 2 * ue * (K - ue) * (ge - ue) * ((K - ue) * (ge - ue)) / (K - ue + (ge - ue)), ft = 2 * K * ue, zt = 2 * ge * ue, Ve = "HSS";
          break;
        case "Filled Steel Tube":
          qe = K * ge, Ue = ge * K ** 3 / 12, Be = K * ge ** 3 / 12, We = 2 * ue * (K - ue) * (ge - ue) * ((K - ue) * (ge - ue)) / (K - ue + (ge - ue)), ft = 2 * K * ue + 5 / 6 * (K - 2 * ue) * (ge - 2 * ue), zt = 2 * ge * ue + 5 / 6 * (K - 2 * ue) * (ge - 2 * ue), Ve = "CFT";
          break;
        case "Steel Angle": {
          const Lt = Ne || ue;
          qe = Lt * (K + ge - Lt), Ue = Lt * (K ** 3 + ge * Lt ** 2 + Lt ** 2 * (K - Lt)) / 12, Be = Lt * (ge ** 3 + K * Lt ** 2 + Lt ** 2 * (ge - Lt)) / 12, We = (K + ge - Lt) * Lt ** 3 / 3, ft = K * Lt, zt = ge * Lt, Ve = "L";
          break;
        }
        case "Steel Channel":
        case "Cold Formed C":
          qe = 2 * ge * Ne + (K - 2 * Ne) * ue, Ue = (ue * K ** 3 + 2 * ge * Ne * (K - Ne) ** 2) / 12, Be = (2 * Ne * ge ** 3 + (K - 2 * Ne) * ue ** 3) / 12, We = (2 * ge * Ne ** 3 + (K - 2 * Ne) * ue ** 3) / 3, ft = (K - 2 * Ne) * ue, zt = 2 * ge * Ne * 5 / 6, Ve = le.shape === "Cold Formed C" ? "coldC" : "C";
          break;
        case "Steel Double Channel":
          qe = 2 * (2 * ge * Ne + (K - 2 * Ne) * ue), Ue = 2 * (ue * K ** 3 + 2 * ge * Ne * (K - Ne) ** 2) / 12, Be = 2 * (2 * Ne * ge ** 3 + (K - 2 * Ne) * ue ** 3) / 12, We = 2 * (2 * ge * Ne ** 3 + (K - 2 * Ne) * ue ** 3) / 3, ft = 2 * (K - 2 * Ne) * ue, zt = 4 * ge * Ne * 5 / 6, Ve = "2C";
          break;
        default:
          K > 0 && ge > 0 && (qe = K * ge, Ue = ge * K ** 3 / 12, Be = K * ge ** 3 / 12, We = Math.min(K, ge) * Math.max(K, ge) ** 3 / 3 * 0.3, ft = zt = 5 / 6 * qe);
          break;
      }
      le.modI2 && (Be *= le.modI2), le.modI3 && (Ue *= le.modI3), ot.set(me, qe), Tt.set(me, Ue), kt.set(me, Be), wt.set(me, We), ft > 0 && ut.set(me, ft), zt > 0 && $t.set(me, zt), Te.set(me, {
        type: Ve,
        b: ge || void 0,
        h: K || void 0,
        d: Ve === "circ" || Ve === "pipe" ? K : void 0,
        tw: ue || void 0,
        tf: Ne || void 0,
        r: le.R,
        name: Ee
    ...
    for (const [me, Ee] of J) {
      ...
      for (const K of Ee) K === "UX" && (Ce[0] = true), K === "UY" && (Ce[1] = true), K === "UZ" && (Ce[2] = true), K === "RX" && (Ce[3] = true), K === "RY" && (Ce[4] = true), K === "RZ" && (Ce[5] = true);
      vt.set(le, Ce);
    }
    const pt = /* @__PURE__ */ new Map(), Ct = /* @__PURE__ */ new Map();
    for (let me = 0; me < Qe.length; me++) Ct.set(`${Qe[me]}@${Re[me]}`, me);
    for (const me of z) {
      const Ee = Ct.get(`${me.line}@${me.story}`);
      if (Ee === void 0) continue;
      const [le, Ce] = je[Ee], K = fe[le], ge = fe[Ce], Ne = Math.sqrt((ge[0] - K[0]) ** 2 + (ge[1] - K[1]) ** 2 + (ge[2] - K[2]) ** 2);
      if (Ne < 1e-10) continue;
      const ue = me.val * Ne / 2;
      let qe = 0, Ue = 0, Be = 0;
      me.dir === "GRAV" || me.dir === "GRAVITY" ? Be = -ue : me.dir === "X" ? qe = ue : me.dir === "Y" ? Ue = ue : me.dir === "Z" && (Be = -ue);
      for (const We of [
        le,
        Ce
      ]) {
        ...
        ft[0] += qe, ft[1] += Ue, ft[2] += Be, pt.set(We, ft);
      }
    }
    ...
    for (const [me, Ee] of _e) {
      ...
      if (!le) continue;
      const Ce = Y.get(le.material);
      (Ce == null ? void 0 : Ce.density) && gt.set(me, Ce.density);
    }
    return {
      units: _,
      stories: k.reverse(),
...
`);
  ...
  function Da(t) {
    var _a2, _b;
    const { nodes: h, elements: _, nodeInputs: k, elementInputs: Y, title: R, units: V } = t, j = (V == null ? void 0 : V.force) || "TONF", D = (V == null ? void 0 : V.length) || "M", J = [], he = (we) => Math.round(we * 1e4) / 1e4;
    J.push("$ File exported from Awatif FEM Studio"), J.push(""), J.push("$ PROGRAM INFORMATION"), J.push('  PROGRAM  "AWATIF"  VERSION "1.0.0"  '), J.push(""), J.push("$ CONTROLS"), J.push(`  UNITS  "${j}"  "${D}"  "C"  `), R && J.push(`  TITLE2  "${R}"  `), J.push("");
    const z = /* @__PURE__ */ new Set();
    h.forEach((we) => z.add(he(we[1])));
    const Z = [
      ...z
    ].sort((we, Re) => we - Re), ye = [], pe = /* @__PURE__ */ new Map();
    ye.push("Base"), pe.set(Z[0], "Base");
    for (let we = 1; we < Z.length; we++) {
      const Re = `Level_${we}`;
      ye.push(Re), pe.set(Z[we], Re);
    }
    J.push("$ STORIES - IN SEQUENCE FROM TOP");
    for (let we = Z.length - 1; we >= 1; we--) J.push(`  STORY "${ye[we]}"  HEIGHT ${he(Z[we] - Z[we - 1])} MASTERSTORY "Yes"  `);
    Z.length > 0 && J.push(`  STORY "Base"  ELEV ${Z[0]} `), J.push(""), J.push("$ MATERIAL PROPERTIES");
    const Q = /* @__PURE__ */ new Set();
    (_a2 = Y.elasticities) == null ? void 0 : _a2.forEach((we) => Q.add(we));
    const se = /* @__PURE__ */ new Map();
    let fe = 0;
    for (const we of Q) {
      const Re = `Mat_${++fe}`;
      se.set(we, Re), J.push(`  MATERIAL  "${Re}"    TYPE "Concrete"    WEIGHTPERVOLUME 2.4`), J.push(`  MATERIAL  "${Re}"    SYMTYPE "Isotropic"  E ${we}  U 0.2  A 1E-05`);
    }
    J.push(""), J.push("$ FRAME SECTIONS");
    const ze = /* @__PURE__ */ new Set(), He = /* @__PURE__ */ new Map(), Ae = /* @__PURE__ */ new Map();
    _.forEach((we, Re) => {
      var _a3, _b2;
      if (we.length !== 2) return;
      const _e = (_a3 = Y.sectionShapes) == null ? void 0 : _a3.get(Re), et = ((_b2 = Y.elasticities) == null ? void 0 : _b2.get(Re)) ?? 0, dt = se.get(et) || "Mat_1", ot = (_e == null ? void 0 : _e.h) ?? 0, ut = (_e == null ? void 0 : _e.b) ?? 0, $t = (_e == null ? void 0 : _e.d) ?? 0, Pt = (_e == null ? void 0 : _e.tf) ?? 0, Nt = (_e == null ? void 0 : _e.tw) ?? 0, Tt = (_e == null ? void 0 : _e.type) || "rect", kt = `${Tt}_${ot}_${ut}_${$t}_${Pt}_${Nt}`;
      (_e == null ? void 0 : _e.name) && !Ae.has(kt) && Ae.set(kt, _e.name);
      let wt = Ae.get(kt);
      if (wt || (Tt === "rect" ? wt = `R${he(ut * 100)}x${he(ot * 100)}` : Tt === "circ" ? wt = `C_D${he($t * 100)}` : Tt === "I" ? wt = `I_${he(ot * 100)}` : wt = `Sec_${ze.size + 1}`, Ae.set(kt, wt)), He.set(Re, wt), ze.has(wt)) return;
      ze.add(wt);
      const vt = {
      ...
      ot && (pt += `  D ${ot}`), ut && (pt += `  B ${ut}`), $t && !ot && (pt += `  D ${$t}`), Pt && (pt += `  TF ${Pt}`), Nt && (pt += `  TW ${Nt}`), J.push(pt);
    }), J.push("");
    ...
    return _.forEach((we, Re) => {
      ...
      if (_e === "BEAM") {
        ...
        J.push(`  LINE  "E${Re + 1}"  BEAM  "${dt.pt}"  "${ot.pt}"  0`), Qe.push(`  LINEASSIGN  "E${Re + 1}"  "${dt.story}"  SECTION "${et}"  MINNUMSTA 3 AUTOMESH "YES"  MESHATINTERSECTIONS "YES"  `);
      } else {
        const dt = h[we[0]][1] <= h[we[1]][1] ? we[0] : we[1], ot = h[we[0]][1] <= h[we[1]][1] ? we[1] : we[0];
        je(dt);
        const ut = je(ot), $t = he(h[dt][1]), Pt = he(h[ot][1]), Nt = Z.indexOf($t), Tt = Z.indexOf(Pt), kt = Math.max(1, Tt >= 0 && Nt >= 0 ? Tt - Nt : 1);
        J.push(`  LINE  "E${Re + 1}"  ${_e}  "${ut.pt}"  "${ut.pt}"  ${kt}`);
    ...
    }), J.push(""), J.push("$ POINT ASSIGNS"), (_b = k.supports) == null ? void 0 : _b.forEach((we, Re) => {
      const _e = [];
      if (we[0] && _e.push("UX"), we[1] && _e.push("UY"), we[2] && _e.push("UZ"), we[3] && _e.push("RX"), we[4] && _e.push("RY"), we[5] && _e.push("RZ"), _e.length > 0) {
        const et = je(Re);
        J.push(`  POINTASSIGN  "${et.pt}"  "${et.story}"  RESTRAINT "${_e.join(" ")}"  `);
      }
    }), J.push(""), J.push("$ LINE ASSIGNS"), Qe.forEach((we) => J.push(we)), J.push(""), J.push("$ LOAD PATTERNS"), J.push('  LOADPATTERN "Dead"  TYPE  "Dead"  SELFWEIGHT  1'), J.push('  LOADPATTERN "Live"  TYPE  "Live"  SELFWEIGHT  0'), J.push(""), k.loads && k.loads.size > 0 && (J.push("$ POINT OBJECT LOADS"), k.loads.forEach((we, Re) => {
      const [_e, et, dt] = we, ot = je(Re);
      Math.abs(_e) > 1e-10 && J.push(`  POINTLOAD  "${ot.pt}"  "${ot.story}"  "Dead"  TYPE "FORCE"  FX ${_e}`), Math.abs(et) > 1e-10 && J.push(`  POINTLOAD  "${ot.pt}"  "${ot.story}"  "Dead"  TYPE "FORCE"  FY ${et}`), Math.abs(dt) > 1e-10 && J.push(`  POINTLOAD  "${ot.pt}"  "${ot.story}"  "Dead"  TYPE "FORCE"  FZ ${dt}`);
...
`);
  ...
  function Wa(t) {
    ...
    return R.push("# OpenSeesPy model exported from Awatif FEM Studio"), R.push(`# ${h.length} nodes, ${_.length} elements`), R.push(""), R.push("import openseespy.opensees as ops"), R.push(""), R.push("ops.wipe()"), R.push("ops.model('basic', '-ndm', 3, '-ndf', 6)"), R.push(""), R.push("# --- Nodes ---"), h.forEach((V, j) => {
      ...
      const D = h[V[0]], J = h[V[1]], z = Math.abs(J[2] - D[2]) > Math.max(Math.abs(J[0] - D[0]), Math.abs(J[1] - D[1])) ? 2 : 1, Z = ((_a3 = Y.areas) == null ? void 0 : _a3.get(j)) ?? 1, ye = ((_b2 = Y.elasticities) == null ? void 0 : _b2.get(j)) ?? 2e5, pe = ((_c = Y.shearModuli) == null ? void 0 : _c.get(j)) ?? 8e4, Q = ((_d = Y.torsionalConstants) == null ? void 0 : _d.get(j)) ?? 1, se = ((_e = Y.momentsOfInertiaY) == null ? void 0 : _e.get(j)) ?? 1, fe = ((_f = Y.momentsOfInertiaZ) == null ? void 0 : _f.get(j)) ?? 1;
      R.push(`ops.element('elasticBeamColumn', ${j + 1}, ${V[0] + 1}, ${V[1] + 1}, ${Z}, ${ye}, ${pe}, ${Q}, ${se}, ${fe}, ${z})`);
...
`);
  ...
  function Ya(t) {
    ...
    return R.push("# OpenSees Tcl model exported from Awatif FEM Studio"), R.push(`# ${h.length} nodes, ${_.length} elements`), R.push(""), R.push("wipe"), R.push("model basic -ndm 3 -ndf 6"), R.push(""), R.push("# --- Nodes ---"), h.forEach((V, j) => {
      ...
      if (V.length !== 2) return;
      const D = h[V[0]], J = h[V[1]], z = Math.abs(J[2] - D[2]) > Math.max(Math.abs(J[0] - D[0]), Math.abs(J[1] - D[1])) ? 2 : 1, Z = ((_a3 = Y.areas) == null ? void 0 : _a3.get(j)) ?? 1, ye = ((_b2 = Y.elasticities) == null ? void 0 : _b2.get(j)) ?? 2e5, pe = ((_c = Y.shearModuli) == null ? void 0 : _c.get(j)) ?? 8e4, Q = ((_d = Y.torsionalConstants) == null ? void 0 : _d.get(j)) ?? 1, se = ((_e = Y.momentsOfInertiaY) == null ? void 0 : _e.get(j)) ?? 1, fe = ((_f = Y.momentsOfInertiaZ) == null ? void 0 : _f.get(j)) ?? 1;
      R.push(`element elasticBeamColumn ${j + 1} ${V[0] + 1} ${V[1] + 1} ${Z} ${ye} ${pe} ${Q} ${se} ${fe} ${z}`);
...
`);
  ...
  function Ga(t) {
    const h = [], _ = [], k = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), V = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), he = /* @__PURE__ */ new Map(), z = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map();
    for (const ye of t.split(/\r?\n/)) {
      const pe = ye.trim(), Q = pe.match(/ops\.node\(\s*(\d+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)/);
      if (Q) {
        const He = parseInt(Q[1]), Ae = h.length;
        h.push([
          parseFloat(Q[2]),
          parseFloat(Q[3]),
          parseFloat(Q[4])
      ...
      const se = pe.match(/ops\.fix\(\s*(\d+)\s*,\s*(\d)\s*,\s*(\d)\s*,\s*(\d)\s*,\s*(\d)\s*,\s*(\d)\s*,\s*(\d)/);
      if (se) {
        const He = parseInt(se[1]), Ae = z.get(He);
        Ae !== void 0 && k.set(Ae, [
          se[2] === "1",
          se[3] === "1",
          se[4] === "1",
      ...
      const fe = pe.match(/ops\.element\(\s*'elasticBeamColumn'\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)/);
      if (fe) {
        const He = parseInt(fe[1]), Ae = z.get(parseInt(fe[2])), Je = z.get(parseInt(fe[3]));
        if (Ae !== void 0 && Je !== void 0) {
          const st = _.length;
          _.push([
            Ae,
            Je
          ]), Z.set(He, st), j.set(st, parseFloat(fe[4])), R.set(st, parseFloat(fe[5])), V.set(st, parseFloat(fe[6])), he.set(st, parseFloat(fe[7])), D.set(st, parseFloat(fe[8])), J.set(st, parseFloat(fe[9]));
        }
        continue;
      }
      const ze = pe.match(/ops\.load\(\s*(\d+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)/);
      if (ze) {
  ...
  function Ja(t) {
    const h = [], _ = [], k = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), V = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), he = /* @__PURE__ */ new Map(), z = /* @__PURE__ */ new Map();
    for (const Z of t.split(/\r?\n/)) {
      const ye = Z.trim();
      if (ye.startsWith("#") || ye.startsWith("//")) continue;
      const pe = ye.split(/\s+/);
      if (pe[0] === "node" && pe.length >= 5) {
        const Q = parseInt(pe[1]), se = h.length;
        h.push([
          parseFloat(pe[2]),
          parseFloat(pe[3]),
          parseFloat(pe[4])
      ...
      if (pe[0] === "element" && pe[1] === "elasticBeamColumn" && pe.length >= 12) {
        const Q = z.get(parseInt(pe[3])), se = z.get(parseInt(pe[4]));
        if (Q !== void 0 && se !== void 0) {
          const fe = _.length;
          _.push([
            Q,
            se
          ]), j.set(fe, parseFloat(pe[5])), R.set(fe, parseFloat(pe[6])), V.set(fe, parseFloat(pe[7])), he.set(fe, parseFloat(pe[8])), D.set(fe, parseFloat(pe[9])), J.set(fe, parseFloat(pe[10]));
        }
        continue;
      }
  ...
  el = function(t) {
    ...
    let z = "", Z = {}, ye = null, pe = "", Q = [], se = [], fe = /* @__PURE__ */ new Set(), ze = /* @__PURE__ */ new Set(), He = /* @__PURE__ */ new Set(), Ae = /* @__PURE__ */ new Map(), Je = /* @__PURE__ */ new Map(), st = null, je = [], Qe = 0.2, we = 2, Re = 2, _e = false, et = 2, dt = "x", ot = /* @__PURE__ */ new Set(), ut = true, $t = 0.15, Pt = 2, Nt = 2, Tt = /* @__PURE__ */ new Set();
    const kt = () => ({
      b: 0.3,
      h: 0.4,
      profileIdx: 0,
    ...
    let vt = 0, pt = 3, Ct = false, gt = 0, me = null, Ee = 0, le = [], Ce = 1, K = true;
    const ge = Sa();
    ...
    function sn(e, o, n) {
      ...
      for (const f of e) {
        const g = f.elev;
        $ ? (Oo(s - b, 0, g, c + b, 0, g, w, At), Bn(f.name, c + b * 1.5, 0, g, x, At)) : (Oo(s, a, g, c, a, g, w, At), Oo(c, a, g, c, i, g, w, At), Oo(c, i, g, s, i, g, w, At), Oo(s, i, g, s, a, g, w, At), Bn(f.name, s - b * 1.5, a, g, x, At));
      }
      At.traverse((f) => {
    ...
    const Ye = {
      ...
      refgrid(e, o, n) {
        ...
        zt(l, s, c), ue = l.map((a, i) => ({
          ...
          label: i === 0 ? "Base" : `P${i}`,
          elev: a
        })), Po(ue.map((a) => a.coord), qe.map((a) => a.coord), Ue, ue.map((a) => a.label), qe.map((a) => a.label));
        {
          const a = c.map((i, u) => ({
            name: u === 0 ? "Base" : `P${u}`,
          ...
          sn(a, ue.map((i) => i.coord), qe.map((i) => i.coord));
        }
      ...
      build(e) {
        var _a2;
        if (ue.length === 0 || Be.length < 2) {
          console.log("Error: call cad.refgrid() first to define axes and levels");
          return;
        }
        const o = (e == null ? void 0 : e.col) || "40x40", n = (e == null ? void 0 : e.viga) || "30x40", l = (e == null ? void 0 : e.fc) || 210, [s, c] = o.split("x").map((H) => parseFloat(H) / 100), [a, i] = n.split("x").map((H) => parseFloat(H) / 100), u = ue.map((H) => H.coord), d = qe.map((H) => H.coord), r = Be.map((H) => H.elev), b = u.length, $ = d.length, w = r.length, x = w - 1, f = [], g = {};
        for (let H = 0; H < w; H++) for (let ce = 0; ce < $; ce++) for (let de = 0; de < b; de++) g[`${de},${H},${ce}`] = f.length, f.push([
          u[de],
          r[H],
          d[ce]
        ]);
        const S = [], I = /* @__PURE__ */ new Set(), E = /* @__PURE__ */ new Set(), F = /* @__PURE__ */ new Map();
        for (let H = 0; H < x; H++) for (let ce = 0; ce < $; ce++) for (let de = 0; de < b; de++) {
          const ne = S.length;
          S.push([
            g[`${de},${H},${ce}`],
            g[`${de},${H + 1},${ce}`]
        ...
        for (let H = 1; H < w; H++) for (let ce = 0; ce < $; ce++) for (let de = 0; de < b - 1; de++) {
          const ne = S.length;
          S.push([
            g[`${de},${H},${ce}`],
            g[`${de + 1},${H},${ce}`]
          ]), E.add(ne), F.set(ne, H - 1);
        }
        for (let H = 1; H < w; H++) for (let ce = 0; ce < b; ce++) for (let de = 0; de < $ - 1; de++) {
          const ne = S.length;
          S.push([
            g[`${ce},${H},${de}`],
            g[`${ce},${H},${de + 1}`]
        ...
        if (y) {
          const H = y === "all" || y === "x" || y === "perimeter", ce = y === "all" || y === "y" || y === "perimeter";
          for (let de = 0; de < x; de++) {
            if (H) {
              for (let ne = 0; ne < $; ne++) if (!(y === "perimeter" && ne !== 0 && ne !== $ - 1)) for (let G = 0; G < b - 1; G++) {
                const be = S.length;
                S.push([
                  g[`${G},${de},${ne}`],
                  g[`${G + 1},${de + 1},${ne}`]
                ]), m.add(be), F.set(be, de);
              }
            }
            if (ce) {
              for (let ne = 0; ne < b; ne++) if (!(y === "perimeter" && ne !== 0 && ne !== b - 1)) for (let G = 0; G < $ - 1; G++) {
                const be = S.length;
                S.push([
                  g[`${ne},${de},${G}`],
                  g[`${ne},${de + 1},${G + 1}`]
        ...
        const p = 15100 * Math.sqrt(l) * 10, v = p / (2 * (1 + 0.2)), M = s * c, L = s * c ** 3 / 12, N = c * s ** 3 / 12, C = s * c * (s ** 2 + c ** 2) / 12, A = a * i, P = a * i ** 3 / 12, q = i * a ** 3 / 12, ee = a * i * (a ** 2 + i ** 2) / 12, U = /* @__PURE__ */ new Map(), ie = /* @__PURE__ */ new Map(), oe = /* @__PURE__ */ new Map(), X = /* @__PURE__ */ new Map(), re = /* @__PURE__ */ new Map(), Me = /* @__PURE__ */ new Map(), Fe = /* @__PURE__ */ new Map();
        for (let H = 0; H < S.length; H++) U.set(H, p), ie.set(H, v), I.has(H) ? (oe.set(H, M), X.set(H, L), re.set(H, N), Me.set(H, C), Fe.set(H, {
          type: "rect",
          b: s,
          h: c,
          name: `COL${o}`
        })) : m.has(H) ? (oe.set(H, M), X.set(H, L), re.set(H, N), Me.set(H, C), Fe.set(H, {
          type: "rect",
          b: s,
          h: c,
          name: `BR${o}`
        })) : (oe.set(H, A), X.set(H, P), re.set(H, q), Me.set(H, ee), Fe.set(H, {
          type: "rect",
          b: a,
          h: i,
          name: `V${n}`
        ...
        for (let H = 0; H < $; H++) for (let ce = 0; ce < b; ce++) Pe.set(g[`${ce},0,${H}`], [
          true,
          true,
          true,
          true,
        ...
        return t.nodes.val = f, t.elements.val = S, t.nodeInputs.val = {
          ...
          sectionShapes: Fe
        }, fe = I, ze = E, Ae = F, console.log(`Built: ${f.length} nodes, ${S.length} elements (${I.size} cols, ${E.size} beams, ${m.size} braces)`), console.log(`  Col: ${o}, Viga: ${n}, f'c=${l}${y ? `, braces=${y}` : ""}`), {
          nodes: f.length,
          elements: S.length
        };
      },
      addCol(e, o, n) {
        var _a2, _b, _c, _d, _e2, _f;
        const l = ue.findIndex((x) => x.label === e), s = qe.findIndex((x) => x.label === o);
        if (l < 0) {
          console.log(`Axis "${e}" not found. Available: ${ue.map((x) => x.label)}`);
          return;
        }
        if (s < 0) {
        ...
        const c = ue[l].coord, a = qe[s].coord, i = [
          ...t.nodes.val
        ], u = [
        ...
        for (const x of r) {
          ...
          u.push([
            f,
            g
          ]), fe.add(u.length - 1), Ae.set(u.length - 1, x - 1), w++;
        }
      ...
      addBeam(e, o, n, l, s) {
        var _a2;
        const c = ue.findIndex((F) => F.label === e), a = qe.findIndex((F) => F.label === o), i = ue.findIndex((F) => F.label === n), u = qe.findIndex((F) => F.label === l), d = Be.findIndex((F) => F.label === s);
        if (c < 0 || a < 0 || i < 0 || u < 0) {
        ...
        const r = ue[c].coord, b = qe[a].coord, $ = ue[i].coord, w = qe[u].coord, x = Be[d].elev, f = [
          ...t.nodes.val
        ], g = [
          ...((_a2 = t.elements) == null ? void 0 : _a2.val) || []
        ], S = (F, y, m) => {
        ...
        return g.push([
          I,
          E
        ]), ze.add(g.length - 1), Ae.set(g.length - 1, d - 1), t.nodes.val = f, t.elements.val = g, console.log(`Added beam ${e}-${o} \u2192 ${n}-${l} at ${s}`), g.length - 1;
      },
      addBrace(e, o, n, l, s, c) {
        var _a2;
        const a = ue.findIndex((p) => p.label === e), i = qe.findIndex((p) => p.label === o), u = Be.findIndex((p) => p.label === n), d = ue.findIndex((p) => p.label === l), r = qe.findIndex((p) => p.label === s), b = Be.findIndex((p) => p.label === c);
        if (a < 0 || i < 0 || u < 0) {
        ...
        const $ = ue[a].coord, w = qe[i].coord, x = Be[u].elev, f = ue[d].coord, g = qe[r].coord, S = Be[b].elev, I = [
          ...t.nodes.val
        ], E = [
          ...((_a2 = t.elements) == null ? void 0 : _a2.val) || []
        ], F = (p, v, M) => {
        ...
        return E.push([
          y,
          m
        ]), Ae.set(E.length - 1, Math.min(u, b)), t.nodes.val = I, t.elements.val = E, console.log(`Added brace ${e}-${o}@${n} \u2192 ${l}-${s}@${c}`), E.length - 1;
      },
      help() {
        return `=== CLI Commands ===
MODEL:
...
`;
      ...
      model3d(e) {
        ...
        const o = (e == null ? void 0 : e.bx) || [
          ...
          3,
          3
        ], s = (e == null ? void 0 : e.col) || "40x40", c = (e == null ? void 0 : e.viga) || "30x40", a = (e == null ? void 0 : e.fc) || 210, [i, u] = s.split("x").map((G) => parseFloat(G) / 100), [d, r] = c.split("x").map((G) => parseFloat(G) / 100), b = [
          0
        ];
        for (const G of o) b.push(b[b.length - 1] + G);
        const $ = [
          0
        ];
        for (const G of n) $.push($[$.length - 1] + G);
        const w = [
          0
        ];
        for (const G of l) w.push(w[w.length - 1] + G);
        const x = b.length, f = $.length, g = w.length, S = l.length, I = [], E = {};
        for (let G = 0; G < g; G++) for (let be = 0; be < f; be++) for (let ke = 0; ke < x; ke++) E[`${ke},${G},${be}`] = I.length, I.push([
          b[ke],
          w[G],
          $[be]
        ]);
        const F = [], y = /* @__PURE__ */ new Set(), m = /* @__PURE__ */ new Set(), p = /* @__PURE__ */ new Map();
        for (let G = 0; G < S; G++) for (let be = 0; be < f; be++) for (let ke = 0; ke < x; ke++) {
          const ae = F.length;
          F.push([
            E[`${ke},${G},${be}`],
            E[`${ke},${G + 1},${be}`]
        ...
        for (let G = 1; G < g; G++) for (let be = 0; be < f; be++) for (let ke = 0; ke < x - 1; ke++) {
          const ae = F.length;
          F.push([
            E[`${ke},${G},${be}`],
            E[`${ke + 1},${G},${be}`]
          ]), m.add(ae), p.set(ae, G - 1);
        }
        for (let G = 1; G < g; G++) for (let be = 0; be < x; be++) for (let ke = 0; ke < f - 1; ke++) {
          const ae = F.length;
          F.push([
            E[`${be},${G},${ke}`],
            E[`${be},${G},${ke + 1}`]
        ...
        const M = 15100 * Math.sqrt(a) * 10, L = M / (2 * (1 + 0.2)), N = i * u, C = i * u ** 3 / 12, A = u * i ** 3 / 12, P = i * u * (i ** 2 + u ** 2) / 12, q = d * r, ee = d * r ** 3 / 12, U = r * d ** 3 / 12, ie = d * r * (d ** 2 + r ** 2) / 12, oe = /* @__PURE__ */ new Map(), X = /* @__PURE__ */ new Map(), re = /* @__PURE__ */ new Map(), Me = /* @__PURE__ */ new Map(), Fe = /* @__PURE__ */ new Map(), Pe = /* @__PURE__ */ new Map(), H = /* @__PURE__ */ new Map();
        for (let G = 0; G < F.length; G++) oe.set(G, M), X.set(G, L), y.has(G) ? (re.set(G, N), Me.set(G, C), Fe.set(G, A), Pe.set(G, P), H.set(G, {
          type: "rect",
          b: i,
          h: u,
          name: `COL${s}`
        })) : (re.set(G, q), Me.set(G, ee), Fe.set(G, U), Pe.set(G, ie), H.set(G, {
          type: "rect",
          b: d,
          h: r,
          name: `V${c}`
        ...
        for (let G = 0; G < f; G++) for (let be = 0; be < x; be++) ce.set(E[`${be},0,${G}`], [
          true,
          true,
          true,
          true,
        ...
        t.nodes.val = I, t.elements.val = F, t.nodeInputs.val = {
          ...
          sectionShapes: H
        }, fe = y, ze = m, Ae = p, ue = b.map((G, be) => ({
          label: String.fromCharCode(65 + be),
          coord: G
        })), qe = $.map((G, be) => ({
          label: `${be + 1}`,
          coord: G
        })), Ue = w[w.length - 1], Po(ue.map((G) => G.coord), qe.map((G) => G.coord), Ue, ue.map((G) => G.label), qe.map((G) => G.label));
        {
          const G = w.map((be, ke) => ({
            name: ke === 0 ? "Base" : `P${ke}`,
            height: ke > 0 ? be - w[ke - 1] : 0,
            elev: be
          }));
          sn(G, b, $);
        }
        const de = ve.querySelector("#cad3d-axis-buttons");
        if (de) {
          de.style.display = "flex";
          const G = ue.map((ke) => ke.label), be = qe.map((ke) => ke.label);
          de.innerHTML = '<span style="font-size:10px;color:var(--cad-heading);margin-right:4px">Ejes:</span>';
          for (const ke of G) de.innerHTML += `<button class="axis-btn" data-axis="x" data-label="${ke}">${ke}</button>`;
          de.innerHTML += '<span style="margin:0 2px">|</span>';
          for (const ke of be) de.innerHTML += `<button class="axis-btn" data-axis="y" data-label="${ke}">${ke}</button>`;
        }
        const ne = ve.querySelector("#cad3d-floor-buttons");
        if (ne) {
          ne.style.display = "flex", ne.innerHTML = '<span style="font-size:10px;color:var(--cad-heading);margin-right:4px">Planta:</span>';
          for (let G = 0; G < S; G++) ne.innerHTML += `<button class="floor-btn" data-floor="${G}">P${G + 1}</button>`;
        }
      ...
      clear() {
        t.nodes.val = [], t.elements.val = [], t.nodeInputs && (t.nodeInputs.val = {}), t.elementInputs && (t.elementInputs.val = {}), fe = /* @__PURE__ */ new Set(), ze = /* @__PURE__ */ new Set(), Ae = /* @__PURE__ */ new Map(), Je = /* @__PURE__ */ new Map(), ue = [], qe = [], Ue = 0, Lt(), Hn(), ft();
      ...
      frame(e, o, n = 0, l = 0) {
        ...
        const b = [];
        fe = /* @__PURE__ */ new Set(), ze = /* @__PURE__ */ new Set();
        for (let x = 0; x < a.length - 1; x++) for (let f = 0; f < s.length; f++) u(f) || (fe.add(b.length), b.push([
          d[`${f},${x}`],
          d[`${f},${x + 1}`]
        ]));
      ...
      building(e, o, n, l = 3, s = 0, c = 0, a = 0, i = 0, u = 1) {
        ...
        const S = f.length, I = [];
        fe = /* @__PURE__ */ new Set(), ze = /* @__PURE__ */ new Set(), Ae = /* @__PURE__ */ new Map();
        const E = [];
        ...
        for (const { el: [p, v], floor: M } of E) {
          if (u <= 1) {
            fe.add(I.length), Ae.set(I.length, M), I.push([
              p,
              v
            ]);
            continue;
        ...
        for (const { el: [p, v], floor: M, dir: L, bay: N } of F) {
          const C = f[p], A = f[v];
          let P = p;
          for (let ee = 1; ee < l; ee++) {
            const U = ee / l, ie = f.length;
            f.push([
              C[0] + (A[0] - C[0]) * U,
              C[1] + (A[1] - C[1]) * U,
              C[2] + (A[2] - C[2]) * U
            ...
            const oe = I.length;
            ze.add(oe), Ae.set(oe, M), Je.set(oe, {
              dir: L,
              bay: N
            }), I.push([
              P,
        ...
        if (ot = /* @__PURE__ */ new Set(), _e && et > 0) {
          const p = (v, M, L) => {
            for (let C = 0; C < f.length; C++) if (Math.abs(f[C][0] - v) < 1e-6 && Math.abs(f[C][1] - M) < 1e-6 && Math.abs(f[C][2] - L) < 1e-6) return C;
            const N = f.length;
            return f.push([
              v,
              M,
          ...
          for (let v = 1; v < b.length; v++) if (dt === "x") for (let M = 0; M < r.length - 1; M++) {
            const L = r[M], N = r[M + 1];
            for (let C = 1; C <= et; C++) {
              const A = L + C / (et + 1) * (N - L), P = [];
              for (let q = 0; q < d.length; q++) P.push(p(d[q], A, b[v]));
              for (let q = 0; q < d.length - 1; q++) {
                const ee = I.length;
                ot.add(ee), ze.add(ee), Ae.set(ee, v - 1), Je.set(ee, {
                  dir: "x",
                  bay: q
                }), I.push([
                  P[q],
            ...
            for (let C = 1; C <= et; C++) {
              const A = L + C / (et + 1) * (N - L), P = [];
              for (let q = 0; q < r.length; q++) P.push(p(A, r[q], b[v]));
        ...
        for (const p of je) {
          ...
          for (const L of M) {
            ...
            const q = g[`${N},${C},${L}`], ee = g[`${N},${C},${L + 1}`];
            let U, ie;
            if (p.dir === "x" ? (U = g[`${A},${P},${L}`], ie = g[`${A},${P},${L + 1}`]) : (U = g[`${A},${P},${L}`], ie = g[`${A},${P},${L + 1}`]), q === void 0 || U === void 0 || ee === void 0 || ie === void 0) continue;
            const oe = Re, X = we, re = f[q], Me = f[U], Fe = f[ee], Pe = f[ie], H = [];
            for (let ce = 0; ce <= X; ce++) {
              const de = [], ne = ce / X;
              for (let G = 0; G <= oe; G++) {
                const be = G / oe, ke = (1 - ne) * ((1 - be) * re[0] + be * Me[0]) + ne * ((1 - be) * Fe[0] + be * Pe[0]), ae = (1 - ne) * ((1 - be) * re[1] + be * Me[1]) + ne * ((1 - be) * Fe[1] + be * Pe[1]), Le = (1 - ne) * ((1 - be) * re[2] + be * Me[2]) + ne * ((1 - be) * Fe[2] + be * Pe[2]);
                ce === 0 && G === 0 ? de.push(q) : ce === 0 && G === oe ? de.push(U) : ce === X && G === 0 ? de.push(ee) : ce === X && G === oe ? de.push(ie) : (de.push(f.length), f.push([
                  ke,
                  ae,
                  Le
                ]));
            ...
            for (let ce = 0; ce < X; ce++) for (let de = 0; de < oe; de++) {
              const ne = H[ce][de], G = H[ce][de + 1], be = H[ce + 1][de + 1], ke = H[ce + 1][de], ae = I.length;
              He.add(ae), Ae.set(ae, L), I.push([
                ne,
                G,
                be,
                ke
        ...
        if (Tt = /* @__PURE__ */ new Set(), ut) {
          const p = l, v = l, M = /* @__PURE__ */ new Map(), L = (N, C, A) => `${Math.round(N * 1e4)},${Math.round(C * 1e4)},${Math.round(A * 1e4)}`;
          ...
          for (let N = 1; N < b.length; N++) {
            ...
            for (let A = 0; A < d.length - 1; A++) for (let P = 0; P < r.length - 1; P++) {
              const q = d[A], ee = d[A + 1], U = r[P], ie = r[P + 1], oe = [];
              for (let X = 0; X <= v; X++) {
                const re = [];
                for (let Me = 0; Me <= p; Me++) {
                  const Fe = q + Me / p * (ee - q), Pe = U + X / v * (ie - U);
                  if (X === 0 && Me === 0) re.push(g[`${A},${P},${N}`]);
                  else if (X === 0 && Me === p) re.push(g[`${A + 1},${P},${N}`]);
                  else if (X === v && Me === 0) re.push(g[`${A},${P + 1},${N}`]);
                  else if (X === v && Me === p) re.push(g[`${A + 1},${P + 1},${N}`]);
                  else {
                    const H = L(Fe, Pe, C), ce = M.get(H);
                    if (ce !== void 0) re.push(ce);
                    else {
                      const de = f.length;
                      f.push([
                        Fe,
              ...
              for (let X = 0; X < v; X++) for (let re = 0; re < p; re++) {
                const Me = oe[X][re], Fe = oe[X][re + 1], Pe = oe[X + 1][re + 1], H = oe[X + 1][re], ce = I.length;
                Tt.add(ce), Ae.set(ce, N - 1), I.push([
                  Me,
                  Fe,
                  Pe,
                  H
      ...
      example(e) {
        ...
        switch (e) {
          ...
          case "edificio-acero": {
            ...
            const o = Q.reduce((l, s) => l + s, 0) / Q.length, n = se.reduce((l, s) => l + s, 0) / se.length;
          ...
          case "edificio-muros": {
            ...
            const o = Math.round(((_a2 = Z.nVanosX) == null ? void 0 : _a2.val) ?? 2), n = Math.round(((_b = Z.nVanosY) == null ? void 0 : _b.val) ?? 2);
            je = [
              {
                dir: "x",
                bay: 0,
          ...
          case "mezanine":
          case "mezzanine": {
            Ke("edificio"), Z.nPisos && (Z.nPisos.val = 1), Z.hPiso && (Z.hPiso.val = 4.5), Z.nVanosX && (Z.nVanosX.val = 3), Z.nVanosY && (Z.nVanosY.val = 2), Z.nSubViga && (Z.nSubViga.val = 3), Q = [
              6,
              6,
              6
            ], se = [
              5,
              5
            ], Te.colMat = 1, Te.vigaMat = 1, Te.steelColType = 0, Te.steelVigaType = 0, je = [], _e = true, et = 2, dt = Q[0] >= se[0] ? "y" : "x", ut = true, $t = 0.08, Pt = 3, Nt = 3, $e();
            break;
          }
          case "galpon": {
            Ke("galpon"), $e();
      ...
      set(e, o) {
        Z[e] ? (Z[e].val = o, console.log(`${e} = ${o}`), Gt(), $e()) : tt[e] ? (tt[e].val = o, console.log(`${e} = ${o}`), Gt(), $e()) : console.error(`Par\xE1metro "${e}" no encontrado. Disponibles: ${Object.keys({
          ...Z,
          ...tt
        }).join(", ")}`);
      },
...
Util:     cad.info()  cad.clear()  cad.help()
    ...
    function Ke(e) {
      ...
      if (e === "edificio") {
        ...
        Q = Array(l).fill(k.defaultSpan), se = Array(s).fill(k.defaultSpan * 0.8);
      }
      Gt(), setTimeout(() => {
        Hs(), $e();
      }, 50);
    ...
    function W(e) {
      var _a2, _b;
      return ((_a2 = Z[e]) == null ? void 0 : _a2.val) ?? ((_b = tt[e]) == null ? void 0 : _b.val) ?? 0;
    }
    function $e() {
      switch (z) {
        case "truss":
        ...
        case "galpon":
          Ye.galpon(W("span"), W("length"), W("height"), W("archRise"), Math.round(W("xDiv")), Math.round(W("yDiv")));
          break;
        case "barra":
          Cs();
          break;
      ...
      if (![
        ...
        if (V.size > 0 || j.size > 0 || D) {
          const o = t.elements.val, n = o.filter((l, s) => !(V.has(s) || j.has(s) || D && !J.has(s)));
    ...
    function Jn() {
      ...
      try {
        ...
        const S = Co(d, r, t.elementInputs.val, g);
    ...
    function Kn() {
      ...
      for (const C of d) for (const A of r) {
        ...
        for (let ee = 0; ee < f.length; ee++) {
          const U = Math.hypot(f[ee][0] - C, f[ee][1] - A);
          U < P && (P = U, q = ee);
        }
    ...
    function Un() {
      ...
      try {
        const m = Ht($, r, y, F), p = Co($, r, F, m), v = $.map((L) => [
          L[0],
          0,
          L[1]
        ]);
        ...
        if (t.nodeInputs) {
          const L = /* @__PURE__ */ new Map();
          x.forEach((C, A) => L.set(A, C));
          const N = /* @__PURE__ */ new Map();
          E.forEach((C, A) => N.set(A, [
            C[0],
            C[2],
            C[1],
            C[3],
    ...
    function Zn() {
      const e = W("H") || 4, o = W("B") || 3, n = W("tw") || 0.3, l = W("tb") || 0.4, s = W("meshSize") || 0.2, c = W("E") || 25e6, a = W("nu") || 0.2, i = c / (2 * (1 + a)), u = W("gamma") || 18, d = W("Ka") || 0.33, r = W("Es") || 5e4, b = W("nus") || 0.3, $ = r / (2 * (1 + b)), w = W("kn") || 1e6, x = W("ks") || 1e4, f = W("gammaW") || 9.81, g = W("Hw") || 3.5, S = W("qs") || 0, I = vt, E = o * 0.3, F = o * 0.7, y = [
        [
          -E,
          0,
          0
      ...
      if (I === 0) {
        ...
        for (let q = 0; q < m.length; q++) {
          const ee = m[q][0], U = m[q][1];
          Math.abs(ee - n) < s * 0.6 && U >= l - 1e-6 && P.push({
            idx: q,
            y: U
          });
        }
        P.sort((q, ee) => q.y - ee.y);
        for (let q = 0; q < P.length; q++) {
          const { idx: ee, y: U } = P[q], ie = l + e - U, oe = d * u * ie + d * S;
          let X = s;
          q > 0 && q < P.length - 1 ? X = (P[q + 1].y - P[q - 1].y) / 2 : q === 0 && P.length > 1 ? X = (P[1].y - P[0].y) / 2 : q === P.length - 1 && P.length > 1 && (X = (P[q].y - P[q - 1].y) / 2);
          const re = oe * X;
          Math.abs(re) > 1e-10 && M.set(ee, [
            re,
            0,
            0,
            0,
        ...
        L = {
          elasticities: new Map(p.map((q, ee) => [
            ee,
            c
          ])),
          elasticitiesOrthogonal: new Map(p.map((q, ee) => [
            ee,
            c
          ])),
          thicknesses: new Map(p.map((q, ee) => [
            ee,
            n
          ])),
          poissonsRatios: new Map(p.map((q, ee) => [
            ee,
            a
          ])),
          shearModuli: new Map(p.map((q, ee) => [
            ee,
            i
          ]))
        };
        ...
        if (I === 2) {
          ...
          ], ee = Math.max(3, Math.ceil((P - l) / s)), U = [];
          for (let ae = 0; ae <= ee; ae++) U.push([
            n,
            l + ae * (P - l) / ee,
            0
          ]);
          ...
          m = ie.nodes, p = ie.elements;
          const oe = s * 0.4, X = [];
          for (let ae = 0; ae < m.length; ae++) {
            const Le = m[ae][0], De = m[ae][1];
            Math.abs(Le - n) < oe && De >= l - oe && X.push(ae);
          }
          X.sort((ae, Le) => m[ae][1] - m[Le][1]);
          const re = [
            X[0]
          ];
          for (let ae = 1; ae < X.length; ae++) {
            const Le = m[X[ae]][1] - m[re[re.length - 1]][1];
            Math.abs(Le) > s * 0.05 && re.push(X[ae]);
          }
          ...
          for (let ae = 0; ae < Fe; ae++) {
            const Le = p[ae], De = (m[Le[0]][0] + m[Le[1]][0] + m[Le[2]][0]) / 3, lt = (m[Le[0]][1] + m[Le[1]][1] + m[Le[2]][1]) / 3, ht = De >= -E && De <= F && lt >= 0 && lt <= l, ko = De >= 0 && De <= n && lt >= l && lt <= l + e, ro = ht || ko;
          ...
          for (let ae = 0; ae < X.length - 1; ae++) {
            const Le = X[ae], De = X[ae + 1], lt = Me.get(Le), ht = Me.get(De);
            p.push([
              De,
              Le,
              lt,
          ...
          const ce = p.length - H, de = /* @__PURE__ */ new Map(), ne = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), be = /* @__PURE__ */ new Map(), ke = /* @__PURE__ */ new Map();
          for (let ae = 0; ae < Fe; ae++) Pe[ae] ? (de.set(ae, r), ne.set(ae, r), be.set(ae, b), ke.set(ae, $), G.set(ae, 1)) : (de.set(ae, c), ne.set(ae, c), be.set(ae, a), ke.set(ae, i), G.set(ae, 1));
          for (let ae = H; ae < p.length; ae++) de.set(ae, w), ne.set(ae, 0), be.set(ae, 0), ke.set(ae, x), G.set(ae, 0);
          L = {
            elasticities: de,
            elasticitiesOrthogonal: ne,
            thicknesses: G,
            poissonsRatios: be,
            shearModuli: ke
          };
          ...
          for (let ae = 0; ae < Fe; ae++) {
            if (!Pe[ae]) continue;
            const Le = p[ae], De = m[Le[0]], lt = m[Le[1]], ht = m[Le[2]], ko = Math.abs((lt[0] - De[0]) * (ht[1] - De[1]) - (ht[0] - De[0]) * (lt[1] - De[1])) / 2, ro = -u * ko / 3;
            for (const Kt of Le) {
              const Zt = M.get(Kt) || [
                0,
                0,
          ...
          if (S > 0) {
            ...
            for (let Le = 0; Le < m.length; Le++) {
              ...
              Math.abs(lt - P) < s * 0.1 && De > n - 1e-6 && ae.push({
                idx: Le,
                x: De
              });
            }
            ae.sort((Le, De) => Le.x - De.x);
            for (let Le = 0; Le < ae.length; Le++) {
              let De = s;
              Le > 0 && Le < ae.length - 1 ? De = (ae[Le + 1].x - ae[Le - 1].x) / 2 : Le === 0 && ae.length > 1 ? De = (ae[1].x - ae[0].x) / 2 : Le === ae.length - 1 && ae.length > 1 && (De = (ae[Le].x - ae[Le - 1].x) / 2);
              const lt = -S * De, ht = M.get(ae[Le].idx) || [
                0,
                0,
                0,
                0,
              ...
              ht[1] += lt, M.set(ae[Le].idx, ht);
            }
          }
          console.log(`  Interfaz Goodman: ${X.length} nodos interfaz, ${ce} elem interfaz, kn=${w}, ks=${x}`);
        } else {
          const q = [
            [
              -E,
          ...
          m = U.nodes, p = U.elements;
          const ie = (H) => {
            const ce = (m[H[0]][0] + m[H[1]][0] + m[H[2]][0]) / 3, de = (m[H[0]][1] + m[H[1]][1] + m[H[2]][1]) / 3, ne = ce >= -E && ce <= F && de >= 0 && de <= l, G = ce >= 0 && ce <= n && de >= l && de <= l + e;
            return ne || G;
          }, oe = /* @__PURE__ */ new Map(), X = /* @__PURE__ */ new Map(), re = /* @__PURE__ */ new Map(), Me = /* @__PURE__ */ new Map(), Fe = /* @__PURE__ */ new Map(), Pe = [];
          for (let H = 0; H < p.length; H++) {
            const ce = ie(p[H]);
            Pe.push(!ce), ce ? (oe.set(H, c), X.set(H, c), Me.set(H, a), Fe.set(H, i), re.set(H, 1)) : (oe.set(H, r), X.set(H, r), Me.set(H, b), Fe.set(H, $), re.set(H, 1));
          }
          L = {
            elasticities: oe,
          ...
          for (let H = 0; H < m.length; H++) {
            const ce = m[H][0], de = m[H][1];
            Math.abs(de) < 1e-6 ? v.set(H, [
              true,
              true,
              true,
              true,
          ...
          for (let H = 0; H < p.length; H++) {
            if (!Pe[H]) continue;
            const ce = p[H], de = m[ce[0]], ne = m[ce[1]], G = m[ce[2]], be = Math.abs((ne[0] - de[0]) * (G[1] - de[1]) - (G[0] - de[0]) * (ne[1] - de[1])) / 2, ke = -u * be / 3;
            for (const ae of ce) {
              const Le = M.get(ae) || [
                0,
                0,
          ...
          if (S > 0) {
            ...
            for (let ce = 0; ce < m.length; ce++) {
              const de = m[ce][0], ne = m[ce][1];
              Math.abs(ne - P) < s * 0.1 && de > n - 1e-6 && H.push({
                idx: ce,
                x: de
              });
            }
            H.sort((ce, de) => ce.x - de.x);
            for (let ce = 0; ce < H.length; ce++) {
              let de = s;
              ce > 0 && ce < H.length - 1 ? de = (H[ce + 1].x - H[ce - 1].x) / 2 : ce === 0 && H.length > 1 ? de = (H[1].x - H[0].x) / 2 : ce === H.length - 1 && H.length > 1 && (de = (H[ce].x - H[ce - 1].x) / 2);
              const ne = -S * de, G = M.get(H[ce].idx) || [
                0,
                0,
                0,
                0,
      ...
      if (I === 3) {
        ...
        m = A.nodes, p = A.elements;
        for (let ie = 0; ie < m.length; ie++) Math.abs(m[ie][1]) < 1e-6 && v.set(ie, [
          true,
          true,
          true,
          true,
        ...
        const P = l + e, q = Math.min(g, e), ee = P - q, U = [];
        for (let ie = 0; ie < m.length; ie++) {
          const oe = m[ie][0], X = m[ie][1];
          Math.abs(oe - n) < s * 0.6 && X >= l - 1e-6 && U.push({
            idx: ie,
            y: X
          });
        }
        U.sort((ie, oe) => ie.y - oe.y);
        for (let ie = 0; ie < U.length; ie++) {
          const { idx: oe, y: X } = U[ie], re = Math.max(0, P - X);
          if (re <= 0 || X < ee - 1e-6) continue;
          const Me = Math.min(re, q), Fe = f * Me;
          let Pe = s;
          ie > 0 && ie < U.length - 1 ? Pe = (U[ie + 1].y - U[ie - 1].y) / 2 : ie === 0 && U.length > 1 ? Pe = (U[1].y - U[0].y) / 2 : ie === U.length - 1 && U.length > 1 && (Pe = (U[ie].y - U[ie - 1].y) / 2);
          const H = Fe * Pe;
          Math.abs(H) > 1e-10 && M.set(oe, [
            H,
            0,
            0,
            0,
        ...
        L = {
          elasticities: new Map(p.map((ie, oe) => [
            oe,
            c
          ])),
          elasticitiesOrthogonal: new Map(p.map((ie, oe) => [
            oe,
            c
          ])),
          thicknesses: new Map(p.map((ie, oe) => [
            oe,
            n
          ])),
          poissonsRatios: new Map(p.map((ie, oe) => [
            oe,
            a
          ])),
          shearModuli: new Map(p.map((ie, oe) => [
            oe,
            i
          ]))
        };
      ...
      try {
        const A = Ht(m, p, N, L), P = p.filter((re) => re.length === 3), q = {};
        ...
        const ee = Co(m, P, q, A), U = m.map((re) => [
          re[0],
          0,
          re[1]
        ]);
        if (t.nodes.val = U, t.elements.val = P, A && A.deformations) {
          const re = /* @__PURE__ */ new Map();
          A.deformations.forEach((Me, Fe) => {
            re.set(Fe, [
              Me[0],
              Me[2],
              Me[1],
        ...
        v.forEach((re, Me) => ie.set(Me, re));
        const oe = /* @__PURE__ */ new Map();
        M.forEach((re, Me) => oe.set(Me, [
          re[0],
          re[2],
          re[1],
          re[3],
        ...
        let X = 0;
        A && A.deformations && A.deformations.forEach((re) => {
          const Me = Math.sqrt(re[0] * re[0] + re[1] * re[1] + re[2] * re[2]);
          X = Math.max(X, Me);
        }), console.log(`Muro Contencion [${C[I]}]: ${m.length} nodos, ${p.length} triangulos`), console.log(`  H=${e}, B=${o}, tw=${n}, tb=${l}, Ka=${d}, gamma=${u}, qs=${S}`), I === 1 && console.log(`  Es=${r}, nus=${b}`), I === 2 && console.log(`  Es=${r}, nus=${b}, kn=${w}, ks=${x}`), I === 3 && console.log(`  gammaW=${f}, Hw=${g}`), console.log(`  max|u| = ${X.toExponential(4)}`);
      } catch (A) {
    ...
    function Qn() {
      const e = W("Lx") || 2, o = W("Ly") || 2, n = W("t") || 0.5, l = W("colA") || 0.4, s = W("colH") || 1.5, c = Math.round(W("nx") || 8), a = Math.round(W("ny") || 8), i = W("E") || 25e6, u = W("nu") || 0.2, d = W("P") || -500, r = W("Mx") || 0, b = W("My") || 0, $ = W("ks") || 2e4, w = e / c, x = o / a, f = e / 2, g = o / 2, S = l / 2, I = [];
      for (let v = 0; v <= a; v++) for (let M = 0; M <= c; M++) {
        const L = v * (c + 1) + M;
        let N = w, C = x;
        (M === 0 || M === c) && (N = w / 2), (v === 0 || v === a) && (C = x / 2), I.push({
          node: L,
          dof: 0,
          k: $ * N * C
        });
      ...
      if (Math.abs(r) > 1e-6) {
        ...
        for (let L = 0; L <= a; L++) for (let N = 0; N <= c; N++) {
          const C = N * w, A = L * x;
          if (Math.abs(C - f) <= S + 1e-6 && Math.abs(A - g) <= S + 1e-6) {
            const P = A - g;
            if (Math.abs(P) > 1e-6) {
              const q = P > 0 ? 1 : -1;
              y.push({
      ...
      try {
        ...
        const N = v.elementResults.map((ee) => [
          ...ee.nodes
        ]);
        N.push([
          L,
        ...
        const A = /* @__PURE__ */ new Map();
        v.nodeResults.forEach((ee, U) => {
          const ie = ee.x, oe = ee.y;
          (ie < 1e-6 || ie > e - 1e-6 || oe < 1e-6 || oe > o - 1e-6) && A.set(U, [
            false,
            false,
            true,
            false,
        ...
        if (P.set(L + 4, [
          ...
          const ee = v.elementResults.length, U = /* @__PURE__ */ new Map(), ie = /* @__PURE__ */ new Map(), oe = /* @__PURE__ */ new Map();
    ...
    function es() {
      ...
      for (let C = 0; C < m.length; C++) {
        ...
        for (const [q, ee] of S) {
          const U = Math.sqrt((A - q) * (A - q) + (P - ee) * (P - ee));
          U >= f * 0.7 && U <= f * 1.5 && p.set(C, [
            true,
            true,
            true,
            false,
      ...
      for (let C = 0; C < m.length; C++) {
        const A = m[C][0], P = m[C][1];
        Math.abs(A - w) <= g && Math.abs(P - x) <= g && M++;
      }
      const L = b / Math.max(M, 1);
      for (let C = 0; C < m.length; C++) {
        const A = m[C][0], P = m[C][1];
        if (Math.abs(A - w) <= g && Math.abs(P - x) <= g) {
          const q = v.get(C) || [
            0,
            0,
            0,
    ...
    function ts() {
      const e = W("colB") || 0.3, o = W("colH") || 0.3, n = W("colT") || 8e-3, l = W("colLen") || 1.5, s = W("Lx") || 0.45, c = W("Ly") || 0.45, a = W("tPlaca") || 0.025, i = W("dBolt") || 0.022, u = W("sx") || 0.32, d = W("sy") || 0.32, r = Math.round(W("nSubColV") || 6), b = Math.round(W("nSubColH") || 4), $ = Math.round(W("nSubPlaca") || 10), w = W("E") || 2e8, x = W("nu") || 0.3, f = w / (2 * (1 + x)), g = W("P") || -300, S = s / 2, I = c / 2, E = i / 2, F = e / 2, y = o / 2, m = [], p = [], v = $, M = s / v, L = c / v, N = (ne, G) => G * (v + 1) + ne;
      for (let ne = 0; ne <= v; ne++) for (let G = 0; G <= v; G++) m.push([
        G * M,
        ne * L,
        0
      ]);
      const C = [
        ...
        for (const [be, ke] of C) if ((ne - be) * (ne - be) + (G - ke) * (G - ke) < E * E) return true;
        return false;
      }, P = p.length;
      for (let ne = 0; ne < v; ne++) for (let G = 0; G < v; G++) {
        const be = (G + 0.5) * M, ke = (ne + 0.5) * L;
        A(be, ke) || p.push([
          N(G, ne),
          N(G + 1, ne),
          N(G + 1, ne + 1),
      ...
      const q = p.length - P, ee = r, U = b, ie = [
        [
          S - F,
          I - y
        ],
        ...
        for (let be = 0; be < (v + 1) * (v + 1); be++) if (Math.abs(m[be][0] - ne) < M * 0.3 && Math.abs(m[be][1] - G) < L * 0.3 && Math.abs(m[be][2]) < 1e-6) return be;
        return -1;
      };
      for (const [ne, G] of X) {
        const [be, ke] = ie[ne], [ae, Le] = ie[G], De = [];
        for (let lt = 0; lt <= ee; lt++) {
          const ht = [], ko = lt / ee * l;
          for (let ro = 0; ro <= U; ro++) {
            const Kt = ro / U, Zt = be + Kt * (ae - be), Tn = ke + Kt * (Le - ke);
            if (lt === 0) {
              const Qt = re(Zt, Tn);
              if (Qt >= 0) {
                ht.push(Qt);
            ...
            Cn >= 0 ? ht.push(Cn) : (ht.push(m.length), m.push([
              Zt,
              Tn,
              ko
            ]));
        ...
        for (let lt = 0; lt < ee; lt++) for (let ht = 0; ht < U; ht++) p.push([
          De[lt][ht],
          De[lt][ht + 1],
          De[lt + 1][ht + 1],
          De[lt + 1][ht]
      ...
      const Me = p.length - oe, Fe = /* @__PURE__ */ new Map();
      for (let ne = 0; ne < (v + 1) * (v + 1); ne++) {
        const G = m[ne][0], be = m[ne][1];
        for (const [ke, ae] of C) {
          const Le = Math.sqrt((G - ke) * (G - ke) + (be - ae) * (be - ae));
          Le >= E * 0.5 && Le <= E * 2 && Fe.set(ne, [
            true,
            true,
            true,
            true,
      ...
      for (let ne = 0; ne < m.length; ne++) Math.abs(m[ne][2] - l) < 1e-6 && H.push(ne);
      const ce = g / Math.max(H.length, 1);
      for (const ne of H) Pe.set(ne, [
        0,
        0,
        ce,
        0,
      ...
      for (let ne = P; ne < P + q; ne++) de.elasticities.set(ne, w), de.poissonsRatios.set(ne, x), de.thicknesses.set(ne, a), de.shearModuli.set(ne, f);
      for (let ne = oe; ne < oe + Me; ne++) de.elasticities.set(ne, w), de.poissonsRatios.set(ne, x), de.thicknesses.set(ne, n), de.shearModuli.set(ne, f);
      ...
      try {
        ...
        t.nodes.val = m, t.elements.val = p, ne && t.deformOutputs && (t.deformOutputs.val = ne), t.nodeInputs && (t.nodeInputs.val = {
          supports: Fe,
          loads: Pe
        }), t.elementInputs && (t.elementInputs.val = de), G && t.analyzeOutputs && (t.analyzeOutputs.val = G);
        let be = 0;
        (ne == null ? void 0 : ne.deformations) && ne.deformations.forEach((ke) => {
          const ae = Math.sqrt(ke[0] * ke[0] + ke[1] * ke[1] + ke[2] * ke[2]);
          be = Math.max(be, ae);
        }), console.log(`  max|u| = ${be.toExponential(4)}`);
      } catch (ne) {
        console.warn("Col+Placa failed:", ne.message), t.nodes.val = m, t.elements.val = p, t.nodeInputs && (t.nodeInputs.val = {
          supports: Fe,
          loads: Pe
        });
      }
    ...
    function $o() {
      ...
      if (!o) return;
      o.style.display = "";
      const n = k, l = Math.round(((_a2 = Z.nPisos) == null ? void 0 : _a2.val) ?? 3), s = qs(), c = Fs(), a = Q.length || 1, i = se.length || 1;
      ...
      for (let m = 0; m < l; m++) {
        ...
        if (Te.colMat === 0) if (Te.colShape === 1) {
          ...
          const L = +fo(1e8).toFixed(0), N = +fo(3e8).toFixed(0), C = Math.max(1, Math.round((N - L) / 200));
          v.addBinding(M, "Es", {
            min: L,
            max: N,
            step: C,
            ...
            ((_a3 = A.target) == null ? void 0 : _a3.key) === "bc" && (p.colBc = rt(A.value), $e()), ((_b = A.target) == null ? void 0 : _b.key) === "hc" && (p.colHc = rt(A.value), $e()), ((_c = A.target) == null ? void 0 : _c.key) === "t" && (p.colT = rt(A.value), $e()), ((_d = A.target) == null ? void 0 : _d.key) === "Es" && (p.colEs = dn(A.value), $e()), ((_e2 = A.target) == null ? void 0 : _e2.key) === "nuS" && (p.colNuS = A.value, $e()), ((_f = A.target) == null ? void 0 : _f.key) === "fc" && (p.colFc = dn(A.value), $e()), ((_g = A.target) == null ? void 0 : _g.key) === "nuC" && (p.colNuC = A.value, $e());
          });
        }
      ...
      const I = Q.length || 1, E = se.length || 1, F = I + 1, y = E + 1;
      if (I > 0) {
        const m = g.addFolder({
        ...
        for (let p = 0; p < I; p++) for (let v = 0; v < y; v++) {
          const M = `wx_${p}_${v}`, L = je.some((A) => A.dir === "x" && A.bay === p && A.axisIdx === v), N = {};
          N[M] = L;
      ...
      if (E > 0) {
        ...
        for (let p = 0; p < E; p++) for (let v = 0; v < F; v++) {
          const M = `wy_${p}_${v}`, L = je.some((A) => A.dir === "y" && A.bay === p && A.axisIdx === v), N = {};
          N[M] = L;
    ...
    function Gt() {
      ...
      if (n) {
        const s = {};
        for (const a of n) s[a.key] = Z[a.key].val;
        ...
        for (const a of n) {
          ...
          c.addBinding(i, "min", {
            ...
            Z[a.key] && (Z[a.key].min = i.min, Z[a.key].max = i.max, Z[a.key].val < i.min && (Z[a.key].val = i.min), Z[a.key].val > i.max && (Z[a.key].val = i.max)), Gt(), $e();
          });
        }
        ye.on("change", (a) => {
          var _a2;
          ...
          if (i && Z[i]) {
            if (Z[i].val = a.value, z === "edificio" && (i === "nVanosX" || i === "nVanosY" || i === "nPisos")) {
              if (i === "nVanosX" || i === "nVanosY") {
                const u = Math.round(Z.nVanosX.val), d = Math.round(Z.nVanosY.val);
                for (; Q.length < u; ) Q.push(Q[Q.length - 1] ?? k.defaultSpan);
                for (Q.length > u && (Q.length = u); se.length < d; ) se.push(se[se.length - 1] ?? k.defaultSpan * 0.8);
      ...
      if (z === "edificio") {
        ...
        if (s) {
          ...
          for (let r = 0; r < Q.length; r++) i[`svx_${r + 1}`] = Q[r];
          for (let r = 0; r < Q.length; r++) a.addBinding(i, `svx_${r + 1}`, {
            min: c.spanRange[0],
            max: c.spanRange[1],
            step: c.spanRange[2],
            label: `svx${r + 1}`
          ...
          a.on("change", (r) => {
            ...
            $ && (Q[parseInt($[1]) - 1] = r.value, $e());
          });
          const u = Ut.addFolder({
            title: "Luces Y",
            expanded: true
          }), d = {};
          for (let r = 0; r < se.length; r++) d[`svy_${r + 1}`] = se[r];
          for (let r = 0; r < se.length; r++) u.addBinding(d, `svy_${r + 1}`, {
            min: c.spanRange[0],
            max: c.spanRange[1],
            step: c.spanRange[2],
            label: `svy${r + 1}`
  ...
  `;
    ...
    function Ns() {
      ...
      if (u && u.size > 0 && (a.push(`## REACTIONS (${u.size} supports)`), a.push("# node          Rx           Ry           Rz           Mx           My           Mz"), u.forEach((d, r) => {
        ...
        a.push("## CLI COMMAND");
        const d = Object.entries(Z).map(([r, b]) => `${r}=${b.val}`).join(" ");
...
`);
    ...
    function mn() {
      Ee && (cancelAnimationFrame(Ee), Ee = 0), le.length > 0 && (t.nodes.val = le.map((e) => [
        ...e
      ])), ge.div.style.display = "none", me = null;
    }
    function _o() {
      var _a2;
      if (Ee && cancelAnimationFrame(Ee), !(me == null ? void 0 : me.modeShapes) || !le.length) return;
      const e = me.modeShapes[gt];
      if (!e) return;
      const o = ((_a2 = me.frequencies) == null ? void 0 : _a2[gt]) || 1, n = Math.max(0.5, Math.min(3, o * 0.1)), l = performance.now(), s = le.length, c = t.elements.rawVal, { extent: a } = no(), i = ve.querySelector("#cad3d-modal-scale"), u = i && parseFloat(i.value) || 5;
      let d = 0;
      for (let E = 0; E < s; E++) {
    ...
    function bn() {
      ...
      if (!n.loads || n.loads.size === 0) {
        const x = W("CM") ?? 0, f = W("CV") ?? 0, g = x + f, S = W("Ex") ?? 0, I = W("Ey") ?? 0;
        if (g === 0 && S === 0 && I === 0) return;
        const E = /* @__PURE__ */ new Map(), F = [];
        for (let A = 0; A < e.length; A++) n.supports.has(A) || F.push(A);
        const y = (A) => Math.round(A * 1e3) / 1e3, m = /* @__PURE__ */ new Set();
        n.supports.forEach((A, P) => {
          m.add(`${y(e[P][0])},${y(e[P][1])}`);
        });
        const p = /* @__PURE__ */ new Set();
        for (const A of F) m.has(`${y(e[A][0])},${y(e[A][1])}`) && p.add(A);
        const v = /* @__PURE__ */ new Set(), M = /* @__PURE__ */ new Set();
        if (S !== 0 || I !== 0) {
          let A = -1 / 0, P = -1 / 0;
          for (const ee of p) A = Math.max(A, y(e[ee][0])), P = Math.max(P, y(e[ee][1]));
          const q = /* @__PURE__ */ new Map();
          for (const ee of p) {
            const U = y(e[ee][2]);
            q.has(U) || q.set(U, []), q.get(U).push(ee);
          }
          q.forEach((ee) => {
            if (S !== 0) {
              const U = /* @__PURE__ */ new Set();
              for (const ie of ee) if (y(e[ie][0]) === A) {
                const oe = y(e[ie][1]);
                U.has(oe) || (U.add(oe), v.add(ie));
              }
            }
            if (I !== 0) {
              const U = /* @__PURE__ */ new Set();
              for (const ie of ee) if (y(e[ie][1]) === P) {
                const oe = y(e[ie][0]);
                U.has(oe) || (U.add(oe), M.add(ie));
              }
            }
          });
        }
        ...
        for (let A = 0; A < o.length; A++) {
          ...
          if (!(Math.abs(q) < 1e-15)) {
            if (P.length === 2) {
              const ee = ((_b = l.areas) == null ? void 0 : _b.get(A)) ?? 0, U = e[P[0]], ie = e[P[1]], oe = Math.sqrt((ie[0] - U[0]) ** 2 + (ie[1] - U[1]) ** 2 + (ie[2] - U[2]) ** 2), re = -(q * ee * oe * L) / 2;
              N.set(P[0], (N.get(P[0]) ?? 0) + re), N.set(P[1], (N.get(P[1]) ?? 0) + re);
            } else if (P.length >= 3) {
              const ee = ((_c = l.thicknesses) == null ? void 0 : _c.get(A)) ?? 0;
              let U = 0;
              if (P.length === 3) {
                const [X, re, Me] = P.map((Fe) => e[Fe]);
                U = 0.5 * Math.abs((re[0] - X[0]) * (Me[1] - X[1]) - (Me[0] - X[0]) * (re[1] - X[1]));
              } else if (P.length === 4) {
                const [X, re, Me, Fe] = P.map((Pe) => e[Pe]);
                if (U = 0.5 * Math.abs((re[0] - X[0]) * (Me[1] - X[1]) - (Me[0] - X[0]) * (re[1] - X[1])) + 0.5 * Math.abs((Me[0] - X[0]) * (Fe[1] - X[1]) - (Fe[0] - X[0]) * (Me[1] - X[1])), U < 1e-10) {
                  const Pe = [
                    re[0] - X[0],
                    re[1] - X[1],
                    re[2] - X[2]
        ...
        for (const A of F) {
          const P = v.has(A) ? S : 0, q = M.has(A) ? I : 0, ee = N.get(A) ?? 0, U = C.has(A) ? g : 0, ie = ee + U;
          (P !== 0 || q !== 0 || Math.abs(ie) > 1e-10) && E.set(A, [
            P,
            q,
            ie,
            0,
      ...
      try {
        ...
        if (x) {
          ...
          const F = performance.now(), y = Co(e, o, l, x), m = performance.now() - F;
      ...
      window.__femLog = $, console.log(`FEM Solver: ${e.length}n ${o.length}e \u2192 ${(performance.now() - s).toFixed(0)}ms`), Ct && setTimeout(() => un(), 50);
    }
    function gn(e, o) {
    ...
    function oo() {
      ...
      if ((z === "edificio" || z === "frame") && fe.size > 0) {
        ...
        for (let f = 0; f < e.length; f++) {
          ...
          const g = fe.has(f), S = Ae.get(f) ?? 0, I = u[S] ?? u[0] ?? {
            bCol: 0.4,
            hCol: 0.4,
            dCol: 0.4
          };
          ...
          if (g) if (s === 0) F = d, y = r, m = b, E = a === 1 ? ls(I.dCol) : gn(I.bCol, I.hCol), n.sectionShapes.set(f, a === 1 ? {
            ...
            if (v <= 1) {
              ...
              const M = I.colBf ?? 0.3, L = I.colHf ?? 0.3, N = I.colTf ?? 0.02, C = I.colTw ?? 0.012;
              E = hn(M, L, N, C);
              const A = `I${(L * 100).toFixed(0)}x${(M * 100).toFixed(0)}`;
              n.sectionShapes.set(f, {
                type: "I",
                b: M,
                h: L,
              ...
              E = xn(M, L, N);
              const C = `\u25A1${(L * 100).toFixed(0)}x${(M * 100).toFixed(0)}x${(N * 1e3).toFixed(0)}`;
              n.sectionShapes.set(f, {
                type: "HSS",
                b: M,
                h: L,
            ...
            const v = I.colBc ?? 0.3, M = I.colHc ?? 0.3, L = I.colT ?? 0.01, N = I.colFc ?? 28e3, C = I.colEs ?? 2e8, A = I.colNuS ?? 0.3;
            I.colNuC;
            const P = Rs(v, M, L, C, A, N);
            E = {
              A: P.A,
              Iz: P.Iz,
              Iy: P.Iy,
            ...
            m = (q * P.A_steel + ee * P.A_conc) / (P.A_steel + P.A_conc);
            const U = `CFT ${(M * 1e3).toFixed(0)}X${(v * 1e3).toFixed(0)}X${(L * 1e3).toFixed(0)}`;
            n.sectionShapes.set(f, {
              type: "CFT",
              b: v,
              h: M,
            ...
            if (c === 0) F = d, y = r, m = b, E = gn(L.b, L.h), n.sectionShapes.set(f, {
              ...
              if (N <= 1) {
                const C = po[L.profileIdx ?? 0] ?? po[0];
                E = {
                  A: C.A,
                  Iz: C.Iz,
                  Iy: C.Iy,
                ...
                const C = L.bf ?? 0.2, A = L.hf ?? 0.4, P = L.tf ?? 0.015, q = L.tw ?? 0.01;
                E = hn(C, A, P, q);
                const ee = `I${(A * 100).toFixed(0)}x${(C * 100).toFixed(0)}`;
                n.sectionShapes.set(f, {
                  type: "I",
                  b: C,
                  h: A,
                ...
                const C = L.bc ?? 0.2, A = L.hc ?? 0.3, P = L.t ?? 8e-3;
                E = xn(C, A, P);
    ...
    setTimeout(() => {
      ...
      function s(y) {
        fe = /* @__PURE__ */ new Set(), ze = /* @__PURE__ */ new Set(), Ae = /* @__PURE__ */ new Map(), Je = /* @__PURE__ */ new Map();
        const m = /* @__PURE__ */ new Map();
        for (let q = 0; q < y.stories.length; q++) m.set(y.stories[q].name, q);
        for (let q = 0; q < y.elementTypes.length; q++) {
          const ee = y.elementTypes[q], U = y.elementStories[q], ie = m.get(U) ?? 0;
          Ae.set(q, ie), ee === "COLUMN" || ee === "BRACE" ? fe.add(q) : ze.add(q);
        }
        z = "edificio";
        const p = y.grids.filter((q) => q.dir === "X").sort((q, ee) => q.coord - ee.coord), v = y.grids.filter((q) => q.dir === "Y").sort((q, ee) => q.coord - ee.coord);
        let M, L, N, C;
        if (p.length > 0 || v.length > 0) M = p.map((q) => q.coord), L = v.map((q) => q.coord), N = p.map((q) => q.label), C = v.map((q) => q.label);
        else {
          const q = new Set(y.nodes.map((U) => U[0])), ee = new Set(y.nodes.map((U) => U[1]));
          M = [
            ...q
          ].sort((U, ie) => U - ie), L = [
            ...ee
          ].sort((U, ie) => U - ie), N = M.map((U, ie) => String(ie + 1)), C = L.map((U, ie) => String.fromCharCode(65 + ie));
        }
        const A = y.stories.length > 0 ? Math.max(...y.stories.map((q) => q.elev)) : Math.max(...y.nodes.map((q) => q[2]));
        ue = M, qe = L, Ue = A, setTimeout(() => {
          yt(), Po(M, L, A, N, C), sn(y.stories, M, L), vn(), yn();
        }, 100);
        const P = {
          COLUMN: 0,
          BEAM: 0,
        ...
        console.log(`E2K grids: X=[${N.join(",")}] Y=[${C.join(",")}]`), console.log(`E2K stories: ${y.stories.map((q) => `${q.name}@${q.elev.toFixed(2)}`).join(", ")}`), console.log(`E2K elements: ${P.COLUMN} columns, ${P.BEAM} beams, ${P.BRACE} braces`), Ge();
      }
      function c(y, m) {
        const p = new Blob([
          y
      ...
      i && (i.value = _, i.addEventListener("change", (y) => {
        ...
        y.addEventListener("click", (m) => {
          ...
          v && (h = v.force, _ = v.length, Y = v.stress, k = xo(h, _), a && (a.value = h), i && (i.value = _), ve.querySelectorAll("[data-preset]").forEach((M) => {
        ...
        var _a3, _b2;
        y.stopPropagation(), Ct = !Ct, (_a3 = ve.querySelector("#cad3d-modal")) == null ? void 0 : _a3.classList.toggle("active", Ct);
        ...
        if (Ct) {
          const N = Ze();
          ((_b2 = N == null ? void 0 : N.settings) == null ? void 0 : _b2.loads) && (K = N.settings.loads.rawVal, N.settings.loads.val = false), un(), p.style.display = "", v.style.display = "", M.style.display = "", L && (L.style.display = ""), u();
          ...
          var _a4;
          const N = Ze();
          ((_a4 = N == null ? void 0 : N.settings) == null ? void 0 : _a4.loads) && K && (N.settings.loads.val = true);
        }, 600);
      });
      function u() {
        var _a3;
        const y = ve.querySelector("#cad3d-mode-label");
        if (!y || !(me == null ? void 0 : me.frequencies)) return;
        const m = me.frequencies[gt], p = m > 0 ? 1 / m : 0, v = [
          0,
          0,
          0,
          0,
        ...
        for (let M = 0; M <= gt; M++) {
          const L = (_a3 = me.massParticipation) == null ? void 0 : _a3[M];
      ...
      (_n2 = ve.querySelector("#cad3d-mode-prev")) == null ? void 0 : _n2.addEventListener("click", (y) => {
        if (y.stopPropagation(), !(me == null ? void 0 : me.modeShapes)) return;
        gt = (gt - 1 + me.modeShapes.length) % me.modeShapes.length;
        const m = me.modeShapes[gt], { extent: p } = no();
        let v = 0;
        for (let M = 0; M < le.length; M++) {
          const L = m[M * 6] || 0, N = m[M * 6 + 1] || 0, C = m[M * 6 + 2] || 0;
          v = Math.max(v, Math.sqrt(L * L + N * N + C * C));
        }
        Ce = v > 1e-12 ? p * 0.05 / v : 1, _o(), u();
      }), (_o2 = ve.querySelector("#cad3d-mode-next")) == null ? void 0 : _o2.addEventListener("click", (y) => {
        if (y.stopPropagation(), !(me == null ? void 0 : me.modeShapes)) return;
        gt = (gt + 1) % me.modeShapes.length;
        const m = me.modeShapes[gt], { extent: p } = no();
        let v = 0;
        for (let M = 0; M < le.length; M++) {
          const L = m[M * 6] || 0, N = m[M * 6 + 1] || 0, C = m[M * 6 + 2] || 0;
      ...
      d == null ? void 0 : d.addEventListener("mousedown", (y) => y.stopPropagation()), d == null ? void 0 : d.addEventListener("change", () => {
        Ct && (me == null ? void 0 : me.modeShapes) && _o();
      });
...
`);
    ...
    function so(e) {
      ...
      if (e === "3d") {
        ...
        if (e === "plan") o.renderer.clippingPlanes = [], u(new Se(n.x, n.y, n.z + l * 2), new Se(n.x, n.y, n.z), new Se(0, 1, 0));
          ...
          const d = parseInt(e.split(":")[1]), r = ((_a2 = Z.hPiso) == null ? void 0 : _a2.val) ?? 3, b = (d + 1) * r, $ = r * 0.45;
          ...
          const d = parseInt(e.split(":")[1]), r = ue[d] ?? n.x;
          if (qe.length > 1) {
            const $ = rs(ue, d, l);
            o.renderer.clippingPlanes = [
    ...
    function yn() {
      ...
      if (!e) return;
      const o = Math.round(((_a2 = Z.nPisos) == null ? void 0 : _a2.val) ?? 0);
      if (o < 1) {
        e.style.display = "none";
        return;
      }
...
${d.join(", ")}`);
        ...
        D = true, J.clear(), nt.forEach((n) => J.add(n)), nt.clear(), lo(), io(), $e();
      }), o.querySelector("#sel-showall").addEventListener("click", () => {
        j.clear(), D = false, J.clear(), io(), $e();
    ...
    function Ys(e) {
      ...
      if (It === "arc") {
        ...
        if (o === at || o === _t) return;
        const n = t.nodes.val, l = new Se(...n[at]), s = new Se(...n[_t]), c = new Se(...n[o]), a = Math.max(4, Math.round(((_a2 = Z.nSubViga) == null ? void 0 : _a2.val) ?? 8)), i = ms(l, s, c, a);
        So();
        const u = [
          ...t.nodes.val
        ], d = [
    ...
    function Gs(e, o, n, l, s, c, a) {
      const i = `${Ie(O("E") + "\xB7" + O("A"), O("L"))}`, u = `${Ie("12\xB7" + O("E") + "\xB7" + O("I", "z"), O("L") + "\xB3")}`, d = `${Ie("12\xB7" + O("E") + "\xB7" + O("I", "y"), O("L") + "\xB3")}`, r = `${Ie(O("G") + "\xB7" + O("J"), O("L"))}`, b = `${Ie("4\xB7" + O("E") + "\xB7" + O("I", "y"), O("L"))}`, $ = `${Ie("4\xB7" + O("E") + "\xB7" + O("I", "z"), O("L"))}`;
      ...
      <div>${i} = ${Ie(te(e) + "\xB7" + te(o), te(a))} = <span class="highlight">${te(e * o / a)}</span></div>
      <div>${u} = ${Ie("12\xB7" + te(e) + "\xB7" + te(n), te(a) + "\xB3")} = <span class="highlight">${te(12 * e * n / a ** 3)}</span></div>
      <div>${d} = ${Ie("12\xB7" + te(e) + "\xB7" + te(l), te(a) + "\xB3")} = <span class="highlight">${te(12 * e * l / a ** 3)}</span></div>
      <div>${r} = ${Ie(te(s) + "\xB7" + te(c), te(a))} = <span class="highlight">${te(s * c / a)}</span></div>
      <div>${b} = ${Ie("4\xB7" + te(e) + "\xB7" + te(l), te(a))} = <span class="highlight">${te(4 * e * l / a)}</span></div>
      <div>${$} = ${Ie("4\xB7" + te(e) + "\xB7" + te(n), te(a))} = <span class="highlight">${te(4 * e * n / a)}</span></div>
    </div>
    <div class="fem-eq">
      ${O("k", "local")} = <span class="mat-sym" style="grid-template-columns:repeat(4,auto)">
        <span class="cell">${Ie(O("EA"), O("L"))}</span><span class="cell">0</span><span class="cell dots">\u22EF</span><span class="cell">${Ie("\u2212" + O("EA"), O("L"))}</span>
        <span class="cell">0</span><span class="cell">${Ie("12" + O("EI", "z"), O("L") + "\xB3")}</span><span class="cell dots">\u22EF</span><span class="cell">0</span>
    ...
    function Js(e) {
      if (e.length === 2) {
        ...
        <div>${O("l")} = cos(\u03B1) = ${Ie("\u0394x", O("L"))} = ${Ie(te(n[0]), te(l))} = <span class="highlight">${te(s)}</span></div>
        <div>${O("m")} = cos(\u03B2) = ${Ie("\u0394y", O("L"))} = ${Ie(te(n[1]), te(l))} = <span class="highlight">${te(c)}</span></div>
        <div>${O("n")} = cos(\u03B3) = ${Ie("\u0394z", O("L"))} = ${Ie(te(n[2]), te(l))} = <span class="highlight">${te(a)}</span></div>
      </div>
      <div class="fem-eq">
        \u03BB = <span class="mat-sym" style="grid-template-columns:repeat(3,auto)">
          ...
          <span class="cell">${Ie("\u2212" + O("m"), O("D"))}</span><span class="cell">${Ie(O("l"), O("D"))}</span><span class="cell">0</span>
          <span class="cell">${Ie("\u2212" + O("l") + "\xB7" + O("n"), O("D"))}</span><span class="cell">${Ie("\u2212" + O("m") + "\xB7" + O("n"), O("D"))}</span><span class="cell">${O("D")}</span>
        </span>
    ...
    function Ks(e) {
      ...
      <div>\u03C3 = ${Ie("1", "2" + O("A"))} \xB7 ${O("D")} \xB7 ${O("B")} \xB7 ${O("u")}</div>
      <div>${O("N", "xx")} = \u03C3<sub>xx</sub> \xB7 ${O("t")} &nbsp;&nbsp; ${O("M", "xx")} = \u03C3<sub>xx</sub> \xB7 ${Ie(O("t") + "\xB3", "12")}</div>
    </div>`;
    }
    function zn(e, o) {
      const n = e.length;
    ...
    function gs() {
      const e = "0", o = Ie(O("EA"), O("L")), n = Ie("\u2212" + O("EA"), O("L")), l = Ie("12" + O("EI", "z"), O("L") + "\xB3"), s = Ie("\u221212" + O("EI", "z"), O("L") + "\xB3"), c = Ie("12" + O("EI", "y"), O("L") + "\xB3"), a = Ie("\u221212" + O("EI", "y"), O("L") + "\xB3"), i = Ie("6" + O("EI", "z"), O("L") + "\xB2"), u = Ie("\u22126" + O("EI", "z"), O("L") + "\xB2"), d = Ie("6" + O("EI", "y"), O("L") + "\xB2"), r = Ie("\u22126" + O("EI", "y"), O("L") + "\xB2"), b = Ie(O("GJ"), O("L")), $ = Ie("\u2212" + O("GJ"), O("L")), w = Ie("4" + O("EI", "z"), O("L")), x = Ie("2" + O("EI", "z"), O("L")), f = Ie("4" + O("EI", "y"), O("L")), g = Ie("2" + O("EI", "y"), O("L")), S = '<span style="color:var(--fem-eq-dots);font-style:italic">sym</span>', I = [
        "P\u2081",
        "P\u2082",
        "P\u2083",
        "P\u2084",
    ...
    function Us(e, o, n, l, s, c, a) {
      return `<div class="coeff-grid">${[
        {
          name: `${Ie(O("E") + "\xB7" + O("A"), O("L"))}`,
          calc: `${Ie(te(e) + "\xD7" + te(o), te(a))}`,
          val: e * o / a,
          label: "Axial"
        },
        {
          name: `${Ie("12\xB7" + O("E") + "\xB7" + O("I", "z"), O("L") + "\xB3")}`,
          calc: `${Ie("12\xD7" + te(e) + "\xD7" + te(n), te(a) + "\xB3")}`,
          val: 12 * e * n / a ** 3,
          label: "Corte Y"
        },
        {
          name: `${Ie("6\xB7" + O("E") + "\xB7" + O("I", "z"), O("L") + "\xB2")}`,
          calc: `${Ie("6\xD7" + te(e) + "\xD7" + te(n), te(a) + "\xB2")}`,
          val: 6 * e * n / a ** 2,
          label: "Corte-Momento Z"
        },
        {
          name: `${Ie("12\xB7" + O("E") + "\xB7" + O("I", "y"), O("L") + "\xB3")}`,
          calc: `${Ie("12\xD7" + te(e) + "\xD7" + te(l), te(a) + "\xB3")}`,
          val: 12 * e * l / a ** 3,
          label: "Corte Z"
        },
        {
          name: `${Ie("6\xB7" + O("E") + "\xB7" + O("I", "y"), O("L") + "\xB2")}`,
          calc: `${Ie("6\xD7" + te(e) + "\xD7" + te(l), te(a) + "\xB2")}`,
          val: 6 * e * l / a ** 2,
          label: "Corte-Momento Y"
        },
        {
          name: `${Ie(O("G") + "\xB7" + O("J"), O("L"))}`,
          calc: `${Ie(te(s) + "\xD7" + te(c), te(a))}`,
          val: s * c / a,
          label: "Torsi\xF3n"
        },
        {
          name: `${Ie("4\xB7" + O("E") + "\xB7" + O("I", "z"), O("L"))}`,
          calc: `${Ie("4\xD7" + te(e) + "\xD7" + te(n), te(a))}`,
          val: 4 * e * n / a,
          label: "Flexi\xF3n Z (4EI/L)"
        },
        {
          name: `${Ie("2\xB7" + O("E") + "\xB7" + O("I", "z"), O("L"))}`,
          calc: `${Ie("2\xD7" + te(e) + "\xD7" + te(n), te(a))}`,
          val: 2 * e * n / a,
          label: "Flexi\xF3n Z (2EI/L)"
        },
        {
          name: `${Ie("4\xB7" + O("E") + "\xB7" + O("I", "y"), O("L"))}`,
          calc: `${Ie("4\xD7" + te(e) + "\xD7" + te(l), te(a))}`,
          val: 4 * e * l / a,
          label: "Flexi\xF3n Y (4EI/L)"
        },
        {
          name: `${Ie("2\xB7" + O("E") + "\xB7" + O("I", "y"), O("L"))}`,
          calc: `${Ie("2\xD7" + te(e) + "\xD7" + te(l), te(a))}`,
          val: 2 * e * l / a,
    ...
    function hs(e) {
      ...
      if (c) {
        const m = vo(to(s[1], s[0])), p = ((_d = a.elasticities) == null ? void 0 : _d.get(e)) ?? 0, v = ((_e2 = a.areas) == null ? void 0 : _e2.get(e)) ?? 0, M = ((_f = a.momentsOfInertiaZ) == null ? void 0 : _f.get(e)) ?? 0, L = ((_g = a.momentsOfInertiaY) == null ? void 0 : _g.get(e)) ?? 0, N = ((_h = a.shearModuli) == null ? void 0 : _h.get(e)) ?? 0, C = ((_i = a.torsionalConstants) == null ? void 0 : _i.get(e)) ?? 0;
        `${l[0]}${l[1]}${te(m)}${te(p)}${te(v)}${te(M)}${te(L)}${te(N)}${te(C)}`;
      } else {
      ...
      try {
        if (S = tn(s, a, e), I = on(s), E = jt(_n(I), jt(S, I)), F = c ? [
          ...
          const M = vo(to(s[1], s[0])), L = ((_m = a.elasticities) == null ? void 0 : _m.get(e)) ?? 0, N = ((_n2 = a.areas) == null ? void 0 : _n2.get(e)) ?? 0, C = ((_o2 = a.momentsOfInertiaZ) == null ? void 0 : _o2.get(e)) ?? 0, A = ((_p = a.momentsOfInertiaY) == null ? void 0 : _p.get(e)) ?? 0, P = ((_q = a.shearModuli) == null ? void 0 : _q.get(e)) ?? 0, q = ((_r = a.torsionalConstants) == null ? void 0 : _r.get(e)) ?? 0;
          $ = Gs(L, N, C, A, P, q, M);
        }
      ...
      if (i == null ? void 0 : i.deformations) {
        ...
        l.map((p, v) => {
          ...
          const M = ((_a3 = i.deformations) == null ? void 0 : _a3.get(p)) || [
            ...
            0,
            0
          ], L = m.map((N, C) => `<span class="prop-key">${N}</span>: <span class="${Math.abs(M[C]) > 1e-10 ? "result-val" : ""}">${te(M[C])}</span>`).join(" &nbsp;");
          return `<div style="margin-bottom:2px"><strong>Nodo ${p}:</strong> ${L}</div>`;
        }).join("");
      }
      if (u && c && (i == null ? void 0 : i.deformations) && S && I) {
        const m = (_s2 = u.normals) == null ? void 0 : _s2.get(e), p = (_t2 = u.shearsY) == null ? void 0 : _t2.get(e), v = (_u = u.shearsZ) == null ? void 0 : _u.get(e), M = (_v = u.torsions) == null ? void 0 : _v.get(e), L = (_w = u.bendingsY) == null ? void 0 : _w.get(e), N = (_x = u.bendingsZ) == null ? void 0 : _x.get(e), C = [
          "ux",
          "uy",
          "uz",
          "\u03B8x",
        ...
        const ee = (oe, X) => oe.map((re, Me) => `<span style="color:${Math.abs(re) > 1e-10 ? "var(--fem-nonzero)" : "var(--fem-eq-dots)"}">${X[Me % 6]}=${te(re)}</span>`).join(", "), ie = [
          "N",
          "Vy",
          "Vz",
          "Mx",
        ...
        `${O("u", "global")}${l.map((oe, X) => `<span style="color:var(--fem-label)">nodo ${oe}:</span> ${C.map((re, Me) => `<span style="color:${Math.abs(A[X * 6 + Me]) > 1e-10 ? "var(--fem-eq-var)" : "var(--fem-eq-dots)"}">${te(A[X * 6 + Me])}</span>`).join(", ")}`).join(" | ")}${O("u", "local")}${O("T")}${O("u", "global")}${O("u", "local")}${ee(P, [
          ...C,
          ...C
        ])}${O("f", "local")}${O("k", "local")}${O("u", "local")}${O("f", "local")}${q.map((oe, X) => `<span style="color:${Math.abs(oe) > 1e-10 ? "var(--fem-nonzero)" : "var(--fem-eq-dots)"}">${ie[X]}=${te(oe)}</span>`).join(", ")}${O("P", "1")}${O("N", "i")}${te(q[0])}${O("P", "7")}${O("N", "j")}${te(q[6])}${O("P", "2")}${O("V", "y,i")}${te(q[1])}${O("P", "8")}${O("V", "y,j")}${te(q[7])}${O("P", "3")}${O("V", "z,i")}${te(q[2])}${O("P", "9")}${O("V", "z,j")}${te(q[8])}${O("P", "4")}${O("M", "x,i")}${te(q[3])}${O("P", "10")}${O("M", "x,j")}${te(q[9])}${O("P", "5")}${O("M", "y,i")}${te(q[4])}${O("P", "11")}${O("M", "y,j")}${te(q[10])}${O("P", "6")}${O("M", "z,i")}${te(q[5])}${O("P", "12")}${O("M", "z,j")}${te(q[11])}${m ? m.map((oe) => te(oe)).join(", ") : "\u2014"}${p ? p.map((oe) => te(oe)).join(", ") : "\u2014"}${v ? v.map((oe) => te(oe)).join(", ") : "\u2014"}${M ? M.map((oe) => te(oe)).join(", ") : "\u2014"}${L ? L.map((oe) => te(oe)).join(", ") : "\u2014"}${N ? N.map((oe) => te(oe)).join(", ") : "\u2014"}`;
      } else if (u && c) {
        ...
        `${m ? m.map((C) => te(C)).join(", ") : "\u2014"}${p ? p.map((C) => te(C)).join(", ") : "\u2014"}${v ? v.map((C) => te(C)).join(", ") : "\u2014"}${M ? M.map((C) => te(C)).join(", ") : "\u2014"}${L ? L.map((C) => te(C)).join(", ") : "\u2014"}${N ? N.map((C) => te(C)).join(", ") : "\u2014"}`;
      } else if (u && !c) {
      ...
      `${l[0]}`, 6 * l[0], 6 * l[0] + 5, `${l[1]}`, 6 * l[1], 6 * l[1] + 5, l.length === 3 && (`${l[2]}`, 6 * l[2], 6 * l[2] + 5), o.length * 6, o.length * 6, Vt = Ca(e, o, n, a, i, u), Vt.id = "fem-inspect-panel", document.body.appendChild(Vt), (_L = Vt.querySelector("#er-close")) == null ? void 0 : _L.addEventListener("click", () => mo());
      const y = c ? (() => {
        var _a3, _b2, _c2, _d2, _e3, _f2;
        const m = vo(to(s[1], s[0])), p = ((_a3 = a.elasticities) == null ? void 0 : _a3.get(e)) ?? 0, v = ((_b2 = a.areas) == null ? void 0 : _b2.get(e)) ?? 0, M = ((_c2 = a.momentsOfInertiaZ) == null ? void 0 : _c2.get(e)) ?? 0, L = ((_d2 = a.momentsOfInertiaY) == null ? void 0 : _d2.get(e)) ?? 0, N = ((_e3 = a.shearModuli) == null ? void 0 : _e3.get(e)) ?? 0, C = ((_f2 = a.torsionalConstants) == null ? void 0 : _f2.get(e)) ?? 0;
        return Us(p, v, M, L, N, C, m);
      })() : void 0;
    ...
    function oa(e) {
      ...
      const y = [];
      for (const U of u) {
        let ie = w, oe = x, X = f, re = g, Me = S, Fe = I, Pe = E, H = F, ce;
        const de = U - b;
        if (Math.abs(de) < 1e-20) {
          y.push($);
          continue;
        }
        if ((H === 0 || H === 3) && (de < 0 ? (H = 2, re = -d, Me = -o, X = re, Fe = 0, Pe = 0) : (H = 1, re = d, Me = o, X = re, Fe = 0, Pe = 0)), H === 2 && de > 0) {
          H = 1, Fe = b, Pe = $, b < ie && (ie = b);
          const Le = (oe - ie) / (2 * 1 * d), De = 1 + 0 * Math.pow(Le, 0.8);
          re = (o * De - r * d * De - Pe + n * Fe) / (n - r), Me = o * De + r * (re - d * De), X = oe;
        } else if (H === 1 && de < 0) {
          H = 2, Fe = b, Pe = $, b > oe && (oe = b);
          const Le = (oe - ie) / (2 * 1 * d), De = 1 + 0 * Math.pow(Le, 0.8);
          re = (-o * De + r * d * De - Pe + n * Fe) / (n - r), Me = -o * De + r * (re + d * De), X = ie;
        }
        const ne = Math.abs((X - re) / d);
        let G = s - 0.925 * ne / (0.15 + ne);
        G < 0.1 && (G = 0.1);
        const be = (U - Fe) / (re - Fe), ke = 1 + Math.pow(Math.abs(be), G), ae = Math.pow(ke, 1 / G);
        ce = l * be + (1 - l) * be / ae, ce = ce * (Me - Pe) + Pe, y.push(ce), b = U, $ = ce, w = ie, x = oe, f = X, g = re, S = Me, I = Fe, E = Pe, F = H;
      }
      const m = e.querySelector("#nl-canvas"), p = m.getContext("2d"), v = m.width, M = m.height;
      p.clearRect(0, 0, v, M);
      const L = Math.max(...u.map(Math.abs)), N = Math.max(...y.map(Math.abs)), C = (v - 40) / (2 * L), A = (M - 40) / (2 * N), P = v / 2, q = M / 2;
      ...
      for (let U = 0; U < u.length; U++) {
        const ie = P + u[U] * C, oe = q - y[U] * A;
        U === 0 ? p.moveTo(ie, oe) : p.lineTo(ie, oe);
      }
      p.stroke(), p.strokeStyle = "#ff333366", p.lineWidth = 1, p.setLineDash([
        4,
        4
      ]), p.beginPath(), p.moveTo(20, q - o * A), p.lineTo(v - 20, q - o * A), p.stroke(), p.beginPath(), p.moveTo(20, q + o * A), p.lineTo(v - 20, q + o * A), p.stroke(), p.setLineDash([]), p.fillStyle = "#ff6666", p.font = "9px monospace", p.fillText(`Fy = ${(o / 1e3).toFixed(0)} MPa`, v - 50, q - o * A - 5);
      const ee = e.querySelector("#nl-info");
      ee.textContent = `Steel02: Fy=${(o / 1e3).toFixed(0)} MPa, E\u2080=${(n / 1e6).toFixed(0)} GPa, b=${l}, R\u2080=${s} \u2014 ${a} ciclos, amp=${(c * 100).toFixed(1)}%`;
    }
    function na() {
      var _a2, _b, _c, _d;
    ...
    setTimeout(() => {
      ...
      function i(u, d, r, b, $, w, x, f) {
        ...
        const S = (I, E, F, y, m, p, v, M) => {
          ...
          const N = ((m - I) * (M - p) - (p - E) * (v - m)) / L, C = ((m - I) * (y - E) - (p - E) * (F - I)) / L;
      ...
      var _a2, _b;
      if (e === void 0 && (e = !Ct), Ct = e, (_a2 = ve.querySelector("#cad3d-modal")) == null ? void 0 : _a2.classList.toggle("active", Ct), Ct) {
        const n = Ze();
        ((_b = n == null ? void 0 : n.settings) == null ? void 0 : _b.loads) && (K = n.settings.loads.rawVal, n.settings.loads.val = false), un(), ve.querySelector("#cad3d-mode-prev").style.display = "", ve.querySelector("#cad3d-mode-next").style.display = "", ve.querySelector("#cad3d-mode-label").style.display = "";
        ...
        var _a3;
        const n = Ze();
        ((_a3 = n == null ? void 0 : n.settings) == null ? void 0 : _a3.loads) && K && (n.settings.loads.val = true);
      }, 600);
      ...
      gt = Math.max(0, Math.min(e, me.modeShapes.length - 1));
      const o = me.modeShapes[gt], { extent: n } = no();
      let l = 0;
      for (let c = 0; c < le.length; c++) {
        const a = o[c * 6] || 0, i = o[c * 6 + 1] || 0, u = o[c * 6 + 2] || 0;
        l = Math.max(l, Math.sqrt(a * a + i * i + u * u));
      }
      Ce = l > 1e-12 ? n * 0.05 / l : 1, _o();
      const s = ve.querySelector("#cad3d-mode-label");
      s && me.frequencies && (s.textContent = `Modo ${gt + 1} \u2014 ${me.frequencies[gt].toFixed(2)} Hz`), console.log(`Modo ${gt + 1}: f = ${(_a2 = me.frequencies) == null ? void 0 : _a2[gt].toFixed(4)} Hz`);
