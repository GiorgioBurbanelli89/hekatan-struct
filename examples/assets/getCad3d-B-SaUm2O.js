...
import { d as Ft, _ as va, p as cs, m as ml, s as gl, __tla as __tla_0 } from "./didacticCpp-BGUxSkhs.js";
import { v as on, P as mn, g as bl, a as hl, o as xl } from "./theme-CzzIlc4y.js";
import { G as bn, b as vl, M as ya, D as $a, B as co, c as Cn, d as yl, C as $l, e as Ta, V as qe, P as Po, R as Ma, f as wa, g as Qo, h as en, i as Ml, S as wl, j as El, F as _o, a as tn, L as Do, k as Sl, l as Il, A as En, T as ds, m as Sn, n as In, o as kl, p as Tl } from "./Text-CBH-tcJP.js";
import { g as Fn, b as Pn, a as Eo } from "./analyze-ClLKGn9k.js";
import { g as Io, __tla as __tla_1 } from "./getMesh-B1dmlgUt.js";
import { t as X, s as zl, u as Al } from "./i18n-DrCrJaxE.js";
import { n as jo, s as ko, m as uo, t as hs } from "./pureFunctionsAny.generated-JAcEVsJ7.js";
let ka, Pl, Mi;
let __tla = Promise.all([
  ...
  function Ho(e, b) {
    const R = bs.find((j) => j.id === e), M = nn.find((j) => j.id === b), V = R.toKN, B = M.toM, Z = (j, he, T) => T / (Math.pow(V, j) * Math.pow(B, he));
    let J, H;
    switch (e) {
      case "kN":
        J = 10, H = [
    ...
    return {
      ...
      "muro-contencion": [
        ...
        },
        {
          ...
          max: 30,
          step: 1,
          label: `${X("gamma suelo")} (${e.force}/${e.length}\xB3)`
        },
        {
          key: "Ka",
          val: 0.33,
        ...
        },
        {
          ...
          max: 1e9,
          step: 1e4,
          label: `${X("kn interfaz")} (${e.force}/${e.length}\xB3)`
        },
        {
          key: "ks",
          val: 1e4,
          ...
          max: 1e7,
          step: 1e3,
          label: `${X("ks interfaz")} (${e.force}/${e.length}\xB3)`
        },
        {
          key: "gammaW",
          val: 9.81,
          ...
          max: 15,
          step: 0.1,
          label: `${X("gamma agua")} (${e.force}/${e.length}\xB3)`
        },
        {
          key: "Hw",
          val: 3.5,
      ...
      pergola: [
        ...
        },
        {
          ...
          label: `${X("q carga")} (${e.force}/${e.length}\xB2)`
        },
        {
          key: "colD",
          val: 0.16,
      ...
      talud: [
        ...
        },
        {
          ...
          max: 100,
          step: 5,
          label: `${X("Sobrecarga")} (${e.stress})`
        }
      ]
    };
  }
  function Fl(e) {
    const b = e.force, [R, M, V] = e.forceRange;
    return {
      truss: [
        {
          key: "CM",
...
<tr style="color:#ff0; border-bottom:1px solid #ff03; position:sticky; top:36px; background:rgba(0,0,0,0.95); z-index:1;">
  ...
  <th style="padding:2px 5px; color:#0ff">\u03A3Rz</th></tr>`, M.frequencies.forEach((j, he) => {
        var _a2;
        const T = j > 0 ? 1 / j : 0, Y = j * 2 * Math.PI, $e = ((_a2 = M.massParticipation) == null ? void 0 : _a2[he]) || [
          0,
          0,
          0,
          0,
  ...
  <td style="padding:2px 5px; text-align:right; color:#0ff">${(Z[5] * 100).toFixed(1)}%</td></tr>`;
        ...
        const j = e.querySelector("#modal-body"), he = e.querySelector("#modal-minimize");
        j && (j.style.display = "none"), he && (he.textContent = "\u25A2", he.title = "Restaurar");
      }
      (_a = e.querySelector("#modal-minimize")) == null ? void 0 : _a.addEventListener("click", () => {
        b = !b;
        const j = e.querySelector("#modal-body"), he = e.querySelector("#modal-minimize");
        b ? (j.style.display = "none", he.textContent = "\u25A2", he.title = "Restaurar") : (j.style.display = "block", he.textContent = "\u25AC", he.title = "Minimizar");
      });
      const H = e.querySelector("#modal-header");
      if (H) {
        let j = false, he = 0, T = 0, Y = 0, $e = 0;
        H.addEventListener("mousedown", (fe) => {
          if (fe.target.tagName === "BUTTON") return;
          j = true, he = fe.clientX, T = fe.clientY;
          const re = e.getBoundingClientRect();
          Y = re.left, $e = re.top, fe.preventDefault();
        }), document.addEventListener("mousemove", (fe) => {
          if (!j) return;
          const re = fe.clientX - he, ne = fe.clientY - T;
          e.style.left = Y + re + "px", e.style.top = $e + ne + "px", e.style.bottom = "auto", e.style.right = "auto";
      ...
      (_b = e.querySelector("#modal-copy")) == null ? void 0 : _b.addEventListener("click", () => {
        ...
        j.push(he), j.push("-".repeat(he.length));
        const T = [
          0,
          0,
          0,
        ...
        M.frequencies.forEach(($e, fe) => {
          ...
          j.push(`${String(fe + 1).padStart(4)}  ${$e.toFixed(4).padStart(9)}  ${re.toFixed(4).padStart(9)}  ${ne.toFixed(2).padStart(9)}  ${D}  ${(T[0] * 100).toFixed(1).padStart(5)}%  ${(T[1] * 100).toFixed(1).padStart(5)}%  ${(T[5] * 100).toFixed(1).padStart(5)}%`);
...
`));
  ...
  const Oe = 64516e-8, q = 416231e-12, ae = 0.0254, Ro = [
    {
      name: "W6x9",
      type: "W",
      A: 2.68 * Oe,
  ...
  function Rl(e) {
    ...
    const { nodes: b, elements: R, elementInputs: M, nodeInputs: V, deformOutputs: B } = e, Z = b.length * 6, J = R.length, H = R.filter((re) => re.length === 2).length, j = R.filter((re) => re.length >= 3).length, he = document.createElement("div");
    ...
    T += '<button class="rpt-close" id="rpt-close">\u2715 Close</button>', T += "<h1>Finite Element Analysis \u2014 Step-by-Step Report</h1>", T += '<div class="rpt-subtitle">Complete FEM derivation from element formulation to final results</div>', T += '<hr class="rpt-sep"/>', T += "<h2>1. Input Data</h2>", T += '<table class="rpt-info"><tbody>', T += `<tr><td>Number of nodes</td><td class="val">${b.length}</td></tr>`, T += `<tr><td>Number of elements</td><td class="val">${J} (${H} frames, ${j} shells)</td></tr>`, T += '<tr><td>DOFs per node</td><td class="val">6 (u<sub>x</sub>, u<sub>y</sub>, u<sub>z</sub>, \u03B8<sub>x</sub>, \u03B8<sub>y</sub>, \u03B8<sub>z</sub>)</td></tr>', T += `<tr><td>Total DOFs</td><td class="val">${Z}</td></tr>`, T += "</tbody></table>", T += "<h3>1.1 Node Coordinates</h3>", T += '<table class="rpt-data"><thead><tr><th>Node</th><th>x</th><th>y</th><th>z</th></tr></thead><tbody>', b.forEach((re, ne) => {
      ...
      var _a2, _b2, _c2, _d2;
      const _ = re.length === 2, D = re.map((ye) => b[ye]), G = _ ? jo(ko(D[1], D[0])) : 0, ue = ((_a2 = M.elasticities) == null ? void 0 : _a2.get(ne)) ?? 0, Me = ((_b2 = M.areas) == null ? void 0 : _b2.get(ne)) ?? 0, Ae = ((_c2 = M.momentsOfInertiaZ) == null ? void 0 : _c2.get(ne)) ?? 0, Ke = ((_d2 = M.momentsOfInertiaY) == null ? void 0 : _d2.get(ne)) ?? 0;
      T += `<tr><td>${ne}</td><td>${_ ? "Frame" : "Shell"}</td><td>${re.join(" \u2192 ")}</td>`, T += `<td>${rt(G)}</td><td>${rt(ue)}</td><td>${rt(Me)}</td><td>${rt(Ae)}</td><td>${rt(Ke)}</td></tr>`;
    ...
    for (let re = 0; re < J; re++) {
      const ne = R[re], _ = ne.map((dt) => b[dt]);
      if (!(ne.length === 2)) continue;
      const G = jo(ko(_[1], _[0])), ue = ((_a = M.elasticities) == null ? void 0 : _a.get(re)) ?? 0, Me = ((_b = M.areas) == null ? void 0 : _b.get(re)) ?? 0, Ae = ((_c = M.momentsOfInertiaZ) == null ? void 0 : _c.get(re)) ?? 0, Ke = ((_d = M.momentsOfInertiaY) == null ? void 0 : _d.get(re)) ?? 0, ye = ((_e = M.shearModuli) == null ? void 0 : _e.get(re)) ?? 0, Ge = ((_f = M.torsionalConstants) == null ? void 0 : _f.get(re)) ?? 0;
      let Ye = null, be = null, Te = null;
      try {
        Ye = Fn(_, M, re), be = Pn(_), Te = uo(hs(be), uo(Ye, be));
      } catch {
        continue;
      }
      const Ce = ko(_[1], _[0]), Ue = Ce[0] / G, ct = Ce[1] / G, Ze = Ce[2] / G;
      T += '<div class="rpt-elem-block">', T += `<h3 class="rpt-elem-title" data-toggle="elem${re}">\u25B6 Element ${re} \u2014 Nodes ${ne[0]} \u2192 ${ne[1]}, L = ${rt(G)}</h3>`, T += `<div id="rpt-elem${re}" class="rpt-elem-body" style="display:none">`, T += "<h4>Properties (numerical substitution)</h4>", T += '<div class="rpt-eq-small">', T += `E = ${rt(ue)} &nbsp;&nbsp; A = ${rt(Me)} &nbsp;&nbsp; I<sub>z</sub> = ${rt(Ae)} &nbsp;&nbsp; I<sub>y</sub> = ${rt(Ke)} &nbsp;&nbsp; G = ${rt(ye)} &nbsp;&nbsp; J = ${rt(Ge)}<br/>`, T += `EA/L = ${rt(ue)}\xB7${rt(Me)}/${rt(G)} = <b>${rt(ue * Me / G)}</b><br/>`, T += `12EI<sub>z</sub>/L\xB3 = 12\xB7${rt(ue)}\xB7${rt(Ae)}/${rt(G)}\xB3 = <b>${rt(12 * ue * Ae / G ** 3)}</b><br/>`, T += `12EI<sub>y</sub>/L\xB3 = 12\xB7${rt(ue)}\xB7${rt(Ke)}/${rt(G)}\xB3 = <b>${rt(12 * ue * Ke / G ** 3)}</b><br/>`, T += `GJ/L = ${rt(ye)}\xB7${rt(Ge)}/${rt(G)} = <b>${rt(ye * Ge / G)}</b>`, T += "</div>", T += "<h4>Direction cosines</h4>", T += `<div class="rpt-eq-small">l = ${An(Ue)}, m = ${An(ct)}, n = ${An(Ze)}, D = ${An(Math.sqrt(Ue ** 2 + ct ** 2))}</div>`, T += "<h4>K<sub>local</sub> (12\xD712)</h4>", T += ps(Ye, 12), T += "<h4>T \u2014 Transformation (12\xD712)</h4>", T += ps(be, 12), T += "<h4>K<sub>global</sub> = T\u1D40 \xB7 K<sub>local</sub> \xB7 T</h4>", T += ps(Te, 12), T += "<h4>Assembly</h4>", T += `<div class="rpt-eq-small">Global DOFs: node ${ne[0]} \u2192 [${ne[0] * 6}..${ne[0] * 6 + 5}], node ${ne[1]} \u2192 [${ne[1] * 6}..${ne[1] * 6 + 5}]</div>`, T += "</div></div>";
    }
    T += "<h2>4. Global Assembly</h2>", T += `<div class="rpt-eq rpt-eq-highlight">K<sub>total</sub> = \u03A3<sub>e=0</sub><sup>${J - 1}</sup> (T<sub>e</sub>\u1D40 \xB7 k<sub>e</sub> \xB7 T<sub>e</sub>)</div>`, T += "<p>Each element contributes its K<sub>global</sub> to the positions determined by its node DOF indices.</p>", T += ql(R, b.length), T += "<h2>5. Boundary Conditions</h2>";
    const Y = [
      "u<sub>x</sub>",
      "u<sub>y</sub>",
      "u<sub>z</sub>",
    ...
    if (T += "<h3>5.1 Supports (fixed DOFs)</h3>", V.supports && V.supports.size > 0) {
      ...
      T += "</tr></thead><tbody>", V.supports.forEach((re, ne) => {
        T += `<tr><td>${ne}</td>`, re.forEach((_, D) => {
          _ && $e.push(ne * 6 + D), T += `<td class="${_ ? "fixed" : ""}">${_ ? "Fixed" : "Free"}</td>`;
        }), T += "</tr>";
      }), T += "</tbody></table>";
    }
    if (T += `<div class="rpt-eq-small">Fixed DOFs: [${$e.join(", ")}] \u2192 ${$e.length} constraints<br/>`, T += `Free DOFs: ${Z} \u2212 ${$e.length} = <b>${Z - $e.length}</b></div>`, T += "<h3>5.2 Applied Loads</h3>", V.loads && V.loads.size > 0) {
      T += '<table class="rpt-data"><thead><tr><th>Node</th>';
      const re = [
        "F<sub>x</sub>",
        "F<sub>y</sub>",
      ...
      T += "</tr></thead><tbody>", V.loads.forEach((ne, _) => {
    ...
    if (T += "<h2>7. Internal Forces</h2>", T += "<p>For each element, transform global displacements to local and multiply by K<sub>local</sub>:</p>", T += '<div class="rpt-eq">u<sub>local</sub> = T \xB7 u<sub>global</sub></div>', T += '<div class="rpt-eq rpt-eq-highlight">f<sub>local</sub> = K<sub>local</sub> \xB7 u<sub>local</sub></div>', B == null ? void 0 : B.deformations) {
      ...
      for (let ne = 0; ne < J; ne++) {
        ...
        const D = _.map((G) => b[G]);
        try {
          const G = Fn(D, M, ne), ue = Pn(D), Me = [];
          for (const ye of _) {
            const Ge = ((_g = B.deformations) == null ? void 0 : _g.get(ye)) || [
              0,
              0,
              0,
              0,
  ...
  function ps(e, b) {
    ...
    for (let V = 0; V < R; V++) {
      M += "<tr>";
      for (let B = 0; B < R; B++) {
        const Z = ((_a = e[V]) == null ? void 0 : _a[B]) ?? 0, J = Math.abs(Z) < 1e-10;
        M += `<td class="${J ? "z" : ""} ${V === B && !J ? "diag" : ""}">${J ? "0" : Ol(Z)}</td>`;
      }
      M += "</tr>";
    }
    return M += "</table>", b > R && (M += `<div style="color:#888;font-size:9pt">(showing ${R}\xD7${R} of ${b}\xD7${b})</div>`), M += "</div>", M;
  }
  function Ol(e) {
  ...
  function ql(e, b) {
    ...
    for (let Z = 0; Z < e.length; Z++) {
      ...
      for (const H of J) for (const j of J) for (let he = 0; he < 6; he++) for (let T = 0; T < 6; T++) {
        const Y = H + he, $e = j + T;
        Y < M && $e < M && B[Y][$e]++;
      }
    }
    for (let Z = 0; Z < M; Z++) {
      ...
      for (let J = 0; J < M; J++) {
        const H = B[Z][J], j = H === 0 ? "#fff" : H === 1 ? "#e8f0fe" : H === 2 ? "#c6dcf5" : "#a0c4e8", he = H === 0 ? "" : H.toString();
        V += `<td style="background:${j};color:#003366">${he}</td>`;
      }
      V += "</tr>";
    }
    return V += "</table></div>", R > M && (V += `<div style="color:#888;font-size:9pt">(showing ${M}\xD7${M} of ${R}\xD7${R})</div>`), V;
  }
  let fs = false;
  function _l(e) {
    if (fs || window.katex) {
  ...
  function Dl(e, b, R, M, V, B) {
    var _a, _b, _c, _d, _e, _f;
    const Z = R[e], J = Z.map((be) => b[be]), H = Z.length === 2, j = H ? jo(ko(J[1], J[0])) : 0, he = ((_a = M.elasticities) == null ? void 0 : _a.get(e)) ?? 0, T = ((_b = M.areas) == null ? void 0 : _b.get(e)) ?? 0, Y = ((_c = M.momentsOfInertiaZ) == null ? void 0 : _c.get(e)) ?? 0, $e = ((_d = M.momentsOfInertiaY) == null ? void 0 : _d.get(e)) ?? 0, fe = ((_e = M.shearModuli) == null ? void 0 : _e.get(e)) ?? 0, re = ((_f = M.torsionalConstants) == null ? void 0 : _f.get(e)) ?? 0;
    let ne = null, _ = null, D = null;
    try {
      ne = Fn(J, M, e), _ = Pn(J), D = uo(hs(_), uo(ne, _));
    } catch {
    }
    const G = H ? ko(J[1], J[0]) : [
      0,
      0,
      0
    ], ue = j > 0 ? G[0] / j : 0, Me = j > 0 ? G[1] / j : 0, Ae = j > 0 ? G[2] / j : 0, Ke = Math.sqrt(ue ** 2 + Me ** 2), ye = [];
    if ((V == null ? void 0 : V.deformations) && H) for (const be of Z) {
      const Te = V.deformations.get(be) || [
        0,
        0,
        0,
        0,
  ...
  function Bl(e, b, R, M, V, B) {
    var _a, _b;
    const Z = Dl(e, b, R, M, V, B), J = document.createElement("div");
    return J.className = "er-panel", J.innerHTML = Gl + `
    <div class="er-header">
  ...
  `, J.querySelectorAll(".er-tab").forEach((H) => {
      H.addEventListener("click", () => {
        J.querySelectorAll(".er-tab").forEach((he) => he.classList.remove("active")), H.classList.add("active");
        const j = H.dataset.tab;
        J.querySelectorAll(".er-body").forEach((he) => he.style.display = "none"), J.querySelector(`#er-body-${j}`).style.display = "";
      });
      ...
      H && (H.innerHTML = Sa(Z)), setTimeout(() => {
        ...
        j.addEventListener("click", () => {
          const he = j.dataset.toggle, T = J.querySelector(`#er-${he}`);
    ...
    if (b += '<div class="er-section-title">1. Propiedades</div>', b += '<table class="er-props">', b += `<tr><td>E</td><td>${Xe(e.E)}</td><td>A</td><td>${Xe(e.A)}</td></tr>`, b += `<tr><td>I<sub>z</sub></td><td>${Xe(e.Iz)}</td><td>I<sub>y</sub></td><td>${Xe(e.Iy)}</td></tr>`, b += `<tr><td>G</td><td>${Xe(e.G)}</td><td>J</td><td>${Xe(e.J)}</td></tr>`, b += "</table>", e.kLocal && (b += `<div class="er-section-title">2. K<sub>local</sub> (${e.kLocal.length}\xD7${e.kLocal.length})</div>`, b += hn(e.kLocal)), e.T && (b += '<div class="er-section-title">3. T \u2014 Transformaci\xF3n</div>', b += hn(e.T)), e.kGlobal && (b += '<div class="er-section-title">4. K<sub>global</sub> = T<sup>T</sup>\xB7K\xB7T</div>', b += hn(e.kGlobal)), b += '<div class="er-section-title">5. Desplazamientos</div>', e.uGlobal.length > 0) {
      ...
      for (let M = 0; M < e.elem.length; M++) {
        ...
        for (let V = 0; V < 6; V++) {
          ...
          b += `${R[V]}=<span class="${Math.abs(B) > 1e-10 ? "nz" : ""}">${Xe(B, 6)}</span> `;
        }
        b += "</div>";
      }
  ...
  function Sa(e) {
    ...
    let b = "";
    const R = (he) => Ea(he), M = (he) => Ea(he, true);
    b += '<div class="er-section-title">1. Geometria del elemento</div>', b += "<p>Viga Euler-Bernoulli con 2 nodos y 6 GDL por nodo:</p>", b += `<div class="er-eq">${M("\\text{DOFs} = [u_x,\\, u_y,\\, u_z,\\, \\theta_x,\\, \\theta_y,\\, \\theta_z] \\quad \\Rightarrow \\quad 12 \\text{ GDL totales}")}</div>`, b += '<div class="er-eq-num">', b += `${R("\\text{Nodo } i")} = (${e.elmNodes[0].map((he) => Xe(he)).join(", ")})<br/>`, b += `${R("\\text{Nodo } j")} = (${e.elmNodes[1].map((he) => Xe(he)).join(", ")})<br/>`, b += `${M(`L = \\sqrt{(x_j - x_i)^2 + (y_j - y_i)^2 + (z_j - z_i)^2} = \\mathbf{${Xe(e.L)}}`)}`, b += "</div>", b += '<div class="er-section-title">2. Funciones de forma</div>', b += "<p>La viga usa <b>interpolacion lineal</b> para axial/torsion y <b>polinomios cubicos de Hermite</b> para flexion.</p>", b += '<div class="er-subsec">2.1 Axial y Torsion (lineal)</div>', b += `<div class="er-eq">${M("N_1(\\xi) = 1 - \\xi \\qquad N_2(\\xi) = \\xi \\qquad \\text{donde } \\xi = \\frac{x}{L} \\in [0,1]")}</div>`, b += "<p>Primera derivada:</p>", b += `<div class="er-eq">${M("\\frac{dN_1}{d\\xi} = -1 \\qquad \\frac{dN_2}{d\\xi} = 1")}</div>`, b += '<div class="er-subsec">2.2 Flexion (Hermite cubicos)</div>', b += `<p>Las funciones de Hermite garantizan continuidad ${R("C^1")} (desplazamiento y pendiente continuos):</p>`, b += `<div class="er-eq">${M("H_1(\\xi) = 1 - 3\\xi^2 + 2\\xi^3 \\qquad \\text{(desplazamiento nodo } i\\text{)}")}</div>`, b += `<div class="er-eq">${M("H_2(\\xi) = L\\,\\xi\\,(1-\\xi)^2 \\qquad \\text{(rotacion nodo } i\\text{)}")}</div>`, b += `<div class="er-eq">${M("H_3(\\xi) = 3\\xi^2 - 2\\xi^3 \\qquad \\text{(desplazamiento nodo } j\\text{)}")}</div>`, b += `<div class="er-eq">${M("H_4(\\xi) = L\\,\\xi^2(\\xi - 1) \\qquad \\text{(rotacion nodo } j\\text{)}")}</div>`, b += `<div class="er-subsec">Derivadas segunda (curvatura ${R("\\kappa = \\frac{d^2v}{dx^2}")}):</div>`, b += `<div class="er-eq">${M("H_1'' = \\frac{-6}{L^2}(1-2\\xi) \\qquad H_2'' = \\frac{-2}{L}(2-3\\xi)")}</div>`, b += `<div class="er-eq">${M("H_3'' = \\frac{6}{L^2}(1-2\\xi) \\qquad H_4'' = \\frac{-2}{L}(1-3\\xi)")}</div>`, b += '<canvas id="er-sf-canvas-math" width="500" height="250" style="width:100%;border:1px solid var(--fem-border);border-radius:4px;margin:8px 0;"></canvas>', b += '<div class="er-section-title">3. Matriz B (strain-displacement)</div>', b += "<p>La matriz B relaciona desplazamientos nodales con deformaciones internas:</p>", b += `<div class="er-eq">${M("\\boldsymbol{\\varepsilon} = \\mathbf{B} \\cdot \\mathbf{u}")}</div>`, b += '<div class="er-subsec">3.1 Deformacion axial</div>', b += `<div class="er-eq">${M("\\varepsilon_{axial} = \\frac{du}{dx} = \\frac{1}{L} \\begin{bmatrix} -1 & 1 \\end{bmatrix} \\begin{Bmatrix} u_i \\\\ u_j \\end{Bmatrix}")}</div>`, b += `<div class="er-subsec">3.2 Curvatura por flexion (plano XY \u2192 ${R("I_z")})</div>`, b += `<div class="er-eq">${M("\\kappa_z = \\frac{d^2 v}{dx^2} = \\mathbf{B}_{bz} \\cdot \\begin{Bmatrix} v_i \\\\ \\theta_{zi} \\\\ v_j \\\\ \\theta_{zj} \\end{Bmatrix}")}</div>`, b += `<div class="er-eq">${M("\\mathbf{B}_{bz}(\\xi) = \\frac{1}{L^2} \\begin{bmatrix} H_1'' & H_2'' & H_3'' & H_4'' \\end{bmatrix}")}</div>`, b += `<div class="er-subsec">3.3 Curvatura (plano XZ \u2192 ${R("I_y")})</div>`, b += `<div class="er-eq">${M("\\kappa_y = \\frac{d^2 w}{dx^2} = \\mathbf{B}_{by} \\cdot \\begin{Bmatrix} w_i \\\\ \\theta_{yi} \\\\ w_j \\\\ \\theta_{yj} \\end{Bmatrix}")}</div>`, b += '<div class="er-subsec">3.4 Torsion</div>', b += `<div class="er-eq">${M("\\phi' = \\frac{d\\theta_x}{dx} = \\frac{1}{L} \\begin{bmatrix} -1 & 1 \\end{bmatrix} \\begin{Bmatrix} \\theta_{xi} \\\\ \\theta_{xj} \\end{Bmatrix}")}</div>`, b += '<div class="er-section-title">4. Relaciones constitutivas D</div>', b += "<p>Cada modo de deformacion tiene su rigidez material:</p>", b += `<div class="er-eq">${M(`\\text{Axial: } \\sigma = E \\cdot \\varepsilon \\;\\Rightarrow\\; D_{ax} = EA = ${Xe(e.E)} \\times ${Xe(e.A)} = \\mathbf{${Xe(e.E * e.A)}}`)}</div>`, b += `<div class="er-eq">${M(`\\text{Flex Z: } M_z = EI_z \\cdot \\kappa \\;\\Rightarrow\\; D_{bz} = EI_z = ${Xe(e.E)} \\times ${Xe(e.Iz)} = \\mathbf{${Xe(e.E * e.Iz)}}`)}</div>`, b += `<div class="er-eq">${M(`\\text{Flex Y: } M_y = EI_y \\cdot \\kappa \\;\\Rightarrow\\; D_{by} = EI_y = ${Xe(e.E)} \\times ${Xe(e.Iy)} = \\mathbf{${Xe(e.E * e.Iy)}}`)}</div>`, b += `<div class="er-eq">${M(`\\text{Torsion: } T = GJ \\cdot \\phi' \\;\\Rightarrow\\; D_t = GJ = ${Xe(e.G)} \\times ${Xe(e.J)} = \\mathbf{${Xe(e.G * e.J)}}`)}</div>`, b += `<div class="er-section-title">5. Integracion \u2192 ${R("\\mathbf{K}_{local}")}</div>`, b += "<p>La matriz de rigidez local se obtiene integrando analiticamente:</p>", b += `<div class="er-eq er-eq-main">${M("\\mathbf{K}_{local} = \\int_0^L \\mathbf{B}^T \\cdot \\mathbf{D} \\cdot \\mathbf{B} \\; dx")}</div>`;
    const V = e.E * e.A / e.L, B = e.E * e.Iz / e.L ** 3, Z = e.E * e.Iy / e.L ** 3, J = e.G * e.J / e.L;
    if (b += '<div class="er-deriv-block">', b += '<div class="er-deriv-header" data-toggle="deriv-axial">\u{1F4D6} K[0,0] = EA/L \u2014 <i>click para ver derivacion completa</i></div>', b += '<div id="er-deriv-axial" class="er-deriv-body" style="display:none">', b += "<p><b>Paso 1:</b> Funcion de forma axial</p>", b += `<div class="er-eq">${M("u(\\xi) = N_1 \\cdot u_i + N_2 \\cdot u_j = (1-\\xi)\\,u_i + \\xi\\,u_j")}</div>`, b += "<p><b>Paso 2:</b> Derivada (deformacion)</p>", b += `<div class="er-eq">${M("\\varepsilon = \\frac{du}{dx} = \\frac{1}{L}\\frac{du}{d\\xi} = \\frac{1}{L}(-u_i + u_j)")}</div>`, b += `<div class="er-eq">${M("\\mathbf{B}_{ax} = \\frac{1}{L}\\begin{bmatrix} -1 & 1 \\end{bmatrix}")}</div>`, b += `<p><b>Paso 3:</b> Integracion ${R("K = \\int_0^L B^T \\cdot EA \\cdot B \\; dx")}</p>`, b += `<div class="er-eq">${M("K_{ax} = \\int_0^L \\frac{1}{L}\\begin{bmatrix}-1\\\\1\\end{bmatrix} \\cdot EA \\cdot \\frac{1}{L}\\begin{bmatrix}-1 & 1\\end{bmatrix} dx")}</div>`, b += `<div class="er-eq">${M("= \\frac{EA}{L^2} \\begin{bmatrix}1 & -1\\\\-1 & 1\\end{bmatrix} \\int_0^L dx = \\frac{EA}{L^2} \\cdot L \\begin{bmatrix}1 & -1\\\\-1 & 1\\end{bmatrix}")}</div>`, b += `<div class="er-eq er-eq-main">${M(`K_{ax} = \\frac{EA}{L}\\begin{bmatrix}1 & -1\\\\-1 & 1\\end{bmatrix} = \\frac{${Xe(e.E)}\\times${Xe(e.A)}}{${Xe(e.L)}}\\begin{bmatrix}1 & -1\\\\-1 & 1\\end{bmatrix}`)}</div>`, b += `<div class="er-eq">${M(`K[0,0] = K[6,6] = \\frac{EA}{L} = \\mathbf{${Xe(V)}}`)}</div>`, b += "</div></div>", b += '<div class="er-deriv-block">', b += '<div class="er-deriv-header" data-toggle="deriv-bend">\u{1F4D6} K[1,1] = 12EI<sub>z</sub>/L\xB3 \u2014 <i>click para ver derivacion completa</i></div>', b += '<div id="er-deriv-bend" class="er-deriv-body" style="display:none">', b += `<p><b>Paso 1:</b> Funcion de forma Hermite para ${R("v(\\xi)")}</p>`, b += `<div class="er-eq">${M("v(\\xi) = H_1 v_i + H_2 \\theta_i + H_3 v_j + H_4 \\theta_j")}</div>`, b += "<p><b>Paso 2:</b> Segunda derivada (curvatura)</p>", b += `<div class="er-eq">${M("\\kappa = \\frac{d^2v}{dx^2} = \\frac{1}{L^2}\\frac{d^2v}{d\\xi^2}")}</div>`, b += `<div class="er-eq">${M("H_1'' = -6+12\\xi, \\quad H_2'' = L(-4+6\\xi), \\quad H_3'' = 6-12\\xi, \\quad H_4'' = L(-2+6\\xi)")}</div>`, b += `<div class="er-eq">${M("\\mathbf{B}_b = \\frac{1}{L^2}\\begin{bmatrix} H_1'' & H_2'' & H_3'' & H_4'' \\end{bmatrix}")}</div>`, b += `<p><b>Paso 3:</b> Integracion para K[1,1] (termino ${R("v_i \\cdot v_i")})</p>`, b += `<div class="er-eq">${M("K[1,1] = \\int_0^L \\frac{(H_1'')^2}{L^4} \\cdot EI_z \\; dx = \\frac{EI_z}{L^4} \\int_0^L (-6+12\\xi)^2 \\; dx")}</div>`, b += `<p>Expandimos: ${R("(-6+12\\xi)^2 = 36 - 144\\xi + 144\\xi^2")}</p>`, b += `<div class="er-eq">${M("\\int_0^L (36-144\\xi+144\\xi^2)\\,dx = 36L - 72L + 48L = 12L")}</div>`, b += `<div class="er-eq er-eq-main">${M(`K[1,1] = \\frac{EI_z}{L^4} \\cdot 12L = \\frac{12EI_z}{L^3} = \\frac{12 \\times ${Xe(e.E)} \\times ${Xe(e.Iz)}}{${Xe(e.L)}^3} = \\mathbf{${Xe(12 * B)}}`)}</div>`, b += "</div></div>", b += '<div class="er-deriv-block">', b += '<div class="er-deriv-header" data-toggle="deriv-tors">\u{1F4D6} K[3,3] = GJ/L \u2014 <i>click para ver derivacion</i></div>', b += '<div id="er-deriv-tors" class="er-deriv-body" style="display:none">', b += `<p>Mismo proceso que axial pero con ${R("\\theta_x")} y ${R("GJ")}:</p>`, b += `<div class="er-eq">${M(`K_{torsion} = \\frac{GJ}{L}\\begin{bmatrix}1 & -1\\\\-1 & 1\\end{bmatrix} = \\frac{${Xe(e.G)}\\times${Xe(e.J)}}{${Xe(e.L)}} = \\mathbf{${Xe(J)}}`)}</div>`, b += "</div></div>", b += '<div class="er-deriv-block">', b += '<div class="er-deriv-header" data-toggle="deriv-coup">\u{1F4D6} K[1,5] = 6EI<sub>z</sub>/L\xB2 \u2014 <i>acoplamiento corte-momento</i></div>', b += '<div id="er-deriv-coup" class="er-deriv-body" style="display:none">', b += `<p>Termino cruzado ${R("v_i \\cdot \\theta_{zi}")} (acoplamiento corte-momento):</p>`, b += `<div class="er-eq">${M("K[1,5] = \\frac{EI_z}{L^4} \\int_0^L H_1'' \\cdot H_2'' \\; dx")}</div>`, b += `<div class="er-eq">${M("= \\frac{EI_z}{L^4} \\int_0^L (-6+12\\xi) \\cdot L(-4+6\\xi) \\; dx")}</div>`, b += `<div class="er-eq">${M("= \\frac{EI_z}{L^3} \\int_0^L (24-36\\xi-48\\xi+72\\xi^2) \\; dx = \\frac{EI_z}{L^3} \\cdot 6L")}</div>`, b += `<div class="er-eq er-eq-main">${M(`K[1,5] = \\frac{6EI_z}{L^2} = \\mathbf{${Xe(6 * e.E * e.Iz / e.L ** 2)}}`)}</div>`, b += "</div></div>", b += '<div class="er-subsec">Resumen de coeficientes:</div>', b += `<div class="er-eq">${M(`\\frac{EA}{L} = \\mathbf{${Xe(V)}} \\qquad \\frac{12EI_z}{L^3} = \\mathbf{${Xe(12 * B)}} \\qquad \\frac{12EI_y}{L^3} = \\mathbf{${Xe(12 * Z)}}`)}</div>`, b += `<div class="er-eq">${M(`\\frac{GJ}{L} = \\mathbf{${Xe(J)}} \\qquad \\frac{4EI_y}{L} = \\mathbf{${Xe(4 * e.E * e.Iy / e.L)}} \\qquad \\frac{4EI_z}{L} = \\mathbf{${Xe(4 * e.E * e.Iz / e.L)}}`)}</div>`, b += `<div class="er-eq">${M(`\\frac{6EI_z}{L^2} = \\mathbf{${Xe(6 * e.E * e.Iz / e.L ** 2)}} \\qquad \\frac{6EI_y}{L^2} = \\mathbf{${Xe(6 * e.E * e.Iy / e.L ** 2)}}`)}</div>`, e.kLocal && (b += `<div class="er-subsec">Resultado: ${R("\\mathbf{K}_{local}")} (12x12)</div>`, b += hn(e.kLocal)), b += '<div class="er-section-title">6. Transformacion de coordenadas</div>', b += "<p>Los cosenos directores del eje del elemento:</p>", b += `<div class="er-eq">${M(`l = \\frac{x_j - x_i}{L} = ${Ln(e.l)} \\qquad m = \\frac{y_j - y_i}{L} = ${Ln(e.m)} \\qquad n = \\frac{z_j - z_i}{L} = ${Ln(e.n)}`)}</div>`, b += `<div class="er-eq">${M(`D = \\sqrt{l^2 + m^2} = ${Ln(e.D)}`)}</div>`, Math.abs(e.n) > 0.999) {
  ...
  function jl(e) {
    ...
    if (b += `<div class="er-section-title">Resumen \u2014 Elemento ${e.elemIdx}</div>`, b += '<table class="er-props">', b += `<tr><td>Tipo</td><td>${e.isFrame ? "Frame (Euler-Bernoulli)" : "Shell"}</td></tr>`, b += `<tr><td>Nodos</td><td>${e.elem.join(" \u2192 ")}</td></tr>`, b += `<tr><td>Longitud</td><td><b>${Xe(e.L)}</b></td></tr>`, b += `<tr><td>E</td><td>${Xe(e.E)}</td></tr>`, b += `<tr><td>A</td><td>${Xe(e.A)}</td></tr>`, b += "</table>", e.uGlobal.length > 0) {
      ...
      for (let M = 0; M < e.elem.length; M++) {
        ...
        for (let V = 0; V < 6; V++) {
          const B = e.uGlobal[M * 6 + V];
          b += `<td class="${Math.abs(B) > 1e-10 ? "nz" : ""}">${Xe(B, 6)}</td>`;
        }
        b += "</tr>";
      }
      b += "</table>";
  ...
  function hn(e) {
    ...
    for (let V = 0; V < R; V++) {
      ...
      for (let B = 0; B < R; B++) {
        const Z = ((_a = e[V]) == null ? void 0 : _a[B]) ?? 0, J = Math.abs(Z) < 1e-10;
        M += `<td class="${J ? "z" : ""} ${V === B && !J ? "diag" : ""}">${J ? "0" : Wl(Z)}</td>`;
      }
      M += "</tr>";
    }
    return M += "</table>", b > R && (M += `<div style="color:var(--fem-label);font-size:9px">(${R}\xD7${R} de ${b}\xD7${b})</div>`), M += "</div>", M;
  }
  function Wl(e) {
    return Math.abs(e) >= 1e6 || Math.abs(e) < 0.01 && e !== 0 ? e.toExponential(1) : Math.abs(e) >= 100 ? e.toFixed(0) : e.toFixed(2);
  }
  function us(e) {
    ...
    if (!b) return;
    const R = e.width, M = e.height, V = 30, B = R - 2 * V, Z = (M - 3 * V) / 2;
    b.fillStyle = getComputedStyle(document.body).getPropertyValue("--fem-bg").trim() || "#111", b.fillRect(0, 0, R, M);
    const J = (H, j, he) => {
      b.strokeStyle = "#333", b.lineWidth = 1, b.strokeRect(V, H, B, Z), b.strokeStyle = "#444", b.beginPath(), b.moveTo(V, H + Z / 2), b.lineTo(V + B, H + Z / 2), b.stroke(), b.fillStyle = "#888", b.font = "11px sans-serif", b.fillText(j, V + 4, H + 14);
      for (const Y of he) {
        b.strokeStyle = Y.color, b.lineWidth = 2.5, b.beginPath();
        for (let $e = 0; $e <= 100; $e++) {
          const fe = $e / 100, re = V + fe * B, ne = H + Z / 2 - Y.fn(fe) * (Z / 2 * 0.85);
          $e === 0 ? b.moveTo(re, ne) : b.lineTo(re, ne);
        }
        b.stroke();
      }
      let T = V + B - 90;
      for (const Y of he) b.fillStyle = Y.color, b.font = "bold 10px sans-serif", b.fillText(Y.label, T, H + Z - 6), T += 36;
      b.fillStyle = "#666", b.font = "9px monospace", b.fillText("0", V, H + Z + 12), b.fillText("1", V + B - 6, H + Z + 12), b.fillText("\u03BE", V + B / 2, H + Z + 12);
    };
    J(V, "Axial (lineal)", [
      {
        fn: (H) => 1 - H,
  ...
  let On = false, Wo = null, bo = null, Yt = null, Ot = null;
  function Yl() {
  ...
  `, document.head.appendChild(R), Ot;
  }
  function Jl() {
    On = true, Ot && (Ot.innerHTML = "\u2715", Ot.style.background = "linear-gradient(135deg, #cc3333, #ff4444)", Ot.style.animation = "none"), Wo = document.createElement("div"), Wo.id = "tour-overlay", Wo.style.cssText = `
    position: fixed; inset: 0; z-index: 9999990;
    pointer-events: none;
  `, document.body.appendChild(Wo), sn(0);
  }
  function xs() {
    On = false, Ot && (Ot.innerHTML = "?", Ot.style.background = "linear-gradient(135deg, #0066cc, #0099ff)", Ot.style.animation = "helpPulse 2s infinite"), bo && (bo.remove(), bo = null), Yt && (Yt.remove(), Yt = null), Wo && (Wo.remove(), Wo = null);
  }
  function sn(e) {
    var _a, _b;
    if (e >= gn.length) {
    ...
    const b = gn[e], R = document.querySelector(b.selector);
    if (!R) {
      sn(e + 1);
      return;
    }
    ...
    const M = R.getBoundingClientRect(), V = window.innerWidth, B = window.innerHeight, Z = 320, J = 180;
  ...
  `, document.body.appendChild(bo);
    const H = V - M.right, j = M.left, he = B - M.bottom, T = M.top;
    let Y = b.position || "bottom";
    Y === "bottom" && he < J + 20 && (Y = "top"), Y === "top" && T < J + 20 && (Y = "right"), Y === "right" && H < Z + 20 && (Y = "left"), Y === "left" && j < Z + 20 && (Y = "bottom");
    let $e, fe, re = "";
    switch (Y) {
      case "bottom":
    ...
    $e = Math.max(10, Math.min($e, V - Z - 10)), fe = Math.max(10, Math.min(fe, B - J - 10)), Yt = document.createElement("div"), Yt.style.cssText = `
    position: fixed;
    left: ${$e}px; top: ${fe}px;
    width: ${Z}px;
  ...
  `, Yt.innerHTML = `
    ...
    <div style="margin-top:8px;display:flex;gap:3px;justify-content:center;">
      ${gn.map((_, D) => `<div style="width:${D === e ? "16px" : "6px"};height:6px;border-radius:3px;background:${D === e ? "#0099ff" : D < e ? "#004488" : "#333"};transition:all 0.3s;"></div>`).join("")}
    </div>
  ...
  `, document.body.appendChild(Yt), (_a = Yt.querySelector("#tour-done")) == null ? void 0 : _a.addEventListener("click", () => xs());
  }
  function Xl(e) {
    var _a;
    const b = e.split(/\r?\n/), R = {
      force: "TONF",
      length: "M"
    }, M = [], V = /* @__PURE__ */ new Map(), B = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), J = [], H = [], j = /* @__PURE__ */ new Map(), he = /* @__PURE__ */ new Map(), T = [], Y = [];
    let $e = "", fe = "";
    ...
    for (const Pe of b) {
      ...
      if (fe === "FRAME SECTIONS") {
        ...
        if (xe) {
          ...
          const ve = B.get(Fe), ze = De.match(/MATERIAL\s+"([^"]+)"/);
          ze && (ve.material = ze[1]);
    ...
    const _ = [], D = [], G = /* @__PURE__ */ new Map(), ue = (Pe, De) => `${Pe}@${De}`, Me = /* @__PURE__ */ new Set(), Ae = /* @__PURE__ */ new Map();
    for (const Pe of J) Ae.set(Pe.name, Pe);
    for (const Pe of J) for (const [De, xe] of he) {
  ...
  function za(e) {
    ...
    let M;
    for (; (M = R.exec(e)) !== null; ) b.set(M[1], M[2] !== void 0 ? M[2] : M[3]);
    return b;
  }
  function Ul(e) {
    const b = e.split(/\r?\n/);
  ...
  function Kl(e) {
    ...
    for (const ne of e) {
      const _ = ne.trimEnd();
      _.endsWith("_") ? R += _.slice(0, -1) + " " : (R += _, b.push(R), R = "");
    }
    R && b.push(R);
    const M = {
      force: "KN",
    ...
    const B = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), H = /* @__PURE__ */ new Map(), j = [], he = [], T = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map(), $e = /* @__PURE__ */ new Map(), fe = [];
    let re = "";
    for (const ne of b) {
      const _ = ne.trim();
      ...
      switch (re) {
        ...
        case "MATERIAL PROPERTIES 02 - BASIC MECHANICAL PROPERTIES": {
          ...
          if (G) {
            ...
            ue.E = it(D.get("E1")), ue.G = it(D.get("G12")), ue.nu = it(D.get("U12")), ue.density = it(D.get("UnitMass")), B.set(G, ue);
          }
          break;
        }
        case "MATERIAL PROPERTIES 03A - STEEL DATA": {
          const G = D.get("Material");
          G && B.has(G) && (B.get(G).fy = it(D.get("Fy")));
          break;
        }
        ...
        case "JOINT COORDINATES": {
          const G = D.get("Joint");
          if (G) {
            const ue = it(D.get("XorR")), Me = it(D.get("Y")), Ae = it(D.get("Z"));
            H.set(G, [
              ue,
              Me,
              Ae
    ...
    return Aa(M, V, B, Z, J, H, j, he, T, Y, $e, fe);
  }
  function Zl(e) {
    const b = {
      force: "KN",
    ...
    const M = /* @__PURE__ */ new Map(), V = /* @__PURE__ */ new Map(), B = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), J = [], H = [], j = /* @__PURE__ */ new Map(), he = [];
    let T = "", Y = "";
    for (const re of e) {
      const ne = re.trim();
    ...
    return Aa(b, R, M, V, B, Z, J, H, j, /* @__PURE__ */ new Map(), /* @__PURE__ */ new Map(), he);
  }
  function Aa(e, b, R, M, V, B, Z, J, H, j, he, T) {
    var _a;
    const Y = [], $e = /* @__PURE__ */ new Map(), fe = [];
    for (const [ye, Ge] of B) $e.set(ye, fe.length), Y.push(ye), fe.push(Ge);
    ...
    }, Me = /* @__PURE__ */ new Map(), Ae = R.values().next().value || {
      E: 29e3,
      nu: 0.3,
      G: 11153
    };
    for (let ye = 0; ye < re.length; ye++) {
      const Ge = _.get(ye), Ye = Ge ? M.get(Ge) : null, be = Ge ? V.get(Ge) : null;
      if (Ye || re[ye].length === 2) {
        const Te = Ye || {
          ...
          B: 0.3,
          shape: "Rectangular"
        }, Ce = R.get(Te.material) || Ae, Ue = Ce.E || Ae.E, ct = Ce.nu || 0.3, Ze = Ce.G || Ue / (2 * (1 + ct));
        ...
        const Te = R.get(be.material) || Ae, Ce = Te.E || Ae.E, Ue = Te.nu || 0.2, ct = Te.G || Ce / (2 * (1 + Ue));
  ...
  function Ql(e) {
    ...
    const { nodes: b, elements: R, nodeInputs: M, elementInputs: V } = e, B = e.units || {
      force: "KN",
      length: "m"
    ...
    if (T.length > 0) {
      ...
      for (const _ of T) {
        const D = R[_], G = D.map((ue, Me) => `Joint${Me + 1}=${ue + 1}`).join("   ");
    ...
    for (const _ of he) {
      const D = ((_a = V.areas) == null ? void 0 : _a.get(_)) || 0, G = ((_b = V.momentsOfInertiaZ) == null ? void 0 : _b.get(_)) || 0, ue = ((_c = V.momentsOfInertiaY) == null ? void 0 : _c.get(_)) || 0, Me = ((_d = V.torsionalConstants) == null ? void 0 : _d.get(_)) || 0, Ae = ((_e = V.elasticities) == null ? void 0 : _e.get(_)) || 0, Ke = `MAT_${Math.round(Ae)}`, ye = `A${D.toPrecision(6)}_Iz${G.toPrecision(6)}`;
      if (!Y.has(ye)) {
        let Ye = 0.3, be = 0.3;
        D > 0 && G > 0 && (Ye = Math.sqrt(12 * G / D), be = D / Ye), Y.set(ye, {
          A: D,
          Iz: G,
          Iy: ue,
          J: Me,
    ...
    if (Y.size > 0) {
      ...
      for (const [, D] of Y) {
        _++;
        const G = D.A * 5 / 6;
        H(`   SectionName=SEC${_}   Material=${D.matKey}   Shape=Rectangular   t3=${Pt(D.h)}   t2=${Pt(D.b)}   Area=${Pt(D.A)}   TorsConst=${Pt(D.J)}   I33=${Pt(D.Iz)}   I22=${Pt(D.Iy)}   I23=0   AS2=${Pt(G)}   AS3=${Pt(G)} _`), H("        Color=Blue   FromFile=No   AMod=1   A2Mod=1   A3Mod=1   JMod=1   I2Mod=1   I3Mod=1   MMod=1   WMod=1");
      }
      j();
    }
    const fe = /* @__PURE__ */ new Map(), re = /* @__PURE__ */ new Map();
    for (const _ of T) {
      const D = ((_f = V.thicknesses) == null ? void 0 : _f.get(_)) || 0.1, G = ((_g = V.elasticities) == null ? void 0 : _g.get(_)) || 0, ue = `MAT_${Math.round(G)}`, Me = `t${D.toPrecision(6)}`;
      fe.has(Me) || fe.set(Me, {
        t: D,
        matKey: ue
      });
    ...
    if (T.length > 0) {
      ...
      let _ = 0;
      for (const [, D] of fe) _++, H(`   Section=SSEC${_}   Material=${D.matKey}   MatAngle=0   AreaType=Shell   Type=ShellThin   DrillDOF=Yes   Thickness=${Pt(D.t)}   BendThick=${Pt(D.t)}   Color=Cyan`);
      j();
    }
    H('TABLE:  "JOINT COORDINATES"');
    for (let _ = 0; _ < b.length; _++) {
      const D = b[_];
      H(`   Joint=${_ + 1}   CoordSys=GLOBAL   CoordType=Cartesian   XorR=${Pt(D[0])}   Y=${Pt(D[1])}   Z=${Pt(D[2])}   SpecialJt=No`);
    }
    ...
    if (H('TABLE:  "LOAD PATTERN DEFINITIONS"'), H("   LoadPat=DEAD   DesignType=Dead   SelfWtMult=0"), j(), H('TABLE:  "LOAD CASE DEFINITIONS"'), H('   Case=DEAD   Type=LinStatic   InitialCond=Zero   DesTypeOpt="Prog Det"   DesignType=Dead   DesActOpt="Prog Det"   DesignAct=Non-Composite   AutoType=None   RunCase=Yes'), j(), H('TABLE:  "CASE - STATIC 1 - LOAD ASSIGNMENTS"'), H('   Case=DEAD   LoadType="Load pattern"   LoadName=DEAD   LoadSF=1'), j(), M.forces && M.forces.size > 0) {
      ...
      for (const [_, D] of M.forces) D.some((G) => Math.abs(G) > 1e-12) && H(`   Joint=${_ + 1}   LoadPat=DEAD   CoordSys=GLOBAL   F1=${Pt(D[0])}   F2=${Pt(D[1])}   F3=${Pt(D[2])}   M1=${Pt(D[3])}   M2=${Pt(D[4])}   M3=${Pt(D[5])}`);
      j();
    }
    const ne = /* @__PURE__ */ new Map();
    for (let _ = 0; _ < R.length; _++) {
      const D = ((_h = V.elasticities) == null ? void 0 : _h.get(_)) || 0, G = ((_i = V.shearModuli) == null ? void 0 : _i.get(_)) || 0, ue = D > 0 && G > 0 ? Math.max(0, Math.min(0.5, D / (2 * G) - 1)) : 0.2, Me = ((_j = V.densities) == null ? void 0 : _j.get(_)) || 0, Ae = `MAT_${Math.round(D)}`;
      ne.has(Ae) || ne.set(Ae, {
        E: D,
        nu: ue,
        G,
    ...
    for (const [_, D] of ne) H(`   Material=${_}   UnitWeight=${Pt(D.rho * 9.81)}   UnitMass=${Pt(D.rho)}   E1=${Pt(D.E)}   G12=${Pt(D.G)}   U12=${Pt(D.nu)}   A1=9.9E-06`);
...
`);
  ...
  function oi(e) {
    var _a, _b, _c, _d;
    const { nodes: b, elements: R, nodeInputs: M, elementInputs: V, title: B, units: Z } = e, J = (Z == null ? void 0 : Z.force) || "TONF", H = (Z == null ? void 0 : Z.length) || "M", j = [], he = (be) => Math.round(be * 1e4) / 1e4;
    ...
    $e.push("Base"), fe.set(Y[0], "Base");
    for (let be = 1; be < Y.length; be++) {
      const Te = `Level_${be}`;
      $e.push(Te), fe.set(Y[be], Te);
    }
    j.push("$ STORIES - IN SEQUENCE FROM TOP");
    for (let be = Y.length - 1; be >= 1; be--) j.push(`  STORY "${$e[be]}"  HEIGHT ${he(Y[be] - Y[be - 1])} MASTERSTORY "Yes"  `);
    Y.length > 0 && j.push(`  STORY "Base"  ELEV ${Y[0]} `), j.push(""), R.some((be) => be.length === 4) && (j.push("$ DIAPHRAGM NAMES"), j.push('  DIAPHRAGM "D1"    TYPE RIGID'), j.push("")), j.push("$ MATERIAL PROPERTIES");
    const ne = /* @__PURE__ */ new Set();
    (_a = V.elasticities) == null ? void 0 : _a.forEach((be) => ne.add(be));
    const _ = /* @__PURE__ */ new Map();
    let D = 0;
    for (const be of ne) {
      const Te = `Mat_${++D}`;
      _.set(be, Te), j.push(`  MATERIAL  "${Te}"    TYPE "Concrete"    WEIGHTPERVOLUME 2.4`), j.push(`  MATERIAL  "${Te}"    SYMTYPE "Isotropic"  E ${be}  U 0.2  A 1E-05`);
    }
    ...
    R.forEach((be, Te) => {
      ...
      Ze && (St += `  D ${Ze}`), dt && (St += `  B ${dt}`), ut && !Ze && (St += `  D ${ut}`), Tt && (St += `  TF ${Tt}`), Nt && (St += `  TW ${Nt}`), j.push(St);
    }), j.push("");
    ...
    R.forEach((be, Te) => {
      ...
      if (Ce === "BEAM") {
        ...
        j.push(`  LINE  "E${Te + 1}"  BEAM  "${ct.pt}"  "${Ze.pt}"  0`), Ge.push(`  LINEASSIGN  "E${Te + 1}"  "${ct.story}"  SECTION "${Ue}"  MINNUMSTA 3 AUTOMESH "YES"  MESHATINTERSECTIONS "YES"  `);
      } else {
        const ct = b[be[0]][1] <= b[be[1]][1] ? be[0] : be[1], Ze = b[be[0]][1] <= b[be[1]][1] ? be[1] : be[0];
        ye(ct);
        const dt = ye(Ze), ut = he(b[ct][1]), Tt = he(b[Ze][1]), Nt = Y.indexOf(ut), Bt = Y.indexOf(Tt), Mt = Math.max(1, Bt >= 0 && Nt >= 0 ? Bt - Nt : 1);
    ...
    }), j.push(""), j.push("$ POINT ASSIGNS"), (_b = M.supports) == null ? void 0 : _b.forEach((be, Te) => {
      const Ce = [];
    ...
    }), j.push(""), j.push("$ LINE ASSIGNS"), Ge.forEach((be) => j.push(be)), j.push("");
    const Ye = [];
    if (R.forEach((be, Te) => {
      if (be.length === 4) {
      ...
      j.push(`  SHELLPROP  "Losa"  PROPTYPE  "Slab"  MATERIAL "${_.values().next().value || "Mat_1"}"  MODELINGTYPE "ShellThin"  SLABTYPE "Slab"  SLABTHICKNESS ${be} `), j.push("");
    }
    if (Ye.some((be) => be.isWall)) {
      j.push("$ WALL PROPERTIES");
      const be = ((_d = V.thicknesses) == null ? void 0 : _d.values().next().value) ?? 0.2;
      j.push(`  SHELLPROP  "Muro"  PROPTYPE  "Wall"  MATERIAL "${_.values().next().value || "Mat_1"}"  MODELINGTYPE "ShellThick"  WALLTHICKNESS ${be} `), j.push("");
    }
    if (Ye.length > 0) {
      ...
      Ye.forEach((Te, Ce) => {
        ...
        if (ct) {
          ...
          j.push(`  AREA "${Ze}"  ${dt}  4  "${ut[Tt].pt}"  "${ut[Nt].pt}"  "${ut[Nt].pt}"  "${ut[Tt].pt}"  1  1  0  0  `);
        ...
        } else j.push(`  AREA "${Ze}"  ${dt}  4  "${ut[0].pt}"  "${ut[1].pt}"  "${ut[2].pt}"  "${ut[3].pt}"  0  0  0  0  `), be.push(`  AREAASSIGN  "${Ze}"  "${ut[0].story}"  SECTION "Losa"  DIAPH  "D1"  OBJMESHTYPE "DEFAULT"  ADDRESTRAINT "Yes"  CARDINALPOINT "TOP"  TRANSFORMSTIFFNESSFOROFFSETS "No"  `);
      }), j.push(""), j.push("$ AREA ASSIGNS"), be.forEach((Te) => j.push(Te)), j.push("");
    }
    return j.push("$ LOAD PATTERNS"), j.push('  LOADPATTERN "Dead"  TYPE  "Dead"  SELFWEIGHT  1'), j.push('  LOADPATTERN "Live"  TYPE  "Live"  SELFWEIGHT  0'), j.push(""), M.loads && M.loads.size > 0 && (j.push("$ POINT OBJECT LOADS"), M.loads.forEach((be, Te) => {
...
`);
  ...
  function ni(e, b) {
    const R = e[b[0]], M = e[b[1]], V = Math.abs(M[1] - R[1]), B = Math.sqrt((M[0] - R[0]) ** 2 + (M[2] - R[2]) ** 2), Z = V > B * 0.5;
    return Z && B > 0.01 ? "BRACE" : Z ? "COLUMN" : "BEAM";
  }
  function si(e) {
    var _a, _b;
    const { nodes: b, elements: R, nodeInputs: M, elementInputs: V } = e, B = [];
    return B.push("# OpenSeesPy model exported from Awatif FEM Studio"), B.push(`# ${b.length} nodes, ${R.length} elements`), B.push(""), B.push("import openseespy.opensees as ops"), B.push(""), B.push("ops.wipe()"), B.push("ops.model('basic', '-ndm', 3, '-ndf', 6)"), B.push(""), B.push("# --- Nodes ---"), b.forEach((Z, J) => {
      B.push(`ops.node(${J + 1}, ${Z[0]}, ${Z[1]}, ${Z[2]})`);
    }), B.push(""), B.push("# --- Boundary Conditions ---"), (_a = M.supports) == null ? void 0 : _a.forEach((Z, J) => {
      const H = Z.map((j) => j ? 1 : 0).join(", ");
      B.push(`ops.fix(${J + 1}, ${H})`);
    }), B.push(""), B.push("# --- Geometric Transformations ---"), B.push("ops.geomTransf('Linear', 1, 0.0, 0.0, 1.0)  # beams (vecxz = Z)"), B.push("ops.geomTransf('Linear', 2, -1.0, 0.0, 0.0)  # columns (vecxz = -X)"), B.push(""), B.push("# --- Elements (elasticBeamColumn) ---"), R.forEach((Z, J) => {
      var _a2, _b2, _c, _d, _e, _f;
      if (Z.length !== 2) return;
      const H = b[Z[0]], j = b[Z[1]], T = Math.abs(j[2] - H[2]) > Math.max(Math.abs(j[0] - H[0]), Math.abs(j[1] - H[1])) ? 2 : 1, Y = ((_a2 = V.areas) == null ? void 0 : _a2.get(J)) ?? 1, $e = ((_b2 = V.elasticities) == null ? void 0 : _b2.get(J)) ?? 2e5, fe = ((_c = V.shearModuli) == null ? void 0 : _c.get(J)) ?? 8e4, re = ((_d = V.torsionalConstants) == null ? void 0 : _d.get(J)) ?? 1, ne = ((_e = V.momentsOfInertiaY) == null ? void 0 : _e.get(J)) ?? 1, _ = ((_f = V.momentsOfInertiaZ) == null ? void 0 : _f.get(J)) ?? 1;
      B.push(`ops.element('elasticBeamColumn', ${J + 1}, ${Z[0] + 1}, ${Z[1] + 1}, ${Y}, ${$e}, ${fe}, ${re}, ${ne}, ${_}, ${T})`);
    }), B.push(""), M.loads && M.loads.size > 0 && (B.push("# --- Loads ---"), B.push("ops.timeSeries('Linear', 1)"), B.push("ops.pattern('Plain', 1, 1)"), M.loads.forEach((Z, J) => {
    ...
    }), B.push(""), B.push('print("\\n=== Reactions ===")'), B.push("ops.reactions()"), (_b = M.supports) == null ? void 0 : _b.forEach((Z, J) => {
...
`);
  ...
  function ai(e) {
    var _a, _b;
    const { nodes: b, elements: R, nodeInputs: M, elementInputs: V } = e, B = [];
    return B.push("# OpenSees Tcl model exported from Awatif FEM Studio"), B.push(`# ${b.length} nodes, ${R.length} elements`), B.push(""), B.push("wipe"), B.push("model basic -ndm 3 -ndf 6"), B.push(""), B.push("# --- Nodes ---"), b.forEach((Z, J) => {
      B.push(`node ${J + 1} ${Z[0]} ${Z[1]} ${Z[2]}`);
    }), B.push(""), B.push("# --- Boundary Conditions ---"), (_a = M.supports) == null ? void 0 : _a.forEach((Z, J) => {
      const H = Z.map((j) => j ? 1 : 0).join(" ");
      B.push(`fix ${J + 1} ${H}`);
    }), B.push(""), B.push("# --- Geometric Transformations ---"), B.push("geomTransf Linear 1 0.0 0.0 1.0"), B.push("geomTransf Linear 2 -1.0 0.0 0.0"), B.push(""), B.push("# --- Elements ---"), R.forEach((Z, J) => {
      var _a2, _b2, _c, _d, _e, _f;
      if (Z.length !== 2) return;
      const H = b[Z[0]], j = b[Z[1]], T = Math.abs(j[2] - H[2]) > Math.max(Math.abs(j[0] - H[0]), Math.abs(j[1] - H[1])) ? 2 : 1, Y = ((_a2 = V.areas) == null ? void 0 : _a2.get(J)) ?? 1, $e = ((_b2 = V.elasticities) == null ? void 0 : _b2.get(J)) ?? 2e5, fe = ((_c = V.shearModuli) == null ? void 0 : _c.get(J)) ?? 8e4, re = ((_d = V.torsionalConstants) == null ? void 0 : _d.get(J)) ?? 1, ne = ((_e = V.momentsOfInertiaY) == null ? void 0 : _e.get(J)) ?? 1, _ = ((_f = V.momentsOfInertiaZ) == null ? void 0 : _f.get(J)) ?? 1;
      B.push(`element elasticBeamColumn ${J + 1} ${Z[0] + 1} ${Z[1] + 1} ${Y} ${$e} ${fe} ${re} ${ne} ${_} ${T}`);
    }), B.push(""), M.loads && M.loads.size > 0 && (B.push("# --- Loads ---"), B.push("timeSeries Linear 1"), B.push("pattern Plain 1 1 {"), M.loads.forEach((Z, J) => {
      const H = Z.map((j) => j).join(" ");
      B.push(`  load ${J + 1} ${H}`);
    ...
    }), B.push('puts "\\n=== Reactions ==="'), B.push("reactions"), (_b = M.supports) == null ? void 0 : _b.forEach((Z, J) => {
      B.push(`puts "Node ${J + 1}: [nodeReaction ${J + 1}]"`);
    }), B.join(`
`);
  }
  function li(e) {
    const b = [], R = [], M = /* @__PURE__ */ new Map(), V = /* @__PURE__ */ new Map(), B = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), H = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map(), he = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map();
      ...
      if (_) {
        ...
        if (ue !== void 0 && Me !== void 0) {
          ...
          R.push([
            ue,
            Me
          ]), Y.set(G, Ae), J.set(Ae, parseFloat(_[4])), B.set(Ae, parseFloat(_[5])), Z.set(Ae, parseFloat(_[6])), he.set(Ae, parseFloat(_[7])), H.set(Ae, parseFloat(_[8])), j.set(Ae, parseFloat(_[9]));
        }
        continue;
      }
      const D = fe.match(/ops\.load\(\s*(\d+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)/);
      if (D) {
  ...
  function ii(e) {
    const b = [], R = [], M = /* @__PURE__ */ new Map(), V = /* @__PURE__ */ new Map(), B = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), H = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map(), he = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Map();
      ...
      if (fe[0] === "element" && fe[1] === "elasticBeamColumn" && fe.length >= 12) {
        ...
        if (re !== void 0 && ne !== void 0) {
          ...
          R.push([
            re,
            ne
          ]), J.set(_, parseFloat(fe[5])), B.set(_, parseFloat(fe[6])), Z.set(_, parseFloat(fe[7])), he.set(_, parseFloat(fe[8])), H.set(_, parseFloat(fe[9])), j.set(_, parseFloat(fe[10]));
        }
        continue;
      }
  ...
  function ri(e) {
    const b = {
      ...
      project: "",
      app: ""
    }, R = {}, M = {}, V = e.match(/FILE_SCHEMA\s*\(\s*\(\s*'([^']*)'/i);
    V && (b.schema = V[1]);
  ...
  function Ca(e, b) {
    const R = no(b.args), M = Zt(e, R[0]), V = M ? ci(e, M) : [
      0,
      0,
      0
    ];
  ...
  function Fa(e, b) {
    ...
    if (M && (V = Ca(e, M)), R[0] && R[0] !== "$") {
      const B = Zt(e, R[0]);
      if (B && B.type === "IFCLOCALPLACEMENT") {
        const Z = Fa(e, B), J = gs(V.origin, Z.dirX, ms(Z.dirZ, Z.dirX), Z.dirZ);
        V.origin = [
          Z.origin[0] + J[0],
          Z.origin[1] + J[1],
          Z.origin[2] + J[2]
        ], V.dirZ = gs(V.dirZ, Z.dirX, ms(Z.dirZ, Z.dirX), Z.dirZ), V.dirX = gs(V.dirX, Z.dirX, ms(Z.dirZ, Z.dirX), Z.dirZ);
      }
    }
    return V;
  }
  ...
  function gs(e, b, R, M) {
    return [
      e[0] * b[0] + e[1] * R[0] + e[2] * M[0],
      e[0] * b[1] + e[1] * R[1] + e[2] * M[1],
      e[0] * b[2] + e[1] * R[2] + e[2] * M[2]
    ];
  }
  const di = 0.01;
  function pi(e) {
    const b = ri(e), { entities: R, typeIndex: M } = b, V = [], B = [], Z = /* @__PURE__ */ new Map();
    Z.set("Hormigon", {
      E: 2132888792e-2,
      nu: 0.2,
      rho: 2.4
    ...
    function j(ne, _, D) {
      for (const G of V) {
        const ue = G.x - ne, Me = G.y - _, Ae = G.z - D;
        if (Math.sqrt(ue * ue + Me * Me + Ae * Ae) < di) return G.id;
      }
      return V.push({
        id: J,
        x: ne,
    ...
    function he(ne) {
      const _ = La(ne.args, 2) || "", D = M.IFCRELASSOCIATESMATERIAL || [];
      for (const ue of D) {
        const Me = R[ue];
        if (!Me) continue;
        const Ae = no(Me.args);
        if ((Ae[4] || Ae[3] || "").includes(`#${ne.id}`)) {
          const ye = Ae[5] || Ae[4] || "", Ge = Zt(R, ye);
          if (Ge) return T(Ge);
        }
      }
    ...
    function T(ne) {
      ...
      if (_ === "IFCRECTANGLEPROFILEDEF") {
        const D = no(ne.args), G = (D[1] || "").replace(/'/g, ""), ue = parseFloat(D[3]) || 0.3, Me = parseFloat(D[4]) || 0.3;
        return {
          b: ue,
          h: Me,
          name: G
      ...
      if (_ === "IFCMATERIALPROFILE") {
        const D = no(ne.args), G = D[2] || D[1] || "", ue = Zt(R, G);
        if (ue) return T(ue);
      }
      if (_ === "IFCMATERIALPROFILESET") {
        const D = no(ne.args), ue = (D[2] || D[1] || "").match(/#(\d+)/);
        if (ue) {
      ...
      if (_ === "IFCMATERIALPROFILESETUSAGE") {
        const G = no(ne.args)[0], ue = Zt(R, G);
        if (ue) return T(ue);
      }
      return {
        b: 0.3,
    ...
    function Y(ne, _, D, G) {
      ...
      for (const Me of ue) {
        const Ae = R[Me];
        if (!Ae) continue;
        const Ke = no(Ae.args), ye = Ke[5] || Ke[4] || "", Ge = Zt(R, ye);
        if (!Ge) continue;
        const Ye = Fa(R, Ge), be = he(Ae);
        let Te = G, Ce = null, Ue = null;
        const ct = Ke[6] || Ke[5] || "", Ze = Zt(R, ct);
        if (Ze) {
          const bt = Rn(R, Ze);
          bt && (Te = bt.depth || G, Ce = bt.origin, Ue = bt.direction);
        }
        const dt = Ce ? Ce[0] : Ye.origin[0], ut = Ce ? Ce[1] : Ye.origin[1], Tt = Ce ? Ce[2] : Ye.origin[2], Nt = Ue || (D === "Z" ? Ye.dirZ : Ye.dirX), Bt = j(dt, ut, Tt), Mt = j(dt + Nt[0] * Te, ut + Nt[1] * Te, Tt + Nt[2] * Te);
        B.push({
          id: H++,
          type: "frame",
          nodeIds: [
    ...
    for (const ne of re) {
      const _ = R[ne];
      if (!_) continue;
      const D = no(_.args), G = (D[2] || "").replace(/'/g, ""), ue = parseFloat(D[9]) || 0;
      fe.push({
        name: G,
        elevation: ue
      });
  ...
  function Rn(e, b) {
    ...
    for (const M of R) {
      const V = M.match(/#(\d+)/g) || [];
      for (const B of V) {
        const Z = parseInt(B.replace("#", "")), J = e[Z];
        if (J) {
          if (J.type === "IFCEXTRUDEDAREASOLID") {
            const H = no(J.args), j = parseFloat(H[3]) || 0, he = Zt(e, H[1]);
            let T = [
              0,
              0,
              0
            ...
            if (Y && Y.type === "IFCDIRECTION") {
              const fe = Y.args.match(/[-+]?\d*\.?\d+(?:[eE][-+]?\d+)?/g);
          ...
          if (J.type === "IFCMAPPEDITEM") {
            ...
            if (j && j.type === "IFCREPRESENTATIONMAP") {
              const he = no(j.args), T = Zt(e, he[1]);
              if (T) {
                const Y = Rn(e, T);
                if (Y) return Y;
              }
  ...
  async function mi(e, b) {
    ...
    const M = new R.IfcAPI(), V = window.location.pathname.replace(/\/[^/]*$/, "/");
    M.SetWasmPath(V), await M.Init();
    const B = M.OpenModel(new Uint8Array(b)), Z = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), H = {
      843113511: "Columna",
      753842376: "Viga",
      1529196076: "Losa",
      900683007: "Zapata",
    ...
    for (const [$e] of Pa) {
      const fe = ui($e);
      try {
        const re = M.GetLineIDsWithType(B, $e);
    ...
    return M.StreamAllMeshes(B, ($e) => {
      ...
      for (let _ = 0; _ < ne.size(); _++) {
        const D = ne.get(_), G = M.GetGeometry(B, D.geometryExpressID), ue = M.GetVertexArray(G.GetVertexData(), G.GetVertexDataSize()), Me = M.GetIndexArray(G.GetIndexData(), G.GetIndexDataSize()), Ae = new co(), Ke = new Float32Array(ue.length / 2), ye = new Float32Array(ue.length / 2);
        ...
        const Ge = new yl();
        Ge.fromArray(D.flatTransformation);
        let Ye;
        const be = D.color;
        be && (be.x !== 1 || be.y !== 1 || be.z !== 1) ? Ye = new ya({
          ...
          opacity: be.w,
          side: $a
        }) : Ye = Y, Ye._origOpacity = Ye.opacity;
        const Te = new Ta(Ae, Ye);
        Te.applyMatrix4(Ge), Te.userData.expressID = $e.expressID, Te.userData.category = fe, re.add(Te), he.expandByObject(Te), T++, G.delete();
      }
    }), M.CloseModel(B), {
      meshCount: T,
      bbox: he,
  ...
  Mi = function(e) {
    ...
    let H = false;
    const j = /* @__PURE__ */ new Set(), he = /* @__PURE__ */ new Map();
    let T = "", Y = {}, $e = null, fe = "", re = [], ne = [], _ = [], D = /* @__PURE__ */ new Set(), G = /* @__PURE__ */ new Set(), ue = /* @__PURE__ */ new Set(), Me = /* @__PURE__ */ new Map(), Ae = /* @__PURE__ */ new Map(), Ke = null, ye = [], Ge = 0.2, Ye = 2, be = 2, Te = false, Ce = 2, Ue = "x", ct = /* @__PURE__ */ new Set(), Ze = true, dt = 0.15, ut = 2, Tt = 2, Nt = /* @__PURE__ */ new Set(), Bt = false, Mt = "perimeter";
    const bt = () => ({
      b: 0.3,
      h: 0.4,
      profileIdx: 0,
    ...
    function vs(t, o, n, l, a) {
      ...
      for (const h of n) {
        for (const I of o) {
          ...
          P.computeLineDistances(), P.renderOrder = -10, xt.add(P);
        }
        for (const I of t) {
          const A = new co().setFromPoints([
            new qe(I, h, p),
      ...
      for (const h of n) for (const I of t) for (const A of o) {
        const z = [
          ...
          new qe(I, h, A - f),
          new qe(I, h, A + f)
        ], P = new co().setFromPoints(z), k = new tn({
          color: 5596791,
          transparent: true,
          opacity: 0.4
        }), m = new en(P, k);
    ...
    function an(t, o, n, l, a) {
      ...
      const s = Math.min(...t), i = Math.max(...t), p = Math.min(...o), r = Math.max(...o), d = i - s || 1, g = r - p || 1, S = Math.max(d, g), $ = S * 0.08, y = l || t.map((m, u) => String.fromCharCode(65 + u)), f = a || o.map((m, u) => String(u + 1)), h = S * 0.018, I = o.length <= 1, A = 8947848;
      for (let m = 0; m < t.length; m++) {
        const u = t[m];
        if (I) {
          const E = -$ - h * 1.5;
          Dn(u, 0, 0, u, 0, E + h, A, Ht), Bn(y[m] || `${m}`, u, 0, E, h, Ht);
        } else {
          const E = p - $ - h * 1.5;
          Dn(u, p, 0, u, E + h, 0, A, Ht), Bn(y[m] || `${m}`, u, E, 0, h, Ht);
        }
      }
      if (!I) for (let m = 0; m < o.length; m++) {
        const u = o[m], E = s - $ - h * 1.5;
        Dn(s, u, 0, E + h, u, 0, A, Ht), Bn(f[m] || `${m}`, E, u, 0, h, Ht);
      }
      const z = h * 1.8, P = $ * 1.2, k = $ * 1.2;
      for (let m = 0; m < t.length - 1; m++) {
        const u = t[m], E = t[m + 1], L = Math.abs(E - u), O = (u + E) / 2, W = `${L.toFixed(2)} m`;
        I ? (qn(W, O, 0, -P, z, Ht), _n(u, 0, -P * 0.7, E, 0, -P * 0.7, 16763904, Ht)) : (qn(W, O, p - k, 0, z, Ht), _n(u, p - k * 0.7, 0, E, p - k * 0.7, 0, 16763904, Ht));
      }
      if (!I) for (let m = 0; m < o.length - 1; m++) {
        const u = o[m], E = o[m + 1], L = Math.abs(E - u), O = (u + E) / 2, W = `${L.toFixed(2)} m`;
        qn(W, s - P, O, 0, z, Ht), _n(s - P * 0.7, u, 0, s - P * 0.7, E, 0, 16763904, Ht);
      }
      Ht.traverse((m) => {
    ...
    function Nn(t, o, n) {
      ...
      for (const f of t) {
        const h = f.elev;
        S ? (ln(a - g, 0, h, c + g, 0, h, $, Qt), Ms(f.name, c + g * 1.5, 0, h, y, Qt)) : (ln(a, s, h, c, s, h, $, Qt), ln(c, s, h, c, i, h, $, Qt), ln(c, i, h, a, i, h, $, Qt), ln(a, i, h, a, s, h, $, Qt), Ms(f.name, a - g * 1.5, s, h, y, Qt));
      }
      Qt.traverse((f) => {
    ...
    const ot = {
      ...
      build(t) {
        ...
        const o = (t == null ? void 0 : t.col) || "40x40", n = (t == null ? void 0 : t.viga) || "30x40", l = (t == null ? void 0 : t.fc) || 210, [a, c] = o.split("x").map((N) => parseFloat(N) / 100), [s, i] = n.split("x").map((N) => parseFloat(N) / 100), p = Je.map((N) => N.coord), r = Qe.map((N) => N.coord), d = pt.map((N) => N.elev), g = p.length, S = r.length, $ = d.length, y = $ - 1, f = [], h = {};
        for (let N = 0; N < $; N++) for (let ce = 0; ce < S; ce++) for (let oe = 0; oe < g; oe++) h[`${oe},${ce},${N}`] = f.length, f.push([
          p[oe],
          r[ce],
          d[N]
        ]);
        const I = [], A = /* @__PURE__ */ new Set(), z = /* @__PURE__ */ new Set(), P = /* @__PURE__ */ new Map();
        for (let N = 0; N < y; N++) for (let ce = 0; ce < S; ce++) for (let oe = 0; oe < g; oe++) {
          const pe = I.length;
          I.push([
            h[`${oe},${ce},${N}`],
            h[`${oe},${ce},${N + 1}`]
        ...
        for (let N = 1; N < $; N++) for (let ce = 0; ce < S; ce++) for (let oe = 0; oe < g - 1; oe++) {
          const pe = I.length;
          I.push([
            h[`${oe},${ce},${N}`],
            h[`${oe + 1},${ce},${N}`]
          ]), z.add(pe), P.set(pe, N - 1);
        }
        for (let N = 1; N < $; N++) for (let ce = 0; ce < g; ce++) for (let oe = 0; oe < S - 1; oe++) {
          const pe = I.length;
          I.push([
            h[`${ce},${oe},${N}`],
            h[`${ce},${oe + 1},${N}`]
        ...
        if (k) {
          const N = k === "all" || k === "x" || k === "perimeter", ce = k === "all" || k === "y" || k === "perimeter";
          for (let oe = 0; oe < y; oe++) {
            if (N) for (let pe = 0; pe < S; pe++) {
        ...
        const u = 15100 * Math.sqrt(l) * 10, E = u / (2 * (1 + 0.2)), L = a * c, O = a * c ** 3 / 12, W = c * a ** 3 / 12, x = a * c * (a ** 2 + c ** 2) / 12, w = s * i, v = s * i ** 3 / 12, F = i * s ** 3 / 12, K = s * i * (s ** 2 + i ** 2) / 12, U = /* @__PURE__ */ new Map(), le = /* @__PURE__ */ new Map(), te = /* @__PURE__ */ new Map(), Q = /* @__PURE__ */ new Map(), me = /* @__PURE__ */ new Map(), de = /* @__PURE__ */ new Map(), ke = /* @__PURE__ */ new Map();
        for (let N = 0; N < I.length; N++) U.set(N, u), le.set(N, E), A.has(N) ? (te.set(N, L), Q.set(N, O), me.set(N, W), de.set(N, x), ke.set(N, {
          type: "rect",
          b: a,
          h: c,
          name: `COL${o}`
        })) : m.has(N) ? (te.set(N, L), Q.set(N, O), me.set(N, W), de.set(N, x), ke.set(N, {
          type: "rect",
          b: a,
          h: c,
          name: `BR${o}`
        })) : (te.set(N, w), Q.set(N, v), me.set(N, F), de.set(N, K), ke.set(N, {
          type: "rect",
          b: s,
          h: i,
          name: `V${n}`
        ...
        const Re = /* @__PURE__ */ new Map();
        for (let N = 0; N < S; N++) for (let ce = 0; ce < g; ce++) Re.set(h[`${ce},${N},0`], [
          true,
          true,
          true,
          true,
        ...
        return e.nodes.val = f, e.elements.val = I, e.nodeInputs.val = {
          ...
          sectionShapes: ke
        }, D = A, G = z, Me = P, console.log(`Built: ${f.length} nodes, ${I.length} elements (${A.size} cols, ${z.size} beams, ${m.size} braces)`), console.log(`  Col: ${o}, Viga: ${n}, f'c=${l}${k ? `, braces=${k}` : ""}`), {
          nodes: f.length,
          elements: I.length
        };
      },
      ...
      addBeam(t, o, n, l, a) {
        var _a2;
        const c = Je.findIndex((P) => P.label === t), s = Qe.findIndex((P) => P.label === o), i = Je.findIndex((P) => P.label === n), p = Qe.findIndex((P) => P.label === l), r = pt.findIndex((P) => P.label === a);
        if (c < 0 || s < 0 || i < 0 || p < 0) {
          console.log("Axis not found");
          return;
        }
        if (r < 1) {
          console.log(`Story "${a}" not found. Available: ${pt.filter((P) => P.label !== "Base").map((P) => P.label)}`);
          return;
        }
        const d = Je[c].coord, g = Qe[s].coord, S = Je[i].coord, $ = Qe[p].coord, y = pt[r].elev, f = [
          ...
          const u = f.findIndex((E) => Math.abs(E[0] - P) < 1e-3 && Math.abs(E[1] - k) < 1e-3 && Math.abs(E[2] - m) < 1e-3);
          return u >= 0 ? u : (f.push([
            P,
            k,
            m
        ...
        return h.push([
          A,
          z
        ]), G.add(h.length - 1), Me.set(h.length - 1, r - 1), e.nodes.val = f, e.elements.val = h, console.log(`Added beam ${t}-${o} \u2192 ${n}-${l} at ${a}`), h.length - 1;
      },
      addBrace(t, o, n, l, a, c) {
        ...
        const S = Je[s].coord, $ = Qe[i].coord, y = pt[p].elev, f = Je[r].coord, h = Qe[d].coord, I = pt[g].elev, A = [
          ...e.nodes.val
        ], z = [
          ...((_a2 = e.elements) == null ? void 0 : _a2.val) || []
        ], P = (u, E, L) => {
        ...
        return z.push([
          k,
          m
        ]), Me.set(z.length - 1, Math.min(p, g)), e.nodes.val = A, e.elements.val = z, console.log(`Added brace ${t}-${o}@${n} \u2192 ${l}-${a}@${c}`), z.length - 1;
      },
      help() {
        return `=== CLI Commands ===
MODEL:
...
`;
      ...
      model3d(t) {
        ...
        for (let ee = 0; ee < h; ee++) for (let ge = 0; ge < f; ge++) for (let Ie = 0; Ie < y; Ie++) z[`${Ie},${ee},${ge}`] = A.length, A.push([
          g[Ie],
          $[ee],
          S[ge]
        ]);
        ...
        const L = 15100 * Math.sqrt(s) * 10, O = L / (2 * (1 + 0.2)), W = i * p, x = i * p ** 3 / 12, w = p * i ** 3 / 12, v = i * p * (i ** 2 + p ** 2) / 12, F = r * d, K = r * d ** 3 / 12, U = d * r ** 3 / 12, le = r * d * (r ** 2 + d ** 2) / 12, te = /* @__PURE__ */ new Map(), Q = /* @__PURE__ */ new Map(), me = /* @__PURE__ */ new Map(), de = /* @__PURE__ */ new Map(), ke = /* @__PURE__ */ new Map(), Re = /* @__PURE__ */ new Map(), N = /* @__PURE__ */ new Map();
        for (let ee = 0; ee < P.length; ee++) te.set(ee, L), Q.set(ee, O), k.has(ee) ? (me.set(ee, W), de.set(ee, x), ke.set(ee, w), Re.set(ee, v), N.set(ee, {
          type: "rect",
          b: i,
          h: p,
          name: `COL${a}`
        })) : (me.set(ee, F), de.set(ee, K), ke.set(ee, U), Re.set(ee, le), N.set(ee, {
          type: "rect",
          b: r,
          h: d,
          name: `V${c}`
        ...
        return vs(g, S, $), st(), console.log(`Model3D: ${A.length}n ${P.length}e | ${y}x${f} grid, ${I} floors | COL${a} V${c} f'c=${s}`), {
          nodes: A.length,
          elements: P.length,
          columns: k.size,
          beams: m.size
      ...
      clear() {
        e.nodes.val = [], e.elements.val = [], e.nodeInputs && (e.nodeInputs.val = {}), e.elementInputs && (e.elementInputs.val = {}), D = /* @__PURE__ */ new Set(), G = /* @__PURE__ */ new Set(), Me = /* @__PURE__ */ new Map(), Ae = /* @__PURE__ */ new Map(), Je = [], Qe = [], mt = 0, ys(), $s(), Jt();
      ...
      building(t, o, n, l = 3, a = 0, c = 0, s = 0, i = 0, p = 1) {
        ...
        for (let u = 0; u < g.length; u++) for (let E = 0; E < d.length; E++) for (let L = 0; L < r.length; L++) u === 0 && y(L, E) || (h[`${L},${E},${u}`] = f.length, f.push([
          r[L],
          d[E],
          g[u]
        ]));
        ...
        const z = [];
        for (let u = 0; u < g.length - 1; u++) for (let E = 0; E < d.length; E++) for (let L = 0; L < r.length; L++) y(L, E) || z.push({
          el: [
            h[`${L},${E},${u}`],
            h[`${L},${E},${u + 1}`]
          ],
        ...
        for (const { el: [u, E], floor: L } of z) {
          if (p <= 1) {
            D.add(A.length), Me.set(A.length, L), A.push([
              u,
              E
            ]);
            continue;
        ...
        Ae = /* @__PURE__ */ new Map();
        const P = [];
        for (let u = 1; u < g.length; u++) for (let E = 0; E < d.length; E++) for (let L = 0; L < r.length - 1; L++) P.push({
          el: [
            h[`${L},${E},${u}`],
            h[`${L + 1},${E},${u}`]
          ],
        ...
        for (let u = 1; u < g.length; u++) for (let E = 0; E < r.length; E++) for (let L = 0; L < d.length - 1; L++) P.push({
          el: [
            h[`${E},${L},${u}`],
            h[`${E},${L + 1},${u}`]
          ],
        ...
        for (const { el: [u, E], floor: L, dir: O, bay: W } of P) {
          ...
          for (let K = 1; K < l; K++) {
            ...
            const te = A.length;
            G.add(te), Me.set(te, L), Ae.set(te, {
              dir: O,
              bay: W
            }), A.push([
              v,
        ...
        if (ct = /* @__PURE__ */ new Set(), Te && Ce > 0) {
          ...
          for (let E = 1; E < g.length; E++) if (Ue === "x") for (let L = 0; L < d.length - 1; L++) {
            const O = d[L], W = d[L + 1];
            for (let x = 1; x <= Ce; x++) {
              const w = O + x / (Ce + 1) * (W - O), v = [];
              for (let F = 0; F < r.length; F++) v.push(u(r[F], w, g[E]));
              for (let F = 0; F < r.length - 1; F++) {
                const K = A.length;
                ct.add(K), G.add(K), Me.set(K, E - 1), Ae.set(K, {
                  dir: "x",
                  bay: F
                }), A.push([
                  v[F],
        ...
        for (const u of ye) {
          ...
          for (const O of L) {
            ...
            const F = h[`${W},${x},${O}`], K = h[`${W},${x},${O + 1}`];
            let U, le;
            if (u.dir === "x" ? (U = h[`${w},${v},${O}`], le = h[`${w},${v},${O + 1}`]) : (U = h[`${w},${v},${O}`], le = h[`${w},${v},${O + 1}`]), F === void 0 || U === void 0 || K === void 0 || le === void 0) continue;
            const te = be, Q = Ye, me = f[F], de = f[U], ke = f[K], Re = f[le], N = [];
            for (let ce = 0; ce <= Q; ce++) {
              ...
              for (let ee = 0; ee <= te; ee++) {
                ...
                ce === 0 && ee === 0 ? oe.push(F) : ce === 0 && ee === te ? oe.push(U) : ce === Q && ee === 0 ? oe.push(K) : ce === Q && ee === te ? oe.push(le) : (oe.push(f.length), f.push([
                  Ie,
                  se,
                  we
                ]));
            ...
            for (let ce = 0; ce < Q; ce++) for (let oe = 0; oe < te; oe++) {
              const pe = N[ce][oe], ee = N[ce][oe + 1], ge = N[ce + 1][oe + 1], Ie = N[ce + 1][oe], se = A.length;
              ue.add(se), Me.set(se, O), A.push([
                pe,
                ee,
                ge,
                Ie
        ...
        if (Nt = /* @__PURE__ */ new Set(), Ze) {
          ...
          for (let W = 1; W < g.length; W++) {
            ...
            for (let w = 0; w < r.length - 1; w++) for (let v = 0; v < d.length - 1; v++) {
              const F = r[w], K = r[w + 1], U = d[v], le = d[v + 1], te = [];
              for (let Q = 0; Q <= E; Q++) {
                const me = [];
                for (let de = 0; de <= u; de++) {
                  const ke = F + de / u * (K - F), Re = U + Q / E * (le - U);
                  if (Q === 0 && de === 0) me.push(h[`${w},${v},${W}`]);
                  else if (Q === 0 && de === u) me.push(h[`${w + 1},${v},${W}`]);
                  else if (Q === E && de === 0) me.push(h[`${w},${v + 1},${W}`]);
                  else if (Q === E && de === u) me.push(h[`${w + 1},${v + 1},${W}`]);
                  else {
                    const N = O(ke, Re, x), ce = L.get(N);
              ...
              for (let Q = 0; Q < E; Q++) for (let me = 0; me < u; me++) {
                const de = te[Q][me], ke = te[Q][me + 1], Re = te[Q + 1][me + 1], N = te[Q + 1][me], ce = A.length;
                Nt.add(ce), Me.set(ce, W - 1), A.push([
                  de,
                  ke,
                  Re,
                  N
          ...
          for (let O = 0; O < L; O++) {
            if (u) for (let W = 0; W < d.length; W++) {
              ...
              for (let w = 0; w < r.length - 1; w++) {
                ...
                const v = h[`${w},${W},${O}`], F = h[`${w + 1},${W},${O + 1}`], K = h[`${w + 1},${W},${O}`], U = h[`${w},${W},${O + 1}`];
                v !== void 0 && F !== void 0 && (A.push([
                  v,
                  F
                ]), Me.set(A.length - 1, O)), K !== void 0 && U !== void 0 && (A.push([
                  K,
                  U
                ]), Me.set(A.length - 1, O));
              }
            ...
            if (E) for (let W = 0; W < r.length; W++) {
              ...
              for (let w = 0; w < d.length - 1; w++) {
                ...
                const v = h[`${W},${w},${O}`], F = h[`${W},${w + 1},${O + 1}`], K = h[`${W},${w + 1},${O}`], U = h[`${W},${w},${O + 1}`];
                v !== void 0 && F !== void 0 && (A.push([
                  v,
                  F
                ]), Me.set(A.length - 1, O)), K !== void 0 && U !== void 0 && (A.push([
      ...
      example(t) {
        ...
        switch (t) {
          case "truss": {
            _e.colMat = 1, _e.vigaMat = 1, ot.clear(), nt("truss"), Ss();
            break;
          }
          case "beams": {
            _e.colMat = 0, _e.vigaMat = 0, _e.colShape = 0, ot.clear(), nt("beams"), Is();
            break;
          }
          case "3d":
          case "3d-structure":
          case "torre": {
            _e.colMat = 1, _e.vigaMat = 1, ot.clear(), nt("3d"), ks();
            break;
          }
          case "portico": {
          ...
          case "mezanine":
          case "mezzanine": {
            nt("edificio"), Y.nPisos && (Y.nPisos.val = 1), Y.hPiso && (Y.hPiso.val = 4.5), Y.nVanosX && (Y.nVanosX.val = 3), Y.nVanosY && (Y.nVanosY.val = 2), Y.nSubViga && (Y.nSubViga.val = 3), re = [
              6,
              6,
              6
            ], ne = [
          ...
          case "plate-q4":
          case "placa-q4": {
            ot.clear(), nt("placa-q4"), zs();
            break;
          }
          case "losa-rect":
          case "rectangular-slab": {
            ot.clear(), nt("losa-rect"), As();
            break;
          }
          case "losa-plana":
          case "flat-slab": {
            ot.clear(), nt("losa-plana"), Ls();
            break;
          }
          case "viga-alta":
          case "deep-beam": {
            ot.clear(), nt("viga-alta"), Cs();
            break;
          }
          case "muro-contencion":
          case "retaining-wall": {
            ot.clear(), nt("muro-contencion"), Fs();
            break;
          }
          case "zapata":
          case "footing": {
            ot.clear(), nt("zapata"), Ps();
            break;
          }
          case "placa-orificios":
          case "plate-holes":
          case "placa-base": {
            ot.clear(), nt("placa-orificios"), Rs();
            break;
          }
          case "col-placa":
          case "columna-placa": {
            ot.clear(), nt("col-placa"), Os();
            break;
          }
          case "talud":
          case "slope": {
            ot.clear(), nt("talud"), Ns();
            break;
          }
          case "eiffel":
          case "torre-eiffel": {
            ot.clear(), nt("eiffel"), Qs();
            break;
          }
          case "arco":
          case "arco-gateway": {
          ...
          case "puente-colgante": {
            ot.clear(), nt("puente"), ta();
            break;
          }
          case "twisted":
          case "torre-twisted":
          case "turning-torso": {
            ot.clear(), nt("twisted"), oa();
            break;
          }
          case "burj":
          case "burj-khalifa": {
          ...
          case "opera":
          case "sydney-opera": {
            ot.clear(), nt("opera"), sa();
            break;
          }
          case "diagrid":
          case "gherkin": {
            ot.clear(), nt("diagrid"), aa();
            break;
          }
          case "muro-q4":
          case "shear-wall":
      ...
      plateQ4(t = 10, o = 10, n = 16, l = 16, a = "simply-supported", c = -10, s = 0.2, i = 3e7, p = 0.3, r = 0) {
        ...
        S.nodeResults.forEach((z, P) => {
          (z.x < 1e-10 || z.x > t - 1e-10 || z.y < 1e-10 || z.y > o - 1e-10) && I.set(P, [
            true,
            true,
            true,
            true,
      ...
      set(t, o) {
        Y[t] ? (Y[t].val = o, console.log(`${t} = ${o}`), mo(), Ne()) : gt[t] ? (gt[t].val = o, console.log(`${t} = ${o}`), mo(), Ne()) : console.error(`Par\xE1metro "${t}" no encontrado. Disponibles: ${Object.keys({
          ...Y,
          ...gt
        }).join(", ")}`);
      },
      ...
      setBc(t) {
        ...
        St = t, St >= o.length && (St = 0), console.log(`Apoyo: ${o[St].label} \u2192 DOFs: [${o[St].dofs.map((n) => n ? "1" : "0").join(",")}]`), mo(), Ne();
      },
      help() {
        console.log(`
=== FEM Studio CLI ===
...
Util:     cad.info()  cad.clear()  cad.help()
      ...
      units(t, o) {
        t && (b = t), o && (R = o), M = Ho(b, R);
        const n = Le.querySelector("#cad3d-force-unit"), l = Le.querySelector("#cad3d-length-unit");
        return n && (n.textContent = b), l && (l.textContent = R), T && nt(T), console.log(`Unidades: ${M.label} | E=${M.E.toExponential(3)} ${M.stress}`), M.id;
      },
      view(t) {
      },
      get mesh() {
    ...
    function ie(t) {
      var _a2, _b;
      return ((_a2 = Y[t]) == null ? void 0 : _a2.val) ?? ((_b = gt[t]) == null ? void 0 : _b.val) ?? 0;
    }
    function Ne() {
      var _a2;
      switch (T) {
    ...
    function Cs() {
      ...
      const A = s * i / Math.max(I.length, 1), z = /* @__PURE__ */ new Map();
      ...
      try {
        const m = Ft(S, d, k, P), u = Eo(S, d, P, m), E = S.map((O) => [
          O[0],
          0,
          O[1]
        ]);
    ...
    function Fs() {
      const t = ie("H") || 4, o = ie("B") || 3, n = ie("tw") || 0.3, l = ie("tb") || 0.4, a = ie("meshSize") || 0.2, c = ie("E") || 25e6, s = ie("nu") || 0.2, i = c / (2 * (1 + s)), p = ie("gamma") || 18, r = ie("Ka") || 0.33, d = ie("Es") || 5e4, g = ie("nus") || 0.3, S = d / (2 * (1 + g)), $ = ie("kn") || 1e6, y = ie("ks") || 1e4, f = ie("gammaW") || 9.81, h = ie("Hw") || 3.5, I = ie("qs") || 0, A = St, z = o * 0.3, P = o * 0.7, k = [
        [
          -z,
          0,
          0
      ...
      if (A === 0) {
        ...
        if (A === 2) {
          ...
          for (let se = 0; se < ke; se++) {
            const we = u[se], Be = (m[we[0]][0] + m[we[1]][0] + m[we[2]][0]) / 3, lt = (m[we[0]][1] + m[we[1]][1] + m[we[2]][1]) / 3, et = Be >= -z && Be <= P && lt >= 0 && lt <= l, vt = Be >= 0 && Be <= n && lt >= l && lt <= l + t, Dt = et || vt;
          ...
          const ce = u.length - N, oe = /* @__PURE__ */ new Map(), pe = /* @__PURE__ */ new Map(), ee = /* @__PURE__ */ new Map(), ge = /* @__PURE__ */ new Map(), Ie = /* @__PURE__ */ new Map();
          ...
          for (let se = N; se < u.length; se++) oe.set(se, $), pe.set(se, 0), ge.set(se, 0), Ie.set(se, y), ee.set(se, 0);
          O = {
            elasticities: oe,
          ...
          const le = (N) => {
            const ce = (m[N[0]][0] + m[N[1]][0] + m[N[2]][0]) / 3, oe = (m[N[0]][1] + m[N[1]][1] + m[N[2]][1]) / 3, pe = ce >= -z && ce <= P && oe >= 0 && oe <= l, ee = ce >= 0 && ce <= n && oe >= l && oe <= l + t;
            return pe || ee;
          }, te = /* @__PURE__ */ new Map(), Q = /* @__PURE__ */ new Map(), me = /* @__PURE__ */ new Map(), de = /* @__PURE__ */ new Map(), ke = /* @__PURE__ */ new Map(), Re = [];
          for (let N = 0; N < u.length; N++) {
            const ce = le(u[N]);
            Re.push(!ce), ce ? (te.set(N, c), Q.set(N, c), de.set(N, s), ke.set(N, i), me.set(N, 1)) : (te.set(N, d), Q.set(N, d), de.set(N, g), ke.set(N, S), me.set(N, 1));
          }
          O = {
            elasticities: te,
          ...
          for (let N = 0; N < m.length; N++) {
            const ce = m[N][0], oe = m[N][1];
            Math.abs(oe) < 1e-6 ? E.set(N, [
              true,
              true,
              true,
              true,
          ...
          for (let N = 0; N < u.length; N++) {
            if (!Re[N]) continue;
            const ce = u[N], oe = m[ce[0]], pe = m[ce[1]], ee = m[ce[2]], ge = Math.abs((pe[0] - oe[0]) * (ee[1] - oe[1]) - (ee[0] - oe[0]) * (pe[1] - oe[1])) / 2, Ie = -p * ge / 3;
            for (const se of ce) {
              const we = L.get(se) || [
                0,
                0,
          ...
          if (I > 0) {
            ...
            for (let ce = 0; ce < m.length; ce++) {
              ...
              Math.abs(pe - v) < a * 0.1 && oe > n - 1e-6 && N.push({
                idx: ce,
                x: oe
              });
            }
            N.sort((ce, oe) => ce.x - oe.x);
            for (let ce = 0; ce < N.length; ce++) {
              let oe = a;
              ce > 0 && ce < N.length - 1 ? oe = (N[ce + 1].x - N[ce - 1].x) / 2 : ce === 0 && N.length > 1 ? oe = (N[1].x - N[0].x) / 2 : ce === N.length - 1 && N.length > 1 && (oe = (N[ce].x - N[ce - 1].x) / 2);
              const pe = -I * oe, ee = L.get(N[ce].idx) || [
                0,
                0,
                0,
                0,
      ...
      try {
        const w = Ft(m, u, W, O), v = u.filter((me) => me.length === 3), F = {};
        for (const me of Object.keys(O)) {
          const de = O[me];
          if (de && de instanceof Map) {
            const ke = /* @__PURE__ */ new Map();
            let Re = 0;
            for (let N = 0; N < u.length; N++) u[N].length === 3 && (de.has(N) && ke.set(Re, de.get(N)), Re++);
            F[me] = ke;
          }
        }
        const K = Eo(m, v, F, w), U = m.map((me) => [
          me[0],
          0,
          me[1]
        ]);
        ...
        w && w.deformations && w.deformations.forEach((me) => {
          ...
          Q = Math.max(Q, de);
        }), console.log(`Muro Contencion [${x[A]}]: ${m.length} nodos, ${u.length} triangulos`), console.log(`  H=${t}, B=${o}, tw=${n}, tb=${l}, Ka=${r}, gamma=${p}, qs=${I}`), A === 1 && console.log(`  Es=${d}, nus=${g}`), A === 2 && console.log(`  Es=${d}, nus=${g}, kn=${$}, ks=${y}`), A === 3 && console.log(`  gammaW=${f}, Hw=${h}`), console.log(`  max|u| = ${Q.toExponential(4)}`);
      } catch (w) {
    ...
    function Ps() {
      const t = ie("Lx") || 2, o = ie("Ly") || 2, n = ie("t") || 0.5, l = ie("colA") || 0.4, a = ie("colH") || 1.5, c = Math.round(ie("nx") || 8), s = Math.round(ie("ny") || 8), i = ie("E") || 25e6, p = ie("nu") || 0.2, r = ie("P") || -500, d = ie("Mx") || 0, g = ie("My") || 0, S = ie("ks") || 2e4, $ = t / c, y = o / s, f = t / 2, h = o / 2, I = l / 2, A = [];
    ...
    function Rs() {
      ...
      for (let x = 0; x < m.length; x++) {
        ...
        for (const [F, K] of I) {
          const U = Math.sqrt((w - F) * (w - F) + (v - K) * (v - K));
    ...
    function Os() {
      const t = ie("colB") || 0.3, o = ie("colH") || 0.3, n = ie("colT") || 8e-3, l = ie("colLen") || 1.5, a = ie("Lx") || 0.45, c = ie("Ly") || 0.45, s = ie("tPlaca") || 0.025, i = ie("dBolt") || 0.022, p = ie("sx") || 0.32, r = ie("sy") || 0.32, d = Math.round(ie("nSubColV") || 6), g = Math.round(ie("nSubColH") || 4), S = Math.round(ie("nSubPlaca") || 10), $ = ie("E") || 2e8, y = ie("nu") || 0.3, f = $ / (2 * (1 + y)), h = ie("P") || -300, I = a / 2, A = c / 2, z = i / 2, P = t / 2, k = o / 2, m = [], u = [], E = S, L = a / E, O = c / E, W = (pe, ee) => ee * (E + 1) + pe;
      ...
      for (let pe = 0; pe < m.length; pe++) Math.abs(m[pe][2] - l) < 1e-6 && N.push(pe);
      const ce = h / Math.max(N.length, 1);
      for (const pe of N) Re.set(pe, [
        0,
        0,
        ce,
        0,
      ...
      for (let pe = v; pe < v + F; pe++) oe.elasticities.set(pe, $), oe.poissonsRatios.set(pe, y), oe.thicknesses.set(pe, s), oe.shearModuli.set(pe, f);
      ...
      console.log(`Col+Placa 3D: col ${t * 1e3}x${o * 1e3}x${n * 1e3}mm, h=${l}m`), console.log(`  Placa ${a * 1e3}x${c * 1e3}mm, t=${s * 1e3}mm, 4 pernos d=${i * 1e3}mm`), console.log(`  ${F} Q4 placa + ${de} Q4 columna = ${u.length} total`), console.log(`  ${m.length} nodos, P=${h} kN`);
      try {
        const pe = Ft(m, u, {
          supports: ke,
          loads: Re
    ...
    function Ns() {
      ...
      try {
        ...
        console.log(`Talud SRM: ${I.length} nodos, ${h.length} triangulos`), console.log(`  H=${t}, angulo=${o}\xB0, c=${p} kPa, \u03C6=${r}\xB0, \u03B3=${i}`), console.log("  \u2550\u2550\u2550 Strength Reduction Method (Mohr-Coulomb) \u2550\u2550\u2550"), console.log(`  FOS = ${u.fos.toFixed(3)}`), console.log(`  max|u| = ${W.toExponential(4)}`), console.log(`  max \u03B5_pl = ${x.toExponential(4)}`), u.fos < 1 ? console.warn("  \u26A0 TALUD INESTABLE (FOS < 1.0)") : u.fos < 1.5 && console.warn("  \u26A0 FOS < 1.5 \u2014 revisar estabilidad");
      } catch (k) {
    ...
    function Oo(t) {
      const o = bs.find((l) => l.id === V.forceId), n = nn.find((l) => l.id === V.lengthId);
    ...
    function Go() {
      ...
      if (!o) return;
      o.style.display = "";
      const n = M, l = Math.round(((_a2 = Y.nPisos) == null ? void 0 : _a2.val) ?? 3), a = _a(), c = Da(), s = re.length || 1, i = ne.length || 1;
      ...
      if (qt.addBinding(r, "vigaMat", {
        ...
        qt.addBinding(m, "vigaType", {
          ...
          _e.steelVigaType = u.value, Go(), Ne();
        });
      }
      ...
      for (let m = 0; m < l; m++) {
        ...
        if (_e.colMat === 0) if (_e.colShape === 1) {
          ...
          const O = +Oo(1e8).toFixed(0), W = +Oo(3e8).toFixed(0), x = Math.max(1, Math.round((W - O) / 200));
          E.addBinding(L, "Es", {
            min: O,
            max: W,
            step: x,
      ...
      const A = re.length || 1, z = ne.length || 1, P = A + 1, k = z + 1;
      if (A > 0) {
        const m = h.addFolder({
        ...
        for (let u = 0; u < A; u++) for (let E = 0; E < k; E++) {
          const L = `wx_${u}_${E}`, O = ye.some((w) => w.dir === "x" && w.bay === u && w.axisIdx === E), W = {};
          W[L] = O;
      ...
      if (z > 0) {
        ...
        for (let u = 0; u < z; u++) for (let E = 0; E < P; E++) {
          const L = `wy_${u}_${E}`, O = ye.some((w) => w.dir === "y" && w.bay === u && w.axisIdx === E), W = {};
          W[L] = O;
    ...
    function mo() {
      ...
      if (n) {
        ...
        for (const s of n) {
          ...
          c.addBinding(i, "min", {
            ...
            Y[s.key] && (Y[s.key].min = i.min, Y[s.key].max = i.max, Y[s.key].val < i.min && (Y[s.key].val = i.min), Y[s.key].val > i.max && (Y[s.key].val = i.max)), mo(), Ne();
          });
        }
        $e.on("change", (s) => {
          var _a2, _b;
          ...
          if (i && Y[i]) {
            if (Y[i].val = s.value, T === "edificio" && (i === "nVanosX" || i === "nVanosY" || i === "nPisos")) {
              if (i === "nVanosX" || i === "nVanosY") {
                const p = Math.round(Y.nVanosX.val), r = Math.round(Y.nVanosY.val);
              ...
              if (i === "nPisos" || i === "hPiso") {
                const p = Math.round(Y.nPisos.val), r = ((_b = Y.hPiso) == null ? void 0 : _b.val) ?? 3;
      ...
      if (T === "edificio") {
        ...
        if (a) {
          let c = function() {
            var _a2, _b, _c, _d;
            const p = "ABCDEFGHIJKLMNOPQRSTUVWXYZ", r = ((_a2 = Y.Lvix) == null ? void 0 : _a2.val) || 0, d = ((_b = Y.Lvdx) == null ? void 0 : _b.val) || 0, g = ((_c = Y.Lviy) == null ? void 0 : _c.val) || 0, S = ((_d = Y.Lvdy) == null ? void 0 : _d.val) || 0;
            let $ = "X: ";
            r > 0 && ($ += `\u251C${r.toFixed(1)}\u2524`);
...
` + f;
  ...
  `, document.head.appendChild(Ds), hl() === "light" && document.documentElement.classList.add("awatif-light"), xl((t) => {
  ...
  `;
    ...
    function ja() {
      var _a2, _b, _c, _d, _e2, _f;
      const t = e.nodes.val, o = e.elements.val, n = (_a2 = e.nodeInputs) == null ? void 0 : _a2.val, l = (_b = e.elementInputs) == null ? void 0 : _b.val, a = R, c = b, s = [];
      ...
      if (p && p.size > 0 && (s.push(`## REACTIONS (${p.size} supports)`), s.push("# node          Rx           Ry           Rz           Mx           My           Mz"), p.forEach((r, d) => {
        ...
        s.push("## CLI COMMAND");
        const r = Object.entries(Y).map(([d, g]) => `${d}=${g.val}`).join(" ");
...
`);
    ...
    function cn() {
      ...
      for (let z = 0; z < a; z++) {
        ...
        r = Math.max(r, Math.sqrt(P * P + k * k + m * m));
      }
      ...
      function A() {
        const z = (performance.now() - l) / 1e3, P = Math.sin(2 * Math.PI * n * z) * d;
        for (let k = 0; k < a; k++) {
          const m = ze[k];
          f[k * 3] = m[0] + (t[k * 6] || 0) * P, f[k * 3 + 1] = m[1] + (t[k * 6 + 1] || 0) * P, f[k * 3 + 2] = m[2] + (t[k * 6 + 2] || 0) * P;
        }
        if (S) {
        ...
        g.render(), ve = requestAnimationFrame(A);
      }
    ...
    function Jn() {
      ...
      if (!n.loads || n.loads.size === 0) {
        const y = ie("CM") ?? 0, f = ie("CV") ?? 0, h = y + f, I = ie("Ex") ?? 0, A = ie("Ey") ?? 0;
        if (h === 0 && I === 0 && A === 0) return;
        const z = /* @__PURE__ */ new Map(), P = [];
        for (let w = 0; w < t.length; w++) n.supports.has(w) || P.push(w);
        ...
        for (let w = 0; w < o.length; w++) {
          ...
          if (!(Math.abs(F) < 1e-15)) {
            if (v.length === 2) {
              const K = ((_b = l.areas) == null ? void 0 : _b.get(w)) ?? 0, U = t[v[0]], le = t[v[1]], te = Math.sqrt((le[0] - U[0]) ** 2 + (le[1] - U[1]) ** 2 + (le[2] - U[2]) ** 2), me = -(F * K * te * O) / 2;
        ...
        for (const w of P) {
          const v = E.has(w) ? I : 0, F = L.has(w) ? A : 0, K = W.get(w) ?? 0, U = x.has(w) ? h : 0, le = K + U;
          (v !== 0 || F !== 0 || Math.abs(le) > 1e-10) && z.set(w, [
            v,
            F,
            le,
            0,
      ...
      try {
        ...
        if (y) {
          ...
          const P = performance.now(), k = Eo(t, o, l, y), m = performance.now() - P;
    ...
    function Ga(t, o, n, l, a, c, s) {
      const p = 4700 * Math.sqrt(c / 1e3) * 1e3 / l, r = t - 2 * n, d = o - 2 * n, g = t * o - r * d, S = (t * o * o * o - r * d * d * d) / 12, $ = (o * t * t * t - d * r * r * r) / 12, y = r * d, f = r * d * d * d / 12, h = d * r * r * r / 12, I = g + p * y, A = S + p * f, z = $ + p * h, P = l / (2 * (1 + a)), k = (t - n) * (o - n), m = 2 * ((t - n) / n + (o - n) / n), u = 4 * k * k / (m > 0 ? m : 1);
      return {
        A: I,
        Iz: A,
        Iy: z,
    ...
    function To() {
      ...
      if ((T === "edificio" || T === "frame") && D.size > 0) {
        ...
        for (let f = 0; f < t.length; f++) {
          ...
          const h = D.has(f), I = Me.get(f) ?? 0, A = p[I] ?? p[0] ?? {
            bCol: 0.4,
            hCol: 0.4,
            dCol: 0.4
          };
          let z, P, k, m;
          if (h) if (a === 0) P = r, k = d, m = g, z = s === 1 ? Bs(A.dCol) : Vn(A.bCol, A.hCol), n.sectionShapes.set(f, s === 1 ? {
            type: "circ",
            d: A.dCol
          } : {
            type: "rect",
            ...
            if (E <= 1) {
              const L = Ro[A.colProfileIdx] ?? Ro[0];
              z = {
                A: L.A,
                Iz: L.Iz,
                Iy: L.Iy,
            ...
            m = (F * v.A_steel + K * v.A_conc) / (v.A_steel + v.A_conc);
            ...
            const E = Ae.get(f), L = E ? E.dir === "x" ? A.vigasX : A.vigasY : [], O = E ? L[E.bay] ?? L[0] ?? bt() : bt();
            if (c === 0) P = r, k = d, m = g, z = Vn(O.b, O.h), n.sectionShapes.set(f, {
              type: "rect",
              b: O.b,
              h: O.h
            });
              ...
              if (W <= 1) {
                const x = Ro[O.profileIdx ?? 0] ?? Ro[0];
                z = {
                  A: x.A,
                  Iz: x.Iz,
                  Iy: x.Iy,
          ...
          const u = he.get(f);
          if (u) {
            if ((u.material ?? 1) === 0 ? (P = r, k = d, m = g) : (P = S, k = $, m = y), u.secType === "rect" && u.b && u.h) z = Vn(u.b, u.h), n.sectionShapes.set(f, {
              type: "rect",
              b: u.b,
              h: u.h
            });
            else if (u.secType === "circ" && u.b) z = Bs(u.b), n.sectionShapes.set(f, {
              type: "circ",
              d: u.b
            });
          ...
          n.elasticities.set(f, P), n.shearModuli.set(f, k), n.areas.set(f, z.A), n.momentsOfInertiaZ.set(f, z.Iy), n.momentsOfInertiaY.set(f, z.Iz), n.torsionalConstants.set(f, z.J), n.densities.set(f, m), u && u.releases12 && u.releases12.some((E) => E) && (n.momentReleases || (n.momentReleases = /* @__PURE__ */ new Map()), n.momentReleases.set(f, u.releases12)), u && u.springs12 && u.springs12.some((E) => E > 0) && (n.partialFixitySprings || (n.partialFixitySprings = /* @__PURE__ */ new Map()), n.partialFixitySprings.set(f, u.springs12));
        }
    ...
    window.innerWidth <= 600 && Le.classList.add("collapsed"), setTimeout(() => {
      ...
      (_a2 = Le.querySelector("#cad3d-toggle")) == null ? void 0 : _a2.addEventListener("click", (x) => {
        ...
        x.addEventListener("click", (w) => {
          ...
          Ao(v), Le.querySelectorAll("[data-view]").forEach((F) => F.classList.remove("view-active")), x.classList.add("view-active");
        });
        ...
        var _a3;
        x.stopPropagation(), po && (po = false, qo()), yo && yn(), eo = !eo, (_a3 = Le.querySelector("#cad3d-select")) == null ? void 0 : _a3.classList.toggle("inspect-active", eo);
        const v = tt();
        v && (v.controls.enabled = !eo), eo || vn();
      }), (_e2 = Le.querySelector("#cad3d-draw")) == null ? void 0 : _e2.addEventListener("click", (x) => {
        var _a3;
        x.stopPropagation(), po && (po = false, qo()), eo && vn(), yo = !yo, (_a3 = Le.querySelector("#cad3d-draw")) == null ? void 0 : _a3.classList.toggle("inspect-active", yo), yo ? Ua() : yn();
      }), (_f = Le.querySelector("#cad3d-inspect")) == null ? void 0 : _f.addEventListener("click", (x) => {
        var _a3;
        x.stopPropagation(), eo && vn(), yo && yn(), po = !po, (_a3 = Le.querySelector("#cad3d-inspect")) == null ? void 0 : _a3.classList.toggle("inspect-active", po), po || qo();
      ...
      function o(x) {
        ...
        const F = 15e3 * Math.sqrt(210) * 10, K = 0.2, U = F / (2 * (1 + K)), le = 0.09, te = 0.3 ** 4 / 12, Q = 0.141 * 0.3 ** 4, me = 0.25 * 0.4, de = 0.25 * 0.4 ** 3 / 12, ke = 0.4 * 0.25 ** 3 / 12, Re = 1e-3, N = 5 / 6 * le, ce = 5 / 6 * me, oe = [];
        function pe(ee, ge, Ie) {
          ...
          for (const we of ge) se.elasticities.set(we, F), se.shearModuli.set(we, U), se.areas.set(we, le), se.momentsOfInertiaZ.set(we, te), se.momentsOfInertiaY.set(we, te), se.torsionalConstants.set(we, Q), se.shearAreasY.set(we, N), se.shearAreasZ.set(we, N);
          for (const we of Ie) se.elasticities.set(we, F), se.shearModuli.set(we, U), se.areas.set(we, me), se.momentsOfInertiaZ.set(we, ke), se.momentsOfInertiaY.set(we, de), se.torsionalConstants.set(we, Re), se.shearAreasY.set(we, ce), se.shearAreasZ.set(we, ce);
          return se;
        }
        if (x === "test-cantilever" || x === "test-all") {
          ...
          Be.elasticities.set(0, F), Be.shearModuli.set(0, U), Be.areas.set(0, le), Be.momentsOfInertiaZ.set(0, te), Be.momentsOfInertiaY.set(0, te), Be.torsionalConstants.set(0, Q);
          const lt = Ft(se, we, {
            supports: /* @__PURE__ */ new Map([
              [
                0,
        ...
        if (x === "test-portal-wall" || x === "test-all") {
          ...
          Ie.elasticities.set(6, F), Ie.shearModuli.set(6, U), Ie.thicknesses = /* @__PURE__ */ new Map([
            [
              6,
              0.2
            ]
      ...
      function n(x) {
        ...
        const K = [
          ...F
        ].sort((N, ce) => N - ce), U = K.map((N, ce) => ce === 0 ? "Base" : `Level_${ce}`), le = /* @__PURE__ */ new Map();
        K.forEach((N, ce) => le.set(N, U[ce])), v.push("$ STORIES - IN SEQUENCE FROM TOP");
        ...
        const te = x.elements.some((N) => N.length === 4);
        ...
        for (const [N, ce] of Q) {
          const [oe, pe] = N.split(",").map(Number);
          v.push(`  POINT "${ce}"  ${oe} ${pe} `);
        }
        v.push("");
        const de = (N) => {
          const ce = x.nodes[N], oe = `${ce[0]},${ce[2]}`;
          return {
            pt: Q.get(oe) || "1",
        ...
        const ke = [];
        if (x.elements.forEach((N, ce) => {
          if (N.length !== 2) return;
          const oe = x.nodes[N[0]], pe = x.nodes[N[1]], ee = Math.abs(pe[1] - oe[1]), ge = Math.sqrt((pe[0] - oe[0]) ** 2 + (pe[2] - oe[2]) ** 2), Ie = ee > ge * 0.5, se = de(N[0]), we = de(N[1]), Be = Ie ? "COL30" : "VIGA";
          ...
          x.elements.forEach((ce, oe) => {
            ...
            v.push(`  AREA "W${oe + 1}"  PANEL  4  "${pe[0].pt}"  "${pe[1].pt}"  "${pe[2].pt}"  "${pe[3].pt}"  1  1  0  0  `), N.push(`  AREAASSIGN  "W${oe + 1}"  "${pe[2].story}"  SECTION "Muro20"  `);
          }), v.push(""), v.push("$ AREA ASSIGNS"), N.forEach((ce) => v.push(ce)), v.push("");
        }
        v.push("$ POINT ASSIGNS"), x.nodes.forEach((N, ce) => {
          if (Math.abs(N[1]) < 0.01) {
            const oe = de(ce);
            v.push(`  POINTASSIGN  "${oe.pt}"  "${oe.story}"  RESTRAINT "UX UY UZ RX RY RZ"  `);
          }
        }), v.push(""), v.push("$ LINE ASSIGNS"), ke.forEach((N) => v.push(N)), v.push(""), v.push("$ LOAD PATTERNS"), v.push('  LOADPATTERN "Lat"  TYPE  "Other"  SELFWEIGHT  0'), v.push(""), v.push("$ POINT OBJECT LOADS");
        const Re = Math.max(...x.nodes.map((N) => N[1]));
        return x.nodes.forEach((N, ce) => {
...
`);
      ...
      function a(x, w) {
        ...
        K.href = F, K.download = w, K.click(), URL.revokeObjectURL(F);
      }
      function c(x) {
      ...
      function r(x, w) {
        ...
        const v = x.elements.filter((K) => K.length === 2).length, F = x.elements.filter((K) => K.length >= 3).length;
        console.log(`${w} (${x.nodes.length} nodos, ${v} frames, ${F} shells): ${x.nodes.length} nodes, ${x.elements.length} elements`), setTimeout(() => It(), 50);
      }
      function d(x, w) {
        var _a3, _b2, _c2;
        const v = {};
        ...
        <div style="display:flex;gap:8px">
          ...
          for (const oe of w.elements) if (Q.has(oe.category) && oe.type === "frame" && oe.nodeIds.length >= 2) {
            ...
            ke.elasticities.set(N, pe.E), ke.shearModuli.set(N, lt), ke.areas.set(N, Ie), ke.momentsOfInertiaZ.set(N, we), ke.momentsOfInertiaY.set(N, se), ke.torsionalConstants.set(N, Be), ke.densities.set(N, pe.rho), ke.sectionShapes.set(N, {
              type: "rect",
              b: ee,
              h: ge,
              name: oe.sectionName
      ...
      function g(x) {
        D = /* @__PURE__ */ new Set(), G = /* @__PURE__ */ new Set(), Me = /* @__PURE__ */ new Map(), Ae = /* @__PURE__ */ new Map();
        const w = /* @__PURE__ */ new Map();
        for (let de = 0; de < x.stories.length; de++) w.set(x.stories[de].name, de);
        for (let de = 0; de < x.elementTypes.length; de++) {
          const ke = x.elementTypes[de], Re = x.elementStories[de], N = w.get(Re) ?? 0;
          Me.set(de, N), ke === "COLUMN" || ke === "BRACE" ? D.add(de) : G.add(de);
        }
        T = "edificio";
        const v = x.grids.filter((de) => de.dir === "X").sort((de, ke) => de.coord - ke.coord), F = x.grids.filter((de) => de.dir === "Y").sort((de, ke) => de.coord - ke.coord);
        let K, U, le, te;
        if (v.length > 0 || F.length > 0) K = v.map((de) => de.coord), U = F.map((de) => de.coord), le = v.map((de) => de.label), te = F.map((de) => de.label);
        else {
          ...
          K = [
            ...
            ...ke
          ].sort((Re, N) => Re - N), le = K.map((Re, N) => String(N + 1)), te = U.map((Re, N) => String.fromCharCode(65 + N));
        }
        ...
        if (s === "import-ifc") {
          ...
          v.onload = async () => {
            ...
            try {
              ...
              K.controls.target.copy(le), K.camera.position.set(le.x + Q, le.y + Q * 0.5, le.z + Q), K.camera.lookAt(le), K.controls.maxDistance = Q * 5, K.controls.update(), K.render(), window.__ifcLoadResult = U, window.__ifcArrayBuffer = F;
              const me = new FileReader();
              me.onload = () => {
                const de = me.result, ke = pi(de);
                window.__ifcAnalytical = ke;
                const Re = {};
                U.elementInfo.forEach((N) => Re[N.category] = (Re[N.category] || 0) + 1), console.log("IFC categories:", Re), console.log(`IFC: ${U.elementInfo.size} geometric elements, ${ke.elements.length} analytical elements`), d(U, ke);
              }, me.readAsText(x);
            } catch (K) {
      ...
      $ && ($.value = b, $.addEventListener("change", (x) => {
        x.stopPropagation(), b = $.value, M = Ho(b, R), T && nt(T);
      }));
      const y = Le.querySelector("#cad3d-length-unit");
      y && (y.value = R, y.addEventListener("change", (x) => {
        x.stopPropagation(), R = y.value, M = Ho(b, R), T && nt(T);
      })), Le.querySelectorAll("[data-preset]").forEach((x) => {
        x.addEventListener("click", (w) => {
          w.stopPropagation();
          const v = x.dataset.preset, F = B[v];
          F && (b = F.force, R = F.length, V = F.stress, M = Ho(b, R), $ && ($.value = b), y && (y.value = R), Le.querySelectorAll("[data-preset]").forEach((K) => {
            K.classList.toggle("active", K.dataset.preset === v);
          }), T && nt(T), console.log(`Preset: ${v} \u2192 ${b}+${R}, stress: ${V.label}`));
        });
      }), Le.querySelectorAll("[data-lang]").forEach((x) => {
        x.addEventListener("click", (w) => {
          w.stopPropagation();
          const v = x.dataset.lang;
          zl(v), Le.querySelectorAll("[data-lang]").forEach((F) => F.classList.remove("active")), x.classList.add("active"), Al(), T && nt(T);
        });
        ...
        if (De) {
          const le = tt();
          ((_b2 = le == null ? void 0 : le.settings) == null ? void 0 : _b2.loads) && (He = le.settings.loads.rawVal, le.settings.loads.val = false), Gn(), v.style.display = "", F.style.display = "", K.style.display = "", U && (U.style.display = ""), f();
        } else Yn(), v.style.display = "none", F.style.display = "none", K.style.display = "none", U && (U.style.display = "none"), T && T !== "placa-q4" && T !== "placa-3q" && Ne(), setTimeout(() => {
          var _a4;
          const le = tt();
      ...
      function f() {
        ...
        const w = Fe.frequencies[xe], v = w > 0 ? 1 / w : 0, F = [
          0,
          0,
          0,
          0,
        ...
        for (let K = 0; K <= xe; K++) {
          ...
          if (U) for (let le = 0; le < 6; le++) F[le] += U[le];
        }
      ...
      (_o2 = Le.querySelector("#cad3d-mode-prev")) == null ? void 0 : _o2.addEventListener("click", (x) => {
        ...
        for (let K = 0; K < ze.length; K++) {
          ...
          F = Math.max(F, Math.sqrt(U * U + le * le + te * te));
        }
...
`));
        ...
        if (x.key === "Escape") {
          ...
          eo && vn(), po && (po = false, qo(), (_a3 = Le.querySelector("#cad3d-inspect")) == null ? void 0 : _a3.classList.remove("inspect-active"));
        }
    ...
    function Ao(t) {
      ...
      if (t === "3d") {
        ...
        if (t === "plan") o.renderer.clippingPlanes = [], p(new qe(n.x, n.y, n.z + l * 2), new qe(n.x, n.y, n.z), new qe(0, 1, 0));
          ...
          const r = parseInt(t.split(":")[1]), d = ((_a2 = Y.hPiso) == null ? void 0 : _a2.val) ?? 3, g = (r + 1) * d, S = d * 0.45;
...
${r.join(", ")}`);
        ...
        wt.forEach((n) => J.add(n)), wt.clear(), Co(), Fo(), Ne();
      }), o.querySelector("#sel-isolate").addEventListener("click", () => {
        H = true, j.clear(), wt.forEach((n) => j.add(n)), wt.clear(), Co(), Fo(), Ne();
      }), o.querySelector("#sel-showall").addEventListener("click", () => {
        J.clear(), H = false, j.clear(), Fo(), Ne();
    ...
    function os() {
      ...
      es = [], No = null, io && (io.remove(), io = null);
    }
    function Ys(t, o, n, l) {
    ...
    `, document.body.appendChild(t), Yo = t;
      ...
      }), t.querySelector("#dt-undo").addEventListener("click", () => Ws()), t.querySelector("#dt-redo").addEventListener("click", () => Gs());
    }
    function Js(t, o, n, l) {
      ...
      if (Lt.node) {
        ...
        for (let f = 0; f < p.length; f++) {
          const h = p[f], I = new qe(h[0], h[1], h[2]).project(n), A = Math.sqrt((I.x - c) ** 2 + (I.y - s) ** 2);
          A < d && A < y && (y = A, $ = f);
        }
        if ($ >= 0) return {
          nodeIdx: $,
      ...
      if (Lt.midpoint) {
        ...
        for (const f of r) {
          ...
          const h = p[f[0]], I = p[f[1]], A = new qe((h[0] + I[0]) / 2, (h[1] + I[1]) / 2, (h[2] + I[2]) / 2), z = A.clone().project(n), P = Math.sqrt((z.x - c) ** 2 + (z.y - s) ** 2);
          P < d * 0.8 && P < $ && ($ = P, y = A);
        }
        if (y) return {
          nodeIdx: null,
    ...
    function Vs(t) {
      ...
      if (Wt && (o.scene.remove(Wt), Wt.geometry.dispose(), Wt.material.dispose(), Wt = null), kt !== null && t.worldPos) {
        ...
        Wt = new Do(a, c), Vt === "arc" && lo !== null && (Wt = new en(a, c)), Wt.renderOrder = 9999, o.scene.add(Wt);
      }
      o.render();
    }
    function Xs(t, o, n, l) {
    ...
    function Ka(t) {
      ...
      if (Vt === "arc") {
        ...
        if (o === kt || o === lo) return;
        const n = e.nodes.val, l = new qe(...n[kt]), a = new qe(...n[lo]), c = new qe(...n[o]), s = Math.max(4, Math.round(((_a2 = Y.nSubViga) == null ? void 0 : _a2.val) ?? 8)), i = Xs(l, a, c, s);
        Vo();
        const p = [
          ...e.nodes.val
        ], r = [
      ...
      for (let g = 0; g < s.length; g++) {
        ...
        if (S.length === 2) {
          ...
          if (r.intersectTriangle($, y, f, false, h)) {
            const A = r.origin.distanceTo(h);
            A < i && (i = A, p = g);
          } else {
            const A = $.add(y).add(f).divideScalar(3), z = new qe();
            r.closestPointToPoint(A, z);
            const P = z.distanceTo(A);
            P < i && (i = P, p = g);
          }
        } else if (S.length === 4) {
          const $ = new qe(...c[S[0]]), y = new qe(...c[S[1]]), f = new qe(...c[S[2]]), h = new qe(...c[S[3]]), I = new qe();
          let A = r.intersectTriangle($, y, f, false, I);
          if (A) {
            const z = r.origin.distanceTo(I);
            z < i && (i = z, p = g);
          }
          if (A = r.intersectTriangle($, f, h, false, I), A) {
            const z = r.origin.distanceTo(I);
            z < i && (i = z, p = g);
          }
        }
    ...
    function Za(t, o, n, l, a, c, s) {
      ...
      <div>${C("a", "z")} = ${je("2\xB7" + C("E") + "\xB7" + C("I", "z") + "\xB7(1\u2212\u03C6/2)", C("L") + "\xB7(1+\u03C6<sub>z</sub>)")} = <span class="highlight">${Ee(h)}</span> &nbsp;(flexi\xF3n off-diag)</div>
      ` : `
    ...
    function Zs(t) {
      ...
      if (c) {
        ...
        `${l[0]}${l[1]}${Ee(m)}${Ee(u)}${Ee(E)}${Ee(L)}${Ee(O)}${Ee(W)}${Ee(x)}${K}`;
      } else {
        ...
        `${l.length}${l.join(", ")}${Ee(m)}${Ee(L)}${Ee(u)}${Ee(E)}`, O && (r = `<div class="fem-eq eq-box">
          ...
          <div>${C("D", "s")} = \u03BA\xB7${C("G")}\xB7${C("t")} = <span class="highlight">${Ee(5 / 6 * L * u)}</span> &nbsp; <sub style="color:var(--fem-label)">\u03BA = 5/6</sub></div>
      ...
      let d = "", g = "", S = "";
      r || (r = "");
      let $ = "", y = "", f = "", h = "", I = null, A = null, z = null, P = [];
      try {
        if (I = Fn(a, s, t), A = Pn(a), z = uo(hs(A), uo(I, A)), P = c ? [
          "ux\u2080",
          "uy\u2080",
          "uz\u2080",
          "\u03B8x\u2080",
          ...
          const L = jo(ko(a[1], a[0])), O = ((_o2 = s.elasticities) == null ? void 0 : _o2.get(t)) ?? 0, W = ((_p = s.areas) == null ? void 0 : _p.get(t)) ?? 0, x = ((_q = s.momentsOfInertiaZ) == null ? void 0 : _q.get(t)) ?? 0, w = ((_r = s.momentsOfInertiaY) == null ? void 0 : _r.get(t)) ?? 0, v = ((_s2 = s.shearModuli) == null ? void 0 : _s2.get(t)) ?? 0, F = ((_t2 = s.torsionalConstants) == null ? void 0 : _t2.get(t)) ?? 0;
          r = Za(O, W, x, w, v, F, L);
        }
        ...
        d = `<div class="matrix-label">k_local (${I.length}\xD7${I.length}) ${m}</div>${as(I, P)}`, g = `<div class="matrix-label">T \u2014 Transformaci\xF3n (${A.length}\xD7${A.length}) ${u}</div>${as(A, P)}`, S = `<div class="matrix-label">K_global = T^T \xB7 k \xB7 T ${E}</div>${as(z, P)}`;
      } catch (m) {
      ...
      if (i == null ? void 0 : i.deformations) {
        ...
        l.map((u, E) => {
          ...
          const L = ((_a3 = i.deformations) == null ? void 0 : _a3.get(u)) || [
            ...
            0,
            0
          ], O = m.map((W, x) => `<span class="prop-key">${W}</span>: <span class="${Math.abs(L[x]) > 1e-10 ? "result-val" : ""}">${Ee(L[x])}</span>`).join(" &nbsp;");
          return `<div style="margin-bottom:2px"><strong>Nodo ${u}:</strong> ${O}</div>`;
        }).join("");
      }
      if (p && c && (i == null ? void 0 : i.deformations) && I && A) {
        ...
        `${C("u", "global")}${l.map((te, Q) => `<span style="color:var(--fem-label)">nodo ${te}:</span> ${x.map((me, de) => `<span style="color:${Math.abs(w[Q * 6 + de]) > 1e-10 ? "var(--fem-eq-var)" : "var(--fem-eq-dots)"}">${Ee(w[Q * 6 + de])}</span>`).join(", ")}`).join(" | ")}${C("u", "local")}${C("T")}${C("u", "global")}${C("u", "local")}${K(v, [
          ...x,
          ...x
        ])}${C("f", "local")}${C("k", "local")}${C("u", "local")}${C("f", "local")}${F.map((te, Q) => `<span style="color:${Math.abs(te) > 1e-10 ? "var(--fem-nonzero)" : "var(--fem-eq-dots)"}">${le[Q]}=${Ee(te)}</span>`).join(", ")}${C("P", "1")}${C("N", "i")}${Ee(F[0])}${C("P", "7")}${C("N", "j")}${Ee(F[6])}${C("P", "2")}${C("V", "y,i")}${Ee(F[1])}${C("P", "8")}${C("V", "y,j")}${Ee(F[7])}${C("P", "3")}${C("V", "z,i")}${Ee(F[2])}${C("P", "9")}${C("V", "z,j")}${Ee(F[8])}${C("P", "4")}${C("M", "x,i")}${Ee(F[3])}${C("P", "10")}${C("M", "x,j")}${Ee(F[9])}${C("P", "5")}${C("M", "y,i")}${Ee(F[4])}${C("P", "11")}${C("M", "y,j")}${Ee(F[10])}${C("P", "6")}${C("M", "z,i")}${Ee(F[5])}${C("P", "12")}${C("M", "z,j")}${Ee(F[11])}${m ? m.map((te) => Ee(te)).join(", ") : "\u2014"}${u ? u.map((te) => Ee(te)).join(", ") : "\u2014"}${E ? E.map((te) => Ee(te)).join(", ") : "\u2014"}${L ? L.map((te) => Ee(te)).join(", ") : "\u2014"}${O ? O.map((te) => Ee(te)).join(", ") : "\u2014"}${W ? W.map((te) => Ee(te)).join(", ") : "\u2014"}`;
      } else if (p && c) {
        ...
        `${m ? m.map((x) => Ee(x)).join(", ") : "\u2014"}${u ? u.map((x) => Ee(x)).join(", ") : "\u2014"}${E ? E.map((x) => Ee(x)).join(", ") : "\u2014"}${L ? L.map((x) => Ee(x)).join(", ") : "\u2014"}${O ? O.map((x) => Ee(x)).join(", ") : "\u2014"}${W ? W.map((x) => Ee(x)).join(", ") : "\u2014"}`;
      } else if (p && !c) {
      ...
      `${l[0]}`, 6 * l[0], 6 * l[0] + 5, `${l[1]}`, 6 * l[1], 6 * l[1] + 5, l.length === 3 && (`${l[2]}`, 6 * l[2], 6 * l[2] + 5), o.length * 6, o.length * 6, ao = Bl(t, o, n, s, i, p), ao.id = "fem-inspect-panel", document.body.appendChild(ao), (_N = ao.querySelector("#er-close")) == null ? void 0 : _N.addEventListener("click", () => qo()), (_O = ao.querySelector("#rel-apply")) == null ? void 0 : _O.addEventListener("click", () => {
      ...
      const k = c ? (() => {
        var _a3, _b2, _c2, _d2, _e3, _f2;
        const m = jo(ko(a[1], a[0])), u = ((_a3 = s.elasticities) == null ? void 0 : _a3.get(t)) ?? 0, E = ((_b2 = s.areas) == null ? void 0 : _b2.get(t)) ?? 0, L = ((_c2 = s.momentsOfInertiaZ) == null ? void 0 : _c2.get(t)) ?? 0, O = ((_d2 = s.momentsOfInertiaY) == null ? void 0 : _d2.get(t)) ?? 0, W = ((_e3 = s.shearModuli) == null ? void 0 : _e3.get(t)) ?? 0, x = ((_f2 = s.torsionalConstants) == null ? void 0 : _f2.get(t)) ?? 0;
        return nl(u, E, L, O, W, x, m);
      })() : void 0;
      ao.querySelectorAll("[data-full]").forEach((m) => {
        m.addEventListener("click", (u) => {
          ...
          if (E === "kLocal" && I) {
            const L = c ? Ks() : "<em>Shell 18\xD718 \u2014 ver tabla num\xE9rica</em>";
            is(`Elemento ${t} \u2014 Rigidez Local k_local`, L, ls(I, P), k);
          } else if (E === "T" && A) is(`Elemento ${t} \u2014 Transformaci\xF3n T`, $, ls(A, P));
          else if (E === "kGlobal" && z) {
            const L = c ? Ks() : "<em>Shell 18\xD718</em>";
            is(`Elemento ${t} \u2014 Rigidez Global K = T^T \xB7 k \xB7 T`, L, ls(z, P), k);
          }
        });
      });
    }
    ...
    function na() {
      ...
      for (let f = 0; f <= 20; f++) {
        ...
        for (let P = 0; P < 3; P++) {
          const k = P * 2 * Math.PI / 3 - Math.PI / 2, m = A * Math.cos(k), u = A * Math.sin(k), E = a.length;
          a.push([
            m,
            u,
            I
    ...
    function sa() {
      ...
      for (let g = 0; g < 3; g++) {
        ...
        for (let A = 0; A <= 4; A++) {
          const z = A / 4, P = -f / 2 + f * z, k = y * (1 - z * z * 0.3);
          for (let m = 0; m <= 12; m++) {
    ...
    function rs() {
      ...
      const P = tt();
      P && (P.settings.shellResults.val = "displacementX"), setTimeout(() => It(), 50), st();
    }
    function la() {
      var _a2, _b, _c, _d, _e2, _f, _g, _h;
      const t = M, o = ((_a2 = Y.L) == null ? void 0 : _a2.val) ?? 6, n = ((_b = Y.h) == null ? void 0 : _b.val) ?? 0.5, l = ((_c = Y.t) == null ? void 0 : _c.val) ?? 0.2, a = Math.round(((_d = Y.nx) == null ? void 0 : _d.val) ?? 12), c = Math.round(((_e2 = Y.ny) == null ? void 0 : _e2.val) ?? 4), s = ((_f = Y.E) == null ? void 0 : _f.val) ?? 25e6, i = ((_g = Y.nu) == null ? void 0 : _g.val) ?? 0.2, p = ((_h = Y.P) == null ? void 0 : _h.val) ?? 50, r = s / (2 * (1 + i)), d = o / a, g = n / c, S = [], $ = [], y = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map();
      for (let P = 0; P <= c; P++) for (let k = 0; k <= a; k++) S.push([
        k * d,
        P * g,
        0
      ]);
      const h = a + 1;
      for (let P = 0; P < c; P++) for (let k = 0; k < a; k++) $.push([
        P * h + k,
        P * h + k + 1,
        (P + 1) * h + k + 1,
        (P + 1) * h + k
      ...
      try {
        ...
        if (P && e.deformOutputs) {
          ...
          const m = P.deformations.get(I), u = m ? m[2] : 0, E = l * n * n * n / 12, L = p * o * o * o / (3 * s * E);
    ...
    function ia() {
      ...
      const P = tt();
      P && (P.settings.shellResults.val = "displacementZ"), setTimeout(() => It(), 50), st();
    }
    function ra() {
      var _a2, _b, _c, _d, _e2, _f, _g, _h, _i, _j, _k, _l2, _m, _n2, _o2, _p, _q, _r, _s2;
      const t = M, o = ((_a2 = Y.Lx) == null ? void 0 : _a2.val) ?? 6, n = ((_b = Y.Ly) == null ? void 0 : _b.val) ?? 8, l = ((_c = Y.H1) == null ? void 0 : _c.val) ?? 3, a = ((_d = Y.H2) == null ? void 0 : _d.val) ?? 4.5, c = Math.round(((_e2 = Y.nCol) == null ? void 0 : _e2.val) ?? 4), s = Math.round(((_f = Y.nCorr) == null ? void 0 : _f.val) ?? 8), i = ((_g = Y.E) == null ? void 0 : _g.val) ?? t.E, p = ((_h = Y.t) == null ? void 0 : _h.val) ?? 5e-4, r = ((_i = Y.q) == null ? void 0 : _i.val) ?? 1, d = 0.3, g = i / (2 * (1 + d)), S = ((_j = Y.colD) == null ? void 0 : _j.val) ?? 0.16, $ = ((_k = Y.colBf) == null ? void 0 : _k.val) ?? 0.16, y = ((_l2 = Y.colTf) == null ? void 0 : _l2.val) ?? 0.013, f = ((_m = Y.colTw) == null ? void 0 : _m.val) ?? 8e-3, h = ((_n2 = Y.vigD) == null ? void 0 : _n2.val) ?? 0.2, I = ((_o2 = Y.vigBf) == null ? void 0 : _o2.val) ?? 0.1, A = ((_p = Y.vigTf) == null ? void 0 : _p.val) ?? 85e-4, z = ((_q = Y.vigTw) == null ? void 0 : _q.val) ?? 56e-4, P = ((_r = Y.corrB) == null ? void 0 : _r.val) ?? 0.06, k = ((_s2 = Y.corrT) == null ? void 0 : _s2.val) ?? 4e-3, m = (Se, We, Et, oo) => {
      ...
      }, u = m(S, $, y, f), E = m(h, I, A, z), L = P - 2 * k, O = P * P - L * L, W = (P ** 4 - L ** 4) / 12, x = 2 * k * (P - k) ** 2 * (P - k) / 2, w = u.A, v = u.Iz, F = u.Iy, K = u.J, U = E.A, le = E.Iz, te = E.Iy, Q = E.J, me = O, de = W, ke = W, Re = x, N = 3, ce = [], oe = [], pe = /* @__PURE__ */ new Map(), ee = /* @__PURE__ */ new Map(), ge = [];
      for (let Se = 0; Se < N; Se++) ge.push(Se * o / (N - 1));
      const Ie = [];
      ...
      const yt = [];
      let Ct = 0;
      for (let Se = 0; Se < N; Se++) for (let We = 0; We < c; We++) oe.push([
        vt[Se][We],
        et[Se][Dt[We]]
      ]), yt.push("col"), Ct++;
      for (let Se = 0; Se < N; Se++) for (let We = 0; We < Be - 1; We++) oe.push([
        et[Se][We],
        et[Se][We + 1]
      ]), yt.push("vig"), Ct++;
      oe.length;
      for (let Se = 0; Se < Be; Se++) for (let We = 0; We < N - 1; We++) oe.push([
        et[We][Se],
        et[We + 1][Se]
      ]), yt.push("corr"), Ct++;
      oe.length;
      for (let Se = 0; Se < N - 1; Se++) for (let We = 0; We < Be - 1; We++) oe.push([
        et[Se][We],
        et[Se + 1][We],
        et[Se + 1][We + 1],
        et[Se][We + 1]
      ]), yt.push("shell");
      for (let Se = 0; Se < N; Se++) for (let We = 0; We < c; We++) pe.set(vt[Se][We], [
        true,
        true,
        true,
        true,
      ...
      for (let Se = 0; Se < N; Se++) for (let We = 0; We < Be; We++) {
        let Et;
        Se === 0 ? Et = (ge[1] - ge[0]) / 2 : Se === N - 1 ? Et = (ge[N - 1] - ge[N - 2]) / 2 : Et = (ge[Se + 1] - ge[Se - 1]) / 2;
        let oo;
      ...
      for (let Se = 0; Se < oe.length; Se++) {
        ...
        const We = yt[Se];
        if (We === "col") {
          Kt.set(Se, w), jt.set(Se, v), at.set(Se, F), Ut.set(Se, K);
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        try {
          const { cyclicPushover: h } = await va(async () => {
    ...
    function ll(t, o, n, l) {
      ...
      const y = g - d, f = $ - S, h = (P) => i.left + (P - d) / y * p, I = (P) => i.top + r - (P - S) / f * r;
      ...
      for (let P = 1; P < o.length; P++) a.lineTo(h(o[P]), I(n[P]));
    ...
    function rl(t) {
      ...
      const r = o / n, d = l * n;
      let g = 0, S = 0, $ = -r, y = r, f = 0, h = 0, I = 0, A = 0, z = 0, P = 0;
      const k = [];
      for (const U of p) {
        let le = $, te = y, Q = f, me = h, de = I, ke = A, Re = z, N = P, ce;
        const oe = U - g;
        if (Math.abs(oe) < 1e-20) {
          k.push(S);
          continue;
        }
        if ((N === 0 || N === 3) && (oe < 0 ? (N = 2, me = -r, de = -o, Q = me, ke = 0, Re = 0) : (N = 1, me = r, de = o, Q = me, ke = 0, Re = 0)), N === 2 && oe > 0) {
          N = 1, ke = g, Re = S, g < le && (le = g);
          const we = (te - le) / (2 * 1 * r), Be = 1 + 0 * Math.pow(we, 0.8);
          me = (o * Be - d * r * Be - Re + n * ke) / (n - d), de = o * Be + d * (me - r * Be), Q = te;
        } else if (N === 1 && oe < 0) {
          N = 2, ke = g, Re = S, g > te && (te = g);
          const we = (te - le) / (2 * 1 * r), Be = 1 + 0 * Math.pow(we, 0.8);
        ...
        ce = l * ge + (1 - l) * ge / se, ce = ce * (de - Re) + Re, k.push(ce), g = U, S = ce, $ = le, y = te, f = Q, h = me, I = de, A = ke, z = Re, P = N;
      }
    ...
    setTimeout(() => {
      ...
      function s(p, r, d, g, S) {
        const $ = Math.min(p, d), y = Math.max(p, d), f = Math.min(r, g), h = Math.max(r, g), I = e.nodes.val, A = e.elements.val, z = [];
        for (let P = 0; P < A.length; P++) {
          const k = A[P], m = k.map((u) => c(I[u])).filter(Boolean);
          if (m.length !== 0) if (S) m.every((E) => E.x >= $ && E.x <= y && E.y >= f && E.y <= h) && z.push(P);
          else {
            ...
            if (k.length === 2) {
              const E = m[0], L = m[1];
              i(E.x, E.y, L.x, L.y, $, f, y, h) && z.push(P);
            }
          }
        }
        return z;
      ...
      o.addEventListener("mousedown", (p) => {
        ...
        if (yo) {
          ...
          if (Lt.track && g.snapType === "node" && g.nodeIdx !== null && g.nodeIdx !== No && Va(g.nodeIdx), Lt.track && No !== null && g.worldPos && g.snapType !== "node") {
            const S = Xa(g.worldPos, No);
            S && (g.worldPos = S, g.snapType = "grid");
          }
          if (No !== null && g.worldPos) {
            const S = e.nodes.val[No];
            S && Ys(p.clientX, p.clientY, new qe(...S), g.worldPos);
          } else if (kt !== null && g.worldPos) {
            const S = e.nodes.val[kt];
            S && Ys(p.clientX, p.clientY, new qe(...S), g.worldPos);
          } else io && (io.remove(), io = null);
          g.nodeIdx, Vs(g), o.style.cursor = g.snapType !== "free" ? "pointer" : "crosshair";
          return;
        }
        if (!po && !eo) return;
        if (eo && n) {
        ...
        if (yo) {
          const r = tt();
          if (!r) return;
          const d = Js(p.clientX, p.clientY, r.camera, r.rendererElm);
          (d.worldPos || d.nodeIdx !== null) && (Ka(d), Vs(d));
          return;
        }
        if (eo) {
          if (l) return;
      ...
      e.nodes.val.length === 0 && (nt("muro-q4"), rs(), Hs("muro-q4"), setTimeout(() => {
        T === "muro-q4" && mo();
      }, 200));
    }, 100);
    ...
    }), document.addEventListener("mousemove", (t) => ba(t.clientX, t.clientY)), document.addEventListener("mouseup", () => ha()), Xt.addEventListener("touchstart", (t) => {
      const o = t.touches[0];
