...
import { d as kt, _ as ea, p as Uo, m as Va, s as Ua, __tla as __tla_0 } from "./didacticCpp-D1M3B8xf.js";
...
`);
      ...
      y && (y.value = P, y.addEventListener("change", (g) => {
        ...
        g.stopPropagation(), ea(async () => {
          const { openCalcPanel: E } = await import("./calcPanel-MiO40P0E.js").then(async (m2) => {
            await m2.__tla;
            return m2;
          });
          return {
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        try {
          const { cyclicPushover: h } = await ea(async () => {
            const { cyclicPushover: A } = await import("./cyclicPushoverCpp-BK4Rr9QF.js").then(async (m2) => {
              await m2.__tla;
              return m2;
            });
            return {
