const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./calcPanel-DCiVpMF7.js","./getMesh-B1dmlgUt.js","./__vite-browser-external-D7Ct-6yo.js","./pureFunctionsAny.generated-JAcEVsJ7.js","./analyze-ClLKGn9k.js","./didacticCpp-CbgPKnqV.js","./cyclicPushoverCpp-Ca848qdR.js"])))=>i.map(i=>d[i]);
import { d as kt, _ as ea, p as Uo, m as Va, s as Ua, __tla as __tla_0 } from "./didacticCpp-CbgPKnqV.js";
...
let __tla = Promise.all([
  ...
  function Rn(e, g) {
    const R = ns.find((j) => j.id === e), M = Vn.find((j) => j.id === g), J = R.toKN, D = M.toM, U = (j, ge, T) => T / (Math.pow(J, j) * Math.pow(D, ge));
    let Y, H;
    switch (e) {
      case "kN":
        Y = 10, H = [
  ...
  <td style="padding:2px 5px; text-align:right; color:#0ff">${(U[5] * 100).toFixed(1)}%</td></tr>`;
      ...
      (_b = e.querySelector("#modal-copy")) == null ? void 0 : _b.addEventListener("click", () => {
        ...
        M.frequencies.forEach((ye, ie) => {
          ...
          j.push(`${String(ie + 1).padStart(4)}  ${ye.toFixed(4).padStart(9)}  ${re.toFixed(4).padStart(9)}  ${te.toFixed(2).padStart(9)}  ${B}  ${(T[0] * 100).toFixed(1).padStart(5)}%  ${(T[1] * 100).toFixed(1).padStart(5)}%  ${(T[5] * 100).toFixed(1).padStart(5)}%`);
...
`));
  ...
  function ul(e) {
    ...
    const { nodes: g, elements: R, elementInputs: M, nodeInputs: J, deformOutputs: D } = e, U = g.length * 6, Y = R.length, H = R.filter((re) => re.length === 2).length, j = R.filter((re) => re.length >= 3).length, ge = document.createElement("div");
    ...
    T += '<button class="rpt-close" id="rpt-close">\u2715 Close</button>', T += "<h1>Finite Element Analysis \u2014 Step-by-Step Report</h1>", T += '<div class="rpt-subtitle">Complete FEM derivation from element formulation to final results</div>', T += '<hr class="rpt-sep"/>', T += "<h2>1. Input Data</h2>", T += '<table class="rpt-info"><tbody>', T += `<tr><td>Number of nodes</td><td class="val">${g.length}</td></tr>`, T += `<tr><td>Number of elements</td><td class="val">${Y} (${H} frames, ${j} shells)</td></tr>`, T += '<tr><td>DOFs per node</td><td class="val">6 (u<sub>x</sub>, u<sub>y</sub>, u<sub>z</sub>, \u03B8<sub>x</sub>, \u03B8<sub>y</sub>, \u03B8<sub>z</sub>)</td></tr>', T += `<tr><td>Total DOFs</td><td class="val">${U}</td></tr>`, T += "</tbody></table>", T += "<h3>1.1 Node Coordinates</h3>", T += '<table class="rpt-data"><thead><tr><th>Node</th><th>x</th><th>y</th><th>z</th></tr></thead><tbody>', g.forEach((re, te) => {
      ...
      var _a2, _b2, _c2, _d2;
      const q = re.length === 2, B = re.map((xe) => g[xe]), G = q ? Pn(xn(B[1], B[0])) : 0, de = ((_a2 = M.elasticities) == null ? void 0 : _a2.get(te)) ?? 0, $e = ((_b2 = M.areas) == null ? void 0 : _b2.get(te)) ?? 0, Te = ((_c2 = M.momentsOfInertiaZ) == null ? void 0 : _c2.get(te)) ?? 0, Ve = ((_d2 = M.momentsOfInertiaY) == null ? void 0 : _d2.get(te)) ?? 0;
    ...
    for (let re = 0; re < Y; re++) {
      ...
      const G = Pn(xn(q[1], q[0])), de = ((_a = M.elasticities) == null ? void 0 : _a.get(re)) ?? 0, $e = ((_b = M.areas) == null ? void 0 : _b.get(re)) ?? 0, Te = ((_c = M.momentsOfInertiaZ) == null ? void 0 : _c.get(re)) ?? 0, Ve = ((_d = M.momentsOfInertiaY) == null ? void 0 : _d.get(re)) ?? 0, xe = ((_e = M.shearModuli) == null ? void 0 : _e.get(re)) ?? 0, De = ((_f = M.torsionalConstants) == null ? void 0 : _f.get(re)) ?? 0;
      ...
      T += '<div class="rpt-elem-block">', T += `<h3 class="rpt-elem-title" data-toggle="elem${re}">\u25B6 Element ${re} \u2014 Nodes ${te[0]} \u2192 ${te[1]}, L = ${ot(G)}</h3>`, T += `<div id="rpt-elem${re}" class="rpt-elem-body" style="display:none">`, T += "<h4>Properties (numerical substitution)</h4>", T += '<div class="rpt-eq-small">', T += `E = ${ot(de)} &nbsp;&nbsp; A = ${ot($e)} &nbsp;&nbsp; I<sub>z</sub> = ${ot(Te)} &nbsp;&nbsp; I<sub>y</sub> = ${ot(Ve)} &nbsp;&nbsp; G = ${ot(xe)} &nbsp;&nbsp; J = ${ot(De)}<br/>`, T += `EA/L = ${ot(de)}\xB7${ot($e)}/${ot(G)} = <b>${ot(de * $e / G)}</b><br/>`, T += `12EI<sub>z</sub>/L\xB3 = 12\xB7${ot(de)}\xB7${ot(Te)}/${ot(G)}\xB3 = <b>${ot(12 * de * Te / G ** 3)}</b><br/>`, T += `12EI<sub>y</sub>/L\xB3 = 12\xB7${ot(de)}\xB7${ot(Ve)}/${ot(G)}\xB3 = <b>${ot(12 * de * Ve / G ** 3)}</b><br/>`, T += `GJ/L = ${ot(xe)}\xB7${ot(De)}/${ot(G)} = <b>${ot(xe * De / G)}</b>`, T += "</div>", T += "<h4>Direction cosines</h4>", T += `<div class="rpt-eq-small">l = ${go(Je)}, m = ${go(st)}, n = ${go(Ue)}, D = ${go(Math.sqrt(Je ** 2 + st ** 2))}</div>`, T += "<h4>K<sub>local</sub> (12\xD712)</h4>", T += Ko(He, 12), T += "<h4>T \u2014 Transformation (12\xD712)</h4>", T += Ko(be, 12), T += "<h4>K<sub>global</sub> = T\u1D40 \xB7 K<sub>local</sub> \xB7 T</h4>", T += Ko(Ee, 12), T += "<h4>Assembly</h4>", T += `<div class="rpt-eq-small">Global DOFs: node ${te[0]} \u2192 [${te[0] * 6}..${te[0] * 6 + 5}], node ${te[1]} \u2192 [${te[1] * 6}..${te[1] * 6 + 5}]</div>`, T += "</div></div>";
    }
    ...
    if (T += "<h3>5.1 Supports (fixed DOFs)</h3>", J.supports && J.supports.size > 0) {
      ...
      T += "</tr></thead><tbody>", J.supports.forEach((re, te) => {
        T += `<tr><td>${te}</td>`, re.forEach((q, B) => {
          q && ye.push(te * 6 + B), T += `<td class="${q ? "fixed" : ""}">${q ? "Fixed" : "Free"}</td>`;
        }), T += "</tr>";
      }), T += "</tbody></table>";
    }
    if (T += `<div class="rpt-eq-small">Fixed DOFs: [${ye.join(", ")}] \u2192 ${ye.length} constraints<br/>`, T += `Free DOFs: ${U} \u2212 ${ye.length} = <b>${U - ye.length}</b></div>`, T += "<h3>5.2 Applied Loads</h3>", J.loads && J.loads.size > 0) {
      ...
      T += "</tr></thead><tbody>", J.loads.forEach((te, q) => {
        T += `<tr><td>${q}</td>`, te.forEach((B) => {
          const G = Math.abs(B) > 1e-10;
          T += `<td class="${G ? "nz" : ""}">${G ? ot(B) : "0"}</td>`;
        }), T += "</tr>";
      }), T += "</tbody></table>";
    }
    if (T += "<h2>6. Solution</h2>", T += "<p>After removing fixed DOFs, the reduced system is:</p>", T += '<div class="rpt-eq rpt-eq-highlight">K<sub>free</sub> \xB7 u<sub>free</sub> = F<sub>free</sub></div>', T += "<p>Solved using LU decomposition with partial pivoting (sparse matrix).</p>", T += "<h3>6.1 Nodal Displacements</h3>", D == null ? void 0 : D.deformations) {
      T += '<table class="rpt-data"><thead><tr><th>Node</th>';
      for (const re of Z) T += `<th>${re}</th>`;
      T += "</tr></thead><tbody>", D.deformations.forEach((re, te) => {
        T += `<tr><td>${te}</td>`, re.forEach((q) => {
          const B = Math.abs(q) > 1e-10;
          T += `<td class="${B ? "nz" : ""}">${ot(q, 6)}</td>`;
        }), T += "</tr>";
      }), T += "</tbody></table>";
    }
    if (T += "<h3>6.2 Reactions</h3>", T += '<div class="rpt-eq">R = K<sub>total</sub> \xB7 u (extract at fixed DOFs)</div>', D == null ? void 0 : D.reactions) {
      T += '<table class="rpt-data"><thead><tr><th>Node</th>';
      for (const re of Z) T += `<th>${re}</th>`;
      T += "</tr></thead><tbody>", D.reactions.forEach((re, te) => {
        T += `<tr><td>${te}</td>`, re.forEach((q) => {
          const B = Math.abs(q) > 1e-10;
          T += `<td class="${B ? "nz-react" : ""}">${B ? ot(q, 4) : "0"}</td>`;
        }), T += "</tr>";
      }), T += "</tbody></table>";
    }
      ...
      for (let te = 0; te < Y; te++) {
        ...
        try {
          ...
          for (let xe = 0; xe < 12; xe++) {
            ...
            T += `<td class="${De ? "nz" : ""}">${ot(Ve[xe], 2)}</td>`;
          }
          T += "</tr>";
        } catch {
        }
  ...
  function Ko(e, g) {
    ...
    for (let J = 0; J < R; J++) {
      ...
      for (let D = 0; D < R; D++) {
        ...
        M += `<td class="${Y ? "z" : ""} ${J === D && !Y ? "diag" : ""}">${Y ? "0" : ml(U)}</td>`;
      }
      M += "</tr>";
    }
  ...
  function xl(e, g, R, M, J, D) {
    ...
    try {
      te = vo(Y, M, e), q = yo(Y), B = on(os(q), on(te, q));
    } catch {
    }
  ...
  function vl(e, g, R, M, J, D) {
    var _a, _b;
    const U = xl(e, g, R, M, J, D), Y = document.createElement("div");
  ...
  function yl(e) {
    ...
    if (g += '<div class="er-section-title">1. Propiedades</div>', g += '<table class="er-props">', g += `<tr><td>E</td><td>${Ye(e.E)}</td><td>A</td><td>${Ye(e.A)}</td></tr>`, g += `<tr><td>I<sub>z</sub></td><td>${Ye(e.Iz)}</td><td>I<sub>y</sub></td><td>${Ye(e.Iy)}</td></tr>`, g += `<tr><td>G</td><td>${Ye(e.G)}</td><td>J</td><td>${Ye(e.J)}</td></tr>`, g += "</table>", e.kLocal && (g += `<div class="er-section-title">2. K<sub>local</sub> (${e.kLocal.length}\xD7${e.kLocal.length})</div>`, g += ao(e.kLocal)), e.T && (g += '<div class="er-section-title">3. T \u2014 Transformaci\xF3n</div>', g += ao(e.T)), e.kGlobal && (g += '<div class="er-section-title">4. K<sub>global</sub> = T<sup>T</sup>\xB7K\xB7T</div>', g += ao(e.kGlobal)), g += '<div class="er-section-title">5. Desplazamientos</div>', e.uGlobal.length > 0) {
      ...
      for (let M = 0; M < e.elem.length; M++) {
        ...
        for (let J = 0; J < 6; J++) {
          const D = e.uGlobal[M * 6 + J];
          g += `${R[J]}=<span class="${Math.abs(D) > 1e-10 ? "nz" : ""}">${Ye(D, 6)}</span> `;
        }
        g += "</div>";
      }
  ...
  function $l(e) {
    ...
    if (g += `<div class="er-section-title">Resumen \u2014 Elemento ${e.elemIdx}</div>`, g += '<table class="er-props">', g += `<tr><td>Tipo</td><td>${e.isFrame ? "Frame (Euler-Bernoulli)" : "Shell"}</td></tr>`, g += `<tr><td>Nodos</td><td>${e.elem.join(" \u2192 ")}</td></tr>`, g += `<tr><td>Longitud</td><td><b>${Ye(e.L)}</b></td></tr>`, g += `<tr><td>E</td><td>${Ye(e.E)}</td></tr>`, g += `<tr><td>A</td><td>${Ye(e.A)}</td></tr>`, g += "</table>", e.uGlobal.length > 0) {
      ...
      for (let M = 0; M < e.elem.length; M++) {
        ...
        for (let J = 0; J < 6; J++) {
          const D = e.uGlobal[M * 6 + J];
          g += `<td class="${Math.abs(D) > 1e-10 ? "nz" : ""}">${Ye(D, 6)}</td>`;
        }
        g += "</tr>";
      }
      g += "</table>";
  ...
  function Qo(e) {
    ...
    if (!g) return;
    const R = e.width, M = e.height, J = 30, D = R - 2 * J, U = (M - 3 * J) / 2;
    g.fillStyle = getComputedStyle(document.body).getPropertyValue("--fem-bg").trim() || "#111", g.fillRect(0, 0, R, M);
    const Y = (H, j, ge) => {
      g.strokeStyle = "#333", g.lineWidth = 1, g.strokeRect(J, H, D, U), g.strokeStyle = "#444", g.beginPath(), g.moveTo(J, H + U / 2), g.lineTo(J + D, H + U / 2), g.stroke(), g.fillStyle = "#888", g.font = "11px sans-serif", g.fillText(j, J + 4, H + 14);
      for (const Z of ge) {
      ...
      g.fillStyle = "#666", g.font = "9px monospace", g.fillText("0", J, H + U + 12), g.fillText("1", J + D - 6, H + U + 12), g.fillText("\u03BE", J + D / 2, H + U + 12);
    };
    Y(J, "Axial (lineal)", [
      {
        fn: (H) => 1 - H,
  ...
  function Un(e) {
    ...
    const M = R.getBoundingClientRect(), J = window.innerWidth, D = window.innerHeight, U = 320, Y = 180;
  ...
  `, document.body.appendChild(ln);
    const H = J - M.right, j = M.left, ge = D - M.bottom, T = M.top;
  ...
  function kl(e) {
    ...
    const g = e.split(/\r?\n/), R = {
      force: "TONF",
      length: "M"
    }, M = [], J = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), Y = [], H = [], j = /* @__PURE__ */ new Map(), ge = /* @__PURE__ */ new Map(), T = [], Z = [];
    let ye = "", ie = "";
    ...
    for (const Le of Y) for (const [qe, ve] of ge) {
      ...
      const Ce = ve.story, he = M.findIndex((ke) => ke.name === Ce);
      if (!(he < 0)) if (Le.type === "COLUMN" || Le.type === "BRACE") {
        $e.add(de(Le.pt2, Ce));
        const ke = Math.max(Le.nStories, 1), Ge = Math.min(he + ke, M.length - 1);
        $e.add(de(Le.pt1, M[Ge].name));
    ...
    for (const Le of Y) for (const [qe, ve] of ge) {
      if (!qe.startsWith(Le.name + "@")) continue;
      const Ce = ve.story, he = M.findIndex((We) => We.name === Ce);
      if (he < 0) continue;
      let ke, Ge;
      if (Le.type === "COLUMN" || Le.type === "BRACE") {
        const We = Math.max(Le.nStories, 1), Xe = Math.min(he + We, M.length - 1);
        ke = de(Le.pt1, M[Xe].name), Ge = de(Le.pt2, Ce);
  ...
  function zl(e) {
    ...
    const D = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map(), H = /* @__PURE__ */ new Map(), j = [], ge = [], T = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), ye = /* @__PURE__ */ new Map(), ie = [];
    let re = "";
    for (const te of g) {
      const q = te.trim();
    ...
    return pa(M, J, D, U, Y, H, j, ge, T, Z, ye, ie);
  }
  function Al(e) {
    const g = {
      force: "KN",
    ...
    const M = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), Y = [], H = [], j = /* @__PURE__ */ new Map(), ge = [];
    let T = "", Z = "";
    for (const re of e) {
      const te = re.trim();
    ...
    return pa(g, R, M, J, D, U, Y, H, j, /* @__PURE__ */ new Map(), /* @__PURE__ */ new Map(), ge);
  }
  function pa(e, g, R, M, J, D, U, Y, H, j, ge, T) {
    var _a;
    ...
    for (let xe = 0; xe < re.length; xe++) {
      const De = q.get(xe), He = De ? M.get(De) : null, be = De ? J.get(De) : null;
  ...
  function Ll(e) {
    ...
    const { nodes: g, elements: R, nodeInputs: M, elementInputs: J } = e, D = e.units || {
      force: "KN",
      length: "m"
    ...
    if (T.length > 0) {
      ...
      for (const q of T) {
        const B = R[q], G = B.map((de, $e) => `Joint${$e + 1}=${de + 1}`).join("   ");
    ...
    if (H('TABLE:  "LOAD PATTERN DEFINITIONS"'), H("   LoadPat=DEAD   DesignType=Dead   SelfWtMult=0"), j(), H('TABLE:  "LOAD CASE DEFINITIONS"'), H('   Case=DEAD   Type=LinStatic   InitialCond=Zero   DesTypeOpt="Prog Det"   DesignType=Dead   DesActOpt="Prog Det"   DesignAct=Non-Composite   AutoType=None   RunCase=Yes'), j(), H('TABLE:  "CASE - STATIC 1 - LOAD ASSIGNMENTS"'), H('   Case=DEAD   LoadType="Load pattern"   LoadName=DEAD   LoadSF=1'), j(), M.forces && M.forces.size > 0) {
      ...
      for (const [q, B] of M.forces) B.some((G) => Math.abs(G) > 1e-12) && H(`   Joint=${q + 1}   LoadPat=DEAD   CoordSys=GLOBAL   F1=${It(B[0])}   F2=${It(B[1])}   F3=${It(B[2])}   M1=${It(B[3])}   M2=${It(B[4])}   M3=${It(B[5])}`);
      j();
    }
    const te = /* @__PURE__ */ new Map();
...
`);
  ...
  function Fl(e, g) {
    ...
    for (const J of M) {
      ...
      if (!(!D || D.length === 0)) {
        R.push(`$ ${J}`);
        for (const U of D) R.push(U);
        R.push("");
      }
    }
    for (const [J, D] of e) if (!M.includes(J) && D.length !== 0) {
      R.push(`$ ${J}`);
      for (const U of D) R.push(U);
      R.push("");
    }
...
`);
  ...
  function Rl(e) {
    var _a, _b, _c, _d;
    const { nodes: g, elements: R, nodeInputs: M, elementInputs: J, title: D, units: U } = e, Y = (U == null ? void 0 : U.force) || "TONF", H = (U == null ? void 0 : U.length) || "M", j = [], ge = (be) => Math.round(be * 1e4) / 1e4;
    ...
    R.forEach((be, Ee) => {
      ...
      if (ze === "BEAM") {
        ...
        xe(st);
        const at = xe(Ue), dt = ge(g[st][1]), yt = ge(g[Ue][1]), zt = Z.indexOf(dt), Ft = Z.indexOf(yt), gt = Math.max(1, Ft >= 0 && zt >= 0 ? Ft - zt : 1);
...
`);
  ...
  function Pl(e, g) {
    const R = e[g[0]], M = e[g[1]], J = Math.abs(M[1] - R[1]), D = Math.sqrt((M[0] - R[0]) ** 2 + (M[2] - R[2]) ** 2), U = J > D * 0.5;
    return U && D > 0.01 ? "BRACE" : U ? "COLUMN" : "BEAM";
  }
  function Ol(e) {
    var _a, _b;
    const { nodes: g, elements: R, nodeInputs: M, elementInputs: J } = e, D = [];
    return D.push("# OpenSeesPy model exported from Awatif FEM Studio"), D.push(`# ${g.length} nodes, ${R.length} elements`), D.push(""), D.push("import openseespy.opensees as ops"), D.push(""), D.push("ops.wipe()"), D.push("ops.model('basic', '-ndm', 3, '-ndf', 6)"), D.push(""), D.push("# --- Nodes ---"), g.forEach((U, Y) => {
      D.push(`ops.node(${Y + 1}, ${U[0]}, ${U[1]}, ${U[2]})`);
    }), D.push(""), D.push("# --- Boundary Conditions ---"), (_a = M.supports) == null ? void 0 : _a.forEach((U, Y) => {
      const H = U.map((j) => j ? 1 : 0).join(", ");
      D.push(`ops.fix(${Y + 1}, ${H})`);
    }), D.push(""), D.push("# --- Geometric Transformations ---"), D.push("ops.geomTransf('Linear', 1, 0.0, 0.0, 1.0)  # beams (vecxz = Z)"), D.push("ops.geomTransf('Linear', 2, -1.0, 0.0, 0.0)  # columns (vecxz = -X)"), D.push(""), D.push("# --- Elements (elasticBeamColumn) ---"), R.forEach((U, Y) => {
      ...
      D.push(`ops.element('elasticBeamColumn', ${Y + 1}, ${U[0] + 1}, ${U[1] + 1}, ${Z}, ${ye}, ${ie}, ${re}, ${te}, ${q}, ${T})`);
    }), D.push(""), M.loads && M.loads.size > 0 && (D.push("# --- Loads ---"), D.push("ops.timeSeries('Linear', 1)"), D.push("ops.pattern('Plain', 1, 1)"), M.loads.forEach((U, Y) => {
    ...
    }), D.push(""), D.push('print("\\n=== Reactions ===")'), D.push("ops.reactions()"), (_b = M.supports) == null ? void 0 : _b.forEach((U, Y) => {
...
`);
  ...
  function Nl(e) {
    var _a, _b;
    const { nodes: g, elements: R, nodeInputs: M, elementInputs: J } = e, D = [];
    return D.push("# OpenSees Tcl model exported from Awatif FEM Studio"), D.push(`# ${g.length} nodes, ${R.length} elements`), D.push(""), D.push("wipe"), D.push("model basic -ndm 3 -ndf 6"), D.push(""), D.push("# --- Nodes ---"), g.forEach((U, Y) => {
      D.push(`node ${Y + 1} ${U[0]} ${U[1]} ${U[2]}`);
    }), D.push(""), D.push("# --- Boundary Conditions ---"), (_a = M.supports) == null ? void 0 : _a.forEach((U, Y) => {
      const H = U.map((j) => j ? 1 : 0).join(" ");
      D.push(`fix ${Y + 1} ${H}`);
    }), D.push(""), D.push("# --- Geometric Transformations ---"), D.push("geomTransf Linear 1 0.0 0.0 1.0"), D.push("geomTransf Linear 2 -1.0 0.0 0.0"), D.push(""), D.push("# --- Elements ---"), R.forEach((U, Y) => {
      var _a2, _b2, _c, _d, _e, _f;
      if (U.length !== 2) return;
      const H = g[U[0]], j = g[U[1]], T = Math.abs(j[2] - H[2]) > Math.max(Math.abs(j[0] - H[0]), Math.abs(j[1] - H[1])) ? 2 : 1, Z = ((_a2 = J.areas) == null ? void 0 : _a2.get(Y)) ?? 1, ye = ((_b2 = J.elasticities) == null ? void 0 : _b2.get(Y)) ?? 2e5, ie = ((_c = J.shearModuli) == null ? void 0 : _c.get(Y)) ?? 8e4, re = ((_d = J.torsionalConstants) == null ? void 0 : _d.get(Y)) ?? 1, te = ((_e = J.momentsOfInertiaY) == null ? void 0 : _e.get(Y)) ?? 1, q = ((_f = J.momentsOfInertiaZ) == null ? void 0 : _f.get(Y)) ?? 1;
      D.push(`element elasticBeamColumn ${Y + 1} ${U[0] + 1} ${U[1] + 1} ${Z} ${ye} ${ie} ${re} ${te} ${q} ${T}`);
    }), D.push(""), M.loads && M.loads.size > 0 && (D.push("# --- Loads ---"), D.push("timeSeries Linear 1"), D.push("pattern Plain 1 1 {"), M.loads.forEach((U, Y) => {
      const H = U.map((j) => j).join(" ");
      D.push(`  load ${Y + 1} ${H}`);
    ...
    }), D.push('puts "\\n=== Reactions ==="'), D.push("reactions"), (_b = M.supports) == null ? void 0 : _b.forEach((U, Y) => {
      D.push(`puts "Node ${Y + 1}: [nodeReaction ${Y + 1}]"`);
    }), D.join(`
`);
  }
  function ql(e) {
    const g = [], R = [], M = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map(), H = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map(), ge = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map();
  ...
  function _l(e) {
    const g = [], R = [], M = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map(), H = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map(), ge = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Map();
  ...
  function ua(e, g) {
    const R = Ut(g.args), M = Wt(e, R[0]), J = M ? Dl(e, M) : [
      0,
      0,
      0
    ];
  ...
  const Hl = 0.01;
  function jl(e) {
    const g = Bl(e), { entities: R, typeIndex: M } = g, J = [], D = [], U = /* @__PURE__ */ new Map();
    U.set("Hormigon", {
      E: 2132888792e-2,
      nu: 0.2,
      rho: 2.4
    ...
    function ge(te) {
      const q = fa(te.args, 2) || "", B = M.IFCRELASSOCIATESMATERIAL || [];
      for (const de of B) {
        const $e = R[de];
        if (!$e) continue;
        const Te = Ut($e.args);
        if ((Te[4] || Te[3] || "").includes(`#${te.id}`)) {
          const xe = Te[5] || Te[4] || "", De = Wt(R, xe);
          if (De) return T(De);
        }
      }
    ...
    function T(te) {
      ...
      if (q === "IFCMATERIALPROFILE") {
        const B = Ut(te.args), G = B[2] || B[1] || "", de = Wt(R, G);
        if (de) return T(de);
      }
    ...
    function Z(te, q, B, G) {
      ...
      for (const $e of de) {
        const Te = R[$e];
        if (!Te) continue;
        const Ve = Ut(Te.args), xe = Ve[5] || Ve[4] || "", De = Wt(R, xe);
        if (!De) continue;
        const He = ma(R, De), be = ge(Te);
  ...
  async function Yl(e, g) {
    ...
    const D = M.OpenModel(new Uint8Array(g)), U = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map(), H = {
      843113511: "Columna",
      753842376: "Viga",
      1529196076: "Losa",
      900683007: "Zapata",
    ...
    for (const [ye] of ba) {
      const ie = Gl(ye);
      try {
        const re = M.GetLineIDsWithType(D, ye);
        for (let te = 0; te < re.size(); te++) {
          const q = re.get(te);
          U.set(q, ie);
          let B = "";
          try {
            const G = M.GetLine(D, q);
    ...
    return M.StreamAllMeshes(D, (ye) => {
      const ie = U.get(ye.expressID) ?? "other", re = j.get(ie), te = ye.geometries;
      for (let q = 0; q < te.size(); q++) {
        const B = te.get(q), G = M.GetGeometry(D, B.geometryExpressID), de = M.GetVertexArray(G.GetVertexData(), G.GetVertexDataSize()), $e = M.GetIndexArray(G.GetIndexData(), G.GetIndexDataSize()), Te = new tn(), Ve = new Float32Array(de.length / 2), xe = new Float32Array(de.length / 2);
        ...
        Ee.applyMatrix4(De), Ee.userData.expressID = ye.expressID, Ee.userData.category = ie, re.add(Ee), ge.expandByObject(Ee), T++, G.delete();
      }
    }), M.CloseModel(D), {
      meshCount: T,
      bbox: ge,
  ...
  er = function(e) {
    ...
    let T = "", Z = {}, ye = null, ie = "", re = [], te = [], q = [], B = /* @__PURE__ */ new Set(), G = /* @__PURE__ */ new Set(), de = /* @__PURE__ */ new Set(), $e = /* @__PURE__ */ new Map(), Te = /* @__PURE__ */ new Map(), Ve = null, xe = [], De = 0.2, He = 2, be = 2, Ee = false, ze = 2, Je = "x", st = /* @__PURE__ */ new Set(), Ue = true, at = 0.15, dt = 2, yt = 2, zt = /* @__PURE__ */ new Set(), Ft = false, gt = "perimeter";
    const ut = () => ({
      b: 0.3,
      h: 0.4,
      profileIdx: 0,
    ...
    const Ke = {
      ...
      build(t) {
        ...
        return e.nodes.val = p, e.elements.val = I, e.nodeInputs.val = {
          ...
          sectionShapes: Ie
        }, B = A, G = z, $e = P, console.log(`Built: ${p.length} nodes, ${I.length} elements (${A.size} cols, ${z.size} beams, ${m.size} braces)`), console.log(`  Col: ${n}, Viga: ${o}, f'c=${l}${k ? `, braces=${k}` : ""}`), {
          nodes: p.length,
          elements: I.length
        };
      },
      addCol(t, n, o) {
        ...
        for (const y of d) {
          ...
          f.push([
            p,
            h
          ]), B.add(f.length - 1), $e.set(f.length - 1, y - 1), $++;
        }
...
`;
      ...
      frame(t, n, o = 0, l = 0) {
        ...
        for (let y = 0; y < a.length - 1; y++) for (let p = 0; p < s.length; p++) f(p) || (B.add(b.length), b.push([
          i[`${p},${y}`],
          i[`${p},${y + 1}`]
        ]));
...
Util:     cad.info()  cad.clear()  cad.help()
    ...
    function ms() {
      const t = le("Lx") || 15, n = le("Ly") || 10, o = le("meshSize") || 0.5, l = le("q") || -3, s = le("t") || 1, c = le("E") || 3e7, a = le("nu") || 0.3, r = c / (2 * (1 + a)), f = Le === 1 ? "Membrana" : Le === 2 ? "Kirchhoff" : "Mindlin", { nodes: i, elements: d, boundaryIndices: b } = hn({
        points: [
          [
            0,
            0,
    ...
    function gs() {
      const t = le("a") || 6, n = le("b") || 4, o = Math.round(le("nx") || 12), l = Math.round(le("ny") || 8), s = le("t") || 0.1, c = le("q") || -10, a = le("E") || 35e6, r = le("nu") || 0.15, i = {
        ...
        2: 1,
        3: 0
      }[Le] ?? 0, d = Ke.plateQ4(t, n, o, l, "simply-supported", c, s, a, r, i), b = a * s * s * s / (12 * (1 - r * r));
      let S = 0;
      ...
      for (const [fe, ee] of K) {
        ...
        for (let rt = 0; rt <= X; rt++) {
          ...
          for (let _t = 0; _t <= V; _t++) {
            ...
            let an = -1;
            for (let Vt = 0; Vt < m.length; Vt++) if (Math.abs(m[Vt][0] - Bt) < 1e-6 && Math.abs(m[Vt][1] - Sn) < 1e-6 && Math.abs(m[Vt][2] - Ct) < 1e-6) {
              an = Vt;
              break;
            }
    ...
    function Nn() {
      ...
      h.addBinding(I, "espesor", {
        ...
        var _a3, _b, _c;
        ((_a3 = m.target) == null ? void 0 : _a3.key) === "espesor" && (De = Mt(m.value), Re()), ((_b = m.target) == null ? void 0 : _b.key) === "subdivH" && (He = Math.round(m.value), Re()), ((_c = m.target) == null ? void 0 : _c.key) === "subdivW" && (be = Math.round(m.value), Re());
      });
      ...
      if (A > 0) {
        ...
        for (let u = 0; u < A; u++) for (let E = 0; E < k; E++) {
          const L = `wx_${u}_${E}`, O = xe.some((w) => w.dir === "x" && w.bay === u && w.axisIdx === E), W = {};
          W[L] = O;
          ...
          m.addBinding(W, L, {
            ...
            }) : xe = xe.filter((v) => !(v.dir === "x" && v.bay === u && v.axisIdx === E)), Re();
          });
        }
      }
      if (z > 0) {
        ...
        for (let u = 0; u < z; u++) for (let E = 0; E < P; E++) {
          const L = `wy_${u}_${E}`, O = xe.some((w) => w.dir === "y" && w.bay === u && w.axisIdx === E), W = {};
          W[L] = O;
          ...
          m.addBinding(W, L, {
            ...
            }) : xe = xe.filter((v) => !(v.dir === "y" && v.bay === u && v.axisIdx === E)), Re();
          });
        }
      }
      if (xe.length > 0) {
...
`);
    ...
    function Qn() {
      ...
      if (!t) return;
      const n = ((_a2 = Ce.frequencies) == null ? void 0 : _a2[ve]) || 1, o = Math.max(0.5, Math.min(3, n * 0.1)), l = performance.now(), s = ke.length, c = e.elements.rawVal, { extent: a } = yn(), r = Ae.querySelector("#cad3d-modal-scale"), f = r && parseFloat(r.value) || 5;
      let i = 0;
      for (let z = 0; z < s; z++) {
      ...
      b.scene.traverse((z) => {
        var _a3, _b;
        !S && z.isPoints && z.geometry && (S = z), !$ && z.isLineSegments && z.geometry && !z.name && ($ = z), !y && z.isMesh && ((_a3 = z.material) == null ? void 0 : _a3.transparent) && ((_b = z.material) == null ? void 0 : _b.opacity) < 0.5 && z.geometry && (y = z);
      });
      ...
      function A() {
        ...
        b.render(), he = requestAnimationFrame(A);
      }
      ...
      if ((T === "edificio" || T === "frame") && B.size > 0) {
        ...
        for (let p = 0; p < t.length; p++) {
          if (de.has(p)) {
            ...
            o.elasticities.set(p, E), o.poissonsRatios.set(p, L), o.thicknesses.set(p, De), o.shearModuli.set(p, E / (2 * (1 + L))), o.densities.set(p, 24 / 9.80665);
            continue;
          }
          if (zt.has(p)) {
            const E = 4700 * Math.sqrt(r / 1e3) * 1e3, L = 0.2;
          ...
          const h = B.has(p), I = $e.get(p) ?? 0, A = f[I] ?? f[0] ?? {
            bCol: 0.4,
            hCol: 0.4,
            dCol: 0.4
          };
    ...
    window.innerWidth <= 600 && Ae.classList.add("collapsed"), setTimeout(() => {
      ...
      (_a2 = Ae.querySelector("#cad3d-toggle")) == null ? void 0 : _a2.addEventListener("click", (x) => {
        ...
        x.addEventListener("click", (w) => {
          ...
          $n(v), Ae.querySelectorAll("[data-view]").forEach((F) => F.classList.remove("view-active")), x.classList.add("view-active");
        });
        ...
        var _a3;
        x.stopPropagation(), nn && (nn = false, An()), pn && io(), Yt = !Yt, (_a3 = Ae.querySelector("#cad3d-select")) == null ? void 0 : _a3.classList.toggle("inspect-active", Yt);
        const v = Ze();
        v && (v.controls.enabled = !Yt), Yt || ro();
      }), (_e2 = Ae.querySelector("#cad3d-draw")) == null ? void 0 : _e2.addEventListener("click", (x) => {
        var _a3;
        x.stopPropagation(), nn && (nn = false, An()), Yt && ro(), pn = !pn, (_a3 = Ae.querySelector("#cad3d-draw")) == null ? void 0 : _a3.classList.toggle("inspect-active", pn), pn ? La() : io();
      }), (_f = Ae.querySelector("#cad3d-inspect")) == null ? void 0 : _f.addEventListener("click", (x) => {
        var _a3;
        x.stopPropagation(), Yt && ro(), pn && io(), nn = !nn, (_a3 = Ae.querySelector("#cad3d-inspect")) == null ? void 0 : _a3.classList.toggle("inspect-active", nn), nn || An();
...
`);
      ...
      y && (y.value = R, y.addEventListener("change", (x) => {
        ...
        x.addEventListener("click", (w) => {
          w.stopPropagation();
          const v = x.dataset.preset, F = D[v];
          F && (g = F.force, R = F.length, J = F.stress, M = Rn(g, R), $ && ($.value = g), y && (y.value = R), Ae.querySelectorAll("[data-preset]").forEach((X) => {
        ...
        x.stopPropagation(), ea(async () => {
          const { openCalcPanel: w } = await import("./calcPanel-DCiVpMF7.js").then(async (m2) => {
            await m2.__tla;
            return m2;
          });
          return {
        ...
        var _a3, _b2;
        x.stopPropagation(), qe = !qe, (_a3 = Ae.querySelector("#cad3d-modal")) == null ? void 0 : _a3.classList.toggle("active", qe);
      ...
      function p() {
        ...
        if (!x || !(Ce == null ? void 0 : Ce.frequencies)) return;
        const w = Ce.frequencies[ve], v = w > 0 ? 1 / w : 0, F = [
          0,
          0,
          0,
          0,
        ...
        x.textContent = `Modo ${ve + 1} \u2014 ${w.toFixed(2)} Hz \u2014 T=${v.toFixed(3)}s \u2014 \u03A3Ux=${(F[0] * 100).toFixed(1)}% \u03A3Uy=${(F[1] * 100).toFixed(1)}% \u03A3Rz=${(F[5] * 100).toFixed(1)}%`;
      }
      (_o2 = Ae.querySelector("#cad3d-mode-prev")) == null ? void 0 : _o2.addEventListener("click", (x) => {
        if (x.stopPropagation(), !(Ce == null ? void 0 : Ce.modeShapes)) return;
        ve = (ve - 1 + Ce.modeShapes.length) % Ce.modeShapes.length;
        const w = Ce.modeShapes[ve], { extent: v } = yn();
        let F = 0;
      ...
      const I = Ae.querySelector("#cad3d-cli-toggle"), A = Ae.querySelector("#cad3d-cli-panel"), z = Ae.querySelector("#cad3d-cli-output"), P = Ae.querySelector("#cad3d-cmd"), k = [];
      let m = -1;
...
`);
      ...
      Ae.addEventListener("mousedown", (x) => {
        ...
        Ae.style.bottom = "unset", E = x.clientX, L = x.clientY, O = v.left, W = v.top, x.preventDefault();
      }), window.addEventListener("mousemove", (x) => {
        u && (x.preventDefault(), Ae.style.left = O + (x.clientX - E) + "px", Ae.style.top = W + (x.clientY - L) + "px");
    ...
    function No() {
      ...
      const n = (c, a, r) => {
        ...
        return f.textContent = c, f.dataset.view = a, f.title = r, f.style.cssText = "min-width:22px;padding:1px 5px;font-weight:bold", f.addEventListener("click", (i) => {
          ...
          Ae.querySelectorAll("[data-view]").forEach((b) => b.classList.remove("view-active")), d ? ($n("3d"), (_a2 = Ae.querySelector('[data-view="3d"]')) == null ? void 0 : _a2.classList.add("view-active")) : ($n(a), f.classList.add("view-active"));
        }), f;
    ...
    function qo() {
      ...
      const o = (s, c, a) => {
        ...
        return r.textContent = s, r.dataset.view = c, r.title = a, r.style.cssText = "min-width:22px;padding:1px 5px;font-weight:bold", r.addEventListener("click", (f) => {
          ...
          Ae.querySelectorAll("[data-view]").forEach((d) => d.classList.remove("view-active")), i ? ($n("3d"), (_a3 = Ae.querySelector('[data-view="3d"]')) == null ? void 0 : _a3.classList.add("view-active")) : ($n(c), r.classList.add("view-active"));
        }), r;
...
${i.join(", ")}`);
    ...
    function za(t) {
      ...
      for (const [c, a] of s) {
        ...
        d.computeLineDistances(), d.renderOrder = 9990, n.scene.add(d), Bo.push(d);
      }
      n.render();
    }
    function Ho() {
    ...
    function Fa(t, n, o, l, s, c, a) {
      ...
      <div style="text-align:left;margin-bottom:6px;color:var(--fem-eq-sub)">
        ${C("A", "s")} = ${Be("5", "6")} \xB7 ${C("A")} = <span class="highlight">${Me(r)}</span>
        &nbsp;&nbsp; \u03C6<sub>z</sub> = ${Be("12\xB7" + C("E") + "\xB7" + C("I", "z"), C("G") + "\xB7" + C("A", "s") + "\xB7" + C("L") + "\xB2")} = <span class="highlight">${Me(i)}</span>
      ...
      <div>${C("t", "z")} = ${Be("12\xB7" + C("E") + "\xB7" + C("I", "z"), C("L") + "\xB3\xB7(1+\u03C6<sub>z</sub>)")} = <span class="highlight">${Me($)}</span> &nbsp;(cortante)</div>
      <div>${C("b", "z")} = ${Be("6\xB7" + C("E") + "\xB7" + C("I", "z"), C("L") + "\xB2\xB7(1+\u03C6<sub>z</sub>)")} = <span class="highlight">${Me(y)}</span> &nbsp;(acoplamiento)</div>
      <div>${C("k", "z")} = ${Be("4\xB7" + C("E") + "\xB7" + C("I", "z") + "\xB7(1+\u03C6/4)", C("L") + "\xB7(1+\u03C6<sub>z</sub>)")} = <span class="highlight">${Me(p)}</span> &nbsp;(flexi\xF3n diagonal)</div>
      <div>${C("a", "z")} = ${Be("2\xB7" + C("E") + "\xB7" + C("I", "z") + "\xB7(1\u2212\u03C6/2)", C("L") + "\xB7(1+\u03C6<sub>z</sub>)")} = <span class="highlight">${Me(h)}</span> &nbsp;(flexi\xF3n off-diag)</div>
      ` : `
      <div style="text-align:left;margin-bottom:4px"><strong style="color:var(--fem-section-title)">Coeficientes de rigidez:</strong></div>
      `}
      <div>${Be(C("E") + "\xB7" + C("A"), C("L"))} = <span class="highlight">${Me(b)}</span> &nbsp;(axial)</div>
      <div>${Be(C("G") + "\xB7" + C("J"), C("L"))} = <span class="highlight">${Me(S)}</span> &nbsp;(torsi\xF3n)</div>
      ${I ? "" : `
      <div>${Be("12\xB7" + C("E") + "\xB7" + C("I", "z"), C("L") + "\xB3")} = <span class="highlight">${Me($)}</span></div>
      <div>${Be("4\xB7" + C("E") + "\xB7" + C("I", "z"), C("L"))} = <span class="highlight">${Me(p)}</span></div>
      `}
    </div>
    <div class="fem-eq">
    ...
    function Ra(t) {
      if (t.length === 2) {
        ...
        <div>${C("l")} = cos(\u03B1) = ${Be("\u0394x", C("L"))} = ${Be(Me(o[0]), Me(l))} = <span class="highlight">${Me(s)}</span></div>
        <div>${C("m")} = cos(\u03B2) = ${Be("\u0394y", C("L"))} = ${Be(Me(o[1]), Me(l))} = <span class="highlight">${Me(c)}</span></div>
        <div>${C("n")} = cos(\u03B3) = ${Be("\u0394z", C("L"))} = ${Be(Me(o[2]), Me(l))} = <span class="highlight">${Me(a)}</span></div>
      </div>
      <div class="fem-eq">
    ...
    function Ns() {
      const t = "0", n = Be(C("EA"), C("L")), o = Be("\u2212" + C("EA"), C("L")), l = Be("12" + C("EI", "z"), C("L") + "\xB3"), s = Be("\u221212" + C("EI", "z"), C("L") + "\xB3"), c = Be("12" + C("EI", "y"), C("L") + "\xB3"), a = Be("\u221212" + C("EI", "y"), C("L") + "\xB3"), r = Be("6" + C("EI", "z"), C("L") + "\xB2"), f = Be("\u22126" + C("EI", "z"), C("L") + "\xB2"), i = Be("6" + C("EI", "y"), C("L") + "\xB2"), d = Be("\u22126" + C("EI", "y"), C("L") + "\xB2"), b = Be(C("GJ"), C("L")), S = Be("\u2212" + C("GJ"), C("L")), $ = Be("4" + C("EI", "z"), C("L")), y = Be("2" + C("EI", "z"), C("L")), p = Be("4" + C("EI", "y"), C("L")), h = Be("2" + C("EI", "y"), C("L")), I = '<span style="color:var(--fem-eq-dots);font-style:italic">sym</span>', A = [
        "P\u2081",
        "P\u2082",
        "P\u2083",
        "P\u2084",
    ...
    function qs(t) {
      ...
      if (c) {
        ...
        `${l.length}${l.join(", ")}${Me(m)}${Me(L)}${Me(u)}${Me(E)}`, O && (S = `<div class="fem-eq eq-box">
          ...
          </span> = ${Be(Me(m), "1\u2212" + Me(E) + "\xB2")} = <span class="highlight">${Me(W)}</span></div>
          ...
          <div>${C("D", "b")} = ${Be(C("E") + "\xB7" + C("t") + "\xB3", "12\xB7(1\u2212\u03BD\xB2)")} = <span class="highlight">${Me(m * u ** 3 / (12 * (1 - E ** 2)))}</span></div>
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        try {
          const { cyclicPushover: h } = await ea(async () => {
            const { cyclicPushover: A } = await import("./cyclicPushoverCpp-Ca848qdR.js").then(async (m) => {
              await m.__tla;
              return m;
            });
            return {
          ...
          S.textContent = `Completado: ${I.nSteps} pasos`, Da(t.querySelector("#pushover-canvas"), I.displacements, I.forces, `Pushover: ${o * 100}x${l * 100}cm, f'c=${s / 1e3}MPa, Fy=${c / 1e3}MPa`);
        } catch (h) {
    ...
    setTimeout(() => {
      ...
      } else Co(), Ae.querySelector("#cad3d-mode-prev").style.display = "none", Ae.querySelector("#cad3d-mode-next").style.display = "none", Ae.querySelector("#cad3d-mode-label").style.display = "none", T && T !== "placa-q4" && T !== "placa-3q" && Re(), setTimeout(() => {
        var _a3;
        const o = Ze();
