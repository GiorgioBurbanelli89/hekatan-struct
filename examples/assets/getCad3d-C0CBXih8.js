...
`);
    ...
    function Qn() {
      ...
      if (!t) return;
      const n = ((_a2 = Ae.frequencies) == null ? void 0 : _a2[he]) || 1, o = Math.max(0.5, Math.min(3, n * 0.1)), l = performance.now(), s = ke.length, c = e.elements.rawVal, { extent: a } = yn(), r = Le.querySelector("#cad3d-modal-scale"), f = r && parseFloat(r.value) || 5;
      let i = 0;
      for (let z = 0; z < s; z++) {
