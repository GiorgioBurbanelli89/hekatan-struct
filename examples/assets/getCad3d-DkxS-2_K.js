...
import { _ as Us, p as wn, m as Zs, d as Ct, s as Qs, __tla as __tla_0 } from "./plateQ4Cpp-CArWqXeL.js";
import { v as So, P as No, g as ea, a as ta, o as oa } from "./theme-CzzIlc4y.js";
import { V as ke, P as so, R as gs, b as xs, B as ao, c as na, d as Sn, e as Fo, f as sa, S as aa, M as la, g as ia, F as po, a as qo, L as Ro, h as ra, G as ca, A as Ho, i as En, T as kn, j as Bo, k as Do, C as da, l as pa } from "./Text-Cin90tvN.js";
import { g as Vo, b as Xo, a as wo } from "./analyze-B0bulnNq.js";
import { g as Xt, __tla as __tla_1 } from "./getMesh-Ch3239Ot.js";
import { n as mo, s as Kt, m as Ot, t as Fn } from "./pureFunctionsAny.generated-BHh0zpCc.js";
let $s, ba, Da;
let __tla = Promise.all([
  ...
  function uo(e, g) {
    const j = Ln.find((W) => W.id === e), z = Eo.find((W) => W.id === g), Y = j.toKN, R = z.toM, G = (W, me, I) => I / (Math.pow(Y, W) * Math.pow(R, me));
    let D, H;
    switch (e) {
      case "kN":
        D = 10, H = [
...
<tr style="color:#ff0; border-bottom:1px solid #ff03">
  ...
  <th style="padding:2px 5px; color:#0ff">\u03A3Rz</th></tr>`, z.frequencies.forEach((H, W) => {
        var _a2;
        const me = H > 0 ? 1 / H : 0, I = H * 2 * Math.PI, K = ((_a2 = z.massParticipation) == null ? void 0 : _a2[W]) || [
          0,
          0,
          0,
          0,
        ...
        for (let ge = 0; ge < 6; ge++) G[ge] += K[ge];
  ...
  <td style="padding:2px 6px; text-align:right">${I.toFixed(2)}</td>`;
        for (let ge = 0; ge < 6; ge++) {
          const re = (K[ge] * 100).toFixed(1), X = K[ge] > 0.5 ? "#f00" : K[ge] > 0.1 ? "#ff0" : "#0f0";
          D += `<td style="padding:2px 5px; text-align:right; color:${X}">${re}%</td>`;
        }
  ...
  <td style="padding:2px 5px; text-align:right; color:#0ff">${(G[5] * 100).toFixed(1)}%</td></tr>`;
      ...
      (_a = e.querySelector("#modal-minimize")) == null ? void 0 : _a.addEventListener("click", () => {
        ...
        z.frequencies.forEach((K, ge) => {
          var _a2;
          const re = K > 0 ? 1 / K : 0, X = K * 2 * Math.PI, Q = ((_a2 = z.massParticipation) == null ? void 0 : _a2[ge]) || [
            0,
            0,
            0,
            0,
          ...
          for (let Ie = 0; Ie < 6; Ie++) me[Ie] += Q[Ie];
          const le = Q.map((Ie) => ((Ie * 100).toFixed(1) + "%").padStart(6)).join(" ");
          H.push(`${String(ge + 1).padStart(4)}  ${K.toFixed(4).padStart(9)}  ${re.toFixed(4).padStart(9)}  ${X.toFixed(2).padStart(9)}  ${le}  ${(me[0] * 100).toFixed(1).padStart(5)}%  ${(me[1] * 100).toFixed(1).padStart(5)}%  ${(me[5] * 100).toFixed(1).padStart(5)}%`);
...
`));
  ...
  const ue = 64516e-8, T = 416231e-12, N = 0.0254, lo = [
    {
      name: "W6x9",
      type: "W",
      A: 2.68 * ue,
  ...
  function ha(e) {
    ...
    const { nodes: g, elements: j, elementInputs: z, nodeInputs: Y, deformOutputs: R } = e, G = g.length * 6, D = j.length, H = j.filter((X) => X.length === 2).length, W = j.filter((X) => X.length >= 3).length, me = document.createElement("div");
    me.className = "rpt-overlay";
    let I = "";
    I += '<button class="rpt-close" id="rpt-close">\u2715 Close</button>', I += "<h1>Finite Element Analysis \u2014 Step-by-Step Report</h1>", I += '<div class="rpt-subtitle">Complete FEM derivation from element formulation to final results</div>', I += '<hr class="rpt-sep"/>', I += "<h2>1. Input Data</h2>", I += '<table class="rpt-info"><tbody>', I += `<tr><td>Number of nodes</td><td class="val">${g.length}</td></tr>`, I += `<tr><td>Number of elements</td><td class="val">${D} (${H} frames, ${W} shells)</td></tr>`, I += '<tr><td>DOFs per node</td><td class="val">6 (u<sub>x</sub>, u<sub>y</sub>, u<sub>z</sub>, \u03B8<sub>x</sub>, \u03B8<sub>y</sub>, \u03B8<sub>z</sub>)</td></tr>', I += `<tr><td>Total DOFs</td><td class="val">${G}</td></tr>`, I += "</tbody></table>", I += "<h3>1.1 Node Coordinates</h3>", I += '<table class="rpt-data"><thead><tr><th>Node</th><th>x</th><th>y</th><th>z</th></tr></thead><tbody>', g.forEach((X, Q) => {
      I += `<tr><td>${Q}</td><td>${Ge(X[0])}</td><td>${Ge(X[1])}</td><td>${Ge(X[2])}</td></tr>`;
    }), I += "</tbody></table>", I += "<h3>1.2 Element Connectivity</h3>", I += '<table class="rpt-data"><thead><tr><th>Elem</th><th>Type</th><th>Nodes</th><th>L</th><th>E</th><th>A</th><th>I<sub>z</sub></th><th>I<sub>y</sub></th></tr></thead><tbody>', j.forEach((X, Q) => {
      var _a2, _b2, _c2, _d2;
      const le = X.length === 2, Ie = X.map((be) => g[be]), Ce = le ? mo(Kt(Ie[1], Ie[0])) : 0, Pe = ((_a2 = z.elasticities) == null ? void 0 : _a2.get(Q)) ?? 0, st = ((_b2 = z.areas) == null ? void 0 : _b2.get(Q)) ?? 0, He = ((_c2 = z.momentsOfInertiaZ) == null ? void 0 : _c2.get(Q)) ?? 0, ut = ((_d2 = z.momentsOfInertiaY) == null ? void 0 : _d2.get(Q)) ?? 0;
      I += `<tr><td>${Q}</td><td>${le ? "Frame" : "Shell"}</td><td>${X.join(" \u2192 ")}</td>`, I += `<td>${Ge(Ce)}</td><td>${Ge(Pe)}</td><td>${Ge(st)}</td><td>${Ge(He)}</td><td>${Ge(ut)}</td></tr>`;
    ...
    for (let X = 0; X < D; X++) {
      const Q = j[X], le = Q.map((zt) => g[zt]);
      if (!(Q.length === 2)) continue;
      const Ce = mo(Kt(le[1], le[0])), Pe = ((_a = z.elasticities) == null ? void 0 : _a.get(X)) ?? 0, st = ((_b = z.areas) == null ? void 0 : _b.get(X)) ?? 0, He = ((_c = z.momentsOfInertiaZ) == null ? void 0 : _c.get(X)) ?? 0, ut = ((_d = z.momentsOfInertiaY) == null ? void 0 : _d.get(X)) ?? 0, be = ((_e = z.shearModuli) == null ? void 0 : _e.get(X)) ?? 0, Le = ((_f = z.torsionalConstants) == null ? void 0 : _f.get(X)) ?? 0;
      let ve = null, je = null, Ke = null;
      try {
        ve = Vo(le, z, X), je = Xo(le), Ke = Ot(Fn(je), Ot(ve, je));
      } catch {
        continue;
      }
      const Re = Kt(le[1], le[0]), Ue = Re[0] / Ce, Ze = Re[1] / Ce, ct = Re[2] / Ce;
      I += '<div class="rpt-elem-block">', I += `<h3 class="rpt-elem-title" data-toggle="elem${X}">\u25B6 Element ${X} \u2014 Nodes ${Q[0]} \u2192 ${Q[1]}, L = ${Ge(Ce)}</h3>`, I += `<div id="rpt-elem${X}" class="rpt-elem-body" style="display:none">`, I += "<h4>Properties (numerical substitution)</h4>", I += '<div class="rpt-eq-small">', I += `E = ${Ge(Pe)} &nbsp;&nbsp; A = ${Ge(st)} &nbsp;&nbsp; I<sub>z</sub> = ${Ge(He)} &nbsp;&nbsp; I<sub>y</sub> = ${Ge(ut)} &nbsp;&nbsp; G = ${Ge(be)} &nbsp;&nbsp; J = ${Ge(Le)}<br/>`, I += `EA/L = ${Ge(Pe)}\xB7${Ge(st)}/${Ge(Ce)} = <b>${Ge(Pe * st / Ce)}</b><br/>`, I += `12EI<sub>z</sub>/L\xB3 = 12\xB7${Ge(Pe)}\xB7${Ge(He)}/${Ge(Ce)}\xB3 = <b>${Ge(12 * Pe * He / Ce ** 3)}</b><br/>`, I += `12EI<sub>y</sub>/L\xB3 = 12\xB7${Ge(Pe)}\xB7${Ge(ut)}/${Ge(Ce)}\xB3 = <b>${Ge(12 * Pe * ut / Ce ** 3)}</b><br/>`, I += `GJ/L = ${Ge(be)}\xB7${Ge(Le)}/${Ge(Ce)} = <b>${Ge(be * Le / Ce)}</b>`, I += "</div>", I += "<h4>Direction cosines</h4>", I += `<div class="rpt-eq-small">l = ${Go(Ue)}, m = ${Go(Ze)}, n = ${Go(ct)}, D = ${Go(Math.sqrt(Ue ** 2 + Ze ** 2))}</div>`, I += "<h4>K<sub>local</sub> (12\xD712)</h4>", I += In(ve, 12), I += "<h4>T \u2014 Transformation (12\xD712)</h4>", I += In(je, 12), I += "<h4>K<sub>global</sub> = T\u1D40 \xB7 K<sub>local</sub> \xB7 T</h4>", I += In(Ke, 12), I += "<h4>Assembly</h4>", I += `<div class="rpt-eq-small">Global DOFs: node ${Q[0]} \u2192 [${Q[0] * 6}..${Q[0] * 6 + 5}], node ${Q[1]} \u2192 [${Q[1] * 6}..${Q[1] * 6 + 5}]</div>`, I += "</div></div>";
    }
    ...
    if (I += "<h3>5.1 Supports (fixed DOFs)</h3>", Y.supports && Y.supports.size > 0) {
      ...
      for (const X of K) I += `<th>${X}</th>`;
      I += "</tr></thead><tbody>", Y.supports.forEach((X, Q) => {
        I += `<tr><td>${Q}</td>`, X.forEach((le, Ie) => {
          le && ge.push(Q * 6 + Ie), I += `<td class="${le ? "fixed" : ""}">${le ? "Fixed" : "Free"}</td>`;
        }), I += "</tr>";
      }), I += "</tbody></table>";
    }
    if (I += `<div class="rpt-eq-small">Fixed DOFs: [${ge.join(", ")}] \u2192 ${ge.length} constraints<br/>`, I += `Free DOFs: ${G} \u2212 ${ge.length} = <b>${G - ge.length}</b></div>`, I += "<h3>5.2 Applied Loads</h3>", Y.loads && Y.loads.size > 0) {
      I += '<table class="rpt-data"><thead><tr><th>Node</th>';
      const X = [
        "F<sub>x</sub>",
        "F<sub>y</sub>",
      ...
      for (const Q of X) I += `<th>${Q}</th>`;
      I += "</tr></thead><tbody>", Y.loads.forEach((Q, le) => {
        I += `<tr><td>${le}</td>`, Q.forEach((Ie) => {
          const Ce = Math.abs(Ie) > 1e-10;
          I += `<td class="${Ce ? "nz" : ""}">${Ce ? Ge(Ie) : "0"}</td>`;
        }), I += "</tr>";
      }), I += "</tbody></table>";
    }
    if (I += "<h2>6. Solution</h2>", I += "<p>After removing fixed DOFs, the reduced system is:</p>", I += '<div class="rpt-eq rpt-eq-highlight">K<sub>free</sub> \xB7 u<sub>free</sub> = F<sub>free</sub></div>', I += "<p>Solved using LU decomposition with partial pivoting (sparse matrix).</p>", I += "<h3>6.1 Nodal Displacements</h3>", R == null ? void 0 : R.deformations) {
      I += '<table class="rpt-data"><thead><tr><th>Node</th>';
      for (const X of K) I += `<th>${X}</th>`;
      I += "</tr></thead><tbody>", R.deformations.forEach((X, Q) => {
        I += `<tr><td>${Q}</td>`, X.forEach((le) => {
          const Ie = Math.abs(le) > 1e-10;
          I += `<td class="${Ie ? "nz" : ""}">${Ge(le, 6)}</td>`;
        }), I += "</tr>";
      }), I += "</tbody></table>";
    }
    if (I += "<h3>6.2 Reactions</h3>", I += '<div class="rpt-eq">R = K<sub>total</sub> \xB7 u (extract at fixed DOFs)</div>', R == null ? void 0 : R.reactions) {
      I += '<table class="rpt-data"><thead><tr><th>Node</th>';
      for (const X of K) I += `<th>${X}</th>`;
      I += "</tr></thead><tbody>", R.reactions.forEach((X, Q) => {
        I += `<tr><td>${Q}</td>`, X.forEach((le) => {
          const Ie = Math.abs(le) > 1e-10;
          I += `<td class="${Ie ? "nz-react" : ""}">${Ie ? Ge(le, 4) : "0"}</td>`;
        }), I += "</tr>";
      }), I += "</tbody></table>";
    }
    if (I += "<h2>7. Internal Forces</h2>", I += "<p>For each element, transform global displacements to local and multiply by K<sub>local</sub>:</p>", I += '<div class="rpt-eq">u<sub>local</sub> = T \xB7 u<sub>global</sub></div>', I += '<div class="rpt-eq rpt-eq-highlight">f<sub>local</sub> = K<sub>local</sub> \xB7 u<sub>local</sub></div>', R == null ? void 0 : R.deformations) {
      ...
      for (const Q of X) I += `<th>${Q}<sub>i</sub></th>`;
      for (const Q of X) I += `<th>${Q}<sub>j</sub></th>`;
      I += "</tr></thead><tbody>";
      for (let Q = 0; Q < D; Q++) {
        const le = j[Q];
        if (le.length !== 2) continue;
        const Ie = le.map((Ce) => g[Ce]);
        try {
          const Ce = Vo(Ie, z, Q), Pe = Xo(Ie), st = [];
          for (const be of le) {
            const Le = ((_g = R.deformations) == null ? void 0 : _g.get(be)) || [
              0,
              0,
              0,
              0,
          ...
          const He = Ot(Pe, st), ut = Ot(Ce, He);
          I += `<tr><td>${Q}</td><td>${le.join("\u2192")}</td>`;
          for (let be = 0; be < 12; be++) {
            const Le = Math.abs(ut[be]) > 1e-10;
            I += `<td class="${Le ? "nz" : ""}">${Ge(ut[be], 2)}</td>`;
          }
          I += "</tr>";
        } catch {
        }
  ...
  `;
    return me.innerHTML = re + I, (_h = me.querySelector("#rpt-close")) == null ? void 0 : _h.addEventListener("click", () => me.remove()), me.querySelectorAll("[data-toggle]").forEach((X) => {
      X.addEventListener("click", () => {
        const Q = X.dataset.toggle, le = me.querySelector(`#rpt-${Q}`);
        if (le) {
          const Ie = le.style.display !== "none";
          le.style.display = Ie ? "none" : "", X.textContent = X.textContent.replace(/^[▼▶]/, Ie ? "\u25B6" : "\u25BC");
        }
      });
    }), me;
  }
  ...
  function In(e, g) {
    ...
    for (let Y = 0; Y < j; Y++) {
      z += "<tr>";
      for (let R = 0; R < j; R++) {
        const G = ((_a = e[Y]) == null ? void 0 : _a[R]) ?? 0, D = Math.abs(G) < 1e-10;
        z += `<td class="${D ? "z" : ""} ${Y === R && !D ? "diag" : ""}">${D ? "0" : ga(G)}</td>`;
      }
      z += "</tr>";
    }
  ...
  function xa() {
    ...
    for (const H of G) {
      ...
      for (let ge = 0; ge <= 80; ge++) {
        const re = ge / 80, X = 30 + re * 540, Q = 180 / 2 - H.fn(re) * 60;
        W += (ge === 0 ? "M" : "L") + `${X.toFixed(1)},${Q.toFixed(1)}`;
      }
      D += `<path d="${W}" fill="none" stroke="${H.color}" stroke-width="2.5"/>`;
      const me = 0.75, I = 30 + me * 540 + 8, K = 180 / 2 - H.fn(me) * 60 - 6;
      D += `<text x="${I}" y="${K}" fill="${H.color}" font-size="11" font-weight="bold" font-family="sans-serif">${H.name}</text>`;
    }
    return D += "</svg>", D;
  }
  function va(e, g) {
    ...
    for (let G = 0; G < z; G++) Y += `<td style="color:#003366;font-weight:bold;font-size:7px">${G}</td>`;
    Y += "</tr>";
    const R = Array.from({
      length: z
    }, () => Array(z).fill(0));
    for (let G = 0; G < e.length; G++) {
      ...
      for (const H of D) for (const W of D) for (let me = 0; me < 6; me++) for (let I = 0; I < 6; I++) {
        const K = H + me, ge = W + I;
        K < z && ge < z && R[K][ge]++;
      }
    }
    for (let G = 0; G < z; G++) {
      Y += `<tr><td style="color:#003366;font-weight:bold;font-size:7px">${G}</td>`;
      for (let D = 0; D < z; D++) {
        const H = R[G][D], W = H === 0 ? "#fff" : H === 1 ? "#e8f0fe" : H === 2 ? "#c6dcf5" : "#a0c4e8", me = H === 0 ? "" : H.toString();
        Y += `<td style="background:${W};color:#003366">${me}</td>`;
      }
      Y += "</tr>";
    }
  ...
  function $a(e, g, j, z, Y, R) {
    ...
    const G = j[e], D = G.map((je) => g[je]), H = G.length === 2, W = H ? mo(Kt(D[1], D[0])) : 0, me = ((_a = z.elasticities) == null ? void 0 : _a.get(e)) ?? 0, I = ((_b = z.areas) == null ? void 0 : _b.get(e)) ?? 0, K = ((_c = z.momentsOfInertiaZ) == null ? void 0 : _c.get(e)) ?? 0, ge = ((_d = z.momentsOfInertiaY) == null ? void 0 : _d.get(e)) ?? 0, re = ((_e = z.shearModuli) == null ? void 0 : _e.get(e)) ?? 0, X = ((_f = z.torsionalConstants) == null ? void 0 : _f.get(e)) ?? 0;
    let Q = null, le = null, Ie = null;
    try {
      Q = Vo(D, z, e), le = Xo(D), Ie = Ot(Fn(le), Ot(Q, le));
    } catch {
    }
    const Ce = H ? Kt(D[1], D[0]) : [
      0,
      0,
      0
    ], Pe = W > 0 ? Ce[0] / W : 0, st = W > 0 ? Ce[1] / W : 0, He = W > 0 ? Ce[2] / W : 0, ut = Math.sqrt(Pe ** 2 + st ** 2), be = [];
    if ((Y == null ? void 0 : Y.deformations) && H) for (const je of G) {
      const Ke = Y.deformations.get(je) || [
        0,
        0,
        0,
        0,
  ...
  function Ma(e, g, j, z, Y, R) {
    var _a, _b;
    const G = $a(e, g, j, z, Y, R), D = document.createElement("div");
  ...
  `, D.querySelectorAll(".er-tab").forEach((H) => {
      H.addEventListener("click", () => {
        D.querySelectorAll(".er-tab").forEach((me) => me.classList.remove("active")), H.classList.add("active");
        const W = H.dataset.tab;
        D.querySelectorAll(".er-body").forEach((me) => me.style.display = "none"), D.querySelector(`#er-body-${W}`).style.display = "";
      });
      ...
      H && (H.innerHTML = ys(G)), setTimeout(() => {
        ...
        W.addEventListener("click", () => {
          const me = W.dataset.toggle, I = D.querySelector(`#er-${me}`);
  ...
  function wa(e) {
    let g = "";
    if (g += '<div class="er-section-title">1. Propiedades</div>', g += '<table class="er-props">', g += `<tr><td>E</td><td>${Ae(e.E)}</td><td>A</td><td>${Ae(e.A)}</td></tr>`, g += `<tr><td>I<sub>z</sub></td><td>${Ae(e.Iz)}</td><td>I<sub>y</sub></td><td>${Ae(e.Iy)}</td></tr>`, g += `<tr><td>G</td><td>${Ae(e.G)}</td><td>J</td><td>${Ae(e.J)}</td></tr>`, g += "</table>", e.kLocal && (g += `<div class="er-section-title">2. K<sub>local</sub> (${e.kLocal.length}\xD7${e.kLocal.length})</div>`, g += Co(e.kLocal)), e.T && (g += '<div class="er-section-title">3. T \u2014 Transformaci\xF3n</div>', g += Co(e.T)), e.kGlobal && (g += '<div class="er-section-title">4. K<sub>global</sub> = T<sup>T</sup>\xB7K\xB7T</div>', g += Co(e.kGlobal)), g += '<div class="er-section-title">5. Desplazamientos</div>', e.uGlobal.length > 0) {
      const j = [
        "u<sub>x</sub>",
        "u<sub>y</sub>",
        "u<sub>z</sub>",
      ...
      for (let z = 0; z < e.elem.length; z++) {
        ...
        for (let Y = 0; Y < 6; Y++) {
          ...
          g += `${j[Y]}=<span class="${Math.abs(R) > 1e-10 ? "nz" : ""}">${Ae(R, 6)}</span> `;
        }
        g += "</div>";
      }
    ...
    if (g += '<div class="er-section-title">6. Fuerzas internas</div>', e.fLocal.length > 0 && e.fLocal.some((j) => j !== 0)) {
      ...
      for (let z = 0; z < 6; z++) g += `<td class="${Math.abs(e.fLocal[z]) > 1e-10 ? "nz" : ""}">${Ae(e.fLocal[z], 3)}</td>`;
      g += "</tr><tr><td>Nodo j</td>";
      for (let z = 6; z < 12; z++) g += `<td class="${Math.abs(e.fLocal[z]) > 1e-10 ? "nz" : ""}">${Ae(e.fLocal[z], 3)}</td>`;
      g += "</tr></table>";
    } else g += '<div class="er-sub">Sin an\xE1lisis</div>';
    return g;
  }
  function ys(e) {
    ...
    if (g += `<div class="er-eq">${z(`\\text{Nodo } ${e.elem[0]} \\rightarrow \\text{DOFs } [${H} \\ldots ${H + 5}]`)}</div>`, g += `<div class="er-eq">${z(`\\text{Nodo } ${e.elem[1]} \\rightarrow \\text{DOFs } [${W} \\ldots ${W + 5}]`)}</div>`, g += `<div class="er-eq">${z("\\mathbf{K}_{total}[\\text{DOFs}_i, \\text{DOFs}_j] \\mathrel{+}= \\mathbf{K}_{global}[i, j]")}</div>`, g += '<div class="er-section-title">9. Recuperacion de fuerzas internas</div>', g += `<div class="er-eq">${z("\\mathbf{u}_{local} = \\mathbf{T} \\cdot \\mathbf{u}_{global}")}</div>`, g += `<div class="er-eq er-eq-main">${z("\\mathbf{f}_{local} = \\mathbf{K}_{local} \\cdot \\mathbf{u}_{local}")}</div>`, e.fLocal.length > 0 && e.fLocal.some((me) => me !== 0)) {
      ...
      g += '<table class="er-forces"><tr><th></th>';
      for (const I of me) g += `<th>${I}</th>`;
      g += `</tr><tr><td>i (${e.elem[0]})</td>`;
      for (let I = 0; I < 6; I++) g += `<td class="${Math.abs(e.fLocal[I]) > 1e-10 ? "nz" : ""}">${Ae(e.fLocal[I], 3)}</td>`;
      g += `</tr><tr><td>j (${e.elem[1]})</td>`;
      for (let I = 6; I < 12; I++) g += `<td class="${Math.abs(e.fLocal[I]) > 1e-10 ? "nz" : ""}">${Ae(e.fLocal[I], 3)}</td>`;
      g += "</tr></table>";
    }
    return g;
  }
  function Sa(e) {
    let g = "";
    if (g += `<div class="er-section-title">Resumen \u2014 Elemento ${e.elemIdx}</div>`, g += '<table class="er-props">', g += `<tr><td>Tipo</td><td>${e.isFrame ? "Frame (Euler-Bernoulli)" : "Shell"}</td></tr>`, g += `<tr><td>Nodos</td><td>${e.elem.join(" \u2192 ")}</td></tr>`, g += `<tr><td>Longitud</td><td><b>${Ae(e.L)}</b></td></tr>`, g += `<tr><td>E</td><td>${Ae(e.E)}</td></tr>`, g += `<tr><td>A</td><td>${Ae(e.A)}</td></tr>`, g += "</table>", e.uGlobal.length > 0) {
      ...
      for (let z = 0; z < e.elem.length; z++) {
        ...
        for (let Y = 0; Y < 6; Y++) {
          const R = e.uGlobal[z * 6 + Y];
          g += `<td class="${Math.abs(R) > 1e-10 ? "nz" : ""}">${Ae(R, 6)}</td>`;
        }
        g += "</tr>";
      }
      g += "</table>";
  ...
  function Co(e) {
    ...
    for (let Y = 0; Y < j; Y++) {
      ...
      for (let R = 0; R < j; R++) {
        const G = ((_a = e[Y]) == null ? void 0 : _a[R]) ?? 0, D = Math.abs(G) < 1e-10;
        z += `<td class="${D ? "z" : ""} ${Y === R && !D ? "diag" : ""}">${D ? "0" : Ea(G)}</td>`;
      }
      z += "</tr>";
    }
  ...
  function Tn(e) {
    ...
    if (!g) return;
    const j = e.width, z = e.height, Y = 30, R = j - 2 * Y, G = (z - 3 * Y) / 2;
    g.fillStyle = getComputedStyle(document.body).getPropertyValue("--fem-bg").trim() || "#111", g.fillRect(0, 0, j, z);
    const D = (H, W, me) => {
      g.strokeStyle = "#333", g.lineWidth = 1, g.strokeRect(Y, H, R, G), g.strokeStyle = "#444", g.beginPath(), g.moveTo(Y, H + G / 2), g.lineTo(Y + R, H + G / 2), g.stroke(), g.fillStyle = "#888", g.font = "11px sans-serif", g.fillText(W, Y + 4, H + 14);
      for (const K of me) {
        g.strokeStyle = K.color, g.lineWidth = 2.5, g.beginPath();
        for (let ge = 0; ge <= 100; ge++) {
          const re = ge / 100, X = Y + re * R, Q = H + G / 2 - K.fn(re) * (G / 2 * 0.85);
          ge === 0 ? g.moveTo(X, Q) : g.lineTo(X, Q);
        }
        g.stroke();
      }
      let I = Y + R - 90;
      for (const K of me) g.fillStyle = K.color, g.font = "bold 10px sans-serif", g.fillText(K.label, I, H + G - 6), I += 36;
      g.fillStyle = "#666", g.font = "9px monospace", g.fillText("0", Y, H + G + 12), g.fillText("1", Y + R - 6, H + G + 12), g.fillText("\u03BE", Y + R / 2, H + G + 12);
    };
    D(Y, "Axial (lineal)", [
      {
        fn: (H) => 1 - H,
    ...
    ]), D(Y + G + Y, "Flexi\xF3n (Hermite c\xFAbicos)", [
      {
  ...
  let Ko = false, bo = null, Nt = null, wt = null, vt = null;
  function Ia() {
  ...
  function za() {
    Ko = true, vt && (vt.innerHTML = "\u2715", vt.style.background = "linear-gradient(135deg, #cc3333, #ff4444)", vt.style.animation = "none"), bo = document.createElement("div"), bo.id = "tour-overlay", bo.style.cssText = `
    position: fixed; inset: 0; z-index: 9999990;
    pointer-events: none;
  `, document.body.appendChild(bo), ko(0);
  }
  function qn() {
    Ko = false, vt && (vt.innerHTML = "?", vt.style.background = "linear-gradient(135deg, #0066cc, #0099ff)", vt.style.animation = "helpPulse 2s infinite"), Nt && (Nt.remove(), Nt = null), wt && (wt.remove(), wt = null), bo && (bo.remove(), bo = null);
  }
  function ko(e) {
    var _a, _b;
    if (e >= Ao.length) {
    ...
    const g = Ao[e], j = document.querySelector(g.selector);
    if (!j) {
      ko(e + 1);
      return;
    }
    j.scrollIntoView({
      behavior: "smooth",
      block: "nearest"
    }), Nt && Nt.remove(), wt && wt.remove();
    const z = j.getBoundingClientRect(), Y = window.innerWidth, R = window.innerHeight, G = 320, D = 180;
    Nt = document.createElement("div"), Nt.style.cssText = `
    position: fixed;
  ...
  `, document.body.appendChild(Nt);
    const H = Y - z.right, W = z.left, me = R - z.bottom, I = z.top;
    let K = g.position || "bottom";
    K === "bottom" && me < D + 20 && (K = "top"), K === "top" && I < D + 20 && (K = "right"), K === "right" && H < G + 20 && (K = "left"), K === "left" && W < G + 20 && (K = "bottom");
    let ge, re, X = "";
    switch (K) {
      case "bottom":
        ge = z.left + z.width / 2 - G / 2, re = z.bottom + 14, X = "position:absolute;top:-8px;left:50%;transform:translateX(-50%);width:0;height:0;border-left:8px solid transparent;border-right:8px solid transparent;border-bottom:8px solid #0099ff;";
        break;
      case "top":
        ge = z.left + z.width / 2 - G / 2, re = z.top - D - 14, X = "position:absolute;bottom:-8px;left:50%;transform:translateX(-50%);width:0;height:0;border-left:8px solid transparent;border-right:8px solid transparent;border-top:8px solid #0099ff;";
        break;
      case "right":
        ge = z.right + 14, re = z.top + z.height / 2 - D / 2, X = "position:absolute;left:-8px;top:50%;transform:translateY(-50%);width:0;height:0;border-top:8px solid transparent;border-bottom:8px solid transparent;border-right:8px solid #0099ff;";
        break;
      case "left":
        ge = z.left - G - 14, re = z.top + z.height / 2 - D / 2, X = "position:absolute;right:-8px;top:50%;transform:translateY(-50%);width:0;height:0;border-top:8px solid transparent;border-bottom:8px solid transparent;border-left:8px solid #0099ff;";
        break;
    }
    ge = Math.max(10, Math.min(ge, Y - G - 10)), re = Math.max(10, Math.min(re, R - D - 10)), wt = document.createElement("div"), wt.style.cssText = `
    position: fixed;
    left: ${ge}px; top: ${re}px;
    width: ${G}px;
  ...
  `, wt.innerHTML = `
    ...
    <div style="display:flex;align-items:center;margin-bottom:8px;">
      ...
      <span style="margin-left:auto;color:#666;font-size:11px;">${e + 1}/${Ao.length}</span>
    </div>
    ...
    <div style="display:flex;gap:8px;justify-content:flex-end;">
      ...
      <button id="tour-next" style="padding:5px 18px;background:linear-gradient(135deg,#0066cc,#0099ff);color:white;border:none;border-radius:6px;cursor:pointer;font-size:12px;font-weight:bold;">
        ${e < Ao.length - 1 ? "Siguiente \u25B6" : "Finalizar \u2713"}
      </button>
    </div>
    <div style="margin-top:8px;display:flex;gap:3px;justify-content:center;">
      ${Ao.map((le, Ie) => `<div style="width:${Ie === e ? "16px" : "6px"};height:6px;border-radius:3px;background:${Ie === e ? "#0099ff" : Ie < e ? "#004488" : "#333"};transition:all 0.3s;"></div>`).join("")}
    </div>
  `, document.body.appendChild(wt), (_a = wt.querySelector("#tour-next")) == null ? void 0 : _a.addEventListener("click", () => {
    ...
    const Q = (le) => {
      ...
      (le.key === "ArrowRight" || le.key === "Enter") && (ko(e + 1), document.removeEventListener("keydown", Q)), le.key === "ArrowLeft" && (ko(Math.max(0, e - 1)), document.removeEventListener("keydown", Q)), le.key === "Escape" && (qn(), document.removeEventListener("keydown", Q));
    };
    document.addEventListener("keydown", Q);
  }
  function Ta() {
    var _a;
    Nt && (Nt.remove(), Nt = null), wt && (wt.remove(), wt = null), wt = document.createElement("div"), wt.style.cssText = `
    position: fixed;
  ...
  `, document.body.appendChild(wt), (_a = wt.querySelector("#tour-done")) == null ? void 0 : _a.addEventListener("click", () => qn());
  }
  function La(e) {
    var _a;
    const g = e.split(/\r?\n/), j = {
      force: "TONF",
      length: "M"
    }, z = [], Y = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), D = [], H = [], W = /* @__PURE__ */ new Map(), me = /* @__PURE__ */ new Map(), I = [], K = [];
    let ge = "", re = "";
    for (const de of g) {
      const fe = de.trim();
      if (!fe || fe.startsWith("$")) {
        fe.startsWith("$ ") && (re = fe.substring(2).trim());
        continue;
      }
      if (re === "CONTROLS") {
        const V = fe.match(/UNITS\s+"([^"]+)"\s+"([^"]+)"/);
        V && (j.force = V[1], j.length = V[2]);
        const $e = fe.match(/TITLE2\s+"([^"]+)"/);
        $e && (ge = $e[1]);
      }
      if (re === "STORIES - IN SEQUENCE FROM TOP") {
        const V = fe.match(/STORY\s+"([^"]+)"\s+(?:HEIGHT\s+([\d.]+)|ELEV\s+([-\d.]+))/);
        if (V) {
          const $e = V[1], J = V[2] ? parseFloat(V[2]) : 0, ce = V[3] ? parseFloat(V[3]) : void 0;
          z.push({
            name: $e,
            height: J,
            elev: ce ?? 0
      ...
      if (re === "MATERIAL PROPERTIES") {
        const V = fe.match(/MATERIAL\s+"([^"]+)"\s+(?:TYPE\s+"([^"]+)")?/);
        if (V) {
          const $e = V[1];
          Y.has($e) || Y.set($e, {
            type: V[2] || "",
          ...
          const J = Y.get($e);
          V[2] && (J.type = V[2]);
          const ce = fe.match(/\bE\s+([\d.eE+-]+)/);
          ce && (J.E = parseFloat(ce[1]));
          const Fe = fe.match(/\bU\s+([\d.eE+-]+)/);
          Fe && (J.nu = parseFloat(Fe[1]), J.G = J.E / (2 * (1 + J.nu)));
          const Me = fe.match(/\bFY\s+([\d.eE+-]+)/);
          Me && (J.fy = parseFloat(Me[1]));
          const Qe = fe.match(/\bFC\s+([\d.eE+-]+)/);
          Qe && (J.fc = parseFloat(Qe[1]));
          const Ve = fe.match(/WEIGHTPERVOLUME\s+([\d.eE+-]+)/);
          Ve && (J.density = parseFloat(Ve[1]));
        }
      }
      if (re === "FRAME SECTIONS") {
        const V = fe.match(/FRAMESECTION\s+"([^"]+)"/);
        if (V) {
          const $e = V[1];
          R.has($e) || R.set($e, {
            material: "",
          ...
          const J = R.get($e), ce = fe.match(/MATERIAL\s+"([^"]+)"/);
          ce && (J.material = ce[1]);
          const Fe = fe.match(/SHAPE\s+"([^"]+)"/);
          Fe && (J.shape = Fe[1]);
          const Me = fe.match(/\bD\s+([\d.eE+-]+)/);
          Me && (J.D = parseFloat(Me[1]));
          const Qe = fe.match(/\bB\s+([\d.eE+-]+)/);
          Qe && (J.B = parseFloat(Qe[1]));
          const Ve = fe.match(/\bTF\s+([\d.eE+-]+)/);
          Ve && (J.TF = parseFloat(Ve[1]));
          const Xe = fe.match(/\bTW\s+([\d.eE+-]+)/);
          Xe && (J.TW = parseFloat(Xe[1]));
          const De = fe.match(/\bR\s+([\d.eE+-]+)/);
          De && (J.R = parseFloat(De[1]));
          const mt = fe.match(/FILLMATERIAL\s+"([^"]+)"/);
          mt && (J.fillMaterial = mt[1]);
          const St = fe.match(/I2MOD\s+([\d.eE+-]+)/);
          St && (J.modI2 = parseFloat(St[1]));
          const et = fe.match(/I3MOD\s+([\d.eE+-]+)/);
          et && (J.modI3 = parseFloat(et[1]));
        }
      }
      if (re === "POINT COORDINATES") {
        const V = fe.match(/POINT\s+"([^"]+)"\s+([-\d.eE+]+)\s+([-\d.eE+]+)/);
        V && G.set(V[1], [
          parseFloat(V[2]),
          parseFloat(V[3])
        ]);
      ...
      if (re === "LINE CONNECTIVITIES") {
        const V = fe.match(/LINE\s+"([^"]+)"\s+(COLUMN|BEAM|BRACE)\s+"([^"]+)"\s+"([^"]+)"\s+(\d+)/);
        V && D.push({
          name: V[1],
          type: V[2],
          pt1: V[3],
          pt2: V[4],
          nStories: parseInt(V[5])
        });
      }
      if (re === "POINT ASSIGNS") {
        const V = fe.match(/POINTASSIGN\s+"([^"]+)"\s+"([^"]+)".*RESTRAINT\s+"([^"]+)"/);
        V && W.set(`${V[1]}@${V[2]}`, V[3].split(/\s+/));
      }
      if (re === "LINE ASSIGNS") {
        const V = fe.match(/LINEASSIGN\s+"([^"]+)"\s+"([^"]+)".*SECTION\s+"([^"]+)"/);
        if (V) {
          const $e = {
            story: V[2],
            section: V[3],
            ...
            releases: [],
            angle: 0
          }, J = fe.match(/RIGIDZONE\s+([\d.eE+-]+)/);
          J && ($e.rigidZone = parseFloat(J[1]));
          const ce = fe.match(/RELEASE\s+"([^"]+)"/);
          ce && ($e.releases = ce[1].split(/\s+/));
          const Fe = fe.match(/ANG\s+([-\d.eE+]+)/);
          Fe && ($e.angle = parseFloat(Fe[1])), me.set(`${V[1]}@${V[2]}`, $e);
        }
      }
      if (re === "GRIDS") {
        const V = fe.match(/^\s*GRID\s+"[^"]+"\s+LABEL\s+"([^"]+)"\s+DIR\s+"([XY])"\s+COORD\s+([-\d.eE+]+)/);
        V && K.push({
          label: V[1],
          dir: V[2],
          coord: parseFloat(V[3])
        });
      }
      if (re === "FRAME OBJECT LOADS") {
        const V = fe.match(/LINELOAD\s+"([^"]+)"\s+"([^"]+)"\s+TYPE\s+"([^"]+)"\s+DIR\s+"([^"]+)"\s+LC\s+"([^"]+)"\s+FVAL\s+([-\d.eE+]+)/);
        V && I.push({
          line: V[1],
          story: V[2],
          type: V[3],
      ...
      if (re === "AREA CONNECTIVITIES") {
        const V = fe.match(/AREA\s+"([^"]+)"\s+\d+\s+(.+)/);
        if (V) {
          const $e = ((_a = V[2].match(/"([^"]+)"/g)) == null ? void 0 : _a.map((J) => J.replace(/"/g, ""))) || [];
          H.push({
            name: V[1],
            pts: $e,
            nStories: 0
    ...
    if (z.length > 0) {
      const de = z.length - 1;
      X.set(z[de].name, z[de].elev);
      for (let fe = de - 1; fe >= 0; fe--) {
        const $e = X.get(z[fe + 1].name) + z[fe].height;
        z[fe].elev = $e, X.set(z[fe].name, $e);
      }
    }
    const Q = [], le = [], Ie = /* @__PURE__ */ new Map(), Ce = (de, fe) => `${de}@${fe}`, Pe = /* @__PURE__ */ new Set(), st = /* @__PURE__ */ new Map();
    for (const de of D) st.set(de.name, de);
    for (const de of D) for (const [fe, V] of me) {
      if (!fe.startsWith(de.name + "@")) continue;
      const $e = V.story, J = z.findIndex((ce) => ce.name === $e);
      if (!(J < 0)) if (de.type === "COLUMN" || de.type === "BRACE") {
        Pe.add(Ce(de.pt2, $e));
        const ce = Math.max(de.nStories, 1), Fe = Math.min(J + ce, z.length - 1);
        Pe.add(Ce(de.pt1, z[Fe].name));
      } else Pe.add(Ce(de.pt1, $e)), Pe.add(Ce(de.pt2, $e));
    }
    for (const [de] of W) Pe.add(de);
    for (const de of Pe) {
      const [fe, V] = de.split("@"), $e = G.get(fe), J = X.get(V);
      $e === void 0 || J === void 0 || (Q.push([
        $e[0],
        $e[1],
        J
      ]), le.push(de), Ie.set(de, Q.length - 1));
    }
    const He = [], ut = [], be = [], Le = [], ve = /* @__PURE__ */ new Map();
    for (const de of D) for (const [fe, V] of me) {
      if (!fe.startsWith(de.name + "@")) continue;
      const $e = V.story, J = z.findIndex((Xe) => Xe.name === $e);
      if (J < 0) continue;
      let ce, Fe;
      if (de.type === "COLUMN" || de.type === "BRACE") {
        const Xe = Math.max(de.nStories, 1), De = Math.min(J + Xe, z.length - 1);
        ce = Ce(de.pt1, z[De].name), Fe = Ce(de.pt2, $e);
      } else ce = Ce(de.pt1, $e), Fe = Ce(de.pt2, $e);
      const Me = Ie.get(ce), Qe = Ie.get(Fe);
      if (Me === void 0 || Qe === void 0 || Me === Qe) continue;
      const Ve = He.length;
      He.push([
        Me,
        Qe
      ]), ut.push(de.name), be.push(de.type), Le.push($e), ve.set(Ve, V.section);
    }
    const je = /* @__PURE__ */ new Map(), Ke = /* @__PURE__ */ new Map(), Re = /* @__PURE__ */ new Map(), Ue = /* @__PURE__ */ new Map(), Ze = /* @__PURE__ */ new Map(), ct = /* @__PURE__ */ new Map(), zt = /* @__PURE__ */ new Map(), Pt = /* @__PURE__ */ new Map(), at = /* @__PURE__ */ new Map();
    for (const [de, fe] of ve) {
      const V = R.get(fe);
      if (!V) continue;
      const $e = Y.get(V.material);
      $e && (je.set(de, $e.E), Ke.set(de, $e.G));
      const J = V.D, ce = V.B, Fe = V.TF, Me = V.TW;
      let Qe = 0, Ve = 0, Xe = 0, De = 0, mt = 0, St = 0, et = "rect";
      switch (V.shape) {
        case "Concrete Rectangular":
          Qe = J * ce, Ve = ce * J ** 3 / 12, Xe = J * ce ** 3 / 12, De = ce * J ** 3 * (1 / 3 - 0.21 * (J / ce) * (1 - J ** 4 / (12 * ce ** 4))), mt = St = 5 / 6 * Qe, et = "rect";
          break;
        case "Concrete Circle":
          Qe = Math.PI * J ** 2 / 4, Ve = Xe = Math.PI * J ** 4 / 64, De = Math.PI * J ** 4 / 32, mt = St = 0.9 * Qe, et = "circ";
          break;
        case "Steel I/Wide Flange":
          Qe = 2 * ce * Fe + (J - 2 * Fe) * Me, Ve = (ce * J ** 3 - (ce - Me) * (J - 2 * Fe) ** 3) / 12, Xe = (2 * Fe * ce ** 3 + (J - 2 * Fe) * Me ** 3) / 12, De = (2 * ce * Fe ** 3 + (J - 2 * Fe) * Me ** 3) / 3, mt = (J - 2 * Fe) * Me, St = 2 * ce * Fe * 5 / 6, et = "I";
          break;
        case "Steel Tube":
          Qe = J * ce - (J - 2 * Me) * (ce - 2 * Me), Ve = (ce * J ** 3 - (ce - 2 * Me) * (J - 2 * Me) ** 3) / 12, Xe = (J * ce ** 3 - (J - 2 * Me) * (ce - 2 * Me) ** 3) / 12, De = 2 * Me * (J - Me) * (ce - Me) * ((J - Me) * (ce - Me)) / (J - Me + (ce - Me)), mt = 2 * J * Me, St = 2 * ce * Me, et = "HSS";
          break;
        case "Filled Steel Tube":
          Qe = J * ce, Ve = ce * J ** 3 / 12, Xe = J * ce ** 3 / 12, De = 2 * Me * (J - Me) * (ce - Me) * ((J - Me) * (ce - Me)) / (J - Me + (ce - Me)), mt = 2 * J * Me + 5 / 6 * (J - 2 * Me) * (ce - 2 * Me), St = 2 * ce * Me + 5 / 6 * (J - 2 * Me) * (ce - 2 * Me), et = "CFT";
          break;
        case "Steel Angle": {
          const It = Fe || Me;
          Qe = It * (J + ce - It), Ve = It * (J ** 3 + ce * It ** 2 + It ** 2 * (J - It)) / 12, Xe = It * (ce ** 3 + J * It ** 2 + It ** 2 * (ce - It)) / 12, De = (J + ce - It) * It ** 3 / 3, mt = J * It, St = ce * It, et = "L";
          break;
        }
        case "Steel Channel":
        case "Cold Formed C":
          Qe = 2 * ce * Fe + (J - 2 * Fe) * Me, Ve = (Me * J ** 3 + 2 * ce * Fe * (J - Fe) ** 2) / 12, Xe = (2 * Fe * ce ** 3 + (J - 2 * Fe) * Me ** 3) / 12, De = (2 * ce * Fe ** 3 + (J - 2 * Fe) * Me ** 3) / 3, mt = (J - 2 * Fe) * Me, St = 2 * ce * Fe * 5 / 6, et = V.shape === "Cold Formed C" ? "coldC" : "C";
          break;
        case "Steel Double Channel":
          Qe = 2 * (2 * ce * Fe + (J - 2 * Fe) * Me), Ve = 2 * (Me * J ** 3 + 2 * ce * Fe * (J - Fe) ** 2) / 12, Xe = 2 * (2 * Fe * ce ** 3 + (J - 2 * Fe) * Me ** 3) / 12, De = 2 * (2 * ce * Fe ** 3 + (J - 2 * Fe) * Me ** 3) / 3, mt = 2 * (J - 2 * Fe) * Me, St = 4 * ce * Fe * 5 / 6, et = "2C";
          break;
        default:
          J > 0 && ce > 0 && (Qe = J * ce, Ve = ce * J ** 3 / 12, Xe = J * ce ** 3 / 12, De = Math.min(J, ce) * Math.max(J, ce) ** 3 / 3 * 0.3, mt = St = 5 / 6 * Qe);
          break;
      }
      V.modI2 && (Xe *= V.modI2), V.modI3 && (Ve *= V.modI3), Re.set(de, Qe), ct.set(de, Ve), zt.set(de, Xe), Pt.set(de, De), mt > 0 && Ue.set(de, mt), St > 0 && Ze.set(de, St), at.set(de, {
        type: et,
        b: ce || void 0,
        h: J || void 0,
        d: et === "circ" || et === "pipe" ? J : void 0,
        tw: Me || void 0,
        tf: Fe || void 0,
        r: V.R,
        name: fe
    ...
    for (const [de, fe] of W) {
      ...
      for (const J of fe) J === "UX" && ($e[0] = true), J === "UY" && ($e[1] = true), J === "UZ" && ($e[2] = true), J === "RX" && ($e[3] = true), J === "RY" && ($e[4] = true), J === "RZ" && ($e[5] = true);
      Yt.set(V, $e);
    }
    const Te = /* @__PURE__ */ new Map(), gt = /* @__PURE__ */ new Map();
    for (let de = 0; de < ut.length; de++) gt.set(`${ut[de]}@${Le[de]}`, de);
    for (const de of I) {
      const fe = gt.get(`${de.line}@${de.story}`);
      if (fe === void 0) continue;
      const [V, $e] = He[fe], J = Q[V], ce = Q[$e], Fe = Math.sqrt((ce[0] - J[0]) ** 2 + (ce[1] - J[1]) ** 2 + (ce[2] - J[2]) ** 2);
      if (Fe < 1e-10) continue;
      const Me = de.val * Fe / 2;
      let Qe = 0, Ve = 0, Xe = 0;
      de.dir === "GRAV" || de.dir === "GRAVITY" ? Xe = -Me : de.dir === "X" ? Qe = Me : de.dir === "Y" ? Ve = Me : de.dir === "Z" && (Xe = -Me);
      for (const De of [
        V,
        $e
      ]) {
        ...
        mt[0] += Qe, mt[1] += Ve, mt[2] += Xe, Te.set(De, mt);
      }
    }
    ...
    for (const [de, fe] of ve) {
      ...
      if (!V) continue;
      const $e = Y.get(V.material);
      ($e == null ? void 0 : $e.density) && kt.set(de, $e.density);
    }
    return {
      units: j,
      stories: z.reverse(),
  ...
  function Fa(e) {
    var _a, _b;
    const { nodes: g, elements: j, nodeInputs: z, elementInputs: Y, title: R, units: G } = e, D = (G == null ? void 0 : G.force) || "TONF", H = (G == null ? void 0 : G.length) || "M", W = [], me = (be) => Math.round(be * 1e4) / 1e4;
    ...
    g.forEach((be) => I.add(me(be[2])));
    const K = [
      ...I
    ].sort((be, Le) => be - Le), ge = [], re = /* @__PURE__ */ new Map();
    if (K.length > 0) {
      ge.push("Base"), re.set(K[0], "Base");
      for (let be = 1; be < K.length; be++) {
        const Le = `Level_${be}`;
        ge.push(Le), re.set(K[be], Le);
      }
    }
    W.push("$ STORIES - IN SEQUENCE FROM TOP");
    for (let be = K.length - 1; be >= 1; be--) {
      const Le = me(K[be] - K[be - 1]);
      W.push(`  STORY "${ge[be]}"  HEIGHT ${Le} MASTERSTORY "Yes"  `);
    }
    K.length > 0 && W.push(`  STORY "Base"  ELEV ${K[0]} `), W.push("");
    const X = /* @__PURE__ */ new Map();
    let Q = 0;
    g.forEach((be) => {
      const Le = `${me(be[0])},${me(be[1])}`;
      X.has(Le) || X.set(Le, `${++Q}`);
    });
    const le = (be) => {
      const Le = g[be], ve = `${me(Le[0])},${me(Le[1])}`;
      return {
        pt: X.get(ve) || "1",
        story: re.get(me(Le[2])) || "Base"
      };
    };
    W.push("$ MATERIAL PROPERTIES");
    const Ie = /* @__PURE__ */ new Set();
    (_a = Y.elasticities) == null ? void 0 : _a.forEach((be) => Ie.add(be));
    let Ce = 0;
    ...
    for (const be of Ie) {
      ...
      Pe.set(be, Le);
      const ve = 0.3;
      W.push(`  MATERIAL  "${Le}"    TYPE "Steel"    WEIGHTPERVOLUME 7.849`), W.push(`  MATERIAL  "${Le}"    SYMTYPE "Isotropic"  E ${be}  U ${ve}  A 1.17E-05`);
    }
    W.push(""), W.push("$ FRAME SECTIONS");
    const st = /* @__PURE__ */ new Map(), He = /* @__PURE__ */ new Set();
    j.forEach((be, Le) => {
      var _a2, _b2;
      if (be.length !== 2) return;
      const ve = (_a2 = Y.sectionShapes) == null ? void 0 : _a2.get(Le), je = ((_b2 = Y.elasticities) == null ? void 0 : _b2.get(Le)) ?? 0, Ke = Pe.get(je) || "Mat_1";
      let Re = (ve == null ? void 0 : ve.name) || `Sec_${Le}`, Ue = "";
      if (ve) {
        const Ze = ve.h ?? 0, ct = ve.b ?? 0, zt = ve.d ?? 0, Pt = ve.tf ?? 0, at = ve.tw ?? 0;
        switch (ve.type) {
          case "rect":
            Re = ve.name || `Rect_${ct.toFixed(2)}x${Ze.toFixed(2)}`, Ue = `  FRAMESECTION  "${Re}"  MATERIAL "${Ke}"  SHAPE "Concrete Rectangular"  D ${Ze} B ${ct} `;
            break;
          case "circ":
            Re = ve.name || `Circ_D${zt.toFixed(2)}`, Ue = `  FRAMESECTION  "${Re}"  MATERIAL "${Ke}"  SHAPE "Concrete Circle"  D ${zt} `;
            break;
          case "I":
            Re = ve.name || `I_${Ze.toFixed(3)}`, Ue = `  FRAMESECTION  "${Re}"  MATERIAL "${Ke}"  SHAPE "Steel I/Wide Flange"  D ${Ze} B ${ct} TF ${Pt} TW ${at} `;
            break;
          case "HSS":
            Re = ve.name || `HSS_${ct.toFixed(3)}x${Ze.toFixed(3)}`, Ue = `  FRAMESECTION  "${Re}"  MATERIAL "${Ke}"  SHAPE "Steel Tube"  D ${Ze} B ${ct} TF ${at} TW ${at} `;
            break;
          case "CFT":
            Re = ve.name || `CFT_${ct.toFixed(3)}x${Ze.toFixed(3)}`, Ue = `  FRAMESECTION  "${Re}"  MATERIAL "${Ke}"  SHAPE "Filled Steel Tube"  D ${Ze} B ${ct} TF ${at} TW ${at} `;
            break;
          case "L":
            Re = ve.name || `L_${(Ze * 1e3).toFixed(0)}x${((ve.t || at) * 1e3).toFixed(0)}`, Ue = `  FRAMESECTION  "${Re}"  MATERIAL "${Ke}"  SHAPE "Steel Angle"  D ${Ze} B ${ct || Ze} TF ${ve.t || at} TW ${ve.t || at} `;
            break;
          case "C":
          case "coldC":
            Re = ve.name || `C_${(Ze * 1e3).toFixed(0)}x${(ct * 1e3).toFixed(0)}`, Ue = `  FRAMESECTION  "${Re}"  MATERIAL "${Ke}"  SHAPE "Steel Channel"  D ${Ze} B ${ct} TF ${Pt || ve.t || 0} TW ${at || ve.t || 0} `;
            break;
          case "2C":
            Re = ve.name || `2C_${(Ze * 1e3).toFixed(0)}`, Ue = `  FRAMESECTION  "${Re}"  MATERIAL "${Ke}"  SHAPE "Steel Double Channel"  D ${Ze} B ${ct} TF ${Pt} TW ${at} DIS ${ve.dis || 0} `;
            break;
          case "pipe":
            Re = ve.name || `Pipe_D${(zt * 1e3).toFixed(0)}`, Ue = `  FRAMESECTION  "${Re}"  MATERIAL "${Ke}"  SHAPE "Steel Pipe"  D ${zt} TW ${at} `;
            break;
          default:
            Re = ve.name || `Sec_${Le}`, Ue = `  FRAMESECTION  "${Re}"  MATERIAL "${Ke}"  SHAPE "Concrete Rectangular"  D 0.5 B 0.3 `;
        }
      } else Ue = `  FRAMESECTION  "${Re}"  MATERIAL "${Ke}"  SHAPE "Concrete Rectangular"  D 0.5 B 0.3 `;
      st.set(Le, Re), He.has(Re) || (He.add(Re), W.push(Ue));
    }), W.push(""), W.push("$ POINT COORDINATES");
    for (const [be, Le] of X) {
      const [ve, je] = be.split(",").map(Number);
      W.push(`  POINT "${Le}"  ${ve} ${je} `);
    }
    W.push(""), W.push("$ LINE CONNECTIVITIES");
    const ut = [];
    return j.forEach((be, Le) => {
      if (be.length !== 2) return;
      const ve = g[be[0]], je = g[be[1]], Ke = Math.abs(je[2] - ve[2]), Re = Math.sqrt((je[0] - ve[0]) ** 2 + (je[1] - ve[1]) ** 2), Ue = Ke > Re * 0.5, ct = Ue && Re > 0.01 ? "BRACE" : Ue ? "COLUMN" : "BEAM", zt = le(be[0]), Pt = le(be[1]);
      let at, Yt;
      if (ct === "BEAM") at = zt.story, Yt = 0, W.push(`  LINE  "E${Le + 1}"  ${ct}  "${zt.pt}"  "${Pt.pt}"  ${Yt}`), ut.push(`  LINEASSIGN  "E${Le + 1}"  "${at}"  SECTION "${st.get(Le) || "Sec_1"}"  MINNUMSTA 3 AUTOMESH "YES"  MESHATINTERSECTIONS "YES"  `);
      else {
        const Te = ve[2] <= je[2] ? be[0] : be[1], gt = ve[2] <= je[2] ? be[1] : be[0], kt = le(Te), de = le(gt), fe = me(g[Te][2]), V = me(g[gt][2]), $e = K.indexOf(fe), J = K.indexOf(V);
        Yt = Math.max(1, J - $e), at = de.story, W.push(`  LINE  "E${Le + 1}"  ${ct}  "${kt.pt}"  "${de.pt}"  ${Yt}`), ut.push(`  LINEASSIGN  "E${Le + 1}"  "${at}"  SECTION "${st.get(Le) || "Sec_1"}"  MINNUMSTA 3 AUTOMESH "YES"  MESHATINTERSECTIONS "YES"  `);
      }
    }), W.push(""), W.push("$ POINT ASSIGNS"), (_b = z.supports) == null ? void 0 : _b.forEach((be, Le) => {
      const ve = [];
      if (be[0] && ve.push("UX"), be[1] && ve.push("UY"), be[2] && ve.push("UZ"), be[3] && ve.push("RX"), be[4] && ve.push("RY"), be[5] && ve.push("RZ"), ve.length > 0) {
        const je = le(Le);
        W.push(`  POINTASSIGN  "${je.pt}"  "${je.story}"  RESTRAINT "${ve.join(" ")}"  `);
      }
    }), W.push(""), W.push("$ LINE ASSIGNS"), ut.forEach((be) => W.push(be)), W.push(""), W.push("$ LOAD PATTERNS"), W.push('  LOADPATTERN "Dead"  TYPE "Dead"  SELFWEIGHT 1'), W.push('  LOADPATTERN "Live"  TYPE "Live"  '), W.push(""), z.loads && z.loads.size > 0 && (W.push("$ POINT OBJECT LOADS"), z.loads.forEach((be, Le) => {
      const [ve, je, Ke] = be, Re = le(Le);
      Math.abs(ve) > 1e-10 && W.push(`  POINTLOAD  "${Re.pt}"  "${Re.story}"  "Dead"  TYPE "FORCE"  FX ${ve}`), Math.abs(je) > 1e-10 && W.push(`  POINTLOAD  "${Re.pt}"  "${Re.story}"  "Dead"  TYPE "FORCE"  FY ${je}`), Math.abs(Ke) > 1e-10 && W.push(`  POINTLOAD  "${Re.pt}"  "${Re.story}"  "Dead"  TYPE "FORCE"  FZ ${Ke}`);
...
`);
  ...
  function qa(e) {
    ...
    return R.push("# OpenSeesPy model exported from Awatif FEM Studio"), R.push(`# ${g.length} nodes, ${j.length} elements`), R.push(""), R.push("import openseespy.opensees as ops"), R.push(""), R.push("ops.wipe()"), R.push("ops.model('basic', '-ndm', 3, '-ndf', 6)"), R.push(""), R.push("# --- Nodes ---"), g.forEach((G, D) => {
      R.push(`ops.node(${D + 1}, ${G[0]}, ${G[1]}, ${G[2]})`);
    }), R.push(""), R.push("# --- Boundary Conditions ---"), (_a = z.supports) == null ? void 0 : _a.forEach((G, D) => {
      const H = G.map((W) => W ? 1 : 0).join(", ");
      R.push(`ops.fix(${D + 1}, ${H})`);
    }), R.push(""), R.push("# --- Geometric Transformations ---"), R.push("ops.geomTransf('Linear', 1, 0.0, 0.0, 1.0)  # beams (vecxz = Z)"), R.push("ops.geomTransf('Linear', 2, -1.0, 0.0, 0.0)  # columns (vecxz = -X)"), R.push(""), R.push("# --- Elements (elasticBeamColumn) ---"), j.forEach((G, D) => {
      var _a2, _b2, _c, _d, _e, _f;
      if (G.length !== 2) return;
      const H = g[G[0]], W = g[G[1]], I = Math.abs(W[2] - H[2]) > Math.max(Math.abs(W[0] - H[0]), Math.abs(W[1] - H[1])) ? 2 : 1, K = ((_a2 = Y.areas) == null ? void 0 : _a2.get(D)) ?? 1, ge = ((_b2 = Y.elasticities) == null ? void 0 : _b2.get(D)) ?? 2e5, re = ((_c = Y.shearModuli) == null ? void 0 : _c.get(D)) ?? 8e4, X = ((_d = Y.torsionalConstants) == null ? void 0 : _d.get(D)) ?? 1, Q = ((_e = Y.momentsOfInertiaY) == null ? void 0 : _e.get(D)) ?? 1, le = ((_f = Y.momentsOfInertiaZ) == null ? void 0 : _f.get(D)) ?? 1;
      R.push(`ops.element('elasticBeamColumn', ${D + 1}, ${G[0] + 1}, ${G[1] + 1}, ${K}, ${ge}, ${re}, ${X}, ${Q}, ${le}, ${I})`);
    }), R.push(""), z.loads && z.loads.size > 0 && (R.push("# --- Loads ---"), R.push("ops.timeSeries('Linear', 1)"), R.push("ops.pattern('Plain', 1, 1)"), z.loads.forEach((G, D) => {
    ...
    }), R.push(""), R.push('print("\\n=== Reactions ===")'), R.push("ops.reactions()"), (_b = z.supports) == null ? void 0 : _b.forEach((G, D) => {
...
`);
  ...
  function Aa(e) {
    var _a, _b;
    const { nodes: g, elements: j, nodeInputs: z, elementInputs: Y } = e, R = [];
    return R.push("# OpenSees Tcl model exported from Awatif FEM Studio"), R.push(`# ${g.length} nodes, ${j.length} elements`), R.push(""), R.push("wipe"), R.push("model basic -ndm 3 -ndf 6"), R.push(""), R.push("# --- Nodes ---"), g.forEach((G, D) => {
      R.push(`node ${D + 1} ${G[0]} ${G[1]} ${G[2]}`);
    }), R.push(""), R.push("# --- Boundary Conditions ---"), (_a = z.supports) == null ? void 0 : _a.forEach((G, D) => {
      const H = G.map((W) => W ? 1 : 0).join(" ");
      R.push(`fix ${D + 1} ${H}`);
    }), R.push(""), R.push("# --- Geometric Transformations ---"), R.push("geomTransf Linear 1 0.0 0.0 1.0"), R.push("geomTransf Linear 2 -1.0 0.0 0.0"), R.push(""), R.push("# --- Elements ---"), j.forEach((G, D) => {
      var _a2, _b2, _c, _d, _e, _f;
      if (G.length !== 2) return;
      const H = g[G[0]], W = g[G[1]], I = Math.abs(W[2] - H[2]) > Math.max(Math.abs(W[0] - H[0]), Math.abs(W[1] - H[1])) ? 2 : 1, K = ((_a2 = Y.areas) == null ? void 0 : _a2.get(D)) ?? 1, ge = ((_b2 = Y.elasticities) == null ? void 0 : _b2.get(D)) ?? 2e5, re = ((_c = Y.shearModuli) == null ? void 0 : _c.get(D)) ?? 8e4, X = ((_d = Y.torsionalConstants) == null ? void 0 : _d.get(D)) ?? 1, Q = ((_e = Y.momentsOfInertiaY) == null ? void 0 : _e.get(D)) ?? 1, le = ((_f = Y.momentsOfInertiaZ) == null ? void 0 : _f.get(D)) ?? 1;
      R.push(`element elasticBeamColumn ${D + 1} ${G[0] + 1} ${G[1] + 1} ${K} ${ge} ${re} ${X} ${Q} ${le} ${I}`);
    }), R.push(""), z.loads && z.loads.size > 0 && (R.push("# --- Loads ---"), R.push("timeSeries Linear 1"), R.push("pattern Plain 1 1 {"), z.loads.forEach((G, D) => {
      const H = G.map((W) => W).join(" ");
      R.push(`  load ${D + 1} ${H}`);
    ...
    }), R.push('puts "\\n=== Reactions ==="'), R.push("reactions"), (_b = z.supports) == null ? void 0 : _b.forEach((G, D) => {
      R.push(`puts "Node ${D + 1}: [nodeReaction ${D + 1}]"`);
    }), R.join(`
`);
  }
  function Ca(e) {
    const g = [], j = [], z = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), H = /* @__PURE__ */ new Map(), W = /* @__PURE__ */ new Map(), me = /* @__PURE__ */ new Map(), I = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Map();
    for (const ge of e.split(/\r?\n/)) {
      const re = ge.trim(), X = re.match(/ops\.node\(\s*(\d+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)/);
      if (X) {
        const Ce = parseInt(X[1]), Pe = g.length;
        g.push([
          parseFloat(X[2]),
          parseFloat(X[3]),
          parseFloat(X[4])
      ...
      const Q = re.match(/ops\.fix\(\s*(\d+)\s*,\s*(\d)\s*,\s*(\d)\s*,\s*(\d)\s*,\s*(\d)\s*,\s*(\d)\s*,\s*(\d)/);
      if (Q) {
        const Ce = parseInt(Q[1]), Pe = I.get(Ce);
        Pe !== void 0 && z.set(Pe, [
          Q[2] === "1",
          Q[3] === "1",
          Q[4] === "1",
      ...
      const le = re.match(/ops\.element\(\s*'elasticBeamColumn'\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)/);
      if (le) {
        const Ce = parseInt(le[1]), Pe = I.get(parseInt(le[2])), st = I.get(parseInt(le[3]));
        if (Pe !== void 0 && st !== void 0) {
          const He = j.length;
          j.push([
            Pe,
            st
          ]), K.set(Ce, He), D.set(He, parseFloat(le[4])), R.set(He, parseFloat(le[5])), G.set(He, parseFloat(le[6])), me.set(He, parseFloat(le[7])), H.set(He, parseFloat(le[8])), W.set(He, parseFloat(le[9]));
        }
        continue;
      }
      const Ie = re.match(/ops\.load\(\s*(\d+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)\s*,\s*([-\d.eE+]+)/);
      if (Ie) {
        const Ce = I.get(parseInt(Ie[1]));
        Ce !== void 0 && Y.set(Ce, [
          parseFloat(Ie[2]),
          parseFloat(Ie[3]),
          parseFloat(Ie[4]),
  ...
  function Pa(e) {
    const g = [], j = [], z = /* @__PURE__ */ new Map(), Y = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), G = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), H = /* @__PURE__ */ new Map(), W = /* @__PURE__ */ new Map(), me = /* @__PURE__ */ new Map(), I = /* @__PURE__ */ new Map();
    for (const K of e.split(/\r?\n/)) {
      const ge = K.trim();
      if (ge.startsWith("#") || ge.startsWith("//")) continue;
      const re = ge.split(/\s+/);
      if (re[0] === "node" && re.length >= 5) {
        const X = parseInt(re[1]), Q = g.length;
        g.push([
          parseFloat(re[2]),
          parseFloat(re[3]),
          parseFloat(re[4])
      ...
      if (re[0] === "element" && re[1] === "elasticBeamColumn" && re.length >= 12) {
        const X = I.get(parseInt(re[3])), Q = I.get(parseInt(re[4]));
        if (X !== void 0 && Q !== void 0) {
          const le = j.length;
          j.push([
            X,
            Q
          ]), D.set(le, parseFloat(re[5])), R.set(le, parseFloat(re[6])), G.set(le, parseFloat(re[7])), me.set(le, parseFloat(re[8])), H.set(le, parseFloat(re[9])), W.set(le, parseFloat(re[10]));
        }
        continue;
      }
  ...
  $s = So.state(false);
  Da = function(e) {
    e.nodeInputs || (e.nodeInputs = So.state({})), e.elementInputs || (e.elementInputs = So.state({})), e.deformOutputs || (e.deformOutputs = So.state({})), e.analyzeOutputs || (e.analyzeOutputs = So.state({}));
    let g = "tonf", j = "m", z = uo(g, j), Y = {
      forceId: "kgf",
      lengthId: "cm",
      label: "kgf/cm\xB2"
    };
    ...
    let H = false;
    const W = /* @__PURE__ */ new Set(), me = /* @__PURE__ */ new Map();
    let I = "", K = {}, ge = null, re = "", X = [], Q = [], le = /* @__PURE__ */ new Set(), Ie = /* @__PURE__ */ new Set(), Ce = /* @__PURE__ */ new Set(), Pe = /* @__PURE__ */ new Map(), st = /* @__PURE__ */ new Map(), He = [], ut = 0.2, be = 2, Le = 2, ve = false, je = 2, Ke = "x", Re = /* @__PURE__ */ new Set(), Ue = true, Ze = 0.15, ct = 2, zt = 2, Pt = /* @__PURE__ */ new Set();
    const at = () => ({
      b: 0.3,
      h: 0.4,
      profileIdx: 0,
    ...
    let gt = 0, kt = 3, de = false, fe = 0, V = null, $e = 0, J = [], ce = 1, Fe = true;
    const Me = ba();
    ...
    function mt() {
      if (!De) return;
      const t = ot();
      t && t.scene.remove(De), De.traverse((o) => {
    ...
    function St(t, o, n, l, s) {
      ...
      for (let b = 0; b < t.length; b++) {
        ...
        if (v) {
          const y = -w - u * 1.5;
          Qo(f, 0, 0, f, 0, y + u, M, De), en(x[b] || `${b}`, f, 0, y, u, De);
        } else {
          const y = m - w - u * 1.5;
          Qo(f, m, 0, f, y + u, 0, M, De), en(x[b] || `${b}`, f, y, 0, u, De);
        }
      }
      if (!v) for (let b = 0; b < o.length; b++) {
        const f = o[b], y = a - w - u * 1.5;
        Qo(a, f, 0, y + u, f, 0, M, De), en(p[b] || `${b}`, y, f, 0, u, De);
      }
      const $ = u * 1.8, A = w * 1.2, q = w * 1.2;
      for (let b = 0; b < t.length - 1; b++) {
        const f = t[b], y = t[b + 1], E = Math.abs(y - f), k = (f + y) / 2, O = `${E.toFixed(2)} m`;
        v ? (Uo(O, k, 0, -A, $, De), Zo(f, 0, -A * 0.7, y, 0, -A * 0.7, 16763904, De)) : (Uo(O, k, m - q, 0, $, De), Zo(f, m - q * 0.7, 0, y, m - q * 0.7, 0, 16763904, De));
      }
      if (!v) for (let b = 0; b < o.length - 1; b++) {
        const f = o[b], y = o[b + 1], E = Math.abs(y - f), k = (f + y) / 2, O = `${E.toFixed(2)} m`;
        Uo(O, a - A, k, 0, $, De), Zo(a - A * 0.7, f, 0, a - A * 0.7, y, 0, 16763904, De);
      }
      De.traverse((b) => {
        b.material && (Array.isArray(b.material) ? b.material.forEach((f) => {
          f.clippingPlanes = [];
        }) : b.material.clippingPlanes = []);
      }), d.scene.add(De), d.render();
    }
    let et = null;
    function It() {
      if (!et) return;
      const t = ot();
      t && t.scene.remove(et), et.traverse((o) => {
        if (o.geometry && o.geometry.dispose(), o.material) {
          const n = o.material;
          n.map && n.map.dispose(), n.dispose();
        }
    ...
    function Ms(t, o, n) {
      ...
      for (const p of t) {
        const u = p.elev;
        S ? (Io(s - h, 0, u, d + h, 0, u, w, et), An(p.name, d + h * 1.5, 0, u, x, et)) : (Io(s, a, u, d, a, u, w, et), Io(d, a, u, d, c, u, w, et), Io(d, c, u, s, c, u, w, et), Io(s, c, u, s, a, u, w, et), An(p.name, s - h * 1.5, a, u, x, et));
      }
      et.traverse((p) => {
        p.material && (Array.isArray(p.material) ? p.material.forEach((u) => {
          u.clippingPlanes = [];
        }) : p.material.clippingPlanes = []);
      }), l.scene.add(et), l.render();
    }
    function Io(t, o, n, l, s, d, a, c) {
      const m = Math.sqrt((l - t) ** 2 + (s - o) ** 2 + (d - n) ** 2) || 1, r = new ao().setFromPoints([
        new ke(t, o, n),
        new ke(l, s, d)
      ]), i = new Sn({
        color: a,
    ...
    function Zo(t, o, n, l, s, d, a, c) {
      const m = [
        new ke(t, o, n),
        new ke(l, s, d)
      ], r = new ao().setFromPoints(m), i = new qo({
        color: a,
        transparent: true,
        opacity: 0.6,
        depthTest: false
    ...
    const We = {
      addNode(t, o, n) {
        ...
        return l.push([
          ...
          o,
          n
        ]), e.nodes.val = l, console.log(`Node ${s} at (${t}, ${o}, ${n})`), Ye(), s;
      },
      removeNode(t) {
        const o = [
          ...e.nodes.val
        ...
        e.nodes.val = o, e.elements.val = n, console.log(`Node ${t} removed`), Ye();
      },
      listNodes() {
        const t = e.nodes.val;
      ...
      addFrame(t, o) {
        ...
        return n.push([
          t,
          o
        ]), e.elements.val = n, console.log(`Element ${l}: node ${t} -> node ${o}`), Ye(), l;
      },
      removeFrame(t) {
        const o = [
          ...e.elements.val
        ...
        o.splice(t, 1), e.elements.val = o, console.log(`Element ${t} removed`), Ye();
      },
      listFrames() {
      ...
      addSupport(t, o) {
        ...
        l.set(t, o || [
          ...
          true,
          true
        ]), n.supports = l, e.nodeInputs.val = n, console.log(`Support added at node ${t}`), Ye();
      },
      removeSupport(t) {
        if (!e.nodeInputs) return;
        const o = {
        ...
        n.delete(t), o.supports = n, e.nodeInputs.val = o, console.log(`Support removed from node ${t}`), Ye();
      },
      addLoad(t, o) {
        if (!e.nodeInputs) return;
        const n = {
        ...
        l.set(t, o), n.loads = l, e.nodeInputs.val = n, console.log(`Load added at node ${t}: [${o.join(", ")}]`), Ye();
      },
      removeLoad(t) {
        if (!e.nodeInputs) return;
        const o = {
        ...
        n.delete(t), o.loads = n, e.nodeInputs.val = o, console.log(`Load removed from node ${t}`), Ye();
      },
      listSupports() {
        if (!e.nodeInputs) return;
      ...
      clear() {
        e.nodes.val = [], e.elements.val = [], e.nodeInputs && (e.nodeInputs.val = {}), e.elementInputs && (e.elementInputs.val = {}), le = /* @__PURE__ */ new Set(), Ie = /* @__PURE__ */ new Set(), Pe = /* @__PURE__ */ new Map(), st = /* @__PURE__ */ new Map(), Ve = [], Xe = [], mt(), It();
        const t = ye.querySelector("#cad3d-axis-buttons");
        t && (t.style.display = "none", t.innerHTML = ""), console.log("Model cleared"), Ye();
      },
      frame(t, o, n = 0, l = 0) {
        We.clear();
        const s = [];
        ...
        const h = [];
        le = /* @__PURE__ */ new Set(), Ie = /* @__PURE__ */ new Set();
        for (let x = 0; x < a.length - 1; x++) for (let p = 0; p < s.length; p++) m(p) || (le.add(h.length), h.push([
          r[`${p},${x}`],
          r[`${p},${x + 1}`]
        ]));
      ...
      building(t, o, n, l = 3, s = 0, d = 0, a = 0, c = 0, m = 1) {
        ...
        const v = p.length, M = [];
        le = /* @__PURE__ */ new Set(), Ie = /* @__PURE__ */ new Set(), Pe = /* @__PURE__ */ new Map();
        const $ = [];
        ...
        for (const { el: [f, y], floor: E } of $) {
          if (m <= 1) {
            le.add(M.length), Pe.set(M.length, E), M.push([
              f,
              y
            ]);
            continue;
        ...
        for (const { el: [f, y], floor: E, dir: k, bay: O } of A) {
          ...
          for (let te = 1; te < l; te++) {
            ...
            const ee = M.length;
            Ie.add(ee), Pe.set(ee, E), st.set(ee, {
              dir: k,
              bay: O
            }), M.push([
              P,
        ...
        if (Re = /* @__PURE__ */ new Set(), ve && je > 0) {
          const f = (y, E, k) => {
          ...
          for (let y = 1; y < h.length; y++) if (Ke === "x") for (let E = 0; E < i.length - 1; E++) {
            const k = i[E], O = i[E + 1];
            for (let F = 1; F <= je; F++) {
              ...
              for (let _ = 0; _ < r.length - 1; _++) {
                const te = M.length;
                Re.add(te), Ie.add(te), Pe.set(te, y - 1), st.set(te, {
                  dir: "x",
                  bay: _
                }), M.push([
                  P[_],
        ...
        for (const f of He) {
          ...
          for (const k of E) {
            ...
            let ne, ie;
            if (f.dir === "x" ? (ne = u[`${L},${P},${k}`], ie = u[`${L},${P},${k + 1}`]) : (ne = u[`${L},${P},${k}`], ie = u[`${L},${P},${k + 1}`]), _ === void 0 || ne === void 0 || te === void 0 || ie === void 0) continue;
            const ee = Le, Z = be, se = p[_], Se = p[ne], Ne = p[te], _e = p[ie], ae = [];
            for (let xe = 0; xe <= Z; xe++) {
              const Ee = [], pe = xe / Z;
              for (let qe = 0; qe <= ee; qe++) {
                const Oe = qe / ee, nt = (1 - pe) * ((1 - Oe) * se[0] + Oe * Se[0]) + pe * ((1 - Oe) * Ne[0] + Oe * _e[0]), oe = (1 - pe) * ((1 - Oe) * se[1] + Oe * Se[1]) + pe * ((1 - Oe) * Ne[1] + Oe * _e[1]), ze = (1 - pe) * ((1 - Oe) * se[2] + Oe * Se[2]) + pe * ((1 - Oe) * Ne[2] + Oe * _e[2]);
                xe === 0 && qe === 0 ? Ee.push(_) : xe === 0 && qe === ee ? Ee.push(ne) : xe === Z && qe === 0 ? Ee.push(te) : xe === Z && qe === ee ? Ee.push(ie) : (Ee.push(p.length), p.push([
                  nt,
                  oe,
                  ze
                ]));
            ...
            for (let xe = 0; xe < Z; xe++) for (let Ee = 0; Ee < ee; Ee++) {
              const pe = ae[xe][Ee], qe = ae[xe][Ee + 1], Oe = ae[xe + 1][Ee + 1], nt = ae[xe + 1][Ee], oe = M.length;
        ...
        if (Pt = /* @__PURE__ */ new Set(), Ue) {
          ...
          for (let O = 1; O < h.length; O++) {
            ...
            for (let L = 0; L < r.length - 1; L++) for (let P = 0; P < i.length - 1; P++) {
              const _ = r[L], te = r[L + 1], ne = i[P], ie = i[P + 1], ee = [];
              for (let Z = 0; Z <= y; Z++) {
                const se = [];
                for (let Se = 0; Se <= f; Se++) {
                  const Ne = _ + Se / f * (te - _), _e = ne + Z / y * (ie - ne);
                  if (Z === 0 && Se === 0) se.push(u[`${L},${P},${O}`]);
                  else if (Z === 0 && Se === f) se.push(u[`${L + 1},${P},${O}`]);
                  else if (Z === y && Se === 0) se.push(u[`${L},${P + 1},${O}`]);
                  else if (Z === y && Se === f) se.push(u[`${L + 1},${P + 1},${O}`]);
                  else {
                    const ae = k(Ne, _e, F), xe = E.get(ae);
                    if (xe !== void 0) se.push(xe);
                    else {
                      const Ee = p.length;
                      p.push([
                        Ne,
                        _e,
                        F
                      ]), E.set(ae, Ee), se.push(Ee);
                    }
                  }
                }
                ee.push(se);
              }
              for (let Z = 0; Z < y; Z++) for (let se = 0; se < f; se++) {
                const Se = ee[Z][se], Ne = ee[Z][se + 1], _e = ee[Z + 1][se + 1], ae = ee[Z + 1][se], xe = M.length;
                Pt.add(xe), Pe.set(xe, O - 1), M.push([
                  Se,
                  Ne,
                  _e,
                  ae
      ...
      example(t) {
        ...
        switch (t) {
          case "truss": {
            We.clear(), Je("truss"), _n();
            break;
          }
          case "beams": {
            We.clear(), Je("beams"), On();
            break;
          }
          case "3d":
          case "3d-structure":
          ...
          case "edificio": {
            Je("edificio"), Te.colMat = 0, Te.vigaMat = 0, Te.colShape = 0, He = [], Ue = false, ve = false, he();
            break;
          }
          case "edif-acero":
          case "edificio-acero": {
            Je("edificio"), Te.colMat = 1, Te.vigaMat = 1, Te.steelColType = 0, Te.steelVigaType = 0, He = [], ve = true, je = 2;
            const o = X.reduce((l, s) => l + s, 0) / X.length, n = Q.reduce((l, s) => l + s, 0) / Q.length;
            Ke = o >= n ? "y" : "x", Ue = true, Ze = 0.08, he();
            break;
          }
          case "edif-muros":
          case "edificio-muros": {
          ...
          case "mezanine":
          case "mezzanine": {
            Je("edificio"), K.nPisos && (K.nPisos.val = 1), K.hPiso && (K.hPiso.val = 4.5), K.nVanosX && (K.nVanosX.val = 3), K.nVanosY && (K.nVanosY.val = 2), K.nSubViga && (K.nSubViga.val = 3), X = [
              6,
              6,
              6
            ], Q = [
              5,
              5
            ], Te.colMat = 1, Te.vigaMat = 1, Te.steelColType = 0, Te.steelVigaType = 0, He = [], ve = true, je = 2, Ke = X[0] >= Q[0] ? "y" : "x", Ue = true, Ze = 0.08, ct = 3, zt = 3, he();
            break;
          }
          case "galpon": {
            Je("galpon"), he();
          ...
          case "plate-q4":
          case "placa-q4": {
            We.clear(), Je("placa-q4"), Hn();
            break;
          }
          case "losa-rect":
          case "rectangular-slab": {
            We.clear(), Je("losa-rect"), Bn();
            break;
          }
          case "losa-plana":
          case "flat-slab": {
            We.clear(), Je("losa-plana"), Dn();
            break;
          }
          case "viga-alta":
          case "deep-beam": {
            We.clear(), Je("viga-alta"), jn();
            break;
          }
          case "muro-contencion":
          case "retaining-wall": {
            We.clear(), Je("muro-contencion"), Wn();
            break;
          }
          case "zapata":
          case "footing": {
            We.clear(), Je("zapata"), Yn();
            break;
          }
          case "placa-orificios":
          case "plate-holes":
          case "placa-base": {
            We.clear(), Je("placa-orificios"), Gn();
            break;
          }
          case "col-placa":
          case "columna-placa": {
            We.clear(), Je("col-placa"), Jn();
            break;
          }
          case "talud":
          case "slope": {
            We.clear(), Je("talud"), Vn();
            break;
          }
          case "eiffel":
          case "torre-eiffel": {
            We.clear(), Je("eiffel"), cs();
            break;
          }
          case "arco":
          case "arco-gateway": {
          ...
          case "puente-colgante": {
            We.clear(), Je("puente"), ps();
            break;
          }
          case "twisted":
          case "torre-twisted":
          case "turning-torso": {
            We.clear(), Je("twisted"), fs();
            break;
          }
          case "burj":
          case "burj-khalifa": {
          ...
          case "opera":
          case "sydney-opera": {
            We.clear(), Je("opera"), ms();
            break;
          }
          case "diagrid":
          case "gherkin": {
            We.clear(), Je("diagrid"), bs();
            break;
          }
          default:
      ...
      plateQ4(t = 10, o = 10, n = 16, l = 16, s = "simply-supported", d = -10, a = 0.2, c = 3e7, m = 0.3, r = 0) {
        ...
        return setTimeout(() => yt(), 50), Ye(), S;
      },
      set(t, o) {
        K[t] ? (K[t].val = o, console.log(`${t} = ${o}`), Ht(), he()) : tt[t] ? (tt[t].val = o, console.log(`${t} = ${o}`), Ht(), he()) : console.error(`Par\xE1metro "${t}" no encontrado. Disponibles: ${Object.keys({
          ...K,
          ...tt
        }).join(", ")}`);
      },
      ...
      setTheory(t) {
        typeof t == "string" && (t = {
          ...
          gruesa: 3,
          thick: 3
        }[t.toLowerCase()] || 3), kt = t, console.log(`Teor\xEDa de placa: ${{
          1: "Membrana",
          2: "Kirchhoff (delgada)",
          3: "Mindlin (gruesa)"
        }[kt] || kt}`), I.includes("placa") && (Ht(), he());
      },
      setBc(t) {
        const o = jo()[I];
        if (!o || o.length === 0) {
        ...
        gt = t, gt >= o.length && (gt = 0), console.log(`Apoyo: ${o[gt].label} \u2192 DOFs: [${o[gt].dofs.map((n) => n ? "1" : "0").join(",")}]`), Ht(), he();
      },
      help() {
        console.log(`
=== FEM Studio CLI ===
...
Util:     cad.info()  cad.clear()  cad.help()
      ...
      units(t, o) {
        t && (g = t), o && (j = o), z = uo(g, j);
        const n = ye.querySelector("#cad3d-force-unit"), l = ye.querySelector("#cad3d-length-unit");
        return n && (n.textContent = g), l && (l.textContent = j), I && Je(I), console.log(`Unidades: ${z.label} | E=${z.E.toExponential(3)} ${z.stress}`), z.id;
      },
      view(t) {
      },
      get mesh() {
    ...
    function Je(t) {
      ...
      if (t === "edificio") {
        ...
        X = Array(l).fill(z.defaultSpan), Q = Array(s).fill(z.defaultSpan * 0.8);
      }
      Ht(), setTimeout(() => {
        Fs(), he();
      }, 50);
    ...
    function B(t) {
      var _a, _b;
      return ((_a = K[t]) == null ? void 0 : _a.val) ?? ((_b = tt[t]) == null ? void 0 : _b.val) ?? 0;
    }
    function he() {
      switch (I) {
        case "truss":
        ...
        case "galpon":
          We.galpon(B("span"), B("length"), B("height"), B("archRise"), Math.round(B("xDiv")), Math.round(B("yDiv")));
          break;
        case "barra":
          ws();
          break;
    ...
    function Rn() {
      const t = B("Lx") || 15, o = B("Ly") || 10, n = B("meshSize") || 0.5, l = B("q") || -3, s = B("t") || 1, d = B("E") || 3e7, a = B("nu") || 0.3, c = d / (2 * (1 + a)), m = kt === 1 ? "Membrana" : kt === 2 ? "Kirchhoff" : "Mindlin", { nodes: r, elements: i, boundaryIndices: h } = Xt({
        points: [
          [
            0,
            0,
      ...
      try {
        ...
        const v = wo(r, i, e.elementInputs.val, u);
    ...
    function Hn() {
      ...
      return We.plateQ4(t, o, n, l, m, d, s, a, c, i);
    }
    function Bn() {
      const t = B("a") || 6, o = B("b") || 4, n = Math.round(B("nx") || 12), l = Math.round(B("ny") || 8), s = B("t") || 0.1, d = B("q") || -10, a = B("E") || 35e6, c = B("nu") || 0.15, r = {
        ...
        2: 1,
        3: 0
      }[kt] ?? 0, i = We.plateQ4(t, o, n, l, "simply-supported", d, s, a, c, r), h = a * s * s * s / (12 * (1 - c * c));
      let S = 0;
    ...
    function jn() {
      const t = B("L") || 4, o = B("H") || 2, n = B("t") || 0.1, l = B("E") || 2e7, s = B("nu") || 0.2, d = l / (2 * (1 + s)), a = B("q") || -100, c = B("b") || 0.8, m = B("meshSize") || 0.2, { nodes: r, elements: i, boundaryIndices: h } = Xt({
        points: [
          [
            0,
            0,
      ...
      try {
        const b = Ct(S, i, q, A), f = wo(S, i, A, b), y = S.map((k) => [
          k[0],
          0,
          k[1]
        ]);
    ...
    function Wn() {
      ...
      if (M === 0) {
        ...
        for (let _ = 0; _ < P.length; _++) {
          const { idx: te, y: ne } = P[_], ie = l + t - ne, ee = r * m * ie + r * v;
          let Z = s;
        ...
        if (M === 2) {
          ...
          b = ie.nodes, f = ie.elements;
          const ee = s * 0.4, Z = [];
          for (let oe = 0; oe < b.length; oe++) {
            const ze = b[oe][0], Be = b[oe][1];
            Math.abs(ze - n) < ee && Be >= l - ee && Z.push(oe);
          }
          Z.sort((oe, ze) => b[oe][1] - b[ze][1]);
          const se = [
            Z[0]
          ];
          for (let oe = 1; oe < Z.length; oe++) {
            const ze = b[Z[oe]][1] - b[se[se.length - 1]][1];
            Math.abs(ze) > s * 0.05 && se.push(Z[oe]);
          }
          Z.length = 0, Z.push(...se);
          ...
          for (let oe = 0; oe < Ne; oe++) {
            const ze = f[oe], Be = (b[ze[0]][0] + b[ze[1]][0] + b[ze[2]][0]) / 3, rt = (b[ze[0]][1] + b[ze[1]][1] + b[ze[2]][1]) / 3, xt = Be >= -$ && Be <= A && rt >= 0 && rt <= l, Mo = Be >= 0 && Be <= n && rt >= l && rt <= l + t, no = xt || Mo;
            if (_e.push(!no), !no) for (let Wt = 0; Wt < ze.length; Wt++) {
              const Jt = Se.get(ze[Wt]);
              Jt !== void 0 && (ze[Wt] = Jt);
            }
          }
          const ae = f.length;
          for (let oe = 0; oe < Z.length - 1; oe++) {
            const ze = Z[oe], Be = Z[oe + 1], rt = Se.get(ze), xt = Se.get(Be);
            f.push([
              Be,
              ze,
              rt,
          ...
          const xe = f.length - ae, Ee = /* @__PURE__ */ new Map(), pe = /* @__PURE__ */ new Map(), qe = /* @__PURE__ */ new Map(), Oe = /* @__PURE__ */ new Map(), nt = /* @__PURE__ */ new Map();
          for (let oe = 0; oe < Ne; oe++) _e[oe] ? (Ee.set(oe, i), pe.set(oe, i), Oe.set(oe, h), nt.set(oe, S), qe.set(oe, 1)) : (Ee.set(oe, d), pe.set(oe, d), Oe.set(oe, a), nt.set(oe, c), qe.set(oe, 1));
          for (let oe = ae; oe < f.length; oe++) Ee.set(oe, w), pe.set(oe, 0), Oe.set(oe, 0), nt.set(oe, x), qe.set(oe, 0);
          k = {
            elasticities: Ee,
          ...
          for (let oe = 0; oe < Ne; oe++) {
            if (!_e[oe]) continue;
            const ze = f[oe], Be = b[ze[0]], rt = b[ze[1]], xt = b[ze[2]], Mo = Math.abs((rt[0] - Be[0]) * (xt[1] - Be[1]) - (xt[0] - Be[0]) * (rt[1] - Be[1])) / 2, no = -m * Mo / 3;
            for (const Wt of ze) {
              const Jt = E.get(Wt) || [
                0,
                0,
          ...
          if (v > 0) {
            ...
            for (let ze = 0; ze < b.length; ze++) {
              const Be = b[ze][0], rt = b[ze][1];
              Math.abs(rt - P) < s * 0.1 && Be > n - 1e-6 && oe.push({
                idx: ze,
                x: Be
              });
            }
            oe.sort((ze, Be) => ze.x - Be.x);
            for (let ze = 0; ze < oe.length; ze++) {
              let Be = s;
              ze > 0 && ze < oe.length - 1 ? Be = (oe[ze + 1].x - oe[ze - 1].x) / 2 : ze === 0 && oe.length > 1 ? Be = (oe[1].x - oe[0].x) / 2 : ze === oe.length - 1 && oe.length > 1 && (Be = (oe[ze].x - oe[ze - 1].x) / 2);
              const rt = -v * Be, xt = E.get(oe[ze].idx) || [
                0,
                0,
                0,
                0,
              ...
              xt[1] += rt, E.set(oe[ze].idx, xt);
            }
          }
          console.log(`  Interfaz Goodman: ${Z.length} nodos interfaz, ${xe} elem interfaz, kn=${w}, ks=${x}`);
        } else {
          const _ = [
            [
              -$,
          ...
          const ie = (ae) => {
            const xe = (b[ae[0]][0] + b[ae[1]][0] + b[ae[2]][0]) / 3, Ee = (b[ae[0]][1] + b[ae[1]][1] + b[ae[2]][1]) / 3, pe = xe >= -$ && xe <= A && Ee >= 0 && Ee <= l, qe = xe >= 0 && xe <= n && Ee >= l && Ee <= l + t;
            return pe || qe;
          }, ee = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), se = /* @__PURE__ */ new Map(), Se = /* @__PURE__ */ new Map(), Ne = /* @__PURE__ */ new Map(), _e = [];
          for (let ae = 0; ae < f.length; ae++) {
            const xe = ie(f[ae]);
            _e.push(!xe), xe ? (ee.set(ae, d), Z.set(ae, d), Se.set(ae, a), Ne.set(ae, c), se.set(ae, 1)) : (ee.set(ae, i), Z.set(ae, i), Se.set(ae, h), Ne.set(ae, S), se.set(ae, 1));
          }
          k = {
            elasticities: ee,
          ...
          for (let ae = 0; ae < b.length; ae++) {
            const xe = b[ae][0], Ee = b[ae][1];
            Math.abs(Ee) < 1e-6 ? y.set(ae, [
              true,
              true,
              true,
              true,
          ...
          for (let ae = 0; ae < f.length; ae++) {
            if (!_e[ae]) continue;
            const xe = f[ae], Ee = b[xe[0]], pe = b[xe[1]], qe = b[xe[2]], Oe = Math.abs((pe[0] - Ee[0]) * (qe[1] - Ee[1]) - (qe[0] - Ee[0]) * (pe[1] - Ee[1])) / 2, nt = -m * Oe / 3;
            for (const oe of xe) {
              const ze = E.get(oe) || [
                0,
                0,
          ...
          if (v > 0) {
            ...
            for (let xe = 0; xe < b.length; xe++) {
              const Ee = b[xe][0], pe = b[xe][1];
              Math.abs(pe - P) < s * 0.1 && Ee > n - 1e-6 && ae.push({
                idx: xe,
                x: Ee
              });
            }
            ae.sort((xe, Ee) => xe.x - Ee.x);
            for (let xe = 0; xe < ae.length; xe++) {
              let Ee = s;
              xe > 0 && xe < ae.length - 1 ? Ee = (ae[xe + 1].x - ae[xe - 1].x) / 2 : xe === 0 && ae.length > 1 ? Ee = (ae[1].x - ae[0].x) / 2 : xe === ae.length - 1 && ae.length > 1 && (Ee = (ae[xe].x - ae[xe - 1].x) / 2);
              const pe = -v * Ee, qe = E.get(ae[xe].idx) || [
                0,
                0,
                0,
                0,
      ...
      if (M === 3) {
        ...
        b = L.nodes, f = L.elements;
        for (let ie = 0; ie < b.length; ie++) Math.abs(b[ie][1]) < 1e-6 && y.set(ie, [
          true,
          true,
          true,
          true,
        ...
        for (let ie = 0; ie < b.length; ie++) {
          const ee = b[ie][0], Z = b[ie][1];
          Math.abs(ee - n) < s * 0.6 && Z >= l - 1e-6 && ne.push({
            idx: ie,
            y: Z
          });
        }
        ne.sort((ie, ee) => ie.y - ee.y);
        for (let ie = 0; ie < ne.length; ie++) {
          const { idx: ee, y: Z } = ne[ie], se = Math.max(0, P - Z);
          if (se <= 0 || Z < te - 1e-6) continue;
          const Se = Math.min(se, _), Ne = p * Se;
          let _e = s;
          ie > 0 && ie < ne.length - 1 ? _e = (ne[ie + 1].y - ne[ie - 1].y) / 2 : ie === 0 && ne.length > 1 ? _e = (ne[1].y - ne[0].y) / 2 : ie === ne.length - 1 && ne.length > 1 && (_e = (ne[ie].y - ne[ie - 1].y) / 2);
          const ae = Ne * _e;
        ...
        k = {
          elasticities: new Map(f.map((ie, ee) => [
            ee,
            d
          ])),
          elasticitiesOrthogonal: new Map(f.map((ie, ee) => [
            ee,
            d
          ])),
          thicknesses: new Map(f.map((ie, ee) => [
            ee,
            n
          ])),
          poissonsRatios: new Map(f.map((ie, ee) => [
            ee,
            a
          ])),
          shearModuli: new Map(f.map((ie, ee) => [
            ee,
            c
          ]))
        };
      ...
      try {
        const L = Ct(b, f, O, k), P = f.filter((se) => se.length === 3), _ = {};
        for (const se of Object.keys(k)) {
          const Se = k[se];
          if (Se && Se instanceof Map) {
            const Ne = /* @__PURE__ */ new Map();
            let _e = 0;
            for (let ae = 0; ae < f.length; ae++) f[ae].length === 3 && (Se.has(ae) && Ne.set(_e, Se.get(ae)), _e++);
            _[se] = Ne;
          }
        }
        const te = wo(b, P, _, L), ne = b.map((se) => [
          se[0],
          0,
          se[1]
        ]);
        ...
        y.forEach((se, Se) => ie.set(Se, se));
        const ee = /* @__PURE__ */ new Map();
        E.forEach((se, Se) => ee.set(Se, [
          se[0],
          se[2],
          se[1],
          se[3],
    ...
    function Yn() {
      ...
      try {
        ...
        y.nodeResults.forEach((te, ne) => {
          const ie = te.x, ee = te.y;
          (ie < 1e-6 || ie > t - 1e-6 || ee < 1e-6 || ee > o - 1e-6) && L.set(ne, [
            false,
            false,
            true,
            false,
        ...
        if (P.set(k + 4, [
          ...
          const te = y.elementResults.length, ne = /* @__PURE__ */ new Map(), ie = /* @__PURE__ */ new Map(), ee = /* @__PURE__ */ new Map();
          y.elementResults.forEach((Z, se) => {
            ne.set(se, [
              Z.Mxx,
              Z.Mxx,
              Z.Mxx
    ...
    function Jn() {
      const t = B("colB") || 0.3, o = B("colH") || 0.3, n = B("colT") || 8e-3, l = B("colLen") || 1.5, s = B("Lx") || 0.45, d = B("Ly") || 0.45, a = B("tPlaca") || 0.025, c = B("dBolt") || 0.022, m = B("sx") || 0.32, r = B("sy") || 0.32, i = Math.round(B("nSubColV") || 6), h = Math.round(B("nSubColH") || 4), S = Math.round(B("nSubPlaca") || 10), w = B("E") || 2e8, x = B("nu") || 0.3, p = w / (2 * (1 + x)), u = B("P") || -300, v = s / 2, M = d / 2, $ = c / 2, A = t / 2, q = o / 2, b = [], f = [], y = S, E = s / y, k = d / y, O = (pe, qe) => qe * (y + 1) + pe;
      for (let pe = 0; pe <= y; pe++) for (let qe = 0; qe <= y; qe++) b.push([
        qe * E,
        pe * k,
        0
      ]);
      const F = [
        ...
        for (const [Oe, nt] of F) if ((pe - Oe) * (pe - Oe) + (qe - nt) * (qe - nt) < $ * $) return true;
        return false;
      }, P = f.length;
      for (let pe = 0; pe < y; pe++) for (let qe = 0; qe < y; qe++) {
        const Oe = (qe + 0.5) * E, nt = (pe + 0.5) * k;
        L(Oe, nt) || f.push([
          O(qe, pe),
          O(qe + 1, pe),
          O(qe + 1, pe + 1),
      ...
      const _ = f.length - P, te = i, ne = h, ie = [
        [
          v - A,
          M - q
        ],
        ...
        for (let Oe = 0; Oe < (y + 1) * (y + 1); Oe++) if (Math.abs(b[Oe][0] - pe) < E * 0.3 && Math.abs(b[Oe][1] - qe) < k * 0.3 && Math.abs(b[Oe][2]) < 1e-6) return Oe;
        return -1;
      };
      for (const [pe, qe] of Z) {
        const [Oe, nt] = ie[pe], [oe, ze] = ie[qe], Be = [];
        for (let rt = 0; rt <= te; rt++) {
          const xt = [], Mo = rt / te * l;
          for (let no = 0; no <= ne; no++) {
            const Wt = no / ne, Jt = Oe + Wt * (oe - Oe), $n = nt + Wt * (ze - nt);
            if (rt === 0) {
              const Vt = se(Jt, $n);
              if (Vt >= 0) {
                xt.push(Vt);
            ...
            let Mn = -1;
            for (let Vt = 0; Vt < b.length; Vt++) if (Math.abs(b[Vt][0] - Jt) < 1e-6 && Math.abs(b[Vt][1] - $n) < 1e-6 && Math.abs(b[Vt][2] - Mo) < 1e-6) {
              Mn = Vt;
              break;
            }
            Mn >= 0 ? xt.push(Mn) : (xt.push(b.length), b.push([
              Jt,
              $n,
              Mo
            ]));
      ...
      const Se = f.length - ee, Ne = /* @__PURE__ */ new Map();
      for (let pe = 0; pe < (y + 1) * (y + 1); pe++) {
        const qe = b[pe][0], Oe = b[pe][1];
        for (const [nt, oe] of F) {
          const ze = Math.sqrt((qe - nt) * (qe - nt) + (Oe - oe) * (Oe - oe));
          ze >= $ * 0.5 && ze <= $ * 2 && Ne.set(pe, [
            true,
            true,
            true,
            true,
      ...
      const xe = u / Math.max(ae.length, 1);
      ...
      for (let pe = ee; pe < ee + Se; pe++) Ee.elasticities.set(pe, w), Ee.poissonsRatios.set(pe, x), Ee.thicknesses.set(pe, n), Ee.shearModuli.set(pe, p);
      ...
      try {
        ...
        e.nodes.val = b, e.elements.val = f, pe && e.deformOutputs && (e.deformOutputs.val = pe), e.nodeInputs && (e.nodeInputs.val = {
          supports: Ne,
          loads: _e
        }), e.elementInputs && (e.elementInputs.val = Ee), qe && e.analyzeOutputs && (e.analyzeOutputs.val = qe);
        let Oe = 0;
        (pe == null ? void 0 : pe.deformations) && pe.deformations.forEach((nt) => {
          const oe = Math.sqrt(nt[0] * nt[0] + nt[1] * nt[1] + nt[2] * nt[2]);
          Oe = Math.max(Oe, oe);
    ...
    function io(t) {
      const o = Ln.find((l) => l.id === Y.forceId), n = Eo.find((l) => l.id === Y.lengthId);
    ...
    function ks() {
      const t = io(20594), o = io(58840), n = Math.max(1, Math.round((o - t) / 40));
      return [
        Math.round(t),
        Math.round(o),
        n
    ...
    function Xn(t, o, n, l, s) {
      const d = Te.steelVigaType, a = d === 0 ? Wo() : Yo();
      if (Te.vigaMat === 0) {
        ...
        t.on("change", (c) => {
          ...
          r && (o[parseInt(r[1])].b = pt(c.value), he()), i && (o[parseInt(i[1])].h = pt(c.value), he());
        });
      } else if (d <= 1) {
        for (let c = 0; c < o.length; c++) {
          const m = {};
        ...
        t.on("change", (c) => {
          ...
          r && (o[parseInt(r[1])].profileIdx = c.value, he());
        });
      } else if (d === 2) {
        for (let c = 0; c < o.length; c++) {
          const m = o[c], r = {}, i = `${n}${c}`;
        ...
        t.on("change", (c) => {
          ...
          for (let r = 0; r < o.length; r++) {
            const i = `${n}${r}`;
            m === `bf${i}` && (o[r].bf = pt(c.value), he()), m === `h${i}` && (o[r].hf = pt(c.value), he()), m === `tf${i}` && (o[r].tf = pt(c.value), he()), m === `tw${i}` && (o[r].tw = pt(c.value), he());
          }
        });
      } else {
        for (let c = 0; c < o.length; c++) {
        ...
        t.on("change", (c) => {
          ...
          for (let r = 0; r < o.length; r++) {
            const i = `${n}${r}`;
            m === `bc${i}` && (o[r].bc = pt(c.value), he()), m === `hc${i}` && (o[r].hc = pt(c.value), he()), m === `t${i}` && (o[r].t = pt(c.value), he());
          }
        });
      }
    }
    function ho() {
      ...
      if (!o) return;
      o.style.display = "";
      const n = z, l = Math.round(((_a = K.nPisos) == null ? void 0 : _a.val) ?? 3), s = Es(), d = ks(), a = X.length || 1, c = Q.length || 1;
      for (; Te.perFloor.length < l; ) {
        const b = Te.perFloor.length > 0 ? JSON.parse(JSON.stringify(Te.perFloor[Te.perFloor.length - 1])) : Yt(a, c);
        Te.perFloor.push(b);
      }
      ...
      if (bt.addBinding(m, "colMat", {
        ...
        bt.addBinding(b, "forma", {
          ...
          Te.colShape = y.value, ho(), he();
        });
        const f = {
          fc: +io(Te.fc).toFixed(1)
        };
        bt.addBinding(f, "fc", {
          min: d[0],
          max: d[1],
          ...
          var _a2;
          ((_a2 = y.target) == null ? void 0 : _a2.key) === "fc" && (Te.fc = tn(y.value), he());
        });
      } else if (Te.colMat === 1) {
        const b = {
      ...
      if (bt.addBinding(r, "vigaMat", {
        ...
        bt.addBinding(b, "vigaType", {
          ...
          Te.steelVigaType = f.value, ho(), he();
        });
      }
      const i = Te.steelColType === 0 ? Wo() : Yo();
      Te.steelVigaType === 0 ? Wo() : Yo();
      const h = j === "m" ? [
        5e-3,
        0.1,
        1e-3
      ...
      for (let b = 0; b < l; b++) {
        ...
        if (Te.colMat === 0) if (Te.colShape === 1) {
          ...
          y.addBinding(E, "dCol", {
            ...
            var _a2;
            ((_a2 = k.target) == null ? void 0 : _a2.key) === "dCol" && (f.dCol = pt(k.value), he());
          });
        } else {
          const E = {
          ...
          y.addBinding(E, "bCol", {
            ...
            var _a2, _b;
            ((_a2 = k.target) == null ? void 0 : _a2.key) === "bCol" && (f.bCol = pt(k.value), he()), ((_b = k.target) == null ? void 0 : _b.key) === "hCol" && (f.hCol = pt(k.value), he());
          });
        }
          ...
          y.addBinding(E, "bf", {
            ...
            var _a2, _b, _c, _d;
            ((_a2 = k.target) == null ? void 0 : _a2.key) === "bf" && (f.colBf = pt(k.value), he()), ((_b = k.target) == null ? void 0 : _b.key) === "h" && (f.colHf = pt(k.value), he()), ((_c = k.target) == null ? void 0 : _c.key) === "tf" && (f.colTf = pt(k.value), he()), ((_d = k.target) == null ? void 0 : _d.key) === "tw" && (f.colTw = pt(k.value), he());
          });
        } else {
          const E = {
          ...
          y.addBinding(E, "bc", {
            ...
            var _a2, _b, _c;
            ((_a2 = k.target) == null ? void 0 : _a2.key) === "bc" && (f.colBc = pt(k.value), he()), ((_b = k.target) == null ? void 0 : _b.key) === "hc" && (f.colHc = pt(k.value), he()), ((_c = k.target) == null ? void 0 : _c.key) === "t" && (f.colT = pt(k.value), he());
          });
        }
        else {
          const E = {
            ...
            hc: +dt(f.colHc ?? 0.3).toFixed(3),
            t: +dt(f.colT ?? 0.01).toFixed(3),
            Es: +io(f.colEs ?? 2e8).toFixed(0),
            nuS: f.colNuS ?? 0.3,
            fc: +io(f.colFc ?? 28e3).toFixed(1),
            nuC: f.colNuC ?? 0.2
          };
          y.addBinding(E, "bc", {
            min: s[0],
          ...
          const k = +io(1e8).toFixed(0), O = +io(3e8).toFixed(0), F = Math.max(1, Math.round((O - k) / 200));
          y.addBinding(E, "Es", {
            min: k,
            max: O,
            step: F,
            ...
            ((_a2 = L.target) == null ? void 0 : _a2.key) === "bc" && (f.colBc = pt(L.value), he()), ((_b = L.target) == null ? void 0 : _b.key) === "hc" && (f.colHc = pt(L.value), he()), ((_c = L.target) == null ? void 0 : _c.key) === "t" && (f.colT = pt(L.value), he()), ((_d = L.target) == null ? void 0 : _d.key) === "Es" && (f.colEs = tn(L.value), he()), ((_e = L.target) == null ? void 0 : _e.key) === "nuS" && (f.colNuS = L.value, he()), ((_f = L.target) == null ? void 0 : _f.key) === "fc" && (f.colFc = tn(L.value), he()), ((_g = L.target) == null ? void 0 : _g.key) === "nuC" && (f.colNuC = L.value, he());
          });
        }
      ...
      S.addBinding(w, "activar", {
        ...
        var _a2, _b, _c;
        ((_a2 = b.target) == null ? void 0 : _a2.key) === "activar" && (ve = b.value, he()), ((_b = b.target) == null ? void 0 : _b.key) === "direccion" && (Ke = b.value === 0 ? "x" : "y", he()), ((_c = b.target) == null ? void 0 : _c.key) === "cantidad" && (je = Math.round(b.value), he());
      }), bt.addBlade({
        view: "separator"
      });
      ...
      x.addBinding(p, "activar", {
        ...
        var _a2, _b, _c, _d;
        ((_a2 = b.target) == null ? void 0 : _a2.key) === "activar" && (Ue = b.value, he()), ((_b = b.target) == null ? void 0 : _b.key) === "espesor" && (Ze = pt(b.value), he()), ((_c = b.target) == null ? void 0 : _c.key) === "subdivX" && (ct = Math.round(b.value), he()), ((_d = b.target) == null ? void 0 : _d.key) === "subdivY" && (zt = Math.round(b.value), he());
      }), bt.addBlade({
        view: "separator"
      });
      ...
      u.addBinding(v, "espesor", {
        ...
        var _a2, _b, _c;
        ((_a2 = b.target) == null ? void 0 : _a2.key) === "espesor" && (ut = pt(b.value), he()), ((_b = b.target) == null ? void 0 : _b.key) === "subdivH" && (be = Math.round(b.value), he()), ((_c = b.target) == null ? void 0 : _c.key) === "subdivW" && (Le = Math.round(b.value), he());
      });
      const M = X.length || 1, $ = Q.length || 1, A = M + 1, q = $ + 1;
      if (M > 0) {
        const b = u.addFolder({
        ...
        for (let f = 0; f < M; f++) for (let y = 0; y < q; y++) {
          const E = `wx_${f}_${y}`, k = He.some((L) => L.dir === "x" && L.bay === f && L.axisIdx === y), O = {};
          O[E] = k;
          ...
          b.addBinding(O, E, {
            ...
            }) : He = He.filter((P) => !(P.dir === "x" && P.bay === f && P.axisIdx === y)), he();
          });
        }
      }
      if ($ > 0) {
        ...
        for (let f = 0; f < $; f++) for (let y = 0; y < A; y++) {
          const E = `wy_${f}_${y}`, k = He.some((L) => L.dir === "y" && L.bay === f && L.axisIdx === y), O = {};
          O[E] = k;
          ...
          b.addBinding(O, E, {
            ...
            }) : He = He.filter((P) => !(P.dir === "y" && P.bay === f && P.axisIdx === y)), he();
          });
        }
      }
      if (He.length > 0) {
    ...
    function Ht() {
      ...
      if (n) {
        ...
        for (const a of n) {
          ...
          d.addBinding(c, "min", {
            ...
            K[a.key] && (K[a.key].min = c.min, K[a.key].max = c.max, K[a.key].val < c.min && (K[a.key].val = c.min), K[a.key].val > c.max && (K[a.key].val = c.max)), Ht(), he();
          });
        }
        ge.on("change", (a) => {
          var _a;
          ...
          if (c && K[c]) {
            if (K[c].val = a.value, I === "edificio" && (c === "nVanosX" || c === "nVanosY" || c === "nPisos")) {
              if (c === "nVanosX" || c === "nVanosY") {
                const m = Math.round(K.nVanosX.val), r = Math.round(K.nVanosY.val);
                for (; X.length < m; ) X.push(X[X.length - 1] ?? z.defaultSpan);
                for (X.length > m && (X.length = m); Q.length < r; ) Q.push(Q[Q.length - 1] ?? z.defaultSpan * 0.8);
      ...
      if (l && l.length > 0) {
        ...
        for (const a of l) Rt.addBinding(s, a.key, {
          min: tt[a.key].min,
          max: tt[a.key].max,
          step: tt[a.key].step,
          label: tt[a.key].label
        });
        const d = Rt.addFolder({
          title: "Rangos",
          expanded: false
        });
        for (const a of l) {
          ...
          d.addBinding(c, "min", {
            ...
            tt[a.key] && (tt[a.key].min = c.min, tt[a.key].max = c.max, tt[a.key].val < c.min && (tt[a.key].val = c.min), tt[a.key].val > c.max && (tt[a.key].val = c.max)), Ht(), he();
          });
        }
        Rt.on("change", (a) => {
          var _a;
          const c = (_a = a.target) == null ? void 0 : _a.key;
          if (c && tt[c]) {
            if (tt[c].val = a.value, e.nodeInputs) {
      ...
      window.__cad = {
        setParam: (s, d) => {
          if (K[s]) K[s].val = d, he(), Ht();
          else if (tt[s]) {
            if (tt[s].val = d, e.nodeInputs) {
        ...
        getParams: () => {
          const s = {};
          for (const d in K) s[d] = K[d].val;
          for (const d in tt) s[d] = tt[d].val;
          return s;
        },
        setGenerator: Je
      };
  ...
  `, document.head.appendChild(Kn), ta() === "light" && document.documentElement.classList.add("awatif-light"), oa((t) => {
      t === "light" ? document.documentElement.classList.add("awatif-light") : document.documentElement.classList.remove("awatif-light"), I && yt(true);
    }), ye.innerHTML = `
  ...
  `;
    ...
    function zs() {
      ...
      if (m && m.size > 0 && (a.push(`## REACTIONS (${m.size} supports)`), a.push("# node          Rx           Ry           Rz           Mx           My           Mz"), m.forEach((r, i) => {
        ...
        a.push("## CLI COMMAND");
        const r = Object.entries(K).map(([i, h]) => `${i}=${h.val}`).join(" ");
...
`);
    ...
    `, document.body.appendChild(ht), (_a = ht.querySelector("#export-close")) == null ? void 0 : _a.addEventListener("click", () => {
        ht == null ? void 0 : ht.remove(), ht = null, zo = false;
        ...
        zo = !zo, zo ? (o.style.display = "none", n.textContent = "\u25A2", n.title = "Restaurar", ht.style.width = "auto") : (o.style.display = "flex", n.textContent = "\u25AC", n.title = "Minimizar", ht.style.width = "720px");
    ...
    function nn() {
      ...
      if (!(t.length === 0 || o.length === 0) && !(!n.supports || n.supports.size === 0) && !(!l.densities || l.densities.size === 0)) try {
        ...
        if (d.frequencies && d.frequencies.length > 0) {
          ...
          const { extent: a } = Zt(), c = (_a = d.modeShapes) == null ? void 0 : _a[0];
          if (c) {
            let r = 0;
            ...
            ce = r > 1e-12 ? a * 0.05 / r : 1;
          }
          const m = `${I} \u2014 ${t.length}n ${o.length}e`;
          Me.render(d, {
            title: m
          }), Me.div.style.display = "", To(), console.log(`Modal: ${d.frequencies.length} modos. f\u2081 = ${d.frequencies[0].toFixed(4)} Hz`);
        }
      } catch (s) {
    ...
    function sn() {
      $e && (cancelAnimationFrame($e), $e = 0), J.length > 0 && (e.nodes.val = J.map((t) => [
        ...t
      ])), Me.div.style.display = "none", V = null;
    }
    function To() {
      var _a;
      if ($e && cancelAnimationFrame($e), !(V == null ? void 0 : V.modeShapes) || !J.length) return;
      const t = V.modeShapes[fe];
      if (!t) return;
      const o = ((_a = V.frequencies) == null ? void 0 : _a[fe]) || 1, n = Math.max(0.5, Math.min(3, o * 0.1)), l = performance.now(), s = J.length, d = e.elements.rawVal, { extent: a } = Zt(), c = ye.querySelector("#cad3d-modal-scale"), m = c && parseFloat(c.value) || 5;
      let r = 0;
      for (let $ = 0; $ < s; $++) {
        const A = t[$ * 6] || 0, q = t[$ * 6 + 1] || 0, b = t[$ * 6 + 2] || 0;
        r = Math.max(r, Math.sqrt(A * A + q * q + b * b));
      }
      const i = r > 1e-12 ? a * m / 100 / r : 1, h = ot();
      if (!h) return;
      ...
      function M() {
        ...
        if (S) {
          ...
          b && b.array.length === p.length ? (b.array.set(p), b.needsUpdate = true) : q.setAttribute("position", new po(p.slice(), 3));
        }
        if (w) {
          ...
          b && b.array.length === v.length ? (b.array.set(v), b.needsUpdate = true) : q.setAttribute("position", new po(v.slice(), 3));
        }
        if (x) {
          const q = [];
          ...
          if (q.length > 0) {
            ...
            y && y.array.length === f.length ? (y.array.set(f), y.needsUpdate = true) : b.setAttribute("position", new po(f, 3));
          }
        }
        h.render(), $e = requestAnimationFrame(M);
      }
    ...
    function an() {
      ...
      if (!n.loads || n.loads.size === 0) {
        ...
        if (v !== 0 || M !== 0) {
          ...
          _.forEach((te) => {
            if (v !== 0) {
              ...
              for (const ie of te) if (q(t[ie][0]) === L) {
                const ee = q(t[ie][1]);
                ne.has(ee) || (ne.add(ee), y.add(ie));
              }
            }
            if (M !== 0) {
              const ne = /* @__PURE__ */ new Set();
              for (const ie of te) if (q(t[ie][1]) === P) {
                const ee = q(t[ie][0]);
                ne.has(ee) || (ne.add(ee), E.add(ie));
              }
            }
          });
        }
        ...
        for (let L = 0; L < o.length; L++) {
          ...
          if (!(Math.abs(_) < 1e-15)) {
            if (P.length === 2) {
              const te = ((_b = l.areas) == null ? void 0 : _b.get(L)) ?? 0, ne = t[P[0]], ie = t[P[1]], ee = Math.sqrt((ie[0] - ne[0]) ** 2 + (ie[1] - ne[1]) ** 2 + (ie[2] - ne[2]) ** 2), se = -(_ * te * ee * k) / 2;
              O.set(P[0], (O.get(P[0]) ?? 0) + se), O.set(P[1], (O.get(P[1]) ?? 0) + se);
            } else if (P.length >= 3) {
              const te = ((_c = l.thicknesses) == null ? void 0 : _c.get(L)) ?? 0;
              let ne = 0;
              if (P.length === 3) {
                const [Z, se, Se] = P.map((Ne) => t[Ne]);
                ne = 0.5 * Math.abs((se[0] - Z[0]) * (Se[1] - Z[1]) - (Se[0] - Z[0]) * (se[1] - Z[1]));
              } else if (P.length === 4) {
                const [Z, se, Se, Ne] = P.map((_e2) => t[_e2]);
                if (ne = 0.5 * Math.abs((se[0] - Z[0]) * (Se[1] - Z[1]) - (Se[0] - Z[0]) * (se[1] - Z[1])) + 0.5 * Math.abs((Se[0] - Z[0]) * (Ne[1] - Z[1]) - (Ne[0] - Z[0]) * (Se[1] - Z[1])), ne < 1e-10) {
                  const _e2 = [
                    se[0] - Z[0],
                    se[1] - Z[1],
                    se[2] - Z[2]
                  ...
                  ne = Math.sqrt(xe[0] ** 2 + xe[1] ** 2 + xe[2] ** 2);
                }
              }
              const ee = -(_ * te * ne * k) / P.length;
              for (const Z of P) O.set(Z, (O.get(Z) ?? 0) + ee);
            }
          }
        }
        const F = /* @__PURE__ */ new Set();
        ...
        for (const L of A) {
          const P = y.has(L) ? v : 0, _ = E.has(L) ? M : 0, te = O.get(L) ?? 0, ne = F.has(L) ? u : 0, ie = te + ne;
          (P !== 0 || _ !== 0 || Math.abs(ie) > 1e-10) && $.set(L, [
            P,
            _,
            ie,
            0,
      ...
      try {
        ...
        if (x) {
          ...
          const A = performance.now(), q = wo(t, o, l, x), b = performance.now() - A;
      ...
      window.__femLog = S, console.log(`FEM Solver: ${t.length}n ${o.length}e \u2192 ${(performance.now() - s).toFixed(0)}ms`), de && setTimeout(() => nn(), 50);
    }
    function ln(t, o) {
    ...
    function Ut() {
      ...
      if ((I === "edificio" || I === "frame") && le.size > 0) {
        ...
        for (let p = 0; p < t.length; p++) {
          ...
          if (Pt.has(p)) {
            const y = 4700 * Math.sqrt(c / 1e3) * 1e3, E = 0.2;
            n.elasticities.set(p, y), n.poissonsRatios.set(p, E), n.thicknesses.set(p, Ze), n.shearModuli.set(p, y / (2 * (1 + E))), n.densities.set(p, 24 / 9.80665);
            continue;
          }
          const u = le.has(p), v = Pe.get(p) ?? 0, M = m[v] ?? m[0] ?? {
            bCol: 0.4,
            hCol: 0.4,
            dCol: 0.4
          };
          let $, A, q, b;
          if (u) if (s === 0) A = r, q = i, b = h, $ = a === 1 ? Un(M.dCol) : ln(M.bCol, M.hCol), n.sectionShapes.set(p, a === 1 ? {
            type: "circ",
            d: M.dCol
          } : {
            type: "rect",
            ...
            if (y <= 1) {
              const E = lo[M.colProfileIdx] ?? lo[0];
              $ = {
                A: E.A,
                Iz: E.Iz,
                Iy: E.Iy,
            ...
            const y = st.get(p), E = y ? y.dir === "x" ? M.vigasX : M.vigasY : [], k = y ? E[y.bay] ?? E[0] ?? at() : at();
            if (d === 0) A = r, q = i, b = h, $ = ln(k.b, k.h), n.sectionShapes.set(p, {
              type: "rect",
              b: k.b,
              h: k.h
            });
              ...
              if (O <= 1) {
                const F = lo[k.profileIdx ?? 0] ?? lo[0];
                $ = {
                  A: F.A,
                  Iz: F.Iz,
                  Iy: F.Iy,
          ...
          const f = me.get(p);
          if (f) {
            if ((f.material ?? 1) === 0 ? (A = r, q = i, b = h) : (A = S, q = w, b = x), f.secType === "rect" && f.b && f.h) $ = ln(f.b, f.h), n.sectionShapes.set(p, {
              type: "rect",
              b: f.b,
              h: f.h
            });
    ...
    setTimeout(() => {
      ...
      (_a = ye.querySelector("#cad3d-toggle")) == null ? void 0 : _a.addEventListener("click", (u) => {
        u.stopPropagation(), ye.classList.add("collapsed");
      }), (_b = ye.querySelector("#cad3d-expand")) == null ? void 0 : _b.addEventListener("click", (u) => {
        u.stopPropagation(), ye.classList.remove("collapsed");
      }), ye.querySelectorAll("[data-ex]").forEach((u) => {
        u.addEventListener("click", (v) => {
          v.stopPropagation();
          const M = u.dataset.ex;
          Zn(M), We.example(M);
        });
      }), ye.querySelectorAll("[data-view]").forEach((u) => {
        u.addEventListener("click", (v) => {
          v.stopPropagation();
          const M = u.dataset.view;
          Qt(M), ye.querySelectorAll("[data-view]").forEach(($) => $.classList.remove("view-active")), u.classList.add("view-active");
        });
      }), (_c = ye.querySelector("#cad3d-btn-clear")) == null ? void 0 : _c.addEventListener("click", (u) => {
        u.stopPropagation(), I = "", $s.val = false, Is(), We.clear();
      }), (_d = ye.querySelector("#cad3d-select")) == null ? void 0 : _d.addEventListener("click", (u) => {
        var _a2;
        u.stopPropagation(), _t && (_t = false, co()), Bt && Oo(), Tt = !Tt, (_a2 = ye.querySelector("#cad3d-select")) == null ? void 0 : _a2.classList.toggle("inspect-active", Tt);
        const M = ot();
        M && (M.controls.enabled = !Tt), Tt || _o();
      }), (_e = ye.querySelector("#cad3d-draw")) == null ? void 0 : _e.addEventListener("click", (u) => {
        var _a2;
        u.stopPropagation(), _t && (_t = false, co()), Tt && _o(), Bt = !Bt, (_a2 = ye.querySelector("#cad3d-draw")) == null ? void 0 : _a2.classList.toggle("inspect-active", Bt), Bt ? Ps() : Oo();
      }), (_f = ye.querySelector("#cad3d-inspect")) == null ? void 0 : _f.addEventListener("click", (u) => {
        var _a2;
        u.stopPropagation(), Tt && _o(), Bt && Oo(), _t = !_t, (_a2 = ye.querySelector("#cad3d-inspect")) == null ? void 0 : _a2.classList.toggle("inspect-active", _t), _t || co();
      }), (_g = ye.querySelector("#cad3d-export")) == null ? void 0 : _g.addEventListener("click", (u) => {
      ...
      function s(u) {
        le = /* @__PURE__ */ new Set(), Ie = /* @__PURE__ */ new Set(), Pe = /* @__PURE__ */ new Map(), st = /* @__PURE__ */ new Map();
        const v = /* @__PURE__ */ new Map();
        ...
        for (let k = 0; k < u.elementTypes.length; k++) {
          ...
          Pe.set(k, L), O === "COLUMN" || O === "BRACE" ? le.add(k) : Ie.add(k);
        }
        I = "edificio";
        ...
        Ve = A, Xe = q, setTimeout(() => {
          yt(), St(A, q, y, b, f), Ms(u.stories, A, q), dn(), pn();
        }, 100);
        const E = {
          COLUMN: 0,
          BEAM: 0,
        ...
        console.log(`E2K grids: X=[${b.join(",")}] Y=[${f.join(",")}]`), console.log(`E2K stories: ${u.stories.map((k) => `${k.name}@${k.elev.toFixed(2)}`).join(", ")}`), console.log(`E2K elements: ${E.COLUMN} columns, ${E.BEAM} beams, ${E.BRACE} braces`), Ye();
      }
      function d(u, v) {
        const M = new Blob([
          u
      ...
      a && (a.value = g, a.addEventListener("change", (u) => {
        u.stopPropagation(), g = a.value, z = uo(g, j), I && Je(I);
      }));
      const c = ye.querySelector("#cad3d-length-unit");
      c && (c.value = j, c.addEventListener("change", (u) => {
        u.stopPropagation(), j = c.value, z = uo(g, j), I && Je(I);
      })), ye.querySelectorAll("[data-preset]").forEach((u) => {
        u.addEventListener("click", (v) => {
          v.stopPropagation();
          const M = u.dataset.preset, $ = R[M];
          $ && (g = $.force, j = $.length, Y = $.stress, z = uo(g, j), a && (a.value = g), c && (c.value = j), ye.querySelectorAll("[data-preset]").forEach((A) => {
            A.classList.toggle("active", A.dataset.preset === M);
          }), I && Je(I), console.log(`Preset: ${M} \u2192 ${g}+${j}, stress: ${Y.label}`));
        });
      }), (_h = ye.querySelector("#cad3d-log")) == null ? void 0 : _h.addEventListener("click", (u) => {
        u.stopPropagation(), js();
      }), (_i = ye.querySelector("#cad3d-pushover")) == null ? void 0 : _i.addEventListener("click", (u) => {
        u.stopPropagation(), Ws();
      }), (_j = ye.querySelector("#cad3d-nonlinear")) == null ? void 0 : _j.addEventListener("click", (u) => {
        u.stopPropagation(), Gs();
      }), (_k = ye.querySelector("#cad3d-fem-solver")) == null ? void 0 : _k.addEventListener("click", (u) => {
        u.stopPropagation(), Vs();
      }), (_l = ye.querySelector("#cad3d-modal")) == null ? void 0 : _l.addEventListener("click", (u) => {
        var _a2, _b2;
        u.stopPropagation(), de = !de, (_a2 = ye.querySelector("#cad3d-modal")) == null ? void 0 : _a2.classList.toggle("active", de);
        const M = ye.querySelector("#cad3d-mode-prev"), $ = ye.querySelector("#cad3d-mode-next"), A = ye.querySelector("#cad3d-mode-label"), q = ye.querySelector("#cad3d-modal-scale");
        if (de) {
          const b = ot();
          ((_b2 = b == null ? void 0 : b.settings) == null ? void 0 : _b2.loads) && (Fe = b.settings.loads.rawVal, b.settings.loads.val = false), nn(), M.style.display = "", $.style.display = "", A.style.display = "", q && (q.style.display = ""), m();
        } else sn(), M.style.display = "none", $.style.display = "none", A.style.display = "none", q && (q.style.display = "none"), I && I !== "placa-q4" && I !== "placa-3q" && he(), setTimeout(() => {
          var _a3;
          const b = ot();
          ((_a3 = b == null ? void 0 : b.settings) == null ? void 0 : _a3.loads) && Fe && (b.settings.loads.val = true);
        }, 600);
      });
      function m() {
        var _a2;
        const u = ye.querySelector("#cad3d-mode-label");
        if (!u || !(V == null ? void 0 : V.frequencies)) return;
        const v = V.frequencies[fe], M = v > 0 ? 1 / v : 0, $ = [
          0,
          0,
          0,
          0,
        ...
        u.textContent = `Modo ${fe + 1} \u2014 ${v.toFixed(2)} Hz \u2014 T=${M.toFixed(3)}s \u2014 \u03A3Ux=${($[0] * 100).toFixed(1)}% \u03A3Uy=${($[1] * 100).toFixed(1)}% \u03A3Rz=${($[5] * 100).toFixed(1)}%`;
      }
      (_m = ye.querySelector("#cad3d-mode-prev")) == null ? void 0 : _m.addEventListener("click", (u) => {
        if (u.stopPropagation(), !(V == null ? void 0 : V.modeShapes)) return;
        fe = (fe - 1 + V.modeShapes.length) % V.modeShapes.length;
        const v = V.modeShapes[fe], { extent: M } = Zt();
        let $ = 0;
        for (let A = 0; A < J.length; A++) {
          const q = v[A * 6] || 0, b = v[A * 6 + 1] || 0, f = v[A * 6 + 2] || 0;
          $ = Math.max($, Math.sqrt(q * q + b * b + f * f));
        }
        ce = $ > 1e-12 ? M * 0.05 / $ : 1, To(), m();
      }), (_n2 = ye.querySelector("#cad3d-mode-next")) == null ? void 0 : _n2.addEventListener("click", (u) => {
        if (u.stopPropagation(), !(V == null ? void 0 : V.modeShapes)) return;
        fe = (fe + 1) % V.modeShapes.length;
        const v = V.modeShapes[fe], { extent: M } = Zt();
        let $ = 0;
        for (let A = 0; A < J.length; A++) {
          const q = v[A * 6] || 0, b = v[A * 6 + 1] || 0, f = v[A * 6 + 2] || 0;
      ...
      const r = ye.querySelector("#cad3d-modal-scale");
      r == null ? void 0 : r.addEventListener("mousedown", (u) => u.stopPropagation()), r == null ? void 0 : r.addEventListener("change", () => {
        de && (V == null ? void 0 : V.modeShapes) && To();
      });
      const i = ye.querySelector("#cad3d-cmd");
      i == null ? void 0 : i.addEventListener("mousedown", (u) => u.stopPropagation()), document.addEventListener("keydown", (u) => {
        ...
        if ((u.key === "Delete" || u.key === "Backspace") && lt.size > 0) {
          u.preventDefault(), lt.forEach((v) => G.add(v)), lt.clear(), jt && (jt.remove(), jt = null), he();
          return;
        }
        if (u.key === "Escape") {
          if (Bt) if (it !== null) {
            it = null;
            const v = ot();
            $t && v && (v.scene.remove($t), $t.geometry.dispose(), $t.material.dispose(), $t = null), Mt && v && (v.scene.remove(Mt), Mt.geometry.dispose(), Mt.material.dispose(), Mt = null), v == null ? void 0 : v.render();
          } else Oo();
          Tt && _o(), _t && (_t = false, co(), (_a2 = ye.querySelector("#cad3d-inspect")) == null ? void 0 : _a2.classList.remove("inspect-active"));
        }
        ...
        if (u.key === "Enter") {
          ...
          if (v) {
            try {
              const M = new Function("cad", `return ${v}`)(We);
      ...
      ye.addEventListener("mousedown", (u) => {
        const v = u.target.tagName;
        if (v === "BUTTON" || v === "INPUT" || v === "SELECT") return;
        h = true;
        const M = ye.getBoundingClientRect();
        ye.style.bottom = "unset", S = u.clientX, w = u.clientY, x = M.left, p = M.top, u.preventDefault();
      }), window.addEventListener("mousemove", (u) => {
        h && (u.preventDefault(), ye.style.left = x + (u.clientX - S) + "px", ye.style.top = p + (u.clientY - w) + "px");
    ...
    function yt(t = false) {
      ...
      a.rotation.x = Math.PI / 2, a.position.set(0.5 * l, 0.5 * l, 0), o.scene.add(a), o.scene.children.filter((h) => h.type === "Group" && h.name !== "gridAxes" && h.name !== "loadsGroup" && (h.name === "viewerAxes" || h.children.some((S) => S instanceof Ho))).forEach((h) => {
        h.traverse((S) => {
          S.geometry && S.geometry.dispose(), S.material && (S.material.map && S.material.map.dispose(), S.material.dispose());
        }), o.scene.remove(h);
      });
      const m = 0.05 * l, r = new En();
      r.name = "viewerAxes";
      const i = d.axisArrow;
      r.add(new Ho(new ke(1, 0, 0), new ke(), 1, i, 0.2, 0.2)), r.add(new Ho(new ke(0, 1, 0), new ke(), 1, i, 0.2, 0.2)), r.add(new Ho(new ke(0, 0, 1), new ke(), 1, i, 0.2, 0.2)), r.children.forEach((h) => h.scale.set(m, m, m));
      for (const [h, S, w] of [
        [
          "X",
          "red",
      ...
      o.scene.add(r), t ? o.render() : Qt("3d");
    }
    function Qn(t, o, n) {
    ...
    function Qt(t) {
      ...
      const o = ot();
      if (!o) return;
      const { center: n, extent: l } = Zt(), s = o.renderer.domElement.clientWidth / (o.renderer.domElement.clientHeight || 1), d = l * 0.7;
      ...
      if (t === "3d") {
        ...
        if (t === "plan") o.renderer.clippingPlanes = [], m(new ke(n.x, n.y, n.z + l * 2), new ke(n.x, n.y, n.z), new ke(0, 1, 0));
          ...
          const r = parseInt(t.split(":")[1]), i = ((_a = K.hPiso) == null ? void 0 : _a.val) ?? 3, h = (r + 1) * i, S = i * 0.45;
          o.renderer.clippingPlanes = [
            new so(new ke(0, 0, -1), h + S),
            new so(new ke(0, 0, 1), -h + S)
          ...
          const r = parseInt(t.split(":")[1]), i = Ve[r] ?? n.x;
          if (Xe.length > 1) {
            const S = Qn(Ve, r, l);
            o.renderer.clippingPlanes = [
              new so(new ke(-1, 0, 0), i + S),
              new so(new ke(1, 0, 0), -i + S)
          ...
          const r = parseInt(t.split(":")[1]), i = Xe[r] ?? n.y;
          if (Ve.length > 1) {
            const S = Qn(Xe, r, l);
            o.renderer.clippingPlanes = [
              new so(new ke(0, -1, 0), i + S),
              new so(new ke(0, 1, 0), -i + S)
    ...
    function dn() {
      ...
      const o = (d, a, c) => {
        ...
        return m.textContent = d, m.dataset.view = a, m.title = c, m.style.cssText = "min-width:22px;padding:1px 5px;font-weight:bold", m.addEventListener("click", (r) => {
          ...
          ye.querySelectorAll("[data-view]").forEach((h) => h.classList.remove("view-active")), i ? (Qt("3d"), (_a = ye.querySelector('[data-view="3d"]')) == null ? void 0 : _a.classList.add("view-active")) : (Qt(a), m.classList.add("view-active"));
        }), m;
    ...
    function pn() {
      ...
      const n = (s, d, a) => {
        ...
        return c.textContent = s, c.dataset.view = d, c.title = a, c.style.cssText = "min-width:22px;padding:1px 5px;font-weight:bold", c.addEventListener("click", (m) => {
          ...
          ye.querySelectorAll("[data-view]").forEach((i) => i.classList.remove("view-active")), r ? (Qt("3d"), (_a2 = ye.querySelector('[data-view="3d"]')) == null ? void 0 : _a2.classList.add("view-active")) : (Qt(d), c.classList.add("view-active"));
        }), c;
    ...
    function Fs() {
      Qt("3d"), ye.querySelectorAll("[data-view]").forEach((t) => t.classList.toggle("view-active", t.dataset.view === "3d"));
    }
    We.view = (t) => {
      t = {
        planta: "plan",
        ...
        elevationY: "elevY",
        corte: "section"
      }[t] || t, Qt(t), ye.querySelectorAll("[data-view]").forEach((n) => n.classList.toggle("view-active", n.dataset.view === t));
    };
    let _t = false, Tt = false, Bt = false, Et = "line", Ft = [], it = null, $t = null, Mt = null, go = null, qt = null;
    const ft = {
      node: true,
      grid: true,
      midpoint: true,
    ...
    function es() {
      ...
      const t = xo.pop();
      e.nodes.val = t.nodes, e.elements.val = t.elements, Ut(), e.elementInputs.val = {
        ...e.elementInputs.val
      };
    }
    function ts() {
    ...
    let Lt = null, eo = [], Dt = null, jt = null;
    function mn(t) {
      const o = ot();
      if (!o) return;
      ...
      const d = new ao();
      d.setAttribute("position", new po(s, 3));
      const a = new Fo(d, new qo({
        color: 16711935,
        linewidth: 3,
        depthTest: false
      }));
      a.renderOrder = 9998, a.__elemIdx = t, o.scene.add(a), eo.push(a), o.render();
    }
    function to() {
      const t = ot();
      eo.forEach((o) => {
        t == null ? void 0 : t.scene.remove(o), o.geometry.dispose(), o.material.dispose();
      }), eo = [], t == null ? void 0 : t.render();
    }
    function oo() {
      jt && jt.remove();
      const t = D.size > 0 || H;
...
${r.join(", ")}`);
        ...
        lt.forEach((n) => D.add(n)), lt.clear(), to(), oo(), he();
      }), o.querySelector("#sel-isolate").addEventListener("click", () => {
        H = true, W.clear(), lt.forEach((n) => W.add(n)), lt.clear(), to(), oo(), he();
      }), o.querySelector("#sel-showall").addEventListener("click", () => {
        D.clear(), H = false, W.clear(), oo(), he();
      }), o.querySelector("#sel-delete").addEventListener("click", () => {
        vo(), lt.forEach((n) => G.add(n)), lt.clear(), to(), oo(), he();
    ...
    function _o() {
      var _a;
      Tt = false, lt.clear(), to(), jt && (jt.remove(), jt = null), (_a = ye.querySelector("#cad3d-select")) == null ? void 0 : _a.classList.remove("inspect-active");
      const o = ot();
    ...
    function As(t) {
      ...
      for (const [d, a] of s) {
        ...
        i.computeLineDistances(), i.renderOrder = 9990, o.scene.add(i), un.push(i);
      }
      o.render();
    }
    function bn() {
      const t = ot();
      for (const o of un) t == null ? void 0 : t.scene.remove(o), o.geometry.dispose(), o.material.dispose();
      un = [], ro = null, At && (At.remove(), At = null);
    }
    function os(t, o, n, l) {
    ...
    function Oo() {
      var _a;
      const t = ot();
      $t && t && (t.scene.remove($t), $t.geometry.dispose(), $t.material.dispose(), $t = null), Mt && t && (t.scene.remove(Mt), Mt.geometry.dispose(), Mt.material.dispose(), Mt = null), bn(), it = null, qt = null, Bt = false, go && (go.remove(), go = null), (_a = ye.querySelector("#cad3d-draw")) == null ? void 0 : _a.classList.remove("inspect-active"), t == null ? void 0 : t.render();
    }
    function Ps() {
      go && go.remove();
      ...
      <button id="dt-line" style="${o(Et === "line")}">\u{1F4CF} Line</button>
      <button id="dt-arc" style="${o(Et === "arc")}">\u2312 Arc</button>
      <button id="dt-node" style="${o(Et === "node")}">\u2295 Node</button>
      <button id="dt-area" style="${o(Et === "area")}">\u25A2 Area</button>
      ...
      <input id="ds-gridsize" type="number" value="${fn}" step="0.1" min="0.1" max="10" style="width:45px;background:#333;color:#fff;border:1px solid #555;padding:2px;font-size:10px;">
    ...
    `, document.body.appendChild(t), go = t;
      const l = () => {
        ...
        s && (s.style.cssText = o(Et === "line")), d && (d.style.cssText = o(Et === "arc")), a && (a.style.cssText = o(Et === "node")), c && (c.style.cssText = o(Et === "area"));
      ...
      t.querySelector("#dt-line").addEventListener("click", () => {
        Et = "line", it = null, qt = null, Ft = [], l();
      }), t.querySelector("#dt-arc").addEventListener("click", () => {
        Et = "arc", it = null, qt = null, Ft = [], l();
      }), t.querySelector("#dt-node").addEventListener("click", () => {
        Et = "node", it = null, qt = null, Ft = [], l();
      }), t.querySelector("#dt-area").addEventListener("click", () => {
        Et = "area", it = null, qt = null, Ft = [], console.log("Area mode: click vertices del poligono. Doble-click o click cerca del 1er punto para cerrar."), l();
        ...
        ft.track = !ft.track, ft.track || bn(), l();
    ...
    function ns(t, o, n, l) {
      ...
      if (ft.grid) {
        const w = new so(new ke(0, 0, 1), 0), x = new ke();
        if (c.ray.intersectPlane(w, x)) {
          const p = ft.gridSize || fn;
      ...
      const h = new so(new ke(0, 0, 1), 0), S = new ke();
    ...
    function ss(t) {
      ...
      if (Mt && (o.scene.remove(Mt), Mt.geometry.dispose(), Mt.material.dispose(), Mt = null), t.worldPos) {
        ...
        Mt = new ia(d, a), Mt.position.copy(t.worldPos), Mt.renderOrder = 9999, o.scene.add(Mt);
      }
      if ($t && (o.scene.remove($t), $t.geometry.dispose(), $t.material.dispose(), $t = null), it !== null && t.worldPos) {
        const l = n[it], s = new ao();
        if (Et === "arc" && qt !== null) {
          const a = n[qt], c = as(new ke(l[0], l[1], l[2]), new ke(a[0], a[1], a[2]), t.worldPos, 16), m = [];
          for (let r = 0; r < c.length - 1; r++) m.push(c[r].x, c[r].y, c[r].z, c[r + 1].x, c[r + 1].y, c[r + 1].z);
          s.setAttribute("position", new po(m, 3));
        } else s.setAttribute("position", new po([
          l[0],
          l[1],
          l[2],
          t.worldPos.x,
        ...
        $t = new Ro(s, d), Et === "arc" && qt !== null && ($t = new Fo(s, d)), $t.renderOrder = 9999, o.scene.add($t);
      }
      o.render();
    }
    function as(t, o, n, l) {
    ...
    function _s(t) {
      ...
      if (Et === "line") {
        ...
        n.some((s) => s.length === 2 && (s[0] === it && s[1] === o || s[1] === it && s[0] === o)) || (n.push([
          it,
          o
        ]), e.elements.val = n, Ut(), e.elementInputs.val = {
          ...e.elementInputs.val
        }), it = o;
        return;
      }
      if (Et === "arc") {
        ...
        if (o === it || o === qt) return;
        const n = e.nodes.val, l = new ke(...n[it]), s = new ke(...n[qt]), d = new ke(...n[o]), a = Math.max(4, Math.round(((_a = K.nSubViga) == null ? void 0 : _a.val) ?? 8)), c = as(l, s, d, a);
        vo();
        const m = [
          ...e.nodes.val
        ], r = [
        ...
        e.nodes.val = m, e.elements.val = r, Ut(), e.elementInputs.val = {
          ...e.elementInputs.val
        }, it = o, qt = null;
        return;
      }
      if (Et === "area") {
        ...
        if (Ft.length >= 3 && o === Ft[0]) {
          ...
          try {
            ...
            e.nodes.val = n, e.elements.val = l, Ut(), console.log(`Area: ${d.elements.length} triangulos creados desde ${Ft.length} vertices`);
          } catch (d) {
        ...
        if (Ft.push(o), console.log(`Area vertex ${Ft.length}: node ${o}`), Ft.length >= 2) {
          const n = Ft[Ft.length - 2], l = e.nodes.val, s = ot();
          if (s) {
            const d = new ao().setFromPoints([
              new ke(...l[n]),
              new ke(...l[o])
            ]), a = new Fo(d, new qo({
              color: 65280,
    ...
    function ls(t) {
      ...
      const d = new ao();
      d.setAttribute("position", new po(s, 3)), Lt = new Fo(d, new qo({
        color: 16776960,
        linewidth: 3,
        depthTest: false
    ...
    function Ns(t) {
      if (t.length === 2) {
        const n = Kt(t[1], t[0]), l = mo(n), s = n[0] / l, d = n[1] / l, a = n[2] / l;
        return `<div class="fem-eq eq-box">
    ...
    function rs(t) {
      ...
      if (d) {
        const b = mo(Kt(s[1], s[0])), f = ((_d = a.elasticities) == null ? void 0 : _d.get(t)) ?? 0, y = ((_e = a.areas) == null ? void 0 : _e.get(t)) ?? 0, E = ((_f = a.momentsOfInertiaZ) == null ? void 0 : _f.get(t)) ?? 0, k = ((_g = a.momentsOfInertiaY) == null ? void 0 : _g.get(t)) ?? 0, O = ((_h = a.shearModuli) == null ? void 0 : _h.get(t)) ?? 0, F = ((_i = a.torsionalConstants) == null ? void 0 : _i.get(t)) ?? 0;
        `${l[0]}${l[1]}${U(b)}${U(f)}${U(y)}${U(E)}${U(k)}${U(O)}${U(F)}`;
      } else {
      ...
      try {
        if (v = Vo(s, a, t), M = Xo(s), $ = Ot(Fn(M), Ot(v, M)), A = d ? [
          "ux\u2080",
          "uy\u2080",
          "uz\u2080",
          "\u03B8x\u2080",
          ...
          const E = mo(Kt(s[1], s[0])), k = ((_m = a.elasticities) == null ? void 0 : _m.get(t)) ?? 0, O = ((_n2 = a.areas) == null ? void 0 : _n2.get(t)) ?? 0, F = ((_o2 = a.momentsOfInertiaZ) == null ? void 0 : _o2.get(t)) ?? 0, L = ((_p = a.momentsOfInertiaY) == null ? void 0 : _p.get(t)) ?? 0, P = ((_q = a.shearModuli) == null ? void 0 : _q.get(t)) ?? 0, _ = ((_r = a.torsionalConstants) == null ? void 0 : _r.get(t)) ?? 0;
          S = Os(k, O, F, L, P, _, E);
        }
        ...
        r = `<div class="matrix-label">k_local (${v.length}\xD7${v.length}) ${b}</div>${xn(v, A)}`, i = `<div class="matrix-label">T \u2014 Transformaci\xF3n (${M.length}\xD7${M.length}) ${f}</div>${xn(M, A)}`, h = `<div class="matrix-label">K_global = T^T \xB7 k \xB7 T ${y}</div>${xn($, A)}`;
      } catch (b) {
      ...
      if (c == null ? void 0 : c.deformations) {
        ...
        l.map((f, y) => {
          ...
          const E = ((_a2 = c.deformations) == null ? void 0 : _a2.get(f)) || [
            ...
            0,
            0
          ], k = b.map((O, F) => `<span class="prop-key">${O}</span>: <span class="${Math.abs(E[F]) > 1e-10 ? "result-val" : ""}">${U(E[F])}</span>`).join(" &nbsp;");
      ...
      if (m && d && (c == null ? void 0 : c.deformations) && v && M) {
        ...
        for (const ee of l) {
          const Z = ((_y = c.deformations) == null ? void 0 : _y.get(ee)) || [
            0,
            0,
            0,
            0,
        ...
        const te = (ee, Z) => ee.map((se, Se) => `<span style="color:${Math.abs(se) > 1e-10 ? "var(--fem-nonzero)" : "var(--fem-eq-dots)"}">${Z[Se % 6]}=${U(se)}</span>`).join(", "), ie = [
          "N",
          "Vy",
          "Vz",
          "Mx",
        ...
        `${C("u", "global")}${l.map((ee, Z) => `<span style="color:var(--fem-label)">nodo ${ee}:</span> ${F.map((se, Se) => `<span style="color:${Math.abs(L[Z * 6 + Se]) > 1e-10 ? "var(--fem-eq-var)" : "var(--fem-eq-dots)"}">${U(L[Z * 6 + Se])}</span>`).join(", ")}`).join(" | ")}${C("u", "local")}${C("T")}${C("u", "global")}${C("u", "local")}${te(P, [
          ...F,
          ...F
        ])}${C("f", "local")}${C("k", "local")}${C("u", "local")}${C("f", "local")}${_.map((ee, Z) => `<span style="color:${Math.abs(ee) > 1e-10 ? "var(--fem-nonzero)" : "var(--fem-eq-dots)"}">${ie[Z]}=${U(ee)}</span>`).join(", ")}${C("P", "1")}${C("N", "i")}${U(_[0])}${C("P", "7")}${C("N", "j")}${U(_[6])}${C("P", "2")}${C("V", "y,i")}${U(_[1])}${C("P", "8")}${C("V", "y,j")}${U(_[7])}${C("P", "3")}${C("V", "z,i")}${U(_[2])}${C("P", "9")}${C("V", "z,j")}${U(_[8])}${C("P", "4")}${C("M", "x,i")}${U(_[3])}${C("P", "10")}${C("M", "x,j")}${U(_[9])}${C("P", "5")}${C("M", "y,i")}${U(_[4])}${C("P", "11")}${C("M", "y,j")}${U(_[10])}${C("P", "6")}${C("M", "z,i")}${U(_[5])}${C("P", "12")}${C("M", "z,j")}${U(_[11])}${b ? b.map((ee) => U(ee)).join(", ") : "\u2014"}${f ? f.map((ee) => U(ee)).join(", ") : "\u2014"}${y ? y.map((ee) => U(ee)).join(", ") : "\u2014"}${E ? E.map((ee) => U(ee)).join(", ") : "\u2014"}${k ? k.map((ee) => U(ee)).join(", ") : "\u2014"}${O ? O.map((ee) => U(ee)).join(", ") : "\u2014"}`;
      } else if (m && d) {
        ...
        `${b ? b.map((F) => U(F)).join(", ") : "\u2014"}${f ? f.map((F) => U(F)).join(", ") : "\u2014"}${y ? y.map((F) => U(F)).join(", ") : "\u2014"}${E ? E.map((F) => U(F)).join(", ") : "\u2014"}${k ? k.map((F) => U(F)).join(", ") : "\u2014"}${O ? O.map((F) => U(F)).join(", ") : "\u2014"}`;
      } else if (m && !d) {
      ...
      `${l[0]}`, 6 * l[0], 6 * l[0] + 5, `${l[1]}`, 6 * l[1], 6 * l[1] + 5, l.length === 3 && (`${l[2]}`, 6 * l[2], 6 * l[2] + 5), o.length * 6, o.length * 6, Dt = Ma(t, o, n, a, c, m), Dt.id = "fem-inspect-panel", document.body.appendChild(Dt), (_L = Dt.querySelector("#er-close")) == null ? void 0 : _L.addEventListener("click", () => co());
      const q = d ? (() => {
        var _a2, _b2, _c2, _d2, _e2, _f2;
        const b = mo(Kt(s[1], s[0])), f = ((_a2 = a.elasticities) == null ? void 0 : _a2.get(t)) ?? 0, y = ((_b2 = a.areas) == null ? void 0 : _b2.get(t)) ?? 0, E = ((_c2 = a.momentsOfInertiaZ) == null ? void 0 : _c2.get(t)) ?? 0, k = ((_d2 = a.momentsOfInertiaY) == null ? void 0 : _d2.get(t)) ?? 0, O = ((_e2 = a.shearModuli) == null ? void 0 : _e2.get(t)) ?? 0, F = ((_f2 = a.torsionalConstants) == null ? void 0 : _f2.get(t)) ?? 0;
        return Ds(f, y, E, k, O, F, b);
      })() : void 0;
      Dt.querySelectorAll("[data-full]").forEach((b) => {
        b.addEventListener("click", (f) => {
          f.stopPropagation();
          const y = b.dataset.full;
          if (y === "kLocal" && v) {
            const E = d ? is() : "<em>Shell 18\xD718 \u2014 ver tabla num\xE9rica</em>";
            yn(`Elemento ${t} \u2014 Rigidez Local k_local`, E, vn(v, A), q);
          } else if (y === "T" && M) yn(`Elemento ${t} \u2014 Transformaci\xF3n T`, w, vn(M, A));
          else if (y === "kGlobal" && $) {
            const E = d ? is() : "<em>Shell 18\xD718</em>";
            yn(`Elemento ${t} \u2014 Rigidez Global K = T^T \xB7 k \xB7 T`, E, vn($, A), q);
          }
        });
      });
    }
    function cs() {
      ...
      setTimeout(() => yt(), 50), Ye(), console.log(`Torre Eiffel: ${l.length} nodos, ${s.length} elementos, H=30m`);
    }
    function ds() {
      const l = [], s = [];
      for (let w = 0; w <= 20; w++) {
      ...
      setTimeout(() => yt(), 50), Ye(), console.log(`Arco Gateway: ${l.length} nodos, ${s.length} elem, span=20m, H=20m`);
    }
    function ps() {
      const d = [], a = [];
      for (let p = 0; p <= 16; p++) {
      ...
      setTimeout(() => yt(), 50), Ye(), console.log(`Puente atirantado: ${d.length} nodos, ${a.length} elem, span=60m`);
    }
    function fs() {
      const d = [], a = [];
      for (let u = 0; u <= 12; u++) {
      ...
      setTimeout(() => yt(), 50), Ye(), console.log(`Torre Twist: ${d.length} nodos, ${a.length} elem, 12 pisos, twist=5deg/piso`);
    }
    function us() {
      const s = [], d = [];
      for (let p = 0; p <= 20; p++) {
      ...
      setTimeout(() => yt(), 50), Ye(), console.log(`Burj Khalifa: ${s.length} nodos, ${d.length} elem, 20 pisos, H=${20 * 3}m`);
    }
    function ms() {
      const t = [], o = [];
      for (let h = 0; h < 3; h++) {
      ...
      setTimeout(() => yt(), 50), Ye(), console.log(`Sydney Opera: ${t.length} nodos, ${o.length} shells Q4, 3 velas`);
    }
    function bs() {
      const l = [], s = [];
      for (let x = 0; x <= 15; x++) {
      ...
      setTimeout(() => yt(), 50), Ye(), console.log(`Diagrid Tower: ${l.length} nodos, ${s.length} elem, 15 pisos, H=${15 * 3.5}m`);
    }
    function js() {
      var _a, _b;
    ...
    `, document.body.appendChild(t), Lo = t, t.querySelector("#nl-close").addEventListener("click", () => {
        t.remove(), Lo = null;
    ...
    function Js(t) {
      ...
      for (let ne = 0; ne < a; ne++) {
        ...
        for (let ee = 0; ee < c; ee++) {
          const Z = ee / c * 2 * Math.PI;
          m.push(ie * Math.sin(Z));
        }
      }
      const r = o / n, i = l * n;
      ...
      const q = [];
      for (const ne of m) {
        let ie = w, ee = x, Z = p, se = u, Se = v, Ne = M, _e = $, ae = A, xe;
        const Ee = ne - h;
        if (Math.abs(Ee) < 1e-20) {
          q.push(S);
          continue;
        }
        if ((ae === 0 || ae === 3) && (Ee < 0 ? (ae = 2, se = -r, Se = -o, Z = se, Ne = 0, _e = 0) : (ae = 1, se = r, Se = o, Z = se, Ne = 0, _e = 0)), ae === 2 && Ee > 0) {
          ae = 1, Ne = h, _e = S, h < ie && (ie = h);
          const ze = (ee - ie) / (2 * 1 * r), Be = 1 + 0 * Math.pow(ze, 0.8);
          se = (o * Be - i * r * Be - _e + n * Ne) / (n - i), Se = o * Be + i * (se - r * Be), Z = ee;
        } else if (ae === 1 && Ee < 0) {
          ae = 2, Ne = h, _e = S, h > ee && (ee = h);
          const ze = (ee - ie) / (2 * 1 * r), Be = 1 + 0 * Math.pow(ze, 0.8);
          se = (-o * Be + i * r * Be - _e + n * Ne) / (n - i), Se = -o * Be + i * (se + r * Be), Z = ie;
        }
        const pe = Math.abs((Z - se) / r);
        let qe = s - 0.925 * pe / (0.15 + pe);
        qe < 0.1 && (qe = 0.1);
        const Oe = (ne - Ne) / (se - Ne), nt = 1 + Math.pow(Math.abs(Oe), qe), oe = Math.pow(nt, 1 / qe);
        xe = l * Oe + (1 - l) * Oe / oe, xe = xe * (Se - _e) + _e, q.push(xe), h = ne, S = xe, w = ie, x = ee, p = Z, u = se, v = Se, M = Ne, $ = _e, A = ae;
      }
      ...
      for (let ne = 0; ne < m.length; ne++) {
        const ie = P + m[ne] * F, ee = _ - q[ne] * L;
        ne === 0 ? f.moveTo(ie, ee) : f.lineTo(ie, ee);
      }
    ...
    function Xs(t) {
      ...
      const n = Wo(), l = Yo(), s = Object.entries(n).map(([r, i]) => `<option value="${i}">${r}</option>`).join(""), d = Object.entries(l).map(([r, i]) => `<option value="${i}">${r}</option>`).join("");
      o.innerHTML = `
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;">
    ...
    `, document.body.appendChild(o), yo = o;
    ...
    `, document.body.appendChild(w), $o = w, w.querySelector("#ep-close").addEventListener("click", () => {
        w.remove(), $o = null, co();
      }), w.querySelector("#ep-delete").addEventListener("click", () => {
        G.add(t), w.remove(), $o = null, co(), he();
      }), w.querySelector("#ep-inspect").addEventListener("click", () => {
        w.remove(), $o = null, rs(t);
      });
    }
    setTimeout(() => {
      const t = document.getElementById("viewer");
      ...
      o.addEventListener("mousedown", (m) => {
        ...
        if (Bt) {
          ...
          if (ft.track && h.snapType === "node" && h.nodeIdx !== null && h.nodeIdx !== ro && As(h.nodeIdx), ft.track && ro !== null && h.worldPos && h.snapType !== "node") {
            const S = Cs(h.worldPos, ro);
            S && (h.worldPos = S, h.snapType = "grid");
          }
          if (ro !== null && h.worldPos) {
            const S = e.nodes.val[ro];
        ...
        if (Tt && n) {
          ...
          if (Math.abs(r) > s || Math.abs(i) > s) {
            ...
            m.ctrlKey || m.metaKey || (lt.clear(), to()), S.forEach((x) => {
              lt.has(x) || (lt.add(x), mn(x));
            }), oo();
          }
        ...
        if (Tt) {
          if (l) return;
          const r = gn(m), i = m.ctrlKey || m.metaKey;
          if (r >= 0) {
            if (i) if (lt.has(r)) {
              lt.delete(r);
              const h = eo.findIndex((S) => S.__elemIdx === r);
              if (h >= 0) {
                const S = ot();
                S == null ? void 0 : S.scene.remove(eo[h]), eo[h].geometry.dispose(), eo[h].material.dispose(), eo.splice(h, 1), S == null ? void 0 : S.render();
              }
            } else lt.add(r), mn(r);
            else lt.clear(), to(), lt.add(r), mn(r);
            oo();
          } else i || (lt.clear(), to(), oo());
          return;
        }
        if (_t) {
          const r = gn(m);
      ...
      var _a;
      e.nodes.val, e.elements.val, (_a = e.nodeInputs) == null ? void 0 : _a.val, Ye();
    }), We.modal = (t) => {
      var _a, _b;
      if (t === void 0 && (t = !de), de = t, (_a = ye.querySelector("#cad3d-modal")) == null ? void 0 : _a.classList.toggle("active", de), de) {
        const n = ot();
        ((_b = n == null ? void 0 : n.settings) == null ? void 0 : _b.loads) && (Fe = n.settings.loads.rawVal, n.settings.loads.val = false), nn(), ye.querySelector("#cad3d-mode-prev").style.display = "", ye.querySelector("#cad3d-mode-next").style.display = "", ye.querySelector("#cad3d-mode-label").style.display = "";
      } else sn(), ye.querySelector("#cad3d-mode-prev").style.display = "none", ye.querySelector("#cad3d-mode-next").style.display = "none", ye.querySelector("#cad3d-mode-label").style.display = "none", I && I !== "placa-q4" && I !== "placa-3q" && he(), setTimeout(() => {
        var _a2;
        const n = ot();
        ((_a2 = n == null ? void 0 : n.settings) == null ? void 0 : _a2.loads) && Fe && (n.settings.loads.val = true);
      }, 600);
      ...
      fe = Math.max(0, Math.min(t, V.modeShapes.length - 1));
      const o = V.modeShapes[fe], { extent: n } = Zt();
      let l = 0;
      for (let d = 0; d < J.length; d++) {
        const a = o[d * 6] || 0, c = o[d * 6 + 1] || 0, m = o[d * 6 + 2] || 0;
        l = Math.max(l, Math.sqrt(a * a + c * c + m * m));
      }
      ce = l > 1e-12 ? n * 0.05 / l : 1, To();
      const s = ye.querySelector("#cad3d-mode-label");
      s && V.frequencies && (s.textContent = `Modo ${fe + 1} \u2014 ${V.frequencies[fe].toFixed(2)} Hz`), console.log(`Modo ${fe + 1}: f = ${(_a = V.frequencies) == null ? void 0 : _a[fe].toFixed(4)} Hz`);
    }, window.cad = We, console.log("FEM Studio CLI ready. Type cad.help() for commands."), setTimeout(() => {
      document.body.appendChild(ye), document.body.appendChild(Me.div);
    }, 0), setTimeout(() => {
      e.nodes.val.length === 0 && (Je("edificio"), he(), Zn("edificio"));
