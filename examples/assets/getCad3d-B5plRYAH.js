...
`));
  ...
  function Rl(e) {
    ...
    T += '<button class="rpt-close" id="rpt-close">\u2715 Close</button>', T += "<h1>Finite Element Analysis \u2014 Step-by-Step Report</h1>", T += '<div class="rpt-subtitle">Complete FEM derivation from element formulation to final results</div>', T += '<hr class="rpt-sep"/>', T += "<h2>1. Input Data</h2>", T += '<table class="rpt-info"><tbody>', T += `<tr><td>Number of nodes</td><td class="val">${b.length}</td></tr>`, T += `<tr><td>Number of elements</td><td class="val">${V} (${j} frames, ${W} shells)</td></tr>`, T += '<tr><td>DOFs per node</td><td class="val">6 (u<sub>x</sub>, u<sub>y</sub>, u<sub>z</sub>, \u03B8<sub>x</sub>, \u03B8<sub>y</sub>, \u03B8<sub>z</sub>)</td></tr>', T += `<tr><td>Total DOFs</td><td class="val">${Z}</td></tr>`, T += "</tbody></table>", T += "<h3>1.1 Node Coordinates</h3>", T += '<table class="rpt-data"><thead><tr><th>Node</th><th>x</th><th>y</th><th>z</th></tr></thead><tbody>', b.forEach((re, ne) => {
      ...
      var _a2, _b2, _c2, _d2;
      const D = re.length === 2, B = re.map((ye) => b[ye]), Y = D ? jo(ko(B[1], B[0])) : 0, ue = ((_a2 = M.elasticities) == null ? void 0 : _a2.get(ne)) ?? 0, Me = ((_b2 = M.areas) == null ? void 0 : _b2.get(ne)) ?? 0, Ae = ((_c2 = M.momentsOfInertiaZ) == null ? void 0 : _c2.get(ne)) ?? 0, Ke = ((_d2 = M.momentsOfInertiaY) == null ? void 0 : _d2.get(ne)) ?? 0;
    ...
    for (let re = 0; re < V; re++) {
      ...
      const Y = jo(ko(D[1], D[0])), ue = ((_a = M.elasticities) == null ? void 0 : _a.get(re)) ?? 0, Me = ((_b = M.areas) == null ? void 0 : _b.get(re)) ?? 0, Ae = ((_c = M.momentsOfInertiaZ) == null ? void 0 : _c.get(re)) ?? 0, Ke = ((_d = M.momentsOfInertiaY) == null ? void 0 : _d.get(re)) ?? 0, ye = ((_e = M.shearModuli) == null ? void 0 : _e.get(re)) ?? 0, Ge = ((_f = M.torsionalConstants) == null ? void 0 : _f.get(re)) ?? 0;
      let Ye = null, be = null, Te = null;
      try {
        Ye = Fn(D, M, re), be = Pn(D), Te = uo(hs(be), uo(Ye, be));
      } catch {
        continue;
      }
  ...
  `, document.body.appendChild(Yt), (_a = Yt.querySelector("#tour-next")) == null ? void 0 : _a.addEventListener("click", () => {
    ...
    const ne = (D) => {
      ...
      (D.key === "ArrowRight" || D.key === "Enter") && (sn(e + 1), document.removeEventListener("keydown", ne)), D.key === "ArrowLeft" && (sn(Math.max(0, e - 1)), document.removeEventListener("keydown", ne)), D.key === "Escape" && (xs(), document.removeEventListener("keydown", ne));
    };
...
`;
      ...
      clear() {
        e.nodes.val = [], e.elements.val = [], e.nodeInputs && (e.nodeInputs.val = {}), e.elementInputs && (e.elementInputs.val = {}), B = /* @__PURE__ */ new Set(), Y = /* @__PURE__ */ new Set(), Me = /* @__PURE__ */ new Map(), Ae = /* @__PURE__ */ new Map(), Je = [], Qe = [], mt = 0, ys(), $s(), Jt();
    ...
    function To() {
      ...
      if ((T === "edificio" || T === "frame") && B.size > 0) {
        ...
        for (let f = 0; f < t.length; f++) {
          ...
          let z, R, k, m;
          if (h) if (a === 0) R = r, k = d, m = g, z = s === 1 ? Bs(L.dCol) : Vn(L.bCol, L.hCol), n.sectionShapes.set(f, s === 1 ? {
            type: "circ",
            d: L.dCol
          } : {
            type: "rect",
...
`);
      ...
      $ && ($.value = b, $.addEventListener("change", (x) => {
        x.stopPropagation(), b = $.value, M = Ho(b, O), T && nt(T);
      }));
      const y = Le.querySelector("#cad3d-length-unit");
      y && (y.value = O, y.addEventListener("change", (x) => {
        x.stopPropagation(), O = y.value, M = Ho(b, O), T && nt(T);
      })), Le.querySelectorAll("[data-preset]").forEach((x) => {
        x.addEventListener("click", (w) => {
          w.stopPropagation();
          const v = x.dataset.preset, P = H[v];
          P && (b = P.force, O = P.length, X = P.stress, M = Ho(b, O), $ && ($.value = b), y && (y.value = O), Le.querySelectorAll("[data-preset]").forEach((K) => {
        ...
        x.addEventListener("click", (w) => {
          ...
          zl(v), Le.querySelectorAll("[data-lang]").forEach((P) => P.classList.remove("active")), x.classList.add("active"), Al(), T && nt(T);
        });
    ...
    function Zs(t) {
      ...
      try {
        if (I = Fn(a, s, t), L = Pn(a), z = uo(hs(L), uo(I, L)), R = c ? [
          ...
          const C = jo(ko(a[1], a[0])), N = ((_o2 = s.elasticities) == null ? void 0 : _o2.get(t)) ?? 0, G = ((_p = s.areas) == null ? void 0 : _p.get(t)) ?? 0, x = ((_q = s.momentsOfInertiaZ) == null ? void 0 : _q.get(t)) ?? 0, w = ((_r = s.momentsOfInertiaY) == null ? void 0 : _r.get(t)) ?? 0, v = ((_s2 = s.shearModuli) == null ? void 0 : _s2.get(t)) ?? 0, P = ((_t2 = s.torsionalConstants) == null ? void 0 : _t2.get(t)) ?? 0;
          r = Za(N, G, x, w, v, P, C);
        }
      ...
      const k = c ? (() => {
        var _a3, _b2, _c2, _d2, _e3, _f2;
        const m = jo(ko(a[1], a[0])), u = ((_a3 = s.elasticities) == null ? void 0 : _a3.get(t)) ?? 0, E = ((_b2 = s.areas) == null ? void 0 : _b2.get(t)) ?? 0, C = ((_c2 = s.momentsOfInertiaZ) == null ? void 0 : _c2.get(t)) ?? 0, N = ((_d2 = s.momentsOfInertiaY) == null ? void 0 : _d2.get(t)) ?? 0, G = ((_e3 = s.shearModuli) == null ? void 0 : _e3.get(t)) ?? 0, x = ((_f2 = s.torsionalConstants) == null ? void 0 : _f2.get(t)) ?? 0;
