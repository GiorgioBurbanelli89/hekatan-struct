const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./calcPanel-5wXZImn4.js","./getMesh-B1dmlgUt.js","./__vite-browser-external-D7Ct-6yo.js","./pureFunctionsAny.generated-JAcEVsJ7.js","./analyze-ClLKGn9k.js","./didacticCpp-Dk8Axtln.js","./cyclicPushoverCpp-DII3nDhN.js"])))=>i.map(i=>d[i]);
import { d as kt, _ as ea, p as Uo, m as Va, s as Ua, __tla as __tla_0 } from "./didacticCpp-Dk8Axtln.js";
...
`);
    ...
    function Qn() {
      ...
      b.scene.traverse((z) => {
        var _a3;
        !S && z.isPoints && z.geometry && (S = z), !$ && z.isLineSegments && z.geometry && !z.name && ($ = z), !y && z.isMesh && ((_a3 = z.material) == null ? void 0 : _a3.vertexColors) && z.geometry && (y = z);
      });
...
`);
      ...
      y && (y.value = R, y.addEventListener("change", (x) => {
        ...
        x.stopPropagation(), ea(async () => {
          const { openCalcPanel: w } = await import("./calcPanel-5wXZImn4.js").then(async (m2) => {
            await m2.__tla;
            return m2;
          });
          return {
    ...
    `, document.body.appendChild(t), (_b = t.querySelector("#pushover-close")) == null ? void 0 : _b.addEventListener("click", () => t.remove()), (_c = t.querySelector("#pushover-run")) == null ? void 0 : _c.addEventListener("click", async () => {
        ...
        try {
          const { cyclicPushover: h } = await ea(async () => {
            const { cyclicPushover: A } = await import("./cyclicPushoverCpp-DII3nDhN.js").then(async (m) => {
              await m.__tla;
              return m;
            });
            return {
