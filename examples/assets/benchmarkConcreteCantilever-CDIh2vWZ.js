...
`;
        if (Math.abs(e.P_lat) > 1e-9) {
          const M = 0.8333333333333334 * a.A_eq, c = e.P_lat * t * t * t / (3 * a.E_col * a.I_eq), u = e.P_lat * t / (a.G_col * M), A = c + u, p = e.P_lat * t, $ = e.P_lat;
          i += `  Ux_top = ${n(x, 4)} (lateral, P=${d(e.P_lat)})
    Anal\xEDtico Timoshenko: ${n(A, 4)} (bending ${n(c, 4)} + shear ${n(u, 4)})
