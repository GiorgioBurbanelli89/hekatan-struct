...
let yh = 0;
class ve extends zn {
  constructor(t = ve.DEFAULT_IMAGE, e = ve.DEFAULT_MAPPING, n = Un, s = Un, r = ze, a = In, o = Ge, l = an, c = ve.DEFAULT_ANISOTROPY, h = mn) {
...
const Gl = new ve(), Po = new Hl(1, 1), Vl = new Ll(), kl = new Th(), Wl = new Fl(), Lo = [], Do = [], Uo = new Float32Array(16), Io = new Float32Array(9), No = new Float32Array(4);
function vi(i, t, e) {
  const n = i[0];
  if (n <= 0 || n > 0) return i;
  const s = t * e;
