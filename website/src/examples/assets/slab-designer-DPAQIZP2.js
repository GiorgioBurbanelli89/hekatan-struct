...
import { g as J } from "./getViewer-C-DuwBFX.js";
import { g as Z } from "./getParameters-DuavtsRL.js";
import { g as q } from "./getTables-BsnSF73m.js";
import { w as Q, x as N, g as W } from "./styles-kwcqhtUA.js";
import { g as Y } from "./getDialog-BfRanF62.js";
import { g as tt } from "./getReport-B45-D-WU.js";
import { a as at } from "./analyze-C6GU_3Il.js";
import { d as et, __tla as __tla_0 } from "./plateQ4Cpp-keaLMavB.js";
import { g as st, a as ot, b as lt, c as A, d as H, __tla as __tla_1 } from "./getSolids-vNls12QS.js";
...
`, document.head.appendChild(n), e;
  ...
  function rt(e, s, n, o, u, C) {
    ...
    for (let i of l) L += i, d.push(L);
    const M = d.map((i) => i - b / 2);
    let k = 0, $ = [];
    const F = 1e3;
    for (let i = 0; i < l.length; i++) {
      let y = l[i], G = F * y ** 3 / 12, K = F * y, X = M[i + 1], E = G + K * X ** 2;
      $.push(E), k += E;
    }
  ...
  const dt = "/awatif-workspace/assets/awatif-logo-DnnuEFJ2.png", mt = "/awatif-workspace/assets/clt-bending-stress-DvR3Ux1R.png", ct = ({ designMomentInput: e, designOutputs: s }) => N`
    <div id="report">
      <header class="header">
  ...
  t.derive(() => {
    const { nodes: e, elements: s, nodeInputs: n, elementInputs: o } = lt(a.points.val, a.stories.val, a.columns.val, a.slabs.val, a.columnsByStory.val, a.slabsByStory.val, a.columnData.val, a.slabData.val);
    P.geometry = A(a.points.val, [], a.columns.val), I.geometry = H(a.points.val, a.slabs.val, a.columns.val), g.val = [
      ...g.rawVal
    ], r.deformOutputs.val = et(e, s, n, o), r.analyzeOutputs.val = at(e, s, o, r.deformOutputs.val), T.val = Math.max(...Array.from(r.analyzeOutputs.val.bendingXX.values()).flat()) * 1e-3, V.val = rt({
      f_mk: 24
    }, 55, 3, 20, T.val, 0.8), r.nodes.val = e, r.elements.val = s, r.nodeInputs.val = n, r.elementInputs.val = o;
  });
  t.derive(() => {
