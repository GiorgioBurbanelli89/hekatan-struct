import { v } from "./theme-DNr3SX9M.js";
import { E as _, B as m, x as y } from "./styles-kwcqhtUA.js";
/**
* @license
...
const d = /* @__PURE__ */ new WeakMap(), L = C(class extends M {
  ...
  update(t, [e]) {
    var _a;
    const s = e !== this.Y;
    return s && this.Y !== void 0 && this.rt(void 0), (s || this.lt !== this.ct) && (this.Y = e, this.ht = (_a = t.options) == null ? void 0 : _a.host, this.rt(this.ct = t.element)), _;
  }
  rt(t) {
...
function N(t) {
  ...
  e.addEventListener("mousedown", (n) => {
    ...
    i = true, r = n.clientY, u = t.offsetHeight, f = parseFloat(getComputedStyle(t).top) || 0, document.body.style.cursor = "ns-resize", n.preventDefault();
    ...
    if (i) {
      ...
      if (document.body.style.cursor === "ns-resize") {
        const h = n.clientY - r, $ = u - h, A = f + h;
        $ > 100 && (t.style.height = `${$}px`, t.style.top = `${A}px`);
      }
    }
