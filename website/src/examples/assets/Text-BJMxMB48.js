import { g as hc } from "./theme-DNr3SX9M.js";
/**
* @license
* Copyright 2010-2024 Three.js Authors
* SPDX-License-Identifier: MIT
*/
const ba = "169", li = { ROTATE: 0, DOLLY: 1, PAN: 2 }, ri = { ROTATE: 0, PAN: 1, DOLLY_PAN: 2, DOLLY_ROTATE: 3 }, uc = 0, $a = 1, fc = 2, ml = 1, dc = 2, en = 3, xn = 0, Ae = 1, nn = 2, _n = 0, ci = 1, Qa = 2, to = 3, eo = 4, pc = 5, Ln = 100, mc = 101, _c = 102, gc = 103, vc = 104, xc = 200, Mc = 201, Sc = 202, yc = 203, Ir = 204, Nr = 205, Ec = 206, Tc = 207, Ac = 208, bc = 209, wc = 210, Rc = 211, Cc = 212, Pc = 213, Lc = 214, Or = 0, Fr = 1, Br = 2, fi = 3, zr = 4, Hr = 5, Gr = 6, Vr = 7, wa = 0, Dc = 1, Uc = 2, gn = 0, Ic = 1, Nc = 2, Oc = 3, Fc = 4, Bc = 5, zc = 6, Hc = 7, _l = 300, di = 301, pi = 302, kr = 303, Wr = 304, Gs = 306, Xr = 1e3, Un = 1001, Yr = 1002, Ue = 1003, Gc = 1004, Xi = 1005, ze = 1006, Js = 1007, In = 1008, an = 1009, gl = 1010, vl = 1011, Ui = 1012, Ra = 1013, Nn = 1014, sn = 1015, Bi = 1016, Ca = 1017, Pa = 1018, mi = 1020, xl = 35902, Ml = 1021, Sl = 1022, Ge = 1023, yl = 1024, El = 1025, hi = 1026, _i = 1027, Tl = 1028, La = 1029, Al = 1030, Da = 1031, Ua = 1033, bs = 33776, ws = 33777, Rs = 33778, Cs = 33779, qr = 35840, Zr = 35841, Kr = 35842, jr = 35843, Jr = 36196, $r = 37492, Qr = 37496, ta = 37808, ea = 37809, na = 37810, ia = 37811, sa = 37812, ra = 37813, aa = 37814, oa = 37815, la = 37816, ca = 37817, ha = 37818, ua = 37819, fa = 37820, da = 37821, Ps = 36492, pa = 36494, ma = 36495, bl = 36283, _a = 36284, ga = 36285, va = 36286, Vc = 3200, kc = 3201, wl = 0, Wc = 1, mn = "", ke = "srgb", Sn = "srgb-linear", Ia = "display-p3", Vs = "display-p3-linear", Us = "linear", ee = "srgb", Is = "rec709", Ns = "p3", Gn = 7680, no = 519, Xc = 512, Yc = 513, qc = 514, Rl = 515, Zc = 516, Kc = 517, jc = 518, Jc = 519, xa = 35044, io = "300 es", rn = 2e3, Os = 2001;
class zn {
...
const ph = { DEG2RAD: Ci, RAD2DEG: Ii, generateUUID: Ye, clamp: ue, euclideanModulo: Na, mapLinear: $c, inverseLerp: Qc, lerp: Pi, damp: th, pingpong: eh, smoothstep: nh, smootherstep: ih, randInt: sh, randFloat: rh, randFloatSpread: ah, seededRandom: oh, degToRad: lh, radToDeg: ch, isPowerOfTwo: hh, ceilPowerOfTwo: uh, floorPowerOfTwo: fh, setQuaternionFromProperEuler: dh, normalize: jt, denormalize: He };
class $ {
  constructor(t = 0, e = 0) {
...
const ro = {};
function Ls(i) {
  i in ro || (ro[i] = true, console.warn(i));
}
function _h(i, t, e) {
...
const ao = new Ft().set(0.8224621, 0.177538, 0, 0.0331941, 0.9668058, 0, 0.0170827, 0.0723974, 0.9105199), oo = new Ft().set(1.2249401, -0.2249404, 0, -0.0420569, 1.0420571, 0, -0.0196376, -0.0786361, 1.0982735), xi = { [Sn]: { transfer: Us, primaries: Is, luminanceCoefficients: [0.2126, 0.7152, 0.0722], toReference: (i) => i, fromReference: (i) => i }, [ke]: { transfer: ee, primaries: Is, luminanceCoefficients: [0.2126, 0.7152, 0.0722], toReference: (i) => i.convertSRGBToLinear(), fromReference: (i) => i.convertLinearToSRGB() }, [Vs]: { transfer: Us, primaries: Ns, luminanceCoefficients: [0.2289, 0.6917, 0.0793], toReference: (i) => i.applyMatrix3(oo), fromReference: (i) => i.applyMatrix3(ao) }, [Ia]: { transfer: ee, primaries: Ns, luminanceCoefficients: [0.2289, 0.6917, 0.0793], toReference: (i) => i.convertSRGBToLinear().applyMatrix3(oo), fromReference: (i) => i.applyMatrix3(ao).convertLinearToSRGB() } }, xh = /* @__PURE__ */ new Set([Sn, Vs]), Zt = { enabled: true, _workingColorSpace: Sn, get workingColorSpace() {
...
class Pl {
  constructor(t = null) {
    this.isSource = true, Object.defineProperty(this, "id", { value: Sh++ }), this.uuid = Ye(), this.data = t, this.dataReady = true, this.version = 0;
  }
  set needsUpdate(t) {
    t === true && this.version++;
  }
...
let yh = 0;
class Se extends zn {
  constructor(t = Se.DEFAULT_IMAGE, e = Se.DEFAULT_MAPPING, n = Un, s = Un, r = ze, a = In, o = Ge, l = an, c = Se.DEFAULT_ANISOTROPY, h = mn) {
    super(), this.isTexture = true, Object.defineProperty(this, "id", { value: yh++ }), this.uuid = Ye(), this.name = "", this.source = new Pl(t), this.mipmaps = [], this.mapping = e, this.channel = 0, this.wrapS = n, this.wrapT = s, this.magFilter = r, this.minFilter = a, this.anisotropy = c, this.format = o, this.internalFormat = null, this.type = l, this.offset = new $(0, 0), this.repeat = new $(1, 1), this.center = new $(0, 0), this.rotation = 0, this.matrixAutoUpdate = true, this.matrix = new Ft(), this.generateMipmaps = true, this.premultiplyAlpha = false, this.flipY = true, this.unpackAlignment = 4, this.colorSpace = h, this.userData = {}, this.version = 0, this.onUpdate = null, this.isRenderTargetTexture = false, this.pmremVersion = 0;
  }
  get image() {
...
class zi {
  ...
  intersectsTriangle(t) {
    ...
    this.getCenter(Mi), qi.subVectors(this.max, Mi), kn.subVectors(t.a, Mi), Wn.subVectors(t.b, Mi), Xn.subVectors(t.c, Mi), ln.subVectors(Wn, kn), cn.subVectors(Xn, Wn), Tn.subVectors(kn, Xn);
    let e = [0, -ln.z, ln.y, 0, -cn.z, cn.y, 0, -Tn.z, Tn.y, ln.z, 0, -ln.x, cn.z, 0, -cn.x, Tn.z, 0, -Tn.x, -ln.y, ln.x, 0, -cn.y, cn.x, 0, -Tn.y, Tn.x, 0];
    return !nr(e, kn, Wn, Xn, qi) || (e = [1, 0, 0, 0, 1, 0, 0, 0, 1], !nr(e, kn, Wn, Xn, qi)) ? false : (Zi.crossVectors(ln, cn), e = [Zi.x, Zi.y, Zi.z], nr(e, kn, Wn, Xn, qi));
  }
  clampPoint(t, e) {
...
const je = [new C(), new C(), new C(), new C(), new C(), new C(), new C(), new C()], Ne = new C(), Yi = new zi(), kn = new C(), Wn = new C(), Xn = new C(), ln = new C(), cn = new C(), Tn = new C(), Mi = new C(), qi = new C(), Zi = new C(), An = new C();
...
const Je = new C(), sr = new C(), Ki = new C(), hn = new C(), rr = new C(), ji = new C(), ar = new C();
class Gi {
  ...
  distanceSqToSegment(t, e, n, s) {
    sr.copy(t).add(e).multiplyScalar(0.5), Ki.copy(e).sub(t).normalize(), hn.copy(this.origin).sub(sr);
    const r = t.distanceTo(e) * 0.5, a = -this.direction.dot(Ki), o = hn.dot(this.direction), l = -hn.dot(Ki), c = hn.lengthSq(), h = Math.abs(1 - a * a);
    let f, u, m, _;
  ...
  intersectTriangle(t, e, n, s, r) {
    ...
    const l = o * this.direction.dot(ji.crossVectors(hn, ji));
    if (l < 0) return null;
    const c = o * this.direction.dot(rr.cross(hn));
...
class $t {
  ...
  lookAt(t, e, n) {
    ...
    return Re.subVectors(t, e), Re.lengthSq() === 0 && (Re.z = 1), Re.normalize(), un.crossVectors(n, Re), un.lengthSq() === 0 && (Math.abs(n.z) === 1 ? Re.x += 1e-4 : Re.z += 1e-4, Re.normalize(), un.crossVectors(n, Re)), un.normalize(), Ji.crossVectors(Re, un), s[0] = un.x, s[4] = Ji.x, s[8] = Re.x, s[1] = un.y, s[5] = Ji.y, s[9] = Re.y, s[2] = un.z, s[6] = Ji.z, s[10] = Re.z, this;
  }
  multiply(t) {
    return this.multiplyMatrices(this, t);
  }
...
const Yn = new C(), Oe = new $t(), bh = new C(0, 0, 0), wh = new C(1, 1, 1), un = new C(), Ji = new C(), Re = new C(), co = new $t(), ho = new Fn();
class qe {
...
let Rh = 0;
const uo = new C(), qn = new Fn(), $e = new $t(), $i = new C(), yi = new C(), Ch = new C(), Ph = new Fn(), fo = new C(1, 0, 0), po = new C(0, 1, 0), mo = new C(0, 0, 1), _o = { type: "added" }, Lh = { type: "removed" }, Zn = { type: "childadded", child: null }, or = { type: "childremoved", child: null };
class ce extends zn {
  constructor() {
    super(), this.isObject3D = true, Object.defineProperty(this, "id", { value: Rh++ }), this.uuid = Ye(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = ce.DEFAULT_UP.clone();
    const t = new C(), e = new qe(), n = new Fn(), s = new C(1, 1, 1);
    function r() {
  ...
  translateOnAxis(t, e) {
    return uo.copy(t).applyQuaternion(this.quaternion), this.position.add(uo.multiplyScalar(e)), this;
  }
  translateX(t) {
  ...
  attach(t) {
    return this.updateWorldMatrix(true, false), $e.copy(this.matrixWorld).invert(), t.parent !== null && (t.parent.updateWorldMatrix(true, false), $e.multiply(t.parent.matrixWorld)), t.applyMatrix4($e), t.removeFromParent(), t.parent = this, this.children.push(t), t.updateWorldMatrix(false, true), t.dispatchEvent(_o), Zn.child = t, this.dispatchEvent(Zn), Zn.child = null, this;
  }
  getObjectById(t) {
...
const Fe = new C(), Qe = new C(), lr = new C(), tn = new C(), Kn = new C(), jn = new C(), go = new C(), cr = new C(), hr = new C(), ur = new C(), fr = new re(), dr = new re(), pr = new re();
class De {
  ...
  closestPointToPoint(t, e) {
    ...
    const d = h * _ - m * f;
    if (d <= 0 && f - h >= 0 && m - _ >= 0) return go.subVectors(r, s), o = (f - h) / (f - h + (m - _)), e.copy(s).addScaledVector(go, o);
    const p = 1 / (d + x + u);
...
class zt {
  ...
  setHSL(t, e, n, s = Zt.workingColorSpace) {
    if (t = Na(t, 1), e = ue(e, 0, 1), n = ue(n, 0, 1), e === 0) this.r = this.g = this.b = n;
    else {
  ...
  lerpHSL(t, e) {
    this.getHSL(fn), t.getHSL(Qi);
    const n = Pi(fn.h, Qi.h, e), s = Pi(fn.s, Qi.s, e), r = Pi(fn.l, Qi.l, e);
...
class yn extends zn {
  constructor() {
    super(), this.isMaterial = true, Object.defineProperty(this, "id", { value: Dh++ }), this.uuid = Ye(), this.name = "", this.type = "Material", this.blending = ci, this.side = xn, this.vertexColors = false, this.opacity = 1, this.transparent = false, this.alphaHash = false, this.blendSrc = Ir, this.blendDst = Nr, this.blendEquation = Ln, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new zt(0, 0, 0), this.blendAlpha = 0, this.depthFunc = fi, this.depthTest = true, this.depthWrite = true, this.stencilWriteMask = 255, this.stencilFunc = no, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = Gn, this.stencilZFail = Gn, this.stencilZPass = Gn, this.stencilWrite = false, this.clippingPlanes = null, this.clipIntersection = false, this.clipShadows = false, this.shadowSide = null, this.colorWrite = true, this.precision = null, this.polygonOffset = false, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = false, this.alphaToCoverage = false, this.premultipliedAlpha = false, this.forceSinglePass = false, this.visible = true, this.toneMapped = true, this.userData = {}, this.version = 0, this._alphaTest = 0;
  }
  get alphaTest() {
...
class Fa extends yn {
  constructor(t) {
    super(), this.isMeshBasicMaterial = true, this.type = "MeshBasicMaterial", this.color = new zt(16777215), this.map = null, this.lightMap = null, this.lightMapIntensity = 1, this.aoMap = null, this.aoMapIntensity = 1, this.specularMap = null, this.alphaMap = null, this.envMap = null, this.envMapRotation = new qe(), this.combine = wa, this.reflectivity = 1, this.refractionRatio = 0.98, this.wireframe = false, this.wireframeLinewidth = 1, this.wireframeLinecap = "round", this.wireframeLinejoin = "round", this.fog = true, this.setValues(t);
  }
  copy(t) {
...
class ve extends zn {
  ...
  toNonIndexed() {
    ...
    const e = new ve(), n = this.index.array, s = this.attributes;
    for (const o in s) {
      const l = s[o], c = t(l, n);
      e.setAttribute(o, c);
    }
...
const vo = new $t(), bn = new Gi(), es = new Hi(), xo = new C(), ns = new C(), is = new C(), ss = new C(), gr = new C(), rs = new C(), Mo = new C(), as = new C();
class Xe extends ce {
  constructor(t = new ve(), e = new Fa()) {
  ...
  raycast(t, e) {
    ...
    s !== void 0 && (n.boundingSphere === null && n.computeBoundingSphere(), es.copy(n.boundingSphere), es.applyMatrix4(r), bn.copy(t.ray).recast(t.near), !(es.containsPoint(bn.origin) === false && (bn.intersectSphere(es, xo) === null || bn.origin.distanceToSquared(xo) > (t.far - t.near) ** 2)) && (vo.copy(r).invert(), bn.copy(t.ray).applyMatrix4(vo), !(n.boundingBox !== null && bn.intersectsBox(n.boundingBox) === false) && this._computeIntersections(t, e, bn)));
  }
...
function Ih(i, t, e, n, s, r, a, o) {
  let l;
  if (t.side === Ae ? l = n.intersectTriangle(a, r, s, true, o) : l = n.intersectTriangle(s, r, a, t.side === xn, o), l === null) return null;
...
function os(i, t, e, n, s, r, a, o, l, c) {
  ...
  const h = Ih(i, t, e, n, ns, is, ss, Mo);
  if (h) {
    const f = new C();
    De.getBarycoord(Mo, ns, is, ss, f), s && (h.uv = De.getInterpolatedAttribute(s, o, l, c, f, new $())), r && (h.uv1 = De.getInterpolatedAttribute(r, o, l, c, f, new $())), a && (h.normal = De.getInterpolatedAttribute(a, o, l, c, f, new C()), h.normal.dot(n.direction) > 0 && h.normal.multiplyScalar(-1));
...
class Be extends Ol {
  ...
  getViewSize(t, e) {
    return this.getViewBounds(t, So, yo), e.subVectors(yo, So);
  }
...
class Hh extends On {
  ...
  fromEquirectangularTexture(t, e) {
    ...
    const n = { uniforms: { tEquirect: { value: null } }, vertexShader: `
			...
			` }, s = new Vi(5, 5, 5), r = new Mn({ name: "CubemapFromEquirect", uniforms: gi(n.uniforms), vertexShader: n.vertexShader, fragmentShader: n.fragmentShader, side: Ae, blending: _n });
...
function Cd(i) {
  ...
  const a = new pn(), o = new Ft(), l = { value: null, needsUpdate: false };
...
const ai = 4, Eo = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582], Dn = 20, xr = new zl(), To = new zt();
let Mr = null, Sr = 0, yr = 0, Er = false;
const Pn = (1 + Math.sqrt(5)) / 2, ti = 1 / Pn, Ao = [new C(-Pn, ti, 0), new C(Pn, ti, 0), new C(-ti, 0, Pn), new C(ti, 0, Pn), new C(0, Pn, -ti), new C(0, Pn, ti), new C(-1, 1, -1), new C(1, 1, -1), new C(-1, 1, 1), new C(1, 1, 1)];
class bo {
  constructor(t) {
  ...
  _allocateTargets() {
    const t = 3 * Math.max(this._cubeSize, 112), e = 4 * this._cubeSize, n = { magFilter: ze, minFilter: ze, generateMipmaps: false, type: Bi, format: Ge, colorSpace: Sn, depthBuffer: false }, s = wo(t, e, n);
  ...
  _sceneToCubeUV(t, e, n, s) {
    ...
    h.getClearColor(To), h.toneMapping = gn, h.autoClear = false;
    const m = new Fa({ name: "PMREM.Background", side: Ae, depthWrite: false, depthTest: false }), _ = new Xe(new Vi(), m);
    let x = false;
    const d = t.background;
    d ? d.isColor && (m.color.copy(d), t.background = null, x = true) : (m.color.copy(To), x = true);
    for (let p = 0; p < 6; p++) {
      const b = p % 3;
  ...
  _textureToCubeUV(t, e) {
    ...
    s ? (this._cubemapMaterial === null && (this._cubemapMaterial = Co()), this._cubemapMaterial.uniforms.flipEnvMap.value = t.isRenderTargetTexture === false ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = Ro());
  ...
  _halfBlur(t, e, n, s, r, a, o) {
    ...
    const h = 3, f = new Xe(this._lodPlanes[s], c), u = c.uniforms, m = this._sizeLods[n] - 1, _ = isFinite(r) ? Math.PI / (2 * m) : 2 * Math.PI / (2 * Dn - 1), x = r / _, d = isFinite(r) ? 1 + Math.floor(h * x) : Dn;
...
function Ld(i) {
  const t = [], e = [], n = [];
  let s = i;
  const r = i - ai + 1 + Eo.length;
  for (let a = 0; a < r; a++) {
    const o = Math.pow(2, s);
    e.push(o);
    let l = 1 / o;
    a > i - ai ? l = Eo[a - i + ai - 1] : a === 0 && (l = 0), n.push(l);
...
function Dd(i, t, e) {
  ...
  return new Mn({ name: "SphericalGaussianBlur", defines: { n: Dn, CUBEUV_TEXEL_WIDTH: 1 / t, CUBEUV_TEXEL_HEIGHT: 1 / e, CUBEUV_MAX_MIP: `${i}.0` }, uniforms: { envMap: { value: null }, samples: { value: 1 }, weights: { value: n }, latitudinal: { value: false }, dTheta: { value: 0 }, mipInt: { value: 0 }, poleAxis: { value: s } }, vertexShader: za(), fragmentShader: `
		...
		`, blending: _n, depthTest: false, depthWrite: false });
}
function Ro() {
  return new Mn({ name: "EquirectangularToCubeUV", uniforms: { envMap: { value: null } }, vertexShader: za(), fragmentShader: `
...
function Co() {
  return new Mn({ name: "CubemapToCubeUV", uniforms: { envMap: { value: null }, flipEnvMap: { value: -1 } }, vertexShader: za(), fragmentShader: `
  ...
  function n(o) {
    if (o && o.isTexture) {
      ...
      if (c || h) {
        ...
        if (o.isRenderTargetTexture && o.pmremVersion !== u) return e === null && (e = new bo(i)), f = c ? e.fromEquirectangular(o, f) : e.fromCubemap(o, f), f.texture.pmremVersion = o.pmremVersion, t.set(o, f), f.texture;
        if (f !== void 0) return f.texture;
        {
          const m = o.image;
          return c && m && m.height > 0 || h && m && s(m) ? (e === null && (e = new bo(i)), f = c ? e.fromEquirectangular(o) : e.fromCubemap(o), f.texture.pmremVersion = o.pmremVersion, t.set(o, f), o.addEventListener("dispose", r), f.texture) : null;
        }
      }
    }
    return o;
...
const Gl = new Se(), Po = new Hl(1, 1), Vl = new Ll(), kl = new Th(), Wl = new Fl(), Lo = [], Do = [], Uo = new Float32Array(16), Io = new Float32Array(9), No = new Float32Array(4);
function vi(i, t, e) {
  const n = i[0];
  if (n <= 0 || n > 0) return i;
  const s = t * e;
...
function Wd(i, t) {
  ...
  if (n === void 0) {
    ...
    if (fe(e, n)) return;
    No.set(n), i.uniformMatrix2fv(this.addr, false, No), de(e, n);
  }
}
function Xd(i, t) {
  const e = this.cache, n = t.elements;
  if (n === void 0) {
    ...
    if (fe(e, n)) return;
    Io.set(n), i.uniformMatrix3fv(this.addr, false, Io), de(e, n);
  }
}
function Yd(i, t) {
  const e = this.cache, n = t.elements;
  if (n === void 0) {
    ...
    if (fe(e, n)) return;
    Uo.set(n), i.uniformMatrix4fv(this.addr, false, Uo), de(e, n);
  }
}
function qd(i, t) {
  const e = this.cache;
...
function ep(i, t, e) {
  ...
  let r;
  this.type === i.SAMPLER_2D_SHADOW ? (Po.compareFunction = Rl, r = Po) : r = Gl, e.setTexture2D(t || r, s);
}
function np(i, t, e) {
  const n = this.cache, s = e.allocateTextureUnit();
...
function Cp(i, t, e) {
  ...
  for (Tr.lastIndex = 0; ; ) {
    ...
    if (l && (o = o | 0), c === void 0 || c === "[" && a + 2 === s) {
      Oo(e, c === void 0 ? new bp(o, i, t) : new wp(o, i, t));
      break;
    } else {
      let f = e.map[o];
      f === void 0 && (f = new Rp(o), Oo(e, f)), e = f;
    }
  }
}
class Ds {
...
function Xp(i) {
  ...
  return i.shadowMapType === ml ? t = "SHADOWMAP_TYPE_PCF" : i.shadowMapType === dc ? t = "SHADOWMAP_TYPE_PCF_SOFT" : i.shadowMapType === en && (t = "SHADOWMAP_TYPE_VSM"), t;
}
function Yp(i) {
  ...
  function w(y) {
    if (i.debug.checkShaderErrors) {
      ...
      if (s.getProgramParameter(x, s.LINK_STATUS) === false) if (j = false, typeof i.debug.onShaderError == "function") i.debug.onShaderError(s, x, N, R);
        ...
        const tt = Bo(s, N, "vertex"), k = Bo(s, R, "fragment");
...
function tm(i, t, e, n, s, r, a) {
  const o = new Oa(), l = new $p(), c = /* @__PURE__ */ new Set(), h = [], f = s.logarithmicDepthBuffer, u = s.reverseDepthBuffer, m = s.vertexTextures;
  let _ = s.precision;
...
function Wo() {
  ...
  function c(f, u) {
    e.length > 1 && e.sort(f || nm), n.length > 1 && n.sort(u || ko), s.length > 1 && s.sort(u || ko);
  }
  function h() {
...
function im() {
  ...
  function t(n, s) {
    const r = i.get(n);
    let a;
    return r === void 0 ? (a = new Wo(), i.set(n, [a])) : s >= r.length ? (a = new Wo(), r.push(a)) : a = r[s], a;
  }
  function e() {
    i = /* @__PURE__ */ new WeakMap();
  }
  ...
  return { get: function(t) {
    ...
    switch (t.type) {
      case "DirectionalLight":
        e = { direction: new C(), color: new zt() };
        break;
      case "SpotLight":
        e = { position: new C(), direction: new C(), color: new zt(), distance: 0, coneCos: 0, penumbraCos: 0, decay: 0 };
        break;
      case "PointLight":
        e = { position: new C(), color: new zt(), distance: 0, decay: 0 };
        break;
      case "HemisphereLight":
        e = { direction: new C(), skyColor: new zt(), groundColor: new zt() };
        break;
      case "RectAreaLight":
        e = { color: new zt(), position: new C(), halfWidth: new C(), halfHeight: new C() };
        break;
    }
    return i[t.id] = e, e;
  } };
...
function cm(i) {
  ...
  function e(s, r = 0) {
    const a = t.get(s);
    let o;
    return a === void 0 ? (o = new Xo(i), t.set(s, [o])) : r >= a.length ? (o = new Xo(i), a.push(o)) : o = a[r], o;
  }
  function n() {
    t = /* @__PURE__ */ new WeakMap();
  }
...
function pm(i, t, e) {
  let n = new Ba();
  const s = new $(), r = new $(), a = new re(), o = new hm({ depthPacking: kc }), l = new um(), c = {}, h = e.maxTextureSize, f = { [xn]: Ae, [Ae]: xn, [nn]: nn }, u = new Mn({ defines: { VSM_SAMPLES: 8 }, uniforms: { shadow_pass: { value: null }, resolution: { value: new $() }, radius: { value: 4 } }, vertexShader: fm, fragmentShader: dm }), m = u.clone();
  m.defines.HORIZONTAL_PASS = 1;
  const _ = new ve();
  _.setAttribute("position", new Ve(new Float32Array([-1, -1, 0.5, 3, -1, 0.5, -1, 3, 0.5]), 3));
  const x = new Xe(_, u), d = this;
...
function _m(i) {
  ...
  let c = {}, h = {}, f = /* @__PURE__ */ new WeakMap(), u = [], m = null, _ = false, x = null, d = null, p = null, b = null, S = null, E = null, N = null, R = new zt(0, 0, 0), w = 0, U = false, J = null, g = null, y = null, G = null, B = null;
  ...
  const Bt = { [Ln]: i.FUNC_ADD, [mc]: i.FUNC_SUBTRACT, [_c]: i.FUNC_REVERSE_SUBTRACT };
  Bt[gc] = i.MIN, Bt[vc] = i.MAX;
  ...
  function A(P, _t, V, K, ut, gt, kt, oe, ye, Xt) {
    ...
    ut = ut || _t, gt = gt || V, kt = kt || K, (_t !== d || ut !== S) && (i.blendEquationSeparate(Bt[_t], Bt[ut]), d = _t, S = ut), (V !== p || K !== b || gt !== E || kt !== N) && (i.blendFuncSeparate(q[V], q[K], q[gt], q[kt]), p = V, b = K, E = gt, N = kt), (oe.equals(R) === false || ye !== w) && (i.blendColor(oe.r, oe.g, oe.b, ye), R.copy(oe), w = ye), x = P, U = false;
  }
  function rt(P, _t) {
    P.side === nn ? ct(i.CULL_FACE) : Mt(i.CULL_FACE);
    let V = P.side === Ae;
    _t && (V = !V), st(V), P.blending === ci && P.transparent === false ? A(_n) : A(P.blending, P.blendEquation, P.blendSrc, P.blendDst, P.blendEquationAlpha, P.blendSrcAlpha, P.blendDstAlpha, P.blendColor, P.blendAlpha, P.premultipliedAlpha), r.setFunc(P.depthFunc), r.setTest(P.depthTest), r.setMask(P.depthWrite), s.setMask(P.colorWrite);
  ...
  function Q(P) {
    P !== uc ? (Mt(i.CULL_FACE), P !== g && (P === $a ? i.cullFace(i.BACK) : P === fc ? i.cullFace(i.FRONT) : i.cullFace(i.FRONT_AND_BACK))) : ct(i.CULL_FACE), g = P;
  }
  function at(P) {
...
function vm(i, t, e, n, s, r, a) {
  ...
  function Wt(T, v, I) {
    ...
    if (Y.version !== Et.__version || Z === true) {
      ...
      const ot = Zt.getPrimaries(Zt.workingColorSpace), vt = v.colorSpace === mn ? null : Zt.getPrimaries(v.colorSpace), Gt = v.colorSpace === mn || ot === vt ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      ...
      if (v.isDepthTexture) Ut = S(v.format === _i, v.type), Qt && (Nt ? e.texStorage2D(i.TEXTURE_2D, 1, Ut, nt.width, nt.height) : e.texImage2D(i.TEXTURE_2D, 0, Ut, nt.width, nt.height, 0, xt, Dt, null));
        ...
        for (let V = 0, K = Vt.length; V < K; V++) if (St = Vt[V], v.format !== Ge) if (xt !== null) if (Nt) {
          if (P) if (v.layerUpdates.size > 0) {
            const ut = Yo(St.width, St.height, v.format, v.type);
        ...
        if (Qt && e.texStorage3D(i.TEXTURE_2D_ARRAY, _t, Ut, nt.width, nt.height, nt.depth), P) if (v.layerUpdates.size > 0) {
          const V = Yo(nt.width, nt.height, v.format, v.type);
  ...
  function W(T, v, I) {
    ...
    if (Z.version !== Y.__version || X === true) {
      e.activeTexture(i.TEXTURE0 + I);
      const Et = Zt.getPrimaries(Zt.workingColorSpace), ot = v.colorSpace === mn ? null : Zt.getPrimaries(v.colorSpace), vt = v.colorSpace === mn || Et === ot ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
  ...
  function bt(T, v) {
    ...
    return T.isCompressedTexture === true || T.isVideoTexture === true || I !== Sn && I !== mn && (Zt.getTransfer(I) === ee ? (X !== Ge || Z !== an) && console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : console.error("THREE.WebGLTextures: Unsupported texture color space:", I)), v;
  }
  function mt(T) {
...
function xm(i, t) {
  function e(n, s = mn) {
    ...
    if (n === bl || n === _a || n === ga || n === va) if (r = t.get("EXT_texture_compression_rgtc"), r !== null) {
...
class Tm {
  ...
  getMesh(t) {
    if (this.texture !== null && this.mesh === null) {
      const e = t.cameras[0].viewport, n = new Mn({ vertexShader: ym, fragmentShader: Em, uniforms: { depthColor: { value: this.texture }, depthWidth: { value: e.z }, depthHeight: { value: e.w } } });
      this.mesh = new Xe(new ks(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
...
class Am extends zn {
  constructor(t, e) {
    ...
    function k(W, et, Mt) {
      ...
      const ct = F.distanceTo(tt), Ct = et.projectionMatrix.elements, Rt = Mt.projectionMatrix.elements, It = Ct[14] / (Ct[10] - 1), Bt = Ct[14] / (Ct[10] + 1), q = (Ct[9] + 1) / Ct[5], A = (Ct[9] - 1) / Ct[5], rt = (Ct[8] - 1) / Ct[0], st = (Rt[8] + 1) / Rt[0], Q = It * rt, at = It * st, bt = ct / (-rt + st), mt = bt * -rt;
      if (et.matrixWorld.decompose(W.position, W.quaternion, W.scale), W.translateX(mt), W.translateZ(bt), W.matrixWorld.compose(W.position, W.quaternion, W.scale), W.matrixWorldInverse.copy(W.matrixWorld).invert(), Ct[10] === -1) W.projectionMatrix.copy(et.projectionMatrix), W.projectionMatrixInverse.copy(et.projectionMatrixInverse);
        ...
        const T = It + bt, v = Bt + bt, I = Q - mt, X = at + (ct - mt), Z = q * Bt / v * T, Y = A * Bt / v * T;
    ...
    function Ht(W, et) {
      if (h = et.getViewerPose(c || a), _ = et, h !== null) {
        ...
        for (let Rt = 0; Rt < Mt.length; Rt++) {
          const It = Mt[Rt];
          let Bt = null;
          if (m !== null) Bt = m.getViewport(It);
          else {
            const A = f.getViewSubImage(u, It);
            Bt = A.viewport, Rt === 0 && (t.setRenderTargetTextures(b, A.colorTexture, u.ignoreDepthValues ? void 0 : A.depthStencilTexture), t.setRenderTarget(b));
          }
          let q = J[Rt];
          q === void 0 && (q = new Be(), q.layers.enable(Rt), q.viewport = new re(), J[Rt] = q), q.matrix.fromArray(It.transform.matrix), q.matrix.decompose(q.position, q.quaternion, q.scale), q.projectionMatrix.fromArray(It.projectionMatrix), q.projectionMatrixInverse.copy(q.projectionMatrix).invert(), q.viewport.set(Bt.x, Bt.y, Bt.width, Bt.height), Rt === 0 && (g.matrix.copy(q.matrix), g.matrix.decompose(g.position, g.quaternion, g.scale)), ct === true && g.cameras.push(q);
        }
...
class L_ {
  constructor(t = {}) {
    ...
    function Xt(M, L, O) {
      M.transparent === true && M.side === nn && M.forceSinglePass === false ? (M.side = Ae, M.needsUpdate = true, Wi(M, L, O), M.side = xn, M.needsUpdate = true, Wi(M, L, O), M.side = nn) : Wi(M, L, O);
    }
    ...
    En.setAnimationLoop(Ke), typeof self < "u" && En.setContext(self), this.setAnimationLoop = function(M) {
    ...
    }, V.addEventListener("sessionstart", Wa), V.addEventListener("sessionend", Xa), this.render = function(M, L) {
      ...
      qs(M, L, 0, S.sortObjects), x.finish(), S.sortObjects === true && x.sort(k, ht), Bt = V.enabled === false || V.isPresenting === false || V.hasDepthSensing() === false, Bt && Dt.addToRenderList(x, M), this.info.render.frame++, W === true && nt.beginShadows();
      ...
      if (d.setupLights(), L.isArrayCamera) {
        ...
        for (let ft = 0, yt = it.length; ft < yt; ft++) {
          const Tt = it[ft];
          Ya(x, M, Tt, Tt.viewport);
        }
      } else D.length > 0 && qa(z, D, M, L), Bt && Dt.render(M), Ya(x, M, L);
    ...
    function qa(M, L, O, z) {
      ...
      S.setRenderTarget(it), S.getClearColor(B), H = S.getClearAlpha(), H < 1 && S.setClearColor(16777215, 0.5), S.clear(), Bt && Dt.render(O);
      ...
      if (z.viewport !== void 0 && (z.viewport = void 0), d.setupLightsView(z), W === true && nt.setGlobalState(S.clippingPlanes, z), ki(M, O, z), T.updateMultisampleRenderTarget(it), T.updateRenderTargetMipmap(it), st.has("WEBGL_multisampled_render_to_texture") === false) {
        ...
        for (let At = 0, Kt = L.length; At < Kt; At++) {
          ...
          if (Yt.side === nn && se.layers.test(z.layers)) {
            const me = Yt.side;
            Yt.side = Ae, Yt.needsUpdate = true, Za(se, O, z, be, Yt, wt), Yt.side = me, Yt.needsUpdate = true, Lt = true;
          }
        }
    ...
    function ki(M, L, O) {
      ...
      for (let D = 0, it = M.length; D < it; D++) {
        ...
        yt.layers.test(O.layers) && Za(yt, L, O, Tt, Pt, Lt);
      }
    }
    function Za(M, L, O, z, D, it) {
      M.onBeforeRender(S, L, O, z, D, it), M.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse, M.matrixWorld), M.normalMatrix.getNormalMatrix(M.modelViewMatrix), D.onBeforeRender(S, L, O, z, M, it), D.transparent === true && D.side === nn && D.forceSinglePass === false ? (D.side = Ae, D.needsUpdate = true, S.renderBufferDirect(O, L, z, D, M, it), D.side = xn, D.needsUpdate = true, S.renderBufferDirect(O, L, z, D, M, it), D.side = nn) : S.renderBufferDirect(O, L, z, D, M, it), M.onAfterRender(S, L, O, z, D, it);
    }
    function Wi(M, L, O) {
      L.isScene !== true && (L = It);
    ...
    function ac(M, L, O, z, D) {
      ...
      const it = L.fog, ft = z.isMeshStandardMaterial ? L.environment : null, yt = w === null ? S.outputColorSpace : w.isXRRenderTarget === true ? w.texture.colorSpace : Sn, Tt = (z.isMeshStandardMaterial ? I : v).get(z.envMap || ft), Pt = z.vertexColors === true && !!O.attributes.color && O.attributes.color.itemSize === 4, Lt = !!O.attributes.tangent && (!!z.normalMap || z.anisotropy > 0), At = !!O.morphAttributes.position, Kt = !!O.morphAttributes.normal, te = !!O.morphAttributes.color;
      let se = gn;
      ...
      const ae = Ie.getUniforms(), on = wt.uniforms;
      ...
      if ((Ks.position !== void 0 || Ks.normal !== void 0 || Ks.color !== void 0) && Ut.update(D, O, Ie), (we || wt.receiveShadow !== D.receiveShadow) && (wt.receiveShadow = D.receiveShadow, ae.setValue(A, "receiveShadow", D.receiveShadow)), z.isMeshGouraudMaterial && z.envMap !== null && (on.envMap.value = Tt, on.flipEnvMap.value = Tt.isCubeTexture && Tt.isRenderTargetTexture === false ? -1 : 1), z.isMeshStandardMaterial && z.envMap === null && L.environment !== null && (on.envMapIntensity.value = L.environmentIntensity), we && (ae.setValue(A, "toneMappingExposure", S.toneMappingExposure), wt.needsLights && oc(on, Zs), it && z.fog === true && ot.refreshFogUniforms(on, it), ot.refreshMaterialUniforms(on, z, tt, F, d.state.transmissionRenderTarget[M.id]), Ds.upload(A, Ka(wt), on, T)), z.isShaderMaterial && z.uniformsNeedUpdate === true && (Ds.upload(A, Ka(wt), on, T), z.uniformsNeedUpdate = false), z.isSpriteMaterial && ae.setValue(A, "center", D.center), ae.setValue(A, "modelViewMatrix", D.modelViewMatrix), ae.setValue(A, "normalMatrix", D.normalMatrix), ae.setValue(A, "modelMatrix", D.matrixWorld), z.isShaderMaterial || z.isRawShaderMaterial) {
        const Pe = z.uniformsGroups;
        for (let js = 0, cc = Pe.length; js < cc; js++) {
          const Ja = Pe[js];
          P.update(Ja, Ie), P.bind(Ja, Ie);
        }
      }
      return Ie;
    }
  ...
  set outputColorSpace(t) {
    ...
    e.drawingBufferColorSpace = t === Ia ? "display-p3" : "srgb", e.unpackColorSpace = Zt.workingColorSpace === Vs ? "display-p3" : "srgb";
  }
}
class D_ extends ce {
  constructor() {
...
class Cm {
  constructor(t, e) {
    this.isInterleavedBuffer = true, this.array = t, this.stride = e, this.count = t !== void 0 ? t.length / e : 0, this.usage = xa, this.updateRanges = [], this.version = 0, this.uuid = Ye();
  }
  onUploadCallback() {
  }
  set needsUpdate(t) {
...
class Bs {
  ...
  applyMatrix4(t) {
    for (let e = 0, n = this.data.count; e < n; e++) xe.fromBufferAttribute(this, e), xe.applyMatrix4(t), this.setXYZ(e, xe.x, xe.y, xe.z);
    return this;
  }
  applyNormalMatrix(t) {
    for (let e = 0, n = this.count; e < n; e++) xe.fromBufferAttribute(this, e), xe.applyNormalMatrix(t), this.setXYZ(e, xe.x, xe.y, xe.z);
    return this;
  }
  transformDirection(t) {
    for (let e = 0, n = this.count; e < n; e++) xe.fromBufferAttribute(this, e), xe.transformDirection(t), this.setXYZ(e, xe.x, xe.y, xe.z);
    return this;
  }
  getComponent(t, e) {
...
let ei;
const Ti = new C(), ni = new C(), ii = new C(), si = new $(), Ai = new $(), Xl = new $t(), ds = new C(), bi = new C(), ps = new C(), qo = new $(), br = new $(), Zo = new $();
class Lm extends ce {
  ...
  raycast(t, e) {
    ...
    const a = this.center;
    ms(ds.set(-0.5, -0.5, 0), ii, a, ni, s, r), ms(bi.set(0.5, -0.5, 0), ii, a, ni, s, r), ms(ps.set(0.5, 0.5, 0), ii, a, ni, s, r), qo.set(0, 0), br.set(1, 0), Zo.set(1, 1);
    ...
    l < t.near || l > t.far || e.push({ distance: l, point: Ti.clone(), uv: De.getInterpolation(Ti, ds, bi, ps, qo, br, Zo, new $()), face: null, object: this });
  }
  copy(t, e) {
...
const zs = new C(), Hs = new C(), Ko = new $t(), wi = new Gi(), _s = new Hi(), wr = new C(), jo = new C();
class Yl extends ce {
  constructor(t = new ve(), e = new Xs()) {
  ...
  raycast(t, e) {
    ...
    Ko.copy(s).invert(), wi.copy(t.ray).applyMatrix4(Ko);
...
class Dm extends Yl {
  ...
  computeLineDistances() {
    ...
    if (t.index === null) {
      ...
      for (let s = 0, r = e.count; s < r; s += 2) Jo.fromBufferAttribute(e, s), $o.fromBufferAttribute(e, s + 1), n[s] = s === 0 ? 0 : n[s - 1], n[s + 1] = n[s] + Jo.distanceTo($o);
      t.setAttribute("lineDistance", new ie(n, 1));
...
const Qo = new $t(), Sa = new Gi(), vs = new Hi(), xs = new C();
class U_ extends ce {
  constructor(t = new ve(), e = new Um()) {
  ...
  raycast(t, e) {
    ...
    Qo.copy(s).invert(), Sa.copy(t.ray).applyMatrix4(Qo);
    ...
    if (c !== null) {
      ...
      for (let _ = u, x = m; _ < x; _++) {
        const d = c.getX(_);
        xs.fromBufferAttribute(f, d), tl(xs, d, l, s, t, e, this);
      }
    } else {
      const u = Math.max(0, a.start), m = Math.min(f.count, a.start + a.count);
      for (let _ = u, x = m; _ < x; _++) xs.fromBufferAttribute(f, _), tl(xs, _, l, s, t, e, this);
    }
  }
  updateMorphTargets() {
    const e = this.geometry.morphAttributes, n = Object.keys(e);
...
const Ms = new C(), Rr = new Ga(), Cr = new Ga(), Pr = new Ga();
class Nm extends Ze {
...
class jl extends Ze {
  ...
  getPoint(t, e = new $()) {
    ...
    return n.set(el(o, l.x, c.x, h.x, f.x), el(o, l.y, c.y, h.y, f.y)), n;
  }
  copy(t) {
    super.copy(t), this.points = [];
    for (let e = 0, n = t.points.length; e < n; e++) {
...
var ya = Object.freeze({ __proto__: null, ArcCurve: Im, CatmullRomCurve3: Nm, CubicBezierCurve: ql, CubicBezierCurve3: km, EllipseCurve: Ha, LineCurve: Zl, LineCurve3: Wm, QuadraticBezierCurve: Kl, QuadraticBezierCurve3: Xm, SplineCurve: jl });
class Ym extends Ze {
  constructor() {
...
class nl extends Ym {
  ...
  absellipse(t, e, n, s, r, a, o, l) {
    const c = new Ha(t, e, n, s, r, a, o, l);
...
class Jl extends nl {
  ...
  fromJSON(t) {
    ...
    for (let e = 0, n = t.holes.length; e < n; e++) {
      const s = t.holes[e];
      this.holes.push(new nl().fromJSON(s));
    }
    return this;
  }
}
...
function $l(i, t, e, n, s) {
  let r, a;
  if (s === c_(i, t, e, n) > 0) for (r = t; r < e; r += n) a = il(r, i[r], i[r + 1], a);
  else for (r = e - n; r >= t; r -= n) a = il(r, i[r], i[r + 1], a);
...
class vn {
  ...
  static triangulateShape(t, e) {
    ...
    let a = t.length;
    e.forEach(sl);
    for (let l = 0; l < e.length; l++) s.push(a), a += e[l].length, rl(n, e[l]);
    ...
    function a(o) {
      ...
      if (!vn.isClockWise(g)) {
        ...
        for (let q = 0, A = y.length; q < A; q++) {
          const rt = y[q];
          vn.isClockWise(rt) && (y[q] = rt.reverse());
        }
      }
      const B = vn.triangulateShape(g, y), H = g;
      for (let q = 0, A = y.length; q < A; q++) {
        const rt = y[q];
        g = g.concat(rt);
      }
...
class nc extends ve {
  constructor(t = new Jl([new $(0, 0.5), new $(-0.5, -0.5), new $(0.5, -0.5)]), e = 12) {
    ...
    function c(h) {
      ...
      let m = u.shape;
      const _ = u.holes;
      vn.isClockWise(m) === false && (m = m.reverse());
      for (let d = 0, p = _.length; d < p; d++) {
        const b = _[d];
        vn.isClockWise(b) === true && (_[d] = b.reverse());
      }
      const x = vn.triangulateShape(m, _);
      for (let d = 0, p = _.length; d < p; d++) {
        const b = _[d];
        m = m.concat(b);
      }
...
class sc extends ce {
  constructor(t, e = 1) {
    super(), this.isLight = true, this.type = "Light", this.color = new zt(t), this.intensity = e;
  }
  dispose() {
  }
  copy(t, e) {
...
const Lr = new $t(), al = new C(), ol = new C();
class d_ {
  constructor(t) {
    this.camera = t, this.intensity = 1, this.bias = 0, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new $(512, 512), this.map = null, this.mapPass = null, this.matrix = new $t(), this.autoUpdate = true, this.needsUpdate = false, this._frustum = new Ba(), this._frameExtents = new $(1, 1), this._viewportCount = 1, this._viewports = [new re(0, 0, 1, 1)];
  }
  getViewportCount() {
  ...
  updateMatrices(t) {
    ...
    al.setFromMatrixPosition(t.matrixWorld), e.position.copy(al), ol.setFromMatrixPosition(t.target.matrixWorld), e.lookAt(ol), e.updateMatrixWorld(), Lr.multiplyMatrices(e.projectionMatrix, e.matrixWorldInverse), this._frustum.setFromProjectionMatrix(Lr), n.set(0.5, 0, 0, 0.5, 0, 0.5, 0, 0.5, 0, 0, 0.5, 0.5, 0, 0, 0, 1), n.multiply(Lr);
  }
  getViewport(t) {
...
class B_ {
  constructor(t, e, n = 0, s = 1 / 0) {
    this.ray = new Gi(t, e), this.near = n, this.far = s, this.camera = null, this.layers = new Oa(), this.params = { Mesh: {}, Line: { threshold: 1 }, LOD: {}, Points: { threshold: 1 }, Sprite: {} };
  }
  set(t, e) {
    this.ray.set(t, e);
  }
  ...
  setFromXRController(t) {
    return ll.identity().extractRotation(t.matrixWorld), this.ray.origin.setFromMatrixPosition(t.matrixWorld), this.ray.direction.set(0, 0, -1).applyMatrix4(ll), this;
  }
  intersectObject(t, e = true, n = []) {
    return Aa(t, this, n, e), n.sort(cl), n;
  }
...
class z_ {
  ...
  closestPointToPointParameter(t, e) {
    ul.subVectors(t, this.start), Es.subVectors(this.end, this.start);
    const n = Es.dot(Es);
    let r = Es.dot(ul) / n;
...
class G_ extends ce {
  constructor(t = new C(0, 0, 1), e = new C(0, 0, 0), n = 1, s = 16776960, r = n * 0.2, a = r * 0.2) {
    super(), this.type = "ArrowHelper", Ts === void 0 && (Ts = new ve(), Ts.setAttribute("position", new ie([0, 0, 0, 0, 1, 0], 3)), Dr = new Va(0, 0.5, 1, 5, 1), Dr.translate(0, -0.5, 0)), this.position.copy(e), this.line = new Yl(Ts, new Xs({ color: s, toneMapped: false })), this.line.matrixAutoUpdate = false, this.add(this.line), this.cone = new Xe(Dr, new Fa({ color: s, toneMapped: false })), this.cone.matrixAutoUpdate = false, this.add(this.cone), this.setDirection(t), this.setLength(n, r, a);
  }
  setDirection(t) {
...
class V_ extends m_ {
  ...
  reset() {
    this.target.copy(this.target0), this.object.position.copy(this.position0), this.object.zoom = this.zoom0, this.object.updateProjectionMatrix(), this.dispatchEvent(dl), this.update(), this.state = Jt.NONE;
  }
  update(t = null) {
    ...
    if (he.setFromSpherical(this._spherical), he.applyQuaternion(this._quatInverse), e.copy(this.target).add(he), this.object.lookAt(this.target), this.enableDamping === true ? (this._sphericalDelta.theta *= 1 - this.dampingFactor, this._sphericalDelta.phi *= 1 - this.dampingFactor, this._panOffset.multiplyScalar(1 - this.dampingFactor)) : (this._sphericalDelta.set(0, 0, 0), this._panOffset.set(0, 0, 0)), this.zoomToCursor && this._performCursorZoom) {
      ...
      a !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position) : (As.origin.copy(this.object.position), As.direction.set(0, 0, -1).transformDirection(this.object.matrix), Math.abs(this.object.up.dot(As.direction)) < __ ? this.object.lookAt(this.target) : (pl.setFromNormalAndCoplanarPoint(this.object.up, this.target), As.intersectPlane(pl, this.target))));
    } else if (this.object.isOrthographicCamera) {
...
function M_(i) {
  ...
  this.state !== Jt.NONE && this.dispatchEvent(ka);
}
function S_(i) {
  switch (this.state) {
    case Jt.ROTATE:
...
function y_(i) {
  this.enabled === false || this.enableZoom === false || this.state !== Jt.NONE || (i.preventDefault(), this.dispatchEvent(ka), this._handleMouseWheel(this._customWheelEvent(i)), this.dispatchEvent(rc));
}
function E_(i) {
